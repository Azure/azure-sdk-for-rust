...
- Use the [doc-comment-review skill](../skills/doc-comment-review/SKILL.md) whenever reviewing code that affects public APIs, even when no doc comments changed; preserve this review's high-signal reporting threshold.
