...
4. Remind the user that generated SDK code must *not* be edited manually—customizations belong in `client.tsp`.
...
- Add `examples/` or `samples/` showcasing at least one happy-path scenario using the generated client, keeping code snippets synchronized with README content.
3. **Tests**
