...
- `{service-directory}` is the directory under [sdk](../../sdk) directory for the current ${file} e.g., `sdk/core`.
...
- In the `{crate-name}/benches/benchmarks.rs` file:
  ...
  - Use [sdk/keyvault/azure_security_keyvault_keys/perf/perf_tests.rs](../../sdk/keyvault/azure_security_keyvault_keys/perf/perf_tests.rs) as an example.
