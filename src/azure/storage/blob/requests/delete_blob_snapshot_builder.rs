...
use azure::storage::blob::responses::DeleteBlobSnapshotResponse;
...
impl<'a> DeleteBlobSnapshotBuilder<'a, Yes, Yes, Yes> {
    pub fn finalize(self) -> impl Future<Item = DeleteBlobSnapshotResponse, Error = AzureError> {
        let mut uri = format!(
        ...
        let req = self.client().perform_request(
            ...
            .and_then(|(headers, _body)| done(DeleteBlobSnapshotResponse::from_headers(&headers)))
    }
}
