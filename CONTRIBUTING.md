...
If your modification involves consuming a new version of the typespec-rust generator, update the `eng/emitter-package.json` file to reference the updated version of the generator.
