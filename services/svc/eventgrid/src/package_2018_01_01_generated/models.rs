...
impl AcsChatMessageDeletedEventData {
    pub fn new(acs_chat_message_event_base_properties: AcsChatMessageEventBaseProperties) -> Self {
        Self {
...
impl AcsChatMessageDeletedInThreadEventData {
    pub fn new(acs_chat_message_event_in_thread_base_properties: AcsChatMessageEventInThreadBaseProperties) -> Self {
        Self {
...
impl AcsChatMessageEventInThreadBaseProperties {
    pub fn new(sender_communication_identifier: CommunicationIdentifierModel) -> Self {
        Self {
...
impl AcsChatThreadCreatedEventData {
    pub fn new(
        ...
        Self {
            acs_chat_thread_event_in_thread_base_properties: AcsChatThreadEventInThreadBaseProperties::default(),
...
impl AcsChatThreadDeletedEventData {
    pub fn new(deleted_by_communication_identifier: CommunicationIdentifierModel) -> Self {
        Self {
            acs_chat_thread_event_in_thread_base_properties: AcsChatThreadEventInThreadBaseProperties::default(),
...
impl AcsChatThreadEventBaseProperties {
    pub fn new(acs_chat_event_base_properties: AcsChatEventBaseProperties) -> Self {
        Self {
            acs_chat_event_base_properties,
            create_time: None,
            version: None,
...
impl AcsEmailDeliveryReportReceivedEventData {
    pub fn new(delivery_status_details: AcsEmailDeliveryReportStatusDetails) -> Self {
        Self {
            sender: None,
            recipient: None,
            message_id: None,
            ...
            delivery_attempt_timestamp: None,
        }
    }
}
#[doc = "The status of the email. Any value other than Delivered is considered failed."]
...
pub struct AcsMessageDeliveryStatusUpdatedEventData {
    ...
    #[doc = "Message delivery status"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<AcsMessageDeliveryStatus>,
    #[doc = "Message channel kind"]
    #[serde(rename = "channelType", default, skip_serializing_if = "Option::is_none")]
    pub channel_type: Option<AcsMessageChannelKind>,
}
impl AcsMessageDeliveryStatusUpdatedEventData {
    pub fn new(acs_message_event_data: AcsMessageEventData) -> Self {
        Self {
...
pub struct AcsMessageEventData {
    ...
    pub received_time_stamp: Option<::time::OffsetDateTime>,
    #[doc = "Message Channel Event Error"]
    pub error: AcsMessageChannelEventError,
}
impl AcsMessageEventData {
    pub fn new(error: AcsMessageChannelEventError) -> Self {
        Self {
            from: None,
            to: None,
...
pub struct AcsMessageInteractiveContent {
    #[doc = "Interactive reply kind"]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<AcsInteractiveReplyKind>,
    #[doc = "Message Interactive button reply content for a user to business message"]
    #[serde(rename = "buttonReply")]
...
impl AcsMessageInteractiveContent {
    pub fn new(button_reply: AcsMessageInteractiveButtonReplyContent, list_reply: AcsMessageInteractiveListReplyContent) -> Self {
        Self {
            type_: None,
            button_reply,
            list_reply,
...
impl AcsRecordingFileStatusUpdatedEventData {
    pub fn new(recording_storage_info: AcsRecordingStorageInfoProperties) -> Self {
        Self {
            recording_storage_info,
            recording_start_time: None,
            recording_duration_ms: None,
            recording_content_type: None,
            recording_channel_type: None,
            recording_format_type: None,
...
pub struct AcsRouterWorkerSelector {
    ...
    pub label_operator: Option<AcsRouterLabelOperator>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<AcsRouterWorkerSelectorState>,
...
impl AcsRouterWorkerSelector {
    pub fn new(value: serde_json::Value, ttl_seconds: f64) -> Self {
        Self {
            key: None,
            label_operator: None,
            value,
...
impl AcsSmsDeliveryReportReceivedEventData {
    pub fn new(delivery_attempts: Vec<AcsSmsDeliveryAttemptProperties>) -> Self {
        Self {
...
impl ContainerRegistryArtifactEventData {
    pub fn new(target: ContainerRegistryArtifactEventTarget, connected_registry: ContainerRegistryEventConnectedRegistry) -> Self {
        Self {
            id: None,
            timestamp: None,
            action: None,
...
impl MediaJobError {
    pub fn new(details: Vec<MediaJobErrorDetail>) -> Self {
        Self {
            code: None,
            message: None,
            category: None,
...
impl MediaJobOutput {
    pub fn new(error: MediaJobError, progress: i64) -> Self {
        Self {
            error,
            label: None,
            progress,
...
impl MediaJobOutputStateChangeEventData {
    pub fn new(output: MediaJobOutputUnion, job_correlation_data: serde_json::Value) -> Self {
        Self {
            previous_state: None,
            output,
            job_correlation_data,
...
impl MediaJobStateChangeEventData {
    pub fn new(correlation_data: serde_json::Value) -> Self {
        Self {
            previous_state: None,
            state: None,
            correlation_data,
...
impl StorageTaskAssignmentCompletedEventData {
    pub fn new(summary_report_blob_url: String) -> Self {
        Self {
            status: None,
