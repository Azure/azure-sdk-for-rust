...
pub mod catalog {
    ...
    ) -> std::result::Result<(), create_secret::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/catalog/usql/databases/{}/secrets/{}",
            operation_config.base_path(),
    ...
    pub async fn update_secret(
        ...
        secret_name: &str,
        parameters: &DataLakeAnalyticsCatalogSecretCreateOrUpdateParameters,
    ) -> std::result::Result<(), update_secret::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/catalog/usql/databases/{}/secrets/{}",
            operation_config.base_path(),
    ...
    pub async fn delete_credential(
        ...
        database_name: &str,
        credential_name: &str,
        parameters: Option<&DataLakeAnalyticsCatalogCredentialDeleteParameters>,
        cascade: Option<bool>,
    ) -> std::result::Result<(), delete_credential::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/catalog/usql/databases/{}/credentials/{}",
            operation_config.base_path(),
        ...
        let mut url = url::Url::parse(url_str).map_err(delete_credential::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        ...
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(delete_credential::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
        let req_body = if let Some(parameters) = parameters {
            req_builder = req_builder.header("content-type", "application/json");
            azure_core::to_json(parameters).map_err(delete_credential::Error::SerializeError)?
        } else {
            bytes::Bytes::from_static(azure_core::EMPTY_BODY)
        };
        if let Some(cascade) = cascade {
            url.query_pairs_mut().append_pair("cascade", cascade.to_string().as_str());
        }
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder.body(req_body).map_err(delete_credential::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(delete_credential::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => Ok(()),
            status_code => {
                let rsp_body = rsp.body();
                Err(delete_credential::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn create_credential(
    ...
    ) -> std::result::Result<(), create_credential::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/catalog/usql/databases/{}/credentials/{}",
            operation_config.base_path(),
        ...
        let mut url = url::Url::parse(url_str).map_err(create_credential::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::PUT);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(create_credential::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
        req_builder = req_builder.header("content-type", "application/json");
        let req_body = azure_core::to_json(parameters).map_err(create_credential::Error::SerializeError)?;
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder.body(req_body).map_err(create_credential::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(create_credential::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => Ok(()),
            status_code => {
                let rsp_body = rsp.body();
                Err(create_credential::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn update_credential(
        ...
        database_name: &str,
        credential_name: &str,
        parameters: &DataLakeAnalyticsCatalogCredentialUpdateParameters,
    ) -> std::result::Result<(), update_credential::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/catalog/usql/databases/{}/credentials/{}",
            operation_config.base_path(),
        ...
        let mut url = url::Url::parse(url_str).map_err(update_credential::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::PATCH);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(update_credential::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
        req_builder = req_builder.header("content-type", "application/json");
        let req_body = azure_core::to_json(parameters).map_err(update_credential::Error::SerializeError)?;
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder.body(req_body).map_err(update_credential::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(update_credential::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => Ok(()),
            status_code => {
                let rsp_body = rsp.body();
                Err(update_credential::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn list_table_fragments(
        ...
        orderby: Option<&str>,
        count: Option<bool>,
    ) -> std::result::Result<USqlTableFragmentList, list_table_fragments::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        let mut url = url::Url::parse(url_str).map_err(list_table_fragments::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(list_table_fragments::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
        if let Some(filter) = filter {
        ...
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder.body(req_body).map_err(list_table_fragments::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(list_table_fragments::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: USqlTableFragmentList = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_table_fragments::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                Err(list_table_fragments::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn list_tables(
        ...
        if let Some(basic) = basic {
            url.query_pairs_mut().append_pair("basic", basic.to_string().as_str());
        }
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        req_builder = req_builder.uri(url.as_str());
    ...
    pub async fn list_table_statistics_by_database_and_schema(
        operation_config: &crate::OperationConfig,
        database_name: &str,
        schema_name: &str,
        filter: Option<&str>,
        ...
        orderby: Option<&str>,
        count: Option<bool>,
    ) -> std::result::Result<USqlTableStatisticsList, list_table_statistics_by_database_and_schema::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        let mut url = url::Url::parse(url_str).map_err(list_table_statistics_by_database_and_schema::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(list_table_statistics_by_database_and_schema::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
        if let Some(filter) = filter {
        ...
        let req = req_builder
            .body(req_body)
            .map_err(list_table_statistics_by_database_and_schema::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(list_table_statistics_by_database_and_schema::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: USqlTableStatisticsList = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_table_statistics_by_database_and_schema::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                Err(list_table_statistics_by_database_and_schema::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn get_package(
        ...
        schema_name: &str,
        package_name: &str,
    ) -> std::result::Result<USqlPackage, get_package::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        let mut url = url::Url::parse(url_str).map_err(get_package::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(get_package::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder.body(req_body).map_err(get_package::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(get_package::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: USqlPackage =
                    serde_json::from_slice(rsp_body).map_err(|source| get_package::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                Err(get_package::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn list_packages(
        ...
        orderby: Option<&str>,
        count: Option<bool>,
    ) -> std::result::Result<USqlPackageList, list_packages::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/catalog/usql/databases/{}/schemas/{}/packages",
            operation_config.base_path(),
        ...
        let mut url = url::Url::parse(url_str).map_err(list_packages::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(list_packages::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
        if let Some(filter) = filter {
        ...
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder.body(req_body).map_err(list_packages::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(list_packages::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: USqlPackageList =
                    serde_json::from_slice(rsp_body).map_err(|source| list_packages::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                Err(list_packages::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn preview_table_partition(
        operation_config: &crate::OperationConfig,
        database_name: &str,
        schema_name: &str,
        table_name: &str,
    ...
    ) -> std::result::Result<USqlTablePreview, preview_table_partition::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        let mut url = url::Url::parse(url_str).map_err(preview_table_partition::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(preview_table_partition::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
        if let Some(max_rows) = max_rows {
            url.query_pairs_mut().append_pair("maxRows", max_rows.to_string().as_str());
        }
        if let Some(max_columns) = max_columns {
            url.query_pairs_mut().append_pair("maxColumns", max_columns.to_string().as_str());
        }
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder
            .body(req_body)
            .map_err(preview_table_partition::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(preview_table_partition::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: USqlTablePreview = serde_json::from_slice(rsp_body)
                    .map_err(|source| preview_table_partition::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                Err(preview_table_partition::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn preview_table(
        ...
        max_rows: Option<i64>,
        max_columns: Option<i64>,
    ) -> std::result::Result<USqlTablePreview, preview_table::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        let mut url = url::Url::parse(url_str).map_err(preview_table::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(preview_table::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
        if let Some(max_rows) = max_rows {
        ...
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder.body(req_body).map_err(preview_table::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(preview_table::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: USqlTablePreview =
                    serde_json::from_slice(rsp_body).map_err(|source| preview_table::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                Err(preview_table::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn list_table_statistics_by_database(
        operation_config: &crate::OperationConfig,
        database_name: &str,
        filter: Option<&str>,
        top: Option<i32>,
        ...
        orderby: Option<&str>,
        count: Option<bool>,
    ) -> std::result::Result<USqlTableStatisticsList, list_table_statistics_by_database::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        let mut url = url::Url::parse(url_str).map_err(list_table_statistics_by_database::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(list_table_statistics_by_database::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
        if let Some(filter) = filter {
        ...
        let req = req_builder
            .body(req_body)
            .map_err(list_table_statistics_by_database::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(list_table_statistics_by_database::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: USqlTableStatisticsList = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_table_statistics_by_database::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                Err(list_table_statistics_by_database::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn list_tables_by_database(
        operation_config: &crate::OperationConfig,
        database_name: &str,
        filter: Option<&str>,
        top: Option<i32>,
        ...
        count: Option<bool>,
        basic: Option<bool>,
    ) -> std::result::Result<USqlTableList, list_tables_by_database::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!("{}/catalog/usql/databases/{}/tables", operation_config.base_path(), database_name);
        let mut url = url::Url::parse(url_str).map_err(list_tables_by_database::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(list_tables_by_database::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
        if let Some(filter) = filter {
        ...
        let req = req_builder
            .body(req_body)
            .map_err(list_tables_by_database::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(list_tables_by_database::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: USqlTableList = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_tables_by_database::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                Err(list_tables_by_database::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn list_table_valued_functions_by_database(
        operation_config: &crate::OperationConfig,
        database_name: &str,
        filter: Option<&str>,
        top: Option<i32>,
        ...
        orderby: Option<&str>,
        count: Option<bool>,
    ) -> std::result::Result<USqlTableValuedFunctionList, list_table_valued_functions_by_database::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        let mut url = url::Url::parse(url_str).map_err(list_table_valued_functions_by_database::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(list_table_valued_functions_by_database::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
        if let Some(filter) = filter {
        ...
        let req = req_builder
            .body(req_body)
            .map_err(list_table_valued_functions_by_database::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(list_table_valued_functions_by_database::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: USqlTableValuedFunctionList = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_table_valued_functions_by_database::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                Err(list_table_valued_functions_by_database::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn list_views_by_database(
        operation_config: &crate::OperationConfig,
        database_name: &str,
        filter: Option<&str>,
        top: Option<i32>,
        ...
        orderby: Option<&str>,
        count: Option<bool>,
    ) -> std::result::Result<USqlViewList, list_views_by_database::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!("{}/catalog/usql/databases/{}/views", operation_config.base_path(), database_name);
        let mut url = url::Url::parse(url_str).map_err(list_views_by_database::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(list_views_by_database::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
        if let Some(filter) = filter {
        ...
        let req = req_builder
            .body(req_body)
            .map_err(list_views_by_database::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(list_views_by_database::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: USqlViewList = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_views_by_database::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                Err(list_views_by_database::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn list_acls_by_database(
        operation_config: &crate::OperationConfig,
        database_name: &str,
        filter: Option<&str>,
        top: Option<i32>,
        ...
        orderby: Option<&str>,
        count: Option<bool>,
    ) -> std::result::Result<AclList, list_acls_by_database::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!("{}/catalog/usql/databases/{}/acl", operation_config.base_path(), database_name);
        let mut url = url::Url::parse(url_str).map_err(list_acls_by_database::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(list_acls_by_database::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
        if let Some(filter) = filter {
        ...
        let req = req_builder
            .body(req_body)
            .map_err(list_acls_by_database::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(list_acls_by_database::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: AclList = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_acls_by_database::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                Err(list_acls_by_database::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn list_acls(
        ...
        orderby: Option<&str>,
        count: Option<bool>,
    ) -> std::result::Result<AclList, list_acls::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!("{}/catalog/usql/acl", operation_config.base_path(),);
        let mut url = url::Url::parse(url_str).map_err(list_acls::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(list_acls::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
        if let Some(filter) = filter {
        ...
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder.body(req_body).map_err(list_acls::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(list_acls::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: AclList =
                    serde_json::from_slice(rsp_body).map_err(|source| list_acls::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                Err(list_acls::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
