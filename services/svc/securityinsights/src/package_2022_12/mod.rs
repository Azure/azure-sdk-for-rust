...
azure_core::static_url!(DEFAULT_ENDPOINT, "https://sentinelus.azure-api.net");
impl ClientBuilder {
...
pub mod threat_intelligence_indicators {
    ...
    impl Client {
        ...
        #[doc = "Upload the list of indicators to the workspace specified"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `workspace_id`: The workspace ID for the indicators to be uploaded."]
        #[doc = "* `body`: Body of the request with an array of indicators and other properties"]
        pub fn upload(&self, workspace_id: impl Into<String>, body: impl Into<models::UploadIndicatorsRequest>) -> upload::RequestBuilder {
    ...
    pub mod upload {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::UploadIndicatorsResponse> {
                ...
                let body: models::UploadIndicatorsResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) body: models::UploadIndicatorsRequest,
        }
        impl RequestBuilder {
