...
pub mod package_7_1;
#[cfg(all(feature = "package-7_1", not(feature = "no-default-tag")))]
...
pub mod package_7_0;
#[cfg(all(feature = "package-7_0", not(feature = "no-default-tag")))]
...
#[cfg(all(feature = "package-7_0-preview", not(feature = "no-default-tag")))]
