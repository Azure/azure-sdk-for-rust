...
pub struct SasDefinitionBundle {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sid: Option<String>,
    #[doc = "The SAS definition metadata in the form of key-value pairs."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct SasDefinitionCreateParameters {
    #[doc = "Sas definition creation metadata in the form of key-value pairs."]
...
pub struct SasDefinitionUpdateParameters {
    #[doc = "Sas definition update metadata in the form of key-value pairs."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub parameters: Option<serde_json::Value>,
    #[doc = "The SAS definition management attributes."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
