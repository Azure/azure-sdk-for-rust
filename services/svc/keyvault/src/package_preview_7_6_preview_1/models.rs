    ...
    impl Serialize for Alg {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::CkmAesKeyWrap => serializer.serialize_unit_variant("Alg", 15u32, "CKM_AES_KEY_WRAP"),
                Self::CkmAesKeyWrapPad => serializer.serialize_unit_variant("Alg", 16u32, "CKM_AES_KEY_WRAP_PAD"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
