...
impl CertificateInfoObject {
    pub fn new(certificates: Vec<SecurityDomainCertificateItem>) -> Self {
        Self {
            certificates,
            required: None,
        }
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::MicrosoftKeyVaultManagedHsmKeysEncryptAction => {
                serializer.serialize_unit_variant("DataAction", 10u32, "Microsoft.KeyVault/managedHsm/keys/encrypt/action")
            }
            Self::MicrosoftKeyVaultManagedHsmKeysDecryptAction => {
                serializer.serialize_unit_variant("DataAction", 11u32, "Microsoft.KeyVault/managedHsm/keys/decrypt/action")
            }
            Self::MicrosoftKeyVaultManagedHsmKeysWrapAction => {
                serializer.serialize_unit_variant("DataAction", 12u32, "Microsoft.KeyVault/managedHsm/keys/wrap/action")
            }
            Self::MicrosoftKeyVaultManagedHsmKeysUnwrapAction => {
                serializer.serialize_unit_variant("DataAction", 13u32, "Microsoft.KeyVault/managedHsm/keys/unwrap/action")
            }
            Self::MicrosoftKeyVaultManagedHsmKeysSignAction => {
                serializer.serialize_unit_variant("DataAction", 14u32, "Microsoft.KeyVault/managedHsm/keys/sign/action")
            }
            Self::MicrosoftKeyVaultManagedHsmKeysVerifyAction => {
                serializer.serialize_unit_variant("DataAction", 15u32, "Microsoft.KeyVault/managedHsm/keys/verify/action")
            }
            Self::MicrosoftKeyVaultManagedHsmKeysCreate => {
                serializer.serialize_unit_variant("DataAction", 16u32, "Microsoft.KeyVault/managedHsm/keys/create")
            }
            Self::MicrosoftKeyVaultManagedHsmKeysDelete => {
                serializer.serialize_unit_variant("DataAction", 17u32, "Microsoft.KeyVault/managedHsm/keys/delete")
            }
            Self::MicrosoftKeyVaultManagedHsmKeysExportAction => {
                serializer.serialize_unit_variant("DataAction", 18u32, "Microsoft.KeyVault/managedHsm/keys/export/action")
            }
            Self::MicrosoftKeyVaultManagedHsmKeysImportAction => {
                serializer.serialize_unit_variant("DataAction", 19u32, "Microsoft.KeyVault/managedHsm/keys/import/action")
            }
            Self::MicrosoftKeyVaultManagedHsmKeysDeletedKeysDelete => {
                serializer.serialize_unit_variant("DataAction", 20u32, "Microsoft.KeyVault/managedHsm/keys/deletedKeys/delete")
            }
            Self::MicrosoftKeyVaultManagedHsmSecuritydomainDownloadAction => {
                serializer.serialize_unit_variant("DataAction", 21u32, "Microsoft.KeyVault/managedHsm/securitydomain/download/action")
            }
            Self::MicrosoftKeyVaultManagedHsmSecuritydomainUploadAction => {
                serializer.serialize_unit_variant("DataAction", 22u32, "Microsoft.KeyVault/managedHsm/securitydomain/upload/action")
            }
            Self::MicrosoftKeyVaultManagedHsmSecuritydomainUploadRead => {
                serializer.serialize_unit_variant("DataAction", 23u32, "Microsoft.KeyVault/managedHsm/securitydomain/upload/read")
            }
            Self::MicrosoftKeyVaultManagedHsmSecuritydomainTransferkeyRead => {
                serializer.serialize_unit_variant("DataAction", 24u32, "Microsoft.KeyVault/managedHsm/securitydomain/transferkey/read")
            }
            Self::MicrosoftKeyVaultManagedHsmBackupStartAction => {
                serializer.serialize_unit_variant("DataAction", 25u32, "Microsoft.KeyVault/managedHsm/backup/start/action")
            }
            Self::MicrosoftKeyVaultManagedHsmRestoreStartAction => {
                serializer.serialize_unit_variant("DataAction", 26u32, "Microsoft.KeyVault/managedHsm/restore/start/action")
            }
            Self::MicrosoftKeyVaultManagedHsmBackupStatusAction => {
                serializer.serialize_unit_variant("DataAction", 27u32, "Microsoft.KeyVault/managedHsm/backup/status/action")
            }
            Self::MicrosoftKeyVaultManagedHsmRestoreStatusAction => {
                serializer.serialize_unit_variant("DataAction", 28u32, "Microsoft.KeyVault/managedHsm/restore/status/action")
            }
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
...
impl SecurityDomainCertificateItem {
    pub fn new(value: SecurityDomainJsonWebKey) -> Self {
        Self { value }
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
