        ...
        S: Serializer,
    {
        match self {
            ...
            Self::MicrosoftKeyVaultManagedHsmKeysImportAction => {
                serializer.serialize_unit_variant("DataAction", 21u32, "Microsoft.KeyVault/managedHsm/keys/import/action")
            }
            Self::MicrosoftKeyVaultManagedHsmKeysDeletedKeysDelete => {
                serializer.serialize_unit_variant("DataAction", 22u32, "Microsoft.KeyVault/managedHsm/keys/deletedKeys/delete")
            }
            Self::MicrosoftKeyVaultManagedHsmSecuritydomainDownloadAction => {
                serializer.serialize_unit_variant("DataAction", 23u32, "Microsoft.KeyVault/managedHsm/securitydomain/download/action")
            }
            Self::MicrosoftKeyVaultManagedHsmSecuritydomainUploadAction => {
                serializer.serialize_unit_variant("DataAction", 24u32, "Microsoft.KeyVault/managedHsm/securitydomain/upload/action")
            }
            Self::MicrosoftKeyVaultManagedHsmSecuritydomainUploadRead => {
                serializer.serialize_unit_variant("DataAction", 25u32, "Microsoft.KeyVault/managedHsm/securitydomain/upload/read")
            }
            Self::MicrosoftKeyVaultManagedHsmSecuritydomainTransferkeyRead => {
                serializer.serialize_unit_variant("DataAction", 26u32, "Microsoft.KeyVault/managedHsm/securitydomain/transferkey/read")
            }
            Self::MicrosoftKeyVaultManagedHsmBackupStartAction => {
                serializer.serialize_unit_variant("DataAction", 27u32, "Microsoft.KeyVault/managedHsm/backup/start/action")
            }
            Self::MicrosoftKeyVaultManagedHsmRestoreStartAction => {
                serializer.serialize_unit_variant("DataAction", 28u32, "Microsoft.KeyVault/managedHsm/restore/start/action")
            }
            Self::MicrosoftKeyVaultManagedHsmBackupStatusAction => {
                serializer.serialize_unit_variant("DataAction", 29u32, "Microsoft.KeyVault/managedHsm/backup/status/action")
            }
            Self::MicrosoftKeyVaultManagedHsmRestoreStatusAction => {
                serializer.serialize_unit_variant("DataAction", 30u32, "Microsoft.KeyVault/managedHsm/restore/status/action")
            }
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
