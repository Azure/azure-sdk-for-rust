...
pub mod indexes {
    ...
    impl Client {
        ...
        pub fn list_latest(&self) -> list_latest::RequestBuilder {
            list_latest::RequestBuilder {
                client: self.0.clone(),
                top: None,
                skip: None,
                maxpagesize: None,
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `name`: Name of the index."]
        pub fn get_latest(&self, name: impl Into<String>) -> get_latest::RequestBuilder {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `name`: Name of the index."]
        pub fn get_next_version(&self, name: impl Into<String>) -> get_next_version::RequestBuilder {
            get_next_version::RequestBuilder {
                client: self.0.clone(),
                name: name.into(),
            }
        }
        ...
        #[doc = "Arguments:"]
        #[doc = "* `name`: Name of the index."]
        #[doc = "* `list_view_type`: View type for including/excluding (for example) archived entities."]
        pub fn list(&self, name: impl Into<String>, list_view_type: impl Into<String>) -> list::RequestBuilder {
            list::RequestBuilder {
                client: self.0.clone(),
                name: name.into(),
                list_view_type: list_view_type.into(),
                order_by: None,
                tags: None,
                top: None,
                skip: None,
        ...
        #[doc = "Arguments:"]
        #[doc = "* `name`: Name of the index."]
        #[doc = "* `version`: Version of the index."]
        pub fn get(&self, name: impl Into<String>, version: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                name: name.into(),
        ...
        #[doc = "* `name`: Name of the index."]
        #[doc = "* `version`: Version of the index."]
        #[doc = "* `body`: Properties of an Index Version."]
        pub fn create_or_update(
            &self,
            name: impl Into<String>,
            version: impl Into<String>,
            body: impl Into<models::Index>,
    ...
    pub mod list_latest {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::PagedIndex> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::PagedIndex = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::PagedIndex, azure_core::error::Error> {
    ...
    pub mod get_latest {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::Index> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::Index = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/indexes/{}", &self.name));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-04-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::Index>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::Index>>;
    ...
    pub mod get_next_version {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::VersionInfo> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::VersionInfo = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/indexes/{}:getNextVersion", &self.name));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-04-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::VersionInfo>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::VersionInfo>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) name: String,
            pub(crate) list_view_type: String,
        ...
        impl RequestBuilder {
                    ...
                    async move {
                        ...
                        let rsp = match continuation {
                            ...
                            None => {
                                ...
                                let bearer_token = this.client.bearer_token().await?;
                                req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                                let list_view_type = &this.list_view_type;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/indexes/{}/versions", &self.name));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-04-01-preview");
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/indexes/{}/versions/{}", &self.name, &self.version));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-04-01-preview");
