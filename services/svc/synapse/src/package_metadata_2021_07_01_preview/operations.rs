...
pub mod metastore {
    ...
    pub async fn get_database_operations(
        ...
        id: &str,
    ) -> std::result::Result<MetastoreRequestSuccessResponse, get_database_operations::Error> {
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                ...
                let rsp_value: MetastoreRequestSuccessResponse = serde_json::from_slice(rsp_body)
    ...
    pub async fn register(
        operation_config: &crate::OperationConfig,
        id: &str,
        register_body: &MetastoreRegisterObject,
    ) -> std::result::Result<MetastoreRegistrationResponse, register::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!("{}/metastore/create-database-operations/{}", operation_config.base_path(), id);
        ...
        match rsp.status() {
            http::StatusCode::CREATED => {
                let rsp_body = rsp.body();
                let rsp_value: MetastoreRegistrationResponse =
    ...
    pub async fn update(
        operation_config: &crate::OperationConfig,
        id: &str,
        update_body: &MetastoreUpdateObject,
    ) -> std::result::Result<MetastoreUpdationResponse, update::Error> {
        let http_client = operation_config.http_client();
        ...
        match rsp.status() {
            http::StatusCode::CREATED => {
                let rsp_body = rsp.body();
                let rsp_value: MetastoreUpdationResponse =
