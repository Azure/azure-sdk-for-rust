...
#[doc = "Enumerates possible request statuses."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "Enumerates possible Status of the resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
pub struct MetastoreRegisterObject {
    #[doc = "The input folder containing CDM files."]
    #[serde(rename = "inputFolder")]
    pub input_folder: String,
}
impl MetastoreRegisterObject {
...
impl MetastoreRegistrationResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl MetastoreRequestSuccessResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl MetastoreUpdationResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
