...
impl Client {
    ...
    pub fn link_connection(&self) -> link_connection::Client {
        link_connection::Client(self.clone())
    }
    pub fn linked_service(&self) -> linked_service::Client {
        linked_service::Client(self.clone())
    }
    pub fn metastore(&self) -> metastore::Client {
        metastore::Client(self.clone())
    }
...
pub enum Error {
    #[error(transparent)]
    LinkConnection_ListLinkConnectionsByWorkspace(#[from] link_connection::list_link_connections_by_workspace::Error),
    #[error(transparent)]
    LinkConnection_GetLinkConnection(#[from] link_connection::get_link_connection::Error),
    #[error(transparent)]
    LinkConnection_CreateOrUpdateLinkConnection(#[from] link_connection::create_or_update_link_connection::Error),
    #[error(transparent)]
    LinkConnection_DeleteLinkConnection(#[from] link_connection::delete_link_connection::Error),
    #[error(transparent)]
    LinkConnection_EditTables(#[from] link_connection::edit_tables::Error),
    #[error(transparent)]
    LinkConnection_Start(#[from] link_connection::start::Error),
    #[error(transparent)]
    LinkConnection_Stop(#[from] link_connection::stop::Error),
    #[error(transparent)]
    LinkConnection_GetDetailedStatus(#[from] link_connection::get_detailed_status::Error),
    #[error(transparent)]
    LinkConnection_ListLinkTables(#[from] link_connection::list_link_tables::Error),
    #[error(transparent)]
    LinkConnection_QueryTableStatus(#[from] link_connection::query_table_status::Error),
    #[error(transparent)]
    LinkConnection_UpdateLandingZoneCredential(#[from] link_connection::update_landing_zone_credential::Error),
    #[error(transparent)]
...
pub mod link_connection {
    ...
    impl Client {
        pub fn list_link_connections_by_workspace(&self) -> list_link_connections_by_workspace::Builder {
            list_link_connections_by_workspace::Builder { client: self.0.clone() }
        }
        pub fn get_link_connection(&self, link_connection_name: impl Into<String>) -> get_link_connection::Builder {
            get_link_connection::Builder {
                client: self.0.clone(),
                link_connection_name: link_connection_name.into(),
            }
        }
        pub fn create_or_update_link_connection(
            &self,
            link_connection_name: impl Into<String>,
            link_connection: impl Into<models::LinkConnectionResource>,
        ) -> create_or_update_link_connection::Builder {
            create_or_update_link_connection::Builder {
                client: self.0.clone(),
                link_connection_name: link_connection_name.into(),
                link_connection: link_connection.into(),
            }
        }
        pub fn delete_link_connection(&self, link_connection_name: impl Into<String>) -> delete_link_connection::Builder {
            delete_link_connection::Builder {
                client: self.0.clone(),
                link_connection_name: link_connection_name.into(),
            }
        }
        pub fn edit_tables(
            &self,
            link_connection_name: impl Into<String>,
            edit_tables_request: impl Into<models::EditTablesRequest>,
        ) -> edit_tables::Builder {
            edit_tables::Builder {
                client: self.0.clone(),
                link_connection_name: link_connection_name.into(),
                edit_tables_request: edit_tables_request.into(),
            }
        }
        pub fn start(&self, link_connection_name: impl Into<String>) -> start::Builder {
            start::Builder {
                client: self.0.clone(),
                link_connection_name: link_connection_name.into(),
            }
        }
        pub fn stop(&self, link_connection_name: impl Into<String>) -> stop::Builder {
            stop::Builder {
                client: self.0.clone(),
                link_connection_name: link_connection_name.into(),
            }
        }
        pub fn get_detailed_status(&self, link_connection_name: impl Into<String>) -> get_detailed_status::Builder {
            get_detailed_status::Builder {
                client: self.0.clone(),
                link_connection_name: link_connection_name.into(),
            }
        }
        pub fn list_link_tables(&self, link_connection_name: impl Into<String>) -> list_link_tables::Builder {
            list_link_tables::Builder {
                client: self.0.clone(),
                link_connection_name: link_connection_name.into(),
            }
        }
        pub fn query_table_status(
            &self,
            link_connection_name: impl Into<String>,
            query_table_status_request: impl Into<models::QueryTableStatusRequest>,
        ) -> query_table_status::Builder {
            query_table_status::Builder {
                client: self.0.clone(),
                link_connection_name: link_connection_name.into(),
                query_table_status_request: query_table_status_request.into(),
            }
        }
        pub fn update_landing_zone_credential(
            &self,
            link_connection_name: impl Into<String>,
            update_landing_zone_credential_request: impl Into<models::UpdateLandingZoneCredential>,
        ) -> update_landing_zone_credential::Builder {
            update_landing_zone_credential::Builder {
                client: self.0.clone(),
                link_connection_name: link_connection_name.into(),
                update_landing_zone_credential_request: update_landing_zone_credential_request.into(),
            }
        }
    }
    pub mod list_link_connections_by_workspace {
        use super::models;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
        ...
        impl Builder {
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, std::result::Result<models::LinkConnectionListResponse, Error>> {
                Box::pin(async move {
                    let url_str = &format!("{}/linkconnections", self.client.endpoint(),);
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            ...
                            let rsp_value: models::LinkConnectionListResponse =
    ...
    pub mod get_link_connection {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::LinkConnectionResource, Error>> {
                Box::pin(async move {
                    let url_str = &format!("{}/linkconnections/{}", self.client.endpoint(), &self.link_connection_name);
                    let mut url = url::Url::parse(url_str).map_err(Error::ParseUrl)?;
                    let mut req_builder = http::request::Builder::new();
                    req_builder = req_builder.method(http::Method::GET);
                    let credential = self.client.token_credential();
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                            let rsp_value: models::LinkConnectionResource =
                                serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                            Ok(rsp_value)
                        }
                        status_code => {
    ...
    pub mod create_or_update_link_connection {
        ...
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) link_connection_name: String,
            pub(crate) link_connection: models::LinkConnectionResource,
        }
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::LinkConnectionResource, Error>> {
                Box::pin(async move {
                    ...
                    let req_body = azure_core::to_json(&self.link_connection).map_err(Error::Serialize)?;
                    req_builder = req_builder.uri(url.as_str());
                    let req = req_builder.body(req_body).map_err(Error::BuildRequest)?;
                    let rsp = self.client.send(req).await.map_err(Error::SendRequest)?;
                    let (rsp_status, rsp_headers, rsp_stream) = rsp.deconstruct();
    ...
    pub mod delete_link_connection {
        use super::models;
        #[derive(Debug)]
        pub enum Response {
            Ok200,
    ...
    pub mod edit_tables {
        ...
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) link_connection_name: String,
            pub(crate) edit_tables_request: models::EditTablesRequest,
        }
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<(), Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/linkconnections/{}/edittables",
                        self.client.endpoint(),
                        &self.link_connection_name
                    );
                    let mut url = url::Url::parse(url_str).map_err(Error::ParseUrl)?;
                    let mut req_builder = http::request::Builder::new();
                    ...
                    url.query_pairs_mut().append_pair("api-version", "2021-12-01-preview");
                    req_builder = req_builder.header("content-type", "application/json");
                    let req_body = azure_core::to_json(&self.edit_tables_request).map_err(Error::Serialize)?;
                    req_builder = req_builder.uri(url.as_str());
                    let req = req_builder.body(req_body).map_err(Error::BuildRequest)?;
                    let rsp = self.client.send(req).await.map_err(Error::SendRequest)?;
                    let (rsp_status, rsp_headers, rsp_stream) = rsp.deconstruct();
    ...
    pub mod start {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<(), Error>> {
                Box::pin(async move {
                    let url_str = &format!("{}/linkconnections/{}/start", self.client.endpoint(), &self.link_connection_name);
                    let mut url = url::Url::parse(url_str).map_err(Error::ParseUrl)?;
                    let mut req_builder = http::request::Builder::new();
                    req_builder = req_builder.method(http::Method::POST);
                    let credential = self.client.token_credential();
    ...
    pub mod stop {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<(), Error>> {
                Box::pin(async move {
                    let url_str = &format!("{}/linkconnections/{}/stop", self.client.endpoint(), &self.link_connection_name);
                    let mut url = url::Url::parse(url_str).map_err(Error::ParseUrl)?;
                    let mut req_builder = http::request::Builder::new();
                    req_builder = req_builder.method(http::Method::POST);
                    let credential = self.client.token_credential();
    ...
    pub mod get_detailed_status {
        ...
        impl Builder {
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, std::result::Result<models::LinkConnectionDetailedStatus, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/linkconnections/{}/detailedstatus",
                        self.client.endpoint(),
                        &self.link_connection_name
                    );
                    let mut url = url::Url::parse(url_str).map_err(Error::ParseUrl)?;
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                            let rsp_value: models::LinkConnectionDetailedStatus =
                                serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                            Ok(rsp_value)
                        }
                        status_code => {
    ...
    pub mod list_link_tables {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::LinkTableListResponse, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/linkconnections/{}/linktables",
                        self.client.endpoint(),
                        &self.link_connection_name
                    );
                    let mut url = url::Url::parse(url_str).map_err(Error::ParseUrl)?;
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                            let rsp_value: models::LinkTableListResponse =
                                serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                            Ok(rsp_value)
                        }
                        status_code => {
    ...
    pub mod query_table_status {
        ...
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) link_connection_name: String,
            pub(crate) query_table_status_request: models::QueryTableStatusRequest,
        }
        impl Builder {
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, std::result::Result<models::LinkConnectionQueryTableStatus, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/linkconnections/{}/querytablestatus",
                        self.client.endpoint(),
                        &self.link_connection_name
                    );
                    let mut url = url::Url::parse(url_str).map_err(Error::ParseUrl)?;
                    ...
                    url.query_pairs_mut().append_pair("api-version", "2021-12-01-preview");
                    req_builder = req_builder.header("content-type", "application/json");
                    let req_body = azure_core::to_json(&self.query_table_status_request).map_err(Error::Serialize)?;
                    req_builder = req_builder.uri(url.as_str());
                    let req = req_builder.body(req_body).map_err(Error::BuildRequest)?;
                    let rsp = self.client.send(req).await.map_err(Error::SendRequest)?;
                    let (rsp_status, rsp_headers, rsp_stream) = rsp.deconstruct();
                    match rsp_status {
                        http::StatusCode::OK => {
                            let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                            let rsp_value: models::LinkConnectionQueryTableStatus =
                                serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                            Ok(rsp_value)
                        }
                        status_code => {
    ...
    pub mod update_landing_zone_credential {
        use super::models;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
        ...
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) link_connection_name: String,
            pub(crate) update_landing_zone_credential_request: models::UpdateLandingZoneCredential,
        }
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<(), Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/linkconnections/{}/updateLandingZoneCredential",
                        self.client.endpoint(),
                        &self.link_connection_name
                    );
                    let mut url = url::Url::parse(url_str).map_err(Error::ParseUrl)?;
                    ...
                    url.query_pairs_mut().append_pair("api-version", "2021-12-01-preview");
                    req_builder = req_builder.header("content-type", "application/json");
                    let req_body = azure_core::to_json(&self.update_landing_zone_credential_request).map_err(Error::Serialize)?;
                    req_builder = req_builder.uri(url.as_str());
                    let req = req_builder.body(req_body).map_err(Error::BuildRequest)?;
                    let rsp = self.client.send(req).await.map_err(Error::SendRequest)?;
                    let (rsp_status, rsp_headers, rsp_stream) = rsp.deconstruct();
...
pub mod metastore {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        pub fn get_database_operations(&self, id: impl Into<String>) -> get_database_operations::Builder {
            get_database_operations::Builder {
                client: self.0.clone(),
                id: id.into(),
            }
        }
        pub fn register(&self, id: impl Into<String>, register_body: impl Into<models::MetastoreRegisterObject>) -> register::Builder {
            register::Builder {
                client: self.0.clone(),
                id: id.into(),
                register_body: register_body.into(),
            }
        }
        pub fn update(&self, id: impl Into<String>, update_body: impl Into<models::MetastoreUpdateObject>) -> update::Builder {
            update::Builder {
                client: self.0.clone(),
                id: id.into(),
                update_body: update_body.into(),
            }
        }
    ...
    pub mod get_database_operations {
        ...
        impl Builder {
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, std::result::Result<models::MetastoreRequestSuccessResponse, Error>> {
                Box::pin(async move {
                    let url_str = &format!("{}/metastore/create-database-operations/{}", self.client.endpoint(), &self.id);
                    let mut url = url::Url::parse(url_str).map_err(Error::ParseUrl)?;
                    let mut req_builder = http::request::Builder::new();
                    req_builder = req_builder.method(http::Method::GET);
                    let credential = self.client.token_credential();
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                            let rsp_value: models::MetastoreRequestSuccessResponse =
                                serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                            Ok(rsp_value)
                        }
                        status_code => {
    ...
    pub mod register {
        ...
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) id: String,
            pub(crate) register_body: models::MetastoreRegisterObject,
        }
        impl Builder {
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, std::result::Result<models::MetastoreRegistrationResponse, Error>> {
                Box::pin(async move {
                    let url_str = &format!("{}/metastore/create-database-operations/{}", self.client.endpoint(), &self.id);
                    let mut url = url::Url::parse(url_str).map_err(Error::ParseUrl)?;
                    let mut req_builder = http::request::Builder::new();
                    ...
                    url.query_pairs_mut().append_pair("api-version", "2021-07-01-preview");
                    req_builder = req_builder.header("content-type", "application/json");
                    let req_body = azure_core::to_json(&self.register_body).map_err(Error::Serialize)?;
                    req_builder = req_builder.uri(url.as_str());
                    let req = req_builder.body(req_body).map_err(Error::BuildRequest)?;
                    let rsp = self.client.send(req).await.map_err(Error::SendRequest)?;
                    let (rsp_status, rsp_headers, rsp_stream) = rsp.deconstruct();
    ...
    pub mod update {
        ...
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) id: String,
            pub(crate) update_body: models::MetastoreUpdateObject,
        }
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::MetastoreUpdationResponse, Error>> {
                Box::pin(async move {
                    let url_str = &format!("{}/metastore/update-database-operations/{}", self.client.endpoint(), &self.id);
                    let mut url = url::Url::parse(url_str).map_err(Error::ParseUrl)?;
                    let mut req_builder = http::request::Builder::new();
                    req_builder = req_builder.method(http::Method::PUT);
                    let credential = self.client.token_credential();
                    ...
                    url.query_pairs_mut().append_pair("api-version", "2021-07-01-preview");
                    req_builder = req_builder.header("content-type", "application/json");
                    let req_body = azure_core::to_json(&self.update_body).map_err(Error::Serialize)?;
                    req_builder = req_builder.uri(url.as_str());
                    let req = req_builder.body(req_body).map_err(Error::BuildRequest)?;
                    let rsp = self.client.send(req).await.map_err(Error::SendRequest)?;
                    let (rsp_status, rsp_headers, rsp_stream) = rsp.deconstruct();
    ...
    pub mod delete {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<(), Error>> {
                Box::pin(async move {
                    let url_str = &format!("{}/metastore/databases/{}", self.client.endpoint(), &self.id);
                    let mut url = url::Url::parse(url_str).map_err(Error::ParseUrl)?;
                    let mut req_builder = http::request::Builder::new();
                    req_builder = req_builder.method(http::Method::DELETE);
                    let credential = self.client.token_credential();
