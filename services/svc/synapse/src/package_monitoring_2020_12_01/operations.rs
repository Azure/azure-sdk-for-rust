...
pub mod monitoring {
    ...
    pub mod get_spark_job_list {
        use super::models;
        type Response = models::SparkJobListViewResponse;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
        ...
        impl Builder {
            ...
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<Response, Error>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url_str = &format!("{}/monitoring/workloadTypes/spark/Applications", this.client.endpoint(),);
    ...
    pub mod get_sql_job_query_string {
        use super::models;
        type Response = models::SqlQueryStringDataModel;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("Unexpected HTTP status code {}", status_code)]
            UnexpectedResponse { status_code: http::StatusCode, body: bytes::Bytes },
        ...
        impl Builder {
            ...
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<Response, Error>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url_str = &format!("{}/monitoring/workloadTypes/sql/querystring", this.client.endpoint(),);
                        let mut url = url::Url::parse(url_str).map_err(Error::ParseUrl)?;
                        let mut req_builder = http::request::Builder::new();
                        req_builder = req_builder.method(http::Method::GET);
                        let credential = this.client.token_credential();
