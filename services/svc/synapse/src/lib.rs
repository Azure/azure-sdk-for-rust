...
#[cfg(all(feature = "package-artifacts-2021-07-01-preview", not(feature = "no-default-version")))]
pub use package_artifacts_2021_07_01_preview::{models, operations, operations::Error};
...
pub use package_artifacts_composite_v1::{models, operations, operations::Error};
...
pub use package_artifacts_2021_06_01_preview::{models, operations, operations::Error};
...
pub use package_vnet_2021_06_01_preview::{models, operations, operations::Error};
...
pub use package_kql_script_2021_06_preview::{models, operations, operations::Error};
...
pub use package_artifacts_composite_v2::{models, operations, operations::Error};
...
pub use package_artifacts_2020_12_01::{models, operations, operations::Error};
...
pub use package_monitoring_2020_12_01::{models, operations, operations::Error};
...
pub use package_access_control_2020_12_01::{models, operations, operations::Error};
...
pub use package_vnet_2020_12_01::{models, operations, operations::Error};
...
pub use package_spark_2020_12_01::{models, operations, operations::Error};
...
pub use package_spark_2019_11_01_preview::{models, operations, operations::Error};
...
pub use package_artifacts_2019_06_01_preview::{models, operations, operations::Error};
...
pub use package_access_control_2020_02_01_preview::{models, operations, operations::Error};
...
pub use package_access_control_2020_08_01_preview::{models, operations, operations::Error};
...
pub use package_vnet_2019_06_01_preview::{models, operations, operations::Error};
...
pub use package_monitoring_2019_11_01_preview::{models, operations, operations::Error};
pub fn config(
