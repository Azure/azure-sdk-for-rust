                        ...
                        let rsp = match continuation {
                            Some(value) => {
                                ...
                                if !has_api_version_already {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair(azure_core::query_param::API_VERSION, "2024-07-01.20.0");
                                }
...
pub mod pool {
    ...
    pub mod list_usage_metrics {
        ...
        impl RequestBuilder {
            ...
            #[doc = "An OData $filter clause. For more information on constructing this filter, see https://docs.microsoft.com/rest/api/batchservice/odata-filters-in-batch#list-account-usage-metrics."]
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            #[doc = "An OData $filter clause. For more information on constructing this filter, see https://docs.microsoft.com/rest/api/batchservice/odata-filters-in-batch#list-pools."]
            pub fn filter(mut self, filter: impl Into<String>) -> Self {
                self.filter = Some(filter.into());
                self
            }
...
pub mod account {
    ...
    pub mod list_supported_images {
        ...
        impl RequestBuilder {
            #[doc = "An OData $filter clause. For more information on constructing this filter, see https://docs.microsoft.com/rest/api/batchservice/odata-filters-in-batch#list-support-images."]
            pub fn filter(mut self, filter: impl Into<String>) -> Self {
                self.filter = Some(filter.into());
                self
            }
    ...
    pub mod list_pool_node_counts {
        ...
        impl RequestBuilder {
            #[doc = "An OData $filter clause. For more information on constructing this filter, see https://docs.microsoft.com/rest/api/batchservice/odata-filters-in-batch."]
            pub fn filter(mut self, filter: impl Into<String>) -> Self {
                self.filter = Some(filter.into());
                self
            }
...
pub mod certificate {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            #[doc = "An OData $filter clause. For more information on constructing this filter, see https://docs.microsoft.com/rest/api/batchservice/odata-filters-in-batch#list-certificates."]
            pub fn filter(mut self, filter: impl Into<String>) -> Self {
                self.filter = Some(filter.into());
                self
            }
...
pub mod file {
    ...
    pub mod list_from_task {
        ...
        impl RequestBuilder {
            #[doc = "An OData $filter clause. For more information on constructing this filter, see https://docs.microsoft.com/rest/api/batchservice/odata-filters-in-batch#list-task-files."]
            pub fn filter(mut self, filter: impl Into<String>) -> Self {
                self.filter = Some(filter.into());
                self
            }
    ...
    pub mod list_from_compute_node {
        ...
        impl RequestBuilder {
            #[doc = "An OData $filter clause. For more information on constructing this filter, see https://docs.microsoft.com/rest/api/batchservice/odata-filters-in-batch#list-compute-node-files."]
            pub fn filter(mut self, filter: impl Into<String>) -> Self {
                self.filter = Some(filter.into());
                self
            }
...
pub mod job_schedule {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            #[doc = "An OData $filter clause. For more information on constructing this filter, see https://docs.microsoft.com/rest/api/batchservice/odata-filters-in-batch#list-job-schedules."]
            pub fn filter(mut self, filter: impl Into<String>) -> Self {
                self.filter = Some(filter.into());
                self
            }
...
pub mod job {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            #[doc = "An OData $filter clause. For more information on constructing this filter, see https://docs.microsoft.com/rest/api/batchservice/odata-filters-in-batch#list-jobs."]
            pub fn filter(mut self, filter: impl Into<String>) -> Self {
                self.filter = Some(filter.into());
                self
            }
    ...
    pub mod list_from_job_schedule {
        ...
        impl RequestBuilder {
            #[doc = "An OData $filter clause. For more information on constructing this filter, see https://docs.microsoft.com/rest/api/batchservice/odata-filters-in-batch#list-jobs-in-a-job-schedule."]
            pub fn filter(mut self, filter: impl Into<String>) -> Self {
                self.filter = Some(filter.into());
                self
            }
    ...
    pub mod list_preparation_and_release_task_status {
        ...
        impl RequestBuilder {
            #[doc = "An OData $filter clause. For more information on constructing this filter, see https://docs.microsoft.com/rest/api/batchservice/odata-filters-in-batch#list-job-preparation-and-release-status."]
            pub fn filter(mut self, filter: impl Into<String>) -> Self {
                self.filter = Some(filter.into());
                self
            }
...
pub mod task {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            #[doc = "An OData $filter clause. For more information on constructing this filter, see https://docs.microsoft.com/rest/api/batchservice/odata-filters-in-batch#list-tasks."]
            pub fn filter(mut self, filter: impl Into<String>) -> Self {
                self.filter = Some(filter.into());
                self
            }
...
pub mod compute_node {
    ...
    impl Client {
        ...
        #[doc = "You can reinstall the operating system on a Compute Node only if it is in an idle or running state."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `pool_id`: The ID of the Pool that contains the Compute Node."]
        #[doc = "* `node_id`: The ID of the Compute Node that you want to restart."]
        ...
        #[doc = "Starts the specified Compute Node."]
        #[doc = "You can start a Compute Node only if it has been deallocated"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `pool_id`: The ID of the Pool that contains the Compute Node."]
        #[doc = "* `node_id`: The ID of the Compute Node that you want to start."]
        pub fn start(&self, pool_id: impl Into<String>, node_id: impl Into<String>) -> start::RequestBuilder {
        ...
        #[doc = "Deallocates the specified Compute Node."]
        #[doc = "You can deallocate a Compute Node only if it is in an idle or running state."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `pool_id`: The ID of the Pool that contains the Compute Node."]
        #[doc = "* `node_id`: The ID of the Compute Node that you want to deallocate."]
        pub fn deallocate(&self, pool_id: impl Into<String>, node_id: impl Into<String>) -> deallocate::RequestBuilder {
            deallocate::RequestBuilder {
                client: self.0.clone(),
                pool_id: pool_id.into(),
                node_id: node_id.into(),
                node_deallocate_parameter: None,
                timeout: None,
                client_request_id: None,
                return_client_request_id: None,
                ocp_date: None,
        ...
        #[doc = "Before you can remotely login to a Compute Node using the remote login settings, you must create a user Account on the Compute Node."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `pool_id`: The ID of the Pool that contains the Compute Node."]
    ...
    pub mod start {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/pools/{}/nodes/{}/start", &self.pool_id, &self.node_id));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-07-01.20.0");
    ...
    pub mod deallocate {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) pool_id: String,
            pub(crate) node_id: String,
            pub(crate) node_deallocate_parameter: Option<models::NodeDeallocateParameter>,
            pub(crate) timeout: Option<i32>,
            pub(crate) client_request_id: Option<String>,
            pub(crate) return_client_request_id: Option<bool>,
            pub(crate) ocp_date: Option<::time::OffsetDateTime>,
        ...
        impl RequestBuilder {
            #[doc = "The parameters for the request."]
            pub fn node_deallocate_parameter(mut self, node_deallocate_parameter: impl Into<models::NodeDeallocateParameter>) -> Self {
                self.node_deallocate_parameter = Some(node_deallocate_parameter.into());
                self
            }
            #[doc = "The maximum time that the server can spend processing the request, in seconds. The default is 30 seconds. If the value is larger than 30, the default will be used instead."]
            pub fn timeout(mut self, timeout: i32) -> Self {
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        let bearer_token = this.client.bearer_token().await?;
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        let req_body = if let Some(node_deallocate_parameter) = &this.node_deallocate_parameter {
                            req.insert_header("content-type", "application/json; odata=minimalmetadata");
                            azure_core::to_json(node_deallocate_parameter)?
                        } else {
                            azure_core::EMPTY_BODY
                        };
                        if let Some(timeout) = &this.timeout {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/pools/{}/nodes/{}/deallocate", &self.pool_id, &self.node_id));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-07-01.20.0");
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            #[doc = "An OData $filter clause. For more information on constructing this filter, see https://docs.microsoft.com/rest/api/batchservice/odata-filters-in-batch#list-nodes-in-a-pool."]
            pub fn filter(mut self, filter: impl Into<String>) -> Self {
                self.filter = Some(filter.into());
                self
            }
