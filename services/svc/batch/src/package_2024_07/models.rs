...
pub struct CertificateReference {
    ...
    #[serde(rename = "thumbprintAlgorithm")]
    pub thumbprint_algorithm: String,
    #[doc = "The default value is currentuser. This property is applicable only for Pools configured with Windows Compute Nodes. For Linux Compute Nodes, the Certificates are stored in a directory inside the Task working directory and an environment variable AZ_BATCH_CERTIFICATES_DIR is supplied to the Task to query for this location. For Certificates with visibility of 'remoteUser', a 'certs' directory is created in the user's home directory (e.g., /home/{user-name}/certs) and Certificates are placed in that directory."]
    #[serde(
    ...
    #[doc = "This property is applicable only for Pools configured with Windows Compute Nodes. Common store names include: My, Root, CA, Trust, Disallowed, TrustedPeople, TrustedPublisher, AuthRoot, AddressBook, but any custom store name can also be used. The default value is My."]
...
pub struct ComputeNodeUser {
    ...
    #[doc = "The password is required for Windows Compute Nodes. For Linux Compute Nodes, the password can optionally be specified along with the sshPublicKey property."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub password: Option<String>,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ContainerHostBatchBindMountEntry {
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        deserialize_with = "case_insensitive_deserialize"
    )]
    pub source: Option<ContainerHostDataPath>,
    #[doc = "For Linux, if you mount this path as a read/write mode, this does not mean that all users in container have the read/write access for the path, it depends on the access in host VM. If this path is mounted read-only, all users within the container will not be able to modify the path."]
    #[serde(rename = "isReadOnly", default, skip_serializing_if = "Option::is_none")]
    pub is_read_only: Option<bool>,
}
impl ContainerHostBatchBindMountEntry {
    pub fn new() -> Self {
        Self::default()
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ContainerHostDataPath")]
pub enum ContainerHostDataPath {
    Shared,
    Startup,
    VfsMounts,
    Task,
...
impl FromStr for ContainerHostDataPath {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for ContainerHostDataPath {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for ContainerHostDataPath {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Shared => serializer.serialize_unit_variant("ContainerHostDataPath", 0u32, "Shared"),
            Self::Startup => serializer.serialize_unit_variant("ContainerHostDataPath", 1u32, "Startup"),
            Self::VfsMounts => serializer.serialize_unit_variant("ContainerHostDataPath", 2u32, "VfsMounts"),
            Self::Task => serializer.serialize_unit_variant("ContainerHostDataPath", 3u32, "Task"),
            Self::JobPrep => serializer.serialize_unit_variant("ContainerHostDataPath", 4u32, "JobPrep"),
            Self::Applications => serializer.serialize_unit_variant("ContainerHostDataPath", 5u32, "Applications"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct DiskEncryptionConfiguration {
    #[doc = "The list of disk targets Batch Service will encrypt on the compute node."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
pub struct ImageReference {
    ...
    #[doc = "This property is mutually exclusive with other properties and can be fetched from shared gallery image GET call."]
    #[serde(rename = "sharedGalleryImageId", default, skip_serializing_if = "Option::is_none")]
    pub shared_gallery_image_id: Option<String>,
    #[doc = "This property is mutually exclusive with other properties and can be fetched from community gallery image GET call."]
...
pub struct JobNetworkConfiguration {
    ...
    #[doc = "If true, nodes will remain joined to the virtual network to DNC. If false, nodes will automatically withdraw when the job ends. Defaults to false."]
    #[serde(rename = "skipWithdrawFromVNet", default, skip_serializing_if = "Option::is_none")]
    pub skip_withdraw_from_v_net: Option<bool>,
}
impl JobNetworkConfiguration {
    pub fn new(subnet_id: String) -> Self {
        Self {
            subnet_id,
            skip_withdraw_from_v_net: None,
        }
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct ManagedDisk {
    ...
    pub storage_account_type: Option<StorageAccountType>,
    #[doc = "Specifies the security profile settings for the managed disk. **Note**: It can only be set for Confidential VMs and required when using Confidential VMs."]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NodeDeallocateParameter {
    #[doc = "The default value is requeue."]
    #[serde(
        rename = "nodeDeallocateOption",
        default,
        skip_serializing_if = "Option::is_none",
        deserialize_with = "case_insensitive_deserialize"
    )]
    pub node_deallocate_option: Option<node_deallocate_parameter::NodeDeallocateOption>,
}
impl NodeDeallocateParameter {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod node_deallocate_parameter {
    use super::*;
    #[doc = "The default value is requeue."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum NodeDeallocateOption {
        #[serde(rename = "requeue")]
        Requeue,
        #[serde(rename = "terminate")]
        Terminate,
...
pub struct NodeUpdateUserParameter {
    #[doc = "The password is required for Windows Compute Nodes. For Linux Compute Nodes, the password can optionally be specified along with the sshPublicKey property. If omitted, any existing password is removed."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub password: Option<String>,
    #[doc = "If omitted, the default is 1 day from the current time. For Linux Compute Nodes, the expiryTime has a precision up to a day."]
    #[serde(rename = "expiryTime", default, with = "azure_core::date::rfc3339::option")]
...
pub struct OutputFileBlobContainerDestination {
    ...
    #[serde(rename = "identityReference", default, skip_serializing_if = "Option::is_none")]
    pub identity_reference: Option<ComputeNodeIdentityReference>,
    #[doc = "These headers will be specified when uploading files to Azure Storage. Official document on allowed headers when uploading blobs: https://docs.microsoft.com/rest/api/storageservices/put-blob#request-headers-all-blob-types"]
    #[serde(
...
pub struct PoolAddParameter {
    ...
    #[serde(rename = "displayName", default, skip_serializing_if = "Option::is_none")]
    pub display_name: Option<String>,
    #[doc = "For information about available VM sizes, see Sizes for Virtual Machines (Linux) (https://azure.microsoft.com/documentation/articles/virtual-machines-linux-sizes/) or Sizes for Virtual Machines (Windows) (https://azure.microsoft.com/documentation/articles/virtual-machines-windows-sizes/). Batch supports all Azure VM sizes except STANDARD_A0 and those with premium storage (STANDARD_GS, STANDARD_DS, and STANDARD_DSV2 series)."]
    #[serde(rename = "vmSize")]
    pub vm_size: String,
    #[serde(rename = "virtualMachineConfiguration", default, skip_serializing_if = "Option::is_none")]
    pub virtual_machine_configuration: Option<VirtualMachineConfiguration>,
...
pub struct PoolPatchParameter {
    ...
    pub target_node_communication_mode: Option<NodeCommunicationMode>,
    #[doc = "The display name need not be unique and can contain any Unicode characters up to a maximum length of 1024.<br /><br />This field can be updated only when the pool is empty."]
    #[serde(rename = "displayName", default, skip_serializing_if = "Option::is_none")]
    pub display_name: Option<String>,
    #[doc = "For information about available sizes of virtual machines in Pools, see Choose a VM size for Compute Nodes in an Azure Batch Pool (https://docs.microsoft.com/azure/batch/batch-pool-vm-sizes).<br /><br />This field can be updated only when the pool is empty."]
    #[serde(rename = "vmSize", default, skip_serializing_if = "Option::is_none")]
    pub vm_size: Option<String>,
    #[doc = "The default value is 1. The maximum value is the smaller of 4 times the number of cores of the vmSize of the pool or 256.<br /><br />This field can be updated only when the pool is empty."]
    #[serde(rename = "taskSlotsPerNode", default, skip_serializing_if = "Option::is_none")]
    pub task_slots_per_node: Option<i32>,
    #[serde(rename = "taskSchedulingPolicy", default, skip_serializing_if = "Option::is_none")]
    pub task_scheduling_policy: Option<TaskSchedulingPolicy>,
    #[doc = "Enabling inter-node communication limits the maximum size of the Pool due to deployment restrictions on the Compute Nodes of the Pool. This may result in the Pool not reaching its desired size. The default value is false.<br /><br />This field can be updated only when the pool is empty."]
    #[serde(rename = "enableInterNodeCommunication", default, skip_serializing_if = "Option::is_none")]
    pub enable_inter_node_communication: Option<bool>,
    #[serde(rename = "virtualMachineConfiguration", default, skip_serializing_if = "Option::is_none")]
    pub virtual_machine_configuration: Option<VirtualMachineConfiguration>,
    ...
    #[serde(rename = "networkConfiguration", default, skip_serializing_if = "Option::is_none")]
    pub network_configuration: Option<NetworkConfiguration>,
    #[doc = "This field can be updated only when the pool is empty."]
    #[serde(
        rename = "userAccounts",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub user_accounts: Vec<UserAccount>,
    #[doc = "Mount the storage using Azure fileshare, NFS, CIFS or Blobfuse based file system.<br /><br />This field can be updated only when the pool is empty."]
    #[serde(
        rename = "mountConfiguration",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    #[serde(rename = "upgradePolicy", default, skip_serializing_if = "Option::is_none")]
    pub upgrade_policy: Option<UpgradePolicy>,
    #[doc = "The user-defined tags to be associated with the Azure Batch Pool. When specified, these tags are propagated to the backing Azure resources associated with the pool. This property can only be specified when the Batch account was created with the poolAllocationMode property set to 'UserSubscription'.<br /><br />This field can be updated only when the pool is empty."]
    #[serde(rename = "resourceTags", default, skip_serializing_if = "Option::is_none")]
    pub resource_tags: Option<serde_json::Value>,
}
...
pub mod security_profile {
    ...
    pub enum SecurityType {
        ...
        TrustedLaunch,
        #[serde(rename = "confidentialVM", alias = "confidentialvm")]
        ConfidentialVm,
    }
}
...
pub struct TaskContainerSettings {
    ...
    #[doc = "If this array is null or be not present, container task will mount entire temporary disk drive in windows (or AZ_BATCH_NODE_ROOT_DIR in Linux). It won't' mount any data paths into container if this array is set as empty."]
    #[serde(
        rename = "containerHostBatchBindMounts",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub container_host_batch_bind_mounts: Vec<ContainerHostBatchBindMountEntry>,
}
impl TaskContainerSettings {
    pub fn new(image_name: String) -> Self {
        Self {
            ...
            container_host_batch_bind_mounts: Vec::new(),
        }
    }
}
...
pub mod vm_disk_security_profile {
    ...
    pub enum SecurityEncryptionType {
        #[serde(rename = "NonPersistedTPM", alias = "nonpersistedtpm")]
        NonPersistedTpm,
        #[serde(rename = "VMGuestStateOnly", alias = "vmgueststateonly")]
        VmGuestStateOnly,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    ...
    impl Serialize for SecurityEncryptionType {
        ...
        {
            match self {
                Self::NonPersistedTpm => serializer.serialize_unit_variant("SecurityEncryptionType", 0u32, "NonPersistedTPM"),
                Self::VmGuestStateOnly => serializer.serialize_unit_variant("SecurityEncryptionType", 1u32, "VMGuestStateOnly"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
