...
pub struct ApplicationPackageReference {
    #[doc = "When creating a pool, the package's application ID must be fully qualified (/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Batch/batchAccounts/{accountName}/applications/{applicationName})."]
...
pub struct CloudJob {
    ...
    #[doc = "If the value is set to True, other high priority jobs submitted to the system will take precedence and will be able requeue tasks from this job. You can update a job's allowTaskPreemption after it has been created using the update job API."]
    #[serde(rename = "allowTaskPreemption", default, skip_serializing_if = "Option::is_none")]
    pub allow_task_preemption: Option<bool>,
...
pub struct CloudPool {
    ...
    #[doc = "Spot/Low-priority Compute Nodes which have been preempted are included in this count."]
    ...
    #[serde(
        rename = "targetNodeCommunicationMode",
        default,
        skip_serializing_if = "Option::is_none",
        deserialize_with = "case_insensitive_deserialize"
    )]
    ...
    #[serde(
        rename = "currentNodeCommunicationMode",
        default,
        skip_serializing_if = "Option::is_none",
        deserialize_with = "case_insensitive_deserialize"
    )]
...
pub mod container_configuration {
    ...
    pub enum Type {
        ...
        DockerCompatible,
        #[serde(rename = "criCompatible", alias = "cricompatible")]
        CriCompatible,
...
#[doc = "The disk encryption configuration applied on compute nodes in the pool. Disk encryption configuration is not supported on Linux pool created with Azure Compute Gallery Image."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct ImageReference {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub version: Option<String>,
    #[doc = "This property is mutually exclusive with other ImageReference properties. The Azure Compute Gallery Image must have replicas in the same region and must be in the same subscription as the Azure Batch account. If the image version is not specified in the imageId, the latest version will be used. For information about the firewall settings for the Batch Compute Node agent to communicate with the Batch service see https://docs.microsoft.com/en-us/azure/batch/batch-api-basics#virtual-network-vnet-and-firewall-configuration."]
...
pub struct OutputFileBlobContainerDestination {
    ...
    #[serde(rename = "identityReference", default, skip_serializing_if = "Option::is_none")]
    pub identity_reference: Option<ComputeNodeIdentityReference>,
    #[doc = "These headers will be specified when uploading files to Azure Storage. Official document on allowed headers when uploading blobs: https://docs.microsoft.com/en-us/rest/api/storageservices/put-blob#request-headers-all-blob-types"]
    #[serde(
...
pub struct PoolAddParameter {
    ...
    pub certificate_references: Vec<CertificateReference>,
    #[doc = "When creating a pool, the package's application ID must be fully qualified (/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Batch/batchAccounts/{accountName}/applications/{applicationName}). Changes to Package references affect all new Nodes joining the Pool, but do not affect Compute Nodes that are already in the Pool until they are rebooted or reimaged. There is a maximum of 10 Package references on any given Pool."]
    #[serde(
        rename = "applicationPackageReferences",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
...
pub mod security_profile {
    ...
    pub enum SecurityType {
        #[serde(rename = "trustedLaunch", alias = "trustedlaunch")]
        TrustedLaunch,
    }
}
...
impl UpgradePolicy {
    pub fn new(mode: upgrade_policy::Mode) -> Self {
        Self {
            mode,
...
pub struct VirtualMachineInfo {
    ...
    #[serde(rename = "scaleSetVmResourceId", default, skip_serializing_if = "Option::is_none")]
    pub scale_set_vm_resource_id: Option<String>,
}
