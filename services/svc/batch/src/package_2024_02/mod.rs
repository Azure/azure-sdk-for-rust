...
pub mod application {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            #[doc = "The maximum time that the server can spend processing the request, in seconds. The default is 30 seconds. If the value is larger than 30, the default will be used instead."]
                        ...
                        let rsp = match continuation {
                            Some(value) => {
                                ...
                                if !has_api_version_already {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair(azure_core::query_param::API_VERSION, "2024-02-01.19.0");
                                }
...
pub mod task {
    ...
    pub mod add_collection {
        ...
        impl RequestBuilder {
            #[doc = "The maximum time that the server can spend processing the request, in seconds. The default is 2 minutes. If the value is larger than 120, the default will be used instead."]
            pub fn timeout(mut self, timeout: i32) -> Self {
                self.timeout = Some(timeout);
                self
            }
