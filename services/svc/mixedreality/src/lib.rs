...
#[cfg(all(feature = "package-0_3-preview_0", not(feature = "no-default-version")))]
...
#[cfg(all(feature = "package-0_2-preview_1", not(feature = "no-default-version")))]
...
#[cfg(all(feature = "package-0_2-preview_0", not(feature = "no-default-version")))]
