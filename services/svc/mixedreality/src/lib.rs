...
pub use package_0_2_preview_1::{models, operations, operations::Error};
...
pub use package_0_2_preview_0::{models, operations, operations::Error};
...
pub use package_2019_02_28_preview::{models, operations, operations::Error};
pub fn config(
