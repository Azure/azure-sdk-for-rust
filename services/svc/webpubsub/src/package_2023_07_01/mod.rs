...
pub mod web_pub_sub {
    ...
    impl Client {
        ...
        #[doc = "* `groups_to_add`: Target groups and connection filter."]
        pub fn add_connections_to_groups(
            &self,
            hub: impl Into<String>,
            groups_to_add: impl Into<models::AddToGroupsRequest>,
        ) -> add_connections_to_groups::RequestBuilder {
            add_connections_to_groups::RequestBuilder {
                client: self.0.clone(),
                hub: hub.into(),
                groups_to_add: groups_to_add.into(),
            }
        }
        ...
        #[doc = "Arguments:"]
        #[doc = "* `hub`: Target hub name, which should start with alphabetic characters and only contain alpha-numeric characters or underscore."]
        #[doc = "* `groups_to_remove`: Target groups and connection filter."]
        pub fn remove_connections_from_groups(
            &self,
            hub: impl Into<String>,
            groups_to_remove: impl Into<models::RemoveFromGroupsRequest>,
        ) -> remove_connections_from_groups::RequestBuilder {
            remove_connections_from_groups::RequestBuilder {
                client: self.0.clone(),
                hub: hub.into(),
                groups_to_remove: groups_to_remove.into(),
            }
        }
        ...
        #[doc = "* `hub`: Target hub name, which should start with alphabetic characters and only contain alpha-numeric characters or underscore."]
        #[doc = "* `connection_id`: Target connection Id."]
        pub fn remove_connection_from_all_groups(
            &self,
            hub: impl Into<String>,
            connection_id: impl Into<String>,
        ) -> remove_connection_from_all_groups::RequestBuilder {
            remove_connection_from_all_groups::RequestBuilder {
                client: self.0.clone(),
                hub: hub.into(),
                connection_id: connection_id.into(),
    ...
    pub mod add_connections_to_groups {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) groups_to_add: models::AddToGroupsRequest,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        let req_body = azure_core::to_json(&this.groups_to_add)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/api/hubs/{}/:addToGroups", self.client.endpoint(), &self.hub))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01");
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        for value in &this.group {
                            req.url_mut().query_pairs_mut().append_pair("group", &value.to_string());
                        }
                        let req_body = azure_core::EMPTY_BODY;
                        req.insert_header(azure_core::headers::CONTENT_LENGTH, "0");
                        req.set_body(req_body);
    ...
    pub mod remove_connections_from_groups {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) hub: String,
            pub(crate) groups_to_remove: models::RemoveFromGroupsRequest,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.groups_to_remove)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/api/hubs/{}/:removeFromGroups", self.client.endpoint(), &self.hub))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01");
    ...
    pub mod send_to_all {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) message_ttl_seconds: Option<i32>,
        }
        impl RequestBuilder {
            ...
            #[doc = "Following OData filter syntax to filter out the subscribers receiving the messages."]
            pub fn filter(mut self, filter: impl Into<String>) -> Self {
                self.filter = Some(filter.into());
                self
            }
            #[doc = "The time-to-live (TTL) value in seconds for messages sent to the service. 0 is the default value, which means the message never expires. 300 is the maximum value. If this parameter is non-zero, messages that are not consumed by the client within the specified TTL will be dropped by the service. This parameter can help when the client's bandwidth is limited."]
            pub fn message_ttl_seconds(mut self, message_ttl_seconds: i32) -> Self {
                self.message_ttl_seconds = Some(message_ttl_seconds);
                self
            }
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        if let Some(message_ttl_seconds) = &this.message_ttl_seconds {
                            req.url_mut()
                                .query_pairs_mut()
                                .append_pair("messageTtlSeconds", &message_ttl_seconds.to_string());
                        }
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
    ...
    pub mod remove_connection_from_all_groups {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
