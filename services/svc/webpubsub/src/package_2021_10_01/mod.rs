...
pub mod web_pub_sub {
    ...
    impl Client {
        ...
        #[doc = "* `hub`: Target hub name, which should start with alphabetic characters and only contain alpha-numeric characters or underscore."]
        #[doc = "* `group`: Target group name, which length should be greater than 0 and less than 1025."]
        pub fn close_group_connections(&self, hub: impl Into<String>, group: impl Into<String>) -> close_group_connections::RequestBuilder {
            close_group_connections::RequestBuilder {
                client: self.0.clone(),
                hub: hub.into(),
                group: group.into(),
                excluded: Vec::new(),
    ...
    pub mod close_all_connections {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/api/hubs/{}/:closeConnections", &self.hub));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2021-10-01");
    ...
    pub mod generate_client_token {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/api/hubs/{}/:generateToken", &self.hub));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2021-10-01");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ClientTokenResponse>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ClientTokenResponse>>;
    ...
    pub mod close_group_connections {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/api/hubs/{}/groups/{}/:closeConnections", &self.hub, &self.group));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2021-10-01");
    ...
    pub mod close_user_connections {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/api/hubs/{}/users/{}/:closeConnections", &self.hub, &self.user_id));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2021-10-01");
