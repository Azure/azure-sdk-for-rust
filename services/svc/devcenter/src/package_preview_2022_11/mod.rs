...
pub mod dev_boxes {
    ...
    impl Client {
        ...
        #[doc = "Lists upcoming actions on a Dev Box."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `project_name`: The DevCenter Project upon which to execute operations."]
        #[doc = "* `user_id`: The AAD object id of the user. If value is 'me', the identity is taken from the authentication context."]
        #[doc = "* `dev_box_name`: The name of a Dev Box."]
        pub fn list_upcoming_actions(
            &self,
            project_name: impl Into<String>,
            user_id: impl Into<String>,
            dev_box_name: impl Into<String>,
        ) -> list_upcoming_actions::RequestBuilder {
            list_upcoming_actions::RequestBuilder {
                client: self.0.clone(),
                project_name: project_name.into(),
                user_id: user_id.into(),
        ...
        #[doc = "Gets an Upcoming Action."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `project_name`: The DevCenter Project upon which to execute operations."]
        #[doc = "* `user_id`: The AAD object id of the user. If value is 'me', the identity is taken from the authentication context."]
        #[doc = "* `dev_box_name`: The name of a Dev Box."]
        #[doc = "* `upcoming_action_id`: The upcoming action id."]
        pub fn get_upcoming_action(
            &self,
            project_name: impl Into<String>,
            user_id: impl Into<String>,
            dev_box_name: impl Into<String>,
            upcoming_action_id: impl Into<String>,
        ) -> get_upcoming_action::RequestBuilder {
            get_upcoming_action::RequestBuilder {
                client: self.0.clone(),
                project_name: project_name.into(),
                user_id: user_id.into(),
                dev_box_name: dev_box_name.into(),
                upcoming_action_id: upcoming_action_id.into(),
            }
        }
        #[doc = "Skips an Upcoming Action."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `project_name`: The DevCenter Project upon which to execute operations."]
        #[doc = "* `user_id`: The AAD object id of the user. If value is 'me', the identity is taken from the authentication context."]
        #[doc = "* `dev_box_name`: The name of a Dev Box."]
        #[doc = "* `upcoming_action_id`: The upcoming action id."]
        pub fn skip_upcoming_action(
            &self,
            project_name: impl Into<String>,
            user_id: impl Into<String>,
            dev_box_name: impl Into<String>,
            upcoming_action_id: impl Into<String>,
        ) -> skip_upcoming_action::RequestBuilder {
            skip_upcoming_action::RequestBuilder {
                client: self.0.clone(),
                project_name: project_name.into(),
                user_id: user_id.into(),
        ...
        #[doc = "* `dev_box_name`: The name of a Dev Box."]
        #[doc = "* `upcoming_action_id`: The upcoming action id."]
        #[doc = "* `delay_until`: The delayed action time (UTC)."]
        pub fn delay_upcoming_action(
            &self,
            project_name: impl Into<String>,
            user_id: impl Into<String>,
            dev_box_name: impl Into<String>,
    ...
    pub mod list_upcoming_actions {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::UpcomingActionsListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::UpcomingActionsListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::UpcomingActionsListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/projects/{}/users/{}/devboxes/{}/upcomingActions",
                    &self.project_name, &self.user_id, &self.dev_box_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod get_upcoming_action {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::UpcomingAction> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::UpcomingAction = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/projects/{}/users/{}/devboxes/{}/upcomingActions/{}",
                    &self.project_name, &self.user_id, &self.dev_box_name, &self.upcoming_action_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::UpcomingAction>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::UpcomingAction>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod skip_upcoming_action {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/projects/{}/users/{}/devboxes/{}/upcomingActions/{}:skip",
                    &self.project_name, &self.user_id, &self.dev_box_name, &self.upcoming_action_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod delay_upcoming_action {
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        let bearer_token = this.client.bearer_token().await?;
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        let delay_until = &this.delay_until;
                        req.url_mut().query_pairs_mut().append_pair("delayUntil", &delay_until.to_string());
                        let req_body = azure_core::EMPTY_BODY;
                        req.insert_header(azure_core::headers::CONTENT_LENGTH, "0");
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/projects/{}/users/{}/devboxes/{}/upcomingActions/{}:delay",
                    &self.project_name, &self.user_id, &self.dev_box_name, &self.upcoming_action_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
...
pub mod environments {
    ...
    pub mod list_catalog_items {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/projects/{}/catalogItems", &self.project_name));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-11-11-preview");
    ...
    pub mod get_catalog_item {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/projects/{}/catalogItems/{}", &self.project_name, &self.catalog_item_id));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-11-11-preview");
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    ...
                    &self.project_name, &self.catalog_item_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
    ...
    pub mod get_catalog_item_version {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/projects/{}/catalogItems/{}/versions/{}",
                    &self.project_name, &self.catalog_item_id, &self.version
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
