...
pub struct DevBox {
    ...
    #[serde(rename = "lastConnectedTime", default, with = "azure_core::date::rfc3339::option")]
    pub last_connected_time: Option<::time::OffsetDateTime>,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DevBoxCaptureSnapshotOperation {
    #[serde(flatten)]
    pub dev_box_operation: DevBoxOperation,
}
impl DevBoxCaptureSnapshotOperation {
...
pub enum DevBoxOperationUnion {
    CaptureSnapshot(DevBoxCaptureSnapshotOperation),
...
impl Serialize for DevBoxOperationKind {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::CaptureSnapshot => serializer.serialize_unit_variant("DevBoxOperationKind", 5u32, "CaptureSnapshot"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl DevBoxSnapshot {
    pub fn new(snapshot_id: String, created_time: ::time::OffsetDateTime, snapshot_type: SnapshotType) -> Self {
        Self {
            snapshot_id,
            created_time,
...
pub struct Pool {
    ...
    #[serde(rename = "stopOnNoConnect", default, skip_serializing_if = "Option::is_none")]
    pub stop_on_no_connect: Option<StopOnNoConnectConfiguration>,
...
impl Serialize for SnapshotType {
    ...
    {
        match self {
            Self::Manual => serializer.serialize_unit_variant("SnapshotType", 0u32, "Manual"),
            Self::Automatic => serializer.serialize_unit_variant("SnapshotType", 1u32, "Automatic"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "Stop on no connect configuration settings for Dev Boxes created in this pool."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct StopOnNoConnectConfiguration {
    #[doc = "Stop on no connect enable or disable status."]
    pub status: StopOnNoConnectEnableStatus,
...
impl StopOnNoConnectConfiguration {
    pub fn new(status: StopOnNoConnectEnableStatus) -> Self {
        Self {
            status,
            grace_period_minutes: None,
        }
...
#[doc = "Stop on no connect enable or disable status."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "StopOnNoConnectEnableStatus")]
pub enum StopOnNoConnectEnableStatus {
    Enabled,
    Disabled,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for StopOnNoConnectEnableStatus {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for StopOnNoConnectEnableStatus {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for StopOnNoConnectEnableStatus {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Enabled => serializer.serialize_unit_variant("StopOnNoConnectEnableStatus", 0u32, "Enabled"),
            Self::Disabled => serializer.serialize_unit_variant("StopOnNoConnectEnableStatus", 1u32, "Disabled"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
