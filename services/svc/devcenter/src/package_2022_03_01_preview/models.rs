...
#[doc = "Results of the artifact list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
impl azure_core::Continuable for ArtifactListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone()
    }
}
impl ArtifactListResult {
    pub fn new(value: Vec<Artifact>) -> Self {
...
pub struct DevBox {
    ...
    #[doc = "User identifier of the user this vm is assigned to."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct Environment {
    ...
    #[doc = "Identifier of the owner of this Environment."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
