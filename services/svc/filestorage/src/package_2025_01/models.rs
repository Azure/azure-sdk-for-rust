...
impl Serialize for ErrorCode {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::FileShareProvisionedBandwidthDowngradeNotAllowed => {
                serializer.serialize_unit_variant("ErrorCode", 8u32, "FileShareProvisionedBandwidthDowngradeNotAllowed")
            }
            Self::FileShareProvisionedIopsDowngradeNotAllowed => {
                serializer.serialize_unit_variant("ErrorCode", 9u32, "FileShareProvisionedIopsDowngradeNotAllowed")
            }
            Self::InsufficientAccountPermissions => serializer.serialize_unit_variant("ErrorCode", 10u32, "InsufficientAccountPermissions"),
            Self::InternalError => serializer.serialize_unit_variant("ErrorCode", 11u32, "InternalError"),
            Self::InvalidAuthenticationInfo => serializer.serialize_unit_variant("ErrorCode", 12u32, "InvalidAuthenticationInfo"),
            Self::InvalidHeaderValue => serializer.serialize_unit_variant("ErrorCode", 13u32, "InvalidHeaderValue"),
            Self::InvalidHttpVerb => serializer.serialize_unit_variant("ErrorCode", 14u32, "InvalidHttpVerb"),
            Self::InvalidInput => serializer.serialize_unit_variant("ErrorCode", 15u32, "InvalidInput"),
            Self::InvalidMd5 => serializer.serialize_unit_variant("ErrorCode", 16u32, "InvalidMd5"),
            Self::InvalidMetadata => serializer.serialize_unit_variant("ErrorCode", 17u32, "InvalidMetadata"),
            Self::InvalidQueryParameterValue => serializer.serialize_unit_variant("ErrorCode", 18u32, "InvalidQueryParameterValue"),
            Self::InvalidRange => serializer.serialize_unit_variant("ErrorCode", 19u32, "InvalidRange"),
            Self::InvalidResourceName => serializer.serialize_unit_variant("ErrorCode", 20u32, "InvalidResourceName"),
            Self::InvalidUri => serializer.serialize_unit_variant("ErrorCode", 21u32, "InvalidUri"),
            Self::InvalidXmlDocument => serializer.serialize_unit_variant("ErrorCode", 22u32, "InvalidXmlDocument"),
            Self::InvalidXmlNodeValue => serializer.serialize_unit_variant("ErrorCode", 23u32, "InvalidXmlNodeValue"),
            Self::Md5Mismatch => serializer.serialize_unit_variant("ErrorCode", 24u32, "Md5Mismatch"),
            Self::MetadataTooLarge => serializer.serialize_unit_variant("ErrorCode", 25u32, "MetadataTooLarge"),
            Self::MissingContentLengthHeader => serializer.serialize_unit_variant("ErrorCode", 26u32, "MissingContentLengthHeader"),
            Self::MissingRequiredQueryParameter => serializer.serialize_unit_variant("ErrorCode", 27u32, "MissingRequiredQueryParameter"),
            Self::MissingRequiredHeader => serializer.serialize_unit_variant("ErrorCode", 28u32, "MissingRequiredHeader"),
            Self::MissingRequiredXmlNode => serializer.serialize_unit_variant("ErrorCode", 29u32, "MissingRequiredXmlNode"),
            Self::MultipleConditionHeadersNotSupported => {
                serializer.serialize_unit_variant("ErrorCode", 30u32, "MultipleConditionHeadersNotSupported")
            }
            Self::OperationTimedOut => serializer.serialize_unit_variant("ErrorCode", 31u32, "OperationTimedOut"),
            Self::OutOfRangeInput => serializer.serialize_unit_variant("ErrorCode", 32u32, "OutOfRangeInput"),
            Self::OutOfRangeQueryParameterValue => serializer.serialize_unit_variant("ErrorCode", 33u32, "OutOfRangeQueryParameterValue"),
            Self::RequestBodyTooLarge => serializer.serialize_unit_variant("ErrorCode", 34u32, "RequestBodyTooLarge"),
            Self::ResourceTypeMismatch => serializer.serialize_unit_variant("ErrorCode", 35u32, "ResourceTypeMismatch"),
            Self::RequestUrlFailedToParse => serializer.serialize_unit_variant("ErrorCode", 36u32, "RequestUrlFailedToParse"),
            Self::ResourceAlreadyExists => serializer.serialize_unit_variant("ErrorCode", 37u32, "ResourceAlreadyExists"),
            Self::ResourceNotFound => serializer.serialize_unit_variant("ErrorCode", 38u32, "ResourceNotFound"),
            Self::ServerBusy => serializer.serialize_unit_variant("ErrorCode", 39u32, "ServerBusy"),
            Self::UnsupportedHeader => serializer.serialize_unit_variant("ErrorCode", 40u32, "UnsupportedHeader"),
            Self::UnsupportedXmlNode => serializer.serialize_unit_variant("ErrorCode", 41u32, "UnsupportedXmlNode"),
            Self::UnsupportedQueryParameter => serializer.serialize_unit_variant("ErrorCode", 42u32, "UnsupportedQueryParameter"),
            Self::UnsupportedHttpVerb => serializer.serialize_unit_variant("ErrorCode", 43u32, "UnsupportedHttpVerb"),
            Self::CannotDeleteFileOrDirectory => serializer.serialize_unit_variant("ErrorCode", 44u32, "CannotDeleteFileOrDirectory"),
            Self::ClientCacheFlushDelay => serializer.serialize_unit_variant("ErrorCode", 45u32, "ClientCacheFlushDelay"),
            Self::DeletePending => serializer.serialize_unit_variant("ErrorCode", 46u32, "DeletePending"),
            Self::DirectoryNotEmpty => serializer.serialize_unit_variant("ErrorCode", 47u32, "DirectoryNotEmpty"),
            Self::FileLockConflict => serializer.serialize_unit_variant("ErrorCode", 48u32, "FileLockConflict"),
            Self::InvalidFileOrDirectoryPathName => serializer.serialize_unit_variant("ErrorCode", 49u32, "InvalidFileOrDirectoryPathName"),
            Self::ParentNotFound => serializer.serialize_unit_variant("ErrorCode", 50u32, "ParentNotFound"),
            Self::ReadOnlyAttribute => serializer.serialize_unit_variant("ErrorCode", 51u32, "ReadOnlyAttribute"),
            Self::ShareAlreadyExists => serializer.serialize_unit_variant("ErrorCode", 52u32, "ShareAlreadyExists"),
            Self::ShareBeingDeleted => serializer.serialize_unit_variant("ErrorCode", 53u32, "ShareBeingDeleted"),
            Self::ShareDisabled => serializer.serialize_unit_variant("ErrorCode", 54u32, "ShareDisabled"),
            Self::ShareNotFound => serializer.serialize_unit_variant("ErrorCode", 55u32, "ShareNotFound"),
            Self::SharingViolation => serializer.serialize_unit_variant("ErrorCode", 56u32, "SharingViolation"),
            Self::ShareSnapshotInProgress => serializer.serialize_unit_variant("ErrorCode", 57u32, "ShareSnapshotInProgress"),
            Self::ShareSnapshotCountExceeded => serializer.serialize_unit_variant("ErrorCode", 58u32, "ShareSnapshotCountExceeded"),
            Self::ShareSnapshotOperationNotSupported => {
                serializer.serialize_unit_variant("ErrorCode", 59u32, "ShareSnapshotOperationNotSupported")
            }
            Self::ShareHasSnapshots => serializer.serialize_unit_variant("ErrorCode", 60u32, "ShareHasSnapshots"),
            Self::PreviousSnapshotNotFound => serializer.serialize_unit_variant("ErrorCode", 61u32, "PreviousSnapshotNotFound"),
            Self::ContainerQuotaDowngradeNotAllowed => {
                serializer.serialize_unit_variant("ErrorCode", 62u32, "ContainerQuotaDowngradeNotAllowed")
            }
            Self::AuthorizationSourceIpMismatch => serializer.serialize_unit_variant("ErrorCode", 63u32, "AuthorizationSourceIPMismatch"),
            Self::AuthorizationProtocolMismatch => serializer.serialize_unit_variant("ErrorCode", 64u32, "AuthorizationProtocolMismatch"),
            Self::AuthorizationPermissionMismatch => {
                serializer.serialize_unit_variant("ErrorCode", 65u32, "AuthorizationPermissionMismatch")
            }
            Self::AuthorizationServiceMismatch => serializer.serialize_unit_variant("ErrorCode", 66u32, "AuthorizationServiceMismatch"),
            Self::AuthorizationResourceTypeMismatch => {
                serializer.serialize_unit_variant("ErrorCode", 67u32, "AuthorizationResourceTypeMismatch")
            }
            Self::FeatureVersionMismatch => serializer.serialize_unit_variant("ErrorCode", 68u32, "FeatureVersionMismatch"),
...
pub struct SharePropertiesInternal {
    ...
    #[serde(rename = "IncludedBurstIops", default, skip_serializing_if = "Option::is_none")]
    pub included_burst_iops: Option<i64>,
    #[serde(rename = "MaxBurstCreditsForIops", default, skip_serializing_if = "Option::is_none")]
    pub max_burst_credits_for_iops: Option<i64>,
    #[serde(
        rename = "NextAllowedProvisionedIopsDowngradeTime",
        default,
        with = "azure_core::date::rfc1123::option"
    )]
    pub next_allowed_provisioned_iops_downgrade_time: Option<::time::OffsetDateTime>,
    #[serde(
        rename = "NextAllowedProvisionedBandwidthDowngradeTime",
        default,
        with = "azure_core::date::rfc1123::option"
    )]
    pub next_allowed_provisioned_bandwidth_downgrade_time: Option<::time::OffsetDateTime>,
}
impl SharePropertiesInternal {
    pub fn new(last_modified: ::time::OffsetDateTime, etag: String, quota: i64) -> Self {
        Self {
            ...
            included_burst_iops: None,
            max_burst_credits_for_iops: None,
            next_allowed_provisioned_iops_downgrade_time: None,
            next_allowed_provisioned_bandwidth_downgrade_time: None,
        }
    }
}
