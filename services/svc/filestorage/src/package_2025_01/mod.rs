            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header(azure_core::headers::VERSION, "2025-01-05");
...
pub mod share {
    ...
    impl Client {
        ...
        pub fn create(&self, share_name: impl Into<String>) -> create::RequestBuilder {
            create::RequestBuilder {
                ...
                x_ms_file_request_intent: None,
                x_ms_share_provisioned_iops: None,
                x_ms_share_provisioned_bandwidth_mibps: None,
            }
        }
    ...
    pub mod get_properties {
        ...
        impl<'a> Headers<'a> {
            ...
            #[doc = "Returns the current share provisioned bandwidth in mebibytes per second."]
            ...
            #[doc = "Return the calculated burst IOPS of the share."]
            pub fn x_ms_share_included_burst_iops(&self) -> azure_core::Result<i64> {
                self.0
                    .get_as(&azure_core::headers::HeaderName::from_static("x-ms-share-included-burst-iops"))
            }
            #[doc = "Returned the calculated maximum burst credits. This is not the current burst credit level, but the maximum burst credits the share can have."]
            pub fn x_ms_share_max_burst_credits_for_iops(&self) -> azure_core::Result<i64> {
                self.0.get_as(&azure_core::headers::HeaderName::from_static(
                    "x-ms-share-max-burst-credits-for-iops",
                ))
            }
            #[doc = "Returns the current share next allowed provisioned iops downgrade time."]
            pub fn x_ms_share_next_allowed_provisioned_iops_downgrade_time(&self) -> azure_core::Result<::time::OffsetDateTime> {
                azure_core::date::parse_rfc1123(self.0.get_str(&azure_core::headers::HeaderName::from_static(
                    "x-ms-share-next-allowed-provisioned-iops-downgrade-time",
                ))?)
            }
            #[doc = "Returns the current share next allowed provisioned bandwidth downgrade time."]
            pub fn x_ms_share_next_allowed_provisioned_bandwidth_downgrade_time(&self) -> azure_core::Result<::time::OffsetDateTime> {
                azure_core::date::parse_rfc1123(self.0.get_str(&azure_core::headers::HeaderName::from_static(
    ...
    pub mod create {
        ...
        impl<'a> Headers<'a> {
            ...
            #[doc = "Returns the current share quota in GB."]
            pub fn x_ms_share_quota(&self) -> azure_core::Result<i64> {
                self.0.get_as(&azure_core::headers::HeaderName::from_static("x-ms-share-quota"))
            }
            #[doc = "The provisioned IOPS of the share."]
            pub fn x_ms_share_provisioned_iops(&self) -> azure_core::Result<i64> {
                self.0
                    .get_as(&azure_core::headers::HeaderName::from_static("x-ms-share-provisioned-iops"))
            }
            #[doc = "The provisioned throughput of the share."]
            pub fn x_ms_share_provisioned_bandwidth_mibps(&self) -> azure_core::Result<i64> {
                self.0.get_as(&azure_core::headers::HeaderName::from_static(
                    "x-ms-share-provisioned-bandwidth-mibps",
                ))
            }
            #[doc = "Returns the calculated burst IOPS of the share."]
            pub fn x_ms_share_included_burst_iops(&self) -> azure_core::Result<i64> {
                self.0
                    .get_as(&azure_core::headers::HeaderName::from_static("x-ms-share-included-burst-iops"))
            }
            #[doc = "Returned the calculated maximum burst credits."]
            pub fn x_ms_share_max_burst_credits_for_iops(&self) -> azure_core::Result<i64> {
                self.0.get_as(&azure_core::headers::HeaderName::from_static(
                    "x-ms-share-max-burst-credits-for-iops",
                ))
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) x_ms_file_request_intent: Option<String>,
            pub(crate) x_ms_share_provisioned_iops: Option<i64>,
            pub(crate) x_ms_share_provisioned_bandwidth_mibps: Option<i64>,
        }
        impl RequestBuilder {
            #[doc = "The timeout parameter is expressed in seconds. For more information, see <a href=\"https://docs.microsoft.com/en-us/rest/api/storageservices/Setting-Timeouts-for-File-Service-Operations?redirectedfrom=MSDN\">Setting Timeouts for File Service Operations.</a>"]
            pub fn timeout(mut self, timeout: i64) -> Self {
            ...
            #[doc = "Optional. Supported in version 2025-01-05 and later. Only allowed for provisioned v2 file shares. Specifies the provisioned number of input/output operations per second (IOPS) of the share. If this is not specified, the provisioned IOPS is set to value calculated based on recommendation formula."]
            pub fn x_ms_share_provisioned_iops(mut self, x_ms_share_provisioned_iops: i64) -> Self {
                self.x_ms_share_provisioned_iops = Some(x_ms_share_provisioned_iops);
                self
            }
            #[doc = "Optional. Supported in version 2025-01-05 and later. Only allowed for provisioned v2 file shares. Specifies the provisioned bandwidth of the share, in mebibytes per second (MiBps). If this is not specified, the provisioned bandwidth is set to value calculated based on recommendation formula."]
            pub fn x_ms_share_provisioned_bandwidth_mibps(mut self, x_ms_share_provisioned_bandwidth_mibps: i64) -> Self {
                self.x_ms_share_provisioned_bandwidth_mibps = Some(x_ms_share_provisioned_bandwidth_mibps);
                self
            }
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        if let Some(x_ms_share_provisioned_iops) = &this.x_ms_share_provisioned_iops {
                            req.insert_header("x-ms-share-provisioned-iops", x_ms_share_provisioned_iops.to_string());
                        }
                        if let Some(x_ms_share_provisioned_bandwidth_mibps) = &this.x_ms_share_provisioned_bandwidth_mibps {
                            req.insert_header(
                                "x-ms-share-provisioned-bandwidth-mibps",
                                x_ms_share_provisioned_bandwidth_mibps.to_string(),
                            );
                        }
                        let req_body = azure_core::EMPTY_BODY;
                        req.set_body(req_body);
    ...
    pub mod delete {
        ...
        impl<'a> Headers<'a> {
            ...
            #[doc = "Returned only for provisioned v2 file shares. Returns an approximate used storage size of the share, in bytes."]
            pub fn x_ms_file_share_usage_bytes(&self) -> azure_core::Result<i64> {
                self.0
                    .get_as(&azure_core::headers::HeaderName::from_static("x-ms-file-share-usage-bytes"))
            }
            #[doc = "Returned only for provisioned v2 file shares. Returns an approximate used snapshot storage size of the share, in bytes."]
            pub fn x_ms_file_share_snapshot_usage_bytes(&self) -> azure_core::Result<i64> {
                self.0.get_as(&azure_core::headers::HeaderName::from_static(
...
pub mod file {
    ...
    impl Client {
        ...
        pub fn upload_range(
            ...
            upload_range::RequestBuilder {
                ...
                x_ms_file_request_intent: None,
                x_ms_structured_body: None,
                x_ms_structured_content_length: None,
            }
        }
    ...
    pub mod download {
        ...
        impl<'a> Headers<'a> {
            ...
            #[doc = "Indicates the response body contains a structured message and specifies the message schema version and properties."]
            pub fn x_ms_structured_body(&self) -> azure_core::Result<&str> {
                self.0
                    .get_str(&azure_core::headers::HeaderName::from_static("x-ms-structured-body"))
            }
            #[doc = "The length of the blob/file content inside the message body when the response body is returned as a structured message. Will always be smaller than Content-Length."]
            pub fn x_ms_structured_content_length(&self) -> azure_core::Result<i64> {
                self.0
                    .get_as(&azure_core::headers::HeaderName::from_static("x-ms-structured-content-length"))
            }
        }
        #[derive(Clone)]
        #[doc = r" `RequestBuilder` provides a mechanism for setting optional parameters on a request."]
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) x_ms_structured_body: Option<String>,
            pub(crate) x_ms_lease_id: Option<String>,
            pub(crate) x_ms_file_request_intent: Option<String>,
        }
        impl RequestBuilder {
            ...
            #[doc = "Specifies the response content should be returned as a structured message and specifies the message schema version and properties."]
            pub fn x_ms_structured_body(mut self, x_ms_structured_body: impl Into<String>) -> Self {
                self.x_ms_structured_body = Some(x_ms_structured_body.into());
                self
            }
            #[doc = "If specified, the operation only succeeds if the resource's lease is active and matches this ID."]
            pub fn x_ms_lease_id(mut self, x_ms_lease_id: impl Into<String>) -> Self {
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        if let Some(x_ms_structured_body) = &this.x_ms_structured_body {
                            req.insert_header("x-ms-structured-body", x_ms_structured_body);
                        }
                        if let Some(x_ms_lease_id) = &this.x_ms_lease_id {
                            req.insert_header("x-ms-lease-id", x_ms_lease_id);
                        }
    ...
    pub mod upload_range {
        ...
        impl<'a> Headers<'a> {
            ...
            #[doc = "Indicates the structured message body was accepted and mirrors back the message schema version and properties."]
            pub fn x_ms_structured_body(&self) -> azure_core::Result<&str> {
                self.0
                    .get_str(&azure_core::headers::HeaderName::from_static("x-ms-structured-body"))
            }
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) x_ms_file_request_intent: Option<String>,
            pub(crate) x_ms_structured_body: Option<String>,
            pub(crate) x_ms_structured_content_length: Option<i64>,
        }
        impl RequestBuilder {
            #[doc = "Initial data."]
            ...
            #[doc = "Required if the request body is a structured message. Specifies the message schema version and properties."]
            pub fn x_ms_structured_body(mut self, x_ms_structured_body: impl Into<String>) -> Self {
                self.x_ms_structured_body = Some(x_ms_structured_body.into());
                self
            }
            #[doc = "Required if the request body is a structured message. Specifies the length of the blob/file content inside the message body. Will always be smaller than Content-Length."]
            pub fn x_ms_structured_content_length(mut self, x_ms_structured_content_length: i64) -> Self {
                self.x_ms_structured_content_length = Some(x_ms_structured_content_length);
                self
            }
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        if let Some(x_ms_structured_content_length) = &this.x_ms_structured_content_length {
                            req.insert_header("x-ms-structured-content-length", x_ms_structured_content_length.to_string());
                        }
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
