...
#[doc = "Access rights of the access policy."]
...
impl DirectoryItem {
    pub fn new(name: StringEncoded) -> Self {
        Self {
            name,
            file_id: None,
            properties: None,
...
impl Serialize for ErrorCode {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::PreviousSnapshotNotFound => serializer.serialize_unit_variant("ErrorCode", 59u32, "PreviousSnapshotNotFound"),
            Self::ContainerQuotaDowngradeNotAllowed => {
                serializer.serialize_unit_variant("ErrorCode", 60u32, "ContainerQuotaDowngradeNotAllowed")
            }
            Self::AuthorizationSourceIpMismatch => serializer.serialize_unit_variant("ErrorCode", 61u32, "AuthorizationSourceIPMismatch"),
            Self::AuthorizationProtocolMismatch => serializer.serialize_unit_variant("ErrorCode", 62u32, "AuthorizationProtocolMismatch"),
            Self::AuthorizationPermissionMismatch => {
                serializer.serialize_unit_variant("ErrorCode", 63u32, "AuthorizationPermissionMismatch")
            }
            Self::AuthorizationServiceMismatch => serializer.serialize_unit_variant("ErrorCode", 64u32, "AuthorizationServiceMismatch"),
            Self::AuthorizationResourceTypeMismatch => {
                serializer.serialize_unit_variant("ErrorCode", 65u32, "AuthorizationResourceTypeMismatch")
            }
            Self::FeatureVersionMismatch => serializer.serialize_unit_variant("ErrorCode", 66u32, "FeatureVersionMismatch"),
...
impl FileItem {
    pub fn new(name: StringEncoded, properties: FileProperty) -> Self {
        Self {
            name,
            file_id: None,
            properties,
...
pub struct HandleItem {
    ...
    #[doc = "Name of the client machine where the share is being mounted"]
    ...
    #[serde(rename = "AccessRightList", default, skip_serializing_if = "Option::is_none")]
    pub access_right_list: Option<handle_item::AccessRightList>,
}
impl HandleItem {
    pub fn new(
        handle_id: String,
...
pub mod handle_item {
    use super::*;
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
    pub struct AccessRightList {
        #[serde(rename = "$value", default, skip_serializing_if = "Vec::is_empty")]
        pub items: Vec<AccessRight>,
    }
}
...
impl ListFilesAndDirectoriesSegmentResponse {
    pub fn new(service_endpoint: String, share_name: String, directory_path: String, prefix: StringEncoded, next_marker: String) -> Self {
        Self {
            service_endpoint,
            share_name,
            share_snapshot: None,
...
pub struct SharePermission {
    ...
    pub format: Option<share_permission::Format>,
}
impl SharePermission {
    pub fn new(permission: String) -> Self {
        Self { permission, format: None }
    }
}
...
pub struct SharePropertiesInternal {
    ...
    #[serde(rename = "EnableSnapshotVirtualDirectoryAccess", default, skip_serializing_if = "Option::is_none")]
    pub enable_snapshot_virtual_directory_access: Option<bool>,
    #[serde(rename = "PaidBurstingEnabled", default, skip_serializing_if = "Option::is_none")]
    pub paid_bursting_enabled: Option<bool>,
    #[serde(rename = "PaidBurstingMaxIops", default, skip_serializing_if = "Option::is_none")]
    pub paid_bursting_max_iops: Option<i64>,
    #[serde(rename = "PaidBurstingMaxBandwidthMibps", default, skip_serializing_if = "Option::is_none")]
    pub paid_bursting_max_bandwidth_mibps: Option<i64>,
}
impl SharePropertiesInternal {
    pub fn new(last_modified: ::time::OffsetDateTime, etag: String, quota: i64) -> Self {
        Self {
            ...
            root_squash: None,
            enable_snapshot_virtual_directory_access: None,
            paid_bursting_enabled: None,
            paid_bursting_max_iops: None,
            paid_bursting_max_bandwidth_mibps: None,
        }
    }
}
...
pub struct StorageError {
    ...
    #[serde(rename = "AuthenticationErrorDetail", default, skip_serializing_if = "Option::is_none")]
