            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header(azure_core::headers::VERSION, "2024-11-04");
...
pub mod share {
    ...
    impl Client {
        ...
        pub fn create(&self, share_name: impl Into<String>) -> create::RequestBuilder {
            create::RequestBuilder {
                ...
                x_ms_enable_snapshot_virtual_directory_access: None,
                x_ms_share_paid_bursting_enabled: None,
                x_ms_share_paid_bursting_max_bandwidth_mibps: None,
                x_ms_share_paid_bursting_max_iops: None,
                x_ms_file_request_intent: None,
            }
        }
        ...
        pub fn get_permission(
            ...
            get_permission::RequestBuilder {
                ...
                x_ms_file_permission_format: None,
                timeout: None,
                x_ms_file_request_intent: None,
            }
        }
    ...
    pub mod get_properties {
        ...
        impl<'a> Headers<'a> {
            ...
            #[doc = "Version 2023-08-03 and newer. Specifies whether the snapshot virtual directory should be accessible at the root of share mount point when NFS is enabled. This header is only returned for shares, not for snapshots."]
            pub fn x_ms_enable_snapshot_virtual_directory_access(&self) -> azure_core::Result<bool> {
                self.0.get_as(&azure_core::headers::HeaderName::from_static(
                    "x-ms-enable-snapshot-virtual-directory-access",
                ))
            }
            #[doc = "Optional. Boolean. Default if not specified is false. This property enables paid bursting."]
            pub fn x_ms_share_paid_bursting_enabled(&self) -> azure_core::Result<bool> {
                self.0
                    .get_as(&azure_core::headers::HeaderName::from_static("x-ms-share-paid-bursting-enabled"))
            }
            #[doc = "Optional. Integer. Default if not specified is the maximum IOPS the file share can support. Current maximum for a file share is 102,400 IOPS."]
            pub fn x_ms_share_paid_bursting_max_iops(&self) -> azure_core::Result<i64> {
                self.0
                    .get_as(&azure_core::headers::HeaderName::from_static("x-ms-share-paid-bursting-max-iops"))
            }
            #[doc = "Optional. Integer. Default if not specified is the maximum throughput the file share can support. Current maximum for a file share is 10,340 MiB/sec."]
            pub fn x_ms_share_paid_bursting_max_bandwidth_mibps(&self) -> azure_core::Result<i64> {
                self.0.get_as(&azure_core::headers::HeaderName::from_static(
    ...
    pub mod create {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) x_ms_enable_snapshot_virtual_directory_access: Option<bool>,
            pub(crate) x_ms_share_paid_bursting_enabled: Option<bool>,
            pub(crate) x_ms_share_paid_bursting_max_bandwidth_mibps: Option<i64>,
            pub(crate) x_ms_share_paid_bursting_max_iops: Option<i64>,
            pub(crate) x_ms_file_request_intent: Option<String>,
        }
        impl RequestBuilder {
            #[doc = "The timeout parameter is expressed in seconds. For more information, see <a href=\"https://docs.microsoft.com/en-us/rest/api/storageservices/Setting-Timeouts-for-File-Service-Operations?redirectedfrom=MSDN\">Setting Timeouts for File Service Operations.</a>"]
            ...
            pub fn x_ms_enable_snapshot_virtual_directory_access(mut self, x_ms_enable_snapshot_virtual_directory_access: bool) -> Self {
                self.x_ms_enable_snapshot_virtual_directory_access = Some(x_ms_enable_snapshot_virtual_directory_access);
                self
            }
            #[doc = "Optional. Boolean. Default if not specified is false. This property enables paid bursting."]
            pub fn x_ms_share_paid_bursting_enabled(mut self, x_ms_share_paid_bursting_enabled: bool) -> Self {
                self.x_ms_share_paid_bursting_enabled = Some(x_ms_share_paid_bursting_enabled);
                self
            }
            #[doc = "Optional. Integer. Default if not specified is the maximum throughput the file share can support. Current maximum for a file share is 10,340  MiB/sec."]
            pub fn x_ms_share_paid_bursting_max_bandwidth_mibps(mut self, x_ms_share_paid_bursting_max_bandwidth_mibps: i64) -> Self {
                self.x_ms_share_paid_bursting_max_bandwidth_mibps = Some(x_ms_share_paid_bursting_max_bandwidth_mibps);
                self
            }
            #[doc = "Optional. Integer. Default if not specified is the maximum IOPS the file share can support. Current maximum for a file share is 102,400 IOPS."]
            pub fn x_ms_share_paid_bursting_max_iops(mut self, x_ms_share_paid_bursting_max_iops: i64) -> Self {
                self.x_ms_share_paid_bursting_max_iops = Some(x_ms_share_paid_bursting_max_iops);
                self
            }
            #[doc = "Valid value is backup"]
            pub fn x_ms_file_request_intent(mut self, x_ms_file_request_intent: impl Into<String>) -> Self {
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        if let Some(x_ms_enable_snapshot_virtual_directory_access) = &this.x_ms_enable_snapshot_virtual_directory_access {
                            req.insert_header(
                                "x-ms-enable-snapshot-virtual-directory-access",
                                x_ms_enable_snapshot_virtual_directory_access.to_string(),
                            );
                        }
                        if let Some(x_ms_share_paid_bursting_enabled) = &this.x_ms_share_paid_bursting_enabled {
                            req.insert_header("x-ms-share-paid-bursting-enabled", x_ms_share_paid_bursting_enabled.to_string());
                        }
                        if let Some(x_ms_share_paid_bursting_max_bandwidth_mibps) = &this.x_ms_share_paid_bursting_max_bandwidth_mibps {
                            req.insert_header(
                                "x-ms-share-paid-bursting-max-bandwidth-mibps",
                                x_ms_share_paid_bursting_max_bandwidth_mibps.to_string(),
                            );
                        }
                        if let Some(x_ms_share_paid_bursting_max_iops) = &this.x_ms_share_paid_bursting_max_iops {
                            req.insert_header("x-ms-share-paid-bursting-max-iops", x_ms_share_paid_bursting_max_iops.to_string());
                        }
                        if let Some(x_ms_file_request_intent) = &this.x_ms_file_request_intent {
                            req.insert_header("x-ms-file-request-intent", x_ms_file_request_intent);
                        }
    ...
    pub mod get_permission {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) x_ms_file_permission_format: Option<String>,
            pub(crate) timeout: Option<i64>,
            pub(crate) x_ms_file_request_intent: Option<String>,
        }
        impl RequestBuilder {
            #[doc = "Optional. Available for version 2023-06-01 and later. Specifies the format in which the permission is returned. Acceptable values are SDDL or binary. If x-ms-file-permission-format is unspecified or explicitly set to SDDL, the permission is returned in SDDL format. If x-ms-file-permission-format is explicitly set to binary, the permission is returned as a base64 string representing the binary encoding of the permission"]
            pub fn x_ms_file_permission_format(mut self, x_ms_file_permission_format: impl Into<String>) -> Self {
                self.x_ms_file_permission_format = Some(x_ms_file_permission_format.into());
                self
            }
            #[doc = "The timeout parameter is expressed in seconds. For more information, see <a href=\"https://docs.microsoft.com/en-us/rest/api/storageservices/Setting-Timeouts-for-File-Service-Operations?redirectedfrom=MSDN\">Setting Timeouts for File Service Operations.</a>"]
            pub fn timeout(mut self, timeout: i64) -> Self {
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        if let Some(x_ms_file_permission_format) = &this.x_ms_file_permission_format {
                            req.insert_header("x-ms-file-permission-format", x_ms_file_permission_format);
                        }
                        if let Some(timeout) = &this.timeout {
                            req.url_mut().query_pairs_mut().append_pair("timeout", &timeout.to_string());
                        }
...
pub mod file {
    ...
    pub mod get_range_list {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) x_ms_allow_trailing_dot: Option<bool>,
            pub(crate) x_ms_file_request_intent: Option<String>,
            pub(crate) x_ms_file_support_rename: Option<bool>,
        }
        impl RequestBuilder {
            #[doc = "The snapshot parameter is an opaque DateTime value that, when present, specifies the share snapshot to query."]
            pub fn sharesnapshot(mut self, sharesnapshot: impl Into<String>) -> Self {
            ...
            pub fn x_ms_file_support_rename(mut self, x_ms_file_support_rename: bool) -> Self {
                self.x_ms_file_support_rename = Some(x_ms_file_support_rename);
                self
            }
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        if let Some(x_ms_file_support_rename) = &this.x_ms_file_support_rename {
                            req.insert_header("x-ms-file-support-rename", x_ms_file_support_rename.to_string());
                        }
                        let req_body = azure_core::EMPTY_BODY;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
