...
pub use v20210519::{models, operations, operations::Client, operations::ClientBuilder};
#[cfg(feature = "20171001")]
pub mod v20171001;
#[cfg(all(feature = "20171001", not(feature = "no-default-tag")))]
pub use v20171001::{models, operations, operations::Client, operations::ClientBuilder};
