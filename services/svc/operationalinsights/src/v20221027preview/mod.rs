...
pub mod query {
    ...
    impl Client {
        ...
        pub fn resource_get_xms(&self, resource_id: impl Into<String>, query: impl Into<String>) -> resource_get_xms::RequestBuilder {
            resource_get_xms::RequestBuilder {
                client: self.0.clone(),
        ...
        pub fn resource_execute_xms(
            &self,
            resource_id: impl Into<String>,
            body: impl Into<models::QueryBody>,
        ) -> resource_execute_xms::RequestBuilder {
            resource_execute_xms::RequestBuilder {
                client: self.0.clone(),
                resource_id: resource_id.into(),
                body: body.into(),
        ...
        #[doc = "* `resource_id`: The identifier of the resource."]
        #[doc = "* `query`: The Analytics query. Learn more about the [Analytics query syntax](https://azure.microsoft.com/documentation/articles/app-insights-analytics-reference/)"]
        pub fn resource_get(&self, resource_id: impl Into<String>, query: impl Into<String>) -> resource_get::RequestBuilder {
            resource_get::RequestBuilder {
                client: self.0.clone(),
                resource_id: resource_id.into(),
                query: query.into(),
                timespan: None,
        ...
        #[doc = "* `resource_id`: The identifier of the resource."]
        #[doc = "* `body`: The Analytics query. Learn more about the [Analytics query syntax](https://azure.microsoft.com/documentation/articles/app-insights-analytics-reference/)"]
        pub fn resource_execute(
            &self,
            resource_id: impl Into<String>,
            body: impl Into<models::QueryBody>,
        ) -> resource_execute::RequestBuilder {
            resource_execute::RequestBuilder {
                client: self.0.clone(),
                resource_id: resource_id.into(),
                body: body.into(),
        ...
        pub fn batch(&self, body: impl Into<models::BatchRequest>) -> batch::RequestBuilder {
    ...
    pub mod resource_get_xms {
        use super::models;
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::QueryResults> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::QueryResults = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::QueryResults>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::QueryResults>>;
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core::Url::parse(&format!("{}/{}/query", this.client.endpoint(), &this.resource_id))?;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Get);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
    ...
    pub mod batch {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BatchResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BatchResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::BatchResponse>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::BatchResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod metadata {
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::MetadataResults> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::MetadataResults = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::MetadataResults>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::MetadataResults>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
