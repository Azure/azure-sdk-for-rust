...
pub use package_job_2017_09_preview::{models, operations, operations::Client, operations::ClientBuilder};
#[cfg(feature = "package-job-2016-11")]
pub mod package_job_2016_11;
#[cfg(all(feature = "package-job-2016-11", not(feature = "no-default-tag")))]
pub use package_job_2016_11::{models, operations, operations::Client, operations::ClientBuilder};
...
pub use package_job_2016_03_preview::{models, operations, operations::Client, operations::ClientBuilder};
...
pub use package_job_2015_11_preview::{models, operations, operations::Client, operations::ClientBuilder};
...
pub use package_catalog_2016_11::{models, operations, operations::Client, operations::ClientBuilder};
