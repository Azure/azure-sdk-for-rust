...
pub mod pipeline {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::JobPipelineInformation>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
...
pub mod recurrence {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::JobRecurrenceInformation>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
