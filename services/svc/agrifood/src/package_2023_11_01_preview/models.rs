...
pub struct ApplicationData {
    ...
    #[doc = "Schema for storing resource type and  resource id."]
    #[serde(rename = "associatedResource", default, skip_serializing_if = "Option::is_none")]
    pub associated_resource: Option<GeoResource>,
...
#[doc = "Schema of application data resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ApplicationDataMetaData {
    #[doc = "Application product details."]
    #[serde(
        rename = "applicationProductDetails",
        default,
...
impl ApplicationDataMetaData {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Paged response contains list of requested objects and a skipToken to get the next set of results."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ApplicationDataMetaDataListResponse {
    #[doc = "List of requested objects."]
    pub value: Vec<ApplicationDataMetaData>,
...
impl ApplicationDataMetaDataListResponse {
    pub fn new(value: Vec<ApplicationDataMetaData>) -> Self {
        Self {
            value,
            skip_token: None,
            next_link: None,
    ...
    impl Serialize for ResourceType {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::ApplicationData => serializer.serialize_unit_variant("ResourceType", 4u32, "ApplicationData"),
                Self::HarvestData => serializer.serialize_unit_variant("ResourceType", 5u32, "HarvestData"),
                Self::TillageData => serializer.serialize_unit_variant("ResourceType", 6u32, "TillageData"),
                Self::PlantingData => serializer.serialize_unit_variant("ResourceType", 7u32, "PlantingData"),
                Self::PlantTissueAnalysis => serializer.serialize_unit_variant("ResourceType", 8u32, "PlantTissueAnalysis"),
                Self::Prescription => serializer.serialize_unit_variant("ResourceType", 9u32, "Prescription"),
...
#[doc = "Schema of ChemicalProduct resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ChemicalProduct {
    #[doc = "The Ids of the crops associated with the Chemical product.\r\nNote: A maximum of 25 crops can be associated with a cropProduct."]
    #[serde(
        rename = "cropIds",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    #[doc = "Reference to a dataset record."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub reference: Option<Reference>,
    #[doc = "Commercial brand of the chemical product."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub brand: Option<String>,
    #[doc = "Commercial product name of the chemical product."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub product: Option<String>,
    #[doc = "Herbicide, Additive, Insecticides, Fertilizers."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<String>,
    #[doc = "Liquid/non Liquid."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<String>,
    #[doc = "Active chemicals in the formulation."]
    #[serde(
    ...
    #[doc = "Specific gravity details."]
    #[serde(rename = "specificGravity", default, skip_serializing_if = "Option::is_none")]
    pub specific_gravity: Option<String>,
    #[doc = "Formulation description. Percentage or other unit of N, P, K, CA, MG, S, FE, MN, ZN, CU, B, MO, CL\r\n(based on the source, the available chemical elements can vary, but this is a typical list)."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub formulation: Option<String>,
    #[doc = "Company/Manufacturer's details."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub company: Option<Company>,
    #[doc = "Area where the chemical is used. This is important from a compliance perspective."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub location: Option<String>,
    #[doc = "Registration number of the chemical. This could vary by geography."]
    #[serde(rename = "registrationNumber", default, skip_serializing_if = "Option::is_none")]
    pub registration_number: Option<String>,
    #[doc = "The number of days after which a person can visit the field after the chemical product is applied."]
    #[serde(rename = "reEntryInterval", default, skip_serializing_if = "Option::is_none")]
    pub re_entry_interval: Option<i32>,
    #[doc = "Unique resource ID."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "The ETag value to implement optimistic concurrency."]
...
#[doc = "Paged response contains list of requested objects and a skipToken to get the next set of results."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ChemicalProductListResponse {
    #[doc = "List of requested objects."]
    pub value: Vec<ChemicalProduct>,
    #[doc = "Token used in retrieving the next page. If null, there are no additional pages."]
    #[serde(rename = "skipToken", default, skip_serializing_if = "Option::is_none")]
    pub skip_token: Option<String>,
    #[doc = "Continuation link (absolute URI) to the next page of results in the list."]
...
impl azure_core::Continuable for ChemicalProductListResponse {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl ChemicalProductListResponse {
    pub fn new(value: Vec<ChemicalProduct>) -> Self {
        Self {
            value,
            skip_token: None,
            next_link: None,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct Company {
    #[doc = "Name of the manufacturing company."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Manufacturing Company description."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    #[doc = "Registration number of the company."]
    #[serde(rename = "registrationNumber", default, skip_serializing_if = "Option::is_none")]
    pub registration_number: Option<String>,
}
impl Company {
...
pub struct Crop {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub reference: Option<Reference>,
    #[doc = "Phenotype of the crop. Example values are crop weight, height, color, etc."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub phenotype: Option<String>,
    #[doc = "Type of breeding Method like VARIETY, HYBRID, UNKNOWN."]
    #[serde(rename = "breedingMethod", default, skip_serializing_if = "Option::is_none")]
    pub breeding_method: Option<String>,
    #[doc = "The properties that pertain to this crop such as nominal weight, nominal moisture, and shrink factor."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub measurements: Option<serde_json::Value>,
    #[doc = "Region where the crop is planted."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub location: Option<String>,
    #[doc = "Unique resource ID."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct CropProduct {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub reference: Option<Reference>,
    #[doc = "Commercial brand of the crop product."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub brand: Option<String>,
    #[doc = "Commercial product name of the crop product."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub product: Option<String>,
    #[doc = "Relative maturity measure."]
    #[serde(rename = "relativeMaturity", default, skip_serializing_if = "Option::is_none")]
    pub relative_maturity: Option<RelativeMaturityMeasure>,
    #[doc = "Seed Coatings Applied for fungus, insects etc."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    ...
    #[doc = "Phenotypic expressions like CONV, RR2. These are the Phenotypic expressions like CONV (Conventional), RR2 (RoundUpReady)."]
    #[serde(rename = "traitStack", default, skip_serializing_if = "Option::is_none")]
    pub trait_stack: Option<String>,
    #[doc = "Traits that are in the stack."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Schema of dataset resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct Dataset {
    #[doc = "Type of the dataset. Supported types: Crop, CropProduct, ChemicalProduct, Equipment."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<dataset::Type>,
    #[doc = "Schema for records under the dataset."]
    #[serde(rename = "recordsSchema", default, skip_serializing_if = "Option::is_none")]
    pub records_schema: Option<serde_json::Value>,
    #[doc = "Solution id of the dataset solution."]
...
pub mod dataset {
    ...
    impl Serialize for Type {
        ...
        {
            match self {
                Self::Crop => serializer.serialize_unit_variant("Type", 0u32, "Crop"),
                Self::CropProduct => serializer.serialize_unit_variant("Type", 1u32, "CropProduct"),
                Self::ChemicalProduct => serializer.serialize_unit_variant("Type", 2u32, "ChemicalProduct"),
                Self::FarmEquipment => serializer.serialize_unit_variant("Type", 3u32, "FarmEquipment"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
}
#[doc = "DatasetAccess object."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DatasetAccess {
    #[doc = "Subscription Id."]
    #[serde(rename = "subscriptionId", default, skip_serializing_if = "Option::is_none")]
    pub subscription_id: Option<String>,
    #[doc = "Azure Data Manager for Agriculture resource Id."]
    #[serde(rename = "resourceId", default, skip_serializing_if = "Option::is_none")]
    pub resource_id: Option<String>,
    #[doc = "Date-time when resource was created, sample format: yyyy-MM-ddTHH:mm:ssZ."]
    #[serde(rename = "createdDateTime", default, with = "azure_core::date::rfc3339::option")]
...
#[doc = "Paged response contains list of requested objects and a skipToken to get the next set of results."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DatasetAccessListResponse {
    #[doc = "List of requested objects."]
    pub value: Vec<DatasetAccess>,
    #[doc = "Token used in retrieving the next page. If null, there are no additional pages."]
    #[serde(rename = "skipToken", default, skip_serializing_if = "Option::is_none")]
    pub skip_token: Option<String>,
    #[doc = "Continuation link (absolute URI) to the next page of results in the list."]
...
impl azure_core::Continuable for DatasetAccessListResponse {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl DatasetAccessListResponse {
    pub fn new(value: Vec<DatasetAccess>) -> Self {
        Self {
            value,
            skip_token: None,
            next_link: None,
...
#[doc = "Schema of dataset records."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DatasetRecord {
    #[doc = "Dataset Id for this record."]
...
#[doc = "Paged response contains list of requested objects and a skipToken to get the next set of results."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DatasetRecordListResponse {
    #[doc = "List of requested objects."]
    pub value: Vec<DatasetRecord>,
    #[doc = "Token used in retrieving the next page. If null, there are no additional pages."]
    #[serde(rename = "skipToken", default, skip_serializing_if = "Option::is_none")]
    pub skip_token: Option<String>,
    #[doc = "Continuation link (absolute URI) to the next page of results in the list."]
...
impl azure_core::Continuable for DatasetRecordListResponse {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl DatasetRecordListResponse {
    pub fn new(value: Vec<DatasetRecord>) -> Self {
        Self {
            value,
            skip_token: None,
            next_link: None,
...
#[doc = "Schema of FarmEquipment resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct FarmEquipment {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub brand: Option<String>,
    #[doc = "Series number of the Farm Equipment."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub series: Option<String>,
    #[doc = "Model number of the Farm Equipment."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub model: Option<String>,
    #[doc = "Serial number of the Farm Equipment."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub serial: Option<String>,
    #[doc = "Type of the Farm Equipment (Tiller, Sower, harvester, Sprayer, …)."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<String>,
    #[doc = "Owned, rented, shared, etc."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ownership: Option<String>,
    #[doc = "Area where the equipment is used."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub location: Option<String>,
    #[doc = "Company/Manufacturer's details."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Paged response contains list of requested objects and a skipToken to get the next set of results."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct FarmEquipmentListResponse {
    #[doc = "List of requested objects."]
    pub value: Vec<FarmEquipment>,
    #[doc = "Token used in retrieving the next page. If null, there are no additional pages."]
    #[serde(rename = "skipToken", default, skip_serializing_if = "Option::is_none")]
    pub skip_token: Option<String>,
    #[doc = "Continuation link (absolute URI) to the next page of results in the list."]
...
impl azure_core::Continuable for FarmEquipmentListResponse {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl FarmEquipmentListResponse {
    pub fn new(value: Vec<FarmEquipment>) -> Self {
        Self {
            value,
            skip_token: None,
            next_link: None,
    ...
    impl Serialize for ShapeType {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::None => serializer.serialize_unit_variant("ShapeType", 2u32, "None"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for ShapeResolution {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::None => serializer.serialize_unit_variant("ShapeResolution", 3u32, "None"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Paged response contains list of requested objects and a skipToken to get the next set of results."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct FieldMetaDataListResponse {
    #[doc = "List of requested objects."]
    pub value: Vec<FieldMetaData>,
    #[doc = "Token used in retrieving the next page. If null, there are no additional pages."]
    #[serde(rename = "skipToken", default, skip_serializing_if = "Option::is_none")]
    pub skip_token: Option<String>,
    #[doc = "Continuation link (absolute URI) to the next page of results in the list."]
...
impl FieldMetaDataListResponse {
    pub fn new(value: Vec<FieldMetaData>) -> Self {
        Self {
            value,
            skip_token: None,
            next_link: None,
...
pub mod geo_resource {
    ...
    impl Serialize for Type {
        ...
        {
            match self {
                Self::Field => serializer.serialize_unit_variant("Type", 0u32, "Field"),
                Self::SeasonalField => serializer.serialize_unit_variant("Type", 1u32, "SeasonalField"),
                Self::Zone => serializer.serialize_unit_variant("Type", 2u32, "Zone"),
                Self::Prescription => serializer.serialize_unit_variant("Type", 3u32, "Prescription"),
                Self::PlantTissueAnalysis => serializer.serialize_unit_variant("Type", 4u32, "PlantTissueAnalysis"),
                Self::PlantingData => serializer.serialize_unit_variant("Type", 5u32, "PlantingData"),
                Self::ApplicationData => serializer.serialize_unit_variant("Type", 6u32, "ApplicationData"),
                Self::HarvestData => serializer.serialize_unit_variant("Type", 7u32, "HarvestData"),
                Self::TillageData => serializer.serialize_unit_variant("Type", 8u32, "TillageData"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Schema of harvest data resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct HarvestDataMetaData {
    #[doc = "Schema for storing measurement reading and unit."]
    #[serde(rename = "totalYield", default, skip_serializing_if = "Option::is_none")]
    pub total_yield: Option<Measure>,
    #[doc = "Schema for storing measurement reading and unit."]
...
#[doc = "Paged response contains list of requested objects and a skipToken to get the next set of results."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct HarvestDataMetaDataListResponse {
    #[doc = "List of requested objects."]
    pub value: Vec<HarvestDataMetaData>,
    #[doc = "Token used in retrieving the next page. If null, there are no additional pages."]
    #[serde(rename = "skipToken", default, skip_serializing_if = "Option::is_none")]
    pub skip_token: Option<String>,
    #[doc = "Continuation link (absolute URI) to the next page of results in the list."]
...
impl HarvestDataMetaDataListResponse {
    pub fn new(value: Vec<HarvestDataMetaData>) -> Self {
        Self {
            value,
            skip_token: None,
            next_link: None,
...
#[doc = "Schema of overlap resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct OverlapResource {
    #[doc = "Party Id of the resource."]
    #[serde(rename = "partyId")]
    pub party_id: String,
    #[doc = "Resource type of the resource."]
    #[serde(rename = "resourceType")]
    pub resource_type: String,
    #[doc = "Id of the resource."]
    #[serde(rename = "resourceId")]
    pub resource_id: String,
    #[doc = "Acreage of the resource."]
    #[serde(rename = "resourceArea", default, skip_serializing_if = "Option::is_none")]
    pub resource_area: Option<f64>,
}
impl OverlapResource {
    pub fn new(party_id: String, resource_type: String, resource_id: String) -> Self {
        Self {
            party_id,
            resource_type,
            resource_id,
...
#[doc = "Overlap Resource Query Parameters."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OverlapResourcesQuery {
    ...
    pub resources: Vec<OverlapResource>,
}
impl OverlapResourcesQuery {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Schema of Party Overlap Response."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PartyOverlapResponse {
    #[doc = "Resources with area."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    ...
    pub resources: Vec<OverlapResource>,
    #[doc = "Acreage of overlapping area."]
    #[serde(rename = "overlappingArea", default, skip_serializing_if = "Option::is_none")]
    pub overlapping_area: Option<f64>,
}
impl PartyOverlapResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Api Model for plant tissue analysis object."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PlantTissueAnalysisMetaData {
    #[doc = "Id of the associated Party."]
    #[serde(rename = "partyId", default, skip_serializing_if = "Option::is_none")]
    pub party_id: Option<String>,
    #[doc = "Id of the associated Field."]
...
impl PlantTissueAnalysisMetaData {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Paged response contains list of requested objects and a skipToken to get the next set of results."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct PlantTissueAnalysisMetaDataListResponse {
    #[doc = "List of requested objects."]
    pub value: Vec<PlantTissueAnalysisMetaData>,
    #[doc = "Token used in retrieving the next page. If null, there are no additional pages."]
    #[serde(rename = "skipToken", default, skip_serializing_if = "Option::is_none")]
    pub skip_token: Option<String>,
    #[doc = "Continuation link (absolute URI) to the next page of results in the list."]
...
impl PlantTissueAnalysisMetaDataListResponse {
    pub fn new(value: Vec<PlantTissueAnalysisMetaData>) -> Self {
        Self {
            value,
            skip_token: None,
            next_link: None,
...
#[doc = "Schema of planting data resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PlantingDataMetaData {
    #[doc = "Schema for storing measurement reading and unit."]
    #[serde(rename = "avgPlantingRate", default, skip_serializing_if = "Option::is_none")]
    pub avg_planting_rate: Option<Measure>,
    #[doc = "Schema for storing measurement reading and unit."]
...
#[doc = "Paged response contains list of requested objects and a skipToken to get the next set of results."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct PlantingDataMetaDataListResponse {
    #[doc = "List of requested objects."]
    pub value: Vec<PlantingDataMetaData>,
    #[doc = "Token used in retrieving the next page. If null, there are no additional pages."]
    #[serde(rename = "skipToken", default, skip_serializing_if = "Option::is_none")]
    pub skip_token: Option<String>,
    #[doc = "Continuation link (absolute URI) to the next page of results in the list."]
...
impl PlantingDataMetaDataListResponse {
    pub fn new(value: Vec<PlantingDataMetaData>) -> Self {
        Self {
            value,
            skip_token: None,
            next_link: None,
...
#[doc = "Paged response contains list of requested objects and a skipToken to get the next set of results."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct PrescriptionMetaDataListResponse {
    #[doc = "List of requested objects."]
    pub value: Vec<PrescriptionMetaData>,
    #[doc = "Token used in retrieving the next page. If null, there are no additional pages."]
    #[serde(rename = "skipToken", default, skip_serializing_if = "Option::is_none")]
    pub skip_token: Option<String>,
    #[doc = "Continuation link (absolute URI) to the next page of results in the list."]
...
impl PrescriptionMetaDataListResponse {
    pub fn new(value: Vec<PrescriptionMetaData>) -> Self {
        Self {
            value,
            skip_token: None,
            next_link: None,
...
#[doc = "Relative maturity measure."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RelativeMaturityMeasure {
    #[doc = "Data unit."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub unit: Option<String>,
    #[doc = "Data value."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub value: Option<f64>,
    #[doc = "The method used to determine the relative maturity of the product. Examples include\r\nComparative Relative Maturity or Heat Units."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub method: Option<String>,
}
impl RelativeMaturityMeasure {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct SatelliteDataIngestionJob {
    ...
    pub associated_resource: GeoResource,
    #[doc = "Start Date."]
    ...
    #[doc = "Provider of satellite data. Available Value: SentinelHub."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub provider: Option<satellite_data_ingestion_job::Provider>,
    #[doc = "Collection of satellite data. Available Value: sentinel-2-l2a, sentinel-2-l1c."]
    pub collection: String,
    #[doc = "Data Model for SatelliteIngestionJobRequest."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub data: Option<SatelliteData>,
    #[doc = "Item Id used to get scenes from sentinel hub."]
...
impl SatelliteDataIngestionJob {
    pub fn new(party_id: String, associated_resource: GeoResource, collection: String) -> Self {
        Self {
            credentials: None,
            party_id,
            associated_resource,
...
pub mod satellite_data_ingestion_job {
    use super::*;
    #[doc = "Provider of satellite data. Available Value: SentinelHub."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    ...
    impl Serialize for Provider {
        ...
        {
            match self {
                Self::SentinelHub => serializer.serialize_unit_variant("Provider", 0u32, "SentinelHub"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct Scene {
    ...
    #[doc = "Data collection of the scene."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "imageFormat", default, skip_serializing_if = "Option::is_none")]
    pub image_format: Option<ImageFormat>,
    #[doc = "ItemId to fetch scenes from sentinel hub."]
    #[serde(rename = "itemId", default, skip_serializing_if = "Option::is_none")]
    pub item_id: Option<String>,
...
#[doc = "SearchApplicationDataQuery."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SearchApplicationDataQuery {
    #[doc = "Minimum average amount of material applied during the application (inclusive)."]
    #[serde(rename = "minAvgMaterial", default, skip_serializing_if = "Option::is_none")]
    pub min_avg_material: Option<f64>,
    #[doc = "Maximum average amount of material applied during the application (inclusive)."]
    #[serde(rename = "maxAvgMaterial", default, skip_serializing_if = "Option::is_none")]
    pub max_avg_material: Option<f64>,
    #[doc = "Minimum total amount of material applied during the application (inclusive)."]
    #[serde(rename = "minTotalMaterial", default, skip_serializing_if = "Option::is_none")]
    pub min_total_material: Option<f64>,
    #[doc = "Maximum total amount of material applied during the application (inclusive)."]
    #[serde(rename = "maxTotalMaterial", default, skip_serializing_if = "Option::is_none")]
    pub max_total_material: Option<f64>,
    ...
    #[serde(rename = "associatedResourceType", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "minOperationStartDateTime", default, with = "azure_core::date::rfc3339::option")]
    pub min_operation_start_date_time: Option<::time::OffsetDateTime>,
    #[doc = "Maximum start date-time of the operation data, sample format: yyyy-MM-ddTHH:mm:ssZ (inclusive)."]
    #[serde(rename = "maxOperationStartDateTime", default, with = "azure_core::date::rfc3339::option")]
    pub max_operation_start_date_time: Option<::time::OffsetDateTime>,
    #[doc = "Minimum end date-time of the operation data, sample format: yyyy-MM-ddTHH:mm:ssZ (inclusive)."]
    #[serde(rename = "minOperationEndDateTime", default, with = "azure_core::date::rfc3339::option")]
    pub min_operation_end_date_time: Option<::time::OffsetDateTime>,
    #[doc = "Maximum end date-time of the operation data, sample format: yyyy-MM-ddTHH:mm:ssZ (inclusive)."]
    #[serde(rename = "maxOperationEndDateTime", default, with = "azure_core::date::rfc3339::option")]
    pub max_operation_end_date_time: Option<::time::OffsetDateTime>,
    #[doc = "Minimum modified date-time of the operation data, sample format: yyyy-MM-ddTHH:mm:ssZ (inclusive)."]
    #[serde(rename = "minOperationModifiedDateTime", default, with = "azure_core::date::rfc3339::option")]
    pub min_operation_modified_date_time: Option<::time::OffsetDateTime>,
    #[doc = "Maximum modified date-time of the operation data, sample format: yyyy-MM-ddTHH:mm:ssZ (inclusive)."]
    #[serde(rename = "maxOperationModifiedDateTime", default, with = "azure_core::date::rfc3339::option")]
    pub max_operation_modified_date_time: Option<::time::OffsetDateTime>,
...
impl SearchApplicationDataQuery {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SearchFieldQuery {
    #[doc = "FarmIds of the resource."]
    #[serde(
        rename = "farmIds",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
...
#[doc = "SearchHarvestDataQuery."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SearchHarvestDataQuery {
    #[doc = "Minimum Yield value(inclusive)."]
    #[serde(rename = "minTotalYield", default, skip_serializing_if = "Option::is_none")]
    pub min_total_yield: Option<f64>,
    #[doc = "Maximum Yield value (inclusive)."]
    #[serde(rename = "maxTotalYield", default, skip_serializing_if = "Option::is_none")]
    pub max_total_yield: Option<f64>,
    #[doc = "Minimum AvgYield value(inclusive)."]
    #[serde(rename = "minAvgYield", default, skip_serializing_if = "Option::is_none")]
    pub min_avg_yield: Option<f64>,
    #[doc = "Maximum AvgYield value (inclusive)."]
    #[serde(rename = "maxAvgYield", default, skip_serializing_if = "Option::is_none")]
    pub max_avg_yield: Option<f64>,
    #[doc = "Minimum Total WetMass value(inclusive)."]
    #[serde(rename = "minTotalWetMass", default, skip_serializing_if = "Option::is_none")]
    pub min_total_wet_mass: Option<f64>,
    #[doc = "Maximum Total WetMass value (inclusive)."]
    #[serde(rename = "maxTotalWetMass", default, skip_serializing_if = "Option::is_none")]
    pub max_total_wet_mass: Option<f64>,
    #[doc = "Minimum AvgWetMass value(inclusive)."]
    #[serde(rename = "minAvgWetMass", default, skip_serializing_if = "Option::is_none")]
    pub min_avg_wet_mass: Option<f64>,
    #[doc = "Maximum AvgWetMass value (inclusive)."]
    #[serde(rename = "maxAvgWetMass", default, skip_serializing_if = "Option::is_none")]
    pub max_avg_wet_mass: Option<f64>,
    #[doc = "Minimum AvgMoisture value(inclusive)."]
    #[serde(rename = "minAvgMoisture", default, skip_serializing_if = "Option::is_none")]
    pub min_avg_moisture: Option<f64>,
    #[doc = "Maximum AvgMoisture value (inclusive)."]
    #[serde(rename = "maxAvgMoisture", default, skip_serializing_if = "Option::is_none")]
    pub max_avg_moisture: Option<f64>,
    #[doc = "Minimum AvgSpeed value(inclusive)."]
    #[serde(rename = "minAvgSpeed", default, skip_serializing_if = "Option::is_none")]
    pub min_avg_speed: Option<f64>,
    #[doc = "Maximum AvgSpeed value (inclusive)."]
    #[serde(rename = "maxAvgSpeed", default, skip_serializing_if = "Option::is_none")]
    pub max_avg_speed: Option<f64>,
    #[doc = "Resource Ids of the resource."]
    #[serde(
        rename = "associatedResourceIds",
        default,
...
impl SearchHarvestDataQuery {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Search stac Items parameters."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SearchItemsQuery {
    #[doc = "OAuthClientCredentials for clientId clientSecret auth."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub credentials: Option<OAuthClientCredentials>,
    #[doc = "Start datetime of the time interval in which to search for Items."]
    #[serde(rename = "startDateTime", with = "azure_core::date::rfc3339")]
    pub start_date_time: ::time::OffsetDateTime,
    #[doc = "End datetime of the time interval in which to search for Items."]
    ...
    pub bbox: Vec<f64>,
    #[doc = "Array of item ids to return."]
    #[serde(
        rename = "itemIds",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
...
#[doc = "Paged response contains list of items and next property to get the next set of results."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
impl SearchItemsResponse {
    pub fn new(items: Vec<StacItem>) -> Self {
        Self { items, next_link: None }
    }
}
#[doc = "Search All PlantTissueAnalysis and Search PlantTissueAnalyses parameters."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SearchPlantTissueAnalysisQuery {
    ...
    #[doc = "CropVariety Ids of the resource."]
    #[serde(
...
impl SearchPlantTissueAnalysisQuery {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "SearchPlantingDataQuery."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SearchPlantingDataQuery {
    #[doc = "Minimum AvgPlantingRate value(inclusive)."]
    #[serde(rename = "minAvgPlantingRate", default, skip_serializing_if = "Option::is_none")]
    pub min_avg_planting_rate: Option<f64>,
    #[doc = "Maximum AvgPlantingRate value (inclusive)."]
    #[serde(rename = "maxAvgPlantingRate", default, skip_serializing_if = "Option::is_none")]
    pub max_avg_planting_rate: Option<f64>,
...
impl SearchPlantingDataQuery {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Get Zones query parameters."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SearchPrescriptionQuery {
    #[doc = "Prescription Map Ids of the resource."]
    #[serde(
        rename = "prescriptionMapIds",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub prescription_map_ids: Vec<String>,
...
#[doc = "SearchAllBoundaries and SearchBoundaries parameters."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SearchSeasonalFieldQuery {
    #[doc = "FarmIds of the resource."]
    #[serde(
        rename = "farmIds",
        default,
...
impl SearchSeasonalFieldQuery {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "SearchTillageDataQuery."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SearchTillageDataQuery {
    #[doc = "Minimum measured tillage depth (inclusive)."]
    #[serde(rename = "minTillageDepth", default, skip_serializing_if = "Option::is_none")]
    pub min_tillage_depth: Option<f64>,
    #[doc = "Maximum measured tillage depth (inclusive)."]
    #[serde(rename = "maxTillageDepth", default, skip_serializing_if = "Option::is_none")]
    pub max_tillage_depth: Option<f64>,
    #[doc = "Minimum pressure applied to a tillage implement (inclusive)."]
    #[serde(rename = "minTillagePressure", default, skip_serializing_if = "Option::is_none")]
    pub min_tillage_pressure: Option<f64>,
    #[doc = "Maximum pressure applied to a tillage implement (inclusive)."]
    #[serde(rename = "maxTillagePressure", default, skip_serializing_if = "Option::is_none")]
    pub max_tillage_pressure: Option<f64>,
    #[doc = "Resource Ids of the resource."]
    #[serde(
        rename = "associatedResourceIds",
        default,
...
pub struct SearchZoneQuery {
    ...
    #[serde(
        rename = "managementZoneIds",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub management_zone_ids: Vec<String>,
...
#[doc = "Schema of seasonal field resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SeasonalFieldMetaData {
    #[doc = "Party Id."]
    #[serde(rename = "partyId", default, skip_serializing_if = "Option::is_none")]
    pub party_id: Option<String>,
    #[doc = "Id of the associated Farm."]
...
#[doc = "Paged response contains list of requested objects and a skipToken to get the next set of results."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SeasonalFieldMetaDataListResponse {
    #[doc = "List of requested objects."]
    pub value: Vec<SeasonalFieldMetaData>,
    #[doc = "Token used in retrieving the next page. If null, there are no additional pages."]
    #[serde(rename = "skipToken", default, skip_serializing_if = "Option::is_none")]
    pub skip_token: Option<String>,
    #[doc = "Continuation link (absolute URI) to the next page of results in the list."]
...
impl SeasonalFieldMetaDataListResponse {
    pub fn new(value: Vec<SeasonalFieldMetaData>) -> Self {
        Self {
            value,
            skip_token: None,
            next_link: None,
...
impl SensorMapping {
    pub fn new(associated_resource: GeoResource) -> Self {
        Self {
            sensor_id: None,
            sensor_partner_id: None,
            party_id: None,
...
pub struct SolutionInference {
    ...
    #[doc = "Additional Headers sent to partner."]
    #[serde(rename = "partnerRequestHeaders", default, skip_serializing_if = "Option::is_none")]
    pub partner_request_headers: Option<serde_json::Value>,
}
impl SolutionInference {
    pub fn new(request_path: String) -> Self {
        Self {
            ...
            partner_request_headers: None,
        }
    }
}
#[doc = "Schema of STAC Item.\r\nRefer for spec: https://github.com/radiantearth/stac-spec/blob/v1.0.0-beta.2/item-spec/item-spec.md#item-fields."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct StacItem {
    #[doc = "The STAC version the Stac Item implements."]
    #[serde(rename = "stacVersion")]
    pub stac_version: String,
    #[doc = "A list of extensions the Stac Item implements."]
    #[serde(
    ...
    pub links: Vec<StacItemLink>,
    #[doc = "Dictionary of asset objects, each with a unique key."]
    pub assets: serde_json::Value,
    #[doc = "The id of the STAC Collection this Stac Item references."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub collection: Option<String>,
}
impl StacItem {
...
#[doc = "Schema of tillage data resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct TillageDataMetaData {
    #[doc = "Schema for storing measurement reading and unit."]
    #[serde(rename = "tillageDepth", default, skip_serializing_if = "Option::is_none")]
    pub tillage_depth: Option<Measure>,
    #[doc = "Schema for storing measurement reading and unit."]
...
#[doc = "Paged response contains list of requested objects and a skipToken to get the next set of results."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct TillageDataMetaDataListResponse {
    #[doc = "List of requested objects."]
    pub value: Vec<TillageDataMetaData>,
    #[doc = "Token used in retrieving the next page. If null, there are no additional pages."]
    #[serde(rename = "skipToken", default, skip_serializing_if = "Option::is_none")]
    pub skip_token: Option<String>,
    #[doc = "Continuation link (absolute URI) to the next page of results in the list."]
...
impl TillageDataMetaDataListResponse {
    pub fn new(value: Vec<TillageDataMetaData>) -> Self {
        Self {
            value,
            skip_token: None,
            next_link: None,
...
#[doc = "Paged response contains list of requested objects and a skipToken to get the next set of results."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ZoneMetaDataListResponse {
    #[doc = "List of requested objects."]
    pub value: Vec<ZoneMetaData>,
    #[doc = "Token used in retrieving the next page. If null, there are no additional pages."]
    #[serde(rename = "skipToken", default, skip_serializing_if = "Option::is_none")]
    pub skip_token: Option<String>,
    #[doc = "Continuation link (absolute URI) to the next page of results in the list."]
...
impl ZoneMetaDataListResponse {
    pub fn new(value: Vec<ZoneMetaData>) -> Self {
        Self {
            value,
            skip_token: None,
            next_link: None,
