...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CascadeDeleteJobPartyBased {
    #[doc = "Party Id."]
    #[serde(rename = "partyId")]
    pub party_id: String,
    ...
    #[doc = "Status of the job.\r\nPossible values: 'Waiting', 'Running', 'Succeeded', 'Failed', 'Cancelled'."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<cascade_delete_job_party_based::Status>,
    #[doc = "Duration of the job in seconds."]
    #[serde(rename = "durationInSeconds", default, skip_serializing_if = "Option::is_none")]
    pub duration_in_seconds: Option<f64>,
    #[doc = "Status message to capture more details of the job."]
...
impl CascadeDeleteJobPartyBased {
...
pub mod cascade_delete_job_party_based {
    use super::*;
    #[doc = "Status of the job.\r\nPossible values: 'Waiting', 'Running', 'Succeeded', 'Failed', 'Cancelled'."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Status")]
...
impl FarmOperationDataIngestionJob {
    pub fn new(party_id: String, auth_provider_id: String, start_year: i32) -> Self {
        Self {
            party_id,
            auth_provider_id,
            operations: Vec::new(),
...
pub struct Locations {
    ...
    #[doc = "List of Weather Data returned by the provider."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub data: Vec<WeatherDataForPassthrough>,
}
impl Locations {
    pub fn new() -> Self {
        Self::default()
...
impl SatelliteDataIngestionJob {
    pub fn new(party_id: String, boundary_id: String, start_date_time: time::OffsetDateTime, end_date_time: time::OffsetDateTime) -> Self {
        Self {
            party_id,
            boundary_id,
            start_date_time,
...
pub struct WeatherDataForPassthrough {
    ...
    #[serde(rename = "dayOrNight", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "iconCode", default, skip_serializing_if = "Option::is_none")]
    pub icon_code: Option<String>,
    #[doc = "Code representing full set sensible weather."]
    #[serde(rename = "iconCodeExtend", default, skip_serializing_if = "Option::is_none")]
    pub icon_code_extend: Option<String>,
    #[doc = "Indicates whether there is precipitation or not."]
    #[serde(rename = "hasPrecipitation", default, skip_serializing_if = "Option::is_none")]
    pub has_precipitation: Option<bool>,
    #[doc = "Schema for storing measurement reading and unit."]
    #[serde(rename = "pressureMeanSeaLevel", default, skip_serializing_if = "Option::is_none")]
    pub pressure_mean_sea_level: Option<Measure>,
    #[doc = "Schema for storing measurement reading and unit."]
    ...
    #[serde(rename = "uvDescription", default, skip_serializing_if = "Option::is_none")]
    pub uv_description: Option<String>,
    #[doc = "Hourly maximum UV index."]
    #[serde(rename = "uvIndex", default, skip_serializing_if = "Option::is_none")]
    pub uv_index: Option<String>,
    #[doc = "Time forecast is valid in local apparent time."]
    #[serde(rename = "validTimeLocal", default, skip_serializing_if = "Option::is_none")]
    pub valid_time_local: Option<String>,
    ...
    #[serde(rename = "wxPhraseLong", default, skip_serializing_if = "Option::is_none")]
    pub wx_phrase_long: Option<String>,
    #[doc = "Hourly sensible weather phrase containing short description."]
    #[serde(rename = "wxPhraseShort", default, skip_serializing_if = "Option::is_none")]
    pub wx_phrase_short: Option<String>,
...
#[doc = "Schema of weather data."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct WeatherDataPartyBased {
    #[doc = "Party ID."]
    #[serde(rename = "partyId")]
    pub party_id: String,
    #[doc = "Boundary ID."]
...
#[doc = "Paged response contains list of requested objects and a URL link to get the next set of results."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct WeatherDataPartyBasedListResponse {
    #[doc = "List of requested objects."]
    pub value: Vec<WeatherDataPartyBased>,
    #[doc = "Token used in retrieving the next page. If null, there are no additional pages."]
    #[serde(rename = "skipToken", default, skip_serializing_if = "Option::is_none")]
    pub skip_token: Option<String>,
    #[doc = "Continuation link (absolute URI) to the next page of results in the list."]
...
impl azure_core::Continuable for WeatherDataPartyBasedListResponse {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone()
    }
}
impl WeatherDataPartyBasedListResponse {
    pub fn new(value: Vec<WeatherDataPartyBased>) -> Self {
        Self {
            value,
            skip_token: None,
            next_link: None,
...
pub struct WeatherDataProviderRequest {
    ...
    #[doc = "App id of the weather data provider."]
    #[serde(rename = "providerAppId", default, skip_serializing_if = "Option::is_none")]
    pub provider_app_id: Option<String>,
    #[doc = "Api key of the weather data provider."]
    #[serde(rename = "providerApiKey")]
    ...
    #[doc = "End of time range. Supported ranges are from 0 to 240. (Only applicable for DTN.ClearAg extension.)"]
...
impl WeatherDataProviderRequest {
    pub fn new(provider_api_key: String, extension_id: String, extension_api_name: String, units: String) -> Self {
        Self {
            locations: Vec::new(),
...
pub struct WeatherDataProviderResponse {
    ...
    #[doc = "List of locations along with corresponding weather data."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
