...
pub mod confidential_ledger_identity_service {
    ...
    pub mod get_ledger_identity {
        use super::models;
        type Response = models::LedgerIdentityInformation;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<Response, Error>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url_str = &format!("{}/ledgerIdentity/{}", this.client.endpoint(), &this.ledger_id);
                        ...
                        match rsp_status {
                            http::StatusCode::OK => {
                                ...
                                let rsp_value: models::LedgerIdentityInformation =
