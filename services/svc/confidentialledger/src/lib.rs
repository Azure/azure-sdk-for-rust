...
mod package_0_1_preview_ledger;
#[cfg(feature = "package-0.1-preview-ledger")]
pub use package_0_1_preview_ledger::{models, operations, API_VERSION};
#[cfg(feature = "package-0.1-preview-identity")]
mod package_0_1_preview_identity;
use azure_core::setters;
#[cfg(feature = "package-0.1-preview-identity")]
pub use package_0_1_preview_identity::{models, operations, API_VERSION};
pub fn config(
