...
#[cfg(feature = "package-2018-12-01-preview")]
pub mod package_2018_12_01_preview;
#[cfg(all(feature = "package-2018-12-01-preview", not(feature = "no-default-version")))]
pub use package_2018_12_01_preview::{models, operations, operations::Error};
#[cfg(feature = "package-2021-07-01-preview")]
pub mod package_2021_07_01_preview;
use azure_core::setters;
#[cfg(all(feature = "package-2021-07-01-preview", not(feature = "no-default-version")))]
pub use package_2021_07_01_preview::{models, operations, operations::Error};
pub fn config(
