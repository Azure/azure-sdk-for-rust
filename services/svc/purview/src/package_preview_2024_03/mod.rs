...
pub mod entity {
    ...
    impl Client {
        ...
        pub fn create_or_update(&self, body: impl Into<models::AtlasEntityWithExtInfo>) -> create_or_update::RequestBuilder {
        ...
        pub fn bulk_create_or_update(&self, body: impl Into<models::AtlasEntitiesWithExtInfo>) -> bulk_create_or_update::RequestBuilder {
        ...
        #[doc = "Delete a list of entities in bulk identified by their GUIDs or unique\nattributes."]
        #[doc = ""]
        #[doc = "Arguments:"]
        ...
        pub fn add_classification(&self, body: impl Into<models::ClassificationAssociateOptions>) -> add_classification::RequestBuilder {
        ...
        pub fn bulk_set_classifications(&self, body: impl Into<models::AtlasEntityHeaders>) -> bulk_set_classifications::RequestBuilder {
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `file`: InputStream of file"]
        pub fn import_business_metadata(&self, file: impl Into<bytes::Bytes>) -> import_business_metadata::RequestBuilder {
        ...
        #[doc = "Update entity partially - create or update entity attribute identified by its\nGUID.\nSupports only primitive attribute type and entity references.\nIt does not support updating complex types like arrays, and maps.\nNull updates are not possible."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `guid`: The globally unique identifier of the entity."]
        ...
        #[doc = "Arguments:"]
        #[doc = "* `guid`: The globally unique identifier of the entity."]
        #[doc = "* `body`: BusinessMetadata payload"]
        pub fn add_or_update_business_metadata(
            &self,
            guid: impl Into<String>,
            body: impl Into<serde_json::Value>,
        ...
        #[doc = "Arguments:"]
        #[doc = "* `guid`: The globally unique identifier of the entity."]
        #[doc = "* `body`: Business metadata payload"]
        pub fn remove_business_metadata(
            &self,
            guid: impl Into<String>,
            body: impl Into<serde_json::Value>,
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `business_metadata_name`: BusinessMetadata name"]
        #[doc = "* `guid`: The globally unique identifier of the entity."]
        #[doc = "* `body`: Business metadata attribute payload"]
        pub fn add_or_update_business_metadata_attributes(
            &self,
            business_metadata_name: impl Into<String>,
            guid: impl Into<String>,
            body: impl Into<serde_json::Value>,
        ) -> add_or_update_business_metadata_attributes::RequestBuilder {
            add_or_update_business_metadata_attributes::RequestBuilder {
                client: self.0.clone(),
                business_metadata_name: business_metadata_name.into(),
                guid: guid.into(),
                body: body.into(),
            }
        }
        ...
        #[doc = "Arguments:"]
        #[doc = "* `guid`: The globally unique identifier of the entity."]
        #[doc = "* `body`: An array of classifications to be added."]
        pub fn add_classifications(
            &self,
            guid: impl Into<String>,
            body: Vec<models::AtlasClassification>,
        ...
        #[doc = "Arguments:"]
        #[doc = "* `guid`: The globally unique identifier of the entity."]
        #[doc = "* `body`: An array of classifications to be updated."]
        ...
        pub fn partial_update_by_unique_attributes(
            ...
            body: impl Into<models::AtlasEntityWithExtInfo>,
        ...
        #[doc = "Delete a given classification from an entity identified by its type and unique\nattributes."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `type_name`: The name of the type."]
        #[doc = "* `classification_name`: The name of the classification."]
        ...
        #[doc = "Arguments:"]
        #[doc = "* `type_name`: The name of the type."]
        #[doc = "* `body`: An array of classification to be added."]
        ...
        #[doc = "Arguments:"]
        #[doc = "* `type_name`: The name of the type."]
        #[doc = "* `body`: An array of classification to be updated."]
        ...
        pub fn move_entities_to_collection(
            ...
            body: impl Into<models::MoveEntitiesOptions>,
    ...
    pub mod create_or_update {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::EntityMutationResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::EntityMutationResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) body: models::AtlasEntityWithExtInfo,
            pub(crate) business_attribute_update_behavior: Option<String>,
            pub(crate) collection_id: Option<String>,
        }
        impl RequestBuilder {
            #[doc = "Used to define the update behavior for business attributes when updating\nentities."]
            ...
            #[doc = "The collection where entities will be moved to. Only specify a value if you\nneed to move an entity to another collection."]
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::EntityMutationResult>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::EntityMutationResult>>;
    ...
    pub mod bulk_create_or_update {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) body: models::AtlasEntitiesWithExtInfo,
            pub(crate) collection_id: Option<String>,
            pub(crate) business_attribute_update_behavior: Option<String>,
        }
        impl RequestBuilder {
    ...
    pub mod add_classification {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) body: models::ClassificationAssociateOptions,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod bulk_set_classifications {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) body: models::AtlasEntityHeaders,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod import_business_metadata {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BulkImportResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BulkImportResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::BulkImportResult>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::BulkImportResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod add_or_update_business_metadata {
        ...
        impl RequestBuilder {
            #[doc = "Whether to overwrite the existing business metadata on the entity or not,\ndefault is false."]
    ...
    pub mod add_or_update_business_metadata_attributes {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) business_metadata_name: String,
            pub(crate) guid: String,
            pub(crate) body: serde_json::Value,
        }
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    ...
                    &self.guid, &self.business_metadata_name
                ));
                Ok(url)
            }
        }
    ...
    pub mod add_classifications {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) guid: String,
            pub(crate) body: Vec<models::AtlasClassification>,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod get_by_unique_attributes {
        ...
        impl RequestBuilder {
            ...
            #[doc = "The qualified name of the entity. (This is only an example. qualifiedName can\nbe changed to other unique attributes)"]
    ...
    pub mod move_entities_to_collection {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) body: models::MoveEntitiesOptions,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
...
pub mod glossary {
    ...
    impl Client {
        ...
        pub fn create(&self, body: impl Into<models::AtlasGlossary>) -> create::RequestBuilder {
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `glossary_id`: The globally unique identifier for glossary."]
        pub fn get(&self, glossary_id: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
        ...
        #[doc = "Arguments:"]
        #[doc = "* `glossary_id`: The globally unique identifier for glossary."]
        pub fn update(&self, glossary_id: impl Into<String>, body: impl Into<models::AtlasGlossary>) -> update::RequestBuilder {
        ...
        #[doc = "Delete a glossary. Will delete underlying terms/categories together. Recommend\nseparate delete terms and categories."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `glossary_id`: The globally unique identifier for glossary."]
        pub fn delete(&self, glossary_id: impl Into<String>) -> delete::RequestBuilder {
            delete::RequestBuilder {
                client: self.0.clone(),
                glossary_id: glossary_id.into(),
            }
        }
        #[doc = "Get the categories belonging to a specific glossary. Recommend using\nlimit/offset to get pagination result."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `glossary_id`: The globally unique identifier for glossary."]
        pub fn list_categories(&self, glossary_id: impl Into<String>) -> list_categories::RequestBuilder {
        ...
        #[doc = "Get the category headers belonging to a specific glossary. Recommend using\nlimit/offset to get pagination result."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `glossary_id`: The globally unique identifier for glossary."]
        pub fn list_categories_headers(&self, glossary_id: impl Into<String>) -> list_categories_headers::RequestBuilder {
        ...
        #[doc = "Get a specific glossary with detailed information. This API is not\nrecommend.\n\nRecommend to fetch terms/categories details separately using \n\nGET /datamap/api/atlas/v2/glossary/{glossaryId}/terms and \n\nGET /datamap/api/atlas/v2/glossary/{glossaryId}/categories."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `glossary_id`: The globally unique identifier for glossary."]
        pub fn get_detailed(&self, glossary_id: impl Into<String>) -> get_detailed::RequestBuilder {
            get_detailed::RequestBuilder {
                client: self.0.clone(),
                glossary_id: glossary_id.into(),
            }
        }
        #[doc = "Update the glossary partially. Some properties such as qualifiedName are not\nallowed to be updated.\n\nSo far we only supports partial updating\nshortDescription, longDescription, language and usage for glossary. \n\nRecommend\nusing 'ignoreTermsAndCategories=true' to reduce response body size."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `glossary_id`: The globally unique identifier for glossary."]
        #[doc = "* `body`: A map containing keys as attribute names and values as corresponding attribute\nvalues."]
        pub fn partial_update(&self, glossary_id: impl Into<String>, body: impl Into<serde_json::Value>) -> partial_update::RequestBuilder {
        ...
        #[doc = "Get terms belonging to a specific glossary. Recommend using limit/offset to get\npagination result."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `glossary_id`: The globally unique identifier for glossary."]
        pub fn list_terms(&self, glossary_id: impl Into<String>) -> list_terms::RequestBuilder {
        ...
        #[doc = "Get term headers belonging to a specific glossary. Recommend using limit/offset\nto get pagination result."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `glossary_id`: The globally unique identifier for glossary."]
        pub fn list_term_headers(&self, glossary_id: impl Into<String>) -> list_term_headers::RequestBuilder {
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `body`: An array of glossary category definitions to be created."]
        pub fn create_categories(&self, body: Vec<models::AtlasGlossaryCategory>) -> create_categories::RequestBuilder {
        ...
        pub fn create_category(&self, body: impl Into<models::AtlasGlossaryCategory>) -> create_category::RequestBuilder {
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `category_id`: The globally unique identifier of the category."]
        pub fn get_category(&self, category_id: impl Into<String>) -> get_category::RequestBuilder {
        ...
        pub fn update_category(
            ...
            body: impl Into<models::AtlasGlossaryCategory>,
        ...
        #[doc = "Arguments:"]
        #[doc = "* `category_id`: The globally unique identifier of the category."]
        pub fn delete_category(&self, category_id: impl Into<String>) -> delete_category::RequestBuilder {
            delete_category::RequestBuilder {
                client: self.0.clone(),
                category_id: category_id.into(),
            }
        }
        #[doc = "Update the glossary category partially. So far we only supports partial\nupdating shortDescription and longDescription for category."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `category_id`: The globally unique identifier of the category."]
        ...
        #[doc = "Get all related categories (parent and children). Limit, offset, and sort\nparameters are currently not being enabled and won't work even they are passed."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `category_id`: The globally unique identifier of the category."]
        pub fn list_related_categories(&self, category_id: impl Into<String>) -> list_related_categories::RequestBuilder {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `category_id`: The globally unique identifier of the category."]
        pub fn list_category_terms(&self, category_id: impl Into<String>) -> list_category_terms::RequestBuilder {
        ...
        pub fn create_term(&self, body: impl Into<models::AtlasGlossaryTerm>) -> create_term::RequestBuilder {
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `term_id`: The globally unique identifier for glossary term."]
        pub fn get_term(&self, term_id: impl Into<String>) -> get_term::RequestBuilder {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `term_id`: The globally unique identifier for glossary term."]
        pub fn update_term(&self, term_id: impl Into<String>, body: impl Into<models::AtlasGlossaryTerm>) -> update_term::RequestBuilder {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `term_id`: The globally unique identifier for glossary term."]
        pub fn delete_term(&self, term_id: impl Into<String>) -> delete_term::RequestBuilder {
            delete_term::RequestBuilder {
                client: self.0.clone(),
                term_id: term_id.into(),
            }
        }
        #[doc = "Update the glossary term partially. So far we only supports partial updating\nshortDescription, longDescription, abbreviation, usage and status for term."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `term_id`: The globally unique identifier for glossary term."]
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `body`: An array of glossary term definitions to be created in bulk."]
        pub fn create_terms(&self, body: Vec<models::AtlasGlossaryTerm>) -> create_terms::RequestBuilder {
        ...
        #[doc = "List all related objects assigned with the specified term. Recommend using\nlimit/offset to get pagination result."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `term_id`: The globally unique identifier for glossary term."]
        pub fn list_entities_assigned_with_term(&self, term_id: impl Into<String>) -> list_entities_assigned_with_term::RequestBuilder {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `term_id`: The globally unique identifier for glossary term."]
        #[doc = "* `body`: An array of related object IDs from which the term has to be dissociated."]
        ...
        #[doc = "Get all related terms for a specific term by its GUID. Limit, offset, and sort\nparameters are currently not being enabled and won't work even they are passed."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `term_id`: The globally unique identifier for glossary term."]
        pub fn list_related_terms(&self, term_id: impl Into<String>) -> list_related_terms::RequestBuilder {
    ...
    pub mod create {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) body: models::AtlasGlossary,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/atlas/v2/glossary/{}", &self.glossary_id));
                Ok(url)
            }
        }
        impl std::future::IntoFuture for RequestBuilder {
    ...
    pub mod list_categories {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/atlas/v2/glossary/{}/categories", &self.glossary_id));
                Ok(url)
            }
        }
        impl std::future::IntoFuture for RequestBuilder {
    ...
    pub mod list_categories_headers {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/atlas/v2/glossary/{}/categories/headers", &self.glossary_id));
                Ok(url)
            }
        }
        impl std::future::IntoFuture for RequestBuilder {
    ...
    pub mod get_detailed {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/atlas/v2/glossary/{}/detailed", &self.glossary_id));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01-preview");
    ...
    pub mod partial_update {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/atlas/v2/glossary/{}/partial", &self.glossary_id));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01-preview");
    ...
    pub mod list_terms {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/atlas/v2/glossary/{}/terms", &self.glossary_id));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01-preview");
    ...
    pub mod list_term_headers {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/atlas/v2/glossary/{}/terms/headers", &self.glossary_id));
                Ok(url)
            }
        }
        impl std::future::IntoFuture for RequestBuilder {
    ...
    pub mod create_categories {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) body: Vec<models::AtlasGlossaryCategory>,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod create_category {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) body: models::AtlasGlossaryCategory,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod get_category {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/atlas/v2/glossary/category/{}", &self.category_id));
                Ok(url)
            }
        }
        impl std::future::IntoFuture for RequestBuilder {
    ...
    pub mod partial_update_category {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/atlas/v2/glossary/category/{}/partial", &self.category_id));
                Ok(url)
            }
        }
        impl std::future::IntoFuture for RequestBuilder {
    ...
    pub mod list_related_categories {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/atlas/v2/glossary/category/{}/related", &self.category_id));
                Ok(url)
            }
        }
        impl std::future::IntoFuture for RequestBuilder {
    ...
    pub mod list_category_terms {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/atlas/v2/glossary/category/{}/terms", &self.category_id));
                Ok(url)
            }
        }
        impl std::future::IntoFuture for RequestBuilder {
    ...
    pub mod create_term {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) body: models::AtlasGlossaryTerm,
    ...
    pub mod get_term {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/atlas/v2/glossary/term/{}", &self.term_id));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01-preview");
    ...
    pub mod partial_update_term {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/atlas/v2/glossary/term/{}/partial", &self.term_id));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01-preview");
    ...
    pub mod create_terms {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) body: Vec<models::AtlasGlossaryTerm>,
            pub(crate) include_term_hierarchy: Option<bool>,
        }
        impl RequestBuilder {
            #[doc = "Whether include term hierarchy"]
    ...
    pub mod list_entities_assigned_with_term {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/atlas/v2/glossary/terms/{}/assignedEntities", &self.term_id));
                Ok(url)
            }
        }
        impl std::future::IntoFuture for RequestBuilder {
    ...
    pub mod assign_term_to_entities {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) term_id: String,
            pub(crate) body: Vec<models::AtlasRelatedObjectId>,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod list_related_terms {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/atlas/v2/glossary/terms/{}/related", &self.term_id));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01-preview");
...
pub mod relationship {
    ...
    impl Client {
        ...
        pub fn create(&self, body: impl Into<models::AtlasRelationship>) -> create::RequestBuilder {
            create::RequestBuilder {
                client: self.0.clone(),
                body: body.into(),
            }
        ...
        pub fn update(&self, body: impl Into<models::AtlasRelationship>) -> update::RequestBuilder {
            update::RequestBuilder {
                client: self.0.clone(),
                body: body.into(),
            }
    ...
    pub mod create {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) body: models::AtlasRelationship,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
...
pub mod type_ {
    ...
    impl Client {
        ...
        pub fn bulk_create(&self, body: impl Into<models::AtlasTypesDef>) -> bulk_create::RequestBuilder {
            bulk_create::RequestBuilder {
                client: self.0.clone(),
                body: body.into(),
            }
        }
        #[doc = "Update all types in bulk, changes detected in the type definitions would be\npersisted."]
        pub fn bulk_update(&self, body: impl Into<models::AtlasTypesDef>) -> bulk_update::RequestBuilder {
        ...
        pub fn bulk_delete(&self, body: impl Into<models::AtlasTypesDef>) -> bulk_delete::RequestBuilder {
            bulk_delete::RequestBuilder {
                client: self.0.clone(),
                body: body.into(),
            }
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `name`: The unique name of the term template."]
    ...
    pub mod bulk_create {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) body: models::AtlasTypesDef,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
...
pub mod discovery {
    ...
    impl Client {
        ...
        pub fn auto_complete(&self, body: impl Into<models::AutoCompleteOptions>) -> auto_complete::RequestBuilder {
        ...
        pub fn query(&self, body: impl Into<models::QueryOptions>) -> query::RequestBuilder {
        ...
        pub fn suggest(&self, body: impl Into<models::SuggestOptions>) -> suggest::RequestBuilder {
            suggest::RequestBuilder {
                client: self.0.clone(),
                body: body.into(),
            }
        }
        #[doc = "Navigate entities by itemPath."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `navigation_request`: An object specifying the navigation criteria."]
        pub fn navigation(&self, navigation_request: impl Into<models::NavigationRequest>) -> navigation::RequestBuilder {
            navigation::RequestBuilder {
                client: self.0.clone(),
                navigation_request: navigation_request.into(),
                maxpagesize: None,
    ...
    pub mod auto_complete {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) body: models::AutoCompleteOptions,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod query {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) body: models::QueryOptions,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod suggest {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) body: models::SuggestOptions,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod navigation {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::NavigationResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::NavigationResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) navigation_request: models::NavigationRequest,
            pub(crate) maxpagesize: Option<i32>,
            pub(crate) continuation_token: Option<String>,
        }
        impl RequestBuilder {
            #[doc = "The page size - by default the value is 100. The maximum is 10000."]
            pub fn maxpagesize(mut self, maxpagesize: i32) -> Self {
                self.maxpagesize = Some(maxpagesize);
                self
            }
            #[doc = "To achieve paginated results, invoke the API with the next continuationToken received from Navigation Result to retrieve subsequent pages."]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.navigation_request)?;
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::NavigationResult>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::NavigationResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
