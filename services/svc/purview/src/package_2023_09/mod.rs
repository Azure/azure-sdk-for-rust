...
impl Client {
    ...
    pub fn type_client(&self) -> type_::Client {
        type_::Client(self.clone())
    }
}
pub mod entity {
    use super::models;
    ...
    impl Client {
        ...
        pub fn bulk_delete(&self, guid: Vec<String>) -> bulk_delete::RequestBuilder {
        ...
        pub fn partial_update_attribute_by_guid(
            &self,
            guid: impl Into<String>,
            name: impl Into<String>,
            body: impl Into<serde_json::Value>,
        ) -> partial_update_attribute_by_guid::RequestBuilder {
            partial_update_attribute_by_guid::RequestBuilder {
                client: self.0.clone(),
                guid: guid.into(),
                name: name.into(),
        ...
        pub fn remove_classification(
            ...
            guid: impl Into<String>,
            classification_name: impl Into<String>,
        ) -> remove_classification::RequestBuilder {
            remove_classification::RequestBuilder {
                client: self.0.clone(),
                guid: guid.into(),
                classification_name: classification_name.into(),
        ...
        #[doc = "Update entity partially - Allow a subset of attributes to be updated on an entity which is identified by its type and unique attribute eg: Referenceable.qualifiedName. Null updates are not possible.\n\nIn addition to the typeName path parameter, attribute key-value pair(s) can be provided in the following format:\n\nattr:<attrName>=<attrValue>.\nNOTE: The attrName and attrValue should be unique across entities, eg. qualifiedName.\n\nThe REST request would look something like this:\nPUT /v2/entity/uniqueAttribute/type/aType?attr:aTypeAttribute=someValue."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `type_name`: The name of the type."]
        #[doc = "* `atlas_entity_with_ext_info`: Atlas entity with extended information."]
        pub fn partial_update_by_unique_attributes(
            &self,
            type_name: impl Into<String>,
            atlas_entity_with_ext_info: impl Into<models::AtlasEntityWithExtInfo>,
        ) -> partial_update_by_unique_attributes::RequestBuilder {
            partial_update_by_unique_attributes::RequestBuilder {
                client: self.0.clone(),
                type_name: type_name.into(),
        ...
        #[doc = "* `type_name`: The name of the type."]
        #[doc = "* `classification_name`: The name of the classification."]
        pub fn remove_classification_by_unique_attribute(
            &self,
            type_name: impl Into<String>,
            classification_name: impl Into<String>,
        ) -> remove_classification_by_unique_attribute::RequestBuilder {
            remove_classification_by_unique_attribute::RequestBuilder {
                client: self.0.clone(),
                type_name: type_name.into(),
                classification_name: classification_name.into(),
        ...
        pub fn bulk_set_classifications(
            &self,
            entity_headers: impl Into<models::AtlasEntityHeaders>,
        ) -> bulk_set_classifications::RequestBuilder {
            bulk_set_classifications::RequestBuilder {
                client: self.0.clone(),
        ...
        #[doc = "Arguments:"]
        #[doc = "* `type_name`: The name of the type."]
        pub fn list_by_unique_attributes(&self, type_name: impl Into<String>) -> list_by_unique_attributes::RequestBuilder {
            list_by_unique_attributes::RequestBuilder {
                client: self.0.clone(),
                type_name: type_name.into(),
                min_ext_info: None,
                ignore_relationships: None,
        ...
        #[doc = "Arguments:"]
        #[doc = "* `guid`: The globally unique identifier of the entity."]
        pub fn remove_business_metadata(&self, guid: impl Into<String>) -> remove_business_metadata::RequestBuilder {
            remove_business_metadata::RequestBuilder {
                client: self.0.clone(),
                guid: guid.into(),
                business_metadata: None,
            }
        ...
        pub fn add_or_update_business_metadata_attributes(
            ...
            add_or_update_business_metadata_attributes::RequestBuilder {
                ...
                guid: guid.into(),
                business_metadata_attributes: None,
            }
        }
        ...
        #[doc = "* `bm_name`: BusinessMetadata name"]
        #[doc = "* `guid`: The globally unique identifier of the entity."]
        pub fn remove_business_metadata_attributes(
            &self,
            bm_name: impl Into<String>,
            guid: impl Into<String>,
        ) -> remove_business_metadata_attributes::RequestBuilder {
            remove_business_metadata_attributes::RequestBuilder {
                client: self.0.clone(),
                bm_name: bm_name.into(),
                guid: guid.into(),
        ...
        #[doc = "Delete given labels to a given entity identified by its type and unique attribute.\n\nIf labels is null/empty, no labels will be removed.\n\nIf any labels in labels set are non-existing labels, they will be ignored, only existing labels will be removed. In addition to the typeName path parameter, attribute key-value pair(s) can be provided in the following format: attr:<attrName>=<attrValue>. NOTE: The attrName and attrValue should be unique across entities, eg. qualifiedName. The REST request would look something like this: DELETE /v2/entity/uniqueAttribute/type/aType?attr:aTypeAttribute=someValue."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `type_name`: The name of the type."]
        pub fn remove_labels_by_unique_attribute(&self, type_name: impl Into<String>) -> remove_labels_by_unique_attribute::RequestBuilder {
            remove_labels_by_unique_attribute::RequestBuilder {
                client: self.0.clone(),
                type_name: type_name.into(),
                attr_qualified_name: None,
                body: Vec::new(),
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `collection_id`: The collection where entities will be moved to."]
    ...
    pub mod create_or_update {
        ...
        impl RequestBuilder {
            ...
            #[doc = "The collection where entities will be moved to. Only specify a value if you need to move an entity to another collection."]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/atlas/v2/entity", self.client.endpoint(),))?;
    ...
    pub mod list_by_guids {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/atlas/v2/entity/bulk", self.client.endpoint(),))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
    ...
    pub mod partial_update_attribute_by_guid {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
    ...
    pub mod partial_update_by_unique_attributes {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
    ...
    pub mod remove_classification_by_unique_attribute {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
    ...
    pub mod bulk_set_classifications {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
    ...
    pub mod list_by_unique_attributes {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
    ...
    pub mod add_or_update_business_metadata {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) business_metadata: Option<models::BusinessMetadata>,
        }
        impl RequestBuilder {
            ...
            pub fn business_metadata(mut self, business_metadata: impl Into<models::BusinessMetadata>) -> Self {
                self.business_metadata = Some(business_metadata.into());
                self
            }
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        let req_body = if let Some(business_metadata) = &this.business_metadata {
                            req.insert_header("content-type", "application/json");
                            azure_core::to_json(business_metadata)?
                        } else {
    ...
    pub mod remove_business_metadata {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
    ...
    pub mod add_or_update_business_metadata_attributes {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) guid: String,
            pub(crate) business_metadata_attributes: Option<models::BusinessMetadataAttributes>,
        }
        impl RequestBuilder {
            pub fn business_metadata_attributes(
                mut self,
                business_metadata_attributes: impl Into<models::BusinessMetadataAttributes>,
            ) -> Self {
                self.business_metadata_attributes = Some(business_metadata_attributes.into());
                self
            }
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        let req_body = if let Some(business_metadata_attributes) = &this.business_metadata_attributes {
                            req.insert_header("content-type", "application/json");
                            azure_core::to_json(business_metadata_attributes)?
                        } else {
                            azure_core::EMPTY_BODY
                        };
                        req.set_body(req_body);
    ...
    pub mod remove_business_metadata_attributes {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
    ...
    pub mod remove_labels_by_unique_attribute {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
    ...
    pub mod move_entities_to_collection {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/entity/moveTo", self.client.endpoint(),))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
...
pub mod glossary {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Get all glossaries. Recommend using limit/offset to get pagination result. Recommend using 'ignoreTermsAndCategories=true' and fetch terms/categories separately using \n\n 'GET /datamap/api/atlas/v2/glossary/{glossaryGuid}/terms' and \n\n 'GET '/datamap/api/atlas/v2/glossary/{glossaryGuid}/categories'."]
        ...
        pub fn create(&self, atlas_glossary: impl Into<models::AtlasGlossary>) -> create::RequestBuilder {
        ...
        pub fn create_categories(&self, glossary_category: Vec<models::AtlasGlossaryCategory>) -> create_categories::RequestBuilder {
            create_categories::RequestBuilder {
                client: self.0.clone(),
                glossary_category,
            }
        }
        ...
        pub fn create_category(&self, glossary_category: impl Into<models::AtlasGlossaryCategory>) -> create_category::RequestBuilder {
            create_category::RequestBuilder {
                client: self.0.clone(),
        ...
        pub fn get_category(&self, category_guid: impl Into<String>) -> get_category::RequestBuilder {
            get_category::RequestBuilder {
                client: self.0.clone(),
        ...
        ) -> update_category::RequestBuilder {
            update_category::RequestBuilder {
                client: self.0.clone(),
                category_guid: category_guid.into(),
                glossary_category: glossary_category.into(),
        ...
        #[doc = "Arguments:"]
        #[doc = "* `category_guid`: The globally unique identifier of the category."]
        pub fn delete_category(&self, category_guid: impl Into<String>) -> delete_category::RequestBuilder {
            delete_category::RequestBuilder {
                client: self.0.clone(),
                category_guid: category_guid.into(),
            }
        }
        ...
        pub fn partial_update_category(
            &self,
            category_guid: impl Into<String>,
            partial_updates: impl Into<serde_json::Value>,
        ) -> partial_update_category::RequestBuilder {
            partial_update_category::RequestBuilder {
                client: self.0.clone(),
                category_guid: category_guid.into(),
        ...
        pub fn create_term(&self, glossary_term: impl Into<models::AtlasGlossaryTerm>) -> create_term::RequestBuilder {
            create_term::RequestBuilder {
                client: self.0.clone(),
        ...
        pub fn get_term(&self, term_guid: impl Into<String>) -> get_term::RequestBuilder {
            get_term::RequestBuilder {
                client: self.0.clone(),
        ...
        #[doc = "Arguments:"]
        #[doc = "* `term_guid`: The globally unique identifier for glossary term."]
        pub fn delete_term(&self, term_guid: impl Into<String>) -> delete_term::RequestBuilder {
            delete_term::RequestBuilder {
                client: self.0.clone(),
                term_guid: term_guid.into(),
            }
        }
        ...
        pub fn partial_update_term(
            &self,
            term_guid: impl Into<String>,
            partial_updates: impl Into<serde_json::Value>,
        ) -> partial_update_term::RequestBuilder {
            partial_update_term::RequestBuilder {
                client: self.0.clone(),
                term_guid: term_guid.into(),
                partial_updates: partial_updates.into(),
        ...
        pub fn create_terms(&self, glossary_term: Vec<models::AtlasGlossaryTerm>) -> create_terms::RequestBuilder {
            create_terms::RequestBuilder {
                client: self.0.clone(),
                glossary_term,
                include_term_hierarchy: None,
            }
        }
        #[doc = "List all related objects assigned with the specified term. Recommend using limit/offset to get pagination result."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `term_guid`: The globally unique identifier for glossary term."]
        pub fn list_entities_assigned_with_term(&self, term_guid: impl Into<String>) -> list_entities_assigned_with_term::RequestBuilder {
            list_entities_assigned_with_term::RequestBuilder {
                client: self.0.clone(),
                term_guid: term_guid.into(),
                limit: None,
                offset: None,
        ...
        pub fn get(&self, glossary_guid: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
        ...
        #[doc = "Arguments:"]
        #[doc = "* `glossary_guid`: The globally unique identifier for glossary."]
        pub fn delete(&self, glossary_guid: impl Into<String>) -> delete::RequestBuilder {
            delete::RequestBuilder {
                client: self.0.clone(),
                glossary_guid: glossary_guid.into(),
            }
        ...
        #[doc = "Arguments:"]
        #[doc = "* `glossary_guid`: The globally unique identifier for glossary."]
        pub fn list_categories(&self, glossary_guid: impl Into<String>) -> list_categories::RequestBuilder {
            list_categories::RequestBuilder {
                client: self.0.clone(),
                glossary_guid: glossary_guid.into(),
                limit: None,
                offset: None,
        ...
        #[doc = "Arguments:"]
        #[doc = "* `glossary_guid`: The globally unique identifier for glossary."]
        pub fn list_categories_headers(&self, glossary_guid: impl Into<String>) -> list_categories_headers::RequestBuilder {
            list_categories_headers::RequestBuilder {
                client: self.0.clone(),
                glossary_guid: glossary_guid.into(),
                limit: None,
                offset: None,
        ...
        #[doc = "Get a specific glossary with detailed information. This API is not recommend.\n\nRecommend to fetch terms/categories details separately using \n\n 'GET /datamap/api/atlas/v2/glossary/{glossaryGuid}/terms' and \n\n 'GET '/datamap/api/atlas/v2/glossary/{glossaryGuid}/categories'."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `glossary_guid`: The globally unique identifier for glossary."]
        pub fn get_detailed(&self, glossary_guid: impl Into<String>) -> get_detailed::RequestBuilder {
            get_detailed::RequestBuilder {
                client: self.0.clone(),
                glossary_guid: glossary_guid.into(),
            }
        }
        ...
        #[doc = "Arguments:"]
        #[doc = "* `glossary_guid`: The globally unique identifier for glossary."]
        pub fn list_terms(&self, glossary_guid: impl Into<String>) -> list_terms::RequestBuilder {
            list_terms::RequestBuilder {
                client: self.0.clone(),
                glossary_guid: glossary_guid.into(),
                limit: None,
                offset: None,
        ...
        #[doc = "Arguments:"]
        #[doc = "* `glossary_guid`: The globally unique identifier for glossary."]
        pub fn list_term_headers(&self, glossary_guid: impl Into<String>) -> list_term_headers::RequestBuilder {
            list_term_headers::RequestBuilder {
                client: self.0.clone(),
                glossary_guid: glossary_guid.into(),
                limit: None,
                offset: None,
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/atlas/v2/glossary", self.client.endpoint(),))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
    ...
    pub mod partial_update_category {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
    ...
    pub mod list_related_categories {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::RelatedCategoryHeaders> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::RelatedCategoryHeaders = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::RelatedCategoryHeaders>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::RelatedCategoryHeaders>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get_term {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/atlas/v2/glossary/term/{}", self.client.endpoint(), &self.term_guid))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
    ...
    pub mod create_terms {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/atlas/v2/glossary/terms", self.client.endpoint(),))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
    ...
    pub mod list_entities_assigned_with_term {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
    ...
    pub mod list_related_terms {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::RelatedTermHeaders> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::RelatedTermHeaders = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::RelatedTermHeaders>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::RelatedTermHeaders>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod update {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/atlas/v2/glossary/{}", self.client.endpoint(), &self.glossary_guid))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
    ...
    pub mod list_categories_headers {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
...
pub mod lineage {
    ...
    impl Client {
        ...
        pub fn get(&self, guid: impl Into<String>, direction: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                guid: guid.into(),
        ...
        #[doc = "* `guid`: The globally unique identifier of the entity."]
        #[doc = "* `direction`: The direction of the lineage, which could be INPUT, OUTPUT or BOTH."]
        pub fn get_next_page(&self, guid: impl Into<String>, direction: impl Into<String>) -> get_next_page::RequestBuilder {
            get_next_page::RequestBuilder {
                client: self.0.clone(),
                guid: guid.into(),
                direction: direction.into(),
                offset: None,
        ...
        #[doc = "Return lineage info about entity.\n\nIn addition to the typeName path parameter, attribute key-value pair(s) can be provided in the following format\n\nattr:[attrName]=[attrValue]\n\nNOTE: The attrName and attrValue should be unique across entities, eg. qualifiedName.\n\nThe REST request would look something like this:\n\nGET /v2/lineage/uniqueAttribute/type/aType?attr:aTypeAttribute=someValue."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `type_name`: The name of the type."]
        #[doc = "* `direction`: The direction of the lineage, which could be INPUT, OUTPUT or BOTH."]
        pub fn get_by_unique_attribute(
            &self,
            type_name: impl Into<String>,
            direction: impl Into<String>,
        ) -> get_by_unique_attribute::RequestBuilder {
            get_by_unique_attribute::RequestBuilder {
                client: self.0.clone(),
                type_name: type_name.into(),
                direction: direction.into(),
    ...
    pub mod get_by_unique_attribute {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
...
pub mod type_ {
    ...
    impl Client {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `guid`: The globally unique identifier of the entity."]
        pub fn get_entity_def_by_guid(&self, guid: impl Into<String>) -> get_entity_def_by_guid::RequestBuilder {
            get_entity_def_by_guid::RequestBuilder {
                client: self.0.clone(),
                guid: guid.into(),
            }
        }
        ...
        pub fn get_entity_def_by_name(&self, name: impl Into<String>) -> get_entity_def_by_name::RequestBuilder {
            get_entity_def_by_name::RequestBuilder {
                client: self.0.clone(),
                name: name.into(),
            }
        }
        ...
        pub fn get_by_name(&self, name: impl Into<String>) -> get_by_name::RequestBuilder {
        ...
        pub fn bulk_create(&self, types_def: impl Into<models::AtlasTypesDef>) -> bulk_create::RequestBuilder {
            bulk_create::RequestBuilder {
                client: self.0.clone(),
        ...
        pub fn bulk_update(&self, types_def: impl Into<models::AtlasTypesDef>) -> bulk_update::RequestBuilder {
            bulk_update::RequestBuilder {
                client: self.0.clone(),
                types_def: types_def.into(),
            }
        }
        ...
        pub fn bulk_delete(&self, types_def: impl Into<models::AtlasTypesDef>) -> bulk_delete::RequestBuilder {
            bulk_delete::RequestBuilder {
                client: self.0.clone(),
                types_def: types_def.into(),
            }
        ...
        pub fn list_headers(&self) -> list_headers::RequestBuilder {
            list_headers::RequestBuilder {
                client: self.0.clone(),
                include_term_template: None,
                type_: None,
            }
    ...
    pub mod get_entity_def_by_guid {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
    ...
    pub mod get_entity_def_by_name {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/atlas/v2/types/typedefs", self.client.endpoint(),))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
    ...
    pub mod list_headers {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/atlas/v2/types/typedefs/headers", self.client.endpoint(),))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
