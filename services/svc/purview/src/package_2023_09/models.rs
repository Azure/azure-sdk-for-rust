...
pub struct AtlasClassification {
    ...
    #[doc = "Status of the entity - can be active or deleted. Deleted entities are not removed."]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct BusinessMetadataAttributes {}
impl BusinessMetadataAttributes {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "An array of related categories."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RelatedCategoryHeaders {}
impl RelatedCategoryHeaders {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "An array of related glossary terms for the given glossary or an empty list."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RelatedTermHeaders {}
impl RelatedTermHeaders {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "See examples for the usage of search order."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SearchOrderItem {}
impl SearchOrderItem {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct SearchRequest {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub limit: Option<i32>,
    #[doc = "The token used to get next batch of data. Default 'Null' to get the first batch, and will return new token in each response unless there's no more data."]
    ...
    pub orderby: Vec<SearchOrderItem>,
...
pub struct SearchResultValue {
    ...
    #[doc = "The object type of the record. Object type is the top-level property to distinguish whether a record is an asset or a term."]
    ...
    #[doc = "The type name of the term. Could be AtlasGlossary, AtlasGlossaryTerm or AtlasGlossaryCategory."]
