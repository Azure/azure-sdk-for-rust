...
use std::str::FromStr;
#[doc = "The workflow approval task properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct Approval {
    #[serde(flatten)]
    pub workflow_task: WorkflowTask,
    #[doc = "The approval task details"]
...
pub struct ApprovalDetail {
    #[doc = "The approval type of an approval task."]
    #[serde(rename = "approvalType")]
    pub approval_type: approval_detail::ApprovalType,
    #[doc = "The status of an approval task."]
...
pub struct ApprovalResponseComment {
    #[doc = "The comment of approving or rejecting an approval request."]
...
#[doc = "The response of approvers for a workflow task."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ApproverResponse {
    #[doc = "The response for an approval task."]
...
impl TasksList {
    pub fn new(value: Vec<WorkflowTask>) -> Self {
...
pub mod workflow_task {
    ...
    impl Serialize for Type {
        ...
        {
            match self {
                Self::Approval => serializer.serialize_unit_variant("Type", 0u32, "Approval"),
                Self::SimpleTask => serializer.serialize_unit_variant("Type", 1u32, "SimpleTask"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
