...
pub mod received_shares {
    ...
    impl Client {
        #[doc = "Get a received share by unique id."]
        #[doc = "Get a received share"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `received_share_id`: Id of the received share"]
        pub fn get(&self, received_share_id: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                received_share_id: received_share_id.into(),
            }
        }
        #[doc = "Create or replace a received share."]
        #[doc = "Update changes to a received share"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `received_share_id`: Id of the received share"]
        #[doc = "* `received_share`: The received share to create or replace"]
        ...
        #[doc = "Arguments:"]
        #[doc = "* `received_share_id`: Id of the received share"]
        pub fn delete(&self, received_share_id: impl Into<String>) -> delete::RequestBuilder {
            delete::RequestBuilder {
                client: self.0.clone(),
                received_share_id: received_share_id.into(),
            }
        }
        #[doc = "Get a list of attached received shares."]
        #[doc = "List attached received shares"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `reference_name`: A name that references a data store."]
        pub fn list_attached(&self, reference_name: impl Into<String>) -> list_attached::RequestBuilder {
            list_attached::RequestBuilder {
                client: self.0.clone(),
        ...
        #[doc = "List detached received shares"]
        pub fn list_detached(&self) -> list_detached::RequestBuilder {
            list_detached::RequestBuilder {
                client: self.0.clone(),
                skip_token: None,
                filter: None,
                orderby: None,
        ...
        pub fn activate_tenant_email_registration(
            &self,
            tenant_email_registration: impl Into<models::TenantEmailRegistration>,
        ) -> activate_tenant_email_registration::RequestBuilder {
            activate_tenant_email_registration::RequestBuilder {
                client: self.0.clone(),
        ...
        pub fn register_tenant_email_registration(&self) -> register_tenant_email_registration::RequestBuilder {
            register_tenant_email_registration::RequestBuilder {
                client: self.0.clone(),
                repeatability_request_id: None,
            }
        }
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        let url =
                            azure_core::Url::parse(&format!("{}/receivedShares/{}", this.client.endpoint(), &this.received_share_id))?;
                        ...
                        req.url_mut()
                            .query_pairs_mut()
                            .append_pair(azure_core::query_param::API_VERSION, "2023-02-15-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::ReceivedShare>>;
    ...
    pub mod list_attached {
        use super::models;
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ReceivedShareList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ReceivedShareList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::ReceivedShareList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core::Url::parse(&format!("{}/receivedShares/attached", this.client.endpoint(),))?;
                        let rsp = match continuation {
                            ...
                            None => {
                                ...
                                req.url_mut()
                                    .query_pairs_mut()
                                    .append_pair(azure_core::query_param::API_VERSION, "2023-02-15-preview");
                                let reference_name = &this.reference_name;
                                req.url_mut().query_pairs_mut().append_pair("referenceName", reference_name);
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::ReceivedShareList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core::Url::parse(&format!("{}/receivedShares/detached", this.client.endpoint(),))?;
                        let rsp = match continuation {
                            Some(value) => {
                                url.set_path("");
                                url = url.join(&value)?;
    ...
    pub mod activate_tenant_email_registration {
        use super::models;
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::TenantEmailRegistration> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::TenantEmailRegistration = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core::Url::parse(&format!("{}/emails:activate", this.client.endpoint(),))?;
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::TenantEmailRegistration>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::TenantEmailRegistration>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod register_tenant_email_registration {
        use super::models;
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::TenantEmailRegistration> {
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core::Url::parse(&format!("{}/emails:register", this.client.endpoint(),))?;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Post);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
...
pub mod sent_shares {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Get a list of sent shares."]
        #[doc = "List sent shares"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `reference_name`: A name that references a data store."]
        pub fn list(&self, reference_name: impl Into<String>) -> list::RequestBuilder {
            list::RequestBuilder {
                client: self.0.clone(),
                reference_name: reference_name.into(),
                skip_token: None,
        ...
        #[doc = "Get a sent share by guid."]
        #[doc = "Get a sent share"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `sent_share_id`: Id of the sent share"]
        pub fn get(&self, sent_share_id: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                sent_share_id: sent_share_id.into(),
            }
        }
        ...
        #[doc = "Arguments:"]
        #[doc = "* `sent_share_id`: Id of the sent share"]
        #[doc = "* `sent_share`: The sent share to create or replace."]
        pub fn create_or_replace(
            &self,
        ...
        #[doc = "Arguments:"]
        #[doc = "* `sent_share_id`: Id of the sent share"]
        pub fn delete(&self, sent_share_id: impl Into<String>) -> delete::RequestBuilder {
            delete::RequestBuilder {
                client: self.0.clone(),
                sent_share_id: sent_share_id.into(),
            }
        }
        #[doc = "List all sent share invitations in a sent share"]
        #[doc = "List sent share recipients"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `sent_share_id`: Id of the sent share"]
        pub fn list_invitations(&self, sent_share_id: impl Into<String>) -> list_invitations::RequestBuilder {
        ...
        #[doc = "Get sent share invitation for a given sent share"]
        #[doc = "Get recipient for a given sent share"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `sent_share_id`: Id of the sent share"]
        #[doc = "* `sent_share_invitation_id`: Id of the sent share invitation"]
        pub fn get_invitation(
            &self,
            sent_share_id: impl Into<String>,
            sent_share_invitation_id: impl Into<String>,
        ) -> get_invitation::RequestBuilder {
            get_invitation::RequestBuilder {
                client: self.0.clone(),
                sent_share_id: sent_share_id.into(),
                sent_share_invitation_id: sent_share_invitation_id.into(),
            }
        }
        ...
        pub fn delete_invitation(
            ...
            sent_share_id: impl Into<String>,
            sent_share_invitation_id: impl Into<String>,
        ) -> delete_invitation::RequestBuilder {
            delete_invitation::RequestBuilder {
                client: self.0.clone(),
                sent_share_id: sent_share_id.into(),
                sent_share_invitation_id: sent_share_invitation_id.into(),
        ...
        #[doc = "Notifies the recipient of the sent share invitation."]
        #[doc = "Notifies the user recipient of the sent share invitation, does not apply to service invitations."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `sent_share_id`: Id of the sent share"]
        #[doc = "* `sent_share_invitation_id`: Id of the sent share invitation"]
        pub fn notify_user_invitation(
            &self,
            sent_share_id: impl Into<String>,
            sent_share_invitation_id: impl Into<String>,
        ) -> notify_user_invitation::RequestBuilder {
            notify_user_invitation::RequestBuilder {
                client: self.0.clone(),
                sent_share_id: sent_share_id.into(),
                sent_share_invitation_id: sent_share_invitation_id.into(),
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SentShareList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SentShareList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::SentShareList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core::Url::parse(&format!("{}/sentShares/{}", this.client.endpoint(), &this.sent_share_id))?;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Get);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::SentShare>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_invitations {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SentShareInvitationList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SentShareInvitationList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::SentShareInvitationList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
    ...
    pub mod get_invitation {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::SentShareInvitation>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod notify_user_invitation {
        use super::models;
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SentShareInvitation> {
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        let url = azure_core::Url::parse(&format!(
                            "{}/sentShares/{}/sentShareInvitations/{}:notify",
                            this.client.endpoint(),
                            &this.sent_share_id,
                            &this.sent_share_invitation_id
                        ))?;
