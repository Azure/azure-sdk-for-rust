...
pub struct ReceivedShareList {
    ...
    #[doc = "Collection of items of type ReceivedShare"]
...
pub struct SentShareInvitationList {
    ...
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
    #[doc = "Collection of items of type SentShareInvitation"]
...
pub struct SentShareList {
    ...
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
    #[doc = "Collection of items of type SentShare"]
...
pub struct ShareResource {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "A count of Received Shares associated with the Microsoft.Azure.Purview.Share.ApiService.V3.DataTransferObjects.ShareResource."]
    #[serde(rename = "receivedSharesCount", default, skip_serializing_if = "Option::is_none")]
    pub received_shares_count: Option<i32>,
    #[doc = "A count of Sent Shares associated with the Microsoft.Azure.Purview.Share.ApiService.V3.DataTransferObjects.ShareResource."]
...
#[doc = "A page of ShareResource results."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ShareResourceList {
    #[doc = "The Url of next result page."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
    #[doc = "Collection of items of type ShareResource"]
    pub value: Vec<ShareResource>,
}
...
impl ShareResourceList {
    pub fn new(value: Vec<ShareResource>) -> Self {
        Self { next_link: None, value }
    }
}
#[doc = "Share status."]
