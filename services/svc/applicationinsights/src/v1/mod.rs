...
azure_core::static_url!(DEFAULT_ENDPOINT, "https://api.applicationinsights.io/v1");
impl ClientBuilder {
...
pub mod metrics {
    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::MetricsResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::MetricsResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::MetricsResult>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::MetricsResult>>;
    ...
    pub mod get_multiple {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::MetricsResults> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::MetricsResults = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::MetricsResults>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::MetricsResults>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod events {
    ...
    pub mod get_by_type {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::EventsResults> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::EventsResults = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::EventsResults>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::EventsResults>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
