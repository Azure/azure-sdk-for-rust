...
impl Client {
    ...
    pub fn list_schema_groups(&self) -> list_schema_groups::RequestBuilder {
        list_schema_groups::RequestBuilder { client: self.clone() }
    }
    #[doc = "Get properties for existing schema."]
    ...
    #[doc = ""]
    #[doc = "Arguments:"]
    #[doc = "* `group_name`: Name of schema group."]
    #[doc = "* `schema_name`: Name of schema."]
    #[doc = "* `schema_content`: String representation (UTF-8) of the schema."]
    pub fn get_schema_properties_by_content(
        &self,
        group_name: impl Into<String>,
        schema_name: impl Into<String>,
        schema_content: impl Into<String>,
    ) -> get_schema_properties_by_content::RequestBuilder {
        get_schema_properties_by_content::RequestBuilder {
            client: self.clone(),
    ...
    pub fn register_schema(
        ...
        schema_name: impl Into<String>,
        schema_content: impl Into<String>,
    ) -> register_schema::RequestBuilder {
        register_schema::RequestBuilder {
            client: self.clone(),
            group_name: group_name.into(),
            schema_name: schema_name.into(),
    ...
    pub fn list_schema_versions(
        ...
        group_name: impl Into<String>,
        schema_name: impl Into<String>,
    ) -> list_schema_versions::RequestBuilder {
        list_schema_versions::RequestBuilder {
            client: self.clone(),
            group_name: group_name.into(),
            schema_name: schema_name.into(),
    ...
    pub fn get_schema_by_version(
        ...
        schema_name: impl Into<String>,
        schema_version: i32,
    ) -> get_schema_by_version::RequestBuilder {
        get_schema_by_version::RequestBuilder {
            client: self.clone(),
            group_name: group_name.into(),
            schema_name: schema_name.into(),
    ...
    #[doc = ""]
    #[doc = "Arguments:"]
    #[doc = "* `id`: Schema ID that uniquely identifies a schema in the registry namespace."]
    pub fn get_schema_by_id(&self, id: impl Into<String>) -> get_schema_by_id::RequestBuilder {
        get_schema_by_id::RequestBuilder {
            client: self.clone(),
            id: id.into(),
        }
    }
}
pub mod list_schema_groups {
    use super::models;
...
pub mod get_schema_properties_by_content {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/$schemaGroups/{}/schemas/{}:get-id", &self.group_name, &self.schema_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "2023-07-01");
...
pub mod register_schema {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/$schemaGroups/{}/schemas/{}", &self.group_name, &self.schema_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "2023-07-01");
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            ...
            url.set_path(&format!(
                ...
                &self.group_name, &self.schema_name
            ));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
...
pub mod get_schema_by_version {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            ...
            url.set_path(&format!(
                "/$schemaGroups/{}/schemas/{}/versions/{}",
                &self.group_name, &self.schema_name, &self.schema_version
            ));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
...
pub mod get_schema_by_id {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/$schemaGroups/$schemas/{}", &self.id));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "2023-07-01");
