...
pub mod digital_twin_models {
    ...
    pub async fn list(
        ...
        x_ms_max_item_count: Option<i64>,
    ) -> std::result::Result<models::PagedModelDataCollection, list::Error> {
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                ...
                let rsp_value: models::PagedModelDataCollection =
    ...
    pub async fn add(
    ...
    ) -> std::result::Result<models::NonPagedModelDataCollection, add::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!("{}/models", operation_config.base_path(),);
        ...
        match rsp.status() {
            http::StatusCode::CREATED => {
                let rsp_body = rsp.body();
                let rsp_value: models::NonPagedModelDataCollection =
    ...
    pub async fn get_by_id(
        ...
        id: &str,
        include_model_definition: Option<bool>,
    ) -> std::result::Result<models::ModelData, get_by_id::Error> {
        let http_client = operation_config.http_client();
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::ModelData =
...
pub mod digital_twins {
    ...
    pub async fn add_relationship(
        ...
        id: &str,
        relationship_id: &str,
        relationship: Option<&serde_json::Value>,
        if_none_match: Option<&str>,
        ...
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        let req_body = if let Some(relationship) = relationship {
            req_builder = req_builder.header("content-type", "application/json");
            azure_core::to_json(relationship).map_err(add_relationship::Error::SerializeError)?
        } else {
            bytes::Bytes::from_static(azure_core::EMPTY_BODY)
        };
        if let Some(if_none_match) = if_none_match {
    ...
    pub async fn update_relationship(
        ...
        id: &str,
        relationship_id: &str,
        patch_document: Option<&[&serde_json::Value]>,
        if_match: Option<&str>,
        ...
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        let req_body = if let Some(patch_document) = patch_document {
            req_builder = req_builder.header("content-type", "application/json");
            azure_core::to_json(patch_document).map_err(update_relationship::Error::SerializeError)?
        } else {
            bytes::Bytes::from_static(azure_core::EMPTY_BODY)
        };
        if let Some(if_match) = if_match {
    ...
    pub async fn send_telemetry(
        ...
        req_builder = req_builder.header("dt-id", dt_id);
        if let Some(dt_timestamp) = dt_timestamp {
            req_builder = req_builder.header("dt-timestamp", dt_timestamp);
        }
        req_builder = req_builder.uri(url.as_str());
    ...
    pub async fn update_component(
        ...
        let req_body = if let Some(patch_document) = patch_document {
            req_builder = req_builder.header("content-type", "application/json");
            azure_core::to_json(patch_document).map_err(update_component::Error::SerializeError)?
        } else {
            bytes::Bytes::from_static(azure_core::EMPTY_BODY)
        };
        if let Some(if_match) = if_match {
