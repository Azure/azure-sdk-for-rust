...
#[doc = "A job which contains a reference to the operations to perform, results, and execution metadata."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DeleteJob {
    #[doc = "The identifier of the delete job."]
...
#[doc = "A collection of delete job objects."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DeleteJobCollection {
    #[doc = "The list of delete job objects."]
    pub value: Vec<DeleteJob>,
    #[doc = "A URI to retrieve the next page of results."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for DeleteJobCollection {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl DeleteJobCollection {
    pub fn new(value: Vec<DeleteJob>) -> Self {
...
pub struct ImportJob {
    #[doc = "The identifier of the import job."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "The path to the input Azure storage blob that contains file(s) describing the operations to perform in the job."]
    #[serde(rename = "inputBlobUri")]
    pub input_blob_uri: String,
    #[doc = "The path to the output Azure storage blob that will contain the errors and progress logs of import job."]
...
impl ImportJob {
    pub fn new(input_blob_uri: String, output_blob_uri: String) -> Self {
        Self {
            id: None,
            input_blob_uri,
            output_blob_uri,
...
#[doc = "A collection of import job objects."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ImportJobCollection {
    #[doc = "The list of import job objects."]
