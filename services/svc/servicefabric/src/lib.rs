...
pub use v6_5::{models, operations, operations::Error};
#[cfg(feature = "7.0")]
pub mod v7_0;
#[cfg(all(feature = "7.0", not(feature = "no-default-version")))]
pub use v7_0::{models, operations, operations::Error};
#[cfg(feature = "7.1")]
pub mod v7_1;
#[cfg(all(feature = "7.1", not(feature = "no-default-version")))]
pub use v7_1::{models, operations, operations::Error};
#[cfg(feature = "7.2")]
pub mod v7_2;
#[cfg(all(feature = "7.2", not(feature = "no-default-version")))]
pub use v7_2::{models, operations, operations::Error};
#[cfg(feature = "8.0")]
pub mod v8_0;
