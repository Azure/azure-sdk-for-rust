...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct Probe {
    #[doc = "The initial delay in seconds to start executing probe once code package has started."]
...
#[doc = "The run to completion execution policy"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
