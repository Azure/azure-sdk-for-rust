...
pub struct ImageReference {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub version: Option<String>,
    #[doc = "This is the resource ID when using a community image."]
    ...
    #[doc = "This is the resource ID when using a direct shared image."]
    #[serde(rename = "sharedGalleryImageId", default, skip_serializing_if = "Option::is_none")]
    pub shared_gallery_image_id: Option<String>,
    #[doc = "This is the version of the community or direct shared image."]
...
pub struct SecurityProfile {
    ...
    #[doc = "Identifies if the VM is a Trusted VM or a Confidential VM"]
...
#[doc = "This is the response from the GetVersions operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct Versions {
    #[doc = "List of API versions supported."]
    #[serde(
        rename = "apiVersions",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
