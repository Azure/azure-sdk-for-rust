...
pub struct AttestedData {
    #[doc = "This is the encoded string containing the VM ID, plan information, public key, timestamp, and nonce value."]
...
pub struct Compute {
    ...
    #[doc = "This is the base64 encoded custom data for the running VM."]
