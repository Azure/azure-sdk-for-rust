...
pub mod certificate_profile_operations {
    ...
    impl Client {
        #[doc = "Submit a sign operation."]
        #[doc = "Submit a sign operation under the created account and profile name provided."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `account_name`: Azure Trusted Signing account name."]
        #[doc = "* `certificate_profile`: Azure Trusted Signing certificate profile name under an account."]
        #[doc = "* `body`: Body parameter."]
        pub fn sign(
            &self,
            account_name: impl Into<String>,
            certificate_profile: impl Into<String>,
            body: impl Into<models::SigningPayloadOptions>,
        ) -> sign::RequestBuilder {
            sign::RequestBuilder {
                client: self.0.clone(),
                account_name: account_name.into(),
                certificate_profile: certificate_profile.into(),
                body: body.into(),
                client_version: None,
                x_correlation_id: None,
            }
        }
        #[doc = "Gets the status of a signing operation."]
        #[doc = "This status operation requires that a Sign request has been submitted and the operationId is known."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `account_name`: Signing account name."]
        #[doc = "* `certificate_profile`: Signing Certificate profile name."]
        ...
        ) -> get_signing_status::RequestBuilder {
            get_signing_status::RequestBuilder {
                client: self.0.clone(),
                account_name: account_name.into(),
                certificate_profile: certificate_profile.into(),
        ...
        #[doc = "* `account_name`: Azure Trusted Signing account name."]
        #[doc = "* `certificate_profile`: Azure Trusted Signing certificate profile name under an account."]
        pub fn list_extended_key_usages(
            &self,
            account_name: impl Into<String>,
            certificate_profile: impl Into<String>,
        ) -> list_extended_key_usages::RequestBuilder {
            list_extended_key_usages::RequestBuilder {
                client: self.0.clone(),
                account_name: account_name.into(),
                certificate_profile: certificate_profile.into(),
        ...
        #[doc = "Gets the signing root certificate on the certificate chain for that account and profile name."]
    ...
    pub mod sign {
        ...
        impl<'a> Headers<'a> {
            ...
            pub fn x_ms_error_code(&self) -> azure_core::Result<&str> {
                self.0.get_str(&azure_core::headers::HeaderName::from_static("x-ms-error-code"))
            }
        }
        #[derive(Clone)]
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) certificate_profile: String,
            pub(crate) body: models::SigningPayloadOptions,
            pub(crate) client_version: Option<String>,
            pub(crate) x_correlation_id: Option<String>,
        }
        impl RequestBuilder {
            ...
            pub fn x_correlation_id(mut self, x_correlation_id: impl Into<String>) -> Self {
                self.x_correlation_id = Some(x_correlation_id.into());
                self
            }
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        if let Some(client_version) = &this.client_version {
                            req.insert_header("client-version", client_version);
                        }
                        if let Some(x_correlation_id) = &this.x_correlation_id {
                            req.insert_header("x-correlation-id", x_correlation_id);
                        }
    ...
    pub mod list_extended_key_usages {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
