...
impl Client {
    ...
    pub fn test_profile_administration_client(&self) -> test_profile_administration::Client {
        test_profile_administration::Client(self.clone())
    }
    pub fn test_profile_run_administration_client(&self) -> test_profile_run_administration::Client {
        test_profile_run_administration::Client(self.clone())
    }
}
pub mod test_profile_run_administration {
    use super::models;
    ...
    impl Client {
        #[doc = "List test profile runs."]
        #[doc = "Get all test profile runs for the given filters."]
        pub fn list_test_profile_runs(&self) -> list_test_profile_runs::RequestBuilder {
            list_test_profile_runs::RequestBuilder {
                client: self.0.clone(),
                maxpagesize: None,
                ...
                created_date_start_time: None,
                created_date_end_time: None,
                test_profile_run_ids: None,
                test_profile_ids: None,
                statuses: None,
            }
        }
        #[doc = "Get test profile run details."]
        #[doc = "Get test profile run details by test profile run Id."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `test_profile_run_id`: Unique identifier for the test profile run, must contain only lower-case alphabetic, numeric, underscore or hyphen characters."]
        pub fn get_test_profile_run(&self, test_profile_run_id: impl Into<String>) -> get_test_profile_run::RequestBuilder {
            get_test_profile_run::RequestBuilder {
                client: self.0.clone(),
                test_profile_run_id: test_profile_run_id.into(),
            }
        }
        #[doc = "Create and start a new test profile run."]
        #[doc = "Create and start a new test profile run with the given test profile run Id."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `test_profile_run_id`: Unique identifier for the test profile run, must contain only lower-case alphabetic, numeric, underscore or hyphen characters."]
        #[doc = "* `body`: The resource instance."]
        pub fn create_or_update_test_profile_run(
            &self,
            test_profile_run_id: impl Into<String>,
            body: impl Into<models::TestProfileRunCreateOrUpdate>,
        ) -> create_or_update_test_profile_run::RequestBuilder {
            create_or_update_test_profile_run::RequestBuilder {
                client: self.0.clone(),
                test_profile_run_id: test_profile_run_id.into(),
                body: body.into(),
        ...
        #[doc = "Delete an existing load test profile run."]
        #[doc = "Delete an existing load test profile run by providing the test profile run Id."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `test_profile_run_id`: Unique identifier for the test profile run, must contain only lower-case alphabetic, numeric, underscore or hyphen characters."]
        pub fn delete_test_profile_run(&self, test_profile_run_id: impl Into<String>) -> delete_test_profile_run::RequestBuilder {
            delete_test_profile_run::RequestBuilder {
                client: self.0.clone(),
                test_profile_run_id: test_profile_run_id.into(),
            }
        }
        #[doc = "Stop test profile run."]
        #[doc = "Stop test profile run for the given test profile run Id."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `test_profile_run_id`: Unique identifier for the test profile run, must contain only lower-case alphabetic, numeric, underscore or hyphen characters."]
        pub fn stop_test_profile_run(&self, test_profile_run_id: impl Into<String>) -> stop_test_profile_run::RequestBuilder {
            stop_test_profile_run::RequestBuilder {
                client: self.0.clone(),
                test_profile_run_id: test_profile_run_id.into(),
            }
        }
    }
    pub mod list_test_profile_runs {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::PagedTestProfileRun> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::PagedTestProfileRun = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) created_date_start_time: Option<::time::OffsetDateTime>,
            pub(crate) created_date_end_time: Option<::time::OffsetDateTime>,
            pub(crate) test_profile_run_ids: Option<String>,
            pub(crate) test_profile_ids: Option<String>,
            pub(crate) statuses: Option<String>,
        }
        impl RequestBuilder {
            ...
            #[doc = "Minimum Start DateTime(RFC 3339 literal format) of the test profile runs to filter on."]
            ...
            #[doc = "Maximum Start DateTime(RFC 3339 literal format) of the test profile runs to filter on."]
            ...
            #[doc = "Minimum End DateTime(RFC 3339 literal format) of the test profile runs to filter on."]
            ...
            #[doc = "Maximum End DateTime(RFC 3339 literal format) of the test profile runs to filter on."]
            ...
            #[doc = "Start DateTime(RFC 3339 literal format) of the created time range to filter test profile runs."]
            pub fn created_date_start_time(mut self, created_date_start_time: impl Into<::time::OffsetDateTime>) -> Self {
                self.created_date_start_time = Some(created_date_start_time.into());
                self
            }
            #[doc = "End DateTime(RFC 3339 literal format) of the created time range to filter test profile runs."]
            pub fn created_date_end_time(mut self, created_date_end_time: impl Into<::time::OffsetDateTime>) -> Self {
                self.created_date_end_time = Some(created_date_end_time.into());
                self
            }
            #[doc = "Comma separated list of IDs of the test profile runs to filter."]
            pub fn test_profile_run_ids(mut self, test_profile_run_ids: impl Into<String>) -> Self {
                self.test_profile_run_ids = Some(test_profile_run_ids.into());
                self
            }
            #[doc = "Comma separated IDs of the test profiles which should be associated with the test profile runs to fetch."]
            pub fn test_profile_ids(mut self, test_profile_ids: impl Into<String>) -> Self {
                self.test_profile_ids = Some(test_profile_ids.into());
                self
            }
            #[doc = "Comma separated list of Statuses of the test profile runs to filter."]
            pub fn statuses(mut self, statuses: impl Into<String>) -> Self {
                self.statuses = Some(statuses.into());
                self
            }
            pub fn into_stream(self) -> azure_core::Pageable<models::PagedTestProfileRun, azure_core::error::Error> {
                    ...
                    async move {
                        ...
                        let rsp = match continuation {
                            ...
                            None => {
                                ...
                                if let Some(created_date_start_time) = &this.created_date_start_time {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair("createdDateStartTime", &created_date_start_time.to_string());
                                }
                                if let Some(created_date_end_time) = &this.created_date_end_time {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair("createdDateEndTime", &created_date_end_time.to_string());
                                }
                                if let Some(test_profile_run_ids) = &this.test_profile_run_ids {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair("testProfileRunIds", test_profile_run_ids);
                                }
                                if let Some(test_profile_ids) = &this.test_profile_ids {
                                    req.url_mut().query_pairs_mut().append_pair("testProfileIds", test_profile_ids);
                                }
                                if let Some(statuses) = &this.statuses {
                                    req.url_mut().query_pairs_mut().append_pair("statuses", statuses);
                                }
                                let req_body = azure_core::EMPTY_BODY;
                                req.set_body(req_body);
                                this.client.send(&mut req).await?
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path("/test-profile-runs");
    ...
    pub mod get_test_profile_run {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::TestProfileRun> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::TestProfileRun = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) test_profile_run_id: String,
        }
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/test-profile-runs/{}", &self.test_profile_run_id));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-05-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::TestProfileRun>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::TestProfileRun>>;
    ...
    pub mod create_or_update_test_profile_run {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) test_profile_run_id: String,
            pub(crate) body: models::TestProfileRunCreateOrUpdate,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod delete_test_profile_run {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
    ...
    pub mod stop_test_profile_run {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/test-profile-runs/{}:stop", &self.test_profile_run_id));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-05-01-preview");
...
pub mod test_profile_administration {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List test profiles."]
        #[doc = "Get all test profiles for the given filters."]
        pub fn list_test_profiles(&self) -> list_test_profiles::RequestBuilder {
            list_test_profiles::RequestBuilder {
                client: self.0.clone(),
                maxpagesize: None,
        ...
        #[doc = "Get load test profile details."]
        #[doc = "Get load test profile details by test profile Id."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `test_profile_id`: Unique identifier for the test profile, must contain only lower-case alphabetic, numeric, underscore or hyphen characters."]
        pub fn get_test_profile(&self, test_profile_id: impl Into<String>) -> get_test_profile::RequestBuilder {
            get_test_profile::RequestBuilder {
                client: self.0.clone(),
                test_profile_id: test_profile_id.into(),
            }
        }
        #[doc = "Create a new test profile or update an existing test profile."]
        #[doc = "Create a new test profile or update an existing test profile by providing the test profile Id."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `test_profile_id`: Unique identifier for the test profile, must contain only lower-case alphabetic, numeric, underscore or hyphen characters."]
        #[doc = "* `body`: The resource instance."]
        pub fn create_or_update_test_profile(
            &self,
            test_profile_id: impl Into<String>,
            body: impl Into<models::TestProfileCreateOrUpdate>,
        ) -> create_or_update_test_profile::RequestBuilder {
            create_or_update_test_profile::RequestBuilder {
                client: self.0.clone(),
                test_profile_id: test_profile_id.into(),
                body: body.into(),
        ...
        #[doc = "Delete a test profile."]
        #[doc = "Delete a test profile by its test profile Id."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `test_profile_id`: Unique identifier for the test profile, must contain only lower-case alphabetic, numeric, underscore or hyphen characters."]
        pub fn delete_test_profile(&self, test_profile_id: impl Into<String>) -> delete_test_profile::RequestBuilder {
            delete_test_profile::RequestBuilder {
                client: self.0.clone(),
                test_profile_id: test_profile_id.into(),
            }
        }
    }
    pub mod list_test_profiles {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::PagedTestProfile> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::PagedTestProfile = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            #[doc = "Start DateTime(RFC 3339 literal format) of the last updated time range to filter test profiles."]
            ...
            #[doc = "End DateTime(RFC 3339 literal format) of the last updated time range to filter test profiles."]
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::PagedTestProfile, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
                        let rsp = match continuation {
                            ...
                            None => {
                                ...
                                if let Some(test_ids) = &this.test_ids {
                                    req.url_mut().query_pairs_mut().append_pair("testIds", test_ids);
                                }
                                let req_body = azure_core::EMPTY_BODY;
                                req.set_body(req_body);
                                this.client.send(&mut req).await?
    ...
    pub mod get_test_profile {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::TestProfile> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::TestProfile = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) test_profile_id: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/test-profiles/{}", &self.test_profile_id));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-05-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::TestProfile>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::TestProfile>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_update_test_profile {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) test_profile_id: String,
            pub(crate) body: models::TestProfileCreateOrUpdate,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
