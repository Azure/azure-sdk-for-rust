...
mod package_1_1_preview;
#[cfg(feature = "package-1.1-preview")]
pub use package_1_1_preview::{models, operations, API_VERSION};
#[cfg(feature = "package-2021-04-30-preview")]
mod package_2021_04_30_preview;
#[cfg(feature = "package-2021-04-30-preview")]
pub use package_2021_04_30_preview::{models, operations, API_VERSION};
#[cfg(feature = "package-1.0")]
mod package_1_0;
use azure_core::setters;
#[cfg(feature = "package-1.0")]
pub use package_1_0::{models, operations, API_VERSION};
pub fn config(
