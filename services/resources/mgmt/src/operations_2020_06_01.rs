...
pub mod tags {
    ...
    pub async fn get_at_scope(configuration: &Configuration, scope: &str) -> Result<TagsResource> {
        let client = &configuration.client;
        let uri_str = &format!("{}/{}/providers/Microsoft.Resources/tags/default", &configuration.base_path, scope);
        let mut req_builder = client.get(uri_str);
        if let Some(token) = &configuration.bearer_access_token {
            req_builder = req_builder.bearer_auth(token);
        }
    ...
    pub async fn create_or_update_at_scope(configuration: &Configuration, scope: &str, parameters: &TagsResource) -> Result<TagsResource> {
        let client = &configuration.client;
        let uri_str = &format!("{}/{}/providers/Microsoft.Resources/tags/default", &configuration.base_path, scope);
        let mut req_builder = client.put(uri_str);
        if let Some(token) = &configuration.bearer_access_token {
    ...
    pub async fn update_at_scope(configuration: &Configuration, scope: &str, parameters: &TagsPatchResource) -> Result<TagsResource> {
        let client = &configuration.client;
        let uri_str = &format!("{}/{}/providers/Microsoft.Resources/tags/default", &configuration.base_path, scope);
        let mut req_builder = client.patch(uri_str);
        if let Some(token) = &configuration.bearer_access_token {
    ...
    pub async fn delete_at_scope(configuration: &Configuration, scope: &str) -> Result<CloudError> {
        let client = &configuration.client;
        let uri_str = &format!("{}/{}/providers/Microsoft.Resources/tags/default", &configuration.base_path, scope);
        let mut req_builder = client.delete(uri_str);
        if let Some(token) = &configuration.bearer_access_token {
