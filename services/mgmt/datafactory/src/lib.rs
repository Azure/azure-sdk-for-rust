...
pub use package_2018_06::{models, operations, operations::Client, operations::ClientBuilder};
...
pub use package_2017_09_preview::{models, operations, operations::Client, operations::ClientBuilder};
