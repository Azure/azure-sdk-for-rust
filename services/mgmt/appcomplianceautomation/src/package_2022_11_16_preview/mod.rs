...
impl Client {
    ...
    pub fn snapshot_client(&self) -> snapshot::Client {
        snapshot::Client(self.clone())
    }
...
pub mod operations {
    ...
    impl Client {
        #[doc = "Lists all of the available REST API operations of the Microsoft.AppComplianceAutomation provider."]
    ...
    pub mod list {
        ...
        impl RequestBuilder {
                        ...
                        let rsp = match continuation {
                            Some(value) => {
                                ...
                                if !has_api_version_already {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair(azure_core::query_param::API_VERSION, "2022-11-16-preview");
                                }
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!("/providers/Microsoft.AppComplianceAutomation/operations",));
...
pub mod reports {
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ReportResourceList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ReportResourceList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) offer_guid: Option<String>,
            pub(crate) report_creator_tenant_id: Option<String>,
        }
        impl RequestBuilder {
            ...
            pub fn offer_guid(mut self, offer_guid: impl Into<String>) -> Self {
                self.offer_guid = Some(offer_guid.into());
                self
            }
            #[doc = "The tenant id of the report creator."]
            pub fn report_creator_tenant_id(mut self, report_creator_tenant_id: impl Into<String>) -> Self {
                self.report_creator_tenant_id = Some(report_creator_tenant_id.into());
                self
            }
            pub fn into_stream(self) -> azure_core::Pageable<models::ReportResourceList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
                        let rsp = match continuation {
                            ...
                            None => {
                                ...
                                if let Some(offer_guid) = &this.offer_guid {
                                    req.url_mut().query_pairs_mut().append_pair("offerGuid", offer_guid);
                                }
                                if let Some(report_creator_tenant_id) = &this.report_creator_tenant_id {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair("reportCreatorTenantId", report_creator_tenant_id);
                                }
                                let req_body = azure_core::EMPTY_BODY;
                                req.set_body(req_body);
                                this.client.send(&mut req).await?
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.AppComplianceAutomation/reports",));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-11-16-preview");
...
pub mod report {
    ...
    impl Client {
        ...
        pub fn get(&self, report_name: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                report_name: report_name.into(),
            }
        }
        #[doc = "Create a new AppComplianceAutomation report or update an exiting AppComplianceAutomation report."]
        #[doc = ""]
        #[doc = "Arguments:"]
        ...
        pub fn create_or_update(
            &self,
            parameters: impl Into<models::ReportResource>,
        ...
        #[doc = "* `parameters`: Parameters for the create or update operation"]
        #[doc = "* `report_name`: Report Name."]
        pub fn update(&self, parameters: impl Into<models::ReportResourcePatch>, report_name: impl Into<String>) -> update::RequestBuilder {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `report_name`: Report Name."]
        pub fn delete(&self, report_name: impl Into<String>) -> delete::RequestBuilder {
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ReportResource> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ReportResource = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ReportResource>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ReportResource>>;
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) parameters: models::ReportResource,
            pub(crate) report_name: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
    ...
    pub mod update {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) parameters: models::ReportResourcePatch,
            pub(crate) report_name: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
...
pub mod snapshots {
    ...
    impl Client {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `report_name`: Report Name."]
        pub fn list(&self, report_name: impl Into<String>) -> list::RequestBuilder {
            list::RequestBuilder {
                client: self.0.clone(),
                report_name: report_name.into(),
                skip_token: None,
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SnapshotResourceList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SnapshotResourceList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::SnapshotResourceList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/providers/Microsoft.AppComplianceAutomation/reports/{}/snapshots",
                    &self.report_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
...
pub mod snapshot {
    ...
    impl Client {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `report_name`: Report Name."]
        #[doc = "* `snapshot_name`: Snapshot Name."]
        pub fn get(&self, report_name: impl Into<String>, snapshot_name: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                report_name: report_name.into(),
        ...
        #[doc = "* `report_name`: Report Name."]
        #[doc = "* `snapshot_name`: Snapshot Name."]
        #[doc = "* `parameters`: Parameters for the query operation"]
        pub fn download(
            &self,
            report_name: impl Into<String>,
            snapshot_name: impl Into<String>,
            parameters: impl Into<models::SnapshotDownloadRequest>,
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SnapshotResource> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SnapshotResource = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/providers/Microsoft.AppComplianceAutomation/reports/{}/snapshots/{}",
                    &self.report_name, &self.snapshot_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::SnapshotResource>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::SnapshotResource>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod download {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DownloadResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DownloadResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) report_name: String,
            pub(crate) snapshot_name: String,
            pub(crate) parameters: models::SnapshotDownloadRequest,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/providers/Microsoft.AppComplianceAutomation/reports/{}/snapshots/{}/download",
                    &self.report_name, &self.snapshot_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DownloadResponse>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DownloadResponse>>;
            #[doc = "Returns a future that polls the long running operation, returning once the operation completes."]
            #[doc = ""]
            #[doc = "To only submit the request but not monitor the status of the operation until completion, use `send()` instead."]
            #[doc = ""]
