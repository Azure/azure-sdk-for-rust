...
pub use package_2022_06_01::{models, operations, operations::Client, operations::ClientBuilder};
#[cfg(feature = "package-2022-05-26")]
pub mod package_2022_05_26;
#[cfg(all(feature = "package-2022-05-26", not(feature = "no-default-tag")))]
pub use package_2022_05_26::{models, operations, operations::Client, operations::ClientBuilder};
