...
#[doc = "Enum representing the status of an async operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "AsyncOperationStatusEnum")]
pub enum AsyncOperationStatusEnum {
    Running,
    Complete,
    Failed,
    #[serde(skip_deserializing)]
...
impl FromStr for AsyncOperationStatusEnum {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for AsyncOperationStatusEnum {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for AsyncOperationStatusEnum {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Running => serializer.serialize_unit_variant("AsyncOperationStatusEnum", 0u32, "Running"),
            Self::Complete => serializer.serialize_unit_variant("AsyncOperationStatusEnum", 1u32, "Complete"),
            Self::Failed => serializer.serialize_unit_variant("AsyncOperationStatusEnum", 2u32, "Failed"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AsyncOperationStatusProperties {
    #[doc = "The CSV file from the reportUrl and secondaryReportUrl blob link will consist of the following columns of benefit utilization data. UtilizedPercentage will be 0 for savings plans reports and non data bricks reservations. Utilization percentages will be 0 for data bricks reservations."]
    #[serde(rename = "reportUrl", default, skip_serializing_if = "Option::is_none")]
    pub report_url: Option<BenefitUtilizationSummaryReportSchema>,
    #[doc = "The CSV file from the reportUrl and secondaryReportUrl blob link will consist of the following columns of benefit utilization data. UtilizedPercentage will be 0 for savings plans reports and non data bricks reservations. Utilization percentages will be 0 for data bricks reservations."]
    #[serde(rename = "secondaryReportUrl", default, skip_serializing_if = "Option::is_none")]
    pub secondary_report_url: Option<BenefitUtilizationSummaryReportSchema>,
...
impl AsyncOperationStatusProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct BenefitUtilizationSummariesOperationStatus {
    #[doc = "Properties of an async benefit utilization summaries request."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub input: Option<BenefitUtilizationSummariesRequest>,
    #[doc = "Enum representing the status of an async operation."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<AsyncOperationStatusEnum>,
    #[doc = "Object representing the report url and valid until date of the async report generated."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<AsyncOperationStatusProperties>,
}
impl BenefitUtilizationSummariesOperationStatus {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Properties of an async benefit utilization summaries request."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct BenefitUtilizationSummariesRequest {
...
impl BenefitUtilizationSummariesRequest {
    pub fn new(grain: Grain, start_date: ::time::OffsetDateTime, end_date: ::time::OffsetDateTime) -> Self {
        Self {
...
#[doc = "The CSV file from the reportUrl and secondaryReportUrl blob link will consist of the following columns of benefit utilization data. UtilizedPercentage will be 0 for savings plans reports and non data bricks reservations. Utilization percentages will be 0 for data bricks reservations."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "BenefitUtilizationSummaryReportSchema")]
pub enum BenefitUtilizationSummaryReportSchema {
    Kind,
...
impl FromStr for BenefitUtilizationSummaryReportSchema {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for BenefitUtilizationSummaryReportSchema {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for BenefitUtilizationSummaryReportSchema {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Kind => serializer.serialize_unit_variant("BenefitUtilizationSummaryReportSchema", 0u32, "Kind"),
            Self::AvgUtilizationPercentage => {
                serializer.serialize_unit_variant("BenefitUtilizationSummaryReportSchema", 1u32, "AvgUtilizationPercentage")
            }
            Self::BenefitOrderId => serializer.serialize_unit_variant("BenefitUtilizationSummaryReportSchema", 2u32, "BenefitOrderId"),
            Self::BenefitId => serializer.serialize_unit_variant("BenefitUtilizationSummaryReportSchema", 3u32, "BenefitId"),
            Self::BenefitType => serializer.serialize_unit_variant("BenefitUtilizationSummaryReportSchema", 4u32, "BenefitType"),
            Self::MaxUtilizationPercentage => {
                serializer.serialize_unit_variant("BenefitUtilizationSummaryReportSchema", 5u32, "MaxUtilizationPercentage")
            }
            Self::MinUtilizationPercentage => {
                serializer.serialize_unit_variant("BenefitUtilizationSummaryReportSchema", 6u32, "MinUtilizationPercentage")
            }
            Self::UsageDate => serializer.serialize_unit_variant("BenefitUtilizationSummaryReportSchema", 7u32, "UsageDate"),
            Self::UtilizedPercentage => {
                serializer.serialize_unit_variant("BenefitUtilizationSummaryReportSchema", 8u32, "UtilizedPercentage")
            }
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
...
pub struct CommonExportProperties {
    ...
    #[doc = "Allow customers to select overwrite data(OverwritePreviousReport) for exports. This setting will enable overwrite data for the same month in customer storage account. By default set to CreateNewReport."]
    #[serde(rename = "dataOverwriteBehavior", default, skip_serializing_if = "Option::is_none")]
    pub data_overwrite_behavior: Option<common_export_properties::DataOverwriteBehavior>,
    #[doc = "Allow customers to select compress data(gzip) for exports. This setting will enable destination file compression scheme at runtime. By default set to None."]
    #[serde(rename = "compressionMode", default, skip_serializing_if = "Option::is_none")]
    pub compression_mode: Option<common_export_properties::CompressionMode>,
    #[doc = "The export description set by customer at time of export creation/update."]
    #[serde(rename = "exportDescription", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "systemSuspensionContext", default, skip_serializing_if = "Option::is_none")]
    pub system_suspension_context: Option<ExportSuspensionContext>,
}
impl CommonExportProperties {
    pub fn new(delivery_info: ExportDeliveryInfo, definition: ExportDefinition) -> Self {
        Self {
            ...
            run_history: None,
            partition_data: None,
            data_overwrite_behavior: None,
            compression_mode: None,
            export_description: None,
            next_run_time_estimate: None,
            system_suspension_context: None,
        }
    }
}
pub mod common_export_properties {
    ...
    #[doc = "Allow customers to select overwrite data(OverwritePreviousReport) for exports. This setting will enable overwrite data for the same month in customer storage account. By default set to CreateNewReport."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "DataOverwriteBehavior")]
    pub enum DataOverwriteBehavior {
        OverwritePreviousReport,
        CreateNewReport,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for DataOverwriteBehavior {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for DataOverwriteBehavior {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for DataOverwriteBehavior {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::OverwritePreviousReport => {
                    serializer.serialize_unit_variant("DataOverwriteBehavior", 0u32, "OverwritePreviousReport")
                }
                Self::CreateNewReport => serializer.serialize_unit_variant("DataOverwriteBehavior", 1u32, "CreateNewReport"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for CompressionMode {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Gzip => serializer.serialize_unit_variant("CompressionMode", 0u32, "gzip"),
                Self::None => serializer.serialize_unit_variant("CompressionMode", 1u32, "None"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct ExportDataset {
    #[doc = "The granularity of rows in the export. Currently 'Daily' is supported for most cases."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct ExportDatasetConfiguration {
    #[doc = "This is on path to deprecation and will not be supported going forward."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    ...
    #[doc = "The data version for the selected for the export. If not provided then the export will default to latest data version."]
    #[serde(rename = "dataVersion", default, skip_serializing_if = "Option::is_none")]
    pub data_version: Option<String>,
    #[doc = "Filters associated with the data sets."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub filters: Vec<FilterItems>,
}
...
pub struct ExportDefinition {
    ...
    #[doc = "The date range for data in the export. This should only be specified with timeFrame set to 'Custom'. The maximum date range is 1 month."]
    ...
    impl Serialize for Type {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::FocusCost => serializer.serialize_unit_variant("Type", 3u32, "FocusCost"),
                Self::PriceSheet => serializer.serialize_unit_variant("Type", 4u32, "PriceSheet"),
                Self::ReservationTransactions => serializer.serialize_unit_variant("Type", 5u32, "ReservationTransactions"),
                Self::ReservationRecommendations => serializer.serialize_unit_variant("Type", 6u32, "ReservationRecommendations"),
                Self::ReservationDetails => serializer.serialize_unit_variant("Type", 7u32, "ReservationDetails"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for Timeframe {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::TheCurrentMonth => serializer.serialize_unit_variant("Timeframe", 6u32, "TheCurrentMonth"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct ExportDeliveryDestination {
    #[doc = "The export delivery destination type. Currently only 'AzureBlob' is supported."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<export_delivery_destination::Type>,
...
pub mod export_delivery_destination {
    use super::*;
    #[doc = "The export delivery destination type. Currently only 'AzureBlob' is supported."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Type")]
    ...
    impl Serialize for Type {
        ...
        {
            match self {
                Self::AzureBlob => serializer.serialize_unit_variant("Type", 0u32, "AzureBlob"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct ExportRunProperties {
    ...
    #[doc = "The manifest file location(URI location) for the exported files."]
...
pub struct ExportSchedule {
    #[doc = "The status of the export's schedule. If 'Inactive', the export's schedule is paused. 'SystemSuspended' can only be set by export service."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    impl Serialize for Status {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::SystemSuspended => serializer.serialize_unit_variant("Status", 2u32, "SystemSuspended"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "The properties of the export run."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ExportSuspensionContext {
    #[doc = "The code for export suspension."]
    #[serde(rename = "suspensionCode", default, skip_serializing_if = "Option::is_none")]
    pub suspension_code: Option<String>,
    #[doc = "The detailed reason for export suspension."]
    #[serde(rename = "suspensionReason", default, skip_serializing_if = "Option::is_none")]
    pub suspension_reason: Option<String>,
    #[doc = "The time when the export was suspended."]
    #[serde(rename = "suspensionTime", default, with = "azure_core::date::rfc3339::option")]
    pub suspension_time: Option<::time::OffsetDateTime>,
}
impl ExportSuspensionContext {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Will contain the filter name and value to operate on. This is currently only supported for Export Definition type of ReservationRecommendations."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct FilterItems {
    #[doc = "The name of the filter. This is currently only supported for Export Definition type of ReservationRecommendations. Supported names are ['ReservationScope', 'LookBackPeriod', 'ResourceType']"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<filter_items::Name>,
    #[doc = "Value to filter by. Currently values supported per name are, for 'ReservationScope' supported values are ['Single', 'Shared'], for 'LookBackPeriod' supported values are ['Last7Days', 'Last30Days', 'Last60Days'] and for 'ResourceType' supported values are ['VirtualMachines', 'SQLDatabases', 'PostgreSQL', 'ManagedDisk', 'MySQL', 'RedHat', 'MariaDB', 'RedisCache', 'CosmosDB', 'SqlDataWarehouse', 'SUSELinux', 'AppService', 'BlockBlob', 'AzureDataExplorer', 'VMwareCloudSimple']."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub mod filter_items {
    ...
    impl Serialize for Name {
        ...
        {
            match self {
                Self::ReservationScope => serializer.serialize_unit_variant("Name", 0u32, "ReservationScope"),
                Self::ResourceType => serializer.serialize_unit_variant("Name", 1u32, "ResourceType"),
                Self::LookBackPeriod => serializer.serialize_unit_variant("Name", 2u32, "LookBackPeriod"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
