...
impl Client {
    ...
    pub fn benefit_recommendations_client(&self) -> benefit_recommendations::Client {
        benefit_recommendations::Client(self.clone())
    }
    pub fn benefit_utilization_summaries_client(&self) -> benefit_utilization_summaries::Client {
        benefit_utilization_summaries::Client(self.clone())
    }
    ...
    pub fn generate_benefit_utilization_summaries_report_client(&self) -> generate_benefit_utilization_summaries_report::Client {
        generate_benefit_utilization_summaries_report::Client(self.clone())
    }
    pub fn generate_cost_details_report_client(&self) -> generate_cost_details_report::Client {
        generate_cost_details_report::Client(self.clone())
    }
    ...
    pub mod list {
        ...
        impl RequestBuilder {
                        ...
                        let rsp = match continuation {
                            Some(value) => {
                                ...
                                if !has_api_version_already {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
                                }
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path("/providers/Microsoft.CostManagement/operations");
...
pub mod benefit_recommendations {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BenefitRecommendationsListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BenefitRecommendationsListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::BenefitRecommendationsListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
...
pub mod benefit_utilization_summaries {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    impl Client {
        ...
        pub fn list_by_billing_account_id(&self, billing_account_id: impl Into<String>) -> list_by_billing_account_id::RequestBuilder {
            list_by_billing_account_id::RequestBuilder {
                client: self.0.clone(),
                billing_account_id: billing_account_id.into(),
                grain_parameter: None,
                filter: None,
            }
        }
        ...
        pub fn list_by_billing_profile_id(
            &self,
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `savings_plan_order_id`: Savings plan order ID."]
        pub fn list_by_savings_plan_order(&self, savings_plan_order_id: impl Into<String>) -> list_by_savings_plan_order::RequestBuilder {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `savings_plan_order_id`: Savings plan order ID."]
        #[doc = "* `savings_plan_id`: Savings plan ID."]
        pub fn list_by_savings_plan_id(
            &self,
            savings_plan_order_id: impl Into<String>,
            savings_plan_id: impl Into<String>,
        ) -> list_by_savings_plan_id::RequestBuilder {
            list_by_savings_plan_id::RequestBuilder {
                client: self.0.clone(),
                savings_plan_order_id: savings_plan_order_id.into(),
    ...
    pub mod list_by_billing_account_id {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BenefitUtilizationSummariesListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BenefitUtilizationSummariesListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) grain_parameter: Option<String>,
            pub(crate) filter: Option<String>,
        }
        impl RequestBuilder {
            #[doc = "Grain."]
            pub fn grain_parameter(mut self, grain_parameter: impl Into<String>) -> Self {
                self.grain_parameter = Some(grain_parameter.into());
                self
            }
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::BenefitUtilizationSummariesListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
                        let rsp = match continuation {
                            ...
                            None => {
                                ...
                                let bearer_token = this.client.bearer_token().await?;
                                req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                                if let Some(grain_parameter) = &this.grain_parameter {
                                    req.url_mut().query_pairs_mut().append_pair("grainParameter", grain_parameter);
                                }
                                if let Some(filter) = &this.filter {
                                    req.url_mut().query_pairs_mut().append_pair("filter", filter);
                                }
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/providers/Microsoft.Billing/billingAccounts/{}/providers/Microsoft.CostManagement/benefitUtilizationSummaries",
    ...
    pub mod list_by_billing_profile_id {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/providers/Microsoft.Billing/billingAccounts/{}/billingProfiles/{}/providers/Microsoft.CostManagement/benefitUtilizationSummaries" , & self . billing_account_id , & self . billing_profile_id)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
    ...
    pub mod list_by_savings_plan_order {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/providers/Microsoft.BillingBenefits/savingsPlanOrders/{}/providers/Microsoft.CostManagement/benefitUtilizationSummaries" , & self . savings_plan_order_id)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
    ...
    pub mod list_by_savings_plan_id {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/providers/Microsoft.BillingBenefits/savingsPlanOrders/{}/savingsPlans/{}/providers/Microsoft.CostManagement/benefitUtilizationSummaries" , & self . savings_plan_order_id , & self . savings_plan_id)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
...
pub mod generate_benefit_utilization_summaries_report {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    impl Client {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `billing_account_id`: Billing account ID"]
        #[doc = "* `benefit_utilization_summaries_request`: Async Benefit Utilization Summary report to be created."]
        pub fn generate_by_billing_account(
            &self,
            billing_account_id: impl Into<String>,
            benefit_utilization_summaries_request: impl Into<models::BenefitUtilizationSummariesRequest>,
        ) -> generate_by_billing_account::RequestBuilder {
            generate_by_billing_account::RequestBuilder {
                client: self.0.clone(),
                billing_account_id: billing_account_id.into(),
                benefit_utilization_summaries_request: benefit_utilization_summaries_request.into(),
            }
        }
        ...
        #[doc = "* `billing_profile_id`: Billing profile ID."]
        #[doc = "* `benefit_utilization_summaries_request`: Async Benefit Utilization Summary report to be created."]
        pub fn generate_by_billing_profile(
            &self,
            billing_account_id: impl Into<String>,
            billing_profile_id: impl Into<String>,
            benefit_utilization_summaries_request: impl Into<models::BenefitUtilizationSummariesRequest>,
        ) -> generate_by_billing_profile::RequestBuilder {
            generate_by_billing_profile::RequestBuilder {
                client: self.0.clone(),
                billing_account_id: billing_account_id.into(),
                billing_profile_id: billing_profile_id.into(),
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `reservation_order_id`: Reservation Order ID"]
        #[doc = "* `benefit_utilization_summaries_request`: Async Benefit Utilization Summary report to be created."]
        pub fn generate_by_reservation_order_id(
            &self,
            reservation_order_id: impl Into<String>,
            benefit_utilization_summaries_request: impl Into<models::BenefitUtilizationSummariesRequest>,
        ) -> generate_by_reservation_order_id::RequestBuilder {
            generate_by_reservation_order_id::RequestBuilder {
                client: self.0.clone(),
        ...
        #[doc = "Arguments:"]
        #[doc = "* `reservation_order_id`: Reservation Order ID"]
        #[doc = "* `reservation_id`: Reservation ID"]
        #[doc = "* `benefit_utilization_summaries_request`: Async Benefit Utilization Summary report to be created."]
        pub fn generate_by_reservation_id(
            &self,
            reservation_order_id: impl Into<String>,
            reservation_id: impl Into<String>,
            benefit_utilization_summaries_request: impl Into<models::BenefitUtilizationSummariesRequest>,
        ) -> generate_by_reservation_id::RequestBuilder {
            generate_by_reservation_id::RequestBuilder {
                client: self.0.clone(),
                reservation_order_id: reservation_order_id.into(),
        ...
        #[doc = "* `savings_plan_order_id`: Savings plan order ID."]
        #[doc = "* `benefit_utilization_summaries_request`: Async Benefit Utilization Summary report to be created."]
        pub fn generate_by_savings_plan_order_id(
            &self,
            savings_plan_order_id: impl Into<String>,
            benefit_utilization_summaries_request: impl Into<models::BenefitUtilizationSummariesRequest>,
        ) -> generate_by_savings_plan_order_id::RequestBuilder {
            generate_by_savings_plan_order_id::RequestBuilder {
                client: self.0.clone(),
                savings_plan_order_id: savings_plan_order_id.into(),
                benefit_utilization_summaries_request: benefit_utilization_summaries_request.into(),
        ...
        #[doc = "* `savings_plan_id`: Savings plan ID."]
        #[doc = "* `benefit_utilization_summaries_request`: Async Benefit Utilization Summary report to be created."]
        pub fn generate_by_savings_plan_id(
            &self,
            savings_plan_order_id: impl Into<String>,
            savings_plan_id: impl Into<String>,
            benefit_utilization_summaries_request: impl Into<models::BenefitUtilizationSummariesRequest>,
        ) -> generate_by_savings_plan_id::RequestBuilder {
            generate_by_savings_plan_id::RequestBuilder {
                client: self.0.clone(),
                savings_plan_order_id: savings_plan_order_id.into(),
                savings_plan_id: savings_plan_id.into(),
    ...
    pub mod generate_by_billing_account {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BenefitUtilizationSummariesOperationStatus> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BenefitUtilizationSummariesOperationStatus = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) billing_account_id: String,
            pub(crate) benefit_utilization_summaries_request: models::BenefitUtilizationSummariesRequest,
        }
        impl RequestBuilder {
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        let req_body = azure_core::to_json(&this.benefit_utilization_summaries_request)?;
                        req.set_body(req_body);
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/providers/Microsoft.Billing/billingAccounts/{}/providers/Microsoft.CostManagement/generateBenefitUtilizationSummariesReport" , & self . billing_account_id)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::BenefitUtilizationSummariesOperationStatus>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::BenefitUtilizationSummariesOperationStatus>>;
    ...
    pub mod generate_by_billing_profile {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/providers/Microsoft.Billing/billingAccounts/{}/billingProfiles/{}/providers/Microsoft.CostManagement/generateBenefitUtilizationSummariesReport" , & self . billing_account_id , & self . billing_profile_id)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
    ...
    pub mod generate_by_reservation_order_id {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/providers/Microsoft.Capacity/reservationorders/{}/providers/Microsoft.CostManagement/generateBenefitUtilizationSummariesReport" , & self . reservation_order_id)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
    ...
    pub mod generate_by_reservation_id {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/providers/Microsoft.Capacity/reservationorders/{}/reservations/{}/providers/Microsoft.CostManagement/generateBenefitUtilizationSummariesReport" , & self . reservation_order_id , & self . reservation_id)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
    ...
    pub mod generate_by_savings_plan_order_id {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/providers/Microsoft.BillingBenefits/savingsPlanOrders/{}/providers/Microsoft.CostManagement/generateBenefitUtilizationSummariesReport" , & self . savings_plan_order_id)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
    ...
    pub mod generate_by_savings_plan_id {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/providers/Microsoft.BillingBenefits/savingsPlanOrders/{}/savingsPlans/{}/providers/Microsoft.CostManagement/generateBenefitUtilizationSummariesReport" , & self . savings_plan_order_id , & self . savings_plan_id)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
...
pub mod exports {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/{}/providers/Microsoft.CostManagement/exports", &self.scope));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ExportListResult>>;
    ...
    pub mod get {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::Export>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod execute {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) scope: String,
            pub(crate) export_name: String,
            pub(crate) parameters: Option<models::ExportRunRequest>,
        }
        impl RequestBuilder {
            #[doc = "Parameters supplied to the CreateOrUpdate Export operation."]
            pub fn parameters(mut self, parameters: impl Into<models::ExportRunRequest>) -> Self {
    ...
    pub mod get_execution_history {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ExportExecutionListResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod generate_cost_details_report {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    impl Client {
        ...
        #[doc = "Get the result of the specified operation. This link is provided in the CostDetails creation request response Location header."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `scope`: The ARM Resource ID for subscription, billing account, or other billing scopes.Currently Resource Group and Management Group are not supported. For details, see https://aka.ms/costmgmt/scopes."]
        #[doc = "* `operation_id`: The target operation Id."]
        pub fn get_operation_results(
            &self,
            scope: impl Into<String>,
    ...
    pub mod create_operation {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CostDetailsOperationResults> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CostDetailsOperationResults = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) scope: String,
            pub(crate) parameters: models::GenerateCostDetailsReportRequestDefinition,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::CostDetailsOperationResults>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::CostDetailsOperationResults>>;
            #[doc = "Returns a future that polls the long running operation, returning once the operation completes."]
            #[doc = ""]
            #[doc = "To only submit the request but not monitor the status of the operation until completion, use `send()` instead."]
            #[doc = ""]
...
pub mod generate_detailed_cost_report {
    ...
    impl Client {
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `scope`: The ARM Resource ID for subscription, resource group, billing account, or other billing scopes. For details, see https://aka.ms/costmgmt/scopes."]
    ...
    pub mod create_operation {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::GenerateDetailedCostReportOperationResult>>;
            #[doc = "Returns a future that polls the long running operation, returning once the operation completes."]
            #[doc = ""]
            #[doc = "To only submit the request but not monitor the status of the operation until completion, use `send()` instead."]
            #[doc = ""]
...
pub mod generate_detailed_cost_report_operation_results {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets the result of the specified operation. The link with this operationId is provided as a response header of the initial request."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `operation_id`: The target operation Id."]
        #[doc = "* `scope`: The ARM Resource ID for subscription, resource group, billing account, or other billing scopes. For details, see https://aka.ms/costmgmt/scopes."]
...
pub mod generate_detailed_cost_report_operation_status {
    ...
    pub mod get {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::GenerateDetailedCostReportOperationStatuses>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod views {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path("/providers/Microsoft.CostManagement/views");
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
    ...
    pub mod list_by_scope {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/{}/providers/Microsoft.CostManagement/views", &self.scope));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.CostManagement/views/{}", &self.view_name));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::View>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod alerts {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/{}/providers/Microsoft.CostManagement/alerts", &self.scope));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::AlertsResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_external {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/providers/Microsoft.CostManagement/{}/{}/alerts",
                    &self.external_cloud_provider_type, &self.external_cloud_provider_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
...
pub mod forecast {
    ...
    pub mod usage {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/{}/providers/Microsoft.CostManagement/forecast", &self.scope));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ForecastResult>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ForecastResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod dimensions {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/{}/providers/Microsoft.CostManagement/dimensions", &self.scope));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
...
pub mod query {
    ...
    pub mod usage {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/{}/providers/Microsoft.CostManagement/query", &self.scope));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
...
pub mod generate_reservation_details_report {
    ...
    impl Client {
        ...
        ) -> by_billing_account_id::RequestBuilder {
            by_billing_account_id::RequestBuilder {
                client: self.0.clone(),
                billing_account_id: billing_account_id.into(),
        ...
        pub fn by_billing_profile_id(
            ...
            start_date: impl Into<String>,
            end_date: impl Into<String>,
        ) -> by_billing_profile_id::RequestBuilder {
            by_billing_profile_id::RequestBuilder {
                client: self.0.clone(),
                billing_account_id: billing_account_id.into(),
                billing_profile_id: billing_profile_id.into(),
    ...
    pub mod by_billing_account_id {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/providers/Microsoft.Billing/billingAccounts/{}/providers/Microsoft.CostManagement/generateReservationDetailsReport",
                    &self.billing_account_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod by_billing_profile_id {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/providers/Microsoft.Billing/billingAccounts/{}/billingProfiles/{}/providers/Microsoft.CostManagement/generateReservationDetailsReport" , & self . billing_account_id , & self . billing_profile_id)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
...
pub mod price_sheet {
    ...
    pub mod download {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/providers/Microsoft.Billing/billingAccounts/{}/billingProfiles/{}/invoices/{}/providers/Microsoft.CostManagement/pricesheets/default/download" , & self . billing_account_name , & self . billing_profile_name , & self . invoice_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
    ...
    pub mod download_by_billing_profile {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/providers/Microsoft.Billing/billingAccounts/{}/billingProfiles/{}/providers/Microsoft.CostManagement/pricesheets/default/download" , & self . billing_account_name , & self . billing_profile_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
...
pub mod scheduled_actions {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List all private scheduled actions."]
        pub fn list(&self) -> list::RequestBuilder {
            list::RequestBuilder {
                client: self.0.clone(),
                filter: None,
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `scope`: The scope associated with scheduled action operations. This includes 'subscriptions/{subscriptionId}' for subscription scope, 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}' for resourceGroup scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}' for Billing Account scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/departments/{departmentId}' for Department scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/enrollmentAccounts/{enrollmentAccountId}' for EnrollmentAccount scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}' for BillingProfile scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/invoiceSections/{invoiceSectionId}' for InvoiceSection scope, 'providers/Microsoft.CostManagement/externalBillingAccounts/{externalBillingAccountName}' for External Billing Account scope and 'providers/Microsoft.CostManagement/externalSubscriptions/{externalSubscriptionName}' for External Subscription scope. Note: Insight Alerts are only available on subscription scope."]
        pub fn list_by_scope(&self, scope: impl Into<String>) -> list_by_scope::RequestBuilder {
            list_by_scope::RequestBuilder {
                client: self.0.clone(),
                scope: scope.into(),
        ...
        #[doc = "Get the private scheduled action by name."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `name`: Scheduled action name."]
        pub fn get(&self, name: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                name: name.into(),
            }
        }
        #[doc = "Create or update a private scheduled action."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `name`: Scheduled action name."]
        #[doc = "* `scheduled_action`: Scheduled action to be created or updated."]
        pub fn create_or_update(
            &self,
            name: impl Into<String>,
            scheduled_action: impl Into<models::ScheduledAction>,
        ) -> create_or_update::RequestBuilder {
            create_or_update::RequestBuilder {
                client: self.0.clone(),
                name: name.into(),
                scheduled_action: scheduled_action.into(),
                if_match: None,
            }
        }
        #[doc = "Delete a private scheduled action."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `name`: Scheduled action name."]
        ...
        #[doc = "* `scope`: The scope associated with scheduled action operations. This includes 'subscriptions/{subscriptionId}' for subscription scope, 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}' for resourceGroup scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}' for Billing Account scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/departments/{departmentId}' for Department scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/enrollmentAccounts/{enrollmentAccountId}' for EnrollmentAccount scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}' for BillingProfile scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/invoiceSections/{invoiceSectionId}' for InvoiceSection scope, 'providers/Microsoft.CostManagement/externalBillingAccounts/{externalBillingAccountName}' for External Billing Account scope and 'providers/Microsoft.CostManagement/externalSubscriptions/{externalSubscriptionName}' for External Subscription scope. Note: Insight Alerts are only available on subscription scope."]
        #[doc = "* `name`: Scheduled action name."]
        pub fn get_by_scope(&self, scope: impl Into<String>, name: impl Into<String>) -> get_by_scope::RequestBuilder {
            get_by_scope::RequestBuilder {
                client: self.0.clone(),
                scope: scope.into(),
                name: name.into(),
        ...
        #[doc = "* `scope`: The scope associated with scheduled action operations. This includes 'subscriptions/{subscriptionId}' for subscription scope, 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}' for resourceGroup scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}' for Billing Account scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/departments/{departmentId}' for Department scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/enrollmentAccounts/{enrollmentAccountId}' for EnrollmentAccount scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}' for BillingProfile scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/invoiceSections/{invoiceSectionId}' for InvoiceSection scope, 'providers/Microsoft.CostManagement/externalBillingAccounts/{externalBillingAccountName}' for External Billing Account scope and 'providers/Microsoft.CostManagement/externalSubscriptions/{externalSubscriptionName}' for External Subscription scope. Note: Insight Alerts are only available on subscription scope."]
        #[doc = "* `name`: Scheduled action name."]
        pub fn delete_by_scope(&self, scope: impl Into<String>, name: impl Into<String>) -> delete_by_scope::RequestBuilder {
            delete_by_scope::RequestBuilder {
                client: self.0.clone(),
                scope: scope.into(),
                name: name.into(),
        ...
        #[doc = "Processes a private scheduled action."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `name`: Scheduled action name."]
        pub fn run(&self, name: impl Into<String>) -> run::RequestBuilder {
            run::RequestBuilder {
                client: self.0.clone(),
                name: name.into(),
            }
        ...
        #[doc = "* `scope`: The scope associated with scheduled action operations. This includes 'subscriptions/{subscriptionId}' for subscription scope, 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}' for resourceGroup scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}' for Billing Account scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/departments/{departmentId}' for Department scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/enrollmentAccounts/{enrollmentAccountId}' for EnrollmentAccount scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}' for BillingProfile scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/invoiceSections/{invoiceSectionId}' for InvoiceSection scope, 'providers/Microsoft.CostManagement/externalBillingAccounts/{externalBillingAccountName}' for External Billing Account scope and 'providers/Microsoft.CostManagement/externalSubscriptions/{externalSubscriptionName}' for External Subscription scope. Note: Insight Alerts are only available on subscription scope."]
        #[doc = "* `name`: Scheduled action name."]
        pub fn run_by_scope(&self, scope: impl Into<String>, name: impl Into<String>) -> run_by_scope::RequestBuilder {
            run_by_scope::RequestBuilder {
                client: self.0.clone(),
                scope: scope.into(),
                name: name.into(),
            }
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `check_name_availability_request`: Scheduled action to be created or updated."]
        ...
        #[doc = "* `scope`: The scope associated with scheduled action operations. This includes 'subscriptions/{subscriptionId}' for subscription scope, 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}' for resourceGroup scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}' for Billing Account scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/departments/{departmentId}' for Department scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/enrollmentAccounts/{enrollmentAccountId}' for EnrollmentAccount scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}' for BillingProfile scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/invoiceSections/{invoiceSectionId}' for InvoiceSection scope, 'providers/Microsoft.CostManagement/externalBillingAccounts/{externalBillingAccountName}' for External Billing Account scope and 'providers/Microsoft.CostManagement/externalSubscriptions/{externalSubscriptionName}' for External Subscription scope. Note: Insight Alerts are only available on subscription scope."]
        #[doc = "* `check_name_availability_request`: Scheduled action to be created or updated."]
        pub fn check_name_availability_by_scope(
            &self,
            scope: impl Into<String>,
            check_name_availability_request: impl Into<models::CheckNameAvailabilityRequest>,
        ) -> check_name_availability_by_scope::RequestBuilder {
            check_name_availability_by_scope::RequestBuilder {
                client: self.0.clone(),
                scope: scope.into(),
                check_name_availability_request: check_name_availability_request.into(),
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ScheduledActionListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ScheduledActionListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::ScheduledActionListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path("/providers/Microsoft.CostManagement/scheduledActions");
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
    ...
    pub mod list_by_scope {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/{}/providers/Microsoft.CostManagement/scheduledActions", &self.scope));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ScheduledAction> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ScheduledAction = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.CostManagement/scheduledActions/{}", &self.name));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ScheduledAction>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ScheduledAction>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) name: String,
            pub(crate) scheduled_action: models::ScheduledAction,
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.scheduled_action)?;
    ...
    pub mod run {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/providers/Microsoft.CostManagement/scheduledActions/{}/execute",
                    &self.name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod check_name_availability {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path("/providers/Microsoft.CostManagement/checkNameAvailability");
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
    ...
    pub mod check_name_availability_by_scope {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
