...
pub enum Error {
    ...
    #[error(transparent)]
    Settings_CreateOrUpdate(#[from] settings::create_or_update::Error),
    #[error(transparent)]
    Settings_Delete(#[from] settings::delete::Error),
    #[error(transparent)]
...
pub mod settings {
    use super::{models, API_VERSION};
    pub async fn list(operation_config: &crate::OperationConfig) -> std::result::Result<models::SettingsListResult, list::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!("{}/providers/Microsoft.CostManagement/settings", operation_config.base_path(),);
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                ...
                let rsp_value: models::SettingsListResult =
    ...
    pub async fn get(operation_config: &crate::OperationConfig, setting_name: &str) -> std::result::Result<models::Setting, get::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
    ...
    ) -> std::result::Result<models::Setting, create_or_update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/providers/Microsoft.CostManagement/settings/{}",
            operation_config.base_path(),
...
pub mod generate_reservation_details_report {
    use super::{models, API_VERSION};
    pub async fn by_billing_account_id(
        operation_config: &crate::OperationConfig,
        billing_account_id: &str,
        start_date: &str,
        end_date: &str,
    ) -> std::result::Result<by_billing_account_id::Response, by_billing_account_id::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        let mut url = url::Url::parse(url_str).map_err(by_billing_account_id::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::POST);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(by_billing_account_id::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        ...
        let req = req_builder
            .body(req_body)
            .map_err(by_billing_account_id::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(by_billing_account_id::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::OperationStatus = serde_json::from_slice(rsp_body)
                    .map_err(|source| by_billing_account_id::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(by_billing_account_id::Response::Ok200(rsp_value))
            }
            http::StatusCode::ACCEPTED => Ok(by_billing_account_id::Response::Accepted202),
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::ErrorResponse = serde_json::from_slice(rsp_body)
                    .map_err(|source| by_billing_account_id::Error::DeserializeError(source, rsp_body.clone()))?;
                Err(by_billing_account_id::Error::DefaultResponse {
                    status_code,
                    value: rsp_value,
                })
            }
    ...
    pub async fn by_billing_profile_id(
        operation_config: &crate::OperationConfig,
        billing_account_id: &str,
        billing_profile_id: &str,
        start_date: &str,
        end_date: &str,
    ) -> std::result::Result<by_billing_profile_id::Response, by_billing_profile_id::Error> {
        let http_client = operation_config.http_client();
        let url_str = & format ! ("{}/providers/Microsoft.Billing/billingAccounts/{}/billingProfiles/{}/providers/Microsoft.CostManagement/generateReservationDetailsReport" , operation_config . base_path () , billing_account_id , billing_profile_id) ;
        let mut url = url::Url::parse(url_str).map_err(by_billing_profile_id::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::POST);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(by_billing_profile_id::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        url.query_pairs_mut().append_pair("startDate", start_date);
        ...
        let req = req_builder
            .body(req_body)
            .map_err(by_billing_profile_id::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(by_billing_profile_id::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::OperationStatus = serde_json::from_slice(rsp_body)
                    .map_err(|source| by_billing_profile_id::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(by_billing_profile_id::Response::Ok200(rsp_value))
            }
            http::StatusCode::ACCEPTED => Ok(by_billing_profile_id::Response::Accepted202),
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::ErrorResponse = serde_json::from_slice(rsp_body)
                    .map_err(|source| by_billing_profile_id::Error::DeserializeError(source, rsp_body.clone()))?;
                Err(by_billing_profile_id::Error::DefaultResponse {
                    status_code,
                    value: rsp_value,
                })
            }
