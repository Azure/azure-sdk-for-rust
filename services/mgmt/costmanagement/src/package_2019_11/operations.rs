...
pub mod settings {
    use super::{models, models::*, API_VERSION};
    pub async fn list(operation_config: &crate::OperationConfig) -> std::result::Result<SettingsListResult, list::Error> {
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                ...
                let rsp_value: SettingsListResult =
    ...
    pub async fn get(operation_config: &crate::OperationConfig, setting_name: &str) -> std::result::Result<Setting, get::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
    ...
    pub async fn create_or_update(
        ...
        setting_name: &str,
        parameters: &Setting,
    ) -> std::result::Result<Setting, create_or_update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/providers/Microsoft.CostManagement/settings/{}",
            operation_config.base_path(),
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: Setting = serde_json::from_slice(rsp_body)
