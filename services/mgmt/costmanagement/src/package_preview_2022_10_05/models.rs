...
#[doc = "The customer billing metadata"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CustomerMetadata {
    #[doc = "Customer billing account id"]
    #[serde(rename = "billingAccountId")]
    pub billing_account_id: String,
    #[doc = "Customer billing profile id"]
    #[serde(rename = "billingProfileId")]
    pub billing_profile_id: String,
}
impl CustomerMetadata {
    pub fn new(billing_account_id: String, billing_profile_id: String) -> Self {
        Self {
            billing_account_id,
            billing_profile_id,
        }
...
pub struct MarkupRule {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "The properties of the markup rule."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<MarkupRuleProperties>,
}
impl MarkupRule {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "Markup rule list result. It contains a list of Markup rules."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MarkupRulePagedResponse {
    #[doc = "The list of markup rules."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<MarkupRule>,
    #[doc = "The link (url) to the next page of results."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for MarkupRulePagedResponse {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone()
    }
}
impl MarkupRulePagedResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The properties of the markup rule."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct MarkupRuleProperties {
    #[doc = "The description of the markup rule."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    #[doc = "The markup percentage of the rule."]
    pub percentage: f64,
    #[doc = "Starting date of the markup rule."]
    #[serde(rename = "startDate", with = "azure_core::date::rfc3339")]
    pub start_date: time::OffsetDateTime,
    #[doc = "Ending date of the markup rule."]
    ...
    pub customer_details: CustomerMetadata,
}
impl MarkupRuleProperties {
    pub fn new(percentage: f64, start_date: time::OffsetDateTime, customer_details: CustomerMetadata) -> Self {
        Self {
            description: None,
            percentage,
            start_date,
...
#[doc = "Setting definition."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct Setting {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Specifies the kind of settings."]
...
pub mod setting {
    ...
    impl Serialize for Kind {
        ...
        {
            match self {
                Self::Taginheritance => serializer.serialize_unit_variant("Kind", 0u32, "taginheritance"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
}
#[doc = "Setting list result. It contains a list of settings."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "The properties of the tag inheritance setting."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct TagInheritanceProperties {
    #[doc = "Prefer Container tags to override container tags with resource tags in case of conflicts."]
    #[serde(rename = "preferContainerTags")]
    pub prefer_container_tags: bool,
}
impl TagInheritanceProperties {
    pub fn new(prefer_container_tags: bool) -> Self {
        Self { prefer_container_tags }
    }
}
#[doc = "Tag Inheritance Setting definition."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct TagInheritanceSetting {
    #[serde(flatten)]
    pub setting: Setting,
    #[doc = "The properties of the tag inheritance setting."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<TagInheritanceProperties>,
}
impl TagInheritanceSetting {
