        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::ViewListResult, Error>> {
                Box::pin(async move {
                    ...
                    url.query_pairs_mut().append_pair("api-version", "2019-04-01-preview");
...
pub mod budget {
    ...
    impl Client {
        ...
        pub fn create_or_update(&self, scope: impl Into<String>, budget_name: impl Into<String>) -> create_or_update::Builder {
            create_or_update::Builder {
                client: self.0.clone(),
                scope: scope.into(),
                budget_name: budget_name.into(),
    ...
    pub mod get {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::BudgetModel, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/{}/providers/Microsoft.CostManagement/budgets/{}",
                        self.client.endpoint(),
    ...
    pub mod create_or_update {
        ...
        pub struct Builder {
            ...
            pub(crate) scope: String,
            pub(crate) budget_name: String,
            pub(crate) parameters: Option<models::BudgetModel>,
        }
        impl Builder {
            pub fn parameters(mut self, parameters: impl Into<models::BudgetModel>) -> Self {
