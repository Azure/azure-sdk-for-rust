...
impl Client {
    ...
    pub fn binary_hardening_client(&self) -> binary_hardening::Client {
        binary_hardening::Client(self.clone())
    }
    pub fn crypto_certificates_client(&self) -> crypto_certificates::Client {
        crypto_certificates::Client(self.clone())
    }
    pub fn crypto_keys_client(&self) -> crypto_keys::Client {
        crypto_keys::Client(self.clone())
    }
    pub fn cves_client(&self) -> cves::Client {
        cves::Client(self.clone())
    }
    pub fn firmwares_client(&self) -> firmwares::Client {
        firmwares::Client(self.clone())
    }
    pub fn operations_client(&self) -> operations::Client {
        operations::Client(self.clone())
    }
    pub fn password_hashes_client(&self) -> password_hashes::Client {
        password_hashes::Client(self.clone())
    }
    pub fn sbom_components_client(&self) -> sbom_components::Client {
        sbom_components::Client(self.clone())
    }
...
pub mod binary_hardening {
    ...
    impl Client {
        #[doc = "Lists binary hardening analysis results of a firmware."]
        #[doc = ""]
        #[doc = "Arguments:"]
        ...
        pub fn list_by_firmware(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            workspace_name: impl Into<String>,
            firmware_id: impl Into<String>,
        ) -> list_by_firmware::RequestBuilder {
            list_by_firmware::RequestBuilder {
                client: self.0.clone(),
    ...
    pub mod list_by_firmware {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BinaryHardeningListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BinaryHardeningListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::BinaryHardeningListResult, azure_core::error::Error> {
                        ...
                        let rsp = match continuation {
                            Some(value) => {
                                ...
                                if !has_api_version_already {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair(azure_core::query_param::API_VERSION, "2024-01-10");
                                }
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.IoTFirmwareDefense/workspaces/{}/firmwares/{}/binaryHardeningResults" , & self . subscription_id , & self . resource_group_name , & self . workspace_name , & self . firmware_id)) ;
...
pub mod crypto_certificates {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Lists cryptographic certificate analysis results found in a firmware."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod list_by_firmware {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CryptoCertificateListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CryptoCertificateListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::CryptoCertificateListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.IoTFirmwareDefense/workspaces/{}/firmwares/{}/cryptoCertificates" , & self . subscription_id , & self . resource_group_name , & self . workspace_name , & self . firmware_id)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-01-10");
...
pub mod crypto_keys {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Lists cryptographic key analysis results found in a firmware."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod list_by_firmware {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CryptoKeyListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CryptoKeyListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::CryptoKeyListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.IoTFirmwareDefense/workspaces/{}/firmwares/{}/cryptoKeys",
...
pub mod cves {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Lists CVE analysis results of a firmware."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod list_by_firmware {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CveListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CveListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::CveListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.IoTFirmwareDefense/workspaces/{}/firmwares/{}/cves",
                    &self.subscription_id, &self.resource_group_name, &self.workspace_name, &self.firmware_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
...
pub mod password_hashes {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Lists password hash analysis results of a firmware."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod list_by_firmware {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::PasswordHashListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::PasswordHashListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::PasswordHashListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.IoTFirmwareDefense/workspaces/{}/firmwares/{}/passwordHashes",
                    &self.subscription_id, &self.resource_group_name, &self.workspace_name, &self.firmware_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
...
pub mod sbom_components {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Lists SBOM analysis results of a firmware."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod list_by_firmware {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SbomComponentListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SbomComponentListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::SbomComponentListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.IoTFirmwareDefense/workspaces/{}/firmwares/{}/sbomComponents",
                    &self.subscription_id, &self.resource_group_name, &self.workspace_name, &self.firmware_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
...
pub mod summaries {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Lists analysis result summary names of a firmware. To fetch the full summary data, get that summary by name."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Get an analysis result summary of a firmware by name."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `workspace_name`: The name of the firmware analysis workspace."]
        #[doc = "* `firmware_id`: The id of the firmware."]
        #[doc = "* `summary_name`: The Firmware analysis summary name describing the type of summary."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
    ...
    pub mod list_by_firmware {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SummaryListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SummaryListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::SummaryListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.IoTFirmwareDefense/workspaces/{}/firmwares/{}/summaries",
                    &self.subscription_id, &self.resource_group_name, &self.workspace_name, &self.firmware_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SummaryResource> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SummaryResource = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.IoTFirmwareDefense/workspaces/{}/firmwares/{}/summaries/{}",
                    &self.subscription_id, &self.resource_group_name, &self.workspace_name, &self.firmware_id, &self.summary_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::SummaryResource>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::SummaryResource>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
