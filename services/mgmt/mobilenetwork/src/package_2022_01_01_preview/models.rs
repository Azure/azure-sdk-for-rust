...
#[doc = "The configuration state of the resource - complete or incomplete."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
impl Serialize for ConfigurationState {
    ...
    {
        match self {
            Self::Incomplete => serializer.serialize_unit_variant("ConfigurationState", 0u32, "Incomplete"),
            Self::Complete => serializer.serialize_unit_variant("ConfigurationState", 1u32, "Complete"),
