...
#[doc = "ASE region."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AseRegion {
    #[serde(flatten)]
    pub proxy_only_resource: ProxyOnlyResource,
    #[doc = "ASE region resource specific properties"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ase_region::Properties>,
}
impl AseRegion {
    pub fn new() -> Self {
        Self::default()
...
pub mod ase_region {
    ...
    pub struct Properties {
        ...
        #[doc = "Is region standard."]
        #[serde(default, skip_serializing_if = "Option::is_none")]
        pub standard: Option<bool>,
        #[doc = "Dedicated host enabled."]
        #[serde(rename = "dedicatedHost", default, skip_serializing_if = "Option::is_none")]
        pub dedicated_host: Option<bool>,
        #[doc = "Zone redundant deployment enabled."]
        #[serde(rename = "zoneRedundant", default, skip_serializing_if = "Option::is_none")]
        pub zone_redundant: Option<bool>,
        #[doc = "Available Skus in region."]
        #[serde(
            rename = "availableSku",
            default,
            deserialize_with = "azure_core::util::deserialize_null_as_default",
        ...
        pub available_sku: Vec<String>,
        #[doc = "Available OSs in region."]
        #[serde(
            rename = "availableOS",
            default,
            deserialize_with = "azure_core::util::deserialize_null_as_default",
...
#[doc = "Collection of ASE regions."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AseRegionCollection {
    #[doc = "Collection of resources."]
    pub value: Vec<AseRegion>,
    #[doc = "Link to next page of resources."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for AseRegionCollection {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl AseRegionCollection {
    pub fn new(value: Vec<AseRegion>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Full view of networking configuration for an ASE."]
...
pub struct DaprConfig {
    ...
    #[doc = "Increasing max size of request body http servers parameter in MB to handle uploading of big files. Default is 4 MB."]
    ...
    pub log_level: Option<dapr_config::LogLevel>,
...
#[doc = "Function app resource requirements."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ResourceConfig {
    #[doc = "Required CPU in cores, e.g. 0.5"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cpu: Option<f64>,
    #[doc = "Required memory, e.g. \"1Gi\""]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub memory: Option<String>,
}
impl ResourceConfig {
...
pub mod site {
    ...
    pub struct Properties {
        ...
        #[doc = "App Dapr configuration."]
        #[serde(rename = "daprConfig", default, skip_serializing_if = "Option::is_none")]
        pub dapr_config: Option<DaprConfig>,
        #[doc = "Workload profile name for function app to execute on."]
        #[serde(rename = "workloadProfileName", default, skip_serializing_if = "Option::is_none")]
        pub workload_profile_name: Option<String>,
        #[doc = "Function app resource requirements."]
        #[serde(rename = "resourceConfig", default, skip_serializing_if = "Option::is_none")]
...
pub struct SiteConfig {
    ...
    #[doc = "The minimum strength TLS cipher suite allowed for an application"]
    #[serde(
        rename = "minTlsCipherSuite",
        default,
        skip_serializing_if = "Option::is_none",
        with = "azure_core::xml::text_content"
    )]
    pub min_tls_cipher_suite: Option<site_config::MinTlsCipherSuite>,
...
pub mod site_config {
    ...
    #[doc = "The minimum strength TLS cipher suite allowed for an application"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "MinTlsCipherSuite")]
    pub enum MinTlsCipherSuite {
    ...
    impl FromStr for MinTlsCipherSuite {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for MinTlsCipherSuite {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for MinTlsCipherSuite {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::TlsAes256GcmSha384 => serializer.serialize_unit_variant("MinTlsCipherSuite", 0u32, "TLS_AES_256_GCM_SHA384"),
                Self::TlsAes128GcmSha256 => serializer.serialize_unit_variant("MinTlsCipherSuite", 1u32, "TLS_AES_128_GCM_SHA256"),
                Self::TlsEcdheEcdsaWithAes256GcmSha384 => {
                    serializer.serialize_unit_variant("MinTlsCipherSuite", 2u32, "TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384")
                }
                Self::TlsEcdheEcdsaWithAes128CbcSha256 => {
                    serializer.serialize_unit_variant("MinTlsCipherSuite", 3u32, "TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256")
                }
                Self::TlsEcdheEcdsaWithAes128GcmSha256 => {
                    serializer.serialize_unit_variant("MinTlsCipherSuite", 4u32, "TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256")
                }
                Self::TlsEcdheRsaWithAes256GcmSha384 => {
                    serializer.serialize_unit_variant("MinTlsCipherSuite", 5u32, "TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384")
                }
                Self::TlsEcdheRsaWithAes128GcmSha256 => {
                    serializer.serialize_unit_variant("MinTlsCipherSuite", 6u32, "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256")
                }
                Self::TlsEcdheRsaWithAes256CbcSha384 => {
                    serializer.serialize_unit_variant("MinTlsCipherSuite", 7u32, "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384")
                }
                Self::TlsEcdheRsaWithAes128CbcSha256 => {
                    serializer.serialize_unit_variant("MinTlsCipherSuite", 8u32, "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256")
                }
                Self::TlsEcdheRsaWithAes256CbcSha => {
                    serializer.serialize_unit_variant("MinTlsCipherSuite", 9u32, "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA")
                }
                Self::TlsEcdheRsaWithAes128CbcSha => {
                    serializer.serialize_unit_variant("MinTlsCipherSuite", 10u32, "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA")
                }
                Self::TlsRsaWithAes256GcmSha384 => {
                    serializer.serialize_unit_variant("MinTlsCipherSuite", 11u32, "TLS_RSA_WITH_AES_256_GCM_SHA384")
                }
                Self::TlsRsaWithAes128GcmSha256 => {
                    serializer.serialize_unit_variant("MinTlsCipherSuite", 12u32, "TLS_RSA_WITH_AES_128_GCM_SHA256")
                }
                Self::TlsRsaWithAes256CbcSha256 => {
                    serializer.serialize_unit_variant("MinTlsCipherSuite", 13u32, "TLS_RSA_WITH_AES_256_CBC_SHA256")
                }
                Self::TlsRsaWithAes128CbcSha256 => {
                    serializer.serialize_unit_variant("MinTlsCipherSuite", 14u32, "TLS_RSA_WITH_AES_128_CBC_SHA256")
                }
                Self::TlsRsaWithAes256CbcSha => {
                    serializer.serialize_unit_variant("MinTlsCipherSuite", 15u32, "TLS_RSA_WITH_AES_256_CBC_SHA")
                }
                Self::TlsRsaWithAes128CbcSha => {
                    serializer.serialize_unit_variant("MinTlsCipherSuite", 16u32, "TLS_RSA_WITH_AES_128_CBC_SHA")
                }
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
