...
pub struct ApiKvReference {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<api_kv_reference::Status>,
    ...
    pub identity_type: Option<api_kv_reference::IdentityType>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub details: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub source: Option<api_kv_reference::Source>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub location: Option<api_kv_reference::Location>,
}
impl ApiKvReference {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "Web app key vault reference and status ARM resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct KeyVaultReferenceCollection {
    #[serde(flatten)]
    pub proxy_only_resource: ProxyOnlyResource,
    #[doc = "KeyVaultReferenceCollection resource specific properties"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<key_vault_reference_collection::Properties>,
}
impl KeyVaultReferenceCollection {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod key_vault_reference_collection {
    use super::*;
    #[doc = "KeyVaultReferenceCollection resource specific properties"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
    pub struct Properties {
        #[serde(rename = "keyToReferenceStatuses", default, skip_serializing_if = "Option::is_none")]
        pub key_to_reference_statuses: Option<serde_json::Value>,
    }
    impl Properties {
        pub fn new() -> Self {
            Self::default()
...
#[doc = "Web app key vault reference and status ARM resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct KeyVaultReferenceResource {
    #[serde(flatten)]
    pub proxy_only_resource: ProxyOnlyResource,
    #[doc = "Description of site key vault references."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ApiKvReference>,
}
impl KeyVaultReferenceResource {
    pub fn new() -> Self {
        Self::default()
    }
}
