...
pub mod app_service_certificate_order {
    ...
    pub struct Properties {
        ...
        #[serde(rename = "productType", with = "azure_core::xml::text_content")]
...
pub struct AppServiceEnvironment {
    ...
    #[serde(
        rename = "internalLoadBalancingMode",
        default,
        skip_serializing_if = "Option::is_none",
        with = "azure_core::xml::text_content"
    )]
    ...
    #[doc = "Upgrade Preference"]
    #[serde(
        rename = "upgradePreference",
        default,
        skip_serializing_if = "Option::is_none",
        with = "azure_core::xml::text_content"
    )]
    pub upgrade_preference: Option<app_service_environment::UpgradePreference>,
    ...
    #[doc = "Full view of the custom domain suffix configuration for ASEv3."]
    #[serde(rename = "customDnsSuffixConfiguration", default, skip_serializing_if = "Option::is_none")]
    pub custom_dns_suffix_configuration: Option<CustomDnsSuffixConfiguration>,
    #[doc = "Full view of networking configuration for an ASE."]
    #[serde(rename = "networkingConfiguration", default, skip_serializing_if = "Option::is_none")]
    pub networking_configuration: Option<AseV3NetworkingConfiguration>,
    #[doc = "Whether an upgrade is available for this App Service Environment."]
    #[serde(
        rename = "upgradeAvailability",
        default,
        skip_serializing_if = "Option::is_none",
        with = "azure_core::xml::text_content"
    )]
    pub upgrade_availability: Option<app_service_environment::UpgradeAvailability>,
}
impl AppServiceEnvironment {
    pub fn new(virtual_network: VirtualNetworkProfile) -> Self {
        Self {
            ...
            zone_redundant: None,
            custom_dns_suffix_configuration: None,
            networking_configuration: None,
            upgrade_availability: None,
        }
    }
}
pub mod app_service_environment {
    ...
    #[doc = "Upgrade Preference"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "UpgradePreference")]
    pub enum UpgradePreference {
        None,
        Early,
        Late,
        Manual,
    ...
    impl FromStr for UpgradePreference {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for UpgradePreference {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for UpgradePreference {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::None => serializer.serialize_unit_variant("UpgradePreference", 0u32, "None"),
                Self::Early => serializer.serialize_unit_variant("UpgradePreference", 1u32, "Early"),
                Self::Late => serializer.serialize_unit_variant("UpgradePreference", 2u32, "Late"),
                Self::Manual => serializer.serialize_unit_variant("UpgradePreference", 3u32, "Manual"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for UpgradePreference {
        fn default() -> Self {
            Self::None
        }
    }
    #[doc = "Whether an upgrade is available for this App Service Environment."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "UpgradeAvailability")]
    ...
    impl FromStr for UpgradeAvailability {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for UpgradeAvailability {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for UpgradeAvailability {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::None => serializer.serialize_unit_variant("UpgradeAvailability", 0u32, "None"),
                Self::Ready => serializer.serialize_unit_variant("UpgradeAvailability", 1u32, "Ready"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub mod app_service_plan {
    ...
    pub struct Properties {
        ...
        #[doc = "The number of instances that are assigned to this App Service plan."]
...
pub mod ase_v3_networking_configuration {
    ...
    pub struct Properties {
        ...
        #[doc = "Property to enable and disable FTP on ASEV3"]
        #[serde(rename = "ftpEnabled", default, skip_serializing_if = "Option::is_none")]
        pub ftp_enabled: Option<bool>,
        #[doc = "Property to enable and disable Remote Debug on ASEV3"]
        #[serde(rename = "remoteDebugEnabled", default, skip_serializing_if = "Option::is_none")]
        pub remote_debug_enabled: Option<bool>,
        #[doc = "Customer provided Inbound IP Address. Only able to be set on Ase create."]
        #[serde(rename = "inboundIpAddressOverride", default, skip_serializing_if = "Option::is_none")]
        pub inbound_ip_address_override: Option<String>,
    }
    impl Properties {
        pub fn new() -> Self {
            Self::default()
...
pub struct BackupSchedule {
    ...
    #[serde(rename = "frequencyUnit", with = "azure_core::xml::text_content")]
...
pub struct CertificateOrderAction {
    ...
    pub action_type: Option<certificate_order_action::ActionType>,
...
pub mod container_app {
    ...
    pub struct Properties {
        ...
        pub provisioning_state: Option<properties::ProvisioningState>,
        #[doc = "Resource ID of the Container App's KubeEnvironment."]
        #[serde(rename = "kubeEnvironmentId", default, skip_serializing_if = "Option::is_none")]
        pub kube_environment_id: Option<String>,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ContainerAppsConfiguration {
    ...
    #[doc = "IP range in CIDR notation that can be reserved for environment infrastructure IP addresses. It must not overlap with any other Subnet IP ranges."]
    ...
    #[doc = "Resource ID of a subnet for control plane infrastructure components. This subnet must be in the same VNET as the subnet defined in appSubnetResourceId. Must not overlap with the IP range defined in platformReservedCidr, if defined."]
    #[serde(rename = "controlPlaneSubnetResourceId", default, skip_serializing_if = "Option::is_none")]
    pub control_plane_subnet_resource_id: Option<String>,
    #[doc = "Resource ID of a subnet for control plane infrastructure components. This subnet must be in the same VNET as the subnet defined in appSubnetResourceId. Must not overlap with the IP range defined in platformReservedCidr, if defined."]
    #[serde(rename = "appSubnetResourceId", default, skip_serializing_if = "Option::is_none")]
    pub app_subnet_resource_id: Option<String>,
    #[doc = "CIDR notation IP range assigned to the Docker bridge network. It must not overlap with any Subnet IP ranges or the IP range defined in platformReservedCidr, if defined."]
    #[serde(rename = "dockerBridgeCidr", default, skip_serializing_if = "Option::is_none")]
    pub docker_bridge_cidr: Option<String>,
}
impl ContainerAppsConfiguration {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Deployment status response payload."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CsmDeploymentStatus {
    #[serde(flatten)]
    pub proxy_only_resource: ProxyOnlyResource,
    #[doc = "CsmDeploymentStatus resource specific properties"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<csm_deployment_status::Properties>,
}
impl CsmDeploymentStatus {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod csm_deployment_status {
    use super::*;
    #[doc = "CsmDeploymentStatus resource specific properties"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
    pub struct Properties {
        ...
        #[doc = "Deployment build status."]
        #[serde(default, skip_serializing_if = "Option::is_none", with = "azure_core::xml::text_content")]
        pub status: Option<properties::Status>,
        #[doc = "Number of site instances currently being provisioned."]
        #[serde(rename = "numberOfInstancesInProgress", default, skip_serializing_if = "Option::is_none")]
        pub number_of_instances_in_progress: Option<i32>,
        #[doc = "Number of site instances provisioned successfully."]
        #[serde(rename = "numberOfInstancesSuccessful", default, skip_serializing_if = "Option::is_none")]
        pub number_of_instances_successful: Option<i32>,
        #[doc = "Number of site instances failed to provision."]
    ...
    pub mod properties {
        ...
        impl Serialize for Status {
            ...
            {
                match self {
                    Self::TimedOut => serializer.serialize_unit_variant("Status", 0u32, "TimedOut"),
                    Self::RuntimeFailed => serializer.serialize_unit_variant("Status", 1u32, "RuntimeFailed"),
                    Self::BuildAborted => serializer.serialize_unit_variant("Status", 2u32, "BuildAborted"),
                    Self::BuildFailed => serializer.serialize_unit_variant("Status", 3u32, "BuildFailed"),
                    Self::BuildRequestReceived => serializer.serialize_unit_variant("Status", 4u32, "BuildRequestReceived"),
                    Self::BuildPending => serializer.serialize_unit_variant("Status", 5u32, "BuildPending"),
                    Self::BuildInProgress => serializer.serialize_unit_variant("Status", 6u32, "BuildInProgress"),
                    Self::BuildSuccessful => serializer.serialize_unit_variant("Status", 7u32, "BuildSuccessful"),
                    Self::PostBuildRestartRequired => serializer.serialize_unit_variant("Status", 8u32, "PostBuildRestartRequired"),
                    Self::StartPolling => serializer.serialize_unit_variant("Status", 9u32, "StartPolling"),
                    Self::StartPollingWithRestart => serializer.serialize_unit_variant("Status", 10u32, "StartPollingWithRestart"),
                    Self::RuntimeStarting => serializer.serialize_unit_variant("Status", 11u32, "RuntimeStarting"),
                    Self::RuntimeSuccessful => serializer.serialize_unit_variant("Status", 12u32, "RuntimeSuccessful"),
                    Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
                }
            }
        }
...
#[doc = "Deployment status collection ARM resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CsmDeploymentStatusCollection {
    #[doc = "Collection of resources."]
    pub value: Vec<CsmDeploymentStatus>,
    #[doc = "Link to next page of resources."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for CsmDeploymentStatusCollection {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl CsmDeploymentStatusCollection {
    pub fn new(value: Vec<CsmDeploymentStatus>) -> Self {
        Self { value, next_link: None }
    }
}
...
#[doc = "Full view of the custom domain suffix configuration for ASEv3."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CustomDnsSuffixConfiguration {
    #[serde(flatten)]
    pub proxy_only_resource: ProxyOnlyResource,
    #[doc = "CustomDnsSuffixConfiguration resource specific properties"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<custom_dns_suffix_configuration::Properties>,
}
impl CustomDnsSuffixConfiguration {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod custom_dns_suffix_configuration {
    use super::*;
    #[doc = "CustomDnsSuffixConfiguration resource specific properties"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
    pub struct Properties {
        ...
        pub provisioning_details: Option<String>,
        #[doc = "The default custom domain suffix to use for all sites deployed on the ASE."]
        #[serde(rename = "dnsSuffix", default, skip_serializing_if = "Option::is_none")]
        pub dns_suffix: Option<String>,
        #[doc = "The URL referencing the Azure Key Vault certificate secret that should be used as the default SSL/TLS certificate for sites with the custom domain suffix."]
        #[serde(rename = "certificateUrl", default, skip_serializing_if = "Option::is_none")]
        pub certificate_url: Option<String>,
        #[doc = "The user-assigned identity to use for resolving the key vault certificate reference. If not specified, the system-assigned ASE identity will be used if available."]
...
#[doc = "A hostname and its assigned sites"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CustomHostnameSites {
    #[serde(flatten)]
    pub proxy_only_resource: ProxyOnlyResource,
    #[doc = "CustomHostnameSites resource specific properties"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<custom_hostname_sites::Properties>,
}
impl CustomHostnameSites {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod custom_hostname_sites {
    use super::*;
    #[doc = "CustomHostnameSites resource specific properties"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
    pub struct Properties {
...
#[doc = "Collection of custom hostname sites"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CustomHostnameSitesCollection {
    #[doc = "Collection of resources."]
    pub value: Vec<CustomHostnameSites>,
    #[doc = "Link to next page of resources."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for CustomHostnameSitesCollection {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl CustomHostnameSitesCollection {
    pub fn new(value: Vec<CustomHostnameSites>) -> Self {
        Self { value, next_link: None }
    }
}
...
pub struct Dapr {
    ...
    #[serde(rename = "appId", default, skip_serializing_if = "Option::is_none")]
    pub app_id: Option<String>,
    #[doc = "Port on which the Dapr side car"]
...
#[doc = "Dapr component configuration"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "Container App Dapr component metadata."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DaprMetadata {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub value: Option<String>,
    #[doc = "Name of the Container App secret from which to pull the metadata property value."]
...
#[doc = "Static Site Database Connection resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DatabaseConnection {
    #[serde(flatten)]
    pub proxy_only_resource: ProxyOnlyResource,
    #[doc = "DatabaseConnection resource specific properties"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<database_connection::Properties>,
}
...
pub mod database_connection {
    ...
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub struct Properties {
        #[doc = "The resource id of the database."]
        #[serde(rename = "resourceId")]
        pub resource_id: String,
        #[doc = "If present, the identity is used in conjunction with connection string to connect to the database. Use of the system-assigned managed identity is indicated with the string 'SystemAssigned', while use of a user-assigned managed identity is indicated with the resource id of the managed identity resource."]
        #[serde(rename = "connectionIdentity", default, skip_serializing_if = "Option::is_none")]
        pub connection_identity: Option<String>,
        #[doc = "The connection string to use to connect to the database."]
        #[serde(rename = "connectionString", default, skip_serializing_if = "Option::is_none")]
        pub connection_string: Option<String>,
        #[doc = "The region of the database resource."]
        pub region: String,
        #[doc = "A list of configuration files associated with this database connection."]
        #[serde(
            rename = "configurationFiles",
            default,
            deserialize_with = "azure_core::util::deserialize_null_as_default",
            skip_serializing_if = "Vec::is_empty"
        )]
        pub configuration_files: Vec<StaticSiteDatabaseConnectionConfigurationFileOverview>,
    }
    impl Properties {
        pub fn new(resource_id: String, region: String) -> Self {
            Self {
                resource_id,
...
#[doc = "Collection of static site database connections."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DatabaseConnectionCollection {
    #[doc = "Collection of resources."]
    pub value: Vec<DatabaseConnection>,
    #[doc = "Link to next page of resources."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for DatabaseConnectionCollection {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl DatabaseConnectionCollection {
    pub fn new(value: Vec<DatabaseConnection>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Static Site Database Connection overview."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DatabaseConnectionOverview {
    #[doc = "The resource id of the database."]
    ...
    pub configuration_files: Vec<StaticSiteDatabaseConnectionConfigurationFileOverview>,
    #[doc = "If present, the name of this database connection resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
impl DatabaseConnectionOverview {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Static Site Database Connection Request Properties resource when patching"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DatabaseConnectionPatchRequest {
    #[doc = "DatabaseConnectionPatchRequest resource specific properties"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<database_connection_patch_request::Properties>,
}
impl DatabaseConnectionPatchRequest {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod database_connection_patch_request {
    use super::*;
    #[doc = "DatabaseConnectionPatchRequest resource specific properties"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
    pub struct Properties {
...
pub struct HostName {
    ...
    #[serde(
        rename = "customHostNameDnsRecordType",
        default,
        skip_serializing_if = "Option::is_none",
        with = "azure_core::xml::text_content"
    )]
...
impl Serialize for Kind {
    ...
    {
        match self {
            Self::Stateful => serializer.serialize_unit_variant("Kind", 0u32, "Stateful"),
            Self::Stateless => serializer.serialize_unit_variant("Kind", 1u32, "Stateless"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub mod kube_environment {
    ...
    pub struct Properties {
        ...
        #[doc = "Type of Kubernetes Environment. Only supported for Container App Environments with value as Managed"]
        ...
        #[serde(rename = "containerAppsConfiguration", default, skip_serializing_if = "Option::is_none")]
        pub container_apps_configuration: Option<ContainerAppsConfiguration>,
...
pub mod migrate_my_sql_request {
    ...
    pub struct Properties {
        ...
        #[serde(rename = "migrationType", with = "azure_core::xml::text_content")]
...
pub mod migrate_my_sql_status {
    ...
    pub struct Properties {
        ...
        #[serde(
            rename = "migrationOperationStatus",
            default,
            skip_serializing_if = "Option::is_none",
            with = "azure_core::xml::text_content"
        )]
...
pub mod premier_add_on_offer {
    ...
    pub struct Properties {
        ...
        #[serde(
            rename = "webHostingPlanRestrictions",
            default,
            skip_serializing_if = "Option::is_none",
            with = "azure_core::xml::text_content"
        )]
...
pub mod public_certificate {
    ...
    pub struct Properties {
        ...
        #[serde(
            rename = "publicCertificateLocation",
            default,
            skip_serializing_if = "Option::is_none",
            with = "azure_core::xml::text_content"
        )]
...
pub struct RequestHistory {
    #[serde(flatten)]
    pub workflow_resource: WorkflowResource,
    #[doc = "The request history."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub mod site {
    ...
    pub struct Properties {
        ...
        #[doc = "To enable pulling image over Virtual Network"]
        #[serde(rename = "vnetImagePullEnabled", default, skip_serializing_if = "Option::is_none")]
        pub vnet_image_pull_enabled: Option<bool>,
        #[doc = "To enable accessing content over virtual network"]
        #[serde(rename = "vnetContentShareEnabled", default, skip_serializing_if = "Option::is_none")]
        pub vnet_content_share_enabled: Option<bool>,
        ...
        #[doc = "Property to allow or block all public traffic. Allowed Values: 'Enabled', 'Disabled' or an empty string."]
        ...
        #[doc = "Azure Resource Manager ID of the customer's selected Managed Environment on which to host this app. This must be of the form /subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.App/managedEnvironments/{managedEnvironmentName}"]
...
pub mod site_auth_settings {
    ...
    pub struct Properties {
        ...
        #[doc = "Allowed audience values to consider when validating JSON Web Tokens issued by \nAzure Active Directory. Note that the <code>ClientID</code> value is always considered an\nallowed audience, regardless of this setting."]
        #[serde(
            rename = "allowedAudiences",
            default,
            deserialize_with = "azure_core::util::deserialize_null_as_default",
...
pub struct SiteConfig {
    ...
    #[doc = "Application metadata. This property cannot be retrieved, since it may contain secrets."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    ...
    #[doc = "Default action for main access restriction if no rules are matched."]
    #[serde(
        rename = "ipSecurityRestrictionsDefaultAction",
        default,
        skip_serializing_if = "Option::is_none",
        with = "azure_core::xml::text_content"
    )]
    pub ip_security_restrictions_default_action: Option<site_config::IpSecurityRestrictionsDefaultAction>,
    ...
    #[doc = "Default action for scm access restriction if no rules are matched."]
    #[serde(
        rename = "scmIpSecurityRestrictionsDefaultAction",
        default,
        skip_serializing_if = "Option::is_none",
        with = "azure_core::xml::text_content"
    )]
    pub scm_ip_security_restrictions_default_action: Option<site_config::ScmIpSecurityRestrictionsDefaultAction>,
    ...
    #[serde(rename = "elasticWebAppScaleLimit", default, skip_serializing_if = "Option::is_none")]
    pub elastic_web_app_scale_limit: Option<i32>,
...
pub mod site_config {
    ...
    #[doc = "Default action for main access restriction if no rules are matched."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "IpSecurityRestrictionsDefaultAction")]
    pub enum IpSecurityRestrictionsDefaultAction {
        Allow,
        Deny,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for IpSecurityRestrictionsDefaultAction {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for IpSecurityRestrictionsDefaultAction {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for IpSecurityRestrictionsDefaultAction {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Allow => serializer.serialize_unit_variant("IpSecurityRestrictionsDefaultAction", 0u32, "Allow"),
                Self::Deny => serializer.serialize_unit_variant("IpSecurityRestrictionsDefaultAction", 1u32, "Deny"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    #[doc = "Default action for scm access restriction if no rules are matched."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ScmIpSecurityRestrictionsDefaultAction")]
    pub enum ScmIpSecurityRestrictionsDefaultAction {
        Allow,
        Deny,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for ScmIpSecurityRestrictionsDefaultAction {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for ScmIpSecurityRestrictionsDefaultAction {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for ScmIpSecurityRestrictionsDefaultAction {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Allow => serializer.serialize_unit_variant("ScmIpSecurityRestrictionsDefaultAction", 0u32, "Allow"),
                Self::Deny => serializer.serialize_unit_variant("ScmIpSecurityRestrictionsDefaultAction", 1u32, "Deny"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct StaticSite {
    ...
    #[serde(
        rename = "stagingEnvironmentPolicy",
        default,
        skip_serializing_if = "Option::is_none",
        with = "azure_core::xml::text_content"
    )]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub provider: Option<String>,
    #[doc = "State indicating the status of the enterprise grade CDN serving traffic to the static web app."]
    #[serde(
        rename = "enterpriseGradeCdnStatus",
        default,
        skip_serializing_if = "Option::is_none",
        with = "azure_core::xml::text_content"
    )]
    pub enterprise_grade_cdn_status: Option<static_site::EnterpriseGradeCdnStatus>,
    #[doc = "State indicating whether public traffic are allowed or not for a static web app. Allowed Values: 'Enabled', 'Disabled' or an empty string."]
    #[serde(rename = "publicNetworkAccess", default, skip_serializing_if = "Option::is_none")]
    pub public_network_access: Option<String>,
    #[doc = "Database connections for the static site"]
    #[serde(
    ...
    pub database_connections: Vec<DatabaseConnectionOverview>,
}
impl StaticSite {
    pub fn new() -> Self {
        Self::default()
...
pub mod static_site {
    ...
    #[doc = "State indicating the status of the enterprise grade CDN serving traffic to the static web app."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "EnterpriseGradeCdnStatus")]
    pub enum EnterpriseGradeCdnStatus {
        Enabled,
        Enabling,
        Disabled,
        Disabling,
    ...
    impl FromStr for EnterpriseGradeCdnStatus {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for EnterpriseGradeCdnStatus {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for EnterpriseGradeCdnStatus {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("EnterpriseGradeCdnStatus", 0u32, "Enabled"),
                Self::Enabling => serializer.serialize_unit_variant("EnterpriseGradeCdnStatus", 1u32, "Enabling"),
                Self::Disabled => serializer.serialize_unit_variant("EnterpriseGradeCdnStatus", 2u32, "Disabled"),
                Self::Disabling => serializer.serialize_unit_variant("EnterpriseGradeCdnStatus", 3u32, "Disabling"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Static site basic auth properties ARM resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct StaticSiteBasicAuthPropertiesArmResource {
    #[serde(flatten)]
    pub proxy_only_resource: ProxyOnlyResource,
    #[doc = "StaticSiteBasicAuthPropertiesARMResource resource specific properties"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<static_site_basic_auth_properties_arm_resource::Properties>,
}
impl StaticSiteBasicAuthPropertiesArmResource {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod static_site_basic_auth_properties_arm_resource {
    use super::*;
    #[doc = "StaticSiteBasicAuthPropertiesARMResource resource specific properties"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub struct Properties {
        ...
        #[serde(default, skip_serializing_if = "Option::is_none")]
        pub password: Option<String>,
        #[doc = "Url to the secret in Key Vault."]
        #[serde(rename = "secretUrl", default, skip_serializing_if = "Option::is_none")]
        pub secret_url: Option<String>,
        #[doc = "State indicating if basic auth is enabled and for what environments it is active."]
        #[serde(rename = "applicableEnvironmentsMode")]
        pub applicable_environments_mode: String,
        #[doc = "The list of enabled environments for Basic Auth if ApplicableEnvironmentsMode is set to SpecifiedEnvironments."]
        #[serde(
            default,
            deserialize_with = "azure_core::util::deserialize_null_as_default",
            skip_serializing_if = "Vec::is_empty"
        ...
        #[doc = "State indicating if basic auth has a secret and what type it is."]
        #[serde(rename = "secretState", default, skip_serializing_if = "Option::is_none")]
        pub secret_state: Option<String>,
    }
    impl Properties {
        pub fn new(applicable_environments_mode: String) -> Self {
            Self {
                password: None,
                secret_url: None,
...
#[doc = "Collection of static site basic auth."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct StaticSiteBasicAuthPropertiesCollection {
    #[doc = "Collection of resources."]
    pub value: Vec<StaticSiteBasicAuthPropertiesArmResource>,
    #[doc = "Link to next page of resources."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for StaticSiteBasicAuthPropertiesCollection {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl StaticSiteBasicAuthPropertiesCollection {
    pub fn new(value: Vec<StaticSiteBasicAuthPropertiesArmResource>) -> Self {
        Self { value, next_link: None }
    }
}
...
pub mod static_site_build_arm_resource {
    ...
    pub struct Properties {
        ...
        pub linked_backends: Vec<StaticSiteLinkedBackend>,
        #[doc = "Database connections for the static site build"]
        #[serde(
            rename = "databaseConnections",
            default,
            deserialize_with = "azure_core::util::deserialize_null_as_default",
        ...
        impl Serialize for Status {
                ...
                S: Serializer,
            {
                match self {
                    ...
                    Self::Failed => serializer.serialize_unit_variant("Status", 4u32, "Failed"),
                    Self::Deleting => serializer.serialize_unit_variant("Status", 5u32, "Deleting"),
                    Self::Unhealthy => serializer.serialize_unit_variant("Status", 6u32, "Unhealthy"),
                    Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
                }
            }
        }
...
#[doc = "A database connection configuration file"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct StaticSiteDatabaseConnectionConfigurationFileOverview {
    #[doc = "The name of the configuration file."]
    #[serde(rename = "fileName", default, skip_serializing_if = "Option::is_none")]
    pub file_name: Option<String>,
    #[doc = "The Base64 encoding of the file contents."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub contents: Option<String>,
    #[doc = "The type of configuration file."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<String>,
}
impl StaticSiteDatabaseConnectionConfigurationFileOverview {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Static Site Linked Backend ARM resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct StaticSiteLinkedBackend {
    #[doc = "The resource id of the backend linked to the static site"]
    #[serde(rename = "backendResourceId", default, skip_serializing_if = "Option::is_none")]
    pub backend_resource_id: Option<String>,
    #[doc = "The region of the backend linked to the static site"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub region: Option<String>,
    #[doc = "The date and time on which the backend was linked to the static site."]
    #[serde(rename = "createdOn", default, with = "azure_core::date::rfc3339::option")]
    pub created_on: Option<time::OffsetDateTime>,
    #[doc = "The provisioning state of the linking process."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<String>,
}
impl StaticSiteLinkedBackend {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Static Site Linked Backend ARM resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct StaticSiteLinkedBackendArmResource {
    #[serde(flatten)]
    pub proxy_only_resource: ProxyOnlyResource,
    #[doc = "StaticSiteLinkedBackendARMResource resource specific properties"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<static_site_linked_backend_arm_resource::Properties>,
}
impl StaticSiteLinkedBackendArmResource {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod static_site_linked_backend_arm_resource {
    use super::*;
    #[doc = "StaticSiteLinkedBackendARMResource resource specific properties"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
    pub struct Properties {
...
#[doc = "Collection of static site linked backends."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct StaticSiteLinkedBackendsCollection {
    #[doc = "Collection of resources."]
    pub value: Vec<StaticSiteLinkedBackendArmResource>,
    #[doc = "Link to next page of resources."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for StaticSiteLinkedBackendsCollection {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl StaticSiteLinkedBackendsCollection {
    pub fn new(value: Vec<StaticSiteLinkedBackendArmResource>) -> Self {
        Self { value, next_link: None }
    }
}
...
#[doc = "Collection of Kudu workflow information elements."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
impl WorkflowRunActionRepetitionDefinition {
    pub fn new(properties: WorkflowRunActionRepetitionProperties) -> Self {
        Self {
            workflow_resource: WorkflowResource::default(),
            properties,
        }
    }
}
...
#[doc = "The sku type."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct WorkflowSku {
    #[doc = "The sku name."]
    #[serde(with = "azure_core::xml::text_content")]
    pub name: WorkflowSkuName,
    #[doc = "The resource reference."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub plan: Option<ResourceReference>,
}
impl WorkflowSku {
    pub fn new(name: WorkflowSkuName) -> Self {
        Self { name, plan: None }
    }
}
#[doc = "The sku name."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "WorkflowSkuName")]
pub enum WorkflowSkuName {
    NotSpecified,
    Free,
    Shared,
    Basic,
...
impl FromStr for WorkflowSkuName {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for WorkflowSkuName {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for WorkflowSkuName {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::NotSpecified => serializer.serialize_unit_variant("WorkflowSkuName", 0u32, "NotSpecified"),
            Self::Free => serializer.serialize_unit_variant("WorkflowSkuName", 1u32, "Free"),
            Self::Shared => serializer.serialize_unit_variant("WorkflowSkuName", 2u32, "Shared"),
            Self::Basic => serializer.serialize_unit_variant("WorkflowSkuName", 3u32, "Basic"),
            Self::Standard => serializer.serialize_unit_variant("WorkflowSkuName", 4u32, "Standard"),
            Self::Premium => serializer.serialize_unit_variant("WorkflowSkuName", 5u32, "Premium"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
