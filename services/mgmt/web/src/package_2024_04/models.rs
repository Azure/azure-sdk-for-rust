...
pub struct AzureStorageInfoValue {
    ...
    #[doc = "Mounting protocol to use for the storage account."]
    #[serde(default, skip_serializing_if = "Option::is_none", with = "azure_core::xml::text_content")]
    pub protocol: Option<azure_storage_info_value::Protocol>,
}
...
pub mod azure_storage_info_value {
    ...
    impl Serialize for Protocol {
        ...
        {
            match self {
                Self::Smb => serializer.serialize_unit_variant("Protocol", 0u32, "Smb"),
                Self::Http => serializer.serialize_unit_variant("Protocol", 1u32, "Http"),
                Self::Nfs => serializer.serialize_unit_variant("Protocol", 2u32, "Nfs"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Describes valid TLS cipher suites."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CipherSuites {
    #[doc = "List of TLS Cipher Suites that are supported by App Service."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
#[doc = "Function app configuration."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct FunctionAppConfig {
    #[doc = "Configuration section for the function app deployment."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub deployment: Option<FunctionsDeployment>,
    #[doc = "Function app runtime name and version."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub runtime: Option<FunctionsRuntime>,
    #[doc = "Scale and concurrency settings for the function app."]
    #[serde(rename = "scaleAndConcurrency", default, skip_serializing_if = "Option::is_none")]
    pub scale_and_concurrency: Option<FunctionsScaleAndConcurrency>,
}
...
#[doc = "Sets the number of 'Always Ready' instances for a function group or a specific function."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct FunctionsAlwaysReadyConfig {
    #[doc = "Either a function group or a function name is required. For additional information see https://aka.ms/flexconsumption/alwaysready."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Sets the number of 'Always Ready' instances for a given function group or a specific function. For additional information see https://aka.ms/flexconsumption/alwaysready."]
    #[serde(rename = "instanceCount", default, skip_serializing_if = "Option::is_none")]
    pub instance_count: Option<i32>,
}
impl FunctionsAlwaysReadyConfig {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct FunctionsDeployment {
    #[doc = "Storage for deployed package used by the function app."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub storage: Option<functions_deployment::Storage>,
}
impl FunctionsDeployment {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod functions_deployment {
    use super::*;
    #[doc = "Storage for deployed package used by the function app."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
    pub struct Storage {
        #[doc = "Property to select Azure Storage type. Available options: blobContainer."]
        #[serde(
            rename = "type",
            default,
            skip_serializing_if = "Option::is_none",
        ...
        #[doc = "Property to set the URL for the selected Azure Storage type. Example: For blobContainer, the value could be https://<storageAccountName>.blob.core.windows.net/<containerName>."]
        #[serde(default, skip_serializing_if = "Option::is_none")]
        pub value: Option<String>,
        #[doc = "Authentication method to access the storage account for deployment."]
        #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub mod storage {
        ...
        pub struct Authentication {
            #[doc = "Property to select authentication type to access the selected storage account. Available options: SystemAssignedIdentity, UserAssignedIdentity, StorageAccountConnectionString."]
            #[serde(
                rename = "type",
                default,
                skip_serializing_if = "Option::is_none",
            ...
            pub type_: Option<authentication::Type>,
            #[doc = "Use this property for UserAssignedIdentity. Set the resource ID of the identity. Do not set a value for this property when using other authentication type."]
            ...
            #[doc = "Use this property for StorageAccountConnectionString. Set the name of the app setting that has the storage account connection string. Do not set a value for this property when using other authentication type."]
            #[serde(rename = "storageAccountConnectionStringName", default, skip_serializing_if = "Option::is_none")]
            pub storage_account_connection_string_name: Option<String>,
        }
        impl Authentication {
            pub fn new() -> Self {
                Self::default()
        ...
        pub mod authentication {
            ...
            impl Serialize for Type {
                ...
                {
                    match self {
                        Self::SystemAssignedIdentity => serializer.serialize_unit_variant("Type", 0u32, "SystemAssignedIdentity"),
                        Self::UserAssignedIdentity => serializer.serialize_unit_variant("Type", 1u32, "UserAssignedIdentity"),
                        Self::StorageAccountConnectionString => {
                            serializer.serialize_unit_variant("Type", 2u32, "StorageAccountConnectionString")
                        }
                        Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
                    }
                }
...
pub struct FunctionsRuntime {
    #[doc = "Function app runtime name. Available options: dotnet-isolated, node, java, powershell, python, custom"]
    #[serde(default, skip_serializing_if = "Option::is_none", with = "azure_core::xml::text_content")]
    pub name: Option<functions_runtime::Name>,
    #[doc = "Function app runtime version. Example: 8 (for dotnet-isolated)"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub version: Option<String>,
}
...
pub mod functions_runtime {
    use super::*;
    #[doc = "Function app runtime name. Available options: dotnet-isolated, node, java, powershell, python, custom"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Name")]
    pub enum Name {
        #[serde(rename = "dotnet-isolated")]
        DotnetIsolated,
        #[serde(rename = "node")]
        Node,
        #[serde(rename = "java")]
    ...
    impl Serialize for Name {
        ...
        {
            match self {
                Self::DotnetIsolated => serializer.serialize_unit_variant("Name", 0u32, "dotnet-isolated"),
                Self::Node => serializer.serialize_unit_variant("Name", 1u32, "node"),
                Self::Java => serializer.serialize_unit_variant("Name", 2u32, "java"),
                Self::Powershell => serializer.serialize_unit_variant("Name", 3u32, "powershell"),
                Self::Python => serializer.serialize_unit_variant("Name", 4u32, "python"),
                Self::Custom => serializer.serialize_unit_variant("Name", 5u32, "custom"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Scale and concurrency settings for the function app."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct FunctionsScaleAndConcurrency {
    #[doc = "'Always Ready' configuration for the function app."]
    #[serde(
        rename = "alwaysReady",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub always_ready: Vec<FunctionsAlwaysReadyConfig>,
    #[doc = "The maximum number of instances for the function app."]
    #[serde(rename = "maximumInstanceCount", default, skip_serializing_if = "Option::is_none")]
    pub maximum_instance_count: Option<i32>,
    #[doc = "Set the amount of memory allocated to each instance of the function app in MB. CPU and network bandwidth are allocated proportionally."]
    #[serde(rename = "instanceMemoryMB", default, skip_serializing_if = "Option::is_none")]
    pub instance_memory_mb: Option<i32>,
    #[doc = "Scale and concurrency settings for the function app triggers."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub triggers: Option<functions_scale_and_concurrency::Triggers>,
}
impl FunctionsScaleAndConcurrency {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod functions_scale_and_concurrency {
    use super::*;
    #[doc = "Scale and concurrency settings for the function app triggers."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
    pub struct Triggers {
        #[doc = "Scale and concurrency settings for the HTTP trigger."]
        #[serde(default, skip_serializing_if = "Option::is_none")]
        pub http: Option<triggers::Http>,
    }
    impl Triggers {
        pub fn new() -> Self {
            Self::default()
    ...
    pub mod triggers {
        ...
        #[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
        pub struct Http {
            #[doc = "The maximum number of concurrent HTTP trigger invocations per instance."]
            #[serde(rename = "perInstanceConcurrency", default, skip_serializing_if = "Option::is_none")]
            pub per_instance_concurrency: Option<i32>,
        }
        impl Http {
            pub fn new() -> Self {
                Self::default()
...
pub struct Resource {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Kind of resource. If the resource is an app, you can refer to https://github.com/Azure/app-service-linux-docs/blob/master/Things_You_Should_Know/kind_property.md#app-service-resource-kind-reference for details supported values for kind."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kind: Option<String>,
...
pub mod site {
    ...
    pub struct Properties {
        ...
        #[serde(rename = "dnsConfiguration", default, skip_serializing_if = "Option::is_none")]
        pub dns_configuration: Option<SiteDnsConfig>,
        ...
        #[doc = "To enable Backup and Restore operations over virtual network"]
        #[serde(rename = "vnetBackupRestoreEnabled", default, skip_serializing_if = "Option::is_none")]
        pub vnet_backup_restore_enabled: Option<bool>,
        ...
        #[doc = "Function app configuration."]
        #[serde(rename = "functionAppConfig", default, skip_serializing_if = "Option::is_none")]
        pub function_app_config: Option<FunctionAppConfig>,
        #[doc = "App Dapr configuration."]
        ...
        #[doc = "Specifies the IP mode of the app."]
        #[serde(
            rename = "ipMode",
            default,
            skip_serializing_if = "Option::is_none",
        ...
        pub ip_mode: Option<properties::IpMode>,
        #[doc = "Whether to use end to end encryption between the FrontEnd and the Worker"]
        #[serde(rename = "endToEndEncryptionEnabled", default, skip_serializing_if = "Option::is_none")]
        pub end_to_end_encryption_enabled: Option<bool>,
        ...
        #[serde(rename = "keyVaultReferenceIdentity", default, skip_serializing_if = "Option::is_none")]
        pub key_vault_reference_identity: Option<String>,
        #[doc = "Specifies the scope of uniqueness for the default hostname during resource creation"]
        #[serde(
        ...
        pub auto_generated_domain_name_label_scope: Option<properties::AutoGeneratedDomainNameLabelScope>,
        ...
        #[doc = "Current SKU of application based on associated App Service Plan. Some valid SKU values are Free, Shared, Basic, Dynamic, FlexConsumption, Standard, Premium, PremiumV2, PremiumV3, Isolated, IsolatedV2"]
        #[serde(default, skip_serializing_if = "Option::is_none")]
        pub sku: Option<String>,
    }
    impl Properties {
    ...
    impl Serialize for MinTlsVersion {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::N1_3 => serializer.serialize_unit_variant("MinTlsVersion", 3u32, "1.3"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for ScmMinTlsVersion {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::N1_3 => serializer.serialize_unit_variant("ScmMinTlsVersion", 3u32, "1.3"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Container of a site"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SiteContainer {
    #[serde(flatten)]
    pub proxy_only_resource: ProxyOnlyResource,
    #[doc = "SiteContainer resource specific properties"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<site_container::Properties>,
}
impl SiteContainer {
    pub fn new() -> Self {
        Self::default()
...
pub mod site_container {
    ...
    pub struct Properties {
        ...
        #[doc = "<code>true</code> if the container is the main site container; <code>false</code> otherwise."]
        #[serde(rename = "isMain")]
        pub is_main: bool,
        #[doc = "StartUp Command"]
        #[serde(rename = "startUpCommand", default, skip_serializing_if = "Option::is_none")]
        ...
        pub auth_type: Option<properties::AuthType>,
        #[doc = "User Name"]
        ...
        #[doc = "UserManagedIdentity ClientId"]
    ...
    impl Properties {
        pub fn new(image: String, is_main: bool) -> Self {
            Self {
                image,
                target_port: None,
                is_main,
                start_up_command: None,
                auth_type: None,
                user_name: None,
...
#[doc = "Collection of site containers"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SiteContainerCollection {
    #[doc = "Collection of resources."]
    pub value: Vec<SiteContainer>,
    #[doc = "Link to next page of resources."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for SiteContainerCollection {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl SiteContainerCollection {
    pub fn new(value: Vec<SiteContainer>) -> Self {
        Self { value, next_link: None }
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SiteDnsConfig {
    #[doc = "List of custom DNS servers to be used by an app for lookups. Maximum 5 dns servers can be set."]
    #[serde(
        rename = "dnsServers",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    #[doc = "Alternate DNS server to be used by apps. This property replicates the WEBSITE_DNS_ALT_SERVER app setting."]
    #[serde(rename = "dnsAltServer", default, skip_serializing_if = "Option::is_none")]
    pub dns_alt_server: Option<String>,
    #[doc = "Timeout for a single dns lookup in seconds. Allowed range: 1-30. Default is 3."]
    #[serde(rename = "dnsRetryAttemptTimeout", default, skip_serializing_if = "Option::is_none")]
    pub dns_retry_attempt_timeout: Option<i32>,
    #[doc = "Total number of retries for dns lookup. Allowed range: 1-5. Default is 3."]
    #[serde(rename = "dnsRetryAttemptCount", default, skip_serializing_if = "Option::is_none")]
    pub dns_retry_attempt_count: Option<i32>,
    #[doc = "Custom time for DNS to be cached in seconds. Allowed range: 0-60. Default is 30 seconds. 0 means caching disabled."]
    #[serde(rename = "dnsMaxCacheTimeout", default, skip_serializing_if = "Option::is_none")]
    pub dns_max_cache_timeout: Option<i32>,
    #[doc = "Indicates that sites using Virtual network custom DNS servers are still sorting the list of DNS servers. Read-Only."]
    #[serde(rename = "dnsLegacySortOrder", default, skip_serializing_if = "Option::is_none")]
    pub dns_legacy_sort_order: Option<bool>,
}
impl SiteDnsConfig {
    pub fn new() -> Self {
        Self::default()
...
pub struct VolumeMount {
    #[doc = "Sub path in the volume where volume is mounted from."]
    #[serde(rename = "volumeSubPath")]
    pub volume_sub_path: String,
    #[doc = "Target path on the container where volume is mounted on"]
    #[serde(rename = "containerMountPath")]
    pub container_mount_path: String,
    #[doc = "Config Data to be mounted on the volume"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub data: Option<String>,
    #[doc = "Boolean to specify if the mount is read only on the container"]
    #[serde(rename = "readOnly", default, skip_serializing_if = "Option::is_none")]
    pub read_only: Option<bool>,
}
impl VolumeMount {
    pub fn new(volume_sub_path: String, container_mount_path: String) -> Self {
        Self {
            volume_sub_path,
...
pub mod web_site_instance_status {
    ...
    pub struct Properties {
        ...
        #[doc = "The physical zone that the instance is in"]
        #[serde(rename = "physicalZone", default, skip_serializing_if = "Option::is_none")]
        pub physical_zone: Option<String>,
    }
    impl Properties {
        pub fn new() -> Self {
            Self::default()
