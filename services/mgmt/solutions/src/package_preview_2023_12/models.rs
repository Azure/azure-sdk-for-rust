...
pub struct RegistryPackage {
    ...
    #[doc = "The plan Id"]
    pub plan: String,
    #[doc = "The version of the plan"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub version: Option<String>,
    #[doc = "Resource information."]
    #[serde(rename = "packageLinks")]
    pub package_links: RegistryPackageLinks,
}
impl RegistryPackage {
    pub fn new(publisher: String, offer: String, plan: String, package_links: RegistryPackageLinks) -> Self {
        Self {
            publisher,
            offer,
            plan,
...
#[doc = "Resource information."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RegistryPackageLinks {
    #[doc = "The create ui definition link."]
    #[serde(rename = "createUiDefinitionLink", default, skip_serializing_if = "Option::is_none")]
    pub create_ui_definition_link: Option<String>,
    #[doc = "The deployment template link."]
    #[serde(rename = "deploymentTemplateLink", default, skip_serializing_if = "Option::is_none")]
    pub deployment_template_link: Option<String>,
}
impl RegistryPackageLinks {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Plan for the managed application."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RegistryPackagePlan {
    #[doc = "The publisher ID."]
    pub publisher: String,
    #[doc = "The offer Id."]
    pub offer: String,
...
impl RegistryPackagePlan {
    pub fn new(publisher: String, offer: String, plan: String) -> Self {
        Self {
            publisher,
            offer,
            plan,
