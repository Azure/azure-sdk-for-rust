...
pub mod application_definitions {
    ...
    impl Client {
        ...
        #[doc = "Lists all the application definitions within a subscription."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
...
impl Client {
    ...
    #[doc = "Generates the registry package links for Managed Applications and Solution Templates."]
    #[doc = ""]
    #[doc = "Arguments:"]
    #[doc = "* `parameters`: Request body parameters to get registry packages."]
    pub fn portal_registry_package(&self, parameters: impl Into<models::RegistryPackagePlan>) -> portal_registry_package::RequestBuilder {
        portal_registry_package::RequestBuilder {
            client: self.clone(),
            parameters: parameters.into(),
        }
    }
...
pub mod portal_registry_package {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    pub struct Response(azure_core::Response);
    impl Response {
        pub async fn into_body(self) -> azure_core::Result<models::RegistryPackage> {
            let bytes = self.0.into_body().collect().await?;
            let body: models::RegistryPackage = serde_json::from_slice(&bytes)?;
            Ok(body)
        }
        pub fn into_raw_response(self) -> azure_core::Response {
            self.0
    ...
    pub struct RequestBuilder {
        pub(crate) client: super::Client,
        pub(crate) parameters: models::RegistryPackagePlan,
    }
    impl RequestBuilder {
        #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
        #[doc = ""]
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path("/providers/Microsoft.Solutions/portalRegistryPackage");
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "2023-12-01-preview");
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::RegistryPackage>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::RegistryPackage>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
