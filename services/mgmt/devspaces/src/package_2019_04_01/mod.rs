...
pub mod container_host_mappings {
    ...
    impl Client {
        ...
        ) -> get_container_host_mapping::RequestBuilder {
            get_container_host_mapping::RequestBuilder {
                client: self.0.clone(),
                container_host_mapping: container_host_mapping.into(),
    ...
    pub mod get_container_host_mapping {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ContainerHostMapping> {
                ...
                let body: models::ContainerHostMapping = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) container_host_mapping: models::ContainerHostMapping,
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        let req_body = azure_core::to_json(&this.container_host_mapping)?;
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ContainerHostMapping>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::ContainerHostMapping>>;
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ResourceProviderOperationList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    ...
                    async move {
                        let mut url =
                            azure_core::Url::parse(&format!("{}/providers/Microsoft.DevSpaces/operations", this.client.endpoint(),))?;
...
pub mod controllers {
    ...
    impl Client {
        ...
        pub fn create(
            ...
            resource_group_name: impl Into<String>,
            name: impl Into<String>,
            controller: impl Into<models::Controller>,
        ...
        pub fn update(
            ...
            resource_group_name: impl Into<String>,
            name: impl Into<String>,
            controller_update_parameters: impl Into<models::ControllerUpdateParameters>,
        ...
        pub fn list_connection_details(
            ...
            resource_group_name: impl Into<String>,
            name: impl Into<String>,
            list_connection_details_parameters: impl Into<models::ListConnectionDetailsParameters>,
        ) -> list_connection_details::RequestBuilder {
            list_connection_details::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
                name: name.into(),
                list_connection_details_parameters: list_connection_details_parameters.into(),
            }
        }
    }
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::Controller> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::Controller = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::Controller>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::Controller>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) name: String,
            pub(crate) controller: models::Controller,
        }
        impl RequestBuilder {
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2019-04-01");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.controller)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
    ...
    pub mod update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) name: String,
            pub(crate) controller_update_parameters: models::ControllerUpdateParameters,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2019-04-01");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.controller_update_parameters)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
    ...
    pub mod list_by_resource_group {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ControllerList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ControllerList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ControllerList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
    ...
    pub mod list_connection_details {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ControllerConnectionDetailsList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ControllerConnectionDetailsList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) name: String,
            pub(crate) list_connection_details_parameters: models::ListConnectionDetailsParameters,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2019-04-01");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.list_connection_details_parameters)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ControllerConnectionDetailsList>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::ControllerConnectionDetailsList>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
