        ...
        impl Builder {
            ...
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core::Url::parse(&format!("{}/providers/Microsoft.Marketplace/search", this.client.endpoint(),))?;
                        ...
                        req.url_mut()
                            .query_pairs_mut()
                            .append_pair(azure_core::query_param::API_VERSION, "2022-02-02");
                        req.insert_header("x-ms-client-tenant-id", &this.x_ms_client_tenant_id);
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.request)?;
                        if let Some(x_ms_app) = &this.x_ms_app {
                            req.insert_header("x-ms-app", x_ms_app);
                        }
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                ...
                                let rsp_value: models::SearchResponseDto = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
