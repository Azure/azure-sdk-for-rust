...
pub mod search {
    ...
    pub mod post_arm {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SearchResponseDto> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SearchResponseDto = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/providers/Microsoft.Marketplace/search", self.client.endpoint(),))?;
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::SearchResponseDto>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::SearchResponseDto>>;
