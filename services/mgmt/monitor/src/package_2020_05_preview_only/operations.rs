...
pub mod scheduled_query_rules {
    ...
    pub async fn list_by_subscription(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                ...
                let rsp_value: ScheduledQueryRuleResourceCollection = serde_json::from_slice(rsp_body)
    ...
    pub async fn create_or_update(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: ScheduledQueryRuleResource = serde_json::from_slice(rsp_body)
