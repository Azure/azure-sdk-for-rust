...
pub mod scheduled_query_rules {
    ...
    pub async fn list_by_subscription(
        ...
        subscription_id: &str,
    ) -> std::result::Result<models::ScheduledQueryRuleResourceCollection, list_by_subscription::Error> {
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                ...
                let rsp_value: models::ScheduledQueryRuleResourceCollection = serde_json::from_slice(rsp_body)
    ...
    ) -> std::result::Result<models::ScheduledQueryRuleResourceCollection, list_by_resource_group::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
    ...
    pub async fn get(
        ...
        resource_group_name: &str,
        rule_name: &str,
    ) -> std::result::Result<models::ScheduledQueryRuleResource, get::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Insights/scheduledQueryRules/{}",
            operation_config.base_path(),
    ...
    pub async fn create_or_update(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::ScheduledQueryRuleResource = serde_json::from_slice(rsp_body)
    ...
    ) -> std::result::Result<models::ScheduledQueryRuleResource, update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Insights/scheduledQueryRules/{}",
            operation_config.base_path(),
