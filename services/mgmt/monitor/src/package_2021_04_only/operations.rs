...
pub mod data_collection_endpoints {
    ...
    pub mod list_by_resource_group {
        use super::models;
        type Response = models::DataCollectionEndpointResourceListResult;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
    ...
    pub mod get {
        use super::models;
        type Response = models::DataCollectionEndpointResource;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
            DefaultResponse {
                ...
                Box::pin({
                    ...
                    async move {
                        let url_str = &format!(
                            ...
                            &this.subscription_id,
                            &this.resource_group_name,
                            &this.data_collection_endpoint_name
                        );
                        let mut url = url::Url::parse(url_str).map_err(Error::ParseUrl)?;
                        let mut req_builder = http::request::Builder::new();
                        req_builder = req_builder.method(http::Method::GET);
...
pub mod data_collection_rules {
    ...
    pub mod list_by_resource_group {
        use super::models;
        type Response = models::DataCollectionRuleResourceListResult;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
            DefaultResponse {
    ...
    pub mod get {
        use super::models;
        type Response = models::DataCollectionRuleResource;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
            DefaultResponse {
                ...
                Box::pin({
                    ...
                    async move {
                        let url_str = &format!(
                            ...
                            &this.subscription_id,
                            &this.resource_group_name,
                            &this.data_collection_rule_name
                        );
                        let mut url = url::Url::parse(url_str).map_err(Error::ParseUrl)?;
                        let mut req_builder = http::request::Builder::new();
                        req_builder = req_builder.method(http::Method::GET);
...
pub mod data_collection_rule_associations {
    ...
    pub mod list_by_resource {
        use super::models;
        type Response = models::DataCollectionRuleAssociationProxyOnlyResourceListResult;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
            DefaultResponse {
    ...
    pub mod get {
        use super::models;
        type Response = models::DataCollectionRuleAssociationProxyOnlyResource;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
            DefaultResponse {
