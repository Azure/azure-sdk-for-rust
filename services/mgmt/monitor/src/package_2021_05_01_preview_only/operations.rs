...
pub mod predictive_metric {
    ...
    pub mod get {
        use super::models;
        type Response = models::PredictiveResponse;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
            DefaultResponse {
...
pub mod management_group_diagnostic_settings {
    ...
    pub mod get {
        use super::models;
        type Response = models::ManagementGroupDiagnosticSettingsResource;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
            DefaultResponse {
    ...
    pub mod list {
        use super::models;
        type Response = models::ManagementGroupDiagnosticSettingsResourceCollection;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
            DefaultResponse {
