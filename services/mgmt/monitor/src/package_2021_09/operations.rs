...
pub mod action_groups {
    ...
    pub async fn post_test_notifications(
    ...
    ) -> std::result::Result<TestNotificationResponse, post_test_notifications::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        match rsp.status() {
            http::StatusCode::ACCEPTED => {
                let rsp_body = rsp.body();
                let rsp_value: TestNotificationResponse = serde_json::from_slice(rsp_body)
    ...
    pub async fn get_test_notifications(
        ...
        subscription_id: &str,
        notification_id: &str,
    ) -> std::result::Result<TestNotificationDetailsResponse, get_test_notifications::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: TestNotificationDetailsResponse = serde_json::from_slice(rsp_body)
