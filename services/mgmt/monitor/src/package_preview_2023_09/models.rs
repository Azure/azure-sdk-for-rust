...
pub struct ActionGroup {
    ...
    #[doc = "The list of incident receivers that are part of this action group."]
    #[serde(
        rename = "incidentReceivers",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub incident_receivers: Vec<IncidentReceiver>,
}
impl ActionGroup {
...
#[doc = "Azure Data Explorer (Adx) destination."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AdxDestination {
    #[doc = "The ARM resource id of the Adx resource."]
    #[serde(rename = "resourceId", default, skip_serializing_if = "Option::is_none")]
    pub resource_id: Option<String>,
    #[doc = "The name of the database to which data will be ingested."]
    #[serde(rename = "databaseName", default, skip_serializing_if = "Option::is_none")]
    pub database_name: Option<String>,
    #[doc = "The ingestion uri of the Adx resource."]
    #[serde(rename = "ingestionUri", default, skip_serializing_if = "Option::is_none")]
    pub ingestion_uri: Option<String>,
...
#[doc = "A setting used to control an agent behavior on a host machine"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AgentSetting {
    #[doc = "The name of the setting. \r\nMust be part of the list of supported settings"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<agent_setting::Name>,
...
pub mod agent_setting {
    ...
    impl Serialize for Name {
        ...
        {
            match self {
                Self::MaxDiskQuotaInMb => serializer.serialize_unit_variant("Name", 0u32, "MaxDiskQuotaInMB"),
                Self::UseTimeReceivedForForwardedEvents => {
                    serializer.serialize_unit_variant("Name", 1u32, "UseTimeReceivedForForwardedEvents")
                }
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
...
#[doc = "An agent setting"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AgentSettingsSpec {
    #[doc = "All the settings that are applicable to the logs agent (AMA)"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub logs: Vec<AgentSetting>,
}
impl AgentSettingsSpec {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct AzureMonitorWorkspace {
    ...
    pub private_endpoint_connections: Vec<PrivateEndpointConnection>,
    #[doc = "Gets or sets allow or disallow public network access to Azure Monitor Workspace"]
    #[serde(rename = "publicNetworkAccess", default, skip_serializing_if = "Option::is_none")]
    pub public_network_access: Option<azure_monitor_workspace::PublicNetworkAccess>,
}
...
pub struct DataCollectionEndpoint {
    ...
    #[serde(rename = "metricsIngestion", default, skip_serializing_if = "Option::is_none")]
    pub metrics_ingestion: Option<serde_json::Value>,
    ...
    #[serde(rename = "failoverConfiguration", default, skip_serializing_if = "Option::is_none")]
    pub failover_configuration: Option<serde_json::Value>,
...
pub struct DataCollectionRule {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metadata: Option<serde_json::Value>,
    #[doc = "Defines the ingestion endpoints to send data to via this rule."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub endpoints: Option<serde_json::Value>,
    #[doc = "Defines all the references that may be used in other sections of the DCR"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub references: Option<serde_json::Value>,
    #[doc = "Agent settings used to modify agent behavior on a given host"]
    #[serde(rename = "agentSettings", default, skip_serializing_if = "Option::is_none")]
...
pub struct DataFlow {
    ...
    #[serde(rename = "builtInTransform", default, skip_serializing_if = "Option::is_none")]
    pub built_in_transform: Option<String>,
    #[doc = "Flag to enable overflow column in LA destinations"]
    #[serde(rename = "captureOverflow", default, skip_serializing_if = "Option::is_none")]
    pub capture_overflow: Option<bool>,
}
impl DataFlow {
    pub fn new() -> Self {
        Self::default()
...
pub struct DataSourcesSpec {
    ...
    #[serde(
        rename = "windowsFirewallLogs",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub windows_firewall_logs: Vec<WindowsFirewallLogsDataSource>,
    #[doc = "The list of Prometheus forwarder data source configurations."]
    #[serde(
        rename = "prometheusForwarder",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub prometheus_forwarder: Vec<PrometheusForwarderDataSource>,
    #[doc = "The list of platform telemetry configurations"]
    #[serde(
        rename = "platformTelemetry",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub platform_telemetry: Vec<PlatformTelemetryDataSource>,
    #[doc = "Specifications of pull based data sources"]
    #[serde(rename = "dataImports", default, skip_serializing_if = "Option::is_none")]
    pub data_imports: Option<serde_json::Value>,
}
...
pub struct DestinationsSpec {
    ...
    #[serde(
        rename = "monitoringAccounts",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub monitoring_accounts: Vec<MonitoringAccountDestination>,
    #[doc = "Azure Monitor Metrics destination."]
    ...
    pub event_hubs: Vec<EventHubDestination>,
    #[doc = "List of Event Hubs Direct destinations."]
    #[serde(
        rename = "eventHubsDirect",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub event_hubs_direct: Vec<EventHubDirectDestination>,
    #[doc = "List of Storage Blob Direct destinations. To be used only for sending data directly to store from the agent."]
    #[serde(
        rename = "storageBlobsDirect",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub storage_blobs_direct: Vec<StorageBlobDestination>,
    #[doc = "List of Storage Table Direct destinations."]
    #[serde(
        rename = "storageTablesDirect",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub storage_tables_direct: Vec<StorageTableDestination>,
    ...
    pub storage_accounts: Vec<StorageBlobDestination>,
    #[doc = "List of Microsoft Fabric destinations."]
    #[serde(
        rename = "microsoftFabric",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub microsoft_fabric: Vec<MicrosoftFabricDestination>,
    #[doc = "List of Azure Data Explorer destinations."]
    #[serde(
        rename = "azureDataExplorer",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub azure_data_explorer: Vec<AdxDestination>,
}
...
#[doc = "This defines all the ingestion endpoints that can be used by this rule"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EndpointsSpec {
    #[doc = "The ingestion endpoint for logs"]
    #[serde(rename = "logsIngestion", default, skip_serializing_if = "Option::is_none")]
    pub logs_ingestion: Option<String>,
    #[doc = "The ingestion endpoint for metrics"]
    #[serde(rename = "metricsIngestion", default, skip_serializing_if = "Option::is_none")]
    pub metrics_ingestion: Option<String>,
}
impl EndpointsSpec {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "All the enrichment data sources referenced in data flows"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EnrichmentData {
    #[doc = "All the storage blobs used as enrichment data sources"]
    #[serde(
        rename = "storageBlobs",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub storage_blobs: Vec<StorageBlob>,
}
impl EnrichmentData {
    pub fn new() -> Self {
        Self::default()
...
impl EventHubDataSource {
    pub fn new() -> Self {
        Self::default()
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EventHubDestination {
...
impl EventHubDestination {
    pub fn new() -> Self {
        Self::default()
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EventHubDirectDestination {
    #[doc = "The resource ID of the event hub."]
    #[serde(rename = "eventHubResourceId", default, skip_serializing_if = "Option::is_none")]
    pub event_hub_resource_id: Option<String>,
    #[doc = "A friendly name for the destination. \r\nThis name should be unique across all destinations (regardless of type) within the data collection rule."]
...
impl EventHubDirectDestination {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct FailoverConfigurationSpec {
...
impl FailoverConfigurationSpec {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct IisLogsDataSource {
    ...
    #[doc = "The KQL query to transform the data source."]
    #[serde(rename = "transformKql", default, skip_serializing_if = "Option::is_none")]
    pub transform_kql: Option<String>,
    #[doc = "A friendly name for the data source.\r\nThis name should be unique across all data sources (regardless of type) within the data collection rule."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "An Incident receiver."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct IncidentReceiver {
    #[doc = "The name of the Incident receiver. Names must be unique across all receivers within an action group."]
    pub name: String,
    #[doc = "The connection info for Incident Receiver."]
    pub connection: IncidentServiceConnection,
    #[doc = "The incident management service type"]
    #[serde(rename = "incidentManagementService")]
    pub incident_management_service: incident_receiver::IncidentManagementService,
    #[doc = "Field mappings for the incident service"]
    pub mappings: serde_json::Value,
}
impl IncidentReceiver {
    pub fn new(
        name: String,
        connection: IncidentServiceConnection,
        incident_management_service: incident_receiver::IncidentManagementService,
...
pub mod incident_receiver {
    use super::*;
    #[doc = "The incident management service type"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "IncidentManagementService")]
    pub enum IncidentManagementService {
        Icm,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for IncidentManagementService {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for IncidentManagementService {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for IncidentManagementService {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Icm => serializer.serialize_unit_variant("IncidentManagementService", 0u32, "Icm"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "The connection info for Incident Receiver."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct IncidentServiceConnection {
    #[doc = "The name of the connection."]
    pub name: String,
    #[doc = "GUID value representing the connection ID for the incident management service."]
    pub id: String,
}
impl IncidentServiceConnection {
...
pub struct LocationSpec {
    ...
    pub provisioning_status: Option<location_spec::ProvisioningStatus>,
}
impl LocationSpec {
    pub fn new() -> Self {
        Self::default()
...
pub mod location_spec {
    ...
    impl Serialize for ProvisioningStatus {
        ...
        {
            match self {
                Self::Creating => serializer.serialize_unit_variant("ProvisioningStatus", 0u32, "Creating"),
                Self::Updating => serializer.serialize_unit_variant("ProvisioningStatus", 1u32, "Updating"),
                Self::Deleting => serializer.serialize_unit_variant("ProvisioningStatus", 2u32, "Deleting"),
                Self::Succeeded => serializer.serialize_unit_variant("ProvisioningStatus", 3u32, "Succeeded"),
                Self::Canceled => serializer.serialize_unit_variant("ProvisioningStatus", 4u32, "Canceled"),
                Self::Failed => serializer.serialize_unit_variant("ProvisioningStatus", 5u32, "Failed"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub mod log_files_data_source {
    ...
    impl Serialize for Format {
        ...
        {
            match self {
                Self::Json => serializer.serialize_unit_variant("Format", 0u32, "json"),
                Self::Text => serializer.serialize_unit_variant("Format", 1u32, "text"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct Metadata {
    ...
    #[serde(rename = "provisionedByResourceId", default, skip_serializing_if = "Option::is_none")]
    pub provisioned_by_resource_id: Option<String>,
    #[doc = "Immutable Id of azure offering managing this resource on-behalf-of customer."]
    #[serde(rename = "provisionedByImmutableId", default, skip_serializing_if = "Option::is_none")]
    pub provisioned_by_immutable_id: Option<String>,
}
impl Metadata {
    pub fn new() -> Self {
        Self::default()
...
pub struct MetricAvailability {
    #[doc = "The time grain specifies a supported aggregation interval for the metric. Expressed as a duration 'PT1M', 'P1D', etc."]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MetricsIngestionEndpointSpec {
    #[doc = "The endpoint. This property is READ-ONLY."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub endpoint: Option<String>,
}
impl MetricsIngestionEndpointSpec {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Microsoft Fabric destination (non-Azure)."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MicrosoftFabricDestination {
    #[doc = "The tenant id of the Microsoft Fabric resource."]
    #[serde(rename = "tenantId", default, skip_serializing_if = "Option::is_none")]
    pub tenant_id: Option<String>,
    #[doc = "The artifact id of the Microsoft Fabric resource."]
    #[serde(rename = "artifactId", default, skip_serializing_if = "Option::is_none")]
    pub artifact_id: Option<String>,
    #[doc = "The name of the database to which data will be ingested."]
    #[serde(rename = "databaseName", default, skip_serializing_if = "Option::is_none")]
    pub database_name: Option<String>,
    #[doc = "The ingestion uri of the Microsoft Fabric resource."]
    #[serde(rename = "ingestionUri", default, skip_serializing_if = "Option::is_none")]
    pub ingestion_uri: Option<String>,
    #[doc = "A friendly name for the destination. \r\nThis name should be unique across all destinations (regardless of type) within the data collection rule."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl MicrosoftFabricDestination {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MonitoringAccountDestination {
    #[doc = "The resource ID of the monitoring account."]
    #[serde(rename = "accountResourceId", default, skip_serializing_if = "Option::is_none")]
    pub account_resource_id: Option<String>,
...
impl MonitoringAccountDestination {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct PlatformTelemetryDataSource {
...
impl PlatformTelemetryDataSource {
    pub fn new(streams: Vec<String>) -> Self {
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PrometheusForwarderDataSource {
    #[doc = "List of streams that this data source will be sent to."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub streams: Vec<String>,
    #[doc = "The list of label inclusion filters in the form of label \"name-value\" pairs.\r\nCurrently only one label is supported: 'microsoft_metrics_include_label'.\r\nLabel values are matched case-insensitively."]
    #[serde(rename = "labelIncludeFilter", default, skip_serializing_if = "Option::is_none")]
    pub label_include_filter: Option<serde_json::Value>,
    #[doc = "A friendly name for the data source.\r\nThis name should be unique across all data sources (regardless of type) within the data collection rule."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
impl PrometheusForwarderDataSource {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "This section defines all the references that may be used in other sections of the DCR"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ReferencesSpec {
    #[doc = "All the enrichment data sources referenced in data flows"]
    #[serde(rename = "enrichmentData", default, skip_serializing_if = "Option::is_none")]
...
pub struct Response {
    ...
    #[doc = "The timespan for which the data was retrieved. Its value consists of two datetimes concatenated, separated by '/'.  This may be adjusted in the future and returned back from what was originally requested."]
    pub timespan: String,
    #[doc = "The interval (window size) for which the metric data was returned in ISO 8601 duration format with a special case for 'FULL' value that returns single datapoint for entire time span requested (*Examples: PT15M, PT1H, P1D, FULL*). \nThis may be adjusted and different from what was originally requested if AutoAdjustTimegrain=true is specified. This is not present if a metadata request was made."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub interval: Option<String>,
...
pub struct ScheduledQueryRuleProperties {
    ...
    pub resolve_configuration: Option<RuleResolveConfiguration>,
}
...
pub struct StorageBlob {
    #[doc = "Resource Id of the storage account that hosts the blob"]
    #[serde(rename = "resourceId", default, skip_serializing_if = "Option::is_none")]
    pub resource_id: Option<String>,
    #[doc = "Url of the storage blob"]
    #[serde(rename = "blobUrl", default, skip_serializing_if = "Option::is_none")]
    pub blob_url: Option<String>,
    #[doc = "The type of lookup to perform on the blob"]
    #[serde(rename = "lookupType", default, skip_serializing_if = "Option::is_none")]
    pub lookup_type: Option<storage_blob::LookupType>,
    #[doc = "The name of the enrichment data source used as an alias when referencing this data source in data flows"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
impl StorageBlob {
...
pub mod storage_blob {
    ...
    impl FromStr for LookupType {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for LookupType {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for LookupType {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::String => serializer.serialize_unit_variant("LookupType", 0u32, "String"),
                Self::Cidr => serializer.serialize_unit_variant("LookupType", 1u32, "Cidr"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct StorageBlobDestination {
...
impl StorageBlobDestination {
    pub fn new() -> Self {
        Self::default()
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct StorageTableDestination {
...
#[doc = "The request body which contain contact detail metadata"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct TenantNotificationRequestBody {
    #[doc = "The value of the supported alert type. Supported alert type value is: servicehealth"]
    #[serde(rename = "alertType")]
    pub alert_type: String,
    #[doc = "The list of email receivers that are part of this action group."]
    #[serde(
...
impl TenantNotificationRequestBody {
    pub fn new(alert_type: String) -> Self {
        Self {
            alert_type,
            email_receivers: Vec::new(),
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct WindowsFirewallLogsDataSource {
    #[doc = "Firewall logs streams"]
    pub streams: Vec<String>,
    #[doc = "Firewall logs profile filter"]
    #[serde(
        rename = "profileFilter",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
...
impl WindowsFirewallLogsDataSource {
    pub fn new(streams: Vec<String>) -> Self {
        Self {
            streams,
