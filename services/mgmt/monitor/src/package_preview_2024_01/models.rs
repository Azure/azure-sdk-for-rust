...
pub struct Condition {
    ...
    #[serde(rename = "criterionType", default, skip_serializing_if = "Option::is_none")]
    pub criterion_type: Option<condition::CriterionType>,
    #[doc = "Log query alert"]
    ...
    #[doc = "the criteria threshold value that activates the alert. Relevant and required only for static threshold rules of the kind LogAlert."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub threshold: Option<f64>,
    #[doc = "The extent of deviation required to trigger an alert. Allowed values are 'Low', 'Medium' and 'High'. This will affect how tight the threshold is to the metric series pattern. Relevant and required only for dynamic threshold rules of the kind LogAlert."]
    #[serde(rename = "alertSensitivity", default, skip_serializing_if = "Option::is_none")]
    pub alert_sensitivity: Option<String>,
    #[doc = "Use this option to set the date from which to start learning the metric historical data and calculate the dynamic thresholds (in ISO8601 format). Relevant only for dynamic threshold rules of the kind LogAlert."]
    ...
    impl Serialize for Operator {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::GreaterOrLessThan => serializer.serialize_unit_variant("Operator", 5u32, "GreaterOrLessThan"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for Kind {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::EventLogAlert => serializer.serialize_unit_variant("Kind", 1u32, "EventLogAlert"),
                Self::LogToMetric => serializer.serialize_unit_variant("Kind", 2u32, "LogToMetric"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
