...
pub enum Error {
    ...
    #[error(transparent)]
    ActionGroups_CreateNotificationsAtResourceGroupLevel(#[from] action_groups::create_notifications_at_resource_group_level::Error),
    #[error(transparent)]
    ActionGroups_GetTestNotifications(#[from] action_groups::get_test_notifications::Error),
    #[error(transparent)]
    ActionGroups_GetTestNotificationsAtResourceGroupLevel(#[from] action_groups::get_test_notifications_at_resource_group_level::Error),
    #[error(transparent)]
...
pub mod action_groups {
    ...
    impl Client {
        ...
        pub fn create_notifications_at_resource_group_level(
            ...
            resource_group_name: impl Into<String>,
            notification_request: impl Into<models::NotificationRequestBody>,
        ) -> create_notifications_at_resource_group_level::Builder {
            create_notifications_at_resource_group_level::Builder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        pub fn get_test_notifications_at_resource_group_level(
            ...
            resource_group_name: impl Into<String>,
            notification_id: impl Into<String>,
        ) -> get_test_notifications_at_resource_group_level::Builder {
            get_test_notifications_at_resource_group_level::Builder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
