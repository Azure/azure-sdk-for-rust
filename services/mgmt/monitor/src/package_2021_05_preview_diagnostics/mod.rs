...
impl Client {
    ...
    pub fn management_group_diagnostic_settings_client(&self) -> management_group_diagnostic_settings::Client {
...
pub mod management_group_diagnostic_settings {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets the active management group diagnostic settings for the specified resource."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `management_group_id`: The management group id."]
        #[doc = "* `name`: The name of the diagnostic setting."]
        pub fn get(&self, management_group_id: impl Into<String>, name: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
        ...
        #[doc = "Creates or updates management group diagnostic settings for the specified resource."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `management_group_id`: The management group id."]
        #[doc = "* `parameters`: Parameters supplied to the operation."]
        ...
        #[doc = "Deletes existing management group diagnostic settings for the specified resource."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `management_group_id`: The management group id."]
        #[doc = "* `name`: The name of the diagnostic setting."]
        pub fn delete(&self, management_group_id: impl Into<String>, name: impl Into<String>) -> delete::RequestBuilder {
            delete::RequestBuilder {
                client: self.0.clone(),
                management_group_id: management_group_id.into(),
                name: name.into(),
        ...
        #[doc = "Gets the active management group diagnostic settings list for the specified management group."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `management_group_id`: The management group id."]
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ManagementGroupDiagnosticSettingsResource> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ManagementGroupDiagnosticSettingsResource = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    ...
                    &self.management_group_id, &self.name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ManagementGroupDiagnosticSettingsResource>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ManagementGroupDiagnosticSettingsResource>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ManagementGroupDiagnosticSettingsResourceCollection> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ManagementGroupDiagnosticSettingsResourceCollection = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
...
pub mod action_groups {
    ...
    impl Client {
        ...
        ) -> post_test_notifications::RequestBuilder {
            post_test_notifications::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `notification_request`: The notification request body which includes the contact details"]
        pub fn create_notifications_at_resource_group_level(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            notification_request: impl Into<models::NotificationRequestBody>,
        ) -> create_notifications_at_resource_group_level::RequestBuilder {
            create_notifications_at_resource_group_level::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        ) -> get_test_notifications::RequestBuilder {
            get_test_notifications::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `notification_id`: The notification id"]
        pub fn get_test_notifications_at_resource_group_level(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            notification_id: impl Into<String>,
        ) -> get_test_notifications_at_resource_group_level::RequestBuilder {
            get_test_notifications_at_resource_group_level::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod create_notifications_at_resource_group_level {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Insights/createNotifications",
                    &self.subscription_id, &self.resource_group_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    ...
                    &self.subscription_id, &self.notification_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
    ...
    pub mod get_test_notifications_at_resource_group_level {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Insights/notificationStatus/{}",
                    &self.subscription_id, &self.resource_group_name, &self.notification_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
