...
pub mod recommendation_metadata {
    use crate::{models::*, *};
    pub async fn get(configuration: &Configuration, name: &str) -> Result<MetadataEntity> {
    ...
    pub async fn list(configuration: &Configuration) -> Result<MetadataEntityListResult> {
        let client = &configuration.client;
...
pub mod configurations {
    use crate::{models::*, *};
    pub async fn list_by_subscription(configuration: &Configuration, subscription_id: &str) -> Result<ConfigurationListResult> {
        let client = &configuration.client;
        let uri_str = &format!(
...
pub mod recommendations {
    ...
    pub async fn get_generate_status(configuration: &Configuration, subscription_id: &str, operation_id: &str) -> Result<()> {
        let client = &configuration.client;
        let uri_str = &format!(
            "{}/subscriptions/{}/providers/Microsoft.Advisor/generateRecommendations/{}",
...
pub mod suppressions {
    ...
    pub async fn list(
        ...
        top: Option<i64>,
        skip_token: Option<&str>,
    ) -> Result<SuppressionContractListResult> {
        let client = &configuration.client;
        let uri_str = &format!(
