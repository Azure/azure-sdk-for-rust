...
pub mod recommendations {
    ...
    pub async fn generate(operation_config: &crate::OperationConfig, subscription_id: &str) -> std::result::Result<(), generate::Error> {
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: ArmErrorResponse = serde_json::from_slice(rsp_body).map_err(|source| generate::Error::DeserializeError {
                    source,
                    body: rsp_body.clone(),
                })?;
    ...
    pub async fn get_generate_status(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: ArmErrorResponse =
                    serde_json::from_slice(rsp_body).map_err(|source| get_generate_status::Error::DeserializeError {
                        source,
                        body: rsp_body.clone(),
                    })?;
...
pub mod suppressions {
    ...
    pub async fn create(
        ...
        match rsp.status() {
            ...
            http::StatusCode::NOT_FOUND => {
                let rsp_body = rsp.body();
                let rsp_value: ArmErrorResponse = serde_json::from_slice(rsp_body).map_err(|source| create::Error::DeserializeError {
                    source,
                    body: rsp_body.clone(),
                })?;
    ...
    pub async fn delete(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: ArmErrorResponse = serde_json::from_slice(rsp_body).map_err(|source| delete::Error::DeserializeError {
                    source,
                    body: rsp_body.clone(),
                })?;
