...
pub struct Nfs3Target {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<String>,
    #[doc = "Identifies the usage model to be used for this Storage Target. Get choices from .../usageModels"]
...
pub struct NfsAccessRule {
    ...
    #[doc = "UID value that replaces 0 when rootSquash is true."]
    #[serde(rename = "anonymousUID", default, skip_serializing_if = "Option::is_none")]
    pub anonymous_uid: Option<String>,
    #[doc = "GID value that replaces 0 when rootSquash is true."]
