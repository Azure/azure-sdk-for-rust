...
pub mod import_jobs {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Returns an import job."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `aml_filesystem_name`: Name for the AML file system. Allows alphanumerics, underscores, and hyphens. Start and end with alphanumeric."]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `import_job_name`: Name for the import job. Allows alphanumerics, underscores, and hyphens. Start and end with alphanumeric."]
        pub fn get(
            &self,
            resource_group_name: impl Into<String>,
            aml_filesystem_name: impl Into<String>,
            subscription_id: impl Into<String>,
            import_job_name: impl Into<String>,
        ) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                aml_filesystem_name: aml_filesystem_name.into(),
                subscription_id: subscription_id.into(),
                import_job_name: import_job_name.into(),
            }
        }
        #[doc = "Create or update an import job. Import jobs are automatically deleted 72 hours after completion."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `aml_filesystem_name`: Name for the AML file system. Allows alphanumerics, underscores, and hyphens. Start and end with alphanumeric."]
        #[doc = "* `import_job_name`: Name for the import job. Allows alphanumerics, underscores, and hyphens. Start and end with alphanumeric."]
        #[doc = "* `import_job`: Object containing the user-selectable properties of the import job. If read-only properties are included, they must match the existing values of those properties."]
        pub fn create_or_update(
            &self,
            resource_group_name: impl Into<String>,
            subscription_id: impl Into<String>,
            aml_filesystem_name: impl Into<String>,
            import_job_name: impl Into<String>,
            import_job: impl Into<models::ImportJob>,
        ) -> create_or_update::RequestBuilder {
            create_or_update::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
        ...
        #[doc = "Update an import job instance."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        ...
        pub fn update(
            ...
            aml_filesystem_name: impl Into<String>,
            import_job_name: impl Into<String>,
            import_job: impl Into<models::ImportJobUpdate>,
        ) -> update::RequestBuilder {
            update::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
        ...
        #[doc = "Schedules an import job for deletion."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `aml_filesystem_name`: Name for the AML file system. Allows alphanumerics, underscores, and hyphens. Start and end with alphanumeric."]
        ...
        #[doc = "Returns all import jobs the user has access to under an AML File System."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `aml_filesystem_name`: Name for the AML file system. Allows alphanumerics, underscores, and hyphens. Start and end with alphanumeric."]
        pub fn list_by_aml_filesystem(
            &self,
            resource_group_name: impl Into<String>,
            subscription_id: impl Into<String>,
            aml_filesystem_name: impl Into<String>,
        ) -> list_by_aml_filesystem::RequestBuilder {
            list_by_aml_filesystem::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                subscription_id: subscription_id.into(),
    ...
    pub mod get {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) aml_filesystem_name: String,
            pub(crate) subscription_id: String,
            pub(crate) import_job_name: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.StorageCache/amlFilesystems/{}/importJobs/{}",
                    &self.subscription_id, &self.resource_group_name, &self.aml_filesystem_name, &self.import_job_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
    ...
    pub mod update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) aml_filesystem_name: String,
            pub(crate) import_job_name: String,
            pub(crate) import_job: models::ImportJobUpdate,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod list_by_aml_filesystem {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ImportJobsListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ImportJobsListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ImportJobsListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
