...
pub enum Error {
    ...
    #[error(transparent)]
    Caches_Create(#[from] caches::create::Error),
    #[error(transparent)]
    ...
    #[error(transparent)]
    StorageTargets_Create(#[from] storage_targets::create::Error),
    #[error(transparent)]
    StorageTargets_Update(#[from] storage_targets::update::Error),
    #[error(transparent)]
...
pub mod caches {
    ...
    pub async fn create(
        ...
        let req_body = if let Some(cache) = cache {
            ...
            azure_core::to_json(cache).map_err(create::Error::SerializeError)?
        } else {
...
pub mod storage_targets {
    ...
    pub async fn create(
        ...
        let req_body = if let Some(storagetarget) = storagetarget {
            req_builder = req_builder.header("content-type", "application/json");
            azure_core::to_json(storagetarget).map_err(create::Error::SerializeError)?
        } else {
            bytes::Bytes::from_static(azure_core::EMPTY_BODY)
        };
        req_builder = req_builder.uri(url.as_str());
    ...
    pub async fn update(
        ...
        storage_target_name: &str,
        storagetarget: Option<&models::StorageTarget>,
    ) -> std::result::Result<models::StorageTarget, update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourcegroups/{}/providers/Microsoft.StorageCache/caches/{}/storageTargets/{}",
            operation_config.base_path(),
        ...
        let req_body = if let Some(storagetarget) = storagetarget {
            req_builder = req_builder.header("content-type", "application/json");
            azure_core::to_json(storagetarget).map_err(update::Error::SerializeError)?
        } else {
            bytes::Bytes::from_static(azure_core::EMPTY_BODY)
        };
        req_builder = req_builder.uri(url.as_str());
