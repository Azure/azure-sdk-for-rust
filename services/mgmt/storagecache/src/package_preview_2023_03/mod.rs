...
impl Client {
    ...
    pub fn aml_filesystems_client(&self) -> aml_filesystems::Client {
        aml_filesystems::Client(self.clone())
    }
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ApiOperationListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    ...
                    async move {
                        let mut url =
                            azure_core::Url::parse(&format!("{}/providers/Microsoft.StorageCache/operations", this.client.endpoint(),))?;
...
pub mod asc_operations {
    ...
    pub mod get {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AscOperation>>;
...
pub mod caches {
    ...
    pub mod get {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::Cache>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod storage_targets {
    ...
    pub mod get {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::StorageTarget>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.StorageCache/caches/{}/storageTargets/{}/restoreDefaults" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . cache_name , & this . storage_target_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Post);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
...
pub mod aml_filesystems {
    use super::models;
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Returns all AML file systems the user has access to under a subscription."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        pub fn list(&self, subscription_id: impl Into<String>) -> list::RequestBuilder {
        ...
        #[doc = "Returns all AML file systems the user has access to under a resource group."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        ...
        #[doc = "Returns an AML file system."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `aml_filesystem_name`: Name for the AML file system. Allows alphanumerics, underscores, and hyphens. Start and end with alphanumeric."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        pub fn get(
            &self,
            resource_group_name: impl Into<String>,
            aml_filesystem_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                aml_filesystem_name: aml_filesystem_name.into(),
                subscription_id: subscription_id.into(),
            }
        }
        #[doc = "Create or update an AML file system."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `aml_filesystem_name`: Name for the AML file system. Allows alphanumerics, underscores, and hyphens. Start and end with alphanumeric."]
        #[doc = "* `aml_filesystem`: Object containing the user-selectable properties of the AML file system. If read-only properties are included, they must match the existing values of those properties."]
        pub fn create_or_update(
            &self,
            resource_group_name: impl Into<String>,
            subscription_id: impl Into<String>,
            aml_filesystem_name: impl Into<String>,
            aml_filesystem: impl Into<models::AmlFilesystem>,
        ) -> create_or_update::RequestBuilder {
            create_or_update::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                subscription_id: subscription_id.into(),
                aml_filesystem_name: aml_filesystem_name.into(),
                aml_filesystem: aml_filesystem.into(),
            }
        }
        #[doc = "Update an AML file system instance."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        ...
        pub fn update(
            ...
            subscription_id: impl Into<String>,
            aml_filesystem_name: impl Into<String>,
            aml_filesystem: impl Into<models::AmlFilesystemUpdate>,
        ) -> update::RequestBuilder {
            update::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
        ...
        #[doc = "Schedules an AML file system for deletion."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `aml_filesystem_name`: Name for the AML file system. Allows alphanumerics, underscores, and hyphens. Start and end with alphanumeric."]
        ...
        #[doc = "Archive data from the AML file system."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        ...
        #[doc = "Cancel archiving data from the AML file system."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AmlFilesystemsListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AmlFilesystemsListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::AmlFilesystemsListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
                            "{}/subscriptions/{}/providers/Microsoft.StorageCache/amlFilesystems",
                            this.client.endpoint(),
                            &this.subscription_id
                        ))?;
                        let rsp = match continuation {
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::AmlFilesystemsListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    ...
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
                            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.StorageCache/amlFilesystems",
                            this.client.endpoint(),
                            &this.subscription_id,
                            &this.resource_group_name
                        ))?;
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AmlFilesystem> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AmlFilesystem = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) resource_group_name: String,
            pub(crate) aml_filesystem_name: String,
            pub(crate) subscription_id: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AmlFilesystem>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AmlFilesystem>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_update {
        ...
        impl<'a> Headers<'a> {
            ...
            pub fn azure_async_operation(&self) -> azure_core::Result<&str> {
                self.0
                    .get_str(&azure_core::headers::HeaderName::from_static("azure-async-operation"))
            }
        }
        #[derive(Clone)]
        #[doc = r" `RequestBuilder` provides a mechanism for setting optional parameters on a request."]
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) subscription_id: String,
            pub(crate) aml_filesystem_name: String,
            pub(crate) aml_filesystem: models::AmlFilesystem,
        }
        impl RequestBuilder {
            #[doc = "only the first response will be fetched as long running operations are not supported yet"]
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2023-03-01-preview");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.aml_filesystem)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
    ...
    pub mod update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) subscription_id: String,
            pub(crate) aml_filesystem_name: String,
            pub(crate) aml_filesystem: models::AmlFilesystemUpdate,
        }
        impl RequestBuilder {
            #[doc = "only the first response will be fetched as long running operations are not supported yet"]
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
    ...
    pub mod archive {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) subscription_id: String,
            pub(crate) aml_filesystem_name: String,
            pub(crate) archive_info: Option<models::AmlFilesystemArchiveInfo>,
        }
        impl RequestBuilder {
            #[doc = "Information about the archive operation"]
            pub fn archive_info(mut self, archive_info: impl Into<models::AmlFilesystemArchiveInfo>) -> Self {
                self.archive_info = Some(archive_info.into());
                self
            }
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        let url = azure_core::Url::parse(&format!(
                            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.StorageCache/amlFilesystems/{}/archive",
                            this.client.endpoint(),
                            &this.subscription_id,
                            &this.resource_group_name,
                            &this.aml_filesystem_name
                        ...
                        req.url_mut()
                            .query_pairs_mut()
                            .append_pair(azure_core::query_param::API_VERSION, "2023-03-01-preview");
                        let req_body = if let Some(archive_info) = &this.archive_info {
                            req.insert_header("content-type", "application/json");
                            azure_core::to_json(archive_info)?
                        } else {
                            azure_core::EMPTY_BODY
                        };
                        req.set_body(req_body);
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        let url = azure_core::Url::parse(&format!(
                            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.StorageCache/amlFilesystems/{}/cancelArchive",
                            this.client.endpoint(),
                            &this.subscription_id,
                            &this.resource_group_name,
                            &this.aml_filesystem_name
...
impl Client {
    #[doc = "Check that subnets will be valid for AML file system create calls."]
    #[doc = ""]
    #[doc = "Arguments:"]
    #[doc = "* `subscription_id`: The ID of the target subscription."]
    pub fn check_aml_fs_subnets(&self, subscription_id: impl Into<String>) -> check_aml_fs_subnets::RequestBuilder {
        check_aml_fs_subnets::RequestBuilder {
            client: self.clone(),
            subscription_id: subscription_id.into(),
            aml_filesystem_subnet_info: None,
        }
    }
    #[doc = "Get the number of available IP addresses needed for the AML file system information provided."]
    #[doc = ""]
    #[doc = "Arguments:"]
    #[doc = "* `subscription_id`: The ID of the target subscription."]
    pub fn get_required_aml_fs_subnets_size(&self, subscription_id: impl Into<String>) -> get_required_aml_fs_subnets_size::RequestBuilder {
        get_required_aml_fs_subnets_size::RequestBuilder {
            client: self.clone(),
            subscription_id: subscription_id.into(),
            required_aml_filesystem_subnets_size_info: None,
        }
    }
}
pub mod check_aml_fs_subnets {
    use super::models;
    pub struct Response(azure_core::Response);
    impl Response {
        pub fn into_raw_response(self) -> azure_core::Response {
    ...
    pub struct RequestBuilder {
        ...
        pub(crate) subscription_id: String,
        pub(crate) aml_filesystem_subnet_info: Option<models::AmlFilesystemSubnetInfo>,
    }
    impl RequestBuilder {
        #[doc = "Information about the subnets to validate."]
        pub fn aml_filesystem_subnet_info(mut self, aml_filesystem_subnet_info: impl Into<models::AmlFilesystemSubnetInfo>) -> Self {
            self.aml_filesystem_subnet_info = Some(aml_filesystem_subnet_info.into());
            self
        }
        #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
        #[doc = ""]
        ...
        pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
            Box::pin({
                ...
                async move {
                    let url = azure_core::Url::parse(&format!(
                        "{}/subscriptions/{}/providers/Microsoft.StorageCache/checkAmlFSSubnets",
                        this.client.endpoint(),
                        &this.subscription_id
                    ))?;
                    let mut req = azure_core::Request::new(url, azure_core::Method::Post);
                    ...
                    req.url_mut()
                        .query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-03-01-preview");
                    let req_body = if let Some(aml_filesystem_subnet_info) = &this.aml_filesystem_subnet_info {
                        req.insert_header("content-type", "application/json");
                        azure_core::to_json(aml_filesystem_subnet_info)?
                    } else {
                        azure_core::EMPTY_BODY
                    };
                    req.set_body(req_body);
...
pub mod get_required_aml_fs_subnets_size {
    use super::models;
    pub struct Response(azure_core::Response);
    impl Response {
        pub async fn into_body(self) -> azure_core::Result<models::RequiredAmlFilesystemSubnetsSize> {
            let bytes = self.0.into_body().collect().await?;
            let body: models::RequiredAmlFilesystemSubnetsSize = serde_json::from_slice(&bytes)?;
            Ok(body)
        }
        pub fn into_raw_response(self) -> azure_core::Response {
            self.0
    ...
    pub struct RequestBuilder {
        pub(crate) client: super::Client,
        pub(crate) subscription_id: String,
        pub(crate) required_aml_filesystem_subnets_size_info: Option<models::RequiredAmlFilesystemSubnetsSizeInfo>,
    }
    impl RequestBuilder {
        #[doc = "Information to determine the number of available IPs a subnet will need to host the AML file system."]
        pub fn required_aml_filesystem_subnets_size_info(
            mut self,
            required_aml_filesystem_subnets_size_info: impl Into<models::RequiredAmlFilesystemSubnetsSizeInfo>,
        ) -> Self {
            self.required_aml_filesystem_subnets_size_info = Some(required_aml_filesystem_subnets_size_info.into());
            self
        }
        #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
        #[doc = ""]
        ...
        pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
            Box::pin({
                ...
                async move {
                    let url = azure_core::Url::parse(&format!(
                        "{}/subscriptions/{}/providers/Microsoft.StorageCache/getRequiredAmlFSSubnetsSize",
                        this.client.endpoint(),
                        &this.subscription_id
                    ))?;
                    let mut req = azure_core::Request::new(url, azure_core::Method::Post);
                    ...
                    req.url_mut()
                        .query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-03-01-preview");
                    let req_body = if let Some(required_aml_filesystem_subnets_size_info) = &this.required_aml_filesystem_subnets_size_info
                    {
                        req.insert_header("content-type", "application/json");
                        azure_core::to_json(required_aml_filesystem_subnets_size_info)?
                    } else {
                        azure_core::EMPTY_BODY
                    };
                    req.set_body(req_body);
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::RequiredAmlFilesystemSubnetsSize>;
        type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::RequiredAmlFilesystemSubnetsSize>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
