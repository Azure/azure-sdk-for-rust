...
#[doc = "An entry of HealthBotKeysResponse"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct HealthBotKey {
...
#[doc = "Health Bot Keys Response."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct HealthBotKeysResponse {
    #[doc = "Array of Azure Health Bot Secrets."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub secrets: Vec<HealthBotKey>,
}
impl HealthBotKeysResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
