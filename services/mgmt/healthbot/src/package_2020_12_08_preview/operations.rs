...
pub enum Error {
    #[error(transparent)]
    Bots_CheckNameAvailability(#[from] bots::check_name_availability::Error),
    #[error(transparent)]
...
pub mod bots {
    ...
    pub async fn check_name_availability(
        ...
        subscription_id: &str,
    ) -> std::result::Result<models::CheckNameAvailabilityResponseBody, check_name_availability::Error> {
