...
pub mod notification_channels {
    ...
    pub async fn list(
        ...
        top: Option<i64>,
        orderby: Option<&str>,
    ) -> Result<ResponseWithContinuationNotificationChannel> {
        let client = &configuration.client;
        let uri_str = &format!(
...
pub mod service_runners {
    ...
    pub async fn list(
        ...
        top: Option<i64>,
        orderby: Option<&str>,
    ) -> Result<ResponseWithContinuationServiceRunner> {
        let client = &configuration.client;
        let uri_str = &format!(
...
pub mod users {
    ...
    pub async fn list(
        ...
        top: Option<i64>,
        orderby: Option<&str>,
    ) -> Result<ResponseWithContinuationUser> {
        let client = &configuration.client;
        let uri_str = &format!(
...
pub mod disks {
    ...
    pub async fn list(
        ...
        top: Option<i64>,
        orderby: Option<&str>,
    ) -> Result<ResponseWithContinuationDisk> {
        let client = &configuration.client;
        let uri_str = &format!(
...
pub mod environments {
    ...
    pub async fn list(
        ...
        top: Option<i64>,
        orderby: Option<&str>,
    ) -> Result<ResponseWithContinuationDtlEnvironment> {
        let client = &configuration.client;
        let uri_str = &format!(
...
pub mod secrets {
    ...
    pub async fn list(
        ...
        top: Option<i64>,
        orderby: Option<&str>,
    ) -> Result<ResponseWithContinuationSecret> {
        let client = &configuration.client;
        let uri_str = &format!(
