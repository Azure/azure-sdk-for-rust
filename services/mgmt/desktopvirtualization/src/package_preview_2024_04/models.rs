...
pub struct ActiveDirectoryInfoProperties {
    ...
    #[doc = "The organizational unit(OU) path."]
    #[serde(rename = "ouPath")]
    pub ou_path: String,
...
pub struct ActiveSessionHostConfigurationProperties {
    ...
    #[doc = "The id of the size of a virtual machine connected to a hostpool. Example: Standard_D2as_v6"]
...
pub struct AppAttachPackageInfoProperties {
    ...
    #[doc = "VHD/CIM/APP-V image path on Network Share."]
    ...
    #[doc = "Identifier not including the package version, for Msix packages it is the family name from the appxmanifest.xml. "]
    #[serde(rename = "packageFamilyName", default, skip_serializing_if = "Option::is_none")]
    pub package_family_name: Option<String>,
    #[doc = "Identifier including the package version, for Msix packages it is the full name from the appxmanifest.xml. "]
    ...
    #[doc = "Date the package source was last updated, for Msix packages this is found in the appxmanifest.xml. "]
...
pub struct AppAttachPackagePatchProperties {
    ...
    #[doc = "Lookback url to third party control plane, should be null for first party packages"]
    #[serde(rename = "packageLookbackUrl", default, skip_serializing_if = "Option::is_none")]
    pub package_lookback_url: Option<String>,
    #[doc = "Field that can be populated with custom data and filtered on in list GET calls"]
...
pub struct AppAttachPackageProperties {
    ...
    #[serde(rename = "failHealthCheckOnStagingFailure", default, skip_serializing_if = "Option::is_none")]
    pub fail_health_check_on_staging_failure: Option<FailHealthCheckOnStagingFailureEnum>,
    #[doc = "Specific name of package owner, is \"AppAttach\" for native app attach packages"]
    #[serde(rename = "packageOwnerName", default, skip_serializing_if = "Option::is_none")]
    pub package_owner_name: Option<String>,
    #[doc = "Lookback url to third party control plane, is null for native app attach packages"]
    #[serde(rename = "packageLookbackUrl", default, skip_serializing_if = "Option::is_none")]
    pub package_lookback_url: Option<String>,
    #[doc = "Field that can be populated with custom data and filtered on in list GET calls"]
    #[serde(rename = "customData", default, skip_serializing_if = "Option::is_none")]
...
impl ApplicationGroup {
    pub fn new(
        resource_model_with_allowed_property_set: ResourceModelWithAllowedPropertySet,
        properties: ApplicationGroupProperties,
    ) -> Self {
        Self {
            resource_model_with_allowed_property_set,
            properties,
        }
    }
}
...
pub struct AzureActiveDirectoryInfoProperties {
    #[doc = "The Mobile Device Management(MDM) guid."]
...
impl HostPool {
    pub fn new(resource_model_with_allowed_property_set: ResourceModelWithAllowedPropertySet, properties: HostPoolProperties) -> Self {
        Self {
            resource_model_with_allowed_property_set,
            properties,
        }
    ...
    impl Serialize for LoadBalancerType {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::MultiplePersistent => serializer.serialize_unit_variant("LoadBalancerType", 3u32, "MultiplePersistent"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Represents properties for a hostpool update control request."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct HostPoolUpdateControlParameter {
    #[doc = "Action types for controlling hostpool update."]
    pub action: host_pool_update_control_parameter::Action,
...
impl HostPoolUpdateControlParameter {
    pub fn new(action: host_pool_update_control_parameter::Action) -> Self {
        Self {
            action,
            cancel_message: None,
        }
...
pub mod host_pool_update_control_parameter {
    use super::*;
    #[doc = "Action types for controlling hostpool update."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Action")]
...
pub struct MsixPackageDependencies {
    #[doc = "Name of the package dependency. For Msix packages, this is the other packages this package depends upon, for APP-V packages this is the locations of the user and deployment config files"]
...
pub struct NetworkInfoPatchProperties {
    ...
    #[doc = "The resource ID of the security group. Any allowable/open ports should be specified in the Network Security Group(NSG)."]
...
#[doc = "List of RegistrationToken definitions."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RegistrationTokenList {
    ...
    pub value: Vec<RegistrationTokenMinimal>,
    #[doc = "Link to the next page of results."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl RegistrationTokenList {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Represents a Minimal set of properties for RegistrationToken definition."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RegistrationTokenMinimal {
    #[doc = "Expiration time of registration token."]
    #[serde(rename = "expirationTime", default, with = "azure_core::date::rfc3339::option")]
    pub expiration_time: Option<::time::OffsetDateTime>,
    #[doc = "The registration token base64 encoded string."]
...
impl ScalingPlan {
    pub fn new(resource_model_with_allowed_property_set: ResourceModelWithAllowedPropertySet, properties: ScalingPlanProperties) -> Self {
        Self {
            resource_model_with_allowed_property_set,
            properties,
        }
    ...
    impl Serialize for RampUpActionOnDisconnect {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Hibernate => serializer.serialize_unit_variant("RampUpActionOnDisconnect", 2u32, "Hibernate"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for RampUpActionOnLogoff {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Hibernate => serializer.serialize_unit_variant("RampUpActionOnLogoff", 2u32, "Hibernate"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for PeakActionOnDisconnect {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Hibernate => serializer.serialize_unit_variant("PeakActionOnDisconnect", 2u32, "Hibernate"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for PeakActionOnLogoff {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Hibernate => serializer.serialize_unit_variant("PeakActionOnLogoff", 2u32, "Hibernate"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for RampDownActionOnDisconnect {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Hibernate => serializer.serialize_unit_variant("RampDownActionOnDisconnect", 2u32, "Hibernate"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for HostPoolType {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Personal => serializer.serialize_unit_variant("HostPoolType", 1u32, "Personal"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct SessionHostConfigurationPatchProperties {
    ...
    pub network_info: Option<NetworkInfoPatchProperties>,
    #[doc = "The id of the size of a virtual machine connected to a hostpool. Example: Standard_D2as_v6"]
...
#[doc = "The current status of the session host update async operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SessionHostManagementUpdateStatus {
    #[doc = "Fully qualified ID for the async operation."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "Name of the async operation."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Operation status. Current defined values are < Error | Scheduled | UpdatingSessionHosts | ValidatingSessionHostUpdate | Paused | Pausing | Cancelling > | Succeeded | Failed | Canceled"]
    pub status: String,
    #[doc = "Percent of the operation that is complete."]
    #[serde(rename = "percentComplete", default, skip_serializing_if = "Option::is_none")]
    pub percent_complete: Option<f64>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub error: Option<ErrorDetail>,
    #[doc = "Properties bag to hold custom RP properties for sessionHostManagement Update Statuses."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<SessionHostManagementUpdateStatusProperties>,
}
impl SessionHostManagementUpdateStatus {
    pub fn new(status: String) -> Self {
        Self {
            id: None,
            name: None,
...
#[doc = "Properties bag to hold custom RP properties for sessionHostManagement Update Statuses."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SessionHostManagementUpdateStatusProperties {
...
impl SessionHostManagementUpdateStatusProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct SessionHostProperties {
    ...
    #[doc = "SessionHostConfiguration version reference at the time the update is initiated, in the format of date time. Example: 2024-04-26T04:56:45Z"]
...
impl Workspace {
    pub fn new(resource_model_with_allowed_property_set: ResourceModelWithAllowedPropertySet) -> Self {
        Self {
            resource_model_with_allowed_property_set,
            properties: None,
        }
