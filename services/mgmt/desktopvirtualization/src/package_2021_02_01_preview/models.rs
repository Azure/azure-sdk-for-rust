...
pub struct ApplicationGroupProperties {
    ...
    #[serde(rename = "migrationRequest", skip_serializing_if = "Option::is_none")]
...
pub struct SessionHostHealthCheckReport {
    ...
    #[serde(rename = "additionalFailureDetails", skip_serializing_if = "Option::is_none")]
...
pub struct MigrationRequestProperties {
    ...
    #[serde(rename = "migrationPath", skip_serializing_if = "Option::is_none")]
