...
pub struct HostPoolPatchProperties {
    ...
    #[doc = "Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections"]
    #[serde(rename = "managedPrivateUDP", default, skip_serializing_if = "Option::is_none")]
    pub managed_private_udp: Option<host_pool_patch_properties::ManagedPrivateUdp>,
    #[doc = "Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections"]
    #[serde(rename = "directUDP", default, skip_serializing_if = "Option::is_none")]
    pub direct_udp: Option<host_pool_patch_properties::DirectUdp>,
    #[doc = "Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections"]
    #[serde(rename = "publicUDP", default, skip_serializing_if = "Option::is_none")]
    pub public_udp: Option<host_pool_patch_properties::PublicUdp>,
    #[doc = "Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections"]
    #[serde(rename = "relayUDP", default, skip_serializing_if = "Option::is_none")]
    pub relay_udp: Option<host_pool_patch_properties::RelayUdp>,
}
...
pub mod host_pool_patch_properties {
    ...
    #[doc = "Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ManagedPrivateUdp")]
    pub enum ManagedPrivateUdp {
        Default,
        Enabled,
        Disabled,
        #[serde(skip_deserializing)]
    ...
    impl FromStr for ManagedPrivateUdp {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for ManagedPrivateUdp {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for ManagedPrivateUdp {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Default => serializer.serialize_unit_variant("ManagedPrivateUdp", 0u32, "Default"),
                Self::Enabled => serializer.serialize_unit_variant("ManagedPrivateUdp", 1u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("ManagedPrivateUdp", 2u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl FromStr for DirectUdp {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for DirectUdp {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for DirectUdp {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Default => serializer.serialize_unit_variant("DirectUdp", 0u32, "Default"),
                Self::Enabled => serializer.serialize_unit_variant("DirectUdp", 1u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("DirectUdp", 2u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl FromStr for PublicUdp {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for PublicUdp {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for PublicUdp {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Default => serializer.serialize_unit_variant("PublicUdp", 0u32, "Default"),
                Self::Enabled => serializer.serialize_unit_variant("PublicUdp", 1u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("PublicUdp", 2u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl FromStr for RelayUdp {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for RelayUdp {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for RelayUdp {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Default => serializer.serialize_unit_variant("RelayUdp", 0u32, "Default"),
                Self::Enabled => serializer.serialize_unit_variant("RelayUdp", 1u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("RelayUdp", 2u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct HostPoolProperties {
    ...
    #[doc = "Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections"]
    #[serde(rename = "managedPrivateUDP", default, skip_serializing_if = "Option::is_none")]
    pub managed_private_udp: Option<host_pool_properties::ManagedPrivateUdp>,
    #[doc = "Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections"]
    #[serde(rename = "directUDP", default, skip_serializing_if = "Option::is_none")]
    pub direct_udp: Option<host_pool_properties::DirectUdp>,
    #[doc = "Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections"]
    #[serde(rename = "publicUDP", default, skip_serializing_if = "Option::is_none")]
    pub public_udp: Option<host_pool_properties::PublicUdp>,
    #[doc = "Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections"]
    #[serde(rename = "relayUDP", default, skip_serializing_if = "Option::is_none")]
    pub relay_udp: Option<host_pool_properties::RelayUdp>,
}
