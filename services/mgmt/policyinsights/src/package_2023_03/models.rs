...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CheckRestrictionEvaluationDetails {
    ...
    #[doc = "The reason for the evaluation result."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub reason: Option<String>,
}
impl CheckRestrictionEvaluationDetails {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct CheckRestrictionsRequest {
    ...
    pub pending_fields: Vec<PendingField>,
    #[doc = "Whether to include policies with the 'audit' effect in the results. Defaults to false."]
    #[serde(rename = "includeAuditEffect", default, skip_serializing_if = "Option::is_none")]
    pub include_audit_effect: Option<bool>,
}
...
pub struct FieldRestriction {
    ...
    #[doc = "The effect of the policy that is causing the field restriction. http://aka.ms/policyeffects"]
    #[serde(rename = "policyEffect", default, skip_serializing_if = "Option::is_none")]
    ...
    impl Serialize for Result {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Audit => serializer.serialize_unit_variant("Result", 3u32, "Audit"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "The details of the effect that was applied to the resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PolicyEffectDetails {
    #[doc = "The effect that was applied to the resource. http://aka.ms/policyeffects"]
    #[serde(rename = "policyEffect", default, skip_serializing_if = "Option::is_none")]
    pub policy_effect: Option<String>,
}
impl PolicyEffectDetails {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct PolicyEvaluationResult {
    ...
    pub evaluation_details: Option<CheckRestrictionEvaluationDetails>,
    #[doc = "The details of the effect that was applied to the resource."]
    #[serde(rename = "effectDetails", default, skip_serializing_if = "Option::is_none")]
    pub effect_details: Option<PolicyEffectDetails>,
}
