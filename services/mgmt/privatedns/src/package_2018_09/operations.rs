...
pub mod private_zones {
    ...
    pub mod get {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::PrivateZone, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
    ...
    pub mod list {
        ...
        impl Builder {
            ...
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::PrivateZoneListResult, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
