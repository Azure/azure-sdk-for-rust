...
#[doc = "The properties related to the fallback route based on which the IoT hub routes messages to the fallback endpoint."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct FallbackRouteProperties {
    #[doc = "The source to which the routing rule is to be applied to. e.g. DeviceMessages"]
    ...
    #[doc = "Used to specify whether the fallback route is enabled or not."]
...
pub struct RoutingEventHubProperties {
    ...
    #[doc = "The name of the event hub endpoint. The name can only include alphanumeric characters, periods, underscores, hyphens and has a maximum length of 64 characters. The following names are reserved;  events, operationsMonitoringEvents, fileNotifications, $default. Endpoint names must be unique across endpoint types."]
    pub name: String,
