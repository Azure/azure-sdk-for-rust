...
pub struct IotHubProperties {
    ...
    #[doc = "This property store root certificate related information"]
    #[serde(rename = "rootCertificate", default, skip_serializing_if = "Option::is_none")]
    pub root_certificate: Option<RootCertificateProperties>,
}
...
#[doc = "This property store root certificate related information"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RootCertificateProperties {
    #[doc = "This property when set to true, hub will use G2 cert; while it's set to false, hub uses Baltimore Cert."]
    #[serde(rename = "enableRootCertificateV2", default, skip_serializing_if = "Option::is_none")]
    pub enable_root_certificate_v2: Option<bool>,
    #[doc = "the last update time to root certificate flag."]
...
impl RootCertificateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
    ...
    impl Serialize for Source {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::MqttBrokerMessages => serializer.serialize_unit_variant("Source", 7u32, "MqttBrokerMessages"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
}
#[doc = "The properties related to a cosmos DB sql collection endpoint."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RoutingCosmosDbSqlApiProperties {
    ...
    pub name: String,
    #[doc = "Id of the cosmos DB sql collection endpoint"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "The subscription identifier of the cosmos DB account."]
    #[serde(rename = "subscriptionId", default, skip_serializing_if = "Option::is_none")]
    pub subscription_id: Option<String>,
    #[doc = "The name of the resource group of the cosmos DB account."]
    #[serde(rename = "resourceGroup", default, skip_serializing_if = "Option::is_none")]
    pub resource_group: Option<String>,
    #[doc = "The url of the cosmos DB account. It must include the protocol https://"]
    #[serde(rename = "endpointUri")]
    pub endpoint_uri: String,
    #[doc = "Method used to authenticate against the cosmos DB sql collection endpoint"]
    #[serde(rename = "authenticationType", default, skip_serializing_if = "Option::is_none")]
    pub authentication_type: Option<routing_cosmos_db_sql_api_properties::AuthenticationType>,
    #[doc = "The properties of the Managed identity."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub identity: Option<ManagedIdentity>,
    #[doc = "The primary key of the cosmos DB account."]
    #[serde(rename = "primaryKey", default, skip_serializing_if = "Option::is_none")]
    pub primary_key: Option<String>,
    #[doc = "The secondary key of the cosmos DB account."]
    #[serde(rename = "secondaryKey", default, skip_serializing_if = "Option::is_none")]
    pub secondary_key: Option<String>,
    #[doc = "The name of the cosmos DB database in the cosmos DB account."]
    #[serde(rename = "databaseName")]
    pub database_name: String,
    #[doc = "The name of the cosmos DB sql collection in the cosmos DB database."]
    #[serde(rename = "collectionName")]
    pub collection_name: String,
    #[doc = "The name of the partition key associated with this cosmos DB sql collection if one exists. This is an optional parameter."]
    #[serde(rename = "partitionKeyName", default, skip_serializing_if = "Option::is_none")]
    pub partition_key_name: Option<String>,
    #[doc = "The template for generating a synthetic partition key value for use with this cosmos DB sql collection. The template must include at least one of the following placeholders: {iothub}, {deviceid}, {DD}, {MM}, and {YYYY}. Any one placeholder may be specified at most once, but order and non-placeholder components are arbitrary. This parameter is only required if PartitionKeyName is specified."]
    #[serde(rename = "partitionKeyTemplate", default, skip_serializing_if = "Option::is_none")]
    pub partition_key_template: Option<String>,
}
impl RoutingCosmosDbSqlApiProperties {
    pub fn new(name: String, endpoint_uri: String, database_name: String, collection_name: String) -> Self {
        Self {
            name,
            id: None,
...
pub mod routing_cosmos_db_sql_api_properties {
    use super::*;
    #[doc = "Method used to authenticate against the cosmos DB sql collection endpoint"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "AuthenticationType")]
    ...
    impl Serialize for RoutingSource {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::MqttBrokerMessages => serializer.serialize_unit_variant("RoutingSource", 7u32, "MqttBrokerMessages"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
