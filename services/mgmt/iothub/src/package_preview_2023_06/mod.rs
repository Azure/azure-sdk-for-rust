        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::OperationListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    ...
                    async move {
                        let mut url =
                            azure_core::Url::parse(&format!("{}/providers/Microsoft.Devices/operations", this.client.endpoint(),))?;
                        let rsp = match continuation {
                            Some(value) => {
                                ...
                                if !has_api_version_already {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair(azure_core::query_param::API_VERSION, "2023-06-30-preview");
                                }
...
pub mod iot_hub_resource {
    ...
    impl Client {
        ...
        #[doc = "* `resource_group_name`: The name of the resource group that contains the IoT hub."]
        #[doc = "* `resource_name`: The name of the IoT hub."]
        pub fn get(
            &self,
        ...
        #[doc = "Create or update the metadata of an Iot hub. The usual pattern to modify a property is to retrieve the IoT hub metadata and security metadata, and then combine them with the modified values in a new body to update the IoT hub."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The subscription identifier."]
        #[doc = "* `resource_group_name`: The name of the resource group that contains the IoT hub."]
        #[doc = "* `resource_name`: The name of the IoT hub."]
        #[doc = "* `iot_hub_description`: The IoT hub metadata and security metadata."]
        ...
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The subscription identifier."]
        #[doc = "* `resource_group_name`: Resource group identifier."]
        #[doc = "* `resource_name`: Name of iot hub to update."]
        #[doc = "* `iot_hub_tags`: Updated tag information to set into the iot hub instance."]
        pub fn update(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "* `resource_group_name`: The name of the resource group that contains the IoT hub."]
        #[doc = "* `resource_name`: The name of the IoT hub."]
        #[doc = "* `event_hub_endpoint_name`: The name of the Event Hub-compatible endpoint."]
        ...
        #[doc = "* `resource_group_name`: The name of the resource group that contains the IoT hub."]
        #[doc = "* `resource_name`: The name of the IoT hub."]
        #[doc = "* `event_hub_endpoint_name`: The name of the Event Hub-compatible endpoint in the IoT hub."]
        #[doc = "* `name`: The name of the consumer group to retrieve."]
        ...
        #[doc = "* `resource_name`: The name of the IoT hub."]
        #[doc = "* `event_hub_endpoint_name`: The name of the Event Hub-compatible endpoint in the IoT hub."]
        #[doc = "* `name`: The name of the consumer group to add."]
        #[doc = "* `consumer_group_body`: The consumer group to add."]
        pub fn create_event_hub_consumer_group(
            ...
            create_event_hub_consumer_group::RequestBuilder {
                ...
                event_hub_endpoint_name: event_hub_endpoint_name.into(),
                name: name.into(),
                consumer_group_body: consumer_group_body.into(),
            }
        }
        ...
        #[doc = "* `resource_name`: The name of the IoT hub."]
        #[doc = "* `event_hub_endpoint_name`: The name of the Event Hub-compatible endpoint in the IoT hub."]
        #[doc = "* `name`: The name of the consumer group to delete."]
        ...
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The subscription identifier."]
        #[doc = "* `operation_inputs`: Set the name parameter in the OperationInputs structure to the name of the IoT hub to check."]
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `input`: Input for testing all routes"]
        #[doc = "* `iot_hub_name`: IotHub to be tested"]
        #[doc = "* `subscription_id`: The subscription identifier."]
        #[doc = "* `resource_group_name`: resource group which Iot Hub belongs to"]
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `input`: Route that needs to be tested"]
        #[doc = "* `iot_hub_name`: IotHub to be tested"]
        #[doc = "* `subscription_id`: The subscription identifier."]
        #[doc = "* `resource_group_name`: resource group which Iot Hub belongs to"]
        pub fn test_route(
        ...
        #[doc = "* `resource_group_name`: The name of the resource group that contains the IoT hub."]
        #[doc = "* `resource_name`: The name of the IoT hub."]
        #[doc = "* `key_name`: The name of the shared access policy."]
        ...
        #[doc = "* `resource_group_name`: The name of the resource group that contains the IoT hub."]
        #[doc = "* `resource_name`: The name of the IoT hub."]
        #[doc = "* `export_devices_parameters`: The parameters that specify the export devices operation."]
        ...
        #[doc = "* `resource_group_name`: The name of the resource group that contains the IoT hub."]
        #[doc = "* `resource_name`: The name of the IoT hub."]
        #[doc = "* `import_devices_parameters`: The parameters that specify the import devices operation."]
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::IotHubDescription> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::IotHubDescription = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::IotHubDescription>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::IotHubDescription>>;
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2023-06-30-preview");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.iot_hub_tags)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
    ...
    pub mod list_by_subscription {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::IotHubDescriptionListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::IotHubDescriptionListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::IotHubDescriptionListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
    ...
    pub mod get_stats {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::RegistryStatistics> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::RegistryStatistics = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::RegistryStatistics>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::RegistryStatistics>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get_valid_skus {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::IotHubSkuDescriptionListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::IotHubSkuDescriptionListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::IotHubSkuDescriptionListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
    ...
    pub mod list_event_hub_consumer_groups {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::EventHubConsumerGroupsListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::EventHubConsumerGroupsListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::EventHubConsumerGroupsListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Devices/IotHubs/{}/eventHubEndpoints/{}/ConsumerGroups" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . resource_name , & this . event_hub_endpoint_name)) ? ;
                        let rsp = match continuation {
                            Some(value) => {
                                url.set_path("");
                                url = url.join(&value)?;
    ...
    pub mod get_event_hub_consumer_group {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::EventHubConsumerGroupInfo> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::EventHubConsumerGroupInfo = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Devices/IotHubs/{}/eventHubEndpoints/{}/ConsumerGroups/{}" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . resource_name , & this . event_hub_endpoint_name , & this . name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Get);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::EventHubConsumerGroupInfo>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::EventHubConsumerGroupInfo>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2023-06-30-preview");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.consumer_group_body)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
    ...
    pub mod list_jobs {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::JobResponseListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::JobResponseListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::JobResponseListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
    ...
    pub mod get_job {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::JobResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::JobResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::JobResponse>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::JobResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get_quota_metrics {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::IotHubQuotaMetricInfoListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::IotHubQuotaMetricInfoListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::IotHubQuotaMetricInfoListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
    ...
    pub mod get_endpoint_health {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::EndpointHealthDataListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::EndpointHealthDataListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::EndpointHealthDataListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
    ...
    pub mod check_name_availability {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::IotHubNameAvailabilityInfo> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::IotHubNameAvailabilityInfo = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::IotHubNameAvailabilityInfo>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::IotHubNameAvailabilityInfo>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod test_all_routes {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::TestAllRoutesResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::TestAllRoutesResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::TestAllRoutesResult>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::TestAllRoutesResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod test_route {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::TestRouteResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::TestRouteResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::TestRouteResult>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::TestRouteResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_keys {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SharedAccessSignatureAuthorizationRuleListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SharedAccessSignatureAuthorizationRuleListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(
                self,
            ) -> azure_core::Pageable<models::SharedAccessSignatureAuthorizationRuleListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
    ...
    pub mod get_keys_for_key_name {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SharedAccessSignatureAuthorizationRule> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SharedAccessSignatureAuthorizationRule = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::SharedAccessSignatureAuthorizationRule>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::SharedAccessSignatureAuthorizationRule>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2023-06-30-preview");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.export_devices_parameters)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2023-06-30-preview");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.import_devices_parameters)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
...
pub mod resource_provider_common {
    ...
    pub mod get_subscription_quota {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::UserSubscriptionQuotaListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::UserSubscriptionQuotaListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::UserSubscriptionQuotaListResult>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::UserSubscriptionQuotaListResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod certificates {
    ...
    impl Client {
        ...
        #[doc = "* `resource_name`: The name of the IoT hub."]
        #[doc = "* `certificate_name`: The name of the certificate"]
        #[doc = "* `certificate_description`: The certificate body."]
        pub fn create_or_update(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "* `resource_name`: The name of the IoT hub."]
        #[doc = "* `certificate_name`: The name of the certificate"]
        #[doc = "* `if_match`: ETag of the Certificate."]
        pub fn delete(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "Generates verification code for proof of possession flow. The verification code will be used to generate a leaf certificate."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The subscription identifier."]
        #[doc = "* `resource_group_name`: The name of the resource group that contains the IoT hub."]
        ...
        #[doc = "* `resource_name`: The name of the IoT hub."]
        #[doc = "* `certificate_name`: The name of the certificate"]
        #[doc = "* `certificate_verification_body`: The name of the certificate"]
        #[doc = "* `if_match`: ETag of the Certificate."]
        pub fn verify(
            &self,
            subscription_id: impl Into<String>,
    ...
    pub mod list_by_iot_hub {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CertificateListDescription> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CertificateListDescription = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::CertificateListDescription>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::CertificateListDescription>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CertificateDescription> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CertificateDescription = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::CertificateDescription>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::CertificateDescription>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod generate_verification_code {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CertificateWithNonceDescription> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CertificateWithNonceDescription = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Devices/IotHubs/{}/certificates/{}/generateVerificationCode" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . resource_name , & this . certificate_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Post);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::CertificateWithNonceDescription>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::CertificateWithNonceDescription>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod iot_hub {
    ...
    impl Client {
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `iot_hub_name`: Name of the IoT hub to failover"]
        #[doc = "* `failover_input`: Region to failover to. Must be the Azure paired region. Get the value from the secondary location in the locations property. To learn more, see https://aka.ms/manualfailover/region"]
        #[doc = "* `subscription_id`: The subscription identifier."]
        #[doc = "* `resource_group_name`: Name of the resource group containing the IoT hub resource"]
...
pub mod private_link_resources {
    ...
    pub mod list {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::PrivateLinkResources>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::PrivateLinkResources>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::GroupIdInformation> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::GroupIdInformation = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::GroupIdInformation>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::GroupIdInformation>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod private_endpoint_connections {
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::PrivateEndpointConnectionsList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::PrivateEndpointConnectionsList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::PrivateEndpointConnectionsList>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::PrivateEndpointConnectionsList>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
