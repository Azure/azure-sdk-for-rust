...
pub struct IotHubProperties {
    ...
    #[doc = "This property specifies the IP Version the hub is currently utilizing."]
    #[serde(rename = "ipVersion", default, skip_serializing_if = "Option::is_none")]
    pub ip_version: Option<iot_hub_properties::IpVersion>,
}
    ...
    impl Serialize for IpVersion {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Ipv4ipv6 => serializer.serialize_unit_variant("IpVersion", 2u32, "ipv4ipv6"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "The properties related to a cosmos DB sql container endpoint."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RoutingCosmosDbSqlApiProperties {
    ...
    pub name: String,
    #[doc = "Id of the cosmos DB sql container endpoint"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    ...
    #[doc = "Method used to authenticate against the cosmos DB sql container endpoint"]
    #[serde(rename = "authenticationType", default, skip_serializing_if = "Option::is_none")]
    ...
    #[doc = "The name of the cosmos DB sql container in the cosmos DB database."]
    #[serde(rename = "containerName")]
    pub container_name: String,
    #[doc = "The name of the partition key associated with this cosmos DB sql container if one exists. This is an optional parameter."]
...
impl RoutingCosmosDbSqlApiProperties {
    pub fn new(name: String, endpoint_uri: String, database_name: String, container_name: String) -> Self {
        Self {
            name,
            id: None,
...
pub struct RoutingEndpoints {
    ...
    #[doc = "The list of Cosmos DB container endpoints that IoT hub routes messages to, based on the routing rules."]
    #[serde(
        rename = "cosmosDBSqlContainers",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub cosmos_db_sql_containers: Vec<RoutingCosmosDbSqlApiProperties>,
}
