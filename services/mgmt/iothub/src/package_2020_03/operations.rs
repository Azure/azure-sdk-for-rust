...
pub mod iot_hub_resource {
    ...
    pub async fn get_endpoint_health(
        ...
        let mut url = url::Url::parse(url_str).context(get_endpoint_health::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
        ...
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder.body(req_body).context(get_endpoint_health::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .context(get_endpoint_health::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: EndpointHealthDataListResult =
                    serde_json::from_slice(rsp_body).context(get_endpoint_health::DeserializeError { body: rsp_body.clone() })?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
    ...
    pub async fn test_all_routes(
        ...
        let mut url = url::Url::parse(url_str).context(test_all_routes::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::POST);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
        ...
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder.body(req_body).context(test_all_routes::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .context(test_all_routes::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: TestAllRoutesResult =
                    serde_json::from_slice(rsp_body).context(test_all_routes::DeserializeError { body: rsp_body.clone() })?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
    ...
    pub async fn test_route(
        ...
        let mut url = url::Url::parse(url_str).context(test_route::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::POST);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
        ...
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder.body(req_body).context(test_route::BuildRequestError)?;
        let rsp = http_client.execute_request(req).await.context(test_route::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: TestRouteResult =
                    serde_json::from_slice(rsp_body).context(test_route::DeserializeError { body: rsp_body.clone() })?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
...
pub mod resource_provider_common {
    ...
    pub async fn get_subscription_quota(
        ...
        let mut url = url::Url::parse(url_str).context(get_subscription_quota::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
        ...
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder.body(req_body).context(get_subscription_quota::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .context(get_subscription_quota::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: UserSubscriptionQuotaListResult =
                    serde_json::from_slice(rsp_body).context(get_subscription_quota::DeserializeError { body: rsp_body.clone() })?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
...
pub mod iot_hub {
    ...
    pub async fn manual_failover(
        ...
        let mut url = url::Url::parse(url_str).context(manual_failover::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::POST);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
        ...
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder.body(req_body).context(manual_failover::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .context(manual_failover::ExecuteRequestError)?;
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: ErrorDetails =
                    serde_json::from_slice(rsp_body).context(manual_failover::DeserializeError { body: rsp_body.clone() })?;
