...
pub mod vault_certificates {
    ...
    pub mod create {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::VaultCertificateResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::VaultCertificateResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        let req_body = azure_core::to_json(&this.certificate_request)?;
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::VaultCertificateResponse>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::VaultCertificateResponse>>;
...
pub mod replication_usages {
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ReplicationUsageList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ReplicationUsageList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
...
pub mod private_link_resources {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::PrivateLinkResources, azure_core::error::Error> {
...
pub mod recovery_services {
    ...
    impl Client {
        ...
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `location`: Location of the resource"]
        #[doc = "* `input`: Contains information about Resource type and properties to get capabilities"]
        pub fn capabilities(
            &self,
            subscription_id: impl Into<String>,
            location: impl Into<String>,
            input: impl Into<models::ResourceCapabilities>,
        ) -> capabilities::RequestBuilder {
            capabilities::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                location: location.into(),
    ...
    pub mod capabilities {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CapabilitiesResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CapabilitiesResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) subscription_id: String,
            pub(crate) location: String,
            pub(crate) input: models::ResourceCapabilities,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        let url = azure_core::Url::parse(&format!(
                            "{}/subscriptions/{}/providers/Microsoft.RecoveryServices/locations/{}/capabilities",
                            this.client.endpoint(),
                            &this.subscription_id,
                            &this.location
                        ))?;
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::CapabilitiesResponse>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::CapabilitiesResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod vaults {
    ...
    pub mod list_by_subscription_id {
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::VaultList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2023-02-01");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.vault)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
...
pub mod vault_extended_info {
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::VaultExtendedInfoResource> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::VaultExtendedInfoResource = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.RecoveryServices/vaults/{}/extendedInformation/vaultExtendedInfo" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . vault_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Get);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::VaultExtendedInfoResource>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::VaultExtendedInfoResource>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2023-02-01");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.resource_resource_extended_info_details)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
...
pub mod get_operation_status {
    ...
    impl std::future::IntoFuture for RequestBuilder {
        ...
        type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::OperationResource>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod usages {
    ...
    pub mod list_by_vaults {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::VaultUsageList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::VaultUsageList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
