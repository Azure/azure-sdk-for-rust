...
pub struct CapabilitiesResponse {
    #[serde(flatten)]
    pub resource_capabilities_base: ResourceCapabilitiesBase,
    #[doc = "Capabilities properties in response"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<CapabilitiesResponseProperties>,
}
impl CapabilitiesResponse {
    pub fn new(resource_capabilities_base: ResourceCapabilitiesBase) -> Self {
        Self {
            resource_capabilities_base,
            properties: None,
        }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ClassicAlertSettings {
    #[serde(rename = "alertsForCriticalOperations", default, skip_serializing_if = "Option::is_none")]
    pub alerts_for_critical_operations: Option<classic_alert_settings::AlertsForCriticalOperations>,
}
impl ClassicAlertSettings {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod classic_alert_settings {
    use super::*;
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "AlertsForCriticalOperations")]
    pub enum AlertsForCriticalOperations {
        Enabled,
        Disabled,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for AlertsForCriticalOperations {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for AlertsForCriticalOperations {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for AlertsForCriticalOperations {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("AlertsForCriticalOperations", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("AlertsForCriticalOperations", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct DnsZone {
    ...
    #[serde(rename = "subResource", default, skip_serializing_if = "Option::is_none")]
    pub sub_resource: Option<dns_zone::SubResource>,
}
impl DnsZone {
    pub fn new() -> Self {
        Self::default()
...
pub mod dns_zone {
    ...
    #[doc = "Subresource type for vault AzureBackup, AzureBackup_secondary or AzureSiteRecovery"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "SubResource")]
    pub enum SubResource {
        AzureBackup,
        #[serde(rename = "AzureBackup_secondary")]
    ...
    impl<'de> Deserialize<'de> for SubResource {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for SubResource {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::AzureBackup => serializer.serialize_unit_variant("SubResource", 0u32, "AzureBackup"),
                Self::AzureBackupSecondary => serializer.serialize_unit_variant("SubResource", 1u32, "AzureBackup_secondary"),
                Self::AzureSiteRecovery => serializer.serialize_unit_variant("SubResource", 2u32, "AzureSiteRecovery"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct MonitoringSettings {
    ...
    #[doc = "Settings for classic alerts"]
    #[serde(rename = "classicAlertSettings", default, skip_serializing_if = "Option::is_none")]
    pub classic_alert_settings: Option<ClassicAlertSettings>,
}
...
pub struct ResourceCapabilities {
    ...
    #[doc = "Capabilities information"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<CapabilitiesProperties>,
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ResourceCapabilitiesBase {
    #[doc = "Describes the Resource type: Microsoft.RecoveryServices/Vaults"]
    #[serde(rename = "type")]
    pub type_: String,
}
impl ResourceCapabilitiesBase {
...
pub struct VaultProperties {
    ...
    pub public_network_access: Option<vault_properties::PublicNetworkAccess>,
    #[doc = "Monitoring Settings of the vault"]
    ...
    #[serde(rename = "redundancySettings", default, skip_serializing_if = "Option::is_none")]
    pub redundancy_settings: Option<vault_properties::RedundancySettings>,
    #[doc = "Security Settings of the vault"]
...
pub mod vault_properties {
    ...
    pub struct RedundancySettings {
        ...
        #[serde(rename = "standardTierStorageRedundancy", default, skip_serializing_if = "Option::is_none")]
        pub standard_tier_storage_redundancy: Option<redundancy_settings::StandardTierStorageRedundancy>,
        #[doc = "Flag to show if Cross Region Restore is enabled on the Vault or not"]
        #[serde(rename = "crossRegionRestore", default, skip_serializing_if = "Option::is_none")]
        pub cross_region_restore: Option<redundancy_settings::CrossRegionRestore>,
    }
    ...
    pub mod redundancy_settings {
        use super::*;
        #[doc = "The storage redundancy setting of a vault"]
        #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
        #[serde(remote = "StandardTierStorageRedundancy")]
        pub enum StandardTierStorageRedundancy {
            LocallyRedundant,
            GeoRedundant,
            ZoneRedundant,
            #[serde(skip_deserializing)]
        ...
        impl FromStr for StandardTierStorageRedundancy {
            type Err = value::Error;
            fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
                Self::deserialize(s.into_deserializer())
            }
        }
        impl<'de> Deserialize<'de> for StandardTierStorageRedundancy {
            fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
            where
                D: Deserializer<'de>,
            {
        ...
        impl Serialize for StandardTierStorageRedundancy {
            fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
            where
                S: Serializer,
            {
                match self {
                    Self::LocallyRedundant => serializer.serialize_unit_variant("StandardTierStorageRedundancy", 0u32, "LocallyRedundant"),
                    Self::GeoRedundant => serializer.serialize_unit_variant("StandardTierStorageRedundancy", 1u32, "GeoRedundant"),
                    Self::ZoneRedundant => serializer.serialize_unit_variant("StandardTierStorageRedundancy", 2u32, "ZoneRedundant"),
                    Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
                }
            }
        }
        #[doc = "Flag to show if Cross Region Restore is enabled on the Vault or not"]
        #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
        #[serde(remote = "CrossRegionRestore")]
        pub enum CrossRegionRestore {
            Enabled,
            Disabled,
            #[serde(skip_deserializing)]
            UnknownValue(String),
        }
        impl FromStr for CrossRegionRestore {
            type Err = value::Error;
            fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
                Self::deserialize(s.into_deserializer())
            }
        }
        impl<'de> Deserialize<'de> for CrossRegionRestore {
            fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
            where
                D: Deserializer<'de>,
            {
        ...
        impl Serialize for CrossRegionRestore {
            fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
            where
                S: Serializer,
            {
                match self {
                    Self::Enabled => serializer.serialize_unit_variant("CrossRegionRestore", 0u32, "Enabled"),
                    Self::Disabled => serializer.serialize_unit_variant("CrossRegionRestore", 1u32, "Disabled"),
                    Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
                }
            }
        }
