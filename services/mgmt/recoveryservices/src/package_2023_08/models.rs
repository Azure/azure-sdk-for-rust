...
pub struct CrossSubscriptionRestoreSettings {
    #[serde(rename = "crossSubscriptionRestoreState", default, skip_serializing_if = "Option::is_none")]
    pub cross_subscription_restore_state: Option<cross_subscription_restore_settings::CrossSubscriptionRestoreState>,
}
...
pub mod cross_subscription_restore_settings {
    use super::*;
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "CrossSubscriptionRestoreState")]
    pub enum CrossSubscriptionRestoreState {
        Enabled,
        Disabled,
        PermanentlyDisabled,
        #[serde(skip_deserializing)]
    ...
    impl FromStr for CrossSubscriptionRestoreState {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for CrossSubscriptionRestoreState {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for CrossSubscriptionRestoreState {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("CrossSubscriptionRestoreState", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("CrossSubscriptionRestoreState", 1u32, "Disabled"),
                Self::PermanentlyDisabled => {
                    serializer.serialize_unit_variant("CrossSubscriptionRestoreState", 2u32, "PermanentlyDisabled")
                }
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
...
#[doc = "MUA Settings of vault"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "MultiUserAuthorization")]
pub enum MultiUserAuthorization {
    Invalid,
    Enabled,
    Disabled,
    #[serde(skip_deserializing)]
...
impl FromStr for MultiUserAuthorization {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for MultiUserAuthorization {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for MultiUserAuthorization {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Invalid => serializer.serialize_unit_variant("MultiUserAuthorization", 0u32, "Invalid"),
            Self::Enabled => serializer.serialize_unit_variant("MultiUserAuthorization", 1u32, "Enabled"),
            Self::Disabled => serializer.serialize_unit_variant("MultiUserAuthorization", 2u32, "Disabled"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct SecuritySettings {
    ...
    #[doc = "MUA Settings of vault"]
    #[serde(rename = "multiUserAuthorization", default, skip_serializing_if = "Option::is_none")]
    pub multi_user_authorization: Option<MultiUserAuthorization>,
}
...
pub struct SoftDeleteSettings {
    #[serde(rename = "softDeleteState", default, skip_serializing_if = "Option::is_none")]
    pub soft_delete_state: Option<soft_delete_settings::SoftDeleteState>,
    ...
    pub enhanced_security_state: Option<soft_delete_settings::EnhancedSecurityState>,
}
...
pub mod soft_delete_settings {
    use super::*;
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "SoftDeleteState")]
    pub enum SoftDeleteState {
        Invalid,
        Enabled,
        Disabled,
    ...
    impl FromStr for SoftDeleteState {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for SoftDeleteState {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for SoftDeleteState {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Invalid => serializer.serialize_unit_variant("SoftDeleteState", 0u32, "Invalid"),
                Self::Enabled => serializer.serialize_unit_variant("SoftDeleteState", 1u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("SoftDeleteState", 2u32, "Disabled"),
                Self::AlwaysOn => serializer.serialize_unit_variant("SoftDeleteState", 3u32, "AlwaysON"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for EnhancedSecurityState {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::AlwaysOn => serializer.serialize_unit_variant("EnhancedSecurityState", 3u32, "AlwaysON"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct VaultProperties {
    ...
    #[doc = "Restore Settings  of the vault"]
    #[serde(rename = "restoreSettings", default, skip_serializing_if = "Option::is_none")]
    pub restore_settings: Option<RestoreSettings>,
    ...
    pub secure_score: Option<vault_properties::SecureScore>,
}
...
pub mod vault_properties {
    ...
    pub mod redundancy_settings {
        ...
        impl Serialize for StandardTierStorageRedundancy {
            ...
            {
                match self {
                    Self::Invalid => serializer.serialize_unit_variant("StandardTierStorageRedundancy", 0u32, "Invalid"),
                    Self::LocallyRedundant => serializer.serialize_unit_variant("StandardTierStorageRedundancy", 1u32, "LocallyRedundant"),
                    Self::GeoRedundant => serializer.serialize_unit_variant("StandardTierStorageRedundancy", 2u32, "GeoRedundant"),
                    Self::ZoneRedundant => serializer.serialize_unit_variant("StandardTierStorageRedundancy", 3u32, "ZoneRedundant"),
                    Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
                }
            }
        }
