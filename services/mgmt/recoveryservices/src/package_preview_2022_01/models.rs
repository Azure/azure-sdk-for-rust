...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DnsZone {
    #[doc = "Subresource type for vault, AzureBackup or AzureSiteRecovery"]
    ...
    impl Serialize for SubResource {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::AzureSiteRecovery => serializer.serialize_unit_variant("SubResource", 1u32, "AzureSiteRecovery"),
