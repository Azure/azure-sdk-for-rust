...
pub struct AzureMonitorAlertSettings {
    ...
    #[serde(rename = "alertsForAllReplicationIssues", default, skip_serializing_if = "Option::is_none")]
    pub alerts_for_all_replication_issues: Option<azure_monitor_alert_settings::AlertsForAllReplicationIssues>,
    #[serde(rename = "alertsForAllFailoverIssues", default, skip_serializing_if = "Option::is_none")]
    pub alerts_for_all_failover_issues: Option<azure_monitor_alert_settings::AlertsForAllFailoverIssues>,
}
...
pub mod azure_monitor_alert_settings {
    ...
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "AlertsForAllReplicationIssues")]
    pub enum AlertsForAllReplicationIssues {
        Enabled,
        Disabled,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for AlertsForAllReplicationIssues {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for AlertsForAllReplicationIssues {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for AlertsForAllReplicationIssues {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("AlertsForAllReplicationIssues", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("AlertsForAllReplicationIssues", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "AlertsForAllFailoverIssues")]
    pub enum AlertsForAllFailoverIssues {
        Enabled,
        Disabled,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for AlertsForAllFailoverIssues {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for AlertsForAllFailoverIssues {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for AlertsForAllFailoverIssues {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("AlertsForAllFailoverIssues", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("AlertsForAllFailoverIssues", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct ClassicAlertSettings {
    ...
    #[serde(rename = "emailNotificationsForSiteRecovery", default, skip_serializing_if = "Option::is_none")]
    pub email_notifications_for_site_recovery: Option<classic_alert_settings::EmailNotificationsForSiteRecovery>,
}
...
pub mod classic_alert_settings {
    ...
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "EmailNotificationsForSiteRecovery")]
    pub enum EmailNotificationsForSiteRecovery {
        Enabled,
        Disabled,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for EmailNotificationsForSiteRecovery {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for EmailNotificationsForSiteRecovery {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for EmailNotificationsForSiteRecovery {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("EmailNotificationsForSiteRecovery", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("EmailNotificationsForSiteRecovery", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct VaultProperties {
    ...
    #[doc = "Security levels of Recovery Services Vault for business continuity and disaster recovery"]
    #[serde(rename = "bcdrSecurityLevel", default, skip_serializing_if = "Option::is_none")]
    pub bcdr_security_level: Option<vault_properties::BcdrSecurityLevel>,
