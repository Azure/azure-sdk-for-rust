...
pub struct RaiPolicyProperties {
    ...
    #[doc = "Rai policy mode. The enum value mapping is as below: Default = 0, Deferred=1, Blocking=2, Asynchronous_filter =3. Please use 'Asynchronous_filter' after 2024-06-01-preview. It is the same as 'Deferred' in previous version."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
