...
pub struct RaiContentFilter {
    ...
    #[doc = "Description of Content Filter."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    #[doc = "Content Filter type."]
    #[serde(rename = "filterType", default, skip_serializing_if = "Option::is_none")]
    pub filter_type: Option<rai_content_filter::FilterType>,
}
...
pub mod rai_content_filter {
    ...
    impl Serialize for FilterType {
        ...
        {
            match self {
                Self::MultiLevel => serializer.serialize_unit_variant("FilterType", 0u32, "MultiLevel"),
                Self::Switch => serializer.serialize_unit_variant("FilterType", 1u32, "Switch"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct RaiPolicyContentFilter {
    ...
    #[serde(rename = "allowedContentLevel", default, skip_serializing_if = "Option::is_none")]
    pub allowed_content_level: Option<rai_policy_content_filter::AllowedContentLevel>,
    #[doc = "If blocking would occur."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub blocking: Option<bool>,
...
pub mod rai_policy_content_filter {
    ...
    #[doc = "Level at which content is filtered."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "AllowedContentLevel")]
    pub enum AllowedContentLevel {
        Low,
        Medium,
        High,
        #[serde(skip_deserializing)]
    ...
    impl FromStr for AllowedContentLevel {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for AllowedContentLevel {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for AllowedContentLevel {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Low => serializer.serialize_unit_variant("AllowedContentLevel", 0u32, "Low"),
                Self::Medium => serializer.serialize_unit_variant("AllowedContentLevel", 1u32, "Medium"),
                Self::High => serializer.serialize_unit_variant("AllowedContentLevel", 2u32, "High"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct RaiPolicyProperties {
    ...
    pub policy_type: Option<rai_policy_properties::PolicyType>,
    #[doc = "Content Filters mode."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mode: Option<rai_policy_properties::Mode>,
    #[doc = "Name of the base Content Filters."]
    #[serde(rename = "basePolicyName", default, skip_serializing_if = "Option::is_none")]
    pub base_policy_name: Option<String>,
    #[doc = "The list of blocklists for prompt."]
    #[serde(
        rename = "promptBlocklists",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub prompt_blocklists: Vec<RaiBlocklistConfig>,
    #[doc = "The list of blocklists for completion."]
    #[serde(
        rename = "completionBlocklists",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub completion_blocklists: Vec<RaiBlocklistConfig>,
    #[doc = "The list of Content Filters."]
    #[serde(
...
pub mod rai_policy_properties {
    ...
    impl Serialize for PolicyType {
        ...
        {
            match self {
                Self::UserManaged => serializer.serialize_unit_variant("PolicyType", 0u32, "UserManaged"),
                Self::SystemManaged => serializer.serialize_unit_variant("PolicyType", 1u32, "SystemManaged"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
