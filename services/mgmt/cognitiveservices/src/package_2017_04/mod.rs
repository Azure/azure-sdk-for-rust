...
pub mod accounts {
    ...
    pub mod list_by_resource_group {
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::CognitiveServicesAccountListResult, azure_core::error::Error> {
...
pub mod check_sku_availability {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
        pub async fn into_body(self) -> azure_core::Result<models::CheckSkuAvailabilityResultList> {
            let bytes = self.0.into_body().collect().await?;
            let body: models::CheckSkuAvailabilityResultList = serde_json::from_slice(&bytes)?;
            Ok(body)
        }
        pub fn into_raw_response(self) -> azure_core::Response {
            self.0
    ...
    impl RequestBuilder {
        ...
        #[doc = "Send the request and return the response body."]
        pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::CheckSkuAvailabilityResultList>> {
            Box::pin(async move { self.send().await?.into_body().await })
        }
    }
}
pub mod check_domain_availability {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
        pub async fn into_body(self) -> azure_core::Result<models::CheckDomainAvailabilityResult> {
            let bytes = self.0.into_body().collect().await?;
            let body: models::CheckDomainAvailabilityResult = serde_json::from_slice(&bytes)?;
            Ok(body)
        }
        pub fn into_raw_response(self) -> azure_core::Response {
            self.0
    ...
    impl RequestBuilder {
        ...
        #[doc = "Send the request and return the response body."]
        pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::CheckDomainAvailabilityResult>> {
            Box::pin(async move { self.send().await?.into_body().await })
        }
    }
}
