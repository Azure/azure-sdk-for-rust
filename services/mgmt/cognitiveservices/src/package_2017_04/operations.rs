...
pub mod accounts {
    ...
    pub async fn update(
        ...
        url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
        let req_body = azure_core::to_json(account).context(update::SerializeError)?;
        req_builder = req_builder.uri(url.as_str());
...
pub async fn check_sku_availability(
    ...
    url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
    let req_body = azure_core::to_json(parameters).context(check_sku_availability::SerializeError)?;
    req_builder = req_builder.uri(url.as_str());
...
pub async fn check_domain_availability(
    ...
    url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
    let req_body = azure_core::to_json(parameters).context(check_domain_availability::SerializeError)?;
    req_builder = req_builder.uri(url.as_str());
