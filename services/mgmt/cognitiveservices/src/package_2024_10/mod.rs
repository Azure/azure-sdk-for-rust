...
impl Client {
    ...
    pub fn defender_for_ai_settings_client(&self) -> defender_for_ai_settings::Client {
        defender_for_ai_settings::Client(self.clone())
    }
    ...
    pub fn location_based_model_capacities_client(&self) -> location_based_model_capacities::Client {
        location_based_model_capacities::Client(self.clone())
    }
    pub fn model_capacities_client(&self) -> model_capacities::Client {
        model_capacities::Client(self.clone())
    }
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-10-01");
                }
                Ok(url)
            }
        }
...
impl Client {
    ...
    #[doc = "Model capacity calculator."]
    #[doc = ""]
    #[doc = "Arguments:"]
    #[doc = "* `subscription_id`: The ID of the target subscription."]
    #[doc = "* `parameters`: Check Domain Availability parameter."]
    pub fn calculate_model_capacity(
        &self,
        subscription_id: impl Into<String>,
        parameters: impl Into<models::CalculateModelCapacityParameter>,
    ) -> calculate_model_capacity::RequestBuilder {
        calculate_model_capacity::RequestBuilder {
            client: self.clone(),
            subscription_id: subscription_id.into(),
            parameters: parameters.into(),
...
pub mod calculate_model_capacity {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    pub struct Response(azure_core::Response);
    impl Response {
        pub async fn into_body(self) -> azure_core::Result<models::CalculateModelCapacityResult> {
            let bytes = self.0.into_body().collect().await?;
            let body: models::CalculateModelCapacityResult = serde_json::from_slice(&bytes)?;
            Ok(body)
        }
        pub fn into_raw_response(self) -> azure_core::Response {
            self.0
    ...
    pub struct RequestBuilder {
        pub(crate) client: super::Client,
        pub(crate) subscription_id: String,
        pub(crate) parameters: models::CalculateModelCapacityParameter,
    }
    impl RequestBuilder {
        #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
        #[doc = ""]
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!(
                "/subscriptions/{}/providers/Microsoft.CognitiveServices/calculateModelCapacity",
                &self.subscription_id
            ));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::CalculateModelCapacityResult>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::CalculateModelCapacityResult>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod location_based_model_capacities {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List Location Based ModelCapacities."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `location`: Resource location."]
        #[doc = "* `model_format`: The format of the Model"]
        #[doc = "* `model_name`: The name of the Model"]
        #[doc = "* `model_version`: The version of the Model"]
        pub fn list(
            &self,
            subscription_id: impl Into<String>,
            location: impl Into<String>,
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ModelCapacityListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ModelCapacityListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ModelCapacityListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
                        let rsp = match continuation {
                            ...
                            None => {
                                ...
                                let bearer_token = this.client.bearer_token().await?;
                                req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                                let model_format = &this.model_format;
                                req.url_mut().query_pairs_mut().append_pair("modelFormat", model_format);
                                let model_name = &this.model_name;
                                req.url_mut().query_pairs_mut().append_pair("modelName", model_name);
                                let model_version = &this.model_version;
                                req.url_mut().query_pairs_mut().append_pair("modelVersion", model_version);
                                let req_body = azure_core::EMPTY_BODY;
                                req.set_body(req_body);
                                this.client.send(&mut req).await?
                            }
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.CognitiveServices/locations/{}/modelCapacities",
                    &self.subscription_id, &self.location
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.CognitiveServices/modelCapacities",
                    &self.subscription_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.CognitiveServices/accounts/{}/raiPolicies/{}",
                    &self.subscription_id, &self.resource_group_name, &self.account_name, &self.rai_policy_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.CognitiveServices/accounts/{}/raiBlocklists/{}",
                    &self.subscription_id, &self.resource_group_name, &self.account_name, &self.rai_blocklist_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
...
pub mod rai_blocklist_items {
    ...
    impl Client {
        ...
        #[doc = "Batch operation to add blocklist items."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `account_name`: The name of Cognitive Services account."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `rai_blocklist_name`: The name of the RaiBlocklist associated with the Cognitive Services Account"]
        #[doc = "* `rai_blocklist_items`: Properties describing the custom blocklist items."]
        pub fn batch_add(
            &self,
            resource_group_name: impl Into<String>,
            account_name: impl Into<String>,
            subscription_id: impl Into<String>,
            rai_blocklist_name: impl Into<String>,
            rai_blocklist_items: impl Into<models::RaiBlocklistItemsBulkAddRequest>,
        ) -> batch_add::RequestBuilder {
            batch_add::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                account_name: account_name.into(),
                subscription_id: subscription_id.into(),
                rai_blocklist_name: rai_blocklist_name.into(),
                rai_blocklist_items: rai_blocklist_items.into(),
            }
        }
        #[doc = "Batch operation to delete blocklist items."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `account_name`: The name of Cognitive Services account."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `rai_blocklist_name`: The name of the RaiBlocklist associated with the Cognitive Services Account"]
        #[doc = "* `rai_blocklist_items_names`: List of RAI Blocklist Items Names."]
        pub fn batch_delete(
            &self,
            resource_group_name: impl Into<String>,
            account_name: impl Into<String>,
            subscription_id: impl Into<String>,
            rai_blocklist_name: impl Into<String>,
            rai_blocklist_items_names: impl Into<models::RaiBlocklistItemsBulkDeleteRequest>,
        ) -> batch_delete::RequestBuilder {
            batch_delete::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                account_name: account_name.into(),
                subscription_id: subscription_id.into(),
                rai_blocklist_name: rai_blocklist_name.into(),
                rai_blocklist_items_names: rai_blocklist_items_names.into(),
            }
        }
    }
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.CognitiveServices/accounts/{}/raiBlocklists/{}/raiBlocklistItems" , & self . subscription_id , & self . resource_group_name , & self . account_name , & self . rai_blocklist_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-10-01");
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.CognitiveServices/accounts/{}/raiBlocklists/{}/raiBlocklistItems/{}" , & self . subscription_id , & self . resource_group_name , & self . account_name , & self . rai_blocklist_name , & self . rai_blocklist_item_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-10-01");
    ...
    pub mod batch_add {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) subscription_id: String,
            pub(crate) rai_blocklist_name: String,
            pub(crate) rai_blocklist_items: models::RaiBlocklistItemsBulkAddRequest,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.rai_blocklist_items)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.CognitiveServices/accounts/{}/raiBlocklists/{}/addRaiBlocklistItems" , & self . subscription_id , & self . resource_group_name , & self . account_name , & self . rai_blocklist_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-10-01");
    ...
    pub mod batch_delete {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) subscription_id: String,
            pub(crate) rai_blocklist_name: String,
            pub(crate) rai_blocklist_items_names: models::RaiBlocklistItemsBulkDeleteRequest,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.rai_blocklist_items_names)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.CognitiveServices/accounts/{}/raiBlocklists/{}/deleteRaiBlocklistItems" , & self . subscription_id , & self . resource_group_name , & self . account_name , & self . rai_blocklist_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-10-01");
...
pub mod rai_content_filters {
    ...
    impl Client {
        ...
        #[doc = "Get Content Filters by Name."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `location`: Resource location."]
        #[doc = "* `filter_name`: The name of the RAI Content Filter."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            location: impl Into<String>,
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::RaiContentFilterListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::RaiContentFilter> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::RaiContentFilter = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.CognitiveServices/locations/{}/raiContentFilters/{}",
                    &self.subscription_id, &self.location, &self.filter_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::RaiContentFilter>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::RaiContentFilter>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod network_security_perimeter_configurations {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets a list of NSP configurations for an account."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `account_name`: The name of Cognitive Services account."]
        ...
        #[doc = "Gets the specified NSP configurations for an account."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `account_name`: The name of Cognitive Services account."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `nsp_configuration_name`: The name of the NSP Configuration."]
        pub fn get(
            &self,
            resource_group_name: impl Into<String>,
            account_name: impl Into<String>,
            subscription_id: impl Into<String>,
            nsp_configuration_name: impl Into<String>,
        ) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                account_name: account_name.into(),
                subscription_id: subscription_id.into(),
                nsp_configuration_name: nsp_configuration_name.into(),
            }
        }
        #[doc = "Reconcile the NSP configuration for an account."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `account_name`: The name of Cognitive Services account."]
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::NetworkSecurityPerimeterConfigurationList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.CognitiveServices/accounts/{}/networkSecurityPerimeterConfigurations" , & self . subscription_id , & self . resource_group_name , & self . account_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-10-01");
    ...
    pub mod get {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) account_name: String,
            pub(crate) subscription_id: String,
            pub(crate) nsp_configuration_name: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.CognitiveServices/accounts/{}/networkSecurityPerimeterConfigurations/{}" , & self . subscription_id , & self . resource_group_name , & self . account_name , & self . nsp_configuration_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-10-01");
    ...
    pub mod reconcile {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.CognitiveServices/accounts/{}/networkSecurityPerimeterConfigurations/{}/reconcile" , & self . subscription_id , & self . resource_group_name , & self . account_name , & self . nsp_configuration_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-10-01");
...
pub mod defender_for_ai_settings {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Lists the Defender for AI settings."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `account_name`: The name of Cognitive Services account."]
        ...
        #[doc = "Gets the specified Defender for AI setting by name."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `account_name`: The name of Cognitive Services account."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `defender_for_ai_setting_name`: The name of the defender for AI setting."]
        pub fn get(
            &self,
            resource_group_name: impl Into<String>,
            account_name: impl Into<String>,
            subscription_id: impl Into<String>,
            defender_for_ai_setting_name: impl Into<String>,
        ) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                account_name: account_name.into(),
                subscription_id: subscription_id.into(),
                defender_for_ai_setting_name: defender_for_ai_setting_name.into(),
            }
        }
        #[doc = "Creates or Updates the specified Defender for AI setting."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `account_name`: The name of Cognitive Services account."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `defender_for_ai_setting_name`: The name of the defender for AI setting."]
        #[doc = "* `defender_for_ai_settings`: Properties describing the Defender for AI setting."]
        pub fn create_or_update(
            &self,
            resource_group_name: impl Into<String>,
            account_name: impl Into<String>,
            subscription_id: impl Into<String>,
            defender_for_ai_setting_name: impl Into<String>,
            defender_for_ai_settings: impl Into<models::DefenderForAiSetting>,
        ) -> create_or_update::RequestBuilder {
            create_or_update::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                ...
                subscription_id: subscription_id.into(),
                defender_for_ai_setting_name: defender_for_ai_setting_name.into(),
                defender_for_ai_settings: defender_for_ai_settings.into(),
            }
        }
        #[doc = "Updates the specified Defender for AI setting."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `account_name`: The name of Cognitive Services account."]
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DefenderForAiSettingResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DefenderForAiSettingResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::DefenderForAiSettingResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.CognitiveServices/accounts/{}/defenderForAISettings",
                    &self.subscription_id, &self.resource_group_name, &self.account_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DefenderForAiSetting> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DefenderForAiSetting = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) account_name: String,
            pub(crate) subscription_id: String,
            pub(crate) defender_for_ai_setting_name: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.CognitiveServices/accounts/{}/defenderForAISettings/{}",
                    &self.subscription_id, &self.resource_group_name, &self.account_name, &self.defender_for_ai_setting_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DefenderForAiSetting>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DefenderForAiSetting>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) subscription_id: String,
            pub(crate) defender_for_ai_setting_name: String,
            pub(crate) defender_for_ai_settings: models::DefenderForAiSetting,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.defender_for_ai_settings)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
