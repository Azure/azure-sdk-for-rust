...
pub mod account_model {
    ...
    impl Serialize for LifecycleStatus {
        ...
        {
            match self {
                Self::Stable => serializer.serialize_unit_variant("LifecycleStatus", 0u32, "Stable"),
                Self::Preview => serializer.serialize_unit_variant("LifecycleStatus", 1u32, "Preview"),
                Self::GenerallyAvailable => serializer.serialize_unit_variant("LifecycleStatus", 2u32, "GenerallyAvailable"),
                Self::Deprecating => serializer.serialize_unit_variant("LifecycleStatus", 3u32, "Deprecating"),
                Self::Deprecated => serializer.serialize_unit_variant("LifecycleStatus", 4u32, "Deprecated"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct AccountProperties {
    ...
    #[serde(
        rename = "userOwnedStorage",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub user_owned_storage: Vec<UserOwnedStorage>,
    #[doc = "The user owned AML workspace for Cognitive Services account."]
    #[serde(rename = "amlWorkspace", default, skip_serializing_if = "Option::is_none")]
    pub aml_workspace: Option<UserOwnedAmlWorkspace>,
    ...
    #[doc = "Cognitive Services Rai Monitor Config."]
    #[serde(rename = "raiMonitorConfig", default, skip_serializing_if = "Option::is_none")]
    pub rai_monitor_config: Option<RaiMonitorConfig>,
}
...
impl BillingMeterInfo {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Calculate Model Capacity parameter."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CalculateModelCapacityParameter {
    #[doc = "Properties of Cognitive Services account deployment model."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[doc = "List of Model Capacity Calculator Workload."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub workloads: Vec<ModelCapacityCalculatorWorkload>,
}
impl CalculateModelCapacityParameter {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Calculate Model Capacity result."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CalculateModelCapacityResult {
    #[doc = "Properties of Cognitive Services account deployment model."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub model: Option<DeploymentModel>,
    #[serde(rename = "skuName", default, skip_serializing_if = "Option::is_none")]
    pub sku_name: Option<String>,
    #[doc = "Model Estimated Capacity."]
    #[serde(rename = "estimatedCapacity", default, skip_serializing_if = "Option::is_none")]
    pub estimated_capacity: Option<calculate_model_capacity_result::EstimatedCapacity>,
}
impl CalculateModelCapacityResult {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod calculate_model_capacity_result {
    use super::*;
    #[doc = "Model Estimated Capacity."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
    pub struct EstimatedCapacity {
        ...
        #[serde(rename = "deployableValue", default, skip_serializing_if = "Option::is_none")]
        pub deployable_value: Option<i32>,
    }
    impl EstimatedCapacity {
        pub fn new() -> Self {
            Self::default()
        }
    }
...
pub struct CapacityConfig {
    ...
    #[doc = "The array of allowed values for capacity."]
    #[serde(
...
#[doc = "Gets or sets the source to which filter applies."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CustomBlocklistConfig {
    #[serde(flatten)]
    pub rai_blocklist_config: RaiBlocklistConfig,
    #[doc = "Content source to apply the Content Filters."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub source: Option<RaiPolicyContentSource>,
}
impl CustomBlocklistConfig {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The Defender for AI resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DefenderForAiSetting {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Metadata pertaining to creation and last modification of the resource."]
    #[serde(rename = "systemData", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<serde_json::Value>,
    #[doc = "The Defender for AI resource properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<DefenderForAiSettingProperties>,
}
impl DefenderForAiSetting {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The Defender for AI resource properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DefenderForAiSettingProperties {
    #[doc = "Defender for AI state on the AI resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<defender_for_ai_setting_properties::State>,
}
impl DefenderForAiSettingProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod defender_for_ai_setting_properties {
    use super::*;
    #[doc = "Defender for AI state on the AI resource."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "State")]
...
#[doc = "The list of cognitive services Defender for AI Settings."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DefenderForAiSettingResult {
    #[doc = "The link used to get the next page of Defender for AI Settings."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
    #[doc = "The list of Defender for AI Settings."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<DefenderForAiSetting>,
}
impl azure_core::Continuable for DefenderForAiSettingResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl DefenderForAiSettingResult {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DeploymentCapacitySettings {
    #[doc = "The designated capacity."]
    #[serde(rename = "designatedCapacity", default, skip_serializing_if = "Option::is_none")]
    pub designated_capacity: Option<i32>,
    #[doc = "The priority of this capacity setting."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub priority: Option<i32>,
}
impl DeploymentCapacitySettings {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct DeploymentModel {
    #[doc = "Deployment model publisher."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[doc = "Optional. Source of the model, another Microsoft.CognitiveServices accounts ARM resource ID."]
...
pub struct DeploymentProperties {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub model: Option<DeploymentModel>,
    #[doc = "Properties of Cognitive Services account deployment model. (Deprecated, please use Deployment.sku instead.)"]
    ...
    #[doc = "If the dynamic throttling is enabled."]
    #[serde(rename = "dynamicThrottlingEnabled", default, skip_serializing_if = "Option::is_none")]
    pub dynamic_throttling_enabled: Option<bool>,
    #[doc = "The current capacity."]
    #[serde(rename = "currentCapacity", default, skip_serializing_if = "Option::is_none")]
    pub current_capacity: Option<i32>,
    #[doc = "Internal use only."]
    #[serde(rename = "capacitySettings", default, skip_serializing_if = "Option::is_none")]
    pub capacity_settings: Option<DeploymentCapacitySettings>,
    #[doc = "The name of parent deployment."]
    #[serde(rename = "parentDeploymentName", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "The list of cognitive services accounts operation response."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DeploymentSkuListResult {
    #[doc = "The link used to get the next page of deployment skus."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
    #[doc = "Gets the list of Cognitive Services accounts deployment skus."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
impl azure_core::Continuable for DeploymentSkuListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl DeploymentSkuListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Cognitive Services EncryptionScope"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EncryptionScope {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<serde_json::Value>,
    #[doc = "Properties to EncryptionScope"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "The list of cognitive services EncryptionScopes."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EncryptionScopeListResult {
    #[doc = "The link used to get the next page of EncryptionScope."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
    #[doc = "The list of EncryptionScope."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
pub struct EncryptionScopeProperties {
    ...
    #[doc = "Gets the status of the resource at the time the operation was called."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<encryption_scope_properties::ProvisioningState>,
    #[doc = "The encryptionScope state."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct Model {
    ...
    #[serde(rename = "skuName", default, skip_serializing_if = "Option::is_none")]
    pub sku_name: Option<SkuName>,
    #[doc = "The description of the model."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Model Capacity Calculator Workload."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ModelCapacityCalculatorWorkload {
    #[doc = "Request per minute."]
    #[serde(rename = "requestPerMinute", default, skip_serializing_if = "Option::is_none")]
    pub request_per_minute: Option<i64>,
    #[doc = "Dictionary, Model Capacity Calculator Workload Parameters."]
    #[serde(rename = "requestParameters", default, skip_serializing_if = "Option::is_none")]
    pub request_parameters: Option<ModelCapacityCalculatorWorkloadRequestParam>,
}
impl ModelCapacityCalculatorWorkload {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Dictionary, Model Capacity Calculator Workload Parameters."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ModelCapacityCalculatorWorkloadRequestParam {
    #[doc = "Average prompt tokens."]
    #[serde(rename = "avgPromptTokens", default, skip_serializing_if = "Option::is_none")]
    pub avg_prompt_tokens: Option<i64>,
    #[doc = "Average generated tokens."]
    #[serde(rename = "avgGeneratedTokens", default, skip_serializing_if = "Option::is_none")]
    pub avg_generated_tokens: Option<i64>,
}
impl ModelCapacityCalculatorWorkloadRequestParam {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The list of cognitive services accounts operation response."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ModelCapacityListResult {
    #[doc = "The link used to get the next page of ModelSkuCapacity."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
    #[doc = "Gets the list of Cognitive Services accounts ModelSkuCapacity."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
impl azure_core::Continuable for ModelCapacityListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl ModelCapacityListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ModelSku {
    ...
    #[doc = "The list of billing meter info."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub cost: Vec<BillingMeterInfo>,
}
impl ModelSku {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "Cognitive Services account ModelSkuCapacity."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ModelSkuCapacityProperties {
    #[doc = "Properties of Cognitive Services account deployment model."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub model: Option<DeploymentModel>,
    #[serde(rename = "skuName", default, skip_serializing_if = "Option::is_none")]
    pub sku_name: Option<String>,
    #[doc = "The available capacity for deployment with this model and sku."]
    #[serde(rename = "availableCapacity", default, skip_serializing_if = "Option::is_none")]
    pub available_capacity: Option<f64>,
    #[doc = "The available capacity for deployment with a fine-tune version of this model and sku."]
    #[serde(rename = "availableFinetuneCapacity", default, skip_serializing_if = "Option::is_none")]
    pub available_finetune_capacity: Option<f64>,
}
impl ModelSkuCapacityProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct NetworkRuleSet {
    ...
    #[doc = "Setting for trusted services."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    impl Serialize for Bypass {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::AzureServices => serializer.serialize_unit_variant("Bypass", 1u32, "AzureServices"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
}
#[doc = "Information about a linked Network Security Perimeter"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "Network Security Perimeter Access Rule"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NetworkSecurityPerimeterAccessRule {
    #[doc = "Network Security Perimeter Access Rule Name"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "The Properties of Network Security Perimeter Rule"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<NetworkSecurityPerimeterAccessRuleProperties>,
}
...
#[doc = "The Properties of Network Security Perimeter Rule"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NetworkSecurityPerimeterAccessRuleProperties {
    #[doc = "Direction of Access Rule"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub direction: Option<network_security_perimeter_access_rule_properties::Direction>,
    #[doc = "Address prefixes for inbound rules"]
    #[serde(
    ...
    #[doc = "Fully qualified domain name for outbound rules"]
    #[serde(
...
impl NetworkSecurityPerimeterAccessRuleProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod network_security_perimeter_access_rule_properties {
    use super::*;
    #[doc = "Direction of Access Rule"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "NSP Configuration for an Cognitive Services account."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NetworkSecurityPerimeterConfiguration {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "The properties of an NSP Configuration."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Network Security Perimeter Configuration Association Information"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NetworkSecurityPerimeterConfigurationAssociationInfo {
...
impl NetworkSecurityPerimeterConfigurationAssociationInfo {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "A list of NSP configurations for an Cognitive Services account."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NetworkSecurityPerimeterConfigurationList {
    #[doc = "Array of NSP configurations List Result for an Cognitive Services account."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
impl azure_core::Continuable for NetworkSecurityPerimeterConfigurationList {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
...
pub struct NetworkSecurityPerimeterConfigurationProperties {
    #[doc = "Provisioning state of NetworkSecurityPerimeter configuration"]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<String>,
    #[doc = "List of Provisioning Issues"]
    #[serde(
        rename = "provisioningIssues",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub network_security_perimeter: Option<NetworkSecurityPerimeter>,
    #[doc = "Network Security Perimeter Configuration Association Information"]
    #[serde(rename = "resourceAssociation", default, skip_serializing_if = "Option::is_none")]
    pub resource_association: Option<NetworkSecurityPerimeterConfigurationAssociationInfo>,
    #[doc = "Network Security Perimeter Profile Information"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub profile: Option<NetworkSecurityPerimeterProfileInfo>,
}
...
#[doc = "Network Security Perimeter Profile Information"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NetworkSecurityPerimeterProfileInfo {
    #[doc = "Name of the resource profile"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Access rules version of the resource profile"]
    #[serde(rename = "accessRulesVersion", default, skip_serializing_if = "Option::is_none")]
    pub access_rules_version: Option<i64>,
    #[serde(
        rename = "accessRules",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub access_rules: Vec<NetworkSecurityPerimeterAccessRule>,
    #[doc = "Current diagnostic settings version"]
    #[serde(rename = "diagnosticSettingsVersion", default, skip_serializing_if = "Option::is_none")]
    pub diagnostic_settings_version: Option<i64>,
    #[doc = "List of enabled log categories"]
    #[serde(
        rename = "enabledLogCategories",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub enabled_log_categories: Vec<String>,
}
impl NetworkSecurityPerimeterProfileInfo {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ProvisioningIssue {
    #[doc = "Name of the NSP provisioning issue"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Properties of Provisioning Issue"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ProvisioningIssueProperties>,
}
...
#[doc = "Properties of Provisioning Issue"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ProvisioningIssueProperties {
    #[doc = "Type of Issue"]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    #[doc = "IDs of resources that can be associated to the same perimeter to remediate the issue."]
    #[serde(
    ...
    #[doc = "Optional array, suggested access rules"]
    #[serde(
    ...
    pub suggested_access_rules: Vec<NetworkSecurityPerimeterAccessRule>,
}
impl ProvisioningIssueProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "The list of cognitive services RAI Blocklist Items."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RaiBlockListItemsResult {
    #[doc = "The link used to get the next page of RaiBlocklistItems."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
    #[doc = "The list of RaiBlocklistItems."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<RaiBlocklistItem>,
}
impl azure_core::Continuable for RaiBlockListItemsResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl RaiBlockListItemsResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The list of cognitive services RAI Blocklists."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RaiBlockListResult {
    #[doc = "The link used to get the next page of RaiBlocklists."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
    #[doc = "The list of RaiBlocklist."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<RaiBlocklist>,
}
impl azure_core::Continuable for RaiBlockListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl RaiBlockListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Cognitive Services RaiBlocklist."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RaiBlocklist {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Metadata pertaining to creation and last modification of the resource."]
    #[serde(rename = "systemData", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<serde_json::Value>,
    #[doc = "RAI Custom Blocklist properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<RaiBlocklistProperties>,
}
impl RaiBlocklist {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "Azure OpenAI blocklist config."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RaiBlocklistConfig {
    #[doc = "Name of ContentFilter."]
    #[serde(rename = "blocklistName", default, skip_serializing_if = "Option::is_none")]
    pub blocklist_name: Option<String>,
    #[doc = "If blocking would occur."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub blocking: Option<bool>,
}
impl RaiBlocklistConfig {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Cognitive Services RaiBlocklist Item."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RaiBlocklistItem {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Metadata pertaining to creation and last modification of the resource."]
    #[serde(rename = "systemData", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<serde_json::Value>,
    #[doc = "RAI Custom Blocklist Item properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<RaiBlocklistItemProperties>,
}
impl RaiBlocklistItem {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The Cognitive Services RaiBlocklist Item request body."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RaiBlocklistItemBulkRequest {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "RAI Custom Blocklist Item properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl RaiBlocklistItemBulkRequest {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "RAI Custom Blocklist Item properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RaiBlocklistItemProperties {
    #[doc = "Pattern to match against."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub pattern: Option<String>,
    #[doc = "If the pattern is a regex pattern."]
    #[serde(rename = "isRegex", default, skip_serializing_if = "Option::is_none")]
    pub is_regex: Option<bool>,
}
impl RaiBlocklistItemProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub type RaiBlocklistItemsBulkAddRequest = Vec<RaiBlocklistItemBulkRequest>;
#[doc = "The list of Cognitive Services RaiBlocklist Items Names."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RaiBlocklistItemsBulkDeleteRequest {}
impl RaiBlocklistItemsBulkDeleteRequest {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "RAI Custom Blocklist properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RaiBlocklistProperties {
    #[doc = "Description of the block list."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
}
impl RaiBlocklistProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Azure OpenAI Content Filter."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RaiContentFilter {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Azure OpenAI Content Filter Properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<rai_content_filter::Properties>,
}
impl RaiContentFilter {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod rai_content_filter {
    use super::*;
    #[doc = "Azure OpenAI Content Filter Properties."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
    pub struct Properties {
        #[doc = "Name of Content Filter."]
        #[serde(default, skip_serializing_if = "Option::is_none")]
        pub name: Option<String>,
        #[doc = "If the Content Filter has multi severity levels(Low, Medium, or High)."]
        #[serde(rename = "isMultiLevelFilter", default, skip_serializing_if = "Option::is_none")]
        pub is_multi_level_filter: Option<bool>,
        #[doc = "Content source to apply the Content Filters."]
        #[serde(default, skip_serializing_if = "Option::is_none")]
        pub source: Option<RaiPolicyContentSource>,
    }
...
#[doc = "The list of Content Filters."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RaiContentFilterListResult {
    #[doc = "The link used to get the next page of Content Filters."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
    #[doc = "The list of RaiContentFilter."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
#[doc = "Cognitive Services Rai Monitor Config."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RaiMonitorConfig {
    #[doc = "The storage resource Id."]
    #[serde(rename = "adxStorageResourceId", default, skip_serializing_if = "Option::is_none")]
    pub adx_storage_resource_id: Option<String>,
    #[doc = "The identity client Id to access the storage."]
    #[serde(rename = "identityClientId", default, skip_serializing_if = "Option::is_none")]
    pub identity_client_id: Option<String>,
}
impl RaiMonitorConfig {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Cognitive Services RaiPolicy."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RaiPolicy {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Metadata pertaining to creation and last modification of the resource."]
    #[serde(rename = "systemData", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<serde_json::Value>,
    #[doc = "Azure OpenAI Content Filters properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<RaiPolicyProperties>,
}
impl RaiPolicy {
    pub fn new() -> Self {
        Self::default()
...
pub struct RaiPolicyContentFilter {
    ...
    #[doc = "Level at which content is filtered."]
    #[serde(rename = "severityThreshold", default, skip_serializing_if = "Option::is_none")]
    pub severity_threshold: Option<rai_policy_content_filter::SeverityThreshold>,
    #[doc = "If blocking would occur."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub blocking: Option<bool>,
    #[doc = "Content source to apply the Content Filters."]
...
impl RaiPolicyContentFilter {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod rai_policy_content_filter {
    use super::*;
    #[doc = "Level at which content is filtered."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "SeverityThreshold")]
    ...
    impl Serialize for SeverityThreshold {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Low => serializer.serialize_unit_variant("SeverityThreshold", 0u32, "Low"),
                Self::Medium => serializer.serialize_unit_variant("SeverityThreshold", 1u32, "Medium"),
                Self::High => serializer.serialize_unit_variant("SeverityThreshold", 2u32, "High"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Content source to apply the Content Filters."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "RaiPolicyContentSource")]
pub enum RaiPolicyContentSource {
    Prompt,
    Completion,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for RaiPolicyContentSource {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for RaiPolicyContentSource {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for RaiPolicyContentSource {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Prompt => serializer.serialize_unit_variant("RaiPolicyContentSource", 0u32, "Prompt"),
            Self::Completion => serializer.serialize_unit_variant("RaiPolicyContentSource", 1u32, "Completion"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "The list of cognitive services RaiPolicies."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RaiPolicyListResult {
    #[doc = "The link used to get the next page of RaiPolicy."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
    #[doc = "The list of RaiPolicy."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<RaiPolicy>,
}
impl azure_core::Continuable for RaiPolicyListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl RaiPolicyListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Azure OpenAI Content Filters properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RaiPolicyProperties {
    #[doc = "Content Filters policy type."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<rai_policy_properties::Type>,
    #[doc = "Rai policy mode. The enum value mapping is as below: Default = 0, Deferred=1, Blocking=2, Asynchronous_filter =3. Please use 'Asynchronous_filter' after 2024-10-01. It is the same as 'Deferred' in previous version."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mode: Option<rai_policy_properties::Mode>,
    #[doc = "Name of Rai policy."]
    #[serde(rename = "basePolicyName", default, skip_serializing_if = "Option::is_none")]
    pub base_policy_name: Option<String>,
    #[doc = "The list of Content Filters."]
    #[serde(
        rename = "contentFilters",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub content_filters: Vec<RaiPolicyContentFilter>,
    #[doc = "The list of custom Blocklist."]
    #[serde(
        rename = "customBlocklists",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub custom_blocklists: Vec<CustomBlocklistConfig>,
}
impl RaiPolicyProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod rai_policy_properties {
    use super::*;
    #[doc = "Content Filters policy type."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Type")]
    ...
    impl Serialize for Type {
        ...
        {
            match self {
                Self::UserManaged => serializer.serialize_unit_variant("Type", 0u32, "UserManaged"),
                Self::SystemManaged => serializer.serialize_unit_variant("Type", 1u32, "SystemManaged"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    pub enum Mode {
        ...
        Deferred,
        Blocking,
        #[serde(rename = "Asynchronous_filter")]
        AsynchronousFilter,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    ...
    impl Serialize for Mode {
        ...
        {
            match self {
                Self::Default => serializer.serialize_unit_variant("Mode", 0u32, "Default"),
                Self::Deferred => serializer.serialize_unit_variant("Mode", 1u32, "Deferred"),
                Self::Blocking => serializer.serialize_unit_variant("Mode", 2u32, "Blocking"),
                Self::AsynchronousFilter => serializer.serialize_unit_variant("Mode", 3u32, "Asynchronous_filter"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Properties of Cognitive Services account resource sku resource properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "The user owned AML workspace for Cognitive Services account."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct UserOwnedAmlWorkspace {
    #[doc = "Full resource id of a AML workspace resource."]
    #[serde(rename = "resourceId", default, skip_serializing_if = "Option::is_none")]
    pub resource_id: Option<String>,
    #[doc = "Identity Client id of a AML workspace resource."]
    #[serde(rename = "identityClientId", default, skip_serializing_if = "Option::is_none")]
    pub identity_client_id: Option<String>,
}
impl UserOwnedAmlWorkspace {
    pub fn new() -> Self {
        Self::default()
    }
}
