...
pub struct DomainSecuritySettings {
    ...
    #[doc = "A flag to determine whether or not LdapSigning is enabled or disabled."]
    #[serde(rename = "ldapSigning", default, skip_serializing_if = "Option::is_none")]
    pub ldap_signing: Option<domain_security_settings::LdapSigning>,
    #[doc = "A flag to determine whether or not ChannelBinding is enabled or disabled."]
    #[serde(rename = "channelBinding", default, skip_serializing_if = "Option::is_none")]
    pub channel_binding: Option<domain_security_settings::ChannelBinding>,
}
...
pub mod domain_security_settings {
    ...
    #[doc = "A flag to determine whether or not LdapSigning is enabled or disabled."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "LdapSigning")]
    pub enum LdapSigning {
        Enabled,
        Disabled,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for LdapSigning {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for LdapSigning {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for LdapSigning {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("LdapSigning", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("LdapSigning", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for LdapSigning {
        fn default() -> Self {
            Self::Disabled
        }
    }
    ...
    impl<'de> Deserialize<'de> for ChannelBinding {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for ChannelBinding {
        ...
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("ChannelBinding", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("ChannelBinding", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct DomainServiceProperties {
    ...
    #[doc = "All or CloudOnly, All users in AAD are synced to AAD DS domain or only users actively syncing in the cloud"]
    #[serde(rename = "syncScope", default, skip_serializing_if = "Option::is_none")]
    pub sync_scope: Option<domain_service_properties::SyncScope>,
...
pub mod domain_service_properties {
    ...
    impl<'de> Deserialize<'de> for SyncScope {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for SyncScope {
        ...
        {
            match self {
                Self::All => serializer.serialize_unit_variant("SyncScope", 0u32, "All"),
                Self::CloudOnly => serializer.serialize_unit_variant("SyncScope", 1u32, "CloudOnly"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
