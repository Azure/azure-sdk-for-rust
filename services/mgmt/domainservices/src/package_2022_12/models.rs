...
pub struct DomainServiceProperties {
    ...
    #[doc = "The unique sync application id of the Azure AD Domain Services deployment."]
    #[serde(rename = "syncApplicationId", default, skip_serializing_if = "Option::is_none")]
    pub sync_application_id: Option<String>,
