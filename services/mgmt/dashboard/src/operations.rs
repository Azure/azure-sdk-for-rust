...
pub enum Error {
    ...
    #[error(transparent)]
    Grafana_List(#[from] grafana::list::Error),
    #[error(transparent)]
    Grafana_ListByResourceGroup(#[from] grafana::list_by_resource_group::Error),
    #[error(transparent)]
    Grafana_Get(#[from] grafana::get::Error),
    #[error(transparent)]
    Grafana_Create(#[from] grafana::create::Error),
    #[error(transparent)]
    Grafana_Update(#[from] grafana::update::Error),
    #[error(transparent)]
    Grafana_Delete(#[from] grafana::delete::Error),
}
pub mod operations {
    use super::models;
    ...
    pub mod list {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::OperationListResult, Error>> {
                Box::pin(async move {
                    let url_str = &format!("{}/providers/Microsoft.Dashboard/operations", self.client.endpoint(),);
