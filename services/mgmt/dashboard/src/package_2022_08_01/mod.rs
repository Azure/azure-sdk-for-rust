    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!("/providers/Microsoft.Dashboard/operations",));
...
pub mod grafana {
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ManagedGrafanaListResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ManagedGrafanaListResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ManagedGrafanaListResponse, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ManagedGrafana> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ManagedGrafana = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ManagedGrafana>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ManagedGrafana>>;
    ...
    pub mod create {
        ...
        impl<'a> Headers<'a> {
            #[doc = "Operation URI for long running operation."]
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Dashboard/grafana/{}/privateLinkResources/{}",
                    &self.subscription_id, &self.resource_group_name, &self.workspace_name, &self.private_link_resource_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
