...
pub struct AlertRuleProperties {
    ...
    #[doc = "The alert rule frequency in ISO8601 format. The time granularity must be in minutes and minimum value is 1 minute, depending on the detector."]
...
pub struct Detector {
    ...
    #[doc = "The Smart Detector name."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "The Smart Detector description."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    #[doc = "The Smart Detector supported resource types."]
    ...
    #[doc = "The Smart Detector parameters definitions.'"]
    #[serde(rename = "parameterDefinitions", default, skip_serializing_if = "Vec::is_empty")]
    pub parameter_definitions: Vec<DetectorParameterDefinition>,
    #[doc = "The Smart Detector supported cadences."]
    #[serde(rename = "supportedCadences", default, skip_serializing_if = "Vec::is_empty")]
    pub supported_cadences: Vec<i32>,
}
impl Detector {
    pub fn new(id: String) -> Self {
        Self {
            ...
            supported_cadences: Vec::new(),
        }
    }
}
#[doc = "The detector parameter definition."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DetectorParameterDefinition {
    #[doc = "The detector parameter name."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "The detector parameter display name."]
    #[serde(rename = "displayName", default, skip_serializing_if = "Option::is_none")]
    pub display_name: Option<String>,
    #[doc = "The detector parameter description."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    #[doc = "The detector parameter type."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<detector_parameter_definition::Type>,
    #[doc = "A value indicating whether this detector parameter is mandatory."]
    #[serde(rename = "isMandatory", default, skip_serializing_if = "Option::is_none")]
    pub is_mandatory: Option<bool>,
}
impl DetectorParameterDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod detector_parameter_definition {
    use super::*;
    #[doc = "The detector parameter type."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum Type {
...
pub struct SmartDetectorErrorResponse {
    #[doc = "API error body."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub error: Option<SmartDetectorErrorResponseBody>,
}
...
#[doc = "API error body."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SmartDetectorErrorResponseBody {
    #[doc = "Error code"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl SmartDetectorErrorResponseBody {
    pub fn new() -> Self {
        Self::default()
    }
}
