...
pub mod health_alerts {
    ...
    pub async fn list_by_subscription(
        ...
        subscription_id: &str,
    ) -> std::result::Result<models::HealthAlertResourceCollection, list_by_subscription::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::HealthAlertResourceCollection = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_by_subscription::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::HealthAlertsErrorResponse = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_by_subscription::Error::DeserializeError(source, rsp_body.clone()))?;
    ...
    ) -> std::result::Result<models::HealthAlertResourceCollection, list_by_resource_group::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
    ...
    pub async fn get(
        ...
        resource_group_name: &str,
        rule_name: &str,
    ) -> std::result::Result<models::HealthAlertResource, get::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.AlertsManagement/resourceHealthAlertRules/{}",
            operation_config.base_path(),
    ...
    pub async fn create_or_update(
        ...
        resource_group_name: &str,
        rule_name: &str,
        parameters: &models::HealthAlertResource,
    ) -> std::result::Result<models::HealthAlertResource, create_or_update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.AlertsManagement/resourceHealthAlertRules/{}",
            operation_config.base_path(),
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::HealthAlertResource = serde_json::from_slice(rsp_body)
    ...
    pub async fn update(
        ...
        resource_group_name: &str,
        rule_name: &str,
        parameters: &models::HealthAlertResourcePatch,
    ) -> std::result::Result<models::HealthAlertResource, update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.AlertsManagement/resourceHealthAlertRules/{}",
            operation_config.base_path(),
