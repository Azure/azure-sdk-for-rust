...
pub struct CorrelateAlerts {
    ...
    #[doc = "Defines the updates to be applied for correlation."]
    #[serde(rename = "correlationUpdates", default, skip_serializing_if = "Option::is_none")]
    pub correlation_updates: Option<CorrelationUpdates>,
}
...
#[doc = "Defines the updates to be applied for correlation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CorrelationUpdates {
    #[doc = "The type of update that needs to be performed."]
    #[serde(rename = "updateType")]
    pub update_type: correlation_updates::UpdateType,
    #[doc = "The update interval for notification updates in ISO8601 format."]
    #[serde(rename = "updateInterval")]
    pub update_interval: String,
    #[doc = "The action group ids."]
    #[serde(rename = "actionGroups")]
    pub action_groups: Vec<String>,
}
impl CorrelationUpdates {
    pub fn new(update_type: correlation_updates::UpdateType, update_interval: String, action_groups: Vec<String>) -> Self {
        Self {
            update_type,
            update_interval,
            action_groups,
...
pub mod correlation_updates {
    ...
    impl Serialize for UpdateType {
        ...
        {
            match self {
                Self::TimeBased => serializer.serialize_unit_variant("UpdateType", 0u32, "timeBased"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
