                        ...
                        let rsp = match continuation {
                            Some(value) => {
                                ...
                                if !has_api_version_already {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-12-preview");
                                }
...
pub mod alerts {
    ...
    impl Client {
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `scope`: scope here is resourceId for which alert is created."]
        pub fn get_all(&self, scope: impl Into<String>) -> get_all::RequestBuilder {
        ...
        pub fn get_by_id(&self, scope: impl Into<String>, alert_id: impl Into<String>) -> get_by_id::RequestBuilder {
        ...
        #[doc = "* `scope`: scope here is resourceId for which alert is created."]
        #[doc = "* `alert_id`: Unique ID of an alert instance."]
        pub fn get_history(&self, scope: impl Into<String>, alert_id: impl Into<String>) -> get_history::RequestBuilder {
        ...
        pub fn get_summary(&self, scope: impl Into<String>, groupby: impl Into<String>) -> get_summary::RequestBuilder {
        ...
        #[doc = "List the enrichments of an alert. It returns a collection of one object named default."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `scope`: scope here is resourceId for which alert is created."]
        #[doc = "* `alert_id`: Unique ID of an alert instance."]
        pub fn list_enrichments(&self, scope: impl Into<String>, alert_id: impl Into<String>) -> list_enrichments::RequestBuilder {
            list_enrichments::RequestBuilder {
                client: self.0.clone(),
                scope: scope.into(),
                alert_id: alert_id.into(),
            }
        }
        #[doc = "Get the enrichments of an alert."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `scope`: scope here is resourceId for which alert is created."]
        #[doc = "* `alert_id`: Unique ID of an alert instance."]
        pub fn get_enrichments(&self, scope: impl Into<String>, alert_id: impl Into<String>) -> get_enrichments::RequestBuilder {
            get_enrichments::RequestBuilder {
                client: self.0.clone(),
                scope: scope.into(),
                alert_id: alert_id.into(),
            }
    ...
    pub mod list_enrichments {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AlertEnrichmentsList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AlertEnrichmentsList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/{}/providers/Microsoft.AlertsManagement/alerts/{}/enrichments",
                    self.client.endpoint(),
                    &self.scope,
                    &self.alert_id
                ))?;
    ...
    pub mod get_enrichments {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AlertEnrichmentResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AlertEnrichmentResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/{}/providers/Microsoft.AlertsManagement/alerts/{}/enrichments/default",
                    self.client.endpoint(),
                    &self.scope,
                    &self.alert_id
                ))?;
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AlertEnrichmentResponse>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::AlertEnrichmentResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
