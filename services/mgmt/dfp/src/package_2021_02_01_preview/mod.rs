...
pub mod instances {
    ...
    pub mod get_details {
        ...
        impl RequestBuilder {
            ...
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::DfpInstance>> {
    ...
    pub mod check_name_availability {
        ...
        impl RequestBuilder {
            ...
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, azure_core::Result<models::CheckInstanceNameAvailabilityResult>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
