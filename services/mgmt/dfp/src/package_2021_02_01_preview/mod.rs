...
pub mod instances {
    ...
    pub mod get_details {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DfpInstance> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DfpInstance = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DfpInstance>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DfpInstance>>;
    ...
    pub mod list_by_resource_group {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DfpInstances> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DfpInstances = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::DfpInstances, azure_core::error::Error> {
    ...
    pub mod check_name_availability {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CheckInstanceNameAvailabilityResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CheckInstanceNameAvailabilityResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::CheckInstanceNameAvailabilityResult>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::CheckInstanceNameAvailabilityResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod list_operations {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/providers/Microsoft.Dynamics365FraudProtection/operations",));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "2021-02-01-preview");
