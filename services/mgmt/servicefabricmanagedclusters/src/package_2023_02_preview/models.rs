...
pub struct NodeTypeProperties {
    ...
    #[doc = "Specifies the security type of the nodeType. Only TrustedLaunch is currently supported"]
    #[serde(rename = "securityType", default, skip_serializing_if = "Option::is_none")]
    pub security_type: Option<node_type_properties::SecurityType>,
    ...
    #[doc = "Specifies whether each node is allocated its own public IP address. This is only supported on secondary node types with custom Load Balancers."]
    ...
    #[serde(rename = "VmSharedGalleryImageId", default, skip_serializing_if = "Option::is_none")]
    pub vm_shared_gallery_image_id: Option<String>,
}
impl NodeTypeProperties {
    pub fn new(is_primary: bool, vm_instance_count: i32) -> Self {
        Self {
            ...
            vm_shared_gallery_image_id: None,
        }
    }
}
pub mod node_type_properties {
    use super::*;
    #[doc = "Specifies the security type of the nodeType. Only TrustedLaunch is currently supported"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
