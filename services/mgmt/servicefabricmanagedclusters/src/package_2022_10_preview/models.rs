...
pub struct FrontendConfiguration {
    ...
    #[serde(
        rename = "applicationGatewayBackendAddressPoolId",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub application_gateway_backend_address_pool_id: Option<String>,
}
...
pub struct ManagedClusterProperties {
    ...
    #[serde(
        rename = "clusterCertificateThumbprints",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    ...
    #[serde(rename = "zonalUpdateMode", default, skip_serializing_if = "Option::is_none")]
    pub zonal_update_mode: Option<ZonalUpdateMode>,
    ...
    #[serde(rename = "useCustomVnet", default, skip_serializing_if = "Option::is_none")]
    pub use_custom_vnet: Option<bool>,
}
impl ManagedClusterProperties {
    pub fn new(dns_name: String, admin_user_name: String) -> Self {
        Self {
            ...
            zonal_update_mode: None,
            use_custom_vnet: None,
        }
    }
}
...
pub struct NodeTypeActionParameters {
    ...
    pub update_type: Option<node_type_action_parameters::UpdateType>,
}
...
pub mod node_type_action_parameters {
    use super::*;
    #[doc = "Specifies the way the operation will be performed."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    ...
    impl Serialize for UpdateType {
        ...
        {
            match self {
                Self::Default => serializer.serialize_unit_variant("UpdateType", 0u32, "Default"),
                Self::ByUpgradeDomain => serializer.serialize_unit_variant("UpdateType", 1u32, "ByUpgradeDomain"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct NodeTypeProperties {
    ...
    pub vm_image_resource_id: Option<String>,
    ...
    #[serde(
        rename = "vmSetupActions",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub vm_setup_actions: Vec<VmSetupAction>,
}
impl NodeTypeProperties {
    pub fn new(is_primary: bool, vm_instance_count: i32) -> Self {
        Self {
            ...
            vm_image_resource_id: None,
            subnet_id: None,
            vm_setup_actions: Vec::new(),
        }
    }
}
#[doc = "Describes a node type sku."]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "VmSetupAction")]
pub enum VmSetupAction {
    EnableContainers,
    EnableHyperV,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for VmSetupAction {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for VmSetupAction {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for VmSetupAction {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::EnableContainers => serializer.serialize_unit_variant("VmSetupAction", 0u32, "EnableContainers"),
            Self::EnableHyperV => serializer.serialize_unit_variant("VmSetupAction", 1u32, "EnableHyperV"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "Indicates the update mode for Cross Az clusters."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ZonalUpdateMode")]
pub enum ZonalUpdateMode {
    Standard,
    Fast,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for ZonalUpdateMode {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for ZonalUpdateMode {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for ZonalUpdateMode {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Standard => serializer.serialize_unit_variant("ZonalUpdateMode", 0u32, "Standard"),
            Self::Fast => serializer.serialize_unit_variant("ZonalUpdateMode", 1u32, "Fast"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
