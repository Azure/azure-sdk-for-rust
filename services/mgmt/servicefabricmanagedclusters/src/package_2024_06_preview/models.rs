...
pub struct ManagedClusterProperties {
    ...
    #[doc = "If using autoGeneratedDomainNameLabelScope, this is the fully qualified domain name using SFMC's domain, pointing to the public load balancer of the cluster."]
    #[serde(rename = "customFqdn", default, skip_serializing_if = "Option::is_none")]
...
pub struct NodeTypeProperties {
    ...
    #[serde(
        rename = "vmApplications",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub vm_applications: Vec<VmApplication>,
}
...
pub struct VmApplication {
    ...
    #[serde(rename = "vmGalleryTags", default, skip_serializing_if = "Option::is_none")]
    pub vm_gallery_tags: Option<String>,
