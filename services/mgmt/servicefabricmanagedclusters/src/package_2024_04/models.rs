...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AdditionalNetworkInterfaceConfiguration {
...
impl AdditionalNetworkInterfaceConfiguration {
    pub fn new(name: String, ip_configurations: Vec<IpConfiguration>) -> Self {
        Self {
            name,
...
pub struct ClusterHealthPolicy {
    ...
    pub max_percent_unhealthy_nodes: i32,
    ...
    pub max_percent_unhealthy_applications: i32,
}
impl ClusterHealthPolicy {
    pub fn new(max_percent_unhealthy_nodes: i32, max_percent_unhealthy_applications: i32) -> Self {
        Self {
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ClusterMonitoringPolicy {
    ...
    pub health_check_wait_duration: String,
    ...
    pub health_check_stable_duration: String,
    ...
    pub health_check_retry_timeout: String,
    ...
    pub upgrade_domain_timeout: String,
}
impl ClusterMonitoringPolicy {
    pub fn new(
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ClusterUpgradeDeltaHealthPolicy {
    ...
    pub max_percent_delta_unhealthy_nodes: i32,
    ...
    pub max_percent_upgrade_domain_delta_unhealthy_nodes: Option<i32>,
    ...
    #[serde(rename = "maxPercentDeltaUnhealthyApplications", default, skip_serializing_if = "Option::is_none")]
    pub max_percent_delta_unhealthy_applications: Option<i32>,
}
impl ClusterUpgradeDeltaHealthPolicy {
    pub fn new(max_percent_delta_unhealthy_nodes: i32) -> Self {
        Self {
            max_percent_delta_unhealthy_nodes,
            max_percent_upgrade_domain_delta_unhealthy_nodes: None,
            max_percent_delta_unhealthy_applications: None,
        }
    }
}
...
pub struct ClusterUpgradePolicy {
    ...
    #[doc = "Defines a health policy used to evaluate the health of the cluster or of a cluster node.\n"]
    #[serde(rename = "healthPolicy", default, skip_serializing_if = "Option::is_none")]
    pub health_policy: Option<ClusterHealthPolicy>,
    #[doc = "Describes the delta health policies for the cluster upgrade."]
    #[serde(rename = "deltaHealthPolicy", default, skip_serializing_if = "Option::is_none")]
    pub delta_health_policy: Option<ClusterUpgradeDeltaHealthPolicy>,
    #[doc = "Describes the monitoring policies for the cluster upgrade."]
    #[serde(rename = "monitoringPolicy", default, skip_serializing_if = "Option::is_none")]
    pub monitoring_policy: Option<ClusterMonitoringPolicy>,
    ...
    #[serde(rename = "upgradeReplicaSetCheckTimeout", default, skip_serializing_if = "Option::is_none")]
    pub upgrade_replica_set_check_timeout: Option<String>,
}
impl ClusterUpgradePolicy {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct IpConfiguration {
    ...
    pub private_ip_address_version: Option<ip_configuration::PrivateIpAddressVersion>,
    ...
    pub public_ip_address_configuration: Option<ip_configuration::PublicIpAddressConfiguration>,
}
...
pub mod ip_configuration {
    ...
    impl Default for PrivateIpAddressVersion {
        fn default() -> Self {
            Self::IPv4
        }
    }
    ...
    pub struct PublicIpAddressConfiguration {
        ...
        pub public_ip_address_version: Option<public_ip_address_configuration::PublicIpAddressVersion>,
    }
    ...
    pub mod public_ip_address_configuration {
        use super::*;
        #[doc = "Specifies whether the IP configuration's public IP is IPv4 or IPv6. Default is IPv4."]
        #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
        ...
        impl Default for PublicIpAddressVersion {
            fn default() -> Self {
                Self::IPv4
            }
        }
...
pub struct ManagedClusterProperties {
    ...
    #[serde(rename = "publicIPPrefixId", default, skip_serializing_if = "Option::is_none")]
    pub public_ip_prefix_id: Option<String>,
    ...
    #[serde(rename = "publicIPv6PrefixId", default, skip_serializing_if = "Option::is_none")]
    pub public_i_pv6_prefix_id: Option<String>,
    ...
    pub upgrade_description: Option<ClusterUpgradePolicy>,
    ...
    #[serde(rename = "httpGatewayTokenAuthConnectionPort", default, skip_serializing_if = "Option::is_none")]
    pub http_gateway_token_auth_connection_port: Option<i32>,
    ...
    #[serde(rename = "enableHttpGatewayExclusiveAuthMode", default, skip_serializing_if = "Option::is_none")]
    pub enable_http_gateway_exclusive_auth_mode: Option<bool>,
}
impl ManagedClusterProperties {
    pub fn new(dns_name: String, admin_user_name: String) -> Self {
        Self {
            ...
            public_ip_prefix_id: None,
            public_i_pv6_prefix_id: None,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ManagedMaintenanceWindowStatus {
    #[doc = "If maintenance window is enabled on this cluster."]
    #[serde(rename = "isWindowEnabled", default, skip_serializing_if = "Option::is_none")]
    pub is_window_enabled: Option<bool>,
    #[doc = "Indicates if the region is ready to configure maintenance windows."]
    #[serde(rename = "isRegionReady", default, skip_serializing_if = "Option::is_none")]
    pub is_region_ready: Option<bool>,
    #[doc = "If maintenance window is active."]
    #[serde(rename = "isWindowActive", default, skip_serializing_if = "Option::is_none")]
    pub is_window_active: Option<bool>,
    #[doc = "If updates can be applied."]
    #[serde(rename = "canApplyUpdates", default, skip_serializing_if = "Option::is_none")]
...
pub struct NodeTypeProperties {
    ...
    #[serde(rename = "enableNodePublicIPv6", default, skip_serializing_if = "Option::is_none")]
    pub enable_node_public_i_pv6: Option<bool>,
    ...
    #[serde(rename = "natGatewayId", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(
        rename = "natConfigurations",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub nat_configurations: Vec<NodeTypeNatConfig>,
    #[doc = "Specifies information about the marketplace image used to create the virtual machine. This element is only used for marketplace images. Before you can use a marketplace image from an API, you must enable the image for programmatic use. In the Azure portal, find the marketplace image that you want to use and then click Want to deploy programmatically, Get Started ->. Enter any required information and then click Save."]
    #[serde(rename = "vmImagePlan", default, skip_serializing_if = "Option::is_none")]
    pub vm_image_plan: Option<VmImagePlan>,
    ...
    #[serde(rename = "serviceArtifactReferenceId", default, skip_serializing_if = "Option::is_none")]
    pub service_artifact_reference_id: Option<String>,
    #[doc = "Specifies the resource id of the DSCP configuration to apply to the node type network interface."]
    #[serde(rename = "dscpConfigurationId", default, skip_serializing_if = "Option::is_none")]
    pub dscp_configuration_id: Option<String>,
    #[doc = "Specifies the settings for any additional secondary network interfaces to attach to the node type."]
    #[serde(
        rename = "additionalNetworkInterfaceConfigurations",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub additional_network_interface_configurations: Vec<AdditionalNetworkInterfaceConfiguration>,
...
impl NodeTypeProperties {
    pub fn new(is_primary: bool, vm_instance_count: i32) -> Self {
        Self {
            ...
            enable_node_public_i_pv6: None,
            vm_shared_gallery_image_id: None,
            nat_gateway_id: None,
            nat_configurations: Vec::new(),
            vm_image_plan: None,
            service_artifact_reference_id: None,
            dscp_configuration_id: None,
            additional_network_interface_configurations: Vec::new(),
    ...
    impl Serialize for SecurityType {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Standard => serializer.serialize_unit_variant("SecurityType", 1u32, "Standard"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "RuntimeFailureAction")]
...
impl FromStr for RuntimeFailureAction {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for RuntimeFailureAction {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for RuntimeFailureAction {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Rollback => serializer.serialize_unit_variant("RuntimeFailureAction", 0u32, "Rollback"),
            Self::Manual => serializer.serialize_unit_variant("RuntimeFailureAction", 1u32, "Manual"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RuntimeResumeApplicationUpgradeParameters {
...
impl RuntimeResumeApplicationUpgradeParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "RuntimeUpgradeMode")]
pub enum RuntimeUpgradeMode {
    UnmonitoredAuto,
    UnmonitoredManual,
    Monitored,
    #[serde(skip_deserializing)]
...
impl FromStr for RuntimeUpgradeMode {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for RuntimeUpgradeMode {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for RuntimeUpgradeMode {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::UnmonitoredAuto => serializer.serialize_unit_variant("RuntimeUpgradeMode", 0u32, "UnmonitoredAuto"),
            Self::UnmonitoredManual => serializer.serialize_unit_variant("RuntimeUpgradeMode", 1u32, "UnmonitoredManual"),
            Self::Monitored => serializer.serialize_unit_variant("RuntimeUpgradeMode", 2u32, "Monitored"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
impl Default for RuntimeUpgradeMode {
    fn default() -> Self {
        Self::Monitored
    }
}
...
pub struct VmssExtensionProperties {
    ...
    pub setup_order: Vec<VmssExtensionSetupOrder>,
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "VmssExtensionSetupOrder")]
pub enum VmssExtensionSetupOrder {
    #[serde(rename = "BeforeSFRuntime")]
    BeforeSfRuntime,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for VmssExtensionSetupOrder {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for VmssExtensionSetupOrder {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for VmssExtensionSetupOrder {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::BeforeSfRuntime => serializer.serialize_unit_variant("VmssExtensionSetupOrder", 0u32, "BeforeSFRuntime"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
