...
pub mod applications {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Get the status of the latest application upgrade."]
        ...
        #[doc = "Send a request to start a rollback of the current application upgrade."]
        ...
        #[doc = "Send a request to resume the current application upgrade."]
        ...
        #[doc = "* `cluster_name`: The name of the cluster resource."]
        #[doc = "* `application_name`: The name of the application resource."]
        #[doc = "* `parameters`: The parameters for resuming an application upgrade."]
        pub fn resume_upgrade(
            ...
            cluster_name: impl Into<String>,
            application_name: impl Into<String>,
            parameters: impl Into<models::RuntimeResumeApplicationUpgradeParameters>,
        ) -> resume_upgrade::RequestBuilder {
            resume_upgrade::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod read_upgrade {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ServiceFabric/managedClusters/{}/applications/{}/fetchUpgradeStatus" , & self . subscription_id , & self . resource_group_name , & self . cluster_name , & self . application_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-04-01");
    ...
    pub mod start_rollback {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ServiceFabric/managedClusters/{}/applications/{}/startRollback" , & self . subscription_id , & self . resource_group_name , & self . cluster_name , & self . application_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-04-01");
    ...
    pub mod resume_upgrade {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) cluster_name: String,
            pub(crate) application_name: String,
            pub(crate) parameters: models::RuntimeResumeApplicationUpgradeParameters,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ServiceFabric/managedClusters/{}/applications/{}/resumeUpgrade" , & self . subscription_id , & self . resource_group_name , & self . cluster_name , & self . application_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-04-01");
