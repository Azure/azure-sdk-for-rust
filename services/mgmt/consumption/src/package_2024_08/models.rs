...
pub struct BalanceProperties {
    ...
    #[doc = "Overage Refunds"]
    #[serde(rename = "overageRefund", default, skip_serializing_if = "Option::is_none")]
    pub overage_refund: Option<f64>,
...
pub struct CreditSummaryProperties {
    ...
    #[doc = "If true, the listed details are based on an estimation and it will be subjected to change."]
    #[serde(rename = "isEstimatedBalance", default, skip_serializing_if = "Option::is_none")]
    pub is_estimated_balance: Option<bool>,
...
pub struct LegacyReservationRecommendationProperties {
    ...
    #[doc = "Term period of the reservation. ex: P1M, P1Y or P3Y."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "lastUsageDate", default, with = "azure_core::date::rfc3339::option")]
    pub last_usage_date: Option<::time::OffsetDateTime>,
    #[doc = "The total hours for which the cost is covered."]
...
pub struct OperationStatus {
    ...
    #[doc = "The properties of the price sheet download."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<PricesheetDownloadProperties>,
}
...
#[doc = "The properties of the price sheet download."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PricesheetDownloadProperties {
    #[doc = "The link (url) to download the pricesheet."]
    #[serde(rename = "downloadUrl", default, skip_serializing_if = "Option::is_none")]
    pub download_url: Option<String>,
    #[doc = "Download link validity."]
...
impl PricesheetDownloadProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
