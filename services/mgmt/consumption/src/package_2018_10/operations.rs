...
pub mod marketplaces {
    ...
    pub async fn list_for_billing_period_by_management_group(
        ...
        let client = &configuration.client;
        let uri_str = & format ! ("{}/providers/Microsoft.Management/managementGroups/{}/providers/Microsoft.Billing/billingPeriods/{}/providers/Microsoft.Consumption/marketplaces" , & configuration . base_path , management_group_id , billing_period_name) ;
        let mut req_builder = client.get(uri_str);
        if let Some(token) = &configuration.bearer_access_token {
            req_builder = req_builder.bearer_auth(token);
        }
