...
pub mod charges {
    ...
    pub async fn list(
        ...
        filter: Option<&str>,
        apply: Option<&str>,
    ) -> std::result::Result<models::ChargesListResult, list::Error> {
        let http_client = operation_config.http_client();
...
pub mod reservation_transactions {
    ...
    pub async fn list(
        ...
        filter: Option<&str>,
        billing_account_id: &str,
    ) -> std::result::Result<models::ReservationTransactionsListResult, list::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
    ...
    ) -> std::result::Result<models::ModernReservationTransactionsListResult, list_by_billing_profile::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
...
pub mod events {
    ...
    pub async fn list_by_billing_profile(
        ...
        start_date: &str,
        end_date: &str,
    ) -> std::result::Result<models::Events, list_by_billing_profile::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
    ...
    pub async fn list_by_billing_account(
        ...
        billing_account_id: &str,
        filter: Option<&str>,
    ) -> std::result::Result<models::Events, list_by_billing_account::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
...
pub mod lots {
    ...
    pub async fn list_by_billing_profile(
        ...
        billing_account_id: &str,
        billing_profile_id: &str,
    ) -> std::result::Result<models::Lots, list_by_billing_profile::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
    ...
    pub async fn list_by_billing_account(
        ...
        billing_account_id: &str,
        filter: Option<&str>,
    ) -> std::result::Result<models::Lots, list_by_billing_account::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
