...
impl Client {
    ...
    pub fn watchers_client(&self) -> watchers::Client {
        watchers::Client(self.clone())
    }
}
pub mod operations {
    use super::models;
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!("/providers/Microsoft.DatabaseWatcher/operations",));
...
pub mod watchers {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List Watcher resources by subscription ID"]
        #[doc = ""]
        #[doc = "Arguments:"]
        ...
        #[doc = "List Watcher resources by resource group"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        ...
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `watcher_name`: The database watcher name."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        pub fn create_or_update(
            ...
            resource_group_name: impl Into<String>,
            watcher_name: impl Into<String>,
            resource: impl Into<models::Watcher>,
        ...
        pub fn update(
            ...
            resource_group_name: impl Into<String>,
            watcher_name: impl Into<String>,
            properties: impl Into<models::WatcherUpdate>,
    ...
    pub mod list_by_subscription {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.DatabaseWatcher/watchers",
    ...
    pub mod list_by_resource_group {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DatabaseWatcher/watchers",
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DatabaseWatcher/watchers/{}",
                    &self.subscription_id, &self.resource_group_name, &self.watcher_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::Watcher>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::Watcher>>;
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) watcher_name: String,
            pub(crate) resource: models::Watcher,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) watcher_name: String,
            pub(crate) properties: models::WatcherUpdate,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod start {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DatabaseWatcher/watchers/{}/start",
                    &self.subscription_id, &self.resource_group_name, &self.watcher_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod stop {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DatabaseWatcher/watchers/{}/stop",
                    &self.subscription_id, &self.resource_group_name, &self.watcher_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
...
pub mod shared_private_link_resources {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List SharedPrivateLinkResource resources by Watcher"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `watcher_name`: The database watcher name."]
        pub fn list_by_watcher(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            watcher_name: impl Into<String>,
        ) -> list_by_watcher::RequestBuilder {
            list_by_watcher::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        #[doc = "Get a SharedPrivateLinkResource"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `watcher_name`: The database watcher name."]
        #[doc = "* `shared_private_link_resource_name`: The Shared Private Link resource name."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "Create a SharedPrivateLinkResource"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        pub fn create(
            ...
            watcher_name: impl Into<String>,
            shared_private_link_resource_name: impl Into<String>,
            resource: impl Into<models::SharedPrivateLinkResource>,
        ...
        #[doc = "Delete a SharedPrivateLinkResource"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod list_by_watcher {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SharedPrivateLinkResourceListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SharedPrivateLinkResourceListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::SharedPrivateLinkResourceListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DatabaseWatcher/watchers/{}/sharedPrivateLinkResources",
                    &self.subscription_id, &self.resource_group_name, &self.watcher_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DatabaseWatcher/watchers/{}/sharedPrivateLinkResources/{}",
                    &self.subscription_id, &self.resource_group_name, &self.watcher_name, &self.shared_private_link_resource_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
    ...
    pub mod create {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) watcher_name: String,
            pub(crate) shared_private_link_resource_name: String,
            pub(crate) resource: models::SharedPrivateLinkResource,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
...
pub mod targets {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List Target resources by Watcher"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `watcher_name`: The database watcher name."]
        #[doc = "* `target_name`: The target resource name."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        pub fn create_or_update(
            ...
            watcher_name: impl Into<String>,
            target_name: impl Into<String>,
            resource: impl Into<models::Target>,
        ) -> create_or_update::RequestBuilder {
            create_or_update::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
    ...
    pub mod list_by_watcher {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DatabaseWatcher/watchers/{}/targets",
                    &self.subscription_id, &self.resource_group_name, &self.watcher_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DatabaseWatcher/watchers/{}/targets/{}",
                    &self.subscription_id, &self.resource_group_name, &self.watcher_name, &self.target_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) watcher_name: String,
            pub(crate) target_name: String,
            pub(crate) resource: models::Target,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
