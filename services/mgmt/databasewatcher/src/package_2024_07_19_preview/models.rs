...
pub struct AlertRuleResource {
    ...
    pub properties: Option<AlertRuleResourceProperties>,
}
...
#[doc = "The response of a AlertRuleResource list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AlertRuleResourceListResult {
    #[doc = "The AlertRuleResource items on this page"]
    pub value: Vec<AlertRuleResource>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for AlertRuleResourceListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl AlertRuleResourceListResult {
    pub fn new(value: Vec<AlertRuleResource>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "The generic properties of the alert rule proxy resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AlertRuleResourceProperties {
    #[doc = "The resource ID of the alert rule resource."]
    #[serde(rename = "alertRuleResourceId")]
    pub alert_rule_resource_id: String,
    #[doc = "The properties with which the alert rule resource was created."]
    #[serde(rename = "createdWithProperties")]
    pub created_with_properties: AlertRuleCreationProperties,
    ...
    #[serde(rename = "alertRuleTemplateId")]
    pub alert_rule_template_id: String,
    #[doc = "The alert rule template version."]
    #[serde(rename = "alertRuleTemplateVersion")]
    pub alert_rule_template_version: String,
}
impl AlertRuleResourceProperties {
    pub fn new(
        alert_rule_resource_id: String,
        created_with_properties: AlertRuleCreationProperties,
...
pub struct WatcherProperties {
    ...
    #[serde(rename = "defaultAlertRuleIdentityResourceId", default, skip_serializing_if = "Option::is_none")]
    pub default_alert_rule_identity_resource_id: Option<String>,
}
...
#[doc = "The properties with which the alert rule resource was created."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "AlertRuleCreationProperties")]
pub enum AlertRuleCreationProperties {
    CreatedWithActionGroup,
    None,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for AlertRuleCreationProperties {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for AlertRuleCreationProperties {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for AlertRuleCreationProperties {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::CreatedWithActionGroup => {
                serializer.serialize_unit_variant("AlertRuleCreationProperties", 0u32, "CreatedWithActionGroup")
            }
            Self::None => serializer.serialize_unit_variant("AlertRuleCreationProperties", 1u32, "None"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
