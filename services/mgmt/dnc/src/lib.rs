...
pub use package_2021_03_15::{models, operations, operations::Client, operations::ClientBuilder};
...
pub use package_2020_08_08_preview::{models, operations, operations::Client, operations::ClientBuilder};
