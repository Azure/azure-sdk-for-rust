...
pub mod private_endpoint_connections {
    ...
    pub async fn list_by_environment(
        ...
        resource_group_name: &str,
        environment_name: &str,
    ) -> std::result::Result<models::PrivateEndpointConnectionListResult, list_by_environment::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.TimeSeriesInsights/environments/{}/privateEndpointConnections",
            operation_config.base_path(),
...
pub mod private_link_resources {
    ...
    pub async fn list_supported(
        ...
        resource_group_name: &str,
        environment_name: &str,
    ) -> std::result::Result<models::PrivateLinkResourceListResult, list_supported::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
