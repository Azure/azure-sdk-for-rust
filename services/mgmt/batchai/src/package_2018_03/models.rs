...
pub struct DataDisks {
    ...
    #[serde(rename = "cachingType", default, skip_serializing_if = "Option::is_none")]
...
pub struct AppInsightsReference {
    ...
    #[serde(rename = "instrumentationKeySecretReference", default, skip_serializing_if = "Option::is_none")]
...
pub struct NodeSetup {
    ...
    #[serde(rename = "performanceCountersSettings", default, skip_serializing_if = "Option::is_none")]
...
pub struct JobBaseProperties {
    ...
    #[serde(rename = "pyTorchSettings", default, skip_serializing_if = "Option::is_none")]
...
pub struct JobProperties {
    ...
    #[serde(rename = "mountVolumes", default, skip_serializing_if = "Option::is_none")]
    pub mount_volumes: Option<MountVolumes>,
    #[serde(rename = "jobOutputDirectoryPathSegment", default, skip_serializing_if = "Option::is_none")]
...
pub struct EnvironmentVariableWithSecretValue {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub value: Option<String>,
    #[serde(rename = "valueSecretReference", default, skip_serializing_if = "Option::is_none")]
...
pub struct PyTorchSettings {
    ...
    #[serde(rename = "processCount", default, skip_serializing_if = "Option::is_none")]
    pub process_count: Option<i32>,
    #[serde(rename = "communicationBackend", default, skip_serializing_if = "Option::is_none")]
...
pub struct TensorFlowSettings {
    ...
    #[serde(rename = "pythonInterpreterPath", default, skip_serializing_if = "Option::is_none")]
    pub python_interpreter_path: Option<String>,
    #[serde(rename = "masterCommandLineArgs", default, skip_serializing_if = "Option::is_none")]
