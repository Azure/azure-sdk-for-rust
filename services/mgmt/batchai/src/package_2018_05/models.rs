...
pub struct JobBaseProperties {
    #[serde(rename = "schedulingPriority", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "customMpiSettings", default, skip_serializing_if = "Option::is_none")]
    pub custom_mpi_settings: Option<CustomMpiSettings>,
    #[serde(rename = "horovodSettings", default, skip_serializing_if = "Option::is_none")]
