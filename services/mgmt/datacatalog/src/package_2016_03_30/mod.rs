    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/providers/Microsoft.DataCatalog/operations", self.client.endpoint(),))?;
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::OperationEntityListResult>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::OperationEntityListResult>>;
...
pub mod adc_catalogs {
    ...
    impl Client {
        ...
        ) -> listt_by_resource_group::RequestBuilder {
            listt_by_resource_group::RequestBuilder {
                client: self.0.clone(),
    ...
    pub mod listt_by_resource_group {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AdcCatalogsListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AdcCatalogsListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AdcCatalogsListResult>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::AdcCatalogsListResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AdcCatalog> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AdcCatalog = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AdcCatalog>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::AdcCatalog>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
