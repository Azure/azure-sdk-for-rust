...
pub struct AcceleratorGitRepository {
    ...
    #[doc = "Folder path inside the git repository to consider as the root of the accelerator or fragment."]
...
pub struct ApiPortalProperties {
    ...
    #[doc = "Indicates whether the API try-out feature is enabled or disabled. When enabled, users can try out the API by sending requests and viewing responses in API portal. When disabled, users cannot try out the API."]
    #[serde(rename = "apiTryOutEnabledState", default, skip_serializing_if = "Option::is_none")]
    pub api_try_out_enabled_state: Option<api_portal_properties::ApiTryOutEnabledState>,
}
...
pub mod api_portal_properties {
    ...
    #[doc = "Indicates whether the API try-out feature is enabled or disabled. When enabled, users can try out the API by sending requests and viewing responses in API portal. When disabled, users cannot try out the API."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ApiTryOutEnabledState")]
    pub enum ApiTryOutEnabledState {
        Enabled,
        Disabled,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for ApiTryOutEnabledState {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for ApiTryOutEnabledState {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for ApiTryOutEnabledState {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("ApiTryOutEnabledState", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("ApiTryOutEnabledState", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for ApiTryOutEnabledState {
        fn default() -> Self {
            Self::Enabled
        }
    }
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ApmProperties {
    #[doc = "APM Type"]
    #[serde(rename = "type")]
    pub type_: String,
    #[doc = "State of the APM."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<apm_properties::ProvisioningState>,
    #[doc = "Non-sensitive properties for the APM"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<serde_json::Value>,
    #[doc = "Sensitive properties for the APM"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "A reference to the APM"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ApmReference {
    #[doc = "Resource Id of the APM"]
...
pub type ApmReferenceCollection = Vec<ApmReference>;
...
#[doc = "Object that includes an array of APM resources and a possible link for next set"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ApmResourceCollection {
    #[doc = "Collection of APM resources"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<ApmResource>,
    #[doc = "URL client should use to fetch the next page (per server side paging).\r\nIt's null for now, added for future use."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ApmResourceCollection {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl ApmResourceCollection {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Keys of APM sensitive properties"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ApmSecretKeys {
    #[doc = "Collection of the keys for the APM sensitive properties"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
pub struct AppResourceProperties {
    ...
    #[doc = "The workload profile used for this app. Supported for Consumption + Dedicated plan."]
...
pub struct BuildProperties {
    ...
    #[doc = "Collection of ApmReferences"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub apms: Option<ApmReferenceCollection>,
    #[doc = "Collection of CertificateReferences"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub certificates: Option<CertificateReferenceCollection>,
...
pub struct BuildResultProperties {
    ...
    #[doc = "The container registry image of this build result."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct BuildServiceProperties {
    #[doc = "The resource id of the container registry used in this build service."]
    ...
    #[doc = "Provisioning state of the KPack build service"]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "A reference to the certificate"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CertificateReference {
    #[doc = "Resource Id of the certificate"]
    #[serde(rename = "resourceId")]
    pub resource_id: String,
}
...
pub type CertificateReferenceCollection = Vec<CertificateReference>;
#[doc = "Certificate resource payload."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct ClusterResourceProperties {
    ...
    #[serde(rename = "maintenanceScheduleConfiguration", default, skip_serializing_if = "Option::is_none")]
    pub maintenance_schedule_configuration: Option<MaintenanceScheduleConfigurationUnion>,
...
pub struct ConfigServerProperties {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub error: Option<Error>,
    #[doc = "Enabled state of the config server. This is only used in Consumption tier."]
    #[serde(rename = "enabledState", default, skip_serializing_if = "Option::is_none")]
    pub enabled_state: Option<config_server_properties::EnabledState>,
...
pub struct ConfigurationServiceGitRepository {
    ...
    #[serde(rename = "strictHostKeyChecking", default, skip_serializing_if = "Option::is_none")]
    pub strict_host_key_checking: Option<bool>,
    #[doc = "Git libraries used to support various repository providers"]
    #[serde(rename = "gitImplementation", default, skip_serializing_if = "Option::is_none")]
    pub git_implementation: Option<GitImplementation>,
    #[doc = "Resource Id of CA certificate for https URL of Git repository."]
    #[serde(rename = "caCertResourceId", default, skip_serializing_if = "Option::is_none")]
    pub ca_cert_resource_id: Option<String>,
}
...
pub struct ConfigurationServiceProperties {
    ...
    #[doc = "The generation of the Application Configuration Service."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub generation: Option<configuration_service_properties::Generation>,
...
pub mod configuration_service_properties {
    ...
    impl Serialize for Generation {
        ...
        {
            match self {
                Self::Gen1 => serializer.serialize_unit_variant("Generation", 0u32, "Gen1"),
                Self::Gen2 => serializer.serialize_unit_variant("Generation", 1u32, "Gen2"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct ContainerRegistryBasicCredentials {
    ...
    pub username: String,
    #[doc = "The password of the Container Registry."]
    pub password: String,
}
...
pub mod container_registry_properties {
    use super::*;
    #[doc = "State of the Container Registry."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ProvisioningState")]
...
#[doc = "Collection compose of container registry resources list and a possible link for next page."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ContainerRegistryResourceCollection {
    #[doc = "The container registry resources list."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<ContainerRegistryResource>,
...
#[doc = "Validation result for container registry properties"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ContainerRegistryValidateResult {
    #[doc = "Indicate if the container registry properties are valid"]
    #[serde(rename = "isValid", default, skip_serializing_if = "Option::is_none")]
    pub is_valid: Option<bool>,
...
impl ContainerRegistryValidateResult {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct CustomContainer {
    ...
    #[doc = "Language framework of the container image uploaded. Supported values: \"springboot\", \"\", null."]
...
pub struct CustomizedAcceleratorProperties {
    ...
    #[doc = "Type of the customized accelerator."]
    #[serde(rename = "acceleratorType", default, skip_serializing_if = "Option::is_none")]
    pub accelerator_type: Option<customized_accelerator_properties::AcceleratorType>,
    ...
    #[doc = "Imports references all imports that this accelerator/fragment depends upon."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
pub mod customized_accelerator_properties {
    ...
    impl Serialize for AcceleratorType {
        ...
        {
            match self {
                Self::Accelerator => serializer.serialize_unit_variant("AcceleratorType", 0u32, "Accelerator"),
                Self::Fragment => serializer.serialize_unit_variant("AcceleratorType", 1u32, "Fragment"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EurekaServerProperties {
    #[doc = "State of the eureka server."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<eureka_server_properties::ProvisioningState>,
    #[doc = "Enabled state of the eureka server. This is only used in Consumption tier."]
    #[serde(rename = "enabledState", default, skip_serializing_if = "Option::is_none")]
    pub enabled_state: Option<eureka_server_properties::EnabledState>,
    #[doc = "The error code compose of code and message."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub error: Option<Error>,
}
impl EurekaServerProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod eureka_server_properties {
    use super::*;
    #[doc = "State of the eureka server."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ProvisioningState")]
...
impl EurekaServerResource {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Object that includes an array of Eureka server resources and a possible link for next set"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EurekaServerResourceCollection {
    #[doc = "Collection of Eureka server resources"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<EurekaServerResource>,
    #[doc = "URL client should use to fetch the next page (per server side paging).\r\nIt's null for now, added for future use."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl EurekaServerResourceCollection {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct GatewayCorsProperties {
    ...
    #[doc = "Allowed origin patterns to make cross-site requests."]
    #[serde(
        rename = "allowedOriginPatterns",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
...
#[doc = "Spring Cloud Gateway local response cache per instance properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GatewayLocalResponseCachePerInstanceProperties {
    #[doc = "Maximum size of cache (10MB, 900KB, 1GB...) to determine if the cache needs to evict some entries"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub size: Option<String>,
    #[doc = "Time before a cached entry is expired (300s, 5m, 1h...)"]
    #[serde(rename = "timeToLive", default, skip_serializing_if = "Option::is_none")]
    pub time_to_live: Option<String>,
}
impl GatewayLocalResponseCachePerInstanceProperties {
    pub fn new() -> Self {
        Self {
            size: None,
            time_to_live: None,
...
#[doc = "Spring Cloud Gateway local response cache per route properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GatewayLocalResponseCachePerRouteProperties {
    #[doc = "Maximum size of cache (10MB, 900KB, 1GB...) to determine if the cache needs to evict some entries."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub size: Option<String>,
    #[doc = "Time before a cached entry is expired (300s, 5m, 1h...)"]
...
impl GatewayLocalResponseCachePerRouteProperties {
    pub fn new() -> Self {
        Self {
            size: None,
            time_to_live: None,
...
pub struct GatewayProperties {
    ...
    pub client_auth: Option<gateway_properties::ClientAuth>,
    ...
    #[doc = "Collection of addons for Spring Cloud Gateway"]
    #[serde(rename = "addonConfigs", default, skip_serializing_if = "Option::is_none")]
    pub addon_configs: Option<serde_json::Value>,
    ...
    #[doc = "Spring Cloud Gateway response cache properties."]
    #[serde(rename = "responseCacheProperties", default, skip_serializing_if = "Option::is_none")]
    pub response_cache_properties: Option<GatewayResponseCachePropertiesUnion>,
}
...
pub mod gateway_properties {
    ...
    pub struct ClientAuth {
        #[doc = "Collection of certificate resource Ids in Azure Spring Apps."]
        #[serde(
            default,
            deserialize_with = "azure_core::util::deserialize_null_as_default",
            skip_serializing_if = "Vec::is_empty"
        ...
        #[doc = "Whether to enable certificate verification or not"]
        #[serde(rename = "certificateVerification", default, skip_serializing_if = "Option::is_none")]
        pub certificate_verification: Option<client_auth::CertificateVerification>,
    }
    impl ClientAuth {
        pub fn new() -> Self {
            Self::default()
    ...
    pub mod client_auth {
        ...
        #[doc = "Whether to enable certificate verification or not"]
        #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
        #[serde(remote = "CertificateVerification")]
        ...
        impl FromStr for CertificateVerification {
            type Err = value::Error;
            fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
                Self::deserialize(s.into_deserializer())
            }
        }
        impl<'de> Deserialize<'de> for CertificateVerification {
            fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
            where
                D: Deserializer<'de>,
            {
        ...
        impl Serialize for CertificateVerification {
            fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
            where
                S: Serializer,
            {
                match self {
                    Self::Enabled => serializer.serialize_unit_variant("CertificateVerification", 0u32, "Enabled"),
                    Self::Disabled => serializer.serialize_unit_variant("CertificateVerification", 1u32, "Disabled"),
                    Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
                }
            }
        }
...
#[doc = "The type of the response cache."]
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "responseCacheType")]
pub enum GatewayResponseCachePropertiesUnion {
...
#[doc = "Git libraries used to support various repository providers"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "GitImplementation")]
pub enum GitImplementation {
    #[serde(rename = "go-git")]
    GoGit,
...
impl FromStr for GitImplementation {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for GitImplementation {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for GitImplementation {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::GoGit => serializer.serialize_unit_variant("GitImplementation", 0u32, "go-git"),
            Self::Libgit2 => serializer.serialize_unit_variant("GitImplementation", 1u32, "libgit2"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "Globally enabled APMs payload"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct GloballyEnabledApms {
    #[doc = "Collection of the globally enabled APMs"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
pub struct KeyVaultCertificateProperties {
    ...
    #[doc = "Indicates whether to automatically synchronize certificate from key vault or not."]
    #[serde(rename = "autoSync", default, skip_serializing_if = "Option::is_none")]
    pub auto_sync: Option<key_vault_certificate_properties::AutoSync>,
}
...
pub mod key_vault_certificate_properties {
    use super::*;
    #[doc = "Indicates whether to automatically synchronize certificate from key vault or not."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "AutoSync")]
    pub enum AutoSync {
        Disabled,
        Enabled,
        #[serde(skip_deserializing)]
    ...
    impl FromStr for AutoSync {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for AutoSync {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for AutoSync {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Disabled => serializer.serialize_unit_variant("AutoSync", 0u32, "Disabled"),
                Self::Enabled => serializer.serialize_unit_variant("AutoSync", 1u32, "Enabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub enum MaintenanceScheduleConfigurationUnion {
    Weekly(WeeklyMaintenanceScheduleConfiguration),
}
#[doc = "Managed identity properties retrieved from ARM request headers."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct ServiceVNetAddons {
    ...
    #[doc = "Indicates whether the data plane components(log stream, app connect, remote debugging) in vnet injection instance could be accessed from internet."]
    #[serde(rename = "dataPlanePublicEndpoint", default, skip_serializing_if = "Option::is_none")]
    pub data_plane_public_endpoint: Option<bool>,
}
...
#[doc = "Supported APM type"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SupportedApmType {
    #[doc = "The name of the supported APM type"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
impl SupportedApmType {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Supported APM types payload"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SupportedApmTypes {
    #[doc = "Collection of the supported APM type"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<SupportedApmType>,
    #[doc = "URL client should use to fetch the next page (per server side paging).\r\nIt's null for now, added for future use."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for SupportedApmTypes {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl SupportedApmTypes {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Supported server version."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SupportedServerVersion {
    #[doc = "The raw server version value which could be passed to deployment CRUD operations."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub value: Option<String>,
    #[doc = "The server name."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub server: Option<String>,
    #[doc = "The Server version."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub version: Option<String>,
}
impl SupportedServerVersion {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Supported server versions."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SupportedServerVersions {
    #[doc = "Collection of the supported server versions."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<SupportedServerVersion>,
    #[doc = "URL client should use to fetch the next page (per server side paging).\r\nIt's null for now, added for future use."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for SupportedServerVersions {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl SupportedServerVersions {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct TriggeredBuildResult {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "The provisioning state of this build result"]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<triggered_build_result::ProvisioningState>,
    #[doc = "The container image of this build result"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub image: Option<String>,
    ...
    #[doc = "The last transition status of this build result"]
    #[serde(rename = "lastTransitionStatus", default, skip_serializing_if = "Option::is_none")]
    pub last_transition_status: Option<String>,
}
...
pub mod triggered_build_result {
    use super::*;
    #[doc = "The provisioning state of this build result"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ProvisioningState")]
...
#[doc = "Uploaded War binary for a deployment"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct WarUploadedUserSourceInfo {
    #[serde(flatten)]
    pub uploaded_user_source_info: UploadedUserSourceInfo,
    #[doc = "Runtime version of the war file"]
    #[serde(rename = "runtimeVersion", default, skip_serializing_if = "Option::is_none")]
    pub runtime_version: Option<String>,
    #[doc = "JVM parameter"]
    #[serde(rename = "jvmOptions", default, skip_serializing_if = "Option::is_none")]
    pub jvm_options: Option<String>,
    #[doc = "Server version, currently only Apache Tomcat is supported"]
    #[serde(rename = "serverVersion", default, skip_serializing_if = "Option::is_none")]
    pub server_version: Option<String>,
}
impl WarUploadedUserSourceInfo {
    pub fn new(uploaded_user_source_info: UploadedUserSourceInfo) -> Self {
        Self {
            uploaded_user_source_info,
            runtime_version: None,
...
pub struct WeeklyMaintenanceScheduleConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub duration: Option<String>,
    #[doc = "The day to run the maintenance job"]
