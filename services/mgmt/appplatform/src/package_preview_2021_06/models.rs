    ...
    impl Serialize for ProvisioningState {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Moving => serializer.serialize_unit_variant("ProvisioningState", 6u32, "Moving"),
                Self::Moved => serializer.serialize_unit_variant("ProvisioningState", 7u32, "Moved"),
                Self::MoveFailed => serializer.serialize_unit_variant("ProvisioningState", 8u32, "MoveFailed"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct DeploymentSettings {
    #[doc = "Required CPU. This should be 1 for Basic tier, and in range [1, 4] for Standard tier. This is deprecated starting from API version 2021-06-01-preview. Please use the resourceRequests field to set the CPU size."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cpu: Option<i32>,
    #[doc = "Required Memory size in GB. This should be in range [1, 2] for Basic tier, and in range [1, 8] for Standard tier. This is deprecated starting from API version 2021-06-01-preview. Please use the resourceRequests field to set the the memory size."]
