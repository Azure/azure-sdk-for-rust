...
pub struct AppResourceProperties {
    ...
    #[doc = "State of test endpoint auth."]
    #[serde(rename = "testEndpointAuthState", default, skip_serializing_if = "Option::is_none")]
    pub test_endpoint_auth_state: Option<app_resource_properties::TestEndpointAuthState>,
}
...
pub mod app_resource_properties {
    ...
    #[doc = "State of test endpoint auth."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "TestEndpointAuthState")]
    pub enum TestEndpointAuthState {
        Enabled,
        Disabled,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for TestEndpointAuthState {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for TestEndpointAuthState {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for TestEndpointAuthState {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("TestEndpointAuthState", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("TestEndpointAuthState", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for TestEndpointAuthState {
        fn default() -> Self {
            Self::Enabled
        }
    }
...
#[doc = "Collection of instances belong to the Config Server, only available in Enterprise Plan."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ConfigServerInstance {
    #[doc = "Name of the Config Server instance"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Status of the Config Server instance"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
}
impl ConfigServerInstance {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ConfigServerProperties {
    ...
    #[doc = "Resource request payload of Config Server, only available in Enterprise Plan."]
    #[serde(rename = "resourceRequests", default, skip_serializing_if = "Option::is_none")]
    pub resource_requests: Option<ConfigServerResourceRequests>,
    #[doc = "Collection of instances belong to Config Server, only available in Enterprise Plan."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub instances: Vec<ConfigServerInstance>,
    #[doc = "The error code compose of code and message."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub error: Option<Error>,
    ...
    impl Serialize for ProvisioningState {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Deleted => serializer.serialize_unit_variant("ProvisioningState", 2u32, "Deleted"),
                Self::Failed => serializer.serialize_unit_variant("ProvisioningState", 3u32, "Failed"),
...
#[doc = "Object that includes an array of config server resources and a possible link for next set"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ConfigServerResourceCollection {
    #[doc = "Collection of config server resources"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<ConfigServerResource>,
    #[doc = "URL client should use to fetch the next page (per server side paging).\r\nIt's null for now, added for future use."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ConfigServerResourceCollection {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl ConfigServerResourceCollection {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Resource request payload of Config Server, only available in Enterprise Plan."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ConfigServerResourceRequests {
    #[doc = "CPU allocated to each Config Server instance"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cpu: Option<String>,
    #[doc = "Memory allocated to each Config Server instance"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub memory: Option<String>,
    #[doc = "Instance count of the Config Server"]
    #[serde(rename = "instanceCount", default, skip_serializing_if = "Option::is_none")]
    pub instance_count: Option<i32>,
}
impl ConfigServerResourceRequests {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ConfigurationServiceSettings {
    ...
    #[doc = "How often (in seconds) to check repository updates. Minimum value is 0."]
    #[serde(rename = "refreshIntervalInSeconds", default, skip_serializing_if = "Option::is_none")]
    pub refresh_interval_in_seconds: Option<i32>,
}
...
pub struct DeploymentResourceProperties {
    #[doc = "Source information for a deployment or a job"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Secret environment variable collection."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnvSecretsCollection {
    #[doc = "Collection of resources."]
    pub value: Vec<Secret>,
}
impl EnvSecretsCollection {
    pub fn new(value: Vec<Secret>) -> Self {
        Self { value }
    }
}
#[doc = "Azure Spring Apps components' environment variable."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EnvVar {
    ...
    #[doc = "secret environment variable value."]
    #[serde(rename = "secretValue", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Azure Spring Apps Job execution."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct JobExecution {
    #[doc = "Job execution Name."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Current state of the job execution"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[doc = "Job's execution template, containing configuration for an execution"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub template: Option<JobExecutionTemplate>,
    #[doc = "Job resource properties payload"]
    #[serde(rename = "jobSnapshot", default, skip_serializing_if = "Option::is_none")]
    pub job_snapshot: Option<JobResourceProperties>,
}
impl JobExecution {
    pub fn new() -> Self {
        Self::default()
    ...
    impl Serialize for Status {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Failed => serializer.serialize_unit_variant("Status", 3u32, "Failed"),
                Self::Completed => serializer.serialize_unit_variant("Status", 4u32, "Completed"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
}
#[doc = "Azure Spring App Job executions collection."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct JobExecutionCollection {
    #[doc = "Collection of Job executions."]
    pub value: Vec<JobExecution>,
    #[doc = "Link to next page of resources."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for JobExecutionCollection {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl JobExecutionCollection {
...
pub struct JobExecutionTemplate {
    #[doc = "Environment variables of Job execution"]
    #[serde(
    ...
    #[doc = "Arguments for the Job execution."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    ...
    pub args: Vec<String>,
    #[doc = "Job resource request payload"]
    #[serde(rename = "resourceRequests", default, skip_serializing_if = "Option::is_none")]
    pub resource_requests: Option<JobResourceRequests>,
}
...
pub struct JobResource {
    ...
    #[doc = "Job resource properties payload"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<JobResourceProperties>,
}
impl JobResource {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "List of Azure Spring Apps Jobs and a possible link for next set."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct JobResourceCollection {
    #[doc = "Collection of Job resources."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
impl azure_core::Continuable for JobResourceCollection {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl JobResourceCollection {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Job resource properties payload"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct JobResourceProperties {
    #[doc = "Provisioning state of the Job"]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<job_resource_properties::ProvisioningState>,
    #[doc = "Job's execution template, containing configuration for an execution"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub template: Option<JobExecutionTemplate>,
    #[doc = "Source information for a deployment or a job"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub source: Option<UserSourceInfoUnion>,
    #[doc = "Collection of managed component reference"]
    #[serde(rename = "managedComponentReferences", default, skip_serializing_if = "Option::is_none")]
    pub managed_component_references: Option<ManagedComponentReferenceCollection>,
    #[doc = "Configuration for different trigger types"]
    #[serde(rename = "triggerConfig", default, skip_serializing_if = "Option::is_none")]
    pub trigger_config: Option<JobTriggerConfigUnion>,
}
impl JobResourceProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod job_resource_properties {
    use super::*;
    #[doc = "Provisioning state of the Job"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ProvisioningState")]
...
#[doc = "Job resource request payload"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct JobResourceRequests {
    #[doc = "CPU allocated to each job execution instance."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cpu: Option<String>,
    #[doc = "Memory allocated to each job execution instance."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub memory: Option<String>,
}
impl JobResourceRequests {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Type of job trigger"]
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "triggerType")]
pub enum JobTriggerConfigUnion {
    Manual(ManualJobTriggerConfig),
}
#[doc = "Properties of certificate imported from key vault."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "A reference to the managed component like Config Server."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ManagedComponentReference {
    #[doc = "Resource Id of the managed component"]
    #[serde(rename = "resourceId")]
    pub resource_id: String,
}
impl ManagedComponentReference {
    pub fn new(resource_id: String) -> Self {
        Self { resource_id }
    }
}
pub type ManagedComponentReferenceCollection = Vec<ManagedComponentReference>;
#[doc = "Managed identity properties retrieved from ARM request headers."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "Configuration for manual triggered job"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ManualJobTriggerConfig {
    #[doc = "Number of parallel replicas of a job execution can run."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub parallelism: Option<i32>,
    #[doc = "Maximum number of seconds an execution is allowed to run."]
    ...
    #[serde(rename = "retryLimit", default, skip_serializing_if = "Option::is_none")]
    pub retry_limit: Option<i32>,
}
impl ManualJobTriggerConfig {
    pub fn new() -> Self {
        Self {
            parallelism: None,
...
pub struct ServiceVNetAddons {
    ...
    #[doc = "Indicates whether the vnet injection service enables private links for backend storage account and container registry."]
    #[serde(rename = "privateStorageAccess", default, skip_serializing_if = "Option::is_none")]
    pub private_storage_access: Option<service_v_net_addons::PrivateStorageAccess>,
    #[doc = "Fully qualified resource Id of the Private DNS zone to link with the customer virtual network."]
...
pub mod service_v_net_addons {
    use super::*;
    #[doc = "Indicates whether the vnet injection service enables private links for backend storage account and container registry."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "PrivateStorageAccess")]
    pub enum PrivateStorageAccess {
        Enabled,
        Disabled,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for PrivateStorageAccess {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for PrivateStorageAccess {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for PrivateStorageAccess {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("PrivateStorageAccess", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("PrivateStorageAccess", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct SupportedBuildpackResourceProperties {
    ...
    #[doc = "The version of supported buildpack"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub version: Option<String>,
}
    ...
    impl Serialize for Value {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Java21 => serializer.serialize_unit_variant("Value", 3u32, "Java_21"),
                Self::NetCore31 => serializer.serialize_unit_variant("Value", 4u32, "NetCore_31"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
