...
pub use schema_2019_09_07::{models, operations, operations::Client, operations::ClientBuilder};
#[cfg(feature = "schema-2019-05-15")]
pub mod schema_2019_05_15;
#[cfg(all(feature = "schema-2019-05-15", not(feature = "no-default-tag")))]
pub use schema_2019_05_15::{models, operations, operations::Client, operations::ClientBuilder};
#[cfg(feature = "schema-2019-01-21")]
pub mod schema_2019_01_21;
#[cfg(all(feature = "schema-2019-01-21", not(feature = "no-default-tag")))]
pub use schema_2019_01_21::{models, operations, operations::Client, operations::ClientBuilder};
...
pub use schema_2018_09_07_preview::{models, operations, operations::Client, operations::ClientBuilder};
...
pub use schema_2017_09_07_privatepreview::{models, operations, operations::Client, operations::ClientBuilder};
