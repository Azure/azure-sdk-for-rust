...
pub mod configurations {
    ...
    impl Client {
        ...
        #[doc = "Analyze an NGINX configuration without applying it to the NGINXaaS deployment"]
        #[doc = ""]
        #[doc = "Arguments:"]
    ...
    pub mod analysis {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AnalysisResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AnalysisResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) deployment_name: String,
            pub(crate) configuration_name: String,
            pub(crate) body: Option<models::AnalysisCreate>,
        }
        impl RequestBuilder {
            #[doc = "The NGINX configuration to analyze"]
            pub fn body(mut self, body: impl Into<models::AnalysisCreate>) -> Self {
                self.body = Some(body.into());
                self
            }
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Nginx.NginxPlus/nginxDeployments/{}/configurations/{}/analyze",
                    &self.subscription_id, &self.resource_group_name, &self.deployment_name, &self.configuration_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AnalysisResult>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::AnalysisResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod operations {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List all operations provided by Nginx.NginxPlus for the 2024-01-01-preview api version."]
