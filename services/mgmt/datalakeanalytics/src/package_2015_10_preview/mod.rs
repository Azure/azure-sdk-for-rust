...
pub mod account {
    ...
    impl Client {
        ...
        pub fn list_data_lake_store_accounts(
            ...
            resource_group_name: impl Into<String>,
            account_name: impl Into<String>,
        ) -> list_data_lake_store_accounts::RequestBuilder {
            list_data_lake_store_accounts::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        ) -> get_data_lake_store_account::RequestBuilder {
            get_data_lake_store_account::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        pub fn add_data_lake_store_account(
            ...
            account_name: impl Into<String>,
            data_lake_store_account_name: impl Into<String>,
        ) -> add_data_lake_store_account::RequestBuilder {
            add_data_lake_store_account::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        pub fn delete_data_lake_store_account(
            ...
            account_name: impl Into<String>,
            data_lake_store_account_name: impl Into<String>,
        ) -> delete_data_lake_store_account::RequestBuilder {
            delete_data_lake_store_account::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        pub fn list_storage_accounts(
            ...
            resource_group_name: impl Into<String>,
            account_name: impl Into<String>,
        ) -> list_storage_accounts::RequestBuilder {
            list_storage_accounts::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        ) -> add_storage_account::RequestBuilder {
            add_storage_account::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
