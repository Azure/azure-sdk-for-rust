...
pub struct OperationDisplay {
    #[doc = "Service provider: Microsoft.M365SecurityAndCompliance"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct OperationListResult {
    ...
    #[doc = "A list of service operations supported by the Microsoft.M365SecurityAndCompliance resource provider."]
...
impl PrivateLinkServicesForMipPolicySyncDescription {
    pub fn new(services_resource: ServicesResource) -> Self {
        Self {
            services_resource,
            properties: None,
