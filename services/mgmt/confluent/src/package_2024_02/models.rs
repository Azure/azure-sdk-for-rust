...
use std::str::FromStr;
#[doc = "API Key Owner details which can be a user or service account"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ApiKeyOwnerEntity {
    #[doc = "API Key owner id"]
    ...
    #[doc = "Type of the owner service or user account"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kind: Option<String>,
}
impl ApiKeyOwnerEntity {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "API Key Properties"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ApiKeyProperties {
    #[doc = "Metadata of the data record"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metadata: Option<ScMetadataEntity>,
    #[doc = "Spec of the API Key record"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub spec: Option<ApiKeySpecEntity>,
}
...
pub struct ApiKeyRecord {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kind: Option<String>,
    #[doc = "Id of the api key"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "API Key Properties"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ApiKeyProperties>,
}
impl ApiKeyRecord {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "API Key Resource details which can be kafka cluster or schema registry cluster"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ApiKeyResourceEntity {
    #[doc = "Id of the resource"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "The environment of the api key"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub environment: Option<String>,
    #[doc = "API URL for accessing or modifying the api key resource object "]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub related: Option<String>,
    #[doc = "CRN reference to the referred resource"]
    #[serde(rename = "resourceName", default, skip_serializing_if = "Option::is_none")]
    pub resource_name: Option<String>,
    #[doc = "Type of the owner which can be service or user account"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kind: Option<String>,
}
impl ApiKeyResourceEntity {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Spec of the API Key record"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ApiKeySpecEntity {
    #[doc = "The description of the API Key"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[doc = "API Key Resource details which can be kafka cluster or schema registry cluster"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resource: Option<ApiKeyResourceEntity>,
    #[doc = "API Key Owner details which can be a user or service account"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub owner: Option<ApiKeyOwnerEntity>,
}
impl ApiKeySpecEntity {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Create role binding request model"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AccessCreateRoleBindingRequestModel {
...
impl AccessCreateRoleBindingRequestModel {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Details of the clusters returned on successful response"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "Details of the environments returned on successful response"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AccessListEnvironmentsSuccessResponse {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metadata: Option<ConfluentListMetadata>,
    #[doc = "List of environment records"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Details of the role bindings returned on successful response"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AccessListRoleBindingsSuccessResponse {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metadata: Option<ConfluentListMetadata>,
    #[doc = "List of Role Binding records"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Details of the role binding names returned on successful response"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AccessRoleBindingNameListSuccessResponse {
    #[doc = "Type of response"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kind: Option<String>,
    #[doc = "Metadata of the list"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metadata: Option<ConfluentListMetadata>,
    #[doc = "List of role binding names"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub data: Option<RoleBindingNameList>,
}
impl AccessRoleBindingNameListSuccessResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ClusterProperties {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub spec: Option<ScClusterSpecEntity>,
...
#[doc = "Details of cluster record"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ClusterRecord {
    #[doc = "Type of cluster"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kind: Option<String>,
    #[doc = "Id of the cluster"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "Metadata of the data record"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metadata: Option<MetadataEntity>,
    #[doc = "Display name of the cluster"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Create API Key model"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CreateApiKeyModel {
    #[doc = "Name of the API Key"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Description of the API Key"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
}
impl CreateApiKeyModel {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Environment resource property"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "Details about environment name, metadata and environment id of an environment"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct GetEnvironmentsResponse {
    #[doc = "List of environments in a confluent organization"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<ScEnvironmentRecord>,
    #[doc = "URL to get the next set of environment records if there are any."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for GetEnvironmentsResponse {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl GetEnvironmentsResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Result of GET request to list clusters in the environment of a confluent organization"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ListClustersSuccessResponse {
    #[doc = "List of clusters in an environment of a confluent organization"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<ScClusterRecord>,
    #[doc = "URL to get the next set of cluster records if there are any."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ListClustersSuccessResponse {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl ListClustersSuccessResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Result of POST request to list regions supported by confluent"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ListRegionsSuccessResponse {
    #[doc = "List of regions supported by confluent"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub data: Vec<RegionRecord>,
}
impl ListRegionsSuccessResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Result of GET request to list schema registry clusters in the environment of a confluent organization"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ListSchemaRegistryClustersResponse {
    #[doc = "List of schema registry clusters in an environment of a confluent organization"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<SchemaRegistryClusterRecord>,
    #[doc = "URL to get the next set of schema registry cluster records if there are any."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ListSchemaRegistryClustersResponse {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl ListSchemaRegistryClustersResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Region Properties"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RegionProperties {
    #[doc = "Metadata of the data record"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metadata: Option<ScMetadataEntity>,
    #[doc = "Region spec details"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub spec: Option<RegionSpecEntity>,
}
...
#[doc = "Details of region record"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RegionRecord {
    #[doc = "Kind of the cluster"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kind: Option<String>,
    #[doc = "Id of the cluster"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[doc = "Region Properties"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<RegionProperties>,
}
impl RegionRecord {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "Region spec details"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RegionSpecEntity {
    #[doc = "Display Name of the region"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
...
pub type RoleBindingNameList = Vec<String>;
#[doc = "Details on principal, role name and crn pattern of a role binding"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RoleBindingRecord {
    #[doc = "The type of the resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kind: Option<String>,
    #[doc = "Id of the role binding"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "Metadata of the data record"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "The network associated with this object"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ScClusterByokEntity {
    #[doc = "ID of the referred resource"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "API URL for accessing or modifying the referred object"]
...
impl ScClusterByokEntity {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The environment or the network to which cluster belongs"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ScClusterNetworkEnvironmentEntity {
    #[doc = "ID of the referred resource"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "Environment of the referred resource"]
...
impl ScClusterNetworkEnvironmentEntity {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Spec of the cluster record"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ScClusterSpecEntity {
    #[doc = "The name of the cluster"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "The availability zone configuration of the cluster"]
    ...
    pub region: Option<String>,
    #[doc = "The bootstrap endpoint used by Kafka clients to connect to the cluster"]
    #[serde(rename = "kafkaBootstrapEndpoint", default, skip_serializing_if = "Option::is_none")]
    pub kafka_bootstrap_endpoint: Option<String>,
    #[doc = "The cluster HTTP request URL."]
    #[serde(rename = "httpEndpoint", default, skip_serializing_if = "Option::is_none")]
    pub http_endpoint: Option<String>,
    #[doc = "The Kafka API cluster endpoint"]
    ...
    #[doc = "The environment or the network to which cluster belongs"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub environment: Option<ScClusterNetworkEnvironmentEntity>,
    #[doc = "The environment or the network to which cluster belongs"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub network: Option<ScClusterNetworkEnvironmentEntity>,
    #[doc = "The network associated with this object"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub byok: Option<ScClusterByokEntity>,
}
impl ScClusterSpecEntity {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Metadata of the list"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ScConfluentListMetadata {
    #[doc = "First page of the list"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub first: Option<String>,
    #[doc = "Last page of the list"]
...
#[doc = "Details about environment name, metadata and environment id of an environment"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ScEnvironmentRecord {
    #[doc = "Type of environment"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kind: Option<String>,
    #[doc = "Id of the environment"]
    ...
    #[doc = "Display name of the environment"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
impl ScEnvironmentRecord {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "The environment associated with this object"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SchemaRegistryClusterEnvironmentRegionEntity {
    #[doc = "ID of the referred resource"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "API URL for accessing or modifying the referred object"]
...
impl SchemaRegistryClusterEnvironmentRegionEntity {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Schema Registry Cluster Properties"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SchemaRegistryClusterProperties {
    #[doc = "Metadata of the data record"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metadata: Option<ScMetadataEntity>,
    #[doc = "Details of schema registry cluster spec"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub spec: Option<SchemaRegistryClusterSpecEntity>,
    #[doc = "Status of the schema registry cluster record"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<SchemaRegistryClusterStatusEntity>,
}
impl SchemaRegistryClusterProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Details of schema registry cluster record"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SchemaRegistryClusterRecord {
    #[doc = "Kind of the cluster"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kind: Option<String>,
    #[doc = "Id of the cluster"]
    ...
    #[doc = "Schema Registry Cluster Properties"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<SchemaRegistryClusterProperties>,
}
impl SchemaRegistryClusterRecord {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Details of schema registry cluster spec"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SchemaRegistryClusterSpecEntity {
    #[doc = "Name of the schema registry cluster"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Http endpoint of the cluster"]
    #[serde(rename = "httpEndpoint", default, skip_serializing_if = "Option::is_none")]
    pub http_endpoint: Option<String>,
    #[doc = "Type of the cluster package Advanced, essentials"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub package: Option<String>,
    #[doc = "The environment associated with this object"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub region: Option<SchemaRegistryClusterEnvironmentRegionEntity>,
    #[doc = "The environment associated with this object"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub environment: Option<SchemaRegistryClusterEnvironmentRegionEntity>,
    #[doc = "The cloud service provider "]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cloud: Option<String>,
}
impl SchemaRegistryClusterSpecEntity {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Status of the schema registry cluster record"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SchemaRegistryClusterStatusEntity {
    #[doc = "The lifecycle phase of the cluster"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub phase: Option<String>,
}
impl SchemaRegistryClusterStatusEntity {
    pub fn new() -> Self {
        Self::default()
    }
}
