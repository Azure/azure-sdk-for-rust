...
pub mod services {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::DeviceService>> {
    ...
    pub mod check_device_service_name_availability {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::DeviceServiceNameAvailabilityInfo>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
