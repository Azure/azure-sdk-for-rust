...
pub mod database_properties {
    ...
    impl Serialize for CreateMode {
        ...
        {
            match self {
                Self::Copy => serializer.serialize_unit_variant("CreateMode", 0u32, "Copy"),
                Self::Default => serializer.serialize_unit_variant("CreateMode", 1u32, "Default"),
                Self::NonReadableSecondary => serializer.serialize_unit_variant("CreateMode", 2u32, "NonReadableSecondary"),
                Self::OnlineSecondary => serializer.serialize_unit_variant("CreateMode", 3u32, "OnlineSecondary"),
                Self::PointInTimeRestore => serializer.serialize_unit_variant("CreateMode", 4u32, "PointInTimeRestore"),
                Self::Recovery => serializer.serialize_unit_variant("CreateMode", 5u32, "Recovery"),
                Self::Restore => serializer.serialize_unit_variant("CreateMode", 6u32, "Restore"),
                Self::RestoreLongTermRetentionBackup => {
                    serializer.serialize_unit_variant("CreateMode", 7u32, "RestoreLongTermRetentionBackup")
                }
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    ...
    impl Serialize for Edition {
        ...
        {
            match self {
                Self::Web => serializer.serialize_unit_variant("Edition", 0u32, "Web"),
                Self::Business => serializer.serialize_unit_variant("Edition", 1u32, "Business"),
                Self::Basic => serializer.serialize_unit_variant("Edition", 2u32, "Basic"),
                Self::Standard => serializer.serialize_unit_variant("Edition", 3u32, "Standard"),
                Self::Premium => serializer.serialize_unit_variant("Edition", 4u32, "Premium"),
                Self::PremiumRs => serializer.serialize_unit_variant("Edition", 5u32, "PremiumRS"),
                Self::Free => serializer.serialize_unit_variant("Edition", 6u32, "Free"),
                Self::Stretch => serializer.serialize_unit_variant("Edition", 7u32, "Stretch"),
                Self::DataWarehouse => serializer.serialize_unit_variant("Edition", 8u32, "DataWarehouse"),
                Self::System => serializer.serialize_unit_variant("Edition", 9u32, "System"),
                Self::System2 => serializer.serialize_unit_variant("Edition", 10u32, "System2"),
                Self::GeneralPurpose => serializer.serialize_unit_variant("Edition", 11u32, "GeneralPurpose"),
                Self::BusinessCritical => serializer.serialize_unit_variant("Edition", 12u32, "BusinessCritical"),
                Self::Hyperscale => serializer.serialize_unit_variant("Edition", 13u32, "Hyperscale"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    #[doc = "The name of the configured service level objective of the database. This is the service level objective that is in the process of being applied to the database. Once successfully updated, it will match the value of serviceLevelObjective property. \r\n\r\nThe list of SKUs may vary by region and support offer. To determine the SKUs (including the SKU name, tier/edition, family, and capacity) that are available to your subscription in an Azure region, use the `Capabilities_ListByLocation` REST API or one of the following commands:\r\n\r\n```azurecli\r\naz sql db list-editions -l <location> -o table\r\n````\r\n\r\n```powershell\r\nGet-AzSqlServerServiceObjective -Location <location>\r\n````\r\n"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "RequestedServiceObjectiveName")]
    ...
    impl FromStr for RequestedServiceObjectiveName {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for RequestedServiceObjectiveName {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for RequestedServiceObjectiveName {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::System => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 0u32, "System"),
                Self::System0 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 1u32, "System0"),
                Self::System1 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 2u32, "System1"),
                Self::System2 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 3u32, "System2"),
                Self::System3 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 4u32, "System3"),
                Self::System4 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 5u32, "System4"),
                Self::System2L => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 6u32, "System2L"),
                Self::System3L => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 7u32, "System3L"),
                Self::System4L => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 8u32, "System4L"),
                Self::Free => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 9u32, "Free"),
                Self::Basic => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 10u32, "Basic"),
                Self::S0 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 11u32, "S0"),
                Self::S1 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 12u32, "S1"),
                Self::S2 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 13u32, "S2"),
                Self::S3 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 14u32, "S3"),
                Self::S4 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 15u32, "S4"),
                Self::S6 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 16u32, "S6"),
                Self::S7 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 17u32, "S7"),
                Self::S9 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 18u32, "S9"),
                Self::S12 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 19u32, "S12"),
                Self::P1 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 20u32, "P1"),
                Self::P2 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 21u32, "P2"),
                Self::P3 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 22u32, "P3"),
                Self::P4 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 23u32, "P4"),
                Self::P6 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 24u32, "P6"),
                Self::P11 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 25u32, "P11"),
                Self::P15 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 26u32, "P15"),
                Self::Prs1 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 27u32, "PRS1"),
                Self::Prs2 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 28u32, "PRS2"),
                Self::Prs4 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 29u32, "PRS4"),
                Self::Prs6 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 30u32, "PRS6"),
                Self::Dw100 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 31u32, "DW100"),
                Self::Dw200 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 32u32, "DW200"),
                Self::Dw300 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 33u32, "DW300"),
                Self::Dw400 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 34u32, "DW400"),
                Self::Dw500 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 35u32, "DW500"),
                Self::Dw600 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 36u32, "DW600"),
                Self::Dw1000 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 37u32, "DW1000"),
                Self::Dw1200 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 38u32, "DW1200"),
                Self::Dw1000c => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 39u32, "DW1000c"),
                Self::Dw1500 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 40u32, "DW1500"),
                Self::Dw1500c => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 41u32, "DW1500c"),
                Self::Dw2000 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 42u32, "DW2000"),
                Self::Dw2000c => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 43u32, "DW2000c"),
                Self::Dw3000 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 44u32, "DW3000"),
                Self::Dw2500c => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 45u32, "DW2500c"),
                Self::Dw3000c => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 46u32, "DW3000c"),
                Self::Dw6000 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 47u32, "DW6000"),
                Self::Dw5000c => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 48u32, "DW5000c"),
                Self::Dw6000c => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 49u32, "DW6000c"),
                Self::Dw7500c => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 50u32, "DW7500c"),
                Self::Dw10000c => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 51u32, "DW10000c"),
                Self::Dw15000c => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 52u32, "DW15000c"),
                Self::Dw30000c => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 53u32, "DW30000c"),
                Self::Ds100 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 54u32, "DS100"),
                Self::Ds200 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 55u32, "DS200"),
                Self::Ds300 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 56u32, "DS300"),
                Self::Ds400 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 57u32, "DS400"),
                Self::Ds500 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 58u32, "DS500"),
                Self::Ds600 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 59u32, "DS600"),
                Self::Ds1000 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 60u32, "DS1000"),
                Self::Ds1200 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 61u32, "DS1200"),
                Self::Ds1500 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 62u32, "DS1500"),
                Self::Ds2000 => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 63u32, "DS2000"),
                Self::ElasticPool => serializer.serialize_unit_variant("RequestedServiceObjectiveName", 64u32, "ElasticPool"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub mod elastic_pool_properties {
    ...
    impl Serialize for Edition {
        ...
        {
            match self {
                Self::Basic => serializer.serialize_unit_variant("Edition", 0u32, "Basic"),
                Self::Standard => serializer.serialize_unit_variant("Edition", 1u32, "Standard"),
                Self::Premium => serializer.serialize_unit_variant("Edition", 2u32, "Premium"),
                Self::GeneralPurpose => serializer.serialize_unit_variant("Edition", 3u32, "GeneralPurpose"),
                Self::BusinessCritical => serializer.serialize_unit_variant("Edition", 4u32, "BusinessCritical"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub mod import_request {
    ...
    #[doc = "The name of the service objective to assign to the database."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ServiceObjectiveName")]
    ...
    impl FromStr for ServiceObjectiveName {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for ServiceObjectiveName {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for ServiceObjectiveName {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::System => serializer.serialize_unit_variant("ServiceObjectiveName", 0u32, "System"),
                Self::System0 => serializer.serialize_unit_variant("ServiceObjectiveName", 1u32, "System0"),
                Self::System1 => serializer.serialize_unit_variant("ServiceObjectiveName", 2u32, "System1"),
                Self::System2 => serializer.serialize_unit_variant("ServiceObjectiveName", 3u32, "System2"),
                Self::System3 => serializer.serialize_unit_variant("ServiceObjectiveName", 4u32, "System3"),
                Self::System4 => serializer.serialize_unit_variant("ServiceObjectiveName", 5u32, "System4"),
                Self::System2L => serializer.serialize_unit_variant("ServiceObjectiveName", 6u32, "System2L"),
                Self::System3L => serializer.serialize_unit_variant("ServiceObjectiveName", 7u32, "System3L"),
                Self::System4L => serializer.serialize_unit_variant("ServiceObjectiveName", 8u32, "System4L"),
                Self::Free => serializer.serialize_unit_variant("ServiceObjectiveName", 9u32, "Free"),
                Self::Basic => serializer.serialize_unit_variant("ServiceObjectiveName", 10u32, "Basic"),
                Self::S0 => serializer.serialize_unit_variant("ServiceObjectiveName", 11u32, "S0"),
                Self::S1 => serializer.serialize_unit_variant("ServiceObjectiveName", 12u32, "S1"),
                Self::S2 => serializer.serialize_unit_variant("ServiceObjectiveName", 13u32, "S2"),
                Self::S3 => serializer.serialize_unit_variant("ServiceObjectiveName", 14u32, "S3"),
                Self::S4 => serializer.serialize_unit_variant("ServiceObjectiveName", 15u32, "S4"),
                Self::S6 => serializer.serialize_unit_variant("ServiceObjectiveName", 16u32, "S6"),
                Self::S7 => serializer.serialize_unit_variant("ServiceObjectiveName", 17u32, "S7"),
                Self::S9 => serializer.serialize_unit_variant("ServiceObjectiveName", 18u32, "S9"),
                Self::S12 => serializer.serialize_unit_variant("ServiceObjectiveName", 19u32, "S12"),
                Self::P1 => serializer.serialize_unit_variant("ServiceObjectiveName", 20u32, "P1"),
                Self::P2 => serializer.serialize_unit_variant("ServiceObjectiveName", 21u32, "P2"),
                Self::P3 => serializer.serialize_unit_variant("ServiceObjectiveName", 22u32, "P3"),
                Self::P4 => serializer.serialize_unit_variant("ServiceObjectiveName", 23u32, "P4"),
                Self::P6 => serializer.serialize_unit_variant("ServiceObjectiveName", 24u32, "P6"),
                Self::P11 => serializer.serialize_unit_variant("ServiceObjectiveName", 25u32, "P11"),
                Self::P15 => serializer.serialize_unit_variant("ServiceObjectiveName", 26u32, "P15"),
                Self::Prs1 => serializer.serialize_unit_variant("ServiceObjectiveName", 27u32, "PRS1"),
                Self::Prs2 => serializer.serialize_unit_variant("ServiceObjectiveName", 28u32, "PRS2"),
                Self::Prs4 => serializer.serialize_unit_variant("ServiceObjectiveName", 29u32, "PRS4"),
                Self::Prs6 => serializer.serialize_unit_variant("ServiceObjectiveName", 30u32, "PRS6"),
                Self::Dw100 => serializer.serialize_unit_variant("ServiceObjectiveName", 31u32, "DW100"),
                Self::Dw200 => serializer.serialize_unit_variant("ServiceObjectiveName", 32u32, "DW200"),
                Self::Dw300 => serializer.serialize_unit_variant("ServiceObjectiveName", 33u32, "DW300"),
                Self::Dw400 => serializer.serialize_unit_variant("ServiceObjectiveName", 34u32, "DW400"),
                Self::Dw500 => serializer.serialize_unit_variant("ServiceObjectiveName", 35u32, "DW500"),
                Self::Dw600 => serializer.serialize_unit_variant("ServiceObjectiveName", 36u32, "DW600"),
                Self::Dw1000 => serializer.serialize_unit_variant("ServiceObjectiveName", 37u32, "DW1000"),
                Self::Dw1200 => serializer.serialize_unit_variant("ServiceObjectiveName", 38u32, "DW1200"),
                Self::Dw1000c => serializer.serialize_unit_variant("ServiceObjectiveName", 39u32, "DW1000c"),
                Self::Dw1500 => serializer.serialize_unit_variant("ServiceObjectiveName", 40u32, "DW1500"),
                Self::Dw1500c => serializer.serialize_unit_variant("ServiceObjectiveName", 41u32, "DW1500c"),
                Self::Dw2000 => serializer.serialize_unit_variant("ServiceObjectiveName", 42u32, "DW2000"),
                Self::Dw2000c => serializer.serialize_unit_variant("ServiceObjectiveName", 43u32, "DW2000c"),
                Self::Dw3000 => serializer.serialize_unit_variant("ServiceObjectiveName", 44u32, "DW3000"),
                Self::Dw2500c => serializer.serialize_unit_variant("ServiceObjectiveName", 45u32, "DW2500c"),
                Self::Dw3000c => serializer.serialize_unit_variant("ServiceObjectiveName", 46u32, "DW3000c"),
                Self::Dw6000 => serializer.serialize_unit_variant("ServiceObjectiveName", 47u32, "DW6000"),
                Self::Dw5000c => serializer.serialize_unit_variant("ServiceObjectiveName", 48u32, "DW5000c"),
                Self::Dw6000c => serializer.serialize_unit_variant("ServiceObjectiveName", 49u32, "DW6000c"),
                Self::Dw7500c => serializer.serialize_unit_variant("ServiceObjectiveName", 50u32, "DW7500c"),
                Self::Dw10000c => serializer.serialize_unit_variant("ServiceObjectiveName", 51u32, "DW10000c"),
                Self::Dw15000c => serializer.serialize_unit_variant("ServiceObjectiveName", 52u32, "DW15000c"),
                Self::Dw30000c => serializer.serialize_unit_variant("ServiceObjectiveName", 53u32, "DW30000c"),
                Self::Ds100 => serializer.serialize_unit_variant("ServiceObjectiveName", 54u32, "DS100"),
                Self::Ds200 => serializer.serialize_unit_variant("ServiceObjectiveName", 55u32, "DS200"),
                Self::Ds300 => serializer.serialize_unit_variant("ServiceObjectiveName", 56u32, "DS300"),
                Self::Ds400 => serializer.serialize_unit_variant("ServiceObjectiveName", 57u32, "DS400"),
                Self::Ds500 => serializer.serialize_unit_variant("ServiceObjectiveName", 58u32, "DS500"),
                Self::Ds600 => serializer.serialize_unit_variant("ServiceObjectiveName", 59u32, "DS600"),
                Self::Ds1000 => serializer.serialize_unit_variant("ServiceObjectiveName", 60u32, "DS1000"),
                Self::Ds1200 => serializer.serialize_unit_variant("ServiceObjectiveName", 61u32, "DS1200"),
                Self::Ds1500 => serializer.serialize_unit_variant("ServiceObjectiveName", 62u32, "DS1500"),
                Self::Ds2000 => serializer.serialize_unit_variant("ServiceObjectiveName", 63u32, "DS2000"),
                Self::ElasticPool => serializer.serialize_unit_variant("ServiceObjectiveName", 64u32, "ElasticPool"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
