...
pub struct ManagedDatabaseRestoreDetailsBackupSetProperties {
    ...
    #[serde(rename = "restoreStartedTimestampUtc", default, skip_serializing_if = "Option::is_none")]
    pub restore_started_timestamp_utc: Option<String>,
    #[doc = "Last restored file time."]
    #[serde(rename = "restoreFinishedTimestampUtc", default, skip_serializing_if = "Option::is_none")]
    pub restore_finished_timestamp_utc: Option<String>,
}
