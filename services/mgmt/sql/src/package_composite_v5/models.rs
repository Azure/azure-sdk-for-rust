...
pub struct ExtendedServerBlobAuditingPolicyProperties {
    #[serde(rename = "isDevopsAuditEnabled", skip_serializing_if = "Option::is_none")]
...
pub struct AdvisorProperties {
    #[serde(rename = "advisorStatus", skip_serializing)]
...
pub struct RecommendedActionProperties {
    #[serde(rename = "recommendationReason", skip_serializing)]
    pub recommendation_reason: Option<String>,
    #[serde(rename = "validSince", skip_serializing)]
    pub valid_since: Option<String>,
    #[serde(rename = "lastRefresh", skip_serializing)]
    pub last_refresh: Option<String>,
    pub state: RecommendedActionStateInfo,
    #[serde(rename = "isExecutableAction", skip_serializing)]
    pub is_executable_action: Option<bool>,
    #[serde(rename = "isRevertableAction", skip_serializing)]
    pub is_revertable_action: Option<bool>,
    #[serde(rename = "isArchivedAction", skip_serializing)]
    pub is_archived_action: Option<bool>,
    #[serde(rename = "executeActionStartTime", skip_serializing)]
    pub execute_action_start_time: Option<String>,
    #[serde(rename = "executeActionDuration", skip_serializing)]
    pub execute_action_duration: Option<String>,
    #[serde(rename = "revertActionStartTime", skip_serializing)]
    pub revert_action_start_time: Option<String>,
    #[serde(rename = "revertActionDuration", skip_serializing)]
    pub revert_action_duration: Option<String>,
    #[serde(rename = "executeActionInitiatedBy", skip_serializing)]
    pub execute_action_initiated_by: Option<recommended_action_properties::ExecuteActionInitiatedBy>,
    #[serde(rename = "executeActionInitiatedTime", skip_serializing)]
    pub execute_action_initiated_time: Option<String>,
    #[serde(rename = "revertActionInitiatedBy", skip_serializing)]
    pub revert_action_initiated_by: Option<recommended_action_properties::RevertActionInitiatedBy>,
    #[serde(rename = "revertActionInitiatedTime", skip_serializing)]
    ...
    #[serde(rename = "observedImpact", skip_serializing)]
    pub observed_impact: Vec<RecommendedActionImpactRecord>,
    #[serde(rename = "timeSeries", skip_serializing)]
    pub time_series: Vec<RecommendedActionMetricInfo>,
    #[serde(rename = "linkedObjects", skip_serializing)]
...
pub struct RecommendedActionStateInfo {
    ...
    #[serde(rename = "actionInitiatedBy", skip_serializing)]
...
pub struct RecommendedActionErrorInfo {
    ...
    #[serde(rename = "isRetryable", skip_serializing)]
...
pub struct RecommendedActionImpactRecord {
    #[serde(rename = "dimensionName", skip_serializing)]
    pub dimension_name: Option<String>,
    #[serde(skip_serializing)]
    pub unit: Option<String>,
    #[serde(rename = "absoluteValue", skip_serializing)]
...
pub struct RecommendedActionMetricInfo {
    #[serde(rename = "metricName", skip_serializing)]
...
pub struct DatabaseColumnProperties {
    ...
    #[serde(rename = "temporalType", skip_serializing_if = "Option::is_none")]
    pub temporal_type: Option<database_column_properties::TemporalType>,
    #[serde(rename = "memoryOptimized", skip_serializing_if = "Option::is_none")]
    pub memory_optimized: Option<bool>,
    #[serde(rename = "isComputed", skip_serializing_if = "Option::is_none")]
...
pub struct DeletedServerProperties {
    ...
    #[serde(rename = "originalId", skip_serializing)]
...
pub struct EncryptionProtectorProperties {
    ...
    #[serde(rename = "autoRotationEnabled", skip_serializing_if = "Option::is_none")]
...
pub struct MaintenanceWindowOptionsProperties {
    #[serde(rename = "isEnabled", skip_serializing_if = "Option::is_none")]
    pub is_enabled: Option<bool>,
    #[serde(rename = "maintenanceWindowCycles", skip_serializing_if = "Vec::is_empty")]
    pub maintenance_window_cycles: Vec<MaintenanceWindowTimeRange>,
    #[serde(rename = "minDurationInMinutes", skip_serializing_if = "Option::is_none")]
    pub min_duration_in_minutes: Option<i32>,
    #[serde(rename = "defaultDurationInMinutes", skip_serializing_if = "Option::is_none")]
    pub default_duration_in_minutes: Option<i32>,
    #[serde(rename = "minCycles", skip_serializing_if = "Option::is_none")]
    pub min_cycles: Option<i32>,
    #[serde(rename = "timeGranularityInMinutes", skip_serializing_if = "Option::is_none")]
    pub time_granularity_in_minutes: Option<i32>,
    #[serde(rename = "allowMultipleMaintenanceWindowsPerCycle", skip_serializing_if = "Option::is_none")]
...
pub struct SecurityEventsFilterParameters {
    ...
    #[serde(rename = "showServerRecords", skip_serializing_if = "Option::is_none")]
...
pub struct SecurityEventProperties {
    #[serde(rename = "eventTime", skip_serializing)]
    pub event_time: Option<String>,
    #[serde(rename = "securityEventType", skip_serializing)]
    ...
    #[serde(rename = "clientIp", skip_serializing)]
    pub client_ip: Option<String>,
    #[serde(rename = "applicationName", skip_serializing)]
    pub application_name: Option<String>,
    #[serde(rename = "principalName", skip_serializing)]
    pub principal_name: Option<String>,
    #[serde(rename = "securityEventSqlInjectionAdditionalProperties", skip_serializing_if = "Option::is_none")]
...
pub struct SecurityEventSqlInjectionAdditionalProperties {
    #[serde(rename = "threatId", skip_serializing)]
    pub threat_id: Option<String>,
    #[serde(skip_serializing)]
    pub statement: Option<String>,
    #[serde(rename = "statementHighlightOffset", skip_serializing)]
    pub statement_highlight_offset: Option<i32>,
    #[serde(rename = "statementHighlightLength", skip_serializing)]
...
pub struct SensitivityLabelProperties {
    #[serde(rename = "schemaName", skip_serializing)]
    pub schema_name: Option<String>,
    #[serde(rename = "tableName", skip_serializing)]
    pub table_name: Option<String>,
    #[serde(rename = "columnName", skip_serializing)]
...
pub struct SensitivityLabelUpdateProperties {
    ...
    pub table: String,
    pub column: String,
    #[serde(rename = "sensitivityLabel", skip_serializing_if = "Option::is_none")]
...
pub struct ManagedInstanceKeyProperties {
    ...
    #[serde(rename = "creationDate", skip_serializing)]
    pub creation_date: Option<String>,
    #[serde(rename = "autoRotationEnabled", skip_serializing)]
    pub auto_rotation_enabled: Option<bool>,
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ResourceIdentityWithUserAssignedIdentities {
    #[serde(rename = "userAssignedIdentities", skip_serializing_if = "Option::is_none")]
    pub user_assigned_identities: Option<serde_json::Value>,
    #[serde(rename = "principalId", skip_serializing)]
    pub principal_id: Option<String>,
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub type_: Option<resource_identity_with_user_assigned_identities::Type>,
    #[serde(rename = "tenantId", skip_serializing)]
    pub tenant_id: Option<String>,
}
pub mod resource_identity_with_user_assigned_identities {
    use super::*;
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum Type {
        None,
...
pub struct ManagedInstanceProperties {
    ...
    #[serde(rename = "zoneRedundant", skip_serializing_if = "Option::is_none")]
    pub zone_redundant: Option<bool>,
    #[serde(rename = "primaryUserAssignedIdentityId", skip_serializing_if = "Option::is_none")]
...
pub struct ManagedInstanceExternalAdministrator {
    ...
    #[serde(rename = "tenantId", skip_serializing_if = "Option::is_none")]
    pub tenant_id: Option<String>,
    #[serde(rename = "azureADOnlyAuthentication", skip_serializing_if = "Option::is_none")]
...
pub struct ManagedInstance {
    ...
    pub tracked_resource: TrackedResource,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub identity: Option<ResourceIdentityWithUserAssignedIdentities>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sku: Option<Sku>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ReplicationLinksListResult {
    #[serde(skip_serializing)]
...
pub struct RestorableDroppedDatabaseProperties {
    ...
    pub max_size_bytes: Option<i64>,
    #[serde(rename = "elasticPoolId", skip_serializing)]
    pub elastic_pool_id: Option<String>,
    #[serde(rename = "creationDate", skip_serializing)]
    pub creation_date: Option<String>,
...
pub struct ServerProperties {
    ...
    #[serde(rename = "workspaceFeature", skip_serializing)]
...
pub struct SyncGroupProperties {
    ...
    #[serde(rename = "enableConflictLogging", skip_serializing_if = "Option::is_none")]
    pub enable_conflict_logging: Option<bool>,
    #[serde(rename = "conflictLoggingRetentionInDays", skip_serializing_if = "Option::is_none")]
...
pub struct TimeZoneProperties {
    #[serde(rename = "timeZoneId", skip_serializing)]
