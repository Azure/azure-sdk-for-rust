...
#[cfg(feature = "package-composite-v5")]
pub use package_composite_v5::{models, operations, API_VERSION};
#[cfg(feature = "package-composite-v4")]
mod package_composite_v4;
#[cfg(feature = "package-composite-v4")]
pub use package_composite_v4::{models, operations, API_VERSION};
...
#[cfg(feature = "package-2017-03-preview")]
pub use package_2017_03_preview::{models, operations, API_VERSION};
