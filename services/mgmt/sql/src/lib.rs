...
pub use package_composite_v5::{models, operations, operations::Client, operations::ClientBuilder};
...
pub use package_composite_v4::{models, operations, operations::Client, operations::ClientBuilder};
