...
impl AdministratorProperties {
    pub fn new(login: String, sid: String) -> Self {
        Self {
...
pub struct DatabaseExtensionsProperties {
    ...
    #[doc = "Storage key type: StorageAccessKey, SharedAccessKey or ManagedIdentity."]
    #[serde(rename = "storageKeyType")]
    pub storage_key_type: database_extensions_properties::StorageKeyType,
    #[doc = "Storage key for the storage account. If StorageKeyType is ManagedIdentity, this field should specify the Managed Identity's resource ID."]
    #[serde(rename = "storageKey")]
    pub storage_key: String,
    #[doc = "Storage Uri for the storage account."]
    #[serde(rename = "storageUri")]
    pub storage_uri: String,
    #[doc = "Administrator login name. If AuthenticationType is ManagedIdentity, this field should specify the Managed Identity's resource ID."]
    #[serde(rename = "administratorLogin", default, skip_serializing_if = "Option::is_none")]
    pub administrator_login: Option<String>,
    #[doc = "Administrator login password. If AuthenticationType is ManagedIdentity, this field should not be specified."]
    ...
    #[doc = "Authentication type used to access the SQL: Sql, ADPassword or ManagedIdentity."]
    ...
    impl Serialize for StorageKeyType {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::ManagedIdentity => serializer.serialize_unit_variant("StorageKeyType", 2u32, "ManagedIdentity"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct ExportDatabaseDefinition {
    ...
    #[serde(rename = "administratorLoginPassword", default, skip_serializing_if = "Option::is_none")]
    pub administrator_login_password: Option<String>,
    #[doc = "Type of credentials provided for access to the target SQL server: SQL, ADPassword or ManagedIdentity."]
    #[serde(rename = "authenticationType", default, skip_serializing_if = "Option::is_none")]
    pub authentication_type: Option<String>,
    #[doc = "Contains the ARM resources for which to create private endpoint connection."]
    #[serde(rename = "networkIsolation", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "A instance pool operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct InstancePoolOperation {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "The properties of a instance pool operation."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<InstancePoolOperationProperties>,
}
impl InstancePoolOperation {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The response to a list instance pool operations request"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct InstancePoolOperationListResult {
    #[doc = "Array of results."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub value: Vec<InstancePoolOperation>,
    #[doc = "Link to retrieve next page of results."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for InstancePoolOperationListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl InstancePoolOperationListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The properties of a instance pool operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct InstancePoolOperationProperties {
    #[doc = "The name of the instance pool the operation is being performed on."]
    #[serde(rename = "instancePoolName", default, skip_serializing_if = "Option::is_none")]
    ...
    #[doc = "The operation state."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<instance_pool_operation_properties::State>,
    #[doc = "The operation error code."]
    #[serde(rename = "errorCode", default, skip_serializing_if = "Option::is_none")]
    pub error_code: Option<i32>,
    #[doc = "The operation error description."]
    ...
    #[serde(rename = "errorSeverity", default, skip_serializing_if = "Option::is_none")]
    pub error_severity: Option<i32>,
    #[doc = "Error type (e.g. None, User)."]
    #[serde(rename = "errorType", default, skip_serializing_if = "Option::is_none")]
    pub error_type: Option<instance_pool_operation_properties::ErrorType>,
    #[doc = "The estimated completion time of the operation."]
    #[serde(rename = "estimatedCompletionTime", default, with = "azure_core::date::rfc3339::option")]
    pub estimated_completion_time: Option<::time::OffsetDateTime>,
    #[doc = "The operation description."]
...
impl InstancePoolOperationProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod instance_pool_operation_properties {
    use super::*;
    #[doc = "The operation state."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "State")]
    ...
    impl Serialize for ErrorType {
        ...
        {
            match self {
                Self::None => serializer.serialize_unit_variant("ErrorType", 0u32, "None"),
                Self::User => serializer.serialize_unit_variant("ErrorType", 1u32, "User"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct ManagedInstanceProperties {
    ...
    #[doc = "Pricing model of Managed Instance."]
