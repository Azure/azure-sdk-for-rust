...
pub struct JobExecutionProperties {
    ...
    #[serde(rename = "endTime", skip_serializing)]
    pub end_time: Option<String>,
    #[serde(rename = "currentAttempts", skip_serializing_if = "Option::is_none")]
...
pub struct JobStepProperties {
    ...
    #[serde(rename = "executionOptions", skip_serializing_if = "Option::is_none")]
...
pub struct JobStepExecutionOptions {
    ...
    #[serde(rename = "initialRetryIntervalSeconds", skip_serializing_if = "Option::is_none")]
    pub initial_retry_interval_seconds: Option<i32>,
    #[serde(rename = "maximumRetryIntervalSeconds", skip_serializing_if = "Option::is_none")]
    pub maximum_retry_interval_seconds: Option<i32>,
    #[serde(rename = "retryIntervalBackoffMultiplier", skip_serializing_if = "Option::is_none")]
...
pub struct JobTarget {
    ...
    pub elastic_pool_name: Option<String>,
    #[serde(rename = "shardMapName", skip_serializing_if = "Option::is_none")]
    pub shard_map_name: Option<String>,
    #[serde(rename = "refreshCredential", skip_serializing_if = "Option::is_none")]
...
pub struct ServerDnsAliasAcquisition {
    #[serde(rename = "oldServerDnsAliasId", skip_serializing_if = "Option::is_none")]
...
pub struct ManagedInstancePairInfo {
    #[serde(rename = "primaryManagedInstanceId", skip_serializing_if = "Option::is_none")]
    pub primary_managed_instance_id: Option<String>,
    #[serde(rename = "partnerManagedInstanceId", skip_serializing_if = "Option::is_none")]
...
pub struct TdeCertificateProperties {
    ...
    #[serde(rename = "certPassword", skip_serializing_if = "Option::is_none")]
...
pub struct ServiceObjectiveCapability {
    ...
    #[serde(rename = "zoneRedundant", skip_serializing)]
    pub zone_redundant: Option<bool>,
    #[serde(rename = "supportedAutoPauseDelay", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "supportedMaintenanceConfigurations", skip_serializing)]
...
pub struct MaxSizeRangeCapability {
    ...
    #[serde(rename = "scaleSize", skip_serializing_if = "Option::is_none")]
...
pub struct BaseLongTermRetentionPolicyProperties {
    #[serde(rename = "weeklyRetention", skip_serializing_if = "Option::is_none")]
    pub weekly_retention: Option<String>,
    #[serde(rename = "monthlyRetention", skip_serializing_if = "Option::is_none")]
    pub monthly_retention: Option<String>,
    #[serde(rename = "yearlyRetention", skip_serializing_if = "Option::is_none")]
    pub yearly_retention: Option<String>,
    #[serde(rename = "weekOfYear", skip_serializing_if = "Option::is_none")]
...
pub struct WorkloadGroupProperties {
    ...
    #[serde(rename = "maxResourcePercentPerRequest", skip_serializing_if = "Option::is_none")]
    pub max_resource_percent_per_request: Option<f64>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub importance: Option<String>,
    #[serde(rename = "queryExecutionTimeout", skip_serializing_if = "Option::is_none")]
...
pub struct ManagedInstanceOperationProperties {
    ...
    #[serde(rename = "operationSteps", skip_serializing_if = "Option::is_none")]
...
pub struct ManagedInstanceOperationParametersPair {
    #[serde(rename = "currentParameters", skip_serializing_if = "Option::is_none")]
    pub current_parameters: Option<UpsertManagedServerOperationParameters>,
    #[serde(rename = "requestedParameters", skip_serializing_if = "Option::is_none")]
...
pub struct SyncGroupProperties {
    ...
    #[serde(rename = "usePrivateLinkConnection", skip_serializing_if = "Option::is_none")]
...
pub struct SyncMemberProperties {
    ...
    #[serde(rename = "syncMemberAzureDatabaseResourceId", skip_serializing_if = "Option::is_none")]
...
pub struct ExportDatabaseDefinition {
    ...
    #[serde(rename = "networkIsolation", skip_serializing_if = "Option::is_none")]
...
pub struct NetworkIsolationSettings {
    ...
    #[serde(rename = "sqlServerResourceId", skip_serializing_if = "Option::is_none")]
...
pub struct ImportNewDatabaseDefinition {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub edition: Option<String>,
    #[serde(rename = "serviceObjectiveName", skip_serializing_if = "Option::is_none")]
    pub service_objective_name: Option<String>,
...
pub struct ManagedDatabaseProperties {
    ...
    #[serde(rename = "catalogCollation", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "storageContainerUri", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "restorableDroppedDatabaseId", skip_serializing_if = "Option::is_none")]
    pub restorable_dropped_database_id: Option<String>,
    #[serde(rename = "storageContainerSasToken", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "longTermRetentionBackupResourceId", skip_serializing_if = "Option::is_none")]
    pub long_term_retention_backup_resource_id: Option<String>,
    #[serde(rename = "autoCompleteRestore", skip_serializing_if = "Option::is_none")]
    pub auto_complete_restore: Option<bool>,
    #[serde(rename = "lastBackupName", skip_serializing_if = "Option::is_none")]
...
pub struct ManagedDatabaseRestoreDetailsProperties {
    #[serde(skip_serializing)]
    pub status: Option<String>,
    #[serde(rename = "currentRestoringFileName", skip_serializing)]
    pub current_restoring_file_name: Option<String>,
    #[serde(rename = "lastRestoredFileName", skip_serializing)]
    pub last_restored_file_name: Option<String>,
    #[serde(rename = "lastRestoredFileTime", skip_serializing)]
    pub last_restored_file_time: Option<String>,
    #[serde(rename = "percentCompleted", skip_serializing)]
    pub percent_completed: Option<f64>,
    #[serde(rename = "unrestorableFiles", skip_serializing)]
    pub unrestorable_files: Vec<String>,
    #[serde(rename = "numberOfFilesDetected", skip_serializing)]
    pub number_of_files_detected: Option<i64>,
    #[serde(rename = "lastUploadedFileName", skip_serializing)]
    pub last_uploaded_file_name: Option<String>,
    #[serde(rename = "lastUploadedFileTime", skip_serializing)]
    pub last_uploaded_file_time: Option<String>,
    #[serde(rename = "blockReason", skip_serializing)]
...
pub struct ElasticPoolProperties {
    ...
    #[serde(rename = "perDatabaseSettings", skip_serializing_if = "Option::is_none")]
...
pub struct DatabaseProperties {
    ...
    #[serde(rename = "elasticPoolId", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "recoveryServicesRecoveryPointId", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "highAvailabilityReplicaCount", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "currentSku", skip_serializing_if = "Option::is_none")]
    pub current_sku: Option<Sku>,
    #[serde(rename = "autoPauseDelay", skip_serializing_if = "Option::is_none")]
    pub auto_pause_delay: Option<i32>,
    #[serde(rename = "currentBackupStorageRedundancy", skip_serializing)]
    pub current_backup_storage_redundancy: Option<database_properties::CurrentBackupStorageRedundancy>,
    #[serde(rename = "requestedBackupStorageRedundancy", skip_serializing_if = "Option::is_none")]
...
pub struct CopyLongTermRetentionBackupParametersProperties {
    #[serde(rename = "targetSubscriptionId", skip_serializing_if = "Option::is_none")]
    pub target_subscription_id: Option<String>,
    #[serde(rename = "targetResourceGroup", skip_serializing_if = "Option::is_none")]
    pub target_resource_group: Option<String>,
    #[serde(rename = "targetServerResourceId", skip_serializing_if = "Option::is_none")]
    pub target_server_resource_id: Option<String>,
    #[serde(rename = "targetServerFullyQualifiedDomainName", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "targetBackupStorageRedundancy", skip_serializing_if = "Option::is_none")]
...
pub struct LongTermRetentionOperationResultProperties {
    ...
    #[serde(rename = "fromBackupResourceId", skip_serializing)]
    pub from_backup_resource_id: Option<String>,
    #[serde(rename = "toBackupResourceId", skip_serializing)]
    pub to_backup_resource_id: Option<String>,
    #[serde(rename = "targetBackupStorageRedundancy", skip_serializing)]
...
pub struct LongTermRetentionBackupProperties {
    ...
    #[serde(rename = "backupExpirationTime", skip_serializing)]
    pub backup_expiration_time: Option<String>,
    #[serde(rename = "backupStorageRedundancy", skip_serializing)]
