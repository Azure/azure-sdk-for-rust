...
#[doc = "The availability status of the capability"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "The database edition capabilities."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EditionCapability {
    #[doc = "The edition name."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "The availability status of the capability"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct ElasticPoolDtuCapability {
    #[doc = "The maximum size of the database (see 'unit' for the units)."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub max_database_count: Option<i64>,
    #[doc = "The availability status of the capability"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<CapabilityStatus>,
    ...
    #[doc = "The list of supported max database DTUs."]
...
#[doc = "The elastic pool edition capabilities."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "The capabilities for a location."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "A possible performance level of a service objective capability."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PerformanceLevel {
    #[doc = "Unit type used to measure service objective performance level."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub unit: Option<performance_level::Unit>,
