...
pub struct DatabaseProperties {
    ...
    #[doc = "The number of secondary replicas associated with the Business Critical, Premium, or Hyperscale edition database that are used to provide high availability. Not applicable to a Hyperscale database within an elastic pool."]
...
pub struct DistributedAvailabilityGroupDatabase {
    ...
    #[doc = "Seeding progress"]
    #[serde(rename = "seedingProgress", default, skip_serializing_if = "Option::is_none")]
    pub seeding_progress: Option<String>,
...
#[doc = "Distributed availability group failover."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DistributedAvailabilityGroupsFailoverRequest {
    #[doc = "The failover type, can be ForcedAllowDataLoss or Planned."]
    #[serde(rename = "failoverType")]
    pub failover_type: distributed_availability_groups_failover_request::FailoverType,
}
impl DistributedAvailabilityGroupsFailoverRequest {
    pub fn new(failover_type: distributed_availability_groups_failover_request::FailoverType) -> Self {
        Self { failover_type }
    }
}
pub mod distributed_availability_groups_failover_request {
    use super::*;
    #[doc = "The failover type, can be ForcedAllowDataLoss or Planned."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "FailoverType")]
    ...
    impl FromStr for FailoverType {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for FailoverType {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for FailoverType {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::ForcedAllowDataLoss => serializer.serialize_unit_variant("FailoverType", 0u32, "ForcedAllowDataLoss"),
                Self::Planned => serializer.serialize_unit_variant("FailoverType", 1u32, "Planned"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct ElasticPoolPerformanceLevelCapability {
    ...
    #[doc = "List of supported availability zones"]
    #[serde(
    ...
    pub supported_zones: Vec<ZonePinningCapability>,
    #[doc = "The status of the capability."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct ElasticPoolProperties {
    ...
    #[serde(rename = "maintenanceConfigurationId", default, skip_serializing_if = "Option::is_none")]
    pub maintenance_configuration_id: Option<String>,
    #[doc = "The number of secondary replicas associated with the Business Critical, Premium, or Hyperscale edition elastic pool that are used to provide high availability. Applicable only to Hyperscale elastic pools."]
    #[serde(rename = "highAvailabilityReplicaCount", default, skip_serializing_if = "Option::is_none")]
    pub high_availability_replica_count: Option<i32>,
...
pub struct ManagedInstanceProperties {
    ...
    #[doc = "Storage IOps. Minimum value: 300. Maximum value: 80000. Increments of 1 IOps allowed only. Maximum value depends on the selected hardware family and number of vCores."]
    #[serde(rename = "storageIOps", default, skip_serializing_if = "Option::is_none")]
    pub storage_i_ops: Option<i32>,
    #[doc = "Storage throughput MBps parameter is not supported in the instance create/update operation."]
    #[serde(rename = "storageThroughputMBps", default, skip_serializing_if = "Option::is_none")]
    pub storage_throughput_m_bps: Option<i32>,
    #[doc = "Total memory in MB. Minimum value: 7168. Maximum value: 891328. Increments of 1 MB allowed only. Maximum value depends on the selected hardware family and number of vCores."]
    #[serde(rename = "totalMemoryMB", default, skip_serializing_if = "Option::is_none")]
...
pub struct ManagedInstanceVcoresCapability {
    ...
    #[serde(rename = "supportedMemoryLimitsMB", default, skip_serializing_if = "Option::is_none")]
    pub supported_memory_limits_mb: Option<MaxLimitRangeCapability>,
    #[doc = "The maximum size capability."]
    #[serde(rename = "includedMaxSize", default, skip_serializing_if = "Option::is_none")]
    pub included_max_size: Option<MaxSizeCapability>,
...
#[doc = "The zone pinning capability"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ZonePinningCapability {
    #[doc = "Name of the availability zone"]
    #[serde(rename = "availabilityZone", default, skip_serializing_if = "Option::is_none")]
    pub availability_zone: Option<String>,
    #[doc = "The status of the capability."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<zone_pinning_capability::Status>,
    #[doc = "The reason for the capability not being available."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub reason: Option<String>,
}
impl ZonePinningCapability {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod zone_pinning_capability {
    use super::*;
    #[doc = "The status of the capability."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum Status {
