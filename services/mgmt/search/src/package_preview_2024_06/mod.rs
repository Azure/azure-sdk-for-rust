...
pub mod admin_keys {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets the primary and secondary admin API keys for the specified Azure AI Search service."]
        #[doc = ""]
        #[doc = "Arguments:"]
        ...
        #[doc = "* `search_service_name`: The name of the Azure AI Search service associated with the specified resource group."]
...
pub mod query_keys {
    ...
    impl Client {
        ...
        #[doc = "Returns the list of query API keys for the given Azure AI Search service."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group within the current subscription. You can obtain this value from the Azure Resource Manager API or the portal."]
        #[doc = "* `search_service_name`: The name of the Azure AI Search service associated with the specified resource group."]
...
pub mod services {
    ...
    impl Client {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group within the current subscription. You can obtain this value from the Azure Resource Manager API or the portal."]
        #[doc = "* `search_service_name`: The name of the Azure AI Search service to create or update. Search service names must only contain lowercase letters, digits or dashes, cannot use dash as the first two or last one characters, cannot contain consecutive dashes, and must be between 2 and 60 characters in length. Search service names must be globally unique since they are part of the service URI (https://<name>.search.windows.net). You cannot change the service name after the service is created."]
        ...
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group within the current subscription. You can obtain this value from the Azure Resource Manager API or the portal."]
        #[doc = "* `search_service_name`: The name of the Azure AI Search service to update."]
...
pub mod private_endpoint_connections {
    ...
    impl Client {
        ...
        #[doc = "* `resource_group_name`: The name of the resource group within the current subscription. You can obtain this value from the Azure Resource Manager API or the portal."]
        #[doc = "* `search_service_name`: The name of the Azure AI Search service associated with the specified resource group."]
        #[doc = "* `private_endpoint_connection_name`: The name of the private endpoint connection to the Azure AI Search service with the specified resource group."]
        #[doc = "* `subscription_id`: The unique identifier for a Microsoft Azure subscription. You can obtain this value from the Azure Resource Manager API or the portal."]
        pub fn get(
            &self,
            resource_group_name: impl Into<String>,
...
pub mod shared_private_link_resources {
    ...
    impl Client {
        ...
        #[doc = "* `resource_group_name`: The name of the resource group within the current subscription. You can obtain this value from the Azure Resource Manager API or the portal."]
        #[doc = "* `search_service_name`: The name of the Azure AI Search service associated with the specified resource group."]
        #[doc = "* `shared_private_link_resource_name`: The name of the shared private link resource managed by the Azure AI Search service within the specified resource group."]
        #[doc = "* `subscription_id`: The unique identifier for a Microsoft Azure subscription. You can obtain this value from the Azure Resource Manager API or the portal."]
        pub fn get(
            &self,
            resource_group_name: impl Into<String>,
...
pub mod usages {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Get a list of all Azure AI Search quota usages across the subscription."]
        #[doc = ""]
        #[doc = "Arguments:"]
    ...
    pub mod list_by_subscription {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.Search/locations/{}/usages",
...
impl Client {
    ...
    ) -> usage_by_subscription_sku::RequestBuilder {
        usage_by_subscription_sku::RequestBuilder {
            client: self.clone(),
            location: location.into(),
            subscription_id: subscription_id.into(),
...
pub mod usage_by_subscription_sku {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    pub struct Response(azure_core::Response);
    impl Response {
        pub async fn into_body(self) -> azure_core::Result<models::QuotaUsageResult> {
            let bytes = self.0.into_body().collect().await?;
            let body: models::QuotaUsageResult = serde_json::from_slice(&bytes)?;
            Ok(body)
        }
        pub fn into_raw_response(self) -> azure_core::Response {
            self.0
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            ...
            url.set_path(&format!(
                "/subscriptions/{}/providers/Microsoft.Search/locations/{}/usages/{}",
                &self.subscription_id, &self.location, &self.sku_name
            ));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::QuotaUsageResult>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::QuotaUsageResult>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod network_security_perimeter_configurations {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets a list of network security perimeter configurations for a search service."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group within the current subscription. You can obtain this value from the Azure Resource Manager API or the portal."]
        #[doc = "* `search_service_name`: The name of the Azure AI Search service associated with the specified resource group."]
        ...
        #[doc = "Gets a network security perimeter configuration."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group within the current subscription. You can obtain this value from the Azure Resource Manager API or the portal."]
        #[doc = "* `search_service_name`: The name of the Azure AI Search service associated with the specified resource group."]
        #[doc = "* `nsp_config_name`: The network security configuration name."]
        #[doc = "* `subscription_id`: The unique identifier for a Microsoft Azure subscription. You can obtain this value from the Azure Resource Manager API or the portal."]
        pub fn get(
            &self,
            resource_group_name: impl Into<String>,
            search_service_name: impl Into<String>,
            nsp_config_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                search_service_name: search_service_name.into(),
                nsp_config_name: nsp_config_name.into(),
                subscription_id: subscription_id.into(),
            }
        }
        #[doc = "Reconcile network security perimeter configuration for the Azure AI Search resource provider. This triggers a manual resync with network security perimeter configurations by ensuring the search service carries the latest configuration."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group within the current subscription. You can obtain this value from the Azure Resource Manager API or the portal."]
        #[doc = "* `search_service_name`: The name of the Azure AI Search service associated with the specified resource group."]
    ...
    pub mod list_by_service {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Search/searchServices/{}/networkSecurityPerimeterConfigurations" , & self . subscription_id , & self . resource_group_name , & self . search_service_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-06-01-preview");
    ...
    pub mod get {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) search_service_name: String,
            pub(crate) nsp_config_name: String,
            pub(crate) subscription_id: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Search/searchServices/{}/networkSecurityPerimeterConfigurations/{}" , & self . subscription_id , & self . resource_group_name , & self . search_service_name , & self . nsp_config_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-06-01-preview");
    ...
    pub mod reconcile {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Search/searchServices/{}/networkSecurityPerimeterConfigurations/{}/reconcile" , & self . subscription_id , & self . resource_group_name , & self . search_service_name , & self . nsp_config_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-06-01-preview");
