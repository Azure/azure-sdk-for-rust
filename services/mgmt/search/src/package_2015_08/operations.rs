...
pub enum Error {
    ...
    #[error(transparent)]
    QueryKeys_ListBySearchServiceGet(#[from] query_keys::list_by_search_service_get::Error),
    #[error(transparent)]
...
pub mod query_keys {
    ...
    pub async fn list_by_search_service_get(
        ...
        x_ms_client_request_id: Option<&str>,
        subscription_id: &str,
    ) -> std::result::Result<models::ListQueryKeysResult, list_by_search_service_get::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
