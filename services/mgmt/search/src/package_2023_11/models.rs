...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct Identity {
    #[doc = "The principal ID of the system-assigned identity of the search service."]
    #[serde(rename = "principalId", default, skip_serializing_if = "Option::is_none")]
    pub principal_id: Option<String>,
    #[doc = "The tenant ID of the system-assigned identity of the search service."]
    ...
    impl Serialize for ProvisioningState {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Incomplete => serializer.serialize_unit_variant("ProvisioningState", 4u32, "Incomplete"),
...
pub struct QuotaUsagesListResult {
    ...
    pub value: Vec<QuotaUsageResult>,
    #[doc = "Request URL that can be used to query next page of quota usages. Returned when the total number of requested quota usages exceed maximum page size."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
...
impl FromStr for SemanticSearch {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for SemanticSearch {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for SemanticSearch {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Disabled => serializer.serialize_unit_variant("SemanticSearch", 0u32, "disabled"),
            Self::Free => serializer.serialize_unit_variant("SemanticSearch", 1u32, "free"),
            Self::Standard => serializer.serialize_unit_variant("SemanticSearch", 2u32, "standard"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
