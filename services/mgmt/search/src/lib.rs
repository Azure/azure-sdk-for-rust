...
pub use package_2021_04_preview::{models, operations, operations::Client, operations::ClientBuilder};
...
pub use package_2020_08_preview::{models, operations, operations::Client, operations::ClientBuilder};
#[cfg(feature = "package-2020-08")]
pub mod package_2020_08;
#[cfg(all(feature = "package-2020-08", not(feature = "no-default-tag")))]
pub use package_2020_08::{models, operations, operations::Client, operations::ClientBuilder};
