...
use std::str::FromStr;
#[doc = "Response containing the primary and secondary admin API keys for a given Azure AI Search service."]
...
pub struct CloudError {
    ...
    #[doc = "A brief description of the error that hints at what went wrong (for details/debugging information refer to the 'error.message' property)."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub message: Option<String>,
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "DisabledDataExfiltrationOption")]
pub enum DisabledDataExfiltrationOption {
    All,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for DisabledDataExfiltrationOption {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for DisabledDataExfiltrationOption {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for DisabledDataExfiltrationOption {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::All => serializer.serialize_unit_variant("DisabledDataExfiltrationOption", 0u32, "All"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct EncryptionWithCmk {
    #[doc = "Describes how a search service should enforce compliance if it finds objects that aren't encrypted with the customer-managed key."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enforcement: Option<encryption_with_cmk::Enforcement>,
    #[doc = "Returns the status of search service compliance with respect to non-CMK-encrypted objects. If a service has more than one unencrypted object, and enforcement is enabled, the service is marked as noncompliant."]
...
#[doc = "Details about the search service identity. A null value indicates that the search service has no identity assigned."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct Identity {
    ...
    #[doc = "The type of identity used for the resource. The type 'SystemAssigned, UserAssigned' includes both an identity created by the system and a set of user assigned identities. The type 'None' will remove all identities from the service."]
    #[serde(rename = "type")]
    pub type_: identity::Type,
    #[doc = "The list of user identities associated with the search service. The user identity dictionary key references will be ARM resource IDs in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'."]
...
#[doc = "The IP restriction rule of the Azure AI Search service."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct IpRule {
...
#[doc = "Response containing the query API keys for a given Azure AI Search service."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ListQueryKeysResult {
    #[doc = "The query keys for the Azure AI Search service."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
#[doc = "An access rule for a network security perimeter configuration."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NspConfigAccessRule {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "The properties for the access rules in a network security perimeter configuration."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "The resource association for the network security perimeter."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "The network security perimeter properties present in a configuration rule."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "The perimeter for a network security perimeter configuration."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "The profile for a network security perimeter configuration."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "An object to describe any issues with provisioning network security perimeters to a search service."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NspProvisioningIssue {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "The properties to describe any issues with provisioning network security perimeters to a search service."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Network specific rules that determine how the Azure AI Search service may be reached."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
    ...
    impl Serialize for Bypass {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::AzurePortal => serializer.serialize_unit_variant("Bypass", 1u32, "AzurePortal"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
}
#[doc = "Network security perimeter configuration for a server."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NetworkSecurityPerimeterConfiguration {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "The properties of a network security perimeter configuration."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "A list of network security perimeter configurations for a server."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct Operation {
    ...
    #[doc = "Describes if the specified operation is a data plane API operation. Operations where this value is not true are supported directly by the resource provider."]
    #[serde(rename = "isDataAction", default, skip_serializing_if = "Option::is_none")]
    pub is_data_action: Option<bool>,
    #[doc = "Describes which originating entities are allowed to invoke this operation."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub origin: Option<String>,
    #[doc = "Describes additional properties for this operation."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Describes a particular availability for the metric specification."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OperationAvailability {
    #[doc = "The time grain for the dimension."]
    #[serde(rename = "timeGrain", default, skip_serializing_if = "Option::is_none")]
    pub time_grain: Option<String>,
    #[doc = "The blob duration for the dimension."]
...
pub struct OperationListResult {
    #[doc = "The list of operations by Azure AI Search, some supported by the resource provider and others by data plane APIs."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
#[doc = "Specifications of one type of log for this operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OperationLogsSpecification {
    #[doc = "The name of the log specification."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "The display name of the log specification."]
    #[serde(rename = "displayName", default, skip_serializing_if = "Option::is_none")]
    pub display_name: Option<String>,
    #[doc = "The blob duration for the log specification."]
    #[serde(rename = "blobDuration", default, skip_serializing_if = "Option::is_none")]
    pub blob_duration: Option<String>,
}
...
#[doc = "Describes a particular dimension for the metric specification."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "Specifications of one type of metric for this operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OperationMetricsSpecification {
    ...
    #[doc = "The unit for the metric specification."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub unit: Option<String>,
    #[doc = "The type of aggregation for the metric specification."]
...
pub struct OperationProperties {
    #[doc = "Specifications of the service for this operation."]
...
#[doc = "Describes an existing private endpoint connection to the Azure AI Search service."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct PrivateEndpointConnectionProperties {
    ...
    #[doc = "Describes the current state of an existing Azure Private Link service connection to the private endpoint."]
    ...
    #[doc = "The group ID of the Azure resource for which the private link service is for."]
    #[serde(rename = "groupId", default, skip_serializing_if = "Option::is_none")]
    pub group_id: Option<String>,
    #[doc = "The provisioning state of the private link service connection. Valid values are Updating, Deleting, Failed, Succeeded, Incomplete, or Canceled."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Describes a supported private link resource for the Azure AI Search service."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PrivateLinkResource {
    #[serde(flatten)]
    pub resource: Resource,
    #[doc = "Describes the properties of a supported private link resource for the Azure AI Search service. For a given API version, this represents the 'supported' groupIds when creating a shared private link resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct PrivateLinkResourceProperties {
    ...
    #[doc = "The list of resources that are onboarded to private link service, that are supported by Azure AI Search."]
    #[serde(
...
#[doc = "Describes an API key for a given Azure AI Search service that conveys read-only permissions on the docs collection of an index."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct QueryKey {
    #[doc = "The name of the query API key. Query names are optional, but assigning a name can help you remember how it's used."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
...
#[doc = "Describes an Azure AI Search service and its current state."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "Response containing a list of Azure AI Search services."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct SearchServiceProperties {
    ...
    #[doc = "Sets options that control the availability of semantic search. This configuration is only possible for certain Azure AI Search SKUs in certain locations."]
    #[serde(rename = "semanticSearch", default, skip_serializing_if = "Option::is_none")]
    pub semantic_search: Option<SemanticSearch>,
    #[doc = "The list of private endpoint connections to the Azure AI Search service."]
    #[serde(
    ...
    #[doc = "The list of shared private link resources managed by the Azure AI Search service."]
    #[serde(
...
#[doc = "The parameters used to update an Azure AI Search service."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "Describes the properties of a resource type that has been onboarded to private link service, supported by Azure AI Search."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ShareablePrivateLinkResourceProperties {
    #[doc = "The resource provider type for the resource that has been onboarded to private link service, supported by Azure AI Search."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<String>,
    #[doc = "The resource provider group id for the resource that has been onboarded to private link service, supported by Azure AI Search."]
    #[serde(rename = "groupId", default, skip_serializing_if = "Option::is_none")]
    pub group_id: Option<String>,
    #[doc = "The description of the resource type that has been onboarded to private link service, supported by Azure AI Search."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
}
...
#[doc = "Describes an resource type that has been onboarded to private link service, supported by Azure AI Search."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ShareablePrivateLinkResourceType {
    #[doc = "The name of the resource type that has been onboarded to private link service, supported by Azure AI Search."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Describes the properties of a resource type that has been onboarded to private link service, supported by Azure AI Search."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Describes a shared private link resource managed by the Azure AI Search service."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SharedPrivateLinkResource {
    #[serde(flatten)]
    pub resource: Resource,
    #[doc = "Describes the properties of an existing shared private link resource managed by the Azure AI Search service."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct SharedPrivateLinkResourceProperties {
    ...
    #[serde(rename = "groupId", default, skip_serializing_if = "Option::is_none")]
    pub group_id: Option<String>,
    #[doc = "The message for requesting approval of the shared private link resource."]
    #[serde(rename = "requestMessage", default, skip_serializing_if = "Option::is_none")]
    pub request_message: Option<String>,
    #[doc = "Optional. Can be used to specify the Azure Resource Manager location of the resource for which a shared private link is being created. This is only required for those resources whose DNS configuration are regional (such as Azure Kubernetes Service)."]
    ...
    impl Serialize for Name {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Standard2 => serializer.serialize_unit_variant("Name", 3u32, "standard2"),
                Self::Standard3 => serializer.serialize_unit_variant("Name", 4u32, "standard3"),
                Self::StorageOptimizedL1 => serializer.serialize_unit_variant("Name", 5u32, "storage_optimized_l1"),
                Self::StorageOptimizedL2 => serializer.serialize_unit_variant("Name", 6u32, "storage_optimized_l2"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "The details of the user assigned managed identity assigned to the search service."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
