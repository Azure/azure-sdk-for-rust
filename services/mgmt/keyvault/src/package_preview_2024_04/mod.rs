...
impl Client {
    ...
    pub fn managed_hsm_keys_client(&self) -> managed_hsm_keys::Client {
        managed_hsm_keys::Client(self.clone())
    }
    ...
    pub fn mhsm_regions_client(&self) -> mhsm_regions::Client {
        mhsm_regions::Client(self.clone())
    }
...
pub mod network_security_perimeter {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "The List operation gets information about the network security perimeter associations for the key vault."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call."]
        #[doc = "* `resource_group_name`: Name of the resource group that contains the key vault."]
        ...
        pub fn list_configuration(
            ...
            resource_group_name: impl Into<String>,
            vault_name: impl Into<String>,
        ) -> list_configuration::RequestBuilder {
            list_configuration::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        #[doc = "The Get operation gets information about the network security perimeter associations for the key vault."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call."]
        #[doc = "* `resource_group_name`: Name of the resource group that contains the key vault."]
        #[doc = "* `vault_name`: The name of the key vault."]
        #[doc = "* `association_proxy_name`: Association proxy name associated with the key vault."]
        pub fn get_configuration(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            vault_name: impl Into<String>,
            association_proxy_name: impl Into<String>,
            ...
            get_configuration::RequestBuilder {
                ...
                resource_group_name: resource_group_name.into(),
                vault_name: vault_name.into(),
                association_proxy_name: association_proxy_name.into(),
            }
        }
    }
    pub mod list_configuration {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.KeyVault/vaults/{}/networkSecurityPerimeterConfigurations",
                    &self.subscription_id, &self.resource_group_name, &self.vault_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod get_configuration {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) vault_name: String,
            pub(crate) association_proxy_name: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.KeyVault/vaults/{}/networkSecurityPerimeterConfigurations/{}",
                    &self.subscription_id, &self.resource_group_name, &self.vault_name, &self.association_proxy_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
...
pub mod managed_hsm_keys {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets the current version of the specified key from the specified managed HSM."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `name`: The name of the Managed HSM Pool within the specified resource group."]
        #[doc = "* `key_name`: The name of the key to be created. The value you provide may be copied globally for the purpose of running the service. The value provided should not include personally identifiable or sensitive information."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
        ...
        pub fn create_if_not_exist(
            ...
            name: impl Into<String>,
            key_name: impl Into<String>,
            parameters: impl Into<models::ManagedHsmKeyCreateParameters>,
        ) -> create_if_not_exist::RequestBuilder {
            create_if_not_exist::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
        ...
        #[doc = "Lists the keys in the specified managed HSM."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Gets the specified version of the specified key in the specified managed HSM."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Lists the versions of the specified key in the specified managed HSM."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ManagedHsmKey> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ManagedHsmKey = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    ...
                    &self.subscription_id, &self.resource_group_name, &self.name, &self.key_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ManagedHsmKey>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ManagedHsmKey>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_if_not_exist {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) name: String,
            pub(crate) key_name: String,
            pub(crate) parameters: models::ManagedHsmKeyCreateParameters,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ManagedHsmKeyListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ManagedHsmKeyListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ManagedHsmKeyListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    ...
                    &self.subscription_id, &self.resource_group_name, &self.name, &self.key_name, &self.key_version
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
...
pub mod mhsm_regions {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "The List operation gets information about the regions associated with the managed HSM Pool."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call."]
        #[doc = "* `resource_group_name`: Name of the resource group that contains the managed HSM pool."]
    ...
    pub mod list_by_resource {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::MhsmRegionsListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::MhsmRegionsListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::MhsmRegionsListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.KeyVault/managedHSMs/{}/regions",
                    &self.subscription_id, &self.resource_group_name, &self.name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
