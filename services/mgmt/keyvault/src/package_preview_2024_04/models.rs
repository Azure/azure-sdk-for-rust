...
#[doc = "A region that this managed HSM Pool has been extended to."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MhsmGeoReplicatedRegion {
    #[doc = "Name of the geo replicated region."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "The current provisioning state."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<MhsmGeoReplicationRegionProvisioningState>,
    #[doc = "A boolean value that indicates whether the region is the primary region or a secondary region."]
    #[serde(rename = "isPrimary", default, skip_serializing_if = "Option::is_none")]
    pub is_primary: Option<bool>,
}
impl MhsmGeoReplicatedRegion {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The current provisioning state."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "MhsmGeoReplicationRegionProvisioningState")]
pub enum MhsmGeoReplicationRegionProvisioningState {
    Preprovisioning,
    Provisioning,
    Succeeded,
    Failed,
...
impl FromStr for MhsmGeoReplicationRegionProvisioningState {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for MhsmGeoReplicationRegionProvisioningState {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for MhsmGeoReplicationRegionProvisioningState {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Preprovisioning => {
                serializer.serialize_unit_variant("MhsmGeoReplicationRegionProvisioningState", 0u32, "Preprovisioning")
            }
            Self::Provisioning => serializer.serialize_unit_variant("MhsmGeoReplicationRegionProvisioningState", 1u32, "Provisioning"),
            Self::Succeeded => serializer.serialize_unit_variant("MhsmGeoReplicationRegionProvisioningState", 2u32, "Succeeded"),
            Self::Failed => serializer.serialize_unit_variant("MhsmGeoReplicationRegionProvisioningState", 3u32, "Failed"),
            Self::Deleting => serializer.serialize_unit_variant("MhsmGeoReplicationRegionProvisioningState", 4u32, "Deleting"),
            Self::Cleanup => serializer.serialize_unit_variant("MhsmGeoReplicationRegionProvisioningState", 5u32, "Cleanup"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "List of regions associated with a managed HSM Pools"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MhsmRegionsListResult {
    #[doc = "The region associated with a managed HSM Pools."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
impl azure_core::Continuable for MhsmRegionsListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl MhsmRegionsListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ManagedHsmAction {
    #[doc = "The type of action."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<managed_hsm_action::Type>,
}
impl ManagedHsmAction {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod managed_hsm_action {
    use super::*;
    #[doc = "The type of action."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum Type {
...
pub struct ManagedHsmKey {
    #[serde(flatten)]
    pub proxy_resource_without_system_data: ProxyResourceWithoutSystemData,
    #[doc = "The properties of the key."]
    pub properties: ManagedHsmKeyProperties,
}
impl ManagedHsmKey {
    pub fn new(properties: ManagedHsmKeyProperties) -> Self {
        Self {
            proxy_resource_without_system_data: ProxyResourceWithoutSystemData::default(),
            properties,
        }
    }
}
...
pub struct ManagedHsmKeyAttributes {
    ...
    #[doc = "The deletion recovery level currently in effect for the object. If it contains 'Purgeable', then the object can be permanently deleted by a privileged user; otherwise, only the system can purge the object at the end of the retention interval."]
    #[serde(rename = "recoveryLevel", default, skip_serializing_if = "Option::is_none")]
    pub recovery_level: Option<managed_hsm_key_attributes::RecoveryLevel>,
    #[doc = "Indicates if the private key can be exported."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub exportable: Option<bool>,
}
impl ManagedHsmKeyAttributes {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod managed_hsm_key_attributes {
    use super::*;
    #[doc = "The deletion recovery level currently in effect for the object. If it contains 'Purgeable', then the object can be permanently deleted by a privileged user; otherwise, only the system can purge the object at the end of the retention interval."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "RecoveryLevel")]
...
impl ManagedHsmKeyCreateParameters {
    pub fn new(properties: ManagedHsmKeyProperties) -> Self {
        Self { tags: None, properties }
    }
}
...
impl azure_core::Continuable for ManagedHsmKeyListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl ManagedHsmKeyListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ManagedHsmKeyProperties {
    ...
    #[doc = "The type of the key. For valid values, see JsonWebKeyType."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kty: Option<managed_hsm_key_properties::Kty>,
    #[serde(
        rename = "keyOps",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    #[doc = "The elliptic curve name. For valid values, see JsonWebKeyCurveName."]
    #[serde(rename = "curveName", default, skip_serializing_if = "Option::is_none")]
    pub curve_name: Option<managed_hsm_key_properties::CurveName>,
    #[doc = "The URI to retrieve the current version of the key."]
    #[serde(rename = "keyUri", default, skip_serializing_if = "Option::is_none")]
    pub key_uri: Option<String>,
    #[doc = "The URI to retrieve the specific version of the key."]
...
impl ManagedHsmKeyProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod managed_hsm_key_properties {
    use super::*;
    #[doc = "The type of the key. For valid values, see JsonWebKeyType."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Kty")]
...
impl ManagedHsmKeyReleasePolicy {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl ManagedHsmKeyRotationPolicyAttributes {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ManagedHsmProperties {
    ...
    #[doc = "List of all regions associated with the managed hsm pool."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub regions: Vec<MhsmGeoReplicatedRegion>,
...
pub struct ManagedHsmRotationPolicy {
    ...
    pub lifetime_actions: Vec<ManagedHsmLifetimeAction>,
}
impl ManagedHsmRotationPolicy {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ProxyResourceWithoutSystemData {
...
impl ProxyResourceWithoutSystemData {
    pub fn new() -> Self {
        Self::default()
    }
}
