...
impl ClientGroupMembersCount {
    pub fn new(start_time: String, end_time: String, group_id: String, count: i32, accuracy: Accuracy) -> Self {
        Self {
            start_time,
            end_time,
            group_id,
...
impl Liveness {
    pub fn new(start_time: String, end_time: String, live: bool) -> Self {
        Self {
            start_time,
            end_time,
            live,
...
pub mod machine {
    ...
    pub struct Properties {
        ...
        #[serde(rename = "bootTime", default, skip_serializing_if = "Option::is_none")]
...
impl MapResponse {
    pub fn new(start_time: String, end_time: String, map: Map) -> Self {
