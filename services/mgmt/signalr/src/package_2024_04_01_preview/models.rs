...
#[doc = "Application firewall settings for the resource"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ApplicationFirewallSettings {
    #[doc = "Rules to control the client connection count"]
    #[serde(
        rename = "clientConnectionCountRules",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub client_connection_count_rules: Vec<ClientConnectionCountRuleUnion>,
}
impl ApplicationFirewallSettings {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[serde(tag = "type")]
pub enum ClientConnectionCountRuleUnion {
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct IpRule {
    #[doc = "An IP or CIDR or ServiceTag"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct ReplicaProperties {
    ...
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<ProvisioningState>,
    #[doc = "Enable or disable the regional endpoint. Default to \"Enabled\".\r\nWhen it's Disabled, new connections will not be routed to this endpoint, however existing connections will not be affected."]
    #[serde(rename = "regionEndpointEnabled", default, skip_serializing_if = "Option::is_none")]
    pub region_endpoint_enabled: Option<String>,
    #[doc = "Stop or start the resource.  Default to \"false\".\r\nWhen it's true, the data plane of the resource is shutdown.\r\nWhen it's false, the data plane of the resource is started."]
    #[serde(rename = "resourceStopped", default, skip_serializing_if = "Option::is_none")]
    pub resource_stopped: Option<String>,
}
...
pub struct SignalRNetworkAcLs {
    ...
    #[doc = "IP rules for filtering public traffic"]
    #[serde(
        rename = "ipRules",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
...
pub struct SignalRProperties {
    ...
    #[doc = "Application firewall settings for the resource"]
    #[serde(rename = "applicationFirewall", default, skip_serializing_if = "Option::is_none")]
    pub application_firewall: Option<ApplicationFirewallSettings>,
...
#[doc = "Throttle the client connection by a custom JWT claim"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ThrottleByJwtCustomClaimRule {
    #[doc = "The name of the claim in the JWT token. The client connection with the same claim value will be aggregated. If the claim is not found in the token, the connection will be allowed."]
    #[serde(rename = "claimName")]
    pub claim_name: String,
    #[doc = "Maximum connection count allowed for the same Jwt claim value. Clients with the same Jwt claim will get rejected if the connection count exceeds this value. Default value is 20."]
    #[serde(rename = "maxCount", default, skip_serializing_if = "Option::is_none")]
    pub max_count: Option<i32>,
}
impl ThrottleByJwtCustomClaimRule {
    pub fn new(claim_name: String) -> Self {
        Self {
            claim_name,
            max_count: None,
        }
...
#[doc = "Throttle the client connection by the JWT signature"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ThrottleByJwtSignatureRule {
    #[doc = "Maximum connection count allowed for the same JWT signature. Clients with the same JWT signature will get rejected if the connection count exceeds this value. Default value is 20."]
    #[serde(rename = "maxCount", default, skip_serializing_if = "Option::is_none")]
    pub max_count: Option<i32>,
}
impl ThrottleByJwtSignatureRule {
    pub fn new() -> Self {
        Self { max_count: None }
    }
}
#[doc = "Throttle the client connection by the user ID"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ThrottleByUserIdRule {
    #[doc = "Maximum connection count allowed for the same user ID. Clients with the same user ID will get rejected if the connection count exceeds this value. Default value is 20."]
    #[serde(rename = "maxCount", default, skip_serializing_if = "Option::is_none")]
    pub max_count: Option<i32>,
}
impl ThrottleByUserIdRule {
    pub fn new() -> Self {
        Self { max_count: None }
    }
}
