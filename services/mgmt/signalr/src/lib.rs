...
pub const USER_AGENT_SDK: &str = "azsdk-rust-mgmt_signalr/0.1.0";
...
mod package_2018_03_01_preview;
#[cfg(feature = "package-2018-03-01-preview")]
pub use package_2018_03_01_preview::{models, operations, API_VERSION};
#[derive(Clone)]
