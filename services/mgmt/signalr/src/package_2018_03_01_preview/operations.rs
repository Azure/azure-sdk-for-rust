...
pub mod signal_r {
    ...
    pub mod create_or_update {
        ...
        pub struct Builder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) resource_name: String,
            pub(crate) parameters: Option<models::SignalRCreateParameters>,
        }
        impl Builder {
            pub fn parameters(mut self, parameters: impl Into<models::SignalRCreateParameters>) -> Self {
                self.parameters = Some(parameters.into());
                self
            }
            #[doc = "only the first response will be fetched as long running operations are not supported yet"]
    ...
    pub mod update {
        ...
        pub struct Builder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) resource_name: String,
            pub(crate) parameters: Option<models::SignalRUpdateParameters>,
        }
        impl Builder {
            pub fn parameters(mut self, parameters: impl Into<models::SignalRUpdateParameters>) -> Self {
                self.parameters = Some(parameters.into());
                self
            }
            #[doc = "only the first response will be fetched as long running operations are not supported yet"]
