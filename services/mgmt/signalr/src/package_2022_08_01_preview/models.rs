...
#[doc = "The kind of the service, it can be SignalR or RawWebSockets"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
pub struct SignalRProperties {
    ...
    #[doc = "Serverless settings."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub serverless: Option<ServerlessSettings>,
    #[doc = "The settings for the Upstream when the service is in server-less mode."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
