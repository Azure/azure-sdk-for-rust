...
pub enum Error {
    ...
    #[error(transparent)]
    SignalRCustomCertificates_List(#[from] signal_r_custom_certificates::list::Error),
    #[error(transparent)]
    SignalRCustomCertificates_Get(#[from] signal_r_custom_certificates::get::Error),
    #[error(transparent)]
    SignalRCustomCertificates_CreateOrUpdate(#[from] signal_r_custom_certificates::create_or_update::Error),
    #[error(transparent)]
    SignalRCustomCertificates_Delete(#[from] signal_r_custom_certificates::delete::Error),
    #[error(transparent)]
    SignalRCustomDomains_List(#[from] signal_r_custom_domains::list::Error),
    #[error(transparent)]
    SignalRCustomDomains_Get(#[from] signal_r_custom_domains::get::Error),
    #[error(transparent)]
    SignalRCustomDomains_CreateOrUpdate(#[from] signal_r_custom_domains::create_or_update::Error),
    #[error(transparent)]
    SignalRCustomDomains_Delete(#[from] signal_r_custom_domains::delete::Error),
    #[error(transparent)]
...
pub mod signal_r_custom_certificates {
    ...
    pub mod list {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::CustomCertificateList, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                            let rsp_value: models::CustomCertificateList =
                                serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                            Ok(rsp_value)
                        }
                        status_code => {
    ...
    pub mod get {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::CustomCertificate, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.SignalRService/signalR/{}/customCertificates/{}",
                        self.client.endpoint(),
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                            let rsp_value: models::CustomCertificate =
                                serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                            Ok(rsp_value)
                        }
                        status_code => {
    ...
    pub mod create_or_update {
        ...
        #[derive(Debug)]
        pub enum Response {
            Ok200(models::CustomCertificate),
            Created201(models::CustomCertificate),
        }
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
...
pub mod signal_r_custom_domains {
    ...
    pub mod list {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::CustomDomainList, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                            let rsp_value: models::CustomDomainList =
                                serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                            Ok(rsp_value)
                        }
                        status_code => {
