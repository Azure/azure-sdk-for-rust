...
pub struct AzureDataExplorerConnectionProperties {
    ...
    #[serde(rename = "adxTwinLifecycleEventsTableName", default, skip_serializing_if = "Option::is_none")]
    pub adx_twin_lifecycle_events_table_name: Option<String>,
    ...
    #[serde(
        rename = "adxRelationshipLifecycleEventsTableName",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub adx_relationship_lifecycle_events_table_name: Option<String>,
...
impl AzureDataExplorerConnectionProperties {
    pub fn new(
        ...
        Self {
            ...
            adx_database_name,
            adx_table_name: None,
            adx_twin_lifecycle_events_table_name: None,
            adx_relationship_lifecycle_events_table_name: None,
            event_hub_endpoint_uri,
            event_hub_entity_path,
            event_hub_namespace_resource_id,
            event_hub_consumer_group: None,
            record_property_and_item_removals: None,
        }
    }
}
pub mod azure_data_explorer_connection_properties {
    use super::*;
    #[doc = "Specifies whether or not to record twin / relationship property and item removals, including removals of indexed or keyed values (such as map entries, array elements, etc.). This feature is de-activated unless explicitly set to 'true'. Setting this property to 'true' will generate an additional column in the property events table in ADX."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "RecordPropertyAndItemRemovals")]
    pub enum RecordPropertyAndItemRemovals {
        #[serde(rename = "true")]
        True,
        #[serde(rename = "false")]
        False,
    ...
    impl FromStr for RecordPropertyAndItemRemovals {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for RecordPropertyAndItemRemovals {
    ...
    impl Serialize for RecordPropertyAndItemRemovals {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::True => serializer.serialize_unit_variant("RecordPropertyAndItemRemovals", 0u32, "true"),
                Self::False => serializer.serialize_unit_variant("RecordPropertyAndItemRemovals", 1u32, "false"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for RecordPropertyAndItemRemovals {
        fn default() -> Self {
            Self::False
        }
    }
...
pub struct DigitalTwinsEndpointResourceProperties {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub identity: Option<ManagedIdentityReference>,
}
...
impl ManagedIdentityReference {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod managed_identity_reference {
    use super::*;
    #[doc = "The type of managed identity used."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Type")]
