...
pub mod operations {
    ...
    pub async fn list(
        ...
        let url_str = &format!("{}/providers/Microsoft.ConfidentialLedger/operations", operation_config.base_path(),);
...
pub async fn check_name_availability(
    operation_config: &crate::OperationConfig,
    subscription_id: &str,
    name_availability_request: &models::CheckNameAvailabilityRequest,
    ...
    let req_body = azure_core::to_json(name_availability_request).map_err(check_name_availability::Error::SerializeError)?;
    req_builder = req_builder.uri(url.as_str());
    let req = req_builder
        .body(req_body)
...
pub mod ledger {
    ...
    pub async fn get(
        ...
        ledger_name: &str,
    ) -> std::result::Result<models::ConfidentialLedger, get::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
    ...
    pub async fn create(
        ...
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        req_builder = req_builder.header("content-type", "application/json");
        let req_body = azure_core::to_json(confidential_ledger).map_err(create::Error::SerializeError)?;
        req_builder = req_builder.uri(url.as_str());
    ...
    pub async fn update(
        ...
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        req_builder = req_builder.header("content-type", "application/json");
        let req_body = azure_core::to_json(confidential_ledger).map_err(update::Error::SerializeError)?;
        req_builder = req_builder.uri(url.as_str());
    ...
    ) -> std::result::Result<models::ConfidentialLedgerList, list_by_resource_group::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ConfidentialLedger/ledgers",
            operation_config.base_path(),
    ...
    pub async fn list_by_subscription(
        ...
        subscription_id: &str,
        u24filter: Option<&str>,
    ) -> std::result::Result<models::ConfidentialLedgerList, list_by_subscription::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
