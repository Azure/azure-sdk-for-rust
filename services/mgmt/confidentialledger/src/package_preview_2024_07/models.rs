...
pub struct LedgerProperties {
    ...
    #[doc = "CCF Property for the logging level for the untrusted host: Trace, Debug, Info, Fail, Fatal."]
    #[serde(rename = "hostLevel", default, skip_serializing_if = "Option::is_none")]
    pub host_level: Option<String>,
    #[doc = "CCF Property for the maximum size of the http request body: 1MB, 5MB, 10MB."]
    #[serde(rename = "maxBodySizeInMb", default, skip_serializing_if = "Option::is_none")]
    pub max_body_size_in_mb: Option<MaxBodySizeInMb>,
    #[doc = "CCF Property for the subject name to include in the node certificate. Default: CN=CCF Node."]
    ...
    #[doc = "Prefix for the write load balancer. Example: write"]
    #[serde(rename = "writeLBAddressPrefix", default, skip_serializing_if = "Option::is_none")]
    pub write_lb_address_prefix: Option<String>,
    #[doc = "Number of additional threads processing incoming client requests in the enclave (modify with care!)"]
    #[serde(rename = "workerThreads", default, skip_serializing_if = "Option::is_none")]
