...
impl Client {
    ...
    pub fn managed_ccf_client(&self) -> managed_ccf::Client {
        managed_ccf::Client(self.clone())
    }
    ...
    pub mod list {
        ...
        impl RequestBuilder {
                        ...
                        let rsp = match continuation {
                            Some(value) => {
                                ...
                                if !has_api_version_already {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair(azure_core::query_param::API_VERSION, "2024-07-09-preview");
                                }
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path("/providers/Microsoft.ConfidentialLedger/operations");
...
pub mod check_name_availability {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!(
                "/subscriptions/{}/providers/Microsoft.ConfidentialLedger/checkNameAvailability",
...
pub mod ledger {
    ...
    impl Client {
        ...
        #[doc = "Performs the backup operation on a Confidential Ledger Resource."]
        #[doc = "Backs up a Confidential Ledger Resource."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `ledger_name`: Name of the Confidential Ledger"]
        #[doc = "* `confidential_ledger`: Confidential Ledger Backup Request Body"]
        pub fn backup(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            ledger_name: impl Into<String>,
            confidential_ledger: impl Into<models::ConfidentialLedgerBackup>,
        ...
        #[doc = "Performs the restore operation to spin up a newly restored Confidential Ledger Resource."]
        #[doc = "Restores a Confidential Ledger Resource."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `ledger_name`: Name of the Confidential Ledger"]
        #[doc = "* `confidential_ledger`: Confidential Ledger Restore Request Body"]
        pub fn restore(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            ledger_name: impl Into<String>,
            confidential_ledger: impl Into<models::ConfidentialLedgerRestore>,
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    ...
                    &self.subscription_id, &self.resource_group_name, &self.ledger_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
    ...
    pub mod backup {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ConfidentialLedgerBackupResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ConfidentialLedgerBackupResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) ledger_name: String,
            pub(crate) confidential_ledger: models::ConfidentialLedgerBackup,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ConfidentialLedger/ledgers/{}/backup",
                    &self.subscription_id, &self.resource_group_name, &self.ledger_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ConfidentialLedgerBackupResponse>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ConfidentialLedgerBackupResponse>>;
            #[doc = "Returns a future that polls the long running operation and checks for the state via `properties.provisioningState` in the response body."]
            #[doc = ""]
            #[doc = "To only submit the request but not monitor the status of the operation until completion, use `send()` instead."]
            #[doc = ""]
    ...
    pub mod restore {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ConfidentialLedgerRestoreResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ConfidentialLedgerRestoreResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) ledger_name: String,
            pub(crate) confidential_ledger: models::ConfidentialLedgerRestore,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ConfidentialLedger/ledgers/{}/restore",
                    &self.subscription_id, &self.resource_group_name, &self.ledger_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ConfidentialLedgerRestoreResponse>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ConfidentialLedgerRestoreResponse>>;
            #[doc = "Returns a future that polls the long running operation and checks for the state via `properties.provisioningState` in the response body."]
            #[doc = ""]
            #[doc = "To only submit the request but not monitor the status of the operation until completion, use `send()` instead."]
            #[doc = ""]
...
pub mod managed_ccf {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Retrieves information about a Managed CCF resource."]
        #[doc = "Retrieves the properties of a Managed CCF app."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `app_name`: Name of the Managed CCF"]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `app_name`: Name of the Managed CCF"]
        #[doc = "* `managed_ccf`: Managed CCF Create Request Body"]
        pub fn create(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            app_name: impl Into<String>,
            managed_ccf: impl Into<models::ManagedCcf>,
        ) -> create::RequestBuilder {
            create::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
                app_name: app_name.into(),
                managed_ccf: managed_ccf.into(),
            }
        }
        #[doc = "Update Managed CCF properties"]
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `app_name`: Name of the Managed CCF"]
        #[doc = "* `managed_ccf`: Request body for Updating Managed CCF App"]
        pub fn update(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "Deletes a Managed CCF resource."]
        ...
        #[doc = "Retrieves information about all Managed CCF resources under the given subscription and resource group"]
        ...
        #[doc = "Retrieves information about all Managed CCF resources under the given subscription"]
        ...
        #[doc = "Performs the backup operation on a Managed CCF Resource."]
        #[doc = "Backs up a Managed CCF Resource."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `app_name`: Name of the Managed CCF"]
        #[doc = "* `managed_ccf`: Managed CCF Backup Request Body"]
        pub fn backup(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            app_name: impl Into<String>,
            managed_ccf: impl Into<models::ManagedCcfBackup>,
        ) -> backup::RequestBuilder {
            backup::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
        ...
        #[doc = "Performs the restore operation to spin up a newly restored Managed CCF Resource."]
        #[doc = "Restores a Managed CCF Resource."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `app_name`: Name of the Managed CCF"]
        #[doc = "* `managed_ccf`: Managed CCF Restore Request Body"]
        pub fn restore(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            app_name: impl Into<String>,
            managed_ccf: impl Into<models::ManagedCcfRestore>,
        ) -> restore::RequestBuilder {
            restore::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ManagedCcf> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ManagedCcf = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ConfidentialLedger/managedCCFs/{}",
                    &self.subscription_id, &self.resource_group_name, &self.app_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ManagedCcf>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ManagedCcf>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) app_name: String,
            pub(crate) managed_ccf: models::ManagedCcf,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.managed_ccf)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
    ...
    pub mod list_by_resource_group {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ManagedCcfList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ManagedCcfList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::ManagedCcfList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod list_by_subscription {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.ConfidentialLedger/managedCCFs/",
                    &self.subscription_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod backup {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ManagedCcfBackupResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ManagedCcfBackupResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) app_name: String,
            pub(crate) managed_ccf: models::ManagedCcfBackup,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ConfidentialLedger/managedCCFs/{}/backup",
                    &self.subscription_id, &self.resource_group_name, &self.app_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ManagedCcfBackupResponse>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ManagedCcfBackupResponse>>;
            #[doc = "Returns a future that polls the long running operation and checks for the state via `properties.provisioningState` in the response body."]
            #[doc = ""]
            #[doc = "To only submit the request but not monitor the status of the operation until completion, use `send()` instead."]
            #[doc = ""]
    ...
    pub mod restore {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ManagedCcfRestoreResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ManagedCcfRestoreResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) app_name: String,
            pub(crate) managed_ccf: models::ManagedCcfRestore,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ConfidentialLedger/managedCCFs/{}/restore",
                    &self.subscription_id, &self.resource_group_name, &self.app_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ManagedCcfRestoreResponse>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ManagedCcfRestoreResponse>>;
            #[doc = "Returns a future that polls the long running operation and checks for the state via `properties.provisioningState` in the response body."]
            #[doc = ""]
            #[doc = "To only submit the request but not monitor the status of the operation until completion, use `send()` instead."]
            #[doc = ""]
