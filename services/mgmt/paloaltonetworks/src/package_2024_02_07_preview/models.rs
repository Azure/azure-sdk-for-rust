...
#[doc = "Cloud Manager Tenant"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CloudManagerTenant {
    #[doc = "Name of Cloud Manager Tenant"]
    pub name: String,
    #[doc = "Cloud Manager Tenant ID"]
    #[serde(rename = "tenantId", default, skip_serializing_if = "Option::is_none")]
    pub tenant_id: Option<String>,
}
impl CloudManagerTenant {
    pub fn new(name: String) -> Self {
        Self { name, tenant_id: None }
    }
}
...
#[doc = "Create Product Serial Number Request status"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ProductSerialNumberRequestStatus {
    #[doc = "allocation status of the product serial number"]
    pub status: String,
}
impl ProductSerialNumberRequestStatus {
    pub fn new(status: String) -> Self {
        Self { status }
    }
}
#[doc = "Product serial and status for the service"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ProductSerialNumberStatus {
    #[doc = "product Serial associated with given resource"]
    #[serde(rename = "serialNumber", default, skip_serializing_if = "Option::is_none")]
    pub serial_number: Option<String>,
    #[doc = "allocation status of the product serial number"]
    pub status: ProductSerialStatusValues,
}
impl ProductSerialNumberStatus {
    pub fn new(status: ProductSerialStatusValues) -> Self {
        Self {
            serial_number: None,
            status,
        }
...
#[doc = "allocation status of the product serial number"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub enum ProductSerialStatusValues {
    Allocated,
    InProgress,
}
#[doc = "security services"]
