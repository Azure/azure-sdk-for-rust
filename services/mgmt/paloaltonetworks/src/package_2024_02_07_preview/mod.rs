                        ...
                        let rsp = match continuation {
                            Some(value) => {
                                ...
                                if !has_api_version_already {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair(azure_core::query_param::API_VERSION, "2024-02-07-preview");
                                }
...
pub mod palo_alto_networks_cloudngfw {
    ...
    impl Client {
        ...
        pub fn create_product_serial_number(&self, subscription_id: impl Into<String>) -> create_product_serial_number::RequestBuilder {
            create_product_serial_number::RequestBuilder {
                client: self.0.clone(),
        ...
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        pub fn list_cloud_manager_tenants(&self, subscription_id: impl Into<String>) -> list_cloud_manager_tenants::RequestBuilder {
            list_cloud_manager_tenants::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
            }
        }
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        pub fn list_product_serial_number_status(
            &self,
            subscription_id: impl Into<String>,
        ) -> list_product_serial_number_status::RequestBuilder {
            list_product_serial_number_status::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
            }
    ...
    pub mod create_product_serial_number {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ProductSerialNumberRequestStatus> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ProductSerialNumberRequestStatus = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/PaloAltoNetworks.Cloudngfw/createProductSerialNumber",
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ProductSerialNumberRequestStatus>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ProductSerialNumberRequestStatus>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_cloud_manager_tenants {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/PaloAltoNetworks.Cloudngfw/listCloudManagerTenants",
                    &self.subscription_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod list_product_serial_number_status {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ProductSerialNumberStatus> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ProductSerialNumberStatus = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/PaloAltoNetworks.Cloudngfw/listProductSerialNumberStatus",
                    &self.subscription_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ProductSerialNumberStatus>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ProductSerialNumberStatus>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
