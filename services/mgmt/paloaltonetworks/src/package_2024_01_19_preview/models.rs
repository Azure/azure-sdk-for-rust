...
pub struct FirewallDeploymentProperties {
    ...
    #[doc = "Boolean Enum"]
    #[serde(rename = "isStrataCloudManaged", default, skip_serializing_if = "Option::is_none")]
    pub is_strata_cloud_managed: Option<BooleanEnum>,
    #[doc = "Panorama Config"]
    #[serde(rename = "panoramaConfig", default, skip_serializing_if = "Option::is_none")]
    pub panorama_config: Option<PanoramaConfig>,
    #[doc = "This field is only present if Strata Cloud Manager is managing the policy for this firewall"]
    #[serde(rename = "strataCloudManagerConfig", default, skip_serializing_if = "Option::is_none")]
    pub strata_cloud_manager_config: Option<StrataCloudManagerConfig>,
...
impl FirewallDeploymentProperties {
    pub fn new(
        ...
        Self {
            ...
            is_strata_cloud_managed: None,
            panorama_config: None,
            strata_cloud_manager_config: None,
...
pub struct FirewallStatusProperty {
    ...
    #[serde(rename = "isStrataCloudManaged", default, skip_serializing_if = "Option::is_none")]
    pub is_strata_cloud_managed: Option<BooleanEnum>,
    #[doc = "Strata Cloud Manager Info"]
    #[serde(rename = "strataCloudManagerInfo", default, skip_serializing_if = "Option::is_none")]
    pub strata_cloud_manager_info: Option<StrataCloudManagerInfo>,
}
...
impl Serialize for RegistrationStatus {
    ...
    {
        match self {
            Self::Registered => serializer.serialize_unit_variant("RegistrationStatus", 0u32, "Registered"),
            Self::NotRegistered => serializer.serialize_unit_variant("RegistrationStatus", 1u32, "Not Registered"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "This field is only present if Strata Cloud Manager is managing the policy for this firewall"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct StrataCloudManagerConfig {
    #[doc = "Strata Cloud Manager name which is intended to manage the policy for this firewall."]
    #[serde(rename = "cloudManagerName")]
    pub cloud_manager_name: String,
}
impl StrataCloudManagerConfig {
    pub fn new(cloud_manager_name: String) -> Self {
        Self { cloud_manager_name }
    }
}
#[doc = "Strata Cloud Manager Info"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct StrataCloudManagerInfo {
    #[doc = "Strata Cloud Manager folder in which this firewall has been placed"]
    #[serde(rename = "folderName", default, skip_serializing_if = "Option::is_none")]
    pub folder_name: Option<String>,
    #[doc = "URL for Strata Cloud Manager"]
    #[serde(rename = "hubUrl", default, skip_serializing_if = "Option::is_none")]
    pub hub_url: Option<String>,
}
impl StrataCloudManagerInfo {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Support information for the service"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SupportInfoModel {
    #[doc = "product SKU associated with given resource"]
    #[serde(rename = "productSku", default, skip_serializing_if = "Option::is_none")]
    pub product_sku: Option<String>,
    #[doc = "product Serial associated with given resource"]
    ...
    pub product_serial: Option<String>,
    #[doc = "Registration status"]
    #[serde(rename = "accountRegistrationStatus", default, skip_serializing_if = "Option::is_none")]
    pub account_registration_status: Option<RegistrationStatus>,
    #[doc = "Support account associated with given resource"]
    #[serde(rename = "accountId", default, skip_serializing_if = "Option::is_none")]
    pub account_id: Option<String>,
    #[doc = "Enable status"]
    #[serde(rename = "freeTrial", default, skip_serializing_if = "Option::is_none")]
    pub free_trial: Option<EnableStatus>,
    #[doc = "Free trial days remaining"]
    #[serde(rename = "freeTrialDaysLeft", default, skip_serializing_if = "Option::is_none")]
    pub free_trial_days_left: Option<i32>,
    #[doc = "Free trial credit remaining"]
    ...
    #[serde(rename = "hubUrl", default, skip_serializing_if = "Option::is_none")]
    pub hub_url: Option<String>,
    #[doc = "credits purchased, unit per hour"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub credits: Option<i32>,
    #[doc = "monthly credit is computed as credits * days in calendar month"]
    #[serde(rename = "monthlyCreditLeft", default, skip_serializing_if = "Option::is_none")]
    pub monthly_credit_left: Option<i32>,
    #[doc = "date in format yyyy-mm-dd"]
    #[serde(rename = "startDateForCredits", default, skip_serializing_if = "Option::is_none")]
    pub start_date_for_credits: Option<String>,
    #[doc = "date in format yyyy-mm-dd"]
    #[serde(rename = "endDateForCredits", default, skip_serializing_if = "Option::is_none")]
    pub end_date_for_credits: Option<String>,
}
impl SupportInfoModel {
    pub fn new() -> Self {
        Self::default()
    }
}
