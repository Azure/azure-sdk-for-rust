...
pub struct VolumeGroupProperties {
    ...
    pub private_endpoint_connections: Vec<PrivateEndpointConnection>,
    #[doc = "A boolean indicating whether or not Data Integrity Check is enabled"]
    #[serde(rename = "enforceDataIntegrityCheckForIscsi", default, skip_serializing_if = "Option::is_none")]
    pub enforce_data_integrity_check_for_iscsi: Option<bool>,
}
