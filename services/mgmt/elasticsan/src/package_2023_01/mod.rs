...
impl Client {
    ...
    pub fn volume_snapshots_client(&self) -> volume_snapshots::Client {
        volume_snapshots::Client(self.clone())
    }
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!("/providers/Microsoft.ElasticSan/operations",));
...
pub mod skus {
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SkuInformationList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SkuInformationList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
...
pub mod elastic_sans {
    ...
    pub mod list_by_subscription {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ElasticSanList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ElasticSanList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ElasticSanList, azure_core::error::Error> {
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ElasticSan> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ElasticSan = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ElasticSan/elasticSans/{}",
                    &self.subscription_id, &self.resource_group_name, &self.elastic_san_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ElasticSan>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ElasticSan>>;
...
pub mod volume_groups {
    ...
    impl Client {
        ...
        pub fn list_by_elastic_san(
            ...
            resource_group_name: impl Into<String>,
            elastic_san_name: impl Into<String>,
        ) -> list_by_elastic_san::RequestBuilder {
            list_by_elastic_san::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod list_by_elastic_san {
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::VolumeGroupList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::VolumeGroup> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::VolumeGroup = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ElasticSan/elasticSans/{}/volumegroups/{}",
                    &self.subscription_id, &self.resource_group_name, &self.elastic_san_name, &self.volume_group_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::VolumeGroup>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::VolumeGroup>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod volumes {
    ...
    impl Client {
        ...
        pub fn list_by_volume_group(
            ...
            elastic_san_name: impl Into<String>,
            volume_group_name: impl Into<String>,
        ) -> list_by_volume_group::RequestBuilder {
            list_by_volume_group::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    ...
                    &self.subscription_id, &self.resource_group_name, &self.elastic_san_name, &self.volume_group_name, &self.volume_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
    ...
    pub mod delete {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) x_ms_force_delete: Option<String>,
        }
        impl RequestBuilder {
            ...
            pub fn x_ms_force_delete(mut self, x_ms_force_delete: impl Into<String>) -> Self {
                self.x_ms_force_delete = Some(x_ms_force_delete.into());
                self
            }
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        if let Some(x_ms_force_delete) = &this.x_ms_force_delete {
                            req.insert_header("x-ms-force-delete", x_ms_force_delete);
                        }
                        let req_body = azure_core::EMPTY_BODY;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
...
pub mod private_endpoint_connections {
    ...
    impl Client {
        ...
        #[doc = "Update the state of specified private endpoint connection associated with the Elastic San"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `elastic_san_name`: The name of the ElasticSan."]
        #[doc = "* `private_endpoint_connection_name`: The name of the Private Endpoint connection."]
        #[doc = "* `parameters`: Private Endpoint Connection Approval object."]
        pub fn create(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "Deletes the specified private endpoint connection associated with the Elastic San"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ElasticSan/elasticSans/{}/privateEndpointConnections/{}",
                    &self.subscription_id, &self.resource_group_name, &self.elastic_san_name, &self.private_endpoint_connection_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
    ...
    pub mod list_by_elastic_san {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ElasticSan/elasticSans/{}/privateLinkResources",
                    &self.subscription_id, &self.resource_group_name, &self.elastic_san_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
...
pub mod volume_snapshots {
    ...
    impl Client {
        ...
        #[doc = "* `elastic_san_name`: The name of the ElasticSan."]
        #[doc = "* `volume_group_name`: The name of the VolumeGroup."]
        #[doc = "* `snapshot_name`: The name of the volume snapshot within the given volume group."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "* `volume_group_name`: The name of the VolumeGroup."]
        #[doc = "* `snapshot_name`: The name of the volume snapshot within the given volume group."]
        #[doc = "* `parameters`: Snapshot object."]
        pub fn create(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
    ...
    pub mod list_by_volume_group {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SnapshotList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SnapshotList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::SnapshotList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ElasticSan/elasticSans/{}/volumegroups/{}/snapshots",
                    &self.subscription_id, &self.resource_group_name, &self.elastic_san_name, &self.volume_group_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ElasticSan/elasticSans/{}/volumegroups/{}/snapshots/{}",
                    &self.subscription_id, &self.resource_group_name, &self.elastic_san_name, &self.volume_group_name, &self.snapshot_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
