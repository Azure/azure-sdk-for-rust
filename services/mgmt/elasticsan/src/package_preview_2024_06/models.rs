...
use std::str::FromStr;
#[doc = "The auto scale settings on Elastic San Appliance."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AutoScaleProperties {
    #[doc = "Scale up properties on Elastic San Appliance."]
    #[serde(rename = "scaleUpProperties", default, skip_serializing_if = "Option::is_none")]
    pub scale_up_properties: Option<ScaleUpProperties>,
}
...
#[doc = "Scale up properties on Elastic San Appliance."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ScaleUpProperties {
    #[doc = "Unused size on Elastic San appliance in TiB."]
    #[serde(rename = "unusedSizeTiB", default, skip_serializing_if = "Option::is_none")]
    pub unused_size_ti_b: Option<i64>,
    #[doc = "Unit to increase Capacity Unit on Elastic San appliance in TiB."]
    #[serde(rename = "increaseCapacityUnitByTiB", default, skip_serializing_if = "Option::is_none")]
    pub increase_capacity_unit_by_ti_b: Option<i64>,
    #[doc = "Maximum scale up size on Elastic San appliance in TiB."]
    #[serde(rename = "capacityUnitScaleUpLimitTiB", default, skip_serializing_if = "Option::is_none")]
    pub capacity_unit_scale_up_limit_ti_b: Option<i64>,
    #[doc = "Enable or Disable scale up setting on Elastic San Appliance."]
    #[serde(rename = "autoScalePolicyEnforcement", default, skip_serializing_if = "Option::is_none")]
    pub auto_scale_policy_enforcement: Option<scale_up_properties::AutoScalePolicyEnforcement>,
}
impl ScaleUpProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod scale_up_properties {
    use super::*;
    #[doc = "Enable or Disable scale up setting on Elastic San Appliance."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "AutoScalePolicyEnforcement")]
    pub enum AutoScalePolicyEnforcement {
        None,
        Enabled,
        Disabled,
        #[serde(skip_deserializing)]
    ...
    impl FromStr for AutoScalePolicyEnforcement {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for AutoScalePolicyEnforcement {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for AutoScalePolicyEnforcement {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::None => serializer.serialize_unit_variant("AutoScalePolicyEnforcement", 0u32, "None"),
                Self::Enabled => serializer.serialize_unit_variant("AutoScalePolicyEnforcement", 1u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("AutoScalePolicyEnforcement", 2u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
