...
pub mod look_up_resource_id {
    ...
    pub async fn post(
        ...
        look_up_resource_id_request: &models::LookUpResourceIdRequest,
    ) -> std::result::Result<models::LookUpResourceIdResponse, post::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!("{}/providers/Microsoft.Support/lookUpResourceId", operation_config.base_path(),);
        ...
        let req_body = azure_core::to_json(look_up_resource_id_request).map_err(post::Error::SerializeError)?;
        req_builder = req_builder.uri(url.as_str());
