...
pub struct CommunicationDetails {
    ...
    pub properties: CommunicationDetailsProperties,
}
impl CommunicationDetails {
    pub fn new(properties: CommunicationDetailsProperties) -> Self {
        Self {
            id: None,
            name: None,
            type_: None,
...
pub struct FileDetailsProperties {
    ...
    #[doc = "Size of each chunk. The size of each chunk should be provided in bytes and must not exceed 2.5 megabytes (MB)."]
    #[serde(rename = "chunkSize", default, skip_serializing_if = "Option::is_none")]
    pub chunk_size: Option<i32>,
    #[doc = "Size of the file to be uploaded. The file size must not exceed 5 MB and should be provided in bytes."]
    #[serde(rename = "fileSize", default, skip_serializing_if = "Option::is_none")]
    pub file_size: Option<i32>,
    #[doc = "Number of chunks to be uploaded. The maximum number of allowed chunks is 2."]
    #[serde(rename = "numberOfChunks", default, skip_serializing_if = "Option::is_none")]
    pub number_of_chunks: Option<i32>,
}
...
pub struct SupportTicketDetails {
    ...
    pub properties: SupportTicketDetailsProperties,
}
impl SupportTicketDetails {
    pub fn new(properties: SupportTicketDetailsProperties) -> Self {
        Self {
            id: None,
            name: None,
            type_: None,
...
pub struct SupportTicketDetailsProperties {
    ...
    #[serde(rename = "advancedDiagnosticConsent")]
    pub advanced_diagnostic_consent: support_ticket_details_properties::AdvancedDiagnosticConsent,
    ...
    #[doc = "This property indicates if support ticket is a temporary ticket."]
    #[serde(rename = "isTemporaryTicket", default, skip_serializing_if = "Option::is_none")]
    pub is_temporary_ticket: Option<support_ticket_details_properties::IsTemporaryTicket>,
...
impl SupportTicketDetailsProperties {
    pub fn new(
        ...
        advanced_diagnostic_consent: support_ticket_details_properties::AdvancedDiagnosticConsent,
...
pub mod support_ticket_details_properties {
    ...
    #[doc = "This property indicates if support ticket is a temporary ticket."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "IsTemporaryTicket")]
    pub enum IsTemporaryTicket {
        Yes,
        No,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for IsTemporaryTicket {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for IsTemporaryTicket {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for IsTemporaryTicket {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Yes => serializer.serialize_unit_variant("IsTemporaryTicket", 0u32, "Yes"),
                Self::No => serializer.serialize_unit_variant("IsTemporaryTicket", 1u32, "No"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Updates severity, ticket status, contact details, advanced diagnostic consent and secondary consent in the support ticket."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
