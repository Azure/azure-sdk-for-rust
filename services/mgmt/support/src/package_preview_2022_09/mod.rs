...
impl Client {
    ...
    pub fn chat_transcripts_client(&self) -> chat_transcripts::Client {
        chat_transcripts::Client(self.clone())
    }
    pub fn chat_transcripts_no_subscription_client(&self) -> chat_transcripts_no_subscription::Client {
        chat_transcripts_no_subscription::Client(self.clone())
    }
    pub fn communications_client(&self) -> communications::Client {
        communications::Client(self.clone())
    }
    pub fn communications_no_subscription_client(&self) -> communications_no_subscription::Client {
        communications_no_subscription::Client(self.clone())
    }
    pub fn file_workspaces_client(&self) -> file_workspaces::Client {
        file_workspaces::Client(self.clone())
    }
    pub fn file_workspaces_no_subscription_client(&self) -> file_workspaces_no_subscription::Client {
        file_workspaces_no_subscription::Client(self.clone())
    }
    pub fn files_client(&self) -> files::Client {
        files::Client(self.clone())
    }
    pub fn files_no_subscription_client(&self) -> files_no_subscription::Client {
        files_no_subscription::Client(self.clone())
    }
    ...
    pub fn support_ticket_chat_transcripts_no_subscription_client(&self) -> support_ticket_chat_transcripts_no_subscription::Client {
        support_ticket_chat_transcripts_no_subscription::Client(self.clone())
    }
    pub fn support_ticket_communications_no_subscription_client(&self) -> support_ticket_communications_no_subscription::Client {
        support_ticket_communications_no_subscription::Client(self.clone())
    }
    pub fn support_tickets_client(&self) -> support_tickets::Client {
        support_tickets::Client(self.clone())
    }
    pub fn support_tickets_no_subscription_client(&self) -> support_tickets_no_subscription::Client {
        support_tickets_no_subscription::Client(self.clone())
    }
}
pub mod operations {
    use super::models;
...
pub mod support_tickets {
    ...
    impl Client {
        ...
        #[doc = "This API allows you to update the severity level, ticket status, advanced diagnostic consent and your contact information in the support ticket.<br/><br/>Note: The severity levels cannot be changed if a support ticket is actively being worked upon by an Azure support engineer. In such a case, contact your support engineer to request severity update by adding a new communication using the Communications API."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `support_ticket_name`: Support ticket name."]
...
pub mod support_tickets_no_subscription {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    impl Client {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `support_ticket_name`: Support ticket name."]
        pub fn get(&self, support_ticket_name: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                support_ticket_name: support_ticket_name.into(),
            }
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/providers/Microsoft.Support/supportTickets", self.client.endpoint(),))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-09-01-preview");
...
pub mod communications_no_subscription {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    impl Client {
        ...
        #[doc = "* `support_ticket_name`: Support ticket name."]
        #[doc = "* `communication_name`: Communication name."]
        pub fn get(&self, support_ticket_name: impl Into<String>, communication_name: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                support_ticket_name: support_ticket_name.into(),
                communication_name: communication_name.into(),
    ...
    pub mod check_name_availability {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/providers/Microsoft.Support/supportTickets/{}/checkNameAvailability",
                    self.client.endpoint(),
                    &self.support_ticket_name
                ))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/providers/Microsoft.Support/supportTickets/{}/communications/{}",
                    self.client.endpoint(),
                    &self.support_ticket_name,
                    &self.communication_name
                ))?;
...
pub mod support_ticket_communications_no_subscription {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    impl Client {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `support_ticket_name`: Support ticket name"]
        pub fn list(&self, support_ticket_name: impl Into<String>) -> list::RequestBuilder {
            list::RequestBuilder {
                client: self.0.clone(),
                support_ticket_name: support_ticket_name.into(),
                top: None,
...
pub mod chat_transcripts {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Lists all chat transcripts for a support ticket under subscription"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `support_ticket_name`: Support ticket name."]
        #[doc = "* `subscription_id`: Azure subscription Id."]
        ...
        #[doc = "Returns chatTranscript details for a support ticket under a subscription."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `support_ticket_name`: Support ticket name."]
        #[doc = "* `chat_transcript_name`: ChatTranscript name."]
        #[doc = "* `subscription_id`: Azure subscription Id."]
        pub fn get(
            &self,
            support_ticket_name: impl Into<String>,
            chat_transcript_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                support_ticket_name: support_ticket_name.into(),
                chat_transcript_name: chat_transcript_name.into(),
                subscription_id: subscription_id.into(),
            }
        }
    }
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ChatTranscriptsListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ChatTranscriptsListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ChatTranscriptsListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/providers/Microsoft.Support/supportTickets/{}/chatTranscripts",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.support_ticket_name
                ))?;
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ChatTranscriptDetails> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ChatTranscriptDetails = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) support_ticket_name: String,
            pub(crate) chat_transcript_name: String,
            pub(crate) subscription_id: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ChatTranscriptDetails>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ChatTranscriptDetails>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod support_ticket_chat_transcripts_no_subscription {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/providers/Microsoft.Support/supportTickets/{}/chatTranscripts",
                    self.client.endpoint(),
                    &self.support_ticket_name
                ))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
...
pub mod chat_transcripts_no_subscription {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    impl Client {
        ...
        #[doc = "* `support_ticket_name`: Support ticket name."]
        #[doc = "* `chat_transcript_name`: ChatTranscript name."]
        pub fn get(&self, support_ticket_name: impl Into<String>, chat_transcript_name: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                support_ticket_name: support_ticket_name.into(),
                chat_transcript_name: chat_transcript_name.into(),
...
pub mod file_workspaces {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets details for a specific file workspace in an Azure subscription."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `file_workspace_name`: File Workspace Name"]
        #[doc = "* `subscription_id`: Azure subscription Id."]
        pub fn get(&self, file_workspace_name: impl Into<String>, subscription_id: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                file_workspace_name: file_workspace_name.into(),
                subscription_id: subscription_id.into(),
            }
        }
        #[doc = "Creates a new file workspace for the specified subscription."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `file_workspace_name`: File workspace name."]
        #[doc = "* `subscription_id`: Azure subscription Id."]
        pub fn create(&self, file_workspace_name: impl Into<String>, subscription_id: impl Into<String>) -> create::RequestBuilder {
            create::RequestBuilder {
                client: self.0.clone(),
                file_workspace_name: file_workspace_name.into(),
                subscription_id: subscription_id.into(),
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::FileWorkspaceDetails> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::FileWorkspaceDetails = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) file_workspace_name: String,
            pub(crate) subscription_id: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/providers/Microsoft.Support/fileWorkspaces/{}",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.file_workspace_name
                ))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::FileWorkspaceDetails>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::FileWorkspaceDetails>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod file_workspaces_no_subscription {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    impl Client {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `file_workspace_name`: File Workspace Name"]
        pub fn get(&self, file_workspace_name: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                file_workspace_name: file_workspace_name.into(),
            }
        ...
        #[doc = "Arguments:"]
        #[doc = "* `file_workspace_name`: File workspace name."]
        pub fn create(&self, file_workspace_name: impl Into<String>) -> create::RequestBuilder {
            create::RequestBuilder {
                client: self.0.clone(),
                file_workspace_name: file_workspace_name.into(),
            }
...
pub mod files {
    ...
    impl Client {
        ...
        #[doc = "* `file_workspace_name`: File Workspace Name"]
        #[doc = "* `subscription_id`: Azure subscription Id."]
        pub fn list(&self, file_workspace_name: impl Into<String>, subscription_id: impl Into<String>) -> list::RequestBuilder {
            list::RequestBuilder {
                client: self.0.clone(),
                file_workspace_name: file_workspace_name.into(),
                subscription_id: subscription_id.into(),
        ...
        pub fn get(
            &self,
            file_workspace_name: impl Into<String>,
        ...
        #[doc = "Creates a new file under a workspace for the specified subscription."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `file_workspace_name`: File workspace name."]
        #[doc = "* `file_name`: File name."]
        #[doc = "* `create_file_parameters`: Create file object"]
        #[doc = "* `subscription_id`: Azure subscription Id."]
        pub fn create(
            &self,
            file_workspace_name: impl Into<String>,
            file_name: impl Into<String>,
            create_file_parameters: impl Into<models::FileDetails>,
            subscription_id: impl Into<String>,
        ) -> create::RequestBuilder {
            create::RequestBuilder {
                client: self.0.clone(),
                file_workspace_name: file_workspace_name.into(),
                file_name: file_name.into(),
                create_file_parameters: create_file_parameters.into(),
                subscription_id: subscription_id.into(),
            }
        }
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `file_workspace_name`: File WorkspaceName"]
        #[doc = "* `file_name`: File Name"]
        #[doc = "* `upload_file`: UploadFile object"]
        #[doc = "* `subscription_id`: Azure subscription Id."]
        pub fn upload(
            &self,
            file_workspace_name: impl Into<String>,
            file_name: impl Into<String>,
            upload_file: impl Into<models::UploadFile>,
            subscription_id: impl Into<String>,
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::FilesListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::FilesListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::FilesListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/providers/Microsoft.Support/fileWorkspaces/{}/files",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.file_workspace_name
                ))?;
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::FileDetails> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::FileDetails = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::FileDetails>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::FileDetails>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) file_workspace_name: String,
            pub(crate) file_name: String,
            pub(crate) create_file_parameters: models::FileDetails,
            pub(crate) subscription_id: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.create_file_parameters)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
    ...
    pub mod upload {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) file_workspace_name: String,
            pub(crate) file_name: String,
            pub(crate) upload_file: models::UploadFile,
            pub(crate) subscription_id: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.upload_file)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/providers/Microsoft.Support/fileWorkspaces/{}/files/{}/upload",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.file_workspace_name,
                    &self.file_name
...
pub mod files_no_subscription {
    ...
    impl Client {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `file_workspace_name`: File Workspace Name"]
        pub fn list(&self, file_workspace_name: impl Into<String>) -> list::RequestBuilder {
            list::RequestBuilder {
                client: self.0.clone(),
                file_workspace_name: file_workspace_name.into(),
            }
        ...
        #[doc = "* `file_workspace_name`: File Workspace Name"]
        #[doc = "* `file_name`: File Name"]
        pub fn get(&self, file_workspace_name: impl Into<String>, file_name: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                file_workspace_name: file_workspace_name.into(),
                file_name: file_name.into(),
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/providers/Microsoft.Support/fileWorkspaces/{}/files",
                    self.client.endpoint(),
                    &self.file_workspace_name
                ))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
    ...
    pub mod upload {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/providers/Microsoft.Support/fileWorkspaces/{}/files/{}/upload",
                    self.client.endpoint(),
                    &self.file_workspace_name,
                    &self.file_name
                ))?;
