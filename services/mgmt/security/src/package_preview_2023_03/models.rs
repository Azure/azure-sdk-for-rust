    ...
    impl Serialize for EnvironmentType {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::GitlabScope => serializer.serialize_unit_variant("EnvironmentType", 4u32, "GitlabScope"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for OfferingType {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::CspmMonitorGitLab => serializer.serialize_unit_variant("OfferingType", 15u32, "CspmMonitorGitLab"),
                Self::DefenderForDevOpsGitLab => serializer.serialize_unit_variant("OfferingType", 16u32, "DefenderForDevOpsGitLab"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
