...
pub mod alert_simulator_request_properties {
    ...
    impl Serialize for Kind {
        ...
        {
            match self {
                Self::Bundles => serializer.serialize_unit_variant("Kind", 0u32, "Bundles"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct ApplicationProperties {
    ...
    #[serde(rename = "sourceResourceType", with = "azure_core::xml::text_content")]
...
pub struct IoTSecuritySolutionProperties {
    ...
    #[serde(
        rename = "unmaskedIpLoggingStatus",
        default,
        skip_serializing_if = "Option::is_none",
        with = "azure_core::xml::text_content"
    )]
...
pub struct RecommendationConfigurationProperties {
    #[doc = "The type of IoT Security recommendation."]
    #[serde(rename = "recommendationType", with = "azure_core::xml::text_content")]
...
pub mod resource_identifier {
    ...
    impl Serialize for Type {
        ...
        {
            match self {
                Self::AzureResource => serializer.serialize_unit_variant("Type", 0u32, "AzureResource"),
                Self::LogAnalytics => serializer.serialize_unit_variant("Type", 1u32, "LogAnalytics"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct SecurityAssessmentMetadataProperties {
    ...
    #[serde(rename = "assessmentType", with = "azure_core::xml::text_content")]
