...
pub mod governance_rules {
    ...
    impl Client {
        #[doc = "Get a list of all relevant governance rules over a scope"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `scope`: The scope of the Governance rules. Valid scopes are: management group (format: 'providers/Microsoft.Management/managementGroups/{managementGroup}'), subscription (format: 'subscriptions/{subscriptionId}'), or security connector (format: 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/securityConnectors/{securityConnectorName})'"]
        ...
        pub fn get(&self, scope: impl Into<String>, rule_id: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                scope: scope.into(),
        ...
        #[doc = "Creates or updates a governance rule over a given scope"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `scope`: The scope of the Governance rules. Valid scopes are: management group (format: 'providers/Microsoft.Management/managementGroups/{managementGroup}'), subscription (format: 'subscriptions/{subscriptionId}'), or security connector (format: 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/securityConnectors/{securityConnectorName})'"]
        #[doc = "* `rule_id`: The governance rule key - unique key for the standard governance rule (GUID)"]
        ...
        #[doc = "* `scope`: The scope of the Governance rules. Valid scopes are: management group (format: 'providers/Microsoft.Management/managementGroups/{managementGroup}'), subscription (format: 'subscriptions/{subscriptionId}'), or security connector (format: 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/securityConnectors/{securityConnectorName})'"]
        #[doc = "* `rule_id`: The governance rule key - unique key for the standard governance rule (GUID)"]
        pub fn delete(&self, scope: impl Into<String>, rule_id: impl Into<String>) -> delete::RequestBuilder {
        ...
        #[doc = "Execute a governance rule"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `scope`: The scope of the Governance rules. Valid scopes are: management group (format: 'providers/Microsoft.Management/managementGroups/{managementGroup}'), subscription (format: 'subscriptions/{subscriptionId}'), or security connector (format: 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/securityConnectors/{securityConnectorName})'"]
        #[doc = "* `rule_id`: The governance rule key - unique key for the standard governance rule (GUID)"]
        pub fn execute(&self, scope: impl Into<String>, rule_id: impl Into<String>) -> execute::RequestBuilder {
        ...
        #[doc = "Get governance rules long run operation result for the requested scope by ruleId and operationId"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `scope`: The scope of the Governance rules. Valid scopes are: management group (format: 'providers/Microsoft.Management/managementGroups/{managementGroup}'), subscription (format: 'subscriptions/{subscriptionId}'), or security connector (format: 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/securityConnectors/{securityConnectorName})'"]
        #[doc = "* `rule_id`: The governance rule key - unique key for the standard governance rule (GUID)"]
        #[doc = "* `operation_id`: The governance rule long running operation unique key"]
        pub fn operation_results(
            &self,
            scope: impl Into<String>,
            rule_id: impl Into<String>,
            operation_id: impl Into<String>,
        ) -> operation_results::RequestBuilder {
            operation_results::RequestBuilder {
                client: self.0.clone(),
                scope: scope.into(),
                rule_id: rule_id.into(),
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        let url = azure_core::Url::parse(&format!(
                            "{}/{}/providers/Microsoft.Security/governanceRules/{}/execute",
                            this.client.endpoint(),
                            &this.scope,
                            &this.rule_id
                        ))?;
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        let url = azure_core::Url::parse(&format!(
                            "{}/{}/providers/Microsoft.Security/governanceRules/{}/operationResults/{}",
                            this.client.endpoint(),
                            &this.scope,
                            &this.rule_id,
                            &this.operation_id
...
pub mod governance_assignments {
    ...
    impl Client {
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `scope`: The scope of the Governance assignments. Valid scopes are: subscription (format: 'subscriptions/{subscriptionId}'), or security connector (format: 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/securityConnectors/{securityConnectorName})'"]
