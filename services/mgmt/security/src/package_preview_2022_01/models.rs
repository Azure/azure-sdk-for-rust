...
pub struct GovernanceAssignmentProperties {
    ...
    #[serde(rename = "remediationDueDate")]
    pub remediation_due_date: String,
...
impl GovernanceAssignmentProperties {
    pub fn new(remediation_due_date: String) -> Self {
        Self {
            owner: None,
...
impl RemediationEta {
    pub fn new(eta: String, justification: String) -> Self {
