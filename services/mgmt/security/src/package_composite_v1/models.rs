...
pub mod alert_properties {
    ...
    impl Serialize for ReportedSeverity {
        ...
        {
            match self {
                Self::Silent => serializer.serialize_unit_variant("ReportedSeverity", 0u32, "Silent"),
                Self::Information => serializer.serialize_unit_variant("ReportedSeverity", 1u32, "Information"),
                Self::Low => serializer.serialize_unit_variant("ReportedSeverity", 2u32, "Low"),
