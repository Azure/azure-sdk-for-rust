...
pub mod source_control_configurations {
    ...
    pub async fn get(
        ...
        let uri_str = & format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/{}/{}/{}/providers/Microsoft.KubernetesConfiguration/sourceControlConfigurations/{}" , & operation_config . base_path , subscription_id , resource_group_name , cluster_rp , cluster_resource_name , cluster_name , source_control_configuration_name) ;
        ...
        match rsp.status() {
            StatusCode::OK => {
                ...
                let rsp_value: SourceControlConfiguration = serde_json::from_slice(&body).context(get::DeserializeError { body })?;
                Ok(rsp_value)
            }
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(get::ResponseBytesError)?;
    ...
    pub async fn create_or_update(
        ...
        req_builder = req_builder.query(&[("api-version", &operation_config.api_version)]);
        req_builder = req_builder.json(source_control_configuration);
    ...
    pub async fn list(
        ...
        let client = &operation_config.client;
        let uri_str = & format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/{}/{}/{}/providers/Microsoft.KubernetesConfiguration/sourceControlConfigurations" , & operation_config . base_path , subscription_id , resource_group_name , cluster_rp , cluster_resource_name , cluster_name) ;
        let mut req_builder = client.get(uri_str);
        if let Some(token) = &operation_config.bearer_access_token {
            req_builder = req_builder.bearer_auth(token);
        }
        ...
        match rsp.status() {
            StatusCode::OK => {
                ...
                let rsp_value: SourceControlConfigurationList = serde_json::from_slice(&body).context(list::DeserializeError { body })?;
                Ok(rsp_value)
            }
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(list::ResponseBytesError)?;
