...
pub struct AzureBlobDefinition {
    ...
    pub service_principal: Option<ServicePrincipalDefinition>,
    ...
    pub managed_identity: Option<ManagedIdentityDefinition>,
...
#[doc = "Parameters to reconcile to the AzureBlob source kind type."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AzureBlobPatchDefinition {
    #[doc = "The URL to sync for the flux configuration Azure Blob storage account."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
    #[doc = "The Azure Blob container name to sync from the url endpoint for the flux configuration."]
    ...
    #[doc = "Parameters to authenticate using Service Principal."]
    #[serde(rename = "servicePrincipal", default, skip_serializing_if = "Option::is_none")]
    pub service_principal: Option<ServicePrincipalPatchDefinition>,
    #[doc = "The account key (shared key) to access the storage account"]
    #[serde(rename = "accountKey", default, skip_serializing_if = "Option::is_none")]
    pub account_key: Option<String>,
    #[doc = "The Shared Access token to access the storage container"]
    ...
    #[doc = "Parameters to authenticate using a Managed Identity."]
    #[serde(rename = "managedIdentity", default, skip_serializing_if = "Option::is_none")]
    pub managed_identity: Option<ManagedIdentityPatchDefinition>,
    #[doc = "Name of a local secret on the Kubernetes cluster to use as the authentication secret rather than the managed or user-provided configuration secrets."]
    #[serde(rename = "localAuthRef", default, skip_serializing_if = "Option::is_none")]
    pub local_auth_ref: Option<String>,
}
impl AzureBlobPatchDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub mod flux_configuration {
    ...
    pub struct Properties {
        ...
        pub azure_blob: Option<AzureBlobDefinition>,
        #[doc = "Parameters to reconcile to the OCIRepository source kind type."]
        #[serde(rename = "ociRepository", default, skip_serializing_if = "Option::is_none")]
        pub oci_repository: Option<OciRepositoryDefinition>,
        ...
        #[doc = "Whether flux configuration deployment should wait for cluster to reconcile the kustomizations."]
        #[serde(rename = "waitForReconciliation", default, skip_serializing_if = "Option::is_none")]
        pub wait_for_reconciliation: Option<bool>,
        #[doc = "Maximum duration to wait for flux configuration reconciliation. E.g PT1H, PT5M, P1D"]
        #[serde(rename = "reconciliationWaitDuration", default, skip_serializing_if = "Option::is_none")]
        pub reconciliation_wait_duration: Option<String>,
        #[doc = "Compliance state of the cluster object."]
        #[serde(rename = "complianceState", default, skip_serializing_if = "Option::is_none")]
...
pub mod flux_configuration_patch {
    ...
    pub struct Properties {
        ...
        #[doc = "Parameters to reconcile to the AzureBlob source kind type."]
        #[serde(rename = "azureBlob", default, skip_serializing_if = "Option::is_none")]
        pub azure_blob: Option<AzureBlobPatchDefinition>,
        #[doc = "Parameters to reconcile to the OCIRepository source kind type."]
        #[serde(rename = "ociRepository", default, skip_serializing_if = "Option::is_none")]
        pub oci_repository: Option<OciRepositoryPatchDefinition>,
        #[doc = "Array of kustomizations used to reconcile the artifact pulled by the source type on the cluster."]
        #[serde(default, skip_serializing_if = "Option::is_none")]
        pub kustomizations: Option<serde_json::Value>,
        #[doc = "Key-value pairs of protected configuration settings for the configuration"]
...
pub struct KustomizationDefinition {
    ...
    #[doc = "Enable/disable health check for all Kubernetes objects created by this Kustomization."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub wait: Option<bool>,
    #[doc = "The postBuild definitions defining variable substitutions for this Kustomization after kustomize build."]
    #[serde(rename = "postBuild", default, skip_serializing_if = "Option::is_none")]
    pub post_build: Option<PostBuildDefinition>,
}
...
pub struct KustomizationPatchDefinition {
    ...
    #[doc = "The postBuild definitions defining variable substitutions for this Kustomization after kustomize build."]
    #[serde(rename = "postBuild", default, skip_serializing_if = "Option::is_none")]
    pub post_build: Option<PostBuildPatchDefinition>,
}
...
#[doc = "Parameters to specify which layer to pull from the OCI artifact. By default, the first layer in the artifact is pulled."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct LayerSelectorDefinition {
    #[doc = "The first layer matching the specified media type will be used."]
    #[serde(rename = "mediaType", default, skip_serializing_if = "Option::is_none")]
    pub media_type: Option<String>,
    #[doc = "The operation to be performed on the selected layer. The default value is 'extract', but it can be set to 'copy'."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub operation: Option<OperationDefinition>,
}
impl LayerSelectorDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Parameters to specify which layer to pull from the OCI artifact. By default, the first layer in the artifact is pulled."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct LayerSelectorPatchDefinition {
    #[doc = "The first layer matching the specified media type will be used."]
    #[serde(rename = "mediaType", default, skip_serializing_if = "Option::is_none")]
    pub media_type: Option<String>,
    #[doc = "The operation to be performed on the selected layer. The default value is 'extract', but it can be set to 'copy'."]
...
impl LayerSelectorPatchDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Parameters to authenticate using a Managed Identity."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ManagedIdentityPatchDefinition {
    #[doc = "The client Id for authenticating a Managed Identity."]
    #[serde(rename = "clientId", default, skip_serializing_if = "Option::is_none")]
    pub client_id: Option<String>,
}
impl ManagedIdentityPatchDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "MatchOIDCIdentity defines the criteria for matching the identity while verifying an OCI artifact."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MatchOidcIdentityDefinition {
    #[doc = "The regex pattern to match against to verify the OIDC issuer."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub issuer: Option<String>,
    #[doc = "The regex pattern to match against to verify the identity subject."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub subject: Option<String>,
}
impl MatchOidcIdentityDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "MatchOIDCIdentity defines the criteria for matching the identity while verifying an OCI artifact."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MatchOidcIdentityPatchDefinition {
    #[doc = "The regex pattern to match against to verify the OIDC issuer."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub issuer: Option<String>,
    #[doc = "The regex pattern to match against to verify the identity subject."]
...
impl MatchOidcIdentityPatchDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Parameters to reconcile to the OCIRepository source kind type."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OciRepositoryDefinition {
    #[doc = "The URL to sync for the flux configuration OCI repository."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
    #[doc = "The maximum time to attempt to reconcile the cluster OCI repository source with the remote."]
    #[serde(rename = "timeoutInSeconds", default, skip_serializing_if = "Option::is_none")]
    pub timeout_in_seconds: Option<i64>,
    #[doc = "The interval at which to re-reconcile the cluster OCI repository source with the remote."]
    #[serde(rename = "syncIntervalInSeconds", default, skip_serializing_if = "Option::is_none")]
    pub sync_interval_in_seconds: Option<i64>,
    #[doc = "The source reference for the OCIRepository object."]
    #[serde(rename = "repositoryRef", default, skip_serializing_if = "Option::is_none")]
    pub repository_ref: Option<OciRepositoryRefDefinition>,
    #[doc = "Parameters to specify which layer to pull from the OCI artifact. By default, the first layer in the artifact is pulled."]
    #[serde(rename = "layerSelector", default, skip_serializing_if = "Option::is_none")]
    pub layer_selector: Option<LayerSelectorDefinition>,
    #[doc = "Parameters to verify the authenticity of an OCI Artifact."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub verify: Option<VerifyDefinition>,
    #[doc = "Specify whether to allow connecting to a non-TLS HTTP container registry."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub insecure: Option<bool>,
    #[doc = "Specifies whether to use Workload Identity to authenticate with the OCI repository."]
    #[serde(rename = "useWorkloadIdentity", default, skip_serializing_if = "Option::is_none")]
    pub use_workload_identity: Option<bool>,
    #[doc = "The service account name to authenticate with the OCI repository."]
    #[serde(rename = "serviceAccountName", default, skip_serializing_if = "Option::is_none")]
    pub service_account_name: Option<String>,
    #[doc = "Parameters to authenticate using TLS config for OCI repository."]
    #[serde(rename = "tlsConfig", default, skip_serializing_if = "Option::is_none")]
    pub tls_config: Option<TlsConfigDefinition>,
    #[doc = "Name of a local secret on the Kubernetes cluster to use as the authentication secret rather than the managed or user-provided configuration secrets."]
    #[serde(rename = "localAuthRef", default, skip_serializing_if = "Option::is_none")]
    pub local_auth_ref: Option<String>,
}
impl OciRepositoryDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Parameters to reconcile to the OCIRepository source kind type."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OciRepositoryPatchDefinition {
    #[doc = "The URL to sync for the flux configuration OCI repository."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
    #[doc = "The maximum time to attempt to reconcile the cluster OCI repository source with the remote."]
    ...
    #[doc = "The source reference for the OCIRepository object."]
    #[serde(rename = "repositoryRef", default, skip_serializing_if = "Option::is_none")]
    pub repository_ref: Option<OciRepositoryRefPatchDefinition>,
    #[doc = "Parameters to specify which layer to pull from the OCI artifact. By default, the first layer in the artifact is pulled."]
    #[serde(rename = "layerSelector", default, skip_serializing_if = "Option::is_none")]
    pub layer_selector: Option<LayerSelectorPatchDefinition>,
    #[doc = "Parameters to verify the authenticity of an OCI Artifact."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub verify: Option<VerifyPatchDefinition>,
    #[doc = "Specify whether to allow connecting to a non-TLS HTTP container registry."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub insecure: Option<bool>,
    #[doc = "Specifies whether to use Workload Identity to authenticate with the OCI repository."]
    ...
    #[doc = "Parameters to authenticate using TLS config for OCI repository."]
    #[serde(rename = "tlsConfig", default, skip_serializing_if = "Option::is_none")]
    pub tls_config: Option<TlsConfigPatchDefinition>,
    #[doc = "Name of a local secret on the Kubernetes cluster to use as the authentication secret rather than the managed or user-provided configuration secrets."]
    #[serde(rename = "localAuthRef", default, skip_serializing_if = "Option::is_none")]
    pub local_auth_ref: Option<String>,
}
impl OciRepositoryPatchDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The source reference for the OCIRepository object."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OciRepositoryRefDefinition {
    #[doc = "The OCI repository image tag name to pull. This defaults to 'latest'."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tag: Option<String>,
    #[doc = "The semver range used to match against OCI repository tags. This takes precedence over tag."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub semver: Option<String>,
    #[doc = "The image digest to pull from OCI repository, the value should be in the format ‘sha256:’. This takes precedence over semver."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub digest: Option<String>,
}
impl OciRepositoryRefDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The source reference for the OCIRepository object."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OciRepositoryRefPatchDefinition {
    #[doc = "The OCI repository image tag name to pull. This defaults to 'latest'."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tag: Option<String>,
    #[doc = "The semver range used to match against OCI repository tags. This takes precedence over tag."]
...
impl OciRepositoryRefPatchDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "The operation to be performed on the selected layer. The default value is 'extract', but it can be set to 'copy'."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "OperationDefinition")]
...
impl FromStr for OperationDefinition {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
...
impl Serialize for OperationDefinition {
    ...
    {
        match self {
            Self::Extract => serializer.serialize_unit_variant("OperationDefinition", 0u32, "extract"),
            Self::Copy => serializer.serialize_unit_variant("OperationDefinition", 1u32, "copy"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "The postBuild definitions defining variable substitutions for this Kustomization after kustomize build."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PostBuildDefinition {
    #[doc = "Key/value pairs holding the variables to be substituted in this Kustomization."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub substitute: Option<serde_json::Value>,
    #[doc = "Array of ConfigMaps/Secrets from which the variables are substituted for this Kustomization."]
    #[serde(
    ...
    pub substitute_from: Vec<SubstituteFromDefinition>,
}
impl PostBuildDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The postBuild definitions defining variable substitutions for this Kustomization after kustomize build."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PostBuildPatchDefinition {
    #[doc = "Key/value pairs holding the variables to be substituted in this Kustomization."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub substitute: Option<serde_json::Value>,
    #[doc = "Array of ConfigMaps/Secrets from which the variables are substituted for this Kustomization."]
    ...
    pub substitute_from: Vec<SubstituteFromPatchDefinition>,
}
impl PostBuildPatchDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ServicePrincipalDefinition {
    ...
    #[serde(rename = "clientCertificate", default, skip_serializing_if = "Option::is_none")]
    pub client_certificate: Option<String>,
    #[doc = "The password for the certificate used to authenticate a Service Principal "]
    #[serde(rename = "clientCertificatePassword", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "clientCertificateSendChain", default, skip_serializing_if = "Option::is_none")]
    pub client_certificate_send_chain: Option<bool>,
}
...
#[doc = "Parameters to authenticate using Service Principal."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ServicePrincipalPatchDefinition {
    #[doc = "The client Id for authenticating a Service Principal."]
    #[serde(rename = "clientId", default, skip_serializing_if = "Option::is_none")]
    pub client_id: Option<String>,
    #[doc = "The tenant Id for authenticating a Service Principal"]
...
impl ServicePrincipalPatchDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl Serialize for SourceKindDefinition {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::AzureBlob => serializer.serialize_unit_variant("SourceKindDefinition", 2u32, "AzureBlob"),
            Self::OciRepository => serializer.serialize_unit_variant("SourceKindDefinition", 3u32, "OCIRepository"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "Array of ConfigMaps/Secrets from which the variables are substituted for this Kustomization."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SubstituteFromDefinition {
    #[doc = "Define whether it is ConfigMap or Secret that holds the variables to be used in substitution."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kind: Option<String>,
    #[doc = "Name of the ConfigMap/Secret that holds the variables to be used in substitution."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Set to True to proceed without ConfigMap/Secret, if it is not present."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub optional: Option<bool>,
}
impl SubstituteFromDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Array of ConfigMaps/Secrets from which the variables are substituted for this Kustomization."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SubstituteFromPatchDefinition {
    #[doc = "Define whether it is ConfigMap or Secret that holds the variables to be used in substitution."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kind: Option<String>,
    #[doc = "Name of the ConfigMap/Secret that holds the variables to be used in substitution."]
...
impl SubstituteFromPatchDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Parameters to authenticate using TLS config for OCI repository."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct TlsConfigDefinition {
    #[doc = "Base64-encoded certificate used to authenticate a client with the OCI repository."]
    #[serde(rename = "clientCertificate", default, skip_serializing_if = "Option::is_none")]
    pub client_certificate: Option<String>,
    #[doc = "Base64-encoded private key used to authenticate a client with the OCI repository."]
    #[serde(rename = "privateKey", default, skip_serializing_if = "Option::is_none")]
    pub private_key: Option<String>,
    #[doc = "Base64-encoded CA certificate used to verify the server."]
    #[serde(rename = "caCertificate", default, skip_serializing_if = "Option::is_none")]
    pub ca_certificate: Option<String>,
}
impl TlsConfigDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Parameters to authenticate using TLS config for OCI repository."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct TlsConfigPatchDefinition {
    #[doc = "Base64-encoded certificate used to authenticate a client with the OCI repository."]
    #[serde(rename = "clientCertificate", default, skip_serializing_if = "Option::is_none")]
    pub client_certificate: Option<String>,
    #[doc = "Base64-encoded private key used to authenticate a client with the OCI repository."]
...
#[doc = "Parameters to verify the authenticity of an OCI Artifact."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct VerifyDefinition {
    #[doc = "Verification provider name."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub provider: Option<String>,
    #[doc = "An object containing trusted public keys of trusted authors."]
    #[serde(rename = "verificationConfig", default, skip_serializing_if = "Option::is_none")]
    pub verification_config: Option<serde_json::Value>,
    #[doc = "Array defining the criteria for matching the identity while verifying an OCI artifact."]
    #[serde(
    ...
    pub match_oidc_identity: Vec<MatchOidcIdentityDefinition>,
}
impl VerifyDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Parameters to verify the authenticity of an OCI Artifact."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct VerifyPatchDefinition {
    #[doc = "Verification provider name."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub provider: Option<String>,
    #[doc = "An object containing trusted public keys of trusted authors."]
    #[serde(rename = "verificationConfig", default, skip_serializing_if = "Option::is_none")]
    pub verification_config: Option<serde_json::Value>,
    #[doc = "Array defining the criteria for matching the OIDC identity while verifying an OCI artifact."]
    #[serde(
        rename = "matchOidcIdentity",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub match_oidc_identity: Vec<MatchOidcIdentityPatchDefinition>,
}
impl VerifyPatchDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
