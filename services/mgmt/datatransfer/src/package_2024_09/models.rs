...
pub struct ConnectionProperties {
    ...
    #[doc = "The schema URIs for this connection"]
    #[serde(
        rename = "schemaUris",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
...
pub struct FlowProperties {
    ...
    #[doc = "The URI to the customer managed key for this flow"]
    #[serde(rename = "customerManagedKeyVaultUri", default, skip_serializing_if = "Option::is_none")]
    pub customer_managed_key_vault_uri: Option<String>,
}
impl FlowProperties {
    pub fn new() -> Self {
        Self::default()
...
impl Serialize for FlowType {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::Standard => serializer.serialize_unit_variant("FlowType", 8u32, "Standard"),
            Self::StreamingVideo => serializer.serialize_unit_variant("FlowType", 9u32, "StreamingVideo"),
            Self::Opaque => serializer.serialize_unit_variant("FlowType", 10u32, "Opaque"),
            Self::MissionOpaqueXml => serializer.serialize_unit_variant("FlowType", 11u32, "MissionOpaqueXML"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct Schema {
    ...
    #[doc = "The direction of the schema."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub direction: Option<schema::Direction>,
    #[doc = "Uri containing SAS token for the zipped schema"]
    ...
    pub schema_type: Option<schema::SchemaType>,
}
impl Schema {
    pub fn new() -> Self {
        Self::default()
...
pub mod schema {
    ...
    impl Serialize for SchemaType {
        ...
        {
            match self {
                Self::Xsd => serializer.serialize_unit_variant("SchemaType", 0u32, "Xsd"),
                Self::Zip => serializer.serialize_unit_variant("SchemaType", 1u32, "Zip"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
