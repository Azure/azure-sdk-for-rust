...
pub struct CertificateProfileProperties {
    ...
    #[serde(rename = "identityValidationId", default, skip_serializing_if = "Option::is_none")]
    pub identity_validation_id: Option<String>,
...
impl CertificateProfileProperties {
    pub fn new(profile_type: ProfileType) -> Self {
        Self {
            ...
            enhanced_key_usage: None,
            identity_validation_id: None,
