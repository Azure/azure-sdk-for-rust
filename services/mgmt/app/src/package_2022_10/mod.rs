...
pub mod billing_meters {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::BillingMeterCollection>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
...
pub mod connected_environments {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::ConnectedEnvironment>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
...
pub mod connected_environments_storages {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, azure_core::Result<models::ConnectedEnvironmentStoragesCollection>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::ConnectedEnvironmentStorage>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
...
pub mod container_apps {
    ...
    pub mod get_auth_token {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::ContainerAppAuthToken>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
...
pub mod container_apps_diagnostics {
    ...
    pub mod get_detector {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::Diagnostics>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
...
pub mod managed_environment_diagnostics {
    ...
    pub mod list_detectors {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::DiagnosticsCollection>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
...
pub mod managed_environments {
    ...
    pub mod get_auth_token {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::EnvironmentAuthToken>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
