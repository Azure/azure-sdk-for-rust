        ...
        impl Serialize for ComponentType {
                ...
                S: Serializer,
            {
                match self {
                    ...
                    Self::AspireResourceServerApi => serializer.serialize_unit_variant("ComponentType", 1u32, "AspireResourceServerApi"),
                    Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
                }
            }
        }
...
pub struct JavaComponent {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Java Component resource specific properties"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<java_component::Properties>,
}
impl JavaComponent {
    pub fn new() -> Self {
        Self::default()
...
pub mod java_component {
    ...
    pub mod properties {
        ...
        impl Serialize for ComponentType {
            ...
            {
                match self {
                    Self::SpringBootAdmin => serializer.serialize_unit_variant("ComponentType", 0u32, "SpringBootAdmin"),
                    Self::SpringCloudEureka => serializer.serialize_unit_variant("ComponentType", 1u32, "SpringCloudEureka"),
                    Self::SpringCloudConfig => serializer.serialize_unit_variant("ComponentType", 2u32, "SpringCloudConfig"),
                    Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
                }
            }
        }
