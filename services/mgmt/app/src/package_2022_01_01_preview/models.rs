...
pub struct AppRegistration {
    ...
    #[doc = "The app secret ref name that contains the app secret."]
    #[serde(rename = "appSecretRefName", default, skip_serializing_if = "Option::is_none")]
    pub app_secret_ref_name: Option<String>,
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct Apple {
    #[doc = "Indicate whether identity provider is enabled or disabled."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<IdentityProviderState>,
...
pub struct AppleRegistration {
    ...
    #[doc = "The app secret ref name that contains the client secret."]
    #[serde(rename = "clientSecretRefName", default, skip_serializing_if = "Option::is_none")]
    pub client_secret_ref_name: Option<String>,
}
...
#[doc = "Configuration settings for the Azure ContainerApp Authentication / Authorization feature."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AuthConfig {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Auth configuration resource specific properties"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub mod auth_config {
    ...
    pub struct Properties {
        #[doc = "<code>Enabled</code> if the Authentication / Authorization feature is enabled for the current app; otherwise, <code>Disabled</code>."]
        #[serde(default, skip_serializing_if = "Option::is_none")]
        pub state: Option<properties::State>,
        #[doc = "The configuration settings that determines the validation flow of users using ContainerApp Authentication/Authorization."]
        #[serde(rename = "globalValidation", default, skip_serializing_if = "Option::is_none")]
        pub global_validation: Option<GlobalValidation>,
        #[doc = "The configuration settings of each of the identity providers used to configure ContainerApp Authentication/Authorization."]
        #[serde(rename = "identityProviders", default, skip_serializing_if = "Option::is_none")]
        pub identity_providers: Option<IdentityProviders>,
        #[doc = "The configuration settings of the login flow of users using ContainerApp Authentication/Authorization."]
        #[serde(default, skip_serializing_if = "Option::is_none")]
        pub login: Option<Login>,
        #[doc = "The configuration settings of the HTTP requests for authentication and authorization requests made against ContainerApp Authentication/Authorization."]
...
pub struct AzureActiveDirectoryLogin {
    ...
    pub disable_www_authenticate: Option<azure_active_directory_login::DisableWwwAuthenticate>,
}
...
pub mod azure_active_directory_login {
    ...
    #[doc = "<code>true</code> if the www-authenticate provider should be omitted from the request; otherwise, <code>false</code>."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum DisableWwwAuthenticate {
        True,
        False,
    }
}
...
pub struct AzureActiveDirectoryRegistration {
    ...
    #[serde(rename = "clientId", default, skip_serializing_if = "Option::is_none")]
    pub client_id: Option<String>,
    #[doc = "The app secret ref name that contains the client secret of the relying party application."]
    #[serde(rename = "clientSecretRefName", default, skip_serializing_if = "Option::is_none")]
    pub client_secret_ref_name: Option<String>,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AzureStaticWebApp {
    #[doc = "Indicate whether identity provider is enabled or disabled."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<IdentityProviderState>,
    #[doc = "The configuration settings of the registration for the Azure Static Web Apps provider"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub registration: Option<AzureStaticWebAppRegistration>,
}
impl AzureStaticWebApp {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The configuration settings of the registration for the Azure Static Web Apps provider"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AzureStaticWebAppRegistration {
    #[doc = "The Client ID of the app used for login."]
    #[serde(rename = "clientId", default, skip_serializing_if = "Option::is_none")]
    pub client_id: Option<String>,
}
impl AzureStaticWebAppRegistration {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct HttpSettings {
    ...
    pub require_https: Option<http_settings::RequireHttps>,
    #[doc = "The configuration settings of the paths HTTP requests."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub route: Option<HttpSettingsRoute>,
}
impl HttpSettings {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "Indicate whether identity provider is enabled or disabled."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub enum IdentityProviderState {
    Enabled,
    Disabled,
}
#[doc = "The configuration settings of each of the identity providers used to configure ContainerApp Authentication/Authorization."]
...
pub struct IdentityProviders {
    ...
    #[doc = "The configuration settings of the Azure Static Web Apps provider."]
    #[serde(rename = "azureStaticWebApp", default, skip_serializing_if = "Option::is_none")]
    pub azure_static_web_app: Option<AzureStaticWebApp>,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct Login {
    #[doc = "The route that specify the endpoint used for login and logout requests."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub route: Option<LoginRoute>,
    ...
    pub preserve_url_fragments_for_logins: Option<login::PreserveUrlFragmentsForLogins>,
...
pub mod login {
    ...
    #[doc = "<code>True</code> if the fragments from the request are preserved after the login request is made; otherwise, <code>False</code>."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum PreserveUrlFragmentsForLogins {
        True,
        False,
    }
}
...
pub struct TwitterRegistration {
    ...
    #[doc = "The app secret ref name that contains the OAuth 1.0a consumer secret of the Twitter\napplication used for sign-in."]
    #[serde(rename = "consumerSecretRefName", default, skip_serializing_if = "Option::is_none")]
    pub consumer_secret_ref_name: Option<String>,
}
