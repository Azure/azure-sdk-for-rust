...
pub use package_2021_08_31_preview::{models, operations, operations::Client, operations::ClientBuilder};
#[cfg(feature = "package-2021-08-15")]
pub mod package_2021_08_15;
#[cfg(all(feature = "package-2021-08-15", not(feature = "no-default-tag")))]
pub use package_2021_08_15::{models, operations, operations::Client, operations::ClientBuilder};
