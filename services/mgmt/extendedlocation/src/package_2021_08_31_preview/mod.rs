...
pub mod custom_locations {
    ...
    impl Client {
        ...
        pub fn list_enabled_resource_types(
            ...
            resource_group_name: impl Into<String>,
            resource_name: impl Into<String>,
        ) -> list_enabled_resource_types::RequestBuilder {
            list_enabled_resource_types::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        ) -> find_target_resource_group::RequestBuilder {
            find_target_resource_group::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod list_operations {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CustomLocationOperationsList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CustomLocationOperationsList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::CustomLocationOperationsList, azure_core::error::Error> {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!("/providers/Microsoft.ExtendedLocation/operations",));
    ...
    pub mod list_by_subscription {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CustomLocationListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CustomLocationListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::CustomLocationListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CustomLocation> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CustomLocation = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::CustomLocation>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::CustomLocation>>;
    ...
    pub mod list_enabled_resource_types {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::EnabledResourceTypesListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::EnabledResourceTypesListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::EnabledResourceTypesListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod find_target_resource_group {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CustomLocationFindTargetResourceGroupResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CustomLocationFindTargetResourceGroupResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ExtendedLocation/customLocations/{}/findTargetResourceGroup",
                    &self.subscription_id, &self.resource_group_name, &self.resource_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::CustomLocationFindTargetResourceGroupResult>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::CustomLocationFindTargetResourceGroupResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod resource_sync_rules {
    ...
    impl Client {
        ...
        pub fn list_by_custom_location_id(
            ...
            resource_group_name: impl Into<String>,
            resource_name: impl Into<String>,
        ) -> list_by_custom_location_id::RequestBuilder {
            list_by_custom_location_id::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod list_by_custom_location_id {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ResourceSyncRuleListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ResourceSyncRuleListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ResourceSyncRuleListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ResourceSyncRule> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ResourceSyncRule = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ResourceSyncRule>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ResourceSyncRule>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
