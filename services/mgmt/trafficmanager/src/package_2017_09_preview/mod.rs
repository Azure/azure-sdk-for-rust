            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            .query_pairs_mut()
                            .append_pair(azure_core::query_param::API_VERSION, "2017-05-01");
...
pub mod traffic_manager_user_metrics_keys {
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::TrafficManagerUserMetricsKeyModel> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::TrafficManagerUserMetricsKeyModel = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::TrafficManagerUserMetricsKeyModel>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
