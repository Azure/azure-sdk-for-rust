...
pub mod profiles {
    ...
    pub mod check_traffic_manager_relative_dns_name_availability {
        use super::models;
        type Response = models::TrafficManagerNameAvailability;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
            DefaultResponse {
...
pub mod geographic_hierarchies {
    ...
    pub mod get_default {
        use super::models;
        type Response = models::TrafficManagerGeographicHierarchy;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
            DefaultResponse {
...
pub mod heat_map {
    ...
    pub mod get {
        use super::models;
        type Response = models::HeatMapModel;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
            DefaultResponse {
...
pub mod traffic_manager_user_metrics_keys {
    ...
    pub mod get {
        use super::models;
        type Response = models::UserMetricsModel;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
            DefaultResponse {
    ...
    pub mod delete {
        use super::models;
        type Response = models::DeleteOperationResult;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
            DefaultResponse {
