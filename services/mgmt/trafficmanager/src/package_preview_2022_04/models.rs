...
#[serde(remote = "AllowedEndpointRecordType")]
...
impl FromStr for AllowedEndpointRecordType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for AllowedEndpointRecordType {
...
impl Serialize for AllowedEndpointRecordType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::DomainName => serializer.serialize_unit_variant("AllowedEndpointRecordType", 0u32, "DomainName"),
            Self::IPv4Address => serializer.serialize_unit_variant("AllowedEndpointRecordType", 1u32, "IPv4Address"),
            Self::IPv6Address => serializer.serialize_unit_variant("AllowedEndpointRecordType", 2u32, "IPv6Address"),
            Self::Any => serializer.serialize_unit_variant("AllowedEndpointRecordType", 3u32, "Any"),
...
pub struct EndpointProperties {
    ...
    #[doc = "If Always Serve is enabled, probing for endpoint health will be disabled and endpoints will be included in the traffic routing method."]
    #[serde(rename = "alwaysServe", default, skip_serializing_if = "Option::is_none")]
    pub always_serve: Option<endpoint_properties::AlwaysServe>,
}
...
pub mod endpoint_properties {
    ...
    #[doc = "If Always Serve is enabled, probing for endpoint health will be disabled and endpoints will be included in the traffic routing method."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "AlwaysServe")]
    pub enum AlwaysServe {
        Enabled,
        Disabled,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for AlwaysServe {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for AlwaysServe {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for AlwaysServe {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("AlwaysServe", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("AlwaysServe", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
