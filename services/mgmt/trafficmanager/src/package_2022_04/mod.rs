...
pub mod profiles {
    ...
    impl Client {
        ...
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `parameters`: The Traffic Manager name parameters supplied to the CheckTrafficManagerNameAvailability operation."]
        pub fn check_traffic_manager_name_availability_v2(
            &self,
            subscription_id: impl Into<String>,
            parameters: impl Into<models::CheckTrafficManagerRelativeDnsNameAvailabilityParameters>,
        ) -> check_traffic_manager_name_availability_v2::RequestBuilder {
            check_traffic_manager_name_availability_v2::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                parameters: parameters.into(),
    ...
    pub mod check_traffic_manager_name_availability_v2 {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        let url = azure_core::Url::parse(&format!(
                            "{}/subscriptions/{}/providers/Microsoft.Network/checkTrafficManagerNameAvailabilityV2",
                            this.client.endpoint(),
                            &this.subscription_id
                        ))?;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Post);
