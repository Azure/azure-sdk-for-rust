...
#[doc = "A server's Advanced Threat Protection."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AdvancedThreatProtection {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Properties of an Advanced Threat Protection setting."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<AdvancedThreatProtectionProperties>,
}
impl AdvancedThreatProtection {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Parameters allowed to update advanced threat protection for a server."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AdvancedThreatProtectionForUpdate {
    #[doc = "Properties of Advanced Threat Protection that can be updated."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<AdvancedThreatProtectionUpdateProperties>,
}
impl AdvancedThreatProtectionForUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AdvancedThreatProtectionListResult {
    ...
    pub value: Vec<AdvancedThreatProtection>,
    #[doc = "Link to retrieve next page of results."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for AdvancedThreatProtectionListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl AdvancedThreatProtectionListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct AdvancedThreatProtectionProperties {
    ...
    #[doc = "Specifies the state of the Advanced Threat Protection, whether it is enabled or disabled on the server."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<AdvancedThreatProtectionState>,
    #[doc = "The current provisioning state."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<AdvancedThreatProtectionProvisioningState>,
}
...
#[doc = "The current provisioning state."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "AdvancedThreatProtectionProvisioningState")]
pub enum AdvancedThreatProtectionProvisioningState {
    Succeeded,
    Updating,
    Canceled,
    Failed,
...
impl FromStr for AdvancedThreatProtectionProvisioningState {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for AdvancedThreatProtectionProvisioningState {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for AdvancedThreatProtectionProvisioningState {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Succeeded => serializer.serialize_unit_variant("AdvancedThreatProtectionProvisioningState", 0u32, "Succeeded"),
            Self::Updating => serializer.serialize_unit_variant("AdvancedThreatProtectionProvisioningState", 1u32, "Updating"),
            Self::Canceled => serializer.serialize_unit_variant("AdvancedThreatProtectionProvisioningState", 2u32, "Canceled"),
            Self::Failed => serializer.serialize_unit_variant("AdvancedThreatProtectionProvisioningState", 3u32, "Failed"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "Specifies the state of the Advanced Threat Protection, whether it is enabled or disabled on the server."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "AdvancedThreatProtectionState")]
pub enum AdvancedThreatProtectionState {
    Enabled,
    Disabled,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for AdvancedThreatProtectionState {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for AdvancedThreatProtectionState {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for AdvancedThreatProtectionState {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Enabled => serializer.serialize_unit_variant("AdvancedThreatProtectionState", 0u32, "Enabled"),
            Self::Disabled => serializer.serialize_unit_variant("AdvancedThreatProtectionState", 1u32, "Disabled"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "Properties of Advanced Threat Protection that can be updated."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AdvancedThreatProtectionUpdateProperties {
    #[doc = "Specifies the state of the Advanced Threat Protection, whether it is enabled or disabled on the server."]
    pub state: AdvancedThreatProtectionState,
}
impl AdvancedThreatProtectionUpdateProperties {
    pub fn new(state: AdvancedThreatProtectionState) -> Self {
        Self { state }
    }
}
...
pub struct Backup {
    ...
    #[doc = "Backup interval hours for the server."]
    #[serde(rename = "backupIntervalHours", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Location capability."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CapabilityPropertiesV2 {
    #[doc = "supported geo backup regions"]
    #[serde(
        rename = "supportedGeoBackupRegions",
        default,
    ...
    pub supported_flexible_server_editions: Vec<ServerEditionCapabilityV2>,
    ...
    pub supported_server_versions: Vec<ServerVersionCapabilityV2>,
}
impl CapabilityPropertiesV2 {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "location capability set"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CapabilitySetsList {
    #[doc = "A list of supported capability sets."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
impl azure_core::Continuable for CapabilitySetsList {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl CapabilitySetsList {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "High availability validation properties of a server"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct HighAvailabilityValidationEstimation {
    #[doc = "Estimated seconds of downtime for the deployment."]
    #[serde(rename = "estimatedDowntime", default, skip_serializing_if = "Option::is_none")]
    pub estimated_downtime: Option<i32>,
    #[doc = "Scheduled Availability zone of the standby server."]
    #[serde(rename = "scheduledStandbyAvailabilityZone", default, skip_serializing_if = "Option::is_none")]
    pub scheduled_standby_availability_zone: Option<String>,
    #[doc = "Expected Availability zone of the standby server."]
    #[serde(rename = "expectedStandbyAvailabilityZone", default, skip_serializing_if = "Option::is_none")]
    pub expected_standby_availability_zone: Option<String>,
}
impl HighAvailabilityValidationEstimation {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Represents a maintenance."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct Maintenance {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "The properties of a maintenance resource."]
    pub properties: MaintenanceProperties,
}
impl Maintenance {
    pub fn new(properties: MaintenanceProperties) -> Self {
        Self {
            proxy_resource: ProxyResource::default(),
            properties,
        }
...
#[doc = "A list of maintenances."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MaintenanceListResult {
    #[doc = "The list of maintenances in a server."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
impl azure_core::Continuable for MaintenanceListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl MaintenanceListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Maintenance policy of a server."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MaintenancePolicy {
    #[doc = "Enum to indicate the patch strategy of a server"]
    #[serde(rename = "patchStrategy", default, skip_serializing_if = "Option::is_none")]
...
pub struct MaintenanceProperties {
    #[doc = "The type of this maintenance."]
    #[serde(rename = "maintenanceType", default, skip_serializing_if = "Option::is_none")]
    pub maintenance_type: Option<MaintenanceType>,
    #[doc = "The current status of this maintenance."]
    #[serde(rename = "maintenanceState", default, skip_serializing_if = "Option::is_none")]
    pub maintenance_state: Option<MaintenanceState>,
    #[doc = "The start time for a maintenance."]
    #[serde(rename = "maintenanceStartTime", default, with = "azure_core::date::rfc3339::option")]
    pub maintenance_start_time: Option<::time::OffsetDateTime>,
    #[doc = "The end time for a maintenance."]
    #[serde(rename = "maintenanceEndTime", default, with = "azure_core::date::rfc3339::option")]
    pub maintenance_end_time: Option<::time::OffsetDateTime>,
    #[doc = "The start time for a maintenance execution."]
    #[serde(rename = "maintenanceExecutionStartTime", default, with = "azure_core::date::rfc3339::option")]
    pub maintenance_execution_start_time: Option<::time::OffsetDateTime>,
    #[doc = "The end time for a maintenance execution."]
    #[serde(rename = "maintenanceExecutionEndTime", default, with = "azure_core::date::rfc3339::option")]
    pub maintenance_execution_end_time: Option<::time::OffsetDateTime>,
    #[doc = "The min time the maintenance can be rescheduled."]
    #[serde(
        rename = "maintenanceAvailableScheduleMinTime",
        default,
        with = "azure_core::date::rfc3339::option"
    )]
    pub maintenance_available_schedule_min_time: Option<::time::OffsetDateTime>,
    #[doc = "The max time the maintenance can be rescheduled."]
    #[serde(
        rename = "maintenanceAvailableScheduleMaxTime",
        default,
        with = "azure_core::date::rfc3339::option"
    )]
    pub maintenance_available_schedule_max_time: Option<::time::OffsetDateTime>,
    #[doc = "The maintenance title."]
    #[serde(rename = "maintenanceTitle", default, skip_serializing_if = "Option::is_none")]
    pub maintenance_title: Option<String>,
    #[doc = "The maintenance description."]
    #[serde(rename = "maintenanceDescription", default, skip_serializing_if = "Option::is_none")]
    pub maintenance_description: Option<String>,
    #[doc = "The current provisioning state."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<MaintenanceProvisioningState>,
}
impl MaintenanceProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The properties of a maintenance update parameter."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MaintenancePropertiesForUpdate {
    #[doc = "The start time for a maintenance."]
    #[serde(rename = "maintenanceStartTime", default, with = "azure_core::date::rfc3339::option")]
    pub maintenance_start_time: Option<::time::OffsetDateTime>,
}
impl MaintenancePropertiesForUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The current provisioning state."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "MaintenanceProvisioningState")]
...
impl Serialize for MaintenanceProvisioningState {
    ...
    {
        match self {
            Self::Succeeded => serializer.serialize_unit_variant("MaintenanceProvisioningState", 0u32, "Succeeded"),
            Self::Creating => serializer.serialize_unit_variant("MaintenanceProvisioningState", 1u32, "Creating"),
            Self::Deleting => serializer.serialize_unit_variant("MaintenanceProvisioningState", 2u32, "Deleting"),
            Self::Failed => serializer.serialize_unit_variant("MaintenanceProvisioningState", 3u32, "Failed"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl Serialize for MaintenanceState {
    ...
    {
        match self {
            Self::Scheduled => serializer.serialize_unit_variant("MaintenanceState", 0u32, "Scheduled"),
            Self::ReScheduled => serializer.serialize_unit_variant("MaintenanceState", 1u32, "ReScheduled"),
            Self::InPreparation => serializer.serialize_unit_variant("MaintenanceState", 2u32, "InPreparation"),
            Self::Processing => serializer.serialize_unit_variant("MaintenanceState", 3u32, "Processing"),
            Self::Completed => serializer.serialize_unit_variant("MaintenanceState", 4u32, "Completed"),
            Self::Canceled => serializer.serialize_unit_variant("MaintenanceState", 5u32, "Canceled"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl Serialize for MaintenanceType {
    ...
    {
        match self {
            Self::RoutineMaintenance => serializer.serialize_unit_variant("MaintenanceType", 0u32, "RoutineMaintenance"),
            Self::MinorVersionUpgrade => serializer.serialize_unit_variant("MaintenanceType", 1u32, "MinorVersionUpgrade"),
            Self::SecurityPatches => serializer.serialize_unit_variant("MaintenanceType", 2u32, "SecurityPatches"),
            Self::HotFixes => serializer.serialize_unit_variant("MaintenanceType", 3u32, "HotFixes"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "Represents a maintenance update parameter."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MaintenanceUpdate {
    #[doc = "The properties of a maintenance update parameter."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<MaintenancePropertiesForUpdate>,
}
...
#[doc = "Identifies the type of source operation"]
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "objectType")]
pub enum OperationProgressResponseTypeUnion {}
#[doc = "Represents Operation Results API Response"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct OperationProgressResult {
    #[serde(flatten)]
    pub operation_status_result: OperationStatusResult,
    #[doc = "Represents the response properties specific to the operation"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<OperationProgressResponseTypeUnion>,
}
impl OperationProgressResult {
...
impl<'de> Deserialize<'de> for PatchStrategy {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for PatchStrategy {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Regular => serializer.serialize_unit_variant("PatchStrategy", 0u32, "Regular"),
            Self::VirtualCanary => serializer.serialize_unit_variant("PatchStrategy", 1u32, "VirtualCanary"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct Provisioning {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ProvisioningStateProperties>,
}
impl Provisioning {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "The properties of a server backup."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ServerBackupPropertiesV2 {
    #[doc = "Backup name"]
    #[serde(rename = "backupNameV2", default, skip_serializing_if = "Option::is_none")]
    pub backup_name_v2: Option<String>,
    #[serde(rename = "backupType", default, skip_serializing_if = "Option::is_none")]
    pub backup_type: Option<server_backup_properties_v2::BackupType>,
    #[doc = "Backup completed time (ISO8601 format)."]
    #[serde(rename = "completedTime", default, with = "azure_core::date::rfc3339::option")]
    pub completed_time: Option<::time::OffsetDateTime>,
    #[doc = "Backup source"]
...
impl ServerBackupPropertiesV2 {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod server_backup_properties_v2 {
    use super::*;
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "Server backup properties"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ServerBackupV2 {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "The properties of a server backup."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ServerBackupPropertiesV2>,
}
impl ServerBackupV2 {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "A list of server backups."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ServerBackupV2ListResult {
    #[doc = "The list of backups of a server."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub value: Vec<ServerBackupV2>,
    #[doc = "The link used to get the next page of operations."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ServerBackupV2ListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl ServerBackupV2ListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Parameters to detach Vnet."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ServerDetachVNetParameter {
    #[doc = "Enum to indicate whether value is 'Enabled' or 'Disabled'"]
    #[serde(rename = "publicNetworkAccess", default, skip_serializing_if = "Option::is_none")]
    pub public_network_access: Option<EnableStatusEnum>,
}
impl ServerDetachVNetParameter {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Server edition capabilities."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ServerEditionCapabilityV2 {
    #[doc = "Server edition name"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Default Sku name"]
    #[serde(rename = "defaultSku", default, skip_serializing_if = "Option::is_none")]
    pub default_sku: Option<String>,
    #[doc = "Default storage size"]
    #[serde(rename = "defaultStorageSize", default, skip_serializing_if = "Option::is_none")]
    pub default_storage_size: Option<i32>,
    #[doc = "A list of supported storage editions"]
    #[serde(
        rename = "supportedStorageEditions",
        default,
    ...
    pub supported_skus: Vec<SkuCapabilityV2>,
}
impl ServerEditionCapabilityV2 {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Server Gtid set parameters: Replication with Global Transaction Identifiers."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct ServerProperties {
    ...
    #[doc = "The server database port. Can only be specified when the server is being created."]
    #[serde(rename = "databasePort", default, skip_serializing_if = "Option::is_none")]
    ...
    #[doc = "Maintenance policy of a server."]
    #[serde(rename = "maintenancePolicy", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Server version capabilities."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ServerVersionCapabilityV2 {
    #[doc = "server version"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
impl ServerVersionCapabilityV2 {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct Storage {
    ...
    #[doc = "Enum to indicate whether storage sku value is 'ZoneRedundancy' or 'LocalRedundancy'"]
    #[serde(rename = "storageRedundancy", default, skip_serializing_if = "Option::is_none")]
    pub storage_redundancy: Option<StorageRedundancyEnum>,
}
impl Storage {
    pub fn new() -> Self {
        Self::default()
...
pub struct StorageEditionCapability {
    ...
    #[doc = "Minimal backup interval hours"]
    #[serde(rename = "minBackupIntervalHours", default, skip_serializing_if = "Option::is_none")]
    pub min_backup_interval_hours: Option<i64>,
    #[doc = "Maximum backup interval hours"]
    #[serde(rename = "maxBackupIntervalHours", default, skip_serializing_if = "Option::is_none")]
    pub max_backup_interval_hours: Option<i64>,
}
...
#[doc = "Enum to indicate whether storage sku value is 'ZoneRedundancy' or 'LocalRedundancy'"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "StorageRedundancyEnum")]
pub enum StorageRedundancyEnum {
    LocalRedundancy,
    ZoneRedundancy,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for StorageRedundancyEnum {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for StorageRedundancyEnum {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for StorageRedundancyEnum {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::LocalRedundancy => serializer.serialize_unit_variant("StorageRedundancyEnum", 0u32, "LocalRedundancy"),
            Self::ZoneRedundancy => serializer.serialize_unit_variant("StorageRedundancyEnum", 1u32, "ZoneRedundancy"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "The properties of a server backup."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ProvisioningStateProperties {
    #[doc = "The current provisioning state."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<ProvisioningState>,
}
impl ProvisioningStateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
