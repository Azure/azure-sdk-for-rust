...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ServerUpgradeParameters {
    #[doc = "The properties that can be updated for a server."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<server_upgrade_parameters::Properties>,
}
impl ServerUpgradeParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod server_upgrade_parameters {
    use super::*;
    #[doc = "The properties that can be updated for a server."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
    pub struct Properties {
        #[doc = "Represents an server storage profile."]
