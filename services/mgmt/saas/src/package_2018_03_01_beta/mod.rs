...
pub mod operations {
    ...
    pub mod list {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SaasAppOperationsResponseWithContinuation> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SaasAppOperationsResponseWithContinuation = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::SaasAppOperationsResponseWithContinuation, azure_core::error::Error> {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!("/providers/Microsoft.SaaS/operations",));
...
pub mod applications {
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SaasAppResponseWithContinuation> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SaasAppResponseWithContinuation = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::SaasAppResponseWithContinuation, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
...
pub mod saa_s {
    ...
    impl Client {
        ...
        pub fn get_resource(&self, resource_id: impl Into<String>) -> get_resource::RequestBuilder {
        ...
        ) -> update_resource::RequestBuilder {
            update_resource::RequestBuilder {
                client: self.0.clone(),
                resource_id: resource_id.into(),
        ...
        pub fn delete(&self, resource_id: impl Into<String>, parameters: impl Into<models::DeleteOptions>) -> delete::RequestBuilder {
        ...
        pub fn create_resource(&self, parameters: impl Into<models::SaasResourceCreation>) -> create_resource::RequestBuilder {
            create_resource::RequestBuilder {
                client: self.0.clone(),
                parameters: parameters.into(),
            }
        }
    ...
    pub mod get_resource {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SaasResource> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SaasResource = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.SaaS/saasresources/{}", &self.resource_id));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2018-03-01-beta");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::SaasResource>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::SaasResource>>;
    ...
    pub mod create_resource {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.SaaS/saasresources",));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2018-03-01-beta");
...
pub mod saas_resources {
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SaasResourceResponseWithContinuation> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SaasResourceResponseWithContinuation = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::SaasResourceResponseWithContinuation, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
...
impl Client {
    ...
    #[doc = "Arguments:"]
    #[doc = "* `resource_id`: The Saas resource ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000)"]
    pub fn saas_resource_list_access_token(&self, resource_id: impl Into<String>) -> saas_resource_list_access_token::RequestBuilder {
        saas_resource_list_access_token::RequestBuilder {
            client: self.clone(),
            resource_id: resource_id.into(),
        }
    }
...
pub mod saas_resource_list_access_token {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
        pub async fn into_body(self) -> azure_core::Result<models::AccessTokenResult> {
            let bytes = self.0.into_body().collect().await?;
            let body: models::AccessTokenResult = serde_json::from_slice(&bytes)?;
            Ok(body)
        }
        pub fn into_raw_response(self) -> azure_core::Response {
            self.0
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::AccessTokenResult>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::AccessTokenResult>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod saas_subscription_level {
    ...
    impl Client {
        ...
        pub fn list_access_token(
            ...
            resource_group_name: impl Into<String>,
            resource_name: impl Into<String>,
        ) -> list_access_token::RequestBuilder {
            list_access_token::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
...
pub mod saa_s_operation {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.SaaS/operationResults/{}", &self.operation_id));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2018-03-01-beta");
