...
#[doc = "Policy Type of the Security Policy"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
impl Serialize for PolicyType {
    ...
    {
        match self {
            Self::Waf => serializer.serialize_unit_variant("PolicyType", 0u32, "waf"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SecurityPolicyConfigurations {
    #[doc = "Web Application Firewall Security Policy"]
    #[serde(rename = "wafSecurityPolicy", default, skip_serializing_if = "Option::is_none")]
    pub waf_security_policy: Option<WafSecurityPolicy>,
}
impl SecurityPolicyConfigurations {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "SecurityPolicyConfigurations Subresource of Traffic Controller."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SecurityPolicyConfigurationsUpdate {
    #[doc = "Web Application Firewall Security Policy"]
    #[serde(rename = "wafSecurityPolicy", default, skip_serializing_if = "Option::is_none")]
    pub waf_security_policy: Option<WafSecurityPolicyUpdate>,
}
impl SecurityPolicyConfigurationsUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The response of a SecurityPolicy list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecurityPolicyListResult {
    #[doc = "The SecurityPolicy items on this page"]
...
impl SecurityPolicyListResult {
    pub fn new(value: Vec<SecurityPolicy>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "SecurityPolicy Properties."]
...
#[doc = "The type used for update operations of the SecurityPolicy."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SecurityPolicyUpdate {
    #[doc = "Resource tags."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<serde_json::Value>,
    #[doc = "The updatable properties of the SecurityPolicy."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<SecurityPolicyUpdateProperties>,
}
impl SecurityPolicyUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct SecurityPolicyUpdateProperties {
    #[doc = "Web Application Firewall Policy"]
    #[serde(rename = "wafPolicy", default, skip_serializing_if = "Option::is_none")]
    pub waf_policy: Option<WafPolicyUpdate>,
}
...
pub struct TrafficControllerProperties {
    ...
    #[serde(
        rename = "securityPolicies",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub security_policies: Vec<ResourceId>,
    #[doc = "SecurityPolicyConfigurations Subresource of Traffic Controller."]
    #[serde(rename = "securityPolicyConfigurations", default, skip_serializing_if = "Option::is_none")]
    pub security_policy_configurations: Option<SecurityPolicyConfigurations>,
    #[doc = "Resource Provisioning State Enum"]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<ProvisioningState>,
}
...
pub struct TrafficControllerUpdateProperties {
    #[doc = "SecurityPolicyConfigurations Subresource of Traffic Controller."]
    #[serde(rename = "securityPolicyConfigurations", default, skip_serializing_if = "Option::is_none")]
    pub security_policy_configurations: Option<SecurityPolicyConfigurationsUpdate>,
}
...
#[doc = "Web Application Firewall Policy"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct WafPolicyUpdate {
    #[doc = "Resource ID of the WAF"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
}
impl WafPolicyUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Web Application Firewall Security Policy"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct WafSecurityPolicy {
    #[doc = "Resource ID of the Waf Security Policy"]
    pub id: String,
}
impl WafSecurityPolicy {
    pub fn new(id: String) -> Self {
        Self { id }
    }
}
#[doc = "Web Application Firewall Security Policy"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct WafSecurityPolicyUpdate {
    #[doc = "Resource ID of the Waf Security Policy"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
}
impl WafSecurityPolicyUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
