...
#[doc = "The response of a Traffic Controller Association list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub enum FrontendIpAddressVersion {
    IPv4,
    IPv6,
}
#[doc = "The response of a Traffic Controller Frontend list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "Frontend IP Address."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct FrontendPropertiesIpAddress {
    #[doc = "IP Address."]
    pub id: String,
}
impl FrontendPropertiesIpAddress {
    pub fn new(id: String) -> Self {
        Self { id }
    }
}
...
pub struct FrontendUpdate {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<FrontendUpdateProperties>,
}
impl FrontendUpdate {
    pub fn new() -> Self {
        Self::default()
...
pub struct TrafficControllerUpdate {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<serde_json::Value>,
    #[doc = "The updatable properties of the TrafficController."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<TrafficControllerUpdateProperties>,
}
...
#[doc = "The updatable properties of the TrafficController."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct TrafficControllerUpdateProperties {}
impl TrafficControllerUpdateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
