...
pub struct DataServiceProperties {
    ...
    #[serde(rename = "supportedDataSinkTypes", skip_serializing_if = "Vec::is_empty")]
...
pub struct DataStoreFilter {
    #[serde(rename = "dataStoreTypeId", skip_serializing_if = "Option::is_none")]
...
pub struct DataStoreTypeProperties {
    ...
    #[serde(rename = "supportedDataServicesAsSink", skip_serializing_if = "Vec::is_empty")]
...
pub struct JobDefinitionProperties {
    ...
    #[serde(rename = "runLocation", skip_serializing_if = "Option::is_none")]
    pub run_location: Option<job_definition_properties::RunLocation>,
    #[serde(rename = "userConfirmation", skip_serializing_if = "Option::is_none")]
    pub user_confirmation: Option<job_definition_properties::UserConfirmation>,
    #[serde(rename = "dataServiceInput", skip_serializing_if = "Option::is_none")]
...
pub struct JobDetails {
    ...
    #[serde(rename = "itemDetailsLink", skip_serializing_if = "Option::is_none")]
...
pub struct JobProperties {
    ...
    #[serde(rename = "bytesProcessed", skip_serializing_if = "Option::is_none")]
    pub bytes_processed: Option<i64>,
    #[serde(rename = "itemsProcessed", skip_serializing_if = "Option::is_none")]
    pub items_processed: Option<i64>,
    #[serde(rename = "totalBytesToProcess", skip_serializing_if = "Option::is_none")]
    pub total_bytes_to_process: Option<i64>,
    #[serde(rename = "totalItemsToProcess", skip_serializing_if = "Option::is_none")]
...
pub struct JobStages {
    ...
    #[serde(rename = "jobStageDetails", skip_serializing_if = "Option::is_none")]
...
pub struct Schedule {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(rename = "policyList", skip_serializing_if = "Vec::is_empty")]
