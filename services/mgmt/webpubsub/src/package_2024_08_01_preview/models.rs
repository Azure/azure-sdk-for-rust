...
pub struct SharedPrivateLinkResourceProperties {
    ...
    #[doc = "A list of FQDNs for third party private link service"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
pub struct WebPubSubHubProperties {
    ...
    #[doc = "The settings for configuring the WebSocket ping-pong interval in seconds for all clients in the hub. Valid range: 1 to 120. Default to 20 seconds."]
    #[serde(rename = "webSocketKeepAliveIntervalInSeconds", default, skip_serializing_if = "Option::is_none")]
    pub web_socket_keep_alive_interval_in_seconds: Option<i32>,
}
...
pub struct WebPubSubProperties {
    ...
    #[serde(rename = "resourceStopped", default, skip_serializing_if = "Option::is_none")]
    pub resource_stopped: Option<String>,
    #[doc = "SocketIO settings for the resource"]
    #[serde(rename = "socketIO", default, skip_serializing_if = "Option::is_none")]
    pub socket_io: Option<WebPubSubSocketIoSettings>,
}
