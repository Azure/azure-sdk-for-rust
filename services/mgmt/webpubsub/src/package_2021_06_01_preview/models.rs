...
#[doc = "Diagnostic configuration of a Microsoft.SignalRService resource. Used together with Azure monitor DiagnosticSettings."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DiagnosticConfiguration {
    #[doc = "Indicate whether or not enable Connectivity logs.\r\nAvailable values: Enabled, Disabled.\r\nCase insensitive."]
    #[serde(rename = "enableConnectivityLogs", default, skip_serializing_if = "Option::is_none")]
    pub enable_connectivity_logs: Option<String>,
    #[doc = "Indicate whether or not enable Messaging logs.\r\nAvailable values: Enabled, Disabled.\r\nCase insensitive."]
    #[serde(rename = "enableMessagingLogs", default, skip_serializing_if = "Option::is_none")]
    pub enable_messaging_logs: Option<String>,
    #[doc = "Indicate whether or not enable Live Trace. \r\nAvailable values: Enabled, Disabled. \r\nCase insensitive. \r\nLive Trace allows you to know what's happening inside Azure SignalR service, it will give you live traces in real time, it will be helpful when you developing your own Azure SignalR based web application or self-troubleshooting some issues."]
    #[serde(rename = "enableLiveTrace", default, skip_serializing_if = "Option::is_none")]
    pub enable_live_trace: Option<String>,
}
...
#[doc = "The settings for event handler in webpubsub service"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EventHandlerSettings {
    #[doc = "Get or set the EventHandler items. The key is the hub name and the value is the corresponding EventHandlerTemplate."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "EventHandler template item settings."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
pub struct WebPubSubProperties {
    ...
    #[doc = "Diagnostic configuration of a Microsoft.SignalRService resource. Used together with Azure monitor DiagnosticSettings."]
    #[serde(rename = "diagnosticConfiguration", default, skip_serializing_if = "Option::is_none")]
    pub diagnostic_configuration: Option<DiagnosticConfiguration>,
    #[doc = "The settings for event handler in webpubsub service"]
