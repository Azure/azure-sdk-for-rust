...
pub mod web_pub_sub_custom_certificates {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::CustomCertificate>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
...
pub mod web_pub_sub_hubs {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::WebPubSubHub>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
