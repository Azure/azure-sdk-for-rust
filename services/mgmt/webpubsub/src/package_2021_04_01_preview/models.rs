...
impl Serialize for FeatureFlags {
    ...
    {
        match self {
            Self::EnableConnectivityLogs => serializer.serialize_unit_variant("FeatureFlags", 0u32, "EnableConnectivityLogs"),
            Self::EnableMessagingLogs => serializer.serialize_unit_variant("FeatureFlags", 1u32, "EnableMessagingLogs"),
            Self::EnableLiveTrace => serializer.serialize_unit_variant("FeatureFlags", 2u32, "EnableLiveTrace"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
