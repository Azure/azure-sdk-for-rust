...
#[doc = "Result of listing enrollment accounts."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "An enrollment account resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EnrollmentAccountSummary {
    #[serde(flatten)]
    pub resource: Resource,
    #[doc = "The properties of the enrollment account."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct EnrollmentAccountSummaryProperties {
    #[doc = "The account owner's principal name."]
