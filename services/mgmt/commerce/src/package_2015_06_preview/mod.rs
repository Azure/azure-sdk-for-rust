...
pub mod usage_aggregates {
    ...
    pub mod list {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::UsageAggregationListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::UsageAggregationListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::UsageAggregationListResult, azure_core::error::Error> {
...
pub mod rate_card {
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ResourceRateCardInfo> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ResourceRateCardInfo = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ResourceRateCardInfo>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::ResourceRateCardInfo>>;
