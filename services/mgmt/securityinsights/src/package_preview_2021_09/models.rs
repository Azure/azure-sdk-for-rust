...
pub mod alert_rule_template_properties_base {
    ...
    impl Serialize for Status {
        ...
        {
            match self {
                Self::Installed => serializer.serialize_unit_variant("Status", 0u32, "Installed"),
                Self::Available => serializer.serialize_unit_variant("Status", 1u32, "Available"),
                Self::NotAvailable => serializer.serialize_unit_variant("Status", 2u32, "NotAvailable"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
impl Serialize for AttackTactic {
    ...
    {
        match self {
            Self::InitialAccess => serializer.serialize_unit_variant("AttackTactic", 0u32, "InitialAccess"),
            Self::Execution => serializer.serialize_unit_variant("AttackTactic", 1u32, "Execution"),
            Self::Persistence => serializer.serialize_unit_variant("AttackTactic", 2u32, "Persistence"),
            Self::PrivilegeEscalation => serializer.serialize_unit_variant("AttackTactic", 3u32, "PrivilegeEscalation"),
            Self::DefenseEvasion => serializer.serialize_unit_variant("AttackTactic", 4u32, "DefenseEvasion"),
            Self::CredentialAccess => serializer.serialize_unit_variant("AttackTactic", 5u32, "CredentialAccess"),
            Self::Discovery => serializer.serialize_unit_variant("AttackTactic", 6u32, "Discovery"),
            Self::LateralMovement => serializer.serialize_unit_variant("AttackTactic", 7u32, "LateralMovement"),
            Self::Collection => serializer.serialize_unit_variant("AttackTactic", 8u32, "Collection"),
            Self::Exfiltration => serializer.serialize_unit_variant("AttackTactic", 9u32, "Exfiltration"),
            Self::CommandAndControl => serializer.serialize_unit_variant("AttackTactic", 10u32, "CommandAndControl"),
            Self::Impact => serializer.serialize_unit_variant("AttackTactic", 11u32, "Impact"),
            Self::PreAttack => serializer.serialize_unit_variant("AttackTactic", 12u32, "PreAttack"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::IncidentTactics => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 4u32, "IncidentTactics")
            }
            ...
            Self::IncidentProviderName => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 6u32, "IncidentProviderName")
            }
            Self::AccountAadTenantId => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 7u32, "AccountAadTenantId")
            }
            Self::AccountAadUserId => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 8u32, "AccountAadUserId")
            }
            Self::AccountName => serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 9u32, "AccountName"),
            Self::AccountNtDomain => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 10u32, "AccountNTDomain")
            }
            Self::AccountPuid => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 11u32, "AccountPUID")
            }
            Self::AccountSid => serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 12u32, "AccountSid"),
            Self::AccountObjectGuid => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 13u32, "AccountObjectGuid")
            }
            Self::AccountUpnSuffix => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 14u32, "AccountUPNSuffix")
            }
            Self::AzureResourceResourceId => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 15u32, "AzureResourceResourceId")
            }
            ...
            Self::CloudApplicationAppId => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 17u32, "CloudApplicationAppId")
            }
            Self::CloudApplicationAppName => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 18u32, "CloudApplicationAppName")
            }
            Self::DnsDomainName => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 19u32, "DNSDomainName")
            }
            Self::FileDirectory => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 20u32, "FileDirectory")
            }
            Self::FileName => serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 21u32, "FileName"),
            Self::FileHashValue => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 22u32, "FileHashValue")
            }
            Self::HostAzureId => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 23u32, "HostAzureID")
            }
            Self::HostName => serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 24u32, "HostName"),
            Self::HostNetBiosName => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 25u32, "HostNetBiosName")
            }
            Self::HostNtDomain => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 26u32, "HostNTDomain")
            }
            Self::HostOsVersion => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 27u32, "HostOSVersion")
            }
            Self::IoTDeviceId => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 28u32, "IoTDeviceId")
            }
            Self::IoTDeviceName => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 29u32, "IoTDeviceName")
            }
            Self::IoTDeviceType => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 30u32, "IoTDeviceType")
            }
            Self::IoTDeviceVendor => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 31u32, "IoTDeviceVendor")
            }
            Self::IoTDeviceModel => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 32u32, "IoTDeviceModel")
            }
            ...
            Self::IpAddress => serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 34u32, "IPAddress"),
            Self::MailboxDisplayName => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 35u32, "MailboxDisplayName")
            }
            Self::MailboxPrimaryAddress => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 36u32, "MailboxPrimaryAddress")
            }
            Self::MailboxUpn => serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 37u32, "MailboxUPN"),
            ...
            Self::MailMessageRecipient => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 40u32, "MailMessageRecipient")
            }
            Self::MailMessageSenderIp => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 41u32, "MailMessageSenderIP")
            }
            Self::MailMessageSubject => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 42u32, "MailMessageSubject")
            }
            Self::MailMessageP1Sender => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 43u32, "MailMessageP1Sender")
            }
            Self::MailMessageP2Sender => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 44u32, "MailMessageP2Sender")
            }
            Self::MalwareCategory => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 45u32, "MalwareCategory")
            }
            Self::MalwareName => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 46u32, "MalwareName")
            }
            Self::ProcessCommandLine => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 47u32, "ProcessCommandLine")
            }
            Self::ProcessId => serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 48u32, "ProcessId"),
            Self::RegistryKey => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 49u32, "RegistryKey")
            }
            Self::RegistryValueData => {
                serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 50u32, "RegistryValueData")
            }
            Self::Url => serializer.serialize_unit_variant("AutomationRulePropertyConditionSupportedProperty", 51u32, "Url"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
        ...
        impl Serialize for Operator {
                ...
                S: Serializer,
            {
                match self {
                    ...
                    Self::NotContains => serializer.serialize_unit_variant("Operator", 3u32, "NotContains"),
                    Self::StartsWith => serializer.serialize_unit_variant("Operator", 4u32, "StartsWith"),
                    Self::NotStartsWith => serializer.serialize_unit_variant("Operator", 5u32, "NotStartsWith"),
                    Self::EndsWith => serializer.serialize_unit_variant("Operator", 6u32, "EndsWith"),
                    Self::NotEndsWith => serializer.serialize_unit_variant("Operator", 7u32, "NotEndsWith"),
                    Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
                }
            }
        }
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::AmazonWebServicesCloudTrail => {
                serializer.serialize_unit_variant("DataConnectorKind", 8u32, "AmazonWebServicesCloudTrail")
            }
            Self::AmazonWebServicesS3 => serializer.serialize_unit_variant("DataConnectorKind", 9u32, "AmazonWebServicesS3"),
            Self::AzureAdvancedThreatProtection => {
                serializer.serialize_unit_variant("DataConnectorKind", 10u32, "AzureAdvancedThreatProtection")
            }
            Self::MicrosoftDefenderAdvancedThreatProtection => {
                serializer.serialize_unit_variant("DataConnectorKind", 11u32, "MicrosoftDefenderAdvancedThreatProtection")
            }
            Self::Dynamics365 => serializer.serialize_unit_variant("DataConnectorKind", 12u32, "Dynamics365"),
            Self::MicrosoftThreatProtection => serializer.serialize_unit_variant("DataConnectorKind", 13u32, "MicrosoftThreatProtection"),
            Self::MicrosoftThreatIntelligence => {
                serializer.serialize_unit_variant("DataConnectorKind", 14u32, "MicrosoftThreatIntelligence")
            }
            Self::GenericUi => serializer.serialize_unit_variant("DataConnectorKind", 15u32, "GenericUI"),
            Self::ApiPolling => serializer.serialize_unit_variant("DataConnectorKind", 16u32, "APIPolling"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub mod incident_label {
    ...
    impl Serialize for LabelType {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::User => serializer.serialize_unit_variant("LabelType", 0u32, "User"),
                Self::System => serializer.serialize_unit_variant("LabelType", 1u32, "System"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub mod microsoft_security_incident_creation_alert_rule_common_properties {
    ...
    impl<'de> Deserialize<'de> for ProductFilter {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for ProductFilter {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::MicrosoftCloudAppSecurity => serializer.serialize_unit_variant("ProductFilter", 0u32, "Microsoft Cloud App Security"),
                Self::AzureSecurityCenter => serializer.serialize_unit_variant("ProductFilter", 1u32, "Azure Security Center"),
                Self::AzureAdvancedThreatProtection => {
                    serializer.serialize_unit_variant("ProductFilter", 2u32, "Azure Advanced Threat Protection")
                }
                Self::AzureActiveDirectoryIdentityProtection => {
                    serializer.serialize_unit_variant("ProductFilter", 3u32, "Azure Active Directory Identity Protection")
                }
                Self::AzureSecurityCenterForIoT => {
                    serializer.serialize_unit_variant("ProductFilter", 4u32, "Azure Security Center for IoT")
                }
                Self::Office365AdvancedThreatProtection => {
                    serializer.serialize_unit_variant("ProductFilter", 5u32, "Office 365 Advanced Threat Protection")
                }
                Self::MicrosoftDefenderAdvancedThreatProtection => {
                    serializer.serialize_unit_variant("ProductFilter", 6u32, "Microsoft Defender Advanced Threat Protection")
                }
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
...
#[doc = "Query based alert rule base property bag."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
pub mod watchlist_properties {
    ...
    impl Serialize for Source {
        ...
        {
            match self {
                Self::LocalFile => serializer.serialize_unit_variant("Source", 0u32, "Local file"),
                Self::RemoteStorage => serializer.serialize_unit_variant("Source", 1u32, "Remote storage"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
