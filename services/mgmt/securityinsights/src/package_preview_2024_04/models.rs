...
#[doc = "The kind of the action"]
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "kind")]
pub enum ActionUnion {
    LockUser(LockUserAction),
...
#[doc = "The status of the action that was performed by the agent"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ActionStatus")]
...
impl Serialize for ActionStatus {
    ...
    {
        match self {
            Self::Pending => serializer.serialize_unit_variant("ActionStatus", 0u32, "Pending"),
            Self::Completed => serializer.serialize_unit_variant("ActionStatus", 1u32, "Completed"),
            Self::Failed => serializer.serialize_unit_variant("ActionStatus", 2u32, "Failed"),
...
#[doc = "Type of the agent"]
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "type")]
pub enum AgentConfigurationUnion {
    #[serde(rename = "SAP")]
    Sap(SapAgentConfiguration),
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AgentProperties {
    #[doc = "Describes the configuration of a Business Application Agent."]
    pub configuration: AgentConfigurationUnion,
    #[serde(
        rename = "agentSystems",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub agent_systems: Vec<AgentSystem>,
...
impl AgentProperties {
    pub fn new(configuration: AgentConfigurationUnion, display_name: String) -> Self {
        Self {
            configuration,
            agent_systems: Vec::new(),
            display_name,
            last_modified_time_utc: None,
        }
    }
}
#[doc = "Describes the configuration of a system inside the agent."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AgentSystem {
    #[serde(rename = "systemResourceName", default, skip_serializing_if = "Option::is_none")]
    pub system_resource_name: Option<String>,
    #[serde(rename = "systemDisplayName", default, skip_serializing_if = "Option::is_none")]
...
impl Serialize for AgentType {
    ...
    {
        match self {
            Self::Sap => serializer.serialize_unit_variant("AgentType", 0u32, "SAP"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl Serialize for AutomationRulePropertyArrayConditionSupportedArrayConditionType {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::AllItems => {
                serializer.serialize_unit_variant("AutomationRulePropertyArrayConditionSupportedArrayConditionType", 1u32, "AllItems")
            }
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
...
impl Serialize for AutomationRulePropertyArrayConditionSupportedArrayType {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::IncidentLabels => {
                serializer.serialize_unit_variant("AutomationRulePropertyArrayConditionSupportedArrayType", 2u32, "IncidentLabels")
            }
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
...
#[doc = "Describes the configuration of a Business Application Agent."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct BusinessApplicationAgentResource {
    #[serde(flatten)]
    pub resource_with_etag: ResourceWithEtag,
    pub properties: AgentProperties,
}
impl BusinessApplicationAgentResource {
...
#[doc = "List of agents."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct BusinessApplicationAgentsList {
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<BusinessApplicationAgentResource>,
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for BusinessApplicationAgentsList {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl BusinessApplicationAgentsList {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Represents the types of configuration for a system."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
impl Serialize for ConfigurationType {
    ...
    {
        match self {
            Self::Sap => serializer.serialize_unit_variant("ConfigurationType", 0u32, "SAP"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct EnrichmentIpGeodata {
    ...
    #[serde(rename = "cityConfidenceFactor", default, skip_serializing_if = "Option::is_none")]
    pub city_confidence_factor: Option<i32>,
    ...
    #[serde(rename = "countryConfidenceFactor", default, skip_serializing_if = "Option::is_none")]
    pub country_confidence_factor: Option<i32>,
    #[doc = "The dotted-decimal or colon-separated string representation of the IP address"]
    ...
    #[serde(rename = "stateConfidenceFactor", default, skip_serializing_if = "Option::is_none")]
    pub state_confidence_factor: Option<i32>,
...
impl azure_core::Continuable for GetQueriesResponse {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        None
    }
...
#[doc = "Represents the types of HTTPS configuration to connect to the SapControl service."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "HttpsConfigurationType")]
pub enum HttpsConfigurationType {
    HttpOnly,
...
impl FromStr for HttpsConfigurationType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for HttpsConfigurationType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for HttpsConfigurationType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::HttpOnly => serializer.serialize_unit_variant("HttpsConfigurationType", 0u32, "HttpOnly"),
            Self::HttpsWithSslVerification => serializer.serialize_unit_variant("HttpsConfigurationType", 1u32, "HttpsWithSslVerification"),
            Self::HttpsWithoutSslVerification => {
                serializer.serialize_unit_variant("HttpsConfigurationType", 2u32, "HttpsWithoutSslVerification")
            }
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
...
impl Serialize for IngestionType {
    ...
    {
        match self {
            Self::Full => serializer.serialize_unit_variant("IngestionType", 0u32, "Full"),
            Self::Incremental => serializer.serialize_unit_variant("IngestionType", 1u32, "Incremental"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "Type for authentication identity to key vault"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "KeyVaultAuthenticationMode")]
pub enum KeyVaultAuthenticationMode {
    ManagedIdentity,
    ServicePrincipal,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for KeyVaultAuthenticationMode {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for KeyVaultAuthenticationMode {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for KeyVaultAuthenticationMode {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::ManagedIdentity => serializer.serialize_unit_variant("KeyVaultAuthenticationMode", 0u32, "ManagedIdentity"),
            Self::ServicePrincipal => serializer.serialize_unit_variant("KeyVaultAuthenticationMode", 1u32, "ServicePrincipal"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "The kind of the action"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ListActionKind")]
pub enum ListActionKind {
    LockUser,
    UnlockUser,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for ListActionKind {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for ListActionKind {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for ListActionKind {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::LockUser => serializer.serialize_unit_variant("ListActionKind", 0u32, "LockUser"),
            Self::UnlockUser => serializer.serialize_unit_variant("ListActionKind", 1u32, "UnlockUser"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "List all actions for a system to perform."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ListActionsResponse {
    #[doc = "Array of actions."]
    pub value: Vec<ActionUnion>,
    #[doc = "The link to fetch the next page of actions."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ListActionsResponse {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
...
impl ListActionsResponse {
    pub fn new(value: Vec<ActionUnion>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Represents lock user action."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct LockUserAction {
    #[doc = "The user to lock"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub user: Option<String>,
    #[doc = "The reason of the failure of the action. Empty if the action is successful."]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct Log {
    #[doc = "Types of logs and tables."]
    #[serde(rename = "type")]
    pub type_: LogType,
    #[doc = "Types of ingestion."]
    #[serde(rename = "ingestionType", default, skip_serializing_if = "Option::is_none")]
    pub ingestion_type: Option<IngestionType>,
    #[doc = "Types of log status."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<LogStatusType>,
    #[doc = "The schedule interval in seconds."]
    #[serde(rename = "scheduleInterval", default, skip_serializing_if = "Option::is_none")]
    pub schedule_interval: Option<i32>,
    #[doc = "The bulk size for the log."]
    #[serde(rename = "bulkSize", default, skip_serializing_if = "Option::is_none")]
    pub bulk_size: Option<i32>,
    #[doc = "The filters for the log."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
#[doc = "Types of log status."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "LogStatusType")]
pub enum LogStatusType {
    Enabled,
    Disabled,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for LogStatusType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for LogStatusType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for LogStatusType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Enabled => serializer.serialize_unit_variant("LogStatusType", 0u32, "Enabled"),
            Self::Disabled => serializer.serialize_unit_variant("LogStatusType", 1u32, "Disabled"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub enum LogType {
    ...
    AbapFilesLogs,
    JavaFilesLogs,
    #[serde(rename = "AGRTCODES")]
    Agrtcodes,
    #[serde(rename = "USR01")]
    Usr01,
    #[serde(rename = "USR02")]
    Usr02,
    #[serde(rename = "AGR1251")]
    Agr1251,
    #[serde(rename = "AGRUSERS")]
    Agrusers,
    #[serde(rename = "AGRPROF")]
    Agrprof,
    #[serde(rename = "UST04")]
    Ust04,
    #[serde(rename = "USR21")]
    ...
    #[serde(rename = "USR05")]
    Usr05,
    #[serde(rename = "USGRPUSER")]
    Usgrpuser,
    #[serde(rename = "USERADDR")]
    Useraddr,
    #[serde(rename = "DEVACCESS")]
    Devaccess,
    #[serde(rename = "AGRDEFINE")]
    Agrdefine,
    #[serde(rename = "PAHI")]
    Pahi,
    #[serde(rename = "AGRAGRS")]
    Agragrs,
    #[serde(rename = "USRSTAMP")]
    Usrstamp,
    #[serde(rename = "AGRFLAGS")]
    Agrflags,
    #[serde(rename = "SNCSYSACL")]
    Sncsysacl,
    #[serde(rename = "USRACL")]
    Usracl,
    #[serde(skip_deserializing)]
...
impl Serialize for LogType {
    ...
    {
        match self {
            Self::AbapAuditLog => serializer.serialize_unit_variant("LogType", 0u32, "AbapAuditLog"),
            Self::AbapJobLog => serializer.serialize_unit_variant("LogType", 1u32, "AbapJobLog"),
            Self::AbapSpoolLog => serializer.serialize_unit_variant("LogType", 2u32, "AbapSpoolLog"),
            Self::AbapSpoolOutputLog => serializer.serialize_unit_variant("LogType", 3u32, "AbapSpoolOutputLog"),
            Self::AbapChangeDocsLog => serializer.serialize_unit_variant("LogType", 4u32, "AbapChangeDocsLog"),
            Self::AbapAppLog => serializer.serialize_unit_variant("LogType", 5u32, "AbapAppLog"),
            Self::AbapWorkflowLog => serializer.serialize_unit_variant("LogType", 6u32, "AbapWorkflowLog"),
            Self::AbapCrLog => serializer.serialize_unit_variant("LogType", 7u32, "AbapCrLog"),
            Self::AbapTableDataLog => serializer.serialize_unit_variant("LogType", 8u32, "AbapTableDataLog"),
            Self::AbapFilesLogs => serializer.serialize_unit_variant("LogType", 9u32, "AbapFilesLogs"),
            Self::JavaFilesLogs => serializer.serialize_unit_variant("LogType", 10u32, "JavaFilesLogs"),
            Self::Agrtcodes => serializer.serialize_unit_variant("LogType", 11u32, "AGRTCODES"),
            Self::Usr01 => serializer.serialize_unit_variant("LogType", 12u32, "USR01"),
            Self::Usr02 => serializer.serialize_unit_variant("LogType", 13u32, "USR02"),
            Self::Agr1251 => serializer.serialize_unit_variant("LogType", 14u32, "AGR1251"),
            Self::Agrusers => serializer.serialize_unit_variant("LogType", 15u32, "AGRUSERS"),
            Self::Agrprof => serializer.serialize_unit_variant("LogType", 16u32, "AGRPROF"),
            Self::Ust04 => serializer.serialize_unit_variant("LogType", 17u32, "UST04"),
            Self::Usr21 => serializer.serialize_unit_variant("LogType", 18u32, "USR21"),
            Self::Adr6 => serializer.serialize_unit_variant("LogType", 19u32, "ADR6"),
            Self::Adcp => serializer.serialize_unit_variant("LogType", 20u32, "ADCP"),
            Self::Usr05 => serializer.serialize_unit_variant("LogType", 21u32, "USR05"),
            Self::Usgrpuser => serializer.serialize_unit_variant("LogType", 22u32, "USGRPUSER"),
            Self::Useraddr => serializer.serialize_unit_variant("LogType", 23u32, "USERADDR"),
            Self::Devaccess => serializer.serialize_unit_variant("LogType", 24u32, "DEVACCESS"),
            Self::Agrdefine => serializer.serialize_unit_variant("LogType", 25u32, "AGRDEFINE"),
            Self::Pahi => serializer.serialize_unit_variant("LogType", 26u32, "PAHI"),
            Self::Agragrs => serializer.serialize_unit_variant("LogType", 27u32, "AGRAGRS"),
            Self::Usrstamp => serializer.serialize_unit_variant("LogType", 28u32, "USRSTAMP"),
            Self::Agrflags => serializer.serialize_unit_variant("LogType", 29u32, "AGRFLAGS"),
            Self::Sncsysacl => serializer.serialize_unit_variant("LogType", 30u32, "SNCSYSACL"),
            Self::Usracl => serializer.serialize_unit_variant("LogType", 31u32, "USRACL"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct Query {
    ...
    #[doc = "Specifies how to sort the query results."]
    #[serde(rename = "sortBy", default, skip_serializing_if = "Option::is_none")]
    pub sort_by: Option<query::SortBy>,
    #[doc = "Represents the maximum size of the page that will be returned from the query API."]
    #[serde(rename = "maxPageSize", default, skip_serializing_if = "Option::is_none")]
    pub max_page_size: Option<i32>,
    #[doc = "Represents the minimum size of the page that will be returned from the query API."]
    #[serde(rename = "minPageSize", default, skip_serializing_if = "Option::is_none")]
    pub min_page_size: Option<i32>,
}
impl Query {
    pub fn new() -> Self {
        Self::default()
...
pub mod query {
    ...
    pub struct SortBy {
        ...
        #[serde(default, skip_serializing_if = "Option::is_none")]
        pub direction: Option<sort_by::Direction>,
        #[doc = "Represents the field to sort the results by."]
        #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub mod sort_by {
        ...
        impl Serialize for Direction {
            ...
            {
                match self {
                    Self::Asc => serializer.serialize_unit_variant("Direction", 0u32, "ASC"),
                    Self::Desc => serializer.serialize_unit_variant("Direction", 1u32, "DESC"),
                    Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
                }
            }
        }
...
impl azure_core::Continuable for RecommendationList {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
...
#[doc = "Report the status of an action that was performed by the agent"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ReportActionStatusPayload {
    #[doc = "The action ID to perform"]
...
impl ReportActionStatusPayload {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Describes the Rfc connector."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RfcConnector {
    #[doc = "FQDN, hostname, or IP address of the ABAP server."]
    #[serde(rename = "abapServerHost", default, skip_serializing_if = "Option::is_none")]
    pub abap_server_host: Option<String>,
    #[doc = "FQDN, hostname, or IP address of the Message server."]
    #[serde(rename = "messageServerHost", default, skip_serializing_if = "Option::is_none")]
    pub message_server_host: Option<String>,
    #[doc = "Logon group of the message server."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub group: Option<String>,
    #[doc = "Port number, or service name (from /etc/services) of the message server."]
    #[serde(rename = "messageServerService", default, skip_serializing_if = "Option::is_none")]
    pub message_server_service: Option<String>,
    #[doc = "SNC QOP.\r\nOptions are 1, 2, 3, 8, 9."]
    #[serde(rename = "sncQop", default, skip_serializing_if = "Option::is_none")]
    pub snc_qop: Option<String>,
    #[doc = "The SAP code page used for character encoding.\r\nExample - 1100"]
    #[serde(rename = "codePage", default, skip_serializing_if = "Option::is_none")]
    pub code_page: Option<String>,
    #[doc = "System number of the ABAP server."]
    #[serde(rename = "systemNumber")]
    pub system_number: String,
    #[doc = "System ID of the ABAP server.\r\nExample - A4H"]
    #[serde(rename = "systemId")]
    pub system_id: String,
    #[doc = "Client number of the ABAP server.\r\nExample - 001"]
    pub client: String,
    #[doc = "Types of authentication to SAP."]
    #[serde(rename = "authenticationType", default, skip_serializing_if = "Option::is_none")]
    pub authentication_type: Option<SapAuthenticationType>,
    #[doc = "Represents the types of SAP systems."]
    #[serde(rename = "type")]
    pub type_: SystemConfigurationConnectorType,
}
impl RfcConnector {
    pub fn new(system_number: String, system_id: String, client: String, type_: SystemConfigurationConnectorType) -> Self {
        Self {
            abap_server_host: None,
...
#[doc = "Describes the configuration of a SAP Docker agent."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SapAgentConfiguration {
    #[doc = "The name of the docker agent.\r\nonly letters with numbers, underscores and hyphens are allowed\r\nexample: \"my-agent\""]
    #[serde(rename = "agentContainerName", default, skip_serializing_if = "Option::is_none")]
    pub agent_container_name: Option<String>,
    #[doc = "The SDK path (a file not a folder) on the agent machine.\r\nexample: \"/path/to/nwrfc750P_8-70002755.zip\""]
    #[serde(rename = "sdkPath", default, skip_serializing_if = "Option::is_none")]
    pub sdk_path: Option<String>,
    #[doc = "The SNC path (a folder not a file) on the agent machine.\r\nexample: \"/path/to/snc\""]
    #[serde(rename = "sncPath", default, skip_serializing_if = "Option::is_none")]
    pub snc_path: Option<String>,
    #[doc = "The key vault resource id to access the key vault.\r\nexample: \"/subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.KeyVault/vaults/myVault\""]
    #[serde(rename = "keyVaultResourceId", default, skip_serializing_if = "Option::is_none")]
    pub key_vault_resource_id: Option<String>,
    #[doc = "Type for authentication identity to key vault"]
    #[serde(rename = "keyVaultAuthenticationMode", default, skip_serializing_if = "Option::is_none")]
    pub key_vault_authentication_mode: Option<KeyVaultAuthenticationMode>,
    #[doc = "Type for Secret Source - Azure Key Vault"]
...
impl SapAgentConfiguration {
    pub fn new(type_: AgentType) -> Self {
        Self {
            agent_container_name: None,
            sdk_path: None,
            snc_path: None,
            key_vault_resource_id: None,
            key_vault_authentication_mode: None,
            secret_source: None,
            type_,
        }
    }
...
#[doc = "Types of authentication to SAP."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "SapAuthenticationType")]
pub enum SapAuthenticationType {
    UsernamePassword,
    Snc,
...
impl FromStr for SapAuthenticationType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for SapAuthenticationType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for SapAuthenticationType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::UsernamePassword => serializer.serialize_unit_variant("SapAuthenticationType", 0u32, "UsernamePassword"),
            Self::Snc => serializer.serialize_unit_variant("SapAuthenticationType", 1u32, "Snc"),
            Self::SncWithUsernamePassword => serializer.serialize_unit_variant("SapAuthenticationType", 2u32, "SncWithUsernamePassword"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "Describes the SapControl connector configuration."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SapControlConnector {
    #[doc = "The server name.\r\nFQDN or IP address."]
    pub server: String,
    #[doc = "The instance number. Only 2 digits are allowed."]
    pub instance: String,
    #[doc = "The timezone.\r\nexample: \"GMT+0\" or \"GMT-8\"\r\ndefault: \"GMT+0\""]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub timezone: Option<String>,
    #[doc = "The port of the SOAP connection to SAP Control."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub port: Option<String>,
    #[doc = "Represents the types of HTTPS configuration to connect to the SapControl service."]
    #[serde(rename = "httpsConfiguration", default, skip_serializing_if = "Option::is_none")]
    pub https_configuration: Option<HttpsConfigurationType>,
    #[doc = "Represents the types of SAP systems."]
    #[serde(rename = "type")]
    pub type_: SystemConfigurationConnectorType,
}
impl SapControlConnector {
    pub fn new(server: String, instance: String, type_: SystemConfigurationConnectorType) -> Self {
        Self {
            server,
            instance,
            timezone: None,
            port: None,
            https_configuration: None,
            type_,
        }
    }
}
...
#[doc = "Describes the SAP configuration."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SapSystemsConfiguration {
    ...
    #[doc = "Base Model for SAP System Connector."]
    pub connector: SystemsConfigurationConnectorUnion,
    #[doc = "The logs configuration."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    ...
    #[doc = "Represents the types of configuration for a system."]
    #[serde(rename = "type")]
    pub type_: ConfigurationType,
}
impl SapSystemsConfiguration {
    pub fn new(connector: SystemsConfigurationConnectorUnion, type_: ConfigurationType) -> Self {
        Self {
...
impl Serialize for SecretSource {
    ...
    {
        match self {
            Self::AzureKeyVault => serializer.serialize_unit_variant("SecretSource", 0u32, "AzureKeyVault"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct SettingList {
    ...
    #[doc = "URL to fetch the next set of settings."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for SettingList {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
...
#[doc = "Represents the types of SAP systems."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "SystemConfigurationConnectorType")]
pub enum SystemConfigurationConnectorType {
    Rfc,
    SapControl,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for SystemConfigurationConnectorType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for SystemConfigurationConnectorType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for SystemConfigurationConnectorType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Rfc => serializer.serialize_unit_variant("SystemConfigurationConnectorType", 0u32, "Rfc"),
            Self::SapControl => serializer.serialize_unit_variant("SystemConfigurationConnectorType", 1u32, "SapControl"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "The properties of the system."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SystemProperties {
    #[doc = "The status of the system."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<SystemStatusType>,
    #[doc = "The configuration of the system."]
    pub configuration: SystemsConfigurationUnion,
    #[serde(rename = "displayName")]
    pub display_name: String,
    #[serde(rename = "lastModifiedTimeUtc", default, with = "azure_core::date::rfc3339::option")]
    pub last_modified_time_utc: Option<::time::OffsetDateTime>,
...
impl SystemProperties {
    pub fn new(configuration: SystemsConfigurationUnion, display_name: String) -> Self {
        Self {
            status: None,
            configuration,
            display_name,
...
#[doc = "Describes the system within the agent."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
impl SystemResource {
    pub fn new(properties: SystemProperties) -> Self {
        Self {
            resource_with_etag: ResourceWithEtag::default(),
            properties,
        }
...
impl FromStr for SystemStatusType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for SystemStatusType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for SystemStatusType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Running => serializer.serialize_unit_variant("SystemStatusType", 0u32, "Running"),
            Self::Stopped => serializer.serialize_unit_variant("SystemStatusType", 1u32, "Stopped"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "type")]
pub enum SystemsConfigurationUnion {
    #[serde(rename = "SAP")]
    Sap(SapSystemsConfiguration),
}
#[doc = "Represents the types of SAP systems."]
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "type")]
pub enum SystemsConfigurationConnectorUnion {
    Rfc(RfcConnector),
    SapControl(SapControlConnector),
}
#[doc = "List of Agent's Systems."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SystemsList {
    ...
    pub value: Vec<SystemResource>,
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for SystemsList {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
...
#[doc = "Represents the undo action."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct UndoActionPayload {
    #[doc = "The action ID of the original action that was performed and now need to undo"]
    #[serde(rename = "actionId", default, skip_serializing_if = "Option::is_none")]
    pub action_id: Option<String>,
}
impl UndoActionPayload {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Represents an unlock user action."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct UnlockUserAction {
    #[doc = "The user to unlock"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub user: Option<String>,
    #[doc = "The reason of the failure of the action. Empty if the action is successful."]
    #[serde(rename = "failureReason", default, skip_serializing_if = "Option::is_none")]
...
pub struct WatchlistProperties {
    ...
    #[doc = "Describes provisioning state"]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
