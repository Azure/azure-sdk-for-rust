...
#[doc = "Model for API authentication with AWS."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AwsAuthModel {
    #[doc = "AWS STS assume role ARN"]
    #[serde(rename = "roleArn")]
    pub role_arn: String,
    #[doc = "AWS STS assume role external ID. This is used to prevent the confused deputy problem: 'https://docs.aws.amazon.com/IAM/latest/UserGuide/confused-deputy.html'"]
...
impl Serialize for AlertProperty {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::SubTechniques => serializer.serialize_unit_variant("AlertProperty", 9u32, "SubTechniques"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "Model for authentication with the API Key. Will result in additional header on the request (default behavior) to the remote server: 'ApiKeyName: ApiKeyIdentifier ApiKey'. If 'IsApiKeyInPostPayload' is true it will send it in the body of the request and not the header."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ApiKeyAuthModel {
    #[doc = "API Key for the user secret key credential"]
    #[serde(rename = "apiKey")]
    pub api_key: String,
    #[doc = "API Key name"]
    #[serde(rename = "apiKeyName")]
    pub api_key_name: String,
    #[doc = "API Key Identifier"]
    #[serde(rename = "apiKeyIdentifier", default, skip_serializing_if = "Option::is_none")]
    pub api_key_identifier: Option<String>,
    #[doc = "Flag to indicate if API key is set in HTTP POST payload"]
    #[serde(rename = "isApiKeyInPostPayload", default, skip_serializing_if = "Option::is_none")]
    pub is_api_key_in_post_payload: Option<bool>,
}
impl ApiKeyAuthModel {
    pub fn new(api_key: String, api_key_name: String) -> Self {
        Self {
            api_key,
            api_key_name,
...
#[doc = "Represents an attack pattern in Azure Security Insights."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AttackPattern {
    #[serde(flatten)]
    pub ti_object: TiObject,
}
impl AttackPattern {
    pub fn new(ti_object: TiObject) -> Self {
        Self { ti_object }
    }
}
...
#[doc = "Model for API authentication with basic flow - user name + password."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct BasicAuthModel {
    #[doc = "The user name."]
...
#[doc = "Type of paging"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "CcpAuthType")]
pub enum CcpAuthType {
    Basic,
    #[serde(rename = "APIKey")]
    ApiKey,
    OAuth2,
...
impl FromStr for CcpAuthType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for CcpAuthType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for CcpAuthType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Basic => serializer.serialize_unit_variant("CcpAuthType", 0u32, "Basic"),
            Self::ApiKey => serializer.serialize_unit_variant("CcpAuthType", 1u32, "APIKey"),
            Self::OAuth2 => serializer.serialize_unit_variant("CcpAuthType", 2u32, "OAuth2"),
            Self::Aws => serializer.serialize_unit_variant("CcpAuthType", 3u32, "AWS"),
            Self::Gcp => serializer.serialize_unit_variant("CcpAuthType", 4u32, "GCP"),
            Self::Session => serializer.serialize_unit_variant("CcpAuthType", 5u32, "Session"),
            Self::JwtToken => serializer.serialize_unit_variant("CcpAuthType", 6u32, "JwtToken"),
            Self::GitHub => serializer.serialize_unit_variant("CcpAuthType", 7u32, "GitHub"),
            Self::ServiceBus => serializer.serialize_unit_variant("CcpAuthType", 8u32, "ServiceBus"),
            Self::Oracle => serializer.serialize_unit_variant("CcpAuthType", 9u32, "Oracle"),
            Self::None => serializer.serialize_unit_variant("CcpAuthType", 10u32, "None"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "A custom response configuration for a rule."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CcpResponseConfig {
    #[doc = "The json paths, '$' char is the json root."]
    #[serde(rename = "eventsJsonPaths")]
    pub events_json_paths: Vec<String>,
    #[doc = "The value where the status message/code should appear in the response."]
    #[serde(rename = "successStatusJsonPath", default, skip_serializing_if = "Option::is_none")]
    pub success_status_json_path: Option<String>,
    #[doc = "The the status value."]
    #[serde(rename = "successStatusValue", default, skip_serializing_if = "Option::is_none")]
    pub success_status_value: Option<String>,
    #[doc = "The value indicating whether the remote server support Gzip and we should expect Gzip response."]
    #[serde(rename = "isGzipCompressed", default, skip_serializing_if = "Option::is_none")]
    pub is_gzip_compressed: Option<bool>,
    #[doc = "The compression algorithm."]
    #[serde(rename = "compressionAlgo", default, skip_serializing_if = "Option::is_none")]
    pub compression_algo: Option<String>,
    #[doc = "The response format. possible values are json,csv,xml"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub format: Option<String>,
    #[doc = "The csv delimiter, in case the response format is CSV."]
    #[serde(rename = "csvDelimiter", default, skip_serializing_if = "Option::is_none")]
    pub csv_delimiter: Option<String>,
    #[doc = "The value indicating whether the response has CSV boundary in case the response in CSV format."]
    #[serde(rename = "hasCsvBoundary", default, skip_serializing_if = "Option::is_none")]
    pub has_csv_boundary: Option<bool>,
    #[doc = "The value indicating whether the response has headers in case the response in CSV format."]
    #[serde(rename = "hasCsvHeader", default, skip_serializing_if = "Option::is_none")]
    pub has_csv_header: Option<bool>,
    #[doc = "The a value indicating whether the response isn't an array of events / logs.  By setting this flag to true it means the remote server will response with an object which each property has as a value an array of events / logs."]
    #[serde(rename = "convertChildPropertiesToArray", default, skip_serializing_if = "Option::is_none")]
    pub convert_child_properties_to_array: Option<bool>,
    #[doc = "Th character used to escape characters in CSV."]
    #[serde(rename = "csvEscape", default, skip_serializing_if = "Option::is_none")]
    pub csv_escape: Option<String>,
}
impl CcpResponseConfig {
    pub fn new(events_json_paths: Vec<String>) -> Self {
        Self {
            ...
            format: None,
            csv_delimiter: None,
            has_csv_boundary: None,
            has_csv_header: None,
            convert_child_properties_to_array: None,
            csv_escape: None,
        }
    }
}
...
#[doc = "Represents a single clause to be evaluated by a NormalizedCondition."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConditionClause {
    #[doc = "Represents boolean connectives used to join clauses in conditions."]
    #[serde(rename = "clauseConnective", default, skip_serializing_if = "Option::is_none")]
    pub clause_connective: Option<Connective>,
    #[doc = "The name of the field that is evaluated."]
    pub field: String,
    #[doc = "Represents an operator in a ConditionClause."]
    pub operator: condition_clause::Operator,
    #[doc = "The top level connective operator for this condition."]
    pub values: Vec<String>,
}
impl ConditionClause {
    pub fn new(field: String, operator: condition_clause::Operator, values: Vec<String>) -> Self {
        Self {
            clause_connective: None,
            field,
            operator,
            values,
        }
    ...
    impl Serialize for Operator {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::LessThan => serializer.serialize_unit_variant("Operator", 2u32, "LessThan"),
                Self::LessThanEqual => serializer.serialize_unit_variant("Operator", 3u32, "LessThanEqual"),
                Self::GreaterThan => serializer.serialize_unit_variant("Operator", 4u32, "GreaterThan"),
                Self::GreaterThanEqual => serializer.serialize_unit_variant("Operator", 5u32, "GreaterThanEqual"),
                Self::StringContains => serializer.serialize_unit_variant("Operator", 6u32, "StringContains"),
                Self::StringNotContains => serializer.serialize_unit_variant("Operator", 7u32, "StringNotContains"),
                Self::StringStartsWith => serializer.serialize_unit_variant("Operator", 8u32, "StringStartsWith"),
                Self::StringNotStartsWith => serializer.serialize_unit_variant("Operator", 9u32, "StringNotStartsWith"),
                Self::StringEndsWith => serializer.serialize_unit_variant("Operator", 10u32, "StringEndsWith"),
                Self::StringNotEndsWith => serializer.serialize_unit_variant("Operator", 11u32, "StringNotEndsWith"),
                Self::StringIsEmpty => serializer.serialize_unit_variant("Operator", 12u32, "StringIsEmpty"),
                Self::IsNull => serializer.serialize_unit_variant("Operator", 13u32, "IsNull"),
                Self::IsTrue => serializer.serialize_unit_variant("Operator", 14u32, "IsTrue"),
                Self::IsFalse => serializer.serialize_unit_variant("Operator", 15u32, "IsFalse"),
                Self::ArrayContains => serializer.serialize_unit_variant("Operator", 16u32, "ArrayContains"),
                Self::ArrayNotContains => serializer.serialize_unit_variant("Operator", 17u32, "ArrayNotContains"),
                Self::OnOrAfterRelative => serializer.serialize_unit_variant("Operator", 18u32, "OnOrAfterRelative"),
                Self::AfterRelative => serializer.serialize_unit_variant("Operator", 19u32, "AfterRelative"),
                Self::OnOrBeforeRelative => serializer.serialize_unit_variant("Operator", 20u32, "OnOrBeforeRelative"),
                Self::BeforeRelative => serializer.serialize_unit_variant("Operator", 21u32, "BeforeRelative"),
                Self::OnOrAfterAbsolute => serializer.serialize_unit_variant("Operator", 22u32, "OnOrAfterAbsolute"),
                Self::AfterAbsolute => serializer.serialize_unit_variant("Operator", 23u32, "AfterAbsolute"),
                Self::OnOrBeforeAbsolute => serializer.serialize_unit_variant("Operator", 24u32, "OnOrBeforeAbsolute"),
                Self::BeforeAbsolute => serializer.serialize_unit_variant("Operator", 25u32, "BeforeAbsolute"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
}
#[doc = "Represents a condition used to query for TI objects."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConditionProperties {
    #[doc = "The STIX type for the objects returned by this query."]
    #[serde(rename = "stixObjectType", default, skip_serializing_if = "Option::is_none")]
    pub stix_object_type: Option<String>,
    #[doc = "The list of clauses to be evaluated in disjunction or conjunction base on the specified top level connective operator."]
    pub clauses: Vec<ConditionClause>,
    #[doc = "Represents boolean connectives used to join clauses in conditions."]
    #[serde(rename = "conditionConnective", default, skip_serializing_if = "Option::is_none")]
    pub condition_connective: Option<Connective>,
}
impl ConditionProperties {
    pub fn new(clauses: Vec<ConditionClause>) -> Self {
        Self {
            stix_object_type: None,
            clauses,
            condition_connective: None,
        }
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
impl<'de> Deserialize<'de> for Connective {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for Connective {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::And => serializer.serialize_unit_variant("Connective", 0u32, "And"),
            Self::Or => serializer.serialize_unit_variant("Connective", 1u32, "Or"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl Serialize for DataConnectorKind {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::RestApiPoller => serializer.serialize_unit_variant("DataConnectorKind", 22u32, "RestApiPoller"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EnrichmentDomainBody {
    #[doc = "The domain name"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub domain: Option<String>,
}
impl EnrichmentDomainBody {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct FusionAlertRuleProperties {
    ...
    pub techniques: Vec<String>,
    #[doc = "The sub-techniques of the alert rule"]
    #[serde(
...
#[doc = "Model for API authentication for all GCP kind connectors."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GcpAuthModel {
    #[doc = "GCP Service Account Email"]
    #[serde(rename = "serviceAccountEmail")]
    pub service_account_email: String,
    #[doc = "GCP Project Number"]
    #[serde(rename = "projectNumber")]
    pub project_number: String,
    #[doc = "GCP Workload Identity Provider ID"]
...
#[doc = "Model for API authentication for working with service bus or storage account."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GenericBlobSbsAuthModel {
    #[doc = "Credentials for service bus namespace, keyvault uri for access key"]
    #[serde(rename = "credentialsConfig", default, skip_serializing_if = "Option::is_none")]
    pub credentials_config: Option<serde_json::Value>,
    #[doc = "Credentials for storage account, keyvault uri for access key"]
    #[serde(rename = "storageAccountCredentialsConfig", default, skip_serializing_if = "Option::is_none")]
    pub storage_account_credentials_config: Option<serde_json::Value>,
}
impl GenericBlobSbsAuthModel {
    pub fn new() -> Self {
        Self {
            credentials_config: None,
            storage_account_credentials_config: None,
        }
    }
}
...
#[doc = "Model for API authentication for GitHub. For this authentication first we need to approve the Router app (Microsoft Security DevOps) to access the GitHub account, Then we only need the InstallationId to get the access token from https://api.github.com/app/installations/{installId}/access_tokens."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GitHubAuthModel {
    #[doc = "The GitHubApp auth installation id."]
    #[serde(rename = "installationId", default, skip_serializing_if = "Option::is_none")]
    pub installation_id: Option<String>,
}
impl GitHubAuthModel {
    pub fn new() -> Self {
...
#[doc = "Represents an identity in Azure Security Insights."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct Identity {
    #[serde(flatten)]
    pub ti_object: TiObject,
...
#[doc = "Represents an indicator in Azure Security Insights."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct Indicator {
    #[serde(flatten)]
    pub ti_object: TiObject,
    #[doc = "The observables of this indicator"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
#[doc = "Model for API authentication with JWT. Simple exchange between user name + password to access token."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct JwtAuthModel {
    #[doc = "Token endpoint to request JWT"]
    #[serde(rename = "tokenEndpoint")]
    pub token_endpoint: String,
    #[doc = "The user name. If user name and password sent in header request we only need to populate the `value` property with the user name (Same as basic auth). If user name and password sent in body request we need to specify the `Key` and `Value`."]
    #[serde(rename = "userName")]
    pub user_name: serde_json::Value,
    #[doc = "The password"]
    pub password: serde_json::Value,
    #[doc = "The custom query parameter we want to add once we send request to token endpoint."]
    #[serde(rename = "queryParameters", default, skip_serializing_if = "Option::is_none")]
    pub query_parameters: Option<serde_json::Value>,
    #[doc = "The custom headers we want to add once we send request to token endpoint."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub headers: Option<serde_json::Value>,
    #[doc = "Flag indicating whether we want to send the user name and password to token endpoint in the headers."]
    #[serde(rename = "isCredentialsInHeaders", default, skip_serializing_if = "Option::is_none")]
    pub is_credentials_in_headers: Option<bool>,
    #[doc = "Flag indicating whether the body request is JSON (header Content-Type = application/json), meaning its a Form URL encoded request (header Content-Type = application/x-www-form-urlencoded)."]
    #[serde(rename = "isJsonRequest", default, skip_serializing_if = "Option::is_none")]
    pub is_json_request: Option<bool>,
    #[doc = "Request timeout in seconds."]
    #[serde(rename = "requestTimeoutInSeconds", default, skip_serializing_if = "Option::is_none")]
    pub request_timeout_in_seconds: Option<i32>,
}
impl JwtAuthModel {
    pub fn new(token_endpoint: String, user_name: serde_json::Value, password: serde_json::Value) -> Self {
        Self {
            token_endpoint,
            user_name,
            password,
            query_parameters: None,
            headers: None,
            is_credentials_in_headers: None,
            is_json_request: None,
...
#[doc = "Model for API authentication with no authentication method - public API."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct NoneAuthModel {}
impl NoneAuthModel {
    pub fn new() -> Self {
        Self {}
    }
...
#[doc = "Model for API authentication with OAuth2."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct OAuthModel {
    #[doc = "The user's authorization code."]
    #[serde(rename = "authorizationCode", default, skip_serializing_if = "Option::is_none")]
    pub authorization_code: Option<String>,
    #[doc = "The Application (client) secret that the OAuth provider assigned to your app."]
    #[serde(rename = "clientSecret")]
    pub client_secret: String,
    #[doc = "The Application (client) ID that the OAuth provider assigned to your app."]
    #[serde(rename = "clientId")]
    pub client_id: String,
    #[doc = "Indicating whether we want to send the clientId and clientSecret to token endpoint in the headers."]
    #[serde(rename = "isCredentialsInHeaders", default, skip_serializing_if = "Option::is_none")]
    pub is_credentials_in_headers: Option<bool>,
    #[doc = "The Application (client) Scope that the OAuth provider assigned to your app."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub scope: Option<String>,
    #[doc = "The Application redirect url that the user config in the OAuth provider."]
    #[serde(rename = "redirectUri", default, skip_serializing_if = "Option::is_none")]
    pub redirect_uri: Option<String>,
    #[doc = "The grant type, usually will be 'authorization code'."]
    #[serde(rename = "grantType")]
    pub grant_type: String,
    #[doc = "The token endpoint. Defines the OAuth2 refresh token."]
    #[serde(rename = "tokenEndpoint")]
    pub token_endpoint: String,
    #[doc = "The token endpoint headers."]
    #[serde(rename = "tokenEndpointHeaders", default, skip_serializing_if = "Option::is_none")]
    pub token_endpoint_headers: Option<serde_json::Value>,
    #[doc = "The token endpoint query parameters."]
    #[serde(rename = "tokenEndpointQueryParameters", default, skip_serializing_if = "Option::is_none")]
    pub token_endpoint_query_parameters: Option<serde_json::Value>,
    #[doc = "The authorization endpoint."]
    #[serde(rename = "authorizationEndpoint", default, skip_serializing_if = "Option::is_none")]
    pub authorization_endpoint: Option<String>,
    #[doc = "The authorization endpoint headers."]
    #[serde(rename = "authorizationEndpointHeaders", default, skip_serializing_if = "Option::is_none")]
    pub authorization_endpoint_headers: Option<serde_json::Value>,
    #[doc = "The authorization endpoint query parameters."]
    #[serde(rename = "authorizationEndpointQueryParameters", default, skip_serializing_if = "Option::is_none")]
    pub authorization_endpoint_query_parameters: Option<serde_json::Value>,
    #[doc = "A value indicating whether it's a JWT flow."]
    #[serde(rename = "isJwtBearerFlow", default, skip_serializing_if = "Option::is_none")]
    pub is_jwt_bearer_flow: Option<bool>,
    #[doc = "Access token prepend. Default is 'Bearer'."]
    #[serde(rename = "accessTokenPrepend", default, skip_serializing_if = "Option::is_none")]
    pub access_token_prepend: Option<String>,
}
impl OAuthModel {
    pub fn new(client_secret: String, client_id: String, grant_type: String, token_endpoint: String) -> Self {
        Self {
            ...
            token_endpoint_query_parameters: None,
            authorization_endpoint: None,
            authorization_endpoint_headers: None,
            authorization_endpoint_query_parameters: None,
            is_jwt_bearer_flow: None,
            access_token_prepend: None,
        }
    }
}
...
#[doc = "Model for API authentication for Oracle."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct OracleAuthModel {
    #[doc = "Oracle tenant ID"]
    #[serde(rename = "tenantId")]
    pub tenant_id: String,
    #[doc = "Oracle user ID"]
    #[serde(rename = "userId")]
    pub user_id: String,
    #[doc = "Public Fingerprint"]
    #[serde(rename = "publicFingerprint")]
    pub public_fingerprint: String,
    #[doc = "Content of the PRM file"]
    #[serde(rename = "pemFile")]
    pub pem_file: String,
}
impl OracleAuthModel {
    pub fn new(tenant_id: String, user_id: String, public_fingerprint: String, pem_file: String) -> Self {
        Self {
            tenant_id,
            user_id,
            public_fingerprint,
...
#[doc = "Represents a query to run on the TI objects in the workspace."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct Query {
    #[doc = "Describes the query properties"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct QueryProperties {
    #[doc = "Represents a condition used to query for TI objects."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub condition: Option<ConditionProperties>,
}
...
pub struct Recommendation {
    #[serde(flatten)]
    pub resource_with_etag: ResourceWithEtag,
    #[doc = "Recommendation properties object."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct RecommendationPatch {
    #[doc = "Recommendation Fields Properties to update."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<RecommendationPatchProperties>,
}
...
#[doc = "Recommendation Fields Properties to update."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RecommendationPatchProperties {
    #[doc = "State of recommendation."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<RecommendationState>,
}
impl RecommendationPatchProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct RecommendationProperties {
    ...
    pub description: String,
    #[doc = "The time stamp (UTC) when the recommendation was created."]
    #[serde(rename = "creationTimeUtc", with = "azure_core::date::rfc3339")]
    pub creation_time_utc: ::time::OffsetDateTime,
    ...
    #[doc = "The time stamp (UTC) when the recommendation was last modified."]
    #[serde(rename = "lastModifiedTimeUtc", with = "azure_core::date::rfc3339")]
    pub last_modified_time_utc: ::time::OffsetDateTime,
    #[doc = "List of suggestions to take for this recommendation."]
    pub suggestions: Vec<RecommendedSuggestion>,
...
impl RecommendationProperties {
    pub fn new(
        ...
        title: String,
        description: String,
        creation_time_utc: ::time::OffsetDateTime,
        last_evaluated_time_utc: ::time::OffsetDateTime,
        last_modified_time_utc: ::time::OffsetDateTime,
        suggestions: Vec<RecommendedSuggestion>,
    ) -> Self {
        Self {
...
impl Serialize for RecommendationState {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::InProgress => serializer.serialize_unit_variant("RecommendationState", 1u32, "InProgress"),
            Self::Dismissed => serializer.serialize_unit_variant("RecommendationState", 2u32, "Dismissed"),
            Self::CompletedByUser => serializer.serialize_unit_variant("RecommendationState", 3u32, "CompletedByUser"),
            Self::CompletedBySystem => serializer.serialize_unit_variant("RecommendationState", 4u32, "CompletedBySystem"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "What suggestions should be taken to complete the recommendation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RecommendedSuggestion {
    #[doc = "Id of the suggestion type."]
    #[serde(rename = "suggestionTypeId")]
    pub suggestion_type_id: String,
    #[doc = "Title of the suggestion."]
    pub title: String,
    #[doc = "Description of the suggestion."]
    pub description: String,
    #[doc = "Action of the suggestion."]
    pub action: String,
    #[doc = "Collection of additional properties for the suggestion."]
    #[serde(rename = "additionalProperties", default, skip_serializing_if = "Option::is_none")]
    pub additional_properties: Option<serde_json::Value>,
}
impl RecommendedSuggestion {
    pub fn new(suggestion_type_id: String, title: String, description: String, action: String) -> Self {
        Self {
            suggestion_type_id,
            title,
            description,
...
#[doc = "Reevaluate response object."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ReevaluateResponse {
    #[doc = "The time stamp (UTC) when the recommendation was last evaluated."]
    #[serde(rename = "lastEvaluatedTimeUtc", default, with = "azure_core::date::rfc3339::option")]
    pub last_evaluated_time_utc: Option<::time::OffsetDateTime>,
}
impl ReevaluateResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Represents a relationship in Azure Security Insights."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "An object used to help follow relationships from this object to other STIX objects."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct Repo {
    ...
    #[doc = "The installation id of the repository."]
    #[serde(rename = "installationId", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Credentials to access repository."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RepositoryAccessObject {
    #[doc = "Credentials to access repository."]
    #[serde(rename = "repositoryAccess")]
    pub repository_access: RepositoryAccess,
}
impl RepositoryAccessObject {
    pub fn new(repository_access: RepositoryAccess) -> Self {
        Self { repository_access }
    }
}
#[doc = "Credentials to access repository."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RepositoryAccessProperties {
    #[doc = "Credentials to access repository."]
    pub properties: RepositoryAccessObject,
}
impl RepositoryAccessProperties {
    pub fn new(properties: RepositoryAccessObject) -> Self {
        Self { properties }
    }
}
...
#[doc = "Represents Rest Api Poller data connector."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RestApiPollerDataConnector {
    #[serde(flatten)]
    pub data_connector: DataConnector,
    #[doc = "Rest Api Poller data connector properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<RestApiPollerDataConnectorProperties>,
}
impl RestApiPollerDataConnector {
    pub fn new(data_connector: DataConnector) -> Self {
        Self {
            data_connector,
            properties: None,
...
#[doc = "Rest Api Poller data connector properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RestApiPollerDataConnectorProperties {
    #[doc = "The connector definition name (the dataConnectorDefinition resource id)."]
    #[serde(rename = "connectorDefinitionName")]
    pub connector_definition_name: String,
    #[doc = "Base Model for API authentication."]
    pub auth: CcpAuthConfigUnion,
    #[doc = "The request configuration."]
    pub request: RestApiPollerRequestConfig,
    #[doc = "The configuration of the destination of the data."]
    #[serde(rename = "dcrConfig", default, skip_serializing_if = "Option::is_none")]
    pub dcr_config: Option<DcrConfiguration>,
    #[doc = "Indicates whether the connector is active or not."]
    #[serde(rename = "isActive", default, skip_serializing_if = "Option::is_none")]
    pub is_active: Option<bool>,
    #[doc = "The Log Analytics table destination."]
    #[serde(rename = "dataType", default, skip_serializing_if = "Option::is_none")]
    pub data_type: Option<String>,
    #[doc = "A custom response configuration for a rule."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub response: Option<CcpResponseConfig>,
    #[doc = "The request paging configuration."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub paging: Option<RestApiPollerRequestPagingConfig>,
    #[doc = "The add on attributes. The key name will become attribute name (a column) and the value will become the attribute value in the payload."]
    #[serde(rename = "addOnAttributes", default, skip_serializing_if = "Option::is_none")]
    pub add_on_attributes: Option<serde_json::Value>,
}
impl RestApiPollerDataConnectorProperties {
    pub fn new(connector_definition_name: String, auth: CcpAuthConfigUnion, request: RestApiPollerRequestConfig) -> Self {
        Self {
            connector_definition_name,
            auth,
            request,
            ...
            response: None,
            paging: None,
            add_on_attributes: None,
        }
    }
}
#[doc = "The request configuration."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RestApiPollerRequestConfig {
    #[doc = "The API endpoint."]
    #[serde(rename = "apiEndpoint")]
    pub api_endpoint: String,
    #[doc = "The Rate limit queries per second for the request.."]
    #[serde(rename = "rateLimitQPS", default, skip_serializing_if = "Option::is_none")]
    pub rate_limit_qps: Option<i32>,
    #[doc = "The query window in minutes for the request."]
    #[serde(rename = "queryWindowInMin", default, skip_serializing_if = "Option::is_none")]
    pub query_window_in_min: Option<i32>,
    #[doc = "The HTTP method, default value GET."]
    #[serde(rename = "httpMethod", default, skip_serializing_if = "Option::is_none")]
    pub http_method: Option<rest_api_poller_request_config::HttpMethod>,
    #[doc = "The query time format. A remote server can have a query to pull data from range 'start' to 'end'. This property indicate what is the expected time format the remote server know to parse."]
    #[serde(rename = "queryTimeFormat", default, skip_serializing_if = "Option::is_none")]
    pub query_time_format: Option<String>,
    #[doc = "The retry count."]
    #[serde(rename = "retryCount", default, skip_serializing_if = "Option::is_none")]
    pub retry_count: Option<i32>,
    ...
    #[serde(rename = "timeoutInSeconds", default, skip_serializing_if = "Option::is_none")]
    pub timeout_in_seconds: Option<i32>,
    #[doc = "Flag to indicate if HTTP POST payload is in JSON format (vs form-urlencoded)."]
    #[serde(rename = "isPostPayloadJson", default, skip_serializing_if = "Option::is_none")]
    pub is_post_payload_json: Option<bool>,
    #[doc = "The header for the request for the remote server."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub headers: Option<serde_json::Value>,
    #[doc = "The HTTP query parameters to RESTful API."]
    #[serde(rename = "queryParameters", default, skip_serializing_if = "Option::is_none")]
    pub query_parameters: Option<serde_json::Value>,
    #[doc = "the query parameters template. Defines the query parameters template to use when passing query parameters in advanced scenarios."]
    #[serde(rename = "queryParametersTemplate", default, skip_serializing_if = "Option::is_none")]
    pub query_parameters_template: Option<String>,
    #[doc = "The query parameter name which the remote server expect to start query. This property goes hand to hand with `endTimeAttributeName`."]
    #[serde(rename = "startTimeAttributeName", default, skip_serializing_if = "Option::is_none")]
    pub start_time_attribute_name: Option<String>,
    #[doc = "The query parameter name which the remote server expect to end query. This property goes hand to hand with `startTimeAttributeName`"]
    #[serde(rename = "endTimeAttributeName", default, skip_serializing_if = "Option::is_none")]
    pub end_time_attribute_name: Option<String>,
    #[doc = "The query parameter name which we need to send the server for query logs in time interval. Should be defined with `queryTimeIntervalPrepend` and `queryTimeIntervalDelimiter`"]
    #[serde(rename = "queryTimeIntervalAttributeName", default, skip_serializing_if = "Option::is_none")]
    pub query_time_interval_attribute_name: Option<String>,
    #[doc = "The string prepend to the value of the query parameter in `queryTimeIntervalAttributeName`."]
    #[serde(rename = "queryTimeIntervalPrepend", default, skip_serializing_if = "Option::is_none")]
    pub query_time_interval_prepend: Option<String>,
    #[doc = "The delimiter string between 2 QueryTimeFormat in the query parameter `queryTimeIntervalAttributeName`."]
    #[serde(rename = "queryTimeIntervalDelimiter", default, skip_serializing_if = "Option::is_none")]
    pub query_time_interval_delimiter: Option<String>,
}
impl RestApiPollerRequestConfig {
    pub fn new(api_endpoint: String) -> Self {
        Self {
            api_endpoint,
            rate_limit_qps: None,
            query_window_in_min: None,
            http_method: None,
            query_time_format: None,
            retry_count: None,
            timeout_in_seconds: None,
            is_post_payload_json: None,
            headers: None,
            query_parameters: None,
            query_parameters_template: None,
            start_time_attribute_name: None,
            end_time_attribute_name: None,
            query_time_interval_attribute_name: None,
            query_time_interval_prepend: None,
            query_time_interval_delimiter: None,
        }
    }
}
pub mod rest_api_poller_request_config {
    use super::*;
    #[doc = "The HTTP method, default value GET."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    ...
    impl Serialize for HttpMethod {
        ...
        {
            match self {
                Self::Get => serializer.serialize_unit_variant("HttpMethod", 0u32, "GET"),
                ...
                Self::Delete => serializer.serialize_unit_variant("HttpMethod", 3u32, "DELETE"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "The request paging configuration."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RestApiPollerRequestPagingConfig {
    #[doc = "Type of paging"]
    #[serde(rename = "pagingType")]
    pub paging_type: RestApiPollerRequestPagingKind,
    #[doc = "Page size"]
    #[serde(rename = "pageSize", default, skip_serializing_if = "Option::is_none")]
    pub page_size: Option<i32>,
    #[doc = "Page size parameter name"]
    #[serde(rename = "pageSizeParameterName", default, skip_serializing_if = "Option::is_none")]
    pub page_size_parameter_name: Option<String>,
}
impl RestApiPollerRequestPagingConfig {
    pub fn new(paging_type: RestApiPollerRequestPagingKind) -> Self {
        Self {
            paging_type,
            page_size: None,
            page_size_parameter_name: None,
        }
    }
}
#[doc = "The request paging configuration for Count base paging type parameters."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RestApiPollerRequestPagingCountBaseConfig {
    #[serde(flatten)]
    pub rest_api_poller_request_paging_config: RestApiPollerRequestPagingConfig,
    #[doc = "Indicates whether the count is zero based"]
    #[serde(rename = "zeroBasedIndexing", default, skip_serializing_if = "Option::is_none")]
    pub zero_based_indexing: Option<bool>,
    #[doc = "JSON path of page count in HTTP response payload"]
    #[serde(rename = "pageCountJsonPath", default, skip_serializing_if = "Option::is_none")]
    pub page_count_json_path: Option<String>,
    #[doc = "Parameter name of page number in HTTP request"]
    #[serde(rename = "pageNumberParaName", default, skip_serializing_if = "Option::is_none")]
    pub page_number_para_name: Option<String>,
    #[doc = "JSON path of page number in HTTP response payload"]
    #[serde(rename = "pageNumberJsonPath", default, skip_serializing_if = "Option::is_none")]
    pub page_number_json_path: Option<String>,
    #[doc = "JSON path of total number of results in HTTP response payload"]
    #[serde(rename = "totalResultsJsonPath", default, skip_serializing_if = "Option::is_none")]
    pub total_results_json_path: Option<String>,
}
impl RestApiPollerRequestPagingCountBaseConfig {
    pub fn new(rest_api_poller_request_paging_config: RestApiPollerRequestPagingConfig) -> Self {
        Self {
            rest_api_poller_request_paging_config,
            zero_based_indexing: None,
            page_count_json_path: None,
            page_number_para_name: None,
            page_number_json_path: None,
            total_results_json_path: None,
        }
    }
}
#[doc = "Type of paging"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "RestApiPollerRequestPagingKind")]
pub enum RestApiPollerRequestPagingKind {
    LinkHeader,
    NextPageToken,
    NextPageUrl,
    PersistentToken,
...
impl FromStr for RestApiPollerRequestPagingKind {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for RestApiPollerRequestPagingKind {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for RestApiPollerRequestPagingKind {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::LinkHeader => serializer.serialize_unit_variant("RestApiPollerRequestPagingKind", 0u32, "LinkHeader"),
            Self::NextPageToken => serializer.serialize_unit_variant("RestApiPollerRequestPagingKind", 1u32, "NextPageToken"),
            Self::NextPageUrl => serializer.serialize_unit_variant("RestApiPollerRequestPagingKind", 2u32, "NextPageUrl"),
            Self::PersistentToken => serializer.serialize_unit_variant("RestApiPollerRequestPagingKind", 3u32, "PersistentToken"),
            Self::PersistentLinkHeader => serializer.serialize_unit_variant("RestApiPollerRequestPagingKind", 4u32, "PersistentLinkHeader"),
            Self::Offset => serializer.serialize_unit_variant("RestApiPollerRequestPagingKind", 5u32, "Offset"),
            Self::CountBasedPaging => serializer.serialize_unit_variant("RestApiPollerRequestPagingKind", 6u32, "CountBasedPaging"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "The request paging configuration for LinkHeader and PersistentLinkHeader paging type parameters."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RestApiPollerRequestPagingLinkHeaderConfig {
    #[serde(flatten)]
    pub rest_api_poller_request_paging_config: RestApiPollerRequestPagingConfig,
    #[doc = "JSON path of link header token in HTTP response payload"]
    #[serde(rename = "linkHeaderTokenJsonPath", default, skip_serializing_if = "Option::is_none")]
    pub link_header_token_json_path: Option<String>,
    #[doc = "Rel link name from the link header"]
    #[serde(rename = "linkHeaderRelLinkName", default, skip_serializing_if = "Option::is_none")]
    pub link_header_rel_link_name: Option<String>,
}
impl RestApiPollerRequestPagingLinkHeaderConfig {
    pub fn new(rest_api_poller_request_paging_config: RestApiPollerRequestPagingConfig) -> Self {
        Self {
            rest_api_poller_request_paging_config,
            link_header_token_json_path: None,
            link_header_rel_link_name: None,
        }
    }
}
#[doc = "The request paging configuration for NextPageUrl paging type parameters."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RestApiPollerRequestPagingNextPageUrlConfig {
    #[serde(flatten)]
    pub rest_api_poller_request_paging_config: RestApiPollerRequestPagingConfig,
    #[doc = "Next page URL"]
    #[serde(rename = "nextPageUrl", default, skip_serializing_if = "Option::is_none")]
    pub next_page_url: Option<String>,
    #[doc = "Query parameters of next page URL"]
    #[serde(rename = "nextPageUrlQueryParameters", default, skip_serializing_if = "Option::is_none")]
    pub next_page_url_query_parameters: Option<serde_json::Value>,
    #[doc = "Paging query parameters in string template format"]
    #[serde(rename = "nextPageUrlQueryParametersTemplate", default, skip_serializing_if = "Option::is_none")]
    pub next_page_url_query_parameters_template: Option<String>,
    #[doc = "Next page parameter name in HTTP request"]
    #[serde(rename = "nextPageParaName", default, skip_serializing_if = "Option::is_none")]
    pub next_page_para_name: Option<String>,
    #[doc = "Next page header name in the request"]
    #[serde(rename = "nextPageRequestHeader", default, skip_serializing_if = "Option::is_none")]
    pub next_page_request_header: Option<String>,
    #[doc = "JSON path of flag in HTTP response payload to indicate more pages"]
    #[serde(rename = "hasNextFlagJsonPath", default, skip_serializing_if = "Option::is_none")]
    pub has_next_flag_json_path: Option<String>,
}
impl RestApiPollerRequestPagingNextPageUrlConfig {
    pub fn new(rest_api_poller_request_paging_config: RestApiPollerRequestPagingConfig) -> Self {
        Self {
            rest_api_poller_request_paging_config,
            next_page_url: None,
            next_page_url_query_parameters: None,
            next_page_url_query_parameters_template: None,
            next_page_para_name: None,
            next_page_request_header: None,
            has_next_flag_json_path: None,
        }
    }
}
#[doc = "The request paging configuration for Offset paging type parameters."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RestApiPollerRequestPagingOffsetConfig {
    #[serde(flatten)]
    pub rest_api_poller_request_paging_config: RestApiPollerRequestPagingConfig,
    #[doc = "Offset parameter name in HTTP request"]
    #[serde(rename = "offsetParaName", default, skip_serializing_if = "Option::is_none")]
    pub offset_para_name: Option<String>,
}
impl RestApiPollerRequestPagingOffsetConfig {
    pub fn new(rest_api_poller_request_paging_config: RestApiPollerRequestPagingConfig) -> Self {
        Self {
            rest_api_poller_request_paging_config,
            offset_para_name: None,
        }
    }
}
#[doc = "The request paging configuration for NextPageToken and PersistentToken paging type parameters."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RestApiPollerRequestPagingTokenConfig {
    #[serde(flatten)]
    pub rest_api_poller_request_paging_config: RestApiPollerRequestPagingConfig,
    #[doc = "JSON path of next page token in HTTP response payload"]
    #[serde(rename = "nextPageTokenJsonPath", default, skip_serializing_if = "Option::is_none")]
    pub next_page_token_json_path: Option<String>,
    #[doc = "JSON path of flag in HTTP response payload to indicate more pages"]
    #[serde(rename = "hasNextFlagJsonPath", default, skip_serializing_if = "Option::is_none")]
    pub has_next_flag_json_path: Option<String>,
    #[doc = "HTTP response header name of next page token"]
    #[serde(rename = "nextPageTokenResponseHeader", default, skip_serializing_if = "Option::is_none")]
    pub next_page_token_response_header: Option<String>,
    #[doc = "Next page parameter name in HTTP request"]
    #[serde(rename = "nextPageParaName", default, skip_serializing_if = "Option::is_none")]
    pub next_page_para_name: Option<String>,
    #[doc = "Next page header name in the request"]
...
impl RestApiPollerRequestPagingTokenConfig {
    pub fn new(rest_api_poller_request_paging_config: RestApiPollerRequestPagingConfig) -> Self {
        Self {
            rest_api_poller_request_paging_config,
            next_page_token_json_path: None,
            has_next_flag_json_path: None,
            next_page_token_response_header: None,
            next_page_para_name: None,
            next_page_request_header: None,
        }
    }
...
pub struct ServicePrincipal {
    ...
    #[doc = "Expiration time of service principal credentials."]
    #[serde(rename = "credentialsExpireOn", default, with = "azure_core::date::rfc3339::option")]
    pub credentials_expire_on: Option<::time::OffsetDateTime>,
}
...
#[doc = "Model for API authentication with session cookie."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SessionAuthModel {
    #[doc = "The user name attribute key value."]
    #[serde(rename = "userName")]
    pub user_name: serde_json::Value,
    #[doc = "The password attribute name."]
    pub password: serde_json::Value,
    #[doc = "Query parameters to session service endpoint."]
    #[serde(rename = "queryParameters", default, skip_serializing_if = "Option::is_none")]
    pub query_parameters: Option<serde_json::Value>,
    #[doc = "Indicating whether API key is set in HTTP POST payload."]
    #[serde(rename = "isPostPayloadJson", default, skip_serializing_if = "Option::is_none")]
    pub is_post_payload_json: Option<bool>,
    #[doc = "HTTP request headers to session service endpoint."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub headers: Option<serde_json::Value>,
    #[doc = "Session timeout in minutes."]
    #[serde(rename = "sessionTimeoutInMinutes", default, skip_serializing_if = "Option::is_none")]
    pub session_timeout_in_minutes: Option<i32>,
    #[doc = "Session id attribute name from HTTP response header."]
    #[serde(rename = "sessionIdName", default, skip_serializing_if = "Option::is_none")]
    pub session_id_name: Option<String>,
    #[doc = "HTTP request URL to session service endpoint."]
    #[serde(rename = "sessionLoginRequestUri", default, skip_serializing_if = "Option::is_none")]
    pub session_login_request_uri: Option<String>,
}
impl SessionAuthModel {
    pub fn new(user_name: serde_json::Value, password: serde_json::Value) -> Self {
        Self {
            user_name,
            password,
            query_parameters: None,
            is_post_payload_json: None,
            headers: None,
            session_timeout_in_minutes: None,
            session_id_name: None,
            session_login_request_uri: None,
        }
    }
}
...
impl SourceControl {
    pub fn new(properties: SourceControlProperties) -> Self {
        Self {
            resource_with_etag: ResourceWithEtag::default(),
            properties,
        }
...
#[doc = "Represents a threat intelligence object in Azure Security Insights."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct TiObject {
    #[serde(flatten)]
    pub resource: Resource,
    #[doc = "Describes properties common to all threat intelligence objects"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<TiObjectCommonProperties>,
}
impl TiObject {
    pub fn new() -> Self {
        Self {
...
#[doc = "The kind of the TI object"]
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "kind")]
pub enum TiObjectUnion {}
#[doc = "Describes properties common to all threat intelligence objects"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct TiObjectCommonProperties {
    #[doc = "The core STIX object that this TI object represents."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub data: Option<serde_json::Value>,
    #[doc = "Data about a user or client application."]
    #[serde(rename = "createdBy", default, skip_serializing_if = "Option::is_none")]
    pub created_by: Option<UserInfo>,
    #[doc = "The source name for this TI object."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub source: Option<String>,
    #[doc = "The timestamp for the first time this object was ingested."]
    #[serde(rename = "firstIngestedTimeUtc", default, with = "azure_core::date::rfc3339::option")]
    pub first_ingested_time_utc: Option<::time::OffsetDateTime>,
    #[doc = "The timestamp for the last time this object was ingested."]
    #[serde(rename = "lastIngestedTimeUtc", default, with = "azure_core::date::rfc3339::option")]
    pub last_ingested_time_utc: Option<::time::OffsetDateTime>,
    #[doc = "The ID of the rules version that was active when this TI object was last ingested."]
    #[serde(rename = "ingestionRulesVersion", default, skip_serializing_if = "Option::is_none")]
    pub ingestion_rules_version: Option<String>,
    #[doc = "The name of the method/application that initiated the last write to this TI object."]
    #[serde(rename = "lastUpdateMethod", default, skip_serializing_if = "Option::is_none")]
    pub last_update_method: Option<String>,
    #[doc = "Data about a user or client application."]
    #[serde(rename = "lastModifiedBy", default, skip_serializing_if = "Option::is_none")]
    pub last_modified_by: Option<UserInfo>,
    #[doc = "The timestamp for the last time this TI object was updated."]
    ...
    #[doc = "A dictionary used to help follow relationships from this object to other STIX objects. The keys are field names from the STIX object (in the 'data' field), and the values are lists of sources that can be prepended to the object ID in order to efficiently locate the target TI object."]
    #[serde(
        rename = "relationshipHints",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
...
#[doc = "Represents a threat actor in Azure Security Insights."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "Count of all the threat intelligence objects on the workspace that match the provided query."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ThreatIntelligenceCount {
    #[doc = "Count of all the threat intelligence objects on the workspace that match the provided query."]
    pub count: i32,
}
impl ThreatIntelligenceCount {
...
#[doc = "List all the threat intelligence objects on the workspace that match the provided query."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ThreatIntelligenceList {
    #[doc = "URL to fetch the next set of threat intelligence objects."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
    #[doc = "Array of threat intelligence objects on the workspace that match the provided query."]
    pub value: Vec<TiObjectUnion>,
}
impl azure_core::Continuable for ThreatIntelligenceList {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl ThreatIntelligenceList {
    pub fn new(value: Vec<TiObjectUnion>) -> Self {
        Self { next_link: None, value }
    }
}
...
pub struct PackageBaseProperties {
    ...
    pub is_deprecated: Option<MetadataTrueFalseFlag>,
    #[doc = "Version of the content.  Default and recommended format is numeric (e.g. 1, 1.0, 1.0.0, 1.0.0.0), following ARM template best practices.  Can also be any string, but then we cannot guarantee any version checks"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub version: Option<MetadataVersion>,
...
#[doc = "The json of the ARM template to deploy"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct ProductPackageAdditionalProperties {
    ...
    #[doc = "The metadata resource id."]
    #[serde(rename = "metadataResourceId", default, skip_serializing_if = "Option::is_none")]
    pub metadata_resource_id: Option<String>,
    #[doc = "The json of the ARM template to deploy"]
...
pub struct TemplateAdditionalProperties {
    ...
    #[doc = "Dependant templates. Expandable."]
    #[serde(
        rename = "dependantTemplates",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub dependant_templates: Vec<TemplateProperties>,
}
