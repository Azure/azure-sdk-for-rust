...
impl<'de> Deserialize<'de> for AlertRuleKind {
...
impl Serialize for AlertRuleKind {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Scheduled => serializer.serialize_unit_variant("AlertRuleKind", 0u32, "Scheduled"),
            Self::MicrosoftSecurityIncidentCreation => {
                serializer.serialize_unit_variant("AlertRuleKind", 1u32, "MicrosoftSecurityIncidentCreation")
            }
            Self::Fusion => serializer.serialize_unit_variant("AlertRuleKind", 2u32, "Fusion"),
...
impl Serialize for AlertSeverity {
    ...
    {
        match self {
            Self::High => serializer.serialize_unit_variant("AlertSeverity", 0u32, "High"),
            Self::Medium => serializer.serialize_unit_variant("AlertSeverity", 1u32, "Medium"),
            Self::Low => serializer.serialize_unit_variant("AlertSeverity", 2u32, "Low"),
            Self::Informational => serializer.serialize_unit_variant("AlertSeverity", 3u32, "Informational"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl Serialize for DataConnectorKind {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::Office365 => serializer.serialize_unit_variant("DataConnectorKind", 4u32, "Office365"),
            Self::AmazonWebServicesCloudTrail => {
                serializer.serialize_unit_variant("DataConnectorKind", 5u32, "AmazonWebServicesCloudTrail")
            }
            Self::AzureAdvancedThreatProtection => {
                serializer.serialize_unit_variant("DataConnectorKind", 6u32, "AzureAdvancedThreatProtection")
            }
            Self::MicrosoftDefenderAdvancedThreatProtection => {
                serializer.serialize_unit_variant("DataConnectorKind", 7u32, "MicrosoftDefenderAdvancedThreatProtection")
            }
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
...
pub mod incident_properties {
    ...
    impl Serialize for Classification {
        ...
        {
            match self {
                Self::Undetermined => serializer.serialize_unit_variant("Classification", 0u32, "Undetermined"),
                Self::TruePositive => serializer.serialize_unit_variant("Classification", 1u32, "TruePositive"),
                Self::BenignPositive => serializer.serialize_unit_variant("Classification", 2u32, "BenignPositive"),
                Self::FalsePositive => serializer.serialize_unit_variant("Classification", 3u32, "FalsePositive"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    #[doc = "The classification reason the incident was closed with"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ClassificationReason")]
    ...
    impl<'de> Deserialize<'de> for ClassificationReason {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for ClassificationReason {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::SuspiciousActivity => serializer.serialize_unit_variant("ClassificationReason", 0u32, "SuspiciousActivity"),
                Self::SuspiciousButExpected => serializer.serialize_unit_variant("ClassificationReason", 1u32, "SuspiciousButExpected"),
                Self::IncorrectAlertLogic => serializer.serialize_unit_variant("ClassificationReason", 2u32, "IncorrectAlertLogic"),
                Self::InaccurateData => serializer.serialize_unit_variant("ClassificationReason", 3u32, "InaccurateData"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
