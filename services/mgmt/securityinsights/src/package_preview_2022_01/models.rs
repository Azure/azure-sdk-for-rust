...
pub struct WatchlistProperties {
    ...
    #[doc = "The Shared Access Signature (SAS) URI under which the large csv watchlist file is located and from which the watchlist and its items will be created"]
