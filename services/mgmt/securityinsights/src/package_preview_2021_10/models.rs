...
impl FusionAlertRuleProperties {
    pub fn new(alert_rule_template_name: String, enabled: bool, source_settings: Vec<FusionSourceSettings>) -> Self {
        Self {
...
impl Serialize for IncidentLabelType {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::System => serializer.serialize_unit_variant("IncidentLabelType", 1u32, "System"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
