...
pub struct DevCenterUpdateProperties {
    ...
    #[doc = "Indicates the resource types that are restricted from being accessed by a project unless allowed by a curation profile."]
    #[serde(
...
pub struct ResourcePolicy {
    #[doc = "Resources that are included and shared as a part of a curation profile."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
