...
#[doc = "Represents an curation profile resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CurationProfile {
    #[serde(flatten)]
    pub resource: Resource,
    #[doc = "Properties of an curation profile."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<CurationProfileProperties>,
}
...
#[doc = "Results of the curation profile list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CurationProfileListResult {
    #[doc = "Current page of results."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub value: Vec<CurationProfile>,
    #[doc = "URL to get the next set of results if there are any."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for CurationProfileListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl CurationProfileListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Properties of an curation profile."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CurationProfileProperties {
    #[serde(flatten)]
    pub curation_profile_update_properties: CurationProfileUpdateProperties,
    #[doc = "Provisioning state of the resource."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<ProvisioningState>,
}
impl CurationProfileProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The curation profile properties for partial update. Properties not provided in the update request will not be changed."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CurationProfileUpdate {
    #[doc = "Properties of an curation profile. These properties can be updated after the resource has been created."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<CurationProfileUpdateProperties>,
}
impl CurationProfileUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Properties of an curation profile. These properties can be updated after the resource has been created."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CurationProfileUpdateProperties {
    #[doc = "Resource policies that are a part of this curation profile."]
    #[serde(
        rename = "resourcePolicies",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub resource_policies: Vec<ResourcePolicy>,
    #[doc = "Resources that have access to the shared resources that are a part of this curation profile."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
impl CurationProfileUpdateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "DevCenterResourceType")]
pub enum DevCenterResourceType {
    Images,
    AttachedNetworks,
    Skus,
    #[serde(skip_deserializing)]
...
impl FromStr for DevCenterResourceType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for DevCenterResourceType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for DevCenterResourceType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Images => serializer.serialize_unit_variant("DevCenterResourceType", 0u32, "Images"),
            Self::AttachedNetworks => serializer.serialize_unit_variant("DevCenterResourceType", 1u32, "AttachedNetworks"),
            Self::Skus => serializer.serialize_unit_variant("DevCenterResourceType", 2u32, "Skus"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct DevCenterUpdateProperties {
    ...
    #[doc = "Indicates the resource types that are restricted from being accessed by a project unless allowed by a project policy."]
    #[serde(
        rename = "restrictedResourceTypes",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub restricted_resource_types: Vec<DevCenterResourceType>,
}
...
pub struct PlanMemberProperties {
    #[serde(flatten)]
    pub plan_member_update_properties: PlanMemberUpdateProperties,
    ...
    #[doc = "The sync status of the plan member."]
    #[serde(rename = "syncStatus", default, skip_serializing_if = "Option::is_none")]
    pub sync_status: Option<PlanMemberSyncStatus>,
    #[doc = "Provisioning state of the resource."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<ProvisioningState>,
}
...
#[doc = "The sync status of the plan member."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PlanMemberSyncStatus {
    #[doc = "The synchronization state of the plan member."]
    #[serde(rename = "syncState", default, skip_serializing_if = "Option::is_none")]
    pub sync_state: Option<plan_member_sync_status::SyncState>,
    #[doc = "The error detail."]
    #[serde(rename = "lastSyncError", default, skip_serializing_if = "Option::is_none")]
    pub last_sync_error: Option<ErrorDetail>,
    #[doc = "When the plan member was last synced."]
    #[serde(rename = "lastSyncTime", default, with = "azure_core::date::rfc3339::option")]
    pub last_sync_time: Option<::time::OffsetDateTime>,
}
impl PlanMemberSyncStatus {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod plan_member_sync_status {
    use super::*;
    #[doc = "The synchronization state of the plan member."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "SyncState")]
    ...
    impl Serialize for SyncState {
            ...
            S: Serializer,
        {
            match self {
                Self::Succeeded => serializer.serialize_unit_variant("SyncState", 0u32, "Succeeded"),
                Self::InProgress => serializer.serialize_unit_variant("SyncState", 1u32, "InProgress"),
                Self::NotStarted => serializer.serialize_unit_variant("SyncState", 2u32, "NotStarted"),
                Self::Failed => serializer.serialize_unit_variant("SyncState", 3u32, "Failed"),
                Self::Canceled => serializer.serialize_unit_variant("SyncState", 4u32, "Canceled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct PlanMemberUpdate {
    #[doc = "Properties of the devcenter plan member."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<PlanMemberUpdateProperties>,
    #[doc = "Resource tags."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<Tags>,
}
...
#[doc = "Properties of the devcenter plan member."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PlanMemberUpdateProperties {
    #[doc = "The tier of the member."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tier: Option<String>,
}
impl PlanMemberUpdateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Represents an project policy resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ProjectPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ProjectPolicyProperties>,
}
impl ProjectPolicy {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "Results of the project policy list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ProjectPolicyListResult {
    #[doc = "Current page of results."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub value: Vec<ProjectPolicy>,
    #[doc = "URL to get the next set of results if there are any."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ProjectPolicyListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl ProjectPolicyListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Properties of an project policy."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ProjectPolicyProperties {
    #[serde(flatten)]
    pub project_policy_update_properties: ProjectPolicyUpdateProperties,
    #[doc = "Provisioning state of the resource."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<ProvisioningState>,
}
impl ProjectPolicyProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ProjectPolicyUpdate {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ProjectPolicyUpdateProperties>,
}
impl ProjectPolicyUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl ProjectPolicyUpdateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct StopOnNoConnectConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<StopOnNoConnectEnableStatus>,
