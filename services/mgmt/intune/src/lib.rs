...
pub use package_2015_01_privatepreview::{models, operations, operations::Client, operations::ClientBuilder};
...
pub use package_2015_01_preview::{models, operations, operations::Client, operations::ClientBuilder};
