...
pub mod role_assignment_approval {
    ...
    pub mod list {
        use super::models;
        type Response = models::RoleAssignmentApprovalListResult;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
            DefaultResponse {
    ...
    pub mod get_by_id {
        use super::models;
        type Response = models::RoleAssignmentApproval;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
            DefaultResponse {
...
pub mod role_assignment_approval_steps {
    ...
    pub mod list {
        use super::models;
        type Response = models::RoleAssignmentApprovalStepListResult;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
            DefaultResponse {
...
pub mod role_assignment_approval_step {
    ...
    pub mod get_by_id {
        use super::models;
        type Response = models::RoleAssignmentApprovalStep;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
            DefaultResponse {
