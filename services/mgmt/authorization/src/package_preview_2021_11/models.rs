...
pub struct AccessReviewHistoryDefinitionProperties {
    ...
    #[serde(rename = "reviewHistoryPeriodStartDateTime", default, skip_serializing_if = "Option::is_none")]
    pub review_history_period_start_date_time: Option<String>,
    ...
    #[serde(rename = "reviewHistoryPeriodEndDateTime", default, skip_serializing_if = "Option::is_none")]
    pub review_history_period_end_date_time: Option<String>,
...
pub struct AccessReviewHistoryInstanceProperties {
    ...
    #[serde(rename = "runDateTime", default, skip_serializing_if = "Option::is_none")]
    pub run_date_time: Option<String>,
    #[doc = "Date time when the history data report is scheduled to be generated."]
    #[serde(rename = "fulfilledDateTime", default, skip_serializing_if = "Option::is_none")]
    pub fulfilled_date_time: Option<String>,
