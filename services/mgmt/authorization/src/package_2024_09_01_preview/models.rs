...
#[doc = "The PIM Only Mode settings."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PimOnlyModeSettings {
    #[doc = "Determines whether the setting is enabled, disabled or report only."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mode: Option<pim_only_mode_settings::Mode>,
    #[doc = "The list of excluded entities that the rule does not apply to."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub excludes: Vec<UsersOrServicePrincipalSet>,
    #[doc = "The list of excluded assignment types allowed."]
    #[serde(
        rename = "excludedAssignmentTypes",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub excluded_assignment_types: Vec<String>,
}
impl PimOnlyModeSettings {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod pim_only_mode_settings {
    use super::*;
    #[doc = "Determines whether the setting is enabled, disabled or report only."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Mode")]
    ...
    impl Serialize for Mode {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Enabled => serializer.serialize_unit_variant("Mode", 1u32, "Enabled"),
...
pub struct RoleAssignmentScheduleRequestProperties {
    ...
    #[serde(rename = "requestorId", default, skip_serializing_if = "Option::is_none")]
    pub requestor_id: Option<String>,
    #[doc = "Provides role assignment request scope, role definition and principal properties for expansion. "]
    #[serde(rename = "expandedProperties", default, skip_serializing_if = "Option::is_none")]
    pub expanded_properties: Option<ExpandedProperties>,
}
...
pub struct RoleManagementPolicyExpirationRule {
    ...
    #[doc = "The members not restricted by expiration rule."]
    #[serde(
        rename = "exceptionMembers",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub exception_members: Vec<UserSet>,
}
...
#[doc = "The role management policy PIM only mode rule."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RoleManagementPolicyPimOnlyModeRule {
    #[serde(flatten)]
    pub role_management_policy_rule: RoleManagementPolicyRule,
    #[doc = "The PIM Only Mode settings."]
    #[serde(rename = "pimOnlyModeSettings", default, skip_serializing_if = "Option::is_none")]
    pub pim_only_mode_settings: Option<PimOnlyModeSettings>,
}
impl RoleManagementPolicyPimOnlyModeRule {
    pub fn new(role_management_policy_rule: RoleManagementPolicyRule) -> Self {
        Self {
            role_management_policy_rule,
            pim_only_mode_settings: None,
        }
    }
}
#[doc = "Role management policy properties with scope."]
...
impl Serialize for RoleManagementPolicyRuleType {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::RoleManagementPolicyPimOnlyModeRule => {
                serializer.serialize_unit_variant("RoleManagementPolicyRuleType", 5u32, "RoleManagementPolicyPimOnlyModeRule")
            }
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
...
#[doc = "The detail of a subject."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct UsersOrServicePrincipalSet {
    #[doc = "The type of user."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<users_or_service_principal_set::Type>,
    #[doc = "The object id of the entity."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "The display Name of the entity."]
    #[serde(rename = "displayName", default, skip_serializing_if = "Option::is_none")]
    pub display_name: Option<String>,
}
impl UsersOrServicePrincipalSet {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod users_or_service_principal_set {
    use super::*;
    #[doc = "The type of user."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Type")]
    ...
    impl Serialize for Type {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::ServicePrincipal => serializer.serialize_unit_variant("Type", 2u32, "ServicePrincipal"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
