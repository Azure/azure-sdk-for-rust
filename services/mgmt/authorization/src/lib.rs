...
#[cfg(feature = "package-2020-10-01-only")]
pub mod package_2020_10_01_only;
#[cfg(all(feature = "package-2020-10-01-only", not(feature = "no-default-tag")))]
pub use package_2020_10_01_only::{models, operations, operations::Client, operations::ClientBuilder, operations::Error};
#[cfg(feature = "package-2022-04-01-preview-only")]
pub mod package_2022_04_01_preview_only;
#[cfg(all(feature = "package-2022-04-01-preview-only", not(feature = "no-default-tag")))]
...
#[cfg(all(feature = "package-2021-01-01-preview-only", not(feature = "no-default-tag")))]
...
#[cfg(all(feature = "package-2020-10-01-preview-only", not(feature = "no-default-tag")))]
...
#[cfg(all(feature = "package-2020-04-01-preview-only", not(feature = "no-default-tag")))]
...
#[cfg(all(feature = "package-2019-08-01-preview-only", not(feature = "no-default-tag")))]
...
#[cfg(all(feature = "package-2018-09-01-preview-only", not(feature = "no-default-tag")))]
...
#[cfg(all(feature = "package-2018-07-01-preview-only", not(feature = "no-default-tag")))]
...
#[cfg(all(feature = "package-2018-01-01-preview", not(feature = "no-default-tag")))]
...
#[cfg(all(feature = "package-2018-01-01-preview-only", not(feature = "no-default-tag")))]
...
#[cfg(all(feature = "package-2017-10-01-preview", not(feature = "no-default-tag")))]
...
#[cfg(all(feature = "package-2017-10-01-preview-only", not(feature = "no-default-tag")))]
...
#[cfg(all(feature = "package-2015-07-01", not(feature = "no-default-tag")))]
...
#[cfg(all(feature = "package-2015-06-01-preview", not(feature = "no-default-tag")))]
