...
use std::str::FromStr;
#[doc = "Marketplace Subscription and Organization details to which resource gets billed into."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct BillingInfoResponse {
    #[doc = "Marketplace SAAS Info of the resource."]
    #[serde(rename = "marketplaceSaasInfo", default, skip_serializing_if = "Option::is_none")]
    pub marketplace_saas_info: Option<MarketplaceSaaSInfo>,
    #[doc = "Partner Billing details associated with the resource."]
    #[serde(rename = "partnerBillingEntity", default, skip_serializing_if = "Option::is_none")]
    pub partner_billing_entity: Option<PartnerBillingEntity>,
}
...
#[doc = "Connected Partner Resource Properties"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ConnectedPartnerResourceProperties {
    #[doc = "Elastic deployment name"]
    #[serde(rename = "partnerDeploymentName", default, skip_serializing_if = "Option::is_none")]
    pub partner_deployment_name: Option<String>,
    #[doc = "Deployment URL of the elasticsearch in Elastic cloud deployment."]
    #[serde(rename = "partnerDeploymentUri", default, skip_serializing_if = "Option::is_none")]
    pub partner_deployment_uri: Option<String>,
    #[doc = "The azure resource Id of the deployment."]
...
impl ConnectedPartnerResourceProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Connected Partner Resources List Format"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ConnectedPartnerResourcesListFormat {
    #[doc = "Connected Partner Resource Properties"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ConnectedPartnerResourceProperties>,
}
impl ConnectedPartnerResourcesListFormat {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = " List of all active elastic deployments."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ConnectedPartnerResourcesListResponse {
    ...
    pub value: Vec<ConnectedPartnerResourcesListFormat>,
...
pub struct DeploymentInfoResponse {
    ...
    #[doc = "Elasticsearch endpoint in Elastic cloud deployment. This is either the aliased_endpoint if available, or the service_url otherwise."]
    #[serde(rename = "elasticsearchEndPoint", default, skip_serializing_if = "Option::is_none")]
    pub elasticsearch_end_point: Option<String>,
    #[doc = "Deployment URL of the elasticsearch in Elastic cloud deployment."]
    #[serde(rename = "deploymentUrl", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "The Azure Subscription ID to which the Organization of the logged in user belongs and gets billed into."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ElasticOrganizationToAzureSubscriptionMappingResponse {
    #[doc = "The properties of Azure Subscription ID to which the Organization of the logged in user belongs and gets billed into."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ElasticOrganizationToAzureSubscriptionMappingResponseProperties>,
}
impl ElasticOrganizationToAzureSubscriptionMappingResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The properties of Azure Subscription ID to which the Organization of the logged in user belongs and gets billed into."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ElasticOrganizationToAzureSubscriptionMappingResponseProperties {
    #[doc = "The Azure Subscription ID to which the Organization belongs and gets billed into. This is empty for a new user OR a user without an Elastic Organization."]
    #[serde(rename = "billedAzureSubscriptionId", default, skip_serializing_if = "Option::is_none")]
    pub billed_azure_subscription_id: Option<String>,
    #[doc = "Marketplace SAAS Info of the resource."]
    #[serde(rename = "marketplaceSaasInfo", default, skip_serializing_if = "Option::is_none")]
    pub marketplace_saas_info: Option<MarketplaceSaaSInfo>,
    #[doc = "The Elastic Organization Id."]
    #[serde(rename = "elasticOrganizationId", default, skip_serializing_if = "Option::is_none")]
    pub elastic_organization_id: Option<String>,
    #[doc = "The Elastic Organization Name."]
    #[serde(rename = "elasticOrganizationName", default, skip_serializing_if = "Option::is_none")]
    pub elastic_organization_name: Option<String>,
}
impl ElasticOrganizationToAzureSubscriptionMappingResponseProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Elastic traffic filter object"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ElasticTrafficFilter {
    #[doc = "Id of the elastic filter"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "Name of the elastic filter"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Description of the elastic filter"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    #[doc = "Region of the elastic filter"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub region: Option<String>,
    #[doc = "Type of the elastic filter"]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<elastic_traffic_filter::Type>,
    #[doc = "IncludeByDefault for the elastic filter"]
    #[serde(rename = "includeByDefault", default, skip_serializing_if = "Option::is_none")]
    pub include_by_default: Option<bool>,
    #[doc = "Rules in the elastic filter"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub rules: Vec<ElasticTrafficFilterRule>,
}
impl ElasticTrafficFilter {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod elastic_traffic_filter {
    use super::*;
    #[doc = "Type of the elastic filter"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Type")]
    pub enum Type {
        #[serde(rename = "ip")]
        Ip,
        #[serde(rename = "azure_private_endpoint")]
    ...
    impl Serialize for Type {
        ...
        {
            match self {
                Self::Ip => serializer.serialize_unit_variant("Type", 0u32, "ip"),
                Self::AzurePrivateEndpoint => serializer.serialize_unit_variant("Type", 1u32, "azure_private_endpoint"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
}
#[doc = "List of elastic traffic filters in the account"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ElasticTrafficFilterResponse {
    #[doc = "List of elastic traffic filters in the account"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub rulesets: Vec<ElasticTrafficFilter>,
}
impl ElasticTrafficFilterResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Elastic traffic filter rule object"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ElasticTrafficFilterRule {
    #[doc = "IP of the elastic filter rule"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub source: Option<String>,
    #[doc = "Description of the elastic filter rule"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    #[doc = "Guid of Private Endpoint in the elastic filter rule"]
    #[serde(rename = "azureEndpointGuid", default, skip_serializing_if = "Option::is_none")]
    pub azure_endpoint_guid: Option<String>,
    #[doc = "Name of the Private Endpoint in the elastic filter rule"]
    #[serde(rename = "azureEndpointName", default, skip_serializing_if = "Option::is_none")]
    pub azure_endpoint_name: Option<String>,
    #[doc = "Id of the elastic filter rule"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
}
...
pub struct MarketplaceSaaSInfo {
    ...
    #[doc = "Marketplace Subscription Details: SaaS Subscription Status"]
    #[serde(rename = "marketplaceStatus", default, skip_serializing_if = "Option::is_none")]
    pub marketplace_status: Option<String>,
    #[doc = "The Azure Subscription ID to which the Marketplace Subscription belongs and gets billed into."]
    #[serde(rename = "billedAzureSubscriptionId", default, skip_serializing_if = "Option::is_none")]
    pub billed_azure_subscription_id: Option<String>,
    #[doc = "Flag specifying if the Marketplace status is subscribed or not."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub subscribed: Option<bool>,
}
impl MarketplaceSaaSInfo {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod marketplace_saa_s_info {
    ...
    pub struct MarketplaceSubscription {
        ...
        #[serde(default, skip_serializing_if = "Option::is_none")]
        pub id: Option<String>,
        #[doc = "Publisher Id of the Marketplace offer."]
        #[serde(rename = "publisherId", default, skip_serializing_if = "Option::is_none")]
        pub publisher_id: Option<String>,
        #[doc = "Offer Id of the Marketplace offer,"]
...
pub struct MonitorProperties {
    ...
    #[doc = "Plan details of the monitor resource."]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub version: Option<String>,
    #[doc = "State of the Azure Subscription containing the monitor resource"]
    #[serde(rename = "subscriptionState", default, skip_serializing_if = "Option::is_none")]
    pub subscription_state: Option<String>,
    #[doc = "Status of Azure Subscription where Marketplace SaaS is located."]
    #[serde(rename = "saaSAzureSubscriptionStatus", default, skip_serializing_if = "Option::is_none")]
    pub saa_s_azure_subscription_status: Option<String>,
    #[doc = "Name of the marketing campaign."]
    #[serde(rename = "sourceCampaignName", default, skip_serializing_if = "Option::is_none")]
    pub source_campaign_name: Option<String>,
    #[doc = "A unique identifier associated with the campaign."]
    #[serde(rename = "sourceCampaignId", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "The list of subscriptions and it's monitoring status by current Elastic monitor."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MonitoredSubscription {
    #[doc = "The subscriptionId to be monitored."]
    #[serde(rename = "subscriptionId", default, skip_serializing_if = "Option::is_none")]
    pub subscription_id: Option<String>,
    #[doc = "The state of monitoring."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<monitored_subscription::Status>,
    #[doc = "The reason of not monitoring the subscription."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub error: Option<String>,
    #[doc = "Definition of the properties for a TagRules resource."]
    #[serde(rename = "tagRules", default, skip_serializing_if = "Option::is_none")]
    pub tag_rules: Option<MonitoringTagRulesProperties>,
}
impl MonitoredSubscription {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod monitored_subscription {
    use super::*;
    #[doc = "The state of monitoring."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Status")]
...
#[doc = "The request to update subscriptions needed to be monitored by the Elastic monitor resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MonitoredSubscriptionProperties {
    #[doc = "Name of the monitored subscription resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "The id of the monitored subscription resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "The type of the monitored subscription resource."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<String>,
    #[doc = "The request to update subscriptions needed to be monitored by the Elastic monitor resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<SubscriptionList>,
}
impl MonitoredSubscriptionProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MonitoredSubscriptionPropertiesList {
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<MonitoredSubscriptionProperties>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for MonitoredSubscriptionPropertiesList {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl MonitoredSubscriptionPropertiesList {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct OpenAiIntegrationProperties {
    ...
    #[serde(rename = "openAIResourceEndpoint", default, skip_serializing_if = "Option::is_none")]
    pub open_ai_resource_endpoint: Option<String>,
    #[doc = "The connector id of Open AI resource"]
    #[serde(rename = "openAIConnectorId", default, skip_serializing_if = "Option::is_none")]
    pub open_ai_connector_id: Option<String>,
    #[doc = "Value of API key for Open AI resource"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Capture properties of Open AI resource Integration."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OpenAiIntegrationRpModel {
    #[doc = "Name of the integration."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "The id of the integration."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "The type of the integration."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<String>,
    #[doc = "Open AI Integration details."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<OpenAiIntegrationProperties>,
}
impl OpenAiIntegrationRpModel {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Response of a list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OpenAiIntegrationRpModelListResponse {
    #[doc = "Results of a list operation."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub value: Vec<OpenAiIntegrationRpModel>,
    #[doc = "Link to the next set of results, if any."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for OpenAiIntegrationRpModelListResponse {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl OpenAiIntegrationRpModelListResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Status of the OpenAI Integration"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OpenAiIntegrationStatusResponse {
    #[doc = "Status of the OpenAI Integration"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<OpenAiIntegrationStatusResponseProperties>,
}
impl OpenAiIntegrationStatusResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Status of the OpenAI Integration"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OpenAiIntegrationStatusResponseProperties {
    #[doc = "Status of the OpenAI Integration"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
}
impl OpenAiIntegrationStatusResponseProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Partner Billing details associated with the resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PartnerBillingEntity {
    #[doc = "The Elastic Organization Id."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "The Elastic Organization Name."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Link to the elastic organization page"]
    #[serde(rename = "partnerEntityUri", default, skip_serializing_if = "Option::is_none")]
    pub partner_entity_uri: Option<String>,
}
impl PartnerBillingEntity {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct PlanDetails {
    #[doc = "Offer ID of the plan"]
    #[serde(rename = "offerID", default, skip_serializing_if = "Option::is_none")]
    pub offer_id: Option<String>,
    #[doc = "Publisher ID of the plan"]
    #[serde(rename = "publisherID", default, skip_serializing_if = "Option::is_none")]
    pub publisher_id: Option<String>,
    #[doc = "Term ID of the plan"]
...
#[doc = "Resubscribe Properties"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ResubscribeProperties {
    #[doc = "Newly selected plan Id to create the new Marketplace subscription for Resubscribe"]
    #[serde(rename = "planId", default, skip_serializing_if = "Option::is_none")]
    pub plan_id: Option<String>,
    #[doc = "Newly selected term to create the new Marketplace subscription for Resubscribe"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub term: Option<String>,
    #[doc = "Newly selected Azure Subscription Id in which the new Marketplace subscription will be created for Resubscribe"]
    #[serde(rename = "subscriptionId", default, skip_serializing_if = "Option::is_none")]
    pub subscription_id: Option<String>,
    #[doc = "Newly selected Azure resource group in which the new Marketplace subscription will be created for Resubscribe"]
    #[serde(rename = "resourceGroup", default, skip_serializing_if = "Option::is_none")]
    pub resource_group: Option<String>,
    #[doc = "Organization Id of the Elastic Organization that needs to be resubscribed"]
    #[serde(rename = "organizationId", default, skip_serializing_if = "Option::is_none")]
    pub organization_id: Option<String>,
}
impl ResubscribeProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct SubscriptionList {
    #[doc = "The operation for the patch on the resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub operation: Option<subscription_list::Operation>,
    #[doc = "List of subscriptions and the state of the monitoring."]
    #[serde(
        rename = "monitoredSubscriptionList",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub monitored_subscription_list: Vec<MonitoredSubscription>,
    #[doc = "Provisioning state of Elastic resource."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<ProvisioningState>,
}
...
pub mod subscription_list {
    ...
    impl Serialize for Operation {
        ...
        {
            match self {
                Self::AddBegin => serializer.serialize_unit_variant("Operation", 0u32, "AddBegin"),
                Self::AddComplete => serializer.serialize_unit_variant("Operation", 1u32, "AddComplete"),
                Self::DeleteBegin => serializer.serialize_unit_variant("Operation", 2u32, "DeleteBegin"),
                Self::DeleteComplete => serializer.serialize_unit_variant("Operation", 3u32, "DeleteComplete"),
                Self::Active => serializer.serialize_unit_variant("Operation", 4u32, "Active"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Email Id of the User Organization, of which the API Key must be returned"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct UserEmailId {
    #[doc = "The User email Id"]
    #[serde(rename = "emailId", default, skip_serializing_if = "Option::is_none")]
    pub email_id: Option<String>,
}
impl UserEmailId {
