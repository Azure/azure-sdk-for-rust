...
#[doc = "An error response from the Gallery service."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
impl GalleryArtifactPublishingProfileBase {
    pub fn new(source: GalleryArtifactSource) -> Self {
        Self {
...
pub struct GalleryImageProperties {
    ...
    #[doc = "The allowed values for OS State are 'Generalized'."]
...
impl GalleryImageVersionProperties {
    pub fn new(publishing_profile: GalleryImageVersionPublishingProfile) -> Self {
        Self {
            publishing_profile,
            provisioning_state: None,
...
impl GalleryImageVersionPublishingProfile {
    pub fn new(gallery_artifact_publishing_profile_base: GalleryArtifactPublishingProfileBase) -> Self {
        Self {
            gallery_artifact_publishing_profile_base,
            replica_count: None,
