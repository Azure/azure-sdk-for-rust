...
#[doc = "SpotPlacementScores API Input."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SpotPlacementScoresInput {
    #[doc = "The desired regions"]
    #[serde(
        rename = "desiredLocations",
        default,
...
impl SpotPlacementScoresInput {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "SpotPlacementScores API response."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SpotPlacementScoresResponse {
    #[doc = "The desired regions"]
    #[serde(
        rename = "desiredLocations",
        default,
...
impl SpotPlacementScoresResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
