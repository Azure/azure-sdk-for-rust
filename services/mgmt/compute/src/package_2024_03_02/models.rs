...
pub struct CapacityReservationGroupInstanceView {
    ...
    #[doc = "List of the subscriptions that the capacity reservation group is shared with. **Note:** Minimum api-version: 2024-03-01. Please refer to https://aka.ms/computereservationsharing for more details."]
    #[serde(
...
#[doc = "Specifies how the virtual machine disk should be created. Possible values are **Attach:** This value is used when you are using a specialized disk to create the virtual machine. **FromImage:** This value is used when you are using an image to create the virtual machine. If you are using a platform image, you should also use the imageReference element described above. If you are using a marketplace image, you should also use the plan element previously described. **Empty:** This value is used when creating an empty data disk. **Copy:** This value is used to create a data disk from a snapshot or another disk. **Restore:** This value is used to create a data disk from a disk restore point."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
impl Serialize for CreateOption {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::Copy => serializer.serialize_unit_variant("CreateOption", 3u32, "Copy"),
            Self::Restore => serializer.serialize_unit_variant("CreateOption", 4u32, "Restore"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct DataDisk {
    ...
    #[doc = "The API entity reference."]
    #[serde(rename = "sourceResource", default, skip_serializing_if = "Option::is_none")]
    pub source_resource: Option<ApiEntityReference>,
...
impl Serialize for DiffDiskPlacement {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::NvmeDisk => serializer.serialize_unit_variant("DiffDiskPlacement", 2u32, "NvmeDisk"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct DiskRestorePointProperties {
    ...
    #[serde(rename = "securityProfile", default, skip_serializing_if = "Option::is_none")]
    pub security_profile: Option<DiskSecurityProfile>,
    #[doc = "Logical sector size in bytes for disk restore points of UltraSSD_LRS and PremiumV2_LRS disks. Supported values are 512 and 4096. 4096 is the default."]
    #[serde(rename = "logicalSectorSize", default, skip_serializing_if = "Option::is_none")]
    pub logical_sector_size: Option<i32>,
}
...
#[doc = "Specifies eventGridAndResourceGraph related Scheduled Event related configurations."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EventGridAndResourceGraph {
    #[doc = "Specifies if event grid and resource graph is enabled for Scheduled event related configurations."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enable: Option<bool>,
}
impl EventGridAndResourceGraph {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Specifies ProxyAgent settings while creating the virtual machine. Minimum api-version: 2024-03-01."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct ResourceSharingProfile {
    #[doc = "Specifies an array of subscription resource IDs that capacity reservation group is shared with. **Note:** Minimum api-version: 2024-03-01. Please refer to https://aka.ms/computereservationsharing for more details."]
    #[serde(
...
pub struct ScheduledEventsAdditionalPublishingTargets {
    #[doc = "Specifies eventGridAndResourceGraph related Scheduled Event related configurations."]
    #[serde(rename = "eventGridAndResourceGraph", default, skip_serializing_if = "Option::is_none")]
    pub event_grid_and_resource_graph: Option<EventGridAndResourceGraph>,
}
impl ScheduledEventsAdditionalPublishingTargets {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Specifies Redeploy, Reboot and ScheduledEventsAdditionalPublishingTargets Scheduled Event related configurations."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ScheduledEventsPolicy {
    #[doc = "Specifies Redeploy related Scheduled Event related configurations."]
    #[serde(rename = "userInitiatedRedeploy", default, skip_serializing_if = "Option::is_none")]
    pub user_initiated_redeploy: Option<UserInitiatedRedeploy>,
    #[doc = "Specifies Reboot related Scheduled Event related configurations."]
    #[serde(rename = "userInitiatedReboot", default, skip_serializing_if = "Option::is_none")]
    ...
    pub scheduled_events_additional_publishing_targets: Option<ScheduledEventsAdditionalPublishingTargets>,
}
impl ScheduledEventsPolicy {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Specifies the security posture to be used in the scale set. Minimum api-version: 2023-03-01"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecurityPostureReference {
    #[doc = "The security posture reference id in the form of /CommunityGalleries/{communityGalleryName}/securityPostures/{securityPostureName}/versions/{major.minor.patch}|latest"]
    pub id: String,
    #[doc = "The list of virtual machine extension names to exclude when applying the security posture."]
    #[serde(
    ...
    #[serde(rename = "isOverridable", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Specifies the security posture to be used in the scale set. Minimum api-version: 2023-03-01"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SecurityPostureReferenceUpdate {
    #[doc = "The security posture reference id in the form of /CommunityGalleries/{communityGalleryName}/securityPostures/{securityPostureName}/versions/{major.minor.patch}|latest"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "The list of virtual machine extension names to exclude when applying the security posture."]
...
impl SecurityPostureReferenceUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct UserInitiatedReboot {
    #[doc = "Specifies Reboot Scheduled Event related configurations."]
    #[serde(rename = "automaticallyApprove", default, skip_serializing_if = "Option::is_none")]
    pub automatically_approve: Option<bool>,
}
impl UserInitiatedReboot {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct UserInitiatedRedeploy {
    #[doc = "Specifies Redeploy Scheduled Event related configurations."]
    #[serde(rename = "automaticallyApprove", default, skip_serializing_if = "Option::is_none")]
    pub automatically_approve: Option<bool>,
}
impl UserInitiatedRedeploy {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct VirtualMachineProperties {
    ...
    pub hardware_profile: Option<HardwareProfile>,
    #[doc = "Specifies Redeploy, Reboot and ScheduledEventsAdditionalPublishingTargets Scheduled Event related configurations."]
    #[serde(rename = "scheduledEventsPolicy", default, skip_serializing_if = "Option::is_none")]
...
pub struct VirtualMachineScaleSetUpdateVmProfile {
    ...
    pub security_posture_reference: Option<SecurityPostureReferenceUpdate>,
    #[doc = "Specifies the Security profile settings for the virtual machine or virtual machine scale set."]
    #[serde(rename = "securityProfile", default, skip_serializing_if = "Option::is_none")]
    pub security_profile: Option<SecurityProfile>,
    #[doc = "Specifies the boot diagnostic settings state. Minimum api-version: 2015-06-15."]
...
pub struct VirtualMachineScaleSetVmProfile {
    ...
    #[doc = "Specifies the time in which this VM profile for the Virtual Machine Scale Set was created. Minimum API version for this property is 2024-03-01. This value will be added to VMSS Flex VM tags when creating/updating the VMSS VM Profile with minimum api-version 2024-03-01."]
    #[serde(rename = "timeCreated", default, with = "azure_core::date::rfc3339::option")]
    pub time_created: Option<::time::OffsetDateTime>,
}
...
pub struct VirtualMachineScaleSetVmReimageParameters {
    ...
    #[doc = "Parameter to force update ephemeral OS disk for a virtual machine scale set VM"]
    #[serde(rename = "forceUpdateOSDiskForEphemeral", default, skip_serializing_if = "Option::is_none")]
    pub force_update_os_disk_for_ephemeral: Option<bool>,
}
