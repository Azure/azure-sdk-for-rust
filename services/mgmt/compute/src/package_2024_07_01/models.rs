...
#[doc = "Specifies the sku profile for the virtual machine scale set. With this property the customer is able to specify a list of VM sizes and an allocation strategy."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SkuProfile {
    #[doc = "Specifies the VM sizes for the virtual machine scale set."]
    #[serde(
        rename = "vmSizes",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub vm_sizes: Vec<SkuProfileVmSize>,
    #[doc = "Specifies the allocation strategy for the virtual machine scale set based on which the VMs will be allocated."]
    #[serde(rename = "allocationStrategy", default, skip_serializing_if = "Option::is_none")]
    pub allocation_strategy: Option<sku_profile::AllocationStrategy>,
}
impl SkuProfile {
    pub fn new() -> Self {
        Self::default()
...
pub mod sku_profile {
    ...
    #[doc = "Specifies the allocation strategy for the virtual machine scale set based on which the VMs will be allocated."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "AllocationStrategy")]
    ...
    impl Serialize for AllocationStrategy {
        ...
        {
            match self {
                Self::LowestPrice => serializer.serialize_unit_variant("AllocationStrategy", 0u32, "LowestPrice"),
                Self::CapacityOptimized => serializer.serialize_unit_variant("AllocationStrategy", 1u32, "CapacityOptimized"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
}
#[doc = "Specifies the VM Size."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SkuProfileVmSize {
    #[doc = "Specifies the name of the VM Size."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
impl SkuProfileVmSize {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct VirtualMachineScaleSet {
    ...
    #[doc = "The virtual machine scale set zones."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
pub struct VirtualMachineScaleSetProperties {
    ...
    #[doc = "Specifies the align mode between Virtual Machine Scale Set compute and storage Fault Domain count."]
    #[serde(rename = "zonalPlatformFaultDomainAlignMode", default, skip_serializing_if = "Option::is_none")]
    pub zonal_platform_fault_domain_align_mode: Option<ZonalPlatformFaultDomainAlignMode>,
    #[doc = "Specifies the sku profile for the virtual machine scale set. With this property the customer is able to specify a list of VM sizes and an allocation strategy."]
    #[serde(rename = "skuProfile", default, skip_serializing_if = "Option::is_none")]
    pub sku_profile: Option<SkuProfile>,
}
...
pub struct VirtualMachineScaleSetVmProfile {
    ...
    #[doc = "Specifies the time in which this VM profile for the Virtual Machine Scale Set was created. This value will be added to VMSS Flex VM tags when creating/updating the VMSS VM Profile. Minimum API version for this property is 2023-09-01."]
    #[serde(rename = "timeCreated", default, with = "azure_core::date::rfc3339::option")]
    pub time_created: Option<::time::OffsetDateTime>,
}
...
pub struct WindowsConfiguration {
    ...
    #[doc = "Indicates whether VMAgent Platform Updates are enabled for the Windows Virtual Machine."]
    #[serde(rename = "enableVMAgentPlatformUpdates", default, skip_serializing_if = "Option::is_none")]
    pub enable_vm_agent_platform_updates: Option<bool>,
}
...
#[doc = "Specifies the align mode between Virtual Machine Scale Set compute and storage Fault Domain count."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ZonalPlatformFaultDomainAlignMode")]
...
impl FromStr for ZonalPlatformFaultDomainAlignMode {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for ZonalPlatformFaultDomainAlignMode {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for ZonalPlatformFaultDomainAlignMode {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Aligned => serializer.serialize_unit_variant("ZonalPlatformFaultDomainAlignMode", 0u32, "Aligned"),
            Self::Unaligned => serializer.serialize_unit_variant("ZonalPlatformFaultDomainAlignMode", 1u32, "Unaligned"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
