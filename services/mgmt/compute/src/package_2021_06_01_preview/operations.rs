...
pub mod cloud_service_operating_systems {
    ...
    pub async fn get_os_version(
        ...
        os_version_name: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::OsVersion, get_os_version::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
    ...
    pub async fn list_os_versions(
        ...
        location: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::OsVersionListResult, list_os_versions::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/providers/Microsoft.Compute/locations/{}/cloudServiceOsVersions",
            operation_config.base_path(),
    ...
    pub async fn get_os_family(
        ...
        os_family_name: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::OsFamily, get_os_family::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
    ...
    pub async fn list_os_families(
        ...
        location: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::OsFamilyListResult, list_os_families::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/providers/Microsoft.Compute/locations/{}/cloudServiceOsFamilies",
            operation_config.base_path(),
