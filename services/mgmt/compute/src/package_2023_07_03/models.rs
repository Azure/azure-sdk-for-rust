...
#[doc = "Describes the alternative option specified by the Publisher for this image when this image is deprecated."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
    ...
    impl Serialize for Type {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Offer => serializer.serialize_unit_variant("Type", 1u32, "Offer"),
                Self::Plan => serializer.serialize_unit_variant("Type", 2u32, "Plan"),
...
#[doc = "Specifies the input for attaching and detaching a list of managed data disks."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AttachDetachDataDisksRequest {
    #[doc = "The list of managed data disks to be attached."]
    #[serde(
        rename = "dataDisksToAttach",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub data_disks_to_attach: Vec<DataDisksToAttach>,
    #[doc = "The list of managed data disks to be detached."]
    #[serde(
        rename = "dataDisksToDetach",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub data_disks_to_detach: Vec<DataDisksToDetach>,
}
impl AttachDetachDataDisksRequest {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct AutomaticOsUpgradePolicy {
    ...
    #[doc = "Indicates whether Auto OS Upgrade should undergo deferral. Deferred OS upgrades will send advanced notifications on a per-VM basis that an OS upgrade from rolling upgrades is incoming, via the IMDS tag 'Platform.PendingOSUpgrade'. The upgrade then defers until the upgrade is approved via an ApproveRollingUpgrade call."]
    #[serde(rename = "osRollingUpgradeDeferral", default, skip_serializing_if = "Option::is_none")]
    pub os_rolling_upgrade_deferral: Option<bool>,
}
...
#[doc = "Boot Diagnostics is a debugging feature which allows you to view Console Output and Screenshot to diagnose VM status. You can easily view the output of your console log. Azure also enables you to see a screenshot of the VM from the hypervisor."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct BootDiagnostics {
    #[doc = "Whether boot diagnostics should be enabled on the Virtual Machine."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
    #[doc = "Uri of the storage account to use for placing the console output and screenshot. If storageUri is not specified while enabling boot diagnostics, managed storage will be used."]
...
pub struct BootDiagnosticsInstanceView {
    #[doc = "The console screenshot blob URI. **Note:** This will **not** be set if boot diagnostics is currently enabled with managed storage."]
    ...
    #[doc = "The serial console log blob Uri. **Note:** This will **not** be set if boot diagnostics is currently enabled with managed storage."]
...
pub struct CapacityReservationGroupInstanceView {
    ...
    #[serde(
        rename = "capacityReservations",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub capacity_reservations: Vec<CapacityReservationInstanceViewWithName>,
    #[doc = "List of the subscriptions that the capacity reservation group is shared with. **Note:** Minimum api-version: 2023-09-01. Please refer to https://aka.ms/computereservationsharing for more details."]
    #[serde(
        rename = "sharedSubscriptionIds",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub shared_subscription_ids: Vec<SubResourceReadOnly>,
}
...
pub struct CapacityReservationGroupProperties {
    ...
    #[serde(
        rename = "virtualMachinesAssociated",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    ...
    pub sharing_profile: Option<ResourceSharingProfile>,
}
...
pub struct CapacityReservationProperties {
    ...
    #[doc = "Specifies the value of fault domain count that Capacity Reservation supports for requested VM size. **Note:** The fault domain count specified for a resource (like virtual machines scale set) must be less than or equal to this value if it deploys using capacity reservation. Minimum api-version: 2022-08-01."]
    #[serde(rename = "platformFaultDomainCount", default, skip_serializing_if = "Option::is_none")]
    pub platform_fault_domain_count: Option<i32>,
    ...
    #[doc = "Specifies the time at which the Capacity Reservation resource was created. Minimum api-version: 2021-11-01."]
...
pub struct CapacityReservationUtilization {
    #[doc = "The value provides the current capacity of the VM size which was reserved successfully and for which the customer is getting billed. Minimum api-version: 2022-08-01."]
    #[serde(rename = "currentCapacity", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(
        rename = "virtualMachinesAllocated",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
...
pub struct CloudServiceExtensionProperties {
    ...
    #[doc = "Protected settings for the extension, referenced using KeyVault which are encrypted before sent to the role instance."]
...
#[doc = "The list operation result."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CloudServiceListResult {
    #[doc = "The list of resources."]
    pub value: Vec<CloudService>,
    #[doc = "The URI to fetch the next page of resources. Use this to get the next page of resources. Do this till nextLink is null to fetch all the resources."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
...
pub struct CloudServiceRole {
    ...
    #[doc = "The cloud service role properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Slot type for the cloud service.\r\nPossible values are <br /><br />**Production**<br /><br />**Staging**<br /><br />\r\nIf not specified, the default value is Production."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "CloudServiceSlotType")]
pub enum CloudServiceSlotType {
    Production,
    Staging,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for CloudServiceSlotType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for CloudServiceSlotType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for CloudServiceSlotType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Production => serializer.serialize_unit_variant("CloudServiceSlotType", 0u32, "Production"),
            Self::Staging => serializer.serialize_unit_variant("CloudServiceSlotType", 1u32, "Staging"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct CloudServiceVaultAndSecretReference {
    ...
    #[doc = "Secret URL which contains the protected settings of the extension"]
...
pub struct CommunityGallery {
    ...
    #[doc = "Describes the properties of a community gallery."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<CommunityGalleryProperties>,
}
...
#[doc = "The artifact tags of a community gallery resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CommunityGalleryArtifactTags {}
impl CommunityGalleryArtifactTags {
    pub fn new() -> Self {
        Self::default()
    }
}
pub type CommunityGalleryDisclaimer = String;
...
pub struct CommunityGalleryImageProperties {
    #[doc = "This property allows you to specify the type of the OS that is included in the disk when creating a VM from a managed image. Possible values are: **Windows,** **Linux.**"]
    #[serde(rename = "osType")]
    ...
    #[doc = "The end-user license agreement for the current community gallery image."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub eula: Option<String>,
    #[doc = "The disclaimer for a community gallery resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub disclaimer: Option<CommunityGalleryDisclaimer>,
    #[doc = "The artifact tags of a community gallery resource."]
    #[serde(rename = "artifactTags", default, skip_serializing_if = "Option::is_none")]
    pub artifact_tags: Option<CommunityGalleryArtifactTags>,
}
...
#[doc = "The metadata of community gallery."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CommunityGalleryMetadata {
    #[doc = "The publisher URI of this community gallery."]
    #[serde(rename = "publisherUri", default, skip_serializing_if = "Option::is_none")]
    pub publisher_uri: Option<String>,
    #[doc = "The publisher email id of this community gallery."]
    #[serde(rename = "publisherContact")]
    pub publisher_contact: String,
    #[doc = "The end-user license agreement for this community gallery."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub eula: Option<String>,
    #[doc = "A list of public names the gallery has."]
    #[serde(rename = "publicNames")]
    pub public_names: Vec<String>,
    #[doc = "The link for the privacy statement of this community gallery from the gallery publisher."]
    #[serde(rename = "privacyStatementUri", default, skip_serializing_if = "Option::is_none")]
    pub privacy_statement_uri: Option<String>,
}
impl CommunityGalleryMetadata {
    pub fn new(publisher_contact: String, public_names: Vec<String>) -> Self {
        Self {
            publisher_uri: None,
            publisher_contact,
            eula: None,
...
#[doc = "Describes the properties of a community gallery."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CommunityGalleryProperties {
    #[doc = "The disclaimer for a community gallery resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub disclaimer: Option<CommunityGalleryDisclaimer>,
    #[doc = "The artifact tags of a community gallery resource."]
    ...
    pub artifact_tags: Option<CommunityGalleryArtifactTags>,
    #[doc = "The metadata of community gallery."]
    #[serde(rename = "communityMetadata", default, skip_serializing_if = "Option::is_none")]
    pub community_metadata: Option<CommunityGalleryMetadata>,
}
impl CommunityGalleryProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Indicates the error details if the background copy of a resource created via the CopyStart operation fails."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
impl CopyCompletionError {
    pub fn new(error_code: copy_completion_error::ErrorCode, error_message: String) -> Self {
        Self { error_code, error_message }
    }
}
pub mod copy_completion_error {
    use super::*;
    #[doc = "Indicates the error code if the background copy of a resource created via the CopyStart operation fails."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    ...
    impl Serialize for ErrorCode {
        ...
        {
            match self {
                Self::CopySourceNotFound => serializer.serialize_unit_variant("ErrorCode", 0u32, "CopySourceNotFound"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct CreationData {
    ...
    #[doc = "Set this flag to true to get a boost on the performance target of the disk deployed, see here on the respective performance target. This flag can only be set on disk creation time and cannot be disabled after enabled."]
    #[serde(rename = "performancePlus", default, skip_serializing_if = "Option::is_none")]
    pub performance_plus: Option<bool>,
    #[doc = "Required if createOption is CopyFromSanSnapshot. This is the ARM id of the source elastic san volume snapshot."]
    #[serde(rename = "elasticSanResourceId", default, skip_serializing_if = "Option::is_none")]
    pub elastic_san_resource_id: Option<String>,
    #[doc = "If this field is set on a snapshot and createOption is CopyStart, the snapshot will be copied at a quicker speed."]
    #[serde(rename = "provisionedBandwidthCopySpeed", default, skip_serializing_if = "Option::is_none")]
    pub provisioned_bandwidth_copy_speed: Option<creation_data::ProvisionedBandwidthCopySpeed>,
}
impl CreationData {
...
pub mod creation_data {
    ...
    impl Serialize for CreateOption {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::CopyFromSanSnapshot => serializer.serialize_unit_variant("CreateOption", 10u32, "CopyFromSanSnapshot"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    #[doc = "If this field is set on a snapshot and createOption is CopyStart, the snapshot will be copied at a quicker speed."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ProvisionedBandwidthCopySpeed")]
    pub enum ProvisionedBandwidthCopySpeed {
        None,
        Enhanced,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for ProvisionedBandwidthCopySpeed {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for ProvisionedBandwidthCopySpeed {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for ProvisionedBandwidthCopySpeed {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::None => serializer.serialize_unit_variant("ProvisionedBandwidthCopySpeed", 0u32, "None"),
                Self::Enhanced => serializer.serialize_unit_variant("ProvisionedBandwidthCopySpeed", 1u32, "Enhanced"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Describes the data disk to be attached."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DataDisksToAttach {
    #[doc = "ID of the managed data disk."]
    #[serde(rename = "diskId")]
    pub disk_id: String,
    #[doc = "The logical unit number of the data disk. This value is used to identify data disks within the VM and therefore must be unique for each data disk attached to a VM. If not specified, lun would be auto assigned."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub lun: Option<i32>,
}
impl DataDisksToAttach {
    pub fn new(disk_id: String) -> Self {
        Self { disk_id, lun: None }
    }
}
#[doc = "Describes the data disk to be detached."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DataDisksToDetach {
    #[doc = "ID of the managed data disk."]
    #[serde(rename = "diskId")]
    pub disk_id: String,
    #[doc = "Specifies the detach behavior to be used while detaching a disk or which is already in the process of detachment from the virtual machine. Supported values are: **ForceDetach.** detachOption: **ForceDetach** is applicable only for managed data disks. If a previous detachment attempt of the data disk did not complete due to an unexpected failure from the virtual machine and the disk is still not released then use force-detach as a last resort option to detach the disk forcibly from the VM. All writes might not have been flushed when using this detach behavior. **This feature is still in preview** mode and is not supported for VirtualMachineScaleSet. To force-detach a data disk update toBeDetached to 'true' along with setting detachOption: 'ForceDetach'."]
...
pub struct DedicatedHostGroupProperties {
    ...
    #[doc = "Enables or disables a capability on the dedicated host group. Minimum api-version: 2022-03-01."]
...
pub struct DedicatedHostProperties {
    ...
    #[doc = "A unique id generated and assigned to the dedicated host by the platform. Does not change throughout the lifetime of the host."]
    ...
    #[doc = "Specifies the time at which the Dedicated Host resource was created. Minimum api-version: 2021-11-01."]
    #[serde(rename = "timeCreated", default, with = "azure_core::date::rfc3339::option")]
    pub time_created: Option<time::OffsetDateTime>,
}
...
#[doc = "The List Dedicated Host sizes operation response."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DedicatedHostSizeListResult {
    #[doc = "The list of dedicated host sizes."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
impl azure_core::Continuable for DedicatedHostSizeListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        None
    }
}
impl DedicatedHostSizeListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct Disk {
    ...
    #[doc = "The disks sku name. Can be Standard_LRS, Premium_LRS, StandardSSD_LRS, UltraSSD_LRS, Premium_ZRS, StandardSSD_ZRS, or PremiumV2_LRS."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "DiskControllerType")]
pub enum DiskControllerType {
    #[serde(rename = "SCSI")]
    Scsi,
    #[serde(rename = "NVMe")]
    NvMe,
...
impl FromStr for DiskControllerType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for DiskControllerType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for DiskControllerType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Scsi => serializer.serialize_unit_variant("DiskControllerType", 0u32, "SCSI"),
            Self::NvMe => serializer.serialize_unit_variant("DiskControllerType", 1u32, "NVMe"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct DiskEncryptionSetUpdateProperties {
    ...
    #[doc = "Multi-tenant application client id to access key vault in a different tenant. Setting the value to 'None' will clear the property."]
...
pub struct DiskProperties {
    ...
    #[doc = "Latest time when bursting was last enabled on a disk."]
    #[serde(rename = "burstingEnabledTime", default, with = "azure_core::date::rfc3339::option")]
    pub bursting_enabled_time: Option<time::OffsetDateTime>,
    ...
    pub optimized_for_frequent_attach: Option<bool>,
    #[doc = "The UTC time when the ownership state of the disk was last changed i.e., the time the disk was last attached or detached from a VM or the time when the VM to which the disk was attached was deallocated or started."]
    #[serde(rename = "LastOwnershipUpdateTime", default, with = "azure_core::date::rfc3339::option")]
    pub last_ownership_update_time: Option<time::OffsetDateTime>,
}
impl DiskProperties {
...
#[doc = "Disk Restore Point details."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DiskRestorePointAttributes {
    #[serde(flatten)]
    pub sub_resource_read_only: SubResourceReadOnly,
    #[doc = "Encryption at rest settings for disk restore point. It is an optional property that can be specified in the input while creating a restore point."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub encryption: Option<RestorePointEncryption>,
    #[doc = "The API entity reference."]
    #[serde(rename = "sourceDiskRestorePoint", default, skip_serializing_if = "Option::is_none")]
    pub source_disk_restore_point: Option<ApiEntityReference>,
}
impl DiskRestorePointAttributes {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl Serialize for DiskSecurityType {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::ConfidentialVmNonPersistedTpm => {
                serializer.serialize_unit_variant("DiskSecurityType", 4u32, "ConfidentialVM_NonPersistedTPM")
            }
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
    ...
    impl Serialize for Name {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::PremiumV2Lrs => serializer.serialize_unit_variant("Name", 6u32, "PremiumV2_LRS"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Specifies the Managed Identity used by ADE to get access token for keyvault operations."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "A custom action that can be performed with a Gallery Application Version."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GalleryApplicationCustomAction {
    #[doc = "The name of the custom action.  Must be unique within the Gallery Application Version."]
    pub name: String,
    #[doc = "The script to run when executing this custom action."]
    pub script: String,
    #[doc = "Description to help the users understand what this custom action does."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    #[doc = "The parameters that this custom action uses"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub parameters: Vec<GalleryApplicationCustomActionParameter>,
}
impl GalleryApplicationCustomAction {
...
#[doc = "The definition of a parameter that can be passed to a custom action of a Gallery Application Version."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GalleryApplicationCustomActionParameter {
    #[doc = "The name of the custom action.  Must be unique within the Gallery Application Version."]
    pub name: String,
    #[doc = "Indicates whether this parameter must be passed when running the custom action."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[doc = "A description to help users understand what this parameter means"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
}
impl GalleryApplicationCustomActionParameter {
...
pub mod gallery_application_custom_action_parameter {
    use super::*;
    #[doc = "Specifies the type of the custom action parameter. Possible values are: String, ConfigurationDataBlob or LogOutputBlob"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum Type {
...
pub struct GalleryApplicationProperties {
    ...
    #[serde(rename = "endOfLifeDate", default, with = "azure_core::date::rfc3339::option")]
    pub end_of_life_date: Option<time::OffsetDateTime>,
    #[doc = "This property allows you to specify the supported type of the OS that application is built for. Possible values are: **Windows,** **Linux.**"]
    ...
    #[serde(
        rename = "customActions",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub custom_actions: Vec<GalleryApplicationCustomAction>,
}
...
pub struct GalleryApplicationVersionProperties {
    ...
    #[doc = "The safety profile of the Gallery Application Version."]
...
pub struct GalleryApplicationVersionPublishingProfile {
    ...
    #[doc = "A list of custom actions that can be performed with this Gallery Application Version."]
    #[serde(
        rename = "customActions",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
...
#[doc = "The safety profile of the Gallery Application Version."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct GalleryApplicationVersionSafetyProfile {
    #[serde(flatten)]
    pub gallery_artifact_safety_profile_base: GalleryArtifactSafetyProfileBase,
}
impl GalleryApplicationVersionSafetyProfile {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct GalleryArtifactPublishingProfileBase {
    ...
    #[serde(
        rename = "targetExtendedLocations",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
...
#[doc = "This is the safety profile of the Gallery Artifact Version."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct GalleryArtifactSafetyProfileBase {
    #[doc = "Indicates whether or not removing this Gallery Image Version from replicated regions is allowed."]
    #[serde(rename = "allowDeletionOfReplicatedLocations", default, skip_serializing_if = "Option::is_none")]
    pub allow_deletion_of_replicated_locations: Option<bool>,
}
impl GalleryArtifactSafetyProfileBase {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "The source of the gallery artifact version."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct GalleryArtifactVersionFullSource {
    #[serde(flatten)]
    pub gallery_artifact_version_source: GalleryArtifactVersionSource,
    #[doc = "The resource Id of the source Community Gallery Image.  Only required when using Community Gallery Image as a source."]
    ...
    #[doc = "The resource Id of the source virtual machine.  Only required when capturing a virtual machine to source this Gallery Image Version."]
    #[serde(rename = "virtualMachineId", default, skip_serializing_if = "Option::is_none")]
    pub virtual_machine_id: Option<String>,
}
impl GalleryArtifactVersionFullSource {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct GalleryArtifactVersionSource {
    #[doc = "The id of the gallery artifact version source."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
}
...
pub struct GalleryDiskImage {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub source: Option<GalleryDiskImageSource>,
}
...
#[doc = "The source for the disk image."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct GalleryDiskImageSource {
    #[serde(flatten)]
    pub gallery_artifact_version_source: GalleryArtifactVersionSource,
    #[doc = "The uri of the gallery artifact version source. Currently used to specify vhd/blob source."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub uri: Option<String>,
    #[doc = "The Storage Account Id that contains the vhd blob being used as a source for this artifact version."]
    #[serde(rename = "storageAccountId", default, skip_serializing_if = "Option::is_none")]
    pub storage_account_id: Option<String>,
}
impl GalleryDiskImageSource {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct GalleryImageVersionProperties {
    ...
    #[doc = "This is the safety profile of the Gallery Image Version."]
    #[serde(rename = "safetyProfile", default, skip_serializing_if = "Option::is_none")]
    pub safety_profile: Option<GalleryImageVersionSafetyProfile>,
    #[doc = "This is the replication status of the gallery image version."]
    #[serde(rename = "replicationStatus", default, skip_serializing_if = "Option::is_none")]
    pub replication_status: Option<ReplicationStatus>,
    #[doc = "The security profile of a gallery image version"]
    #[serde(rename = "securityProfile", default, skip_serializing_if = "Option::is_none")]
    pub security_profile: Option<ImageVersionSecurityProfile>,
}
...
#[doc = "This is the safety profile of the Gallery Image Version."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct GalleryImageVersionSafetyProfile {
    #[serde(flatten)]
    pub gallery_artifact_safety_profile_base: GalleryArtifactSafetyProfileBase,
    #[doc = "Indicates whether this image has been reported as violating Microsoft's policies."]
    #[serde(rename = "reportedForPolicyViolation", default, skip_serializing_if = "Option::is_none")]
    pub reported_for_policy_violation: Option<bool>,
    #[doc = "A list of Policy Violations that have been reported for this Gallery Image Version."]
    #[serde(
        rename = "policyViolations",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
...
impl GalleryImageVersionSafetyProfile {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct GalleryImageVersionStorageProfile {
    #[doc = "The source of the gallery artifact version."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub source: Option<GalleryArtifactVersionFullSource>,
...
#[doc = "Contains UEFI settings for the image version."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct GalleryImageVersionUefiSettings {
    #[doc = "The name of the template(s) that contains default UEFI key signatures that will be added to the image."]
    #[serde(
        rename = "signatureTemplateNames",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub signature_template_names: Vec<UefiSignatureTemplateName>,
    #[doc = "Additional UEFI key signatures that will be added to the image in addition to the signature templates"]
    #[serde(rename = "additionalSignatures", default, skip_serializing_if = "Option::is_none")]
    pub additional_signatures: Option<UefiKeySignatures>,
}
impl GalleryImageVersionUefiSettings {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub mod grant_access_data {
    ...
    impl Serialize for FileFormat {
        ...
        {
            match self {
                Self::Vhd => serializer.serialize_unit_variant("FileFormat", 0u32, "VHD"),
                Self::Vhdx => serializer.serialize_unit_variant("FileFormat", 1u32, "VHDX"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct ImageDeprecationStatus {
    ...
    pub scheduled_deprecation_time: Option<time::OffsetDateTime>,
    #[doc = "Describes the alternative option specified by the Publisher for this image when this image is deprecated."]
    #[serde(rename = "alternativeOption", default, skip_serializing_if = "Option::is_none")]
    pub alternative_option: Option<AlternativeOption>,
}
impl ImageDeprecationStatus {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod image_deprecation_status {
    use super::*;
    #[doc = "Describes the state of the image."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ImageState")]
    pub enum ImageState {
        Active,
    ...
    impl Serialize for ImageState {
        ...
        {
            match self {
                Self::Active => serializer.serialize_unit_variant("ImageState", 0u32, "Active"),
                Self::ScheduledForDeprecation => serializer.serialize_unit_variant("ImageState", 1u32, "ScheduledForDeprecation"),
                Self::Deprecated => serializer.serialize_unit_variant("ImageState", 2u32, "Deprecated"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct ImageDiskReference {
    #[doc = "A relative uri containing either a Platform Image Repository, user image, or Azure Compute Gallery image reference."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "A relative uri containing a direct shared Azure Compute Gallery image reference."]
    #[serde(rename = "sharedGalleryImageId", default, skip_serializing_if = "Option::is_none")]
    pub shared_gallery_image_id: Option<String>,
    #[doc = "A relative uri containing a community Azure Compute Gallery image reference."]
    #[serde(rename = "communityGalleryImageId", default, skip_serializing_if = "Option::is_none")]
    pub community_gallery_image_id: Option<String>,
...
#[doc = "The security profile of a gallery image version"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ImageVersionSecurityProfile {
    #[doc = "Contains UEFI settings for the image version."]
    #[serde(rename = "uefiSettings", default, skip_serializing_if = "Option::is_none")]
    pub uefi_settings: Option<GalleryImageVersionUefiSettings>,
}
impl ImageVersionSecurityProfile {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "The gallery image version with latest version in a particular region."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct LatestGalleryImageVersion {
    #[doc = "The name of the latest version in the region."]
    #[serde(rename = "latestVersionName", default, skip_serializing_if = "Option::is_none")]
    pub latest_version_name: Option<String>,
    #[doc = "region of the Gallery Image Version."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub location: Option<String>,
}
impl LatestGalleryImageVersion {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Specifies the Linux operating system settings on the virtual machine. For a list of supported Linux distributions, see [Linux on Azure-Endorsed Distributions](https://docs.microsoft.com/azure/virtual-machines/linux/endorsed-distros)."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct LinuxConfiguration {
    ...
    #[doc = "Indicates whether virtual machine agent should be provisioned on the virtual machine. When this property is not specified in the request body, default behavior is to set it to true. This will ensure that VM Agent is installed on the VM so that extensions can be added to the VM later."]
    ...
    #[doc = "Indicates whether VMAgent Platform Updates is enabled for the Linux virtual machine. Default value is false."]
    #[serde(rename = "enableVMAgentPlatformUpdates", default, skip_serializing_if = "Option::is_none")]
...
pub struct LoadBalancerConfiguration {
    ...
    pub name: String,
    #[doc = "Describes the properties of the load balancer configuration."]
    ...
    impl Serialize for ConfidentialVmEncryptionType {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::NonPersistedTpm => serializer.serialize_unit_variant("ConfidentialVmEncryptionType", 3u32, "NonPersistedTPM"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct OsImageNotificationProfile {
    #[doc = "Length of time a Virtual Machine being reimaged or having its OS upgraded will have to potentially approve the OS Image Scheduled Event before the event is auto approved (timed out). The configuration is specified in ISO 8601 format, and the value must be 15 minutes (PT15M)"]
...
impl OsImageNotificationProfile {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct OsProfile {
    ...
    #[doc = "Specifies whether extension operations should be allowed on the virtual machine. This may only be set to False when no extensions are present on the virtual machine."]
...
#[doc = "Additional parameters for Reimaging Non-Ephemeral Virtual Machine."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OsProfileProvisioningData {
    #[doc = "Specifies the password of the administrator account. <br><br> **Minimum-length (Windows):** 8 characters <br><br> **Minimum-length (Linux):** 6 characters <br><br> **Max-length (Windows):** 123 characters <br><br> **Max-length (Linux):** 72 characters <br><br> **Complexity requirements:** 3 out of 4 conditions below need to be fulfilled <br> Has lower characters <br>Has upper characters <br> Has a digit <br> Has a special character (Regex match [\\W_]) <br><br> **Disallowed values:** \"abc@123\", \"P@$$w0rd\", \"P@ssw0rd\", \"P@ssword123\", \"Pa$$word\", \"pass@word1\", \"Password!\", \"Password1\", \"Password22\", \"iloveyou!\" <br><br> For resetting the password, see [How to reset the Remote Desktop service or its login password in a Windows VM](https://docs.microsoft.com/troubleshoot/azure/virtual-machines/reset-rdp) <br><br> For resetting root password, see [Manage users, SSH, and check or repair disks on Azure Linux VMs using the VMAccess Extension](https://docs.microsoft.com/troubleshoot/azure/virtual-machines/troubleshoot-ssh-connection)"]
    #[serde(rename = "adminPassword", default, skip_serializing_if = "Option::is_none")]
    pub admin_password: Option<String>,
...
impl OsProfileProvisioningData {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Base information about the community gallery resource in azure compute gallery."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "A policy violation reported against a gallery artifact."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
    ...
    impl Serialize for Category {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::ImageFlaggedUnsafe => serializer.serialize_unit_variant("Category", 1u32, "ImageFlaggedUnsafe"),
                Self::CopyrightValidation => serializer.serialize_unit_variant("Category", 2u32, "CopyrightValidation"),
                Self::IpTheft => serializer.serialize_unit_variant("Category", 3u32, "IpTheft"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
}
#[doc = "Specifies the target splits for Spot and Regular priority VMs within a scale set with flexible orchestration mode. With this property the customer is able to specify the base number of regular priority VMs created as the VMSS flex instance scales out and the split between Spot and Regular priority VMs after this base target has been reached."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PriorityMixPolicy {
    #[doc = "The base number of regular priority VMs that will be created in this scale set as it scales out."]
    #[serde(rename = "baseRegularPriorityCount", default, skip_serializing_if = "Option::is_none")]
    pub base_regular_priority_count: Option<i32>,
    #[doc = "The percentage of VM instances, after the base regular priority count has been reached, that are expected to use regular priority."]
    #[serde(rename = "regularPriorityPercentageAboveBase", default, skip_serializing_if = "Option::is_none")]
    pub regular_priority_percentage_above_base: Option<i32>,
}
impl PriorityMixPolicy {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Specifies ProxyAgent settings while creating the virtual machine. Minimum api-version: 2023-09-01."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ProxyAgentSettings {
    #[doc = "Specifies whether ProxyAgent feature should be enabled on the virtual machine or virtual machine scale set."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
    #[doc = "Specifies the mode that ProxyAgent will execute on if the feature is enabled. ProxyAgent will start to audit or monitor but not enforce access control over requests to host endpoints in Audit mode, while in Enforce mode it will enforce access control. The default value is Enforce mode."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mode: Option<proxy_agent_settings::Mode>,
    #[doc = "Increase the value of this property allows user to reset the key used for securing communication channel between guest and host."]
    #[serde(rename = "keyIncarnationId", default, skip_serializing_if = "Option::is_none")]
    pub key_incarnation_id: Option<i32>,
}
impl ProxyAgentSettings {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod proxy_agent_settings {
    use super::*;
    #[doc = "Specifies the mode that ProxyAgent will execute on if the feature is enabled. ProxyAgent will start to audit or monitor but not enforce access control over requests to host endpoints in Audit mode, while in Enforce mode it will enforce access control. The default value is Enforce mode."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Mode")]
    ...
    impl Serialize for Mode {
        ...
        {
            match self {
                Self::Audit => serializer.serialize_unit_variant("Mode", 0u32, "Audit"),
                Self::Enforce => serializer.serialize_unit_variant("Mode", 1u32, "Enforce"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Describes an resiliency policy - resilientVMCreationPolicy and/or resilientVMDeletionPolicy."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ResiliencyPolicy {
    #[doc = "The configuration parameters used while performing resilient VM creation."]
    #[serde(rename = "resilientVMCreationPolicy", default, skip_serializing_if = "Option::is_none")]
    pub resilient_vm_creation_policy: Option<ResilientVmCreationPolicy>,
    #[doc = "The configuration parameters used while performing resilient VM deletion."]
    #[serde(rename = "resilientVMDeletionPolicy", default, skip_serializing_if = "Option::is_none")]
    pub resilient_vm_deletion_policy: Option<ResilientVmDeletionPolicy>,
}
...
#[doc = "The configuration parameters used while performing resilient VM creation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ResilientVmCreationPolicy {
    #[doc = "Specifies whether resilient VM creation should be enabled on the virtual machine scale set. The default value is false."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
}
impl ResilientVmCreationPolicy {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The configuration parameters used while performing resilient VM deletion."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ResilientVmDeletionPolicy {
    #[doc = "Specifies whether resilient VM deletion should be enabled on the virtual machine scale set. The default value is false."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
}
impl ResilientVmDeletionPolicy {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ResourceSharingProfile {
    #[doc = "Specifies an array of subscription resource IDs that capacity reservation group is shared with. **Note:** Minimum api-version: 2023-09-01. Please refer to https://aka.ms/computereservationsharing for more details."]
    #[serde(
    ...
    pub subscription_ids: Vec<SubResource>,
}
impl ResourceSharingProfile {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Encryption at rest settings for disk restore point. It is an optional property that can be specified in the input while creating a restore point."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RestorePointEncryption {
    #[doc = "Describes the parameter of customer managed disk encryption set resource id that can be specified for disk. **Note:** The disk encryption set resource id can only be specified for managed disk. Please refer https://aka.ms/mdssewithcmkoverview for more details."]
    #[serde(rename = "diskEncryptionSet", default, skip_serializing_if = "Option::is_none")]
    pub disk_encryption_set: Option<DiskEncryptionSetParameters>,
...
#[doc = "The type of key used to encrypt the data of the disk restore point."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "RestorePointEncryptionType")]
...
impl FromStr for RestorePointEncryptionType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for RestorePointEncryptionType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for RestorePointEncryptionType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::EncryptionAtRestWithPlatformKey => {
                serializer.serialize_unit_variant("RestorePointEncryptionType", 0u32, "EncryptionAtRestWithPlatformKey")
            }
            Self::EncryptionAtRestWithCustomerKey => {
                serializer.serialize_unit_variant("RestorePointEncryptionType", 1u32, "EncryptionAtRestWithCustomerKey")
            }
            Self::EncryptionAtRestWithPlatformAndCustomerKeys => {
                serializer.serialize_unit_variant("RestorePointEncryptionType", 2u32, "EncryptionAtRestWithPlatformAndCustomerKeys")
            }
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
...
pub struct RestorePointSourceMetadata {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub location: Option<String>,
    #[doc = "UserData associated with the source VM for which restore point is captured, which is a base-64 encoded value."]
...
pub struct RestorePointSourceVmDataDisk {
    ...
    pub disk_restore_point: Option<DiskRestorePointAttributes>,
    #[doc = "Shows true if the disk is write-accelerator enabled."]
    #[serde(rename = "writeAcceleratorEnabled", default, skip_serializing_if = "Option::is_none")]
    pub write_accelerator_enabled: Option<bool>,
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "RestorePointSourceVmDiskControllerType")]
pub enum RestorePointSourceVmDiskControllerType {
    #[serde(rename = "SCSI")]
    Scsi,
    #[serde(rename = "NVMe")]
    NvMe,
...
impl FromStr for RestorePointSourceVmDiskControllerType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for RestorePointSourceVmDiskControllerType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for RestorePointSourceVmDiskControllerType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Scsi => serializer.serialize_unit_variant("RestorePointSourceVmDiskControllerType", 0u32, "SCSI"),
            Self::NvMe => serializer.serialize_unit_variant("RestorePointSourceVmDiskControllerType", 1u32, "NVMe"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct RestorePointSourceVmStorageProfile {
    ...
    pub disk_controller_type: Option<RestorePointSourceVmDiskControllerType>,
}
...
pub struct RollingUpgradePolicy {
    ...
    #[serde(rename = "rollbackFailedInstancesOnPolicyBreach", default, skip_serializing_if = "Option::is_none")]
    pub rollback_failed_instances_on_policy_breach: Option<bool>,
    #[doc = "Create new virtual machines to upgrade the scale set, rather than updating the existing virtual machines. Existing virtual machines will be deleted once the new virtual machines are created for each batch."]
    #[serde(rename = "maxSurge", default, skip_serializing_if = "Option::is_none")]
    pub max_surge: Option<bool>,
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RunCommandManagedIdentity {
...
impl RunCommandManagedIdentity {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ScheduledEventsProfile {
    ...
    #[serde(rename = "osImageNotificationProfile", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Specifies the security posture to be used for all virtual machines in the scale set. Minimum api-version: 2023-03-01"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SecurityPostureReference {
    #[doc = "The security posture reference id in the form of /CommunityGalleries/{communityGalleryName}/securityPostures/{securityPostureName}/versions/{major.minor.patch}|{major.*}|latest"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "List of virtual machine extensions to exclude when applying the Security Posture."]
    #[serde(
        rename = "excludeExtensions",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub exclude_extensions: Vec<VirtualMachineExtension>,
}
impl SecurityPostureReference {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct SecurityProfile {
    #[doc = "Specifies the security settings like secure boot and vTPM used while creating the virtual machine. Minimum api-version: 2020-12-01."]
    #[serde(rename = "uefiSettings", default, skip_serializing_if = "Option::is_none")]
    ...
    #[doc = "Specifies the Managed Identity used by ADE to get access token for keyvault operations."]
    #[serde(rename = "encryptionIdentity", default, skip_serializing_if = "Option::is_none")]
    pub encryption_identity: Option<EncryptionIdentity>,
    #[doc = "Specifies ProxyAgent settings while creating the virtual machine. Minimum api-version: 2023-09-01."]
    #[serde(rename = "proxyAgentSettings", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Specifies the service artifact reference id used to set same image version for all virtual machines in the scale set when using 'latest' image version. Minimum api-version: 2022-11-01"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ServiceArtifactReference {
    #[doc = "The service artifact reference id in the form of /subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.Compute/galleries/{galleryName}/serviceArtifacts/{serviceArtifactName}/vmArtifactsProfiles/{vmArtifactsProfilesName}"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
}
...
pub struct SharedGallery {
    ...
    #[doc = "Specifies the properties of a shared gallery"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<SharedGalleryProperties>,
}
impl SharedGallery {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "The artifact tags of a shared gallery resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SharedGalleryArtifactTags {}
impl SharedGalleryArtifactTags {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct SharedGalleryImageProperties {
    ...
    #[doc = "The artifact tags of a shared gallery resource."]
    #[serde(rename = "artifactTags", default, skip_serializing_if = "Option::is_none")]
    pub artifact_tags: Option<SharedGalleryArtifactTags>,
}
...
#[doc = "Specifies the properties of a shared gallery"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SharedGalleryProperties {
    #[doc = "The artifact tags of a shared gallery resource."]
    #[serde(rename = "artifactTags", default, skip_serializing_if = "Option::is_none")]
    pub artifact_tags: Option<SharedGalleryArtifactTags>,
}
impl SharedGalleryProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct SharingProfile {
    #[doc = "This property allows you to specify the permission of sharing gallery. Possible values are: **Private,** **Groups,** **Community.**"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct SharingProfileGroup {
    #[doc = "This property allows you to specify the type of sharing group. Possible values are: **Subscriptions,** **AADTenants.**"]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
...
pub struct SharingUpdate {
    #[doc = "This property allows you to specify the operation type of gallery sharing update. Possible values are: **Add,** **Remove,** **Reset.**"]
...
pub struct SnapshotProperties {
    ...
    #[doc = "Incremental snapshots for a disk share an incremental snapshot family id. The Get Page Range Diff API can only be called on incremental snapshots with the same family id."]
    #[serde(rename = "incrementalSnapshotFamilyId", default, skip_serializing_if = "Option::is_none")]
    pub incremental_snapshot_family_id: Option<String>,
    #[doc = "Encryption at rest settings for disk or snapshot"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub encryption: Option<Encryption>,
    #[doc = "Policy for accessing the disk via network."]
...
impl SnapshotProperties {
    pub fn new(creation_data: CreationData) -> Self {
        Self {
            ...
            provisioning_state: None,
            incremental: None,
            incremental_snapshot_family_id: None,
            encryption: None,
            network_access_policy: None,
            disk_access_id: None,
            security_profile: None,
...
#[doc = "Parameters for GenerateSshKeyPair."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SshGenerateKeyPairInputParameters {
    #[doc = "The encryption type of the SSH keys to be generated. See SshEncryptionTypes for possible set of values. If not provided, will default to RSA"]
    #[serde(rename = "encryptionType", default, skip_serializing_if = "Option::is_none")]
    pub encryption_type: Option<ssh_generate_key_pair_input_parameters::EncryptionType>,
}
impl SshGenerateKeyPairInputParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod ssh_generate_key_pair_input_parameters {
    use super::*;
    #[doc = "The encryption type of the SSH keys to be generated. See SshEncryptionTypes for possible set of values. If not provided, will default to RSA"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "EncryptionType")]
    ...
    impl Serialize for EncryptionType {
        ...
        {
            match self {
                Self::Rsa => serializer.serialize_unit_variant("EncryptionType", 0u32, "RSA"),
                Self::Ed25519 => serializer.serialize_unit_variant("EncryptionType", 1u32, "Ed25519"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct SshPublicKey {
    ...
    #[doc = "SSH public key certificate used to authenticate with the VM through ssh. The key needs to be at least 2048-bit and in ssh-rsa format. For creating ssh keys, see [Create SSH keys on Linux and Mac for Linux VMs in Azure]https://docs.microsoft.com/azure/virtual-machines/linux/create-ssh-keys-detailed)."]
...
#[doc = "The status code and count of the cloud service instance view statuses"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct StorageProfile {
    ...
    #[doc = "Specifies the parameters that are used to add a data disk to a virtual machine. For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/managed-disks-overview)."]
    #[serde(
        rename = "dataDisks",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
...
pub struct SupportedCapabilities {
    #[doc = "The disk controllers that an OS disk supports. If set it can be SCSI or SCSI, NVME or NVME, SCSI."]
    #[serde(rename = "diskControllerTypes", default, skip_serializing_if = "Option::is_none")]
    pub disk_controller_types: Option<String>,
...
pub struct TargetRegion {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub encryption: Option<EncryptionImages>,
    #[doc = "Contains the flag setting to hide an image when users specify version='latest'"]
    #[serde(rename = "excludeFromLatest", default, skip_serializing_if = "Option::is_none")]
    pub exclude_from_latest: Option<bool>,
}
impl TargetRegion {
...
#[doc = "A UEFI key signature."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct UefiKey {
    #[doc = "The type of key signature."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<uefi_key::Type>,
    #[doc = "The value of the key signature."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
pub mod uefi_key {
    ...
    impl Serialize for Type {
        ...
        {
            match self {
                Self::Sha256 => serializer.serialize_unit_variant("Type", 0u32, "sha256"),
                Self::X509 => serializer.serialize_unit_variant("Type", 1u32, "x509"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Additional UEFI key signatures that will be added to the image in addition to the signature templates"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct UefiKeySignatures {
    #[doc = "A UEFI key signature."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub pk: Option<UefiKey>,
    #[doc = "The Key Encryption Keys of this image version."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    ...
    pub kek: Vec<UefiKey>,
    #[doc = "The database of UEFI keys for this image version."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    ...
    pub db: Vec<UefiKey>,
    #[doc = "The database of revoked UEFI keys for this image version."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
pub struct UefiSettings {
    #[doc = "Specifies whether secure boot should be enabled on the virtual machine. Minimum api-version: 2020-12-01."]
    #[serde(rename = "secureBootEnabled", default, skip_serializing_if = "Option::is_none")]
    pub secure_boot_enabled: Option<bool>,
    #[doc = "Specifies whether vTPM should be enabled on the virtual machine. Minimum api-version: 2020-12-01."]
...
#[doc = "The name of the signature template that contains default UEFI keys."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "UefiSignatureTemplateName")]
pub enum UefiSignatureTemplateName {
    NoSignatureTemplate,
...
impl FromStr for UefiSignatureTemplateName {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for UefiSignatureTemplateName {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for UefiSignatureTemplateName {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::NoSignatureTemplate => serializer.serialize_unit_variant("UefiSignatureTemplateName", 0u32, "NoSignatureTemplate"),
            Self::MicrosoftUefiCertificateAuthorityTemplate => {
                serializer.serialize_unit_variant("UefiSignatureTemplateName", 1u32, "MicrosoftUefiCertificateAuthorityTemplate")
            }
            Self::MicrosoftWindowsTemplate => {
                serializer.serialize_unit_variant("UefiSignatureTemplateName", 2u32, "MicrosoftWindowsTemplate")
            }
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
    ...
    impl Serialize for SecurityEncryptionType {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::NonPersistedTpm => serializer.serialize_unit_variant("SecurityEncryptionType", 2u32, "NonPersistedTPM"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct VirtualMachine {
    ...
    #[serde(rename = "extendedLocation", default, skip_serializing_if = "Option::is_none")]
    pub extended_location: Option<ExtendedLocation>,
    #[doc = "ManagedBy is set to Virtual Machine Scale Set(VMSS) flex ARM resourceID, if the VM is part of the VMSS. This property is used by platform for internal resource group delete optimization."]
    #[serde(rename = "managedBy", default, skip_serializing_if = "Option::is_none")]
    pub managed_by: Option<String>,
    #[doc = "Etag is property returned in Create/Update/Get response of the VM, so that customer can supply it in the header to ensure optimistic updates."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct VirtualMachineInstanceView {
    ...
    #[doc = "Resource id of the dedicated host, on which the virtual machine is allocated through automatic placement, when the virtual machine is associated with a dedicated host group that has automatic placement enabled. Minimum api-version: 2020-06-01."]
    ...
    #[doc = "[Preview Feature] Specifies whether the VM is currently in or out of the Standby Pool."]
    #[serde(rename = "isVMInStandbyPool", default, skip_serializing_if = "Option::is_none")]
...
pub struct VirtualMachineNetworkInterfaceConfigurationProperties {
    ...
    #[doc = "Specifies whether the Auxiliary mode is enabled for the Network Interface resource."]
    #[serde(rename = "auxiliaryMode", default, skip_serializing_if = "Option::is_none")]
    pub auxiliary_mode: Option<virtual_machine_network_interface_configuration_properties::AuxiliaryMode>,
    #[doc = "Specifies whether the Auxiliary sku is enabled for the Network Interface resource."]
    #[serde(rename = "auxiliarySku", default, skip_serializing_if = "Option::is_none")]
    pub auxiliary_sku: Option<virtual_machine_network_interface_configuration_properties::AuxiliarySku>,
}
    ...
    impl Serialize for AuxiliaryMode {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::AcceleratedConnections => serializer.serialize_unit_variant("AuxiliaryMode", 1u32, "AcceleratedConnections"),
...
pub struct VirtualMachineProperties {
    ...
    #[serde(rename = "vmId", default, skip_serializing_if = "Option::is_none")]
    pub vm_id: Option<String>,
    #[doc = "Specifies the time alloted for all extensions to start. The time duration should be between 15 minutes and 120 minutes (inclusive) and should be specified in ISO 8601 format. The default value is 90 minutes (PT1H30M). Minimum api-version: 2020-06-01."]
    ...
    #[doc = "UserData for the VM, which must be base-64 encoded. Customer should not pass any secrets in here. Minimum api-version: 2021-03-01."]
    #[serde(rename = "userData", default, skip_serializing_if = "Option::is_none")]
    pub user_data: Option<String>,
    #[doc = "The parameters of a capacity reservation Profile."]
    ...
    #[doc = "Specifies the time at which the Virtual Machine resource was created. Minimum api-version: 2021-11-01."]
    #[serde(rename = "timeCreated", default, with = "azure_core::date::rfc3339::option")]
    pub time_created: Option<time::OffsetDateTime>,
}
...
pub struct VirtualMachinePublicIpAddressDnsSettingsConfiguration {
    ...
    #[doc = "The Domain name label scope of the PublicIPAddress resources that will be created. The generated name label is the concatenation of the hashed domain name label with policy according to the domain name label scope and vm network profile unique ID."]
    #[serde(rename = "domainNameLabelScope", default, skip_serializing_if = "Option::is_none")]
    pub domain_name_label_scope: Option<virtual_machine_public_ip_address_dns_settings_configuration::DomainNameLabelScope>,
}
...
pub mod virtual_machine_public_ip_address_dns_settings_configuration {
    use super::*;
    #[doc = "The Domain name label scope of the PublicIPAddress resources that will be created. The generated name label is the concatenation of the hashed domain name label with policy according to the domain name label scope and vm network profile unique ID."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "DomainNameLabelScope")]
    ...
    impl FromStr for DomainNameLabelScope {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for DomainNameLabelScope {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for DomainNameLabelScope {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::TenantReuse => serializer.serialize_unit_variant("DomainNameLabelScope", 0u32, "TenantReuse"),
                Self::SubscriptionReuse => serializer.serialize_unit_variant("DomainNameLabelScope", 1u32, "SubscriptionReuse"),
                Self::ResourceGroupReuse => serializer.serialize_unit_variant("DomainNameLabelScope", 2u32, "ResourceGroupReuse"),
                Self::NoReuse => serializer.serialize_unit_variant("DomainNameLabelScope", 3u32, "NoReuse"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct VirtualMachineReimageParameters {
    ...
    #[doc = "Specifies in decimal number, the version the OS disk should be reimaged to. If exact version is not provided, the OS disk is reimaged to the existing version of OS Disk."]
    #[serde(rename = "exactVersion", default, skip_serializing_if = "Option::is_none")]
    pub exact_version: Option<String>,
    #[doc = "Additional parameters for Reimaging Non-Ephemeral Virtual Machine."]
    #[serde(rename = "osProfile", default, skip_serializing_if = "Option::is_none")]
    pub os_profile: Option<OsProfileProvisioningData>,
}
...
pub struct VirtualMachineRunCommandProperties {
    ...
    #[doc = " Contains clientId or objectId (use only one, not both) of a user-assigned managed identity that has access to storage blob used in Run Command. Use an empty RunCommandManagedIdentity object in case of system-assigned identity. Make sure the Azure storage blob exists in case of scriptUri, and managed identity has been given access to blob's container with 'Storage Blob Data Reader' role assignment with scriptUri blob and 'Storage Blob Data Contributor' for Append blobs(outputBlobUri, errorBlobUri). In case of user assigned identity, make sure you add it under VM's identity. For more info on managed identity and Run Command, refer https://aka.ms/ManagedIdentity and https://aka.ms/RunCommandManaged."]
    #[serde(rename = "outputBlobManagedIdentity", default, skip_serializing_if = "Option::is_none")]
    pub output_blob_managed_identity: Option<RunCommandManagedIdentity>,
    #[doc = " Contains clientId or objectId (use only one, not both) of a user-assigned managed identity that has access to storage blob used in Run Command. Use an empty RunCommandManagedIdentity object in case of system-assigned identity. Make sure the Azure storage blob exists in case of scriptUri, and managed identity has been given access to blob's container with 'Storage Blob Data Reader' role assignment with scriptUri blob and 'Storage Blob Data Contributor' for Append blobs(outputBlobUri, errorBlobUri). In case of user assigned identity, make sure you add it under VM's identity. For more info on managed identity and Run Command, refer https://aka.ms/ManagedIdentity and https://aka.ms/RunCommandManaged."]
    #[serde(rename = "errorBlobManagedIdentity", default, skip_serializing_if = "Option::is_none")]
    pub error_blob_managed_identity: Option<RunCommandManagedIdentity>,
    #[doc = "The provisioning state, which only appears in the response. If treatFailureAsDeploymentFailure set to true, any failure in the script will fail the deployment and ProvisioningState will be marked as Failed. If treatFailureAsDeploymentFailure set to false, ProvisioningState would only reflect whether the run command was run or not by the extensions platform, it would not indicate whether script failed in case of script failures. See instance view of run command in case of script failures to see executionMessage, output, error: https://aka.ms/runcommandmanaged#get-execution-status-and-results "]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<String>,
    #[doc = "The instance view of a virtual machine run command."]
    #[serde(rename = "instanceView", default, skip_serializing_if = "Option::is_none")]
    pub instance_view: Option<VirtualMachineRunCommandInstanceView>,
    #[doc = "Optional. If set to true, any failure in the script will fail the deployment and ProvisioningState will be marked as Failed. If set to false, ProvisioningState would only reflect whether the run command was run or not by the extensions platform, it would not indicate whether script failed in case of script failures. See instance view of run command in case of script failures to see executionMessage, output, error: https://aka.ms/runcommandmanaged#get-execution-status-and-results "]
    #[serde(rename = "treatFailureAsDeploymentFailure", default, skip_serializing_if = "Option::is_none")]
    pub treat_failure_as_deployment_failure: Option<bool>,
}
...
pub struct VirtualMachineRunCommandScriptSource {
    ...
    #[doc = " Contains clientId or objectId (use only one, not both) of a user-assigned managed identity that has access to storage blob used in Run Command. Use an empty RunCommandManagedIdentity object in case of system-assigned identity. Make sure the Azure storage blob exists in case of scriptUri, and managed identity has been given access to blob's container with 'Storage Blob Data Reader' role assignment with scriptUri blob and 'Storage Blob Data Contributor' for Append blobs(outputBlobUri, errorBlobUri). In case of user assigned identity, make sure you add it under VM's identity. For more info on managed identity and Run Command, refer https://aka.ms/ManagedIdentity and https://aka.ms/RunCommandManaged."]
    #[serde(rename = "scriptUriManagedIdentity", default, skip_serializing_if = "Option::is_none")]
    pub script_uri_managed_identity: Option<RunCommandManagedIdentity>,
}
...
pub struct VirtualMachineScaleSet {
    ...
    #[serde(rename = "extendedLocation", default, skip_serializing_if = "Option::is_none")]
    pub extended_location: Option<ExtendedLocation>,
    #[doc = "Etag is property returned in Create/Update/Get response of the VMSS, so that customer can supply it in the header to ensure optimistic updates"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub etag: Option<String>,
}
...
pub struct VirtualMachineScaleSetIpConfigurationProperties {
    ...
    #[serde(
        rename = "loadBalancerInboundNatPools",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
...
pub struct VirtualMachineScaleSetNetworkConfigurationProperties {
    ...
    #[doc = "Specifies whether the Auxiliary mode is enabled for the Network Interface resource."]
    #[serde(rename = "auxiliaryMode", default, skip_serializing_if = "Option::is_none")]
    pub auxiliary_mode: Option<virtual_machine_scale_set_network_configuration_properties::AuxiliaryMode>,
    #[doc = "Specifies whether the Auxiliary sku is enabled for the Network Interface resource."]
    #[serde(rename = "auxiliarySku", default, skip_serializing_if = "Option::is_none")]
    pub auxiliary_sku: Option<virtual_machine_scale_set_network_configuration_properties::AuxiliarySku>,
}
...
pub struct VirtualMachineScaleSetOsProfile {
    ...
    pub secrets: Vec<VaultSecretGroup>,
    #[doc = "Specifies whether extension operations should be allowed on the virtual machine scale set. This may only be set to False when no extensions are present on the virtual machine scale set."]
    #[serde(rename = "allowExtensionOperations", default, skip_serializing_if = "Option::is_none")]
    pub allow_extension_operations: Option<bool>,
    #[doc = "Optional property which must either be set to True or omitted."]
    #[serde(rename = "requireGuestProvisionSignal", default, skip_serializing_if = "Option::is_none")]
...
pub struct VirtualMachineScaleSetProperties {
    ...
    #[doc = "Specifies the target splits for Spot and Regular priority VMs within a scale set with flexible orchestration mode. With this property the customer is able to specify the base number of regular priority VMs created as the VMSS flex instance scales out and the split between Spot and Regular priority VMs after this base target has been reached."]
    #[serde(rename = "priorityMixPolicy", default, skip_serializing_if = "Option::is_none")]
    pub priority_mix_policy: Option<PriorityMixPolicy>,
    #[doc = "Specifies the time at which the Virtual Machine Scale Set resource was created. Minimum api-version: 2021-11-01."]
    #[serde(rename = "timeCreated", default, with = "azure_core::date::rfc3339::option")]
    pub time_created: Option<time::OffsetDateTime>,
    #[doc = "Optional property which must either be set to True or omitted."]
    #[serde(rename = "constrainedMaximumCapacity", default, skip_serializing_if = "Option::is_none")]
    pub constrained_maximum_capacity: Option<bool>,
    #[doc = "Describes an resiliency policy - resilientVMCreationPolicy and/or resilientVMDeletionPolicy."]
    #[serde(rename = "resiliencyPolicy", default, skip_serializing_if = "Option::is_none")]
    pub resiliency_policy: Option<ResiliencyPolicy>,
}
...
pub struct VirtualMachineScaleSetPublicIpAddressConfigurationDnsSettings {
    ...
    #[serde(rename = "domainNameLabel")]
    pub domain_name_label: String,
    #[doc = "The Domain name label scope.The concatenation of the hashed domain name label that generated according to the policy from domain name label scope and vm index will be the domain name labels of the PublicIPAddress resources that will be created"]
    #[serde(rename = "domainNameLabelScope", default, skip_serializing_if = "Option::is_none")]
    pub domain_name_label_scope: Option<virtual_machine_scale_set_public_ip_address_configuration_dns_settings::DomainNameLabelScope>,
}
...
pub mod virtual_machine_scale_set_public_ip_address_configuration_dns_settings {
    use super::*;
    #[doc = "The Domain name label scope.The concatenation of the hashed domain name label that generated according to the policy from domain name label scope and vm index will be the domain name labels of the PublicIPAddress resources that will be created"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "DomainNameLabelScope")]
...
pub struct VirtualMachineScaleSetStorageProfile {
    ...
    #[doc = "Specifies the parameters that are used to add data disks to the virtual machines in the scale set. For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/managed-disks-overview)."]
    #[serde(
        rename = "dataDisks",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
...
pub struct VirtualMachineScaleSetUpdateNetworkConfigurationProperties {
    ...
    #[doc = "Specifies whether the Auxiliary mode is enabled for the Network Interface resource."]
    #[serde(rename = "auxiliaryMode", default, skip_serializing_if = "Option::is_none")]
    pub auxiliary_mode: Option<virtual_machine_scale_set_update_network_configuration_properties::AuxiliaryMode>,
    #[doc = "Specifies whether the Auxiliary sku is enabled for the Network Interface resource."]
    #[serde(rename = "auxiliarySku", default, skip_serializing_if = "Option::is_none")]
    pub auxiliary_sku: Option<virtual_machine_scale_set_update_network_configuration_properties::AuxiliarySku>,
}
...
pub struct VirtualMachineScaleSetUpdateOsDisk {
    ...
    #[serde(rename = "writeAcceleratorEnabled", default, skip_serializing_if = "Option::is_none")]
    pub write_accelerator_enabled: Option<bool>,
    #[doc = "Specifies the size of an empty data disk in gigabytes. This element can be used to overwrite the size of the disk in a virtual machine image. <br><br> diskSizeGB is the number of bytes x 1024^3 for the disk and the value cannot be larger than 1023"]
    #[serde(rename = "diskSizeGB", default, skip_serializing_if = "Option::is_none")]
    pub disk_size_gb: Option<i32>,
    #[doc = "Describes the uri of a disk."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct VirtualMachineScaleSetVm {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub identity: Option<VirtualMachineIdentity>,
    #[doc = "Etag is property returned in Update/Get response of the VMSS VM, so that customer can supply it in the header to ensure optimistic updates."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub etag: Option<String>,
}
...
pub struct VirtualMachineScaleSetVmExtension {
    ...
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<String>,
    #[doc = "The location of the extension."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub location: Option<String>,
    #[doc = "Describes the properties of a Virtual Machine Extension."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct VirtualMachineScaleSetVmProfile {
    ...
    #[serde(rename = "scheduledEventsProfile", default, skip_serializing_if = "Option::is_none")]
    pub scheduled_events_profile: Option<ScheduledEventsProfile>,
    #[doc = "UserData for the virtual machines in the scale set, which must be base-64 encoded. Customer should not pass any secrets in here. Minimum api-version: 2021-03-01."]
    #[serde(rename = "userData", default, skip_serializing_if = "Option::is_none")]
    pub user_data: Option<String>,
    #[doc = "The parameters of a capacity reservation Profile."]
    #[serde(rename = "capacityReservation", default, skip_serializing_if = "Option::is_none")]
    ...
    pub hardware_profile: Option<VirtualMachineScaleSetHardwareProfile>,
    #[doc = "Specifies the service artifact reference id used to set same image version for all virtual machines in the scale set when using 'latest' image version. Minimum api-version: 2022-11-01"]
    #[serde(rename = "serviceArtifactReference", default, skip_serializing_if = "Option::is_none")]
    pub service_artifact_reference: Option<ServiceArtifactReference>,
    #[doc = "Specifies the security posture to be used for all virtual machines in the scale set. Minimum api-version: 2023-03-01"]
    #[serde(rename = "securityPostureReference", default, skip_serializing_if = "Option::is_none")]
    pub security_posture_reference: Option<SecurityPostureReference>,
    #[doc = "Specifies the time in which this VM profile for the Virtual Machine Scale Set was created. Minimum API version for this property is 2023-09-01. This value will be added to VMSS Flex VM tags when creating/updating the VMSS VM Profile with minimum api-version 2023-09-01."]
    #[serde(rename = "timeCreated", default, with = "azure_core::date::rfc3339::option")]
    pub time_created: Option<time::OffsetDateTime>,
}
...
pub struct WindowsConfiguration {
    #[doc = "Indicates whether virtual machine agent should be provisioned on the virtual machine. When this property is not specified in the request body, it is set to true by default. This will ensure that VM Agent is installed on the VM so that extensions can be added to the VM later."]
    #[serde(rename = "provisionVMAgent", default, skip_serializing_if = "Option::is_none")]
    pub provision_vm_agent: Option<bool>,
    #[doc = "Indicates whether Automatic Updates is enabled for the Windows virtual machine. Default value is true. For virtual machine scale sets, this property can be updated and updates will take effect on OS reprovisioning."]
    #[serde(rename = "enableAutomaticUpdates", default, skip_serializing_if = "Option::is_none")]
    pub enable_automatic_updates: Option<bool>,
    #[doc = "Specifies the time zone of the virtual machine. e.g. \"Pacific Standard Time\". Possible values can be [TimeZoneInfo.Id](https://docs.microsoft.com/dotnet/api/system.timezoneinfo.id?#System_TimeZoneInfo_Id) value from time zones returned by [TimeZoneInfo.GetSystemTimeZones](https://docs.microsoft.com/dotnet/api/system.timezoneinfo.getsystemtimezones)."]
    ...
    #[doc = "Indicates whether VMAgent Platform Updates is enabled for the Windows virtual machine. Default value is false."]
    #[serde(rename = "enableVMAgentPlatformUpdates", default, skip_serializing_if = "Option::is_none")]
    pub enable_vm_agent_platform_updates: Option<bool>,
}
