    ...
    pub async fn perform_maintenance(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: OperationStatusResponse =
                    serde_json::from_slice(rsp_body).map_err(|source| perform_maintenance::Error::DeserializeError {
                        source,
                        body: rsp_body.clone(),
                    })?;
    ...
    pub async fn start_os_upgrade(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: OperationStatusResponse =
                    serde_json::from_slice(rsp_body).map_err(|source| start_os_upgrade::Error::DeserializeError {
                        source,
                        body: rsp_body.clone(),
                    })?;
