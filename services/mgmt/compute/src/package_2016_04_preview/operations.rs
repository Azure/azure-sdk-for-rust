    ...
    pub async fn convert_to_managed_disks(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: OperationStatusResponse =
                    serde_json::from_slice(rsp_body).map_err(|source| convert_to_managed_disks::Error::DeserializeError {
                        source,
                        body: rsp_body.clone(),
                    })?;
    ...
    pub async fn reimage_all(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: OperationStatusResponse =
                    serde_json::from_slice(rsp_body).map_err(|source| reimage_all::Error::DeserializeError {
                        source,
                        body: rsp_body.clone(),
                    })?;
    ...
    pub async fn revoke_access(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: OperationStatusResponse =
                    serde_json::from_slice(rsp_body).map_err(|source| revoke_access::Error::DeserializeError {
                        source,
                        body: rsp_body.clone(),
                    })?;
