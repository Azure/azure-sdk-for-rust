...
pub struct ApplicationPackageProperties {
    ...
    #[serde(rename = "storageUrlExpiry", with = "azure_core::date::rfc3339::option")]
...
#[doc = "The authentication mode for the Batch account."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
pub struct AutoStorageBaseProperties {
    ...
    pub node_identity_reference: Option<ComputeNodeIdentityReference>,
}
impl AutoStorageBaseProperties {
    pub fn new(storage_account_id: String) -> Self {
        Self {
            ...
            node_identity_reference: None,
        }
    }
}
pub mod auto_storage_base_properties {
    use super::*;
    #[doc = "The authentication mode which the Batch service will use to manage the auto-storage account."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum AuthenticationMode {
...
pub struct AzureBlobFileSystemConfiguration {
    ...
    #[doc = "This property is mutually exclusive with both sasKey and identity; exactly one must be specified."]
    #[serde(rename = "accountKey", default, skip_serializing_if = "Option::is_none")]
    pub account_key: Option<String>,
    #[doc = "This property is mutually exclusive with both accountKey and identity; exactly one must be specified."]
    ...
    pub identity_reference: Option<ComputeNodeIdentityReference>,
}
...
pub struct BatchAccount {
    ...
    #[doc = "The identity of the Batch account, if configured. This is used when the user specifies 'Microsoft.KeyVault' as their Batch account encryption configuration or when `ManagedIdentity` is selected as the auto-storage authentication mode."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "The identity of the Batch pool, if configured. If the pool identity is updated during update an existing pool, only the new vms which are created after the pool shrinks to 0 will have the updated identities"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
impl BatchPoolIdentity {
    pub fn new(type_: batch_pool_identity::Type) -> Self {
        Self {
            type_,
            user_assigned_identities: None,
        }
...
#[doc = "Base certificate properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct CertificateProperties {
    ...
    #[serde(rename = "provisioningStateTransitionTime", with = "azure_core::date::rfc3339::option")]
    ...
    #[serde(rename = "previousProvisioningStateTransitionTime", with = "azure_core::date::rfc3339::option")]
...
#[doc = "The reference to a user assigned identity associated with the Batch pool which a compute node will use."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ComputeNodeIdentityReference {
    #[doc = "The ARM resource id of the user assigned identity."]
    #[serde(rename = "resourceId", default, skip_serializing_if = "Option::is_none")]
    pub resource_id: Option<String>,
}
impl ComputeNodeIdentityReference {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Allocation configuration used by Batch Service to provision the nodes."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "The default value is regional."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub enum NodePlacementPolicyType {
    Regional,
    Zonal,
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OsDisk {
    #[serde(rename = "ephemeralOSDiskSettings", default, skip_serializing_if = "Option::is_none")]
    pub ephemeral_os_disk_settings: Option<DiffDiskSettings>,
}
impl OsDisk {
    pub fn new() -> Self {
        Self::default()
...
pub struct OutboundEnvironmentEndpoint {
    #[doc = "The type of service that the Batch service connects to."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct Pool {
    ...
    #[doc = "The identity of the Batch pool, if configured. If the pool identity is updated during update an existing pool, only the new vms which are created after the pool shrinks to 0 will have the updated identities"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub identity: Option<BatchPoolIdentity>,
}
impl Pool {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "A SKU capability, such as the number of cores."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SkuCapability {
    #[doc = "The name of the feature."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "The value of the feature."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub value: Option<String>,
}
impl SkuCapability {
...
#[doc = "Describes a Batch supported SKU."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SupportedSku {
    #[doc = "The name of the SKU."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "The family name of the SKU."]
...
#[doc = "The Batch List supported SKUs operation response."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SupportedSkusResult {
    #[doc = "The list of SKUs available for the Batch service in the location."]
    pub value: Vec<SupportedSku>,
    #[doc = "The URL to use for getting the next set of results."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for SupportedSkusResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone()
    }
}
impl SupportedSkusResult {
    pub fn new(value: Vec<SupportedSku>) -> Self {
...
#[doc = "The list of associated user identities."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
impl VmExtension {
    pub fn new(name: String, publisher: String, type_: String) -> Self {
        Self {
            name,
            publisher,
            type_,
