...
#[doc = "Values returned by the List operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DetectorListResult {
    #[doc = "The collection of Batch account detectors returned by the listing operation."]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
...
impl DetectorListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Contains the information for a detector."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DetectorResponse {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Detector response properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<DetectorResponseProperties>,
}
...
#[doc = "Detector response properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DetectorResponseProperties {
    #[doc = "A base64 encoded string that represents the content of a detector."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub value: Option<String>,
}
impl DetectorResponseProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ImageReference {
    ...
    #[doc = "For example, 18.04-LTS or 2022-datacenter."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct NetworkConfiguration {
    ...
    #[serde(rename = "dynamicVNetAssignmentScope", default, skip_serializing_if = "Option::is_none")]
