...
impl Client {
    ...
    pub fn network_security_perimeter_client(&self) -> network_security_perimeter::Client {
        network_security_perimeter::Client(self.clone())
    }
...
pub mod batch_account {
    ...
    impl Client {
        ...
        #[doc = "Synchronizes access keys for the auto-storage account configured for the specified Batch account, only if storage key authentication is being used."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group that contains the Batch account."]
        #[doc = "* `account_name`: The name of the Batch account."]
        ...
        pub fn synchronize_auto_storage_keys(
            ...
            account_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ) -> synchronize_auto_storage_keys::RequestBuilder {
            synchronize_auto_storage_keys::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                account_name: account_name.into(),
        ...
        #[doc = "This operation applies only to Batch accounts with allowedAuthenticationModes containing 'SharedKey'. If the Batch account doesn't contain 'SharedKey' in its allowedAuthenticationMode, clients cannot use shared keys to authenticate, and must use another allowedAuthenticationModes instead. In this case, regenerating the keys will fail."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group that contains the Batch account."]
        #[doc = "* `account_name`: The name of the Batch account."]
        ...
        #[doc = "This operation applies only to Batch accounts with allowedAuthenticationModes containing 'SharedKey'. If the Batch account doesn't contain 'SharedKey' in its allowedAuthenticationMode, clients cannot use shared keys to authenticate, and must use another allowedAuthenticationModes instead. In this case, getting the keys will fail."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group that contains the Batch account."]
        #[doc = "* `account_name`: The name of the Batch account."]
        ...
        #[doc = "Gets information about the detectors available for a given Batch account."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group that contains the Batch account."]
        #[doc = "* `subscription_id`: The Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000)"]
        ...
        #[doc = "Gets information about the given detector for a given Batch account."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group that contains the Batch account."]
        #[doc = "* `subscription_id`: The Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000)"]
        #[doc = "* `account_name`: The name of the Batch account."]
        #[doc = "* `detector_id`: The name of the detector."]
        pub fn get_detector(
            &self,
            resource_group_name: impl Into<String>,
            subscription_id: impl Into<String>,
    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BatchAccount> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BatchAccount = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::BatchAccount>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::BatchAccount>>;
    ...
    pub mod create {
        ...
        impl<'a> Headers<'a> {
            ...
            #[doc = "Suggested delay to check the status of the asynchronous operation. The value is an integer that specifies the delay in seconds."]
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BatchAccountListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BatchAccountListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::BatchAccountListResult, azure_core::error::Error> {
    ...
    pub mod regenerate_key {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BatchAccountKeys> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BatchAccountKeys = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::BatchAccountKeys>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::BatchAccountKeys>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_detectors {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DetectorListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DetectorListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::DetectorListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod get_detector {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Batch/batchAccounts/{}/detectors/{}",
                    &self.subscription_id, &self.resource_group_name, &self.account_name, &self.detector_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DetectorResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_outbound_network_dependencies_endpoints {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Batch/batchAccounts/{}/outboundNetworkDependenciesEndpoints",
                    &self.subscription_id, &self.resource_group_name, &self.account_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
...
pub mod application_package {
    ...
    pub mod activate {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ApplicationPackage> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ApplicationPackage = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    ...
                    &self.subscription_id, &self.resource_group_name, &self.account_name, &self.application_name, &self.version_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ApplicationPackage>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ApplicationPackage>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ListApplicationPackagesResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ListApplicationPackagesResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::ListApplicationPackagesResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Batch/batchAccounts/{}/applications/{}/versions",
                    &self.subscription_id, &self.resource_group_name, &self.account_name, &self.application_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
...
pub mod application {
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ListApplicationsResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ListApplicationsResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::ListApplicationsResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
...
pub mod location {
    ...
    impl Client {
        ...
        #[doc = "* `subscription_id`: The Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000)"]
        pub fn get_quotas(&self, location_name: impl Into<String>, subscription_id: impl Into<String>) -> get_quotas::RequestBuilder {
            get_quotas::RequestBuilder {
                client: self.0.clone(),
                location_name: location_name.into(),
                subscription_id: subscription_id.into(),
            }
        }
        #[doc = "Gets the list of Batch supported Virtual Machine VM sizes available at the given location."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `location_name`: The region for which to retrieve Batch service supported SKUs."]
        #[doc = "* `subscription_id`: The Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000)"]
        pub fn list_supported_virtual_machine_skus(
            &self,
            location_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ) -> list_supported_virtual_machine_skus::RequestBuilder {
            list_supported_virtual_machine_skus::RequestBuilder {
                client: self.0.clone(),
                location_name: location_name.into(),
                subscription_id: subscription_id.into(),
    ...
    pub mod get_quotas {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BatchLocationQuota> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BatchLocationQuota = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::BatchLocationQuota>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::BatchLocationQuota>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_supported_virtual_machine_skus {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SupportedSkusResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SupportedSkusResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            #[doc = "OData filter expression. Valid properties for filtering are \"familyName\"."]
            pub fn filter(mut self, filter: impl Into<String>) -> Self {
                self.filter = Some(filter.into());
                self
            }
            pub fn into_stream(self) -> azure_core::Pageable<models::SupportedSkusResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
...
pub mod operations {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path("/providers/Microsoft.Batch/operations");
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-07-01");
...
pub mod certificate {
    ...
    impl Client {
        ...
        #[doc = "Warning: This operation is deprecated and will be removed after February, 2024. Please use the [Azure KeyVault Extension](https://learn.microsoft.com/azure/batch/batch-certificate-migration-guide) instead."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group that contains the Batch account."]
        #[doc = "* `account_name`: The name of the Batch account."]
        ...
        pub fn list_by_batch_account(
            ...
            account_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ) -> list_by_batch_account::RequestBuilder {
            list_by_batch_account::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                account_name: account_name.into(),
    ...
    pub mod list_by_batch_account {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ListCertificatesResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ListCertificatesResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::ListCertificatesResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Batch/batchAccounts/{}/certificates/{}",
                    &self.subscription_id, &self.resource_group_name, &self.account_name, &self.certificate_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
...
pub mod private_link_resource {
    ...
    pub mod list_by_batch_account {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ListPrivateLinkResourcesResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ListPrivateLinkResourcesResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::ListPrivateLinkResourcesResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
...
pub mod private_endpoint_connection {
    ...
    pub mod list_by_batch_account {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ListPrivateEndpointConnectionsResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ListPrivateEndpointConnectionsResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::ListPrivateEndpointConnectionsResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
...
pub mod pool {
    ...
    pub mod list_by_batch_account {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ListPoolsResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ListPoolsResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::ListPoolsResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Batch/batchAccounts/{}/pools/{}",
                    &self.subscription_id, &self.resource_group_name, &self.account_name, &self.pool_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
...
pub mod network_security_perimeter {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Lists all of the NSP configurations in the specified account."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000)"]
        #[doc = "* `resource_group_name`: The name of the resource group that contains the Batch account."]
        ...
        #[doc = "Gets information about the specified NSP configuration."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000)"]
        #[doc = "* `resource_group_name`: The name of the resource group that contains the Batch account."]
        ...
        #[doc = "Reconciles the specified NSP configuration."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000)"]
        #[doc = "* `resource_group_name`: The name of the resource group that contains the Batch account."]
        ...
        pub fn reconcile_configuration(
            ...
            account_name: impl Into<String>,
            network_security_perimeter_configuration_name: impl Into<String>,
        ) -> reconcile_configuration::RequestBuilder {
            reconcile_configuration::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod list_configurations {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::NetworkSecurityPerimeterConfigurationListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::NetworkSecurityPerimeterConfigurationListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(
                self,
            ) -> azure_core::Pageable<models::NetworkSecurityPerimeterConfigurationListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Batch/batchAccounts/{}/networkSecurityPerimeterConfigurations",
                    &self.subscription_id, &self.resource_group_name, &self.account_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod get_configuration {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Batch/batchAccounts/{}/networkSecurityPerimeterConfigurations/{}" , & self . subscription_id , & self . resource_group_name , & self . account_name , & self . network_security_perimeter_configuration_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-07-01");
    ...
    pub mod reconcile_configuration {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Batch/batchAccounts/{}/networkSecurityPerimeterConfigurations/{}/reconcile" , & self . subscription_id , & self . resource_group_name , & self . account_name , & self . network_security_perimeter_configuration_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-07-01");
