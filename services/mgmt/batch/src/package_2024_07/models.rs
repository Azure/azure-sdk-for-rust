...
pub struct Application {
    #[serde(flatten)]
    pub azure_proxy_resource: AzureProxyResource,
...
pub struct ManagedDisk {
    #[serde(rename = "storageAccountType", default, skip_serializing_if = "Option::is_none")]
    pub storage_account_type: Option<StorageAccountType>,
    #[doc = "Specifies the security profile settings for the managed disk. **Note**: It can only be set for Confidential VMs and is required when using Confidential VMs."]
...
pub struct WindowsUserConfiguration {
    #[doc = "Specifies login mode for the user. The default value is Interactive."]
