...
pub mod event_channels {
    ...
    pub async fn list_by_partner_namespace(
        ...
        filter: Option<&str>,
        top: Option<i64>,
    ) -> Result<EventChannelsListResult> {
        let client = &configuration.client;
        let uri_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.EventGrid/partnerNamespaces/{}/eventChannels",
...
pub mod partner_namespaces {
    ...
    pub async fn list_by_subscription(
        ...
        filter: Option<&str>,
        top: Option<i64>,
    ) -> Result<PartnerNamespacesListResult> {
        let client = &configuration.client;
        let uri_str = &format!(
...
pub mod partner_registrations {
    ...
    pub async fn list_by_subscription(
        ...
        filter: Option<&str>,
        top: Option<i64>,
    ) -> Result<PartnerRegistrationsListResult> {
        let client = &configuration.client;
        let uri_str = &format!(
    ...
    pub async fn list(configuration: &Configuration) -> Result<PartnerRegistrationsListResult> {
        let client = &configuration.client;
...
pub mod partner_topics {
    ...
    pub async fn list_by_subscription(
        ...
        filter: Option<&str>,
        top: Option<i64>,
    ) -> Result<PartnerTopicsListResult> {
        let client = &configuration.client;
        let uri_str = &format!(
...
pub mod extension_topics {
    use crate::{models::*, *};
    pub async fn get(configuration: &Configuration, scope: &str) -> Result<ExtensionTopic> {
        let client = &configuration.client;
        let uri_str = &format!(
