...
pub struct ClientAuthenticationSettings {
    ...
    #[doc = "Custom JWT authentication settings for namespace resource."]
    #[serde(rename = "customJwtAuthentication", default, skip_serializing_if = "Option::is_none")]
    pub custom_jwt_authentication: Option<CustomJwtAuthenticationSettings>,
}
...
#[doc = "A custom domain configuration that allows users to publish to their own domain name."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CustomDomainConfiguration {
    #[doc = "Fully Qualified Domain Name (FQDN) for the custom domain."]
    #[serde(rename = "fullyQualifiedDomainName")]
    pub fully_qualified_domain_name: String,
    #[doc = "Validation state for the custom domain. This is a read only property and is initially set to 'Pending' and will be updated to 'Approved' by Event Grid only after ownership of the domain name has been successfully validated."]
    #[serde(rename = "validationState", default, skip_serializing_if = "Option::is_none")]
    pub validation_state: Option<custom_domain_configuration::ValidationState>,
    #[doc = "The identity information for retrieving the certificate for the custom domain."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub identity: Option<CustomDomainIdentity>,
    #[doc = "The URL for the certificate that is used for publishing to the custom domain. We currently support certificates stored in Azure Key Vault only. While certificate URL can be either\r\nversioned URL of the following format https://{key-vault-name}.vault.azure.net/certificates/{certificate-name}/{version-id}, or unversioned URL of the following format (e.g.,\r\nhttps://contosovault.vault.azure.net/certificates/contosocert, we support unversioned certificate URL only (e.g., https://contosovault.vault.azure.net/certificates/contosocert)"]
    #[serde(rename = "certificateUrl", default, skip_serializing_if = "Option::is_none")]
    pub certificate_url: Option<String>,
    #[doc = "Expected DNS TXT record name. Event Grid will check for a TXT record with this name in the DNS record set of the custom domain name to prove ownership over the domain.\r\nThe values under this TXT record must contain the expected TXT record value."]
    #[serde(rename = "expectedTxtRecordName", default, skip_serializing_if = "Option::is_none")]
    pub expected_txt_record_name: Option<String>,
    #[doc = "Expected DNS TXT record value. Event Grid will check for a TXT record with this value in the DNS record set of the custom domain name to prove ownership over the domain."]
    #[serde(rename = "expectedTxtRecordValue", default, skip_serializing_if = "Option::is_none")]
    pub expected_txt_record_value: Option<String>,
}
impl CustomDomainConfiguration {
    pub fn new(fully_qualified_domain_name: String) -> Self {
        Self {
            fully_qualified_domain_name,
            validation_state: None,
            identity: None,
            certificate_url: None,
            expected_txt_record_name: None,
            expected_txt_record_value: None,
        }
    }
}
pub mod custom_domain_configuration {
    use super::*;
    #[doc = "Validation state for the custom domain. This is a read only property and is initially set to 'Pending' and will be updated to 'Approved' by Event Grid only after ownership of the domain name has been successfully validated."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    ...
    impl Serialize for ValidationState {
        ...
        {
            match self {
                Self::Pending => serializer.serialize_unit_variant("ValidationState", 0u32, "Pending"),
                Self::Approved => serializer.serialize_unit_variant("ValidationState", 1u32, "Approved"),
                Self::ErrorRetrievingDnsRecord => serializer.serialize_unit_variant("ValidationState", 2u32, "ErrorRetrievingDnsRecord"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "The identity information for retrieving the certificate for the custom domain."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CustomDomainIdentity {
    #[doc = "The type of managed identity used. Can be either 'SystemAssigned' or 'UserAssigned'."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<custom_domain_identity::Type>,
...
impl CustomDomainIdentity {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod custom_domain_identity {
    use super::*;
    #[doc = "The type of managed identity used. Can be either 'SystemAssigned' or 'UserAssigned'."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Type")]
...
#[doc = "Namespace custom domain ownership validation result."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CustomDomainOwnershipValidationResult {
    #[doc = "List of custom domain configurations for the namespace under topics configuration."]
    #[serde(
        rename = "customDomainsForTopicsConfiguration",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub custom_domains_for_topics_configuration: Vec<CustomDomainConfiguration>,
    #[doc = "List of custom domain configurations for the namespace under topic spaces configuration."]
    #[serde(
        rename = "customDomainsForTopicSpacesConfiguration",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub custom_domains_for_topic_spaces_configuration: Vec<CustomDomainConfiguration>,
}
impl CustomDomainOwnershipValidationResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The identity information for retrieving the certificate for custom JWT authentication."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CustomJwtAuthenticationManagedIdentity {
    #[doc = "The type of managed identity used. Can be either 'SystemAssigned' or 'UserAssigned'."]
    #[serde(rename = "type")]
    pub type_: custom_jwt_authentication_managed_identity::Type,
    #[doc = "The user identity associated with the resource."]
    #[serde(rename = "userAssignedIdentity", default, skip_serializing_if = "Option::is_none")]
    pub user_assigned_identity: Option<String>,
}
impl CustomJwtAuthenticationManagedIdentity {
    pub fn new(type_: custom_jwt_authentication_managed_identity::Type) -> Self {
        Self {
            type_,
...
pub mod custom_jwt_authentication_managed_identity {
    use super::*;
    #[doc = "The type of managed identity used. Can be either 'SystemAssigned' or 'UserAssigned'."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Type")]
...
#[doc = "Custom JWT authentication settings for namespace resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CustomJwtAuthenticationSettings {
    #[doc = "Expected JWT token issuer."]
    #[serde(rename = "tokenIssuer", default, skip_serializing_if = "Option::is_none")]
    pub token_issuer: Option<String>,
    #[doc = "Information about the certificate that is used for token validation. We currently support maximum 2 certificates."]
    #[serde(
        rename = "issuerCertificates",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub issuer_certificates: Vec<IssuerCertificateInfo>,
}
impl CustomJwtAuthenticationSettings {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct DeliveryConfiguration {
    ...
    #[doc = "Properties of the destination info for event subscription supporting push."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    impl Serialize for DeliveryMode {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Push => serializer.serialize_unit_variant("DeliveryMode", 1u32, "Push"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Information about the certificate that is used for token validation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct IssuerCertificateInfo {
    #[doc = "Keyvault certificate URL in https://keyvaultname.vault.azure.net/certificates/certificateName/certificateVersion format."]
    #[serde(rename = "certificateUrl")]
    pub certificate_url: String,
    #[doc = "The identity information for retrieving the certificate for custom JWT authentication."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub identity: Option<CustomJwtAuthenticationManagedIdentity>,
}
impl IssuerCertificateInfo {
...
#[doc = "Information about the Monitor Alert destination for an event subscription."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct MonitorAlertEventSubscriptionDestination {
    #[doc = "The properties that represent the Monitor Alert destination of an event subscription."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<MonitorAlertEventSubscriptionDestinationProperties>,
}
impl MonitorAlertEventSubscriptionDestination {
    pub fn new() -> Self {
        Self { properties: None }
    }
}
#[doc = "The properties that represent the Monitor Alert destination of an event subscription."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MonitorAlertEventSubscriptionDestinationProperties {
    #[doc = "The severity that will be attached to every Alert fired through this event subscription.\r\nThis field must be provided."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub severity: Option<monitor_alert_event_subscription_destination_properties::Severity>,
    #[doc = "The description that will be attached to every Alert fired through this event subscription."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    #[doc = "The list of ARM Ids of Action Groups that will be triggered on every Alert fired through this event subscription.\r\nEach resource ARM Id should follow this pattern: /subscriptions/{AzureSubscriptionId}/resourceGroups/{ResourceGroupName}/providers/Microsoft.Insights/actionGroups/{ActionGroupName}."]
    #[serde(
        rename = "actionGroups",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
...
impl MonitorAlertEventSubscriptionDestinationProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod monitor_alert_event_subscription_destination_properties {
    use super::*;
    #[doc = "The severity that will be attached to every Alert fired through this event subscription.\r\nThis field must be provided."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
pub struct NamespaceProperties {
    ...
    #[doc = "This is an optional property and it allows the user to specify if the namespace resource supports zone-redundancy capability or not. If this\r\nproperty is not specified explicitly by the user, its default value depends on the following conditions:\r\n    a. For Availability Zones enabled regions - The default property value would be true.\r\n    b. For non-Availability Zones enabled regions - The default property value would be false.\r\nOnce specified, this property cannot be updated."]
...
#[doc = "Information about the Namespace Topic destination for an event subscription."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct NamespaceTopicEventSubscriptionDestination {
    #[doc = "The properties that represent the Event Grid Namespace Topic destination of an event subscription."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<NamespaceTopicEventSubscriptionDestinationProperties>,
}
impl NamespaceTopicEventSubscriptionDestination {
    pub fn new() -> Self {
        Self { properties: None }
    }
}
...
pub struct NamespaceUpdateParameterProperties {
    ...
    #[doc = "Properties of the topics configuration info of a namespace."]
    #[serde(rename = "topicsConfiguration", default, skip_serializing_if = "Option::is_none")]
    pub topics_configuration: Option<UpdateTopicsConfigurationInfo>,
...
#[doc = "Network security perimeter configuration."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NetworkSecurityPerimeterConfiguration {
    #[serde(flatten)]
    pub resource: Resource,
    #[doc = "Network security perimeter configuration information to reflect latest association and nsp profile configuration."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Network security perimeter configuration issues."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NetworkSecurityPerimeterConfigurationIssues {
    #[doc = "Provisioning issue name."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Network security perimeter configuration issues properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<NetworkSecurityPerimeterConfigurationIssuesProperties>,
}
impl NetworkSecurityPerimeterConfigurationIssues {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Network security perimeter configuration issues properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NetworkSecurityPerimeterConfigurationIssuesProperties {
    #[doc = "Provisioning issue type."]
    #[serde(rename = "issueType", default, skip_serializing_if = "Option::is_none")]
    pub issue_type: Option<network_security_perimeter_configuration_issues_properties::IssueType>,
    #[doc = "Provisioning issue severity."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub severity: Option<network_security_perimeter_configuration_issues_properties::Severity>,
    #[doc = "Provisioning issue description."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
...
impl NetworkSecurityPerimeterConfigurationIssuesProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod network_security_perimeter_configuration_issues_properties {
    use super::*;
    #[doc = "Provisioning issue type."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "IssueType")]
    pub enum IssueType {
    ...
    impl Serialize for IssueType {
        ...
        {
            match self {
                Self::MissingPerimeterConfiguration => {
                    serializer.serialize_unit_variant("IssueType", 0u32, "MissingPerimeterConfiguration")
                }
                Self::MissingIdentityConfiguration => serializer.serialize_unit_variant("IssueType", 1u32, "MissingIdentityConfiguration"),
                Self::ConfigurationPropagationFailure => {
                    serializer.serialize_unit_variant("IssueType", 2u32, "ConfigurationPropagationFailure")
                }
                Self::Other => serializer.serialize_unit_variant("IssueType", 3u32, "Other"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for Severity {
        ...
        {
            match self {
                Self::Warning => serializer.serialize_unit_variant("Severity", 0u32, "Warning"),
                Self::Error => serializer.serialize_unit_variant("Severity", 1u32, "Error"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
}
#[doc = "Network security perimeter configuration List."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NetworkSecurityPerimeterConfigurationList {
    #[doc = "List of all network security parameter configurations."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    ...
    #[doc = "A link for the next page of Network Security Perimeter Configuration."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
...
#[doc = "Nsp configuration with profile information."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NetworkSecurityPerimeterConfigurationProfile {
    #[doc = "Nsp configuration profile name."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Access rules version number for nsp profile."]
    #[serde(rename = "accessRulesVersion", default, skip_serializing_if = "Option::is_none")]
    pub access_rules_version: Option<String>,
    #[doc = "List of inbound or outbound access rule setup on the nsp profile."]
    #[serde(
        rename = "accessRules",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub access_rules: Vec<NetworkSecurityPerimeterProfileAccessRule>,
    #[doc = "Diagnostic settings version number for nsp profile."]
    ...
    #[doc = "Enabled log categories for nsp profile."]
    #[serde(
...
impl NetworkSecurityPerimeterConfigurationProfile {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct NetworkSecurityPerimeterConfigurationProperties {
    #[doc = "Provisioning state to reflect configuration state and indicate status of nsp profile configuration retrieval."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<network_security_perimeter_configuration_properties::ProvisioningState>,
    #[doc = "Provisioning issues to reflect status when attempting to retrieve nsp profile configuration."]
    #[serde(
    ...
    pub provisioning_issues: Vec<NetworkSecurityPerimeterConfigurationIssues>,
    #[doc = "Network security perimeter info."]
    #[serde(rename = "networkSecurityPerimeter", default, skip_serializing_if = "Option::is_none")]
    pub network_security_perimeter: Option<NetworkSecurityPerimeterInfo>,
    #[doc = "Nsp resource association"]
    #[serde(rename = "resourceAssociation", default, skip_serializing_if = "Option::is_none")]
    pub resource_association: Option<ResourceAssociation>,
    #[doc = "Nsp configuration with profile information."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub profile: Option<NetworkSecurityPerimeterConfigurationProfile>,
}
...
pub mod network_security_perimeter_configuration_properties {
    use super::*;
    #[doc = "Provisioning state to reflect configuration state and indicate status of nsp profile configuration retrieval."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ProvisioningState")]
...
#[doc = "Network security perimeter info."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NetworkSecurityPerimeterInfo {
    #[doc = "Arm id for network security perimeter."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "Network security perimeter guid."]
    #[serde(rename = "perimeterGuid", default, skip_serializing_if = "Option::is_none")]
    pub perimeter_guid: Option<String>,
    #[doc = "Network security perimeter location."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub location: Option<String>,
}
impl NetworkSecurityPerimeterInfo {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Network security perimeter profile access rule."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NetworkSecurityPerimeterProfileAccessRule {
    #[doc = "Fully Qualified Arm id for network security perimeter profile access rule."]
    #[serde(rename = "fullyQualifiedArmId", default, skip_serializing_if = "Option::is_none")]
    pub fully_qualified_arm_id: Option<String>,
    #[doc = "Name for nsp access rule."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "nsp access rule type."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<String>,
    #[doc = "Network security perimeter profile access rule properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<NetworkSecurityPerimeterProfileAccessRuleProperties>,
}
impl NetworkSecurityPerimeterProfileAccessRule {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Network security perimeter profile access rule properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NetworkSecurityPerimeterProfileAccessRuleProperties {
    #[doc = "NSP access rule direction."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub direction: Option<network_security_perimeter_profile_access_rule_properties::Direction>,
    #[doc = "Address prefixes."]
    #[serde(
    ...
    pub subscriptions: Vec<NetworkSecurityPerimeterSubscription>,
    #[doc = "Network security perimeters."]
    #[serde(
    ...
    pub network_security_perimeters: Vec<NetworkSecurityPerimeterInfo>,
...
impl NetworkSecurityPerimeterProfileAccessRuleProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod network_security_perimeter_profile_access_rule_properties {
    use super::*;
    #[doc = "NSP access rule direction."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "Network security perimeter subscription inbound access rule."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NetworkSecurityPerimeterSubscription {
    #[doc = "Subscription id."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
}
impl NetworkSecurityPerimeterSubscription {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ResourceAssociation {
    #[doc = "Association name"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Network security perimeter access mode."]
    #[serde(rename = "accessMode", default, skip_serializing_if = "Option::is_none")]
    pub access_mode: Option<resource_association::AccessMode>,
}
...
pub struct RoutingEnrichments {
    ...
    pub static_: Vec<StaticRoutingEnrichmentUnion>,
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
pub struct RoutingIdentityInfo {
    #[doc = "Routing identity type for topic spaces configuration."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Static routing enrichment details."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "valueType")]
pub enum StaticRoutingEnrichmentUnion {
    String(StaticStringRoutingEnrichment),
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct StaticStringRoutingEnrichment {
    #[serde(flatten)]
    pub static_routing_enrichment: StaticRoutingEnrichment,
    #[doc = "String type routing enrichment value."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub value: Option<String>,
    #[doc = "Static routing enrichment key."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl StaticStringRoutingEnrichment {
    pub fn new(static_routing_enrichment: StaticRoutingEnrichment) -> Self {
        Self {
...
#[doc = "Full endpoint URL of an event subscription"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SubscriptionFullUrl {
    #[doc = "The URL that represents the endpoint of the destination of an event subscription."]
    #[serde(rename = "endpointUrl", default, skip_serializing_if = "Option::is_none")]
    pub endpoint_url: Option<String>,
}
impl SubscriptionFullUrl {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct TopicSpacesConfiguration {
    ...
    #[doc = "List of custom domain configurations for the namespace."]
    #[serde(
    ...
    pub custom_domains: Vec<CustomDomainConfiguration>,
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct TopicTypeAdditionalEnforcedPermission {
    #[serde(rename = "permissionName", default, skip_serializing_if = "Option::is_none")]
    pub permission_name: Option<String>,
    #[serde(rename = "isDataAction", default, skip_serializing_if = "Option::is_none")]
    pub is_data_action: Option<bool>,
}
impl TopicTypeAdditionalEnforcedPermission {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct TopicTypeProperties {
    ...
    #[doc = "Permissions which are enforced for creating and updating system topics of this this topic type."]
    #[serde(
        rename = "additionalEnforcedPermissions",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub additional_enforced_permissions: Vec<TopicTypeAdditionalEnforcedPermission>,
}
...
pub struct UpdateTopicSpacesConfigurationInfo {
    ...
    #[serde(rename = "routingIdentityInfo", default, skip_serializing_if = "Option::is_none")]
    pub routing_identity_info: Option<RoutingIdentityInfo>,
    #[doc = "Custom domain info for topic spaces configuration."]
    #[serde(
        rename = "customDomains",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
...
#[doc = "Properties of the topics configuration info of a namespace."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct UpdateTopicsConfigurationInfo {
    #[doc = "Custom domain info for topics configuration."]
    #[serde(
        rename = "customDomains",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
...
impl UpdateTopicsConfigurationInfo {
    pub fn new() -> Self {
        Self::default()
    }
}
