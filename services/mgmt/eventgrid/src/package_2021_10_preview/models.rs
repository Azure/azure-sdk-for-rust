...
pub struct ChannelProperties {
    ...
    #[serde(rename = "expirationTimeIfNotActivatedUtc", default, skip_serializing_if = "Option::is_none")]
    pub expiration_time_if_not_activated_utc: Option<String>,
}
...
pub struct ChannelUpdateParametersProperties {
    #[doc = "Expiration time of the event channel. If this timer expires while the corresponding partner topic or partner destination is never activated,\r\nthe channel and corresponding partner topic or partner destination are deleted."]
    #[serde(rename = "expirationTimeIfNotActivatedUtc", default, skip_serializing_if = "Option::is_none")]
    pub expiration_time_if_not_activated_utc: Option<String>,
    #[doc = "Properties of the corresponding partner destination of a Channel."]
    #[serde(rename = "partnerDestinationInfo", default, skip_serializing_if = "Option::is_none")]
...
pub struct EventChannel {
    #[serde(flatten)]
    pub resource: Resource,
    #[doc = "Properties of the Event Channel."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Properties of the destination of an event channel."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EventChannelDestination {
    #[doc = "Azure subscription ID of the customer creating the event channel. The partner topic\r\nassociated with the event channel will be created under this Azure subscription."]
    #[serde(rename = "azureSubscriptionId", default, skip_serializing_if = "Option::is_none")]
    pub azure_subscription_id: Option<String>,
    #[doc = "Azure Resource Group of the customer creating the event channel. The partner topic\r\nassociated with the event channel will be created under this resource group."]
    #[serde(rename = "resourceGroup", default, skip_serializing_if = "Option::is_none")]
    pub resource_group: Option<String>,
    #[doc = "Name of the partner topic associated with the event channel."]
    #[serde(rename = "partnerTopicName", default, skip_serializing_if = "Option::is_none")]
    pub partner_topic_name: Option<String>,
}
impl EventChannelDestination {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Filter for the Event Channel."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EventChannelFilter {
    #[doc = "Allows advanced filters to be evaluated against an array of values instead of expecting a singular value. The default value is either false or null."]
...
#[doc = "Properties of the Event Channel."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EventChannelProperties {
    #[doc = "Properties of the source of an event channel."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub source: Option<EventChannelSource>,
    #[doc = "Properties of the destination of an event channel."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub destination: Option<EventChannelDestination>,
    #[doc = "Provisioning state of the event channel."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<event_channel_properties::ProvisioningState>,
    #[doc = "The readiness state of the corresponding partner topic."]
    #[serde(rename = "partnerTopicReadinessState", default, skip_serializing_if = "Option::is_none")]
    pub partner_topic_readiness_state: Option<event_channel_properties::PartnerTopicReadinessState>,
    #[doc = "Expiration time of the event channel. If this timer expires while the corresponding partner topic is never activated,\r\nthe event channel and corresponding partner topic are deleted."]
    #[serde(rename = "expirationTimeIfNotActivatedUtc", default, skip_serializing_if = "Option::is_none")]
    pub expiration_time_if_not_activated_utc: Option<String>,
    #[doc = "Filter for the Event Channel."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub filter: Option<EventChannelFilter>,
...
pub mod event_channel_properties {
    ...
    #[doc = "The readiness state of the corresponding partner topic."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "PartnerTopicReadinessState")]
    pub enum PartnerTopicReadinessState {
    ...
    impl FromStr for PartnerTopicReadinessState {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for PartnerTopicReadinessState {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for PartnerTopicReadinessState {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::NotActivatedByUserYet => {
                    serializer.serialize_unit_variant("PartnerTopicReadinessState", 0u32, "NotActivatedByUserYet")
                }
                Self::ActivatedByUser => serializer.serialize_unit_variant("PartnerTopicReadinessState", 1u32, "ActivatedByUser"),
                Self::DeactivatedByUser => serializer.serialize_unit_variant("PartnerTopicReadinessState", 2u32, "DeactivatedByUser"),
                Self::DeletedByUser => serializer.serialize_unit_variant("PartnerTopicReadinessState", 3u32, "DeletedByUser"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Properties of the source of an event channel."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EventChannelSource {
    #[doc = "The identifier of the resource that's the source of the events.\r\nThis represents a unique resource in the partner's resource model."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub source: Option<String>,
}
impl EventChannelSource {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Result of the List Event Channels operation"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EventChannelsListResult {
    #[doc = "A collection of Event Channels"]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub value: Vec<EventChannel>,
...
pub struct Partner {
    ...
    #[serde(rename = "authorizationExpirationTimeInUtc", default, skip_serializing_if = "Option::is_none")]
    pub authorization_expiration_time_in_utc: Option<String>,
}
impl Partner {
    pub fn new() -> Self {
        Self::default()
...
pub struct PartnerDestinationInfo {
    ...
    #[serde(rename = "resourceMoveChangeHistory", default, skip_serializing_if = "Vec::is_empty")]
...
pub struct PartnerRegistrationProperties {
    ...
    #[serde(rename = "partnerRegistrationImmutableId", default, skip_serializing_if = "Option::is_none")]
    pub partner_registration_immutable_id: Option<String>,
    #[doc = "Official name of the partner name. For example: \"Contoso\"."]
    #[serde(rename = "partnerName", default, skip_serializing_if = "Option::is_none")]
    pub partner_name: Option<String>,
    #[doc = "Name of the partner resource type."]
    #[serde(rename = "partnerResourceTypeName", default, skip_serializing_if = "Option::is_none")]
    pub partner_resource_type_name: Option<String>,
    #[doc = "Display name of the partner resource type."]
    #[serde(rename = "partnerResourceTypeDisplayName", default, skip_serializing_if = "Option::is_none")]
    pub partner_resource_type_display_name: Option<String>,
    #[doc = "Short description of the partner resource type. The length of this description should not exceed 256 characters."]
    #[serde(rename = "partnerResourceTypeDescription", default, skip_serializing_if = "Option::is_none")]
    pub partner_resource_type_description: Option<String>,
    #[doc = "Long description for the custom scenarios and integration to be displayed in the portal if needed.\r\nLength of this description should not exceed 2048 characters."]
    #[serde(rename = "longDescription", default, skip_serializing_if = "Option::is_none")]
    pub long_description: Option<String>,
    #[doc = "The customer service number of the publisher. The expected phone format should start with a '+' sign \r\nfollowed by the country code. The remaining digits are then followed. Only digits and spaces are allowed and its\r\nlength cannot exceed 16 digits including country code. Examples of valid phone numbers are: +1 515 123 4567 and\r\n+966 7 5115 2471. Examples of invalid phone numbers are: +1 (515) 123-4567, 1 515 123 4567 and +966 121 5115 24 7 551 1234 43"]
    #[serde(rename = "partnerCustomerServiceNumber", default, skip_serializing_if = "Option::is_none")]
    pub partner_customer_service_number: Option<String>,
    #[doc = "The extension of the customer service number of the publisher. Only digits are allowed and number of digits should not exceed 10."]
    #[serde(rename = "partnerCustomerServiceExtension", default, skip_serializing_if = "Option::is_none")]
    pub partner_customer_service_extension: Option<String>,
    #[doc = "The extension of the customer service URI of the publisher."]
    #[serde(rename = "customerServiceUri", default, skip_serializing_if = "Option::is_none")]
    pub customer_service_uri: Option<String>,
    #[doc = "URI of the partner website that can be used by Azure customers to setup Event Grid\r\nintegration on an event source."]
    #[serde(rename = "setupUri", default, skip_serializing_if = "Option::is_none")]
    pub setup_uri: Option<String>,
    #[doc = "URI of the logo."]
    ...
    #[doc = "Visibility state of the partner registration."]
    #[serde(rename = "visibilityState", default, skip_serializing_if = "Option::is_none")]
    pub visibility_state: Option<partner_registration_properties::VisibilityState>,
    #[doc = "List of Azure subscription Ids that are authorized to create a partner namespace\r\nassociated with this partner registration. This is an optional property. Creating\r\npartner namespaces is always permitted under the same Azure subscription as the one used\r\nfor creating the partner registration."]
    #[serde(rename = "authorizedAzureSubscriptionIds", default, skip_serializing_if = "Vec::is_empty")]
...
pub mod partner_registration_properties {
    ...
    impl<'de> Deserialize<'de> for VisibilityState {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for VisibilityState {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Hidden => serializer.serialize_unit_variant("VisibilityState", 0u32, "Hidden"),
                Self::PublicPreview => serializer.serialize_unit_variant("VisibilityState", 1u32, "PublicPreview"),
                Self::GenerallyAvailable => serializer.serialize_unit_variant("VisibilityState", 2u32, "GenerallyAvailable"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct PartnerRegistrationUpdateParameters {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<serde_json::Value>,
    #[doc = "Name of the partner topic type."]
    #[serde(rename = "partnerTopicTypeName", default, skip_serializing_if = "Option::is_none")]
    pub partner_topic_type_name: Option<String>,
    #[doc = "Display name of the partner topic type."]
    #[serde(rename = "partnerTopicTypeDisplayName", default, skip_serializing_if = "Option::is_none")]
    pub partner_topic_type_display_name: Option<String>,
    #[doc = "Description of the partner topic type."]
    #[serde(rename = "partnerTopicTypeDescription", default, skip_serializing_if = "Option::is_none")]
    pub partner_topic_type_description: Option<String>,
    #[doc = "URI of the partner website that can be used by Azure customers to setup Event Grid\r\nintegration on an event source."]
    #[serde(rename = "setupUri", default, skip_serializing_if = "Option::is_none")]
    pub setup_uri: Option<String>,
    #[doc = "URI of the partner logo."]
    #[serde(rename = "logoUri", default, skip_serializing_if = "Option::is_none")]
    pub logo_uri: Option<String>,
    #[doc = "List of IDs of Azure AD applications that are authorized to create a partner namespace\r\nassociated with this partner registration. This is an optional property. Creating\r\npartner namespaces is always permitted under the same Azure subscription as the one used\r\nfor creating the partner registration."]
    #[serde(rename = "authorizedAzureSubscriptionIds", default, skip_serializing_if = "Vec::is_empty")]
    pub authorized_azure_subscription_ids: Vec<String>,
}
...
pub struct ResourceMoveChangeHistory {
    ...
    #[serde(rename = "changedTimeUtc", default, skip_serializing_if = "Option::is_none")]
    pub changed_time_utc: Option<String>,
}
