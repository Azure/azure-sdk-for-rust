...
pub mod workspaces {
    ...
    pub async fn update(
        operation_config: &crate::OperationConfig,
        parameters: &models::WorkspaceUpdate,
        resource_group_name: &str,
        workspace_name: &str,
        subscription_id: &str,
...
pub mod operations {
    ...
    pub async fn list(operation_config: &crate::OperationConfig) -> std::result::Result<models::OperationListResult, list::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!("{}/providers/Microsoft.Databricks/operations", operation_config.base_path(),);
...
pub mod v_net_peering {
    ...
    pub async fn list_by_workspace(
        ...
        workspace_name: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::VirtualNetworkPeeringList, list_by_workspace::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Databricks/workspaces/{}/virtualNetworkPeerings",
            operation_config.base_path(),
