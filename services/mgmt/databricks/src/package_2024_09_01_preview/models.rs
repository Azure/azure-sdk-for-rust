...
use std::str::FromStr;
#[doc = "Information about Azure Databricks Access Connector."]
...
#[doc = "List of Azure Databricks Access Connector."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AccessConnectorListResult {
    #[doc = "The array of Azure Databricks Access Connector."]
    #[serde(
        default,
...
pub struct AccessConnectorProperties {
    #[doc = "Provisioning status of the Access Connector."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<access_connector_properties::ProvisioningState>,
    #[doc = "List of workspaces referring this Access Connector."]
    #[serde(
        rename = "referedBy",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
...
#[doc = "An update to an Azure Databricks Access Connector."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "Status of automated cluster updates feature."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AutomaticClusterUpdateDefinition {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub value: Option<automatic_cluster_update_definition::Value>,
}
impl AutomaticClusterUpdateDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod automatic_cluster_update_definition {
    use super::*;
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Value")]
    pub enum Value {
    ...
    impl Serialize for Value {
        ...
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("Value", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("Value", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
}
#[doc = "Status of Compliance Security Profile feature."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ComplianceSecurityProfileDefinition {
    #[doc = "Compliance standards associated with the workspace."]
    #[serde(
        rename = "complianceStandards",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub compliance_standards: Vec<ComplianceStandardDefinition>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub value: Option<compliance_security_profile_definition::Value>,
}
impl ComplianceSecurityProfileDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod compliance_security_profile_definition {
    use super::*;
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Value")]
    pub enum Value {
...
#[doc = "Compliance standard that can be associated with a workspace. CYBER_ESSENTIAL_PLUS is only available for UK region workspaces"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ComplianceStandardDefinition")]
pub enum ComplianceStandardDefinition {
    #[serde(rename = "NONE")]
    None,
    #[serde(rename = "HIPAA")]
    Hipaa,
    ...
    PciDss,
    #[serde(rename = "CYBER_ESSENTIAL_PLUS")]
    CyberEssentialPlus,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for ComplianceStandardDefinition {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for ComplianceStandardDefinition {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for ComplianceStandardDefinition {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::None => serializer.serialize_unit_variant("ComplianceStandardDefinition", 0u32, "NONE"),
            Self::Hipaa => serializer.serialize_unit_variant("ComplianceStandardDefinition", 1u32, "HIPAA"),
            Self::PciDss => serializer.serialize_unit_variant("ComplianceStandardDefinition", 2u32, "PCI_DSS"),
            Self::CyberEssentialPlus => serializer.serialize_unit_variant("ComplianceStandardDefinition", 3u32, "CYBER_ESSENTIAL_PLUS"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "These properties lets user specify default catalog properties during workspace creation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DefaultCatalogProperties {
    #[doc = "Defines the initial type of the default catalog. Possible values (case-insensitive):  HiveMetastore, UnityCatalog"]
    #[serde(rename = "initialType", default, skip_serializing_if = "Option::is_none")]
    pub initial_type: Option<default_catalog_properties::InitialType>,
    #[doc = "Specifies the initial Name of default catalog. If not specified, the name of the workspace will be used."]
    #[serde(rename = "initialName", default, skip_serializing_if = "Option::is_none")]
    pub initial_name: Option<String>,
}
impl DefaultCatalogProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod default_catalog_properties {
    use super::*;
    #[doc = "Defines the initial type of the default catalog. Possible values (case-insensitive):  HiveMetastore, UnityCatalog"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "InitialType")]
    ...
    impl FromStr for InitialType {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for InitialType {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for InitialType {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::HiveMetastore => serializer.serialize_unit_variant("InitialType", 0u32, "HiveMetastore"),
                Self::UnityCatalog => serializer.serialize_unit_variant("InitialType", 1u32, "UnityCatalog"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for InitialType {
        fn default() -> Self {
            Self::HiveMetastore
        }
    }
...
#[doc = "Status of settings related to the Enhanced Security and Compliance Add-On."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EnhancedSecurityComplianceDefinition {
    #[doc = "Status of automated cluster updates feature."]
    #[serde(rename = "automaticClusterUpdate", default, skip_serializing_if = "Option::is_none")]
    pub automatic_cluster_update: Option<AutomaticClusterUpdateDefinition>,
    #[doc = "Status of Compliance Security Profile feature."]
    #[serde(rename = "complianceSecurityProfile", default, skip_serializing_if = "Option::is_none")]
    pub compliance_security_profile: Option<ComplianceSecurityProfileDefinition>,
    #[doc = "Status of Enhanced Security Monitoring feature."]
    #[serde(rename = "enhancedSecurityMonitoring", default, skip_serializing_if = "Option::is_none")]
    pub enhanced_security_monitoring: Option<EnhancedSecurityMonitoringDefinition>,
}
impl EnhancedSecurityComplianceDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Status of Enhanced Security Monitoring feature."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EnhancedSecurityMonitoringDefinition {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub value: Option<enhanced_security_monitoring_definition::Value>,
}
impl EnhancedSecurityMonitoringDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod enhanced_security_monitoring_definition {
    use super::*;
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Value")]
    pub enum Value {
...
pub struct WorkspaceCustomParameters {
    ...
    pub enable_no_public_ip: Option<WorkspaceNoPublicIpBooleanParameter>,
    #[doc = "The Value."]
...
#[doc = "The value which should be used for this field."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct WorkspaceNoPublicIpBooleanParameter {
    #[doc = "Provisioning status of the workspace."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<WorkspaceCustomParameterType>,
    #[doc = "The value which should be used for this field."]
...
impl WorkspaceNoPublicIpBooleanParameter {
    pub fn new(value: bool) -> Self {
        Self { type_: None, value }
    }
}
...
pub struct WorkspaceProperties {
    ...
    #[doc = "Status of settings related to the Enhanced Security and Compliance Add-On."]
    #[serde(rename = "enhancedSecurityCompliance", default, skip_serializing_if = "Option::is_none")]
    pub enhanced_security_compliance: Option<EnhancedSecurityComplianceDefinition>,
    ...
    #[doc = "These properties lets user specify default catalog properties during workspace creation."]
    #[serde(rename = "defaultCatalog", default, skip_serializing_if = "Option::is_none")]
    pub default_catalog: Option<DefaultCatalogProperties>,
    #[doc = "Indicates whether unity catalog enabled for the workspace or not."]
    #[serde(rename = "isUcEnabled", default, skip_serializing_if = "Option::is_none")]
    pub is_uc_enabled: Option<bool>,
    #[doc = "Access Connector Resource that is going to be associated with Databricks Workspace"]
    #[serde(rename = "accessConnector", default, skip_serializing_if = "Option::is_none")]
    pub access_connector: Option<workspace_properties::AccessConnector>,
    #[doc = "Gets or Sets Default Storage Firewall configuration information"]
    #[serde(rename = "defaultStorageFirewall", default, skip_serializing_if = "Option::is_none")]
    pub default_storage_firewall: Option<workspace_properties::DefaultStorageFirewall>,
}
impl WorkspaceProperties {
    pub fn new(managed_resource_group_id: String) -> Self {
        Self {
            ...
            encryption: None,
            enhanced_security_compliance: None,
...
pub mod workspace_properties {
    ...
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub struct AccessConnector {
        #[doc = "The resource ID of Azure Databricks Access Connector Resource."]
        pub id: String,
        #[doc = "The identity type of the Access Connector Resource."]
        #[serde(rename = "identityType")]
        pub identity_type: access_connector::IdentityType,
        #[doc = "The resource ID of the User Assigned Identity associated with the Access Connector Resource. This is required for type 'UserAssigned' and not valid for type 'SystemAssigned'."]
        #[serde(rename = "userAssignedIdentityId", default, skip_serializing_if = "Option::is_none")]
        pub user_assigned_identity_id: Option<String>,
    }
    impl AccessConnector {
        pub fn new(id: String, identity_type: access_connector::IdentityType) -> Self {
            Self {
                id,
                identity_type,
    ...
    #[doc = "Gets or Sets Default Storage Firewall configuration information"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "DefaultStorageFirewall")]
    pub enum DefaultStorageFirewall {
        Disabled,
        Enabled,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for DefaultStorageFirewall {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for DefaultStorageFirewall {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for DefaultStorageFirewall {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Disabled => serializer.serialize_unit_variant("DefaultStorageFirewall", 0u32, "Disabled"),
                Self::Enabled => serializer.serialize_unit_variant("DefaultStorageFirewall", 1u32, "Enabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
