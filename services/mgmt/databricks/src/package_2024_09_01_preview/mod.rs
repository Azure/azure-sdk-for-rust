...
pub mod workspaces {
    ...
    pub mod delete {
        ...
        impl RequestBuilder {
            #[doc = "Optional parameter to retain default unity catalog data. By default the data will retained if Uc is enabled on the workspace."]
...
pub mod access_connectors {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets an Azure Databricks Access Connector."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `connector_name`: The name of the Azure Databricks Access Connector."]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        pub fn get(
            &self,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "Creates or updates Azure Databricks Access Connector."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `parameters`: Parameters supplied to the create or update an Azure Databricks Access Connector."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `connector_name`: The name of the Azure Databricks Access Connector."]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        pub fn create_or_update(
        ...
        #[doc = "Updates an Azure Databricks Access Connector."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `parameters`: The update to the Azure Databricks Access Connector."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `connector_name`: The name of the Azure Databricks Access Connector."]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        pub fn update(
        ...
        #[doc = "Deletes the Azure Databricks Access Connector."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `connector_name`: The name of the Azure Databricks Access Connector."]
        ...
        #[doc = "Gets all the Azure Databricks Access Connectors within a resource group."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        ...
        #[doc = "Gets all the Azure Databricks Access Connectors within a subscription."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        pub fn list_by_subscription(&self, subscription_id: impl Into<String>) -> list_by_subscription::RequestBuilder {
