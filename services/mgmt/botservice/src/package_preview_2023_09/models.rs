...
pub struct BotProperties {
    ...
    #[serde(
        rename = "networkSecurityPerimeterConfigurations",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub network_security_perimeter_configurations: Vec<NetworkSecurityPerimeterConfiguration>,
...
impl BotProperties {
    pub fn new(display_name: String, endpoint: String, msa_app_id: String) -> Self {
        Self {
            ...
            network_security_perimeter_configurations: Vec::new(),
            open_with_hint: None,
...
pub mod provisioning_issue {
    ...
    pub struct Properties {
        ...
        pub suggested_access_rules: Vec<NspAccessRule>,
    }
    impl Properties {
        pub fn new() -> Self {
            Self::default()
