...
pub use package_preview_2021_05::{models, operations, operations::Client, operations::ClientBuilder};
...
pub use package_2020_06_02::{models, operations, operations::Client, operations::ClientBuilder};
#[cfg(feature = "package-2018-07-12")]
pub mod package_2018_07_12;
#[cfg(all(feature = "package-2018-07-12", not(feature = "no-default-tag")))]
pub use package_2018_07_12::{models, operations, operations::Client, operations::ClientBuilder};
#[cfg(feature = "package-2017-12-01")]
pub mod package_2017_12_01;
#[cfg(all(feature = "package-2017-12-01", not(feature = "no-default-tag")))]
pub use package_2017_12_01::{models, operations, operations::Client, operations::ClientBuilder};
