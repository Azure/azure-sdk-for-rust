...
pub use package_preview_2021_05::{models, operations, API_VERSION};
...
#[cfg(all(feature = "package-2020-06-02", not(feature = "no-default-version")))]
pub use package_2020_06_02::{models, operations, API_VERSION};
#[cfg(feature = "package-2018-07-12")]
pub mod package_2018_07_12;
#[cfg(all(feature = "package-2018-07-12", not(feature = "no-default-version")))]
pub use package_2018_07_12::{models, operations, API_VERSION};
