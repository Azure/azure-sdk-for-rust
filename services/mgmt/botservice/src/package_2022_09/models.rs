...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CreateEmailSignInUrlResponse {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<CreateEmailSignInUrlResponseProperties>,
}
impl CreateEmailSignInUrlResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The set of properties specific to sign in url"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CreateEmailSignInUrlResponseProperties {
    #[doc = "Sign in url."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
}
impl CreateEmailSignInUrlResponseProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct QnAMakerEndpointKeysRequestBody {
...
impl QnAMakerEndpointKeysRequestBody {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct QnAMakerEndpointKeysResponse {
    #[doc = "Primary Access Key."]
    #[serde(rename = "primaryEndpointKey", default, skip_serializing_if = "Option::is_none")]
    pub primary_endpoint_key: Option<String>,
    #[doc = "Secondary Access Key."]
    #[serde(rename = "secondaryEndpointKey", default, skip_serializing_if = "Option::is_none")]
    pub secondary_endpoint_key: Option<String>,
    ...
    #[serde(rename = "lastStableVersion", default, skip_serializing_if = "Option::is_none")]
    pub last_stable_version: Option<String>,
}
impl QnAMakerEndpointKeysResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
