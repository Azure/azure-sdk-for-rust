...
impl Client {
    ...
    pub fn qn_a_maker_endpoint_keys_client(&self) -> qn_a_maker_endpoint_keys::Client {
        qn_a_maker_endpoint_keys::Client(self.clone())
    }
}
pub mod bots {
    use super::models;
    ...
    impl Client {
        ...
        ) -> get_check_name_availability::RequestBuilder {
            get_check_name_availability::RequestBuilder {
                client: self.0.clone(),
                parameters: parameters.into(),
            }
    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::Bot> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::Bot = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::Bot>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::Bot>>;
    ...
    pub mod get_check_name_availability {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.BotService/checkNameAvailability",));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-06-15-preview");
...
pub mod channels {
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BotChannel> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BotChannel = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    ...
                    &self.subscription_id, &self.resource_group_name, &self.resource_name, &self.channel_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::BotChannel>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::BotChannel>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_with_keys {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ListChannelWithKeysResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ListChannelWithKeysResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ListChannelWithKeysResponse>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ListChannelWithKeysResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_by_resource_group {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ChannelResponseList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ChannelResponseList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ChannelResponseList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
...
pub mod email {
    ...
    impl Client {
        ...
        #[doc = "* `resource_name`: The name of the Bot resource."]
        #[doc = "* `subscription_id`: Azure Subscription ID."]
        pub fn create_sign_in_url(
            &self,
            resource_group_name: impl Into<String>,
            resource_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ) -> create_sign_in_url::RequestBuilder {
            create_sign_in_url::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                resource_name: resource_name.into(),
    ...
    pub mod create_sign_in_url {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CreateEmailSignInUrlResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CreateEmailSignInUrlResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.BotService/botServices/{}/createEmailSignInUrl",
                    &self.subscription_id, &self.resource_group_name, &self.resource_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::CreateEmailSignInUrlResponse>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::CreateEmailSignInUrlResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod operations {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.BotService/operations",));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-06-15-preview");
...
pub mod bot_connection {
    ...
    impl Client {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: Azure Subscription ID."]
        pub fn list_service_providers(&self, subscription_id: impl Into<String>) -> list_service_providers::RequestBuilder {
            list_service_providers::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
            }
        }
        ...
        pub fn list_with_secrets(
            ...
            subscription_id: impl Into<String>,
        ) -> list_with_secrets::RequestBuilder {
            list_with_secrets::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                resource_name: resource_name.into(),
        ...
        pub fn list_by_bot_service(
            ...
            resource_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ) -> list_by_bot_service::RequestBuilder {
            list_by_bot_service::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                resource_name: resource_name.into(),
    ...
    pub mod list_service_providers {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ServiceProviderResponseList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ServiceProviderResponseList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ServiceProviderResponseList>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ServiceProviderResponseList>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_with_secrets {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ConnectionSetting> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ConnectionSetting = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    ...
                    &self.subscription_id, &self.resource_group_name, &self.resource_name, &self.connection_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ConnectionSetting>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ConnectionSetting>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_by_bot_service {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ConnectionSettingResponseList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ConnectionSettingResponseList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ConnectionSettingResponseList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
...
pub mod qn_a_maker_endpoint_keys {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    impl Client {
        ...
        pub fn get(
            &self,
            parameters: impl Into<models::QnAMakerEndpointKeysRequestBody>,
            subscription_id: impl Into<String>,
        ) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::QnAMakerEndpointKeysResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::QnAMakerEndpointKeysResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) parameters: models::QnAMakerEndpointKeysRequestBody,
            pub(crate) subscription_id: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.BotService/listQnAMakerEndpointKeys",
                    &self.subscription_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::QnAMakerEndpointKeysResponse>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::QnAMakerEndpointKeysResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod host_settings {
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::HostSettingsResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::HostSettingsResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::HostSettingsResponse>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::HostSettingsResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod private_link_resources {
    ...
    impl Client {
        ...
        pub fn list_by_bot_resource(
            ...
            resource_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ) -> list_by_bot_resource::RequestBuilder {
            list_by_bot_resource::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                resource_name: resource_name.into(),
