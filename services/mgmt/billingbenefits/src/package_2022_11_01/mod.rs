...
impl Client {
    ...
    pub fn reservation_order_alias_client(&self) -> reservation_order_alias::Client {
        reservation_order_alias::Client(self.clone())
    }
    pub fn savings_plan_client(&self) -> savings_plan::Client {
        savings_plan::Client(self.clone())
    }
    pub fn savings_plan_order_client(&self) -> savings_plan_order::Client {
        savings_plan_order::Client(self.clone())
    }
    pub fn savings_plan_order_alias_client(&self) -> savings_plan_order_alias::Client {
        savings_plan_order_alias::Client(self.clone())
    }
}
pub mod operations {
    use super::models;
...
pub mod savings_plan_order_alias {
    use super::models;
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Get a savings plan."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `savings_plan_order_alias_name`: Name of the savings plan order alias"]
        pub fn get(&self, savings_plan_order_alias_name: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                savings_plan_order_alias_name: savings_plan_order_alias_name.into(),
            }
        }
        #[doc = "Create a savings plan. Learn more about permissions needed at https://go.microsoft.com/fwlink/?linkid=2215851"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `savings_plan_order_alias_name`: Name of the savings plan order alias"]
        #[doc = "* `body`: Request body for creating a savings plan order alias"]
        pub fn create(
            &self,
            savings_plan_order_alias_name: impl Into<String>,
            body: impl Into<models::SavingsPlanOrderAliasModel>,
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SavingsPlanOrderAliasModel> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SavingsPlanOrderAliasModel = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) savings_plan_order_alias_name: String,
        }
        impl RequestBuilder {
                ...
                Box::pin({
                    ...
                    async move {
                        let url = azure_core::Url::parse(&format!(
                            ...
                            this.client.endpoint(),
                            &this.savings_plan_order_alias_name
                        ))?;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Get);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::SavingsPlanOrderAliasModel>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::SavingsPlanOrderAliasModel>>;
    ...
    pub mod create {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) savings_plan_order_alias_name: String,
            pub(crate) body: models::SavingsPlanOrderAliasModel,
        }
        impl RequestBuilder {
...
pub mod savings_plan_order {
    use super::models;
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Get a savings plan order."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `savings_plan_order_id`: Order ID of the savings plan"]
        pub fn get(&self, savings_plan_order_id: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
        ...
        #[doc = "Elevate as owner on savings plan order based on billing permissions."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `savings_plan_order_id`: Order ID of the savings plan"]
        pub fn elevate(&self, savings_plan_order_id: impl Into<String>) -> elevate::RequestBuilder {
            elevate::RequestBuilder {
                client: self.0.clone(),
                savings_plan_order_id: savings_plan_order_id.into(),
            }
        }
        #[doc = "List all Savings plan orders."]
        pub fn list(&self) -> list::RequestBuilder {
            list::RequestBuilder { client: self.0.clone() }
        }
    }
    pub mod get {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::SavingsPlanOrderModel>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod elevate {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::RoleAssignmentEntity> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::RoleAssignmentEntity = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        let url = azure_core::Url::parse(&format!(
                            "{}/providers/Microsoft.BillingBenefits/savingsPlanOrders/{}/elevate",
                            this.client.endpoint(),
                            &this.savings_plan_order_id
                        ))?;
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::RoleAssignmentEntity>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::RoleAssignmentEntity>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod savings_plan {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List savings plans in an order."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `savings_plan_order_id`: Order ID of the savings plan"]
        pub fn list(&self, savings_plan_order_id: impl Into<String>) -> list::RequestBuilder {
            list::RequestBuilder {
                client: self.0.clone(),
                savings_plan_order_id: savings_plan_order_id.into(),
            }
        }
        #[doc = "List savings plans."]
        ...
        #[doc = "Get savings plan."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `savings_plan_order_id`: Order ID of the savings plan"]
        #[doc = "* `savings_plan_id`: ID of the savings plan"]
        pub fn get(&self, savings_plan_order_id: impl Into<String>, savings_plan_id: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                savings_plan_order_id: savings_plan_order_id.into(),
        ...
        #[doc = "Validate savings plan patch."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `savings_plan_order_id`: Order ID of the savings plan"]
        #[doc = "* `savings_plan_id`: ID of the savings plan"]
        #[doc = "* `body`: Request body for validating a savings plan patch request"]
        pub fn validate_update(
            &self,
            savings_plan_order_id: impl Into<String>,
            savings_plan_id: impl Into<String>,
            body: impl Into<models::SavingsPlanUpdateValidateRequest>,
        ) -> validate_update::RequestBuilder {
            validate_update::RequestBuilder {
                client: self.0.clone(),
                savings_plan_order_id: savings_plan_order_id.into(),
                savings_plan_id: savings_plan_id.into(),
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::SavingsPlanModelList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    ...
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
                            "{}/providers/Microsoft.BillingBenefits/savingsPlanOrders/{}/savingsPlans",
                            this.client.endpoint(),
                            &this.savings_plan_order_id
                        ))?;
                        let rsp = match continuation {
    ...
    pub mod list_all {
        ...
        impl RequestBuilder {
            ...
            #[doc = "To number of savings plans to return"]
    ...
    pub mod get {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::SavingsPlanModel>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod validate_update {
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        let url = azure_core::Url::parse(&format!(
                            "{}/providers/Microsoft.BillingBenefits/savingsPlanOrders/{}/savingsPlans/{}/validate",
                            this.client.endpoint(),
                            &this.savings_plan_order_id,
                            &this.savings_plan_id
                        ))?;
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::SavingsPlanValidateResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
impl Client {
    #[doc = "Validate savings plan purchase."]
    #[doc = ""]
    #[doc = "Arguments:"]
    #[doc = "* `body`: Request body for validating the purchase of a savings plan"]
    pub fn validate_purchase(&self, body: impl Into<models::SavingsPlanPurchaseValidateRequest>) -> validate_purchase::RequestBuilder {
        validate_purchase::RequestBuilder {
            client: self.clone(),
            body: body.into(),
        }
    }
}
pub mod validate_purchase {
    use super::models;
    pub struct Response(azure_core::Response);
    impl Response {
        pub async fn into_body(self) -> azure_core::Result<models::SavingsPlanValidateResponse> {
    ...
    pub struct RequestBuilder {
        ...
        pub(crate) body: models::SavingsPlanPurchaseValidateRequest,
    }
    impl RequestBuilder {
        #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
        #[doc = ""]
        ...
        pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
            Box::pin({
                let this = self.clone();
                async move {
                    let url = azure_core::Url::parse(&format!("{}/providers/Microsoft.BillingBenefits/validate", this.client.endpoint(),))?;
                    let mut req = azure_core::Request::new(url, azure_core::Method::Post);
                    let credential = this.client.token_credential();
                    let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                    req.insert_header(
...
pub mod reservation_order_alias {
    use super::models;
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Get a reservation order alias."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `reservation_order_alias_name`: Name of the reservation order alias"]
        pub fn get(&self, reservation_order_alias_name: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                reservation_order_alias_name: reservation_order_alias_name.into(),
            }
        }
        #[doc = "Create a reservation order alias."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `reservation_order_alias_name`: Name of the reservation order alias"]
        #[doc = "* `body`: Request body for creating a reservation order alias"]
        pub fn create(
            &self,
            reservation_order_alias_name: impl Into<String>,
            body: impl Into<models::ReservationOrderAliasRequest>,
        ) -> create::RequestBuilder {
            create::RequestBuilder {
                client: self.0.clone(),
                reservation_order_alias_name: reservation_order_alias_name.into(),
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ReservationOrderAliasResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ReservationOrderAliasResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) reservation_order_alias_name: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
                ...
                Box::pin({
                    ...
                    async move {
                        let url = azure_core::Url::parse(&format!(
                            ...
                            this.client.endpoint(),
                            &this.reservation_order_alias_name
                        ))?;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Get);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ReservationOrderAliasResponse>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::ReservationOrderAliasResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) reservation_order_alias_name: String,
            pub(crate) body: models::ReservationOrderAliasRequest,
        }
        impl RequestBuilder {
            #[doc = "only the first response will be fetched as long running operations are not supported yet"]
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
