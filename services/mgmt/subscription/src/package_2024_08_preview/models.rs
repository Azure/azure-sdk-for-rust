...
impl azure_core::Continuable for SubscriptionAliasListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
...
#[doc = "Subscription Response to list out Changed Target Directory."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct TargetDirectoryListResult {
    #[doc = "The list of subscription response to changed target directory."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<TargetDirectoryResult>,
    #[doc = "The link (url) to the next page of results."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for TargetDirectoryListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl TargetDirectoryListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Subscription Request for Changed Target Directory."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct TargetDirectoryRequest {
    #[doc = "Properties of subscription Request for Changed Target Directory."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<TargetDirectoryRequestProperties>,
}
impl TargetDirectoryRequest {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Properties of subscription Request for Changed Target Directory."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct TargetDirectoryRequestProperties {
    #[doc = "The destination OwnerId, can be object id or email address"]
    #[serde(rename = "destinationOwnerId", default, skip_serializing_if = "Option::is_none")]
    pub destination_owner_id: Option<String>,
    #[doc = "The destination Tenant id where subscription needs to be accepted"]
    #[serde(rename = "destinationTenantId", default, skip_serializing_if = "Option::is_none")]
    pub destination_tenant_id: Option<String>,
}
impl TargetDirectoryRequestProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Subscription Response for Changed Target Directory."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct TargetDirectoryResult {
    #[doc = "Fully qualified ID for the Subscription Changed Directory resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "Subscription Name."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Resource type, Microsoft.Subscription/changeTenantRequest."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<String>,
    #[doc = "Properties of subscription Response for Changed Target Directory."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<TargetDirectoryResultProperties>,
}
impl TargetDirectoryResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Properties of subscription Response for Changed Target Directory."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct TargetDirectoryResultProperties {
    #[doc = "Destination Tenant Id where Subscription will be accepted."]
    #[serde(rename = "destinationTenantId", default, skip_serializing_if = "Option::is_none")]
    pub destination_tenant_id: Option<String>,
    #[doc = "Destination Owner Id where Subscription will be accepted."]
    #[serde(rename = "destinationOwnerId", default, skip_serializing_if = "Option::is_none")]
    pub destination_owner_id: Option<String>,
    #[doc = "Subscription Status."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[doc = "Subscription Initiate Request Expiry time"]
    #[serde(rename = "expiresOn", default, with = "azure_core::date::rfc3339::option")]
    pub expires_on: Option<::time::OffsetDateTime>,
}
impl TargetDirectoryResultProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Subscription Status for accepted request."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct TargetDirectoryStatusResult {
    #[doc = "Subscription Status"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
}
impl TargetDirectoryStatusResult {
    pub fn new() -> Self {
        Self::default()
    }
}
