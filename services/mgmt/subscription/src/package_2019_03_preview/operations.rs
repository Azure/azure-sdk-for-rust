...
pub enum Error {
    #[error(transparent)]
    Subscriptions_Cancel(#[from] subscriptions::cancel::Error),
    #[error(transparent)]
    Subscriptions_Rename(#[from] subscriptions::rename::Error),
    #[error(transparent)]
    Subscriptions_Enable(#[from] subscriptions::enable::Error),
    #[error(transparent)]
