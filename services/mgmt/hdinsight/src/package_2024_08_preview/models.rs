...
pub struct IpTag {
    ...
    #[doc = "Gets or sets value of the IpTag associated with the public IP. Example HDInsight, SQL, Storage etc"]
    pub tag: String,
}
impl IpTag {
...
pub struct NetworkProperties {
    ...
    #[doc = "Contains the IpTag associated with the public IP address"]
    #[serde(rename = "publicIpTag", default, skip_serializing_if = "Option::is_none")]
    pub public_ip_tag: Option<IpTag>,
}
