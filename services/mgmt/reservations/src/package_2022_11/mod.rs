...
pub mod reservation {
    ...
    impl Client {
        ...
        #[doc = "Check whether the scopes from request is valid for `Reservation`.\n"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `reservation_order_id`: Order Id of the reservation"]
        #[doc = "* `reservation_id`: Id of the reservation item"]
        #[doc = "* `body`: Scopes to be checked for eligibility."]
        ...
        #[doc = "* `reservation_order_id`: Order Id of the reservation"]
        #[doc = "* `reservation_id`: Id of the reservation item"]
        pub fn get(&self, reservation_order_id: impl Into<String>, reservation_id: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                reservation_order_id: reservation_order_id.into(),
                reservation_id: reservation_id.into(),
        ...
        #[doc = "Restores a `Reservation` to the state it was before archiving.\n"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `reservation_order_id`: Order Id of the reservation"]
        #[doc = "* `reservation_id`: Id of the reservation item"]
    ...
    pub mod available_scopes {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::AvailableScopeProperties>>;
    ...
    pub mod split {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<Vec<models::ReservationResponse>>>;
    ...
    pub mod get {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ReservationResponse>>;
    ...
    pub mod list_all {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.Capacity/reservations",));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-11-01");
...
impl Client {
    ...
    pub fn get_catalog(&self, subscription_id: impl Into<String>) -> get_catalog::RequestBuilder {
...
pub mod get_catalog {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
        pub async fn into_body(self) -> azure_core::Result<models::CatalogsResult> {
            let bytes = self.0.into_body().collect().await?;
            let body: models::CatalogsResult = serde_json::from_slice(&bytes)?;
            Ok(body)
        }
        pub fn into_raw_response(self) -> azure_core::Response {
            self.0
    ...
    impl RequestBuilder {
        ...
        #[doc = "The number of reservations to skip from the list before returning results"]
        pub fn skip(mut self, skip: f64) -> Self {
            self.skip = Some(skip);
            self
        }
        #[doc = "To number of reservations to return"]
        ...
        pub fn into_stream(self) -> azure_core::Pageable<models::CatalogsResult, azure_core::error::Error> {
            let make_request = move |continuation: Option<String>| {
                let this = self.clone();
                async move {
                    let mut url = this.url()?;
...
pub mod get_applied_reservation_list {
    ...
    impl std::future::IntoFuture for RequestBuilder {
        ...
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::AppliedReservations>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod reservation_order {
    ...
    pub mod calculate {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.Capacity/calculatePrice",));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-11-01");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::CalculatePriceResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.Capacity/reservationOrders",));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-11-01");
    ...
    pub mod get {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ReservationOrderResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod change_directory {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ChangeDirectoryResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod operation {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.Capacity/operations",));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-11-01");
...
pub mod calculate_refund {
    ...
    pub mod post {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::CalculateRefundResponse>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::CalculateRefundResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod calculate_exchange {
    ...
    pub mod post {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.Capacity/calculateExchange",));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-11-01");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::CalculateExchangeOperationResultResponse>>;
            #[doc = "Returns a future that polls the long running operation, returning once the operation completes."]
            #[doc = ""]
            #[doc = "To only submit the request but not monitor the status of the operation until completion, use `send()` instead."]
            #[doc = ""]
...
pub mod exchange {
    ...
    pub mod post {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.Capacity/exchange",));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-11-01");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ExchangeOperationResultResponse>>;
            #[doc = "Returns a future that polls the long running operation, returning once the operation completes."]
            #[doc = ""]
            #[doc = "To only submit the request but not monitor the status of the operation until completion, use `send()` instead."]
            #[doc = ""]
...
pub mod quota {
    ...
    pub mod get {
        ...
        pub struct Headers<'a>(&'a azure_core::headers::Headers);
        impl<'a> Headers<'a> {
            #[doc = "Current entity state version. It should be treated as opaque and used to make conditional HTTP requests."]
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    ...
                    &self.subscription_id, &self.provider_id, &self.location, &self.resource_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::CurrentQuotaLimitBase>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.Capacity/resourceProviders/{}/locations/{}/serviceLimits",
                    &self.subscription_id, &self.provider_id, &self.location
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
...
pub mod quota_request_status {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    ...
                    &self.subscription_id, &self.provider_id, &self.location, &self.id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::QuotaRequestDetails>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
