...
#[doc = "The properties of ADO OAuth."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AdooAuth {
...
#[doc = "ADOOAuth request object"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AdooAuthCallRequest {
...
impl AdooAuthCallRequest {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Response containing ADO OAuth information"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AdooAuthInfoResponse {
    #[doc = "URL used to authorize ADO app using Entra ID"]
    #[serde(rename = "authURL", default, skip_serializing_if = "Option::is_none")]
    pub auth_url: Option<String>,
    #[doc = "OAuth token used to make calls to ADO APIs"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub token: Option<String>,
}
impl AdooAuthInfoResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The response from List ADOOAuth operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AdooAuthListResponse {
    #[doc = "Singleton list response containing one ADOOAuthResponse"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<AdooAuthResponse>,
    #[doc = "The URL to the next set of ADO OAuth results."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for AdooAuthListResponse {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl AdooAuthListResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Singleton response of ADO OAuth."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AdooAuthResponse {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "The properties of ADO OAuth."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<AdooAuth>,
}
impl AdooAuthResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Details of the ADO repository associated with the workflow."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AdoRepository {
    #[doc = "The owner of the repository the workflow is associated with."]
    #[serde(rename = "repositoryOwner", default, skip_serializing_if = "Option::is_none")]
    pub repository_owner: Option<String>,
    #[doc = "The name of the repository the workflow is associated with."]
    #[serde(rename = "repositoryName", default, skip_serializing_if = "Option::is_none")]
    pub repository_name: Option<String>,
    #[doc = "The name of the branch the workflow is associated with."]
    #[serde(rename = "branchName", default, skip_serializing_if = "Option::is_none")]
    pub branch_name: Option<String>,
    #[doc = "The name of the Azure DevOps organization the pipeline is associated with."]
    #[serde(rename = "adoOrganization", default, skip_serializing_if = "Option::is_none")]
    pub ado_organization: Option<String>,
    #[doc = "The name of the project the pipeline is associated with."]
...
#[doc = "Azure Pipeline Profile"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AzurePipelineProfile {
    #[doc = "Details of the ADO repository associated with the workflow."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub repository: Option<AdoRepository>,
    #[doc = "The name of the ARM Service Connection the pipeline is associated with."]
    #[serde(rename = "armServiceConnection", default, skip_serializing_if = "Option::is_none")]
    pub arm_service_connection: Option<String>,
    #[doc = "Build details of the repository associated with the workflow."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub build: Option<Build>,
    #[doc = "Deployment details of the repository associated with the workflow."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub deployment: Option<Deployment>,
    #[doc = "Kubernetes namespace the application is deployed to."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub namespace: Option<String>,
    #[doc = "Resource identifier for azure container registry repository associated with the workflow."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub acr: Option<String>,
    #[doc = "The Azure Kubernetes Cluster Resource the application will be deployed to."]
    #[serde(rename = "clusterId", default, skip_serializing_if = "Option::is_none")]
    pub cluster_id: Option<String>,
    #[doc = "Details of the pull request containing the workflow."]
...
pub struct GitHubWorkflowProfile {
    ...
    pub deployment_properties: Option<Deployment>,
    #[doc = "Kubernetes namespace the application is deployed to."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub namespace: Option<String>,
    #[doc = "Information on the azure container registry"]
...
pub struct ScaleProperty {
    ...
    #[serde(rename = "numberOfStore", default, skip_serializing_if = "Option::is_none")]
    pub number_of_store: Option<i32>,
}
impl ScaleProperty {
    pub fn new() -> Self {
        Self::default()
...
pub struct ScaleTemplateRequest {
    ...
    pub template_name: Option<String>,
    #[serde(
        rename = "scaleRequirement",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub scale_requirement: Vec<ScaleProperty>,
}
...
pub struct WorkflowProperties {
    ...
    #[doc = "Azure Pipeline Profile"]
    #[serde(rename = "azurePipelineProfile", default, skip_serializing_if = "Option::is_none")]
    pub azure_pipeline_profile: Option<AzurePipelineProfile>,
}
