...
impl Client {
    ...
    pub fn adoo_auth_client(&self) -> adoo_auth::Client {
        adoo_auth::Client(self.clone())
    }
...
impl Client {
    ...
    #[doc = "Gets ADOOAuth info used to authenticate users with ADO."]
    #[doc = ""]
    #[doc = "Arguments:"]
    #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
    #[doc = "* `location`: The name of the Azure region."]
    pub fn get_adoo_auth_info(
        &self,
        subscription_id: impl Into<String>,
        location: impl Into<String>,
    ) -> get_adoo_auth_info::RequestBuilder {
        get_adoo_auth_info::RequestBuilder {
            client: self.clone(),
            subscription_id: subscription_id.into(),
            location: location.into(),
...
pub mod get_adoo_auth_info {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
        pub async fn into_body(self) -> azure_core::Result<models::AdooAuthInfoResponse> {
            let bytes = self.0.into_body().collect().await?;
            let body: models::AdooAuthInfoResponse = serde_json::from_slice(&bytes)?;
            Ok(body)
        }
        pub fn into_raw_response(self) -> azure_core::Response {
            self.0
    ...
    pub struct RequestBuilder {
        ...
        pub(crate) subscription_id: String,
        pub(crate) location: String,
        pub(crate) parameters: Option<models::AdooAuthCallRequest>,
    }
    impl RequestBuilder {
        #[doc = "The fields required in ADO OAuth call request."]
        pub fn parameters(mut self, parameters: impl Into<models::AdooAuthCallRequest>) -> Self {
            self.parameters = Some(parameters.into());
            self
        }
        #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!(
                "/subscriptions/{}/providers/Microsoft.DevHub/locations/{}/adooauth/default/getADOOAuthInfo",
                &self.subscription_id, &self.location
            ));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::AdooAuthInfoResponse>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::AdooAuthInfoResponse>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod adoo_auth {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Callback URL to hit once authenticated with Entra ID to have the service store the OAuth token."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `location`: The name of the Azure region."]
        ...
        #[doc = "Callback URL to hit once authenticated with ADO to have the service store the OAuth token."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `location`: The name of the Azure region."]
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AdooAuthResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AdooAuthResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.DevHub/locations/{}/adooauth/default",
                    &self.subscription_id, &self.location
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AdooAuthResponse>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::AdooAuthResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AdooAuthListResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AdooAuthListResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::AdooAuthListResponse, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.DevHub/locations/{}/adooauth",
                    &self.subscription_id, &self.location
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
