...
impl Client {
    ...
    pub fn device_capacity_check_client(&self) -> device_capacity_check::Client {
        device_capacity_check::Client(self.clone())
    }
    pub fn device_capacity_info_client(&self) -> device_capacity_info::Client {
        device_capacity_info::Client(self.clone())
    }
    ...
    pub fn marketplace_image_offer_client(&self) -> marketplace_image_offer::Client {
        marketplace_image_offer::Client(self.clone())
    }
    pub fn marketplace_image_publisher_client(&self) -> marketplace_image_publisher::Client {
        marketplace_image_publisher::Client(self.clone())
    }
    pub fn marketplace_image_sas_token_client(&self) -> marketplace_image_sas_token::Client {
        marketplace_image_sas_token::Client(self.clone())
    }
    pub fn marketplace_image_sku_client(&self) -> marketplace_image_sku::Client {
        marketplace_image_sku::Client(self.clone())
    }
    pub fn marketplace_image_version_client(&self) -> marketplace_image_version::Client {
        marketplace_image_version::Client(self.clone())
    }
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/providers/Microsoft.DataBoxEdge/operations", self.client.endpoint(),))?;
...
pub mod available_skus {
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DataBoxEdgeSkuList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DataBoxEdgeSkuList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::DataBoxEdgeSkuList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
...
pub mod devices {
    ...
    pub mod list_by_subscription {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DataBoxEdgeDeviceList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DataBoxEdgeDeviceList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::DataBoxEdgeDeviceList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DataBoxEdgeDevice> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DataBoxEdgeDevice = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DataBoxEdgeDevice>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DataBoxEdgeDevice>>;
    ...
    pub mod generate_certificate {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::GenerateCertResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::GenerateCertResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::GenerateCertResponse>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::GenerateCertResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get_extended_information {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DataBoxEdgeDeviceExtendedInfo> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DataBoxEdgeDeviceExtendedInfo = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DataBoxEdgeDeviceExtendedInfo>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DataBoxEdgeDeviceExtendedInfo>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get_network_settings {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::NetworkSettings>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::NetworkSettings>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_update_security_settings {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{}/securitySettings/default/update" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . device_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-12-01-preview");
    ...
    pub mod get_update_summary {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::UpdateSummary> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::UpdateSummary = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::UpdateSummary>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::UpdateSummary>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod upload_certificate {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::UploadCertificateResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::UploadCertificateResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::UploadCertificateResponse>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::UploadCertificateResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod bandwidth_schedules {
    ...
    pub mod list_by_data_box_edge_device {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BandwidthSchedulesList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BandwidthSchedulesList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::BandwidthSchedulesList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BandwidthSchedule> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BandwidthSchedule = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::BandwidthSchedule>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::BandwidthSchedule>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod device_capacity_check {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Posts the device capacity request info to check feasibility."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The subscription ID."]
        #[doc = "* `resource_group_name`: The resource group name."]
        #[doc = "* `device_name`: The device name."]
        #[doc = "* `device_capacity_request_info`: The device capacity request info."]
        pub fn check_resource_creation_feasibility(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            device_name: impl Into<String>,
            device_capacity_request_info: impl Into<models::DeviceCapacityRequestInfo>,
        ) -> check_resource_creation_feasibility::RequestBuilder {
            check_resource_creation_feasibility::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
                device_name: device_name.into(),
                device_capacity_request_info: device_capacity_request_info.into(),
                capacity_name: None,
            }
        }
    }
    pub mod check_resource_creation_feasibility {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) device_name: String,
            pub(crate) device_capacity_request_info: models::DeviceCapacityRequestInfo,
            pub(crate) capacity_name: Option<String>,
        }
        impl RequestBuilder {
            #[doc = "The capacity name."]
            pub fn capacity_name(mut self, capacity_name: impl Into<String>) -> Self {
                self.capacity_name = Some(capacity_name.into());
                self
            }
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.device_capacity_request_info)?;
                        if let Some(capacity_name) = &this.capacity_name {
                            req.url_mut().query_pairs_mut().append_pair("capacityName", capacity_name);
                        }
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{}/deviceCapacityCheck",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.resource_group_name,
                    &self.device_name
...
pub mod device_capacity_info {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets the properties of the specified device capacity info."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The subscription ID."]
        #[doc = "* `resource_group_name`: The resource group name."]
        #[doc = "* `device_name`: The device name."]
        pub fn get_device_capacity_info(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            device_name: impl Into<String>,
        ) -> get_device_capacity_info::RequestBuilder {
            get_device_capacity_info::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod get_device_capacity_info {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DeviceCapacityInfo> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DeviceCapacityInfo = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{}/deviceCapacityInfo/default" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . device_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-12-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DeviceCapacityInfo>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DeviceCapacityInfo>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod diagnostic_settings {
    ...
    impl Client {
        ...
        pub fn get_diagnostic_proactive_log_collection_settings(
            ...
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ) -> get_diagnostic_proactive_log_collection_settings::RequestBuilder {
            get_diagnostic_proactive_log_collection_settings::RequestBuilder {
                client: self.0.clone(),
                device_name: device_name.into(),
                subscription_id: subscription_id.into(),
        ...
        pub fn update_diagnostic_proactive_log_collection_settings(
            ...
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ) -> update_diagnostic_proactive_log_collection_settings::RequestBuilder {
            update_diagnostic_proactive_log_collection_settings::RequestBuilder {
                client: self.0.clone(),
                device_name: device_name.into(),
        ...
        pub fn get_diagnostic_remote_support_settings(
            ...
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ) -> get_diagnostic_remote_support_settings::RequestBuilder {
            get_diagnostic_remote_support_settings::RequestBuilder {
                client: self.0.clone(),
                device_name: device_name.into(),
                subscription_id: subscription_id.into(),
        ...
        pub fn update_diagnostic_remote_support_settings(
            ...
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ) -> update_diagnostic_remote_support_settings::RequestBuilder {
            update_diagnostic_remote_support_settings::RequestBuilder {
                client: self.0.clone(),
                device_name: device_name.into(),
    ...
    pub mod get_diagnostic_proactive_log_collection_settings {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DiagnosticProactiveLogCollectionSettings> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DiagnosticProactiveLogCollectionSettings = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{}/diagnosticProactiveLogCollectionSettings/default" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . device_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-12-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DiagnosticProactiveLogCollectionSettings>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DiagnosticProactiveLogCollectionSettings>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.proactive_log_collection_settings)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
    ...
    pub mod get_diagnostic_remote_support_settings {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DiagnosticRemoteSupportSettings> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DiagnosticRemoteSupportSettings = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{}/diagnosticRemoteSupportSettings/default" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . device_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-12-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DiagnosticRemoteSupportSettings>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DiagnosticRemoteSupportSettings>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.diagnostic_remote_support_settings)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
...
pub mod nodes {
    ...
    pub mod list_by_data_box_edge_device {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::NodeList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::NodeList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::NodeList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
...
pub mod marketplace_image_offer {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Returns list of all offers"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The subscription ID."]
        #[doc = "* `resource_group_name`: The resource group name."]
        ...
        #[doc = "Returns List of Offers by Publisher name"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The subscription ID."]
        #[doc = "* `resource_group_name`: The resource group name."]
        pub fn list_offersby_publisher(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            device_name: impl Into<String>,
            publisher_name: impl Into<String>,
        ) -> list_offersby_publisher::RequestBuilder {
            list_offersby_publisher::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod list_offers {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::MarketplaceImageOfferList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::MarketplaceImageOfferList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::MarketplaceImageOfferList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{}/offers",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.resource_group_name,
                    &self.device_name
    ...
    pub mod list_offersby_publisher {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{}/publishers/{}/offers",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.resource_group_name,
                    &self.device_name,
...
pub mod orders {
    ...
    pub mod list_by_data_box_edge_device {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::OrderList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::OrderList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::OrderList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::Order> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::Order = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::Order>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::Order>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_dc_access_code {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DcAccessCode> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DcAccessCode = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{}/orders/default/listDCAccessCode" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . device_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-12-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DcAccessCode>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DcAccessCode>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod marketplace_image_publisher {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Returns list of publishers"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The subscription ID."]
        #[doc = "* `resource_group_name`: The resource group name."]
        pub fn list_publishers(
            ...
            resource_group_name: impl Into<String>,
            device_name: impl Into<String>,
        ) -> list_publishers::RequestBuilder {
            list_publishers::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod list_publishers {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::MarketplaceImagePublisherList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::MarketplaceImagePublisherList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::MarketplaceImagePublisherList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{}/publishers",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.resource_group_name,
                    &self.device_name
...
pub mod marketplace_image_sku {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Returns List of SKUs Within Offer"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The subscription ID."]
        #[doc = "* `resource_group_name`: The resource group name."]
        pub fn list_sk_us_within_offer(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            device_name: impl Into<String>,
        ...
        ) -> list_sk_us_within_offer::RequestBuilder {
            list_sk_us_within_offer::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod list_sk_us_within_offer {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::MarketplaceImageSkuList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::MarketplaceImageSkuList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::MarketplaceImageSkuList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{}/publishers/{}/offers/{}/skus" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . device_name , & self . publisher_name , & self . offer_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-12-01-preview");
...
pub mod marketplace_image_version {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Returns List of Versions within SKU"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The subscription ID."]
        #[doc = "* `resource_group_name`: The resource group name."]
        pub fn list_versionswithin_sku(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            device_name: impl Into<String>,
        ...
        ) -> list_versionswithin_sku::RequestBuilder {
            list_versionswithin_sku::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        #[doc = "Get Particular Image"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The subscription ID."]
        #[doc = "* `resource_group_name`: The resource group name."]
        pub fn get_particular_image(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            device_name: impl Into<String>,
        ...
        ) -> get_particular_image::RequestBuilder {
            get_particular_image::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod list_versionswithin_sku {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::MarketplaceImageVersionList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::MarketplaceImageVersionList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::MarketplaceImageVersionList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{}/publishers/{}/offers/{}/skus/{}/versions" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . device_name , & self . publisher_name , & self . offer_name , & self . sku_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-12-01-preview");
    ...
    pub mod get_particular_image {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::MarketplaceImageVersion> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::MarketplaceImageVersion = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{}/publishers/{}/offers/{}/skus/{}/versions/{}" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . device_name , & self . publisher_name , & self . offer_name , & self . sku_name , & self . version_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-12-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::MarketplaceImageVersion>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::MarketplaceImageVersion>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod marketplace_image_sas_token {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Returns SASToken"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The subscription ID."]
        #[doc = "* `resource_group_name`: The resource group name."]
        pub fn get_sas_token(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            device_name: impl Into<String>,
    ...
    pub mod get_sas_token {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::MarketplaceSasToken> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::MarketplaceSasToken = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{}/publishers/{}/offers/{}/skus/{}/versions/{}/generatesastoken" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . device_name , & self . publisher_name , & self . offer_name , & self . sku_name , & self . version_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-12-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::MarketplaceSasToken>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::MarketplaceSasToken>>;
...
pub mod roles {
    ...
    pub mod list_by_data_box_edge_device {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::RoleList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::RoleList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::RoleList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
...
pub mod monitoring_config {
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::MonitoringMetricConfigurationList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::MonitoringMetricConfigurationList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::MonitoringMetricConfigurationList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::MonitoringMetricConfiguration> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::MonitoringMetricConfiguration = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{}/roles/{}/monitoringConfig/default" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . device_name , & self . role_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-12-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::MonitoringMetricConfiguration>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::MonitoringMetricConfiguration>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod shares {
    ...
    pub mod get {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::Share>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod storage_account_credentials {
    ...
    pub mod list_by_data_box_edge_device {
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::StorageAccountCredentialList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{}/storageAccountCredentials/{}" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . device_name , & self . name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-12-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::StorageAccountCredential>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::StorageAccountCredential>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod storage_accounts {
    ...
    pub mod list_by_data_box_edge_device {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::StorageAccountList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::StorageAccountList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::StorageAccountList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
...
pub mod containers {
    ...
    pub mod list_by_storage_account {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ContainerList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ContainerList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ContainerList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{}/storageAccounts/{}/containers" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . device_name , & self . storage_account_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-12-01-preview");
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::Container> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::Container = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{}/storageAccounts/{}/containers/{}" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . device_name , & self . storage_account_name , & self . container_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-12-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::Container>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::Container>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod refresh {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{}/storageAccounts/{}/containers/{}/refresh" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . device_name , & self . storage_account_name , & self . container_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-12-01-preview");
...
pub mod support_packages {
    ...
    impl Client {
        ...
        pub fn trigger_support_package(
            ...
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ) -> trigger_support_package::RequestBuilder {
            trigger_support_package::RequestBuilder {
                client: self.0.clone(),
                device_name: device_name.into(),
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.trigger_support_package_request)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
...
pub mod users {
    ...
    pub mod list_by_data_box_edge_device {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::UserList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::UserList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::UserList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
