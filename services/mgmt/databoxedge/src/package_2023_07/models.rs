...
pub struct DataBoxEdgeDeviceProperties {
    ...
    #[doc = "Kubernetes Workload Profile"]
    #[serde(rename = "kubernetesWorkloadProfile", default, skip_serializing_if = "Option::is_none")]
    pub kubernetes_workload_profile: Option<String>,
}
