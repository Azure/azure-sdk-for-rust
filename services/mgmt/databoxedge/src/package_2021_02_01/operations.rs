...
pub mod diagnostic_settings {
    ...
    > {
        ...
        match rsp.status() {
            http::StatusCode::OK => Ok(update_diagnostic_proactive_log_collection_settings::Response::Ok200),
    ...
    pub async fn update_diagnostic_remote_support_settings(
        ...
        match rsp.status() {
            ...
            http::StatusCode::OK => Ok(update_diagnostic_remote_support_settings::Response::Ok200),
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: CloudError = serde_json::from_slice(rsp_body)
