...
pub mod storage_accounts {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Lists all the storage accounts in a Data Box Edge/Data Box Gateway device."]
        pub fn list_by_data_box_edge_device(
            &self,
            device_name: impl Into<String>,
            subscription_id: impl Into<String>,
...
pub mod skus {
    ...
    pub mod list {
        ...
        impl Builder {
            ...
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::SkuInformationList, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
