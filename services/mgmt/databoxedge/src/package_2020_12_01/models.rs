...
pub struct AlertProperties {
    ...
    #[serde(rename = "appearedAtDateTime", with = "azure_core::date::rfc3339::option")]
...
#[doc = "CloudEdgeManagementRole role."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    ...
    impl Serialize for Name {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::EdgeMrMini => serializer.serialize_unit_variant("Name", 17u32, "EdgeMR_Mini"),
                Self::RcaSmall => serializer.serialize_unit_variant("Name", 18u32, "RCA_Small"),
                Self::RcaLarge => serializer.serialize_unit_variant("Name", 19u32, "RCA_Large"),
                Self::Rdc => serializer.serialize_unit_variant("Name", 20u32, "RDC"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct DeviceSecrets {
    ...
    #[serde(rename = "hcsDataVolumeBitLockerExternalKey", default, skip_serializing_if = "Option::is_none")]
    pub hcs_data_volume_bit_locker_external_key: Option<Secret>,
    #[doc = "Holds device secret either as a KeyVault reference or as an encrypted value."]
    #[serde(rename = "hcsInternalVolumeBitLockerExternalKey", default, skip_serializing_if = "Option::is_none")]
    pub hcs_internal_volume_bit_locker_external_key: Option<Secret>,
    #[doc = "Holds device secret either as a KeyVault reference or as an encrypted value."]
    #[serde(rename = "systemVolumeBitLockerRecoveryKey", default, skip_serializing_if = "Option::is_none")]
    pub system_volume_bit_locker_recovery_key: Option<Secret>,
    #[doc = "Holds device secret either as a KeyVault reference or as an encrypted value."]
    #[serde(rename = "sedEncryptionExternalKeyId", default, skip_serializing_if = "Option::is_none")]
    pub sed_encryption_external_key_id: Option<Secret>,
    #[doc = "Holds device secret either as a KeyVault reference or as an encrypted value."]
    #[serde(rename = "sedEncryptionExternalKey", default, skip_serializing_if = "Option::is_none")]
    pub sed_encryption_external_key: Option<Secret>,
    #[doc = "Holds device secret either as a KeyVault reference or as an encrypted value."]
    #[serde(rename = "bmcDefaultUserPassword", default, skip_serializing_if = "Option::is_none")]
    pub bmc_default_user_password: Option<Secret>,
    #[doc = "Holds device secret either as a KeyVault reference or as an encrypted value."]
    #[serde(rename = "rotateKeyForDataVolumeBitlocker", default, skip_serializing_if = "Option::is_none")]
    pub rotate_key_for_data_volume_bitlocker: Option<Secret>,
    #[doc = "Holds device secret either as a KeyVault reference or as an encrypted value."]
    #[serde(rename = "rotateKeysForSedDrivesSerialized", default, skip_serializing_if = "Option::is_none")]
...
pub struct OrderStatus {
    ...
    #[serde(rename = "updateDateTime", with = "azure_core::date::rfc3339::option")]
    ...
    impl Serialize for Status {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::AwaitingFulfilment => serializer.serialize_unit_variant("Status", 1u32, "AwaitingFulfilment"),
...
pub struct RefreshDetails {
    ...
    #[serde(rename = "lastCompletedRefreshJobTimeInUTC", with = "azure_core::date::rfc3339::option")]
...
pub struct ResourceMoveDetails {
    ...
    #[serde(rename = "operationInProgressLockTimeoutInUTC", with = "azure_core::date::rfc3339::option")]
...
pub struct UpdateSummaryProperties {
    ...
    #[serde(rename = "deviceLastScannedDateTime", with = "azure_core::date::rfc3339::option")]
    ...
    #[serde(rename = "lastCompletedScanJobDateTime", with = "azure_core::date::rfc3339::option")]
    ...
    #[serde(rename = "lastCompletedDownloadJobDateTime", with = "azure_core::date::rfc3339::option")]
    ...
    #[serde(rename = "lastCompletedInstallJobDateTime", with = "azure_core::date::rfc3339::option")]
    ...
    #[serde(rename = "inProgressDownloadJobStartedDateTime", with = "azure_core::date::rfc3339::option")]
    ...
    #[serde(rename = "inProgressInstallJobStartedDateTime", with = "azure_core::date::rfc3339::option")]
