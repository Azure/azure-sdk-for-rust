...
pub mod diagnostic_settings {
    use super::{models, API_VERSION};
    pub async fn get_diagnostic_proactive_log_collection_settings(
        operation_config: &crate::OperationConfig,
        device_name: &str,
        subscription_id: &str,
        resource_group_name: &str,
    ) -> std::result::Result<models::DiagnosticProactiveLogCollectionSettings, get_diagnostic_proactive_log_collection_settings::Error>
    {
        let http_client = operation_config.http_client();
        let url_str = & format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{}/diagnosticProactiveLogCollectionSettings/default" , operation_config . base_path () , subscription_id , resource_group_name , device_name) ;
        let mut url = url::Url::parse(url_str).map_err(get_diagnostic_proactive_log_collection_settings::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(get_diagnostic_proactive_log_collection_settings::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        ...
        let req = req_builder
            .body(req_body)
            .map_err(get_diagnostic_proactive_log_collection_settings::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(get_diagnostic_proactive_log_collection_settings::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::DiagnosticProactiveLogCollectionSettings = serde_json::from_slice(rsp_body).map_err(|source| {
                    get_diagnostic_proactive_log_collection_settings::Error::DeserializeError(source, rsp_body.clone())
                })?;
                Ok(rsp_value)
            }
            status_code => {
                ...
                Err(get_diagnostic_proactive_log_collection_settings::Error::DefaultResponse {
                    status_code,
                    value: rsp_value,
                })
            }
    ...
    pub async fn update_diagnostic_proactive_log_collection_settings(
        operation_config: &crate::OperationConfig,
        device_name: &str,
        proactive_log_collection_settings: &models::DiagnosticProactiveLogCollectionSettings,
        subscription_id: &str,
        resource_group_name: &str,
    ) -> std::result::Result<
        update_diagnostic_proactive_log_collection_settings::Response,
        update_diagnostic_proactive_log_collection_settings::Error,
    > {
        let http_client = operation_config.http_client();
        let url_str = & format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{}/diagnosticProactiveLogCollectionSettings/default" , operation_config . base_path () , subscription_id , resource_group_name , device_name) ;
        let mut url = url::Url::parse(url_str).map_err(update_diagnostic_proactive_log_collection_settings::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::PUT);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(update_diagnostic_proactive_log_collection_settings::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        req_builder = req_builder.header("content-type", "application/json");
        let req_body = azure_core::to_json(proactive_log_collection_settings)
            .map_err(update_diagnostic_proactive_log_collection_settings::Error::SerializeError)?;
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder
            .body(req_body)
            .map_err(update_diagnostic_proactive_log_collection_settings::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(update_diagnostic_proactive_log_collection_settings::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::DiagnosticProactiveLogCollectionSettings = serde_json::from_slice(rsp_body).map_err(|source| {
                    update_diagnostic_proactive_log_collection_settings::Error::DeserializeError(source, rsp_body.clone())
                })?;
                Ok(update_diagnostic_proactive_log_collection_settings::Response::Ok200(rsp_value))
            }
            http::StatusCode::ACCEPTED => Ok(update_diagnostic_proactive_log_collection_settings::Response::Accepted202),
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::CloudError = serde_json::from_slice(rsp_body).map_err(|source| {
                    update_diagnostic_proactive_log_collection_settings::Error::DeserializeError(source, rsp_body.clone())
                })?;
                Err(update_diagnostic_proactive_log_collection_settings::Error::DefaultResponse {
                    status_code,
                    value: rsp_value,
                })
            }
    ...
    pub async fn get_diagnostic_remote_support_settings(
        operation_config: &crate::OperationConfig,
        device_name: &str,
        subscription_id: &str,
        resource_group_name: &str,
    ) -> std::result::Result<models::DiagnosticRemoteSupportSettings, get_diagnostic_remote_support_settings::Error> {
        let http_client = operation_config.http_client();
        let url_str = & format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{}/diagnosticRemoteSupportSettings/default" , operation_config . base_path () , subscription_id , resource_group_name , device_name) ;
        let mut url = url::Url::parse(url_str).map_err(get_diagnostic_remote_support_settings::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(get_diagnostic_remote_support_settings::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        ...
        let req = req_builder
            .body(req_body)
            .map_err(get_diagnostic_remote_support_settings::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(get_diagnostic_remote_support_settings::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::DiagnosticRemoteSupportSettings = serde_json::from_slice(rsp_body)
                    .map_err(|source| get_diagnostic_remote_support_settings::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::CloudError = serde_json::from_slice(rsp_body)
                    .map_err(|source| get_diagnostic_remote_support_settings::Error::DeserializeError(source, rsp_body.clone()))?;
                Err(get_diagnostic_remote_support_settings::Error::DefaultResponse {
                    status_code,
                    value: rsp_value,
                })
            }
    ...
    pub async fn update_diagnostic_remote_support_settings(
        operation_config: &crate::OperationConfig,
        device_name: &str,
        diagnostic_remote_support_settings: &models::DiagnosticRemoteSupportSettings,
        subscription_id: &str,
        resource_group_name: &str,
    ) -> std::result::Result<update_diagnostic_remote_support_settings::Response, update_diagnostic_remote_support_settings::Error> {
        let http_client = operation_config.http_client();
        let url_str = & format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{}/diagnosticRemoteSupportSettings/default" , operation_config . base_path () , subscription_id , resource_group_name , device_name) ;
        let mut url = url::Url::parse(url_str).map_err(update_diagnostic_remote_support_settings::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::PUT);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(update_diagnostic_remote_support_settings::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        req_builder = req_builder.header("content-type", "application/json");
        let req_body = azure_core::to_json(diagnostic_remote_support_settings)
            .map_err(update_diagnostic_remote_support_settings::Error::SerializeError)?;
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder
            .body(req_body)
            .map_err(update_diagnostic_remote_support_settings::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(update_diagnostic_remote_support_settings::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::ACCEPTED => Ok(update_diagnostic_remote_support_settings::Response::Accepted202),
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::DiagnosticRemoteSupportSettings = serde_json::from_slice(rsp_body)
                    .map_err(|source| update_diagnostic_remote_support_settings::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(update_diagnostic_remote_support_settings::Response::Ok200(rsp_value))
            }
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::CloudError = serde_json::from_slice(rsp_body)
                    .map_err(|source| update_diagnostic_remote_support_settings::Error::DeserializeError(source, rsp_body.clone()))?;
                Err(update_diagnostic_remote_support_settings::Error::DefaultResponse {
                    status_code,
                    value: rsp_value,
                })
            }
...
pub mod support_packages {
    use super::{models, API_VERSION};
    pub async fn trigger_support_package(
        operation_config: &crate::OperationConfig,
        device_name: &str,
        trigger_support_package_request: &models::TriggerSupportPackageRequest,
        subscription_id: &str,
        resource_group_name: &str,
    ) -> std::result::Result<trigger_support_package::Response, trigger_support_package::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        let mut url = url::Url::parse(url_str).map_err(trigger_support_package::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::POST);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(trigger_support_package::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        req_builder = req_builder.header("content-type", "application/json");
        let req_body = azure_core::to_json(trigger_support_package_request).map_err(trigger_support_package::Error::SerializeError)?;
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder
            .body(req_body)
            .map_err(trigger_support_package::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(trigger_support_package::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => Ok(trigger_support_package::Response::Ok200),
            http::StatusCode::ACCEPTED => Ok(trigger_support_package::Response::Accepted202),
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::CloudError = serde_json::from_slice(rsp_body)
                    .map_err(|source| trigger_support_package::Error::DeserializeError(source, rsp_body.clone()))?;
                Err(trigger_support_package::Error::DefaultResponse {
                    status_code,
                    value: rsp_value,
                })
            }
