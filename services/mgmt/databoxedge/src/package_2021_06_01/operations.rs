...
pub mod diagnostic_settings {
    ...
    pub async fn get_diagnostic_proactive_log_collection_settings(
        ...
        subscription_id: &str,
        resource_group_name: &str,
    ) -> std::result::Result<DiagnosticProactiveLogCollectionSettings, get_diagnostic_proactive_log_collection_settings::Error> {
        let http_client = operation_config.http_client();
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: DiagnosticProactiveLogCollectionSettings = serde_json::from_slice(rsp_body).map_err(|source| {
    ...
    pub mod update_diagnostic_proactive_log_collection_settings {
        ...
        #[derive(Debug)]
        pub enum Response {
            Ok200(DiagnosticProactiveLogCollectionSettings),
            Accepted202,
        }
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
    ...
    pub async fn get_diagnostic_remote_support_settings(
        ...
        subscription_id: &str,
        resource_group_name: &str,
    ) -> std::result::Result<DiagnosticRemoteSupportSettings, get_diagnostic_remote_support_settings::Error> {
        let http_client = operation_config.http_client();
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: DiagnosticRemoteSupportSettings = serde_json::from_slice(rsp_body)
    ...
    pub mod update_diagnostic_remote_support_settings {
        ...
        pub enum Response {
            Accepted202,
            Ok200(DiagnosticRemoteSupportSettings),
        }
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
