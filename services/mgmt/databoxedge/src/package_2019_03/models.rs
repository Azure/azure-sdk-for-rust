...
pub struct JobProperties {
    ...
    #[doc = "ARM ID of the share that was refreshed."]
    #[serde(rename = "shareId", default, skip_serializing_if = "Option::is_none")]
    pub share_id: Option<String>,
    #[doc = "If only subfolders need to be refreshed, then the subfolder path inside the share. (The path is empty if there are no subfolders.)"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct PeriodicTimerSourceInfo {
    #[doc = "The time of the day that results in a valid trigger. Schedule is computed with reference to the time specified up to seconds. If timezone is not specified the time will considered to be in device timezone. The value will always be returned as UTC time."]
...
#[doc = "Fields for tracking refresh job on the share."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RefreshDetails {
    #[doc = "If a refresh share job is currently in progress on this share, this field indicates the ARM resource ID of that job. The field is empty if no job is in progress."]
    ...
    #[doc = "Indicates the completed time for the last refresh job on this particular share, if any.This could be a failed job or a successful job."]
    ...
    #[doc = "Indicates the relative path of the error xml for the last refresh job on this particular share, if any. This could be a failed job or a successful job."]
    #[serde(rename = "errorManifestFile", default, skip_serializing_if = "Option::is_none")]
    pub error_manifest_file: Option<String>,
    #[doc = "Indicates the id of the last refresh job on this particular share,if any. This could be a failed job or a successful job."]
