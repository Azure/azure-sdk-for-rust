...
pub mod data_box_edge_device_extended_info_properties {
    ...
    #[doc = "Cluster Witness Type"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ClusterWitnessType")]
    ...
    impl FromStr for ClusterWitnessType {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for ClusterWitnessType {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for ClusterWitnessType {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::None => serializer.serialize_unit_variant("ClusterWitnessType", 0u32, "None"),
                Self::Cloud => serializer.serialize_unit_variant("ClusterWitnessType", 1u32, "Cloud"),
                Self::FileShare => serializer.serialize_unit_variant("ClusterWitnessType", 2u32, "FileShare"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct Order {
    ...
    #[serde(rename = "systemData", default, skip_serializing_if = "Option::is_none")]
    pub system_data: Option<SystemData>,
    #[doc = "It specify the order api version."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kind: Option<String>,
...
pub struct RemoteSupportSettings {
    ...
    #[serde(rename = "expirationTimeStampInUTC", with = "azure_core::date::rfc3339::option")]
...
pub struct SupportPackageRequestProperties {
    ...
    #[serde(rename = "minimumTimeStamp", with = "azure_core::date::rfc3339::option")]
    pub minimum_time_stamp: Option<time::OffsetDateTime>,
    #[doc = "MaximumTimeStamp until where logs need to be collected"]
    #[serde(rename = "maximumTimeStamp", with = "azure_core::date::rfc3339::option")]
...
pub struct UpdateSummaryProperties {
    ...
    #[serde(rename = "lastSuccessfulScanJobTime", with = "azure_core::date::rfc3339::option")]
    ...
    #[serde(rename = "lastSuccessfulInstallJobDateTime", with = "azure_core::date::rfc3339::option")]
