...
pub struct ArcAddonProperties {
    ...
    #[doc = "Arc Custom Locations ObjectId"]
    #[serde(rename = "customLocationsObjectId", default, skip_serializing_if = "Option::is_none")]
    pub custom_locations_object_id: Option<String>,
...
impl ArcAddonProperties {
    pub fn new(subscription_id: String, resource_group_name: String, resource_name: String, resource_location: String) -> Self {
        Self {
            ...
            custom_locations_object_id: None,
...
pub mod cni_config {
    ...
    impl Serialize for ComponentType {
        ...
        {
            match self {
                Self::Invalid => serializer.serialize_unit_variant("ComponentType", 0u32, "Invalid"),
                Self::Cluster => serializer.serialize_unit_variant("ComponentType", 1u32, "Cluster"),
                Self::Node => serializer.serialize_unit_variant("ComponentType", 2u32, "Node"),
                Self::Etcd => serializer.serialize_unit_variant("ComponentType", 3u32, "Etcd"),
                Self::Cni => serializer.serialize_unit_variant("ComponentType", 4u32, "CNI"),
                Self::LoadBalancer => serializer.serialize_unit_variant("ComponentType", 5u32, "LoadBalancer"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for Name {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Ep264Mx1W => serializer.serialize_unit_variant("Name", 25u32, "EP2_64_Mx1_W"),
                Self::Ep2128Gpu1Mx1W => serializer.serialize_unit_variant("Name", 26u32, "EP2_128_GPU1_Mx1_W"),
                Self::Ep2256Gpu2Mx1 => serializer.serialize_unit_variant("Name", 27u32, "EP2_256_GPU2_Mx1"),
                Self::EdgeMrTcp => serializer.serialize_unit_variant("Name", 28u32, "EdgeMR_TCP"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct DeviceCapacityRequestInfoProperties {
    ...
    #[serde(
        rename = "vmPlacementResults",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub vm_placement_results: Vec<VmPlacementRequestResult>,
    #[doc = "Flag to check the type of capacity check on the appliance."]
    #[serde(rename = "deviceCapacityRequestType", default, skip_serializing_if = "Option::is_none")]
    pub device_capacity_request_type: Option<String>,
}
impl DeviceCapacityRequestInfoProperties {
    pub fn new(vm_placement_query: Vec<Vec<String>>) -> Self {
        Self {
            ...
            device_capacity_request_type: None,
        }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MarketplaceImageOffer {
    #[serde(flatten)]
    pub arm_base_model: ArmBaseModel,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<MarketplaceImageOfferProperties>,
}
impl MarketplaceImageOffer {
    pub fn new() -> Self {
        Self::default()
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MarketplaceImageOfferList {
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<MarketplaceImageOffer>,
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MarketplaceImageOfferProperties {
...
impl MarketplaceImageOfferProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MarketplaceImagePublisher {
    #[serde(flatten)]
    pub arm_base_model: ArmBaseModel,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<MarketplaceImagePublisherProperties>,
}
impl MarketplaceImagePublisher {
    pub fn new() -> Self {
        Self::default()
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MarketplaceImagePublisherList {
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<MarketplaceImagePublisher>,
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MarketplaceImagePublisherProperties {
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<String>,
}
impl MarketplaceImagePublisherProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MarketplaceImageSku {
    #[serde(flatten)]
    pub arm_base_model: ArmBaseModel,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<MarketplaceImageSkuProperties>,
}
impl MarketplaceImageSku {
    pub fn new() -> Self {
        Self::default()
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MarketplaceImageSkuList {
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<MarketplaceImageSku>,
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MarketplaceImageSkuProperties {
    #[serde(rename = "publisherId", default, skip_serializing_if = "Option::is_none")]
    pub publisher_id: Option<String>,
...
impl MarketplaceImageSkuProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MarketplaceImageVersion {
    #[serde(flatten)]
    pub arm_base_model: ArmBaseModel,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<MarketplaceImageVersionProperties>,
}
impl MarketplaceImageVersion {
    pub fn new() -> Self {
        Self::default()
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MarketplaceImageVersionList {
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<MarketplaceImageVersion>,
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MarketplaceImageVersionProperties {
    #[serde(rename = "publisherId", default, skip_serializing_if = "Option::is_none")]
    pub publisher_id: Option<String>,
    #[serde(rename = "offerId", default, skip_serializing_if = "Option::is_none")]
    pub offer_id: Option<String>,
...
impl MarketplaceImageVersionProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MarketplaceSasToken {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[serde(rename = "sasUri", default, skip_serializing_if = "Option::is_none")]
    pub sas_uri: Option<String>,
}
impl MarketplaceSasToken {
    pub fn new() -> Self {
        Self::default()
    }
}
    ...
    impl Serialize for Type {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::ManagementCluster => serializer.serialize_unit_variant("Type", 3u32, "ManagementCluster"),
                Self::ControlPlane => serializer.serialize_unit_variant("Type", 4u32, "ControlPlane"),
                Self::NodePool => serializer.serialize_unit_variant("Type", 5u32, "NodePool"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct SkuMapping {
    #[serde(rename = "catalogPlanId", default, skip_serializing_if = "Option::is_none")]
    pub catalog_plan_id: Option<String>,
    #[serde(rename = "marketplaceSkuId", default, skip_serializing_if = "Option::is_none")]
    pub marketplace_sku_id: Option<String>,
    #[serde(
    ...
    pub marketplace_sku_versions: Vec<String>,
}
impl SkuMapping {
    pub fn new() -> Self {
        Self::default()
