...
The default tag is `package-2023-12-01`.

The following [tags](https://github.com/Azure/azure-sdk-for-rust/blob/legacy/services/tags.md) are available:

- `package-2023-12-01` has 77 operations from 1 API versions: `2023-12-01`. Use crate feature `package-2023-12-01` to enable. The operations will be in the `package_2023_12_01` module.
