...
pub struct AksAssessment {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "ARM model of AKS Assessment Properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<AksAssessmentProperties>,
...
#[doc = "Data model of AKS Assessment Details."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AksAssessmentDetails {
    #[serde(flatten)]
    pub assessment_details: AssessmentDetails,
    #[doc = "Gets the number of web apps."]
    #[serde(rename = "webAppCount")]
    pub web_app_count: i32,
    #[doc = "Gets the number of web servers."]
    #[serde(rename = "webServerCount")]
    pub web_server_count: i32,
    #[doc = "Gets the number of machines."]
    #[serde(rename = "machineCount")]
    pub machine_count: i32,
    #[doc = "Gets the total monthly cost."]
    #[serde(rename = "totalMonthlyCost")]
    pub total_monthly_cost: f32,
}
impl AksAssessmentDetails {
    pub fn new(
        assessment_details: AssessmentDetails,
        web_app_count: i32,
        web_server_count: i32,
        machine_count: i32,
        total_monthly_cost: f32,
    ) -> Self {
        Self {
            assessment_details,
            web_app_count,
...
#[doc = "The response of a AKSAssessment list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AksAssessmentListResult {
    #[doc = "The AKSAssessment items on this page"]
    pub value: Vec<AksAssessment>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for AksAssessmentListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl AksAssessmentListResult {
    pub fn new(value: Vec<AksAssessment>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "ARM model of AKS Assessment Options."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AksAssessmentOptions {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "ARM model of AKS Assessment Options Properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<AksAssessmentOptionsProperties>,
    #[doc = "If eTag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields."]
    #[serde(rename = "eTag", default, skip_serializing_if = "Option::is_none")]
    pub e_tag: Option<String>,
}
impl AksAssessmentOptions {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The response of a AKSAssessmentOptions list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AksAssessmentOptionsListResult {
    #[doc = "The AKSAssessmentOptions items on this page"]
    pub value: Vec<AksAssessmentOptions>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for AksAssessmentOptionsListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl AksAssessmentOptionsListResult {
    pub fn new(value: Vec<AksAssessmentOptions>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "ARM model of AKS Assessment Options Properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AksAssessmentOptionsProperties {
    #[serde(flatten)]
    pub options_arm_properties_base: OptionsArmPropertiesBase,
}
impl AksAssessmentOptionsProperties {
    pub fn new(options_arm_properties_base: OptionsArmPropertiesBase) -> Self {
        Self {
            options_arm_properties_base,
        }
    }
}
#[doc = "ARM model of AKS Assessment Properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AksAssessmentProperties {
    #[serde(flatten)]
    pub assessment_properties_base: AssessmentPropertiesBase,
    #[doc = "Data model of AKS Assessment Settings."]
    pub settings: AksAssessmentSettings,
    #[doc = "Data model of AKS Assessment Details."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub details: Option<AksAssessmentDetails>,
}
impl AksAssessmentProperties {
    pub fn new(settings: AksAssessmentSettings) -> Self {
        Self {
            assessment_properties_base: AssessmentPropertiesBase::default(),
            settings,
            details: None,
        }
    }
...
#[doc = "Data model of AKS Assessment Settings."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AksAssessmentSettings {
    #[serde(flatten)]
    pub assessment_settings: AssessmentSettings,
    #[doc = "Azure VM Category."]
    pub category: AzureVmCategory,
    #[doc = "Savings Options for Azure."]
    #[serde(rename = "savingsOptions")]
    pub savings_options: SavingsOptions,
...
#[doc = "Data model of AKS Assessment Summary."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AksAssessmentSummary {
    #[doc = "Gets SKU summary."]
    #[serde(rename = "skuSummary")]
    pub sku_summary: serde_json::Value,
    #[doc = "Gets web app summary."]
    #[serde(rename = "webAppSummary")]
    pub web_app_summary: serde_json::Value,
    #[doc = "Gets web server summary."]
    #[serde(rename = "webServerSummary")]
    pub web_server_summary: serde_json::Value,
    #[doc = "Gets the number of web apps."]
    #[serde(rename = "webAppCount")]
    pub web_app_count: i32,
    #[doc = "Gets the number of web servers."]
...
impl AksAssessmentSummary {
    pub fn new(
        sku_summary: serde_json::Value,
        web_app_summary: serde_json::Value,
        web_server_summary: serde_json::Value,
        web_app_count: i32,
        web_server_count: i32,
        machine_count: i32,
        total_monthly_cost: f32,
...
pub struct AksCluster {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<AksClusterProperties>,
    #[doc = "If eTag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields."]
    #[serde(rename = "eTag", default, skip_serializing_if = "Option::is_none")]
    pub e_tag: Option<String>,
}
...
#[doc = "The response of a AKSCluster list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AksClusterListResult {
    #[doc = "The AKSCluster items on this page"]
    pub value: Vec<AksCluster>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for AksClusterListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl AksClusterListResult {
    pub fn new(value: Vec<AksCluster>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "ARM model of AKS Cluster Properties."]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AksCostDetail {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "ARM model of AKS Cost Detail Properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<AksCostDetailProperties>,
    #[doc = "If eTag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields."]
    #[serde(rename = "eTag", default, skip_serializing_if = "Option::is_none")]
    pub e_tag: Option<String>,
}
...
#[doc = "The response of a AKSCostDetail list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AksCostDetailListResult {
    #[doc = "The AKSCostDetail items on this page"]
    pub value: Vec<AksCostDetail>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for AksCostDetailListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl AksCostDetailListResult {
    pub fn new(value: Vec<AksCostDetail>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "ARM model of AKS Cost Detail Properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AksCostDetailProperties {
    #[serde(flatten)]
    pub node_pool: NodePool,
}
impl AksCostDetailProperties {
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AksSummary {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "ARM model of AKS Summary Properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<AksSummaryProperties>,
    #[doc = "If eTag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields."]
    #[serde(rename = "eTag", default, skip_serializing_if = "Option::is_none")]
    pub e_tag: Option<String>,
}
...
#[doc = "The response of a AKSSummary list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AksSummaryListResult {
    #[doc = "The AKSSummary items on this page"]
    pub value: Vec<AksSummary>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for AksSummaryListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl AksSummaryListResult {
    pub fn new(value: Vec<AksSummary>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "ARM model of AKS Summary Properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AksSummaryProperties {
    #[serde(flatten)]
    pub summary_properties_base: SummaryPropertiesBase,
    #[doc = "Data model of AKS Assessment Summary."]
    #[serde(rename = "aksAssessmentSummary")]
    pub aks_assessment_summary: AksAssessmentSummary,
}
impl AksSummaryProperties {
    pub fn new(summary_properties_base: SummaryPropertiesBase, aks_assessment_summary: AksAssessmentSummary) -> Self {
        Self {
            summary_properties_base,
            aks_assessment_summary,
        }
    }
}
...
pub enum ApiVersions {
    ...
    N2022_02_02_preview,
    #[serde(rename = "2022-08-01-preview")]
    N2022_08_01_preview,
...
impl Serialize for ApiVersions {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::N2022_08_01_preview => serializer.serialize_unit_variant("ApiVersions", 4u32, "2022-08-01-preview"),
            Self::N2023_03_03 => serializer.serialize_unit_variant("ApiVersions", 5u32, "2023-03-03"),
            Self::N2023_03_15 => serializer.serialize_unit_variant("ApiVersions", 6u32, "2023-03-15"),
            Self::N2023_04_01_preview => serializer.serialize_unit_variant("ApiVersions", 7u32, "2023-04-01-preview"),
            Self::N2023_07_07_preview => serializer.serialize_unit_variant("ApiVersions", 8u32, "2023-07-07-preview"),
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AppSvcContainerSettings {
    #[doc = "Gets or sets the isolation required."]
    #[serde(rename = "isolationRequired")]
    pub isolation_required: bool,
}
impl AppSvcContainerSettings {
    pub fn new(isolation_required: bool) -> Self {
        Self { isolation_required }
    }
}
#[doc = "App service native settings."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AppSvcNativeSettings {
    #[doc = "Gets or sets the isolation required."]
    #[serde(rename = "isolationRequired")]
    pub isolation_required: bool,
}
impl AppSvcNativeSettings {
    pub fn new(isolation_required: bool) -> Self {
        Self { isolation_required }
    }
}
...
#[doc = "Data model of Assessed Web App."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AssessedWebApp {
    #[serde(flatten)]
    pub web_app: WebApp,
    #[doc = "Data model of Suitability Result."]
    #[serde(rename = "suitabilityResult", default, skip_serializing_if = "Option::is_none")]
    pub suitability_result: Option<SuitabilityResult>,
    #[doc = "Data model of Recommendation Result."]
    #[serde(rename = "recommendationResult", default, skip_serializing_if = "Option::is_none")]
    pub recommendation_result: Option<RecommendationResult>,
}
impl AssessedWebApp {
    pub fn new(web_app: WebApp) -> Self {
        Self {
            web_app,
...
#[doc = "Assessed Web app web model class."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AssessedWebAppV2 {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Assessed Web app database properties web model."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<AssessedWebAppV2Properties>,
}
impl AssessedWebAppV2 {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The response of a AssessedWebAppV2 list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AssessedWebAppV2ListResult {
    #[doc = "The AssessedWebAppV2 items on this page"]
    pub value: Vec<AssessedWebAppV2>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for AssessedWebAppV2ListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl AssessedWebAppV2ListResult {
    pub fn new(value: Vec<AssessedWebAppV2>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Assessed Web app database properties web model."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AssessedWebAppV2Properties {
    #[doc = "Web App Type."]
    #[serde(rename = "webAppType", default, skip_serializing_if = "Option::is_none")]
    pub web_app_type: Option<WebAppType>,
    #[doc = "Gets or sets the target specific result."]
    #[serde(rename = "targetSpecificResult", default, skip_serializing_if = "Option::is_none")]
    pub target_specific_result: Option<serde_json::Value>,
    #[doc = "Gets or sets the app service plan name."]
    #[serde(rename = "appServicePlanName")]
    pub app_service_plan_name: String,
    #[doc = "Gets the machine name."]
    #[serde(rename = "machineName")]
    pub machine_name: String,
    #[doc = "Gets or sets the server ARM Id."]
    #[serde(rename = "serverArmId", default, skip_serializing_if = "Option::is_none")]
    ...
    #[doc = "Gets or sets web app name."]
    #[serde(rename = "webAppName", default, skip_serializing_if = "Option::is_none")]
    pub web_app_name: Option<String>,
    #[doc = "Gets the discovered web app ID."]
    #[serde(rename = "discoveredWebAppId", default, skip_serializing_if = "Option::is_none")]
    pub discovered_web_app_id: Option<String>,
    #[doc = "Machine arm id."]
    #[serde(rename = "discoveredMachineId", default, skip_serializing_if = "Option::is_none")]
    pub discovered_machine_id: Option<String>,
    #[doc = "Confidence Rating in Percentage."]
    #[serde(rename = "confidenceRatingInPercentage", default, skip_serializing_if = "Option::is_none")]
    pub confidence_rating_in_percentage: Option<f32>,
    #[doc = "When was assessed SQL database first created."]
    #[serde(rename = "createdTimestamp", default, with = "azure_core::date::rfc3339::option")]
    pub created_timestamp: Option<::time::OffsetDateTime>,
    #[doc = "When was assessed Web app database last updated."]
    #[serde(rename = "updatedTimestamp", default, with = "azure_core::date::rfc3339::option")]
    pub updated_timestamp: Option<::time::OffsetDateTime>,
}
impl AssessedWebAppV2Properties {
    pub fn new(app_service_plan_name: String, machine_name: String) -> Self {
        Self {
            web_app_type: None,
            target_specific_result: None,
            app_service_plan_name,
            machine_name,
            server_arm_id: None,
            web_server_name: None,
            web_app_name: None,
            discovered_web_app_id: None,
            discovered_machine_id: None,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AssessedWebApplication {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "ARM model of Assessed Web Application Properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<AssessedWebApplicationProperties>,
    #[doc = "If eTag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields."]
    #[serde(rename = "eTag", default, skip_serializing_if = "Option::is_none")]
    pub e_tag: Option<String>,
}
impl AssessedWebApplication {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The response of a AssessedWebApplication list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AssessedWebApplicationListResult {
    #[doc = "The AssessedWebApplication items on this page"]
    pub value: Vec<AssessedWebApplication>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for AssessedWebApplicationListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl AssessedWebApplicationListResult {
    pub fn new(value: Vec<AssessedWebApplication>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "ARM model of Assessed Web Application Properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AssessedWebApplicationProperties {
    #[serde(flatten)]
    pub assessed_web_app: AssessedWebApp,
}
impl AssessedWebApplicationProperties {
    pub fn new(assessed_web_app: AssessedWebApp) -> Self {
        Self { assessed_web_app }
    }
}
...
#[doc = "Data model of Details of Assessment Computation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AssessmentDetails {
    #[doc = "Gets last time when rates were queried."]
    #[serde(rename = "pricesTimestamp", default, with = "azure_core::date::rfc3339::option")]
    pub prices_timestamp: Option<::time::OffsetDateTime>,
    #[doc = "Gets Confidence score."]
    #[serde(rename = "confidenceRatingInPercentage", default, skip_serializing_if = "Option::is_none")]
    pub confidence_rating_in_percentage: Option<f32>,
    #[doc = "Gets date and time when assessment was created."]
    #[serde(rename = "createdTimestamp", with = "azure_core::date::rfc3339")]
    pub created_timestamp: ::time::OffsetDateTime,
    #[doc = "Gets date and time when assessment was last updated."]
    #[serde(rename = "updatedTimestamp", with = "azure_core::date::rfc3339")]
    pub updated_timestamp: ::time::OffsetDateTime,
    #[doc = "Assessment Status."]
    pub status: AssessmentStatus,
}
impl AssessmentDetails {
    pub fn new(created_timestamp: ::time::OffsetDateTime, updated_timestamp: ::time::OffsetDateTime, status: AssessmentStatus) -> Self {
        Self {
...
#[doc = "Base ARM model of Assessment ARM properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AssessmentPropertiesBase {
    #[serde(flatten)]
    pub mutable_arm_resource: MutableArmResource,
    #[doc = "Data model of Assessment Scope Parameters."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub scope: Option<AssessmentScopeParameters>,
}
impl AssessmentPropertiesBase {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct AssessmentResult {
    ...
    pub app_service_plan_name: String,
    #[doc = "Cloud Suitability for Azure."]
    pub suitability: CloudSuitability,
    #[doc = "Cloud Suitability for Azure."]
    #[serde(rename = "securitySuitability")]
    pub security_suitability: CloudSuitability,
    #[doc = "Gets or sets the web app sku name."]
    #[serde(rename = "webAppSkuName")]
    pub web_app_sku_name: String,
    #[doc = "Gets or sets the web app sku size."]
    #[serde(rename = "webAppSkuSize")]
    pub web_app_sku_size: String,
}
impl AssessmentResult {
    pub fn new(
        app_service_plan_name: String,
        suitability: CloudSuitability,
        security_suitability: CloudSuitability,
        web_app_sku_name: String,
        web_app_sku_size: String,
    ) -> Self {
        Self {
            app_service_plan_name,
            suitability,
            security_suitability,
            web_app_sku_name,
            web_app_sku_size,
        }
    }
...
#[doc = "Data model of Assessment Scope Parameters."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AssessmentScopeParameters {
    #[doc = "Gets or sets the server group id."]
    #[serde(rename = "serverGroupId", default, skip_serializing_if = "Option::is_none")]
    pub server_group_id: Option<String>,
}
impl AssessmentScopeParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Base data model of Assessment Settings."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AssessmentSettings {
    #[doc = "Gets or sets azure location."]
    #[serde(rename = "azureLocation")]
    pub azure_location: String,
    #[doc = "Environment Type for Azure."]
    #[serde(rename = "environmentType")]
    pub environment_type: AzureEnvironmentType,
    #[doc = "Licensing Program for Azure."]
    #[serde(rename = "licensingProgram")]
    pub licensing_program: LicensingProgram,
    #[doc = "Currency for Azure."]
    pub currency: AzureCurrency,
    #[doc = "Gets or sets discount percentage."]
    #[serde(rename = "discountPercentage", default, skip_serializing_if = "Option::is_none")]
    pub discount_percentage: Option<f32>,
    #[doc = "Assessment Sizing Criteria."]
    #[serde(rename = "sizingCriteria")]
    pub sizing_criteria: AssessmentSizingCriterion,
    #[doc = "Data model of Performance Data Settings."]
    #[serde(rename = "performanceData", default, skip_serializing_if = "Option::is_none")]
    pub performance_data: Option<PerfDataSettings>,
    #[doc = "Gets or sets scaling factor."]
...
impl AssessmentSettings {
    pub fn new(
        ...
        environment_type: AzureEnvironmentType,
        licensing_program: LicensingProgram,
        currency: AzureCurrency,
        sizing_criteria: AssessmentSizingCriterion,
    ) -> Self {
        Self {
            azure_location,
            environment_type,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AvsNodeSummary {
    #[doc = "Servers suitable for migration."]
    #[serde(rename = "serversSuitableForMigration", default, skip_serializing_if = "Option::is_none")]
    pub servers_suitable_for_migration: Option<i32>,
    #[doc = "The total number of servers."]
    #[serde(rename = "totalNumberOfServers", default, skip_serializing_if = "Option::is_none")]
    pub total_number_of_servers: Option<i32>,
    ...
    #[serde(rename = "avsNodeCostDetails", default, skip_serializing_if = "Option::is_none")]
    pub avs_node_cost_details: Option<CostDetails>,
    #[doc = "Estimated cost."]
    #[serde(rename = "estimatedCost", default, skip_serializing_if = "Option::is_none")]
    pub estimated_cost: Option<f32>,
    #[doc = "OS licensing cost."]
    #[serde(rename = "osLicensingCost", default, skip_serializing_if = "Option::is_none")]
    pub os_licensing_cost: Option<f32>,
    #[doc = "Estimated cost by offer."]
    #[serde(
        rename = "estimatedCostByRecommendedOffer",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub estimated_cost_by_recommended_offer: Vec<EstimatedCostByOffer>,
    #[doc = "The recommended VM family summary."]
    #[serde(
        rename = "recommendedAvsNodeTypeSummary",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub recommended_avs_node_type_summary: Vec<RecommendedAvsNodeTypeSummary>,
}
impl AvsNodeSummary {
    pub fn new() -> Self {
        Self::default()
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AvsSummary {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Avs summary properties class."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<AvsSummaryProperties>,
}
impl AvsSummary {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "The response of a AvsSummary list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AvsSummaryListResult {
    #[doc = "The AvsSummary items on this page"]
    pub value: Vec<AvsSummary>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for AvsSummaryListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl AvsSummaryListResult {
    pub fn new(value: Vec<AvsSummary>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Avs summary properties class."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AvsSummaryProperties {
    #[doc = "The Azure AVS summary."]
    #[serde(rename = "azureAvsSummary", default, skip_serializing_if = "Option::is_none")]
    pub azure_avs_summary: Option<AzureAvsSummary>,
    #[doc = "The on premises IAAS summary."]
    #[serde(rename = "onPremisesAvsSummary", default, skip_serializing_if = "Option::is_none")]
    pub on_premises_avs_summary: Option<OnPremisesIaasSummary>,
}
impl AvsSummaryProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AzureAppServiceContainerSummary {
    #[doc = "Estimated cost by recommendation offer."]
    #[serde(
        rename = "estimatedCostByOffer",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub estimated_cost_by_offer: Vec<EstimatedCostByOffer>,
    #[doc = "Distribution by SKU."]
    #[serde(
        rename = "distributionBySku",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub distribution_by_sku: Vec<WebAppTargetSku>,
    #[doc = "Distribution by application type."]
    #[serde(
        rename = "distributionByApp",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub distribution_by_app: Vec<WebAppDistribution>,
}
impl AzureAppServiceContainerSummary {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AzureAppServiceSummary {
    #[doc = "Estimated cost by recommendation offer."]
    #[serde(
        rename = "estimatedCostByOffer",
        default,
    ...
    pub distribution_by_sku: Vec<AppServiceSku>,
    #[doc = "Distribution by application type."]
    #[serde(
        rename = "distributionByApp",
        default,
...
#[doc = "The Azure AVS summary."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AzureAvsSummary {
    #[doc = "Shows the year-on-year cost overall."]
    #[serde(rename = "yearOnYearEstimates", default, skip_serializing_if = "Option::is_none")]
    pub year_on_year_estimates: Option<YearOnYearEstimates>,
    #[doc = "Azure Avs Node summary."]
    #[serde(rename = "avsNodeSummary", default, skip_serializing_if = "Option::is_none")]
    pub avs_node_summary: Option<AvsNodeSummary>,
    #[doc = "The on premises PaaS cost."]
    #[serde(rename = "avsCostDetails", default, skip_serializing_if = "Option::is_none")]
    pub avs_cost_details: Option<CostDetails>,
}
impl AzureAvsSummary {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Environment Type for Azure."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "AzureEnvironmentType")]
pub enum AzureEnvironmentType {
    Unknown,
    DevTest,
    Production,
    #[serde(skip_deserializing)]
...
impl FromStr for AzureEnvironmentType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for AzureEnvironmentType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for AzureEnvironmentType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("AzureEnvironmentType", 0u32, "Unknown"),
            Self::DevTest => serializer.serialize_unit_variant("AzureEnvironmentType", 1u32, "DevTest"),
            Self::Production => serializer.serialize_unit_variant("AzureEnvironmentType", 2u32, "Production"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AzureIaasSqlSummary {
    #[doc = "Total SQL entities."]
    #[serde(rename = "totalSqlEntities", default, skip_serializing_if = "Option::is_none")]
    pub total_sql_entities: Option<i32>,
    #[doc = "Suitable SQL entities."]
    #[serde(rename = "suitableSqlEntities", default, skip_serializing_if = "Option::is_none")]
    pub suitable_sql_entities: Option<i32>,
    #[doc = "The on premises PaaS cost."]
    #[serde(rename = "azureSqlCostDetails", default, skip_serializing_if = "Option::is_none")]
    pub azure_sql_cost_details: Option<CostDetails>,
    #[doc = "Estimated cost."]
    #[serde(rename = "estimatedCost", default, skip_serializing_if = "Option::is_none")]
    pub estimated_cost: Option<f32>,
    #[doc = "OS licensing cost."]
    ...
    #[doc = "The recommended VM family summary."]
    #[serde(
        rename = "recommendedVmFamilySummary",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub recommended_vm_family_summary: Vec<RecommendedVmFamilySummary>,
    #[doc = "The cost by storage type."]
    #[serde(
        rename = "costByStorageType",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub cost_by_storage_type: Vec<CostByStorageType>,
}
impl AzureIaasSqlSummary {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AzureIaasSummary {
    #[doc = "Shows the year-on-year cost overall."]
    #[serde(rename = "yearOnYearEstimates", default, skip_serializing_if = "Option::is_none")]
    pub year_on_year_estimates: Option<YearOnYearEstimates>,
    #[doc = "Azure Iaas virtual machine summary."]
    #[serde(rename = "azureIaasVmSummary", default, skip_serializing_if = "Option::is_none")]
    pub azure_iaas_vm_summary: Option<AzureIaasVmSummary>,
    #[doc = "Azure Iaas sql server summary."]
    #[serde(rename = "azureIaasSqlSummary", default, skip_serializing_if = "Option::is_none")]
    pub azure_iaas_sql_summary: Option<AzureIaasSqlSummary>,
    #[doc = "The on premises PaaS cost."]
    #[serde(rename = "azureIaasCostDetails", default, skip_serializing_if = "Option::is_none")]
    pub azure_iaas_cost_details: Option<CostDetails>,
}
impl AzureIaasSummary {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct AzureIaasVmSummary {
    ...
    pub memory_gb: Option<f32>,
    #[doc = "The on premises PaaS cost."]
    #[serde(rename = "azureVmCostDetails", default, skip_serializing_if = "Option::is_none")]
    pub azure_vm_cost_details: Option<CostDetails>,
    #[doc = "Estimated cost."]
    #[serde(rename = "estimatedCost", default, skip_serializing_if = "Option::is_none")]
    pub estimated_cost: Option<f32>,
    #[doc = "OS licensing cost."]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AzureKubernetesServiceSummary {
    #[doc = "Estimated cost by recommendation offer."]
    #[serde(
        rename = "estimatedCostByOffer",
        default,
...
impl AzureKubernetesServiceSummary {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct AzurePaasSummary {
    ...
    #[serde(rename = "totalWebApps", default, skip_serializing_if = "Option::is_none")]
    pub total_web_apps: Option<i32>,
    #[doc = "Suitable web applications."]
    #[serde(rename = "suitableWebApps", default, skip_serializing_if = "Option::is_none")]
    pub suitable_web_apps: Option<i32>,
    #[doc = "Number of cores."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cores: Option<i32>,
    ...
    #[serde(rename = "estimatedCostByTarget", default, skip_serializing_if = "Option::is_none")]
    pub estimated_cost_by_target: Option<EstimatedCostByTarget>,
    #[doc = "estimated SQL Server licensing cost."]
    #[serde(rename = "estimatedSqlServerLicensingCost", default, skip_serializing_if = "Option::is_none")]
    pub estimated_sql_server_licensing_cost: Option<f32>,
    #[doc = "Shows the Azure SQL details."]
    #[serde(rename = "azureSqlSummary", default, skip_serializing_if = "Option::is_none")]
    pub azure_sql_summary: Option<AzureSqlSummary>,
    #[doc = "Shows Azure App Service summary."]
    #[serde(rename = "azureAppServiceSummary", default, skip_serializing_if = "Option::is_none")]
    pub azure_app_service_summary: Option<AzureAppServiceSummary>,
    #[doc = "Shows Azure App Service Container summary."]
    #[serde(rename = "azureAppServiceContainerSummary", default, skip_serializing_if = "Option::is_none")]
    pub azure_app_service_container_summary: Option<AzureAppServiceContainerSummary>,
    #[doc = "Shows Azure Kubernetes Service summary."]
    #[serde(rename = "azureKubernetesServiceSummary", default, skip_serializing_if = "Option::is_none")]
    pub azure_kubernetes_service_summary: Option<AzureKubernetesServiceSummary>,
    #[doc = "The on premises PaaS cost."]
    #[serde(rename = "totalAzurePaasCost", default, skip_serializing_if = "Option::is_none")]
    pub total_azure_paas_cost: Option<CostDetails>,
}
impl AzurePaasSummary {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Common properties for all azure tracked and proxy resources."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AzureResourceProperties2 {
    #[doc = "The status of the current operation."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<ProvisioningState2>,
}
impl AzureResourceProperties2 {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct AzureSettings {
    ...
    pub currency: BusinessCaseCurrency,
    #[doc = "Business case supported migration strategy types."]
    #[serde(rename = "businessCaseType", default, skip_serializing_if = "Option::is_none")]
    pub business_case_type: Option<MigrationStrategy>,
    #[doc = "Business case supported Discovery source types."]
    #[serde(rename = "workloadDiscoverySource", default, skip_serializing_if = "Option::is_none")]
    pub workload_discovery_source: Option<DiscoverySource>,
    #[doc = "Gets start time to use for performance."]
    #[serde(rename = "performanceDataStartTime", default, with = "azure_core::date::rfc3339::option")]
    pub performance_data_start_time: Option<::time::OffsetDateTime>,
    #[doc = "Gets end time to use for performance."]
    #[serde(rename = "performanceDataEndTime", default, with = "azure_core::date::rfc3339::option")]
    pub performance_data_end_time: Option<::time::OffsetDateTime>,
    #[doc = "Gets comfort factor."]
    #[serde(rename = "comfortFactor", default, skip_serializing_if = "Option::is_none")]
    pub comfort_factor: Option<f32>,
    #[doc = "Gets utilization percentile for performance."]
    #[serde(rename = "performanceUtilizationPercentile", default, skip_serializing_if = "Option::is_none")]
    pub performance_utilization_percentile: Option<f32>,
    #[doc = "Gets migration completion percentage per year."]
    #[serde(rename = "perYearMigrationCompletionPercentage", default, skip_serializing_if = "Option::is_none")]
    pub per_year_migration_completion_percentage: Option<serde_json::Value>,
    #[doc = "Gets infrastructure growth rate."]
    #[serde(rename = "infrastructureGrowthRate", default, skip_serializing_if = "Option::is_none")]
    pub infrastructure_growth_rate: Option<f32>,
    #[doc = "Gets wACC percentage."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub wacc: Option<f32>,
    #[doc = "Gets network cost percentage."]
    #[serde(rename = "networkCostPercentage", default, skip_serializing_if = "Option::is_none")]
    pub network_cost_percentage: Option<f32>,
    #[doc = "Gets IaaS labour cost percentage."]
    #[serde(rename = "iaasLaborCostPercentage", default, skip_serializing_if = "Option::is_none")]
    pub iaas_labor_cost_percentage: Option<f32>,
    #[doc = "Gets PaaS labour cost percentage."]
    #[serde(rename = "paasLaborCostPercentage", default, skip_serializing_if = "Option::is_none")]
    pub paas_labor_cost_percentage: Option<f32>,
    #[doc = "Gets Avs labour cost percentage."]
    #[serde(rename = "avsLaborCostPercentage", default, skip_serializing_if = "Option::is_none")]
    pub avs_labor_cost_percentage: Option<f32>,
    #[doc = "Business case supported Savings Option types."]
    #[serde(rename = "savingsOption", default, skip_serializing_if = "Option::is_none")]
    pub savings_option: Option<SavingsOption>,
}
impl AzureSettings {
    pub fn new(target_location: String, currency: BusinessCaseCurrency) -> Self {
        Self {
            target_location,
            discount_percentage: None,
            currency,
            business_case_type: None,
            workload_discovery_source: None,
            performance_data_start_time: None,
            performance_data_end_time: None,
            comfort_factor: None,
            performance_utilization_percentile: None,
            per_year_migration_completion_percentage: None,
            infrastructure_growth_rate: None,
            wacc: None,
            network_cost_percentage: None,
            iaas_labor_cost_percentage: None,
            paas_labor_cost_percentage: None,
            avs_labor_cost_percentage: None,
            savings_option: None,
        }
    }
}
...
pub struct AzureSqlSummary {
    ...
    #[serde(
        rename = "distributionByServiceTier",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub distribution_by_service_tier: Vec<SqlServiceTier>,
    #[doc = "Distribution by service tiers for SQL MI."]
    #[serde(
        rename = "distributionByServiceTierForSqlMi",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub distribution_by_service_tier_for_sql_mi: Vec<SqlServiceTier>,
    #[doc = "Distribution by service tiers for SQL DB."]
    #[serde(
        rename = "distributionByServiceTierForSqlDb",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub distribution_by_service_tier_for_sql_db: Vec<SqlServiceTier>,
}
impl AzureSqlSummary {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Azure VM Category."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "AzureVmCategory")]
pub enum AzureVmCategory {
    All,
    ComputeOptimized,
    GeneralPurpose,
    GpuOptimized,
...
impl FromStr for AzureVmCategory {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for AzureVmCategory {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for AzureVmCategory {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::All => serializer.serialize_unit_variant("AzureVmCategory", 0u32, "All"),
            Self::ComputeOptimized => serializer.serialize_unit_variant("AzureVmCategory", 1u32, "ComputeOptimized"),
            Self::GeneralPurpose => serializer.serialize_unit_variant("AzureVmCategory", 2u32, "GeneralPurpose"),
            Self::GpuOptimized => serializer.serialize_unit_variant("AzureVmCategory", 3u32, "GpuOptimized"),
            Self::HighPerformanceCompute => serializer.serialize_unit_variant("AzureVmCategory", 4u32, "HighPerformanceCompute"),
            Self::MemoryOptimized => serializer.serialize_unit_variant("AzureVmCategory", 5u32, "MemoryOptimized"),
            Self::StorageOptimized => serializer.serialize_unit_variant("AzureVmCategory", 6u32, "StorageOptimized"),
            Self::Isolated => serializer.serialize_unit_variant("AzureVmCategory", 7u32, "Isolated"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "AzureWebAppSuitabilityIssueCategory")]
pub enum AzureWebAppSuitabilityIssueCategory {
    Unknown,
    Issue,
    Info,
    #[serde(skip_deserializing)]
...
impl FromStr for AzureWebAppSuitabilityIssueCategory {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for AzureWebAppSuitabilityIssueCategory {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for AzureWebAppSuitabilityIssueCategory {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("AzureWebAppSuitabilityIssueCategory", 0u32, "Unknown"),
            Self::Issue => serializer.serialize_unit_variant("AzureWebAppSuitabilityIssueCategory", 1u32, "Issue"),
            Self::Info => serializer.serialize_unit_variant("AzureWebAppSuitabilityIssueCategory", 2u32, "Info"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "AzureWebAppTargetType")]
pub enum AzureWebAppTargetType {
    Unknown,
    AzureAppService,
...
impl FromStr for AzureWebAppTargetType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for AzureWebAppTargetType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for AzureWebAppTargetType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("AzureWebAppTargetType", 0u32, "Unknown"),
            Self::AzureAppService => serializer.serialize_unit_variant("AzureWebAppTargetType", 1u32, "AzureAppService"),
            Self::AzureAppServiceContainer => serializer.serialize_unit_variant("AzureWebAppTargetType", 2u32, "AzureAppServiceContainer"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "AzureWebAppTier")]
pub enum AzureWebAppTier {
    Unknown,
    Free,
    #[serde(rename = "Premium_V2")]
    PremiumV2,
    #[serde(rename = "Premium_V3")]
    PremiumV3,
    Isolated,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for AzureWebAppTier {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for AzureWebAppTier {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for AzureWebAppTier {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("AzureWebAppTier", 0u32, "Unknown"),
            Self::Free => serializer.serialize_unit_variant("AzureWebAppTier", 1u32, "Free"),
            Self::PremiumV2 => serializer.serialize_unit_variant("AzureWebAppTier", 2u32, "Premium_V2"),
            Self::PremiumV3 => serializer.serialize_unit_variant("AzureWebAppTier", 3u32, "Premium_V3"),
            Self::Isolated => serializer.serialize_unit_variant("AzureWebAppTier", 4u32, "Isolated"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "Business case supported currency types."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "BusinessCaseCurrency")]
pub enum BusinessCaseCurrency {
    Unknown,
    #[serde(rename = "USD")]
    Usd,
    #[serde(rename = "DKK")]
...
impl FromStr for BusinessCaseCurrency {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for BusinessCaseCurrency {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for BusinessCaseCurrency {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("BusinessCaseCurrency", 0u32, "Unknown"),
            Self::Usd => serializer.serialize_unit_variant("BusinessCaseCurrency", 1u32, "USD"),
            Self::Dkk => serializer.serialize_unit_variant("BusinessCaseCurrency", 2u32, "DKK"),
            Self::Cad => serializer.serialize_unit_variant("BusinessCaseCurrency", 3u32, "CAD"),
            Self::Idr => serializer.serialize_unit_variant("BusinessCaseCurrency", 4u32, "IDR"),
            Self::Jpy => serializer.serialize_unit_variant("BusinessCaseCurrency", 5u32, "JPY"),
            Self::Krw => serializer.serialize_unit_variant("BusinessCaseCurrency", 6u32, "KRW"),
            Self::Nzd => serializer.serialize_unit_variant("BusinessCaseCurrency", 7u32, "NZD"),
            Self::Nok => serializer.serialize_unit_variant("BusinessCaseCurrency", 8u32, "NOK"),
            Self::Rub => serializer.serialize_unit_variant("BusinessCaseCurrency", 9u32, "RUB"),
            Self::Sar => serializer.serialize_unit_variant("BusinessCaseCurrency", 10u32, "SAR"),
            Self::Zar => serializer.serialize_unit_variant("BusinessCaseCurrency", 11u32, "ZAR"),
            Self::Sek => serializer.serialize_unit_variant("BusinessCaseCurrency", 12u32, "SEK"),
            Self::Try => serializer.serialize_unit_variant("BusinessCaseCurrency", 13u32, "TRY"),
            Self::Gbp => serializer.serialize_unit_variant("BusinessCaseCurrency", 14u32, "GBP"),
            Self::Mxn => serializer.serialize_unit_variant("BusinessCaseCurrency", 15u32, "MXN"),
            Self::Myr => serializer.serialize_unit_variant("BusinessCaseCurrency", 16u32, "MYR"),
            Self::Inr => serializer.serialize_unit_variant("BusinessCaseCurrency", 17u32, "INR"),
            Self::Hkd => serializer.serialize_unit_variant("BusinessCaseCurrency", 18u32, "HKD"),
            Self::Brl => serializer.serialize_unit_variant("BusinessCaseCurrency", 19u32, "BRL"),
            Self::Twd => serializer.serialize_unit_variant("BusinessCaseCurrency", 20u32, "TWD"),
            Self::Eur => serializer.serialize_unit_variant("BusinessCaseCurrency", 21u32, "EUR"),
            Self::Chf => serializer.serialize_unit_variant("BusinessCaseCurrency", 22u32, "CHF"),
            Self::Ars => serializer.serialize_unit_variant("BusinessCaseCurrency", 23u32, "ARS"),
            Self::Aud => serializer.serialize_unit_variant("BusinessCaseCurrency", 24u32, "AUD"),
            Self::Cny => serializer.serialize_unit_variant("BusinessCaseCurrency", 25u32, "CNY"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "The response of a BusinessCase list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct BusinessCaseListResult {
    #[doc = "The BusinessCase items on this page"]
    pub value: Vec<BusinessCase>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for BusinessCaseListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl BusinessCaseListResult {
    pub fn new(value: Vec<BusinessCase>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Property bag for an\nMicrosoft.Azure.Migrate.BusinessCaseService.Api.V20220202_preview.Resources.BusinessCase\nresource."]
...
pub struct BusinessCaseProperties {
    #[serde(flatten)]
    pub azure_resource_properties2: AzureResourceProperties2,
    #[doc = "Business case settings."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub settings: Option<Settings>,
    #[doc = "Business case supported state types."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<BusinessCaseState>,
    #[doc = "Gets the state of business case reports."]
    #[serde(
        rename = "reportStatusDetails",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub report_status_details: Vec<ReportDetails>,
}
impl BusinessCaseProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Business case supported state types."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "BusinessCaseState")]
pub enum BusinessCaseState {
    Unknown,
    InProgress,
    Completed,
    OutDated,
...
impl FromStr for BusinessCaseState {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for BusinessCaseState {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for BusinessCaseState {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("BusinessCaseState", 0u32, "Unknown"),
            Self::InProgress => serializer.serialize_unit_variant("BusinessCaseState", 1u32, "InProgress"),
            Self::Completed => serializer.serialize_unit_variant("BusinessCaseState", 2u32, "Completed"),
            Self::OutDated => serializer.serialize_unit_variant("BusinessCaseState", 3u32, "OutDated"),
            Self::Invalid => serializer.serialize_unit_variant("BusinessCaseState", 4u32, "Invalid"),
            Self::OutOfSync => serializer.serialize_unit_variant("BusinessCaseState", 5u32, "OutOfSync"),
            Self::Failed => serializer.serialize_unit_variant("BusinessCaseState", 6u32, "Failed"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "Data model of Check or Rule for Suitability Analysis."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct Check {
    #[doc = "Gets name."]
    pub name: String,
    #[doc = "Suitability Check or Rule Result."]
    pub behavior: CheckResult,
    #[doc = "Gets description."]
    pub description: String,
    #[doc = "Gets cause."]
    pub cause: String,
    #[doc = "Gets recommendation."]
    pub recommendation: String,
    #[doc = "Data model of More information about check or rule."]
...
impl Serialize for CheckResult {
    ...
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("CheckResult", 0u32, "Unknown"),
            Self::Issue => serializer.serialize_unit_variant("CheckResult", 1u32, "Issue"),
            Self::Warn => serializer.serialize_unit_variant("CheckResult", 2u32, "Warn"),
            Self::Pass => serializer.serialize_unit_variant("CheckResult", 3u32, "Pass"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct Cluster {
    ...
    #[serde(rename = "userNodePoolCount")]
    pub user_node_pool_count: i32,
    #[doc = "Gets user node count."]
    #[serde(rename = "userNodeCount")]
    pub user_node_count: i32,
    #[doc = "Gets system node pool count."]
    #[serde(rename = "systemNodePoolCount")]
    pub system_node_pool_count: i32,
    #[doc = "Gets system node count."]
    #[serde(rename = "systemNodeCount")]
    pub system_node_count: i32,
    #[doc = "Gets pod count."]
...
impl Cluster {
    pub fn new(
        ...
        region: String,
        user_node_pool_count: i32,
        user_node_count: i32,
        system_node_pool_count: i32,
        system_node_count: i32,
        pod_count: i32,
        monthly_cost: f32,
    ) -> Self {
        Self {
            ...
            node_pools,
            region,
            user_node_pool_count,
            user_node_count,
            system_node_pool_count,
            system_node_count,
            pod_count,
            monthly_cost,
        }
...
pub struct CompareSummary {
    #[doc = "The on premises PaaS cost."]
    #[serde(rename = "azurePaasCostDetails", default, skip_serializing_if = "Option::is_none")]
    pub azure_paas_cost_details: Option<CostDetails>,
    #[doc = "The on premises PaaS cost."]
    #[serde(rename = "azureIaasCostDetails", default, skip_serializing_if = "Option::is_none")]
    pub azure_iaas_cost_details: Option<CostDetails>,
    #[doc = "The on premises PaaS cost."]
    #[serde(rename = "azureAvsCostDetails", default, skip_serializing_if = "Option::is_none")]
    pub azure_avs_cost_details: Option<CostDetails>,
    #[doc = "The on premises PaaS cost."]
    #[serde(rename = "onPremisesPaasCostDetails", default, skip_serializing_if = "Option::is_none")]
    pub on_premises_paas_cost_details: Option<CostDetails>,
    #[doc = "The on premises PaaS cost."]
    #[serde(rename = "onPremisesIaasCostDetails", default, skip_serializing_if = "Option::is_none")]
    pub on_premises_iaas_cost_details: Option<CostDetails>,
    #[doc = "The on premises PaaS cost."]
    #[serde(rename = "onPremisesAvsCostDetails", default, skip_serializing_if = "Option::is_none")]
    pub on_premises_avs_cost_details: Option<CostDetails>,
    #[doc = "The on premises PaaS cost."]
    #[serde(
        rename = "onPremisesPaasDecommissionedCostDetails",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub on_premises_paas_decommissioned_cost_details: Option<CostDetails>,
    #[doc = "The on premises PaaS cost."]
    #[serde(
        rename = "onPremisesIaasDecommissionedCostDetails",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub on_premises_iaas_decommissioned_cost_details: Option<CostDetails>,
    #[doc = "The on premises PaaS cost."]
    #[serde(
        rename = "onPremisesAvsDecommissionedCostDetails",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub on_premises_avs_decommissioned_cost_details: Option<CostDetails>,
}
impl CompareSummary {
    pub fn new() -> Self {
        Self::default()
...
impl ComputeResource {
    pub fn new(cores: f32, memory: f32) -> Self {
        Self { cores, memory }
    }
}
...
pub struct ComputeSettings {
    ...
    #[serde(rename = "hyperthreadCoreToMemoryRatio")]
    pub hyperthread_core_to_memory_ratio: f32,
    #[doc = "Compute Price."]
    pub price: f32,
    #[doc = "SQL Server licensing settings."]
    #[serde(rename = "sqlServerLicensing")]
    pub sql_server_licensing: Vec<SqlServerLicensingSettings>,
    #[doc = "Windows Server licensing settings."]
    #[serde(rename = "windowsServerLicensing")]
    pub windows_server_licensing: WindowsServerLicensingSettings,
    #[doc = "Linux Server licensing settings."]
    #[serde(rename = "rhelLinuxServerLicensing")]
    pub rhel_linux_server_licensing: LinuxServerLicensingSettings,
    #[doc = "Linux Server licensing settings."]
    #[serde(rename = "suseLinuxServerLicensing")]
    pub suse_linux_server_licensing: LinuxServerLicensingSettings,
    #[doc = "Virtualization software settings."]
    #[serde(rename = "virtualizationSoftwareSettings")]
    pub virtualization_software_settings: VirtualizationSoftwareSettings,
}
impl ComputeSettings {
    pub fn new(
        hyperthread_core_to_memory_ratio: f32,
        price: f32,
        sql_server_licensing: Vec<SqlServerLicensingSettings>,
        ...
        Self {
            hyperthread_core_to_memory_ratio,
            price,
...
#[doc = "Consolidation Type."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ConsolidationType")]
...
impl FromStr for ConsolidationType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for ConsolidationType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for ConsolidationType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Full => serializer.serialize_unit_variant("ConsolidationType", 0u32, "Full"),
            Self::AsOnSource => serializer.serialize_unit_variant("ConsolidationType", 1u32, "AsOnSource"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl Serialize for CostComponentName {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::MonthlyLinuxAzureHybridCostSavings => {
                serializer.serialize_unit_variant("CostComponentName", 4u32, "MonthlyLinuxAzureHybridCostSavings")
            }
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
...
pub struct CostDetails {
    ...
    #[serde(rename = "itLaborCost", default, skip_serializing_if = "Option::is_none")]
    pub it_labor_cost: Option<f32>,
    #[doc = "The network cost."]
    #[serde(rename = "networkCost", default, skip_serializing_if = "Option::is_none")]
    pub network_cost: Option<f32>,
    #[doc = "The windows AhubSavings."]
    #[serde(rename = "ahubSavings", default, skip_serializing_if = "Option::is_none")]
    pub ahub_savings: Option<f32>,
    #[doc = "The linux AhubSavings."]
    #[serde(rename = "linuxAhubSavings", default, skip_serializing_if = "Option::is_none")]
    pub linux_ahub_savings: Option<f32>,
    #[doc = "Security Cost."]
    #[serde(rename = "securityCost", default, skip_serializing_if = "Option::is_none")]
    pub security_cost: Option<f32>,
    #[doc = "Management Cost Details."]
    #[serde(rename = "managementCostDetails", default, skip_serializing_if = "Option::is_none")]
    pub management_cost_details: Option<ManagementCostDetails>,
    #[doc = "esu savings."]
    #[serde(rename = "esuSavings", default, skip_serializing_if = "Option::is_none")]
    pub esu_savings: Option<f32>,
}
impl CostDetails {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "Discovered entities summary."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DiscoveredEntitiesSummary {
    #[doc = "Number of web servers"]
    #[serde(rename = "numberOfServers", default, skip_serializing_if = "Option::is_none")]
    pub number_of_servers: Option<i32>,
    #[doc = "Number of web apps"]
    #[serde(rename = "numberOfWebApps", default, skip_serializing_if = "Option::is_none")]
    pub number_of_web_apps: Option<i32>,
    #[doc = "Number of machines"]
    #[serde(rename = "numberOfMachines", default, skip_serializing_if = "Option::is_none")]
    pub number_of_machines: Option<i32>,
    #[doc = "Web server summary data"]
    #[serde(rename = "webServerSummary", default, skip_serializing_if = "Option::is_none")]
    pub web_server_summary: Option<serde_json::Value>,
    #[doc = "Web app summary data"]
    #[serde(rename = "webAppSummary", default, skip_serializing_if = "Option::is_none")]
    pub web_app_summary: Option<serde_json::Value>,
}
impl DiscoveredEntitiesSummary {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveredEntityLightSummary {
    #[doc = "Gets or sets the number of servers."]
    #[serde(rename = "numberOfServers")]
    pub number_of_servers: i32,
    #[doc = "Gets or sets the number of web apps."]
    #[serde(rename = "numberOfWebApps")]
    pub number_of_web_apps: i32,
    #[doc = "Gets or sets the number of machines."]
    #[serde(rename = "numberOfMachines")]
    pub number_of_machines: i32,
}
impl DiscoveredEntityLightSummary {
    pub fn new(number_of_servers: i32, number_of_web_apps: i32, number_of_machines: i32) -> Self {
        Self {
            number_of_servers,
            number_of_web_apps,
            number_of_machines,
...
impl Serialize for DiscoverySource {
    ...
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("DiscoverySource", 0u32, "Unknown"),
            Self::Appliance => serializer.serialize_unit_variant("DiscoverySource", 1u32, "Appliance"),
            Self::Import => serializer.serialize_unit_variant("DiscoverySource", 2u32, "Import"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DistributionByOperatingSystem {
    #[doc = "The Os classification type."]
    #[serde(rename = "osClassificationType", default, skip_serializing_if = "Option::is_none")]
    pub os_classification_type: Option<String>,
    #[doc = "The number of machines with the OS type classification."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub count: Option<i32>,
}
impl DistributionByOperatingSystem {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DistributionByVirtualization {
    #[doc = "The Virtualization type."]
    #[serde(rename = "virtualizationType", default, skip_serializing_if = "Option::is_none")]
    pub virtualization_type: Option<String>,
    #[doc = "The number of machines with the Virtualization type classification."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub count: Option<i32>,
}
impl DistributionByVirtualization {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EstimatedCostByOffer {
    #[doc = "The offer name."]
...
#[doc = "Shows the estimated cost by target."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EstimatedCostByTarget {
    #[doc = "Azure SQL MI cost."]
    #[serde(rename = "azureSqlMiCost", default, skip_serializing_if = "Option::is_none")]
    pub azure_sql_mi_cost: Option<f32>,
    #[doc = "Azure SQL DB cost."]
    #[serde(rename = "azureSqlDbCost", default, skip_serializing_if = "Option::is_none")]
    pub azure_sql_db_cost: Option<f32>,
    #[doc = "Azure App Service cost."]
    #[serde(rename = "appServiceCost", default, skip_serializing_if = "Option::is_none")]
    pub app_service_cost: Option<f32>,
    #[doc = "Azure App Service Containers cost."]
    #[serde(rename = "appServiceContainerCost", default, skip_serializing_if = "Option::is_none")]
    pub app_service_container_cost: Option<f32>,
    #[doc = "Azure Kubernetes Service cost."]
    #[serde(rename = "azureKubernetesServiceCost", default, skip_serializing_if = "Option::is_none")]
    pub azure_kubernetes_service_cost: Option<f32>,
}
impl EstimatedCostByTarget {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Evaluated AVS machine resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EvaluatedAvsMachine {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Evaluated AVS machine properties class."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<EvaluatedAvsMachineProperties>,
}
impl EvaluatedAvsMachine {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The response of a EvaluatedAvsMachine list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct EvaluatedAvsMachineListResult {
    #[doc = "The EvaluatedAvsMachine items on this page"]
    pub value: Vec<EvaluatedAvsMachine>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for EvaluatedAvsMachineListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl EvaluatedAvsMachineListResult {
    pub fn new(value: Vec<EvaluatedAvsMachine>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Evaluated AVS machine properties class."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EvaluatedAvsMachineProperties {
    #[doc = "Machine Id."]
    ...
    pub virtualization_type: Option<String>,
    #[doc = "Activity state."]
    #[serde(rename = "activityState", default, skip_serializing_if = "Option::is_none")]
    pub activity_state: Option<String>,
    #[doc = "Operating System (OS) name."]
    #[serde(rename = "operatingSystemName", default, skip_serializing_if = "Option::is_none")]
    pub operating_system_name: Option<String>,
    #[doc = "Recommended Azure target."]
    #[serde(rename = "recommendedAzureTarget", default, skip_serializing_if = "Option::is_none")]
    pub recommended_azure_target: Option<String>,
    #[doc = "Qualifying offer."]
    #[serde(rename = "qualifyingOffer", default, skip_serializing_if = "Option::is_none")]
    pub qualifying_offer: Option<String>,
    #[doc = "Is machine ready for migration."]
    #[serde(rename = "readyForMigration", default, skip_serializing_if = "Option::is_none")]
    pub ready_for_migration: Option<String>,
    #[doc = "Supportability Status."]
    #[serde(rename = "supportStatus", default, skip_serializing_if = "Option::is_none")]
    pub support_status: Option<SupportabilityStatus>,
}
impl EvaluatedAvsMachineProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct EvaluatedMachine {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<EvaluatedMachineProperties>,
}
...
#[doc = "The response of a EvaluatedMachine list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct EvaluatedMachineListResult {
    #[doc = "The EvaluatedMachine items on this page"]
    pub value: Vec<EvaluatedMachine>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for EvaluatedMachineListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl EvaluatedMachineListResult {
    pub fn new(value: Vec<EvaluatedMachine>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Evaluated machine properties class."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EvaluatedMachineProperties {
    #[doc = "Machine Id."]
    #[serde(rename = "machineId", default, skip_serializing_if = "Option::is_none")]
    pub machine_id: Option<String>,
    #[doc = "Server Name."]
...
impl EvaluatedMachineProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EvaluatedSqlEntity {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Evaluated sql entity properties class."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<EvaluatedSqlEntityProperties>,
}
impl EvaluatedSqlEntity {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The response of a EvaluatedSqlEntity list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct EvaluatedSqlEntityListResult {
    #[doc = "The EvaluatedSqlEntity items on this page"]
    pub value: Vec<EvaluatedSqlEntity>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for EvaluatedSqlEntityListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl EvaluatedSqlEntityListResult {
    pub fn new(value: Vec<EvaluatedSqlEntity>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Evaluated sql entity properties class."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EvaluatedSqlEntityProperties {
    #[doc = "Server name."]
    #[serde(rename = "serverName", default, skip_serializing_if = "Option::is_none")]
    pub server_name: Option<String>,
    #[doc = "Activity state."]
...
impl EvaluatedSqlEntityProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EvaluatedWebApp {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Evaluated web app properties class."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<EvaluatedWebAppProperties>,
}
impl EvaluatedWebApp {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The response of a EvaluatedWebApp list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct EvaluatedWebAppListResult {
    #[doc = "The EvaluatedWebApp items on this page"]
    pub value: Vec<EvaluatedWebApp>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for EvaluatedWebAppListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl EvaluatedWebAppListResult {
    pub fn new(value: Vec<EvaluatedWebApp>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Evaluated web app properties class."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EvaluatedWebAppProperties {
    #[doc = "Recommended Azure target."]
    #[serde(rename = "recommendedAzureTarget", default, skip_serializing_if = "Option::is_none")]
    pub recommended_azure_target: Option<String>,
    #[doc = "Recommended Azure SKU name."]
    #[serde(rename = "recommendedAzureSkuName", default, skip_serializing_if = "Option::is_none")]
    pub recommended_azure_sku_name: Option<String>,
    #[doc = "Recommended Azure SKU size."]
    #[serde(rename = "recommendedAzureSkuSize", default, skip_serializing_if = "Option::is_none")]
    pub recommended_azure_sku_size: Option<String>,
    #[doc = "The server name."]
    #[serde(rename = "serverName", default, skip_serializing_if = "Option::is_none")]
    pub server_name: Option<String>,
    #[doc = "The workload."]
...
impl EvaluatedWebAppProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct FacilitySettings {
    ...
    #[serde(rename = "facilitiesCost")]
    pub facilities_cost: f32,
}
impl FacilitySettings {
    pub fn new(facilities_cost: f32) -> Self {
        Self { facilities_cost }
    }
}
#[doc = "FTT and RAID Level."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "HyperVLicenseType")]
pub enum HyperVLicenseType {
    Unknown,
    Datacentre,
    Standard,
    #[serde(skip_deserializing)]
...
impl FromStr for HyperVLicenseType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for HyperVLicenseType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for HyperVLicenseType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("HyperVLicenseType", 0u32, "Unknown"),
            Self::Datacentre => serializer.serialize_unit_variant("HyperVLicenseType", 1u32, "Datacentre"),
            Self::Standard => serializer.serialize_unit_variant("HyperVLicenseType", 2u32, "Standard"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct HypervLicense {
    #[doc = "Cost of a licence."]
    #[serde(rename = "licenseCost")]
    pub license_cost: f32,
    #[doc = "Business case supported HyperV License types."]
    #[serde(rename = "licenseType")]
    pub license_type: HyperVLicenseType,
}
impl HypervLicense {
    pub fn new(license_cost: f32, license_type: HyperVLicenseType) -> Self {
        Self {
            license_cost,
            license_type,
        }
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct HypervVirtualizationManagementSettings {
    #[doc = "Number of physical cores per licence."]
    #[serde(rename = "numberOfPhysicalCoresPerLicense")]
    pub number_of_physical_cores_per_license: i32,
    #[doc = "Software Assurance Cost."]
    #[serde(rename = "softwareAssuranceCost")]
    pub software_assurance_cost: f32,
    #[doc = "Licence and support list."]
    #[serde(rename = "licenseAndSupportList")]
    pub license_and_support_list: Vec<HypervLicense>,
}
impl HypervVirtualizationManagementSettings {
    pub fn new(
        number_of_physical_cores_per_license: i32,
        software_assurance_cost: f32,
        license_and_support_list: Vec<HypervLicense>,
    ) -> Self {
        Self {
            number_of_physical_cores_per_license,
            software_assurance_cost,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct IaasOsLicensingDetails {
    #[doc = "The OS type."]
    ...
    #[serde(rename = "decomissionCost", default, skip_serializing_if = "Option::is_none")]
    pub decomission_cost: Option<f32>,
}
impl IaasOsLicensingDetails {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct IaasSummary {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Iaas summary properties class."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<IaasSummaryProperties>,
}
impl IaasSummary {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "The response of a IaasSummary list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct IaasSummaryListResult {
    #[doc = "The IaasSummary items on this page"]
    pub value: Vec<IaasSummary>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for IaasSummaryListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl IaasSummaryListResult {
    pub fn new(value: Vec<IaasSummary>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Iaas summary properties class."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct IaasSummaryProperties {
    #[doc = "The Azure IaaS summary."]
    #[serde(rename = "azureIaasSummary", default, skip_serializing_if = "Option::is_none")]
    pub azure_iaas_summary: Option<AzureIaasSummary>,
    #[doc = "The on premises IAAS summary."]
    #[serde(rename = "onPremisesIaasSummary", default, skip_serializing_if = "Option::is_none")]
    pub on_premises_iaas_summary: Option<OnPremisesIaasSummary>,
}
impl IaasSummaryProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct LaborSettings {
    ...
    #[serde(rename = "physicalServersPerAdmin")]
    pub physical_servers_per_admin: i32,
    #[doc = "Virtual machines per administrator."]
    #[serde(rename = "virtualMachinesPerAdmin")]
    pub virtual_machines_per_admin: i32,
    #[doc = "Hourly administrator cost."]
    #[serde(rename = "hourlyAdminCost")]
    pub hourly_admin_cost: f32,
}
impl LaborSettings {
    pub fn new(physical_servers_per_admin: i32, virtual_machines_per_admin: i32, hourly_admin_cost: f32) -> Self {
        Self {
            physical_servers_per_admin,
            virtual_machines_per_admin,
            hourly_admin_cost,
        }
    }
}
...
impl Serialize for LicenseType {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::VSphereStandard => serializer.serialize_unit_variant("LicenseType", 1u32, "VSphereStandard"),
            Self::VSphereEnterprisePlus => serializer.serialize_unit_variant("LicenseType", 2u32, "VSphereEnterprisePlus"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "Licensing Program for Azure."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "LicensingProgram")]
pub enum LicensingProgram {
    Default,
    #[serde(rename = "EA")]
    Ea,
    #[serde(skip_deserializing)]
...
impl FromStr for LicensingProgram {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for LicensingProgram {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for LicensingProgram {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Default => serializer.serialize_unit_variant("LicensingProgram", 0u32, "Default"),
            Self::Ea => serializer.serialize_unit_variant("LicensingProgram", 1u32, "EA"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "Linux Server licensing settings."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct LinuxServerLicensingSettings {
    #[doc = "Licence Cost."]
    #[serde(rename = "licenseCost")]
    pub license_cost: f32,
}
impl LinuxServerLicensingSettings {
    pub fn new(license_cost: f32) -> Self {
        Self { license_cost }
    }
}
...
pub struct MachineAssessmentProperties {
    ...
    #[serde(rename = "linuxAzureHybridUseBenefit", default, skip_serializing_if = "Option::is_none")]
    pub linux_azure_hybrid_use_benefit: Option<AzureHybridUseBenefit>,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ManagementCostComponent {
    #[doc = "Management Cost Component Names."]
    pub name: ManagementCostComponentName,
    #[doc = "Cost of Management Component."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub value: Option<f32>,
}
impl ManagementCostComponent {
    pub fn new(name: ManagementCostComponentName) -> Self {
        Self { name, value: None }
    }
}
#[doc = "Management Cost Component Names."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ManagementCostComponentName")]
pub enum ManagementCostComponentName {
    Unknown,
    SystemCenterLicenseCost,
    VSphereManagementCost,
    ThirdPartyManagementCost,
    OtherMonitoringCost,
    OtherDataProtectionCost,
    OtherPatchingCost,
    AzureMonitoringCost,
    AzurePatchingCost,
    AzureDataProtectionCost,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for ManagementCostComponentName {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for ManagementCostComponentName {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for ManagementCostComponentName {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("ManagementCostComponentName", 0u32, "Unknown"),
            Self::SystemCenterLicenseCost => {
                serializer.serialize_unit_variant("ManagementCostComponentName", 1u32, "SystemCenterLicenseCost")
            }
            Self::VSphereManagementCost => serializer.serialize_unit_variant("ManagementCostComponentName", 2u32, "VSphereManagementCost"),
            Self::ThirdPartyManagementCost => {
                serializer.serialize_unit_variant("ManagementCostComponentName", 3u32, "ThirdPartyManagementCost")
            }
            Self::OtherMonitoringCost => serializer.serialize_unit_variant("ManagementCostComponentName", 4u32, "OtherMonitoringCost"),
            Self::OtherDataProtectionCost => {
                serializer.serialize_unit_variant("ManagementCostComponentName", 5u32, "OtherDataProtectionCost")
            }
            Self::OtherPatchingCost => serializer.serialize_unit_variant("ManagementCostComponentName", 6u32, "OtherPatchingCost"),
            Self::AzureMonitoringCost => serializer.serialize_unit_variant("ManagementCostComponentName", 7u32, "AzureMonitoringCost"),
            Self::AzurePatchingCost => serializer.serialize_unit_variant("ManagementCostComponentName", 8u32, "AzurePatchingCost"),
            Self::AzureDataProtectionCost => {
                serializer.serialize_unit_variant("ManagementCostComponentName", 9u32, "AzureDataProtectionCost")
            }
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
...
#[doc = "Management Cost Details."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ManagementCostDetails {
    #[doc = "Management Cost."]
    #[serde(rename = "managementCost", default, skip_serializing_if = "Option::is_none")]
    pub management_cost: Option<f32>,
    #[doc = "Management Cost Components."]
    #[serde(
        rename = "managementCostComponents",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub management_cost_components: Vec<ManagementCostComponent>,
}
impl ManagementCostDetails {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ManagementSettings {
    #[doc = "HyperV Virtualization Management Settings."]
    #[serde(rename = "hypervVirtualizationManagementSettings")]
    pub hyperv_virtualization_management_settings: HypervVirtualizationManagementSettings,
    #[doc = "Vsphere management settings."]
    #[serde(rename = "vsphereManagementSettings")]
    pub vsphere_management_settings: VsphereManagementSettings,
    #[doc = "Third Party Management settings."]
    #[serde(rename = "thirdPartyManagementSettings")]
    pub third_party_management_settings: ThirdPartyManagementSettings,
    #[doc = "Other Management Costs Settings."]
    #[serde(rename = "otherManagementCostsSettings")]
    pub other_management_costs_settings: OtherManagementCostsSettings,
}
impl ManagementSettings {
    pub fn new(
        hyperv_virtualization_management_settings: HypervVirtualizationManagementSettings,
        vsphere_management_settings: VsphereManagementSettings,
        third_party_management_settings: ThirdPartyManagementSettings,
        other_management_costs_settings: OtherManagementCostsSettings,
    ) -> Self {
        Self {
...
#[doc = "Business case supported migration strategy types."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "MigrationStrategy")]
pub enum MigrationStrategy {
    Unknown,
    OptimizeForCost,
    IaaSOnly,
    OptimizeForPaas,
    #[serde(rename = "AVSOnly")]
    AvsOnly,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
...
impl<'de> Deserialize<'de> for MigrationStrategy {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for MigrationStrategy {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("MigrationStrategy", 0u32, "Unknown"),
            Self::OptimizeForCost => serializer.serialize_unit_variant("MigrationStrategy", 1u32, "OptimizeForCost"),
            Self::IaaSOnly => serializer.serialize_unit_variant("MigrationStrategy", 2u32, "IaaSOnly"),
            Self::OptimizeForPaas => serializer.serialize_unit_variant("MigrationStrategy", 3u32, "OptimizeForPaas"),
            Self::AvsOnly => serializer.serialize_unit_variant("MigrationStrategy", 4u32, "AVSOnly"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "ARM model of Assessment ARM object."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MutableArmResource {
    #[doc = "Provisioning Status."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<ProvisioningStatus>,
}
impl MutableArmResource {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct NetworkSettings {
    #[doc = "Network hardware and software cost percentage."]
    #[serde(rename = "hardwareSoftwareCostPercentage")]
    pub hardware_software_cost_percentage: f32,
    #[doc = "Network maintenance cost percentage."]
    #[serde(rename = "maintenanceCostPercentage")]
    pub maintenance_cost_percentage: f32,
}
impl NetworkSettings {
    pub fn new(hardware_software_cost_percentage: f32, maintenance_cost_percentage: f32) -> Self {
        Self {
...
pub struct NodePool {
    ...
    #[serde(rename = "podApproxMonthlyCost")]
    pub pod_approx_monthly_cost: f32,
}
impl NodePool {
    pub fn new(
        id: String,
        ...
        Self {
            ...
            pod_count,
            monthly_cost,
            pod_approx_monthly_cost,
        }
    }
}
#[doc = "Node Pool Mode."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "NodePoolMode")]
...
impl FromStr for NodePoolMode {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for NodePoolMode {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for NodePoolMode {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::User => serializer.serialize_unit_variant("NodePoolMode", 0u32, "User"),
            Self::System => serializer.serialize_unit_variant("NodePoolMode", 1u32, "System"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct OnPremiseSettings {
    #[doc = "Compute settings."]
    #[serde(rename = "computeSettings")]
    ...
    #[doc = "Facility settings."]
    #[serde(rename = "facilitySettings")]
    pub facility_settings: FacilitySettings,
    #[doc = "Labour settings."]
    #[serde(rename = "laborSettings")]
    pub labor_settings: LaborSettings,
    #[doc = "Security settings."]
    #[serde(rename = "securitySettings")]
    pub security_settings: SecuritySettings,
    #[doc = "Management settings."]
    #[serde(rename = "managementSettings", default, skip_serializing_if = "Option::is_none")]
    pub management_settings: Option<ManagementSettings>,
}
impl OnPremiseSettings {
    pub fn new(
...
#[doc = "The on premises IAAS summary."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OnPremisesIaasSummary {
    ...
    #[serde(rename = "memoryUtilization", default, skip_serializing_if = "Option::is_none")]
    ...
    pub on_premises_iaas_cost_details: Option<CostDetails>,
    #[doc = "The on premises PaaS cost."]
    #[serde(rename = "onPremisesIaasCostForDecommissioned", default, skip_serializing_if = "Option::is_none")]
    pub on_premises_iaas_cost_for_decommissioned: Option<CostDetails>,
    #[doc = "The OS licensing details."]
    #[serde(
        rename = "osLicensingDetails",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub os_licensing_details: Vec<IaasOsLicensingDetails>,
    #[doc = "The distribution by operating system."]
    #[serde(
        rename = "distributionByOperatingSystem",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub distribution_by_operating_system: Vec<DistributionByOperatingSystem>,
    #[doc = "The SQL on premises utilization insights."]
    #[serde(rename = "onPremisesUtilizationData", default, skip_serializing_if = "Option::is_none")]
    pub on_premises_utilization_data: Option<UtilizationData>,
    #[doc = "The distribution by virtualization."]
    #[serde(
        rename = "distributionByVirtualization",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub distribution_by_virtualization: Vec<DistributionByVirtualization>,
    #[doc = "Support Status Distribution."]
    #[serde(rename = "iaasOsSupportStatusDistribution", default, skip_serializing_if = "Option::is_none")]
    pub iaas_os_support_status_distribution: Option<SupportStatusDistribution>,
    #[doc = "Support Status Distribution."]
    #[serde(rename = "iaasSqlSupportStatusDistribution", default, skip_serializing_if = "Option::is_none")]
    pub iaas_sql_support_status_distribution: Option<SupportStatusDistribution>,
    #[doc = "Service Pack Insight."]
    #[serde(rename = "osServicePackInsight", default, skip_serializing_if = "Option::is_none")]
    pub os_service_pack_insight: Option<ServicePackInsight>,
    #[doc = "Service Pack Insight."]
    #[serde(rename = "sqlServicePackInsight", default, skip_serializing_if = "Option::is_none")]
    pub sql_service_pack_insight: Option<ServicePackInsight>,
    #[doc = "Distribution by Operating System Version."]
    #[serde(
        rename = "distributionByOperatingSystemVersion",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub distribution_by_operating_system_version: Vec<DistributionByType>,
    #[doc = "Distribution by Sql Version."]
    #[serde(
        rename = "distributionBySqlVersion",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub distribution_by_sql_version: Vec<DistributionByType>,
    #[doc = "Distribution by Sql Edition."]
    #[serde(
        rename = "distributionBySqlEdition",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub distribution_by_sql_edition: Vec<DistributionByType>,
}
impl OnPremisesIaasSummary {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OnPremisesPaasLicensingCost {
    #[doc = "The version."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub version: Option<String>,
    #[doc = "The total cost."]
    ...
    #[serde(rename = "decomissionServerCost", default, skip_serializing_if = "Option::is_none")]
    pub decomission_server_cost: Option<f32>,
}
impl OnPremisesPaasLicensingCost {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OnPremisesPaasSummary {
    #[doc = "Total servers."]
    #[serde(rename = "totalServers", default, skip_serializing_if = "Option::is_none")]
    ...
    pub memory_utilization: Option<f32>,
    #[doc = "The on premises PaaS cost."]
    #[serde(rename = "totalOnPremisesPaasCost", default, skip_serializing_if = "Option::is_none")]
    pub total_on_premises_paas_cost: Option<CostDetails>,
    #[doc = "The on premises PaaS cost."]
    #[serde(rename = "onPremisesPaasCostForDecommisioned", default, skip_serializing_if = "Option::is_none")]
    pub on_premises_paas_cost_for_decommisioned: Option<CostDetails>,
    #[doc = "The on premises paas licensing cost."]
    #[serde(rename = "onPremisesPaasLicensingCost", default, skip_serializing_if = "Option::is_none")]
    pub on_premises_paas_licensing_cost: Option<OnPremisesPaasLicensingCost>,
    #[doc = "The on premises SQL summary."]
    #[serde(rename = "onPremisesSqlSummary", default, skip_serializing_if = "Option::is_none")]
    pub on_premises_sql_summary: Option<OnPremisesSqlSummary>,
    #[doc = "The on premises web application summary."]
    #[serde(rename = "onPremisesWebAppSummary", default, skip_serializing_if = "Option::is_none")]
    pub on_premises_web_app_summary: Option<OnPremisesWebAppSummary>,
    #[doc = "Support Status Distribution."]
    #[serde(rename = "osSupportStatusDistribution", default, skip_serializing_if = "Option::is_none")]
    pub os_support_status_distribution: Option<SupportStatusDistribution>,
    #[doc = "Support Status Distribution."]
    #[serde(rename = "sqlSupportStatusDistribution", default, skip_serializing_if = "Option::is_none")]
    pub sql_support_status_distribution: Option<SupportStatusDistribution>,
    #[doc = "Service Pack Insight."]
    #[serde(rename = "osServicePackInsight", default, skip_serializing_if = "Option::is_none")]
    pub os_service_pack_insight: Option<ServicePackInsight>,
    #[doc = "Service Pack Insight."]
...
#[doc = "The on premises SQL summary."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OnPremisesSqlSummary {
    #[doc = "The number of SQL instances."]
    #[serde(rename = "sqlInstances", default, skip_serializing_if = "Option::is_none")]
    pub sql_instances: Option<i32>,
    #[doc = "The number of SQL databases."]
    #[serde(rename = "sqlDatabases", default, skip_serializing_if = "Option::is_none")]
    pub sql_databases: Option<i32>,
    #[doc = "Distribution by SQL version."]
    #[serde(
        rename = "distributionBySqlVersion",
        default,
    ...
    pub distribution_by_sql_version: Vec<SqlVersionDetails>,
    #[doc = "The SQL on premises utilization insights."]
    #[serde(rename = "sqlOnPremisesUtilizationData", default, skip_serializing_if = "Option::is_none")]
    pub sql_on_premises_utilization_data: Option<UtilizationData>,
    #[doc = "Distribution by Sql Edition."]
    #[serde(
        rename = "distributionBySqlEdition",
        default,
...
#[doc = "The on premises web application summary."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OnPremisesWebAppSummary {
    #[doc = "The number of web servers."]
    #[serde(rename = "numberOfWebServers", default, skip_serializing_if = "Option::is_none")]
    pub number_of_web_servers: Option<i32>,
    #[doc = "The number of web applications."]
    #[serde(rename = "numberOfWebApplications", default, skip_serializing_if = "Option::is_none")]
    pub number_of_web_applications: Option<i32>,
    #[doc = "The number of web applications per web application type."]
    #[serde(rename = "numberOfWebAppsPerType", default, skip_serializing_if = "Option::is_none")]
    pub number_of_web_apps_per_type: Option<serde_json::Value>,
}
impl OnPremisesWebAppSummary {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Base ARM model of ARM properties for assessment options."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct OptionsArmPropertiesBase {
    #[doc = "Gets the mapping of Assessment Options in graph representation."]
    pub edges: serde_json::Value,
}
impl OptionsArmPropertiesBase {
    pub fn new(edges: serde_json::Value) -> Self {
        Self { edges }
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "Other Management Costs Settings."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct OtherManagementCostsSettings {
    #[doc = "Monitoring Cost Per Server Per Year."]
    #[serde(rename = "monitoringCostPerServerPerYear")]
    pub monitoring_cost_per_server_per_year: f32,
    #[doc = "Patching Cost Per Server Per Year."]
    #[serde(rename = "patchingCostPerServerPerYear")]
    pub patching_cost_per_server_per_year: f32,
    #[doc = "Data Protection Cost Per Server Per Year."]
    #[serde(rename = "dataProtectionCostPerServerPerYear")]
    pub data_protection_cost_per_server_per_year: f32,
}
impl OtherManagementCostsSettings {
    pub fn new(
        monitoring_cost_per_server_per_year: f32,
        patching_cost_per_server_per_year: f32,
        data_protection_cost_per_server_per_year: f32,
    ) -> Self {
        Self {
            monitoring_cost_per_server_per_year,
            patching_cost_per_server_per_year,
            data_protection_cost_per_server_per_year,
        }
    }
}
...
pub struct OverviewSummary {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<OverviewSummaryProperties>,
}
...
#[doc = "The response of a OverviewSummary list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct OverviewSummaryListResult {
    #[doc = "The OverviewSummary items on this page"]
    pub value: Vec<OverviewSummary>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for OverviewSummaryListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl OverviewSummaryListResult {
    pub fn new(value: Vec<OverviewSummary>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Overview summary properties class."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OverviewSummaryProperties {
    #[doc = "The total Azure cost.."]
    #[serde(rename = "totalAzureCost", default, skip_serializing_if = "Option::is_none")]
    pub total_azure_cost: Option<f32>,
    #[doc = "The total Azure IaaS cost."]
    #[serde(rename = "totalAzureIaasCost", default, skip_serializing_if = "Option::is_none")]
    pub total_azure_iaas_cost: Option<f32>,
    #[doc = "The total Azure PaaS cost."]
    #[serde(rename = "totalAzurePaasCost", default, skip_serializing_if = "Option::is_none")]
    pub total_azure_paas_cost: Option<f32>,
    #[doc = "The total Avs cost."]
    #[serde(rename = "totalAzureAvsCost", default, skip_serializing_if = "Option::is_none")]
    pub total_azure_avs_cost: Option<f32>,
    #[doc = "The windows ahub saving."]
    #[serde(rename = "windowsAhubSavings", default, skip_serializing_if = "Option::is_none")]
    pub windows_ahub_savings: Option<f32>,
    #[doc = "The linux ahub saving."]
    #[serde(rename = "linuxAhubSavings", default, skip_serializing_if = "Option::is_none")]
    pub linux_ahub_savings: Option<f32>,
    #[doc = "The sql ahub saving."]
    #[serde(rename = "sqlAhubSavings", default, skip_serializing_if = "Option::is_none")]
    pub sql_ahub_savings: Option<f32>,
    #[doc = "The total on premises cost."]
    #[serde(rename = "totalOnPremisesCost", default, skip_serializing_if = "Option::is_none")]
    pub total_on_premises_cost: Option<f32>,
    #[doc = "ESU Savings 4 Years."]
    #[serde(rename = "esuSavingsFor4years", default, skip_serializing_if = "Option::is_none")]
    pub esu_savings_for4years: Option<f32>,
    #[doc = "The management cost saving."]
    #[serde(rename = "managementCostSavings", default, skip_serializing_if = "Option::is_none")]
    pub management_cost_savings: Option<f32>,
    #[doc = "The security cost saving."]
    #[serde(rename = "securityCostSavings", default, skip_serializing_if = "Option::is_none")]
    pub security_cost_savings: Option<f32>,
    #[doc = "Shows the year-on-year cost overall."]
    #[serde(rename = "yearOnYearEstimates", default, skip_serializing_if = "Option::is_none")]
    pub year_on_year_estimates: Option<YearOnYearEstimates>,
    #[doc = "Shows the discovered servers by virtualization platform."]
    #[serde(rename = "serversDiscovered", default, skip_serializing_if = "Option::is_none")]
    pub servers_discovered: Option<ServersDiscovered>,
    #[doc = "The SQL on premises utilization insights."]
    #[serde(rename = "utilizationData", default, skip_serializing_if = "Option::is_none")]
    pub utilization_data: Option<UtilizationData>,
    #[doc = "Shows the infrastructure as a service machine OS distribution."]
    #[serde(rename = "iaasOsDistribution", default, skip_serializing_if = "Option::is_none")]
    pub iaas_os_distribution: Option<IaasOsDistribution>,
    #[doc = "Support Status Distribution."]
    #[serde(rename = "osSupportStatusDistribution", default, skip_serializing_if = "Option::is_none")]
    pub os_support_status_distribution: Option<SupportStatusDistribution>,
    #[doc = "Support Status Distribution."]
    ...
    #[serde(rename = "paasDistribution", default, skip_serializing_if = "Option::is_none")]
    pub paas_distribution: Option<PaasDistribution>,
}
impl OverviewSummaryProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Pricing Tier for Azure."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "PosAzurePricingTier")]
pub enum PosAzurePricingTier {
    Unknown,
    Standard,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for PosAzurePricingTier {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for PosAzurePricingTier {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for PosAzurePricingTier {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("PosAzurePricingTier", 0u32, "Unknown"),
            Self::Standard => serializer.serialize_unit_variant("PosAzurePricingTier", 1u32, "Standard"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "Shows the distribution of platforms."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PaasDistribution {
    #[doc = "Number of SQL Server machines."]
    #[serde(rename = "sqlServers", default, skip_serializing_if = "Option::is_none")]
    pub sql_servers: Option<i32>,
    #[doc = "Number of IIS Web servers."]
    #[serde(rename = "iisWebServers", default, skip_serializing_if = "Option::is_none")]
    pub iis_web_servers: Option<i32>,
    #[doc = "Distribution of webapps for each target type."]
    #[serde(rename = "webAppDistribution", default, skip_serializing_if = "Option::is_none")]
    pub web_app_distribution: Option<serde_json::Value>,
}
impl PaasDistribution {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PaasSummary {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Paas summary properties class."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<PaasSummaryProperties>,
}
impl PaasSummary {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "The response of a PaasSummary list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct PaasSummaryListResult {
    #[doc = "The PaasSummary items on this page"]
    pub value: Vec<PaasSummary>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for PaasSummaryListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl PaasSummaryListResult {
    pub fn new(value: Vec<PaasSummary>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Paas summary properties class."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PaasSummaryProperties {
    #[doc = "Shows the PaaS Azure summary."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub azure: Option<AzurePaasSummary>,
    #[doc = "Shows platform as a service (PaaS) summary."]
    #[serde(rename = "onPremises", default, skip_serializing_if = "Option::is_none")]
    pub on_premises: Option<OnPremisesPaasSummary>,
}
impl PaasSummaryProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct PerfDataSettings {
    ...
    #[doc = "Gets or sets perf data start time."]
    #[serde(rename = "perfDataStartTime", default, with = "azure_core::date::rfc3339::option")]
    pub perf_data_start_time: Option<::time::OffsetDateTime>,
    #[doc = "Gets or sets perf data end time."]
    #[serde(rename = "perfDataEndTime", default, with = "azure_core::date::rfc3339::option")]
    pub perf_data_end_time: Option<::time::OffsetDateTime>,
    #[doc = "Percentile for Performance Data."]
    pub percentile: Percentile,
}
impl PerfDataSettings {
    pub fn new(time_range: TimeRange, percentile: Percentile) -> Self {
        Self {
            time_range,
...
impl Serialize for PricingTier {
    ...
    {
        match self {
            Self::Standard => serializer.serialize_unit_variant("PricingTier", 0u32, "Standard"),
            Self::Free => serializer.serialize_unit_variant("PricingTier", 1u32, "Free"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "The status of the current operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ProvisioningState2")]
pub enum ProvisioningState2 {
    Succeeded,
    Failed,
    Canceled,
    Provisioning,
...
impl FromStr for ProvisioningState2 {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for ProvisioningState2 {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for ProvisioningState2 {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Succeeded => serializer.serialize_unit_variant("ProvisioningState2", 0u32, "Succeeded"),
            Self::Failed => serializer.serialize_unit_variant("ProvisioningState2", 1u32, "Failed"),
            Self::Canceled => serializer.serialize_unit_variant("ProvisioningState2", 2u32, "Canceled"),
            Self::Provisioning => serializer.serialize_unit_variant("ProvisioningState2", 3u32, "Provisioning"),
            Self::Updating => serializer.serialize_unit_variant("ProvisioningState2", 4u32, "Updating"),
            Self::Deleting => serializer.serialize_unit_variant("ProvisioningState2", 5u32, "Deleting"),
            Self::Accepted => serializer.serialize_unit_variant("ProvisioningState2", 6u32, "Accepted"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl Serialize for ProvisioningStatus {
    ...
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("ProvisioningStatus", 0u32, "Unknown"),
            Self::Succeeded => serializer.serialize_unit_variant("ProvisioningStatus", 1u32, "Succeeded"),
            Self::Failed => serializer.serialize_unit_variant("ProvisioningStatus", 2u32, "Failed"),
            Self::Canceled => serializer.serialize_unit_variant("ProvisioningStatus", 3u32, "Canceled"),
            Self::InProgress => serializer.serialize_unit_variant("ProvisioningStatus", 4u32, "InProgress"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl Serialize for Readiness {
    ...
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("Readiness", 0u32, "Unknown"),
            Self::NotReady => serializer.serialize_unit_variant("Readiness", 1u32, "NotReady"),
            Self::ReadyWithConditions => serializer.serialize_unit_variant("Readiness", 2u32, "ReadyWithConditions"),
            Self::Ready => serializer.serialize_unit_variant("Readiness", 3u32, "Ready"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct RecommendationResult {
    #[doc = "Data model of Cores and Memory Compute Resource."]
    pub request: ComputeResource,
    #[doc = "Data model of Cores and Memory Compute Resource."]
    pub limit: ComputeResource,
    #[doc = "Operating System Type."]
    #[serde(rename = "osType")]
    pub os_type: OsType,
    #[doc = "Gets cluster name."]
    #[serde(rename = "clusterName")]
    pub cluster_name: String,
    #[doc = "Gets node pool id."]
    #[serde(rename = "nodePoolId")]
    pub node_pool_id: String,
    #[doc = "Gets node pool name."]
    #[serde(rename = "nodePoolName")]
    pub node_pool_name: String,
    #[doc = "Gets node pool arm sku name."]
    #[serde(rename = "nodePoolArmSkuName")]
    pub node_pool_arm_sku_name: String,
    #[doc = "Gets approximate monthly cost."]
    #[serde(rename = "approxMonthlyCost")]
    pub approx_monthly_cost: f32,
}
impl RecommendationResult {
    pub fn new(
        ...
        node_pool_arm_sku_name: String,
        approx_monthly_cost: f32,
    ) -> Self {
        Self {
            request,
            limit,
...
#[doc = "Azure Avs Node summary."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RecommendedAvsNodeTypeSummary {
    #[doc = "AVS node type."]
    #[serde(rename = "avsNodeType", default, skip_serializing_if = "Option::is_none")]
    pub avs_node_type: Option<String>,
    #[doc = "Number of nodes."]
    #[serde(rename = "numberOfNodes", default, skip_serializing_if = "Option::is_none")]
    pub number_of_nodes: Option<i32>,
    #[doc = "FTT and RAID Level."]
...
impl RecommendedAvsNodeTypeSummary {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "The recommended VM family summary."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RecommendedVmFamilySummary {
    #[doc = "The Azure VM family."]
    #[serde(rename = "azureVmFamily", default, skip_serializing_if = "Option::is_none")]
    pub azure_vm_family: Option<String>,
    #[doc = "The number of machines."]
    #[serde(rename = "numberOfMachines", default, skip_serializing_if = "Option::is_none")]
    pub number_of_machines: Option<i32>,
}
impl RecommendedVmFamilySummary {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Data Model for Dictionary<string, int>."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RecordOfInt {}
impl RecordOfInt {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Data Model for Dictionary<string, string[]>."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RecordOfStringArray {}
impl RecordOfStringArray {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ReportDetails {
    ...
    #[serde(rename = "reportStatus", default, skip_serializing_if = "Option::is_none")]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ReportDownloadUrl {
    #[doc = "Hyperlink to download report."]
    #[serde(rename = "businessCaseReportUrl", default, skip_serializing_if = "Option::is_none")]
    pub business_case_report_url: Option<String>,
    #[doc = "Expiry date of download url."]
    #[serde(rename = "expirationTime", default, with = "azure_core::date::rfc3339::option")]
    pub expiration_time: Option<::time::OffsetDateTime>,
}
impl ReportDownloadUrl {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl Serialize for ReportStatus {
    ...
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("ReportStatus", 0u32, "Unknown"),
            Self::None => serializer.serialize_unit_variant("ReportStatus", 1u32, "None"),
            Self::InProgress => serializer.serialize_unit_variant("ReportStatus", 2u32, "InProgress"),
            Self::Failed => serializer.serialize_unit_variant("ReportStatus", 3u32, "Failed"),
            Self::Completed => serializer.serialize_unit_variant("ReportStatus", 4u32, "Completed"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl Serialize for ReportType {
    ...
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("ReportType", 0u32, "Unknown"),
            Self::Excel => serializer.serialize_unit_variant("ReportType", 1u32, "Excel"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "Business case supported Savings Option types."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "SavingsOption")]
pub enum SavingsOption {
    Unknown,
    #[serde(rename = "RI3Year")]
    Ri3Year,
    SavingsPlan3Year,
...
impl FromStr for SavingsOption {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for SavingsOption {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for SavingsOption {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("SavingsOption", 0u32, "Unknown"),
            Self::Ri3Year => serializer.serialize_unit_variant("SavingsOption", 1u32, "RI3Year"),
            Self::SavingsPlan3Year => serializer.serialize_unit_variant("SavingsOption", 2u32, "SavingsPlan3Year"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "Savings Options for Azure."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "SavingsOptions")]
pub enum SavingsOptions {
    None,
    OneYearSavings,
    ThreeYearsSavings,
    OneYearReserved,
...
impl FromStr for SavingsOptions {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for SavingsOptions {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for SavingsOptions {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::None => serializer.serialize_unit_variant("SavingsOptions", 0u32, "None"),
            Self::OneYearSavings => serializer.serialize_unit_variant("SavingsOptions", 1u32, "OneYearSavings"),
            Self::ThreeYearsSavings => serializer.serialize_unit_variant("SavingsOptions", 2u32, "ThreeYearsSavings"),
            Self::OneYearReserved => serializer.serialize_unit_variant("SavingsOptions", 3u32, "OneYearReserved"),
            Self::ThreeYearsReserved => serializer.serialize_unit_variant("SavingsOptions", 4u32, "ThreeYearsReserved"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct SecuritySettings {
    #[doc = "Physical servers per administrator."]
    #[serde(rename = "serverSecurityCostPerServerPerYear")]
    pub server_security_cost_per_server_per_year: f32,
    #[doc = "Virtual machines per administrator."]
    #[serde(rename = "sqlServerSecurityCostPerServerPerYear")]
    pub sql_server_security_cost_per_server_per_year: f32,
}
impl SecuritySettings {
    pub fn new(server_security_cost_per_server_per_year: f32, sql_server_security_cost_per_server_per_year: f32) -> Self {
        Self {
...
#[doc = "Service Pack Insight."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ServicePackInsight {
    #[doc = "Unknown support."]
    #[serde(rename = "unknownServicePack", default, skip_serializing_if = "Option::is_none")]
    pub unknown_service_pack: Option<i32>,
    #[doc = "Patched Service Pack Insight."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub patched: Option<i32>,
    #[doc = "Unpatched Service Pack Insight."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub unpatched: Option<i32>,
}
impl ServicePackInsight {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct Settings {
    #[doc = "Azure settings for a business case."]
    #[serde(rename = "azureSettings")]
    pub azure_settings: AzureSettings,
    #[doc = "On-premise settings."]
    #[serde(rename = "onPremiseSettings", default, skip_serializing_if = "Option::is_none")]
    pub on_premise_settings: Option<OnPremiseSettings>,
}
impl Settings {
    pub fn new(azure_settings: AzureSettings) -> Self {
        Self {
            azure_settings,
            on_premise_settings: None,
        }
    }
}
...
impl Serialize for SqlServerLicenseType {
    ...
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("SqlServerLicenseType", 0u32, "Unknown"),
            Self::Enterprise => serializer.serialize_unit_variant("SqlServerLicenseType", 1u32, "Enterprise"),
            Self::Standard => serializer.serialize_unit_variant("SqlServerLicenseType", 2u32, "Standard"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "SQL Server licensing settings."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SqlServerLicensingSettings {
    #[doc = "Business case supported SQL Server License types."]
    pub version: SqlServerLicenseType,
    #[doc = "Licence cost."]
    #[serde(rename = "licenseCost")]
    pub license_cost: f32,
...
impl SqlServerLicensingSettings {
    pub fn new(version: SqlServerLicenseType, license_cost: f32, software_assurance_cost: f32) -> Self {
        Self {
            version,
            license_cost,
            software_assurance_cost,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SqlServiceTier {
    #[doc = "The service tier name."]
    #[serde(rename = "serviceTierName", default, skip_serializing_if = "Option::is_none")]
    pub service_tier_name: Option<String>,
    #[doc = "The number of sql entities with this tier."]
    #[serde(rename = "serviceTierNumber", default, skip_serializing_if = "Option::is_none")]
    pub service_tier_number: Option<f32>,
}
impl SqlServiceTier {
    pub fn new() -> Self {
        Self::default()
...
pub struct StorageSettings {
    #[doc = "Cost per gigabyte per month."]
    #[serde(rename = "costPerGbPerMonth")]
    pub cost_per_gb_per_month: f32,
    #[doc = "Maintenance cost percentage."]
    #[serde(rename = "maintainanceCostPercentageToAcquisitionCost")]
    pub maintainance_cost_percentage_to_acquisition_cost: f32,
}
impl StorageSettings {
    pub fn new(cost_per_gb_per_month: f32, maintainance_cost_percentage_to_acquisition_cost: f32) -> Self {
        Self {
...
#[doc = "Suggested Migration Tool for Azure."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "SuggestedMigrationTool")]
pub enum SuggestedMigrationTool {
    None,
    WebAppMigration,
    ServerMigration,
    #[serde(skip_deserializing)]
...
impl FromStr for SuggestedMigrationTool {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for SuggestedMigrationTool {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for SuggestedMigrationTool {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::None => serializer.serialize_unit_variant("SuggestedMigrationTool", 0u32, "None"),
            Self::WebAppMigration => serializer.serialize_unit_variant("SuggestedMigrationTool", 1u32, "WebAppMigration"),
            Self::ServerMigration => serializer.serialize_unit_variant("SuggestedMigrationTool", 2u32, "ServerMigration"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "Suitability for Azure."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
impl Serialize for Suitability {
    ...
    {
        match self {
            Self::NotSuitable => serializer.serialize_unit_variant("Suitability", 0u32, "NotSuitable"),
            Self::Suitable => serializer.serialize_unit_variant("Suitability", 1u32, "Suitable"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct SuitabilityResult {
    ...
    #[doc = "Gets list of failed Checks."]
    #[serde(rename = "failedChecks")]
    pub failed_checks: Vec<Check>,
    #[doc = "Suggested Migration Tool for Azure."]
    #[serde(rename = "suggestedMigrationTool")]
    pub suggested_migration_tool: SuggestedMigrationTool,
}
impl SuitabilityResult {
    pub fn new(
        ...
        suggested_migration_tool: SuggestedMigrationTool,
    ) -> Self {
        Self {
            readiness,
            suitability,
...
#[doc = "Data model of Summary Details."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
impl SummaryDetails {
    pub fn new(count: i32, monthly_cost: f32) -> Self {
        Self { count, monthly_cost }
    }
}
#[doc = "Base ARM model of Assessment Summary ARM properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SummaryPropertiesBase {
    #[doc = "Gets the assessment name."]
    #[serde(rename = "assessmentName")]
    pub assessment_name: String,
    #[doc = "Gets the summary name."]
    #[serde(rename = "summaryName")]
    pub summary_name: String,
    #[doc = "Gets the cloud suitability summary for all entities in the assessment per target."]
    #[serde(rename = "suitabilityPerTarget")]
    pub suitability_per_target: serde_json::Value,
    #[doc = "Gets the monthly compute cost."]
    #[serde(rename = "monthlyComputeCost")]
    pub monthly_compute_cost: f32,
    #[doc = "Gets the monthly storage cost."]
    #[serde(rename = "monthlyStorageCost")]
    pub monthly_storage_cost: f32,
    #[doc = "Gets the confidence score."]
    #[serde(rename = "confidenceScore")]
    pub confidence_score: f32,
}
impl SummaryPropertiesBase {
    pub fn new(
        assessment_name: String,
        summary_name: String,
        suitability_per_target: serde_json::Value,
        monthly_compute_cost: f32,
        monthly_storage_cost: f32,
        confidence_score: f32,
    ) -> Self {
        Self {
            assessment_name,
            summary_name,
            suitability_per_target,
...
#[doc = "Support Status Distribution."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SupportStatusDistribution {
    #[doc = "Unknown support."]
    #[serde(rename = "unknownSupport", default, skip_serializing_if = "Option::is_none")]
    pub unknown_support: Option<i32>,
    #[doc = "Mainstream support."]
    #[serde(rename = "mainStream", default, skip_serializing_if = "Option::is_none")]
    pub main_stream: Option<i32>,
    #[doc = "Extended support."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub extended: Option<i32>,
    #[doc = "Out of support."]
    #[serde(rename = "outOfSupport", default, skip_serializing_if = "Option::is_none")]
    pub out_of_support: Option<i32>,
}
impl SupportStatusDistribution {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Supportability Status."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "SupportabilityStatus")]
pub enum SupportabilityStatus {
    Unknown,
    Mainstream,
    Extended,
    OutOfSupport,
...
impl FromStr for SupportabilityStatus {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for SupportabilityStatus {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for SupportabilityStatus {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("SupportabilityStatus", 0u32, "Unknown"),
            Self::Mainstream => serializer.serialize_unit_variant("SupportabilityStatus", 1u32, "Mainstream"),
            Self::Extended => serializer.serialize_unit_variant("SupportabilityStatus", 2u32, "Extended"),
            Self::OutOfSupport => serializer.serialize_unit_variant("SupportabilityStatus", 3u32, "OutOfSupport"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "Target specific result."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct TargetSpecificResult {
    #[doc = "Assessment results."]
    #[serde(rename = "assessmentResult")]
    pub assessment_result: AssessmentResult,
    #[doc = "Gets or sets the web app migration issues."]
    #[serde(rename = "migrationIssues")]
    pub migration_issues: Vec<WebAppMigrationIssues>,
}
impl TargetSpecificResult {
    pub fn new(assessment_result: AssessmentResult, migration_issues: Vec<WebAppMigrationIssues>) -> Self {
        Self {
            assessment_result,
            migration_issues,
        }
...
#[doc = "Web app target specific summary data."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct TargetSpecificSummary {
    #[doc = "Web app readiness summary data"]
    #[serde(rename = "readinessSummary", default, skip_serializing_if = "Option::is_none")]
    pub readiness_summary: Option<serde_json::Value>,
    #[doc = "Web app recommendation sku details data"]
    #[serde(rename = "recommendationResultSkuDetails", default, skip_serializing_if = "Option::is_none")]
    pub recommendation_result_sku_details: Option<serde_json::Value>,
}
impl TargetSpecificSummary {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Third Party Management settings."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ThirdPartyManagementSettings {
    #[doc = "License Cost."]
    #[serde(rename = "licenseCost")]
    pub license_cost: f32,
    #[doc = "Support Cost."]
    #[serde(rename = "supportCost")]
    pub support_cost: f32,
}
impl ThirdPartyManagementSettings {
    pub fn new(license_cost: f32, support_cost: f32) -> Self {
        Self {
            license_cost,
            support_cost,
        }
...
pub struct UtilizationData {
    ...
    #[serde(rename = "numberOfActiveEntities", default, skip_serializing_if = "Option::is_none")]
    pub number_of_active_entities: Option<i32>,
    #[doc = "The number of inactive entities."]
    #[serde(rename = "numberOfInactiveEntities", default, skip_serializing_if = "Option::is_none")]
    pub number_of_inactive_entities: Option<i32>,
    #[doc = "The number of decommission entities."]
    #[serde(rename = "numberOfDecommisionEntities", default, skip_serializing_if = "Option::is_none")]
    pub number_of_decommision_entities: Option<i32>,
    #[doc = "The number of unknown entities."]
    #[serde(rename = "numberOfUnknownEntities", default, skip_serializing_if = "Option::is_none")]
    pub number_of_unknown_entities: Option<i32>,
}
...
#[doc = "Virtualization software settings."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct VirtualizationSoftwareSettings {
    #[doc = "Number of physical cores per licence."]
    #[serde(rename = "numberOfPhysicalCoresPerLicense")]
    pub number_of_physical_cores_per_license: i32,
    #[doc = "Software Assurance cost."]
    ...
    #[doc = "Licence and support list."]
    #[serde(rename = "licenseAndSupportList")]
    pub license_and_support_list: Vec<VsphereLicense>,
}
impl VirtualizationSoftwareSettings {
    pub fn new(
        number_of_physical_cores_per_license: i32,
        software_assurance_cost: f32,
        license_and_support_list: Vec<VsphereLicense>,
    ) -> Self {
        Self {
            number_of_physical_cores_per_license,
            software_assurance_cost,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct VsphereLicense {
    #[serde(flatten)]
    pub vsphere_license_base: VsphereLicenseBase,
    #[doc = "Business case supported VmWare License types."]
    #[serde(rename = "licenseType")]
    pub license_type: LicenseType,
}
impl VsphereLicense {
    pub fn new(vsphere_license_base: VsphereLicenseBase, license_type: LicenseType) -> Self {
        Self {
            vsphere_license_base,
            license_type,
        }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct VsphereLicenseBase {
    #[doc = "Cost of a licence."]
    #[serde(rename = "licenseCost")]
    pub license_cost: f32,
    #[doc = "Basic support cost."]
    #[serde(rename = "basicSupportCost")]
    pub basic_support_cost: f32,
    #[doc = "Production support cost."]
    #[serde(rename = "productionSupportCost")]
    pub production_support_cost: f32,
}
impl VsphereLicenseBase {
    pub fn new(license_cost: f32, basic_support_cost: f32, production_support_cost: f32) -> Self {
        Self {
            license_cost,
            basic_support_cost,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct VsphereManagementLicense {
    #[serde(flatten)]
    pub vsphere_license_base: VsphereLicenseBase,
    #[doc = "Business case supported Vsphere Management License types."]
    #[serde(rename = "licenseType")]
    pub license_type: VsphereManagementLicenseType,
}
impl VsphereManagementLicense {
    pub fn new(vsphere_license_base: VsphereLicenseBase, license_type: VsphereManagementLicenseType) -> Self {
        Self {
            vsphere_license_base,
            license_type,
        }
...
#[doc = "Business case supported Vsphere Management License types."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "VsphereManagementLicenseType")]
pub enum VsphereManagementLicenseType {
    Unknown,
    VSphereServerStandard,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for VsphereManagementLicenseType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for VsphereManagementLicenseType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for VsphereManagementLicenseType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("VsphereManagementLicenseType", 0u32, "Unknown"),
            Self::VSphereServerStandard => serializer.serialize_unit_variant("VsphereManagementLicenseType", 1u32, "VSphereServerStandard"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "Vsphere management settings."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct VsphereManagementSettings {
    #[doc = "Licence and support list."]
    #[serde(rename = "licenseAndSupportList")]
    pub license_and_support_list: Vec<VsphereManagementLicense>,
}
impl VsphereManagementSettings {
    pub fn new(license_and_support_list: Vec<VsphereManagementLicense>) -> Self {
        Self { license_and_support_list }
    }
}
#[doc = "Data model of Web App."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct WebApp {
    #[doc = "Gets discovery arm id."]
    #[serde(rename = "discoveryArmId")]
    pub discovery_arm_id: String,
    #[doc = "Gets display name."]
    #[serde(rename = "displayName")]
    pub display_name: String,
    #[doc = "Gets web server arm id."]
    #[serde(rename = "webServerArmId")]
    pub web_server_arm_id: String,
    #[doc = "Gets web server display name."]
    #[serde(rename = "webServerDisplayName")]
    pub web_server_display_name: String,
    #[doc = "Gets machine arm id."]
    #[serde(rename = "machineArmId")]
    pub machine_arm_id: String,
    #[doc = "Gets machine display name."]
    #[serde(rename = "machineDisplayName")]
    pub machine_display_name: String,
    #[doc = "Web App Type."]
    #[serde(rename = "webAppType")]
    pub web_app_type: WebAppType,
}
impl WebApp {
    pub fn new(
        discovery_arm_id: String,
        display_name: String,
        web_server_arm_id: String,
        web_server_display_name: String,
        machine_arm_id: String,
        machine_display_name: String,
        web_app_type: WebAppType,
    ) -> Self {
        Self {
            discovery_arm_id,
            display_name,
            web_server_arm_id,
            web_server_display_name,
            machine_arm_id,
...
#[doc = "Web app Assessment options web model object."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct WebAppAssessmentOptions {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Web app Assessment options properties Web model object."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<WebAppAssessmentOptionsProperties>,
}
impl WebAppAssessmentOptions {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The response of a WebAppAssessmentOptions list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct WebAppAssessmentOptionsListResult {
    #[doc = "The WebAppAssessmentOptions items on this page"]
    pub value: Vec<WebAppAssessmentOptions>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for WebAppAssessmentOptionsListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl WebAppAssessmentOptionsListResult {
    pub fn new(value: Vec<WebAppAssessmentOptions>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Web app Assessment options properties Web model object."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct WebAppAssessmentOptionsProperties {
    #[doc = "Gets the list of web app target options."]
    #[serde(
        rename = "webAppSkus",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub web_app_skus: Vec<WebAppTargetOptions>,
    #[doc = "Gets or sets the list of Azure locations supporting Saving Plans for IAAS."]
    #[serde(
        rename = "savingsPlanSupportedLocations",
        default,
    ...
    #[doc = "Gets or sets the list of currencies supported for Reserved Instances."]
    #[serde(
        rename = "reservedInstanceSupportedWebAppTiers",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub reserved_instance_supported_web_app_tiers: Vec<AzureWebAppTier>,
    #[doc = "Gets or sets the list of Azure Offers supporting Saving Plans."]
    #[serde(
        rename = "savingsPlanSupportedWebAppTiers",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub savings_plan_supported_web_app_tiers: Vec<AzureWebAppTier>,
}
impl WebAppAssessmentOptionsProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Web app Assessment REST resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct WebAppAssessmentV2 {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Web app assessment properties class."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<WebAppAssessmentV2Properties>,
}
impl WebAppAssessmentV2 {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The response of a WebAppAssessmentV2 list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct WebAppAssessmentV2ListResult {
    #[doc = "The WebAppAssessmentV2 items on this page"]
    pub value: Vec<WebAppAssessmentV2>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for WebAppAssessmentV2ListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl WebAppAssessmentV2ListResult {
    pub fn new(value: Vec<WebAppAssessmentV2>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Web app assessment properties class."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct WebAppAssessmentV2Properties {
    #[serde(flatten)]
    pub azure_resource_properties2: AzureResourceProperties2,
    #[serde(rename = "environmentType", default, skip_serializing_if = "Option::is_none")]
    pub environment_type: Option<EnvironmentType>,
    ...
    pub ea_subscription_id: Option<String>,
    #[doc = "App service native settings."]
    #[serde(rename = "appSvcNativeSettings", default, skip_serializing_if = "Option::is_none")]
    pub app_svc_native_settings: Option<AppSvcNativeSettings>,
    #[doc = "App service container settings."]
    #[serde(rename = "appSvcContainerSettings", default, skip_serializing_if = "Option::is_none")]
    pub app_svc_container_settings: Option<AppSvcContainerSettings>,
    #[doc = "Discovered entity light summary."]
    #[serde(rename = "discoveredEntityLightSummary", default, skip_serializing_if = "Option::is_none")]
    pub discovered_entity_light_summary: Option<DiscoveredEntityLightSummary>,
    #[serde(rename = "azureSecurityOfferingType", default, skip_serializing_if = "Option::is_none")]
    pub azure_security_offering_type: Option<AzureSecurityOfferingType>,
    #[serde(rename = "reservedInstance", default, skip_serializing_if = "Option::is_none")]
    pub reserved_instance: Option<AzureReservedInstance>,
...
impl WebAppAssessmentV2Properties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Web app Assessment REST resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct WebAppAssessmentV2Summary {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Web app Assessment V2 summary properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<WebAppAssessmentV2SummaryProperties>,
}
impl WebAppAssessmentV2Summary {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The response of a WebAppAssessmentV2Summary list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct WebAppAssessmentV2SummaryListResult {
    #[doc = "The WebAppAssessmentV2Summary items on this page"]
    pub value: Vec<WebAppAssessmentV2Summary>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for WebAppAssessmentV2SummaryListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl WebAppAssessmentV2SummaryListResult {
    pub fn new(value: Vec<WebAppAssessmentV2Summary>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Web app Assessment V2 summary properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct WebAppAssessmentV2SummaryProperties {
    #[doc = "Gets or sets the discovered entities summary."]
    #[serde(rename = "assessmentSummary", default, skip_serializing_if = "Option::is_none")]
    pub assessment_summary: Option<serde_json::Value>,
    #[doc = "Gets the target specific summary."]
    #[serde(rename = "targetSpecificSummary", default, skip_serializing_if = "Option::is_none")]
    pub target_specific_summary: Option<serde_json::Value>,
}
impl WebAppAssessmentV2SummaryProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct WebAppCollector {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Collector properties class."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<WebAppCollectorPropertiesBaseWithAgent>,
}
impl WebAppCollector {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The response of a WebAppCollector list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct WebAppCollectorListResult {
    #[doc = "The WebAppCollector items on this page"]
    pub value: Vec<WebAppCollector>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for WebAppCollectorListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl WebAppCollectorListResult {
    pub fn new(value: Vec<WebAppCollector>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Collector properties class."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct WebAppCollectorPropertiesBaseWithAgent {
    #[serde(flatten)]
    pub azure_resource_properties2: AzureResourceProperties2,
    #[doc = "Collector agent property class."]
    #[serde(rename = "agentProperties", default, skip_serializing_if = "Option::is_none")]
...
impl WebAppCollectorPropertiesBaseWithAgent {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct WebAppDistribution {
    #[doc = "Business case supported WebApp types."]
    #[serde(rename = "webAppType", default, skip_serializing_if = "Option::is_none")]
    pub web_app_type: Option<WebAppTypes>,
    #[doc = "The cost details."]
    #[serde(rename = "numberOfWebApps", default, skip_serializing_if = "Option::is_none")]
    pub number_of_web_apps: Option<f32>,
}
impl WebAppDistribution {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Web app migration issues."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct WebAppMigrationIssues {
    #[doc = "Gets or sets the issue Id."]
    #[serde(rename = "issueId")]
    pub issue_id: String,
    #[serde(rename = "issueCategory")]
    pub issue_category: AzureWebAppSuitabilityIssueCategory,
    #[doc = "Gets or sets the issue description list."]
    #[serde(rename = "issueDescriptionList")]
    pub issue_description_list: Vec<String>,
}
impl WebAppMigrationIssues {
    pub fn new(issue_id: String, issue_category: AzureWebAppSuitabilityIssueCategory, issue_description_list: Vec<String>) -> Self {
        Self {
            issue_id,
            issue_category,
...
#[doc = "Assessed Web app web model class."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct WebAppServicePlanV2 {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Assessed Web app database properties web model."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<WebAppServicePlanV2Properties>,
}
impl WebAppServicePlanV2 {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The response of a WebAppServicePlanV2 list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct WebAppServicePlanV2ListResult {
    #[doc = "The WebAppServicePlanV2 items on this page"]
    pub value: Vec<WebAppServicePlanV2>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for WebAppServicePlanV2ListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl WebAppServicePlanV2ListResult {
    pub fn new(value: Vec<WebAppServicePlanV2>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Assessed Web app database properties web model."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct WebAppServicePlanV2Properties {
    #[doc = "Web App Type."]
    #[serde(rename = "webAppType", default, skip_serializing_if = "Option::is_none")]
    pub web_app_type: Option<WebAppType>,
    #[serde(rename = "webAppTargetType", default, skip_serializing_if = "Option::is_none")]
    pub web_app_target_type: Option<AzureWebAppTargetType>,
    #[doc = "Gets or sets the app service plan name."]
    #[serde(rename = "webAppServicePlanName")]
    pub web_app_service_plan_name: String,
    #[doc = "Gets the machine name."]
    #[serde(rename = "numberOfWebApps")]
    pub number_of_web_apps: i32,
    #[doc = "Gets or sets the server ARM Id."]
    #[serde(rename = "monthlyCost", default, skip_serializing_if = "Option::is_none")]
    pub monthly_cost: Option<f32>,
    #[doc = "Gets or sets the web server name."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub storage: Option<f64>,
    #[doc = "Gets or sets web app name."]
    #[serde(rename = "scaleOutInstances", default, skip_serializing_if = "Option::is_none")]
    pub scale_out_instances: Option<i32>,
    #[doc = "Gets the discovered web app ID."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cores: Option<i32>,
    #[doc = "Machine arm id."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ram: Option<f64>,
    #[doc = "Web app sku name."]
    #[serde(rename = "webAppSkuName", default, skip_serializing_if = "Option::is_none")]
    pub web_app_sku_name: Option<String>,
    #[doc = "Web app sku size."]
    #[serde(rename = "webAppSkuSize", default, skip_serializing_if = "Option::is_none")]
    pub web_app_sku_size: Option<String>,
    #[doc = "When was assessed SQL database first created."]
    #[serde(rename = "createdTimestamp", default, with = "azure_core::date::rfc3339::option")]
    pub created_timestamp: Option<::time::OffsetDateTime>,
    #[doc = "When was assessed Web app database last updated."]
...
impl WebAppServicePlanV2Properties {
    pub fn new(web_app_service_plan_name: String, number_of_web_apps: i32) -> Self {
        Self {
            web_app_type: None,
            web_app_target_type: None,
            web_app_service_plan_name,
            number_of_web_apps,
            monthly_cost: None,
            storage: None,
            scale_out_instances: None,
            cores: None,
            ram: None,
            web_app_sku_name: None,
            web_app_sku_size: None,
            created_timestamp: None,
            updated_timestamp: None,
...
#[doc = "Web app sku details."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct WebAppSkuDetails {
    #[doc = "Total monthly cost"]
    #[serde(rename = "totalMonthlyCost", default, skip_serializing_if = "Option::is_none")]
    pub total_monthly_cost: Option<f32>,
    #[doc = "Monthly security data"]
    #[serde(rename = "monthlySecurityCost", default, skip_serializing_if = "Option::is_none")]
    pub monthly_security_cost: Option<f32>,
    #[doc = "Sku name"]
    ...
    pub sku_name: String,
    #[doc = "Sku size"]
    #[serde(rename = "skuSize")]
    pub sku_size: String,
    #[doc = "App service plan count"]
    #[serde(rename = "appServicePlanCount")]
    pub app_service_plan_count: i32,
}
impl WebAppSkuDetails {
    pub fn new(sku_name: String, sku_size: String, app_service_plan_count: i32) -> Self {
        Self {
            total_monthly_cost: None,
            monthly_security_cost: None,
            sku_name,
            sku_size,
            app_service_plan_count,
        }
    }
}
#[doc = "Web app target options."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct WebAppTargetOptions {
    #[serde(rename = "webAppTier", default, skip_serializing_if = "Option::is_none")]
    pub web_app_tier: Option<AzureWebAppTier>,
    #[doc = "Gets or sets the target location."]
    #[serde(
        rename = "targetLocations",
        default,
...
impl FromStr for WebAppType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for WebAppType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for WebAppType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("WebAppType", 0u32, "Unknown"),
            Self::Iis => serializer.serialize_unit_variant("WebAppType", 1u32, "IIS"),
            Self::Tomcat => serializer.serialize_unit_variant("WebAppType", 2u32, "Tomcat"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "Business case supported WebApp types."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "WebAppTypes")]
pub enum WebAppTypes {
    Unknown,
    #[serde(rename = "ASPNET")]
    Aspnet,
    Java,
...
impl FromStr for WebAppTypes {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for WebAppTypes {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for WebAppTypes {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("WebAppTypes", 0u32, "Unknown"),
            Self::Aspnet => serializer.serialize_unit_variant("WebAppTypes", 1u32, "ASPNET"),
            Self::Java => serializer.serialize_unit_variant("WebAppTypes", 2u32, "Java"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "Windows Server licensing settings."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct WindowsServerLicensingSettings {
    #[doc = "Licence Cost."]
    #[serde(rename = "licenseCost")]
    pub license_cost: f32,
    #[doc = "Software assurance (SA) cost."]
    ...
    #[serde(rename = "licensesPerCore")]
    pub licenses_per_core: i32,
}
impl WindowsServerLicensingSettings {
    pub fn new(license_cost: f32, software_assurance_cost: f32, licenses_per_core: i32) -> Self {
        Self {
            license_cost,
            software_assurance_cost,
            licenses_per_core,
...
#[doc = "Shows the year-on-year cost overall."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct YearOnYearEstimates {
    #[doc = "Year-on-Year on-premises cost."]
    #[serde(rename = "onPremisesCost", default, skip_serializing_if = "Option::is_none")]
    pub on_premises_cost: Option<serde_json::Value>,
    #[doc = "Year-on-Year Azure cost."]
    #[serde(rename = "azureCost", default, skip_serializing_if = "Option::is_none")]
    pub azure_cost: Option<serde_json::Value>,
    #[doc = "Year-on-Year savings."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub savings: Option<serde_json::Value>,
    #[doc = "Year-on-Year on-premises capex cost."]
    #[serde(rename = "onPremisesCapexCost", default, skip_serializing_if = "Option::is_none")]
    pub on_premises_capex_cost: Option<serde_json::Value>,
    #[doc = "Year-on-Year on-premises opex cost."]
    #[serde(rename = "onPremisesOpexCost", default, skip_serializing_if = "Option::is_none")]
    pub on_premises_opex_cost: Option<serde_json::Value>,
    #[doc = "Year-on-Year azure capex cost."]
    #[serde(rename = "azureCapexCost", default, skip_serializing_if = "Option::is_none")]
    pub azure_capex_cost: Option<serde_json::Value>,
    #[doc = "Year-on-Year azure opex cost."]
    #[serde(rename = "azureOpexCost", default, skip_serializing_if = "Option::is_none")]
    pub azure_opex_cost: Option<serde_json::Value>,
    #[doc = "Payback period."]
    #[serde(rename = "paybackPeriod", default, skip_serializing_if = "Option::is_none")]
    pub payback_period: Option<i32>,
}
impl YearOnYearEstimates {
    pub fn new() -> Self {
        Self::default()
    }
}
