...
pub enum ApiVersions {
    ...
    N2023_04_01_preview,
    #[serde(rename = "2023-05-01-preview")]
    N2023_05_01_preview,
...
impl Serialize for ApiVersions {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::N2023_05_01_preview => serializer.serialize_unit_variant("ApiVersions", 8u32, "2023-05-01-preview"),
            Self::N2023_07_07_preview => serializer.serialize_unit_variant("ApiVersions", 9u32, "2023-07-07-preview"),
...
pub struct AvsAssessedDisk {
    ...
    #[serde(rename = "assessedExternalStorageType", default, skip_serializing_if = "Option::is_none")]
    pub assessed_external_storage_type: Option<ExternalStorageType>,
    #[doc = "Estimated Disk Size in GB."]
    #[serde(rename = "estimatedDiskSizeInGB", default, skip_serializing_if = "Option::is_none")]
    pub estimated_disk_size_in_gb: Option<f32>,
    #[serde(rename = "suitabilityDetail", default, skip_serializing_if = "Option::is_none")]
    pub suitability_detail: Option<AzureDiskSuitabilityDetail>,
}
...
pub struct AvsAssessmentOptionsProperties {
    ...
    #[doc = "AVS External Storage Types Supported."]
    #[serde(
        rename = "avsExternalStorageTypes",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub avs_external_storage_types: Vec<AvsExternalStorageOptions>,
...
pub struct AvsAssessmentProperties {
    ...
    #[serde(
        rename = "failuresToTolerateAndRaidLevelList",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub failures_to_tolerate_and_raid_level_list: Vec<FttAndRaidLevel>,
    ...
    pub node_types: Vec<AzureAvsNodeType>,
    #[doc = "List of AVS external storage types."]
    #[serde(
        rename = "externalStorageTypes",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub external_storage_types: Vec<ExternalStorageType>,
    #[doc = "Scenarios with which Avs Assessments can be created."]
    #[serde(rename = "avsAssessmentScenario", default, skip_serializing_if = "Option::is_none")]
    pub avs_assessment_scenario: Option<AvsAssessmentScenario>,
    #[doc = "Is VCF license applied"]
    #[serde(rename = "isVcfByolEnabled", default, skip_serializing_if = "Option::is_none")]
    pub is_vcf_byol_enabled: Option<bool>,
    #[doc = "collection of cost components."]
    #[serde(
        rename = "costComponents",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    #[doc = "EstimatedNodes AVS SKU for Assessment."]
    #[serde(
        rename = "avsEstimatedNodes",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub avs_estimated_nodes: Vec<AvsEstimatedNode>,
    #[doc = "Estimated External Storage for Assessment."]
    #[serde(
        rename = "avsEstimatedExternalStorages",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub avs_estimated_external_storages: Vec<AvsEstimatedExternalStorage>,
    #[doc = "Estimated External Storage for Assessment."]
    #[serde(
        rename = "avsEstimatedNetworks",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub avs_estimated_networks: Vec<AvsEstimatedNetwork>,
...
#[doc = "Scenarios with which Avs Assessments can be created."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "AvsAssessmentScenario")]
pub enum AvsAssessmentScenario {
    Unknown,
    NewAvsSddc,
    AvsSddcExpansion,
    #[serde(skip_deserializing)]
...
impl FromStr for AvsAssessmentScenario {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for AvsAssessmentScenario {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for AvsAssessmentScenario {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("AvsAssessmentScenario", 0u32, "Unknown"),
            Self::NewAvsSddc => serializer.serialize_unit_variant("AvsAssessmentScenario", 1u32, "NewAvsSddc"),
            Self::AvsSddcExpansion => serializer.serialize_unit_variant("AvsAssessmentScenario", 2u32, "AvsSddcExpansion"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AvsEstimatedExternalStorage {
    #[doc = "Total monthly cost for type of storage."]
    #[serde(rename = "monthlyPrice", default, skip_serializing_if = "Option::is_none")]
    pub monthly_price: Option<f32>,
    #[doc = "Different External storage skus."]
    #[serde(rename = "storageType", default, skip_serializing_if = "Option::is_none")]
    pub storage_type: Option<ExternalStorageType>,
    #[doc = "Predicted total Storage used in GB."]
    #[serde(rename = "totalStorageInGB", default, skip_serializing_if = "Option::is_none")]
    pub total_storage_in_gb: Option<f32>,
    #[doc = "Predicted storage utilization."]
...
impl AvsEstimatedExternalStorage {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AvsEstimatedNetwork {
    ...
    pub network_type: Option<NetworkSkuType>,
}
impl AvsEstimatedNetwork {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct AvsEstimatedNode {
    ...
    #[serde(rename = "nodeNumber", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "totalCpu", default, skip_serializing_if = "Option::is_none")]
    ...
    pub total_storage: Option<f32>,
    #[serde(rename = "pricingModel", default, skip_serializing_if = "Option::is_none")]
    pub pricing_model: Option<AzureReservedInstance>,
    #[doc = "FTT and RAID Level."]
    #[serde(rename = "fttRaidLevel", default, skip_serializing_if = "Option::is_none")]
    pub ftt_raid_level: Option<FttAndRaidLevel>,
}
impl AvsEstimatedNode {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "AVS External Storage specific options."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AvsExternalStorageOptions {
    #[doc = "Different External storage skus."]
    #[serde(rename = "storageType", default, skip_serializing_if = "Option::is_none")]
    pub storage_type: Option<ExternalStorageType>,
    #[doc = "List of locations where this storage type is available."]
    #[serde(
...
impl AvsExternalStorageOptions {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct AvsNodeSummary {
    ...
    #[serde(
        rename = "estimatedExternalStorage",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub estimated_external_storage: Vec<EstimatedExternalStorage>,
    #[doc = "Estimated Network"]
    #[serde(
        rename = "estimatedNetwork",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub estimated_network: Vec<EstimatedNetwork>,
    #[doc = "Estimated Cost With VCF BYOL"]
    #[serde(rename = "estimatedCostWithVcfByol", default, skip_serializing_if = "Option::is_none")]
    pub estimated_cost_with_vcf_byol: Option<f32>,
...
impl Serialize for AzureAvsNodeType {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::Av36p => serializer.serialize_unit_variant("AzureAvsNodeType", 2u32, "AV36P"),
            Self::Av52 => serializer.serialize_unit_variant("AzureAvsNodeType", 3u32, "AV52"),
            Self::Av64 => serializer.serialize_unit_variant("AzureAvsNodeType", 4u32, "AV64"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl Serialize for AzureAvsSuitabilityExplanation {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::InternalErrorInRecommendation => {
                serializer.serialize_unit_variant("AzureAvsSuitabilityExplanation", 3u32, "InternalErrorInRecommendation")
            }
            Self::UnsupportedLocationForSelectedExternalStorageTypes => serializer.serialize_unit_variant(
...
impl Serialize for CostComponentName {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::MonthlyAvsNodeCost => serializer.serialize_unit_variant("CostComponentName", 5u32, "MonthlyAvsNodeCost"),
            Self::MonthlyAvsExternalStorageCost => {
                serializer.serialize_unit_variant("CostComponentName", 6u32, "MonthlyAvsExternalStorageCost")
            }
            Self::MonthlyAvsNetworkCost => serializer.serialize_unit_variant("CostComponentName", 7u32, "MonthlyAvsNetworkCost"),
            Self::MonthlyVcfByolCostDifference => {
                serializer.serialize_unit_variant("CostComponentName", 8u32, "MonthlyVcfByolCostDifference")
            }
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
...
#[doc = "Estimated external storage"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EstimatedExternalStorage {
    #[doc = "Different External storage skus."]
    #[serde(rename = "storageType", default, skip_serializing_if = "Option::is_none")]
    pub storage_type: Option<ExternalStorageType>,
    ...
    #[serde(rename = "totalStorageCost", default, skip_serializing_if = "Option::is_none")]
    pub total_storage_cost: Option<f32>,
}
impl EstimatedExternalStorage {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Different External storage skus."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ExternalStorageType")]
...
impl FromStr for ExternalStorageType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for ExternalStorageType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for ExternalStorageType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("ExternalStorageType", 0u32, "Unknown"),
            Self::None => serializer.serialize_unit_variant("ExternalStorageType", 1u32, "None"),
            Self::AnfStandard => serializer.serialize_unit_variant("ExternalStorageType", 2u32, "AnfStandard"),
            Self::AnfPremium => serializer.serialize_unit_variant("ExternalStorageType", 3u32, "AnfPremium"),
            Self::AnfUltra => serializer.serialize_unit_variant("ExternalStorageType", 4u32, "AnfUltra"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "Different network skus."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "NetworkSkuType")]
pub enum NetworkSkuType {
    Unknown,
    None,
    ExpressRouteUltra,
    #[serde(skip_deserializing)]
...
impl FromStr for NetworkSkuType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for NetworkSkuType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for NetworkSkuType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("NetworkSkuType", 0u32, "Unknown"),
            Self::None => serializer.serialize_unit_variant("NetworkSkuType", 1u32, "None"),
            Self::ExpressRouteUltra => serializer.serialize_unit_variant("NetworkSkuType", 2u32, "ExpressRouteUltra"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
