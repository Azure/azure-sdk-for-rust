...
pub mod profiles {
    ...
    impl Client {
        ...
        pub fn get_supported_optimization_types(
            &self,
            resource_group_name: impl Into<String>,
            profile_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ) -> get_supported_optimization_types::Builder {
            get_supported_optimization_types::Builder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                profile_name: profile_name.into(),
                        ...
                        let rsp = match continuation {
                            Some(token) => {
                                ...
                                if !has_api_version_already {
                                    url.query_pairs_mut().append_pair("api-version", "2016-10-02");
                                }
    ...
    pub mod get_supported_optimization_types {
        use super::models;
        type Response = models::SupportedOptimizationTypesResult;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
            DefaultResponse {
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        match rsp_status {
                            http::StatusCode::OK => {
                                let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                                let rsp_value: models::SupportedOptimizationTypesResult =
                                    serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                                Ok(rsp_value)
                            }
                            status_code => {
...
impl Client {
    ...
    pub fn list_resource_usage(&self, subscription_id: impl Into<String>) -> list_resource_usage::Builder {
        list_resource_usage::Builder {
            client: self.clone(),
            subscription_id: subscription_id.into(),
        }
