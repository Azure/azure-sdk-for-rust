...
pub mod profiles {
    ...
    pub async fn get_supported_optimization_types(
        ...
        profile_name: &str,
        subscription_id: &str,
    ) -> Result<SupportedOptimizationTypesResult> {
        let client = &configuration.client;
        let uri_str = &format!(
...
pub async fn list_resource_usage(configuration: &Configuration, subscription_id: &str) -> Result<ResourceUsageListResult> {
    let client = &configuration.client;
    let uri_str = &format!(
