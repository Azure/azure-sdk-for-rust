...
impl Client {
    ...
    pub fn cdn_profiles_client(&self) -> cdn_profiles::Client {
        cdn_profiles::Client(self.clone())
    }
...
pub mod profiles {
    ...
    impl Client {
        ...
        #[doc = "Abort the migration to Azure Frontdoor Premium/Standard."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `profile_name`: Name of the Azure Front Door Standard or Azure Front Door Premium which is unique within the resource group."]
        pub fn migration_abort(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            profile_name: impl Into<String>,
        ) -> migration_abort::RequestBuilder {
            migration_abort::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod migration_abort {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::MigrationResultEmpty> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::MigrationResultEmpty = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Cdn/profiles/{}/migrationAbort",
                    &self.subscription_id, &self.resource_group_name, &self.profile_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::MigrationResultEmpty>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::MigrationResultEmpty>>;
            #[doc = "Returns a future that polls the long running operation, returning once the operation completes."]
            #[doc = ""]
            #[doc = "To only submit the request but not monitor the status of the operation until completion, use `send()` instead."]
            #[doc = ""]
...
pub mod cdn_profiles {
    ...
    impl Client {
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `profile_name`: Name of the Azure Front Door Standard or Azure Front Door Premium which is unique within the resource group."]
        pub fn cdn_can_migrate_to_afd(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            profile_name: impl Into<String>,
        ) -> cdn_can_migrate_to_afd::RequestBuilder {
            cdn_can_migrate_to_afd::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        #[doc = "Migrate the CDN profile to Azure Frontdoor(Standard/Premium) profile. This step prepares the profile for migration and will be followed by Commit to finalize the migration."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `profile_name`: Name of the Azure Front Door Standard or Azure Front Door Premium which is unique within the resource group."]
        #[doc = "* `migration_parameters`: Properties needed to migrate the profile."]
        pub fn cdn_migrate_to_afd(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            profile_name: impl Into<String>,
            migration_parameters: impl Into<models::CdnMigrationToAfdParameters>,
        ) -> cdn_migrate_to_afd::RequestBuilder {
            cdn_migrate_to_afd::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod cdn_can_migrate_to_afd {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Cdn/profiles/{}/cdnCanMigrateToAfd",
                    &self.subscription_id, &self.resource_group_name, &self.profile_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod cdn_migrate_to_afd {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) profile_name: String,
            pub(crate) migration_parameters: models::CdnMigrationToAfdParameters,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Cdn/profiles/{}/cdnMigrateToAfd",
                    &self.subscription_id, &self.resource_group_name, &self.profile_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
