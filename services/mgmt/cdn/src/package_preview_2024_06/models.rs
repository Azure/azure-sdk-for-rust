...
#[doc = "Customized cipher suite set object that will be used for Https when cipherSuiteSetType is Customized."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AfdDomainHttpsCustomizedCipherSuiteSet {
    #[doc = "Cipher suites for TLS 1.0. Required at least one in minimumTlsVersion TLS 1.0."]
    #[serde(
        rename = "cipherSuiteSetForTls10",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub cipher_suite_set_for_tls10: Vec<String>,
    #[doc = "Cipher suites for TLS 1.2. Required at least one in minimumTlsVersion TLS 1.2, option in minimumTlsVersion TLS 1.0."]
    #[serde(
        rename = "cipherSuiteSetForTls12",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub cipher_suite_set_for_tls12: Vec<String>,
    #[doc = "Cipher suites for TLS 1.3. Required at least one in minimumTlsVersion TLS 1.0, TLS 1.2, TLS 1.3."]
    #[serde(
        rename = "cipherSuiteSetForTls13",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub cipher_suite_set_for_tls13: Vec<String>,
}
impl AfdDomainHttpsCustomizedCipherSuiteSet {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct AfdDomainHttpsParameters {
    ...
    #[doc = "cipher suite set type that will be used for Https"]
    #[serde(rename = "cipherSuiteSetType", default, skip_serializing_if = "Option::is_none")]
    pub cipher_suite_set_type: Option<afd_domain_https_parameters::CipherSuiteSetType>,
    #[doc = "TLS protocol version that will be used for Https when cipherSuiteSetType is Customized."]
    ...
    #[doc = "Customized cipher suite set object that will be used for Https when cipherSuiteSetType is Customized."]
    #[serde(rename = "customizedCipherSuiteSet", default, skip_serializing_if = "Option::is_none")]
    pub customized_cipher_suite_set: Option<AfdDomainHttpsCustomizedCipherSuiteSet>,
...
impl AfdDomainHttpsParameters {
    pub fn new(certificate_type: afd_domain_https_parameters::CertificateType) -> Self {
        Self {
            certificate_type,
            cipher_suite_set_type: None,
            minimum_tls_version: None,
            customized_cipher_suite_set: None,
            secret: None,
        }
    }
}
pub mod afd_domain_https_parameters {
    ...
    #[doc = "cipher suite set type that will be used for Https"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "CipherSuiteSetType")]
    pub enum CipherSuiteSetType {
        Customized,
        #[serde(rename = "TLS10_2019")]
        Tls102019,
        #[serde(rename = "TLS12_2022")]
        Tls122022,
        #[serde(rename = "TLS12_2023")]
        Tls122023,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for CipherSuiteSetType {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for CipherSuiteSetType {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for CipherSuiteSetType {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Customized => serializer.serialize_unit_variant("CipherSuiteSetType", 0u32, "Customized"),
                Self::Tls102019 => serializer.serialize_unit_variant("CipherSuiteSetType", 1u32, "TLS10_2019"),
                Self::Tls122022 => serializer.serialize_unit_variant("CipherSuiteSetType", 2u32, "TLS12_2022"),
                Self::Tls122023 => serializer.serialize_unit_variant("CipherSuiteSetType", 3u32, "TLS12_2023"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "The JSON object that contains the properties to configure mutual TLS for a custom domain with FQDN. Mutual TLS cannot be configured for custom domains with wildcard host names."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AfdDomainMtlsParameters {
    #[doc = "List of one or two of Resource References (ie. subs/rg/profile/secret) to Secrets of type MtlsCertificateChain to use in mutual TLS handshake."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub secrets: Vec<ResourceReference>,
    #[doc = "List of FQDN that will be accepted for mutual TLS validation in addition to custom domain's hostname."]
    #[serde(
        rename = "otherAllowedFqdn",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub other_allowed_fqdn: Vec<String>,
    #[doc = "Set to Enabled by default. If set to Disabled, validation of client certificate chain for mutual TLS handshake will be skipped."]
    #[serde(rename = "certificateValidation", default, skip_serializing_if = "Option::is_none")]
    pub certificate_validation: Option<afd_domain_mtls_parameters::CertificateValidation>,
    #[doc = "Set to Disabled by default. If set to Enabled, then selected client certificate chain(s) are sent directly to origin using reserved header."]
    #[serde(rename = "certificatePassthrough", default, skip_serializing_if = "Option::is_none")]
    pub certificate_passthrough: Option<afd_domain_mtls_parameters::CertificatePassthrough>,
    #[doc = "Set to Enabled by default. If set to Disabled, revocation status of client certificate chain will be checked before establishing mutual TLS connection."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ocsp: Option<afd_domain_mtls_parameters::Ocsp>,
}
impl AfdDomainMtlsParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod afd_domain_mtls_parameters {
    use super::*;
    #[doc = "Set to Enabled by default. If set to Disabled, validation of client certificate chain for mutual TLS handshake will be skipped."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "CertificateValidation")]
    ...
    impl FromStr for CertificateValidation {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for CertificateValidation {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for CertificateValidation {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("CertificateValidation", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("CertificateValidation", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    #[doc = "Set to Disabled by default. If set to Enabled, then selected client certificate chain(s) are sent directly to origin using reserved header."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "CertificatePassthrough")]
    pub enum CertificatePassthrough {
        Enabled,
        Disabled,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for CertificatePassthrough {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for CertificatePassthrough {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for CertificatePassthrough {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("CertificatePassthrough", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("CertificatePassthrough", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for Ocsp {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("Ocsp", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("Ocsp", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct AfdDomainUpdatePropertiesParameters {
    ...
    #[doc = "The JSON object that contains the properties to configure mutual TLS for a custom domain with FQDN. Mutual TLS cannot be configured for custom domains with wildcard host names."]
    #[serde(rename = "mtlsSettings", default, skip_serializing_if = "Option::is_none")]
    pub mtls_settings: Option<AfdDomainMtlsParameters>,
    #[doc = "Reference to another resource."]
...
#[doc = "AFDTargetGroup comprises a list of Endpoints that is used for tunnelling protocols to allow certain traffic."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AfdTargetGroup {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "The JSON object that contains the properties of the TargetGroups to create."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<AfdTargetGroupProperties>,
}
impl AfdTargetGroup {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "Result of the request to list target groups. It contains a list of target group objects and a URL link to get the next set of results."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AfdTargetGroupListResult {
    #[doc = "List of AzureFrontDoor target groups within a profile."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<AfdTargetGroup>,
    #[doc = "URL to get the next set of route objects if there are any."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for AfdTargetGroupListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl AfdTargetGroupListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The JSON object that contains the properties of the TargetGroups to create."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AfdTargetGroupProperties {
    #[serde(flatten)]
    pub afd_target_group_update_properties_parameters: AfdTargetGroupUpdatePropertiesParameters,
    #[serde(flatten)]
    pub afd_state_properties: AfdStateProperties,
}
impl AfdTargetGroupProperties {
    pub fn new() -> Self {
        Self {
            afd_target_group_update_properties_parameters: AfdTargetGroupUpdatePropertiesParameters::default(),
            afd_state_properties: AfdStateProperties::default(),
        }
    }
}
#[doc = "The domain JSON object required for TargetGroup creation or update."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AfdTargetGroupUpdateParameters {
    #[doc = "The JSON object that contains the properties of the TargetGroup to create."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<AfdTargetGroupUpdatePropertiesParameters>,
}
impl AfdTargetGroupUpdateParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The JSON object that contains the properties of the TargetGroup to create."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AfdTargetGroupUpdatePropertiesParameters {
    #[doc = "TargetEndpoint list referenced by this target group."]
    #[serde(
...
impl AfdTargetGroupUpdatePropertiesParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Server-side certificate used for mTLS validation"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AfdSecretMtlsCertificateChain {
    #[doc = "Reference to another resource."]
    ...
    #[doc = "Soonest expiration date among certificates in customer's certificate chain in ISO 8601 compliant format yyyy-MM-ddTHH:mm:ss.fffffffK in UTC"]
    #[serde(rename = "expirationDate", default, skip_serializing_if = "Option::is_none")]
    pub expiration_date: Option<String>,
}
impl AfdSecretMtlsCertificateChain {
    pub fn new(secret_source: ResourceReference, secret_version: String) -> Self {
        Self {
            secret_source,
            secret_version,
...
impl AfdUrlSigningAction {
    pub fn new(parameters: AfdUrlSigningActionParameters) -> Self {
        Self { parameters }
    }
}
#[doc = "Defines the parameters for the Url Signing action."]
...
impl CacheKeyQueryStringActionParameters {
    pub fn new(query_string_behavior: cache_key_query_string_action_parameters::QueryStringBehavior) -> Self {
        Self {
...
impl CdnCertificateSourceParameters {
    pub fn new(certificate_type: cdn_certificate_source_parameters::CertificateType) -> Self {
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CdnMigrationToAfdParameters {
    ...
    pub sku: Sku,
    #[doc = "A name map between classic CDN endpoints and AFD Premium/Standard endpoints."]
    #[serde(
        rename = "migrationEndpointMappings",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub migration_endpoint_mappings: Vec<MigrationEndpointMapping>,
}
impl CdnMigrationToAfdParameters {
    pub fn new(sku: Sku) -> Self {
        Self {
            sku,
            migration_endpoint_mappings: Vec::new(),
        }
    }
}
...
#[serde(tag = "typeName")]
pub enum CertificateSourceParametersUnion {
...
impl ClientPortMatchConditionParameters {
    pub fn new(operator: client_port_match_condition_parameters::Operator) -> Self {
        Self {
            operator,
...
#[doc = "compare deployment versions request parameter"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CompareDeploymentVersionsParameter {
    #[doc = "the deployment version to be compared to"]
    #[serde(rename = "compareTo")]
    pub compare_to: String,
}
impl CompareDeploymentVersionsParameter {
    pub fn new(compare_to: String) -> Self {
        Self { compare_to }
    }
}
#[doc = "compare deployment versions response"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CompareDeploymentVersionsResponse {
    #[doc = "The difference between two deployment versions"]
    pub value: Vec<DeploymentVersionChangeUnion>,
}
impl CompareDeploymentVersionsResponse {
    pub fn new(value: Vec<DeploymentVersionChangeUnion>) -> Self {
        Self { value }
    }
}
#[doc = "settings for compression."]
...
impl CookiesMatchConditionParameters {
    pub fn new(operator: cookies_match_condition_parameters::Operator) -> Self {
        Self {
            selector: None,
            operator,
            negate_condition: None,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "typeName")]
pub enum DeliveryRuleActionParametersUnion {
    DeliveryRuleCacheExpirationActionParameters(CacheExpirationActionParameters),
    DeliveryRuleCacheKeyQueryStringBehaviorActionParameters(CacheKeyQueryStringActionParameters),
    DeliveryRuleHeaderActionParameters(HeaderActionParameters),
    DeliveryRuleOriginGroupOverrideActionParameters(OriginGroupOverrideActionParameters),
    DeliveryRuleRouteConfigurationOverrideActionParameters(RouteConfigurationOverrideActionParameters),
    DeliveryRuleUrlRedirectActionParameters(UrlRedirectActionParameters),
    DeliveryRuleUrlRewriteActionParameters(UrlRewriteActionParameters),
    DeliveryRuleUrlSigningActionParameters(UrlSigningActionParameters),
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "typeName")]
pub enum DeliveryRuleConditionParametersUnion {
    DeliveryRuleClientPortConditionParameters(ClientPortMatchConditionParameters),
    DeliveryRuleCookiesConditionParameters(CookiesMatchConditionParameters),
    DeliveryRuleHostNameConditionParameters(HostNameMatchConditionParameters),
    DeliveryRuleHttpVersionConditionParameters(HttpVersionMatchConditionParameters),
    DeliveryRuleIsDeviceConditionParameters(IsDeviceMatchConditionParameters),
    DeliveryRulePostArgsConditionParameters(PostArgsMatchConditionParameters),
    DeliveryRuleQueryStringConditionParameters(QueryStringMatchConditionParameters),
    DeliveryRuleRemoteAddressConditionParameters(RemoteAddressMatchConditionParameters),
    DeliveryRuleRequestBodyConditionParameters(RequestBodyMatchConditionParameters),
    DeliveryRuleRequestHeaderConditionParameters(RequestHeaderMatchConditionParameters),
    DeliveryRuleRequestMethodConditionParameters(RequestMethodMatchConditionParameters),
    DeliveryRuleRequestSchemeConditionParameters(RequestSchemeMatchConditionParameters),
    DeliveryRuleRequestUriConditionParameters(RequestUriMatchConditionParameters),
    DeliveryRuleServerPortConditionParameters(ServerPortMatchConditionParameters),
    DeliveryRuleSocketAddrConditionParameters(SocketAddrMatchConditionParameters),
    DeliveryRuleSslProtocolConditionParameters(SslProtocolMatchConditionParameters),
    DeliveryRuleUrlFileExtensionMatchConditionParameters(UrlFileExtensionMatchConditionParameters),
    DeliveryRuleUrlFilenameConditionParameters(UrlFileNameMatchConditionParameters),
    DeliveryRuleUrlPathMatchConditionParameters(UrlPathMatchConditionParameters),
}
...
#[doc = "The deployment status of the deployment version under the profile"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DeploymentStageStatus {
    #[doc = "The provisioning state of a resource."]
    #[serde(rename = "rolloutStatus", default, skip_serializing_if = "Option::is_none")]
    pub rollout_status: Option<deployment_stage_status::RolloutStatus>,
}
impl DeploymentStageStatus {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod deployment_stage_status {
    use super::*;
    #[doc = "The provisioning state of a resource."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "RolloutStatus")]
    ...
    impl<'de> Deserialize<'de> for RolloutStatus {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for RolloutStatus {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::NotStarted => serializer.serialize_unit_variant("RolloutStatus", 0u32, "NotStarted"),
                Self::InProgress => serializer.serialize_unit_variant("RolloutStatus", 1u32, "InProgress"),
                Self::Succeeded => serializer.serialize_unit_variant("RolloutStatus", 2u32, "Succeeded"),
                Self::Failed => serializer.serialize_unit_variant("RolloutStatus", 3u32, "Failed"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
}
#[doc = "The preview and production deployment status of the deployment version under the profile"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DeploymentStages {
    #[doc = "The deployment status of the deployment version under the profile"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub preview: Option<DeploymentStageStatus>,
    #[doc = "The deployment status of the deployment version under the profile"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub production: Option<DeploymentStageStatus>,
}
impl DeploymentStages {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Deployment version object"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DeploymentVersion {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "The JSON object that contains the properties of the deployment version."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<DeploymentVersionProperties>,
}
...
#[doc = "Deployment change of the origin group under the profile"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DeploymentVersionAfdOriginChange {
    #[serde(flatten)]
    pub deployment_version_change: DeploymentVersionChange,
    #[doc = "The JSON object that contains the properties of the origin."]
    #[serde(rename = "previousProperties", default, skip_serializing_if = "Option::is_none")]
    pub previous_properties: Option<AfdOriginProperties>,
    #[doc = "The JSON object that contains the properties of the origin."]
    #[serde(rename = "currentProperties", default, skip_serializing_if = "Option::is_none")]
    pub current_properties: Option<AfdOriginProperties>,
}
impl DeploymentVersionAfdOriginChange {
    pub fn new(deployment_version_change: DeploymentVersionChange) -> Self {
        Self {
            deployment_version_change,
...
#[doc = "Deployment change of the origin group under the profile"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DeploymentVersionAfdOriginGroupChange {
    #[serde(flatten)]
    pub deployment_version_change: DeploymentVersionChange,
    #[doc = "The JSON object that contains the properties of the origin group."]
    #[serde(rename = "previousProperties", default, skip_serializing_if = "Option::is_none")]
    pub previous_properties: Option<AfdOriginGroupProperties>,
    #[doc = "The JSON object that contains the properties of the origin group."]
    #[serde(rename = "currentProperties", default, skip_serializing_if = "Option::is_none")]
    pub current_properties: Option<AfdOriginGroupProperties>,
}
impl DeploymentVersionAfdOriginGroupChange {
    pub fn new(deployment_version_change: DeploymentVersionChange) -> Self {
        Self {
            deployment_version_change,
            previous_properties: None,
...
#[doc = "Deployment change under the profile"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DeploymentVersionChange {
    #[serde(rename = "resourceId", default, skip_serializing_if = "Option::is_none")]
    pub resource_id: Option<String>,
    #[serde(rename = "resourceName", default, skip_serializing_if = "Option::is_none")]
    pub resource_name: Option<String>,
}
impl DeploymentVersionChange {
    pub fn new() -> Self {
        Self {
            resource_id: None,
            resource_name: None,
...
#[doc = "Resource type supported by preview."]
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "resourceType")]
pub enum DeploymentVersionChangeUnion {
    #[serde(rename = "Microsoft.Cdn/profiles/originGroups/origins")]
    MicrosoftCdnProfilesOriginGroupsOrigins(DeploymentVersionAfdOriginChange),
    #[serde(rename = "Microsoft.Cdn/profiles/originGroups")]
    MicrosoftCdnProfilesOriginGroups(DeploymentVersionAfdOriginGroupChange),
    #[serde(rename = "Microsoft.Cdn/profiles/afdEndpoints/routes")]
    MicrosoftCdnProfilesAfdEndpointsRoutes(DeploymentVersionRouteChange),
    #[serde(rename = "Microsoft.Cdn/profiles/ruleSets")]
    MicrosoftCdnProfilesRuleSets(DeploymentVersionRuleChange),
    #[serde(rename = "Microsoft.Cdn/profiles/ruleSets/rules")]
    MicrosoftCdnProfilesRuleSetsRules(DeploymentVersionRuleSetChange),
    #[serde(rename = "Microsoft.Cdn/profiles/securityPolicies")]
    MicrosoftCdnProfilesSecurityPolicies(DeploymentVersionSecurityPolicyChange),
}
#[doc = "Result of the request to list deployment versions. It contains a list of deployment versions objects and a URL link to get the next set of results."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DeploymentVersionListResult {
    #[doc = "List of DeploymentVersions within a profile."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<DeploymentVersion>,
    #[doc = "URL to get the next set of deployment version objects if there are any."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for DeploymentVersionListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl DeploymentVersionListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The JSON object that contains the properties of the deployment version."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DeploymentVersionProperties {
    #[serde(flatten)]
    pub deployment_version_update_properties: DeploymentVersionUpdateProperties,
    #[serde(flatten)]
    pub afd_state_properties: AfdStateProperties,
    #[serde(rename = "creationTime", default, with = "azure_core::date::rfc3339::option")]
    pub creation_time: Option<::time::OffsetDateTime>,
    #[serde(rename = "approvalTime", default, with = "azure_core::date::rfc3339::option")]
    pub approval_time: Option<::time::OffsetDateTime>,
    #[serde(rename = "approvalStatus", default, skip_serializing_if = "Option::is_none")]
    pub approval_status: Option<deployment_version_properties::ApprovalStatus>,
    #[doc = "The preview and production deployment status of the deployment version under the profile"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub stages: Option<DeploymentStages>,
}
impl DeploymentVersionProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod deployment_version_properties {
    use super::*;
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    ...
    impl Serialize for ApprovalStatus {
        ...
        {
            match self {
                Self::NotApproved => serializer.serialize_unit_variant("ApprovalStatus", 0u32, "NotApproved"),
                Self::Approved => serializer.serialize_unit_variant("ApprovalStatus", 1u32, "Approved"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
}
#[doc = "Deployment change of the route under the profile"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DeploymentVersionRouteChange {
    #[serde(flatten)]
    pub deployment_version_change: DeploymentVersionChange,
    #[doc = "The JSON object that contains the properties of the Routes to create."]
    #[serde(rename = "previousProperties", default, skip_serializing_if = "Option::is_none")]
    pub previous_properties: Option<RouteProperties>,
    #[doc = "The JSON object that contains the properties of the Routes to create."]
    #[serde(rename = "currentProperties", default, skip_serializing_if = "Option::is_none")]
    pub current_properties: Option<RouteProperties>,
}
impl DeploymentVersionRouteChange {
    pub fn new(deployment_version_change: DeploymentVersionChange) -> Self {
        Self {
            deployment_version_change,
            previous_properties: None,
...
#[doc = "Deployment change of the rule under the profile"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DeploymentVersionRuleChange {
    #[serde(flatten)]
    pub deployment_version_change: DeploymentVersionChange,
    #[doc = "The JSON object that contains the properties of the Rules to create."]
    #[serde(rename = "previousProperties", default, skip_serializing_if = "Option::is_none")]
    pub previous_properties: Option<RuleProperties>,
    #[doc = "The JSON object that contains the properties of the Rules to create."]
    #[serde(rename = "currentProperties", default, skip_serializing_if = "Option::is_none")]
    pub current_properties: Option<RuleProperties>,
}
impl DeploymentVersionRuleChange {
    pub fn new(deployment_version_change: DeploymentVersionChange) -> Self {
        Self {
            deployment_version_change,
            previous_properties: None,
...
#[doc = "Deployment change of the rule set under the profile"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DeploymentVersionRuleSetChange {
    #[serde(flatten)]
    pub deployment_version_change: DeploymentVersionChange,
    #[doc = "The JSON object that contains the properties of the Rule Set to create."]
    #[serde(rename = "previousProperties", default, skip_serializing_if = "Option::is_none")]
    pub previous_properties: Option<RuleSetProperties>,
    #[doc = "The JSON object that contains the properties of the Rule Set to create."]
    #[serde(rename = "currentProperties", default, skip_serializing_if = "Option::is_none")]
    pub current_properties: Option<RuleSetProperties>,
}
impl DeploymentVersionRuleSetChange {
    pub fn new(deployment_version_change: DeploymentVersionChange) -> Self {
        Self {
            deployment_version_change,
            previous_properties: None,
...
#[doc = "Deployment change of the security policy under the profile"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DeploymentVersionSecurityPolicyChange {
    #[serde(flatten)]
    pub deployment_version_change: DeploymentVersionChange,
    #[doc = "The json object that contains properties required to create a security policy"]
    #[serde(rename = "previousProperties", default, skip_serializing_if = "Option::is_none")]
    pub previous_properties: Option<SecurityPolicyProperties>,
    #[doc = "The json object that contains properties required to create a security policy"]
    #[serde(rename = "currentProperties", default, skip_serializing_if = "Option::is_none")]
    pub current_properties: Option<SecurityPolicyProperties>,
}
impl DeploymentVersionSecurityPolicyChange {
    pub fn new(deployment_version_change: DeploymentVersionChange) -> Self {
        Self {
            deployment_version_change,
            previous_properties: None,
...
#[doc = "The domain JSON object required for deployment version creation or update."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DeploymentVersionUpdate {
    #[doc = "The JSON object that contains the properties of the deployment version."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<DeploymentVersionUpdateProperties>,
}
impl DeploymentVersionUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The JSON object that contains the properties of the deployment version."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DeploymentVersionUpdateProperties {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
}
impl DeploymentVersionUpdateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl HeaderActionParameters {
    pub fn new(header_action: header_action_parameters::HeaderAction, header_name: String) -> Self {
        Self {
            header_action,
            header_name,
            value: None,
...
impl HostNameMatchConditionParameters {
    pub fn new(operator: host_name_match_condition_parameters::Operator) -> Self {
        Self {
            operator,
            negate_condition: None,
            match_values: Vec::new(),
...
impl HttpVersionMatchConditionParameters {
    pub fn new(operator: http_version_match_condition_parameters::Operator) -> Self {
        Self {
            operator,
            negate_condition: None,
            match_values: Vec::new(),
...
impl IsDeviceMatchConditionParameters {
    pub fn new(operator: is_device_match_condition_parameters::Operator) -> Self {
        Self {
            operator,
            negate_condition: None,
            match_values: Vec::new(),
...
pub mod key_vault_signing_key_parameters {
    ...
    impl Serialize for TypeName {
        ...
        {
            match self {
                Self::KeyVaultSigningKeyParameters => serializer.serialize_unit_variant("TypeName", 0u32, "KeyVaultSigningKeyParameters"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Empty 200 response."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MigrationResultEmpty {}
impl MigrationResultEmpty {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl OriginGroupOverrideActionParameters {
    pub fn new(origin_group: ResourceReference) -> Self {
        Self { origin_group }
    }
}
#[doc = "The JSON object that contains the properties of the origin group."]
...
impl PostArgsMatchConditionParameters {
    pub fn new(operator: post_args_match_condition_parameters::Operator) -> Self {
        Self {
            selector: None,
            operator,
            negate_condition: None,
...
#[doc = "Defines rules that scrub sensitive fields in the Azure Front Door profile logs."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ProfileLogScrubbing {
    #[doc = "State of the log scrubbing config. Default value is Enabled."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<profile_log_scrubbing::State>,
    #[doc = "List of log scrubbing rules applied to the Azure Front Door profile logs."]
    #[serde(
    ...
    pub scrubbing_rules: Vec<ProfileScrubbingRules>,
}
impl ProfileLogScrubbing {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod profile_log_scrubbing {
    use super::*;
    #[doc = "State of the log scrubbing config. Default value is Enabled."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "State")]
...
pub struct ProfileProperties {
    ...
    pub log_scrubbing: Option<ProfileLogScrubbing>,
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ProfileScrubbingRules {
    #[doc = "The variable to be scrubbed from the logs."]
    #[serde(rename = "matchVariable")]
    pub match_variable: profile_scrubbing_rules::MatchVariable,
    ...
    pub selector_match_operator: profile_scrubbing_rules::SelectorMatchOperator,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<profile_scrubbing_rules::State>,
}
impl ProfileScrubbingRules {
    pub fn new(
        match_variable: profile_scrubbing_rules::MatchVariable,
        selector_match_operator: profile_scrubbing_rules::SelectorMatchOperator,
    ) -> Self {
        Self {
            match_variable,
...
pub mod profile_scrubbing_rules {
    use super::*;
    #[doc = "The variable to be scrubbed from the logs."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "MatchVariable")]
...
impl QueryStringMatchConditionParameters {
    pub fn new(operator: query_string_match_condition_parameters::Operator) -> Self {
        Self {
            operator,
            negate_condition: None,
            match_values: Vec::new(),
...
impl RemoteAddressMatchConditionParameters {
    pub fn new(operator: remote_address_match_condition_parameters::Operator) -> Self {
        Self {
            operator,
            negate_condition: None,
            match_values: Vec::new(),
...
impl RequestBodyMatchConditionParameters {
    pub fn new(operator: request_body_match_condition_parameters::Operator) -> Self {
        Self {
            operator,
            negate_condition: None,
            match_values: Vec::new(),
...
impl RequestHeaderMatchConditionParameters {
    pub fn new(operator: request_header_match_condition_parameters::Operator) -> Self {
        Self {
            selector: None,
            operator,
            negate_condition: None,
...
impl RequestMethodMatchConditionParameters {
    pub fn new(operator: request_method_match_condition_parameters::Operator) -> Self {
        Self {
            operator,
            negate_condition: None,
            transforms: Vec::new(),
...
impl RequestSchemeMatchConditionParameters {
    pub fn new(operator: request_scheme_match_condition_parameters::Operator) -> Self {
        Self {
            operator,
            negate_condition: None,
            transforms: Vec::new(),
...
impl RequestUriMatchConditionParameters {
    pub fn new(operator: request_uri_match_condition_parameters::Operator) -> Self {
        Self {
            operator,
            negate_condition: None,
            match_values: Vec::new(),
...
pub struct RouteUpdatePropertiesParameters {
    ...
    #[doc = "Whether or not gRPC is enabled on this route. Permitted values are 'Enabled' or 'Disabled'"]
    #[serde(rename = "grpcState", default, skip_serializing_if = "Option::is_none")]
    pub grpc_state: Option<route_update_properties_parameters::GrpcState>,
}
...
pub mod route_update_properties_parameters {
    ...
    impl FromStr for GrpcState {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for GrpcState {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for GrpcState {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("GrpcState", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("GrpcState", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub enum SecretParametersUnion {
    MtlsCertificateChain(AfdSecretMtlsCertificateChain),
...
impl Serialize for SecretType {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::MtlsCertificateChain => serializer.serialize_unit_variant("SecretType", 4u32, "MtlsCertificateChain"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl ServerPortMatchConditionParameters {
    pub fn new(operator: server_port_match_condition_parameters::Operator) -> Self {
        Self {
            operator,
            negate_condition: None,
            match_values: Vec::new(),
...
impl SocketAddrMatchConditionParameters {
    pub fn new(operator: socket_addr_match_condition_parameters::Operator) -> Self {
        Self {
            operator,
            negate_condition: None,
            match_values: Vec::new(),
...
impl SslProtocolMatchConditionParameters {
    pub fn new(operator: ssl_protocol_match_condition_parameters::Operator) -> Self {
        Self {
            operator,
            negate_condition: None,
            match_values: Vec::new(),
...
#[doc = "TargetEndpoint object that forms a traffic endpoint."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct TargetEndpoint {
    #[doc = "The FQDN for traffic endpoint."]
    #[serde(rename = "targetFqdn", default, skip_serializing_if = "Option::is_none")]
    pub target_fqdn: Option<String>,
    #[doc = "The Ports to be allowed for the FQDN."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
#[doc = "Tunnel Policy maps domains to target endpoints to process traffic over the tunnelling protocol."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct TunnelPolicy {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "The JSON object that contains the properties of the tunnel policy to create."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<TunnelPolicyProperties>,
}
impl TunnelPolicy {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "Result of the request to list tunnel policies. It contains a list of tunnel policy objects."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct TunnelPolicyListResult {
    #[doc = "List of AzureFrontDoor tunnel policies within a profile."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<TunnelPolicy>,
    #[doc = "URL to get the next set of route objects if there are any."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for TunnelPolicyListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl TunnelPolicyListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The JSON object that contains the properties of the tunnel policy to create."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct TunnelPolicyProperties {
    #[serde(flatten)]
    pub tunnel_policy_update_properties_parameters: TunnelPolicyUpdatePropertiesParameters,
    #[serde(flatten)]
    pub afd_state_properties: AfdStateProperties,
}
impl TunnelPolicyProperties {
    pub fn new() -> Self {
        Self {
            tunnel_policy_update_properties_parameters: TunnelPolicyUpdatePropertiesParameters::default(),
            afd_state_properties: AfdStateProperties::default(),
        }
    }
}
#[doc = "The domain JSON object required for tunnel policy creation or update."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct TunnelPolicyUpdateParameters {
    #[doc = "The JSON object that contains the properties of the tunnel policy to create."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<TunnelPolicyUpdatePropertiesParameters>,
}
impl TunnelPolicyUpdateParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The JSON object that contains the properties of the tunnel policy to create."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct TunnelPolicyUpdatePropertiesParameters {
    #[doc = "Protocol this tunnel will use for allowing traffic to backends."]
    #[serde(rename = "tunnelType", default, skip_serializing_if = "Option::is_none")]
    pub tunnel_type: Option<tunnel_policy_update_properties_parameters::TunnelType>,
    #[doc = "Domains referenced by this tunnel policy."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    ...
    pub domains: Vec<ActivatedResourceReference>,
    #[doc = "Target Groups referenced by this tunnel policy."]
    #[serde(
        rename = "targetGroups",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub target_groups: Vec<ResourceReference>,
}
impl TunnelPolicyUpdatePropertiesParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod tunnel_policy_update_properties_parameters {
    use super::*;
    #[doc = "Protocol this tunnel will use for allowing traffic to backends."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "TunnelType")]
    pub enum TunnelType {
        HttpConnect,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    ...
    impl Serialize for TunnelType {
        ...
        {
            match self {
                Self::HttpConnect => serializer.serialize_unit_variant("TunnelType", 0u32, "HttpConnect"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
impl UrlFileExtensionMatchConditionParameters {
    pub fn new(operator: url_file_extension_match_condition_parameters::Operator) -> Self {
        Self {
            operator,
            negate_condition: None,
            match_values: Vec::new(),
...
impl UrlFileNameMatchConditionParameters {
    pub fn new(operator: url_file_name_match_condition_parameters::Operator) -> Self {
        Self {
            operator,
            negate_condition: None,
            match_values: Vec::new(),
...
impl UrlPathMatchConditionParameters {
    pub fn new(operator: url_path_match_condition_parameters::Operator) -> Self {
        Self {
            operator,
            negate_condition: None,
            match_values: Vec::new(),
...
impl UrlRedirectActionParameters {
    pub fn new(redirect_type: url_redirect_action_parameters::RedirectType) -> Self {
        Self {
            redirect_type,
...
impl UrlRewriteActionParameters {
    pub fn new(source_pattern: String, destination: String) -> Self {
        Self {
            source_pattern,
            destination,
...
impl UrlSigningKeyParameters {
    pub fn new(key_id: String, secret_source: ResourceReference, secret_version: String) -> Self {
        Self {
            key_id,
            secret_source,
            secret_version,
