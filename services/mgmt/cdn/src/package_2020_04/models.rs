...
pub struct UrlSigningActionParameters {
    ...
    pub u40odata_type: Option<url_signing_action_parameters::U40odataType>,
    #[serde(rename = "keyId")]
    pub key_id: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub mod url_signing_action_parameters {
    ...
    pub enum U40odataType {
        ...
        U23MicrosoftAzureCdnModelsDeliveryRuleUrlSigningActionParameters,
    }
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum Algorithm {
        #[serde(rename = "SHA256")]
...
pub mod key_vault_signing_key_parameters {
    ...
    pub enum U40odataType {
        ...
        U23MicrosoftAzureCdnModelsKeyVaultSigningKeyParameters,
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
