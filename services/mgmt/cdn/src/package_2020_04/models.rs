...
pub struct UrlSigningActionParameters {
    ...
    pub odata_type: Option<url_signing_action_parameters::Odata_type>,
    #[serde(rename = "keyId")]
    pub key_id: String,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "ipSubnets", skip_serializing_if = "Vec::is_empty")]
    pub ip_subnets: Vec<String>,
}
mod url_signing_action_parameters {
    use super::*;
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum Odata_type {
        #[serde(rename = "#Microsoft.Azure.Cdn.Models.DeliveryRuleUrlSigningActionParameters")]
        Microsoft_Azure_Cdn_Models_DeliveryRuleUrlSigningActionParameters,
    }
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum Algorithm {
        #[serde(rename = "SHA256")]
...
mod url_signing_param_identifier {
    use super::*;
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
mod key_vault_signing_key_parameters {
    use super::*;
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum Odata_type {
        #[serde(rename = "#Microsoft.Azure.Cdn.Models.KeyVaultSigningKeyParameters")]
        Microsoft_Azure_Cdn_Models_KeyVaultSigningKeyParameters,
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
mod response_based_origin_error_detection_parameters {
    use super::*;
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
