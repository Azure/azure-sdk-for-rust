...
impl Client {
    ...
    pub fn discovery_solution_nlp_client(&self) -> discovery_solution_nlp::Client {
        discovery_solution_nlp::Client(self.clone())
    }
    pub fn operations_client(&self) -> operations::Client {
        operations::Client(self.clone())
    }
    pub fn simplified_solutions_client(&self) -> simplified_solutions::Client {
        simplified_solutions::Client(self.clone())
    }
    pub fn solution_client(&self) -> solution::Client {
        solution::Client(self.clone())
    }
    pub fn solution_self_help_client(&self) -> solution_self_help::Client {
        solution_self_help::Client(self.clone())
    }
...
pub mod check_name_availability {
    ...
    impl Client {
        ...
        pub fn check_availability(&self, scope: impl Into<String>) -> check_availability::RequestBuilder {
...
pub mod diagnostics {
    ...
    impl Client {
        ...
        #[doc = "Creates a diagnostic for the specific resource using solutionId from discovery solutions. <br/>Diagnostics are powerful solutions that access product resources or other relevant data and provide the root cause of the issue and the steps to address the issue.<br/><br/>"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `scope`: scope = resourceUri of affected resource.<br/> For example: /subscriptions/0d0fcd2e-c4fd-4349-8497-200edb3923c6/resourcegroups/myresourceGroup/providers/Microsoft.KeyVault/vaults/test-keyvault-non-read "]
        #[doc = "* `diagnostics_resource_name`: Unique resource name for insight resources"]
...
pub mod discovery_solution {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path("/providers/Microsoft.Help/discoverySolutions");
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01-preview");
...
pub mod solution {
    ...
    impl Client {
        ...
        #[doc = "Warm up the solution resource by preloading asynchronous diagnostics results into cache"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `scope`: scope = resourceUri of affected resource.<br/> For example: /subscriptions/0d0fcd2e-c4fd-4349-8497-200edb3923c6/resourcegroups/myresourceGroup/providers/Microsoft.KeyVault/vaults/test-keyvault-non-read "]
        #[doc = "* `solution_resource_name`: Solution resource Name."]
        pub fn warm_up(&self, scope: impl Into<String>, solution_resource_name: impl Into<String>) -> warm_up::RequestBuilder {
            warm_up::RequestBuilder {
                client: self.0.clone(),
                scope: scope.into(),
                solution_resource_name: solution_resource_name.into(),
                solution_warm_up_request_body: None,
            }
        }
    }
    pub mod get {
    ...
    pub mod warm_up {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) scope: String,
            pub(crate) solution_resource_name: String,
            pub(crate) solution_warm_up_request_body: Option<models::SolutionWarmUpRequestBody>,
        }
        impl RequestBuilder {
            #[doc = "The required request body for warming up a solution resource."]
            pub fn solution_warm_up_request_body(
                mut self,
                solution_warm_up_request_body: impl Into<models::SolutionWarmUpRequestBody>,
            ) -> Self {
                self.solution_warm_up_request_body = Some(solution_warm_up_request_body.into());
                self
            }
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        let bearer_token = this.client.bearer_token().await?;
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        let req_body = if let Some(solution_warm_up_request_body) = &this.solution_warm_up_request_body {
                            req.insert_header("content-type", "application/json");
                            azure_core::to_json(solution_warm_up_request_body)?
                        } else {
                            azure_core::EMPTY_BODY
                        };
                        req.set_body(req_body);
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/{}/providers/Microsoft.Help/solutions/{}/warmup",
                    &self.scope, &self.solution_resource_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
...
pub mod simplified_solutions {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Get the simplified Solutions using the applicable solutionResourceName while creating the simplified Solutions."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `scope`: scope = resourceUri of affected resource.<br/> For example: /subscriptions/0d0fcd2e-c4fd-4349-8497-200edb3923c6/resourcegroups/myresourceGroup/providers/Microsoft.KeyVault/vaults/test-keyvault-non-read "]
        #[doc = "* `simplified_solutions_resource_name`: Simplified Solutions Resource Name."]
        pub fn get(&self, scope: impl Into<String>, simplified_solutions_resource_name: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                scope: scope.into(),
                simplified_solutions_resource_name: simplified_solutions_resource_name.into(),
            }
        }
        #[doc = "Creates Simplified Solutions for an Azure subscription using 'solutionId' from Discovery Solutions as the input. <br/><br/> Simplified Solutions API makes the consumption of solutions APIs easier while still providing access to the same powerful solutions rendered in Solutions API. With Simplified Solutions, users don't have to worry about stitching together the article using replacement maps and can use the content in the API response to directly render as HTML content.<br/>"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `scope`: scope = resourceUri of affected resource.<br/> For example: /subscriptions/0d0fcd2e-c4fd-4349-8497-200edb3923c6/resourcegroups/myresourceGroup/providers/Microsoft.KeyVault/vaults/test-keyvault-non-read "]
        #[doc = "* `simplified_solutions_resource_name`: Simplified Solutions Resource Name."]
        pub fn create(&self, scope: impl Into<String>, simplified_solutions_resource_name: impl Into<String>) -> create::RequestBuilder {
            create::RequestBuilder {
                client: self.0.clone(),
                scope: scope.into(),
                simplified_solutions_resource_name: simplified_solutions_resource_name.into(),
                simplified_solutions_request_body: None,
            }
        }
    }
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SimplifiedSolutionsResource> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SimplifiedSolutionsResource = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) scope: String,
            pub(crate) simplified_solutions_resource_name: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    ...
                    &self.scope, &self.simplified_solutions_resource_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::SimplifiedSolutionsResource>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::SimplifiedSolutionsResource>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) scope: String,
            pub(crate) simplified_solutions_resource_name: String,
            pub(crate) simplified_solutions_request_body: Option<models::SimplifiedSolutionsResource>,
        }
        impl RequestBuilder {
            #[doc = "The required request body for simplified Solutions resource creation."]
            pub fn simplified_solutions_request_body(
                mut self,
                simplified_solutions_request_body: impl Into<models::SimplifiedSolutionsResource>,
            ) -> Self {
                self.simplified_solutions_request_body = Some(simplified_solutions_request_body.into());
                self
            }
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        let bearer_token = this.client.bearer_token().await?;
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        let req_body = if let Some(simplified_solutions_request_body) = &this.simplified_solutions_request_body {
                            req.insert_header("content-type", "application/json");
                            azure_core::to_json(simplified_solutions_request_body)?
                        } else {
                            azure_core::EMPTY_BODY
                        };
                        req.set_body(req_body);
...
pub mod solution_self_help {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets Self Help Solutions for a given solutionId. Self Help Solutions consist of rich instructional video tutorials, links and guides to public documentation related to a specific problem that enables users to troubleshoot Azure issues."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `solution_id`: SolutionId is a unique id to identify a solution. You can retrieve the solution id using the Discovery api - https://learn.microsoft.com/en-us/rest/api/help/discovery-solution/list?view=rest-help-2023-09-01-preview&tabs=HTTP"]
        pub fn get(&self, solution_id: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SolutionResourceSelfHelp> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SolutionResourceSelfHelp = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.Help/selfHelp/{}", &self.solution_id));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::SolutionResourceSelfHelp>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::SolutionResourceSelfHelp>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod discovery_solution_nlp {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Search for relevant Azure Diagnostics, Solutions and Troubleshooters using a natural language issue summary."]
        pub fn discover_solutions(&self) -> discover_solutions::RequestBuilder {
            discover_solutions::RequestBuilder {
                client: self.0.clone(),
                discover_solution_request: None,
            }
        }
        #[doc = "Search for relevant Azure Diagnostics, Solutions and Troubleshooters using a natural language issue summary and subscription."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The Azure subscription ID."]
        pub fn discover_solutions_by_subscription(
            &self,
            subscription_id: impl Into<String>,
        ) -> discover_solutions_by_subscription::RequestBuilder {
            discover_solutions_by_subscription::RequestBuilder {
                client: self.0.clone(),
    ...
    pub mod discover_solutions {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DiscoveryNlpResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DiscoveryNlpResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) discover_solution_request: Option<models::DiscoveryNlpRequest>,
        }
        impl RequestBuilder {
            #[doc = "Request body for discovering solutions using NLP."]
            pub fn discover_solution_request(mut self, discover_solution_request: impl Into<models::DiscoveryNlpRequest>) -> Self {
                self.discover_solution_request = Some(discover_solution_request.into());
                self
            }
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        let bearer_token = this.client.bearer_token().await?;
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        let req_body = if let Some(discover_solution_request) = &this.discover_solution_request {
                            req.insert_header("content-type", "application/json");
                            azure_core::to_json(discover_solution_request)?
                        } else {
                            azure_core::EMPTY_BODY
                        };
                        req.set_body(req_body);
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path("/providers/Microsoft.Help/discoverSolutions");
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DiscoveryNlpResponse>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DiscoveryNlpResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod discover_solutions_by_subscription {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.Help/discoverSolutions",
