...
#[doc = "Detailed insights(s) obtained via the invocation of an insight diagnostic troubleshooter."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct Insight {
    #[doc = "Article id."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Diagnostic solution metadata."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SolutionMetadataProperties {
    ...
    #[serde(
        rename = "requiredParameterSets",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub required_parameter_sets: Vec<Vec<String>>,
}
...
#[doc = "Solution Metadata resource"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SolutionMetadataResource {
    ...
    #[doc = "Diagnostic solution metadata."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<SolutionMetadataProperties>,
}
