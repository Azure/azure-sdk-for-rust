...
pub struct AgentConfiguration {
    ...
    #[serde(rename = "extensionsAllowList", default, skip_serializing_if = "Vec::is_empty")]
    ...
    #[serde(rename = "extensionsBlockList", default, skip_serializing_if = "Vec::is_empty")]
    ...
    #[serde(rename = "proxyBypass", default, skip_serializing_if = "Vec::is_empty")]
