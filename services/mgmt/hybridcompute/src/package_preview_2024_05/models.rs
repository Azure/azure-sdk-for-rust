...
impl Serialize for AccessMode {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::Audit => serializer.serialize_unit_variant("AccessMode", 1u32, "audit"),
            Self::Learning => serializer.serialize_unit_variant("AccessMode", 2u32, "learning"),
...
pub struct AccessRule {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<AccessRuleProperties>,
}
impl AccessRule {
    pub fn new() -> Self {
        Self::default()
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "AccessRuleDirection")]
...
impl FromStr for AccessRuleDirection {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for AccessRuleDirection {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for AccessRuleDirection {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Inbound => serializer.serialize_unit_variant("AccessRuleDirection", 0u32, "Inbound"),
            Self::Outbound => serializer.serialize_unit_variant("AccessRuleDirection", 1u32, "Outbound"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "Properties of an access rule."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AccessRuleProperties {
    #[doc = "Indicates direction of an access rule."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub direction: Option<AccessRuleDirection>,
...
pub struct EsuKey {
    ...
    #[doc = "The current status of the license profile key. Represented by the same integer value that is presented on the machine itself when querying the license key status."]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ExtensionsResourceStatus {
    #[doc = "The status code."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub code: Option<String>,
    #[doc = "The level code."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub level: Option<extensions_resource_status::Level>,
...
pub mod extensions_resource_status {
    use super::*;
    #[doc = "The level code."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum Level {
...
#[doc = "Describes an Arc Gateway."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct Gateway {
    #[serde(flatten)]
    pub tracked_resource: TrackedResource,
    #[doc = "Describes the properties of a Gateway Profile."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct GatewayProperties {
    ...
    #[doc = "A unique, immutable, identifier for the Gateway."]
    #[serde(rename = "gatewayId", default, skip_serializing_if = "Option::is_none")]
    pub gateway_id: Option<String>,
    #[doc = "The type of the Gateway resource."]
    #[serde(rename = "gatewayType", default, skip_serializing_if = "Option::is_none")]
    pub gateway_type: Option<GatewayType>,
    #[doc = "The endpoint fqdn for the Gateway."]
    #[serde(rename = "gatewayEndpoint", default, skip_serializing_if = "Option::is_none")]
    pub gateway_endpoint: Option<String>,
    #[doc = "Specifies the list of features that are enabled for this Gateway."]
    #[serde(
...
impl Serialize for GatewayType {
    ...
    {
        match self {
            Self::Public => serializer.serialize_unit_variant("GatewayType", 0u32, "Public"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct GatewayUpdate {
    ...
    #[doc = "Describes the Update properties of a Gateway Profile."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<GatewayUpdateProperties>,
}
impl GatewayUpdate {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "Describes the Update properties of a Gateway Profile."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct GatewayUpdateProperties {
    #[doc = "Specifies the list of features that are enabled for this Gateway."]
    #[serde(
        rename = "allowedFeatures",
        default,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GatewaysListResult {
    #[doc = "The list of Gateways."]
    pub value: Vec<Gateway>,
    #[doc = "The URI to fetch the next page of Gateways. Call ListNext() with this URI to fetch the next page of Gateways."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for GatewaysListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl GatewaysListResult {
    pub fn new(value: Vec<Gateway>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Status of hotpatch enablement or disablement."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "HotpatchEnablementStatus")]
pub enum HotpatchEnablementStatus {
    Unknown,
    PendingEvaluation,
    Disabled,
    ActionRequired,
...
impl FromStr for HotpatchEnablementStatus {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for HotpatchEnablementStatus {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for HotpatchEnablementStatus {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("HotpatchEnablementStatus", 0u32, "Unknown"),
            Self::PendingEvaluation => serializer.serialize_unit_variant("HotpatchEnablementStatus", 1u32, "PendingEvaluation"),
            Self::Disabled => serializer.serialize_unit_variant("HotpatchEnablementStatus", 2u32, "Disabled"),
            Self::ActionRequired => serializer.serialize_unit_variant("HotpatchEnablementStatus", 3u32, "ActionRequired"),
            Self::Enabled => serializer.serialize_unit_variant("HotpatchEnablementStatus", 4u32, "Enabled"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct KeyProperties {
    ...
    pub client_public_key: Option<KeyDetails>,
    #[doc = "Public key details"]
    #[serde(rename = "candidatePublicKey", default, skip_serializing_if = "Option::is_none")]
    pub candidate_public_key: Option<KeyDetails>,
}
impl KeyProperties {
    pub fn new() -> Self {
        Self::default()
...
pub struct LicenseDetails {
    ...
    #[doc = "A list of volume license details."]
    #[serde(
        rename = "volumeLicenseDetails",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub volume_license_details: Vec<VolumeLicenseDetails>,
}
impl LicenseDetails {
    pub fn new() -> Self {
        Self::default()
...
pub mod license_profile {
    ...
    pub struct Properties {
        #[serde(rename = "softwareAssurance", default, skip_serializing_if = "Option::is_none")]
        pub software_assurance: Option<properties::SoftwareAssurance>,
        ...
        #[serde(rename = "productProfile", default, skip_serializing_if = "Option::is_none")]
        pub product_profile: Option<LicenseProfileArmProductProfileProperties>,
        #[doc = "The provisioning state, which only appears in the response."]
        #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
        pub provisioning_state: Option<ProvisioningState>,
    }
    ...
    pub mod properties {
        use super::*;
        #[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
        pub struct SoftwareAssurance {
            #[doc = "Specifies if this machine is licensed as part of a Software Assurance agreement."]
            #[serde(rename = "softwareAssuranceCustomer", default, skip_serializing_if = "Option::is_none")]
            pub software_assurance_customer: Option<bool>,
        }
        impl SoftwareAssurance {
            pub fn new() -> Self {
                Self::default()
            }
        }
...
#[doc = "Describes the properties of a Product License Profile ARM model."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct LicenseProfileArmProductProfileProperties {
    ...
    #[doc = "The timestamp in UTC when the billing ends."]
    #[serde(rename = "billingEndDate", default, with = "azure_core::date::rfc3339::option")]
    pub billing_end_date: Option<::time::OffsetDateTime>,
    #[doc = "The error detail."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub error: Option<ErrorDetail>,
    ...
    pub product_features: Vec<ProductFeature>,
}
impl LicenseProfileArmProductProfileProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct LicenseProfileMachineInstanceView {
    ...
    #[serde(rename = "licenseChannel", default, skip_serializing_if = "Option::is_none")]
    pub license_channel: Option<String>,
    #[serde(rename = "softwareAssurance", default, skip_serializing_if = "Option::is_none")]
    pub software_assurance: Option<license_profile_machine_instance_view::SoftwareAssurance>,
...
pub mod license_profile_machine_instance_view {
    use super::*;
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
    pub struct SoftwareAssurance {
        #[doc = "Specifies if this machine is licensed as part of a Software Assurance agreement."]
...
#[doc = "The product type of the license."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "LicenseProfileProductType")]
pub enum LicenseProfileProductType {
    WindowsServer,
    WindowsIoTEnterprise,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for LicenseProfileProductType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for LicenseProfileProductType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for LicenseProfileProductType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::WindowsServer => serializer.serialize_unit_variant("LicenseProfileProductType", 0u32, "WindowsServer"),
            Self::WindowsIoTEnterprise => serializer.serialize_unit_variant("LicenseProfileProductType", 1u32, "WindowsIoTEnterprise"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "Subscription status of the OS or Product feature."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "LicenseProfileSubscriptionStatus")]
pub enum LicenseProfileSubscriptionStatus {
    Unknown,
    Enabling,
    Enabled,
    Disabled,
...
impl FromStr for LicenseProfileSubscriptionStatus {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for LicenseProfileSubscriptionStatus {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for LicenseProfileSubscriptionStatus {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("LicenseProfileSubscriptionStatus", 0u32, "Unknown"),
            Self::Enabling => serializer.serialize_unit_variant("LicenseProfileSubscriptionStatus", 1u32, "Enabling"),
            Self::Enabled => serializer.serialize_unit_variant("LicenseProfileSubscriptionStatus", 2u32, "Enabled"),
            Self::Disabled => serializer.serialize_unit_variant("LicenseProfileSubscriptionStatus", 3u32, "Disabled"),
            Self::Disabling => serializer.serialize_unit_variant("LicenseProfileSubscriptionStatus", 4u32, "Disabling"),
            Self::Failed => serializer.serialize_unit_variant("LicenseProfileSubscriptionStatus", 5u32, "Failed"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "LicenseProfileSubscriptionStatusUpdate")]
pub enum LicenseProfileSubscriptionStatusUpdate {
    Enable,
    Disable,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for LicenseProfileSubscriptionStatusUpdate {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for LicenseProfileSubscriptionStatusUpdate {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for LicenseProfileSubscriptionStatusUpdate {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Enable => serializer.serialize_unit_variant("LicenseProfileSubscriptionStatusUpdate", 0u32, "Enable"),
            Self::Disable => serializer.serialize_unit_variant("LicenseProfileSubscriptionStatusUpdate", 1u32, "Disable"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub mod license_profile_update {
    ...
    pub struct Properties {
        ...
        #[serde(rename = "productProfile", default, skip_serializing_if = "Option::is_none")]
        pub product_profile: Option<ProductProfileUpdateProperties>,
    }
    impl Properties {
        pub fn new() -> Self {
            Self::default()
...
#[doc = "The license status."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "LicenseStatus")]
pub enum LicenseStatus {
    Unlicensed,
    Licensed,
    #[serde(rename = "OOBGrace")]
    OobGrace,
    #[serde(rename = "OOTGrace")]
    OotGrace,
    NonGenuineGrace,
    Notification,
    ExtendedGrace,
...
impl Serialize for LicenseStatus {
    ...
    {
        match self {
            Self::Unlicensed => serializer.serialize_unit_variant("LicenseStatus", 0u32, "Unlicensed"),
            Self::Licensed => serializer.serialize_unit_variant("LicenseStatus", 1u32, "Licensed"),
            Self::OobGrace => serializer.serialize_unit_variant("LicenseStatus", 2u32, "OOBGrace"),
            Self::OotGrace => serializer.serialize_unit_variant("LicenseStatus", 3u32, "OOTGrace"),
            Self::NonGenuineGrace => serializer.serialize_unit_variant("LicenseStatus", 4u32, "NonGenuineGrace"),
            Self::Notification => serializer.serialize_unit_variant("LicenseStatus", 5u32, "Notification"),
            Self::ExtendedGrace => serializer.serialize_unit_variant("LicenseStatus", 6u32, "ExtendedGrace"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct MachineRunCommandInstanceView {
    ...
    pub execution_state: Option<machine_run_command_instance_view::ExecutionState>,
    ...
    pub statuses: Vec<ExtensionsResourceStatus>,
}
...
pub struct NetworkConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<NetworkConfigurationProperties>,
}
...
#[doc = "Network configuration properties"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct NetworkConfigurationProperties {
    ...
    #[serde(rename = "networkConfigurationScopeId", default, skip_serializing_if = "Option::is_none")]
    pub network_configuration_scope_id: Option<String>,
    #[doc = "Associated Network Configuration Scope Resource Id"]
    #[serde(rename = "networkConfigurationScopeResourceId")]
    pub network_configuration_scope_resource_id: String,
    #[doc = "Public key information for client authentication"]
    #[serde(rename = "keyProperties", default, skip_serializing_if = "Option::is_none")]
    pub key_properties: Option<KeyProperties>,
}
impl NetworkConfigurationProperties {
    pub fn new(network_configuration_scope_resource_id: String) -> Self {
        Self {
            location: None,
            tenant_id: None,
            network_configuration_scope_id: None,
...
pub struct NetworkSecurityPerimeterConfigurationProperties {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub profile: Option<NetworkSecurityPerimeterProfile>,
}
...
#[doc = "Result of network security perimeter configurations."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NetworkSecurityPerimeterConfigurationReconcileResult {
    #[doc = "The URL of the resource used to check the status of the asynchronous operation."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub location: Option<String>,
}
impl NetworkSecurityPerimeterConfigurationReconcileResult {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct NetworkSecurityPerimeterProfile {
    ...
    pub access_rules_version: Option<i32>,
    ...
    pub diagnostic_settings_version: Option<i32>,
...
pub struct PatchSettings {
    ...
    #[doc = "Captures the hotpatch capability enrollment intent of the customers, which enables customers to patch their Windows machines without requiring a reboot."]
    #[serde(rename = "enableHotpatching", default, skip_serializing_if = "Option::is_none")]
    pub enable_hotpatching: Option<bool>,
    #[doc = "Status of the hotpatch capability enrollment or disenrollment."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<patch_settings::Status>,
}
impl PatchSettings {
    pub fn new() -> Self {
        Self::default()
...
pub mod patch_settings {
    ...
    pub struct Status {
        #[doc = "Status of hotpatch enablement or disablement."]
        #[serde(rename = "hotpatchEnablementStatus", default, skip_serializing_if = "Option::is_none")]
        pub hotpatch_enablement_status: Option<HotpatchEnablementStatus>,
        #[doc = "The error detail."]
        #[serde(default, skip_serializing_if = "Option::is_none")]
        pub error: Option<ErrorDetail>,
    }
...
#[doc = "Product Feature"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ProductFeatureUpdate {
    #[doc = "Product feature name."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Indicates the new subscription status of the OS or Product Features."]
    #[serde(rename = "subscriptionStatus", default, skip_serializing_if = "Option::is_none")]
    pub subscription_status: Option<LicenseProfileSubscriptionStatusUpdate>,
}
impl ProductFeatureUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Describes the Update properties of a Product Profile."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ProductProfileUpdateProperties {
    #[doc = "Indicates the new subscription status of the OS or Product Features."]
    #[serde(rename = "subscriptionStatus", default, skip_serializing_if = "Option::is_none")]
    pub subscription_status: Option<LicenseProfileSubscriptionStatusUpdate>,
    #[doc = "The product type of the license."]
    ...
    pub product_features: Vec<ProductFeatureUpdate>,
}
impl ProductProfileUpdateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ProvisioningIssueProperties {
    ...
    pub issue_type: Option<ProvisioningIssueType>,
    #[doc = "Severity of the provisioning issue."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub severity: Option<ProvisioningIssueSeverity>,
    ...
    pub suggested_access_rules: Vec<AccessRule>,
}
...
#[doc = "Severity of the provisioning issue."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ProvisioningIssueSeverity")]
pub enum ProvisioningIssueSeverity {
    Warning,
    Error,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for ProvisioningIssueSeverity {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for ProvisioningIssueSeverity {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for ProvisioningIssueSeverity {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Warning => serializer.serialize_unit_variant("ProvisioningIssueSeverity", 0u32, "Warning"),
            Self::Error => serializer.serialize_unit_variant("ProvisioningIssueSeverity", 1u32, "Error"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "Type of provisioning issue."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ProvisioningIssueType")]
pub enum ProvisioningIssueType {
...
impl FromStr for ProvisioningIssueType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for ProvisioningIssueType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for ProvisioningIssueType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::MissingPerimeterConfiguration => {
                serializer.serialize_unit_variant("ProvisioningIssueType", 0u32, "MissingPerimeterConfiguration")
            }
            Self::MissingIdentityConfiguration => {
                serializer.serialize_unit_variant("ProvisioningIssueType", 1u32, "MissingIdentityConfiguration")
            }
            Self::ConfigurationPropagationFailure => {
                serializer.serialize_unit_variant("ProvisioningIssueType", 2u32, "ConfigurationPropagationFailure")
            }
            Self::Other => serializer.serialize_unit_variant("ProvisioningIssueType", 3u32, "Other"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "Settings Gateway properties"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SettingsGatewayProperties {
    #[doc = "Associated Gateway Resource Id"]
    #[serde(rename = "gatewayResourceId", default, skip_serializing_if = "Option::is_none")]
    pub gateway_resource_id: Option<String>,
}
impl SettingsGatewayProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct SettingsProperties {
    ...
    pub tenant_id: Option<String>,
    #[doc = "Settings Gateway properties"]
    #[serde(rename = "gatewayProperties", default, skip_serializing_if = "Option::is_none")]
    pub gateway_properties: Option<SettingsGatewayProperties>,
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct VolumeLicenseDetails {
    #[doc = "Describes the program year the volume license is for."]
    #[serde(rename = "programYear", default, skip_serializing_if = "Option::is_none")]
    pub program_year: Option<volume_license_details::ProgramYear>,
    #[doc = "The invoice id for the volume license."]
    #[serde(rename = "invoiceId", default, skip_serializing_if = "Option::is_none")]
    pub invoice_id: Option<String>,
}
impl VolumeLicenseDetails {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod volume_license_details {
    use super::*;
    #[doc = "Describes the program year the volume license is for."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ProgramYear")]
    ...
    impl FromStr for ProgramYear {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for ProgramYear {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for ProgramYear {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Year1 => serializer.serialize_unit_variant("ProgramYear", 0u32, "Year 1"),
                Self::Year2 => serializer.serialize_unit_variant("ProgramYear", 1u32, "Year 2"),
                Self::Year3 => serializer.serialize_unit_variant("ProgramYear", 2u32, "Year 3"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
