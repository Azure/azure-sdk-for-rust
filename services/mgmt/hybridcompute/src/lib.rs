...
#[cfg(all(feature = "package-preview-2021-05", not(feature = "no-default-version")))]
pub use package_preview_2021_05::{models, operations, operations::Error};
...
pub use package_preview_2020_08::{models, operations, operations::Error};
...
#[cfg(all(feature = "package-2020-07-30-preview", not(feature = "no-default-version")))]
pub use package_2020_07_30_preview::{models, operations, operations::Error};
#[cfg(feature = "package-2020-08-02")]
pub mod package_2020_08_02;
use azure_core::setters;
#[cfg(all(feature = "package-2020-08-02", not(feature = "no-default-version")))]
pub use package_2020_08_02::{models, operations, operations::Error};
pub fn config(
