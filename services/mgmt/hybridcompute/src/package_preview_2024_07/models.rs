...
pub struct AgentUpgrade {
    ...
    #[doc = "The correlation ID associated with an agent upgrade operation."]
    #[serde(rename = "correlationId", default, skip_serializing_if = "Option::is_none")]
    pub correlation_id: Option<String>,
    #[doc = "Specifies if the machine's agent should be upgraded"]
...
impl azure_core::Continuable for AgentVersionsList {
...
#[doc = "Describes a disk on the machine"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct Disk {
    #[doc = "The path of the disk."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub path: Option<String>,
    #[doc = "The type of the disk."]
    #[serde(rename = "diskType", default, skip_serializing_if = "Option::is_none")]
    pub disk_type: Option<String>,
    #[doc = "The generated ID of the disk."]
    ...
    #[doc = "The amount of space used on the disk, in bytes"]
...
#[doc = "Describes the firmware of the machine"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct FirmwareProfile {
    #[doc = "The serial number of the firmware"]
    #[serde(rename = "serialNumber", default, skip_serializing_if = "Option::is_none")]
    pub serial_number: Option<String>,
    #[doc = "The type of the firmware"]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<String>,
}
...
#[doc = "Describes the hardware of the machine"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct HardwareProfile {
    #[doc = "The total physical memory on the machine"]
    #[serde(rename = "totalPhysicalMemoryInBytes", default, skip_serializing_if = "Option::is_none")]
    pub total_physical_memory_in_bytes: Option<i64>,
    #[doc = "The total number of CPU sockets available on the machine"]
    #[serde(rename = "numberOfCpuSockets", default, skip_serializing_if = "Option::is_none")]
    pub number_of_cpu_sockets: Option<i32>,
    #[doc = "The physical processors of the machine."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
pub struct MachineProperties {
    ...
    #[doc = "Describes the storage configuration of the machine"]
    #[serde(rename = "storageProfile", default, skip_serializing_if = "Option::is_none")]
    pub storage_profile: Option<StorageProfile>,
    #[doc = "Describes the firmware of the machine"]
    #[serde(rename = "firmwareProfile", default, skip_serializing_if = "Option::is_none")]
...
pub struct NetworkConfigurationProperties {
    ...
    #[serde(rename = "networkConfigurationScopeResourceId", default, skip_serializing_if = "Option::is_none")]
    pub network_configuration_scope_resource_id: Option<String>,
    #[doc = "Public key information for client authentication"]
...
pub struct NetworkInterface {
    #[doc = "Represents MAC address of the network interface."]
    #[serde(rename = "macAddress", default, skip_serializing_if = "Option::is_none")]
    pub mac_address: Option<String>,
    #[doc = "Represents the ID of the network interface."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "Represents the name of the network interface."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
...
pub struct Processor {
    #[doc = "The name of the processor."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "The total number of physical cores on the processor."]
