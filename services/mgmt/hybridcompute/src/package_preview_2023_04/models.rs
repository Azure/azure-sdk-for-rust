...
pub struct Machine {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub identity: Option<Identity>,
    #[doc = "Indicates which kind of VM fabric the instance is an instance of, such as HCI or SCVMM etc."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kind: Option<machine::Kind>,
}
impl Machine {
...
pub mod machine {
    ...
    impl Serialize for Kind {
        ...
        {
            match self {
                Self::Avs => serializer.serialize_unit_variant("Kind", 0u32, "AVS"),
                Self::Hci => serializer.serialize_unit_variant("Kind", 1u32, "HCI"),
                Self::Scvmm => serializer.serialize_unit_variant("Kind", 2u32, "SCVMM"),
                Self::VMware => serializer.serialize_unit_variant("Kind", 3u32, "VMware"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Describes a Run Command"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct MachineRunCommand {
    #[serde(flatten)]
    pub tracked_resource: TrackedResource,
    #[doc = "Describes the properties of a run command."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<MachineRunCommandProperties>,
}
impl MachineRunCommand {
    pub fn new(tracked_resource: TrackedResource) -> Self {
        Self {
            tracked_resource,
            properties: None,
...
#[doc = "Describes the Machine Extension Instance View."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MachineRunCommandInstanceView {
    #[doc = "The run command name."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Instance view status."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<machine_run_command_instance_view::Status>,
}
impl MachineRunCommandInstanceView {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod machine_run_command_instance_view {
    use super::*;
    #[doc = "Instance view status."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
    pub struct Status {
...
pub struct MachineRunCommandProperties {
    ...
    #[doc = "Describes the Machine Extension Instance View."]
    #[serde(rename = "instanceView", default, skip_serializing_if = "Option::is_none")]
    pub instance_view: Option<MachineRunCommandInstanceView>,
}
impl MachineRunCommandProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Describes the script sources for run command. Use only one of script, scriptUri, commandId."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MachineRunCommandScriptSource {
...
impl MachineRunCommandScriptSource {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Describes a Machine Extension Update."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MachineRunCommandUpdate {
    #[serde(flatten)]
    pub resource_update: ResourceUpdate,
}
impl MachineRunCommandUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Describes the Run Commands List Result."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MachineRunCommandsListResult {
    ...
    pub value: Vec<MachineRunCommand>,
    #[doc = "The uri to fetch the next page of run commands. Call ListNext() with this to fetch the next page of run commands."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for MachineRunCommandsListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone()
    }
}
impl MachineRunCommandsListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct MachineUpdate {
    ...
    #[doc = "Indicates which kind of VM fabric the instance is an instance of, such as HCI or SCVMM etc."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kind: Option<machine_update::Kind>,
