...
pub struct HierarchySettingsProperties {
    #[serde(rename = "tenantId", skip_serializing_if = "Option::is_none")]
    pub tenant_id: Option<String>,
    #[serde(rename = "requireAuthorizationForGroupCreation", skip_serializing_if = "Option::is_none")]
    pub require_authorization_for_group_creation: Option<bool>,
    #[serde(rename = "defaultManagementGroup", skip_serializing_if = "Option::is_none")]
...
mod check_name_availability_request {
    ...
    pub enum Type {
        ...
        Microsoft_ManagementManagementGroup,
    }
}
