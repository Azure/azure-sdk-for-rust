...
impl AuthorizedGroundstation {
    pub fn new(ground_station: String, expiration_date: String) -> Self {
        Self {
            ground_station,
            expiration_date,
        }
...
pub struct ContactProfileLinkChannel {
    ...
    #[doc = "Customer end point to store and retrieve data during a contact with the spacecraft."]
...
#[doc = "Contact Profile third-party partner configuration."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ContactProfileThirdPartyConfiguration {
    #[doc = "Name of the third-party provider."]
    #[serde(rename = "providerName")]
    pub provider_name: String,
    #[doc = "Name of string referencing the configuration describing contact set-up for a particular mission. Expected values are those which have been created in collaboration with the partner network."]
    #[serde(rename = "missionConfiguration")]
    pub mission_configuration: String,
}
impl ContactProfileThirdPartyConfiguration {
    pub fn new(provider_name: String, mission_configuration: String) -> Self {
        Self {
            provider_name,
...
pub struct ContactProfilesProperties {
    ...
    #[doc = "Third-party mission configuration of the Contact Profile. Describes RF links, modem processing, and IP endpoints."]
    #[serde(
        rename = "thirdPartyConfigurations",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub third_party_configurations: Vec<ContactProfileThirdPartyConfiguration>,
...
impl ContactProfilesProperties {
    pub fn new(network_configuration: contact_profiles_properties::NetworkConfiguration, links: Vec<ContactProfileLink>) -> Self {
        Self {
            ...
            third_party_configurations: Vec::new(),
            links,
        }
    }
}
...
pub struct OperationResult {
    ...
    #[doc = "A list of results when the operation returns multiple results."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
pub struct Spacecraft {
    ...
    pub properties: SpacecraftsProperties,
}
impl Spacecraft {
    pub fn new(tracked_resource: TrackedResource, properties: SpacecraftsProperties) -> Self {
        Self {
            tracked_resource,
            properties,
        }
