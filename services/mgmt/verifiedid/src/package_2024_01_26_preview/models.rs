...
pub struct Authority {
    ...
    pub properties: Option<AuthorityProperties>,
}
impl Authority {
...
#[doc = "The response of a Authority list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AuthorityListResult {
    #[doc = "The Authority items on this page"]
    pub value: Vec<Authority>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for AuthorityListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl AuthorityListResult {
    pub fn new(value: Vec<Authority>) -> Self {
...
impl AuthorityProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The type used for update operations of the Authority."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
