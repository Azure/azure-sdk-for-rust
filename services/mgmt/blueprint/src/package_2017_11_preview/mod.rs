...
pub mod blueprints {
    ...
    impl Client {
        ...
        pub fn get(&self, management_group_name: impl Into<String>, blueprint_name: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
        ...
        #[doc = "* `management_group_name`: ManagementGroup where blueprint stores."]
        #[doc = "* `blueprint_name`: name of the blueprint."]
        pub fn delete(&self, management_group_name: impl Into<String>, blueprint_name: impl Into<String>) -> delete::RequestBuilder {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `management_group_name`: ManagementGroup where blueprint stores."]
        pub fn list(&self, management_group_name: impl Into<String>) -> list::RequestBuilder {
            list::RequestBuilder {
                client: self.0.clone(),
                management_group_name: management_group_name.into(),
            }
    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::Blueprint> {
                ...
                let body: models::Blueprint = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::Blueprint>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::Blueprint>>;
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BlueprintList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BlueprintList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::BlueprintList, azure_core::error::Error> {
...
pub mod artifacts {
    ...
    impl Client {
        ...
        #[doc = "* `management_group_name`: ManagementGroup where blueprint stores."]
        #[doc = "* `blueprint_name`: name of the blueprint."]
        pub fn list(&self, management_group_name: impl Into<String>, blueprint_name: impl Into<String>) -> list::RequestBuilder {
            list::RequestBuilder {
                client: self.0.clone(),
                management_group_name: management_group_name.into(),
                blueprint_name: blueprint_name.into(),
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ArtifactList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ArtifactList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ArtifactList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
...
pub mod published_blueprints {
    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::PublishedBlueprint> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::PublishedBlueprint = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::PublishedBlueprint>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::PublishedBlueprint>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::PublishedBlueprintList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::PublishedBlueprintList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::PublishedBlueprintList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
...
pub mod published_artifacts {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/providers/Microsoft.Management/managementGroups/{}/providers/Microsoft.Blueprint/blueprints/{}/versions/{}/artifacts/{}" , self . client . endpoint () , & self . management_group_name , & self . blueprint_name , & self . version_id , & self . artifact_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2017-11-11-preview");
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/providers/Microsoft.Management/managementGroups/{}/providers/Microsoft.Blueprint/blueprints/{}/versions/{}/artifacts" , self . client . endpoint () , & self . management_group_name , & self . blueprint_name , & self . version_id)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2017-11-11-preview");
...
pub mod operations {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/providers/Microsoft.Blueprint/operations", self.client.endpoint(),))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2017-11-11-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ResourceProviderOperationList>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ResourceProviderOperationList>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod assignments {
    ...
    impl Client {
        ...
        pub fn get(&self, subscription_id: impl Into<String>, assignment_name: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
        ...
        #[doc = "* `subscription_id`: azure subscriptionId, which we assign the blueprint to."]
        #[doc = "* `assignment_name`: name of the assignment."]
        pub fn delete(&self, subscription_id: impl Into<String>, assignment_name: impl Into<String>) -> delete::RequestBuilder {
            delete::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                assignment_name: assignment_name.into(),
    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::Assignment> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::Assignment = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::Assignment>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::Assignment>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AssignmentList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AssignmentList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::AssignmentList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
