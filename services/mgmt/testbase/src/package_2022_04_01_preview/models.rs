...
pub struct BillingHubFreeHourIncrementEntry {
    #[serde(rename = "createTimeStamp", default, skip_serializing_if = "Option::is_none")]
...
impl BillingHubGetUsageRequest {
    pub fn new(start_time_stamp: String, end_time_stamp: String) -> Self {
        Self {
            start_time_stamp,
            end_time_stamp,
            page_size: None,
...
pub struct BillingHubUsageGroup {
    ...
    #[serde(rename = "releaseBuildDate", default, skip_serializing_if = "Option::is_none")]
    pub release_build_date: Option<String>,
    #[serde(rename = "osBuild", default, skip_serializing_if = "Option::is_none")]
    pub os_build: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub release: Option<String>,
