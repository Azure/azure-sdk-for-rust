...
#[doc = "Suggested subscription list"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CollectionOffersByAllContextsPayload {
    #[doc = "Suggested subscription list"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<CollectionOffersByAllContextsProperties>,
}
impl CollectionOffersByAllContextsPayload {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Suggested subscription list"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CollectionOffersByAllContextsProperties {
    #[doc = "Subscription ids list"]
    #[serde(
...
impl CollectionOffersByAllContextsProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "List of offers and plans that restricted to the context"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CollectionOffersByContext {
    #[doc = "Offer's context, e.g. subscription ID, tenant ID."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub context: Option<String>,
    #[doc = "List of offers"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub offers: Option<collection_offers_by_context::Offers>,
}
impl CollectionOffersByContext {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod collection_offers_by_context {
    use super::*;
    #[doc = "List of offers"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
    pub struct Offers {
...
#[doc = "List of objects which describes offers per context. An empty GUID is a public context."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CollectionOffersByContextList {
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<CollectionOffersByContext>,
    #[doc = "URL to get the next set of offer list per context results if there are any."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for CollectionOffersByContextList {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone()
    }
}
impl CollectionOffersByContextList {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct CollectionProperties {
    ...
    #[doc = "Gets list of collection rules"]
    #[serde(
        rename = "appliedRules",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
...
#[doc = "List of subscriptions IDs to query the user's rules"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct QueryUserRulesDetails {
    #[doc = "List of subscription IDs"]
    #[serde(
        rename = "subscriptionIds",
        default,
...
impl QueryUserRulesDetails {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Query user's rules properties"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct QueryUserRulesProperties {
    #[doc = "List of subscriptions IDs to query the user's rules"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<QueryUserRulesDetails>,
}
impl QueryUserRulesProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub mod rule {
    ...
    impl Serialize for Type {
        ...
        {
            match self {
                Self::PrivateProducts => serializer.serialize_unit_variant("Type", 0u32, "PrivateProducts"),
                Self::TermsAndCondition => serializer.serialize_unit_variant("Type", 1u32, "TermsAndCondition"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct RuleListResponse {
    ...
    pub value: Vec<Rule>,
    #[doc = "URL to get the next set of rules list results if there are any."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
