...
pub mod private_store {
    ...
    impl Client {
        ...
        ) -> any_existing_offers_in_the_collections::RequestBuilder {
            any_existing_offers_in_the_collections::RequestBuilder {
                client: self.0.clone(),
                private_store_id: private_store_id.into(),
            }
        ...
        #[doc = "Arguments:"]
        #[doc = "* `private_store_id`: The store ID - must use the tenant ID"]
        pub fn query_user_offers(&self, private_store_id: impl Into<String>) -> query_user_offers::RequestBuilder {
            query_user_offers::RequestBuilder {
                client: self.0.clone(),
                private_store_id: private_store_id.into(),
                payload: None,
            }
    ...
    pub mod any_existing_offers_in_the_collections {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AnyExistingOffersInTheCollectionsResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AnyExistingOffersInTheCollectionsResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AnyExistingOffersInTheCollectionsResponse>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AnyExistingOffersInTheCollectionsResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
impl Client {
    ...
    #[doc = "Arguments:"]
    #[doc = "* `private_store_id`: The store ID - must use the tenant ID"]
    pub fn query_user_rules(&self, private_store_id: impl Into<String>) -> query_user_rules::RequestBuilder {
        query_user_rules::RequestBuilder {
            client: self.clone(),
            private_store_id: private_store_id.into(),
            payload: None,
        }
    ...
    ) -> set_collection_rules::RequestBuilder {
        set_collection_rules::RequestBuilder {
            client: self.clone(),
            private_store_id: private_store_id.into(),
    ...
    #[doc = "* `private_store_id`: The store ID - must use the tenant ID"]
    #[doc = "* `collection_id`: The collection ID"]
    pub fn query_rules(&self, private_store_id: impl Into<String>, collection_id: impl Into<String>) -> query_rules::RequestBuilder {
        query_rules::RequestBuilder {
            client: self.clone(),
            private_store_id: private_store_id.into(),
            collection_id: collection_id.into(),
        }
...
pub mod query_user_rules {
    use super::models;
    pub struct Response(azure_core::Response);
    impl Response {
        pub async fn into_body(self) -> azure_core::Result<models::RuleListResponse> {
            let bytes = self.0.into_body().collect().await?;
            let body: models::RuleListResponse = serde_json::from_slice(&bytes)?;
            Ok(body)
        }
        pub fn into_raw_response(self) -> azure_core::Response {
            self.0
    ...
    pub struct RequestBuilder {
        ...
        pub(crate) private_store_id: String,
        pub(crate) payload: Option<models::QueryUserRulesProperties>,
    }
    impl RequestBuilder {
        pub fn payload(mut self, payload: impl Into<models::QueryUserRulesProperties>) -> Self {
            self.payload = Some(payload.into());
            self
        }
        #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
        ...
        pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
            Box::pin({
                ...
                async move {
                    let url = azure_core::Url::parse(&format!(
                        "{}/providers/Microsoft.Marketplace/privateStores/{}/queryUserRules",
                        this.client.endpoint(),
                        &this.private_store_id
                    ))?;
                    let mut req = azure_core::Request::new(url, azure_core::Method::Post);
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::RuleListResponse>;
        type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::RuleListResponse>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod set_collection_rules {
    ...
    pub struct RequestBuilder {
        ...
        pub(crate) payload: Option<models::SetRulesRequest>,
    }
    impl RequestBuilder {
        pub fn payload(mut self, payload: impl Into<models::SetRulesRequest>) -> Self {
            self.payload = Some(payload.into());
            self
        }
        #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
        ...
        pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
            Box::pin({
                ...
                async move {
                    let url = azure_core::Url::parse(&format!(
                        "{}/providers/Microsoft.Marketplace/privateStores/{}/collections/{}/setRules",
                        this.client.endpoint(),
                        &this.private_store_id,
                        &this.collection_id
                    ))?;
    ...
    impl RequestBuilder {
        ...
        pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
            Box::pin({
                ...
                async move {
                    let url = azure_core::Url::parse(&format!(
                        "{}/providers/Microsoft.Marketplace/privateStores/{}/collections/{}/queryRules",
                        this.client.endpoint(),
                        &this.private_store_id,
                        &this.collection_id
                    ))?;
...
pub mod private_store_collection {
    ...
    impl Client {
        ...
        pub fn approve_all_items(
            ...
            private_store_id: impl Into<String>,
            collection_id: impl Into<String>,
        ) -> approve_all_items::RequestBuilder {
            approve_all_items::RequestBuilder {
                client: self.0.clone(),
                private_store_id: private_store_id.into(),
                collection_id: collection_id.into(),
        ...
        pub fn disable_approve_all_items(
            ...
            private_store_id: impl Into<String>,
            collection_id: impl Into<String>,
        ) -> disable_approve_all_items::RequestBuilder {
            disable_approve_all_items::RequestBuilder {
                client: self.0.clone(),
                private_store_id: private_store_id.into(),
                collection_id: collection_id.into(),
...
pub mod private_store_collection_offer {
    ...
    impl Client {
        ...
        #[doc = "* `private_store_id`: The store ID - must use the tenant ID"]
        #[doc = "* `collection_id`: The collection ID"]
        pub fn list_by_contexts(
            &self,
            private_store_id: impl Into<String>,
            collection_id: impl Into<String>,
        ) -> list_by_contexts::RequestBuilder {
            list_by_contexts::RequestBuilder {
                client: self.0.clone(),
                private_store_id: private_store_id.into(),
                collection_id: collection_id.into(),
        ...
        pub fn upsert_offer_with_multi_context(
            ...
            collection_id: impl Into<String>,
            offer_id: impl Into<String>,
        ) -> upsert_offer_with_multi_context::RequestBuilder {
            upsert_offer_with_multi_context::RequestBuilder {
                client: self.0.clone(),
                private_store_id: private_store_id.into(),
                collection_id: collection_id.into(),
    ...
    pub mod list_by_contexts {
        use super::models;
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CollectionOffersByContextList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CollectionOffersByContextList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) private_store_id: String,
            pub(crate) collection_id: String,
            pub(crate) payload: Option<models::CollectionOffersByAllContextsPayload>,
        }
        impl RequestBuilder {
            pub fn payload(mut self, payload: impl Into<models::CollectionOffersByAllContextsPayload>) -> Self {
                self.payload = Some(payload.into());
                self
            }
            pub fn into_stream(self) -> azure_core::Pageable<models::CollectionOffersByContextList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
                            "{}/providers/Microsoft.Marketplace/privateStores/{}/collections/{}/mapOffersToContexts",
                            this.client.endpoint(),
                            &this.private_store_id,
                            &this.collection_id
                        ))?;
