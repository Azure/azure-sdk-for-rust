...
pub mod accounts {
    ...
    pub mod list {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DataLakeStoreAccountListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DataLakeStoreAccountListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::DataLakeStoreAccountListResult, azure_core::error::Error> {
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DataLakeStoreAccount> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DataLakeStoreAccount = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DataLakeStoreAccount>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DataLakeStoreAccount>>;
    ...
    pub mod check_name_availability {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::NameAvailabilityInformation> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::NameAvailabilityInformation = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::NameAvailabilityInformation>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::NameAvailabilityInformation>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataLakeStore/accounts/{}/firewallRules/{}",
                    &self.subscription_id, &self.resource_group_name, &self.account_name, &self.firewall_rule_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataLakeStore/accounts/{}/virtualNetworkRules/{}",
                    &self.subscription_id, &self.resource_group_name, &self.account_name, &self.virtual_network_rule_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
...
pub mod trusted_id_providers {
    ...
    pub mod list_by_account {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::TrustedIdProviderListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::TrustedIdProviderListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::TrustedIdProviderListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::TrustedIdProvider> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::TrustedIdProvider = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataLakeStore/accounts/{}/trustedIdProviders/{}",
                    &self.subscription_id, &self.resource_group_name, &self.account_name, &self.trusted_id_provider_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::TrustedIdProvider>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::TrustedIdProvider>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod operations {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.DataLakeStore/operations",));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2016-11-01");
...
pub mod locations {
    ...
    impl Client {
        ...
        #[doc = "* `subscription_id`: Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call."]
        #[doc = "* `location`: The resource location without whitespace."]
        pub fn get_capability(&self, subscription_id: impl Into<String>, location: impl Into<String>) -> get_capability::RequestBuilder {
            get_capability::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                location: location.into(),
            }
        ...
        #[doc = "* `subscription_id`: Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call."]
        #[doc = "* `location`: The resource location without whitespace."]
        pub fn get_usage(&self, subscription_id: impl Into<String>, location: impl Into<String>) -> get_usage::RequestBuilder {
            get_usage::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                location: location.into(),
            }
    ...
    pub mod get_capability {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CapabilityInformation> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CapabilityInformation = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::CapabilityInformation>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::CapabilityInformation>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
