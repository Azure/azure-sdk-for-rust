...
pub mod accounts {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::DataLakeStoreAccount>> {
    ...
    pub mod check_name_availability {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::NameAvailabilityInformation>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
...
pub mod trusted_id_providers {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::TrustedIdProvider>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
...
pub mod locations {
    ...
    pub mod get_capability {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::CapabilityInformation>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
