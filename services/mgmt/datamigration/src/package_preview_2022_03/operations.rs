...
pub enum Error {
    #[error(transparent)]
    DatabaseMigrationsSqlDb_Get(#[from] database_migrations_sql_db::get::Error),
    #[error(transparent)]
    DatabaseMigrationsSqlDb_CreateOrUpdate(#[from] database_migrations_sql_db::create_or_update::Error),
    #[error(transparent)]
    DatabaseMigrationsSqlDb_Delete(#[from] database_migrations_sql_db::delete::Error),
    #[error(transparent)]
    DatabaseMigrationsSqlDb_Cancel(#[from] database_migrations_sql_db::cancel::Error),
    #[error(transparent)]
        ...
        impl Builder {
            ...
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<Response, Error>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url_str = & format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Sql/servers/{}/providers/Microsoft.DataMigration/databaseMigrations/{}" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . sql_db_instance_name , & this . target_db_name) ;
                        ...
                        url.query_pairs_mut().append_pair("api-version", "2022-03-30-preview");
                        ...
                        match rsp_status {
                            http::StatusCode::OK => {
                                ...
                                let rsp_value: models::DatabaseMigrationSqlDb =
        ...
        impl Builder {
            ...
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<Response, Error>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url_str = & format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Sql/servers/{}/providers/Microsoft.DataMigration/databaseMigrations/{}/cancel" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . sql_db_instance_name , & this . target_db_name) ;
                        let mut url = url::Url::parse(url_str).map_err(Error::ParseUrl)?;
                        let mut req_builder = http::request::Builder::new();
