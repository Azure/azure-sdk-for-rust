...
pub struct CopyProgressDetails {
    ...
    #[doc = "Copy Start"]
    #[serde(rename = "copyStart", default, skip_serializing_if = "Option::is_none")]
...
pub struct MigrationStatusDetails {
    ...
    #[serde(rename = "invalidFiles", default, skip_serializing_if = "Vec::is_empty")]
    ...
    #[serde(rename = "fileUploadBlockingErrors", default, skip_serializing_if = "Vec::is_empty")]
...
pub struct MongoDbProgress {
    ...
    #[serde(rename = "lastEventTime", default, skip_serializing_if = "Option::is_none")]
    pub last_event_time: Option<String>,
    #[doc = "The timestamp of the last oplog event replayed, or null if no oplog event has been replayed yet"]
    #[serde(rename = "lastReplayTime", default, skip_serializing_if = "Option::is_none")]
    pub last_replay_time: Option<String>,
...
pub struct SqlBackupSetInfo {
    ...
    #[serde(rename = "ignoreReasons", default, skip_serializing_if = "Vec::is_empty")]
...
pub struct SqlDbMigrationStatusDetails {
    ...
    #[serde(rename = "sqlDataCopyErrors", default, skip_serializing_if = "Vec::is_empty")]
    pub sql_data_copy_errors: Vec<String>,
    #[doc = "Details on progress of ADF copy activities."]
    #[serde(rename = "listOfCopyProgressDetails", default, skip_serializing_if = "Vec::is_empty")]
