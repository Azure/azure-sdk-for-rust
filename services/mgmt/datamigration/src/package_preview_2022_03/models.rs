...
pub struct AzureActiveDirectoryApp {
    ...
    #[serde(rename = "appKey", default, skip_serializing_if = "Option::is_none")]
    pub app_key: Option<String>,
    #[doc = "Tenant id of the customer"]
    #[serde(rename = "tenantId", default, skip_serializing_if = "Option::is_none")]
    pub tenant_id: Option<String>,
    #[doc = "Ignore checking azure permissions on the AAD app"]
    #[serde(rename = "ignoreAzurePermissions", default, skip_serializing_if = "Option::is_none")]
    pub ignore_azure_permissions: Option<bool>,
}
...
pub struct CommandProperties {
    ...
    pub command_type: command_properties::CommandType,
...
impl CommandProperties {
    pub fn new(command_type: command_properties::CommandType) -> Self {
        Self {
            command_type,
            errors: Vec::new(),
            state: None,
...
pub mod command_properties {
    ...
    impl Serialize for CommandType {
        ...
        {
            match self {
                Self::MigrateSyncCompleteDatabase => {
                    serializer.serialize_unit_variant("CommandType", 0u32, "Migrate.Sync.Complete.Database")
                }
                Self::MigrateSqlServerAzureDbSqlMiComplete => {
                    serializer.serialize_unit_variant("CommandType", 1u32, "Migrate.SqlServer.AzureDbSqlMi.Complete")
                }
                Self::Cancel => serializer.serialize_unit_variant("CommandType", 2u32, "cancel"),
                Self::Finish => serializer.serialize_unit_variant("CommandType", 3u32, "finish"),
                Self::Restart => serializer.serialize_unit_variant("CommandType", 4u32, "restart"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct ConnectToSourceSqlServerTaskInput {
    ...
    #[serde(rename = "encryptedKeyForSecureFields", default, skip_serializing_if = "Option::is_none")]
    pub encrypted_key_for_secure_fields: Option<String>,
}
impl ConnectToSourceSqlServerTaskInput {
    pub fn new(source_connection_info: SqlConnectionInfo) -> Self {
        Self {
            ...
            encrypted_key_for_secure_fields: None,
        }
    }
}
...
pub struct ConnectToTargetSqlDbTaskInput {
    ...
    #[serde(rename = "queryObjectCounts", default, skip_serializing_if = "Option::is_none")]
    pub query_object_counts: Option<bool>,
}
impl ConnectToTargetSqlDbTaskInput {
    pub fn new(target_connection_info: SqlConnectionInfo) -> Self {
        Self {
            target_connection_info,
            query_object_counts: None,
        }
    }
}
...
pub struct CopyProgressDetails {
    ...
    #[serde(rename = "parallelCopyType", default, skip_serializing_if = "Option::is_none")]
    pub parallel_copy_type: Option<String>,
    #[doc = "The degree of parallelization."]
    #[serde(rename = "usedParallelCopies", default, skip_serializing_if = "Option::is_none")]
    ...
    #[doc = "Copy Start"]
    #[serde(rename = "copyStart", default, with = "azure_core::date::rfc3339::option")]
    pub copy_start: Option<time::OffsetDateTime>,
    #[doc = "Copy throughput in KBps"]
    #[serde(rename = "copyThroughput", default, skip_serializing_if = "Option::is_none")]
    pub copy_throughput: Option<f64>,
    #[doc = "Copy Duration in seconds"]
    #[serde(rename = "copyDuration", default, skip_serializing_if = "Option::is_none")]
    pub copy_duration: Option<i32>,
}
impl CopyProgressDetails {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct DataMigrationServiceProperties {
    ...
    #[serde(rename = "virtualSubnetId", default, skip_serializing_if = "Option::is_none")]
    pub virtual_subnet_id: Option<String>,
    ...
    #[serde(rename = "autoStopDelay", default, skip_serializing_if = "Option::is_none")]
    pub auto_stop_delay: Option<String>,
    #[doc = "Whether service resources should be deleted when stopped. (Turned on by default)"]
    #[serde(rename = "deleteResourcesOnStop", default, skip_serializing_if = "Option::is_none")]
    pub delete_resources_on_stop: Option<bool>,
}
...
pub struct DataMigrationServiceStatusResponse {
    ...
    pub agent_configuration: Option<serde_json::Value>,
...
pub struct DatabaseMigration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<DatabaseMigrationPropertiesUnion>,
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DatabaseMigrationListResult {
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<DatabaseMigration>,
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
...
#[doc = "Database Migration Resource properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DatabaseMigrationProperties {
    pub kind: database_migration_properties::Kind,
    ...
    #[serde(rename = "sourceSqlConnection", default, skip_serializing_if = "Option::is_none")]
    pub source_sql_connection: Option<SqlConnectionInformation>,
    ...
    #[serde(rename = "migrationService", default, skip_serializing_if = "Option::is_none")]
    pub migration_service: Option<String>,
    #[doc = "ID tracking current migration operation."]
    #[serde(rename = "migrationOperationId", default, skip_serializing_if = "Option::is_none")]
    pub migration_operation_id: Option<String>,
    #[doc = "Error details"]
    #[serde(rename = "migrationFailureError", default, skip_serializing_if = "Option::is_none")]
    pub migration_failure_error: Option<ErrorInfo>,
    #[doc = "Database collation to be used for the target database."]
    #[serde(rename = "targetDatabaseCollation", default, skip_serializing_if = "Option::is_none")]
    pub target_database_collation: Option<String>,
...
impl DatabaseMigrationProperties {
    pub fn new(kind: database_migration_properties::Kind) -> Self {
        Self {
            kind,
            scope: None,
            ...
            migration_failure_error: None,
            target_database_collation: None,
            provisioning_error: None,
        }
    }
}
pub mod database_migration_properties {
    use super::*;
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Kind")]
    pub enum Kind {
    ...
    impl Serialize for Kind {
        ...
        {
            match self {
                Self::SqlMi => serializer.serialize_unit_variant("Kind", 0u32, "SqlMi"),
                Self::SqlVm => serializer.serialize_unit_variant("Kind", 1u32, "SqlVm"),
                Self::SqlDb => serializer.serialize_unit_variant("Kind", 2u32, "SqlDb"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "kind")]
pub enum DatabaseMigrationPropertiesUnion {
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DatabaseMigrationPropertiesSqlDb {
    #[serde(flatten)]
    pub database_migration_properties: DatabaseMigrationProperties,
    #[doc = "Detailed status of current Sql Db migration."]
    #[serde(rename = "migrationStatusDetails", default, skip_serializing_if = "Option::is_none")]
    pub migration_status_details: Option<SqlDbMigrationStatusDetails>,
    #[doc = "Source SQL Connection"]
    #[serde(rename = "targetSqlConnection", default, skip_serializing_if = "Option::is_none")]
    pub target_sql_connection: Option<SqlConnectionInformation>,
    #[doc = "Offline configuration"]
    #[serde(rename = "offlineConfiguration", default, skip_serializing_if = "Option::is_none")]
    pub offline_configuration: Option<SqlDbOfflineConfiguration>,
...
impl DatabaseMigrationPropertiesSqlDb {
    pub fn new(database_migration_properties: DatabaseMigrationProperties) -> Self {
        Self {
            database_migration_properties,
            migration_status_details: None,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DatabaseMigrationPropertiesSqlMi {
    #[serde(flatten)]
    pub database_migration_properties: DatabaseMigrationProperties,
    #[doc = "Detailed status of current migration."]
    #[serde(rename = "migrationStatusDetails", default, skip_serializing_if = "Option::is_none")]
    pub migration_status_details: Option<MigrationStatusDetails>,
    #[doc = "Backup Configuration"]
    #[serde(rename = "backupConfiguration", default, skip_serializing_if = "Option::is_none")]
    pub backup_configuration: Option<BackupConfiguration>,
    #[doc = "Offline configuration"]
    #[serde(rename = "offlineConfiguration", default, skip_serializing_if = "Option::is_none")]
    pub offline_configuration: Option<OfflineConfiguration>,
}
impl DatabaseMigrationPropertiesSqlMi {
    pub fn new(database_migration_properties: DatabaseMigrationProperties) -> Self {
        Self {
            database_migration_properties,
            migration_status_details: None,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DatabaseMigrationPropertiesSqlVm {
    #[serde(flatten)]
    pub database_migration_properties: DatabaseMigrationProperties,
    #[doc = "Detailed status of current migration."]
    #[serde(rename = "migrationStatusDetails", default, skip_serializing_if = "Option::is_none")]
...
impl DatabaseMigrationPropertiesSqlVm {
    pub fn new(database_migration_properties: DatabaseMigrationProperties) -> Self {
        Self {
            database_migration_properties,
            migration_status_details: None,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DatabaseMigrationSqlDb {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[serde(rename = "systemData", default, skip_serializing_if = "Option::is_none")]
    pub system_data: Option<SystemData>,
    #[doc = "Database Migration Resource properties for SQL database."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<DatabaseMigrationPropertiesSqlDb>,
}
impl DatabaseMigrationSqlDb {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DatabaseMigrationSqlMi {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[serde(rename = "systemData", default, skip_serializing_if = "Option::is_none")]
    pub system_data: Option<SystemData>,
    #[doc = "Database Migration Resource properties for SQL Managed Instance."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<DatabaseMigrationPropertiesSqlMi>,
}
impl DatabaseMigrationSqlMi {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DatabaseMigrationSqlVm {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[serde(rename = "systemData", default, skip_serializing_if = "Option::is_none")]
    pub system_data: Option<SystemData>,
    #[doc = "Database Migration Resource properties for SQL Virtual Machine."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<DatabaseMigrationPropertiesSqlVm>,
}
impl DatabaseMigrationSqlVm {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct IntegrationRuntimeMonitoringData {
    ...
    pub nodes: Vec<NodeMonitoringData>,
}
...
pub struct MigrateMongoDbTaskProperties {
    ...
    pub output: Vec<MongoDbProgressUnion>,
}
...
pub struct MigrateMySqlAzureDbForMySqlOfflineTaskProperties {
    ...
    pub output: Vec<MigrateMySqlAzureDbForMySqlOfflineTaskOutputUnion>,
    #[doc = "whether the task can be cloned or not"]
    #[serde(rename = "isCloneable", default, skip_serializing_if = "Option::is_none")]
...
pub struct MigrateOracleAzureDbForPostgreSqlSyncTaskProperties {
    ...
    pub output: Vec<MigrateOracleAzureDbPostgreSqlSyncTaskOutputUnion>,
}
...
pub struct MigrateSchemaSqlServerSqlDbTaskProperties {
    ...
    pub output: Vec<MigrateSchemaSqlServerSqlDbTaskOutputUnion>,
    #[doc = "DateTime in UTC when the task was created"]
    #[serde(rename = "createdOn", default, skip_serializing_if = "Option::is_none")]
    pub created_on: Option<String>,
    #[doc = "Task id "]
...
pub struct MigrateSqlServerSqlDbDatabaseInput {
    ...
    #[serde(rename = "schemaSetting", default, skip_serializing_if = "Option::is_none")]
    pub schema_setting: Option<serde_json::Value>,
...
pub struct MigrateSqlServerSqlMiSyncTaskInput {
    ...
    #[serde(rename = "numberOfParallelDatabaseMigrations", default, skip_serializing_if = "Option::is_none")]
...
impl MigrateSqlServerSqlMiSyncTaskInput {
    pub fn new(sql_server_sql_mi_sync_task_input: SqlServerSqlMiSyncTaskInput) -> Self {
        Self {
            ...
            number_of_parallel_database_migrations: None,
        }
    }
}
...
pub struct MigrateSsisTaskProperties {
    ...
    pub output: Vec<MigrateSsisTaskOutputUnion>,
}
...
#[doc = "Detailed status of current migration."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MigrationStatusDetails {
    #[doc = "Current State of Migration."]
    #[serde(rename = "migrationState", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "restoreBlockingReason", default, skip_serializing_if = "Option::is_none")]
    pub restore_blocking_reason: Option<String>,
    #[doc = "Complete restore error message, if any"]
    #[serde(rename = "completeRestoreErrorMessage", default, skip_serializing_if = "Option::is_none")]
    pub complete_restore_error_message: Option<String>,
    #[doc = "File upload blocking errors, if any."]
    #[serde(
        rename = "fileUploadBlockingErrors",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    ...
    #[serde(rename = "pendingLogBackupsCount", default, skip_serializing_if = "Option::is_none")]
    pub pending_log_backups_count: Option<i32>,
}
impl MigrationStatusDetails {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct MongoDbConnectionInfo {
    ...
    #[doc = "server brand version"]
    #[serde(rename = "serverBrandVersion", default, skip_serializing_if = "Option::is_none")]
...
pub struct ProjectProperties {
    ...
    #[doc = "Azure Active Directory Application"]
    #[serde(rename = "azureAuthenticationInfo", default, skip_serializing_if = "Option::is_none")]
...
impl ProjectProperties {
    pub fn new(source_platform: ProjectSourcePlatform, target_platform: ProjectTargetPlatform) -> Self {
        Self {
            source_platform,
            azure_authentication_info: None,
            target_platform,
            creation_time: None,
...
pub struct ProjectTaskProperties {
    ...
    pub task_type: project_task_properties::TaskType,
    #[doc = "Array of errors. This is ignored if submitted."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
...
impl ProjectTaskProperties {
    pub fn new(task_type: project_task_properties::TaskType) -> Self {
        Self {
            task_type,
            errors: Vec::new(),
            state: None,
...
pub mod project_task_properties {
    ...
    pub enum TaskType {
        ...
        #[serde(rename = "ConnectToSource.Oracle.Sync")]
        ...
        #[serde(rename = "ConnectToTarget.Oracle.AzureDbForPostgreSql.Sync")]
        ...
        #[serde(rename = "Migrate.MySql.AzureDbForMySql")]
        MigrateMySqlAzureDbForMySql,
        #[serde(rename = "Migrate.PostgreSql.AzureDbForPostgreSql.SyncV2")]
        MigratePostgreSqlAzureDbForPostgreSqlSyncV2,
        #[serde(rename = "Migrate.Oracle.AzureDbForPostgreSql.Sync")]
        ...
        #[serde(rename = "Validate.MongoDb")]
        ValidateMongoDb,
        #[serde(rename = "Validate.Oracle.AzureDbPostgreSql.Sync")]
        ValidateOracleAzureDbPostgreSqlSync,
        #[serde(rename = "GetTDECertificates.Sql")]
        GetTdeCertificatesSql,
        #[serde(rename = "Migrate.Ssis")]
        MigrateSsis,
        #[serde(rename = "Service.Check.OCI")]
        ServiceCheckOci,
        #[serde(rename = "Service.Upload.OCI")]
        ServiceUploadOci,
        #[serde(rename = "Service.Install.OCI")]
        ServiceInstallOci,
    ...
    impl Serialize for TaskType {
        ...
        {
            match self {
                Self::ConnectMongoDb => serializer.serialize_unit_variant("TaskType", 0u32, "Connect.MongoDb"),
                Self::ConnectToSourceSqlServer => serializer.serialize_unit_variant("TaskType", 1u32, "ConnectToSource.SqlServer"),
                Self::ConnectToSourceSqlServerSync => serializer.serialize_unit_variant("TaskType", 2u32, "ConnectToSource.SqlServer.Sync"),
                Self::ConnectToSourcePostgreSqlSync => {
                    serializer.serialize_unit_variant("TaskType", 3u32, "ConnectToSource.PostgreSql.Sync")
                }
                Self::ConnectToSourceMySql => serializer.serialize_unit_variant("TaskType", 4u32, "ConnectToSource.MySql"),
                Self::ConnectToSourceOracleSync => serializer.serialize_unit_variant("TaskType", 5u32, "ConnectToSource.Oracle.Sync"),
                Self::ConnectToTargetSqlDb => serializer.serialize_unit_variant("TaskType", 6u32, "ConnectToTarget.SqlDb"),
                Self::ConnectToTargetSqlDbSync => serializer.serialize_unit_variant("TaskType", 7u32, "ConnectToTarget.SqlDb.Sync"),
                Self::ConnectToTargetAzureDbForPostgreSqlSync => {
                    serializer.serialize_unit_variant("TaskType", 8u32, "ConnectToTarget.AzureDbForPostgreSql.Sync")
                }
                Self::ConnectToTargetOracleAzureDbForPostgreSqlSync => {
                    serializer.serialize_unit_variant("TaskType", 9u32, "ConnectToTarget.Oracle.AzureDbForPostgreSql.Sync")
                }
                Self::ConnectToTargetAzureSqlDbMi => serializer.serialize_unit_variant("TaskType", 10u32, "ConnectToTarget.AzureSqlDbMI"),
                Self::ConnectToTargetAzureSqlDbMiSyncLrs => {
                    serializer.serialize_unit_variant("TaskType", 11u32, "ConnectToTarget.AzureSqlDbMI.Sync.LRS")
                }
                Self::ConnectToTargetAzureDbForMySql => {
                    serializer.serialize_unit_variant("TaskType", 12u32, "ConnectToTarget.AzureDbForMySql")
                }
                Self::GetUserTablesSql => serializer.serialize_unit_variant("TaskType", 13u32, "GetUserTables.Sql"),
                Self::GetUserTablesAzureSqlDbSync => serializer.serialize_unit_variant("TaskType", 14u32, "GetUserTables.AzureSqlDb.Sync"),
                Self::GetUserTablesOracle => serializer.serialize_unit_variant("TaskType", 15u32, "GetUserTablesOracle"),
                Self::GetUserTablesPostgreSql => serializer.serialize_unit_variant("TaskType", 16u32, "GetUserTablesPostgreSql"),
                Self::GetUserTablesMySql => serializer.serialize_unit_variant("TaskType", 17u32, "GetUserTablesMySql"),
                Self::MigrateMongoDb => serializer.serialize_unit_variant("TaskType", 18u32, "Migrate.MongoDb"),
                Self::MigrateSqlServerAzureSqlDbMi => {
                    serializer.serialize_unit_variant("TaskType", 19u32, "Migrate.SqlServer.AzureSqlDbMI")
                }
                Self::MigrateSqlServerAzureSqlDbMiSyncLrs => {
                    serializer.serialize_unit_variant("TaskType", 20u32, "Migrate.SqlServer.AzureSqlDbMI.Sync.LRS")
                }
                Self::MigrateSqlServerSqlDb => serializer.serialize_unit_variant("TaskType", 21u32, "Migrate.SqlServer.SqlDb"),
                Self::MigrateSqlServerAzureSqlDbSync => {
                    serializer.serialize_unit_variant("TaskType", 22u32, "Migrate.SqlServer.AzureSqlDb.Sync")
                }
                Self::MigrateMySqlAzureDbForMySqlSync => {
                    serializer.serialize_unit_variant("TaskType", 23u32, "Migrate.MySql.AzureDbForMySql.Sync")
                }
                Self::MigrateMySqlAzureDbForMySql => serializer.serialize_unit_variant("TaskType", 24u32, "Migrate.MySql.AzureDbForMySql"),
                Self::MigratePostgreSqlAzureDbForPostgreSqlSyncV2 => {
                    serializer.serialize_unit_variant("TaskType", 25u32, "Migrate.PostgreSql.AzureDbForPostgreSql.SyncV2")
                }
                Self::MigrateOracleAzureDbForPostgreSqlSync => {
                    serializer.serialize_unit_variant("TaskType", 26u32, "Migrate.Oracle.AzureDbForPostgreSql.Sync")
                }
                Self::ValidateMigrationInputSqlServerSqlDbSync => {
                    serializer.serialize_unit_variant("TaskType", 27u32, "ValidateMigrationInput.SqlServer.SqlDb.Sync")
                }
                Self::ValidateMigrationInputSqlServerAzureSqlDbMi => {
                    serializer.serialize_unit_variant("TaskType", 28u32, "ValidateMigrationInput.SqlServer.AzureSqlDbMI")
                }
                Self::ValidateMigrationInputSqlServerAzureSqlDbMiSyncLrs => {
                    serializer.serialize_unit_variant("TaskType", 29u32, "ValidateMigrationInput.SqlServer.AzureSqlDbMI.Sync.LRS")
                }
                Self::ValidateMongoDb => serializer.serialize_unit_variant("TaskType", 30u32, "Validate.MongoDb"),
                Self::ValidateOracleAzureDbPostgreSqlSync => {
                    serializer.serialize_unit_variant("TaskType", 31u32, "Validate.Oracle.AzureDbPostgreSql.Sync")
                }
                Self::GetTdeCertificatesSql => serializer.serialize_unit_variant("TaskType", 32u32, "GetTDECertificates.Sql"),
                Self::MigrateSsis => serializer.serialize_unit_variant("TaskType", 33u32, "Migrate.Ssis"),
                Self::ServiceCheckOci => serializer.serialize_unit_variant("TaskType", 34u32, "Service.Check.OCI"),
                Self::ServiceUploadOci => serializer.serialize_unit_variant("TaskType", 35u32, "Service.Upload.OCI"),
                Self::ServiceInstallOci => serializer.serialize_unit_variant("TaskType", 36u32, "Service.Install.OCI"),
                Self::MigrateSchemaSqlServerSqlDb => serializer.serialize_unit_variant("TaskType", 37u32, "MigrateSchemaSqlServerSqlDb"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub enum ProjectTaskPropertiesUnion {
    #[serde(rename = "Service.Check.OCI")]
    ServiceCheckOci(CheckOciDriverTaskProperties),
    #[serde(rename = "Connect.MongoDb")]
    ConnectMongoDb(ConnectToMongoDbTaskProperties),
    #[serde(rename = "ConnectToSource.MySql")]
    ConnectToSourceMySql(ConnectToSourceMySqlTaskProperties),
    #[serde(rename = "ConnectToSource.Oracle.Sync")]
    ConnectToSourceOracleSync(ConnectToSourceOracleSyncTaskProperties),
    #[serde(rename = "ConnectToSource.PostgreSql.Sync")]
    ...
    #[serde(rename = "ConnectToTarget.Oracle.AzureDbForPostgreSql.Sync")]
    ConnectToTargetOracleAzureDbForPostgreSqlSync(ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskProperties),
    #[serde(rename = "ConnectToTarget.SqlDb")]
    ...
    #[serde(rename = "Service.Install.OCI")]
    ServiceInstallOci(InstallOciDriverTaskProperties),
    #[serde(rename = "Migrate.MongoDb")]
    MigrateMongoDb(MigrateMongoDbTaskProperties),
    #[serde(rename = "Migrate.MySql.AzureDbForMySql")]
    MigrateMySqlAzureDbForMySql(MigrateMySqlAzureDbForMySqlOfflineTaskProperties),
    #[serde(rename = "Migrate.MySql.AzureDbForMySql.Sync")]
    MigrateMySqlAzureDbForMySqlSync(MigrateMySqlAzureDbForMySqlSyncTaskProperties),
    #[serde(rename = "Migrate.Oracle.AzureDbForPostgreSql.Sync")]
    MigrateOracleAzureDbForPostgreSqlSync(MigrateOracleAzureDbForPostgreSqlSyncTaskProperties),
    #[serde(rename = "Migrate.PostgreSql.AzureDbForPostgreSql.SyncV2")]
    MigratePostgreSqlAzureDbForPostgreSqlSyncV2(MigratePostgreSqlAzureDbForPostgreSqlSyncTaskProperties),
    ...
    #[serde(rename = "Migrate.Ssis")]
    MigrateSsis(MigrateSsisTaskProperties),
    #[serde(rename = "Service.Upload.OCI")]
    ServiceUploadOci(UploadOciDriverTaskProperties),
    #[serde(rename = "ValidateMigrationInput.SqlServer.SqlDb.Sync")]
    ...
    #[serde(rename = "Validate.MongoDb")]
    ValidateMongoDb(ValidateMongoDbTaskProperties),
    #[serde(rename = "Validate.Oracle.AzureDbPostgreSql.Sync")]
    ValidateOracleAzureDbPostgreSqlSync(ValidateOracleAzureDbForPostgreSqlSyncTaskProperties),
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub enum ServerLevelPermissionsGroup {
    ...
    #[serde(rename = "MigrationFromSqlServerToAzureVM")]
...
pub struct SourceLocation {
    ...
    pub file_share: Option<SqlFileShare>,
    #[doc = "Azure Blob Details"]
    #[serde(rename = "azureBlob", default, skip_serializing_if = "Option::is_none")]
    pub azure_blob: Option<AzureBlob>,
    #[doc = "Backup storage Type."]
    #[serde(rename = "fileStorageType", default, skip_serializing_if = "Option::is_none")]
...
pub struct SqlBackupSetInfo {
    ...
    pub list_of_backup_files: Vec<SqlBackupFileInfo>,
    ...
    #[serde(rename = "hasBackupChecksums", default, skip_serializing_if = "Option::is_none")]
    pub has_backup_checksums: Option<bool>,
    #[doc = "Media family count"]
    #[serde(rename = "familyCount", default, skip_serializing_if = "Option::is_none")]
    pub family_count: Option<i32>,
    #[doc = "The reasons why the backup set is ignored"]
    #[serde(
        rename = "ignoreReasons",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
...
#[doc = "Detailed status of current Sql Db migration."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SqlDbMigrationStatusDetails {
    #[doc = "Current State of Migration."]
    #[serde(rename = "migrationState", default, skip_serializing_if = "Option::is_none")]
    pub migration_state: Option<String>,
    #[doc = "Sql Data Copy errors, if any."]
    #[serde(
        rename = "sqlDataCopyErrors",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub sql_data_copy_errors: Vec<String>,
    #[doc = "Details on progress of ADF copy activities."]
    #[serde(
        rename = "listOfCopyProgressDetails",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub list_of_copy_progress_details: Vec<CopyProgressDetails>,
}
impl SqlDbMigrationStatusDetails {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Offline configuration"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SqlDbOfflineConfiguration {
    #[doc = "Offline migration"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub offline: Option<bool>,
}
impl SqlDbOfflineConfiguration {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "A list of SQL Migration Service."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SqlMigrationListResult {
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<SqlMigrationService>,
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
...
pub struct SqlMigrationService {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<SqlMigrationServiceProperties>,
}
...
pub struct SqlMigrationServiceProperties {
    ...
    #[serde(rename = "integrationRuntimeState", default, skip_serializing_if = "Option::is_none")]
    pub integration_runtime_state: Option<String>,
}
impl SqlMigrationServiceProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "An update to a SQL Migration Service."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SqlMigrationServiceUpdate {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<serde_json::Value>,
}
impl SqlMigrationServiceUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
