...
#[doc = "Database Migration Resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DatabaseMigrationBase {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Database Migration Base Resource properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<DatabaseMigrationBasePropertiesUnion>,
}
impl DatabaseMigrationBase {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DatabaseMigrationBaseListResult {
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<DatabaseMigrationBase>,
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for DatabaseMigrationBaseListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl DatabaseMigrationBaseListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Database Migration Base Resource properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DatabaseMigrationBaseProperties {
    #[doc = "Resource Id of the target resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<database_migration_base_properties::ProvisioningState>,
    ...
    #[doc = "ID for current migration operation."]
...
impl DatabaseMigrationBaseProperties {
    pub fn new() -> Self {
        Self {
            scope: None,
...
pub mod database_migration_base_properties {
    use super::*;
    #[doc = "Provisioning State of migration. ProvisioningState as Succeeded implies that validations have been performed and migration has started."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ProvisioningState")]
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "kind")]
pub enum DatabaseMigrationBasePropertiesUnion {
    MongoToCosmosDbMongo(DatabaseMigrationPropertiesCosmosDbMongo),
}
#[doc = "Database Migration Resource for Mongo to CosmosDb."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DatabaseMigrationCosmosDbMongo {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Database Migration Resource properties for CosmosDb for Mongo."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<DatabaseMigrationPropertiesCosmosDbMongo>,
}
impl DatabaseMigrationCosmosDbMongo {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "A list of Database Migrations."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DatabaseMigrationCosmosDbMongoListResult {
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<DatabaseMigrationCosmosDbMongo>,
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for DatabaseMigrationCosmosDbMongoListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl DatabaseMigrationCosmosDbMongoListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct DatabaseMigrationProperties {
    #[serde(flatten)]
    pub database_migration_base_properties: DatabaseMigrationBaseProperties,
...
impl DatabaseMigrationProperties {
    pub fn new(database_migration_base_properties: DatabaseMigrationBaseProperties) -> Self {
        Self {
            database_migration_base_properties,
...
#[doc = "Database Migration Resource properties for CosmosDb for Mongo."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DatabaseMigrationPropertiesCosmosDbMongo {
    #[serde(flatten)]
    pub database_migration_base_properties: DatabaseMigrationBaseProperties,
    #[doc = "Mongo Connection"]
    #[serde(rename = "sourceMongoConnection", default, skip_serializing_if = "Option::is_none")]
    pub source_mongo_connection: Option<MongoConnectionInformation>,
    #[doc = "Mongo Connection"]
    #[serde(rename = "targetMongoConnection", default, skip_serializing_if = "Option::is_none")]
    pub target_mongo_connection: Option<MongoConnectionInformation>,
    #[doc = "List of Mongo Collections to be migrated."]
    #[serde(
        rename = "collectionList",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub collection_list: Vec<MongoMigrationCollection>,
}
impl DatabaseMigrationPropertiesCosmosDbMongo {
    pub fn new(database_migration_base_properties: DatabaseMigrationBaseProperties) -> Self {
        Self {
            database_migration_base_properties,
            source_mongo_connection: None,
            target_mongo_connection: None,
...
#[doc = "A Migration Service."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct MigrationService {
    #[serde(flatten)]
    pub tracked_resource: TrackedResource,
    #[doc = "The Migration Service properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<MigrationServiceProperties>,
}
...
#[doc = "A list of Migration Service."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MigrationServiceListResult {
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<MigrationService>,
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for MigrationServiceListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl MigrationServiceListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The Migration Service properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MigrationServiceProperties {
    #[doc = "Provisioning state to track the async operation status."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<migration_service_properties::ProvisioningState>,
...
impl MigrationServiceProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod migration_service_properties {
    use super::*;
    #[doc = "Provisioning state to track the async operation status."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ProvisioningState")]
...
#[doc = "An update to a Migration Service."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MigrationServiceUpdate {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<serde_json::Value>,
}
impl MigrationServiceUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Mongo Connection"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MongoConnectionInformation {
    #[doc = "Host of mongo connection."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub host: Option<String>,
    #[doc = "Port of mongo connection."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub port: Option<i32>,
    #[doc = "User name to connect to Mongo."]
    #[serde(rename = "userName", default, skip_serializing_if = "Option::is_none")]
    pub user_name: Option<String>,
    #[doc = "Password to connect to Mongo."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub password: Option<String>,
    #[doc = "Whether to UseSsl or UseTls to connect to Mongo. Default is true."]
    #[serde(rename = "useSsl", default, skip_serializing_if = "Option::is_none")]
    pub use_ssl: Option<bool>,
    #[doc = "ConnectionString to connect to Mongo."]
    #[serde(rename = "connectionString", default, skip_serializing_if = "Option::is_none")]
    pub connection_string: Option<String>,
}
impl MongoConnectionInformation {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Mongo source and target database and collection details."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MongoMigrationCollection {
    #[doc = "Source database name."]
    #[serde(rename = "sourceDatabase", default, skip_serializing_if = "Option::is_none")]
    pub source_database: Option<String>,
    #[doc = "Source collection name."]
    #[serde(rename = "sourceCollection", default, skip_serializing_if = "Option::is_none")]
    pub source_collection: Option<String>,
    #[doc = "Target database name."]
    #[serde(rename = "targetDatabase", default, skip_serializing_if = "Option::is_none")]
    pub target_database: Option<String>,
    #[doc = "Target collection name."]
    #[serde(rename = "targetCollection", default, skip_serializing_if = "Option::is_none")]
    pub target_collection: Option<String>,
    #[doc = "Detailed status of collection migration."]
    #[serde(rename = "migrationProgressDetails", default, skip_serializing_if = "Option::is_none")]
    pub migration_progress_details: Option<MongoMigrationProgressDetails>,
}
impl MongoMigrationCollection {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Detailed status of collection migration."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MongoMigrationProgressDetails {
    #[doc = "Migration Status"]
    #[serde(rename = "migrationStatus", default, skip_serializing_if = "Option::is_none")]
    pub migration_status: Option<mongo_migration_progress_details::MigrationStatus>,
    #[doc = "Migration Error"]
    #[serde(rename = "migrationError", default, skip_serializing_if = "Option::is_none")]
    pub migration_error: Option<String>,
    #[doc = "Source Document Count"]
    #[serde(rename = "sourceDocumentCount", default, skip_serializing_if = "Option::is_none")]
    pub source_document_count: Option<i64>,
    #[doc = "Processed Document Count"]
    #[serde(rename = "processedDocumentCount", default, skip_serializing_if = "Option::is_none")]
    pub processed_document_count: Option<i64>,
    #[doc = "Migration duration"]
    #[serde(rename = "durationInSeconds", default, skip_serializing_if = "Option::is_none")]
    pub duration_in_seconds: Option<i32>,
}
impl MongoMigrationProgressDetails {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod mongo_migration_progress_details {
    use super::*;
    #[doc = "Migration Status"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "MigrationStatus")]
    ...
    impl Serialize for MigrationStatus {
        ...
        {
            match self {
                Self::NotStarted => serializer.serialize_unit_variant("MigrationStatus", 0u32, "NotStarted"),
                Self::InProgress => serializer.serialize_unit_variant("MigrationStatus", 1u32, "InProgress"),
                Self::Completed => serializer.serialize_unit_variant("MigrationStatus", 2u32, "Completed"),
                Self::Failed => serializer.serialize_unit_variant("MigrationStatus", 3u32, "Failed"),
                Self::Canceled => serializer.serialize_unit_variant("MigrationStatus", 4u32, "Canceled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
