...
impl Client {
    ...
    pub fn database_migrations_mongo_to_cosmos_db_ru_mongo_client(&self) -> database_migrations_mongo_to_cosmos_db_ru_mongo::Client {
        database_migrations_mongo_to_cosmos_db_ru_mongo::Client(self.clone())
    }
    pub fn database_migrations_mongo_to_cosmos_dbv_core_mongo_client(&self) -> database_migrations_mongo_to_cosmos_dbv_core_mongo::Client {
        database_migrations_mongo_to_cosmos_dbv_core_mongo::Client(self.clone())
    }
    ...
    pub fn migration_services_client(&self) -> migration_services::Client {
        migration_services::Client(self.clone())
    }
...
pub mod database_migrations_mongo_to_cosmos_db_ru_mongo {
    use super::models;
    ...
    impl Client {
        #[doc = "Get Database Migration resource."]
        #[doc = ""]
        #[doc = "Arguments:"]
        ...
        #[doc = "* `target_resource_name`: The name of the target resource/account."]
        #[doc = "* `migration_name`: Name of the migration."]
        ...
        #[doc = "* `target_resource_name`: The name of the target resource/account."]
        #[doc = "* `migration_name`: Name of the migration."]
        #[doc = "* `parameters`: Details of CosmosDB for Mongo API Migration resource."]
        #[doc = "* `subscription_id`: Subscription ID that identifies an Azure subscription."]
        pub fn create(
            &self,
            resource_group_name: impl Into<String>,
            target_resource_name: impl Into<String>,
            migration_name: impl Into<String>,
            parameters: impl Into<models::DatabaseMigrationCosmosDbMongo>,
            subscription_id: impl Into<String>,
        ...
        #[doc = "Get Database Migration resources for the scope."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: Name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal."]
        #[doc = "* `target_resource_name`: The name of the target resource/account."]
    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DatabaseMigrationCosmosDbMongo> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DatabaseMigrationCosmosDbMongo = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) target_resource_name: String,
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DocumentDB/databaseAccounts/{}/providers/Microsoft.DataMigration/databaseMigrations/{}" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . target_resource_name , & self . migration_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-15-preview");
                }
                Ok(url)
            }
        }
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DatabaseMigrationCosmosDbMongo>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DatabaseMigrationCosmosDbMongo>>;
    ...
    pub mod create {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) target_resource_name: String,
            pub(crate) migration_name: String,
            pub(crate) parameters: models::DatabaseMigrationCosmosDbMongo,
            pub(crate) subscription_id: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
    ...
    pub mod get_for_scope {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DatabaseMigrationCosmosDbMongoListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DatabaseMigrationCosmosDbMongoListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::DatabaseMigrationCosmosDbMongoListResult, azure_core::error::Error> {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DocumentDB/databaseAccounts/{}/providers/Microsoft.DataMigration/databaseMigrations" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . target_resource_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-15-preview");
...
pub mod database_migrations_mongo_to_cosmos_dbv_core_mongo {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DocumentDB/mongoClusters/{}/providers/Microsoft.DataMigration/databaseMigrations/{}" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . target_resource_name , & self . migration_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-15-preview");
    ...
    pub mod get_for_scope {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DocumentDB/mongoClusters/{}/providers/Microsoft.DataMigration/databaseMigrations" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . target_resource_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-15-preview");
...
pub mod migration_services {
    ...
    impl Client {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: Name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal."]
        #[doc = "* `migration_service_name`: Name of the Migration Service."]
        #[doc = "* `subscription_id`: Subscription ID that identifies an Azure subscription."]
        pub fn get(
            &self,
            resource_group_name: impl Into<String>,
            migration_service_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                migration_service_name: migration_service_name.into(),
                subscription_id: subscription_id.into(),
            }
        }
        ...
        #[doc = "* `resource_group_name`: Name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal."]
        #[doc = "* `migration_service_name`: Name of the Migration Service."]
        #[doc = "* `parameters`: Details of MigrationService resource."]
        #[doc = "* `subscription_id`: Subscription ID that identifies an Azure subscription."]
        pub fn create_or_update(
            &self,
            resource_group_name: impl Into<String>,
            migration_service_name: impl Into<String>,
            parameters: impl Into<models::MigrationService>,
            subscription_id: impl Into<String>,
        ) -> create_or_update::RequestBuilder {
            create_or_update::RequestBuilder {
                client: self.0.clone(),
        ...
        pub fn update(
            ...
            resource_group_name: impl Into<String>,
            migration_service_name: impl Into<String>,
            parameters: impl Into<models::MigrationServiceUpdate>,
            subscription_id: impl Into<String>,
        ...
        #[doc = "Retrieve all migration services in the resource group."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: Name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal."]
        #[doc = "* `subscription_id`: Subscription ID that identifies an Azure subscription."]
        ...
        #[doc = "Retrieve all migration services in the subscriptions."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: Subscription ID that identifies an Azure subscription."]
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::MigrationService> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::MigrationService = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) resource_group_name: String,
            pub(crate) migration_service_name: String,
            pub(crate) subscription_id: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataMigration/migrationServices/{}",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.resource_group_name,
                    &self.migration_service_name
                ))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::MigrationService>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::MigrationService>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) migration_service_name: String,
            pub(crate) parameters: models::MigrationService,
            pub(crate) subscription_id: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
    ...
    pub mod update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) migration_service_name: String,
            pub(crate) parameters: models::MigrationServiceUpdate,
            pub(crate) subscription_id: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
    ...
    pub mod list_by_resource_group {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::MigrationServiceListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::MigrationServiceListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::MigrationServiceListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod list_by_subscription {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/providers/Microsoft.DataMigration/migrationServices",
                    self.client.endpoint(),
                    &self.subscription_id
                ))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
    ...
    pub mod list_migrations {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DatabaseMigrationBaseListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DatabaseMigrationBaseListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::DatabaseMigrationBaseListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataMigration/migrationServices/{}/listMigrations",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.resource_group_name,
                    &self.migration_service_name
