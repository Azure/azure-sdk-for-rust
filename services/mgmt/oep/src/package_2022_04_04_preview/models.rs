...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DataPartitionAddOrRemoveRequest {
    #[doc = "The list of Energy services resource's Data Partition Names."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<DataPartitionNames>,
}
impl DataPartitionAddOrRemoveRequest {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DataPartitionProperties {
...
#[doc = "List of data partitions."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DataPartitionsListResult {
    #[doc = "List of data partitions along with their properties in a given OEP resource."]
    #[serde(rename = "dataPartitionInfo", default, skip_serializing_if = "Vec::is_empty")]
    pub data_partition_info: Vec<DataPartitionProperties>,
}
impl DataPartitionsListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
