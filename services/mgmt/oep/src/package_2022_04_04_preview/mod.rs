...
pub mod energy_services {
    ...
    impl Client {
        ...
        pub fn remove_partition(
            ...
            resource_group_name: impl Into<String>,
            resource_name: impl Into<String>,
        ) -> remove_partition::RequestBuilder {
            remove_partition::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        pub fn list_partitions(
            ...
            resource_group_name: impl Into<String>,
            resource_name: impl Into<String>,
        ) -> list_partitions::RequestBuilder {
            list_partitions::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod add_partition {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DataPartitionAddOrRemoveRequest> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DataPartitionAddOrRemoveRequest = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DataPartitionAddOrRemoveRequest>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DataPartitionAddOrRemoveRequest>>;
    ...
    pub mod remove_partition {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.OpenEnergyPlatform/energyServices/{}/removePartition",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.resource_group_name,
                    &self.resource_name
    ...
    pub mod list_partitions {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DataPartitionsListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DataPartitionsListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DataPartitionsListResult>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DataPartitionsListResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
