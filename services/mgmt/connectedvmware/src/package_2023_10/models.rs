...
pub struct ClusterProperties {
    ...
    #[serde(rename = "usedMemoryGB", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "usedCpuMHz", default, skip_serializing_if = "Option::is_none")]
    pub used_cpu_m_hz: Option<i64>,
    #[doc = "Gets the max CPU usage across all cores on the cluster in MHz."]
    #[serde(rename = "totalCpuMHz", default, skip_serializing_if = "Option::is_none")]
    pub total_cpu_m_hz: Option<i64>,
...
pub struct HostProperties {
    ...
    #[serde(rename = "overallMemoryUsageGB", default, skip_serializing_if = "Option::is_none")]
    pub overall_memory_usage_gb: Option<i64>,
    ...
    #[serde(rename = "overallCpuUsageMHz", default, skip_serializing_if = "Option::is_none")]
    pub overall_cpu_usage_m_hz: Option<i64>,
    #[doc = "Gets the max CPU usage across all cores in MHz."]
    #[serde(rename = "cpuMhz", default, skip_serializing_if = "Option::is_none")]
    pub cpu_mhz: Option<i64>,
    #[doc = "Gets the datastore ARM ids."]
    #[serde(
        rename = "datastoreIds",
        default,
...
pub struct ResourcePoolProperties {
    ...
    #[serde(rename = "memOverallUsageGB", default, skip_serializing_if = "Option::is_none")]
    pub mem_overall_usage_gb: Option<i64>,
    #[doc = "Gets the total amount of physical memory on the pool in GB."]
    #[serde(rename = "memCapacityGB", default, skip_serializing_if = "Option::is_none")]
    pub mem_capacity_gb: Option<i64>,
    #[doc = "Gets the used CPU usage across all cores on the pool in MHz."]
    #[serde(rename = "cpuOverallUsageMHz", default, skip_serializing_if = "Option::is_none")]
    pub cpu_overall_usage_m_hz: Option<i64>,
    #[doc = "Gets the max CPU usage across all cores on the pool in MHz."]
    #[serde(rename = "cpuCapacityMHz", default, skip_serializing_if = "Option::is_none")]
    pub cpu_capacity_m_hz: Option<i64>,
    #[doc = "Gets the name of the corresponding resource in Kubernetes."]
    #[serde(rename = "customResourceName", default, skip_serializing_if = "Option::is_none")]
    pub custom_resource_name: Option<String>,
    #[doc = "Gets the datastore ARM ids."]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct VirtualMachineInstancesList {
...
pub struct VirtualMachineInventoryItem {
    ...
    #[doc = "Describes the properties of an Inventory Item reference."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cluster: Option<InventoryItemDetails>,
    #[doc = "Gets or sets the instance uuid of the vm."]
    #[serde(rename = "instanceUuid", default, skip_serializing_if = "Option::is_none")]
    pub instance_uuid: Option<String>,
    #[doc = "Gets or sets the SMBIOS UUID of the vm."]
