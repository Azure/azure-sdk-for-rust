...
pub struct GuestCredential {
    ...
    #[doc = "Private key used to authenticate to a virtual machine through ssh."]
...
pub struct HostInventoryItem {
    ...
    #[doc = "Gets or sets the number of cores per socket on the host."]
    #[serde(rename = "numCoresPerSocket", default, skip_serializing_if = "Option::is_none")]
    pub num_cores_per_socket: Option<i32>,
    #[doc = "Gets or sets the number of sockets on the host."]
    #[serde(rename = "numSockets", default, skip_serializing_if = "Option::is_none")]
    pub num_sockets: Option<i32>,
    #[doc = "Gets or sets the version of the host."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub version: Option<String>,
    #[doc = "Gets or sets the cpu model of the host."]
    ...
    #[doc = "Gets or sets the power state of the host."]
...
#[doc = "Inventory Network Interface model"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
impl NetworkInterfaceInventory {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct OsProfileForVmInstance {
    ...
    #[doc = "Specifies the Windows Configuration settings for the virtual machine."]
...
#[doc = "Specifies the storage settings for the virtual machine disks."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct StorageProfileInventory {
    #[doc = "Gets or sets the list of virtual disks associated with the virtual machine."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub disks: Vec<VirtualDiskInventory>,
}
impl StorageProfileInventory {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Virtual disk model"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct VirtualDiskInventory {
    #[doc = "Gets or sets the name of the virtual disk."]
    ...
    #[serde(rename = "deviceName", default, skip_serializing_if = "Option::is_none")]
    pub device_name: Option<String>,
    #[doc = "Gets or sets the disk file name."]
    #[serde(rename = "fileName", default, skip_serializing_if = "Option::is_none")]
    pub file_name: Option<String>,
    #[doc = "Defines the different types of disks."]
    #[serde(rename = "diskType", default, skip_serializing_if = "Option::is_none")]
    pub disk_type: Option<DiskType>,
    #[doc = "Gets or sets the eagerly scrub property of disk."]
    #[serde(rename = "eagerlyScrub", default, skip_serializing_if = "Option::is_none")]
    pub eagerly_scrub: Option<bool>,
    #[doc = "Gets or sets the thin provisioning property of disk."]
    #[serde(rename = "thinProvisioned", default, skip_serializing_if = "Option::is_none")]
...
impl VirtualMachineInventoryItem {
    pub fn new(inventory_item_properties: InventoryItemProperties) -> Self {
        Self {
            ...
            tools_version: None,
            firmware_type: None,
            change_tracking_supported: None,
            change_tracking_enabled: None,
            max_snapshots: None,
            number_of_snapshots: None,
            disk_enabled_uuid: None,
            computer_name: None,
            memory_size_mb: None,
            num_cp_us: None,
...
pub struct WindowsConfiguration {
    #[doc = "Sets full name of the owner of the vm."]
    #[serde(rename = "fullName", default, skip_serializing_if = "Option::is_none")]
    pub full_name: Option<String>,
    #[doc = "Sets org name to which the owner of the vm belongs."]
    #[serde(rename = "orgName", default, skip_serializing_if = "Option::is_none")]
    pub org_name: Option<String>,
    #[doc = "Sets domain name that vm should join."]
    #[serde(rename = "domainName", default, skip_serializing_if = "Option::is_none")]
    pub domain_name: Option<String>,
    #[doc = "Sets domain username."]
    #[serde(rename = "domainUsername", default, skip_serializing_if = "Option::is_none")]
    pub domain_username: Option<String>,
    #[doc = "Sets domain user password."]
    #[serde(rename = "domainUserPassword", default, skip_serializing_if = "Option::is_none")]
    pub domain_user_password: Option<String>,
    #[doc = "Sets work group name that vm should join."]
    #[serde(rename = "workGroupName", default, skip_serializing_if = "Option::is_none")]
    pub work_group_name: Option<String>,
    #[doc = "Sets product id of the vm."]
    #[serde(rename = "productId", default, skip_serializing_if = "Option::is_none")]
    pub product_id: Option<String>,
    #[doc = "Sets a value indicating whether auto logon is enabled."]
    #[serde(rename = "autoLogon", default, skip_serializing_if = "Option::is_none")]
    pub auto_logon: Option<bool>,
    #[doc = "Sets auto logon count."]
    #[serde(rename = "autoLogonCount", default, skip_serializing_if = "Option::is_none")]
    pub auto_logon_count: Option<i32>,
    #[doc = "Specifies the time zone of the virtual machine. e.g. \"Pacific Standard Time\". Time zone name correspond to time zones listed at Microsoft Time Zone name values(https://learn.microsoft.com/en-us/previous-versions/windows/embedded/ms912391(v=winembedded.11))."]
    #[serde(rename = "timeZone", default, skip_serializing_if = "Option::is_none")]
    pub time_zone: Option<String>,
    #[doc = "Sets first logon commands"]
    #[serde(
        rename = "firstLogonCommands",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
