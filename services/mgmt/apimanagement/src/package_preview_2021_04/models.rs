...
impl ApiSchemaContractProperties {
...
impl ApiSchemaDocumentProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl SchemaContractProperties {
    pub fn new(schema_type: schema_contract_properties::SchemaType) -> Self {
        Self {
            schema_type,
            description: None,
            value: None,
