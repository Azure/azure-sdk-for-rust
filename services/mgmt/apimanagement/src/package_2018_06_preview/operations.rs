...
pub mod api_management_service_skus {
    ...
    pub async fn list_available_service_skus(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                Err(list_available_service_skus::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
...
pub mod api_management_service {
    ...
    pub async fn get_sso_token(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                Err(get_sso_token::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn apply_network_configuration_updates(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                Err(apply_network_configuration_updates::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn upload_certificate(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: CertificateInformation = serde_json::from_slice(rsp_body)
                    .map_err(|source| upload_certificate::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                Err(upload_certificate::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn update_hostname(
        ...
        let mut url = url::Url::parse(url_str).map_err(update_hostname::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::POST);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(update_hostname::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
        req_builder = req_builder.header("content-type", "application/json");
        let req_body = azure_core::to_json(parameters).map_err(update_hostname::Error::SerializeError)?;
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder.body(req_body).map_err(update_hostname::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(update_hostname::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: ApiManagementServiceResource = serde_json::from_slice(rsp_body)
                    .map_err(|source| update_hostname::Error::DeserializeError(source, rsp_body.clone()))?;
            ...
            status_code => {
                let rsp_body = rsp.body();
                Err(update_hostname::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
...
pub mod policy_snippets {
    ...
    pub async fn list_by_service(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: PolicySnippetsCollection = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_by_service::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
...
pub mod property {
    ...
    pub async fn list_by_service(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: PropertyCollection = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_by_service::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
    ...
    pub async fn create_or_update(
        ...
        match rsp.status() {
            http::StatusCode::CREATED => {
                let rsp_body = rsp.body();
                let rsp_value: PropertyContract = serde_json::from_slice(rsp_body)
                    .map_err(|source| create_or_update::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(create_or_update::Response::Created201(rsp_value))
            }
            http::StatusCode::OK => {
