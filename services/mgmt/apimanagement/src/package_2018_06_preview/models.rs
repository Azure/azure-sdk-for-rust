...
pub struct AccessInformationContract {
    ...
    #[doc = "Tenant access information of the API Management service."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct ApiCreateOrUpdateProperties {
    ...
    #[serde(rename = "contentValue", default, skip_serializing_if = "Option::is_none")]
    pub content_value: Option<String>,
    #[doc = "Format of the Content in which the API is getting imported."]
    #[serde(rename = "contentFormat", default, skip_serializing_if = "Option::is_none")]
    pub content_format: Option<api_create_or_update_properties::ContentFormat>,
...
#[doc = "API Export result Blob Uri."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct ApiManagementServiceSkuProperties {
    ...
    #[doc = "Capacity of the SKU (number of deployed units of the SKU). The default value is 1."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub capacity: Option<i32>,
}
impl ApiManagementServiceSkuProperties {
    pub fn new(name: api_management_service_sku_properties::Name) -> Self {
...
#[doc = "Parameters supplied to the UpdateHostname operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ApiManagementServiceUpdateHostnameParameters {
    #[doc = "Hostnames to create or update."]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub update: Vec<HostnameConfigurationOld>,
    #[doc = "Hostnames types to delete."]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub delete: Vec<String>,
}
impl ApiManagementServiceUpdateHostnameParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Parameters supplied to the Upload SSL certificate for an API Management service operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ApiManagementServiceUploadCertificateParameters {
    #[doc = "Hostname type."]
    #[serde(rename = "type")]
    pub type_: api_management_service_upload_certificate_parameters::Type,
    #[doc = "Base64 Encoded certificate."]
    pub certificate: String,
    #[doc = "Certificate password."]
    pub certificate_password: String,
}
impl ApiManagementServiceUploadCertificateParameters {
    pub fn new(
        type_: api_management_service_upload_certificate_parameters::Type,
        certificate: String,
...
pub mod api_management_service_upload_certificate_parameters {
    use super::*;
    #[doc = "Hostname type."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum Type {
...
pub struct AuthorizationServerContractBaseProperties {
    ...
    #[doc = "Client or app secret registered with this authorization server."]
...
pub struct CurrentUserIdentity {
    #[doc = "API Management service user id."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
}
...
pub struct DiagnosticContractProperties {
    ...
    #[doc = "Whether to process Correlation Headers coming to Api Management Service. Only applicable to Application Insights diagnostics. Default is true."]
    #[serde(rename = "enableHttpCorrelationHeaders", default, skip_serializing_if = "Option::is_none")]
    pub enable_http_correlation_headers: Option<bool>,
}
...
#[doc = "Custom hostname configuration."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct HostnameConfigurationOld {
    #[doc = "Hostname type."]
    #[serde(rename = "type")]
    pub type_: hostname_configuration_old::Type,
    #[doc = "Hostname to configure."]
    pub hostname: String,
    #[doc = "SSL certificate information."]
    pub certificate: CertificateInformation,
}
impl HostnameConfigurationOld {
    pub fn new(type_: hostname_configuration_old::Type, hostname: String, certificate: CertificateInformation) -> Self {
        Self {
            type_,
            hostname,
            certificate,
...
pub mod hostname_configuration_old {
    use super::*;
    #[doc = "Hostname type."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum Type {
...
pub struct ParameterContract {
    ...
    #[doc = "whether parameter is required or not."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct PolicyContractProperties {
    #[doc = "Json escaped Xml Encoded contents of the Policy."]
    #[serde(rename = "policyContent")]
    pub policy_content: String,
    #[doc = "Format of the policyContent."]
    #[serde(rename = "contentFormat", default, skip_serializing_if = "Option::is_none")]
    pub content_format: Option<policy_contract_properties::ContentFormat>,
}
...
impl PolicySnippetContract {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The response of the list policy snippets operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PolicySnippetsCollection {
    #[doc = "Policy snippet value."]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub value: Vec<PolicySnippetContract>,
}
impl PolicySnippetsCollection {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Paged Property list representation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PropertyCollection {
    #[doc = "Page values."]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub value: Vec<PropertyContract>,
    #[doc = "Next page link if any."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for PropertyCollection {
    fn continuation(&self) -> Option<String> {
        self.next_link.clone()
    }
}
...
pub struct PropertyContract {
    #[serde(flatten)]
    pub resource: Resource,
    #[doc = "Property Contract properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<PropertyContractProperties>,
}
...
#[doc = "Property Contract properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct PropertyContractProperties {
    #[serde(flatten)]
    pub property_entity_base_parameters: PropertyEntityBaseParameters,
    #[doc = "Unique name of Property. It may contain only letters, digits, period, dash, and underscore characters."]
    #[serde(rename = "displayName")]
    pub display_name: String,
    #[doc = "Value of the property. Can contain policy expressions. It may not be empty or consist only of whitespace."]
    pub value: String,
}
impl PropertyContractProperties {
    pub fn new(display_name: String, value: String) -> Self {
        Self {
            property_entity_base_parameters: PropertyEntityBaseParameters::default(),
            display_name,
            value,
        }
    }
}
#[doc = "Property Entity Base Parameters set."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PropertyEntityBaseParameters {
    #[doc = "Optional tags that when provided can be used to filter the property list."]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub tags: Vec<String>,
...
impl PropertyEntityBaseParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Property Contract properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PropertyUpdateParameterProperties {
    #[serde(flatten)]
    pub property_entity_base_parameters: PropertyEntityBaseParameters,
    #[doc = "Unique name of Property. It may contain only letters, digits, period, dash, and underscore characters."]
    #[serde(rename = "displayName", default, skip_serializing_if = "Option::is_none")]
...
impl PropertyUpdateParameterProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Property update Parameters."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PropertyUpdateParameters {
    #[doc = "Property Contract properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<PropertyUpdateParameterProperties>,
}
impl PropertyUpdateParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct SchemaContract {
    #[serde(flatten)]
    pub resource: Resource,
    #[doc = "Schema contract Properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct SchemaContractProperties {
    #[doc = "Must be a valid a media type used in a Content-Type header as defined in the RFC 2616. Media type of the schema document (e.g. application/json, application/xml)."]
    #[serde(rename = "contentType")]
    pub content_type: String,
...
pub struct SchemaDocumentProperties {
    #[doc = "Json escaped string defining the document representing the Schema."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub value: Option<String>,
}
...
impl SubscriptionContractProperties {
    pub fn new(scope: String, state: subscription_contract_properties::State, primary_key: String, secondary_key: String) -> Self {
        Self {
            owner_id: None,
            scope,
            display_name: None,
...
pub struct UserTokenParameters {
    ...
    pub key_type: user_token_parameters::KeyType,
...
impl UserTokenParameters {
    pub fn new(key_type: user_token_parameters::KeyType, expiry: String) -> Self {
        Self { key_type, expiry }
    }
}
pub mod user_token_parameters {
    use super::*;
    #[doc = "The Key to be used to generate token for user."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum KeyType {
