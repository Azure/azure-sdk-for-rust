...
#[doc = "The response of All Policies."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AllPoliciesCollection {
    #[doc = "AllPolicies Contract value."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<AllPoliciesContract>,
    #[doc = "Next page link if any."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for AllPoliciesCollection {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl AllPoliciesCollection {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "AllPolicies Contract details."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AllPoliciesContract {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "AllPolicies Properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<AllPoliciesContractProperties>,
}
impl AllPoliciesContract {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "AllPolicies Properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AllPoliciesContractProperties {
    #[doc = "Policy Identifier"]
    #[serde(rename = "referencePolicyId", default, skip_serializing_if = "Option::is_none")]
    pub reference_policy_id: Option<String>,
    #[doc = "Policy Restriction Compliance State"]
    #[serde(rename = "complianceState", default, skip_serializing_if = "Option::is_none")]
    pub compliance_state: Option<all_policies_contract_properties::ComplianceState>,
}
impl AllPoliciesContractProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod all_policies_contract_properties {
    use super::*;
    #[doc = "Policy Restriction Compliance State"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    ...
    impl Serialize for ComplianceState {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Compliant => serializer.serialize_unit_variant("ComplianceState", 2u32, "Compliant"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct ApiCreateOrUpdateProperties {
    ...
    #[doc = "Format of the Content in which the API is getting imported. New formats can be added in the future"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub mod api_create_or_update_properties {
    ...
    pub enum Format {
        ...
        #[serde(rename = "odata")]
        Odata,
        #[serde(rename = "odata-link")]
        OdataLink,
        #[serde(rename = "grpc")]
        Grpc,
        #[serde(rename = "grpc-link")]
        GrpcLink,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    ...
    impl Serialize for Format {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Odata => serializer.serialize_unit_variant("Format", 11u32, "odata"),
                Self::OdataLink => serializer.serialize_unit_variant("Format", 12u32, "odata-link"),
                Self::Grpc => serializer.serialize_unit_variant("Format", 13u32, "grpc"),
                Self::GrpcLink => serializer.serialize_unit_variant("Format", 14u32, "grpc-link"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for ApiType {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Odata => serializer.serialize_unit_variant("ApiType", 4u32, "odata"),
                Self::Grpc => serializer.serialize_unit_variant("ApiType", 5u32, "grpc"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for Type {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Odata => serializer.serialize_unit_variant("Type", 4u32, "odata"),
                Self::Grpc => serializer.serialize_unit_variant("Type", 5u32, "grpc"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Base Properties of an API Management gateway resource description."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ApiManagementGatewayBaseProperties {
    #[doc = "The current provisioning state of the API Management gateway which can be one of the following: Created/Activating/Succeeded/Updating/Failed/Stopped/Terminating/TerminationFailed/Deleted."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<String>,
    #[doc = "The provisioning state of the API Management gateway, which is targeted by the long running operation started on the gateway."]
    ...
    #[doc = "Creation UTC date of the API Management gateway.The date conforms to the following format: `yyyy-MM-ddTHH:mm:ssZ` as specified by the ISO 8601 standard."]
    #[serde(rename = "createdAtUtc", default, with = "azure_core::date::rfc3339::option")]
    pub created_at_utc: Option<::time::OffsetDateTime>,
    #[doc = "Information regarding how the gateway should be exposed."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub frontend: Option<FrontendConfiguration>,
    #[doc = "Information regarding how the gateway should integrate with backend systems."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub backend: Option<BackendConfiguration>,
    #[doc = "Information regarding the Configuration API of the API Management gateway. This is only applicable for API gateway with Standard SKU."]
    #[serde(rename = "configurationApi", default, skip_serializing_if = "Option::is_none")]
    pub configuration_api: Option<GatewayConfigurationApi>,
    #[doc = "The type of VPN in which API Management gateway needs to be configured in. "]
    #[serde(rename = "virtualNetworkType", default, skip_serializing_if = "Option::is_none")]
    pub virtual_network_type: Option<api_management_gateway_base_properties::VirtualNetworkType>,
}
impl ApiManagementGatewayBaseProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod api_management_gateway_base_properties {
    use super::*;
    #[doc = "The type of VPN in which API Management gateway needs to be configured in. "]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "The response of the List API Management gateway operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ApiManagementGatewayConfigConnectionListResult {
    #[doc = "Result of the List API Management gateway config connection operation."]
    pub value: Vec<ApiManagementGatewayConfigConnectionResource>,
    #[doc = "Link to the next set of results. Not empty if Value contains incomplete list of API Management services."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ApiManagementGatewayConfigConnectionListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl ApiManagementGatewayConfigConnectionListResult {
    pub fn new(value: Vec<ApiManagementGatewayConfigConnectionResource>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "A single API Management gateway resource in List or Get response."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ApiManagementGatewayConfigConnectionResource {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    pub properties: GatewayConfigConnectionBaseProperties,
    #[doc = "ETag of the resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub etag: Option<String>,
}
impl ApiManagementGatewayConfigConnectionResource {
    pub fn new(properties: GatewayConfigConnectionBaseProperties) -> Self {
        Self {
...
#[doc = "The response of the List API Management gateway operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ApiManagementGatewayListResult {
    #[doc = "Result of the List API Management gateway operation."]
    pub value: Vec<ApiManagementGatewayResource>,
    #[doc = "Link to the next set of results. Not empty if Value contains incomplete list of API Management services."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ApiManagementGatewayListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl ApiManagementGatewayListResult {
    pub fn new(value: Vec<ApiManagementGatewayResource>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Properties of an API Management gateway resource description."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ApiManagementGatewayProperties {
    #[serde(flatten)]
    pub api_management_gateway_base_properties: ApiManagementGatewayBaseProperties,
}
impl ApiManagementGatewayProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "A single API Management gateway resource in List or Get response."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ApiManagementGatewayResource {
    #[serde(flatten)]
    pub apim_resource: ApimResource,
    #[doc = "Properties of an API Management gateway resource description."]
    pub properties: ApiManagementGatewayProperties,
    #[doc = "API Management gateway resource SKU properties."]
    pub sku: ApiManagementGatewaySkuProperties,
...
impl ApiManagementGatewayResource {
    pub fn new(properties: ApiManagementGatewayProperties, sku: ApiManagementGatewaySkuProperties, location: String) -> Self {
        Self {
...
#[doc = "API Management gateway resource SKU properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ApiManagementGatewaySkuProperties {
    #[doc = "Name of the Sku."]
    pub name: api_management_gateway_sku_properties::Name,
    #[doc = "Capacity of the SKU (number of deployed units of the SKU)"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub capacity: Option<i32>,
}
impl ApiManagementGatewaySkuProperties {
    pub fn new(name: api_management_gateway_sku_properties::Name) -> Self {
        Self { name, capacity: None }
    }
}
pub mod api_management_gateway_sku_properties {
    use super::*;
    #[doc = "Name of the Sku."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Name")]
    ...
    impl Serialize for Name {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::WorkspaceGatewayStandard => serializer.serialize_unit_variant("Name", 1u32, "WorkspaceGatewayStandard"),
                Self::WorkspaceGatewayPremium => serializer.serialize_unit_variant("Name", 2u32, "WorkspaceGatewayPremium"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
}
#[doc = "API Management gateway resource SKU properties for PATCH operations given nothing should be required."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ApiManagementGatewaySkuPropertiesForPatch {
    #[doc = "Name of the Sku."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<api_management_gateway_sku_properties_for_patch::Name>,
    #[doc = "Capacity of the SKU (number of deployed units of the SKU)"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub capacity: Option<i32>,
}
impl ApiManagementGatewaySkuPropertiesForPatch {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod api_management_gateway_sku_properties_for_patch {
    use super::*;
    #[doc = "Name of the Sku."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Name")]
...
#[doc = "Parameter supplied to Update API Management gateway."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ApiManagementGatewayUpdateParameters {
    #[serde(flatten)]
    pub apim_resource: ApimResource,
    #[doc = "Properties of an API Management gateway resource description."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ApiManagementGatewayUpdateProperties>,
    #[doc = "API Management gateway resource SKU properties for PATCH operations given nothing should be required."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sku: Option<ApiManagementGatewaySkuPropertiesForPatch>,
    #[doc = "ETag of the resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub etag: Option<String>,
}
impl ApiManagementGatewayUpdateParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Properties of an API Management gateway resource description."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ApiManagementGatewayUpdateProperties {
    #[serde(flatten)]
    pub api_management_gateway_base_properties: ApiManagementGatewayBaseProperties,
}
impl ApiManagementGatewayUpdateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ApiManagementServiceBaseProperties {
    ...
    #[doc = "Information regarding the Configuration API of the API Management service."]
    #[serde(rename = "configurationApi", default, skip_serializing_if = "Option::is_none")]
    pub configuration_api: Option<ConfigurationApi>,
    #[doc = "Configuration of a virtual network to which API Management service is deployed."]
    #[serde(rename = "virtualNetworkConfiguration", default, skip_serializing_if = "Option::is_none")]
    pub virtual_network_configuration: Option<VirtualNetworkConfiguration>,
    ...
    #[doc = "Status of legacy portal in the API Management service."]
    #[serde(rename = "legacyPortalStatus", default, skip_serializing_if = "Option::is_none")]
    pub legacy_portal_status: Option<api_management_service_base_properties::LegacyPortalStatus>,
    #[doc = "Status of developer portal in this API Management service."]
    #[serde(rename = "developerPortalStatus", default, skip_serializing_if = "Option::is_none")]
    pub developer_portal_status: Option<api_management_service_base_properties::DeveloperPortalStatus>,
}
...
pub mod api_management_service_base_properties {
    ...
    #[doc = "Status of legacy portal in the API Management service."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "LegacyPortalStatus")]
    pub enum LegacyPortalStatus {
        Enabled,
        Disabled,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for LegacyPortalStatus {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for LegacyPortalStatus {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for LegacyPortalStatus {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("LegacyPortalStatus", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("LegacyPortalStatus", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for LegacyPortalStatus {
        fn default() -> Self {
            Self::Enabled
        }
    }
    #[doc = "Status of developer portal in this API Management service."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "DeveloperPortalStatus")]
    pub enum DeveloperPortalStatus {
        Enabled,
        Disabled,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for DeveloperPortalStatus {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for DeveloperPortalStatus {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for DeveloperPortalStatus {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("DeveloperPortalStatus", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("DeveloperPortalStatus", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for DeveloperPortalStatus {
        fn default() -> Self {
            Self::Enabled
        }
    }
    ...
    impl Serialize for Name {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::BasicV2 => serializer.serialize_unit_variant("Name", 6u32, "BasicV2"),
                Self::StandardV2 => serializer.serialize_unit_variant("Name", 7u32, "StandardV2"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "The response of the List API Management WorkspaceLink operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ApiManagementWorkspaceLinksListResult {
    #[doc = "Result of the List API Management WorkspaceLinks operation."]
    pub value: Vec<ApiManagementWorkspaceLinksResource>,
    #[doc = "Link to the next set of results. Not empty if Value contains incomplete list of API Management services."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ApiManagementWorkspaceLinksListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl ApiManagementWorkspaceLinksListResult {
    pub fn new(value: Vec<ApiManagementWorkspaceLinksResource>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Properties of an API Management workspaceLinks resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ApiManagementWorkspaceLinksProperties {
    #[serde(flatten)]
    pub workspace_links_base_properties: WorkspaceLinksBaseProperties,
}
impl ApiManagementWorkspaceLinksProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "A single API Management WorkspaceLinks in List or Get response."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ApiManagementWorkspaceLinksResource {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Properties of an API Management workspaceLinks resource."]
    pub properties: ApiManagementWorkspaceLinksProperties,
    #[doc = "ETag of the resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub etag: Option<String>,
}
impl ApiManagementWorkspaceLinksResource {
    pub fn new(properties: ApiManagementWorkspaceLinksProperties) -> Self {
        Self {
            proxy_resource: ProxyResource::default(),
            properties,
            etag: None,
...
pub struct AuthorizationAccessPolicyContractProperties {
    #[doc = "The allowed Azure Active Directory Application IDs"]
    #[serde(
        rename = "appIds",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
...
pub struct BackendBaseParameters {
    ...
    #[doc = "Type of the backend. A backend can be either Single or Pool."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<backend_base_parameters::Type>,
}
...
pub mod backend_base_parameters {
    use super::*;
    #[doc = "Type of the backend. A backend can be either Single or Pool."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Type")]
    ...
    impl Serialize for Type {
        ...
        {
            match self {
                Self::Single => serializer.serialize_unit_variant("Type", 0u32, "Single"),
                Self::Pool => serializer.serialize_unit_variant("Type", 1u32, "Pool"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct BackendConfiguration {
    #[doc = "Information regarding how the subnet to which the gateway should be injected."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub subnet: Option<BackendSubnetConfiguration>,
}
...
#[doc = "Backend pool information"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct BackendPool {
    #[doc = "The list of backend entities belonging to a pool."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub services: Vec<BackendPoolItem>,
}
impl BackendPool {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "Backend pool service information"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct BackendPoolItem {
    #[doc = "The unique ARM id of the backend entity. The ARM id should refer to an already existing backend entity."]
    pub id: String,
    #[doc = "The weight of the backend entity in the backend pool. Must be between 0 and 100. It can be also null if the value not specified."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub weight: Option<i32>,
    #[doc = "The priority of the backend entity in the backend pool. Must be between 0 and 100. It can be also null if the value not specified."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub priority: Option<i32>,
}
impl BackendPoolItem {
...
#[doc = "Information regarding how the subnet to which the gateway should be injected."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct BackendSubnetConfiguration {
    #[doc = "The ARM ID of the subnet in which the backend systems are hosted."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
}
impl BackendSubnetConfiguration {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct CircuitBreakerRule {
    ...
    #[doc = "flag to accept Retry-After header from the backend."]
    #[serde(rename = "acceptRetryAfter", default, skip_serializing_if = "Option::is_none")]
    pub accept_retry_after: Option<bool>,
}
...
pub struct ConfigurationApi {
    #[doc = "Indication whether or not the legacy Configuration API (v1) should be exposed on the API Management service. Value is optional but must be 'Enabled' or 'Disabled'. If 'Disabled', legacy Configuration API (v1) will not be available for self-hosted gateways. Default value is 'Enabled'"]
    #[serde(rename = "legacyApi", default, skip_serializing_if = "Option::is_none")]
    pub legacy_api: Option<configuration_api::LegacyApi>,
}
...
pub mod configuration_api {
    ...
    impl FromStr for LegacyApi {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for LegacyApi {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for LegacyApi {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("LegacyApi", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("LegacyApi", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for LegacyApi {
        fn default() -> Self {
            Self::Enabled
        }
    }
...
#[doc = "Diagnostic Entity Properties"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DiagnosticContractUpdateProperties {
    #[doc = "Specifies for what type of messages sampling settings should not apply."]
    #[serde(rename = "alwaysLog", default, skip_serializing_if = "Option::is_none")]
    pub always_log: Option<diagnostic_contract_update_properties::AlwaysLog>,
    #[doc = "Resource Id of a target logger."]
    #[serde(rename = "loggerId", default, skip_serializing_if = "Option::is_none")]
    ...
    #[doc = "Sets correlation protocol to use for Application Insights diagnostics."]
    #[serde(rename = "httpCorrelationProtocol", default, skip_serializing_if = "Option::is_none")]
    pub http_correlation_protocol: Option<diagnostic_contract_update_properties::HttpCorrelationProtocol>,
    #[doc = "The verbosity level applied to traces emitted by trace policies."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub verbosity: Option<diagnostic_contract_update_properties::Verbosity>,
    #[doc = "The format of the Operation Name for Application Insights telemetries. Default is Name."]
    #[serde(rename = "operationNameFormat", default, skip_serializing_if = "Option::is_none")]
    pub operation_name_format: Option<diagnostic_contract_update_properties::OperationNameFormat>,
    #[doc = "Emit custom metrics via emit-metric policy. Applicable only to Application Insights diagnostic settings."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metrics: Option<bool>,
}
impl DiagnosticContractUpdateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod diagnostic_contract_update_properties {
    use super::*;
    #[doc = "Specifies for what type of messages sampling settings should not apply."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "AlwaysLog")]
...
#[doc = "Diagnostic details."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DiagnosticUpdateContract {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Diagnostic Entity Properties"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<DiagnosticContractUpdateProperties>,
}
impl DiagnosticUpdateContract {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct FrontendConfiguration {
    #[doc = "The default hostname of the data-plane gateway to which requests can be sent. This is only applicable for API gateway with Standard SKU."]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct GatewayConfigConnectionBaseProperties {
    #[doc = "The current provisioning state of the API Management gateway config connection "]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<gateway_config_connection_base_properties::ProvisioningState>,
    #[doc = "The link to the API Management service workspace."]
    #[serde(rename = "sourceId", default, skip_serializing_if = "Option::is_none")]
    pub source_id: Option<String>,
    #[doc = "The default hostname of the data-plane gateway."]
    #[serde(rename = "defaultHostname", default, skip_serializing_if = "Option::is_none")]
    pub default_hostname: Option<String>,
    #[doc = "The hostnames of the data-plane gateway to which requests can be sent."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
impl GatewayConfigConnectionBaseProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod gateway_config_connection_base_properties {
    use super::*;
    #[doc = "The current provisioning state of the API Management gateway config connection "]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    ...
    impl Serialize for ProvisioningState {
        ...
        {
            match self {
                Self::Activating => serializer.serialize_unit_variant("ProvisioningState", 0u32, "Activating"),
                ...
                Self::Terminating => serializer.serialize_unit_variant("ProvisioningState", 4u32, "Terminating"),
                Self::Upgrading => serializer.serialize_unit_variant("ProvisioningState", 5u32, "Upgrading"),
...
#[doc = "Information regarding the Configuration API of the API Management gateway. This is only applicable for API gateway with Standard SKU."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct GatewayConfigurationApi {
    #[doc = "Hostname to which the agent connects to propagate configuration to the cloud."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub hostname: Option<String>,
}
impl GatewayConfigurationApi {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Gateway debug credentials."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct GatewayDebugCredentialsContract {
    #[doc = "Gateway debug token."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub token: Option<String>,
}
impl GatewayDebugCredentialsContract {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "List debug credentials properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GatewayListDebugCredentialsContract {
    #[doc = "Credentials expiration in ISO8601 format. Maximum duration of the credentials is PT1H. When property is not specified, them value PT1H is used."]
    #[serde(rename = "credentialsExpireAfter", default, skip_serializing_if = "Option::is_none")]
    pub credentials_expire_after: Option<String>,
    #[doc = "Purposes of debug credential."]
    pub purposes: Vec<String>,
    #[doc = "Full resource Id of an API."]
    #[serde(rename = "apiId")]
    pub api_id: String,
}
impl GatewayListDebugCredentialsContract {
    pub fn new(purposes: Vec<String>, api_id: String) -> Self {
        Self {
            credentials_expire_after: None,
            purposes,
            api_id,
        }
    }
}
#[doc = "List trace properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct GatewayListTraceContract {
    #[doc = "Trace id."]
    #[serde(rename = "traceId", default, skip_serializing_if = "Option::is_none")]
    pub trace_id: Option<String>,
}
impl GatewayListTraceContract {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Describes an available API Management gateway SKU."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct GatewayResourceSkuResult {
    #[doc = "The type of resource the SKU applies to."]
    #[serde(rename = "resourceType", default, skip_serializing_if = "Option::is_none")]
    pub resource_type: Option<String>,
    #[doc = "Describes an available API Management SKU for gateways."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sku: Option<GatewaySku>,
    #[doc = "Describes scaling information of a SKU."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub capacity: Option<GatewaySkuCapacity>,
}
impl GatewayResourceSkuResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The API Management gateway SKUs operation response."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GatewayResourceSkuResults {
    #[doc = "The list of skus available for the gateway."]
    pub value: Vec<GatewayResourceSkuResult>,
    #[doc = "The uri to fetch the next page of API Management gateway Skus."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for GatewayResourceSkuResults {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl GatewayResourceSkuResults {
    pub fn new(value: Vec<GatewayResourceSkuResult>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Describes an available API Management SKU for gateways."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct GatewaySku {
    #[doc = "Name of the Sku."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<gateway_sku::Name>,
}
impl GatewaySku {
    pub fn new() -> Self {
        Self::default()
...
pub struct GatewaySkuCapacity {
    ...
    #[doc = "The scale type applicable to the sku."]
    #[serde(rename = "scaleType", default, skip_serializing_if = "Option::is_none")]
    pub scale_type: Option<gateway_sku_capacity::ScaleType>,
}
impl GatewaySkuCapacity {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod gateway_sku_capacity {
    use super::*;
    #[doc = "The scale type applicable to the sku."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "Trace collected in gateway."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct GatewayTraceContract {}
impl GatewayTraceContract {
    pub fn new() -> Self {
        Self::default()
    }
}
    ...
    impl Serialize for Type {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::ConfigurationApi => serializer.serialize_unit_variant("Type", 5u32, "ConfigurationApi"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MigrateToStv2Contract {
    #[doc = "Mode of Migration to stv2. Default is PreserveIp."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mode: Option<migrate_to_stv2_contract::Mode>,
}
impl MigrateToStv2Contract {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod migrate_to_stv2_contract {
    use super::*;
    #[doc = "Mode of Migration to stv2. Default is PreserveIp."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Mode")]
    ...
    impl Serialize for Mode {
        ...
        {
            match self {
                Self::PreserveIp => serializer.serialize_unit_variant("Mode", 0u32, "PreserveIp"),
                Self::NewIp => serializer.serialize_unit_variant("Mode", 1u32, "NewIP"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "The response of the get policy restrictions operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PolicyRestrictionCollection {
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<PolicyRestrictionContract>,
    #[doc = "Next page link if any."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for PolicyRestrictionCollection {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl PolicyRestrictionCollection {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Policy restriction contract details."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PolicyRestrictionContract {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Policy restrictions contract properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<PolicyRestrictionContractProperties>,
}
impl PolicyRestrictionContract {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Policy restrictions contract properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PolicyRestrictionContractProperties {
    #[doc = "Path to the policy document."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub scope: Option<String>,
    #[doc = "Indicates if base policy should be enforced for the policy document."]
    #[serde(rename = "requireBase", default, skip_serializing_if = "Option::is_none")]
    pub require_base: Option<policy_restriction_contract_properties::RequireBase>,
}
impl PolicyRestrictionContractProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod policy_restriction_contract_properties {
    use super::*;
    #[doc = "Indicates if base policy should be enforced for the policy document."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "RequireBase")]
    pub enum RequireBase {
        #[serde(rename = "true")]
        True,
        #[serde(rename = "false")]
        False,
    ...
    impl FromStr for RequireBase {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for RequireBase {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for RequireBase {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::True => serializer.serialize_unit_variant("RequireBase", 0u32, "true"),
                Self::False => serializer.serialize_unit_variant("RequireBase", 1u32, "false"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for RequireBase {
        fn default() -> Self {
            Self::False
        }
    }
...
#[doc = "Policy restriction contract details."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PolicyRestrictionUpdateContract {
    #[doc = "Policy restrictions contract properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<PolicyRestrictionContractProperties>,
}
impl PolicyRestrictionUpdateContract {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The response of the list policy operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PolicyWithComplianceCollection {
    #[doc = "Policy Contract value."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub value: Vec<PolicyWithComplianceContract>,
    #[doc = "Next page link if any."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl PolicyWithComplianceCollection {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Policy Contract details."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PolicyWithComplianceContract {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Policy contract Properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<PolicyWithComplianceContractProperties>,
}
impl PolicyWithComplianceContract {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Policy contract Properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PolicyWithComplianceContractProperties {
    #[doc = "Policy Identifier"]
    #[serde(rename = "referencePolicyId", default, skip_serializing_if = "Option::is_none")]
    pub reference_policy_id: Option<String>,
    #[doc = "Policy Restriction Compliance State"]
    #[serde(rename = "complianceState", default, skip_serializing_if = "Option::is_none")]
    pub compliance_state: Option<policy_with_compliance_contract_properties::ComplianceState>,
}
impl PolicyWithComplianceContractProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod policy_with_compliance_contract_properties {
    use super::*;
    #[doc = "Policy Restriction Compliance State"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ComplianceState")]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct WorkspaceLinksBaseProperties {
    #[doc = "The link to the API Management service workspace."]
    #[serde(rename = "workspaceId", default, skip_serializing_if = "Option::is_none")]
    pub workspace_id: Option<String>,
    #[doc = "The array of linked gateways."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub gateways: Vec<WorkspaceLinksGateway>,
}
impl WorkspaceLinksBaseProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct WorkspaceLinksGateway {
    #[doc = "The link to the API Management gateway."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
}
impl WorkspaceLinksGateway {
    pub fn new() -> Self {
        Self::default()
    }
}
