...
pub enum Error {
    ...
    #[error(transparent)]
    Certificate_RefreshSecret(#[from] certificate::refresh_secret::Error),
    #[error(transparent)]
    ContentType_ListByService(#[from] content_type::list_by_service::Error),
    #[error(transparent)]
    ContentType_Get(#[from] content_type::get::Error),
    #[error(transparent)]
    ...
    #[error(transparent)]
    DeletedServices_ListBySubscription(#[from] deleted_services::list_by_subscription::Error),
    #[error(transparent)]
    DeletedServices_GetByName(#[from] deleted_services::get_by_name::Error),
    #[error(transparent)]
    DeletedServices_Purge(#[from] deleted_services::purge::Error),
    #[error(transparent)]
    ...
    #[error(transparent)]
    ApiManagementService_GetDomainOwnershipIdentifier(#[from] api_management_service::get_domain_ownership_identifier::Error),
    #[error(transparent)]
    ...
    #[error(transparent)]
    GatewayCertificateAuthority_ListByService(#[from] gateway_certificate_authority::list_by_service::Error),
    #[error(transparent)]
    GatewayCertificateAuthority_Get(#[from] gateway_certificate_authority::get::Error),
    #[error(transparent)]
    GatewayCertificateAuthority_CreateOrUpdate(#[from] gateway_certificate_authority::create_or_update::Error),
    #[error(transparent)]
    GatewayCertificateAuthority_Delete(#[from] gateway_certificate_authority::delete::Error),
    #[error(transparent)]
    GatewayCertificateAuthority_GetEntityTag(#[from] gateway_certificate_authority::get_entity_tag::Error),
    #[error(transparent)]
    ...
    #[error(transparent)]
    NamedValue_RefreshSecret(#[from] named_value::refresh_secret::Error),
    #[error(transparent)]
    ...
    #[error(transparent)]
    PortalRevision_ListByService(#[from] portal_revision::list_by_service::Error),
    #[error(transparent)]
    PortalRevision_Get(#[from] portal_revision::get::Error),
    #[error(transparent)]
    PortalRevision_CreateOrUpdate(#[from] portal_revision::create_or_update::Error),
    #[error(transparent)]
    PortalRevision_Update(#[from] portal_revision::update::Error),
    #[error(transparent)]
    PortalRevision_GetEntityTag(#[from] portal_revision::get_entity_tag::Error),
    #[error(transparent)]
    PortalSettings_ListByService(#[from] portal_settings::list_by_service::Error),
    #[error(transparent)]
    ...
    #[error(transparent)]
    TenantSettings_ListByService(#[from] tenant_settings::list_by_service::Error),
    #[error(transparent)]
    TenantSettings_Get(#[from] tenant_settings::get::Error),
    #[error(transparent)]
    ApiManagementSkus_List(#[from] api_management_skus::list::Error),
    #[error(transparent)]
    ...
    #[error(transparent)]
    TenantAccess_ListByService(#[from] tenant_access::list_by_service::Error),
    #[error(transparent)]
    TenantAccess_Get(#[from] tenant_access::get::Error),
    #[error(transparent)]
    TenantAccess_Create(#[from] tenant_access::create::Error),
    #[error(transparent)]
    ...
    #[error(transparent)]
    UserSubscription_Get(#[from] user_subscription::get::Error),
    #[error(transparent)]
...
pub mod api_version_set {
    ...
    pub async fn update(
        ...
        if_match: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::ApiVersionSetContract, update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ApiManagement/service/{}/apiVersionSets/{}",
            operation_config.base_path(),
...
pub mod authorization_server {
    ...
    pub async fn update(
        ...
        if_match: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::AuthorizationServerContract, update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ApiManagement/service/{}/authorizationServers/{}",
            operation_config.base_path(),
    ...
    pub async fn list_secrets(
        ...
        authsid: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::AuthorizationServerSecretsContract, list_secrets::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::AuthorizationServerSecretsContract =
...
pub mod backend {
    ...
    pub async fn update(
        ...
        if_match: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::BackendContract, update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ApiManagement/service/{}/backends/{}",
            operation_config.base_path(),
...
pub mod cache {
    ...
    pub async fn update(
        ...
        if_match: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::CacheContract, update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ApiManagement/service/{}/caches/{}",
            operation_config.base_path(),
...
pub mod certificate {
    ...
    pub async fn refresh_secret(
        ...
        certificate_id: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::CertificateContract, refresh_secret::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
...
pub mod deleted_services {
    ...
    pub async fn list_by_subscription(
        operation_config: &crate::OperationConfig,
        subscription_id: &str,
    ) -> std::result::Result<models::DeletedServicesCollection, list_by_subscription::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
    ...
    pub async fn get_by_name(
        ...
        subscription_id: &str,
        location: &str,
    ) -> std::result::Result<models::DeletedServiceContract, get_by_name::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::DeletedServiceContract =
...
pub mod api_management_service {
    ...
    pub async fn get_domain_ownership_identifier(
        operation_config: &crate::OperationConfig,
        subscription_id: &str,
    ) -> std::result::Result<models::ApiManagementServiceGetDomainOwnershipIdentifierResult, get_domain_ownership_identifier::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::ApiManagementServiceGetDomainOwnershipIdentifierResult = serde_json::from_slice(rsp_body)
...
pub mod diagnostic {
    ...
    pub async fn update(
        ...
        if_match: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::DiagnosticContract, update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ApiManagement/service/{}/diagnostics/{}",
            operation_config.base_path(),
...
pub mod email_template {
    ...
    pub async fn update(
        ...
        parameters: &models::EmailTemplateUpdateParameters,
        subscription_id: &str,
    ) -> std::result::Result<models::EmailTemplateContract, update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ApiManagement/service/{}/templates/{}",
            operation_config.base_path(),
...
pub mod gateway {
    ...
    pub async fn update(
        ...
        if_match: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::GatewayContract, update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ApiManagement/service/{}/gateways/{}",
            operation_config.base_path(),
...
pub mod gateway_certificate_authority {
    ...
    pub async fn list_by_service(
        ...
        u24skip: Option<i32>,
        subscription_id: &str,
    ) -> std::result::Result<models::GatewayCertificateAuthorityCollection, list_by_service::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
    ...
    pub async fn get(
        ...
        certificate_id: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::GatewayCertificateAuthorityContract, get::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ApiManagement/service/{}/gateways/{}/certificateAuthorities/{}",
            operation_config.base_path(),
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::GatewayCertificateAuthorityContract =
                    serde_json::from_slice(rsp_body).map_err(|source| get::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
    ...
    pub async fn create_or_update(
        ...
        certificate_id: &str,
        if_match: Option<&str>,
        parameters: &models::GatewayCertificateAuthorityContract,
        subscription_id: &str,
    ) -> std::result::Result<create_or_update::Response, create_or_update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
...
pub mod group {
    ...
    pub async fn update(
        ...
        if_match: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::GroupContract, update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ApiManagement/service/{}/groups/{}",
            operation_config.base_path(),
...
pub mod identity_provider {
    ...
    pub async fn update(
        ...
        if_match: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::IdentityProviderContract, update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ApiManagement/service/{}/identityProviders/{}",
            operation_config.base_path(),
...
pub mod logger {
    ...
    pub async fn update(
        ...
        if_match: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::LoggerContract, update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ApiManagement/service/{}/loggers/{}",
            operation_config.base_path(),
...
pub mod named_value {
    ...
    pub async fn list_value(
        ...
        named_value_id: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::NamedValueSecretContract, list_value::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::NamedValueSecretContract =
...
pub mod open_id_connect_provider {
    ...
    pub async fn update(
        ...
        if_match: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::OpenidConnectProviderContract, update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ApiManagement/service/{}/openidConnectProviders/{}",
            operation_config.base_path(),
...
pub mod portal_revision {
    ...
    pub async fn list_by_service(
        ...
        u24skip: Option<i32>,
        subscription_id: &str,
    ) -> std::result::Result<models::PortalRevisionCollection, list_by_service::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
    ...
    pub async fn get(
        ...
        subscription_id: &str,
    ) -> std::result::Result<models::PortalRevisionContract, get::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ApiManagement/service/{}/portalRevisions/{}",
            operation_config.base_path(),
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::PortalRevisionContract =
                    serde_json::from_slice(rsp_body).map_err(|source| get::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
    ...
    pub async fn create_or_update(
        ...
        service_name: &str,
        portal_revision_id: &str,
        parameters: &models::PortalRevisionContract,
        subscription_id: &str,
    ) -> std::result::Result<create_or_update::Response, create_or_update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
...
pub mod portal_settings {
    ...
    pub async fn list_by_service(
        ...
        service_name: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::PortalSettingsCollection, list_by_service::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
...
pub mod product {
    ...
    pub async fn update(
        ...
        if_match: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::ProductContract, update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ApiManagement/service/{}/products/{}",
            operation_config.base_path(),
...
pub mod tag {
    ...
    pub async fn update(
        ...
        if_match: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::TagContract, update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ApiManagement/service/{}/tags/{}",
            operation_config.base_path(),
...
pub mod quota_by_counter_keys {
    ...
    pub async fn update(
        ...
        subscription_id: &str,
    ) -> std::result::Result<models::QuotaCounterCollection, update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ApiManagement/service/{}/quotas/{}",
            operation_config.base_path(),
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::QuotaCounterCollection =
                    serde_json::from_slice(rsp_body).map_err(|source| update::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
...
pub mod quota_by_period_keys {
    ...
    pub async fn update(
        ...
        parameters: &models::QuotaCounterValueUpdateContract,
        subscription_id: &str,
    ) -> std::result::Result<models::QuotaCounterContract, update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ApiManagement/service/{}/quotas/{}/periods/{}",
            operation_config.base_path(),
...
pub mod tenant_settings {
    ...
    pub async fn list_by_service(
        ...
        u24filter: Option<&str>,
        subscription_id: &str,
    ) -> std::result::Result<models::TenantSettingsCollection, list_by_service::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
    ...
    pub async fn get(
        ...
        subscription_id: &str,
        settings_type: &str,
    ) -> std::result::Result<models::TenantSettingsContract, get::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ApiManagement/service/{}/settings/{}",
            operation_config.base_path(),
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::TenantSettingsContract =
                    serde_json::from_slice(rsp_body).map_err(|source| get::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
...
pub mod api_management_skus {
    ...
    pub async fn list(
        operation_config: &crate::OperationConfig,
        subscription_id: &str,
    ) -> std::result::Result<models::ApiManagementSkusResult, list::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::ApiManagementSkusResult =
                    serde_json::from_slice(rsp_body).map_err(|source| list::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
...
pub mod subscription {
    ...
    pub async fn update(
        ...
        subscription_id: &str,
        app_type: Option<&str>,
    ) -> std::result::Result<models::SubscriptionContract, update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ApiManagement/service/{}/subscriptions/{}",
            operation_config.base_path(),
...
pub mod tenant_access {
    ...
    pub async fn list_by_service(
        ...
        u24filter: Option<&str>,
        subscription_id: &str,
    ) -> std::result::Result<models::AccessInformationCollection, list_by_service::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
    ...
    pub async fn create(
        ...
        resource_group_name: &str,
        service_name: &str,
        parameters: &models::AccessInformationCreateParameters,
        access_name: &str,
        if_match: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::AccessInformationContract, create::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ApiManagement/service/{}/tenant/{}",
            operation_config.base_path(),
    ...
    pub async fn update(
        ...
        if_match: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::AccessInformationContract, update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ApiManagement/service/{}/tenant/{}",
            operation_config.base_path(),
    ...
    pub async fn list_secrets(
        ...
        subscription_id: &str,
        access_name: &str,
    ) -> std::result::Result<models::AccessInformationSecretsContract, list_secrets::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::AccessInformationSecretsContract =
                    serde_json::from_slice(rsp_body).map_err(|source| list_secrets::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
...
pub mod user {
    ...
    pub async fn update(
        ...
        if_match: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::UserContract, update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ApiManagement/service/{}/users/{}",
            operation_config.base_path(),
