...
impl Serialize for ActionType {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::JsChallenge => serializer.serialize_unit_variant("ActionType", 5u32, "JSChallenge"),
...
pub struct CustomRule {
    ...
    #[doc = "Describes the list of variables to group the rate limit requests"]
    #[serde(
        rename = "groupBy",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub group_by: Vec<GroupByVariable>,
...
#[doc = "Describes the variables available to group the rate limit requests"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GroupByVariable {
    #[doc = "Describes the supported variable for group by"]
...
pub mod group_by_variable {
    ...
    impl Serialize for VariableName {
        ...
        {
            match self {
                Self::SocketAddr => serializer.serialize_unit_variant("VariableName", 0u32, "SocketAddr"),
...
pub struct PolicySettings {
    ...
    #[doc = "Defines the JavaScript challenge cookie validity lifetime in minutes. This setting is only applicable to Premium_AzureFrontDoor. Value must be an integer between 5 and 1440 with the default value being 30."]
    #[serde(
        rename = "javascriptChallengeExpirationInMinutes",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub javascript_challenge_expiration_in_minutes: Option<i32>,
    #[doc = "Defines rules that scrub sensitive fields in the Web Application Firewall logs."]
...
pub mod policy_settings {
    ...
    pub struct LogScrubbing {
        ...
        #[doc = "List of log scrubbing rules applied to the Web Application Firewall logs."]
        #[serde(
...
#[doc = "Defines the contents of the log scrubbing rules."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct WebApplicationFirewallScrubbingRules {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub selector: Option<String>,
    #[doc = "Defines the state of a log scrubbing rule. Default value is enabled."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub mod web_application_firewall_scrubbing_rules {
    ...
    impl Serialize for MatchVariable {
        ...
        {
            match self {
                Self::RequestIpAddress => serializer.serialize_unit_variant("MatchVariable", 0u32, "RequestIPAddress"),
                Self::RequestUri => serializer.serialize_unit_variant("MatchVariable", 1u32, "RequestUri"),
                Self::QueryStringArgNames => serializer.serialize_unit_variant("MatchVariable", 2u32, "QueryStringArgNames"),
                Self::RequestHeaderNames => serializer.serialize_unit_variant("MatchVariable", 3u32, "RequestHeaderNames"),
                Self::RequestCookieNames => serializer.serialize_unit_variant("MatchVariable", 4u32, "RequestCookieNames"),
                Self::RequestBodyPostArgNames => serializer.serialize_unit_variant("MatchVariable", 5u32, "RequestBodyPostArgNames"),
                Self::RequestBodyJsonArgNames => serializer.serialize_unit_variant("MatchVariable", 6u32, "RequestBodyJsonArgNames"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for SelectorMatchOperator {
        ...
        {
            match self {
                Self::EqualsAny => serializer.serialize_unit_variant("SelectorMatchOperator", 0u32, "EqualsAny"),
                Self::Equals => serializer.serialize_unit_variant("SelectorMatchOperator", 1u32, "Equals"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
