...
#[doc = "Cloud Hsm Cluster backup information"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct BackupProperties {
    #[doc = "Azure storage Resource Uri"]
    #[serde(rename = "azureStorageResourceUri", default, skip_serializing_if = "Option::is_none")]
    pub azure_storage_resource_uri: Option<String>,
    #[doc = "Last Date Time that Customer Enabled Backup was taken"]
    #[serde(rename = "lastBackupDateTime", default, with = "azure_core::date::rfc3339::option")]
    pub last_backup_date_time: Option<time::OffsetDateTime>,
    #[doc = "Status of last backup"]
...
pub struct CloudHsmClusterPatchParameters {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<cloud_hsm_cluster_patch_parameters::Properties>,
}
...
pub mod cloud_hsm_cluster_patch_parameters {
    use super::*;
    #[doc = "Properties of the Cloud HSM Cluster"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
    pub struct Properties {
        #[doc = "Cloud Hsm Cluster backup information"]
        #[serde(rename = "backupProperties", default, skip_serializing_if = "Option::is_none")]
...
pub struct CloudHsmClusterProperties {
    ...
    #[serde(rename = "restoreProperties", default, skip_serializing_if = "Option::is_none")]
    pub restore_properties: Option<RestoreProperties>,
    #[doc = "Cloud Hsm Cluster backup information"]
    #[serde(rename = "backupProperties", default, skip_serializing_if = "Option::is_none")]
    pub backup_properties: Option<BackupProperties>,
}
...
#[doc = "Cloud Hsm Cluster restore information"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RestoreProperties {
    #[doc = "Directory name in Azure Storage Blob where the backup is stored"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
