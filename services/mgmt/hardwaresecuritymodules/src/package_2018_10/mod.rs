    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!("/providers/Microsoft.HardwareSecurityModules/operations",));
...
pub mod dedicated_hsm {
    ...
    pub mod get {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DedicatedHsm>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DedicatedHsm>>;
