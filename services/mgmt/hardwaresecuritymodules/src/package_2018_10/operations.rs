    ...
    pub async fn list(operation_config: &crate::OperationConfig) -> std::result::Result<DedicatedHsmOperationListResult, list::Error> {
        ...
        match rsp.status() {
            StatusCode::OK => {
                ...
                let rsp_value: DedicatedHsmOperationListResult = serde_json::from_slice(&body).context(list::DeserializeError { body })?;
                Ok(rsp_value)
            }
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(list::ResponseBytesError)?;
                let rsp_value: DedicatedHsmError = serde_json::from_slice(&body).context(list::DeserializeError { body })?;
    ...
    pub async fn get(
        ...
        match rsp.status() {
            StatusCode::OK => {
                ...
                let rsp_value: DedicatedHsm = serde_json::from_slice(&body).context(get::DeserializeError { body })?;
                Ok(rsp_value)
            }
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(get::ResponseBytesError)?;
                let rsp_value: DedicatedHsmError = serde_json::from_slice(&body).context(get::DeserializeError { body })?;
                get::DefaultResponse {
                    status_code,
                    value: rsp_value,
                }
    ...
    pub async fn create_or_update(
        ...
        match rsp.status() {
            StatusCode::CREATED => {
                ...
                let rsp_value: DedicatedHsm = serde_json::from_slice(&body).context(create_or_update::DeserializeError { body })?;
            ...
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(create_or_update::ResponseBytesError)?;
                let rsp_value: DedicatedHsmError = serde_json::from_slice(&body).context(create_or_update::DeserializeError { body })?;
    ...
    pub async fn update(
        ...
        match rsp.status() {
            StatusCode::OK => {
                ...
                let rsp_value: DedicatedHsm = serde_json::from_slice(&body).context(update::DeserializeError { body })?;
                Ok(rsp_value)
            }
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(update::ResponseBytesError)?;
                let rsp_value: DedicatedHsmError = serde_json::from_slice(&body).context(update::DeserializeError { body })?;
    ...
    pub async fn delete(
        ...
        match rsp.status() {
            ...
            status_code => {
                ...
                let rsp_value: DedicatedHsmError = serde_json::from_slice(&body).context(delete::DeserializeError { body })?;
    ...
    pub async fn list_by_resource_group(
        ...
        match rsp.status() {
            StatusCode::OK => {
                ...
                let rsp_value: DedicatedHsmListResult =
