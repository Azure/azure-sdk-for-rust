...
pub mod operations {
    ...
    pub mod list {
        use super::models;
        type Response = models::DedicatedHsmOperationListResult;
        #[derive(Clone)]
        pub struct Builder {
            ...
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            .query_pairs_mut()
                            .append_pair(azure_core::query_param::API_VERSION, "2021-11-30");
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                ...
                                let rsp_value: models::DedicatedHsmOperationListResult = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
...
pub mod dedicated_hsm {
    ...
    impl Client {
        ...
        #[doc = "Gets a list of egress endpoints (network endpoints of all outbound dependencies) in the specified dedicated hsm resource."]
        #[doc = "Gets a list of egress endpoints (network endpoints of all outbound dependencies) in the specified dedicated hsm resource. The operation returns properties of each egress endpoint."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the Resource Group to which the dedicated hsm belongs."]
        #[doc = "* `name`: The name of the dedicated HSM."]
    ...
    pub mod get {
        use super::models;
        type Response = models::DedicatedHsm;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
    ...
    pub mod list_by_resource_group {
        use super::models;
        type Response = models::DedicatedHsmListResult;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) resource_group_name: String,
        ...
        impl Builder {
            pub fn into_stream(self) -> azure_core::Pageable<Response, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.HardwareSecurityModules/dedicatedHSMs/{}/outboundNetworkDependenciesEndpoints" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . name)) ? ;
                        let rsp = match continuation {
                            Some(value) => {
                                url.set_path("");
                                url = url.join(&value)?;
