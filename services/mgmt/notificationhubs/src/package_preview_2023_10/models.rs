...
pub struct CheckAvailabilityParameters {
    ...
    #[doc = "Not used and deprecated since API version 2023-01-01-preview"]
...
#[doc = "Description of a NotificationHub FcmV1Credential."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct FcmV1Credential {
    #[doc = "Description of a NotificationHub FcmV1Credential."]
    pub properties: FcmV1CredentialProperties,
}
impl FcmV1Credential {
    pub fn new(properties: FcmV1CredentialProperties) -> Self {
        Self { properties }
    }
}
#[doc = "Description of a NotificationHub FcmV1Credential."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct FcmV1CredentialProperties {
    #[doc = "Gets or sets client email."]
    #[serde(rename = "clientEmail")]
    pub client_email: String,
    #[doc = "Gets or sets private key."]
    #[serde(rename = "privateKey")]
    pub private_key: String,
    #[doc = "Gets or sets project id."]
    #[serde(rename = "projectId")]
    pub project_id: String,
}
impl FcmV1CredentialProperties {
    pub fn new(client_email: String, private_key: String, project_id: String) -> Self {
        Self {
            client_email,
            private_key,
            project_id,
...
pub struct LogSpecification {
    ...
    #[serde(rename = "blobDuration", default, skip_serializing_if = "Option::is_none")]
    pub blob_duration: Option<String>,
    #[doc = "Category group for the log specification."]
    #[serde(
...
pub struct MetricSpecification {
    ...
    #[doc = "List of supported time grain types."]
    #[serde(
...
pub struct NotificationHubProperties {
    ...
    #[doc = "Description of a NotificationHub FcmV1Credential."]
    #[serde(rename = "fcmV1Credential", default, skip_serializing_if = "Option::is_none")]
    pub fcm_v1_credential: Option<FcmV1Credential>,
