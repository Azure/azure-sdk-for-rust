...
pub mod namespaces {
    ...
    pub async fn list_keys(
        ...
        authorization_rule_name: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::SharedAccessAuthorizationRuleListResult, list_keys::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
...
pub mod notification_hubs {
    ...
    pub async fn check_notification_hub_availability(
        ...
        parameters: &models::CheckAvailabilityParameters,
        subscription_id: &str,
    ) -> std::result::Result<models::CheckAvailabilityResult, check_notification_hub_availability::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
    ...
    pub async fn patch(
        ...
        namespace_name: &str,
        notification_hub_name: &str,
        parameters: Option<&models::NotificationHubPatchParameters>,
        subscription_id: &str,
    ) -> std::result::Result<models::NotificationHubResource, patch::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NotificationHubs/namespaces/{}/notificationHubs/{}",
            operation_config.base_path(),
    ...
    pub async fn debug_send(
        ...
        namespace_name: &str,
        notification_hub_name: &str,
        parameters: Option<&models::DebugSendParameters>,
        subscription_id: &str,
    ) -> std::result::Result<models::DebugSendResponse, debug_send::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
