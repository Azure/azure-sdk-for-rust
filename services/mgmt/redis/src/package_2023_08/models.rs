...
pub struct ExportRdbParameters {
    ...
    #[doc = "Subscription id of the storage container for data to be exported using ManagedIdentity."]
    #[serde(rename = "storage-subscription-id", default, skip_serializing_if = "Option::is_none")]
    pub storage_subscription_id: Option<String>,
}
impl ExportRdbParameters {
    pub fn new(prefix: String, container: String) -> Self {
        Self {
            ...
            prefix,
            container,
            preferred_data_archive_auth_method: None,
            storage_subscription_id: None,
        }
    }
}
...
pub struct ImportRdbParameters {
    ...
    #[serde(rename = "preferred-data-archive-auth-method", default, skip_serializing_if = "Option::is_none")]
    pub preferred_data_archive_auth_method: Option<String>,
    #[doc = "Subscription id of the storage container containing files to import using Managed Identity."]
    #[serde(rename = "storage-subscription-id", default, skip_serializing_if = "Option::is_none")]
    pub storage_subscription_id: Option<String>,
}
...
impl RedisCacheAccessPolicyAssignment {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "List of access policies assignments (with properties) of a Redis cache."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RedisCacheAccessPolicyAssignmentList {
    #[doc = "List of access policies assignments (with properties) of a Redis cache."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub value: Vec<RedisCacheAccessPolicyAssignment>,
...
#[doc = "Properties for an access policy assignment"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RedisCacheAccessPolicyAssignmentProperties {
    #[doc = "Provisioning state of an access policy assignment set"]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<redis_cache_access_policy_assignment_properties::ProvisioningState>,
    #[doc = "Object Id to assign access policy to"]
    #[serde(rename = "objectId")]
    pub object_id: String,
    #[doc = "User friendly name for object id. Also represents username for token based authentication"]
    #[serde(rename = "objectIdAlias")]
    pub object_id_alias: String,
    #[doc = "The name of the access policy that is being assigned"]
    #[serde(rename = "accessPolicyName")]
    pub access_policy_name: String,
}
impl RedisCacheAccessPolicyAssignmentProperties {
    pub fn new(object_id: String, object_id_alias: String, access_policy_name: String) -> Self {
        Self {
            provisioning_state: None,
            object_id,
            object_id_alias,
...
pub mod redis_cache_access_policy_assignment_properties {
    use super::*;
    #[doc = "Provisioning state of an access policy assignment set"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "List of access policies (with properties) of a Redis cache."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RedisCacheAccessPolicyList {
    #[doc = "List of access policies (with properties) of a Redis cache."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub value: Vec<RedisCacheAccessPolicy>,
    #[doc = "Link for next set."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
...
#[doc = "All properties of an access policy."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RedisCacheAccessPolicyProperties {
    #[doc = "Provisioning state of access policy"]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<redis_cache_access_policy_properties::ProvisioningState>,
    #[doc = "Built-In or Custom access policy"]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<redis_cache_access_policy_properties::Type>,
    #[doc = "Permissions for the access policy. Learn how to configure permissions at https://aka.ms/redis/AADPreRequisites"]
    pub permissions: String,
}
impl RedisCacheAccessPolicyProperties {
...
pub mod redis_cache_access_policy_properties {
    use super::*;
    #[doc = "Provisioning state of access policy"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ProvisioningState")]
    ...
    impl Serialize for Type {
        ...
        {
            match self {
                Self::Custom => serializer.serialize_unit_variant("Type", 0u32, "Custom"),
                Self::BuiltIn => serializer.serialize_unit_variant("Type", 1u32, "BuiltIn"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct RedisCommonProperties {
    ...
    #[doc = "Redis version. This should be in the form 'major[.minor]' (only 'major' is required) or the value 'latest' which refers to the latest stable Redis version that is available. Supported versions: 4.0, 6.0 (latest). Default value is 'latest'."]
    ...
    #[doc = "Optional: Specifies the update channel for the monthly Redis updates your Redis Cache will receive. Caches using 'Preview' update channel get latest Redis updates at least 4 weeks ahead of 'Stable' channel caches. Default value is 'Stable'."]
    #[serde(rename = "updateChannel", default, skip_serializing_if = "Option::is_none")]
    pub update_channel: Option<redis_common_properties::UpdateChannel>,
}
...
pub mod redis_common_properties {
    ...
    pub struct RedisConfiguration {
        ...
        #[doc = "SubscriptionId of the storage account for persistence (aof/rdb) using ManagedIdentity."]
        #[serde(rename = "storage-subscription-id", default, skip_serializing_if = "Option::is_none")]
        pub storage_subscription_id: Option<String>,
        #[doc = "Specifies whether AAD based authentication has been enabled or disabled for the cache"]
        #[serde(rename = "aad-enabled", default, skip_serializing_if = "Option::is_none")]
        pub aad_enabled: Option<String>,
    }
    ...
    impl Serialize for UpdateChannel {
        ...
        {
            match self {
                Self::Stable => serializer.serialize_unit_variant("UpdateChannel", 0u32, "Stable"),
                Self::Preview => serializer.serialize_unit_variant("UpdateChannel", 1u32, "Preview"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct RedisLinkedServerCreateProperties {
    ...
    #[doc = "The unchanging DNS name which will always point to current geo-primary cache among the linked redis caches for seamless Geo Failover experience."]
    #[serde(rename = "geoReplicatedPrimaryHostName", default, skip_serializing_if = "Option::is_none")]
    pub geo_replicated_primary_host_name: Option<String>,
    #[doc = "The changing DNS name that resolves to the current geo-primary cache among the linked redis caches before or after the Geo Failover."]
    #[serde(rename = "primaryHostName", default, skip_serializing_if = "Option::is_none")]
    pub primary_host_name: Option<String>,
}
impl RedisLinkedServerCreateProperties {
    pub fn new(
        ...
        Self {
            ...
            server_role,
            geo_replicated_primary_host_name: None,
