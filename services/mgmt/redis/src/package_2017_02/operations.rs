...
impl Client {
    ...
    pub fn redis_linked_server(&self) -> redis_linked_server::Client {
        redis_linked_server::Client(self.clone())
    }
}
#[non_exhaustive]
...
pub enum Error {
    ...
    #[error(transparent)]
    RedisLinkedServer_Get(#[from] redis_linked_server::get::Error),
    #[error(transparent)]
    RedisLinkedServer_Create(#[from] redis_linked_server::create::Error),
    #[error(transparent)]
    RedisLinkedServer_Delete(#[from] redis_linked_server::delete::Error),
    #[error(transparent)]
    RedisLinkedServer_List(#[from] redis_linked_server::list::Error),
}
pub mod operations {
    use super::models;
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::OperationListResult, Error>> {
                Box::pin(async move {
                    ...
                    url.query_pairs_mut().append_pair("api-version", "2017-02-01");
