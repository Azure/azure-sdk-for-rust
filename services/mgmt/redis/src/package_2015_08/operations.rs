...
pub mod redis {
    ...
    impl Client {
        ...
        pub fn create_or_update(
            ...
            resource_group_name: impl Into<String>,
            name: impl Into<String>,
            parameters: impl Into<models::RedisCreateOrUpdateParameters>,
            subscription_id: impl Into<String>,
    ...
    pub mod create_or_update {
        ...
        pub struct Builder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) name: String,
            pub(crate) parameters: models::RedisCreateOrUpdateParameters,
            pub(crate) subscription_id: String,
        }
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<Response, Error>> {
                    ...
                    async move {
                        ...
                        match rsp_status {
                            http::StatusCode::CREATED => {
                                let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                                let rsp_value: models::RedisResourceWithAccessKey =
                                    serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
    ...
    pub mod list_keys {
        use super::models;
        type Response = models::RedisListKeysResult;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("Unexpected HTTP status code {}", status_code)]
            UnexpectedResponse { status_code: http::StatusCode, body: bytes::Bytes },
