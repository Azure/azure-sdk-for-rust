...
pub mod redis {
    ...
    pub mod list_upgrade_notifications {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::NotificationListResponse>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::NotificationListResponse>>;
