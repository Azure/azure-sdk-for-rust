...
pub struct DirectConnection {
    ...
    #[serde(rename = "provisionedBandwidthInMbps", skip_serializing_if = "Option::is_none")]
...
pub struct PeeringServicePrefixProperties {
    ...
    #[serde(rename = "prefixValidationState", skip_serializing_if = "Option::is_none")]
    pub prefix_validation_state: Option<peering_service_prefix_properties::PrefixValidationState>,
    #[serde(rename = "learnedType", skip_serializing_if = "Option::is_none")]
