...
impl Client {
    ...
    pub fn peering_service_prefixes(&self) -> peering_service_prefixes::Client {
        peering_service_prefixes::Client(self.clone())
    }
...
pub enum Error {
    ...
    #[error(transparent)]
    PeeringServicePrefixes_Get(#[from] peering_service_prefixes::get::Error),
    #[error(transparent)]
    PeeringServicePrefixes_CreateOrUpdate(#[from] peering_service_prefixes::create_or_update::Error),
    #[error(transparent)]
    PeeringServicePrefixes_Delete(#[from] peering_service_prefixes::delete::Error),
    #[error(transparent)]
