                    ...
                    async move {
                        ...
                        let rsp = match continuation {
                            ...
                            None => {
                                ...
                                req.url_mut()
                                    .query_pairs_mut()
                                    .append_pair(azure_core::query_param::API_VERSION, "2022-01-01");
                                let peering_location = &this.peering_location;
                                req.url_mut().query_pairs_mut().append_pair("peeringLocation", peering_location);
                                let req_body = azure_core::EMPTY_BODY;
                                req.set_body(req_body);
                                this.client.send(&mut req).await?
                            }
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                ...
                                let rsp_value: models::CdnPeeringPrefixListResult = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
        ...
        pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
            Box::pin({
                ...
                async move {
                    ...
                    let req_body = azure_core::to_json(&this.check_service_provider_availability_input)?;
                    req.set_body(req_body);
                    ...
                    async move {
                        ...
                        let rsp = match continuation {
                            ...
                            None => {
                                ...
                                if let Some(asn) = &this.asn {
                                    req.url_mut().query_pairs_mut().append_pair("asn", &asn.to_string());
                                }
                                let req_body = azure_core::EMPTY_BODY;
                                req.set_body(req_body);
                                this.client.send(&mut req).await?
...
pub mod looking_glass {
    ...
    impl Client {
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `command`: The command to be executed: ping, traceroute, bgpRoute."]
        #[doc = "* `source_type`: The type of the source: Edge site or Azure Region."]
        #[doc = "* `source_location`: The location of the source."]
        #[doc = "* `destination_ip`: The IP address of the destination."]
        #[doc = "* `subscription_id`: The Azure subscription ID."]
        pub fn invoke(
            &self,
    ...
    pub mod invoke {
        use super::models;
        type Response = models::LookingGlassOutput;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            ...
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        let source_location = &this.source_location;
                        req.url_mut().query_pairs_mut().append_pair("sourceLocation", source_location);
                        let destination_ip = &this.destination_ip;
                        req.url_mut().query_pairs_mut().append_pair("destinationIP", destination_ip);
                        let req_body = azure_core::EMPTY_BODY;
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await?;
                                let rsp_value: models::LookingGlassOutput = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
        ...
        impl Builder {
            pub fn into_stream(self) -> azure_core::Pageable<Response, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    ...
                    async move {
                        let mut url =
                            azure_core::Url::parse(&format!("{}/providers/Microsoft.Peering/operations", this.client.endpoint(),))?;
                        let rsp = match continuation {
                            Some(value) => {
                                url.set_path("");
                                url = url.join(&value)?;
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2022-01-01");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.peer_asn)?;
                        req.set_body(req_body);
                        let rsp = this.client.send(&mut req).await?;
                        let (rsp_status, rsp_headers, rsp_stream) = rsp.deconstruct();
                        match rsp_status {
                    ...
                    async move {
                        ...
                        let rsp = match continuation {
                            ...
                            None => {
                                ...
                                let kind = &this.kind;
                                req.url_mut().query_pairs_mut().append_pair("kind", kind);
                                if let Some(direct_peering_type) = &this.direct_peering_type {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair("directPeeringType", direct_peering_type);
                                }
                                let req_body = azure_core::EMPTY_BODY;
                                req.set_body(req_body);
                                this.client.send(&mut req).await?
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await?;
                                let rsp_value: models::PeeringLocationListResult = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2022-01-01");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.registered_asn)?;
                        req.set_body(req_body);
                        let rsp = this.client.send(&mut req).await?;
                        let (rsp_status, rsp_headers, rsp_stream) = rsp.deconstruct();
                        match rsp_status {
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2022-01-01");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.registered_prefix)?;
                        req.set_body(req_body);
                        let rsp = this.client.send(&mut req).await?;
                        let (rsp_status, rsp_headers, rsp_stream) = rsp.deconstruct();
                        match rsp_status {
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2022-01-01");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.peering)?;
                        req.set_body(req_body);
                        let rsp = this.client.send(&mut req).await?;
                        let (rsp_status, rsp_headers, rsp_stream) = rsp.deconstruct();
                        match rsp_status {
                    ...
                    async move {
                        ...
                        let rsp = match continuation {
                            ...
                            None => {
                                ...
                                if let Some(as_path) = &this.as_path {
                                    req.url_mut().query_pairs_mut().append_pair("asPath", as_path);
                                }
                                if let Some(origin_as_validation_state) = &this.origin_as_validation_state {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair("originAsValidationState", origin_as_validation_state);
                                }
                                if let Some(rpki_validation_state) = &this.rpki_validation_state {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair("rpkiValidationState", rpki_validation_state);
                                }
...
pub mod connection_monitor_tests {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets an existing connection monitor test with the specified name under the given subscription, resource group and peering service."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group."]
        #[doc = "* `peering_service_name`: The name of the peering service."]
        #[doc = "* `connection_monitor_test_name`: The name of the connection monitor test"]
        #[doc = "* `subscription_id`: The Azure subscription ID."]
        pub fn get(
            &self,
            resource_group_name: impl Into<String>,
            peering_service_name: impl Into<String>,
            connection_monitor_test_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ) -> get::Builder {
            get::Builder {
                client: self.0.clone(),
                ...
                connection_monitor_test_name: connection_monitor_test_name.into(),
                subscription_id: subscription_id.into(),
            }
        }
        #[doc = "Creates or updates a connection monitor test with the specified name under the given subscription, resource group and peering service."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group."]
        #[doc = "* `peering_service_name`: The name of the peering service."]
        #[doc = "* `connection_monitor_test_name`: The name of the connection monitor test"]
        #[doc = "* `connection_monitor_test`: The properties needed to create a connection monitor test"]
        #[doc = "* `subscription_id`: The Azure subscription ID."]
        pub fn create_or_update(
            &self,
            resource_group_name: impl Into<String>,
            peering_service_name: impl Into<String>,
            connection_monitor_test_name: impl Into<String>,
            connection_monitor_test: impl Into<models::ConnectionMonitorTest>,
            subscription_id: impl Into<String>,
        ) -> create_or_update::Builder {
            create_or_update::Builder {
                client: self.0.clone(),
                ...
                peering_service_name: peering_service_name.into(),
                connection_monitor_test_name: connection_monitor_test_name.into(),
                connection_monitor_test: connection_monitor_test.into(),
                subscription_id: subscription_id.into(),
            }
        }
        #[doc = "Deletes an existing connection monitor test with the specified name under the given subscription, resource group and peering service."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group."]
        #[doc = "* `peering_service_name`: The name of the peering service."]
        ...
        #[doc = "Lists all connection monitor tests under the given subscription, resource group and peering service."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group."]
        #[doc = "* `peering_service_name`: The name of the peering service."]
    ...
    pub mod get {
        use super::models;
        type Response = models::ConnectionMonitorTest;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) resource_group_name: String,
            pub(crate) peering_service_name: String,
            pub(crate) connection_monitor_test_name: String,
            pub(crate) subscription_id: String,
        }
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Peering/peeringServices/{}/connectionMonitorTests/{}" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . peering_service_name , & this . connection_monitor_test_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Get);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
    ...
    pub mod create_or_update {
        ...
        pub struct Builder {
            ...
            pub(crate) peering_service_name: String,
            pub(crate) connection_monitor_test_name: String,
            pub(crate) connection_monitor_test: models::ConnectionMonitorTest,
            pub(crate) subscription_id: String,
        }
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2022-01-01");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.connection_monitor_test)?;
                        req.set_body(req_body);
                        let rsp = this.client.send(&mut req).await?;
                        let (rsp_status, rsp_headers, rsp_stream) = rsp.deconstruct();
                        match rsp_status {
    ...
    pub mod list_by_peering_service {
        use super::models;
        type Response = models::ConnectionMonitorTestListResult;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) resource_group_name: String,
                ...
                let make_request = move |continuation: Option<String>| {
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await?;
                                let rsp_value: models::PeeringServiceCountryListResult = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
                ...
                let make_request = move |continuation: Option<String>| {
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await?;
                                let rsp_value: models::PeeringServiceLocationListResult = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2022-01-01");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.peering_service_prefix)?;
                        req.set_body(req_body);
                        let rsp = this.client.send(&mut req).await?;
                        let (rsp_status, rsp_headers, rsp_stream) = rsp.deconstruct();
                        match rsp_status {
                ...
                let make_request = move |continuation: Option<String>| {
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await?;
                                let rsp_value: models::PeeringServiceProviderListResult = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
...
pub mod peering_services {
    ...
    impl Client {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The Azure subscription ID."]
        pub fn initialize_connection_monitor(&self, subscription_id: impl Into<String>) -> initialize_connection_monitor::Builder {
            initialize_connection_monitor::Builder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
            }
        }
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2022-01-01");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.peering_service)?;
                        req.set_body(req_body);
                        let rsp = this.client.send(&mut req).await?;
                        let (rsp_status, rsp_headers, rsp_stream) = rsp.deconstruct();
                        match rsp_status {
