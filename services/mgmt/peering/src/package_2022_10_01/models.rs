...
#[doc = "The paginated list of Connection Monitor Tests."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ConnectionMonitorTestListResult {
    #[doc = "The list of Connection Monitor Tests."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    ...
    #[doc = "The link to fetch the next page of Connection Monitor Tests."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
    ...
    impl Serialize for ConnectionState {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::TypeChangeRequested => serializer.serialize_unit_variant("ConnectionState", 8u32, "TypeChangeRequested"),
                Self::TypeChangeInProgress => serializer.serialize_unit_variant("ConnectionState", 9u32, "TypeChangeInProgress"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RpUnbilledPrefixListResult {
    #[doc = "The list of RP unbilled prefixes."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<RpUnbilledPrefix>,
    #[doc = "The link to fetch the next page of RP unbilled prefixes."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for RpUnbilledPrefixListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl RpUnbilledPrefixListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
