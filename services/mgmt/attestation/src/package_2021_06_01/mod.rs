...
pub mod attestation_providers {
    ...
    impl Client {
        ...
        #[doc = "Creates or updates an Attestation Provider."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        pub fn list_default(&self, subscription_id: impl Into<String>) -> list_default::RequestBuilder {
            list_default::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
            }
        }
        ...
        pub fn get_default_by_location(
            ...
            subscription_id: impl Into<String>,
        ) -> get_default_by_location::RequestBuilder {
            get_default_by_location::RequestBuilder {
                client: self.0.clone(),
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AttestationProvider> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AttestationProvider = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AttestationProvider>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::AttestationProvider>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AttestationProviderListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AttestationProviderListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AttestationProviderListResult>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::AttestationProviderListResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod private_endpoint_connections {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Attestation/attestationProviders/{}/privateEndpointConnections" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . provider_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2021-06-01");
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Attestation/attestationProviders/{}/privateEndpointConnections/{}" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . provider_name , & self . private_endpoint_connection_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2021-06-01");
...
pub mod private_link_resources {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets the private link resources supported for the attestation provider."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `provider_name`: The name of the attestation provider."]
        ...
        pub fn list_by_provider(
            ...
            provider_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ) -> list_by_provider::RequestBuilder {
            list_by_provider::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                provider_name: provider_name.into(),
