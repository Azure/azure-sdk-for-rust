...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct LiftrBaseCompanyDetails {
    #[doc = "Company name"]
    ...
    #[serde(rename = "businessPhone", default, skip_serializing_if = "Option::is_none")]
...
pub struct LiftrBaseDataOrganizationProperties {
    ...
    pub company_details: LiftrBaseCompanyDetails,
    #[doc = "The provisioning state of a resource type."]
...
impl LiftrBaseDataOrganizationProperties {
    pub fn new(
        ...
        company_details: LiftrBaseCompanyDetails,
    ) -> Self {
        Self {
            marketplace_details,
            user_details,
...
#[doc = "Properties specific to Data Organization resource"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct LiftrBaseDataOrganizationPropertiesUpdate {
    #[doc = "User details for an organization"]
    ...
    pub company_details: Option<LiftrBaseCompanyDetails>,
    #[doc = "Properties specific to Partner's organization"]
    #[serde(rename = "partnerOrganizationProperties", default, skip_serializing_if = "Option::is_none")]
    pub partner_organization_properties: Option<LiftrBaseDataPartnerOrganizationPropertiesUpdate>,
}
impl LiftrBaseDataOrganizationPropertiesUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct OrganizationResourceUpdate {
    ...
    #[doc = "Properties specific to Data Organization resource"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<LiftrBaseDataOrganizationPropertiesUpdate>,
}
