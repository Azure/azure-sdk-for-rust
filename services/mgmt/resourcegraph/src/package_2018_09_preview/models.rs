...
impl FacetResult {
    pub fn new(facet: Facet, total_records: i64, count: i32, data: Table) -> Self {
        Self {
            facet,
            total_records,
            count,
...
impl GraphQueryPropertiesUpdateParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl GraphQueryUpdateParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl QueryResponse {
    pub fn new(total_records: i64, count: i64, result_truncated: query_response::ResultTruncated, data: Table) -> Self {
        Self {
            total_records,
            count,
            result_truncated,
