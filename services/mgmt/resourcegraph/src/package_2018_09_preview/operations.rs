...
pub mod graph_query {
    ...
    pub mod list {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::GraphQueryListResult, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
    ...
    pub mod get {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::GraphQueryResource, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ResourceGraph/queries/{}",
                        self.client.endpoint(),
    ...
    pub mod create_or_update {
        ...
        pub struct Builder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) resource_name: String,
            pub(crate) properties: models::GraphQueryResource,
        }
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::GraphQueryResource, Error>> {
                Box::pin(async move {
    ...
    pub mod update {
        ...
        pub struct Builder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) resource_name: String,
            pub(crate) body: models::GraphQueryUpdateParameters,
        }
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::GraphQueryResource, Error>> {
                Box::pin(async move {
