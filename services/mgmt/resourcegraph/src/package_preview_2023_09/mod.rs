...
pub mod query {
    ...
    impl Client {
        #[doc = "Generates ARG query for a given user prompt."]
        pub fn generate_query(&self, body: impl Into<models::QueryGenerationRequest>) -> generate_query::RequestBuilder {
            generate_query::RequestBuilder {
                client: self.0.clone(),
                body: body.into(),
            }
        }
    ...
    pub mod generate_query {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::QueryGenerationResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::QueryGenerationResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) body: models::QueryGenerationRequest,
        }
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!("/providers/Microsoft.ResourceGraph/generateQuery",));
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::QueryGenerationResponse>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::QueryGenerationResponse>>;
