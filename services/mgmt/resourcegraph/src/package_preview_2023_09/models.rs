...
#[doc = "History content generated by a user, assistant or system role"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct HistoryContext {
    #[doc = "Content generated by a given role"]
    pub content: String,
    #[doc = "The role which generates a specific message. Restricted to the user or assistant role."]
    pub role: Role,
}
impl HistoryContext {
...
#[doc = "Query Generation Request"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct QueryGenerationRequest {
    #[doc = "A collection of chat history to provide context in query generation"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub history: Vec<HistoryContext>,
    #[doc = "Prompt text from user"]
    pub prompt: String,
}
impl QueryGenerationRequest {
...
#[doc = "Query Generation Response"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct QueryGenerationResponse {
    #[doc = "Query generated for a given user prompt text"]
    pub query: String,
    #[doc = "Status"]
    pub status: StatusResponse,
}
impl QueryGenerationResponse {
    pub fn new(query: String, status: StatusResponse) -> Self {
        Self { query, status }
    }
}
...
impl Serialize for Role {
    ...
    {
        match self {
            Self::User => serializer.serialize_unit_variant("Role", 0u32, "user"),
            Self::Assistant => serializer.serialize_unit_variant("Role", 1u32, "assistant"),
            Self::System => serializer.serialize_unit_variant("Role", 2u32, "system"),
...
impl Serialize for StatusCategory {
    ...
    {
        match self {
            Self::Succeeded => serializer.serialize_unit_variant("StatusCategory", 0u32, "Succeeded"),
            Self::Failed => serializer.serialize_unit_variant("StatusCategory", 1u32, "Failed"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct StatusResponse {
    ...
    #[doc = "Status message for query generation result"]
    pub message: String,
}
impl StatusResponse {
    pub fn new(category: StatusCategory, message: String) -> Self {
...
impl Serialize for Versions {
    ...
    {
        match self {
            Self::N2023_09_01_preview => serializer.serialize_unit_variant("Versions", 0u32, "2023-09-01-preview"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
