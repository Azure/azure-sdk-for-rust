...
impl Client {
    ...
    pub fn professional_service_operation_client(&self) -> professional_service_operation::Client {
        professional_service_operation::Client(self.clone())
    }
    pub fn professional_service_subscription_level_client(&self) -> professional_service_subscription_level::Client {
        professional_service_subscription_level::Client(self.clone())
    }
}
pub mod professional_service_subscription_level {
    use super::models;
    ...
    impl Client {
        #[doc = "Gets information about all the Subscription Level ProfessionalService in a certain Azure subscription."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000)"]
        pub fn list_by_azure_subscription(&self, subscription_id: impl Into<String>) -> list_by_azure_subscription::RequestBuilder {
            list_by_azure_subscription::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
            }
        }
        #[doc = "Gets information about all the Subscription Level ProfessionalService in a certain resource group."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000)"]
        ...
        #[doc = "Gets information about the specified Subscription Level ProfessionalService."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000)"]
        #[doc = "* `resource_group_name`: The name of the resource group."]
        ...
        #[doc = "Creates or updates a ProfessionalService resource."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000)"]
        #[doc = "* `resource_group_name`: The name of the resource group."]
        #[doc = "* `resource_name`: The name of the resource."]
        #[doc = "* `parameters`: Parameters supplied to the create or update subscription level ProfessionalService operation."]
        pub fn create_or_update(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            resource_name: impl Into<String>,
            parameters: impl Into<models::ProfessionalServiceResourceCreation>,
        ...
        #[doc = "Deletes the specified ProfessionalService."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000)"]
        #[doc = "* `resource_group_name`: The name of the resource group."]
        ...
        #[doc = "Unsubscribe from a specified Subscription Level ProfessionalService."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000)"]
        #[doc = "* `resource_group_name`: The name of the resource group."]
        #[doc = "* `resource_name`: The name of the resource."]
        #[doc = "* `parameters`: Parameters supplied to unsubscribe ProfessionalService operation."]
        ...
        ) -> update_to_unsubscribed::RequestBuilder {
            update_to_unsubscribed::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod list_by_azure_subscription {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ProfessionalServiceResourceResponseWithContinuation> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ProfessionalServiceResourceResponseWithContinuation = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl RequestBuilder {
            pub fn into_stream(
                self,
            ) -> azure_core::Pageable<models::ProfessionalServiceResourceResponseWithContinuation, azure_core::error::Error> {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.ProfessionalService/resources",
    ...
    pub mod list_by_resource_group {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ProfessionalService/resources",
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ProfessionalServiceResource> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ProfessionalServiceResource = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ProfessionalServiceResource>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ProfessionalServiceResource>>;
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) resource_name: String,
            pub(crate) parameters: models::ProfessionalServiceResourceCreation,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod update_to_unsubscribed {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ProfessionalService/resources/{}/unsubscribe",
                    &self.subscription_id, &self.resource_group_name, &self.resource_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
...
pub mod professional_service_operation {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
...
pub mod operations {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets all ProfessionalService app operations."]
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ProfessionalServiceAppOperationsResponseWithContinuation> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ProfessionalServiceAppOperationsResponseWithContinuation = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(
                self,
            ) -> azure_core::Pageable<models::ProfessionalServiceAppOperationsResponseWithContinuation, azure_core::error::Error>
            {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.ProfessionalService/operations",));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01-preview");
