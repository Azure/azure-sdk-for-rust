        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-12-01-preview");
                }
                Ok(url)
            }
        }
...
pub mod private_endpoint_connections {
    ...
    pub mod delete {
        ...
        impl<'a> Headers<'a> {
            ...
            #[doc = "Operation Results Location URI"]
...
pub mod operation_result {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Get the result of a long running azure asynchronous operation."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.Maps/operationResults/{}",
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.Maps/operationStatuses/{}",
                    &self.subscription_id, &self.operation_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
