...
pub mod accounts {
    ...
    pub mod list_by_resource_group {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::MapsAccounts>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
...
pub mod maps {
    ...
    pub mod list_operations {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::MapsOperations>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
...
pub mod private_atlases {
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::PrivateAtlas> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::PrivateAtlas = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::PrivateAtlas>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2020-02-01-preview");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.private_atlas_create_parameters)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2020-02-01-preview");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.private_atlas_update_parameters)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
    ...
    pub mod list_by_account {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::PrivateAtlasList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::PrivateAtlasList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::PrivateAtlasList>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
...
pub mod creators {
    ...
    pub mod list_by_account {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::CreatorList>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2020-02-01-preview");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.creator_create_parameters)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
