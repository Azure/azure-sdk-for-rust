...
pub struct GuestConfigurationNavigation {
    ...
    #[doc = "Managed identity with storage access of the guest configuration package and configuration parameters."]
    #[serde(rename = "contentManagedIdentity", default, skip_serializing_if = "Option::is_none")]
    pub content_managed_identity: Option<String>,
