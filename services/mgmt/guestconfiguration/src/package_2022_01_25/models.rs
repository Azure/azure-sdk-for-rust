...
impl azure_core::Continuable for GuestConfigurationAssignmentReportList {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        None
    }
...
pub struct GuestConfigurationNavigation {
    ...
    #[serde(rename = "assignmentSource", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(
        rename = "configurationProtectedParameter",
        default,
        deserialize_with = "azure_core::util::deserialize_null_default",
        skip_serializing_if = "Vec::is_empty"
    )]
