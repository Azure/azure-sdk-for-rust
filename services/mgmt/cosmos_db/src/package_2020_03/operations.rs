...
pub mod sql_resources {
    ...
    pub async fn migrate_sql_database_to_autoscale(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                Err(migrate_sql_database_to_autoscale::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn migrate_sql_database_to_manual_throughput(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                Err(migrate_sql_database_to_manual_throughput::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn migrate_sql_container_to_autoscale(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                Err(migrate_sql_container_to_autoscale::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn migrate_sql_container_to_manual_throughput(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                Err(migrate_sql_container_to_manual_throughput::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
...
pub mod mongo_db_resources {
    ...
    pub async fn migrate_mongo_db_database_to_autoscale(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                Err(migrate_mongo_db_database_to_autoscale::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    ) -> std::result::Result<migrate_mongo_db_database_to_manual_throughput::Response, migrate_mongo_db_database_to_manual_throughput::Error>
    {
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                Err(migrate_mongo_db_database_to_manual_throughput::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn migrate_mongo_db_collection_to_autoscale(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                Err(migrate_mongo_db_collection_to_autoscale::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    > {
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                Err(migrate_mongo_db_collection_to_manual_throughput::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
...
pub mod table_resources {
    ...
    pub async fn migrate_table_to_autoscale(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                Err(migrate_table_to_autoscale::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn migrate_table_to_manual_throughput(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                Err(migrate_table_to_manual_throughput::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
...
pub mod cassandra_resources {
    ...
    pub async fn migrate_cassandra_keyspace_to_autoscale(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                Err(migrate_cassandra_keyspace_to_autoscale::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    > {
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                Err(migrate_cassandra_keyspace_to_manual_throughput::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn migrate_cassandra_table_to_autoscale(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                Err(migrate_cassandra_table_to_autoscale::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    ) -> std::result::Result<migrate_cassandra_table_to_manual_throughput::Response, migrate_cassandra_table_to_manual_throughput::Error>
    {
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                Err(migrate_cassandra_table_to_manual_throughput::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
...
pub mod gremlin_resources {
    ...
    pub async fn migrate_gremlin_database_to_autoscale(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                Err(migrate_gremlin_database_to_autoscale::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    ) -> std::result::Result<migrate_gremlin_database_to_manual_throughput::Response, migrate_gremlin_database_to_manual_throughput::Error>
    {
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                Err(migrate_gremlin_database_to_manual_throughput::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn migrate_gremlin_graph_to_autoscale(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                Err(migrate_gremlin_graph_to_autoscale::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn migrate_gremlin_graph_to_manual_throughput(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                Err(migrate_gremlin_graph_to_manual_throughput::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
