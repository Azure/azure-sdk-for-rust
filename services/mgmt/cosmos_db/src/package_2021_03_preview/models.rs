...
pub struct DatabaseAccountGetProperties {
    ...
    #[serde(rename = "networkAclBypass", skip_serializing_if = "Option::is_none")]
    pub network_acl_bypass: Option<NetworkAclBypass>,
    #[serde(rename = "networkAclBypassResourceIds", skip_serializing_if = "Vec::is_empty")]
...
pub struct ContainerPartitionKey {
    ...
    #[serde(rename = "systemKey", skip_serializing)]
...
pub struct LocationProperties {
    ...
    #[serde(rename = "supportsAvailabilityZone", skip_serializing)]
    pub supports_availability_zone: Option<bool>,
    #[serde(rename = "isResidencyRestricted", skip_serializing)]
    pub is_residency_restricted: Option<bool>,
    #[serde(rename = "backupStorageRedundancies", skip_serializing)]
...
pub mod cluster_resource {
    ...
    pub struct Properties {
        ...
        #[serde(rename = "restoreFromBackupId", skip_serializing_if = "Option::is_none")]
        pub restore_from_backup_id: Option<String>,
        #[serde(rename = "delegatedManagementSubnetId", skip_serializing_if = "Option::is_none")]
        pub delegated_management_subnet_id: Option<String>,
        #[serde(rename = "cassandraVersion", skip_serializing_if = "Option::is_none")]
        pub cassandra_version: Option<String>,
        #[serde(rename = "clusterNameOverride", skip_serializing_if = "Option::is_none")]
        ...
        #[serde(rename = "initialCassandraAdminPassword", skip_serializing_if = "Option::is_none")]
        pub initial_cassandra_admin_password: Option<String>,
        #[serde(rename = "hoursBetweenBackups", skip_serializing_if = "Option::is_none")]
        pub hours_between_backups: Option<i32>,
        #[serde(rename = "prometheusEndpoint", skip_serializing_if = "Option::is_none")]
        pub prometheus_endpoint: Option<SeedNode>,
        #[serde(rename = "repairEnabled", skip_serializing_if = "Option::is_none")]
        pub repair_enabled: Option<bool>,
        #[serde(rename = "clientCertificates", skip_serializing_if = "Vec::is_empty")]
        pub client_certificates: Vec<Certificate>,
        #[serde(rename = "externalGossipCertificates", skip_serializing_if = "Vec::is_empty")]
        pub external_gossip_certificates: Vec<Certificate>,
        #[serde(rename = "gossipCertificates", skip_serializing)]
        pub gossip_certificates: Vec<Certificate>,
        #[serde(rename = "externalSeedNodes", skip_serializing_if = "Vec::is_empty")]
        pub external_seed_nodes: Vec<SeedNode>,
        #[serde(rename = "seedNodes", skip_serializing)]
...
pub mod data_center_resource {
    ...
    pub struct Properties {
        #[serde(rename = "provisioningState", skip_serializing_if = "Option::is_none")]
        pub provisioning_state: Option<ManagedCassandraProvisioningState>,
        #[serde(rename = "dataCenterLocation", skip_serializing_if = "Option::is_none")]
        pub data_center_location: Option<String>,
        #[serde(rename = "delegatedSubnetId", skip_serializing_if = "Option::is_none")]
        pub delegated_subnet_id: Option<String>,
        #[serde(rename = "nodeCount", skip_serializing_if = "Option::is_none")]
        pub node_count: Option<i32>,
        #[serde(rename = "seedNodes", skip_serializing)]
        pub seed_nodes: Vec<SeedNode>,
        #[serde(rename = "base64EncodedCassandraYamlFragment", skip_serializing_if = "Option::is_none")]
