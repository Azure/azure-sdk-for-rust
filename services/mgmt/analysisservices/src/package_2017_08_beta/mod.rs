...
pub mod servers {
    ...
    impl Client {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: A unique identifier for a Microsoft Azure subscription. The subscription ID forms part of the URI for every service call."]
        pub fn list_skus_for_new(&self, subscription_id: impl Into<String>) -> list_skus_for_new::RequestBuilder {
            list_skus_for_new::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
            }
        }
        ...
        pub fn list_skus_for_existing(
            ...
            server_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ) -> list_skus_for_existing::RequestBuilder {
            list_skus_for_existing::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                server_name: server_name.into(),
        ...
        pub fn list_gateway_status(
            ...
            server_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ) -> list_gateway_status::RequestBuilder {
            list_gateway_status::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                server_name: server_name.into(),
        ...
        pub fn dissociate_gateway(
            ...
            server_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ) -> dissociate_gateway::RequestBuilder {
            dissociate_gateway::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                server_name: server_name.into(),
        ...
        pub fn list_operation_results(
            ...
            subscription_id: impl Into<String>,
        ) -> list_operation_results::RequestBuilder {
            list_operation_results::RequestBuilder {
                client: self.0.clone(),
                location: location.into(),
        ...
        pub fn list_operation_statuses(
            ...
            operation_id: impl Into<String>,
            subscription_id: impl Into<String>,
        ) -> list_operation_statuses::RequestBuilder {
            list_operation_statuses::RequestBuilder {
                client: self.0.clone(),
                location: location.into(),
                operation_id: operation_id.into(),
    ...
    pub mod get_details {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AnalysisServicesServer> {
                ...
                let body: models::AnalysisServicesServer = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2017-08-01-beta");
                }
                Ok(url)
            }
        }
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AnalysisServicesServer>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::AnalysisServicesServer>>;
    ...
    pub mod list_by_resource_group {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AnalysisServicesServers> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AnalysisServicesServers = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
    ...
    pub mod list_gateway_status {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::GatewayListStatusLive> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::GatewayListStatusLive = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::GatewayListStatusLive>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::GatewayListStatusLive>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod check_name_availability {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CheckServerNameAvailabilityResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CheckServerNameAvailabilityResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::CheckServerNameAvailabilityResult>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::CheckServerNameAvailabilityResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod operations {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.AnalysisServices/operations",));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2017-08-01-beta");
