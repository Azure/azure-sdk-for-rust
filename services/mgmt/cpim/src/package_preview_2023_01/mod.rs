...
pub mod b2c_tenants {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            .query_pairs_mut()
                            .append_pair(azure_core::query_param::API_VERSION, "2023-01-18-preview");
    ...
    pub mod list_by_resource_group {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::B2cTenantResourceList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::B2cTenantResourceList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::B2cTenantResource> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::B2cTenantResource = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::B2cTenantResource>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::B2cTenantResource>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod delete {
        ...
        pub struct Headers<'a>(&'a azure_core::headers::Headers);
        impl<'a> Headers<'a> {
            #[doc = "Contains the URL/location which can return the deletion status."]
            pub fn location(&self) -> azure_core::Result<&str> {
                self.0.get_str(&azure_core::headers::HeaderName::from_static("location"))
            }
            #[doc = "Contains the number of seconds to wait before checking the deletion status."]
            pub fn retry_after(&self) -> azure_core::Result<&str> {
                self.0.get_str(&azure_core::headers::HeaderName::from_static("retry-after"))
            }
        }
    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::GuestUsagesResource> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::GuestUsagesResource = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::GuestUsagesResource>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::GuestUsagesResource>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_by_subscription {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::GuestUsagesResourceList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::GuestUsagesResourceList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
