...
pub struct B2cTenantResourceProperties {
    ...
    #[doc = "Enable GoLocal add-on to store data at rest in the specific Geo. Refer to [aka.ms/B2CDataResidency](https://aka.ms/B2CDataResidency) to see local data residency options."]
    #[serde(rename = "isGoLocalTenant", default, skip_serializing_if = "Option::is_none")]
    pub is_go_local_tenant: Option<GoLocal>,
}
