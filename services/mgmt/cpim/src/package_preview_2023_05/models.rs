...
#[doc = "SKU properties of the Azure AD for customers tenant. Learn more about Azure AD for customers billing at [https://aka.ms/ciambilling](https://aka.ms/ciambilling)."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CiamResourceSku {
    #[doc = "The name of the SKU for the tenant."]
    pub name: ciam_resource_sku::Name,
    #[doc = "The tier of the tenant."]
    pub tier: ciam_resource_sku::Tier,
}
impl CiamResourceSku {
    pub fn new(name: ciam_resource_sku::Name, tier: ciam_resource_sku::Tier) -> Self {
        Self { name, tier }
    }
}
pub mod ciam_resource_sku {
    use super::*;
    #[doc = "The name of the SKU for the tenant."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Name")]
...
#[doc = "The Azure AD for customers resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CiamTenantResource {
    #[doc = "An identifier that represents the Azure AD for customers tenant resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "The name of the Azure AD for customers tenant resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "The type of the Azure AD for customers tenant resource."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<ciam_tenant_resource::Type>,
    #[doc = "The location in which the resource is hosted and data resides. Can be one of 'United States', 'Europe', 'Asia Pacific', or 'Australia'. Refer to [this documentation](https://aka.ms/ciam-data-location) for more information."]
    pub location: String,
    #[doc = "SKU properties of the Azure AD for customers tenant. Learn more about Azure AD for customers billing at [https://aka.ms/ciambilling](https://aka.ms/ciambilling)."]
    pub sku: CiamResourceSku,
    #[doc = "Properties of the Azure AD for customers tenant Azure resource."]
    pub properties: CiamTenantResourceProperties,
    #[doc = "Resource Tags"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<serde_json::Value>,
    #[doc = "Metadata pertaining to creation and last modification of the resource."]
...
impl CiamTenantResource {
    pub fn new(location: String, sku: CiamResourceSku, properties: CiamTenantResourceProperties) -> Self {
        Self {
            id: None,
            name: None,
            type_: None,
...
pub mod ciam_tenant_resource {
    use super::*;
    #[doc = "The type of the Azure AD for customers tenant resource."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Type")]
    pub enum Type {
        #[serde(rename = "Microsoft.AzureActiveDirectory/ciamDirectories")]
        MicrosoftAzureActiveDirectoryCiamDirectories,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for Type {
    ...
    impl Serialize for Type {
        ...
        {
            match self {
                Self::MicrosoftAzureActiveDirectoryCiamDirectories => {
                    serializer.serialize_unit_variant("Type", 0u32, "Microsoft.AzureActiveDirectory/ciamDirectories")
                }
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
...
#[doc = "The collection of Azure AD for customers tenant resources"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CiamTenantResourceList {
    #[doc = "List of Azure AD for customers tenant resources"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<CiamTenantResource>,
    #[doc = "The URL to get the next set of Azure AD for customers tenant resources."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for CiamTenantResourceList {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl CiamTenantResourceList {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Properties of the Azure AD for customers tenant Azure resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CiamTenantResourceProperties {
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<ProvisioningState>,
    #[doc = "These properties are used to create the Azure AD for customers tenant. These properties are not part of the Azure resource."]
    #[serde(rename = "createTenantProperties")]
    pub create_tenant_properties: CreateCiamTenantProperties,
    #[doc = "The domain name of the tenant"]
    #[serde(rename = "domainName", default, skip_serializing_if = "Option::is_none")]
    pub domain_name: Option<String>,
    #[doc = "The billing configuration for the tenant."]
    #[serde(rename = "billingConfig", default, skip_serializing_if = "Option::is_none")]
    pub billing_config: Option<ciam_tenant_resource_properties::BillingConfig>,
    #[doc = "An identifier of the Azure AD for customers tenant."]
    #[serde(rename = "tenantId", default, skip_serializing_if = "Option::is_none")]
    pub tenant_id: Option<String>,
}
impl CiamTenantResourceProperties {
    pub fn new(create_tenant_properties: CreateCiamTenantProperties) -> Self {
        Self {
...
pub mod ciam_tenant_resource_properties {
    use super::*;
    #[doc = "The billing configuration for the tenant."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
    pub struct BillingConfig {
        #[doc = "The type of billing. Will be MAU for all new customers. Cannot be changed if value is 'MAU'. Learn more about Azure AD for customers billing at [aka.ms/b2cBilling](https://aka.ms/b2cbilling)."]
        #[serde(rename = "billingType", default, skip_serializing_if = "Option::is_none")]
        pub billing_type: Option<billing_config::BillingType>,
        #[doc = "The data from which the billing type took effect"]
        #[serde(rename = "effectiveStartDateUtc", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "The request body to update the Azure AD for customers tenant resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CiamTenantUpdateRequest {
    #[doc = "SKU properties of the Azure AD for customers tenant. Learn more about Azure AD for customers billing at [https://aka.ms/ciambilling](https://aka.ms/ciambilling)."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sku: Option<CiamResourceSku>,
    #[doc = "Resource Tags"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<serde_json::Value>,
}
impl CiamTenantUpdateRequest {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The information required to check the availability of the sub domain name for the tenant."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CheckNameAvailabilityRequestBody {
    #[doc = "The sub domain name to check for availability."]
    pub name: String,
...
#[doc = "These properties are used to create the Azure AD for customers tenant. These properties are not part of the Azure resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CreateCiamTenantProperties {
    #[doc = "The display name of the Azure AD for customers tenant."]
    #[serde(rename = "displayName")]
    pub display_name: String,
    #[doc = "Country code of Azure tenant (e.g. 'US'). Refer to [https://aka.ms/ciam-data-location](https://aka.ms/ciam-data-location) to see valid country codes and corresponding data residency locations. If you do not see a country code in an valid data residency location, choose one from the list."]
    #[serde(rename = "countryCode")]
    pub country_code: String,
}
impl CreateCiamTenantProperties {
    pub fn new(display_name: String, country_code: String) -> Self {
        Self {
            display_name,
            country_code,
        }
...
pub struct GuestUsagesResourceList {
    ...
    #[doc = "The URL to get the next set of Guest Usages resources."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
