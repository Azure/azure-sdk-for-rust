...
pub struct FileSystemResourceListResult {
    ...
    pub value: Vec<LiftrBaseStorageFileSystemResource>,
...
impl FileSystemResourceListResult {
    pub fn new(value: Vec<LiftrBaseStorageFileSystemResource>) -> Self {
...
pub struct LiftrBaseMarketplaceDetails {
    ...
    pub marketplace_subscription_status: Option<LiftrBaseMarketplaceSubscriptionStatus>,
}
impl LiftrBaseMarketplaceDetails {
    pub fn new(plan_id: String, offer_id: String) -> Self {
        Self {
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "LiftrBaseProvisioningState")]
pub enum LiftrBaseProvisioningState {
    Accepted,
    Creating,
    Updating,
    Deleting,
...
impl FromStr for LiftrBaseProvisioningState {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for LiftrBaseProvisioningState {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for LiftrBaseProvisioningState {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Accepted => serializer.serialize_unit_variant("LiftrBaseProvisioningState", 0u32, "Accepted"),
            Self::Creating => serializer.serialize_unit_variant("LiftrBaseProvisioningState", 1u32, "Creating"),
            Self::Updating => serializer.serialize_unit_variant("LiftrBaseProvisioningState", 2u32, "Updating"),
            Self::Deleting => serializer.serialize_unit_variant("LiftrBaseProvisioningState", 3u32, "Deleting"),
            Self::Succeeded => serializer.serialize_unit_variant("LiftrBaseProvisioningState", 4u32, "Succeeded"),
            Self::Failed => serializer.serialize_unit_variant("LiftrBaseProvisioningState", 5u32, "Failed"),
            Self::Canceled => serializer.serialize_unit_variant("LiftrBaseProvisioningState", 6u32, "Canceled"),
            Self::Deleted => serializer.serialize_unit_variant("LiftrBaseProvisioningState", 7u32, "Deleted"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct LiftrBaseStorageFileSystemResource {
    #[serde(flatten)]
    pub tracked_resource: TrackedResource,
    #[doc = "Properties specific to the Qumulo File System resource"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<LiftrBaseStorageFileSystemResourceProperties>,
    #[doc = "Managed service identity (system assigned and/or user assigned identities)"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub identity: Option<ManagedServiceIdentity>,
}
impl LiftrBaseStorageFileSystemResource {
...
#[doc = "Properties specific to the Qumulo File System resource"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct LiftrBaseStorageFileSystemResourceProperties {
    #[doc = "MarketplaceDetails of Qumulo FileSystem resource"]
    #[serde(rename = "marketplaceDetails")]
    pub marketplace_details: LiftrBaseMarketplaceDetails,
    #[doc = "Provisioning State of the File system resource"]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<LiftrBaseProvisioningState>,
    #[doc = "Storage Sku"]
    #[serde(rename = "storageSku")]
    pub storage_sku: String,
    #[doc = "User Details of Qumulo FileSystem resource"]
    #[serde(rename = "userDetails")]
    pub user_details: LiftrBaseUserDetails,
...
impl LiftrBaseStorageFileSystemResourceProperties {
    pub fn new(
        marketplace_details: LiftrBaseMarketplaceDetails,
        storage_sku: String,
        user_details: LiftrBaseUserDetails,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct LiftrBaseStorageFileSystemResourceUpdate {
    #[doc = "Managed service identity (system assigned and/or user assigned identities)"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub identity: Option<ManagedServiceIdentity>,
    #[doc = "Resource tags."]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<LiftrBaseStorageFileSystemResourceUpdateProperties>,
}
impl LiftrBaseStorageFileSystemResourceUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
