                        ...
                        let rsp = match continuation {
                            Some(value) => {
                                ...
                                if !has_api_version_already {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair(azure_core::query_param::API_VERSION, "2024-06-19");
                                }
...
pub mod file_systems {
    ...
    impl Client {
        ...
        pub fn create_or_update(
            ...
            resource_group_name: impl Into<String>,
            file_system_name: impl Into<String>,
            resource: impl Into<models::LiftrBaseStorageFileSystemResource>,
        ...
        pub fn update(
            ...
            resource_group_name: impl Into<String>,
            file_system_name: impl Into<String>,
            properties: impl Into<models::LiftrBaseStorageFileSystemResourceUpdate>,
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::LiftrBaseStorageFileSystemResource> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::LiftrBaseStorageFileSystemResource = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::LiftrBaseStorageFileSystemResource>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::LiftrBaseStorageFileSystemResource>>;
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) file_system_name: String,
            pub(crate) resource: models::LiftrBaseStorageFileSystemResource,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) file_system_name: String,
            pub(crate) properties: models::LiftrBaseStorageFileSystemResourceUpdate,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
