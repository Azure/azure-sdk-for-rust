...
pub struct FileSystemResource {
    ...
    pub properties: FileSystemResourceProperties,
    #[doc = "Name of the File System resource"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl FileSystemResource {
    pub fn new(tracked_resource: TrackedResource, properties: FileSystemResourceProperties) -> Self {
        Self {
            tracked_resource,
            properties,
            name: None,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct FileSystemResourceListResult {
    #[doc = "The FileSystemResource items on this page"]
    pub value: Vec<FileSystemResource>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for FileSystemResourceListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl FileSystemResourceListResult {
    pub fn new(value: Vec<FileSystemResource>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Properties specific to the Qumulo File System resource"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct FileSystemResourceProperties {
    ...
    #[doc = "Provisioning State of the File system resource"]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<ProvisioningState>,
    #[doc = "Storage Sku"]
    #[serde(rename = "storageSku")]
    pub storage_sku: StorageSku,
    #[doc = "User Details of Qumulo FileSystem resource"]
    #[serde(rename = "userDetails")]
    pub user_details: UserDetails,
    #[doc = "Delegated subnet id for Vnet injection"]
    #[serde(rename = "delegatedSubnetId")]
    pub delegated_subnet_id: String,
    #[doc = "File system Id of the resource"]
    #[serde(rename = "clusterLoginUrl", default, skip_serializing_if = "Option::is_none")]
    pub cluster_login_url: Option<String>,
...
impl FileSystemResourceProperties {
    pub fn new(
        ...
        Self {
            ...
            user_details,
            delegated_subnet_id,
            cluster_login_url: None,
            private_i_ps: Vec::new(),
            admin_password,
            initial_capacity,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct FileSystemResourceUpdate {
    #[doc = "Managed service identity (system assigned and/or user assigned identities)"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub identity: Option<ManagedServiceIdentity>,
    #[doc = "Resource tags."]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<FileSystemResourceUpdateProperties>,
}
impl FileSystemResourceUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The updatable properties of the FileSystemResource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct FileSystemResourceUpdateProperties {
    #[doc = "MarketplaceDetails of Qumulo FileSystem resource"]
...
impl FileSystemResourceUpdateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct MarketplaceDetails {
    ...
    #[doc = "Marketplace subscription status of the file system resource"]
...
impl MarketplaceDetails {
    pub fn new(plan_id: String, offer_id: String, publisher_id: String) -> Self {
        Self {
