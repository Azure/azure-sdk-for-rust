...
pub struct CompanyDetails {
    ...
    #[doc = "Country or region of operation"]
...
impl FileSystemResourceProperties {
    pub fn new(marketplace_details: MarketplaceDetails, user_details: UserDetails, delegated_subnet_id: String) -> Self {
        Self {
            marketplace_details,
...
pub struct MarketplaceDetails {
    ...
    #[serde(rename = "marketplaceSubscriptionStatus", with = "azure_core::xml::text_content")]
    pub marketplace_subscription_status: MarketplaceSubscriptionStatus,
}
...
pub struct UserDetails {
    ...
    #[serde(rename = "alternateEmail", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "contactPhoneNumber", default, skip_serializing_if = "Option::is_none")]
