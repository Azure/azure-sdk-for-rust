...
pub struct CloudEndpointChangeEnumerationActivity {
    ...
    #[serde(rename = "startedTimestamp", default, skip_serializing_if = "Option::is_none")]
...
pub struct CloudEndpointLastChangeEnumerationStatus {
    ...
    #[serde(rename = "completedTimestamp", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "nextRunTimestamp", default, skip_serializing_if = "Option::is_none")]
    pub next_run_timestamp: Option<String>,
}
...
pub struct WorkflowProperties {
    ...
    #[serde(rename = "lastStatusTimestamp", default, skip_serializing_if = "Option::is_none")]
