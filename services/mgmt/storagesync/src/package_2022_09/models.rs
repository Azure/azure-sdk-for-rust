...
impl Default for InitialDownloadPolicy {
    fn default() -> Self {
        Self::NamespaceThenModifiedFiles
    }
}
...
impl Default for InitialUploadPolicy {
    fn default() -> Self {
        Self::Merge
    }
}
...
impl Default for LocalCacheMode {
    fn default() -> Self {
        Self::UpdateLocallyCachedFiles
    }
}
...
pub struct OperationResourceMetricSpecification {
    ...
    #[doc = "Lock Aggregation type for the metric."]
...
pub struct PreRestoreRequest {
    ...
    pub pause_wait_for_sync_drain_time_period_in_seconds: Option<i32>,
}
...
pub struct RegisteredServerCreateParametersProperties {
    ...
    #[serde(rename = "friendlyName", default, skip_serializing_if = "Option::is_none")]
    pub friendly_name: Option<String>,
    #[doc = "Server ServicePrincipal Id"]
    #[serde(rename = "applicationId", default, skip_serializing_if = "Option::is_none")]
    pub application_id: Option<String>,
    #[doc = "Apply server with newly discovered ApplicationId if available."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct RegisteredServerProperties {
    ...
    pub server_management_error_code: Option<i32>,
    #[doc = "Registered Server last heart beat"]
    #[serde(rename = "lastHeartBeat", default, skip_serializing_if = "Option::is_none")]
    pub last_heart_beat: Option<String>,
    ...
    #[doc = "Server Application Id"]
    #[serde(rename = "applicationId", default, skip_serializing_if = "Option::is_none")]
    pub application_id: Option<String>,
    #[doc = "Apply server with newly discovered ApplicationId if available."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub identity: Option<bool>,
    #[doc = "Latest Server Application Id discovered from the server. It is not yet applied."]
    #[serde(rename = "latestApplicationId", default, skip_serializing_if = "Option::is_none")]
    pub latest_application_id: Option<String>,
    #[doc = "Type of the Server Auth type"]
    #[serde(rename = "activeAuthType", default, skip_serializing_if = "Option::is_none")]
    pub active_auth_type: Option<ServerAuthType>,
}
...
#[doc = "The parameters used when updating a registered server."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RegisteredServerUpdateParameters {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "RegisteredServer Update Properties object."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<RegisteredServerUpdateProperties>,
}
impl RegisteredServerUpdateParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "RegisteredServer Update Properties object."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RegisteredServerUpdateProperties {
    #[doc = "Apply server with newly discovered ApplicationId if available."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub identity: Option<bool>,
}
impl RegisteredServerUpdateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl FromStr for ServerAuthType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for ServerAuthType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for ServerAuthType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Certificate => serializer.serialize_unit_variant("ServerAuthType", 0u32, "Certificate"),
            Self::ManagedIdentity => serializer.serialize_unit_variant("ServerAuthType", 1u32, "ManagedIdentity"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct ServerEndpointProperties {
    ...
    #[serde(rename = "serverName", default, skip_serializing_if = "Option::is_none")]
    pub server_name: Option<String>,
    #[doc = "Server endpoint provisioning status information"]
    #[serde(rename = "serverEndpointProvisioningStatus", default, skip_serializing_if = "Option::is_none")]
    pub server_endpoint_provisioning_status: Option<ServerEndpointProvisioningStatus>,
}
...
#[doc = "Server endpoint provisioning status information"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ServerEndpointProvisioningStatus {
    #[doc = "Server provisioning status"]
    #[serde(rename = "provisioningStatus", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_status: Option<ServerProvisioningStatus>,
    #[doc = "Server Endpoint provisioning type"]
    #[serde(rename = "provisioningType", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_type: Option<String>,
    #[doc = "Provisioning Step status information for each step in the provisioning process"]
    #[serde(
        rename = "provisioningStepStatuses",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub provisioning_step_statuses: Vec<ServerEndpointProvisioningStepStatus>,
}
impl ServerEndpointProvisioningStatus {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Server endpoint provisioning step status object."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ServerEndpointProvisioningStepStatus {
    #[doc = "Name of the provisioning step"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Status of the provisioning step"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[doc = "Start time of the provisioning step"]
    #[serde(rename = "startTime", default, with = "azure_core::date::rfc3339::option")]
    pub start_time: Option<time::OffsetDateTime>,
    #[doc = "Estimated completion time of the provisioning step in minutes"]
    #[serde(rename = "minutesLeft", default, skip_serializing_if = "Option::is_none")]
    pub minutes_left: Option<i32>,
    #[doc = "Estimated progress percentage"]
    #[serde(rename = "progressPercentage", default, skip_serializing_if = "Option::is_none")]
    pub progress_percentage: Option<i32>,
    #[doc = "End time of the provisioning step"]
    #[serde(rename = "endTime", default, with = "azure_core::date::rfc3339::option")]
    pub end_time: Option<time::OffsetDateTime>,
    #[doc = "Error code (HResult) for the provisioning step"]
    #[serde(rename = "errorCode", default, skip_serializing_if = "Option::is_none")]
    pub error_code: Option<i32>,
    #[doc = "Additional information for the provisioning step"]
...
impl ServerEndpointProvisioningStepStatus {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Server provisioning status"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ServerProvisioningStatus")]
pub enum ServerProvisioningStatus {
    NotStarted,
    InProgress,
    #[serde(rename = "Ready_SyncNotFunctional")]
    ReadySyncNotFunctional,
    #[serde(rename = "Ready_SyncFunctional")]
    ReadySyncFunctional,
    Error,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for ServerProvisioningStatus {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for ServerProvisioningStatus {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for ServerProvisioningStatus {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::NotStarted => serializer.serialize_unit_variant("ServerProvisioningStatus", 0u32, "NotStarted"),
            Self::InProgress => serializer.serialize_unit_variant("ServerProvisioningStatus", 1u32, "InProgress"),
            Self::ReadySyncNotFunctional => serializer.serialize_unit_variant("ServerProvisioningStatus", 2u32, "Ready_SyncNotFunctional"),
            Self::ReadySyncFunctional => serializer.serialize_unit_variant("ServerProvisioningStatus", 3u32, "Ready_SyncFunctional"),
            Self::Error => serializer.serialize_unit_variant("ServerProvisioningStatus", 4u32, "Error"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct StorageSyncServiceCreateParametersProperties {
    ...
    #[doc = "Use Identity authorization when customer have finished setup RBAC permissions."]
    #[serde(rename = "useIdentity", default, skip_serializing_if = "Option::is_none")]
    pub use_identity: Option<bool>,
}
...
pub struct StorageSyncServiceProperties {
    ...
    pub storage_sync_service_status: Option<i32>,
