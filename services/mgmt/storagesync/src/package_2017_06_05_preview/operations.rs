...
pub mod storage_sync_services {
    ...
    pub async fn create(
        ...
        resource_group_name: &str,
        storage_sync_service_name: &str,
        parameters: &models::StorageSyncService,
    ...
    pub async fn update(
        ...
        resource_group_name: &str,
        storage_sync_service_name: &str,
        parameters: Option<&models::StorageSyncService>,
...
pub mod cloud_endpoints {
    ...
    pub async fn create(
        ...
        sync_group_name: &str,
        cloud_endpoint_name: &str,
        parameters: &models::CloudEndpoint,
    ...
    pub async fn restore_heatbeat(
        ...
        let mut url = url::Url::parse(url_str).map_err(restore_heatbeat::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::POST);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(restore_heatbeat::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        ...
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder.body(req_body).map_err(restore_heatbeat::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(restore_heatbeat::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => Ok(()),
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::StorageSyncError = serde_json::from_slice(rsp_body)
                    .map_err(|source| restore_heatbeat::Error::DeserializeError(source, rsp_body.clone()))?;
...
pub mod server_endpoints {
    ...
    pub async fn create(
        ...
        sync_group_name: &str,
        server_endpoint_name: &str,
        parameters: &models::ServerEndpoint,
    ) -> std::result::Result<create::Response, create::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.StorageSync/storageSyncServices/{}/syncGroups/{}/serverEndpoints/{}",
    ...
    pub async fn update(
        ...
        sync_group_name: &str,
        server_endpoint_name: &str,
        parameters: Option<&models::ServerEndpoint>,
    ...
    pub async fn recall(
        ...
        let mut url = url::Url::parse(url_str).map_err(recall::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::POST);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(recall::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        req_builder = req_builder.header(http::header::CONTENT_LENGTH, 0);
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder.body(req_body).map_err(recall::Error::BuildRequestError)?;
        let rsp = http_client.execute_request(req).await.map_err(recall::Error::ExecuteRequestError)?;
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::StorageSyncError =
                    serde_json::from_slice(rsp_body).map_err(|source| recall::Error::DeserializeError(source, rsp_body.clone()))?;
...
pub mod registered_servers {
    ...
    pub async fn create(
        ...
        storage_sync_service_name: &str,
        server_id: &str,
        parameters: &models::RegisteredServer,
    ) -> std::result::Result<create::Response, create::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.StorageSync/storageSyncServices/{}/registeredServers/{}",
