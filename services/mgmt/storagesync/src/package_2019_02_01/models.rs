...
pub struct ServerEndpointSyncStatus {
    ...
    #[doc = "Total count of persistent files not syncing (combined upload + download). Reserved for future use."]
...
pub struct SyncSessionStatus {
    ...
    #[doc = "Count of persistent files not syncing. Reserved for future use."]
    ...
    #[doc = "Count of transient files not syncing. Reserved for future use."]
    ...
    #[doc = "Array of per-item errors coming from the last sync session. Reserved for future use."]
