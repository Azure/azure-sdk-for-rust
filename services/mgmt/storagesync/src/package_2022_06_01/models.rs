...
#[doc = "Cloud endpoint AFS file share metadata signing certificate public keys."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CloudEndpointAfsShareMetadataCertificatePublicKeys {
    #[doc = "The first public key."]
    #[serde(rename = "firstKey", default, skip_serializing_if = "Option::is_none")]
    pub first_key: Option<String>,
    #[doc = "The second public key."]
    #[serde(rename = "secondKey", default, skip_serializing_if = "Option::is_none")]
    pub second_key: Option<String>,
}
impl CloudEndpointAfsShareMetadataCertificatePublicKeys {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Cloud endpoint change enumeration activity object"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CloudEndpointChangeEnumerationActivity {
    ...
    #[doc = "State of change enumeration activity"]
    #[serde(rename = "operationState", default, skip_serializing_if = "Option::is_none")]
    pub operation_state: Option<CloudEndpointChangeEnumerationActivityState>,
    #[doc = "When non-zero, indicates an issue that is delaying change enumeration"]
    #[serde(rename = "statusCode", default, skip_serializing_if = "Option::is_none")]
    pub status_code: Option<i32>,
    #[doc = "Timestamp when change enumeration started"]
    #[serde(rename = "startedTimestamp", default, with = "azure_core::date::rfc3339::option")]
    pub started_timestamp: Option<time::OffsetDateTime>,
    #[doc = "Count of files processed"]
    #[serde(rename = "processedFilesCount", default, skip_serializing_if = "Option::is_none")]
    pub processed_files_count: Option<i64>,
    #[doc = "Count of directories processed"]
    #[serde(rename = "processedDirectoriesCount", default, skip_serializing_if = "Option::is_none")]
    pub processed_directories_count: Option<i64>,
    #[doc = "Total count of files enumerated"]
    #[serde(rename = "totalFilesCount", default, skip_serializing_if = "Option::is_none")]
    pub total_files_count: Option<i64>,
    #[doc = "Total count of directories enumerated"]
    #[serde(rename = "totalDirectoriesCount", default, skip_serializing_if = "Option::is_none")]
    pub total_directories_count: Option<i64>,
    #[doc = "Total enumerated size in bytes"]
    #[serde(rename = "totalSizeBytes", default, skip_serializing_if = "Option::is_none")]
    pub total_size_bytes: Option<i64>,
    #[doc = "Progress percentage for change enumeration run, excluding processing of deletes"]
    #[serde(rename = "progressPercent", default, skip_serializing_if = "Option::is_none")]
    pub progress_percent: Option<i32>,
    #[doc = "Estimate of time remaining for the enumeration run"]
    #[serde(rename = "minutesRemaining", default, skip_serializing_if = "Option::is_none")]
    pub minutes_remaining: Option<i32>,
    #[doc = "State of the total counts of change enumeration activity"]
    #[serde(rename = "totalCountsState", default, skip_serializing_if = "Option::is_none")]
    pub total_counts_state: Option<CloudEndpointChangeEnumerationTotalCountsState>,
    #[doc = "Progress percentage for processing deletes. This is done separately from the rest of the enumeration run"]
    #[serde(rename = "deletesProgressPercent", default, skip_serializing_if = "Option::is_none")]
    pub deletes_progress_percent: Option<i32>,
}
impl CloudEndpointChangeEnumerationActivity {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "State of change enumeration activity"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "CloudEndpointChangeEnumerationActivityState")]
pub enum CloudEndpointChangeEnumerationActivityState {
    InitialEnumerationInProgress,
    EnumerationInProgress,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for CloudEndpointChangeEnumerationActivityState {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for CloudEndpointChangeEnumerationActivityState {
...
impl Serialize for CloudEndpointChangeEnumerationActivityState {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::InitialEnumerationInProgress => {
                serializer.serialize_unit_variant("CloudEndpointChangeEnumerationActivityState", 0u32, "InitialEnumerationInProgress")
            }
            Self::EnumerationInProgress => {
                serializer.serialize_unit_variant("CloudEndpointChangeEnumerationActivityState", 1u32, "EnumerationInProgress")
            }
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "Cloud endpoint change enumeration status object"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CloudEndpointChangeEnumerationStatus {
    #[doc = "Last updated timestamp"]
    #[serde(rename = "lastUpdatedTimestamp", default, with = "azure_core::date::rfc3339::option")]
    pub last_updated_timestamp: Option<time::OffsetDateTime>,
    #[doc = "Cloud endpoint change enumeration status object"]
    #[serde(rename = "lastEnumerationStatus", default, skip_serializing_if = "Option::is_none")]
    pub last_enumeration_status: Option<CloudEndpointLastChangeEnumerationStatus>,
    #[doc = "Cloud endpoint change enumeration activity object"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub activity: Option<CloudEndpointChangeEnumerationActivity>,
}
impl CloudEndpointChangeEnumerationStatus {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "State of the total counts of change enumeration activity"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "CloudEndpointChangeEnumerationTotalCountsState")]
pub enum CloudEndpointChangeEnumerationTotalCountsState {
    Calculating,
    Final,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for CloudEndpointChangeEnumerationTotalCountsState {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for CloudEndpointChangeEnumerationTotalCountsState {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for CloudEndpointChangeEnumerationTotalCountsState {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Calculating => serializer.serialize_unit_variant("CloudEndpointChangeEnumerationTotalCountsState", 0u32, "Calculating"),
            Self::Final => serializer.serialize_unit_variant("CloudEndpointChangeEnumerationTotalCountsState", 1u32, "Final"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "Cloud endpoint change enumeration status object"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CloudEndpointLastChangeEnumerationStatus {
    #[doc = "Timestamp when change enumeration started"]
    #[serde(rename = "startedTimestamp", default, with = "azure_core::date::rfc3339::option")]
    pub started_timestamp: Option<time::OffsetDateTime>,
    #[doc = "Timestamp when change enumeration completed"]
    #[serde(rename = "completedTimestamp", default, with = "azure_core::date::rfc3339::option")]
    pub completed_timestamp: Option<time::OffsetDateTime>,
    #[doc = "Count of files in the namespace"]
    #[serde(rename = "namespaceFilesCount", default, skip_serializing_if = "Option::is_none")]
    pub namespace_files_count: Option<i64>,
    #[doc = "Count of directories in the namespace"]
    #[serde(rename = "namespaceDirectoriesCount", default, skip_serializing_if = "Option::is_none")]
    pub namespace_directories_count: Option<i64>,
    #[doc = "Namespace size in bytes"]
    #[serde(rename = "namespaceSizeBytes", default, skip_serializing_if = "Option::is_none")]
    pub namespace_size_bytes: Option<i64>,
    #[doc = "Timestamp of when change enumeration is expected to run again"]
    #[serde(rename = "nextRunTimestamp", default, with = "azure_core::date::rfc3339::option")]
    pub next_run_timestamp: Option<time::OffsetDateTime>,
}
impl CloudEndpointLastChangeEnumerationStatus {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct CloudEndpointProperties {
    ...
    #[doc = "Cloud endpoint change enumeration status object"]
    #[serde(rename = "changeEnumerationStatus", default, skip_serializing_if = "Option::is_none")]
    pub change_enumeration_status: Option<CloudEndpointChangeEnumerationStatus>,
}
...
#[doc = "Information regarding the low disk mode state"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CloudTieringLowDiskMode {
    #[doc = "Last updated timestamp"]
    #[serde(rename = "lastUpdatedTimestamp", default, with = "azure_core::date::rfc3339::option")]
    pub last_updated_timestamp: Option<time::OffsetDateTime>,
    #[doc = "Type of the cloud tiering low disk mode state"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<CloudTieringLowDiskModeState>,
}
impl CloudTieringLowDiskMode {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Type of the cloud tiering low disk mode state"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "CloudTieringLowDiskModeState")]
pub enum CloudTieringLowDiskModeState {
    Enabled,
    Disabled,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for CloudTieringLowDiskModeState {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for CloudTieringLowDiskModeState {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for CloudTieringLowDiskModeState {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Enabled => serializer.serialize_unit_variant("CloudTieringLowDiskModeState", 0u32, "Enabled"),
            Self::Disabled => serializer.serialize_unit_variant("CloudTieringLowDiskModeState", 1u32, "Disabled"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "Policy for how the initial upload sync session is performed."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "InitialUploadPolicy")]
pub enum InitialUploadPolicy {
    ServerAuthoritative,
    Merge,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for InitialUploadPolicy {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for InitialUploadPolicy {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for InitialUploadPolicy {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::ServerAuthoritative => serializer.serialize_unit_variant("InitialUploadPolicy", 0u32, "ServerAuthoritative"),
            Self::Merge => serializer.serialize_unit_variant("InitialUploadPolicy", 1u32, "Merge"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "Background data download activity object"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ServerEndpointBackgroundDataDownloadActivity {
    #[doc = "Timestamp when properties were updated"]
    #[serde(default, with = "azure_core::date::rfc3339::option")]
    pub timestamp: Option<time::OffsetDateTime>,
    #[doc = "Timestamp when the operation started"]
    #[serde(rename = "startedTimestamp", default, with = "azure_core::date::rfc3339::option")]
    pub started_timestamp: Option<time::OffsetDateTime>,
    #[doc = "Progress percentage"]
    #[serde(rename = "percentProgress", default, skip_serializing_if = "Option::is_none")]
    pub percent_progress: Option<i32>,
    #[doc = "Running count of bytes downloaded"]
    #[serde(rename = "downloadedBytes", default, skip_serializing_if = "Option::is_none")]
    pub downloaded_bytes: Option<i64>,
}
impl ServerEndpointBackgroundDataDownloadActivity {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ServerEndpointCloudTieringStatus {
    ...
    #[serde(rename = "lastUpdatedTimestamp", default, with = "azure_core::date::rfc3339::option")]
    pub last_updated_timestamp: Option<time::OffsetDateTime>,
    #[doc = "Type of the server endpoint health state"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[doc = "Information regarding the low disk mode state"]
    #[serde(rename = "lowDiskMode", default, skip_serializing_if = "Option::is_none")]
    pub low_disk_mode: Option<CloudTieringLowDiskMode>,
}
...
pub struct ServerEndpointCreateParametersProperties {
    ...
    #[doc = "Policy for how the initial upload sync session is performed."]
    #[serde(rename = "initialUploadPolicy", default, skip_serializing_if = "Option::is_none")]
    pub initial_upload_policy: Option<InitialUploadPolicy>,
}
...
#[doc = "Type of the server endpoint health state"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ServerEndpointHealthState")]
...
impl FromStr for ServerEndpointHealthState {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for ServerEndpointHealthState {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for ServerEndpointHealthState {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Unavailable => serializer.serialize_unit_variant("ServerEndpointHealthState", 0u32, "Unavailable"),
            Self::Healthy => serializer.serialize_unit_variant("ServerEndpointHealthState", 1u32, "Healthy"),
            Self::Error => serializer.serialize_unit_variant("ServerEndpointHealthState", 2u32, "Error"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct ServerEndpointSyncActivityStatus {
    ...
    #[doc = "Session minutes remaining (if available)"]
    #[serde(rename = "sessionMinutesRemaining", default, skip_serializing_if = "Option::is_none")]
    pub session_minutes_remaining: Option<i32>,
}
...
pub struct WorkflowProperties {
    ...
    #[doc = "workflow last status timestamp."]
    #[serde(rename = "lastStatusTimestamp", default, with = "azure_core::date::rfc3339::option")]
    pub last_status_timestamp: Option<time::OffsetDateTime>,
}
