...
pub mod backup_resource_vault_configs {
    ...
    pub async fn get(
        ...
        match rsp.status() {
            ...
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(get::ResponseBytesError)?;
                let rsp_value: NewErrorResponse = serde_json::from_slice(&body).context(get::DeserializeError { body })?;
                get::DefaultResponse {
                    status_code,
                    value: rsp_value,
                }
    ...
    pub async fn put(
        ...
        match rsp.status() {
            ...
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(put::ResponseBytesError)?;
                let rsp_value: NewErrorResponse = serde_json::from_slice(&body).context(put::DeserializeError { body })?;
                put::DefaultResponse {
                    status_code,
                    value: rsp_value,
                }
    ...
    pub async fn update(
        ...
        match rsp.status() {
            ...
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(update::ResponseBytesError)?;
                let rsp_value: NewErrorResponse = serde_json::from_slice(&body).context(update::DeserializeError { body })?;
...
pub mod backup_resource_encryption_configs {
    ...
    pub async fn get(
        ...
        let client = &operation_config.client;
        let uri_str = & format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.RecoveryServices/vaults/{}/backupEncryptionConfigs/backupResourceEncryptionConfig" , & operation_config . base_path , subscription_id , resource_group_name , vault_name) ;
        let mut req_builder = client.get(uri_str);
        if let Some(token_credential) = &operation_config.token_credential {
            let token_response = token_credential
                .get_token(&operation_config.token_credential_resource)
...
pub mod private_endpoint {
    ...
    pub async fn get_operation_status(
        ...
        let client = &operation_config.client;
        let uri_str = & format ! ("{}/Subscriptions/{}/resourceGroups/{}/providers/Microsoft.RecoveryServices/vaults/{}/privateEndpointConnections/{}/operationsStatus/{}" , & operation_config . base_path , subscription_id , resource_group_name , vault_name , private_endpoint_connection_name , operation_id) ;
        let mut req_builder = client.get(uri_str);
        if let Some(token_credential) = &operation_config.token_credential {
            let token_response = token_credential
                .get_token(&operation_config.token_credential_resource)
        ...
        match rsp.status() {
            ...
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(get_operation_status::ResponseBytesError)?;
                let rsp_value: NewErrorResponse = serde_json::from_slice(&body).context(get_operation_status::DeserializeError { body })?;
...
pub async fn get_operation_status(
    ...
    let client = &operation_config.client;
    let uri_str = & format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.RecoveryServices/vaults/{}/backupstorageconfig/vaultstorageconfig/operationStatus/{}" , & operation_config . base_path , subscription_id , resource_group_name , vault_name , operation_id) ;
    let mut req_builder = client.get(uri_str);
    if let Some(token_credential) = &operation_config.token_credential {
        let token_response = token_credential
            .get_token(&operation_config.token_credential_resource)
...
pub async fn bms_prepare_data_move(
    ...
    let client = &operation_config.client;
    let uri_str = & format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.RecoveryServices/vaults/{}/backupstorageconfig/vaultstorageconfig/prepareDataMove" , & operation_config . base_path , subscription_id , resource_group_name , vault_name) ;
    ...
    req_builder = req_builder.query(&[("api-version", &operation_config.api_version)]);
    req_builder = req_builder.json(parameters);
    let req = req_builder.build().context(bms_prepare_data_move::BuildRequestError)?;
    let rsp = client.execute(req).await.context(bms_prepare_data_move::ExecuteRequestError)?;
    match rsp.status() {
        StatusCode::OK => Ok(bms_prepare_data_move::Response::Ok200),
        StatusCode::ACCEPTED => Ok(bms_prepare_data_move::Response::Accepted202),
        status_code => {
            let body: bytes::Bytes = rsp.bytes().await.context(bms_prepare_data_move::ResponseBytesError)?;
            let rsp_value: NewErrorResponse = serde_json::from_slice(&body).context(bms_prepare_data_move::DeserializeError { body })?;
...
pub async fn bms_trigger_data_move(
    ...
    let client = &operation_config.client;
    let uri_str = & format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.RecoveryServices/vaults/{}/backupstorageconfig/vaultstorageconfig/triggerDataMove" , & operation_config . base_path , subscription_id , resource_group_name , vault_name) ;
    let mut req_builder = client.post(uri_str);
    if let Some(token_credential) = &operation_config.token_credential {
        let token_response = token_credential
            .get_token(&operation_config.token_credential_resource)
    ...
    req_builder = req_builder.query(&[("api-version", &operation_config.api_version)]);
    req_builder = req_builder.json(parameters);
    let req = req_builder.build().context(bms_trigger_data_move::BuildRequestError)?;
    let rsp = client.execute(req).await.context(bms_trigger_data_move::ExecuteRequestError)?;
    match rsp.status() {
        StatusCode::OK => Ok(bms_trigger_data_move::Response::Ok200),
        StatusCode::ACCEPTED => Ok(bms_trigger_data_move::Response::Accepted202),
        status_code => {
            let body: bytes::Bytes = rsp.bytes().await.context(bms_trigger_data_move::ResponseBytesError)?;
            let rsp_value: NewErrorResponse = serde_json::from_slice(&body).context(bms_trigger_data_move::DeserializeError { body })?;
...
pub mod bms_prepare_data_move_operation_result {
    ...
    pub async fn get(
        ...
        let client = &operation_config.client;
        let uri_str = & format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.RecoveryServices/vaults/{}/backupstorageconfig/vaultstorageconfig/operationResults/{}" , & operation_config . base_path , subscription_id , resource_group_name , vault_name , operation_id) ;
        let mut req_builder = client.get(uri_str);
        if let Some(token_credential) = &operation_config.token_credential {
            let token_response = token_credential
                .get_token(&operation_config.token_credential_resource)
...
pub mod recovery_points {
    ...
    pub async fn get_access_token(
        ...
        match rsp.status() {
            ...
            StatusCode::BAD_REQUEST => get_access_token::BadRequest400 {}.fail(),
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(get_access_token::ResponseBytesError)?;
                let rsp_value: NewErrorResponse = serde_json::from_slice(&body).context(get_access_token::DeserializeError { body })?;
...
pub mod cross_region_restore {
    ...
    pub async fn trigger(
        ...
        let rsp = client.execute(req).await.context(trigger::ExecuteRequestError)?;
        match rsp.status() {
            StatusCode::OK => Ok(trigger::Response::Ok200),
            StatusCode::ACCEPTED => Ok(trigger::Response::Accepted202),
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(trigger::ResponseBytesError)?;
                let rsp_value: NewErrorResponse = serde_json::from_slice(&body).context(trigger::DeserializeError { body })?;
...
pub mod backup_crr_jobs {
    ...
    pub async fn list(
        ...
        match rsp.status() {
            ...
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(list::ResponseBytesError)?;
                let rsp_value: NewErrorResponse = serde_json::from_slice(&body).context(list::DeserializeError { body })?;
    ...
    pub async fn patch(
        ...
        match rsp.status() {
            ...
            status_code => {
                ...
                let rsp_value: NewErrorResponse = serde_json::from_slice(&body).context(patch::DeserializeError { body })?;
