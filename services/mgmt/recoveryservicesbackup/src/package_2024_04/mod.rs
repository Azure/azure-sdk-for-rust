...
pub mod backup_resource_vault_configs {
    ...
    impl Client {
        ...
        pub fn put(
            ...
            put::RequestBuilder {
                ...
                subscription_id: subscription_id.into(),
                parameters: parameters.into(),
                x_ms_authorization_auxiliary: None,
            }
        }
        #[doc = "Updates vault security config."]
        #[doc = ""]
    ...
    pub mod put {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) x_ms_authorization_auxiliary: Option<String>,
        }
        impl RequestBuilder {
            pub fn x_ms_authorization_auxiliary(mut self, x_ms_authorization_auxiliary: impl Into<String>) -> Self {
                self.x_ms_authorization_auxiliary = Some(x_ms_authorization_auxiliary.into());
                self
            }
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.parameters)?;
                        if let Some(x_ms_authorization_auxiliary) = &this.x_ms_authorization_auxiliary {
                            req.insert_header("x-ms-authorization-auxiliary", x_ms_authorization_auxiliary);
                        }
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
