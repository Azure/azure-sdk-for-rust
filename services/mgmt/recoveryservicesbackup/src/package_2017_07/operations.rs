...
pub mod aad_properties {
    use crate::{models::*, *};
    pub async fn get(configuration: &Configuration, azure_region: &str, subscription_id: &str) -> Result<AadPropertiesResource> {
...
pub mod backup_crr_job_details {
    use crate::{models::*, *};
    pub async fn get(configuration: &Configuration, azure_region: &str, subscription_id: &str) -> Result<JobResource> {
        let client = &configuration.client;
        let uri_str = &format!(
...
pub mod backup_crr_jobs {
    use crate::{models::*, *};
    pub async fn list(configuration: &Configuration, azure_region: &str, subscription_id: &str) -> Result<JobResourceList> {
        let client = &configuration.client;
        let uri_str = &format!(
...
pub mod crr_operation_results {
    use crate::{models::*, *};
    pub async fn get(configuration: &Configuration, azure_region: &str, subscription_id: &str, operation_id: &str) -> Result<()> {
        let client = &configuration.client;
        let uri_str = &format!(
