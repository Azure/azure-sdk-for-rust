    ...
    impl Serialize for ContainerType {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::StorageContainer => serializer.serialize_unit_variant("ContainerType", 13u32, "StorageContainer"),
                Self::GenericContainer => serializer.serialize_unit_variant("ContainerType", 14u32, "GenericContainer"),
                Self::AzureWorkloadContainer => serializer.serialize_unit_variant("ContainerType", 15u32, "AzureWorkloadContainer"),
                Self::MicrosoftClassicComputeVirtualMachines => {
                    serializer.serialize_unit_variant("ContainerType", 16u32, "Microsoft.ClassicCompute/virtualMachines")
                }
                Self::MicrosoftComputeVirtualMachines => {
                    serializer.serialize_unit_variant("ContainerType", 17u32, "Microsoft.Compute/virtualMachines")
                }
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
