...
pub struct AzureFileShareProtectionPolicy {
    ...
    #[doc = "Vault retention policy for AzureFileShare"]
    #[serde(rename = "vaultRetentionPolicy", default, skip_serializing_if = "Option::is_none")]
    pub vault_retention_policy: Option<VaultRetentionPolicy>,
...
pub struct AzureFileShareRecoveryPoint {
    ...
    #[doc = "Properties of Recovery Point"]
    #[serde(rename = "recoveryPointProperties", default, skip_serializing_if = "Option::is_none")]
    ...
    impl Serialize for ProtectionState {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::BackupsSuspended => serializer.serialize_unit_variant("ProtectionState", 6u32, "BackupsSuspended"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct AzureIaaSvmProtectionPolicy {
    ...
    #[serde(rename = "snapshotConsistencyType", default, skip_serializing_if = "Option::is_none")]
    pub snapshot_consistency_type: Option<azure_iaa_svm_protection_policy::SnapshotConsistencyType>,
}
impl AzureIaaSvmProtectionPolicy {
    pub fn new(protection_policy: ProtectionPolicy) -> Self {
        Self {
            ...
            time_zone: None,
            policy_type: None,
            snapshot_consistency_type: None,
        }
    }
}
pub mod azure_iaa_svm_protection_policy {
    ...
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "SnapshotConsistencyType")]
    pub enum SnapshotConsistencyType {
        OnlyCrashConsistent,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for SnapshotConsistencyType {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for SnapshotConsistencyType {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for SnapshotConsistencyType {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::OnlyCrashConsistent => serializer.serialize_unit_variant("SnapshotConsistencyType", 0u32, "OnlyCrashConsistent"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct AzureVmWorkloadProtectableItem {
    ...
    #[doc = "Indicates if item is protectable"]
    #[serde(rename = "isProtectable", default, skip_serializing_if = "Option::is_none")]
    pub is_protectable: Option<bool>,
}
...
pub struct AzureWorkloadRestoreRequest {
    ...
    #[doc = "Defines the Resource group of the Target VM"]
    ...
    #[doc = "User assigned managed identity details"]
    #[serde(rename = "userAssignedManagedIdentityDetails", default, skip_serializing_if = "Option::is_none")]
    pub user_assigned_managed_identity_details: Option<UserAssignedManagedIdentityDetails>,
    #[doc = "Encapsulates information regarding snapshot recovery for SAP Hana"]
    #[serde(rename = "snapshotRestoreParameters", default, skip_serializing_if = "Option::is_none")]
    pub snapshot_restore_parameters: Option<SnapshotRestoreParameters>,
...
impl AzureWorkloadRestoreRequest {
    pub fn new(restore_request: RestoreRequest) -> Self {
        Self {
            ...
            user_assigned_managed_identity_details: None,
            snapshot_restore_parameters: None,
    ...
    impl Serialize for RecoveryMode {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::SnapshotAttach => serializer.serialize_unit_variant("RecoveryMode", 3u32, "SnapshotAttach"),
                Self::RecoveryUsingSnapshot => serializer.serialize_unit_variant("RecoveryMode", 4u32, "RecoveryUsingSnapshot"),
                Self::SnapshotAttachAndRecover => serializer.serialize_unit_variant("RecoveryMode", 5u32, "SnapshotAttachAndRecover"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct BmsrpQueryObject {
    ...
    #[doc = "Flag to indicate whether Soft Deleted RPs should be included/excluded from result."]
    #[serde(rename = "includeSoftDeletedRP", default, skip_serializing_if = "Option::is_none")]
    pub include_soft_deleted_rp: Option<bool>,
}
...
pub struct DistributedNodesInfo {
    ...
    #[doc = "ARM resource id of the node"]
    #[serde(rename = "sourceResourceId", default, skip_serializing_if = "Option::is_none")]
    pub source_resource_id: Option<String>,
}
...
pub struct ExtendedLocation {
    #[doc = "Name of the extended location."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Type of the extended location. Possible values include: 'EdgeZone'"]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<String>,
}
...
#[doc = "Request parameters for fetching cost info of rehydration"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct FetchTieringCostInfoForRehydrationRequest {
    #[serde(flatten)]
    pub fetch_tiering_cost_info_request: FetchTieringCostInfoRequest,
    #[doc = "Name of the protected item container"]
    #[serde(rename = "containerName")]
    pub container_name: String,
    #[doc = "Name of the protectedItemName"]
    #[serde(rename = "protectedItemName")]
    pub protected_item_name: String,
    #[doc = "ID of the backup copy for rehydration cost info needs to be fetched."]
    #[serde(rename = "recoveryPointId")]
    pub recovery_point_id: String,
    #[doc = "Rehydration Priority"]
    #[serde(rename = "rehydrationPriority")]
    pub rehydration_priority: fetch_tiering_cost_info_for_rehydration_request::RehydrationPriority,
}
impl FetchTieringCostInfoForRehydrationRequest {
    pub fn new(
        fetch_tiering_cost_info_request: FetchTieringCostInfoRequest,
        container_name: String,
        protected_item_name: String,
        recovery_point_id: String,
        rehydration_priority: fetch_tiering_cost_info_for_rehydration_request::RehydrationPriority,
    ) -> Self {
        Self {
            fetch_tiering_cost_info_request,
            container_name,
            protected_item_name,
            recovery_point_id,
...
pub mod fetch_tiering_cost_info_for_rehydration_request {
    use super::*;
    #[doc = "Rehydration Priority"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "Base class for tiering cost request.\r\nSpecific cost request types are derived from this class."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct FetchTieringCostInfoRequest {
    #[doc = "Source tier for the request"]
    #[serde(rename = "sourceTierType")]
    pub source_tier_type: fetch_tiering_cost_info_request::SourceTierType,
    #[doc = "target tier for the request"]
    #[serde(rename = "targetTierType")]
    pub target_tier_type: fetch_tiering_cost_info_request::TargetTierType,
}
impl FetchTieringCostInfoRequest {
    pub fn new(
        source_tier_type: fetch_tiering_cost_info_request::SourceTierType,
        target_tier_type: fetch_tiering_cost_info_request::TargetTierType,
    ) -> Self {
        Self {
            source_tier_type,
            target_tier_type,
...
pub mod fetch_tiering_cost_info_request {
    use super::*;
    #[doc = "Source tier for the request"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "objectType")]
pub enum FetchTieringCostInfoRequestUnion {
...
#[doc = "Request parameters for tiering cost info for policy"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct FetchTieringCostSavingsInfoForPolicyRequest {
    #[serde(flatten)]
    pub fetch_tiering_cost_info_request: FetchTieringCostInfoRequest,
    #[doc = "Name of the backup policy for which the cost savings information is requested"]
    #[serde(rename = "policyName")]
    pub policy_name: String,
}
impl FetchTieringCostSavingsInfoForPolicyRequest {
    pub fn new(fetch_tiering_cost_info_request: FetchTieringCostInfoRequest, policy_name: String) -> Self {
        Self {
            fetch_tiering_cost_info_request,
            policy_name,
        }
...
#[doc = "Request parameters for tiering cost info for protected item"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct FetchTieringCostSavingsInfoForProtectedItemRequest {
    #[serde(flatten)]
    pub fetch_tiering_cost_info_request: FetchTieringCostInfoRequest,
    #[doc = "Name of the protected item container"]
    #[serde(rename = "containerName")]
...
impl FetchTieringCostSavingsInfoForProtectedItemRequest {
    pub fn new(fetch_tiering_cost_info_request: FetchTieringCostInfoRequest, container_name: String, protected_item_name: String) -> Self {
        Self {
            fetch_tiering_cost_info_request,
            container_name,
            protected_item_name,
...
#[doc = "Request parameters for tiering cost info for vault"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct FetchTieringCostSavingsInfoForVaultRequest {
    #[serde(flatten)]
    pub fetch_tiering_cost_info_request: FetchTieringCostInfoRequest,
}
impl FetchTieringCostSavingsInfoForVaultRequest {
    pub fn new(fetch_tiering_cost_info_request: FetchTieringCostInfoRequest) -> Self {
        Self {
            fetch_tiering_cost_info_request,
        }
    }
...
pub struct IaasVmRestoreRequest {
    ...
    #[serde(rename = "securedVMDetails", default, skip_serializing_if = "Option::is_none")]
    pub secured_vm_details: Option<SecuredVmDetails>,
    #[doc = "Specifies target network access settings for disks of VM to be restored."]
    #[serde(rename = "targetDiskNetworkAccessSettings", default, skip_serializing_if = "Option::is_none")]
...
impl IaasVmRestoreRequest {
    pub fn new(restore_request: RestoreRequest) -> Self {
        Self {
            ...
            extended_location: None,
            secured_vm_details: None,
            target_disk_network_access_settings: None,
        }
    }
}
...
#[doc = "Recovery Point Contract for Update Recovery Point API."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PatchRecoveryPointInput {
    #[doc = "Recovery Point Properties Contract for Update Recovery Point API."]
    #[serde(rename = "recoveryPointProperties", default, skip_serializing_if = "Option::is_none")]
    pub recovery_point_properties: Option<PatchRecoveryPointPropertiesInput>,
}
impl PatchRecoveryPointInput {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Recovery Point Properties Contract for Update Recovery Point API."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PatchRecoveryPointPropertiesInput {
    #[doc = "Expiry time of Recovery Point in UTC."]
    #[serde(rename = "expiryTime", default, with = "azure_core::date::rfc3339::option")]
    pub expiry_time: Option<::time::OffsetDateTime>,
}
impl PatchRecoveryPointPropertiesInput {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct RecoveryPointProperties {
    ...
    #[doc = "Rule name tagged on Recovery Point that governs life cycle"]
    #[serde(rename = "ruleName", default, skip_serializing_if = "Option::is_none")]
    pub rule_name: Option<String>,
    #[doc = "Bool to indicate whether RP is in soft delete state or not"]
    #[serde(rename = "isSoftDeleted", default, skip_serializing_if = "Option::is_none")]
...
pub struct ResourceGuardProxyBase {
    #[serde(rename = "resourceGuardResourceId")]
    pub resource_guard_resource_id: String,
    #[serde(
...
impl ResourceGuardProxyBase {
    pub fn new(resource_guard_resource_id: String) -> Self {
        Self {
            resource_guard_resource_id,
            resource_guard_operation_details: Vec::new(),
            last_updated_time: None,
            description: None,
        }
    }
...
#[doc = "Restore request parameters for Secured VMs"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SecuredVmDetails {
    #[doc = "Gets or Sets Disk Encryption Set Id for Secured VM OS Disk"]
    #[serde(rename = "securedVMOsDiskEncryptionSetId", default, skip_serializing_if = "Option::is_none")]
    pub secured_vm_os_disk_encryption_set_id: Option<String>,
}
impl SecuredVmDetails {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Snapshot Backup related fields for WorkloadType SaPHanaSystem"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SnapshotBackupAdditionalDetails {
    #[serde(rename = "instantRpRetentionRangeInDays", default, skip_serializing_if = "Option::is_none")]
    pub instant_rp_retention_range_in_days: Option<i32>,
    #[serde(rename = "instantRPDetails", default, skip_serializing_if = "Option::is_none")]
    pub instant_rp_details: Option<String>,
    #[doc = "User assigned managed identity details"]
    #[serde(rename = "userAssignedManagedIdentityDetails", default, skip_serializing_if = "Option::is_none")]
    pub user_assigned_managed_identity_details: Option<UserAssignedManagedIdentityDetails>,
}
impl SnapshotBackupAdditionalDetails {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Encapsulates information regarding snapshot recovery for SAP Hana"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SnapshotRestoreParameters {
    #[serde(rename = "skipAttachAndMount", default, skip_serializing_if = "Option::is_none")]
    pub skip_attach_and_mount: Option<bool>,
    #[serde(rename = "logPointInTimeForDBRecovery", default, skip_serializing_if = "Option::is_none")]
    pub log_point_in_time_for_db_recovery: Option<String>,
}
impl SnapshotRestoreParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct SubProtectionPolicy {
    ...
    pub tiering_policy: Option<serde_json::Value>,
    #[doc = "Snapshot Backup related fields for WorkloadType SaPHanaSystem"]
    #[serde(rename = "snapshotBackupAdditionalDetails", default, skip_serializing_if = "Option::is_none")]
    pub snapshot_backup_additional_details: Option<SnapshotBackupAdditionalDetails>,
}
...
#[doc = "Specifies target network access settings for disks of VM to be restored."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct TargetDiskNetworkAccessSettings {
    #[doc = "Network access settings to be used for restored disks"]
    #[serde(rename = "targetDiskNetworkAccessOption", default, skip_serializing_if = "Option::is_none")]
    pub target_disk_network_access_option: Option<target_disk_network_access_settings::TargetDiskNetworkAccessOption>,
    #[doc = "Gets or sets the ARM resource ID of the target disk access to be used when TargetDiskNetworkAccessOption is set to TargetDiskNetworkAccessOption.UseNew"]
    #[serde(rename = "targetDiskAccessId", default, skip_serializing_if = "Option::is_none")]
    pub target_disk_access_id: Option<String>,
}
impl TargetDiskNetworkAccessSettings {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod target_disk_network_access_settings {
    use super::*;
    #[doc = "Network access settings to be used for restored disks"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum TargetDiskNetworkAccessOption {
        SameAsOnSourceDisks,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "objectType")]
pub enum TieringCostInfoUnion {
    TieringCostRehydrationInfo(TieringCostRehydrationInfo),
    TieringCostSavingInfo(TieringCostSavingInfo),
}
#[doc = "Response parameters for tiering cost info for rehydration"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct TieringCostRehydrationInfo {
    #[doc = "Rehydration size in bytes"]
    #[serde(rename = "rehydrationSizeInBytes")]
    pub rehydration_size_in_bytes: i64,
    #[doc = "Source tier to target tier rehydration cost per GB per month"]
    #[serde(rename = "retailRehydrationCostPerGBPerMonth")]
    pub retail_rehydration_cost_per_gb_per_month: f64,
}
impl TieringCostRehydrationInfo {
    pub fn new(rehydration_size_in_bytes: i64, retail_rehydration_cost_per_gb_per_month: f64) -> Self {
        Self {
            rehydration_size_in_bytes,
            retail_rehydration_cost_per_gb_per_month,
        }
    }
}
#[doc = "Response parameters for tiering cost info for savings"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct TieringCostSavingInfo {
    #[doc = "Source tier size reduction in bytes after moving all the recommended backup points to target tier"]
    #[serde(rename = "sourceTierSizeReductionInBytes")]
    pub source_tier_size_reduction_in_bytes: i64,
    #[doc = "Target tier size increase in bytes after moving all the recommended backup points to target tier"]
    #[serde(rename = "targetTierSizeIncreaseInBytes")]
    pub target_tier_size_increase_in_bytes: i64,
    #[doc = "Source tier retail cost per GB per month"]
    #[serde(rename = "retailSourceTierCostPerGBPerMonth")]
    pub retail_source_tier_cost_per_gb_per_month: f64,
    #[doc = "Target tier retail cost per GB per month"]
    #[serde(rename = "retailTargetTierCostPerGBPerMonth")]
    pub retail_target_tier_cost_per_gb_per_month: f64,
}
impl TieringCostSavingInfo {
    pub fn new(
        source_tier_size_reduction_in_bytes: i64,
        target_tier_size_increase_in_bytes: i64,
        retail_source_tier_cost_per_gb_per_month: f64,
        retail_target_tier_cost_per_gb_per_month: f64,
    ) -> Self {
        Self {
            source_tier_size_reduction_in_bytes,
            target_tier_size_increase_in_bytes,
            retail_source_tier_cost_per_gb_per_month,
            retail_target_tier_cost_per_gb_per_month,
        }
    }
}
...
#[doc = "Patch Request content to update recovery point for given RecoveryPointId"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct UpdateRecoveryPointRequest {
    #[doc = "Recovery Point Contract for Update Recovery Point API."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<PatchRecoveryPointInput>,
}
impl UpdateRecoveryPointRequest {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "User assigned managed identity details"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct UserAssignedManagedIdentityDetails {
    #[doc = "The ARM id of the assigned identity."]
    #[serde(rename = "identityArmId", default, skip_serializing_if = "Option::is_none")]
    pub identity_arm_id: Option<String>,
    #[doc = "The name of the assigned identity."]
    #[serde(rename = "identityName", default, skip_serializing_if = "Option::is_none")]
    pub identity_name: Option<String>,
    #[doc = "User assigned managed identity properties"]
    #[serde(rename = "userAssignedIdentityProperties", default, skip_serializing_if = "Option::is_none")]
    pub user_assigned_identity_properties: Option<UserAssignedIdentityProperties>,
}
impl UserAssignedManagedIdentityDetails {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ValidateOperationRequestResource {
    #[doc = "Recovery point ID."]
    pub id: String,
    #[doc = "Base class for validate operation request."]
    pub properties: ValidateOperationRequestUnion,
}
impl ValidateOperationRequestResource {
    pub fn new(id: String, properties: ValidateOperationRequestUnion) -> Self {
        Self { id, properties }
    }
}
#[doc = "Base class for validate operation response."]
...
#[doc = "Vault retention policy for AzureFileShare"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct VaultRetentionPolicy {
    #[doc = "Base class for retention policy."]
    #[serde(rename = "vaultRetention")]
    pub vault_retention: RetentionPolicyUnion,
    #[serde(rename = "snapshotRetentionInDays")]
    pub snapshot_retention_in_days: i32,
}
impl VaultRetentionPolicy {
    pub fn new(vault_retention: RetentionPolicyUnion, snapshot_retention_in_days: i32) -> Self {
        Self {
            vault_retention,
