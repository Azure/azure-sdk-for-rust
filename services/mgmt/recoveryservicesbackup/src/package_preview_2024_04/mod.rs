        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-04-30-preview");
                }
                Ok(url)
            }
        }
...
pub mod recovery_points {
    ...
    impl Client {
        ...
        #[doc = "UpdateRecoveryPoint to update recovery point for given RecoveryPointID."]
        #[doc = ""]
        #[doc = "Arguments:"]
        ...
        pub fn update(
            ...
            protected_item_name: impl Into<String>,
            recovery_point_id: impl Into<String>,
            parameters: impl Into<models::UpdateRecoveryPointRequest>,
        ) -> update::RequestBuilder {
            update::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
    ...
    pub mod update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) protected_item_name: String,
            pub(crate) recovery_point_id: String,
            pub(crate) parameters: models::UpdateRecoveryPointRequest,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
