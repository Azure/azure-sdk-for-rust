...
pub mod resource_guard_proxies {
    ...
    pub async fn get(
        ...
        resource_group_name: &str,
        subscription_id: &str,
    ) -> std::result::Result<models::ResourceGuardProxyBaseResourceList, get::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
...
pub mod resource_guard_proxy {
    ...
    ) -> std::result::Result<models::ResourceGuardProxyBaseResource, get::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.RecoveryServices/vaults/{}/backupResourceGuardProxies/{}",
            operation_config.base_path(),
    ...
    pub async fn put(
        ...
        subscription_id: &str,
        resource_guard_proxy_name: &str,
    ) -> std::result::Result<models::ResourceGuardProxyBaseResource, put::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.RecoveryServices/vaults/{}/backupResourceGuardProxies/{}",
            operation_config.base_path(),
    ...
    pub async fn unlock_delete(
        ...
        subscription_id: &str,
        resource_guard_proxy_name: &str,
        parameters: &models::UnlockDeleteRequest,
    ) -> std::result::Result<models::UnlockDeleteResponse, unlock_delete::Error> {
        let http_client = operation_config.http_client();
