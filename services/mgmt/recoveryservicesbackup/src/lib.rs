...
#[cfg(all(feature = "package-2021-02-10", not(feature = "no-default-tag")))]
...
#[cfg(all(feature = "package-2016-08", not(feature = "no-default-tag")))]
...
#[cfg(all(feature = "package-2017-07-only", not(feature = "no-default-tag")))]
