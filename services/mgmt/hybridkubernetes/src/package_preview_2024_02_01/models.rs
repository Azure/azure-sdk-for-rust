...
pub struct ArcAgentProfile {
    ...
    #[doc = "List of system extensions can be installed on the cluster resource."]
    #[serde(
...
#[doc = "System Extension and its desired versions to be installed on the cluster resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SystemComponent {
    ...
    #[doc = "Major Version of the system extension to be installed on the cluster resource."]
    #[serde(rename = "majorVersion", default, skip_serializing_if = "Option::is_none")]
    pub major_version: Option<i32>,
    #[doc = "Version of the system extension is currently installed on the cluster resource."]
