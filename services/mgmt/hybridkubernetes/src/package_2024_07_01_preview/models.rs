...
#[doc = "Agent Errors if any during agent or system component upgrade."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AgentError {
    #[doc = "Agent error message."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub message: Option<String>,
    #[doc = "Severity of the error message."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub severity: Option<String>,
    #[doc = "Agent component where error message occured."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Defines the Arc Agent properties for the clusters."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ArcAgentProfile {
    #[doc = "Version of the Arc agents to be installed on the cluster resource"]
    #[serde(rename = "desiredAgentVersion", default, skip_serializing_if = "Option::is_none")]
    pub desired_agent_version: Option<String>,
    #[doc = "Indicates whether the Arc agents on the be upgraded automatically to the latest version. Defaults to Enabled."]
    ...
    #[doc = "List of system extensions that are installed on the cluster resource."]
    #[serde(
        rename = "systemComponents",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub system_components: Vec<SystemComponent>,
    #[doc = "List of arc agentry and system components errors on the cluster resource."]
    #[serde(
        rename = "agentErrors",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    #[doc = "Represents the current state of the Arc agentry and its dependent components."]
    #[serde(rename = "agentState", default, skip_serializing_if = "Option::is_none")]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ArcAgentryConfigurations {
    #[doc = "Specifies the name of the feature for the configuration setting."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub feature: Option<String>,
    #[doc = "The configuration settings for the feature that do not contain any sensitive or secret information."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub settings: Option<serde_json::Value>,
    #[doc = "The configuration settings for the feature that contain any sensitive or secret information."]
    #[serde(rename = "protectedSettings", default, skip_serializing_if = "Option::is_none")]
    pub protected_settings: Option<serde_json::Value>,
}
impl ArcAgentryConfigurations {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ConnectedCluster {
    ...
    #[doc = "Indicates the kind of Arc connected cluster based on host infrastructure."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kind: Option<ConnectedClusterKind>,
...
#[doc = "Indicates the kind of Arc connected cluster based on host infrastructure."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ConnectedClusterKind")]
pub enum ConnectedClusterKind {
    ProvisionedCluster,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for ConnectedClusterKind {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for ConnectedClusterKind {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for ConnectedClusterKind {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::ProvisionedCluster => serializer.serialize_unit_variant("ConnectedClusterKind", 0u32, "ProvisionedCluster"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct ConnectedClusterList {
    ...
    #[doc = "The link to fetch the next page of connected clusters"]
...
pub struct ConnectedClusterPatchProperties {
    #[doc = "Represents the distribution of the connected cluster"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub distribution: Option<String>,
    #[doc = "Represents the Kubernetes distribution version on this connected cluster."]
    #[serde(rename = "distributionVersion", default, skip_serializing_if = "Option::is_none")]
    ...
    pub azure_hybrid_benefit: Option<connected_cluster_patch_properties::AzureHybridBenefit>,
}
...
pub struct ConnectedClusterProperties {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub distribution: Option<String>,
    #[doc = "The Kubernetes distribution version on this connected cluster."]
    #[serde(rename = "distributionVersion", default, skip_serializing_if = "Option::is_none")]
    pub distribution_version: Option<String>,
    ...
    #[doc = "This is populated only if privateLinkState is enabled. The resource id of the private link scope this connected cluster is assigned to, if any."]
    ...
    #[doc = "Indicates whether Azure Hybrid Benefit is opted in"]
    #[serde(rename = "azureHybridBenefit", default, skip_serializing_if = "Option::is_none")]
    pub azure_hybrid_benefit: Option<connected_cluster_properties::AzureHybridBenefit>,
    #[doc = "AAD Profile specifies attributes for Azure Active Directory integration."]
    ...
    #[doc = "Security Profile specifies attributes for cluster security features."]
    #[serde(rename = "securityProfile", default, skip_serializing_if = "Option::is_none")]
    pub security_profile: Option<SecurityProfile>,
    #[doc = "OIDC Issuer Profile specifies attributes for workload identity integration."]
    #[serde(rename = "oidcIssuerProfile", default, skip_serializing_if = "Option::is_none")]
    pub oidc_issuer_profile: Option<OidcIssuerProfile>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub gateway: Option<Gateway>,
    #[doc = "Configuration settings for customizing the behavior of the connected cluster."]
    #[serde(
        rename = "arcAgentryConfigurations",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub arc_agentry_configurations: Vec<ArcAgentryConfigurations>,
    #[doc = "More properties related to the Connected Cluster"]
    #[serde(rename = "miscellaneousProperties", default, skip_serializing_if = "Option::is_none")]
    pub miscellaneous_properties: Option<serde_json::Value>,
}
impl ConnectedClusterProperties {
    pub fn new(agent_public_key_certificate: String) -> Self {
        Self {
            ...
            gateway: None,
            arc_agentry_configurations: Vec::new(),
            miscellaneous_properties: None,
        }
    }
}
pub mod connected_cluster_properties {
    ...
    impl FromStr for PrivateLinkState {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for PrivateLinkState {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for PrivateLinkState {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("PrivateLinkState", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("PrivateLinkState", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct Gateway {
    #[doc = "Indicates whether the gateway for arc router connectivity is enabled."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
    #[doc = "The resource ID of the gateway used for the Arc router feature."]
...
#[doc = "OIDC Issuer Profile specifies attributes for workload identity integration."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OidcIssuerProfile {
    #[doc = "Whether to enable oidc issuer for workload identity integration."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
    #[doc = "The issuer url for hybrid clusters connected to Arc used for the workload identity feature."]
    #[serde(rename = "issuerUrl", default, skip_serializing_if = "Option::is_none")]
    pub issuer_url: Option<String>,
    #[doc = "The issuer url for public cloud clusters - AKS, EKS, GKE - used for the workload identity feature."]
    #[serde(rename = "selfHostedIssuerUrl", default, skip_serializing_if = "Option::is_none")]
    pub self_hosted_issuer_url: Option<String>,
}
impl OidcIssuerProfile {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub mod operation {
    ...
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
    pub struct Display {
        #[doc = "Service provider: Microsoft.Kubernetes"]
        #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct SecurityProfile {
    #[doc = "The workload identity feature webhook."]
    #[serde(rename = "workloadIdentity", default, skip_serializing_if = "Option::is_none")]
    pub workload_identity: Option<security_profile::WorkloadIdentity>,
}
...
pub mod security_profile {
    ...
    pub struct WorkloadIdentity {
        #[doc = "Whether to enable or disable the workload identity Webhook"]
        #[serde(default, skip_serializing_if = "Option::is_none")]
        pub enabled: Option<bool>,
    }
...
#[doc = "System extensions and its current versions installed on the cluster resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SystemComponent {
    #[doc = "Type of the system extension"]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<String>,
    #[doc = "Version of the system extension to be installed on the cluster resource."]
    #[serde(rename = "userSpecifiedVersion", default, skip_serializing_if = "Option::is_none")]
    pub user_specified_version: Option<String>,
    #[doc = "Major Version of the system extension that is currently installed on the cluster resource."]
    #[serde(rename = "majorVersion", default, skip_serializing_if = "Option::is_none")]
    pub major_version: Option<i32>,
    #[doc = "Version of the system extension that is currently installed on the cluster resource."]
