...
pub mod namespaces {
    ...
    impl Client {
        ...
        #[doc = "This operation Migrate the given namespace to provided name type"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: Name of the Resource group within the Azure subscription."]
        #[doc = "* `namespace_name`: The namespace name"]
        #[doc = "* `subscription_id`: Subscription credentials that uniquely identify a Microsoft Azure subscription. The subscription ID forms part of the URI for every service call."]
        #[doc = "* `parameters`: Parameters supplied to migrate namespace type."]
        pub fn migrate(
            &self,
            resource_group_name: impl Into<String>,
            namespace_name: impl Into<String>,
...
pub mod event_hubs {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets all the Event Hubs in a service bus Namespace."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: Name of the Resource group within the Azure subscription."]
        #[doc = "* `namespace_name`: The namespace name"]
...
pub mod premium_messaging_regions {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets the available premium messaging regions for servicebus "]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: Subscription credentials that uniquely identify a Microsoft Azure subscription. The subscription ID forms part of the URI for every service call."]
        pub fn list(&self, subscription_id: impl Into<String>) -> list::Builder {
                ...
                let make_request = move |continuation: Option<String>| {
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await?;
                                let rsp_value: models::PremiumMessagingRegionsListResult = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
