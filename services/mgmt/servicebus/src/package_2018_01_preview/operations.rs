...
pub mod namespaces {
    ...
    impl Client {
        ...
        pub fn create_or_update_ip_filter_rule(
            ...
            subscription_id: impl Into<String>,
        ) -> create_or_update_ip_filter_rule::Builder {
            create_or_update_ip_filter_rule::Builder {
                client: self.base_clone(),
                resource_group_name: resource_group_name.into(),
                namespace_name: namespace_name.into(),
        ...
        pub fn list_virtual_network_rules(
            ...
            namespace_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ) -> list_virtual_network_rules::Builder {
            list_virtual_network_rules::Builder {
                client: self.base_clone(),
                resource_group_name: resource_group_name.into(),
                namespace_name: namespace_name.into(),
        ...
        pub fn get_virtual_network_rule(
            ...
            subscription_id: impl Into<String>,
        ) -> get_virtual_network_rule::Builder {
            get_virtual_network_rule::Builder {
                client: self.base_clone(),
                resource_group_name: resource_group_name.into(),
                namespace_name: namespace_name.into(),
        ...
        pub fn create_or_update_virtual_network_rule(
            ...
            subscription_id: impl Into<String>,
        ) -> create_or_update_virtual_network_rule::Builder {
            create_or_update_virtual_network_rule::Builder {
                client: self.base_clone(),
                resource_group_name: resource_group_name.into(),
                namespace_name: namespace_name.into(),
        ...
        pub fn delete_virtual_network_rule(
            ...
            virtual_network_rule_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ) -> delete_virtual_network_rule::Builder {
            delete_virtual_network_rule::Builder {
                client: self.base_clone(),
                resource_group_name: resource_group_name.into(),
                namespace_name: namespace_name.into(),
        ...
        pub fn migrate(
            ...
            namespace_name: impl Into<String>,
            subscription_id: impl Into<String>,
            parameters: impl Into<models::SbNamespaceMigrate>,
        ) -> migrate::Builder {
            migrate::Builder {
                client: self.base_clone(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod list_ip_filter_rules {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::IpFilterRuleListResult, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            ...
                            let rsp_value: models::IpFilterRuleListResult =
    ...
    pub mod get_ip_filter_rule {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::IpFilterRule, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ServiceBus/namespaces/{}/ipfilterrules/{}",
                        self.client.endpoint(),
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                            let rsp_value: models::IpFilterRule =
                                serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                            Ok(rsp_value)
                        }
                        status_code => {
    ...
    pub mod migrate {
        ...
        pub struct Builder {
            ...
            pub(crate) namespace_name: String,
            pub(crate) subscription_id: String,
            pub(crate) parameters: models::SbNamespaceMigrate,
        }
        impl Builder {
...
pub mod premium_messaging_regions {
    ...
    pub mod list {
        ...
        impl Builder {
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, std::result::Result<models::PremiumMessagingRegionsListResult, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
