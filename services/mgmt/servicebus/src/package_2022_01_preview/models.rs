        ...
        impl Serialize for Role {
                ...
                S: Serializer,
            {
                match self {
                    ...
                    Self::PrimaryNotReplicating => serializer.serialize_unit_variant("Role", 1u32, "PrimaryNotReplicating"),
                    Self::Secondary => serializer.serialize_unit_variant("Role", 2u32, "Secondary"),
                    Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
                }
            }
        }
...
impl Serialize for FilterType {
    ...
    {
        match self {
            Self::SqlFilter => serializer.serialize_unit_variant("FilterType", 0u32, "SqlFilter"),
            Self::CorrelationFilter => serializer.serialize_unit_variant("FilterType", 1u32, "CorrelationFilter"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
