...
pub struct AccountPropertiesForPutRequest {
    ...
    #[doc = "An integer representing the total minutes that have been indexed on the account"]
    #[serde(rename = "totalMinutesIndexed", default, skip_serializing_if = "Option::is_none")]
    pub total_minutes_indexed: Option<i64>,
    #[doc = "Gets the status of the account at the time the operation was called."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
