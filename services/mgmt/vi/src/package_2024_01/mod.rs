...
pub mod generate {
    ...
    impl Client {
        ...
        #[doc = "Generate an Azure Video Indexer restricted viewer access token."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `account_name`: The name of the Azure Video Indexer account."]
        pub fn restricted_viewer_access_token(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            account_name: impl Into<String>,
        ) -> restricted_viewer_access_token::RequestBuilder {
            restricted_viewer_access_token::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod restricted_viewer_access_token {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) account_name: String,
            pub(crate) parameters: Option<models::GenerateRestrictedViewerAccessTokenParameters>,
        }
        impl RequestBuilder {
            #[doc = "The parameters for generating restricted viewer access token"]
            pub fn parameters(mut self, parameters: impl Into<models::GenerateRestrictedViewerAccessTokenParameters>) -> Self {
                self.parameters = Some(parameters.into());
                self
            }
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.VideoIndexer/accounts/{}/generateRestrictedViewerAccessToken" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . account_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-01-01");
