...
pub mod user_classic_accounts {
    ...
    pub async fn list(
        operation_config: &crate::OperationConfig,
        location: &str,
    ) -> std::result::Result<models::UserClassicAccountList, list::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        match rsp.status() {
            ...
            http::StatusCode::INTERNAL_SERVER_ERROR => {
                ...
                let rsp_value: models::ErrorResponse =
                    serde_json::from_slice(rsp_body).map_err(|source| list::Error::DeserializeError(source, rsp_body.clone()))?;
                Err(list::Error::InternalServerError500 { value: rsp_value })
            }
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::ErrorResponse =
...
pub mod classic_accounts {
    ...
    pub async fn get_details(
        ...
        location: &str,
        account_name: &str,
    ) -> std::result::Result<models::ClassicAccount, get_details::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        match rsp.status() {
            ...
            http::StatusCode::BAD_REQUEST => {
                ...
                let rsp_value: models::ErrorResponse =
                    serde_json::from_slice(rsp_body).map_err(|source| get_details::Error::DeserializeError(source, rsp_body.clone()))?;
                Err(get_details::Error::BadRequest400 { value: rsp_value })
            }
            http::StatusCode::UNAUTHORIZED => {
                let rsp_body = rsp.body();
                let rsp_value: models::ErrorResponse =
                    serde_json::from_slice(rsp_body).map_err(|source| get_details::Error::DeserializeError(source, rsp_body.clone()))?;
                Err(get_details::Error::Unauthorized401 { value: rsp_value })
            }
            http::StatusCode::NOT_FOUND => {
                let rsp_body = rsp.body();
                let rsp_value: models::ErrorResponse =
                    serde_json::from_slice(rsp_body).map_err(|source| get_details::Error::DeserializeError(source, rsp_body.clone()))?;
                Err(get_details::Error::NotFound404 { value: rsp_value })
            }
            http::StatusCode::INTERNAL_SERVER_ERROR => {
                let rsp_body = rsp.body();
                let rsp_value: models::ErrorResponse =
                    serde_json::from_slice(rsp_body).map_err(|source| get_details::Error::DeserializeError(source, rsp_body.clone()))?;
                Err(get_details::Error::InternalServerError500 { value: rsp_value })
            }
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::ErrorResponse =
