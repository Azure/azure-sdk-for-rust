...
pub mod operations {
    ...
    impl Client {
        #[doc = "Lists all of the available Azure Video Indexer provider operations."]
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::OperationListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    ...
                    async move {
                        let mut url =
                            azure_core::Url::parse(&format!("{}/providers/Microsoft.VideoIndexer/operations", this.client.endpoint(),))?;
                        let rsp = match continuation {
                            Some(value) => {
                                ...
                                if !has_api_version_already {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair(azure_core::query_param::API_VERSION, "2022-04-13-preview");
                                }
...
pub mod accounts {
    ...
    impl Client {
        ...
        #[doc = "List all Azure Video Indexer accounts available under the subscription"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        ...
        #[doc = "List all Azure Video Indexer accounts available under the resource group"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        ...
        #[doc = "Gets the properties of an Azure Video Indexer account."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `account_name`: The name of the Azure Video Indexer account."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "Creates or updates an Azure Video Indexer account."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Updates the properties of an existing Azure Video Indexer account."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Delete an Azure Video Indexer account."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod create_or_update {
        ...
        impl RequestBuilder {
            #[doc = "The parameters to provide for the Azure Video Indexer account."]
    ...
    pub mod update {
        ...
        impl RequestBuilder {
            #[doc = "The parameters to provide for the current Azure Video Indexer account."]
...
pub mod user_classic_accounts {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Lists all Azure Video Indexer classic accounts"]
        #[doc = ""]
        #[doc = "Arguments:"]
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::UserClassicAccountList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::UserClassicAccountList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::UserClassicAccountList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
...
pub mod classic_accounts {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets the properties of an Azure Video Indexer Classic account."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `location`: The name of Azure region."]
        #[doc = "* `account_name`: The name of the Azure Video Indexer account."]
    ...
    pub mod get_details {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ClassicAccount> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ClassicAccount = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ClassicAccount>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::ClassicAccount>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod generate {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Generate an Azure Video Indexer access token."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod access_token {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AccessToken>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AccessToken>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
