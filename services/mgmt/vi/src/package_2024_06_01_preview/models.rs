...
pub struct AccountPropertiesForPatchRequest {
    ...
    #[doc = "The storage services details"]
    #[serde(rename = "storageServices", default, skip_serializing_if = "Option::is_none")]
    pub storage_services: Option<StorageServicesForPatchRequest>,
    #[doc = "The openAi services details"]
    #[serde(rename = "openAiServices", default, skip_serializing_if = "Option::is_none")]
    pub open_ai_services: Option<OpenAiServicesForPatchRequest>,
    #[doc = "Whether or not public network access is allowed for the account."]
    #[serde(rename = "publicNetworkAccess", default, skip_serializing_if = "Option::is_none")]
    pub public_network_access: Option<account_properties_for_patch_request::PublicNetworkAccess>,
...
pub struct AccountPropertiesForPutRequest {
    ...
    #[doc = "The storage services details"]
    #[serde(rename = "storageServices", default, skip_serializing_if = "Option::is_none")]
    pub storage_services: Option<StorageServicesForPutRequest>,
    #[doc = "The openAi services details"]
    #[serde(rename = "openAiServices", default, skip_serializing_if = "Option::is_none")]
    pub open_ai_services: Option<OpenAiServicesForPutRequest>,
    ...
    #[doc = "Whether or not public network access is allowed for the account."]
    #[serde(rename = "publicNetworkAccess", default, skip_serializing_if = "Option::is_none")]
    pub public_network_access: Option<account_properties_for_put_request::PublicNetworkAccess>,
    #[doc = "List of private endpoint connections associated with the account."]
    #[serde(
        rename = "privateEndpointConnections",
        default,
...
#[doc = "Restricted viewer access token generation request's parameters"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GenerateRestrictedViewerAccessTokenParameters {
    #[doc = "The requested media type"]
    pub scope: generate_restricted_viewer_access_token_parameters::Scope,
    #[doc = "The video ID"]
    #[serde(rename = "videoId", default, skip_serializing_if = "Option::is_none")]
    pub video_id: Option<String>,
    #[doc = "The project ID"]
...
impl GenerateRestrictedViewerAccessTokenParameters {
    pub fn new(scope: generate_restricted_viewer_access_token_parameters::Scope) -> Self {
        Self {
            scope,
            video_id: None,
            project_id: None,
...
pub mod generate_restricted_viewer_access_token_parameters {
    use super::*;
    #[doc = "The requested media type"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Scope")]
...
#[doc = "The openAi services details"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OpenAiServicesForPatchRequest {
    #[doc = "The openAi services resource id"]
...
impl OpenAiServicesForPatchRequest {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The openAi services details"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OpenAiServicesForPutRequest {
    #[doc = "The openAi services resource id"]
    #[serde(rename = "resourceId", default, skip_serializing_if = "Option::is_none")]
    pub resource_id: Option<String>,
    #[doc = "The user assigned identity to be used to grant permissions"]
...
impl OpenAiServicesForPutRequest {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "The storage services details"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct StorageServicesForPatchRequest {
    #[doc = "The user assigned identity to be used to grant permissions"]
    #[serde(rename = "userAssignedIdentity", default, skip_serializing_if = "Option::is_none")]
    pub user_assigned_identity: Option<String>,
}
impl StorageServicesForPatchRequest {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The storage services details"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct StorageServicesForPutRequest {
    #[doc = "The storage services resource id"]
    #[serde(rename = "resourceId", default, skip_serializing_if = "Option::is_none")]
    pub resource_id: Option<String>,
    #[doc = "The user assigned identity to be used to grant permissions"]
    #[serde(rename = "userAssignedIdentity", default, skip_serializing_if = "Option::is_none")]
...
impl StorageServicesForPutRequest {
    pub fn new() -> Self {
        Self::default()
    }
}
