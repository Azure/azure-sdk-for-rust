...
use std::str::FromStr;
#[doc = "Azure Video Indexer access token."]
...
#[doc = "An Azure Video Indexer account."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct Account {
    #[serde(flatten)]
    pub tracked_resource: TrackedResource,
    #[doc = "Azure Video Indexer account properties"]
...
#[doc = "Azure Video Indexer account"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct AccountPropertiesForPutRequest {
    ...
    #[doc = "An integer representing the total seconds that have been indexed on the account"]
...
#[doc = "An Azure Video Indexer classic account."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ClassicAccount {
    ...
    #[doc = "The account's id"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "Azure Video Indexer classic account properties"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ClassicAccountProperties>,
}
impl ClassicAccount {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "Azure Video Indexer classic account properties"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ClassicAccountProperties {
    #[doc = "Azure Video Indexer classic account properties"]
    #[serde(rename = "mediaServices", default, skip_serializing_if = "Option::is_none")]
    pub media_services: Option<ClassicAccountMediaServices>,
}
impl ClassicAccountProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
