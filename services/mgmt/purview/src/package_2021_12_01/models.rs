...
pub struct AccountProperties {
    ...
    #[serde(
        rename = "managedResourcesPublicNetworkAccess",
        default,
        skip_serializing_if = "Option::is_none",
        with = "azure_core::xml::text_content"
    )]
...
pub struct AccountStatus {
    ...
    #[serde(
        rename = "accountProvisioningState",
        default,
        skip_serializing_if = "Option::is_none",
        with = "azure_core::xml::text_content"
    )]
