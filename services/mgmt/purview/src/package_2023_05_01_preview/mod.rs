...
impl Client {
    ...
    pub fn ingestion_private_endpoint_connections_client(&self) -> ingestion_private_endpoint_connections::Client {
        ingestion_private_endpoint_connections::Client(self.clone())
    }
    pub fn kafka_configurations_client(&self) -> kafka_configurations::Client {
        kafka_configurations::Client(self.clone())
    }
...
pub mod accounts {
    ...
    impl Client {
        ...
        pub fn add_root_collection_admin(
            ...
            resource_group_name: impl Into<String>,
            account_name: impl Into<String>,
            collection_admin_update: impl Into<models::CollectionAdminUpdate>,
        ) -> add_root_collection_admin::RequestBuilder {
            add_root_collection_admin::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
...
pub mod default_accounts {
    ...
    impl Client {
        ...
        pub fn get(&self, scope_tenant_id: impl Into<String>, scope_type: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
        ...
        #[doc = "* `scope_tenant_id`: The tenant ID."]
        #[doc = "* `scope_type`: The scope for the default account."]
        pub fn remove(&self, scope_tenant_id: impl Into<String>, scope_type: impl Into<String>) -> remove::RequestBuilder {
        ...
        pub fn set(&self, default_account_payload: impl Into<models::DefaultAccountPayload>) -> set::RequestBuilder {
            set::RequestBuilder {
                client: self.0.clone(),
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DefaultAccountPayload> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DefaultAccountPayload = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.Purview/getDefaultAccount",));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-05-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DefaultAccountPayload>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DefaultAccountPayload>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod remove {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.Purview/removeDefaultAccount",));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-05-01-preview");
    ...
    pub mod set {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.Purview/setDefaultAccount",));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-05-01-preview");
...
pub mod features {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets a list of features and their status for the location and subscription.\r\nStatus of enabled features will be true. Status of disabled features will be false.\r\nFeatures that don't exist will be excluded from the results."]
        #[doc = "Gets details from a list of feature names."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The subscription identifier"]
        #[doc = "* `locations`: Location of feature."]
        #[doc = "* `feature_request`: Request body with feature names."]
        pub fn subscription_get(
            &self,
            subscription_id: impl Into<String>,
            locations: impl Into<String>,
            feature_request: impl Into<models::BatchFeatureRequest>,
        ) -> subscription_get::RequestBuilder {
            subscription_get::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                locations: locations.into(),
                feature_request: feature_request.into(),
            }
        }
        #[doc = "Gets a list of features and their status for the account.\r\nStatus of enabled features will be true. Status of disabled features will be false.\r\nFeatures that don't exist will be excluded from the results."]
        #[doc = "Gets details from a list of feature names."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The subscription identifier"]
    ...
    pub mod subscription_get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BatchFeatureStatus> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BatchFeatureStatus = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) feature_request: models::BatchFeatureRequest,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.feature_request)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.Purview/locations/{}/listFeatures",
                    &self.subscription_id, &self.locations
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::BatchFeatureStatus>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::BatchFeatureStatus>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod account_get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Purview/accounts/{}/listFeatures",
                    &self.subscription_id, &self.resource_group_name, &self.account_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
...
pub mod ingestion_private_endpoint_connections {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Lists all ingestion private endpoint connections."]
        #[doc = "Lists all ingestion private endpoint connections"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The subscription identifier"]
        ...
        #[doc = "Updates ingestion private endpoint connection status."]
        #[doc = "Update ingestion private endpoint connection status"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The subscription identifier"]
        #[doc = "* `resource_group_name`: The resource group name."]
        #[doc = "* `account_name`: The name of the account."]
        #[doc = "* `request`: The ingestion private endpoint connection status update request."]
        pub fn update_status(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            account_name: impl Into<String>,
            request: impl Into<models::PrivateEndpointConnectionStatusUpdateRequest>,
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Purview/accounts/{}/ingestionPrivateEndpointConnections",
                    &self.subscription_id, &self.resource_group_name, &self.account_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod update_status {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::PrivateEndpointConnectionStatusUpdateResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::PrivateEndpointConnectionStatusUpdateResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) account_name: String,
            pub(crate) request: models::PrivateEndpointConnectionStatusUpdateRequest,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Purview/accounts/{}/ingestionPrivateEndpointConnectionStatus",
                    &self.subscription_id, &self.resource_group_name, &self.account_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::PrivateEndpointConnectionStatusUpdateResponse>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::PrivateEndpointConnectionStatusUpdateResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod kafka_configurations {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets the list of Kafka configurations for the account."]
        #[doc = "Lists the Kafka configurations in the Account"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The subscription identifier"]
        #[doc = "* `resource_group_name`: The resource group name."]
        ...
        #[doc = "Gets the kafka configuration."]
        #[doc = "Gets the kafka configuration for the account"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The subscription identifier"]
        #[doc = "* `resource_group_name`: The resource group name."]
        #[doc = "* `account_name`: The name of the account."]
        #[doc = "* `kafka_configuration_name`: Name of kafka configuration."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            account_name: impl Into<String>,
            kafka_configuration_name: impl Into<String>,
        ) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
                account_name: account_name.into(),
                kafka_configuration_name: kafka_configuration_name.into(),
            }
        }
        #[doc = "Create or update the kafka configuration."]
        #[doc = "Create or update Kafka Configuration"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The subscription identifier"]
        #[doc = "* `resource_group_name`: The resource group name."]
        #[doc = "* `account_name`: The name of the account."]
        #[doc = "* `kafka_configuration_name`: The kafka configuration name."]
        #[doc = "* `kafka_configuration`: The kafka configuration of the account."]
        pub fn create_or_update(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            account_name: impl Into<String>,
            kafka_configuration_name: impl Into<String>,
            kafka_configuration: impl Into<models::KafkaConfiguration>,
        ) -> create_or_update::RequestBuilder {
            create_or_update::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                ...
                account_name: account_name.into(),
                kafka_configuration_name: kafka_configuration_name.into(),
                kafka_configuration: kafka_configuration.into(),
            }
        }
        #[doc = "Deletes the kafka configuration on the account."]
        #[doc = "Deletes a KafkaConfiguration resource."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The subscription identifier"]
        #[doc = "* `resource_group_name`: The resource group name."]
    ...
    pub mod list_by_account {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::KafkaConfigurationList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::KafkaConfigurationList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::KafkaConfigurationList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Purview/accounts/{}/kafkaConfigurations",
                    &self.subscription_id, &self.resource_group_name, &self.account_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::KafkaConfiguration> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::KafkaConfiguration = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) account_name: String,
            pub(crate) kafka_configuration_name: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Purview/accounts/{}/kafkaConfigurations/{}",
                    &self.subscription_id, &self.resource_group_name, &self.account_name, &self.kafka_configuration_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::KafkaConfiguration>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::KafkaConfiguration>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) account_name: String,
            pub(crate) kafka_configuration_name: String,
            pub(crate) kafka_configuration: models::KafkaConfiguration,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.kafka_configuration)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
...
pub mod operations {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.Purview/operations",));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-05-01-preview");
...
pub mod private_link_resources {
    ...
    impl Client {
        ...
        ) -> get_by_group_id::RequestBuilder {
            get_by_group_id::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
...
pub mod usages {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets the Usage quota configuration."]
        #[doc = "Get the usage quota configuration"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The subscription identifier"]
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::UsageList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::UsageList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            #[doc = "The filter, currently unused."]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.Purview/locations/{}/usages",
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::UsageList>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::UsageList>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
