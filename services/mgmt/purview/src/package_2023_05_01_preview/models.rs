...
use std::str::FromStr;
#[doc = "The Purview Account access keys."]
...
pub struct AccountProperties {
    #[doc = "Gets or sets the status of the account."]
    #[serde(rename = "accountStatus", default, skip_serializing_if = "Option::is_none")]
    pub account_status: Option<serde_json::Value>,
    ...
    #[doc = "Ingestion Storage Account Info"]
    #[serde(rename = "ingestionStorage", default, skip_serializing_if = "Option::is_none")]
    pub ingestion_storage: Option<IngestionStorage>,
    #[doc = "Gets or sets the state of managed eventhub. If enabled managed eventhub will be created, if disabled the managed eventhub will be removed."]
    #[serde(rename = "managedEventHubState", default, skip_serializing_if = "Option::is_none")]
    pub managed_event_hub_state: Option<account_properties::ManagedEventHubState>,
    ...
    #[doc = "Gets or sets the public network access for managed resources."]
    #[serde(rename = "managedResourcesPublicNetworkAccess", default, skip_serializing_if = "Option::is_none")]
    pub managed_resources_public_network_access: Option<account_properties::ManagedResourcesPublicNetworkAccess>,
...
pub mod account_properties {
    ...
    #[doc = "Gets or sets the state of managed eventhub. If enabled managed eventhub will be created, if disabled the managed eventhub will be removed."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ManagedEventHubState")]
    pub enum ManagedEventHubState {
        NotSpecified,
        Disabled,
        Enabled,
    ...
    impl FromStr for ManagedEventHubState {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for ManagedEventHubState {
    ...
    impl Serialize for ManagedEventHubState {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::NotSpecified => serializer.serialize_unit_variant("ManagedEventHubState", 0u32, "NotSpecified"),
                Self::Disabled => serializer.serialize_unit_variant("ManagedEventHubState", 1u32, "Disabled"),
                Self::Enabled => serializer.serialize_unit_variant("ManagedEventHubState", 2u32, "Enabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for ManagedEventHubState {
        fn default() -> Self {
            Self::NotSpecified
        }
    }
    #[doc = "Gets or sets the public network access for managed resources."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ManagedResourcesPublicNetworkAccess")]
    pub enum ManagedResourcesPublicNetworkAccess {
        NotSpecified,
        Enabled,
        Disabled,
        #[serde(skip_deserializing)]
    ...
    impl FromStr for ManagedResourcesPublicNetworkAccess {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for ManagedResourcesPublicNetworkAccess {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for ManagedResourcesPublicNetworkAccess {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::NotSpecified => serializer.serialize_unit_variant("ManagedResourcesPublicNetworkAccess", 0u32, "NotSpecified"),
                Self::Enabled => serializer.serialize_unit_variant("ManagedResourcesPublicNetworkAccess", 1u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("ManagedResourcesPublicNetworkAccess", 2u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for ManagedResourcesPublicNetworkAccess {
        fn default() -> Self {
            Self::NotSpecified
        }
    }
    ...
    impl Serialize for Name {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Free => serializer.serialize_unit_variant("Name", 1u32, "Free"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
}
#[doc = "The account status."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AccountStatus {
    #[doc = "Gets the account status code."]
    #[serde(rename = "accountProvisioningState", default, skip_serializing_if = "Option::is_none")]
    pub account_provisioning_state: Option<account_status::AccountProvisioningState>,
    #[doc = "Gets the account error details."]
...
pub mod account_status {
    ...
    #[doc = "Gets the account status code."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "AccountProvisioningState")]
    pub enum AccountProvisioningState {
        Unknown,
        Creating,
        Updating,
        Moving,
    ...
    impl FromStr for AccountProvisioningState {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for AccountProvisioningState {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for AccountProvisioningState {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Unknown => serializer.serialize_unit_variant("AccountProvisioningState", 0u32, "Unknown"),
                Self::Creating => serializer.serialize_unit_variant("AccountProvisioningState", 1u32, "Creating"),
                Self::Updating => serializer.serialize_unit_variant("AccountProvisioningState", 2u32, "Updating"),
                Self::Moving => serializer.serialize_unit_variant("AccountProvisioningState", 3u32, "Moving"),
                Self::Deleting => serializer.serialize_unit_variant("AccountProvisioningState", 4u32, "Deleting"),
                Self::SoftDeleting => serializer.serialize_unit_variant("AccountProvisioningState", 5u32, "SoftDeleting"),
                Self::SoftDeleted => serializer.serialize_unit_variant("AccountProvisioningState", 6u32, "SoftDeleted"),
                Self::Failed => serializer.serialize_unit_variant("AccountProvisioningState", 7u32, "Failed"),
                Self::Succeeded => serializer.serialize_unit_variant("AccountProvisioningState", 8u32, "Succeeded"),
                Self::Canceled => serializer.serialize_unit_variant("AccountProvisioningState", 9u32, "Canceled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
impl BatchFeatureRequest {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "List of features with enabled status"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct BatchFeatureStatus {
    #[doc = "Features with enabled status"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub features: Option<serde_json::Value>,
}
impl BatchFeatureStatus {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Consent extension resource"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct Consent {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Gets or sets the consent kind."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kind: Option<consent::Kind>,
    #[doc = "The consent properties"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ConsentProperties>,
}
impl Consent {
    pub fn new() -> Self {
        Self::default()
...
pub mod consent {
    ...
    impl Serialize for Kind {
        ...
        {
            match self {
                Self::Metadata => serializer.serialize_unit_variant("Kind", 0u32, "Metadata"),
                Self::Governance => serializer.serialize_unit_variant("Kind", 1u32, "Governance"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "The consent properties"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ConsentProperties {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub scope: Option<String>,
    #[doc = "Defines consent scope type."]
    #[serde(rename = "scopeType", default, skip_serializing_if = "Option::is_none")]
    pub scope_type: Option<consent_properties::ScopeType>,
    #[doc = "Defines consent status."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<consent_properties::Status>,
}
impl ConsentProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod consent_properties {
    use super::*;
    #[doc = "Defines consent scope type."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    ...
    impl Serialize for ScopeType {
        ...
        {
            match self {
                Self::Azure => serializer.serialize_unit_variant("ScopeType", 0u32, "Azure"),
                Self::Fabric => serializer.serialize_unit_variant("ScopeType", 1u32, "Fabric"),
                Self::Databricks => serializer.serialize_unit_variant("ScopeType", 2u32, "Databricks"),
                Self::Snowflake => serializer.serialize_unit_variant("ScopeType", 3u32, "Snowflake"),
                Self::S3 => serializer.serialize_unit_variant("ScopeType", 4u32, "S3"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Credentials to access the event streaming service attached to the purview account."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct Credentials {
    #[doc = "Identity identifier for UserAssign type."]
    #[serde(rename = "identityId", default, skip_serializing_if = "Option::is_none")]
    pub identity_id: Option<String>,
    #[doc = "Identity Type."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<credentials::Type>,
}
impl Credentials {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "Ingestion Storage Account Info"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct IngestionStorage {
    #[doc = "Gets or sets the Id."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "Gets or sets the primary endpoint."]
    #[serde(rename = "primaryEndpoint", default, skip_serializing_if = "Option::is_none")]
    pub primary_endpoint: Option<String>,
    #[doc = "Gets or sets the public network access setting"]
    #[serde(rename = "publicNetworkAccess", default, skip_serializing_if = "Option::is_none")]
    pub public_network_access: Option<ingestion_storage::PublicNetworkAccess>,
}
impl IngestionStorage {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod ingestion_storage {
    use super::*;
    #[doc = "Gets or sets the public network access setting"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "PublicNetworkAccess")]
...
#[doc = "The configuration of the event streaming service resource attached to the Purview account for kafka notifications."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct KafkaConfiguration {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "The kafka configuration properties of the event streaming service attached to the Purview account for kafka notifications."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<KafkaConfigurationProperties>,
}
...
#[doc = "Paged list of kafka configuration resources"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct KafkaConfigurationList {
    #[doc = "The Url of next result page."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
    #[doc = "Collection of items of type results."]
    pub value: Vec<KafkaConfiguration>,
}
impl azure_core::Continuable for KafkaConfigurationList {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl KafkaConfigurationList {
    pub fn new(value: Vec<KafkaConfiguration>) -> Self {
        Self { next_link: None, value }
    }
}
#[doc = "The kafka configuration properties of the event streaming service attached to the Purview account for kafka notifications."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct KafkaConfigurationProperties {
    #[doc = "Consumer group for hook event hub."]
    #[serde(rename = "consumerGroup", default, skip_serializing_if = "Option::is_none")]
    pub consumer_group: Option<String>,
    #[doc = "Credentials to access the event streaming service attached to the purview account."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub credentials: Option<Credentials>,
    #[doc = "Optional partition Id for notification event hub. If not set, all partitions will be leveraged."]
    #[serde(rename = "eventHubPartitionId", default, skip_serializing_if = "Option::is_none")]
    pub event_hub_partition_id: Option<String>,
    #[serde(rename = "eventHubResourceId", default, skip_serializing_if = "Option::is_none")]
    pub event_hub_resource_id: Option<String>,
    #[doc = "The event hub type."]
    #[serde(rename = "eventHubType", default, skip_serializing_if = "Option::is_none")]
    pub event_hub_type: Option<kafka_configuration_properties::EventHubType>,
    #[doc = "The state of the event streaming service"]
    #[serde(rename = "eventStreamingState", default, skip_serializing_if = "Option::is_none")]
    pub event_streaming_state: Option<kafka_configuration_properties::EventStreamingState>,
    #[doc = "The event streaming service type"]
    #[serde(rename = "eventStreamingType", default, skip_serializing_if = "Option::is_none")]
    pub event_streaming_type: Option<kafka_configuration_properties::EventStreamingType>,
}
impl KafkaConfigurationProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod kafka_configuration_properties {
    use super::*;
    #[doc = "The event hub type."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "EventHubType")]
    pub enum EventHubType {
        Notification,
        Hook,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for EventHubType {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for EventHubType {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for EventHubType {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Notification => serializer.serialize_unit_variant("EventHubType", 0u32, "Notification"),
                Self::Hook => serializer.serialize_unit_variant("EventHubType", 1u32, "Hook"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    #[doc = "The state of the event streaming service"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "EventStreamingState")]
    pub enum EventStreamingState {
        Disabled,
        Enabled,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for EventStreamingState {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for EventStreamingState {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for EventStreamingState {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Disabled => serializer.serialize_unit_variant("EventStreamingState", 0u32, "Disabled"),
                Self::Enabled => serializer.serialize_unit_variant("EventStreamingState", 1u32, "Enabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for EventStreamingState {
        fn default() -> Self {
            Self::Enabled
        }
    }
    #[doc = "The event streaming service type"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "EventStreamingType")]
    pub enum EventStreamingType {
        None,
        Managed,
        Azure,
        #[serde(skip_deserializing)]
    ...
    impl FromStr for EventStreamingType {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for EventStreamingType {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for EventStreamingType {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::None => serializer.serialize_unit_variant("EventStreamingType", 0u32, "None"),
                Self::Managed => serializer.serialize_unit_variant("EventStreamingType", 1u32, "Managed"),
                Self::Azure => serializer.serialize_unit_variant("EventStreamingType", 2u32, "Azure"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for EventStreamingType {
        fn default() -> Self {
            Self::None
        }
    }
...
#[doc = "A private endpoint connection status update request class."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PrivateEndpointConnectionStatusUpdateRequest {
    #[doc = "The private endpoint resource identifier."]
...
impl PrivateEndpointConnectionStatusUpdateRequest {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "A private endpoint connection status update response class."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PrivateEndpointConnectionStatusUpdateResponse {
    #[doc = "The private endpoint resource identifier."]
    #[serde(rename = "privateEndpointId", default, skip_serializing_if = "Option::is_none")]
    pub private_endpoint_id: Option<String>,
    #[doc = "The private endpoint connection status."]
...
impl PrivateEndpointConnectionStatusUpdateResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct QuotaName {
    #[doc = "Gets or sets the localized name value."]
    #[serde(rename = "localizedValue", default, skip_serializing_if = "Option::is_none")]
    pub localized_value: Option<String>,
    #[doc = "Gets or sets the name value."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Response for usage information"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct Usage {
    #[doc = "Current usage quota value"]
    #[serde(rename = "currentValue", default, skip_serializing_if = "Option::is_none")]
    pub current_value: Option<i32>,
    #[doc = "Fully qualified resource Id"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "Usage quota limit"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub limit: Option<i32>,
    #[doc = "Quota name"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<serde_json::Value>,
    #[doc = "Quota usage unit."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub unit: Option<String>,
}
impl Usage {
...
#[doc = "List of usage information"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct UsageList {
    #[doc = "Collection of usage values."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
