...
#[doc = "The public Account Merge Info model."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AccountMergeInfo {
    #[doc = "The account location of the *other* account in the merge operation."]
    #[serde(rename = "accountLocation", default, skip_serializing_if = "Option::is_none")]
    pub account_location: Option<String>,
    #[doc = "The account name of the *other* account in the merge operation."]
    #[serde(rename = "accountName", default, skip_serializing_if = "Option::is_none")]
    pub account_name: Option<String>,
    #[doc = "The resource group name of the *other* account in the merge operation."]
    #[serde(rename = "accountResourceGroupName", default, skip_serializing_if = "Option::is_none")]
    pub account_resource_group_name: Option<String>,
    #[doc = "The subscription id of the *other* account in the merge operation."]
    #[serde(rename = "accountSubscriptionId", default, skip_serializing_if = "Option::is_none")]
    pub account_subscription_id: Option<String>,
    #[doc = "The deprovisioned status of the account.\r\nOnly applicable for the secondary account."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub deprovisioned: Option<bool>,
    #[doc = "The status of the merge operation."]
    #[serde(rename = "mergeStatus", default, skip_serializing_if = "Option::is_none")]
    pub merge_status: Option<account_merge_info::MergeStatus>,
    #[doc = "The account's type for the merge operation."]
    #[serde(rename = "typeOfAccount", default, skip_serializing_if = "Option::is_none")]
    pub type_of_account: Option<account_merge_info::TypeOfAccount>,
}
impl AccountMergeInfo {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod account_merge_info {
    use super::*;
    #[doc = "The status of the merge operation."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "MergeStatus")]
    ...
    impl Serialize for MergeStatus {
        ...
        {
            match self {
                Self::Succeeded => serializer.serialize_unit_variant("MergeStatus", 0u32, "Succeeded"),
                Self::Failed => serializer.serialize_unit_variant("MergeStatus", 1u32, "Failed"),
                Self::InProgress => serializer.serialize_unit_variant("MergeStatus", 2u32, "InProgress"),
    ...
    #[doc = "The account's type for the merge operation."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "TypeOfAccount")]
    pub enum TypeOfAccount {
        Primary,
        Secondary,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for TypeOfAccount {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for TypeOfAccount {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for TypeOfAccount {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Primary => serializer.serialize_unit_variant("TypeOfAccount", 0u32, "Primary"),
                Self::Secondary => serializer.serialize_unit_variant("TypeOfAccount", 1u32, "Secondary"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct AccountProperties {
    ...
    #[doc = "Gets the default domain in the account."]
    ...
    #[doc = "The public Account Merge Info model."]
    #[serde(rename = "mergeInfo", default, skip_serializing_if = "Option::is_none")]
    ...
    #[doc = "Gets or sets the state of tenant endpoint."]
    #[serde(rename = "tenantEndpointState", default, skip_serializing_if = "Option::is_none")]
    pub tenant_endpoint_state: Option<account_properties::TenantEndpointState>,
}
...
pub mod account_properties {
    ...
    #[doc = "Gets or sets the state of tenant endpoint."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "TenantEndpointState")]
    pub enum TenantEndpointState {
        NotSpecified,
        Disabled,
        Enabled,
        #[serde(skip_deserializing)]
    ...
    impl FromStr for TenantEndpointState {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for TenantEndpointState {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for TenantEndpointState {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::NotSpecified => serializer.serialize_unit_variant("TenantEndpointState", 0u32, "NotSpecified"),
                Self::Disabled => serializer.serialize_unit_variant("TenantEndpointState", 1u32, "Disabled"),
                Self::Enabled => serializer.serialize_unit_variant("TenantEndpointState", 2u32, "Enabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
