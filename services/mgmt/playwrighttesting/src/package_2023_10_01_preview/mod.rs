...
pub mod quotas {
    ...
    impl Client {
        ...
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `location`: The location of quota in ARM Normalized format like eastus, southeastasia etc."]
        #[doc = "* `name`: The quota name."]
        pub fn get(&self, subscription_id: impl Into<String>, location: impl Into<String>, name: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                location: location.into(),
