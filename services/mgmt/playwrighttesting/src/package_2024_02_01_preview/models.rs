...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AccountFreeTrialProperties {
...
impl AccountFreeTrialProperties {
    pub fn new(
...
#[doc = "The response of a Account list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AccountListResult {
    #[doc = "The Account items on this page"]
...
pub struct AccountProperties {
    ...
    pub regional_affinity: Option<account_properties::RegionalAffinity>,
    ...
    #[serde(rename = "scalableExecution", default, skip_serializing_if = "Option::is_none")]
    pub scalable_execution: Option<account_properties::ScalableExecution>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub reporting: Option<account_properties::Reporting>,
...
pub mod account_properties {
    ...
    #[doc = "This property sets the connection region for Playwright client workers to cloud-hosted browsers. If enabled, workers connect to browsers in the closest Azure region, ensuring lower latency. If disabled, workers connect to browsers in the Azure region in which the workspace was initially created."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "RegionalAffinity")]
    pub enum RegionalAffinity {
        Enabled,
        Disabled,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for RegionalAffinity {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for RegionalAffinity {
    ...
    impl Serialize for RegionalAffinity {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("RegionalAffinity", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("RegionalAffinity", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for RegionalAffinity {
        fn default() -> Self {
            Self::Enabled
        }
    }
    #[doc = "When enabled, Playwright client workers can connect to cloud-hosted browsers. This can increase the number of parallel workers for a test run, significantly minimizing test completion durations."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ScalableExecution")]
    pub enum ScalableExecution {
        Enabled,
        Disabled,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for ScalableExecution {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for ScalableExecution {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for ScalableExecution {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("ScalableExecution", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("ScalableExecution", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for ScalableExecution {
        fn default() -> Self {
            Self::Enabled
        }
    }
    ...
    impl Serialize for Reporting {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("Reporting", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("Reporting", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct AccountQuota {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<AccountQuotaProperties>,
}
impl AccountQuota {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "The response of a AccountQuota list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AccountQuotaListResult {
    #[doc = "The AccountQuota items on this page"]
    pub value: Vec<AccountQuota>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for AccountQuotaListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl AccountQuotaListResult {
    pub fn new(value: Vec<AccountQuota>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "The Playwright service account quota resource properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AccountQuotaProperties {
    #[doc = "The Playwright service account quota resource free-trial properties."]
    #[serde(rename = "freeTrial", default, skip_serializing_if = "Option::is_none")]
    pub free_trial: Option<AccountFreeTrialProperties>,
    #[doc = "The status of the current operation."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<ProvisioningState>,
}
impl AccountQuotaProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct AccountUpdate {
    ...
    #[doc = "The updatable properties of the Account."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<AccountUpdateProperties>,
}
impl AccountUpdate {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "The updatable properties of the Account."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AccountUpdateProperties {
    #[doc = "This property sets the connection region for Playwright client workers to cloud-hosted browsers. If enabled, workers connect to browsers in the closest Azure region, ensuring lower latency. If disabled, workers connect to browsers in the Azure region in which the workspace was initially created."]
    #[serde(rename = "regionalAffinity", default, skip_serializing_if = "Option::is_none")]
    pub regional_affinity: Option<account_update_properties::RegionalAffinity>,
    #[doc = "When enabled, Playwright client workers can connect to cloud-hosted browsers. This can increase the number of parallel workers for a test run, significantly minimizing test completion durations."]
    #[serde(rename = "scalableExecution", default, skip_serializing_if = "Option::is_none")]
    pub scalable_execution: Option<account_update_properties::ScalableExecution>,
    #[doc = "When enabled, this feature allows the workspace to upload and display test results, including artifacts like traces and screenshots, in the Playwright portal. This enables faster and more efficient troubleshooting."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub reporting: Option<account_update_properties::Reporting>,
}
impl AccountUpdateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod account_update_properties {
    use super::*;
    #[doc = "This property sets the connection region for Playwright client workers to cloud-hosted browsers. If enabled, workers connect to browsers in the closest Azure region, ensuring lower latency. If disabled, workers connect to browsers in the Azure region in which the workspace was initially created."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "RegionalAffinity")]
...
pub struct FreeTrialProperties {
    ...
    pub state: FreeTrialState,
}
impl FreeTrialProperties {
    pub fn new(account_id: String, state: FreeTrialState) -> Self {
        Self { account_id, state }
    }
}
#[doc = "The free-trial state."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "FreeTrialState")]
pub enum FreeTrialState {
    Active,
    Expired,
    NotEligible,
    NotRegistered,
...
impl FromStr for FreeTrialState {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for FreeTrialState {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for FreeTrialState {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Active => serializer.serialize_unit_variant("FreeTrialState", 0u32, "Active"),
            Self::Expired => serializer.serialize_unit_variant("FreeTrialState", 1u32, "Expired"),
            Self::NotEligible => serializer.serialize_unit_variant("FreeTrialState", 2u32, "NotEligible"),
            Self::NotRegistered => serializer.serialize_unit_variant("FreeTrialState", 3u32, "NotRegistered"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "The response of a Quota list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
impl azure_core::Continuable for QuotaListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl QuotaListResult {
...
pub struct QuotaProperties {
    #[doc = "The subscription quota resource free-trial properties."]
    #[serde(rename = "freeTrial", default, skip_serializing_if = "Option::is_none")]
    pub free_trial: Option<FreeTrialProperties>,
    #[doc = "The status of the current operation."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<ProvisioningState>,
}
