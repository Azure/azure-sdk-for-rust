...
#[doc = "List of Override Properties for the maintenance Configuration."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MaintenanceConfigurationOverrides {
    #[doc = "Override Properties for the maintenance Configuration."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub overrides: Vec<MaintenanceOverrideProperties>,
}
impl MaintenanceConfigurationOverrides {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct MaintenanceConfigurationProperties {
    ...
    #[doc = "List of Override Properties for the maintenance Configuration."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub overrides: Option<MaintenanceConfigurationOverrides>,
    ...
    impl Serialize for MaintenanceScope {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Resource => serializer.serialize_unit_variant("MaintenanceScope", 1u32, "Resource"),
                Self::OsImage => serializer.serialize_unit_variant("MaintenanceScope", 2u32, "OSImage"),
                Self::Extension => serializer.serialize_unit_variant("MaintenanceScope", 3u32, "Extension"),
                Self::InGuestPatch => serializer.serialize_unit_variant("MaintenanceScope", 4u32, "InGuestPatch"),
                Self::Sqldb => serializer.serialize_unit_variant("MaintenanceScope", 5u32, "SQLDB"),
                Self::SqlManagedInstance => serializer.serialize_unit_variant("MaintenanceScope", 6u32, "SQLManagedInstance"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Definition of a MaintenanceOverrideProperties"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MaintenanceOverrideProperties {
    ...
    #[doc = "Gets or sets overrideProperties of the maintenanceConfiguration"]
    #[serde(rename = "overrideProperties", default, skip_serializing_if = "Option::is_none")]
    pub override_properties: Option<serde_json::Value>,
}
impl MaintenanceOverrideProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
