...
impl Client {
    ...
    pub fn configuration_assignments_for_resource_group_client(&self) -> configuration_assignments_for_resource_group::Client {
        configuration_assignments_for_resource_group::Client(self.clone())
    }
    pub fn configuration_assignments_for_subscriptions_client(&self) -> configuration_assignments_for_subscriptions::Client {
        configuration_assignments_for_subscriptions::Client(self.clone())
    }
    ...
    pub fn scheduled_event_client(&self) -> scheduled_event::Client {
        scheduled_event::Client(self.clone())
    }
...
pub mod scheduled_event {
    ...
    impl Client {
        #[doc = "Post Scheduled Event Acknowledgement"]
        #[doc = ""]
        #[doc = "Arguments:"]
        ...
        #[doc = "* `resource_name`: Resource Name"]
        #[doc = "* `scheduled_event_id`: Scheduled Event Id. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000)"]
        pub fn acknowledge(
            &self,
            ...
            scheduled_event_id: impl Into<String>,
        ) -> acknowledge::RequestBuilder {
            acknowledge::RequestBuilder {
                client: self.0.clone(),
    ...
    pub mod acknowledge {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ScheduledEventApproveResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ScheduledEventApproveResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) scheduled_event_id: String,
        }
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url . set_path (& format ! ("/subscriptions/{}/resourcegroups/{}/providers/Microsoft.Compute/{}/{}/providers/Microsoft.Maintenance/scheduledevents/{}/acknowledge" , & self . subscription_id , & self . resource_group_name , & self . resource_type , & self . resource_name , & self . scheduled_event_id)) ;
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ScheduledEventApproveResponse>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ScheduledEventApproveResponse>>;
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.Maintenance/publicMaintenanceConfigurations/{}",
                    &self.subscription_id, &self.resource_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
...
pub mod apply_updates {
    ...
    impl Client {
        ...
        #[doc = "* `resource_type`: Resource type"]
        #[doc = "* `resource_name`: Resource identifier"]
        #[doc = "* `apply_update_name`: ApplyUpdate name"]
        #[doc = "* `apply_update`: The ApplyUpdate"]
        pub fn create_or_update_or_cancel(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            provider_name: impl Into<String>,
            ...
            resource_name: impl Into<String>,
            apply_update_name: impl Into<String>,
            apply_update: impl Into<models::ApplyUpdate>,
        ) -> create_or_update_or_cancel::RequestBuilder {
            create_or_update_or_cancel::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
                ...
                resource_name: resource_name.into(),
                apply_update_name: apply_update_name.into(),
                apply_update: apply_update.into(),
            }
        }
    ...
    pub mod create_or_update_or_cancel {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_name: String,
            pub(crate) apply_update_name: String,
            pub(crate) apply_update: models::ApplyUpdate,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        let req_body = azure_core::to_json(&this.apply_update)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
    ...
    pub mod create_or_update {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourcegroups/{}/providers/{}/{}/{}/providers/Microsoft.Maintenance/applyUpdates/default",
                    &self.subscription_id, &self.resource_group_name, &self.provider_name, &self.resource_type, &self.resource_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
...
pub mod configuration_assignments {
    ...
    impl Client {
        ...
        #[doc = "Get configuration assignment for resource.."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: Subscription credentials that uniquely identify a Microsoft Azure subscription. The subscription ID forms part of the URI for every service call."]
        #[doc = "* `resource_group_name`: Resource group name"]
    ...
    pub mod get_parent {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourcegroups/{}/providers/{}/{}/{}/{}/{}/providers/Microsoft.Maintenance/configurationAssignments/{}" , & self . subscription_id , & self . resource_group_name , & self . provider_name , & self . resource_parent_type , & self . resource_parent_name , & self . resource_type , & self . resource_name , & self . configuration_assignment_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-10-01-preview");
...
pub mod configuration_assignments_for_subscriptions {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    impl Client {
        ...
        #[doc = "* `subscription_id`: Subscription credentials that uniquely identify a Microsoft Azure subscription. The subscription ID forms part of the URI for every service call."]
        #[doc = "* `configuration_assignment_name`: Configuration assignment name"]
        pub fn get(&self, subscription_id: impl Into<String>, configuration_assignment_name: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                configuration_assignment_name: configuration_assignment_name.into(),
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.Maintenance/configurationAssignments/{}",
                    &self.subscription_id, &self.configuration_assignment_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
...
pub mod configuration_assignments_for_resource_group {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourcegroups/{}/providers/Microsoft.Maintenance/configurationAssignments/{}",
                    &self.subscription_id, &self.resource_group_name, &self.configuration_assignment_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
...
pub mod operations {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.Maintenance/operations",));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-10-01-preview");
