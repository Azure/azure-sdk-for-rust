    ...
    impl Serialize for Status {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::NoUpdatesPending => serializer.serialize_unit_variant("Status", 5u32, "NoUpdatesPending"),
                Self::Cancel => serializer.serialize_unit_variant("Status", 6u32, "Cancel"),
                Self::Cancelled => serializer.serialize_unit_variant("Status", 7u32, "Cancelled"),
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ConfigurationAssignmentFilterProperties {
...
impl ConfigurationAssignmentFilterProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ConfigurationAssignmentProperties {
    ...
    #[doc = "Azure query for the update configuration."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub filter: Option<ConfigurationAssignmentFilterProperties>,
}
...
#[doc = "Response of scheduled event acknowledge"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ScheduledEventApproveResponse {
    #[doc = "Successfully Approved"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub value: Option<String>,
}
impl ScheduledEventApproveResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
