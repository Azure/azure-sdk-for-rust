...
#[doc = "A list of Arc Sql Availability Group Databases."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ArcSqlAvailabilityGroupDatabasesListResult {
    #[doc = "Array of  Arc Sql Availability Group Database."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<SqlAvailabilityGroupDatabaseResource>,
    #[doc = "Link to retrieve next page of results."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ArcSqlAvailabilityGroupDatabasesListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone()
    }
}
impl ArcSqlAvailabilityGroupDatabasesListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "A list of Arc Sql Availability Group Replica."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ArcSqlAvailabilityGroupReplicaListResult {
    #[doc = "Array of  Arc Sql Availability Group Replica."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<SqlAvailabilityGroupReplicaResource>,
    #[doc = "Link to retrieve next page of results."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ArcSqlAvailabilityGroupReplicaListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone()
    }
}
impl ArcSqlAvailabilityGroupReplicaListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "A list of Arc Sql Server Availability Group."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ArcSqlServerAvailabilityGroupListResult {
    #[doc = "Array of  Arc Sql Server Availability Group."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
pub struct AvailabilityGroupConfigure {
    ...
    #[doc = "Availability Synchronization mode description of availability group replica."]
    #[serde(rename = "availabilityModeDesc", default, skip_serializing_if = "Option::is_none")]
    pub availability_mode_desc: Option<String>,
    #[doc = "failover mode description of the availability group replica."]
    #[serde(rename = "failoverModeDesc", default, skip_serializing_if = "Option::is_none")]
    pub failover_mode_desc: Option<String>,
    ...
    #[doc = "Allowed the connections for primary role of the availability group replica."]
    #[serde(rename = "primaryRoleAllowConnectionsDesc", default, skip_serializing_if = "Option::is_none")]
    pub primary_role_allow_connections_desc: Option<String>,
    #[doc = "Allowed the connections for secondary role of availability group replica."]
    #[serde(rename = "secondaryRoleAllowConnectionsDesc", default, skip_serializing_if = "Option::is_none")]
    pub secondary_role_allow_connections_desc: Option<String>,
    ...
    #[serde(rename = "modifyDate", default, with = "azure_core::date::rfc3339::option")]
    pub modify_date: Option<time::OffsetDateTime>,
    ...
    #[serde(rename = "seedingModeDesc", default, skip_serializing_if = "Option::is_none")]
    pub seeding_mode_desc: Option<String>,
}
...
pub struct AvailabilityGroupState {
    #[doc = "Role description of the availability group replica."]
    ...
    #[doc = "Operation state description of the availability group replica"]
    #[serde(rename = "operationalStateDesc", default, skip_serializing_if = "Option::is_none")]
    pub operational_state_desc: Option<String>,
    #[doc = "Recovery health description of the availability group replica."]
    #[serde(rename = "recoveryHealthDesc", default, skip_serializing_if = "Option::is_none")]
    pub recovery_health_desc: Option<String>,
    #[doc = "Synchronization health description of the availability group replica."]
    #[serde(rename = "synchronizationHealthDesc", default, skip_serializing_if = "Option::is_none")]
    pub synchronization_health_desc: Option<String>,
    #[doc = "Connected state description of the availability group replica."]
    #[serde(rename = "connectedStateDesc", default, skip_serializing_if = "Option::is_none")]
    pub connected_state_desc: Option<String>,
    #[doc = "Last connect error description of the availability group replica."]
    ...
    #[doc = "Last connect error time stamp of the availability group replica."]
...
#[doc = "A SqlAvailabilityGroup."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SqlAvailabilityGroup {
    #[serde(flatten)]
    pub tracked_resource: TrackedResource,
    #[doc = "Properties of SqlAvailabilityGroup."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct SqlAvailabilityGroupDatabaseReplicaResourceProperties {
    ...
    #[serde(rename = "synchronizationStateDesc", default, skip_serializing_if = "Option::is_none")]
    pub synchronization_state_desc: Option<String>,
    ...
    #[serde(rename = "databaseStateDesc", default, skip_serializing_if = "Option::is_none")]
    pub database_state_desc: Option<String>,
    ...
    #[serde(rename = "suspendReasonDesc", default, skip_serializing_if = "Option::is_none")]
    pub suspend_reason_desc: Option<String>,
...
#[doc = "Arc Sql Server Availability Group Database"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SqlAvailabilityGroupDatabaseResource {
    #[serde(flatten)]
    pub tracked_resource: TrackedResource,
    #[doc = "The properties of Arc Sql availability group multiple database replica resource"]
    pub properties: SqlAvailabilityGroupMultiDatabaseReplicaResourceProperties,
}
impl SqlAvailabilityGroupDatabaseResource {
    pub fn new(tracked_resource: TrackedResource, properties: SqlAvailabilityGroupMultiDatabaseReplicaResourceProperties) -> Self {
        Self {
            tracked_resource,
            properties,
        }
...
#[doc = "An update to Availability Group Database Replica resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SqlAvailabilityGroupDatabaseUpdate {
    #[doc = "Resource tags."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<serde_json::Value>,
    #[doc = "The properties of Arc Sql availability group multiple database replica resource"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<SqlAvailabilityGroupMultiDatabaseReplicaResourceProperties>,
}
impl SqlAvailabilityGroupDatabaseUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "A list of SqlAvailabilityGroup."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "The properties of Arc Sql availability group multiple database replica resource"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SqlAvailabilityGroupMultiDatabaseReplicaResourceProperties {
    #[doc = "ID GUID of the database for availability group."]
    #[serde(rename = "groupDatabaseId", default, skip_serializing_if = "Option::is_none")]
    pub group_database_id: Option<String>,
    #[doc = "Array of  Arc Sql Availability Group Database Replicas."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
impl SqlAvailabilityGroupMultiDatabaseReplicaResourceProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct SqlAvailabilityGroupProperties {
    #[doc = "The name of the availability group."]
    #[serde(rename = "availabilityGroupName")]
    pub availability_group_name: String,
    #[doc = "Id GUID of the availability group."]
    #[serde(rename = "availabilityGroupId")]
    pub availability_group_id: String,
    #[doc = "The name of the instance name which availability group primary is on."]
    ...
    #[serde(rename = "clusterTypeDesc", default, skip_serializing_if = "Option::is_none")]
    pub cluster_type_desc: Option<String>,
    #[doc = "Availability group required the number of synchronized secondary to commit."]
    #[serde(rename = "requiredSynchronizedSecondariesCommit", default, skip_serializing_if = "Option::is_none")]
    pub required_synchronized_secondaries_commit: Option<i64>,
...
impl SqlAvailabilityGroupProperties {
    pub fn new(availability_group_name: String, availability_group_id: String) -> Self {
        Self {
            ...
            required_synchronized_secondaries_commit: None,
            is_contained: None,
        }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SqlAvailabilityGroupReplicaResource {
    #[serde(flatten)]
    pub tracked_resource: TrackedResource,
    #[doc = "The properties of Arc Sql availability group replica resource"]
    pub properties: SqlAvailabilityGroupReplicaResourceProperties,
}
impl SqlAvailabilityGroupReplicaResource {
    pub fn new(tracked_resource: TrackedResource, properties: SqlAvailabilityGroupReplicaResourceProperties) -> Self {
        Self {
            tracked_resource,
            properties,
        }
...
#[doc = "An update to Availability Group Replica resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SqlAvailabilityGroupReplicaUpdate {
    #[doc = "Resource tags."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<serde_json::Value>,
    #[doc = "The properties of Arc Sql availability group replica resource"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<SqlAvailabilityGroupReplicaResourceProperties>,
}
impl SqlAvailabilityGroupReplicaUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "An update to a SQL Availability Group."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SqlAvailabilityGroupUpdate {
    #[doc = "Resource tags."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<serde_json::Value>,
}
impl SqlAvailabilityGroupUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct SqlServerAvailabilityGroupResourceProperties {
    ...
    #[serde(rename = "availabilityGroupId")]
    pub availability_group_id: String,
    #[doc = "the availability group name."]
...
impl SqlServerAvailabilityGroupResourceProperties {
    pub fn new(availability_group_id: String) -> Self {
        Self {
            availability_group_id,
