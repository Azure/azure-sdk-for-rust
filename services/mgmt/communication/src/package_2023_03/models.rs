...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SenderUsernameProperties {
    ...
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<sender_username_properties::ProvisioningState>,
}
impl SenderUsernameProperties {
...
pub mod sender_username_properties {
    use super::*;
    #[doc = "Provisioning state of the resource. Unknown is the default state for Communication Services."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ProvisioningState")]
...
impl SenderUsernameResource {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "A class representing a Domains SenderUsernames collection."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SenderUsernameResourceCollection {
    #[doc = "List of SenderUsernames"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<SenderUsernameResource>,
    #[doc = "The URL the client should use to fetch the next page (per server side paging)."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for SenderUsernameResourceCollection {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone()
    }
}
impl SenderUsernameResourceCollection {
    pub fn new() -> Self {
        Self::default()
    }
}
