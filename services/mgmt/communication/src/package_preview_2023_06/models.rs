...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SuppressionListAddressProperties {
...
impl SuppressionListAddressProperties {
...
#[doc = "A object that represents a SuppressionList record."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SuppressionListAddressResource {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "A class that describes the properties of a SuppressionListAddress resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<SuppressionListAddressProperties>,
}
impl SuppressionListAddressResource {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Collection of addresses in a suppression list. Response will include a nextLink if response contains more pages."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SuppressionListAddressResourceCollection {
    #[doc = "List of suppressed email addresses."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<SuppressionListAddressResource>,
    #[doc = "The URL the client should use to fetch the next page (per server side paging)."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for SuppressionListAddressResourceCollection {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl SuppressionListAddressResourceCollection {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SuppressionListProperties {
...
impl SuppressionListProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "A class representing a SuppressionList resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SuppressionListResource {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "A class that describes the properties of a SuppressionList resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<SuppressionListProperties>,
}
impl SuppressionListResource {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "A class representing a Domains SuppressionListResource collection."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SuppressionListResourceCollection {
    #[doc = "List of SuppressionListResource"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<SuppressionListResource>,
    #[doc = "The URL the client should use to fetch the next page (per server side paging)."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for SuppressionListResourceCollection {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl SuppressionListResourceCollection {
    pub fn new() -> Self {
        Self::default()
    }
}
