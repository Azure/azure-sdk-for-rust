...
pub use package_preview_2022_07::{models, operations, operations::Client, operations::ClientBuilder};
...
pub use package_2020_08_20_preview::{models, operations, operations::Client, operations::ClientBuilder};
#[cfg(feature = "package-2020-08-20")]
pub mod package_2020_08_20;
#[cfg(all(feature = "package-2020-08-20", not(feature = "no-default-tag")))]
pub use package_2020_08_20::{models, operations, operations::Client, operations::ClientBuilder};
