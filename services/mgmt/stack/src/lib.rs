...
pub use package_preview_2020_06::{models, operations, operations::Client, operations::ClientBuilder};
#[cfg(feature = "package-2017-06-01")]
pub mod package_2017_06_01;
#[cfg(all(feature = "package-2017-06-01", not(feature = "no-default-tag")))]
pub use package_2017_06_01::{models, operations, operations::Client, operations::ClientBuilder};
#[cfg(feature = "package-2016-01")]
pub mod package_2016_01;
#[cfg(all(feature = "package-2016-01", not(feature = "no-default-tag")))]
pub use package_2016_01::{models, operations, operations::Client, operations::ClientBuilder};
