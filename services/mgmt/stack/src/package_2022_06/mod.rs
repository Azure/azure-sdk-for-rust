...
impl Client {
    ...
    pub fn deployment_license_client(&self) -> deployment_license::Client {
        deployment_license::Client(self.clone())
    }
...
pub mod deployment_license {
    use super::models;
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Creates a license that can be used to deploy an Azure Stack device."]
        #[doc = ""]
        #[doc = "Arguments:"]
        ...
        #[doc = "* `deployment_license_request`: Request body for creating a deployment license."]
        pub fn create(
            &self,
            subscription_id: impl Into<String>,
            deployment_license_request: impl Into<models::DeploymentLicenseRequest>,
        ) -> create::RequestBuilder {
            create::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                deployment_license_request: deployment_license_request.into(),
            }
        }
    }
    pub mod create {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DeploymentLicenseResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DeploymentLicenseResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) deployment_license_request: models::DeploymentLicenseRequest,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        let url = azure_core::Url::parse(&format!(
                            "{}/subscriptions/{}/providers/Microsoft.AzureStack/generateDeploymentLicense",
                            this.client.endpoint(),
                        ...
                        let req_body = azure_core::to_json(&this.deployment_license_request)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DeploymentLicenseResponse>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::DeploymentLicenseResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
