...
pub struct ResubscribeProperties {
    ...
    #[doc = "Newly selected term Id to create the new Marketplace subscription for Resubscribe"]
    ...
    #[doc = "Organization Id of the NewRelic Organization that needs to be resubscribed"]
    #[serde(rename = "organizationId", default, skip_serializing_if = "Option::is_none")]
    pub organization_id: Option<String>,
    #[doc = "Publisher Id of the NewRelic offer that needs to be resubscribed"]
    #[serde(rename = "publisherId", default, skip_serializing_if = "Option::is_none")]
    pub publisher_id: Option<String>,
    #[doc = "Offer Id of the NewRelic offer that needs to be resubscribed"]
    #[serde(rename = "offerId", default, skip_serializing_if = "Option::is_none")]
    pub offer_id: Option<String>,
}
