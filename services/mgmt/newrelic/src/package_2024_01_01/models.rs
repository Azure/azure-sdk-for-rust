...
pub struct ConnectedPartnerResourceProperties {
    #[doc = "NewRelic account name"]
    #[serde(rename = "accountName", default, skip_serializing_if = "Option::is_none")]
    pub account_name: Option<String>,
    #[doc = "NewRelic Account Id"]
    #[serde(rename = "accountId", default, skip_serializing_if = "Option::is_none")]
    pub account_id: Option<String>,
...
#[doc = " List of all active newrelic deployments."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct MarketplaceSaaSInfo {
    ...
    #[serde(rename = "marketplaceSubscriptionName", default, skip_serializing_if = "Option::is_none")]
    pub marketplace_subscription_name: Option<String>,
...
#[doc = "The list of subscriptions and it's monitoring status by current NewRelic monitor."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "The request to update subscriptions needed to be monitored by the NewRelic monitor resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct PartnerBillingEntity {
    #[doc = "The New Relic Organization Id."]
    #[serde(rename = "organizationId", default, skip_serializing_if = "Option::is_none")]
    pub organization_id: Option<String>,
    #[doc = "The New Relic Organization Name."]
    #[serde(rename = "organizationName", default, skip_serializing_if = "Option::is_none")]
    pub organization_name: Option<String>,
}
...
pub struct SubscriptionList {
    ...
    #[serde(rename = "patchOperation", default, skip_serializing_if = "Option::is_none")]
    pub patch_operation: Option<subscription_list::PatchOperation>,
...
pub mod subscription_list {
    ...
    impl Serialize for PatchOperation {
        ...
        {
            match self {
                Self::AddBegin => serializer.serialize_unit_variant("PatchOperation", 0u32, "AddBegin"),
                Self::AddComplete => serializer.serialize_unit_variant("PatchOperation", 1u32, "AddComplete"),
                Self::DeleteBegin => serializer.serialize_unit_variant("PatchOperation", 2u32, "DeleteBegin"),
                Self::DeleteComplete => serializer.serialize_unit_variant("PatchOperation", 3u32, "DeleteComplete"),
                Self::Active => serializer.serialize_unit_variant("PatchOperation", 4u32, "Active"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
