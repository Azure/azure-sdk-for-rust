...
impl AddonSrmProperties {
    pub fn new(addon_properties: AddonProperties, license_key: String) -> Self {
        Self {
            addon_properties,
            license_key,
        }
...
pub mod workload_network_port_mirroring_properties {
    ...
    impl Serialize for Direction {
        ...
        {
            match self {
                Self::IngressEgressBidirectional => serializer.serialize_unit_variant("Direction", 0u32, "INGRESS, EGRESS, BIDIRECTIONAL"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for Status {
        ...
        {
            match self {
                Self::SuccessFailure => serializer.serialize_unit_variant("Status", 0u32, "SUCCESS, FAILURE"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub mod workload_network_virtual_machine_properties {
    ...
    impl Serialize for VmType {
        ...
        {
            match self {
                Self::RegularEdgeService => serializer.serialize_unit_variant("VmType", 0u32, "REGULAR, EDGE, SERVICE"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
