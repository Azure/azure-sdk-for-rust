...
pub struct ContainerGroupInstanceCountSummary {
    #[doc = "The count of pooled resources in each state."]
    #[serde(rename = "instanceCountsByState")]
    pub instance_counts_by_state: Vec<PoolResourceStateCount>,
}
impl ContainerGroupInstanceCountSummary {
    pub fn new(instance_counts_by_state: Vec<PoolResourceStateCount>) -> Self {
        Self { instance_counts_by_state }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct StandbyContainerGroupPoolRuntimeViewResource {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Contains information about a standby pool as last known by the StandbyPool resource provider."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<StandbyContainerGroupPoolRuntimeViewResourceProperties>,
}
impl StandbyContainerGroupPoolRuntimeViewResource {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The response of a StandbyContainerGroupPoolRuntimeViewResource list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct StandbyContainerGroupPoolRuntimeViewResourceListResult {
    #[doc = "The StandbyContainerGroupPoolRuntimeViewResource items on this page"]
    pub value: Vec<StandbyContainerGroupPoolRuntimeViewResource>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for StandbyContainerGroupPoolRuntimeViewResourceListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl StandbyContainerGroupPoolRuntimeViewResourceListResult {
    pub fn new(value: Vec<StandbyContainerGroupPoolRuntimeViewResource>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Contains information about a standby pool as last known by the StandbyPool resource provider."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct StandbyContainerGroupPoolRuntimeViewResourceProperties {
    ...
    #[serde(rename = "instanceCountSummary")]
    pub instance_count_summary: Vec<ContainerGroupInstanceCountSummary>,
    #[doc = "Provisioning state"]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<ProvisioningState>,
}
impl StandbyContainerGroupPoolRuntimeViewResourceProperties {
    pub fn new(instance_count_summary: Vec<ContainerGroupInstanceCountSummary>) -> Self {
        Self {
...
pub struct StandbyVirtualMachinePoolElasticityProfile {
    ...
    #[serde(rename = "minReadyCapacity", default, skip_serializing_if = "Option::is_none")]
    pub min_ready_capacity: Option<i64>,
}
impl StandbyVirtualMachinePoolElasticityProfile {
    pub fn new(max_ready_capacity: i64) -> Self {
        Self {
            max_ready_capacity,
            min_ready_capacity: None,
        }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct StandbyVirtualMachinePoolRuntimeViewResource {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Contains information about a standby pool as last known by the StandbyPool resource provider."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<StandbyVirtualMachinePoolRuntimeViewResourceProperties>,
}
impl StandbyVirtualMachinePoolRuntimeViewResource {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The response of a StandbyVirtualMachinePoolRuntimeViewResource list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct StandbyVirtualMachinePoolRuntimeViewResourceListResult {
    #[doc = "The StandbyVirtualMachinePoolRuntimeViewResource items on this page"]
    pub value: Vec<StandbyVirtualMachinePoolRuntimeViewResource>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for StandbyVirtualMachinePoolRuntimeViewResourceListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl StandbyVirtualMachinePoolRuntimeViewResourceListResult {
    pub fn new(value: Vec<StandbyVirtualMachinePoolRuntimeViewResource>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Contains information about a standby pool as last known by the StandbyPool resource provider."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct StandbyVirtualMachinePoolRuntimeViewResourceProperties {
    ...
    #[serde(rename = "instanceCountSummary")]
    pub instance_count_summary: Vec<VirtualMachineInstanceCountSummary>,
    #[doc = "Provisioning state"]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<ProvisioningState>,
}
impl StandbyVirtualMachinePoolRuntimeViewResourceProperties {
    pub fn new(instance_count_summary: Vec<VirtualMachineInstanceCountSummary>) -> Self {
        Self {
            instance_count_summary,
            provisioning_state: None,
        }
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct VirtualMachineInstanceCountSummary {
...
impl VirtualMachineInstanceCountSummary {
    pub fn new(instance_counts_by_state: Vec<PoolResourceStateCount>) -> Self {
        Self {
            zone: None,
            instance_counts_by_state,
        }
    }
}
#[doc = "State of standby virtual machines"]
