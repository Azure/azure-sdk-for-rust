...
#[doc = "List operation response containing list of Datadog Hosts."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DatadogHostListResponse {
    #[doc = "List operation results containing list of Datadog Hosts."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
#[doc = "Specify the Datadog organization name. In the case of linking to existing organizations, Id, ApiKey, and Applicationkey is required as well."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DatadogOrganizationProperties {
    ...
    #[doc = "The configuration which describes the state of cloud security posture management. This collects configuration information for all resources in a subscription and track conformance to industry benchmarks."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cspm: Option<bool>,
}
...
pub struct IdentityProperties {
    ...
    #[doc = "Specifies the identity type of the Datadog Monitor. At this time the only allowed value is 'SystemAssigned'."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
...
pub struct MonitorProperties {
    ...
    #[doc = "Includes name, email and optionally, phone number. User Information can't be null."]
...
pub struct MonitorUpdateProperties {
    ...
    #[serde(rename = "monitoringStatus", default, skip_serializing_if = "Option::is_none")]
    pub monitoring_status: Option<MonitoringStatus>,
    #[doc = "The new cloud security posture management value of the monitor resource. This collects configuration information for all resources in a subscription and track conformance to industry benchmarks."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cspm: Option<bool>,
}
...
pub struct MonitoringTagRulesProperties {
    ...
    #[doc = "Configuration to enable/disable auto-muting flag"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub automuting: Option<bool>,
}
...
pub struct ResourceSku {
    #[doc = "Name of the SKU in {PlanId} format. For Terraform, the only allowed value is 'linking'."]
    pub name: String,
}
impl ResourceSku {
