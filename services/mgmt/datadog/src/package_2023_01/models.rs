...
use std::str::FromStr;
#[doc = "Datadog resource can be created or not properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CreateResourceSupportedProperties {
    #[doc = "The ARM id of the subscription."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Indicates if selected subscription supports Datadog resource creation, if not it is already being monitored for the selected organization via multi subscription feature. "]
    #[serde(rename = "creationSupported", default, skip_serializing_if = "Option::is_none")]
    pub creation_supported: Option<bool>,
}
impl CreateResourceSupportedProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Datadog resource can be created or not."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CreateResourceSupportedResponse {
    #[doc = "Datadog resource can be created or not properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<CreateResourceSupportedProperties>,
}
impl CreateResourceSupportedResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CreateResourceSupportedResponseList {
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<CreateResourceSupportedResponse>,
}
impl azure_core::Continuable for CreateResourceSupportedResponseList {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        None
    }
}
impl CreateResourceSupportedResponseList {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct DatadogHost {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "The aliases for the host installed via the Datadog agent."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
#[doc = "The list of subscriptions and it's monitoring status by current Datadog monitor."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "The request to update subscriptions needed to be monitored by the Datadog monitor resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
