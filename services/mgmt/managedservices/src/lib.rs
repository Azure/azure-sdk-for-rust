...
pub use package_2019_09::{models, operations, operations::Client, operations::ClientBuilder};
...
pub use package_2019_04_preview::{models, operations, operations::Client, operations::ClientBuilder};
