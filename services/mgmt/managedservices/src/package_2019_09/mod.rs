...
pub mod marketplace_registration_definitions {
    ...
    impl Client {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `scope`: Scope of the resource."]
        #[doc = "* `marketplace_identifier`: Market place identifier. Expected Formats - {publisher}.{product[-preview]}.{planName}.{version} or {publisher}.{product[-preview]}.{planName} or {publisher}.{product[-preview]} or {publisher})."]
