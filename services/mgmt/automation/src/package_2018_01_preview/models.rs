...
#[doc = "object returned when requesting a collection of software update configuration"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
impl CollectionItemUpdateConfiguration {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl SoftareUpdateConfigurationRunTaskProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl SoftareUpdateConfigurationRunTasks {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl SoftwareUpdateConfigurationProperties {
    pub fn new(update_configuration: UpdateConfiguration, schedule_info: ScheduleProperties) -> Self {
        Self {
