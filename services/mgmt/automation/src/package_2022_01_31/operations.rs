...
pub enum Error {
    #[error(transparent)]
    PrivateEndpointConnections_ListByAutomationAccount(#[from] private_endpoint_connections::list_by_automation_account::Error),
    #[error(transparent)]
    ...
    #[error(transparent)]
    PrivateLinkResources_Automation(#[from] private_link_resources::automation::Error),
    #[error(transparent)]
    ...
    #[error(transparent)]
    HybridRunbookWorkerGroup_Create(#[from] hybrid_runbook_worker_group::create::Error),
    #[error(transparent)]
    ...
    #[error(transparent)]
    ConvertGraphRunbookContent(#[from] convert_graph_runbook_content::Error),
    #[error(transparent)]
    ...
    #[error(transparent)]
    HybridRunbookWorkers_Get(#[from] hybrid_runbook_workers::get::Error),
    #[error(transparent)]
    HybridRunbookWorkers_Create(#[from] hybrid_runbook_workers::create::Error),
    #[error(transparent)]
    HybridRunbookWorkers_Delete(#[from] hybrid_runbook_workers::delete::Error),
    #[error(transparent)]
    HybridRunbookWorkers_Move(#[from] hybrid_runbook_workers::move_::Error),
    #[error(transparent)]
    HybridRunbookWorkers_ListByHybridRunbookWorkerGroup(#[from] hybrid_runbook_workers::list_by_hybrid_runbook_worker_group::Error),
    #[error(transparent)]
    DeletedAutomationAccounts_ListBySubscription(#[from] deleted_automation_accounts::list_by_subscription::Error),
}
            ...
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<Response, Error>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req_builder = req_builder.header("content-type", "application/json");
                        let req_body =
                            azure_core::to_json(&this.hybrid_runbook_worker_group_creation_parameters).map_err(Error::Serialize)?;
                        req_builder = req_builder.uri(url.as_str());
                        let req = req_builder.body(req_body).map_err(Error::BuildRequest)?;
                        let rsp = this.client.send(req).await.map_err(Error::SendRequest)?;
                        let (rsp_status, rsp_headers, rsp_stream) = rsp.deconstruct();
            ...
            Box::pin({
                ...
                async move {
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                            let rsp_value: models::GraphicalRunbookContent =
                                serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                            Ok(rsp_value)
                        }
                        status_code => {
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        match rsp_status {
                            http::StatusCode::OK => {
                                let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                                let rsp_value: models::HybridRunbookWorker =
                                    serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                                Ok(rsp_value)
                            }
                            status_code => {
            ...
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<Response, Error>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        url.query_pairs_mut().append_pair("api-version", "2021-06-22");
                        req_builder = req_builder.header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.hybrid_runbook_worker_creation_parameters).map_err(Error::Serialize)?;
                        req_builder = req_builder.uri(url.as_str());
                        let req = req_builder.body(req_body).map_err(Error::BuildRequest)?;
                        let rsp = this.client.send(req).await.map_err(Error::SendRequest)?;
                        let (rsp_status, rsp_headers, rsp_stream) = rsp.deconstruct();
            ...
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<Response, Error>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        url.query_pairs_mut().append_pair("api-version", "2021-06-22");
                        req_builder = req_builder.header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.hybrid_runbook_worker_move_parameters).map_err(Error::Serialize)?;
                        req_builder = req_builder.uri(url.as_str());
                        let req = req_builder.body(req_body).map_err(Error::BuildRequest)?;
                        let rsp = this.client.send(req).await.map_err(Error::SendRequest)?;
                        let (rsp_status, rsp_headers, rsp_stream) = rsp.deconstruct();
                ...
                let make_request = move |continuation: Option<azure_core::prelude::Continuation>| {
                    ...
                    async move {
                        ...
                        match rsp_status {
                            http::StatusCode::OK => {
                                let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                                let rsp_value: models::HybridRunbookWorkersListResult =
                                    serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                                Ok(rsp_value)
                            }
                            status_code => {
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        let token_response = credential
                            ...
                            .map_err(Error::GetToken)?;
                        req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
                        url.query_pairs_mut().append_pair("api-version", "2022-01-31");
                        let req_body = azure_core::EMPTY_BODY;
                        req_builder = req_builder.uri(url.as_str());
                        let req = req_builder.body(req_body).map_err(Error::BuildRequest)?;
                        let rsp = this.client.send(req).await.map_err(Error::SendRequest)?;
                        ...
                        match rsp_status {
                            http::StatusCode::OK => {
                                let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                                let rsp_value: models::DeletedAutomationAccountListResult =
                                    serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                                Ok(rsp_value)
                            }
                            status_code => {
