...
pub struct ContentLink {
    #[doc = "Gets or sets the uri of content."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Gets or sets default packages of Runtime Environment."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DefaultPackages {}
impl DefaultPackages {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Definition of deleted runbook."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DeletedRunbook {
    #[doc = "Definition of the deleted runbook property."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<DeletedRunbookProperties>,
    #[doc = "The resource id."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "Gets or sets name of the resource."]
...
#[doc = "The response model for the list deleted runbook."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DeletedRunbookListResult {
    #[doc = "List of deleted runbooks in automation account."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<DeletedRunbook>,
    #[doc = "Gets or sets the next link."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for DeletedRunbookListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl DeletedRunbookListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Definition of the deleted runbook property."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DeletedRunbookProperties {
    #[doc = "Gets or sets the Runbook Id."]
    #[serde(rename = "runbookId", default, skip_serializing_if = "Option::is_none")]
    pub runbook_id: Option<String>,
    #[doc = "Type of the runbook."]
    #[serde(rename = "runbookType", default, skip_serializing_if = "Option::is_none")]
    pub runbook_type: Option<String>,
    #[doc = "Gets or sets runtime of the runbook."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub runtime: Option<String>,
    #[doc = "Environment of the runbook."]
    #[serde(rename = "runtimeEnvironment", default, skip_serializing_if = "Option::is_none")]
...
pub struct HybridRunbookWorkerCreateParameters {
    #[doc = "The parameters supplied to the create or update hybrid runbook worker operation."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<HybridRunbookWorkerCreateOrUpdateParameters>,
    #[doc = "Gets or sets the name of the resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
...
pub struct JobCollectionItemProperties {
    ...
    #[doc = "The runbook property associated with the entity."]
    #[serde(rename = "jobRuntimeEnvironment", default, skip_serializing_if = "Option::is_none")]
    pub job_runtime_environment: Option<JobRuntimeEnvironment>,
...
#[doc = "The runbook property associated with the entity."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct JobRuntimeEnvironment {
    #[doc = "Name of Runtime Environment."]
    #[serde(rename = "runtimeEnvironmentName", default, skip_serializing_if = "Option::is_none")]
    pub runtime_environment_name: Option<String>,
}
impl JobRuntimeEnvironment {
    pub fn new() -> Self {
        Self::default()
    }
}
    ...
    impl Serialize for ProvisioningState {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Cancelled => serializer.serialize_unit_variant("ProvisioningState", 14u32, "Cancelled"),
...
#[doc = "Definition of the Package type."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct Package {
    #[serde(flatten)]
    pub tracked_resource: TrackedResource,
    #[doc = "Definition of the package property type."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "The parameters supplied to the create or update package operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct PackageCreateOrUpdateParameters {
    #[doc = "The parameters supplied to the create or update package properties."]
    pub properties: PackageCreateOrUpdateProperties,
    #[doc = "The resource model definition for an Azure Resource Manager tracked top level resource which has 'tags' and a 'location'"]
    #[serde(rename = "allOf", default, skip_serializing_if = "Option::is_none")]
    pub all_of: Option<TrackedResource>,
}
impl PackageCreateOrUpdateParameters {
    pub fn new(properties: PackageCreateOrUpdateProperties) -> Self {
        Self { properties, all_of: None }
    }
}
#[doc = "The parameters supplied to the create or update package properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct PackageCreateOrUpdateProperties {
    #[doc = "Definition of the content link."]
    #[serde(rename = "contentLink")]
    pub content_link: ContentLink,
}
impl PackageCreateOrUpdateProperties {
    pub fn new(content_link: ContentLink) -> Self {
        Self { content_link }
    }
}
#[doc = "Definition of the package error info type."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PackageErrorInfo {
    #[doc = "Package import error code."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub code: Option<String>,
    #[doc = "Package import error message."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub message: Option<String>,
}
impl PackageErrorInfo {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The response model for the list runtime environments operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PackageListResult {
    #[doc = "list of the Packages of the runtime environment."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
pub struct PackageProperties {
    #[doc = "Gets or sets the isGlobal flag of the package."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub default: Option<bool>,
    #[doc = "Gets or sets the version of the Package."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub version: Option<String>,
    #[doc = "Gets or sets the size in bytes of the Package."]
    #[serde(rename = "sizeInBytes", default, skip_serializing_if = "Option::is_none")]
    pub size_in_bytes: Option<i64>,
    #[doc = "Gets or sets the provisioning state of the Package."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<package_properties::ProvisioningState>,
    #[doc = "Definition of the content link."]
    #[serde(rename = "contentLink", default, skip_serializing_if = "Option::is_none")]
    pub content_link: Option<ContentLink>,
    #[doc = "Definition of the package error info type."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub error: Option<PackageErrorInfo>,
    #[doc = "Metadata pertaining to creation and last modification of the resource."]
    #[serde(rename = "allOf", default, skip_serializing_if = "Option::is_none")]
    pub all_of: Option<SystemData>,
}
...
#[doc = "The parameters supplied to the update package operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PackageUpdateParameters {
    #[doc = "The parameters supplied to the update properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<PackageUpdateProperties>,
    #[doc = "The resource model definition for an Azure Resource Manager tracked top level resource which has 'tags' and a 'location'"]
    #[serde(rename = "allOf", default, skip_serializing_if = "Option::is_none")]
    pub all_of: Option<TrackedResource>,
}
...
#[doc = "The parameters supplied to the update properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PackageUpdateProperties {
    #[doc = "Definition of the content link."]
    #[serde(rename = "contentLink", default, skip_serializing_if = "Option::is_none")]
    pub content_link: Option<ContentLink>,
}
impl PackageUpdateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
    ...
    impl Serialize for RunbookType {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Python => serializer.serialize_unit_variant("RunbookType", 8u32, "Python"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct RunbookProperties {
    #[doc = "Runtime Environment of the runbook execution."]
    #[serde(rename = "runtimeEnvironment", default, skip_serializing_if = "Option::is_none")]
    pub runtime_environment: Option<String>,
    #[doc = "Gets or sets the type of the runbook."]
    #[serde(rename = "runbookType", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Definition of the Runtime Environment type."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RuntimeEnvironment {
    #[serde(flatten)]
    pub tracked_resource: TrackedResource,
    #[doc = "Runtime Environment properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<RuntimeEnvironmentProperties>,
    #[doc = "Metadata pertaining to creation and last modification of the resource."]
    #[serde(rename = "systemData", default, skip_serializing_if = "Option::is_none")]
    pub system_data: Option<SystemData>,
}
...
#[doc = "List of all the  Runtime Environments of automation account."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RuntimeEnvironmentListResult {
    #[doc = "list of RuntimeEnvironment."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<RuntimeEnvironment>,
    #[doc = "Gets or sets the next link."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for RuntimeEnvironmentListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl RuntimeEnvironmentListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Runtime Environment properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RuntimeEnvironmentProperties {
    #[doc = "Runtime properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub runtime: Option<RuntimeProperties>,
    #[doc = "Gets or sets default packages of Runtime Environment."]
    #[serde(rename = "defaultPackages", default, skip_serializing_if = "Option::is_none")]
    pub default_packages: Option<DefaultPackages>,
    #[doc = "Gets or sets the description."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
}
impl RuntimeEnvironmentProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The parameters supplied to the update automation account operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RuntimeEnvironmentUpdateParameters {
    #[doc = "Gets or sets Runtime update properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<RuntimeEnvironmentUpdateProperties>,
    #[doc = "Metadata pertaining to creation and last modification of the resource."]
    #[serde(rename = "systemData", default, skip_serializing_if = "Option::is_none")]
    pub system_data: Option<SystemData>,
}
impl RuntimeEnvironmentUpdateParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Gets or sets Runtime update properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RuntimeEnvironmentUpdateProperties {
    #[doc = "Gets or sets default packages of Runtime Environment."]
    #[serde(rename = "defaultPackages", default, skip_serializing_if = "Option::is_none")]
    pub default_packages: Option<DefaultPackages>,
}
impl RuntimeEnvironmentUpdateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct RuntimeProperties {
    #[doc = "Language of Runtime Environment"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub language: Option<String>,
    #[doc = "Version of Language"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub version: Option<String>,
}
...
pub struct TestJobCreateParameters {
    ...
    #[serde(rename = "runOn", default, skip_serializing_if = "Option::is_none")]
    pub run_on: Option<String>,
    #[doc = "The runtime Environment Name on which job needs to be tested"]
    #[serde(rename = "runtimeEnvironment", default, skip_serializing_if = "Option::is_none")]
    pub runtime_environment: Option<String>,
}
