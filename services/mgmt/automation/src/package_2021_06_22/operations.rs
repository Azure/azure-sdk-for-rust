...
pub mod private_endpoint_connections {
    ...
    ) -> std::result::Result<PrivateEndpointConnectionListResult, list_by_automation_account::Error> {
...
pub mod private_link_resources {
    ...
    pub async fn automation(
        ...
        resource_group_name: &str,
        automation_account_name: &str,
    ) -> std::result::Result<PrivateLinkResourceListResult, automation::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
...
pub mod hybrid_runbook_worker_group {
    ...
    pub async fn create(
        ...
        subscription_id: &str,
    ) -> std::result::Result<HybridRunbookWorkerGroup, create::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Automation/automationAccounts/{}/hybridRunbookWorkerGroups/{}",
            operation_config.base_path(),
    ...
    pub async fn update(
        ...
        automation_account_name: &str,
        hybrid_runbook_worker_group_name: &str,
        parameters: &HybridRunbookWorkerGroupCreateOrUpdateParameters,
        subscription_id: &str,
...
pub async fn convert_graph_runbook_content(
...
) -> std::result::Result<GraphicalRunbookContent, convert_graph_runbook_content::Error> {
    let http_client = operation_config.http_client();
    let url_str = &format!(
    ...
    match rsp.status() {
        http::StatusCode::OK => {
            let rsp_body = rsp.body();
            let rsp_value: GraphicalRunbookContent = serde_json::from_slice(rsp_body)
...
pub mod hybrid_runbook_workers {
    ...
    pub async fn get(
        ...
        subscription_id: &str,
    ) -> std::result::Result<HybridRunbookWorker, get::Error> {
        let http_client = operation_config.http_client();
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: HybridRunbookWorker =
                    serde_json::from_slice(rsp_body).map_err(|source| get::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
    ...
    pub async fn create(
        ...
        subscription_id: &str,
    ) -> std::result::Result<HybridRunbookWorker, create::Error> {
        let http_client = operation_config.http_client();
        let url_str = & format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Automation/automationAccounts/{}/hybridRunbookWorkerGroups/{}/hybridRunbookWorkers/{}" , operation_config . base_path () , subscription_id , resource_group_name , automation_account_name , hybrid_runbook_worker_group_name , hybrid_runbook_worker_id) ;
        let mut url = url::Url::parse(url_str).map_err(create::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
    ...
    pub async fn list_by_hybrid_runbook_worker_group(
        ...
        filter: Option<&str>,
        subscription_id: &str,
    ) -> std::result::Result<HybridRunbookWorkersListResult, list_by_hybrid_runbook_worker_group::Error> {
        let http_client = operation_config.http_client();
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: HybridRunbookWorkersListResult = serde_json::from_slice(rsp_body)
