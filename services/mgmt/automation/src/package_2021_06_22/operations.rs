...
pub mod private_endpoint_connections {
    ...
    ) -> std::result::Result<models::PrivateEndpointConnectionListResult, list_by_automation_account::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Automation/automationAccounts/{}/privateEndpointConnections",
...
pub mod private_link_resources {
    ...
    pub async fn automation(
        ...
        resource_group_name: &str,
        automation_account_name: &str,
    ) -> std::result::Result<models::PrivateLinkResourceListResult, automation::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        let mut url = url::Url::parse(url_str).map_err(automation::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(automation::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder.body(req_body).map_err(automation::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(automation::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::PrivateLinkResourceListResult =
                    serde_json::from_slice(rsp_body).map_err(|source| automation::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                Err(automation::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
...
pub mod hybrid_runbook_worker_group {
    ...
    pub async fn create(
        ...
        automation_account_name: &str,
        hybrid_runbook_worker_group_name: &str,
        hybrid_runbook_worker_group_creation_parameters: &models::HybridRunbookWorkerGroupCreateOrUpdateParameters,
        subscription_id: &str,
    ) -> std::result::Result<models::HybridRunbookWorkerGroup, create::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Automation/automationAccounts/{}/hybridRunbookWorkerGroups/{}",
            operation_config.base_path(),
        ...
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        req_builder = req_builder.header("content-type", "application/json");
        let req_body = azure_core::to_json(hybrid_runbook_worker_group_creation_parameters).map_err(create::Error::SerializeError)?;
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder.body(req_body).map_err(create::Error::BuildRequestError)?;
        let rsp = http_client.execute_request(req).await.map_err(create::Error::ExecuteRequestError)?;
        match rsp.status() {
    ...
    pub async fn update(
        ...
        automation_account_name: &str,
        hybrid_runbook_worker_group_name: &str,
        parameters: &models::HybridRunbookWorkerGroupCreateOrUpdateParameters,
        subscription_id: &str,
...
pub mod dsc_configuration {
    ...
    pub async fn get_content(
        ...
        configuration_name: &str,
        subscription_id: &str,
    ) -> std::result::Result<String, get_content::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
...
pub mod job {
    ...
    ) -> std::result::Result<String, get_output::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
    ...
    pub async fn get_runbook_content(
        ...
        job_name: &str,
        client_request_id: Option<&str>,
    ) -> std::result::Result<String, get_runbook_content::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
...
pub async fn convert_graph_runbook_content(
    operation_config: &crate::OperationConfig,
    resource_group_name: &str,
    automation_account_name: &str,
    subscription_id: &str,
    parameters: &models::GraphicalRunbookContent,
) -> std::result::Result<models::GraphicalRunbookContent, convert_graph_runbook_content::Error> {
    let http_client = operation_config.http_client();
    let url_str = &format!(
    ...
    let mut url = url::Url::parse(url_str).map_err(convert_graph_runbook_content::Error::ParseUrlError)?;
    let mut req_builder = http::request::Builder::new();
    req_builder = req_builder.method(http::Method::POST);
    if let Some(token_credential) = operation_config.token_credential() {
        let token_response = token_credential
            .get_token(operation_config.token_credential_resource())
            .await
            .map_err(convert_graph_runbook_content::Error::GetTokenError)?;
        req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
    }
    url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
    req_builder = req_builder.header("content-type", "application/json");
    let req_body = azure_core::to_json(parameters).map_err(convert_graph_runbook_content::Error::SerializeError)?;
    req_builder = req_builder.uri(url.as_str());
    let req = req_builder
        .body(req_body)
        .map_err(convert_graph_runbook_content::Error::BuildRequestError)?;
    let rsp = http_client
        .execute_request(req)
        .await
        .map_err(convert_graph_runbook_content::Error::ExecuteRequestError)?;
    match rsp.status() {
        http::StatusCode::OK => {
            let rsp_body = rsp.body();
            let rsp_value: models::GraphicalRunbookContent = serde_json::from_slice(rsp_body)
                .map_err(|source| convert_graph_runbook_content::Error::DeserializeError(source, rsp_body.clone()))?;
            Ok(rsp_value)
        }
        status_code => {
            let rsp_body = rsp.body();
            let rsp_value: models::ErrorResponse = serde_json::from_slice(rsp_body)
                .map_err(|source| convert_graph_runbook_content::Error::DeserializeError(source, rsp_body.clone()))?;
            Err(convert_graph_runbook_content::Error::DefaultResponse {
                status_code,
                value: rsp_value,
            })
        }
...
pub mod hybrid_runbook_workers {
    ...
    pub async fn get(
        ...
        subscription_id: &str,
    ) -> std::result::Result<models::HybridRunbookWorker, get::Error> {
        let http_client = operation_config.http_client();
        let url_str = & format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Automation/automationAccounts/{}/hybridRunbookWorkerGroups/{}/hybridRunbookWorkers/{}" , operation_config . base_path () , subscription_id , resource_group_name , automation_account_name , hybrid_runbook_worker_group_name , hybrid_runbook_worker_id) ;
        let mut url = url::Url::parse(url_str).map_err(get::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
    ...
    pub async fn create(
        ...
        hybrid_runbook_worker_group_name: &str,
        hybrid_runbook_worker_id: &str,
        hybrid_runbook_worker_creation_parameters: &models::HybridRunbookWorkerCreateParameters,
        subscription_id: &str,
    ) -> std::result::Result<models::HybridRunbookWorker, create::Error> {
        let http_client = operation_config.http_client();
        let url_str = & format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Automation/automationAccounts/{}/hybridRunbookWorkerGroups/{}/hybridRunbookWorkers/{}" , operation_config . base_path () , subscription_id , resource_group_name , automation_account_name , hybrid_runbook_worker_group_name , hybrid_runbook_worker_id) ;
        let mut url = url::Url::parse(url_str).map_err(create::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        ...
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        req_builder = req_builder.header("content-type", "application/json");
        let req_body = azure_core::to_json(hybrid_runbook_worker_creation_parameters).map_err(create::Error::SerializeError)?;
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder.body(req_body).map_err(create::Error::BuildRequestError)?;
        let rsp = http_client.execute_request(req).await.map_err(create::Error::ExecuteRequestError)?;
        match rsp.status() {
    ...
    pub async fn move_(
        ...
        hybrid_runbook_worker_group_name: &str,
        hybrid_runbook_worker_id: &str,
        hybrid_runbook_worker_move_parameters: &models::HybridRunbookWorkerMoveParameters,
        subscription_id: &str,
    ) -> std::result::Result<(), move_::Error> {
        let http_client = operation_config.http_client();
        let url_str = & format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Automation/automationAccounts/{}/hybridRunbookWorkerGroups/{}/hybridRunbookWorkers/{}/move" , operation_config . base_path () , subscription_id , resource_group_name , automation_account_name , hybrid_runbook_worker_group_name , hybrid_runbook_worker_id) ;
        ...
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        req_builder = req_builder.header("content-type", "application/json");
        let req_body = azure_core::to_json(hybrid_runbook_worker_move_parameters).map_err(move_::Error::SerializeError)?;
        req_builder = req_builder.uri(url.as_str());
    ...
    pub async fn list_by_hybrid_runbook_worker_group(
        operation_config: &crate::OperationConfig,
        resource_group_name: &str,
        automation_account_name: &str,
        hybrid_runbook_worker_group_name: &str,
        u24filter: Option<&str>,
        subscription_id: &str,
    ) -> std::result::Result<models::HybridRunbookWorkersListResult, list_by_hybrid_runbook_worker_group::Error> {
        let http_client = operation_config.http_client();
        let url_str = & format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Automation/automationAccounts/{}/hybridRunbookWorkerGroups/{}/hybridRunbookWorkers" , operation_config . base_path () , subscription_id , resource_group_name , automation_account_name , hybrid_runbook_worker_group_name) ;
        let mut url = url::Url::parse(url_str).map_err(list_by_hybrid_runbook_worker_group::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(list_by_hybrid_runbook_worker_group::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        if let Some(u24filter) = u24filter {
        ...
        let req = req_builder
            .body(req_body)
            .map_err(list_by_hybrid_runbook_worker_group::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(list_by_hybrid_runbook_worker_group::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::HybridRunbookWorkersListResult = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_by_hybrid_runbook_worker_group::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::ErrorResponse = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_by_hybrid_runbook_worker_group::Error::DeserializeError(source, rsp_body.clone()))?;
                Err(list_by_hybrid_runbook_worker_group::Error::DefaultResponse {
                    status_code,
                    value: rsp_value,
                })
            }
