...
pub struct ConfigurationStoreProperties {
    ...
    #[doc = "The data plane proxy settings for a configuration store."]
    #[serde(rename = "dataPlaneProxy", default, skip_serializing_if = "Option::is_none")]
    pub data_plane_proxy: Option<DataPlaneProxyProperties>,
...
#[doc = "The data plane proxy settings for a configuration store."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DataPlaneProxyProperties {
    #[doc = "The data plane proxy authentication mode. This property manages the authentication mode of request to the data plane resources."]
    #[serde(rename = "authenticationMode", default, skip_serializing_if = "Option::is_none")]
    pub authentication_mode: Option<data_plane_proxy_properties::AuthenticationMode>,
    #[doc = "The data plane proxy private link delegation. This property manages if a request from delegated ARM private link is allowed when the data plane resource requires private link."]
    #[serde(rename = "privateLinkDelegation", default, skip_serializing_if = "Option::is_none")]
    pub private_link_delegation: Option<data_plane_proxy_properties::PrivateLinkDelegation>,
}
impl DataPlaneProxyProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod data_plane_proxy_properties {
    use super::*;
    #[doc = "The data plane proxy authentication mode. This property manages the authentication mode of request to the data plane resources."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    ...
    impl Serialize for AuthenticationMode {
        ...
        {
            match self {
                Self::Local => serializer.serialize_unit_variant("AuthenticationMode", 0u32, "Local"),
                Self::PassThrough => serializer.serialize_unit_variant("AuthenticationMode", 1u32, "Pass-through"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    #[doc = "The data plane proxy private link delegation. This property manages if a request from delegated ARM private link is allowed when the data plane resource requires private link."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "PrivateLinkDelegation")]
    pub enum PrivateLinkDelegation {
        Enabled,
        Disabled,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for PrivateLinkDelegation {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for PrivateLinkDelegation {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for PrivateLinkDelegation {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("PrivateLinkDelegation", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("PrivateLinkDelegation", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct Replica {
    ...
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<String>,
    #[doc = "The location of the replica."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub location: Option<String>,
    #[doc = "Metadata pertaining to creation and last modification of the resource."]
    #[serde(rename = "systemData", default, skip_serializing_if = "Option::is_none")]
    pub system_data: Option<SystemData>,
    #[doc = "All replica properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "The result of a request to list replicas."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct ReplicaProperties {
    #[doc = "The URI of the replica where the replica API will be available."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub endpoint: Option<String>,
...
pub struct SnapshotProperties {
    #[doc = "The provisioning state of the snapshot."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<snapshot_properties::ProvisioningState>,
    #[doc = "The current status of the snapshot."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<snapshot_properties::Status>,
    ...
    #[serde(rename = "compositionType", default, skip_serializing_if = "Option::is_none")]
    pub composition_type: Option<snapshot_properties::CompositionType>,
    ...
    #[doc = "The tags of the snapshot. NOTE: These are data plane tags, not ARM tags."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<serde_json::Value>,
