...
pub struct ConfigurationStoreProperties {
    ...
    #[doc = "Telemetry settings"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub telemetry: Option<TelemetryProperties>,
    #[doc = "Experimentation settings"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub experimentation: Option<ExperimentationProperties>,
}
...
#[doc = "Experimentation settings"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ExperimentationProperties {
    #[doc = "Resource ID of a resource enabling experimentation"]
    #[serde(rename = "resourceId", default, skip_serializing_if = "Option::is_none")]
    pub resource_id: Option<String>,
    #[doc = "The data plane endpoint of the Split experimentation workspace resource where experimentation data can be retrieved"]
    #[serde(rename = "dataPlaneEndpoint", default, skip_serializing_if = "Option::is_none")]
    pub data_plane_endpoint: Option<String>,
}
impl ExperimentationProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct TelemetryProperties {
    #[doc = "Resource ID of a resource enabling telemetry collection"]
    #[serde(rename = "resourceId", default, skip_serializing_if = "Option::is_none")]
    pub resource_id: Option<String>,
}
