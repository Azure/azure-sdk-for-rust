...
pub struct DataPlaneProxyProperties {
    ...
    #[doc = "The data plane proxy private link delegation. This property manages if a request from delegated Azure Resource Manager (ARM) private link is allowed when the data plane resource requires private link."]
...
pub struct SnapshotProperties {
    ...
    #[doc = "The tags of the snapshot. NOTE: These are data plane tags, not Azure Resource Manager (ARM) tags."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<serde_json::Value>,
