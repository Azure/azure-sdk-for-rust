...
#[cfg(all(feature = "package-2021-10-01-preview", not(feature = "no-default-version")))]
pub use package_2021_10_01_preview::{models, operations, operations::Client, operations::ClientBuilder, operations::Error};
