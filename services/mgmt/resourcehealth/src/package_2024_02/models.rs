...
pub struct MetadataSupportedValueDetail {
    #[doc = "The id of the metadata value"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "The previous value of the id field incase the data has changed."]
    #[serde(rename = "previousId", default, skip_serializing_if = "Option::is_none")]
    pub previous_id: Option<String>,
    #[doc = "The permanent guid for the service. Used when the id is a service name."]
    #[serde(rename = "serviceGuid", default, skip_serializing_if = "Option::is_none")]
    pub service_guid: Option<String>,
    #[doc = "The display name."]
    #[serde(rename = "displayName", default, skip_serializing_if = "Option::is_none")]
    pub display_name: Option<String>,
...
pub struct Impact {
    ...
    #[doc = "Impacted service guid. This is the permanent identifier for the impacted service."]
    #[serde(rename = "impactedServiceGuid", default, skip_serializing_if = "Option::is_none")]
    pub impacted_service_guid: Option<String>,
