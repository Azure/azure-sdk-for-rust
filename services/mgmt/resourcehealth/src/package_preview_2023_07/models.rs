...
pub mod event {
    ...
    pub struct Properties {
        ...
        #[serde(rename = "eventSubType", default, skip_serializing_if = "Option::is_none")]
        pub event_sub_type: Option<properties::EventSubType>,
        #[doc = "Source of event."]
        ...
        #[serde(rename = "maintenanceId", default, skip_serializing_if = "Option::is_none")]
        ...
        #[serde(rename = "argQuery", default, skip_serializing_if = "Option::is_none")]
    ...
    pub mod properties {
        ...
        impl Serialize for EventSubType {
            ...
            {
                match self {
                    Self::Retirement => serializer.serialize_unit_variant("EventSubType", 0u32, "Retirement"),
                    Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
                }
            }
        }
...
pub mod event_impacted_resource {
    ...
    pub struct Properties {
        ...
        #[serde(rename = "maintenanceStartTime", default, skip_serializing_if = "Option::is_none")]
        pub maintenance_start_time: Option<String>,
        #[doc = "End time of maintenance for the impacted resource."]
        #[serde(rename = "maintenanceEndTime", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Operation available in the Microsoft.ResourceHealth resource provider."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct OperationListResult {
    #[doc = "List of operations available in the Microsoft.ResourceHealth resource provider."]
