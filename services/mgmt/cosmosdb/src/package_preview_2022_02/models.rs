...
pub struct DataTransferJobProperties {
    ...
    #[serde(rename = "lastUpdatedUtcTime", with = "azure_core::date::rfc3339::option")]
...
pub struct RestorableDatabaseAccountProperties {
    ...
    #[serde(rename = "oldestRestorableTime", with = "azure_core::date::rfc3339::option")]
...
pub struct RestorableGremlinResourcesListResult {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub value: Vec<GremlinDatabaseRestoreResource>,
}
