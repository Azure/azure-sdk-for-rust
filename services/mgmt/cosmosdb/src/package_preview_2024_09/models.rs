...
#[doc = "Access rule in a network security perimeter configuration profile"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct AccessRuleProperties {
    ...
    #[doc = "Network security perimeters for inbound rules"]
    #[serde(
    ...
    #[doc = "Fully qualified domain names (FQDN) for outbound rules"]
    #[serde(
...
pub struct ApiProperties {
    #[doc = "Describes the version of the MongoDB account."]
    ...
    impl Serialize for ServerVersion {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::N5_0 => serializer.serialize_unit_variant("ServerVersion", 4u32, "5.0"),
                Self::N6_0 => serializer.serialize_unit_variant("ServerVersion", 5u32, "6.0"),
                Self::N7_0 => serializer.serialize_unit_variant("ServerVersion", 6u32, "7.0"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Indicates the capacity mode of the account."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "CapacityMode")]
...
impl<'de> Deserialize<'de> for CapacityMode {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for CapacityMode {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::None => serializer.serialize_unit_variant("CapacityMode", 0u32, "None"),
            Self::Provisioned => serializer.serialize_unit_variant("CapacityMode", 1u32, "Provisioned"),
            Self::Serverless => serializer.serialize_unit_variant("CapacityMode", 2u32, "Serverless"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "The transition state information related capacity mode change with update request."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CapacityModeChangeTransitionState {
    #[doc = "The transition status of capacity mode."]
    #[serde(rename = "capacityModeTransitionStatus", default, skip_serializing_if = "Option::is_none")]
    pub capacity_mode_transition_status: Option<capacity_mode_change_transition_state::CapacityModeTransitionStatus>,
    #[doc = "Indicates the current capacity mode of the account."]
    #[serde(rename = "currentCapacityMode", default, skip_serializing_if = "Option::is_none")]
    pub current_capacity_mode: Option<capacity_mode_change_transition_state::CurrentCapacityMode>,
    #[doc = "Indicates the previous capacity mode of the account before successful transition."]
    #[serde(rename = "previousCapacityMode", default, skip_serializing_if = "Option::is_none")]
    pub previous_capacity_mode: Option<capacity_mode_change_transition_state::PreviousCapacityMode>,
    #[doc = "Begin time in UTC of the capacity mode change."]
    #[serde(
        rename = "capacityModeTransitionBeginTimestamp",
        default,
        with = "azure_core::date::rfc3339::option"
    )]
    pub capacity_mode_transition_begin_timestamp: Option<::time::OffsetDateTime>,
    #[doc = "End time in UTC of the capacity mode change."]
    #[serde(rename = "capacityModeTransitionEndTimestamp", default, with = "azure_core::date::rfc3339::option")]
    pub capacity_mode_transition_end_timestamp: Option<::time::OffsetDateTime>,
    #[doc = "End time in UTC of the last successful capacity mode change."]
    #[serde(
        rename = "capacityModeLastSuccessfulTransitionEndTimestamp",
        default,
        with = "azure_core::date::rfc3339::option"
    )]
    pub capacity_mode_last_successful_transition_end_timestamp: Option<::time::OffsetDateTime>,
}
impl CapacityModeChangeTransitionState {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod capacity_mode_change_transition_state {
    use super::*;
    #[doc = "The transition status of capacity mode."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "CapacityModeTransitionStatus")]
    pub enum CapacityModeTransitionStatus {
        Invalid,
        Initialized,
        InProgress,
        Completed,
    ...
    impl FromStr for CapacityModeTransitionStatus {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for CapacityModeTransitionStatus {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for CapacityModeTransitionStatus {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Invalid => serializer.serialize_unit_variant("CapacityModeTransitionStatus", 0u32, "Invalid"),
                Self::Initialized => serializer.serialize_unit_variant("CapacityModeTransitionStatus", 1u32, "Initialized"),
                Self::InProgress => serializer.serialize_unit_variant("CapacityModeTransitionStatus", 2u32, "InProgress"),
                Self::Completed => serializer.serialize_unit_variant("CapacityModeTransitionStatus", 3u32, "Completed"),
                Self::Failed => serializer.serialize_unit_variant("CapacityModeTransitionStatus", 4u32, "Failed"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    #[doc = "Indicates the current capacity mode of the account."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "CurrentCapacityMode")]
    pub enum CurrentCapacityMode {
        None,
        Provisioned,
        Serverless,
        #[serde(skip_deserializing)]
    ...
    impl FromStr for CurrentCapacityMode {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for CurrentCapacityMode {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for CurrentCapacityMode {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::None => serializer.serialize_unit_variant("CurrentCapacityMode", 0u32, "None"),
                Self::Provisioned => serializer.serialize_unit_variant("CurrentCapacityMode", 1u32, "Provisioned"),
                Self::Serverless => serializer.serialize_unit_variant("CurrentCapacityMode", 2u32, "Serverless"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    #[doc = "Indicates the previous capacity mode of the account before successful transition."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "PreviousCapacityMode")]
    pub enum PreviousCapacityMode {
        None,
        Provisioned,
        Serverless,
        #[serde(skip_deserializing)]
    ...
    impl FromStr for PreviousCapacityMode {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for PreviousCapacityMode {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for PreviousCapacityMode {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::None => serializer.serialize_unit_variant("PreviousCapacityMode", 0u32, "None"),
                Self::Provisioned => serializer.serialize_unit_variant("PreviousCapacityMode", 1u32, "Provisioned"),
                Self::Serverless => serializer.serialize_unit_variant("PreviousCapacityMode", 2u32, "Serverless"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "A CosmosDB Mongo vCore API data source/sink"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CosmosMongoVCoreDataTransferDataSourceSink {
    #[serde(rename = "databaseName")]
    pub database_name: String,
    #[serde(rename = "collectionName")]
    pub collection_name: String,
    ...
    #[serde(rename = "connectionStringKeyVaultUri", default, skip_serializing_if = "Option::is_none")]
    pub connection_string_key_vault_uri: Option<String>,
}
impl CosmosMongoVCoreDataTransferDataSourceSink {
...
pub enum DataTransferDataSourceSinkUnion {
    ...
    #[serde(rename = "CosmosDBMongoVCore")]
...
#[doc = "Properties for Create or Update request for DataTransferServiceResource"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DataTransferServiceResourceCreateUpdateProperties {
    #[serde(flatten)]
    pub service_resource_create_update_properties: ServiceResourceCreateUpdateProperties,
}
impl DataTransferServiceResourceCreateUpdateProperties {
    pub fn new(service_resource_create_update_properties: ServiceResourceCreateUpdateProperties) -> Self {
        Self {
            service_resource_create_update_properties,
        }
    }
}
#[doc = "Properties for DataTransferServiceResource."]
...
pub struct DatabaseAccountCreateUpdateProperties {
    ...
    #[doc = "Indicates the capacity mode of the account."]
    #[serde(rename = "capacityMode", default, skip_serializing_if = "Option::is_none")]
...
pub struct DatabaseAccountGetProperties {
    ...
    pub capacity_mode: Option<CapacityMode>,
    #[doc = "The transition state information related capacity mode change with update request."]
    #[serde(rename = "capacityModeChangeTransitionState", default, skip_serializing_if = "Option::is_none")]
    pub capacity_mode_change_transition_state: Option<CapacityModeChangeTransitionState>,
    #[doc = "Flag to indicate whether to enable MaterializedViews on the Cosmos DB account"]
    #[serde(rename = "enableMaterializedViews", default, skip_serializing_if = "Option::is_none")]
    pub enable_materialized_views: Option<bool>,
    #[doc = "The metadata related to each access key for the given Cosmos DB database account."]
...
#[doc = "Properties for Create or Update request for GraphAPIComputeServiceResource"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GraphApiComputeServiceResourceCreateUpdateProperties {
    #[serde(flatten)]
    pub service_resource_create_update_properties: ServiceResourceCreateUpdateProperties,
}
impl GraphApiComputeServiceResourceCreateUpdateProperties {
    pub fn new(service_resource_create_update_properties: ServiceResourceCreateUpdateProperties) -> Self {
        Self {
            service_resource_create_update_properties,
        }
...
#[doc = "Properties for Create or Update request for MaterializedViewsBuilderServiceResource"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct MaterializedViewsBuilderServiceResourceCreateUpdateProperties {
    #[serde(flatten)]
    pub service_resource_create_update_properties: ServiceResourceCreateUpdateProperties,
}
impl MaterializedViewsBuilderServiceResourceCreateUpdateProperties {
    pub fn new(service_resource_create_update_properties: ServiceResourceCreateUpdateProperties) -> Self {
        Self {
            service_resource_create_update_properties,
        }
...
#[doc = "Information about a network security perimeter (NSP)"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NetworkSecurityPerimeter {
    #[doc = "Fully qualified Azure resource ID of the NSP resource"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "Universal unique ID (UUID) of the network security perimeter"]
...
#[doc = "Network security perimeter (NSP) configuration resource"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NetworkSecurityPerimeterConfiguration {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Network security configuration properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Result of a list NSP (network security perimeter) configurations request."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NetworkSecurityPerimeterConfigurationListResult {
    #[doc = "Array of network security perimeter results."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
pub struct NetworkSecurityPerimeterConfigurationProperties {
    #[doc = "Provisioning state of a network security perimeter configuration that is being created or updated."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<NetworkSecurityPerimeterConfigurationProvisioningState>,
    ...
    #[doc = "Network security perimeter configuration profile"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub profile: Option<NetworkSecurityProfile>,
}
...
#[doc = "Provisioning state of a network security perimeter configuration that is being created or updated."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "NetworkSecurityPerimeterConfigurationProvisioningState")]
pub enum NetworkSecurityPerimeterConfigurationProvisioningState {
    Succeeded,
    Creating,
    Updating,
    Deleting,
...
impl FromStr for NetworkSecurityPerimeterConfigurationProvisioningState {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for NetworkSecurityPerimeterConfigurationProvisioningState {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for NetworkSecurityPerimeterConfigurationProvisioningState {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Succeeded => {
                serializer.serialize_unit_variant("NetworkSecurityPerimeterConfigurationProvisioningState", 0u32, "Succeeded")
            }
            Self::Creating => serializer.serialize_unit_variant("NetworkSecurityPerimeterConfigurationProvisioningState", 1u32, "Creating"),
            Self::Updating => serializer.serialize_unit_variant("NetworkSecurityPerimeterConfigurationProvisioningState", 2u32, "Updating"),
            Self::Deleting => serializer.serialize_unit_variant("NetworkSecurityPerimeterConfigurationProvisioningState", 3u32, "Deleting"),
            Self::Accepted => serializer.serialize_unit_variant("NetworkSecurityPerimeterConfigurationProvisioningState", 4u32, "Accepted"),
            Self::Failed => serializer.serialize_unit_variant("NetworkSecurityPerimeterConfigurationProvisioningState", 5u32, "Failed"),
            Self::Canceled => serializer.serialize_unit_variant("NetworkSecurityPerimeterConfigurationProvisioningState", 6u32, "Canceled"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "Network security perimeter configuration profile"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NetworkSecurityProfile {
    ...
    #[doc = "List of log categories that are enabled"]
    #[serde(
...
#[doc = "Describes a provisioning issue for a network security perimeter configuration"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ProvisioningIssue {
    #[doc = "Name of the issue"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Details of a provisioning issue for a network security perimeter (NSP) configuration. Resource providers should generate separate provisioning issue elements for each separate issue detected, and include a meaningful and distinctive description, as well as any appropriate suggestedResourceIds and suggestedAccessRules"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct ProvisioningIssueProperties {
    ...
    pub issue_type: Option<provisioning_issue_properties::IssueType>,
    #[doc = "Severity of the issue."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub severity: Option<provisioning_issue_properties::Severity>,
    #[doc = "Description of the issue"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    #[doc = "Fully qualified resource IDs of suggested resources that can be associated to the network security perimeter (NSP) to remediate the issue."]
    #[serde(
    ...
    #[doc = "Access rules that can be added to the network security profile (NSP) to remediate the issue."]
    #[serde(
...
pub mod provisioning_issue_properties {
    use super::*;
    #[doc = "Type of issue"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::MissingPerimeterConfiguration => {
                    serializer.serialize_unit_variant("IssueType", 2u32, "MissingPerimeterConfiguration")
                }
                Self::MissingIdentityConfiguration => serializer.serialize_unit_variant("IssueType", 3u32, "MissingIdentityConfiguration"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct ResourceAssociation {
    ...
    pub access_mode: Option<ResourceAssociationAccessMode>,
}
...
#[doc = "Access mode of the resource association"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ResourceAssociationAccessMode")]
pub enum ResourceAssociationAccessMode {
    Enforced,
    Learning,
    Audit,
    #[serde(skip_deserializing)]
...
impl FromStr for ResourceAssociationAccessMode {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for ResourceAssociationAccessMode {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for ResourceAssociationAccessMode {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Enforced => serializer.serialize_unit_variant("ResourceAssociationAccessMode", 0u32, "Enforced"),
            Self::Learning => serializer.serialize_unit_variant("ResourceAssociationAccessMode", 1u32, "Learning"),
            Self::Audit => serializer.serialize_unit_variant("ResourceAssociationAccessMode", 2u32, "Audit"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct ServiceResourceCreateUpdateParameters {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ServiceResourceCreateUpdatePropertiesUnion>,
}
...
pub enum ServiceResourceCreateUpdatePropertiesUnion {
...
#[doc = "Properties for Create or Update request for SqlDedicatedGatewayServiceResource"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SqlDedicatedGatewayServiceResourceCreateUpdateProperties {
    #[serde(flatten)]
    pub service_resource_create_update_properties: ServiceResourceCreateUpdateProperties,
    #[doc = "DedicatedGatewayType for the service."]
    #[serde(rename = "dedicatedGatewayType", default, skip_serializing_if = "Option::is_none")]
    pub dedicated_gateway_type: Option<SqlDedicatedGatewayType>,
}
impl SqlDedicatedGatewayServiceResourceCreateUpdateProperties {
    pub fn new(service_resource_create_update_properties: ServiceResourceCreateUpdateProperties) -> Self {
        Self {
            service_resource_create_update_properties,
            dedicated_gateway_type: None,
        }
    }
}
#[doc = "Properties for SqlDedicatedGatewayServiceResource."]
...
#[doc = "DedicatedGatewayType for the service."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "SqlDedicatedGatewayType")]
pub enum SqlDedicatedGatewayType {
    IntegratedCache,
    DistributedQuery,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for SqlDedicatedGatewayType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for SqlDedicatedGatewayType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for SqlDedicatedGatewayType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::IntegratedCache => serializer.serialize_unit_variant("SqlDedicatedGatewayType", 0u32, "IntegratedCache"),
            Self::DistributedQuery => serializer.serialize_unit_variant("SqlDedicatedGatewayType", 1u32, "DistributedQuery"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "Chaos Fault List Response."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ChaosFaultListResponse {
    #[doc = "List of Chaos Faults."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<ChaosFaultResource>,
    #[doc = "The link used to get the next page of results."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ChaosFaultListResponse {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl ChaosFaultListResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "A request object to enable/disable the chaos fault."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ChaosFaultProperties {
    #[doc = "Indicates whether what action to take for the Chaos Fault."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub action: Option<chaos_fault_properties::Action>,
    #[doc = "Region of the account where the Chaos Fault is to be enabled/disabled."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl ChaosFaultProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod chaos_fault_properties {
    use super::*;
    #[doc = "Indicates whether what action to take for the Chaos Fault."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum Action {
...
#[doc = "A request object to enable/disable the chaos fault"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ChaosFaultResource {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "A request object to enable/disable the chaos fault."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ChaosFaultProperties>,
}
impl ChaosFaultResource {
    pub fn new() -> Self {
        Self::default()
    }
}
