...
pub enum Error {
    ...
    #[error(transparent)]
    SqlResources_ListClientEncryptionKeys(#[from] sql_resources::list_client_encryption_keys::Error),
    #[error(transparent)]
    SqlResources_GetClientEncryptionKey(#[from] sql_resources::get_client_encryption_key::Error),
    #[error(transparent)]
    SqlResources_CreateUpdateClientEncryptionKey(#[from] sql_resources::create_update_client_encryption_key::Error),
    #[error(transparent)]
    ...
    #[error(transparent)]
    MongoDbResources_GetMongoRoleDefinition(#[from] mongo_db_resources::get_mongo_role_definition::Error),
    #[error(transparent)]
    MongoDbResources_CreateUpdateMongoRoleDefinition(#[from] mongo_db_resources::create_update_mongo_role_definition::Error),
    #[error(transparent)]
    MongoDbResources_DeleteMongoRoleDefinition(#[from] mongo_db_resources::delete_mongo_role_definition::Error),
    #[error(transparent)]
    MongoDbResources_ListMongoRoleDefinitions(#[from] mongo_db_resources::list_mongo_role_definitions::Error),
    #[error(transparent)]
    MongoDbResources_GetMongoUserDefinition(#[from] mongo_db_resources::get_mongo_user_definition::Error),
    #[error(transparent)]
    MongoDbResources_CreateUpdateMongoUserDefinition(#[from] mongo_db_resources::create_update_mongo_user_definition::Error),
    #[error(transparent)]
    MongoDbResources_DeleteMongoUserDefinition(#[from] mongo_db_resources::delete_mongo_user_definition::Error),
    #[error(transparent)]
    MongoDbResources_ListMongoUserDefinitions(#[from] mongo_db_resources::list_mongo_user_definitions::Error),
    #[error(transparent)]
    DataTransferJobs_Get(#[from] data_transfer_jobs::get::Error),
    #[error(transparent)]
    DataTransferJobs_Create(#[from] data_transfer_jobs::create::Error),
    #[error(transparent)]
    DataTransferJobs_ListByDatabaseAccount(#[from] data_transfer_jobs::list_by_database_account::Error),
}
...
pub mod sql_resources {
    ...
    pub async fn list_client_encryption_keys(
        operation_config: &crate::OperationConfig,
        subscription_id: &str,
        resource_group_name: &str,
        account_name: &str,
        database_name: &str,
    ) -> std::result::Result<models::ClientEncryptionKeysListResult, list_client_encryption_keys::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DocumentDB/databaseAccounts/{}/sqlDatabases/{}/clientEncryptionKeys",
            operation_config.base_path(),
            subscription_id,
            resource_group_name,
            account_name,
        ...
        let mut url = url::Url::parse(url_str).map_err(list_client_encryption_keys::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(list_client_encryption_keys::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        ...
        let req = req_builder
            .body(req_body)
            .map_err(list_client_encryption_keys::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(list_client_encryption_keys::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::ClientEncryptionKeysListResult = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_client_encryption_keys::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                Err(list_client_encryption_keys::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn get_client_encryption_key(
        operation_config: &crate::OperationConfig,
        subscription_id: &str,
        resource_group_name: &str,
        account_name: &str,
    ...
    ) -> std::result::Result<models::ClientEncryptionKeyGetResults, get_client_encryption_key::Error> {
        let http_client = operation_config.http_client();
        let url_str = & format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DocumentDB/databaseAccounts/{}/sqlDatabases/{}/clientEncryptionKeys/{}" , operation_config . base_path () , subscription_id , resource_group_name , account_name , database_name , client_encryption_key_name) ;
        let mut url = url::Url::parse(url_str).map_err(get_client_encryption_key::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(get_client_encryption_key::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        ...
        let req = req_builder
            .body(req_body)
            .map_err(get_client_encryption_key::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(get_client_encryption_key::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::ClientEncryptionKeyGetResults = serde_json::from_slice(rsp_body)
                    .map_err(|source| get_client_encryption_key::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                Err(get_client_encryption_key::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
    ...
    pub async fn create_update_client_encryption_key(
        operation_config: &crate::OperationConfig,
        subscription_id: &str,
        resource_group_name: &str,
        account_name: &str,
    ...
    ) -> std::result::Result<models::ClientEncryptionKeyGetResults, create_update_client_encryption_key::Error> {
        let http_client = operation_config.http_client();
        let url_str = & format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DocumentDB/databaseAccounts/{}/sqlDatabases/{}/clientEncryptionKeys/{}" , operation_config . base_path () , subscription_id , resource_group_name , account_name , database_name , client_encryption_key_name) ;
        let mut url = url::Url::parse(url_str).map_err(create_update_client_encryption_key::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::PUT);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(create_update_client_encryption_key::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        req_builder = req_builder.header("content-type", "application/json");
        let req_body = azure_core::to_json(create_update_client_encryption_key_parameters)
            .map_err(create_update_client_encryption_key::Error::SerializeError)?;
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder
            .body(req_body)
            .map_err(create_update_client_encryption_key::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(create_update_client_encryption_key::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::ClientEncryptionKeyGetResults = serde_json::from_slice(rsp_body)
                    .map_err(|source| create_update_client_encryption_key::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                Err(create_update_client_encryption_key::Error::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                })
            }
...
pub mod mongo_db_resources {
    ...
    pub async fn get_mongo_role_definition(
        operation_config: &crate::OperationConfig,
        mongo_role_definition_id: &str,
        subscription_id: &str,
        resource_group_name: &str,
        account_name: &str,
    ) -> std::result::Result<models::MongoRoleDefinitionGetResults, get_mongo_role_definition::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DocumentDB/databaseAccounts/{}/mongodbRoleDefinitions/{}",
            operation_config.base_path(),
            subscription_id,
            resource_group_name,
            account_name,
        ...
        let mut url = url::Url::parse(url_str).map_err(get_mongo_role_definition::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(get_mongo_role_definition::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        ...
        let req = req_builder
            .body(req_body)
            .map_err(get_mongo_role_definition::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(get_mongo_role_definition::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::MongoRoleDefinitionGetResults = serde_json::from_slice(rsp_body)
                    .map_err(|source| get_mongo_role_definition::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::CloudError = serde_json::from_slice(rsp_body)
                    .map_err(|source| get_mongo_role_definition::Error::DeserializeError(source, rsp_body.clone()))?;
                Err(get_mongo_role_definition::Error::DefaultResponse {
                    status_code,
                    value: rsp_value,
                })
            }
    ...
    pub async fn create_update_mongo_role_definition(
        operation_config: &crate::OperationConfig,
        mongo_role_definition_id: &str,
        subscription_id: &str,
        resource_group_name: &str,
        account_name: &str,
        create_update_mongo_role_definition_parameters: &models::MongoRoleDefinitionCreateUpdateParameters,
    ) -> std::result::Result<create_update_mongo_role_definition::Response, create_update_mongo_role_definition::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DocumentDB/databaseAccounts/{}/mongodbRoleDefinitions/{}",
            operation_config.base_path(),
        ...
        let mut url = url::Url::parse(url_str).map_err(create_update_mongo_role_definition::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::PUT);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(create_update_mongo_role_definition::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        req_builder = req_builder.header("content-type", "application/json");
        let req_body = azure_core::to_json(create_update_mongo_role_definition_parameters)
            .map_err(create_update_mongo_role_definition::Error::SerializeError)?;
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder
            .body(req_body)
            .map_err(create_update_mongo_role_definition::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(create_update_mongo_role_definition::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::MongoRoleDefinitionGetResults = serde_json::from_slice(rsp_body)
                    .map_err(|source| create_update_mongo_role_definition::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(create_update_mongo_role_definition::Response::Ok200(rsp_value))
            }
            http::StatusCode::ACCEPTED => Ok(create_update_mongo_role_definition::Response::Accepted202),
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::CloudError = serde_json::from_slice(rsp_body)
                    .map_err(|source| create_update_mongo_role_definition::Error::DeserializeError(source, rsp_body.clone()))?;
                Err(create_update_mongo_role_definition::Error::DefaultResponse {
                    status_code,
                    value: rsp_value,
                })
            }
    ...
    pub async fn delete_mongo_role_definition(
        operation_config: &crate::OperationConfig,
        mongo_role_definition_id: &str,
        subscription_id: &str,
        resource_group_name: &str,
        account_name: &str,
    ) -> std::result::Result<delete_mongo_role_definition::Response, delete_mongo_role_definition::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DocumentDB/databaseAccounts/{}/mongodbRoleDefinitions/{}",
            operation_config.base_path(),
        ...
        let mut url = url::Url::parse(url_str).map_err(delete_mongo_role_definition::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::DELETE);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(delete_mongo_role_definition::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        ...
        let req = req_builder
            .body(req_body)
            .map_err(delete_mongo_role_definition::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(delete_mongo_role_definition::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => Ok(delete_mongo_role_definition::Response::Ok200),
            http::StatusCode::ACCEPTED => Ok(delete_mongo_role_definition::Response::Accepted202),
            http::StatusCode::NO_CONTENT => Ok(delete_mongo_role_definition::Response::NoContent204),
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::CloudError = serde_json::from_slice(rsp_body)
                    .map_err(|source| delete_mongo_role_definition::Error::DeserializeError(source, rsp_body.clone()))?;
                Err(delete_mongo_role_definition::Error::DefaultResponse {
                    status_code,
                    value: rsp_value,
                })
            }
    ...
    pub async fn list_mongo_role_definitions(
        operation_config: &crate::OperationConfig,
        subscription_id: &str,
        resource_group_name: &str,
        account_name: &str,
    ) -> std::result::Result<models::MongoRoleDefinitionListResult, list_mongo_role_definitions::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DocumentDB/databaseAccounts/{}/mongodbRoleDefinitions",
            operation_config.base_path(),
        ...
        let mut url = url::Url::parse(url_str).map_err(list_mongo_role_definitions::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(list_mongo_role_definitions::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        ...
        let req = req_builder
            .body(req_body)
            .map_err(list_mongo_role_definitions::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(list_mongo_role_definitions::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::MongoRoleDefinitionListResult = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_mongo_role_definitions::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::CloudError = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_mongo_role_definitions::Error::DeserializeError(source, rsp_body.clone()))?;
                Err(list_mongo_role_definitions::Error::DefaultResponse {
                    status_code,
                    value: rsp_value,
                })
            }
    ...
    pub async fn get_mongo_user_definition(
        operation_config: &crate::OperationConfig,
        mongo_user_definition_id: &str,
        subscription_id: &str,
        resource_group_name: &str,
        account_name: &str,
    ) -> std::result::Result<models::MongoUserDefinitionGetResults, get_mongo_user_definition::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DocumentDB/databaseAccounts/{}/mongodbUserDefinitions/{}",
            operation_config.base_path(),
            subscription_id,
            resource_group_name,
            account_name,
        ...
        let mut url = url::Url::parse(url_str).map_err(get_mongo_user_definition::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(get_mongo_user_definition::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        ...
        let req = req_builder
            .body(req_body)
            .map_err(get_mongo_user_definition::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(get_mongo_user_definition::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::MongoUserDefinitionGetResults = serde_json::from_slice(rsp_body)
                    .map_err(|source| get_mongo_user_definition::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::CloudError = serde_json::from_slice(rsp_body)
                    .map_err(|source| get_mongo_user_definition::Error::DeserializeError(source, rsp_body.clone()))?;
                Err(get_mongo_user_definition::Error::DefaultResponse {
                    status_code,
                    value: rsp_value,
                })
            }
    ...
    pub async fn create_update_mongo_user_definition(
        operation_config: &crate::OperationConfig,
        mongo_user_definition_id: &str,
        subscription_id: &str,
        resource_group_name: &str,
        account_name: &str,
        create_update_mongo_user_definition_parameters: &models::MongoUserDefinitionCreateUpdateParameters,
    ) -> std::result::Result<create_update_mongo_user_definition::Response, create_update_mongo_user_definition::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DocumentDB/databaseAccounts/{}/mongodbUserDefinitions/{}",
            operation_config.base_path(),
        ...
        let mut url = url::Url::parse(url_str).map_err(create_update_mongo_user_definition::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::PUT);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(create_update_mongo_user_definition::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        req_builder = req_builder.header("content-type", "application/json");
        let req_body = azure_core::to_json(create_update_mongo_user_definition_parameters)
            .map_err(create_update_mongo_user_definition::Error::SerializeError)?;
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder
            .body(req_body)
            .map_err(create_update_mongo_user_definition::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(create_update_mongo_user_definition::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::MongoUserDefinitionGetResults = serde_json::from_slice(rsp_body)
                    .map_err(|source| create_update_mongo_user_definition::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(create_update_mongo_user_definition::Response::Ok200(rsp_value))
            }
            http::StatusCode::ACCEPTED => Ok(create_update_mongo_user_definition::Response::Accepted202),
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::CloudError = serde_json::from_slice(rsp_body)
                    .map_err(|source| create_update_mongo_user_definition::Error::DeserializeError(source, rsp_body.clone()))?;
                Err(create_update_mongo_user_definition::Error::DefaultResponse {
                    status_code,
                    value: rsp_value,
                })
            }
    ...
    pub async fn delete_mongo_user_definition(
        operation_config: &crate::OperationConfig,
        mongo_user_definition_id: &str,
        subscription_id: &str,
        resource_group_name: &str,
        account_name: &str,
    ) -> std::result::Result<delete_mongo_user_definition::Response, delete_mongo_user_definition::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DocumentDB/databaseAccounts/{}/mongodbUserDefinitions/{}",
            operation_config.base_path(),
        ...
        let mut url = url::Url::parse(url_str).map_err(delete_mongo_user_definition::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::DELETE);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(delete_mongo_user_definition::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        ...
        let req = req_builder
            .body(req_body)
            .map_err(delete_mongo_user_definition::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(delete_mongo_user_definition::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => Ok(delete_mongo_user_definition::Response::Ok200),
            http::StatusCode::ACCEPTED => Ok(delete_mongo_user_definition::Response::Accepted202),
            http::StatusCode::NO_CONTENT => Ok(delete_mongo_user_definition::Response::NoContent204),
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::CloudError = serde_json::from_slice(rsp_body)
                    .map_err(|source| delete_mongo_user_definition::Error::DeserializeError(source, rsp_body.clone()))?;
                Err(delete_mongo_user_definition::Error::DefaultResponse {
                    status_code,
                    value: rsp_value,
                })
            }
    ...
    pub async fn list_mongo_user_definitions(
        operation_config: &crate::OperationConfig,
        subscription_id: &str,
        resource_group_name: &str,
        account_name: &str,
    ) -> std::result::Result<models::MongoUserDefinitionListResult, list_mongo_user_definitions::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DocumentDB/databaseAccounts/{}/mongodbUserDefinitions",
            operation_config.base_path(),
        ...
        let mut url = url::Url::parse(url_str).map_err(list_mongo_user_definitions::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(list_mongo_user_definitions::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        ...
        let req = req_builder
            .body(req_body)
            .map_err(list_mongo_user_definitions::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(list_mongo_user_definitions::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::MongoUserDefinitionListResult = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_mongo_user_definitions::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::CloudError = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_mongo_user_definitions::Error::DeserializeError(source, rsp_body.clone()))?;
                Err(list_mongo_user_definitions::Error::DefaultResponse {
                    status_code,
                    value: rsp_value,
                })
            }
...
pub mod data_transfer_jobs {
    ...
    pub async fn get(
        ...
        account_name: &str,
        job_name: &str,
    ) -> std::result::Result<models::DataTransferJobGetResults, get::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::DataTransferJobGetResults =
                    serde_json::from_slice(rsp_body).map_err(|source| get::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
    ...
    pub async fn create(
        ...
        account_name: &str,
        job_name: &str,
        job_create_parameters: &models::CreateJobRequest,
    ) -> std::result::Result<models::DataTransferJobGetResults, create::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DocumentDB/databaseAccounts/{}/dataTransferJobs/{}",
            operation_config.base_path(),
        ...
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        req_builder = req_builder.header("content-type", "application/json");
        let req_body = azure_core::to_json(job_create_parameters).map_err(create::Error::SerializeError)?;
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder.body(req_body).map_err(create::Error::BuildRequestError)?;
        let rsp = http_client.execute_request(req).await.map_err(create::Error::ExecuteRequestError)?;
        match rsp.status() {
    ...
    pub async fn list_by_database_account(
        ...
        resource_group_name: &str,
        account_name: &str,
    ) -> std::result::Result<models::DataTransferJobFeedResults, list_by_database_account::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DocumentDB/databaseAccounts/{}/dataTransferJobs",
            operation_config.base_path(),
