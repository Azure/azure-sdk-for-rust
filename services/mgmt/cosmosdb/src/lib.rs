...
#[cfg(all(feature = "package-2020-06-preview", not(feature = "no-default-tag")))]
...
#[cfg(all(feature = "package-2015-04", not(feature = "no-default-tag")))]
...
#[cfg(all(feature = "package-2016-03-19", not(feature = "no-default-tag")))]
...
#[cfg(all(feature = "package-2016-03-31", not(feature = "no-default-tag")))]
