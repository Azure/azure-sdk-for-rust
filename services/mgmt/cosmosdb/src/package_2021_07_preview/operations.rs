...
pub mod graph_resources {
    ...
    pub async fn list_graphs(
        ...
        resource_group_name: &str,
        account_name: &str,
    ) -> std::result::Result<GraphResourcesListResult, list_graphs::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: GraphResourcesListResult =
    ...
    pub async fn get_graph(
        ...
        account_name: &str,
        graph_name: &str,
    ) -> std::result::Result<GraphResourceGetResults, get_graph::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DocumentDB/databaseAccounts/{}/graphs/{}",
            operation_config.base_path(),
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: GraphResourceGetResults =
    ...
    pub async fn create_update_graph(
        ...
        match rsp.status() {
            ...
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: GraphResourceGetResults = serde_json::from_slice(rsp_body)
...
pub mod cassandra_resources {
    ...
    pub async fn list_cassandra_views(
        ...
        account_name: &str,
        keyspace_name: &str,
    ) -> std::result::Result<CassandraViewListResult, list_cassandra_views::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: CassandraViewListResult = serde_json::from_slice(rsp_body)
    ...
    pub async fn get_cassandra_view(
        ...
        keyspace_name: &str,
        view_name: &str,
    ) -> std::result::Result<CassandraViewGetResults, get_cassandra_view::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DocumentDB/databaseAccounts/{}/cassandraKeyspaces/{}/views/{}",
            operation_config.base_path(),
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: CassandraViewGetResults = serde_json::from_slice(rsp_body)
    ...
    pub async fn get_cassandra_view_throughput(
        ...
        keyspace_name: &str,
        view_name: &str,
    ) -> std::result::Result<ThroughputSettingsGetResults, get_cassandra_view_throughput::Error> {
        let http_client = operation_config.http_client();
...
pub mod service {
    ...
    pub async fn list(
        ...
        resource_group_name: &str,
        account_name: &str,
    ) -> std::result::Result<ServiceResourceListResult, list::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: ServiceResourceListResult =
                    serde_json::from_slice(rsp_body).map_err(|source| list::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
