...
pub struct AccountKeyMetadata {
    ...
    #[serde(rename = "generationTime", default, skip_serializing_if = "Option::is_none")]
...
pub struct RestorableDatabaseAccountProperties {
    ...
    #[serde(rename = "oldestRestorableTime", default, skip_serializing_if = "Option::is_none")]
    pub oldest_restorable_time: Option<String>,
