...
pub mod graph_resources {
    ...
    pub mod list_graphs {
        use super::models;
        type Response = models::GraphResourcesListResult;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) subscription_id: String,
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = rsp_stream.collect().await?;
                                let rsp_value: models::GraphResourcesListResult = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
    ...
    pub mod get_graph {
        use super::models;
        type Response = models::GraphResourceGetResults;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) subscription_id: String,
...
pub mod sql_resources {
    ...
    impl Client {
        ...
        pub fn list_client_encryption_keys(
            ...
            account_name: impl Into<String>,
            database_name: impl Into<String>,
        ) -> list_client_encryption_keys::Builder {
            list_client_encryption_keys::Builder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        ) -> get_client_encryption_key::Builder {
            get_client_encryption_key::Builder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        ) -> create_update_client_encryption_key::Builder {
            create_update_client_encryption_key::Builder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        ) -> list_sql_container_partition_merge::Builder {
            list_sql_container_partition_merge::Builder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod list_client_encryption_keys {
        use super::models;
        type Response = models::ClientEncryptionKeysListResult;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) subscription_id: String,
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = rsp_stream.collect().await?;
                                let rsp_value: models::ClientEncryptionKeysListResult = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
    ...
    pub mod get_client_encryption_key {
        use super::models;
        type Response = models::ClientEncryptionKeyGetResults;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) subscription_id: String,
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = rsp_stream.collect().await?;
                                let rsp_value: models::ClientEncryptionKeyGetResults = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
    ...
    pub mod list_sql_container_partition_merge {
        ...
        pub enum Response {
            Accepted202,
            Ok200(models::PhysicalPartitionStorageInfoCollection),
        }
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        match rsp_status {
                            ...
                            azure_core::StatusCode::Ok => {
                                let rsp_body = rsp_stream.collect().await?;
                                let rsp_value: models::PhysicalPartitionStorageInfoCollection = serde_json::from_slice(&rsp_body)?;
                                Ok(Response::Ok200(rsp_value))
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
...
pub mod mongo_db_resources {
    ...
    impl Client {
        ...
        pub fn mongo_db_container_redistribute_throughput(
            ...
            collection_name: impl Into<String>,
            redistribute_throughput_parameters: impl Into<models::RedistributeThroughputParameters>,
        ) -> mongo_db_container_redistribute_throughput::Builder {
            mongo_db_container_redistribute_throughput::Builder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        pub fn list_mongo_db_collection_partition_merge(
            ...
            collection_name: impl Into<String>,
            merge_parameters: impl Into<models::MergeParameters>,
        ) -> list_mongo_db_collection_partition_merge::Builder {
            list_mongo_db_collection_partition_merge::Builder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        pub fn get_mongo_role_definition(
            ...
            resource_group_name: impl Into<String>,
            account_name: impl Into<String>,
        ) -> get_mongo_role_definition::Builder {
            get_mongo_role_definition::Builder {
                client: self.0.clone(),
        ...
        ) -> create_update_mongo_role_definition::Builder {
            create_update_mongo_role_definition::Builder {
                client: self.0.clone(),
                mongo_role_definition_id: mongo_role_definition_id.into(),
                subscription_id: subscription_id.into(),
        ...
        pub fn delete_mongo_role_definition(
            ...
            resource_group_name: impl Into<String>,
            account_name: impl Into<String>,
        ) -> delete_mongo_role_definition::Builder {
            delete_mongo_role_definition::Builder {
                client: self.0.clone(),
                mongo_role_definition_id: mongo_role_definition_id.into(),
                subscription_id: subscription_id.into(),
        ...
        pub fn list_mongo_role_definitions(
            ...
            resource_group_name: impl Into<String>,
            account_name: impl Into<String>,
        ) -> list_mongo_role_definitions::Builder {
            list_mongo_role_definitions::Builder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        pub fn get_mongo_user_definition(
            ...
            resource_group_name: impl Into<String>,
            account_name: impl Into<String>,
        ) -> get_mongo_user_definition::Builder {
            get_mongo_user_definition::Builder {
                client: self.0.clone(),
        ...
        ) -> create_update_mongo_user_definition::Builder {
            create_update_mongo_user_definition::Builder {
                client: self.0.clone(),
                mongo_user_definition_id: mongo_user_definition_id.into(),
                subscription_id: subscription_id.into(),
        ...
        pub fn delete_mongo_user_definition(
            ...
            resource_group_name: impl Into<String>,
            account_name: impl Into<String>,
        ) -> delete_mongo_user_definition::Builder {
            delete_mongo_user_definition::Builder {
                client: self.0.clone(),
                mongo_user_definition_id: mongo_user_definition_id.into(),
                subscription_id: subscription_id.into(),
        ...
        pub fn list_mongo_user_definitions(
            ...
            resource_group_name: impl Into<String>,
            account_name: impl Into<String>,
        ) -> list_mongo_user_definitions::Builder {
            list_mongo_user_definitions::Builder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod get_mongo_role_definition {
        use super::models;
        type Response = models::MongoRoleDefinitionGetResults;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = rsp_stream.collect().await?;
                                let rsp_value: models::MongoRoleDefinitionGetResults = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
    ...
    pub mod create_update_mongo_role_definition {
        ...
        #[derive(Debug)]
        pub enum Response {
            Ok200(models::MongoRoleDefinitionGetResults),
            Accepted202,
        }
        #[derive(Clone)]
        pub struct Builder {
    ...
    pub mod list_mongo_role_definitions {
        use super::models;
        type Response = models::MongoRoleDefinitionListResult;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) subscription_id: String,
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = rsp_stream.collect().await?;
                                let rsp_value: models::MongoRoleDefinitionListResult = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
    ...
    pub mod get_mongo_user_definition {
        use super::models;
        type Response = models::MongoUserDefinitionGetResults;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = rsp_stream.collect().await?;
                                let rsp_value: models::MongoUserDefinitionGetResults = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
    ...
    pub mod create_update_mongo_user_definition {
        ...
        #[derive(Debug)]
        pub enum Response {
            Ok200(models::MongoUserDefinitionGetResults),
            Accepted202,
        }
        #[derive(Clone)]
        pub struct Builder {
    ...
    pub mod list_mongo_user_definitions {
        use super::models;
        type Response = models::MongoUserDefinitionListResult;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) subscription_id: String,
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = rsp_stream.collect().await?;
                                let rsp_value: models::MongoUserDefinitionListResult = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
...
pub mod cassandra_resources {
    ...
    impl Client {
        ...
        ) -> create_update_cassandra_view::Builder {
            create_update_cassandra_view::Builder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        pub fn get_cassandra_view_throughput(
            ...
            keyspace_name: impl Into<String>,
            view_name: impl Into<String>,
        ) -> get_cassandra_view_throughput::Builder {
            get_cassandra_view_throughput::Builder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        pub fn update_cassandra_view_throughput(
            ...
            view_name: impl Into<String>,
            update_throughput_parameters: impl Into<models::ThroughputSettingsUpdateParameters>,
        ) -> update_cassandra_view_throughput::Builder {
            update_cassandra_view_throughput::Builder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        pub fn migrate_cassandra_view_to_autoscale(
            ...
            keyspace_name: impl Into<String>,
            view_name: impl Into<String>,
        ) -> migrate_cassandra_view_to_autoscale::Builder {
            migrate_cassandra_view_to_autoscale::Builder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        pub fn migrate_cassandra_view_to_manual_throughput(
            ...
            keyspace_name: impl Into<String>,
            view_name: impl Into<String>,
        ) -> migrate_cassandra_view_to_manual_throughput::Builder {
            migrate_cassandra_view_to_manual_throughput::Builder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod list_cassandra_views {
        use super::models;
        type Response = models::CassandraViewListResult;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) subscription_id: String,
    ...
    pub mod get_cassandra_view {
        use super::models;
        type Response = models::CassandraViewGetResults;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) subscription_id: String,
...
pub mod data_transfer_jobs {
    ...
    pub mod get {
        use super::models;
        type Response = models::DataTransferJobGetResults;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) subscription_id: String,
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = rsp_stream.collect().await?;
                                let rsp_value: models::DataTransferJobGetResults = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
    ...
    pub mod list_by_database_account {
        use super::models;
        type Response = models::DataTransferJobFeedResults;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) subscription_id: String,
                ...
                let make_request = move |continuation: Option<String>| {
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = rsp_stream.collect().await?;
                                let rsp_value: models::DataTransferJobFeedResults = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
...
pub mod cassandra_clusters {
    ...
    pub mod invoke_command {
        use super::models;
        type Response = models::CommandOutput;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) subscription_id: String,
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Accepted => {
                                let rsp_body = rsp_stream.collect().await?;
                                let rsp_value: models::CommandOutput = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
    ...
    pub mod status {
        use super::models;
        type Response = models::CassandraClusterPublicStatus;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) subscription_id: String,
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = rsp_stream.collect().await?;
                                let rsp_value: models::CassandraClusterPublicStatus = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
...
pub mod restorable_gremlin_databases {
    ...
    pub mod list {
        use super::models;
        type Response = models::RestorableGremlinDatabasesListResult;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) subscription_id: String,
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = rsp_stream.collect().await?;
                                let rsp_value: models::RestorableGremlinDatabasesListResult = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
...
pub mod restorable_gremlin_graphs {
    ...
    pub mod list {
        use super::models;
        type Response = models::RestorableGremlinGraphsListResult;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) subscription_id: String,
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = rsp_stream.collect().await?;
                                let rsp_value: models::RestorableGremlinGraphsListResult = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
...
pub mod restorable_gremlin_resources {
    ...
    pub mod list {
        use super::models;
        type Response = models::RestorableGremlinResourcesListResult;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) subscription_id: String,
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = rsp_stream.collect().await?;
                                let rsp_value: models::RestorableGremlinResourcesListResult = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
...
pub mod restorable_tables {
    ...
    pub mod list {
        use super::models;
        type Response = models::RestorableTablesListResult;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) subscription_id: String,
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = rsp_stream.collect().await?;
                                let rsp_value: models::RestorableTablesListResult = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
...
pub mod restorable_table_resources {
    ...
    pub mod list {
        use super::models;
        type Response = models::RestorableTableResourcesListResult;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) subscription_id: String,
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = rsp_stream.collect().await?;
                                let rsp_value: models::RestorableTableResourcesListResult = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
...
pub mod service {
    ...
    pub mod list {
        use super::models;
        type Response = models::ServiceResourceListResult;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) subscription_id: String,
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = rsp_stream.collect().await?;
                                let rsp_value: models::ServiceResourceListResult = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
