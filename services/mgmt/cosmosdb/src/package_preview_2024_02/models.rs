...
pub mod cluster_resource {
    ...
    pub struct Properties {
        ...
        #[doc = "The form of AutoReplicate that is being used by this cluster."]
        #[serde(rename = "autoReplicate", default, skip_serializing_if = "Option::is_none")]
        pub auto_replicate: Option<properties::AutoReplicate>,
        ...
        #[doc = "List of the data center names for unmanaged data centers in this cluster to be included in auto-replication."]
        #[serde(
            rename = "externalDataCenters",
            default,
            deserialize_with = "azure_core::util::deserialize_null_as_default",
            skip_serializing_if = "Vec::is_empty"
        )]
        pub external_data_centers: Vec<String>,
        ...
        #[doc = "How the nodes in the cluster react to scheduled events"]
        #[serde(rename = "scheduledEventStrategy", default, skip_serializing_if = "Option::is_none")]
        pub scheduled_event_strategy: Option<properties::ScheduledEventStrategy>,
        #[doc = "How to connect to the azure services needed for running the cluster"]
        #[serde(rename = "azureConnectionMethod", default, skip_serializing_if = "Option::is_none")]
        pub azure_connection_method: Option<properties::AzureConnectionMethod>,
        #[doc = "If the Connection Method is Vpn, this is the Id of the private link resource that the datacenters need to connect to."]
    ...
    pub mod properties {
        ...
        #[doc = "The form of AutoReplicate that is being used by this cluster."]
        #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
        #[serde(remote = "AutoReplicate")]
        pub enum AutoReplicate {
            None,
            SystemKeyspaces,
            AllKeyspaces,
            #[serde(skip_deserializing)]
        ...
        impl FromStr for AutoReplicate {
            type Err = value::Error;
            fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
                Self::deserialize(s.into_deserializer())
            }
        }
        impl<'de> Deserialize<'de> for AutoReplicate {
            fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
            where
                D: Deserializer<'de>,
            {
        ...
        impl Serialize for AutoReplicate {
            fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
            where
                S: Serializer,
            {
                match self {
                    Self::None => serializer.serialize_unit_variant("AutoReplicate", 0u32, "None"),
                    Self::SystemKeyspaces => serializer.serialize_unit_variant("AutoReplicate", 1u32, "SystemKeyspaces"),
                    Self::AllKeyspaces => serializer.serialize_unit_variant("AutoReplicate", 2u32, "AllKeyspaces"),
                    Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
                }
            }
        }
        ...
        #[doc = "How the nodes in the cluster react to scheduled events"]
        #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
        #[serde(remote = "ScheduledEventStrategy")]
        pub enum ScheduledEventStrategy {
            Ignore,
            StopAny,
            StopByRack,
            #[serde(skip_deserializing)]
        ...
        impl FromStr for ScheduledEventStrategy {
            type Err = value::Error;
            fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
                Self::deserialize(s.into_deserializer())
            }
        }
        impl<'de> Deserialize<'de> for ScheduledEventStrategy {
            fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
            where
                D: Deserializer<'de>,
            {
        ...
        impl Serialize for ScheduledEventStrategy {
            fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
            where
                S: Serializer,
            {
                match self {
                    Self::Ignore => serializer.serialize_unit_variant("ScheduledEventStrategy", 0u32, "Ignore"),
                    Self::StopAny => serializer.serialize_unit_variant("ScheduledEventStrategy", 1u32, "StopAny"),
                    Self::StopByRack => serializer.serialize_unit_variant("ScheduledEventStrategy", 2u32, "StopByRack"),
                    Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
                }
            }
        }
        #[doc = "How to connect to the azure services needed for running the cluster"]
        #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
        #[serde(remote = "AzureConnectionMethod")]
        ...
        impl FromStr for AzureConnectionMethod {
            type Err = value::Error;
            fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
                Self::deserialize(s.into_deserializer())
            }
        }
        impl<'de> Deserialize<'de> for AzureConnectionMethod {
            fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
            where
                D: Deserializer<'de>,
            {
        ...
        impl Serialize for AzureConnectionMethod {
            fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
            where
                S: Serializer,
            {
                match self {
                    Self::None => serializer.serialize_unit_variant("AzureConnectionMethod", 0u32, "None"),
                    Self::Vpn => serializer.serialize_unit_variant("AzureConnectionMethod", 1u32, "VPN"),
                    Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
                }
            }
        }
...
pub struct CommandPostBody {
    ...
    #[serde(rename = "readWrite", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "resource representing a command"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CommandPublicResource {
    #[doc = "The command which should be run"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub command: Option<String>,
    #[doc = "The unique id of command"]
    ...
    #[doc = "Whether command has admin privileges"]
    #[serde(rename = "isAdmin", default, skip_serializing_if = "Option::is_none")]
    pub is_admin: Option<bool>,
    #[doc = "If true, stops cassandra before executing the command and then start it again"]
    #[serde(rename = "cassandraStopStart", default, skip_serializing_if = "Option::is_none")]
    pub cassandra_stop_start: Option<bool>,
    #[doc = "If true, allows the command to *write* to the cassandra directory, otherwise read-only."]
    #[serde(rename = "readWrite", default, skip_serializing_if = "Option::is_none")]
    pub read_write: Option<bool>,
    #[doc = "Result output of the command."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub result: Option<String>,
    #[doc = "Status of the command."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<command_public_resource::Status>,
    #[doc = "The name of the file where the result is written."]
    #[serde(rename = "outputFile", default, skip_serializing_if = "Option::is_none")]
    pub output_file: Option<String>,
}
impl CommandPublicResource {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod command_public_resource {
    use super::*;
    #[doc = "Status of the command."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Status")]
    ...
    impl Serialize for Status {
        ...
        {
            match self {
                Self::Done => serializer.serialize_unit_variant("Status", 0u32, "Done"),
                Self::Running => serializer.serialize_unit_variant("Status", 1u32, "Running"),
                Self::Enqueue => serializer.serialize_unit_variant("Status", 2u32, "Enqueue"),
                Self::Processing => serializer.serialize_unit_variant("Status", 3u32, "Processing"),
                Self::Finished => serializer.serialize_unit_variant("Status", 4u32, "Finished"),
...
#[doc = "The definition of a computed property"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ComputedProperty {
    #[doc = "The name of a computed property, for example - \"cp_lowerName\""]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "The query that evaluates the value for computed property, for example - \"SELECT VALUE LOWER(c.name) FROM c\""]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub mod data_center_resource {
    ...
    pub struct Properties {
        ...
        #[serde(rename = "provisionError", default, skip_serializing_if = "Option::is_none")]
        pub provision_error: Option<CassandraError>,
        #[doc = "Ip of the VPN Endpoint for this data center."]
        #[serde(rename = "privateEndpointIpAddress", default, skip_serializing_if = "Option::is_none")]
        pub private_endpoint_ip_address: Option<String>,
    }
    impl Properties {
        pub fn new() -> Self {
            Self::default()
...
pub struct DataTransferJobProperties {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub error: Option<ErrorResponse>,
    #[doc = "Total Duration of Job"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub duration: Option<String>,
    #[doc = "Mode of job execution"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mode: Option<data_transfer_job_properties::Mode>,
}
...
pub mod data_transfer_job_properties {
    use super::*;
    #[doc = "Mode of job execution"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Mode")]
    ...
    impl Serialize for Mode {
        ...
        {
            match self {
                Self::Offline => serializer.serialize_unit_variant("Mode", 0u32, "Offline"),
                Self::Online => serializer.serialize_unit_variant("Mode", 1u32, "Online"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct DatabaseAccountCreateUpdateProperties {
    ...
    #[doc = "Flag to indicate enabling/disabling of Per-Region Per-partition autoscale Preview feature on the account"]
    #[serde(rename = "enablePerRegionPerPartitionAutoscale", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "List of commands for cluster."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ListCommands {
    #[doc = "Container for array of commands."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<CommandPublicResource>,
}
impl azure_core::Continuable for ListCommands {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        None
    }
...
pub mod restorable_gremlin_database_properties {
    ...
    pub struct Resource {
        ...
        #[doc = "A state of this database to identify if this database is restorable in same account."]
        #[serde(rename = "canUndelete", default, skip_serializing_if = "Option::is_none")]
        pub can_undelete: Option<String>,
        #[doc = "The reason why this database can not be restored in same account."]
        #[serde(rename = "canUndeleteReason", default, skip_serializing_if = "Option::is_none")]
        pub can_undelete_reason: Option<String>,
...
pub mod restorable_gremlin_graph_properties {
    ...
    pub struct Resource {
        ...
        #[serde(rename = "operationType", default, skip_serializing_if = "Option::is_none")]
        pub operation_type: Option<OperationType>,
        #[doc = "A state of this graph to identify if this graph is restorable in same account."]
        #[serde(rename = "canUndelete", default, skip_serializing_if = "Option::is_none")]
        pub can_undelete: Option<String>,
        #[doc = "The reason why this graph can not be restored in same account."]
        #[serde(rename = "canUndeleteReason", default, skip_serializing_if = "Option::is_none")]
        pub can_undelete_reason: Option<String>,
...
pub mod restorable_mongodb_collection_properties {
    ...
    pub struct Resource {
        ...
        #[serde(rename = "operationType", default, skip_serializing_if = "Option::is_none")]
        pub operation_type: Option<OperationType>,
        #[doc = "A state of this collection to identify if this container is restorable in same account."]
        #[serde(rename = "canUndelete", default, skip_serializing_if = "Option::is_none")]
        pub can_undelete: Option<String>,
        #[doc = "The reason why this collection can not be restored in same account."]
        #[serde(rename = "canUndeleteReason", default, skip_serializing_if = "Option::is_none")]
        pub can_undelete_reason: Option<String>,
...
pub mod restorable_sql_container_properties {
    ...
    pub struct Resource {
        ...
        #[serde(rename = "operationType", default, skip_serializing_if = "Option::is_none")]
        pub operation_type: Option<OperationType>,
        #[doc = "A state of this container to identify if this container is restorable in same account."]
        #[serde(rename = "canUndelete", default, skip_serializing_if = "Option::is_none")]
        pub can_undelete: Option<String>,
        #[doc = "The reason why this container can not be restored in same account."]
        #[serde(rename = "canUndeleteReason", default, skip_serializing_if = "Option::is_none")]
        pub can_undelete_reason: Option<String>,
...
pub mod restorable_table_properties {
    ...
    pub struct Resource {
        ...
        #[serde(rename = "operationType", default, skip_serializing_if = "Option::is_none")]
        pub operation_type: Option<OperationType>,
        #[doc = "A state of this table to identify if this table is restorable in same account."]
        #[serde(rename = "canUndelete", default, skip_serializing_if = "Option::is_none")]
        pub can_undelete: Option<String>,
        #[doc = "The reason why this table can not be restored in same account."]
        #[serde(rename = "canUndeleteReason", default, skip_serializing_if = "Option::is_none")]
        pub can_undelete_reason: Option<String>,
...
pub struct RestoreParametersBase {
    ...
    #[serde(rename = "restoreTimestampInUtc", default, with = "azure_core::date::rfc3339::option")]
    pub restore_timestamp_in_utc: Option<::time::OffsetDateTime>,
    #[doc = "Specifies whether the restored account will have Time-To-Live disabled upon the successful restore."]
    #[serde(rename = "restoreWithTtlDisabled", default, skip_serializing_if = "Option::is_none")]
    pub restore_with_ttl_disabled: Option<bool>,
}
...
pub struct SqlContainerResource {
    ...
    #[doc = "List of computed properties"]
    #[serde(
        rename = "computedProperties",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
...
#[doc = "Parameters for creating a Azure Cosmos DB throughput pool account."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ThroughputPoolAccountCreateParameters {
    #[doc = "Tags are a list of key-value pairs that describe the resource. These tags can be used in viewing and grouping this resource (across resource groups). A maximum of 15 tags can be provided for a resource. Each tag must have a key no greater than 128 characters and value no greater than 256 characters. For example, the default experience for a template type is set with \"defaultExperience\": \"Cassandra\". Current \"defaultExperience\" values also include \"Table\", \"Graph\", \"DocumentDB\", and \"MongoDB\"."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<Tags>,
    #[doc = "Properties to update Azure Cosmos DB throughput pool."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ThroughputPoolAccountCreateProperties>,
}
impl ThroughputPoolAccountCreateParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Properties to update Azure Cosmos DB throughput pool."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ThroughputPoolAccountCreateProperties {
    #[doc = "The resource identifier of global database account in the throughputPool."]
    #[serde(rename = "accountResourceIdentifier", default, skip_serializing_if = "Option::is_none")]
    pub account_resource_identifier: Option<String>,
    #[doc = "The location of global database account in the throughputPool."]
    #[serde(rename = "accountLocation", default, skip_serializing_if = "Option::is_none")]
    pub account_location: Option<String>,
}
impl ThroughputPoolAccountCreateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "An Azure Cosmos DB Global Database Account which is part of a Throughputpool."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ThroughputPoolAccountProperties {
    #[doc = "The provisioning state of the resource."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<ProvisioningState>,
    #[doc = "The resource identifier of global database account in the throughputPool."]
    ...
    #[serde(rename = "accountLocation", default, skip_serializing_if = "Option::is_none")]
    pub account_location: Option<String>,
    #[doc = "The instance id of global database account in the throughputPool."]
    #[serde(rename = "accountInstanceId", default, skip_serializing_if = "Option::is_none")]
    pub account_instance_id: Option<String>,
}
impl ThroughputPoolAccountProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "An Azure Cosmos DB Throughputpool Account"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ThroughputPoolAccountResource {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "An Azure Cosmos DB Global Database Account which is part of a Throughputpool."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ThroughputPoolAccountProperties>,
}
impl ThroughputPoolAccountResource {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The List operation response, that contains the global database accounts and their properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ThroughputPoolAccountsListResult {
    #[doc = "List of global database accounts in a throughput pool and their properties."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<ThroughputPoolAccountResource>,
    #[doc = "The link used to get the next page of results."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ThroughputPoolAccountsListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl ThroughputPoolAccountsListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Properties to update Azure Cosmos DB throughput pool."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ThroughputPoolProperties {
    #[doc = "The provisioning state of the resource."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<ProvisioningState>,
    #[doc = "Value for throughput to be shared among CosmosDB resources in the pool."]
    #[serde(rename = "maxThroughput", default, skip_serializing_if = "Option::is_none")]
    pub max_throughput: Option<i32>,
}
impl ThroughputPoolProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "An Azure Cosmos DB Throughputpool."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ThroughputPoolResource {
    #[serde(flatten)]
    pub tracked_resource: TrackedResource,
    #[doc = "Properties to update Azure Cosmos DB throughput pool."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ThroughputPoolProperties>,
}
impl ThroughputPoolResource {
    pub fn new(tracked_resource: TrackedResource) -> Self {
        Self {
            tracked_resource,
            properties: None,
...
#[doc = "Represents a throughput pool resource for updates."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ThroughputPoolUpdate {
    #[doc = "Properties to update Azure Cosmos DB throughput pool."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ThroughputPoolProperties>,
}
impl ThroughputPoolUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The List operation response, that contains the throughput pools and their properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ThroughputPoolsListResult {
    #[doc = "List of throughput pools and their properties."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<ThroughputPoolResource>,
    #[doc = "The link used to get the next page of results."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ThroughputPoolsListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl ThroughputPoolsListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
