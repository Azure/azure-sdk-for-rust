...
pub struct RegistryProperties {
    ...
    #[doc = "Determines whether registry artifacts are indexed for metadata search."]
    #[serde(rename = "metadataSearch", default, skip_serializing_if = "Option::is_none")]
    pub metadata_search: Option<registry_properties::MetadataSearch>,
}
...
pub mod registry_properties {
    ...
    #[doc = "Determines whether registry artifacts are indexed for metadata search."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "MetadataSearch")]
    pub enum MetadataSearch {
        Enabled,
        Disabled,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for MetadataSearch {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for MetadataSearch {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for MetadataSearch {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("MetadataSearch", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("MetadataSearch", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct RegistryPropertiesUpdateParameters {
    ...
    #[doc = "Determines whether registry artifacts are indexed for metadata search."]
    #[serde(rename = "metadataSearch", default, skip_serializing_if = "Option::is_none")]
    pub metadata_search: Option<registry_properties_update_parameters::MetadataSearch>,
}
