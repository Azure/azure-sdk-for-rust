...
pub mod registries {
    ...
    impl Client {
        ...
        pub fn create(
            ...
            resource_group_name: impl Into<String>,
            registry_name: impl Into<String>,
            registry_create_parameters: impl Into<models::RegistryCreateParameters>,
        ) -> create::Builder {
            create::Builder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
                registry_name: registry_name.into(),
                registry_create_parameters: registry_create_parameters.into(),
            }
        }
        pub fn update(
            &self,
    ...
    pub mod create {
        ...
        pub struct Builder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) registry_name: String,
            pub(crate) registry_create_parameters: models::RegistryCreateParameters,
        }
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<Response, Error>> {
                Box::pin(async move {
                    ...
                    url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
                    req_builder = req_builder.header("content-type", "application/json");
                    let req_body = azure_core::to_json(&self.registry_create_parameters).map_err(Error::Serialize)?;
                    req_builder = req_builder.uri(url.as_str());
                    let req = req_builder.body(req_body).map_err(Error::BuildRequest)?;
                    let rsp = self.client.send(req).await.map_err(Error::SendRequest)?;
                    let (rsp_status, rsp_headers, rsp_stream) = rsp.deconstruct();
