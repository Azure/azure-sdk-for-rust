...
pub mod connected_registries {
    ...
    pub async fn get(
        ...
        let uri_str = &format!(
            ...
            &operation_config.base_path, subscription_id, resource_group_name, registry_name, connected_registry_name
        );
        ...
        match rsp.status() {
            StatusCode::OK => {
                ...
                let rsp_value: ConnectedRegistry = serde_json::from_slice(&body).context(get::DeserializeError { body })?;
                Ok(rsp_value)
            }
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(get::ResponseBytesError)?;
    ...
    pub async fn create(
        ...
        req_builder = req_builder.query(&[("api-version", &operation_config.api_version)]);
        req_builder = req_builder.json(connected_registry_create_parameters);
        ...
        match rsp.status() {
            StatusCode::OK => {
                ...
                let rsp_value: ConnectedRegistry = serde_json::from_slice(&body).context(create::DeserializeError { body })?;
    ...
    pub async fn update(
        ...
        req_builder = req_builder.query(&[("api-version", &operation_config.api_version)]);
        req_builder = req_builder.json(connected_registry_update_parameters);
        let req = req_builder.build().context(update::BuildRequestError)?;
        let rsp = client.execute(req).await.context(update::ExecuteRequestError)?;
        match rsp.status() {
            StatusCode::OK => {
                let body: bytes::Bytes = rsp.bytes().await.context(update::ResponseBytesError)?;
                let rsp_value: ConnectedRegistry = serde_json::from_slice(&body).context(update::DeserializeError { body })?;
    ...
    pub async fn list(
        ...
        match rsp.status() {
            StatusCode::OK => {
                ...
                let rsp_value: ConnectedRegistryListResult = serde_json::from_slice(&body).context(list::DeserializeError { body })?;
                Ok(rsp_value)
            }
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(list::ResponseBytesError)?;
    ...
    pub async fn deactivate(
        ...
        match rsp.status() {
            StatusCode::OK => Ok(deactivate::Response::Ok200),
            ...
            status_code => {
                ...
                let rsp_value: ErrorResponse = serde_json::from_slice(&body).context(deactivate::DeserializeError { body })?;
...
pub mod export_pipelines {
    ...
    pub async fn get(
        ...
        let uri_str = &format!(
            ...
            &operation_config.base_path, subscription_id, resource_group_name, registry_name, export_pipeline_name
        );
        let mut req_builder = client.get(uri_str);
        if let Some(token_credential) = &operation_config.token_credential {
            let token_response = token_credential
...
pub mod import_pipelines {
    ...
    pub async fn get(
        ...
        let uri_str = &format!(
            ...
            &operation_config.base_path, subscription_id, resource_group_name, registry_name, import_pipeline_name
        );
        let mut req_builder = client.get(uri_str);
        if let Some(token_credential) = &operation_config.token_credential {
            let token_response = token_credential
...
pub mod pipeline_runs {
    ...
    pub async fn get(
        ...
        let uri_str = &format!(
            ...
            &operation_config.base_path, subscription_id, resource_group_name, registry_name, pipeline_run_name
        );
        let mut req_builder = client.get(uri_str);
        if let Some(token_credential) = &operation_config.token_credential {
            let token_response = token_credential
...
pub mod private_endpoint_connections {
    ...
    pub async fn get(
        ...
        let uri_str = &format!(
            ...
            &operation_config.base_path, subscription_id, resource_group_name, registry_name, private_endpoint_connection_name
        );
        let mut req_builder = client.get(uri_str);
        if let Some(token_credential) = &operation_config.token_credential {
            let token_response = token_credential
