...
pub struct DicomServiceProperties {
    ...
    #[doc = "Settings to encrypt a service"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub encryption: Option<Encryption>,
    #[doc = "The configuration of connected storage"]
...
pub struct Encryption {
    #[doc = "The encryption settings for the customer-managed key"]
...
pub mod encryption {
    ...
    pub struct CustomerManagedKeyEncryption {
        #[doc = "The URL of the key to use for encryption"]
...
pub struct FhirServiceAuthenticationConfiguration {
    ...
    #[doc = "The array of identity provider configurations for SMART on FHIR authentication."]
    #[serde(
        rename = "smartIdentityProviders",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub smart_identity_providers: Vec<SmartIdentityProviderConfiguration>,
}
...
pub struct FhirServiceProperties {
    ...
    #[doc = "The settings for Implementation Guides - defining capabilities for national standards, vendor consortiums, clinical societies, etc."]
    #[serde(rename = "implementationGuidesConfiguration", default, skip_serializing_if = "Option::is_none")]
    pub implementation_guides_configuration: Option<ImplementationGuidesConfiguration>,
    #[doc = "Settings to encrypt a service"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub encryption: Option<Encryption>,
}
...
#[doc = "The settings for Implementation Guides - defining capabilities for national standards, vendor consortiums, clinical societies, etc."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ImplementationGuidesConfiguration {
    #[doc = "If US Core Missing Data requirement is enabled."]
    #[serde(rename = "usCoreMissingData", default, skip_serializing_if = "Option::is_none")]
    pub us_core_missing_data: Option<bool>,
}
impl ImplementationGuidesConfiguration {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ServiceCosmosDbConfigurationInfo {
    ...
    #[doc = "The multi-tenant application id used to enable CMK access for services in a data sovereign region."]
    #[serde(rename = "crossTenantCmkApplicationId", default, skip_serializing_if = "Option::is_none")]
    pub cross_tenant_cmk_application_id: Option<String>,
}
...
#[doc = "The Data Actions that can be enabled for a Smart Identity Provider Application."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "SmartDataActions")]
pub enum SmartDataActions {
    Read,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for SmartDataActions {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for SmartDataActions {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for SmartDataActions {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Read => serializer.serialize_unit_variant("SmartDataActions", 0u32, "Read"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "An Application configured in the Identity Provider used to access FHIR resources."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SmartIdentityProviderApplication {
    #[doc = "The application client id defined in the identity provider. This value will be used to validate bearer tokens against the given authority."]
    #[serde(rename = "clientId", default, skip_serializing_if = "Option::is_none")]
    pub client_id: Option<String>,
    #[doc = "The audience that will be used to validate bearer tokens against the given authority."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub audience: Option<String>,
    #[doc = "The actions that are permitted to be performed on FHIR resources for the application."]
    #[serde(
    ...
    pub allowed_data_actions: Vec<SmartDataActions>,
}
impl SmartIdentityProviderApplication {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "An object to configure an identity provider for use with SMART on FHIR authentication."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SmartIdentityProviderConfiguration {
    #[doc = "The identity provider token authority also known as the token issuing authority."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub authority: Option<String>,
    #[doc = "The array of identity provider applications for SMART on FHIR authentication."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub applications: Vec<SmartIdentityProviderApplication>,
}
impl SmartIdentityProviderConfiguration {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct StorageConfiguration {
    #[doc = "The resource id of connected storage account."]
    #[serde(rename = "storageResourceId", default, skip_serializing_if = "Option::is_none")]
    pub storage_resource_id: Option<String>,
    #[doc = "The filesystem name of connected storage account."]
    #[serde(rename = "fileSystemName", default, skip_serializing_if = "Option::is_none")]
