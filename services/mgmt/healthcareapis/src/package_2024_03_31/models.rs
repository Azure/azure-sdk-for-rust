...
pub struct DicomServiceProperties {
    ...
    #[doc = "Boolean to indicate if data partitions is enabled or not."]
    #[serde(rename = "enableDataPartitions", default, skip_serializing_if = "Option::is_none")]
    pub enable_data_partitions: Option<EnableDataPartitions>,
}
...
pub type EnableDataPartitions = bool;
#[doc = "Settings to encrypt a service"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
