...
use std::str::FromStr;
#[doc = "Analytics Connector definition."]
...
pub struct AnalyticsConnector {
    ...
    pub properties: Option<AnalyticsConnectorProperties>,
...
#[doc = "A collection of Analytics Connectors."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AnalyticsConnectorCollection {
    #[doc = "The link used to get the next page of AnalyticsConnectors."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
    #[doc = "The list of Analytics Connectors."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<AnalyticsConnector>,
}
...
pub struct AnalyticsConnectorDataLakeDataDestination {
    #[serde(flatten)]
    pub analytics_connector_data_destination: AnalyticsConnectorDataDestination,
    #[doc = "The name for the Data Lake."]
    #[serde(rename = "dataLakeName")]
    pub data_lake_name: String,
}
impl AnalyticsConnectorDataLakeDataDestination {
    pub fn new(analytics_connector_data_destination: AnalyticsConnectorDataDestination, data_lake_name: String) -> Self {
        Self {
            analytics_connector_data_destination,
            data_lake_name,
        }
    }
}
...
pub mod analytics_connector_fhir_service_data_source {
    ...
    impl Serialize for Kind {
        ...
        {
            match self {
                Self::Stu3 => serializer.serialize_unit_variant("Kind", 0u32, "STU3"),
                Self::R4 => serializer.serialize_unit_variant("Kind", 1u32, "R4"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct AnalyticsConnectorFhirToParquetMapping {
    ...
    #[doc = "Artifact reference for extension schema."]
    #[serde(rename = "extensionSchemaReference", default, skip_serializing_if = "Option::is_none")]
...
impl AnalyticsConnectorPatchResource {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Analytics Connector Properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AnalyticsConnectorProperties {
...
pub struct IotFhirDestinationProperties {
    ...
    #[serde(rename = "resourceIdentityResolutionType", with = "azure_core::xml::text_content")]
