...
impl Client {
    ...
    pub fn extended_zones_client(&self) -> extended_zones::Client {
        extended_zones::Client(self.clone())
    }
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path("/providers/Microsoft.EdgeZones/operations");
...
pub mod extended_zones {
    ...
    impl Client {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `extended_zone_name`: The name of the ExtendedZone"]
        pub fn get(&self, subscription_id: impl Into<String>, extended_zone_name: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                extended_zone_name: extended_zone_name.into(),
            }
        }
        ...
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `extended_zone_name`: The name of the ExtendedZone"]
        pub fn register(&self, subscription_id: impl Into<String>, extended_zone_name: impl Into<String>) -> register::RequestBuilder {
        ...
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `extended_zone_name`: The name of the ExtendedZone"]
        pub fn unregister(&self, subscription_id: impl Into<String>, extended_zone_name: impl Into<String>) -> unregister::RequestBuilder {
    ...
    pub mod list_by_subscription {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ExtendedZoneListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ExtendedZoneListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ExtendedZoneListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.EdgeZones/extendedZones",
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ExtendedZone> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ExtendedZone = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) subscription_id: String,
            pub(crate) extended_zone_name: String,
        }
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.EdgeZones/extendedZones/{}",
                    &self.subscription_id, &self.extended_zone_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ExtendedZone>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ExtendedZone>>;
    ...
    pub mod register {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.EdgeZones/extendedZones/{}/register",
                    &self.subscription_id, &self.extended_zone_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod unregister {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.EdgeZones/extendedZones/{}/unregister",
                    &self.subscription_id, &self.extended_zone_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
