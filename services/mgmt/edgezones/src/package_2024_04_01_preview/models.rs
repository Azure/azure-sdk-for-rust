...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ExtendedZone {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "The properties of an Extended Zone resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ExtendedZoneProperties>,
}
impl ExtendedZone {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "The response of a ExtendedZone list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ExtendedZoneListResult {
    #[doc = "The ExtendedZone items on this page"]
    pub value: Vec<ExtendedZone>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ExtendedZoneListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl ExtendedZoneListResult {
    pub fn new(value: Vec<ExtendedZone>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "The properties of an Extended Zone resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ExtendedZoneProperties {
    ...
    #[serde(rename = "regionalDisplayName")]
    ...
    #[serde(rename = "geographyGroup")]
    pub geography_group: String,
...
#[doc = "The Azure Extended Zone registration status for a subscription"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "RegistrationState")]
...
impl Serialize for RegistrationState {
    ...
    {
        match self {
            Self::NotRegistered => serializer.serialize_unit_variant("RegistrationState", 0u32, "NotRegistered"),
            Self::PendingRegister => serializer.serialize_unit_variant("RegistrationState", 1u32, "PendingRegister"),
            Self::Registered => serializer.serialize_unit_variant("RegistrationState", 2u32, "Registered"),
            Self::PendingUnregister => serializer.serialize_unit_variant("RegistrationState", 3u32, "PendingUnregister"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
