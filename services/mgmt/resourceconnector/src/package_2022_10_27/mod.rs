...
pub mod appliances {
    ...
    pub mod get_telemetry_config {
        ...
        impl RequestBuilder {
            ...
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::ApplianceGetTelemetryConfigResult>> {
    ...
    pub mod list_keys {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::ApplianceListKeysResults>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
