...
pub mod appliances {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::Appliance>> {
    ...
    pub mod list_cluster_customer_user_credential {
        ...
        impl RequestBuilder {
            ...
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, azure_core::Result<models::ApplianceListClusterCustomerUserCredentialResults>>
            {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    ...
    pub mod list_cluster_user_credential {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::ApplianceListCredentialResults>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
    pub mod get_upgrade_graph {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::UpgradeGraph>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
