...
pub mod container_group_properties {
    ...
    pub struct Properties {
        ...
        #[doc = "Time in seconds in which a container group deployment would timeout and fail. The allowed maximum value is 1800 seconds. If value is not provided, property is given maximum value by default."]
        #[serde(rename = "provisioningTimeoutInSeconds", default, skip_serializing_if = "Option::is_none")]
        pub provisioning_timeout_in_seconds: Option<i32>,
        #[doc = "Flag indicating whether a custom value was provided for the provisioningTimeoutInSeconds property"]
        #[serde(rename = "isCustomProvisioningTimeout", default, skip_serializing_if = "Option::is_none")]
        pub is_custom_provisioning_timeout: Option<properties::IsCustomProvisioningTimeout>,
    ...
    impl Properties {
        pub fn new(containers: Vec<Container>, os_type: properties::OsType) -> Self {
            Self {
                ...
                provisioning_timeout_in_seconds: None,
                is_custom_provisioning_timeout: None,
                restart_policy: None,
                ip_address: None,
                os_type,
                volumes: Vec::new(),
    ...
    pub mod properties {
        ...
        #[doc = "Flag indicating whether a custom value was provided for the provisioningTimeoutInSeconds property"]
        #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
        #[serde(remote = "IsCustomProvisioningTimeout")]
        pub enum IsCustomProvisioningTimeout {
            True,
            False,
            #[serde(skip_deserializing)]
            UnknownValue(String),
        }
        impl FromStr for IsCustomProvisioningTimeout {
            type Err = value::Error;
            fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
                Self::deserialize(s.into_deserializer())
            }
        }
        impl<'de> Deserialize<'de> for IsCustomProvisioningTimeout {
        ...
        impl Serialize for IsCustomProvisioningTimeout {
            fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
            where
                S: Serializer,
            {
                match self {
                    Self::True => serializer.serialize_unit_variant("IsCustomProvisioningTimeout", 0u32, "True"),
                    Self::False => serializer.serialize_unit_variant("IsCustomProvisioningTimeout", 1u32, "False"),
