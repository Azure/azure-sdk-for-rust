...
#[doc = "The object that contains a reference to a Container Group Profile"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ContainerGroupProfileStub {
    #[doc = "The API entity reference."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resource: Option<ApiEntityReference>,
}
impl ContainerGroupProfileStub {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Describes the elastic profile of the Container Scale Set"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct NGroup {
    ...
    #[doc = "Describes the properties of a Container Scale Set."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<NGroupProperties>,
    #[doc = "Identity for the nGroup."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub identity: Option<NGroupIdentity>,
    #[doc = "The nGroups zones. NOTE: Availability zones can only be set when you create the scale set"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
#[doc = "Identity for the nGroup."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NGroupIdentity {
    #[doc = "The principal id of the nGroup identity. This property will only be provided for a system assigned identity."]
    #[serde(rename = "principalId", default, skip_serializing_if = "Option::is_none")]
    pub principal_id: Option<String>,
    #[doc = "The tenant id associated with the nGroup. This property will only be provided for a system assigned identity."]
    #[serde(rename = "tenantId", default, skip_serializing_if = "Option::is_none")]
    pub tenant_id: Option<String>,
    #[doc = "The type of identity used for the container scale set. The type 'SystemAssigned, UserAssigned' includes both an implicitly created identity and a set of user assigned identities. The type 'None' will remove any identities from the nGroup."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<n_group_identity::Type>,
    #[doc = "The list of user identities associated with the container scale set. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'."]
    #[serde(rename = "userAssignedIdentities", default, skip_serializing_if = "Option::is_none")]
    pub user_assigned_identities: Option<serde_json::Value>,
}
impl NGroupIdentity {
...
#[doc = "Describes the properties of a Container Scale Set."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NGroupProperties {
    #[doc = "Describes the elastic profile of the Container Scale Set"]
    #[serde(rename = "elasticProfile", default, skip_serializing_if = "Option::is_none")]
    pub elastic_profile: Option<ElasticProfile>,
    #[doc = "The Container Group Profiles that could be used in a nGroup."]
    #[serde(
        rename = "containerGroupProfiles",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub container_group_profiles: Vec<ContainerGroupProfileStub>,
    #[doc = "The provisioning state, which only appears in the response."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<n_group_properties::ProvisioningState>,
}
impl NGroupProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod n_group_properties {
    use super::*;
    #[doc = "The provisioning state, which only appears in the response."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "The container probe, for liveness or readiness."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NGroupSkus {
    #[doc = "The type of resource the sku is applied to."]
    #[serde(rename = "resourceType", default, skip_serializing_if = "Option::is_none")]
    pub resource_type: Option<String>,
    #[doc = "The sku of the resource type"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sku: Option<String>,
    #[doc = "The number of container groups of the nGroups."]
    #[serde(rename = "skuCapacity", default, skip_serializing_if = "Option::is_none")]
    pub sku_capacity: Option<String>,
}
impl NGroupSkus {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "The nGroups list response that contains the nGroups properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NGroupsListResult {
    #[doc = "The list of N Groups."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<NGroup>,
    #[doc = "The URI to fetch the next page of N Groups."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for NGroupsListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl NGroupsListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "List of SKU definitions. NGroups offer a single sku"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NGroupsSkusList {
    #[doc = "The list of N Groups SKUs."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<NGroupSkus>,
    #[doc = "The URI to fetch the next page of N Groups SKUs."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for NGroupsSkusList {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl NGroupsSkusList {
    pub fn new() -> Self {
        Self::default()
    }
}
