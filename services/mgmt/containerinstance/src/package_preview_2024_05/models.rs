...
#[doc = "The container config map."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ConfigMap {
    #[doc = "The key value pairs dictionary in the config map."]
    #[serde(rename = "keyValuePairs", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "A container group profile."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ContainerGroupProfile {
    #[serde(flatten)]
    pub resource: Resource,
    #[serde(flatten)]
    pub container_group_profile_properties: ContainerGroupProfileProperties,
}
impl ContainerGroupProfile {
    pub fn new(container_group_profile_properties: ContainerGroupProfileProperties) -> Self {
        Self {
            resource: Resource::default(),
            container_group_profile_properties,
        }
    }
}
#[doc = "The container group profile list response that contains the container group profile properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ContainerGroupProfileListResult {
    #[doc = "The list of container group profiles."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<ContainerGroupProfile>,
    #[doc = "The URI to fetch the next page of container group profiles."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ContainerGroupProfileListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl ContainerGroupProfileListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Properties of container group profile that need to be patched"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ContainerGroupProfilePatch {
    #[doc = "Resource tags."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<serde_json::Value>,
}
impl ContainerGroupProfilePatch {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The container group profile properties"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ContainerGroupProfileProperties {
    #[doc = "The container group profile properties"]
    pub properties: container_group_profile_properties::Properties,
}
impl ContainerGroupProfileProperties {
    pub fn new(properties: container_group_profile_properties::Properties) -> Self {
        Self { properties }
    }
}
pub mod container_group_profile_properties {
    use super::*;
    #[doc = "The container group profile properties"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub struct Properties {
        ...
        #[doc = "The container group profile current revision number. This only appears in the response."]
        #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "The container group profile reference."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ContainerGroupProfileReferenceDefinition {
    #[doc = "The container group profile reference id.This will be an ARM resource id in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerInstance/containerGroupProfiles/{containerGroupProfileName}'."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "The container group profile reference revision."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub revision: Option<i32>,
}
impl ContainerGroupProfileReferenceDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub mod container_group_properties {
    ...
    pub struct Properties {
        ...
        pub container_group_profile: Option<ContainerGroupProfileReferenceDefinition>,
        #[doc = "The standby pool profile reference."]
        #[serde(rename = "standbyPoolProfile", default, skip_serializing_if = "Option::is_none")]
        pub standby_pool_profile: Option<StandbyPoolProfileDefinition>,
        #[doc = "The flag indicating whether the container group is created by standby pool."]
        #[serde(rename = "isCreatedFromStandbyPool", default, skip_serializing_if = "Option::is_none")]
    ...
    impl Properties {
        pub fn new(containers: Vec<Container>) -> Self {
            Self {
                ...
                confidential_compute_properties: None,
                priority: None,
                container_group_profile: None,
                standby_pool_profile: None,
                is_created_from_standby_pool: None,
            }
        }
    }
    pub mod properties {
...
#[doc = "The standby pool profile reference."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct StandbyPoolProfileDefinition {
    #[doc = "The standby pool profile reference id.This will be an ARM resource id in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StandbyPool/standbyContainerGroupPools/{standbyPoolName}'."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "The flag to determine whether ACI should fail the create request if the container group can not be obtained from standby pool."]
    #[serde(
        rename = "failContainerGroupCreateOnReuseFailure",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub fail_container_group_create_on_reuse_failure: Option<bool>,
}
impl StandbyPoolProfileDefinition {
    pub fn new() -> Self {
        Self::default()
    }
}
