...
pub use package_preview_2020_07::{models, operations, operations::Client, operations::ClientBuilder};
...
pub use package_preview_2020_03::{models, operations, operations::Client, operations::ClientBuilder};
...
pub use package_preview_2017_04::{models, operations, operations::Client, operations::ClientBuilder};
#[cfg(feature = "package-2020-03")]
pub mod package_2020_03;
#[cfg(all(feature = "package-2020-03", not(feature = "no-default-tag")))]
pub use package_2020_03::{models, operations, operations::Client, operations::ClientBuilder};
#[cfg(feature = "package-2017-04-01")]
pub mod package_2017_04_01;
#[cfg(all(feature = "package-2017-04-01", not(feature = "no-default-tag")))]
pub use package_2017_04_01::{models, operations, operations::Client, operations::ClientBuilder};
