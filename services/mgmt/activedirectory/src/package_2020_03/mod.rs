...
pub mod private_link_for_azure_ad {
    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::PrivateLinkPolicy> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::PrivateLinkPolicy = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::PrivateLinkPolicy>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::PrivateLinkPolicy>>;
    ...
    pub mod list_by_subscription {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::PrivateLinkPolicyListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::PrivateLinkPolicyListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::PrivateLinkPolicyListResult, azure_core::error::Error> {
...
pub mod private_link_resources {
    ...
    impl Client {
        ...
        pub fn list_by_private_link_policy(
            ...
            resource_group_name: impl Into<String>,
            policy_name: impl Into<String>,
        ) -> list_by_private_link_policy::RequestBuilder {
            list_by_private_link_policy::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
...
pub mod private_endpoint_connections {
    ...
    impl Client {
        ...
        pub fn list_by_policy_name(
            ...
            policy_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ) -> list_by_policy_name::RequestBuilder {
            list_by_policy_name::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                policy_name: policy_name.into(),
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/microsoft.aadiam/privateLinkForAzureAd/{}/privateEndpointConnections/{}" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . policy_name , & self . private_endpoint_connection_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2020-03-01");
