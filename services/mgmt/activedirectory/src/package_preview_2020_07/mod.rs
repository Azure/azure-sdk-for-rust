...
pub mod azure_ad_metrics {
    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AzureAdMetricsConfig> {
                ...
                let body: models::AzureAdMetricsConfig = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    ...
                    &self.subscription_id, &self.resource_group_name, &self.azure_ad_metrics_name
                ));
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AzureAdMetricsConfig>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::AzureAdMetricsConfig>>;
    ...
    pub mod list_by_subscription {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AzureAdMetricsListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AzureAdMetricsListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::AzureAdMetricsListResult, azure_core::error::Error> {
