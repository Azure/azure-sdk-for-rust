    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path("/providers/Microsoft.AzureTerraform/operations");
...
impl Client {
    ...
    #[doc = "* `export_parameter`: The export parameter"]
    pub fn export_terraform(
        &self,
        subscription_id: impl Into<String>,
        export_parameter: impl Into<models::BaseExportModelUnion>,
    ) -> export_terraform::RequestBuilder {
        export_terraform::RequestBuilder {
            client: self.clone(),
            subscription_id: subscription_id.into(),
            export_parameter: export_parameter.into(),
        }
    }
}
pub mod export_terraform {
    ...
    pub struct RequestBuilder {
        ...
        pub(crate) export_parameter: models::BaseExportModelUnion,
    }
    impl RequestBuilder {
        ...
        pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
            Box::pin({
                ...
                async move {
                    ...
                    let req_body = azure_core::to_json(&this.export_parameter)?;
                    req.set_body(req_body);
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!(
                "/subscriptions/{}/providers/Microsoft.AzureTerraform/exportTerraform",
...
pub mod operation_statuses {
    ...
    impl Client {
        ...
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        pub fn get(&self, operation_id: impl Into<String>, subscription_id: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.AzureTerraform/operationStatuses/{}",
