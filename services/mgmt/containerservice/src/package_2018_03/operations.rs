...
pub mod managed_clusters {
    ...
    pub async fn list_cluster_admin_credentials(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                list_cluster_admin_credentials::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                }
                .fail()
    ...
    pub async fn list_cluster_user_credentials(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                list_cluster_user_credentials::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                }
                .fail()
    ...
    pub async fn reset_service_principal_profile(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                reset_service_principal_profile::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                }
                .fail()
    ...
    pub async fn reset_aad_profile(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                reset_aad_profile::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                }
                .fail()
