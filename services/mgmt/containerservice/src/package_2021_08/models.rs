...
pub struct ManagedClusterAgentPoolProfileProperties {
    #[doc = "Desired Number of agents (VMs) specified to host docker containers. Allowed values must be in the range of 0 to 1000 (inclusive) for user pools and in the range of 1 to 1000 (inclusive) for system pools. The default value is 1."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub mod managed_cluster_load_balancer_profile {
    ...
    pub struct ManagedOutboundIPs {
        #[doc = "The desired number of outbound IPs created/managed by Azure for the cluster load balancer. Allowed values must be in the range of 1 to 100 (inclusive). The default value is 1. "]
        #[serde(default, skip_serializing_if = "Option::is_none")]
        pub count: Option<i32>,
    }
...
pub struct ManagedClusterProperties {
    ...
    #[doc = "Default value is 'Enabled' (case insensitive). Could be set to 'Disabled' to enable private cluster"]
