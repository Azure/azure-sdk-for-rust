...
pub mod snapshots {
    ...
    pub async fn list(
        operation_config: &crate::OperationConfig,
        subscription_id: &str,
    ) -> std::result::Result<models::SnapshotListResult, list::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
    ...
    pub async fn list_by_resource_group(
        ...
        subscription_id: &str,
        resource_group_name: &str,
    ) -> std::result::Result<models::SnapshotListResult, list_by_resource_group::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
    ...
    pub async fn update_tags(
        ...
        resource_name: &str,
        parameters: &models::TagsObject,
    ) -> std::result::Result<models::Snapshot, update_tags::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ContainerService/snapshots/{}",
            operation_config.base_path(),
