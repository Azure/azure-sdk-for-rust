...
pub enum Error {
    ...
    #[error(transparent)]
    ManagedClusters_RotateServiceAccountSigningKeys(#[from] managed_clusters::rotate_service_account_signing_keys::Error),
    #[error(transparent)]
    ...
    #[error(transparent)]
    ManagedClusterSnapshots_List(#[from] managed_cluster_snapshots::list::Error),
    #[error(transparent)]
    ManagedClusterSnapshots_ListByResourceGroup(#[from] managed_cluster_snapshots::list_by_resource_group::Error),
    #[error(transparent)]
    ManagedClusterSnapshots_Get(#[from] managed_cluster_snapshots::get::Error),
    #[error(transparent)]
    ManagedClusterSnapshots_CreateOrUpdate(#[from] managed_cluster_snapshots::create_or_update::Error),
    #[error(transparent)]
    ManagedClusterSnapshots_UpdateTags(#[from] managed_cluster_snapshots::update_tags::Error),
    #[error(transparent)]
    ManagedClusterSnapshots_Delete(#[from] managed_cluster_snapshots::delete::Error),
}
pub mod operations {
    use super::models;
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::OperationListResult, Error>> {
                Box::pin(async move {
                    ...
                    url.query_pairs_mut().append_pair("api-version", "2022-03-02-preview");
...
pub mod managed_clusters {
        ...
        impl Builder {
            ...
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<Response, Error>> {
                Box::pin(async move {
                    ...
                    req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
                    url.query_pairs_mut().append_pair("api-version", "2022-03-02-preview");
                    if let Some(ignore_pod_disruption_budget) = &self.ignore_pod_disruption_budget {
                        url.query_pairs_mut()
    ...
    pub mod rotate_service_account_signing_keys {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<Response, Error>> {
                Box::pin(async move {
                    let url_str = & format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ContainerService/managedClusters/{}/rotateServiceAccountSigningKeys" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . resource_name) ;
                    let mut url = url::Url::parse(url_str).map_err(Error::ParseUrl)?;
                    let mut req_builder = http::request::Builder::new();
                    req_builder = req_builder.method(http::Method::POST);
                    let credential = self.client.token_credential();
...
pub mod managed_cluster_snapshots {
    ...
    pub mod list {
        ...
        impl Builder {
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, std::result::Result<models::ManagedClusterSnapshotListResult, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                            let rsp_value: models::ManagedClusterSnapshotListResult =
                                serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                            Ok(rsp_value)
                        }
                        status_code => {
    ...
    pub mod get {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::ManagedClusterSnapshot, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ContainerService/managedclustersnapshots/{}",
                        self.client.endpoint(),
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                            let rsp_value: models::ManagedClusterSnapshot =
                                serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                            Ok(rsp_value)
                        }
                        status_code => {
