...
pub mod open_shift_managed_clusters {
    ...
    pub mod list {
        use super::models;
        type Response = models::OpenShiftManagedClusterListResult;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
                        ...
                        let rsp = match continuation {
                            Some(token) => {
                                ...
                                if !has_api_version_already {
                                    url.query_pairs_mut().append_pair("api-version", "2018-09-30-preview");
                                }
    ...
    pub mod get {
        use super::models;
        type Response = models::OpenShiftManagedCluster;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        let token_response = credential
                            ...
                            .map_err(Error::GetToken)?;
                        req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
                        url.query_pairs_mut().append_pair("api-version", "2019-02-01");
                        let req_body = azure_core::EMPTY_BODY;
                        req_builder = req_builder.uri(url.as_str());
                        let req = req_builder.body(req_body).map_err(Error::BuildRequest)?;
                        let rsp = this.client.send(req).await.map_err(Error::SendRequest)?;
...
pub mod agent_pools {
    ...
    impl Client {
        ...
        pub fn list(
            ...
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            managed_cluster_name: impl Into<String>,
        ) -> list::Builder {
            list::Builder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
                managed_cluster_name: managed_cluster_name.into(),
            }
        }
    ...
    pub mod list {
        ...
        pub struct Builder {
            ...
            pub(crate) subscription_id: String,
            pub(crate) resource_group_name: String,
            pub(crate) managed_cluster_name: String,
        }
        impl Builder {
            pub fn into_stream(self) -> azure_core::Pageable<Response, Error> {
                let make_request = move |continuation: Option<azure_core::prelude::Continuation>| {
