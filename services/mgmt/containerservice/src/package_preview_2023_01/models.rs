...
use std::str::FromStr;
#[doc = "For schedules like: 'recur every month on the 15th' or 'recur every 3 months on the 20th'."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AbsoluteMonthlySchedule {
    #[doc = "Specifies the number of months between each set of occurrences."]
    #[serde(rename = "intervalMonths")]
    pub interval_months: i32,
    #[doc = "The date of the month."]
    #[serde(rename = "dayOfMonth")]
    pub day_of_month: i32,
}
impl AbsoluteMonthlySchedule {
    pub fn new(interval_months: i32, day_of_month: i32) -> Self {
        Self {
            interval_months,
            day_of_month,
        }
...
#[doc = "Network settings of an agent pool."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AgentPoolNetworkProfile {
    #[doc = "The list of tags associated with the node public IP address."]
    #[serde(rename = "nodePublicIPTags", default, skip_serializing_if = "Option::is_none")]
    pub node_public_ip_tags: Option<NodePublicIpTags>,
    #[doc = "The port ranges that are allowed to access. The specified ranges are allowed to overlap."]
    #[serde(
        rename = "allowedHostPorts",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub allowed_host_ports: Vec<PortRange>,
    #[doc = "The IDs of the application security groups which agent pool will associate when created."]
    #[serde(
    ...
    pub application_security_groups: Vec<String>,
}
impl AgentPoolNetworkProfile {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "The Windows agent pool's specific profile."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AgentPoolWindowsProfile {
    #[doc = "The default value is false. Outbound NAT can only be disabled if the cluster outboundType is NAT Gateway and the Windows agent pool does not have node public IP enabled."]
    #[serde(rename = "disableOutboundNat", default, skip_serializing_if = "Option::is_none")]
    pub disable_outbound_nat: Option<bool>,
}
impl AgentPoolWindowsProfile {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct AzureKeyVaultKms {
    ...
    #[doc = "Network access of key vault. The possible values are `Public` and `Private`. `Public` means the key vault allows public access from all networks. `Private` means the key vault disables public access and enables private link. The default value is `Public`."]
    #[serde(rename = "keyVaultNetworkAccess", default, skip_serializing_if = "Option::is_none")]
    pub key_vault_network_access: Option<azure_key_vault_kms::KeyVaultNetworkAccess>,
    #[doc = "Resource ID of key vault. When keyVaultNetworkAccess is `Private`, this field is required and must be a valid resource ID. When keyVaultNetworkAccess is `Public`, leave the field empty."]
...
pub mod azure_key_vault_kms {
    use super::*;
    #[doc = "Network access of key vault. The possible values are `Public` and `Private`. `Public` means the key vault allows public access from all networks. `Private` means the key vault disables public access and enables private link. The default value is `Public`."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "KeyVaultNetworkAccess")]
    ...
    impl FromStr for KeyVaultNetworkAccess {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for KeyVaultNetworkAccess {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for KeyVaultNetworkAccess {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Public => serializer.serialize_unit_variant("KeyVaultNetworkAccess", 0u32, "Public"),
                Self::Private => serializer.serialize_unit_variant("KeyVaultNetworkAccess", 1u32, "Private"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for KeyVaultNetworkAccess {
        fn default() -> Self {
            Self::Public
        }
    }
...
#[doc = "Settings for upgrading a cluster."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ClusterUpgradeSettings {
    #[doc = "Settings for overrides when upgrading a cluster."]
    #[serde(rename = "overrideSettings", default, skip_serializing_if = "Option::is_none")]
    pub override_settings: Option<UpgradeOverrideSettings>,
}
impl ClusterUpgradeSettings {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ContainerServiceNetworkProfile {
    ...
    #[doc = "The eBPF dataplane used for building the Kubernetes network."]
    #[serde(rename = "ebpfDataplane", default, skip_serializing_if = "Option::is_none")]
    ...
    #[doc = "Holds configuration customizations for kube-proxy. Any values not defined will use the kube-proxy defaulting behavior. See https://v<version>.docs.kubernetes.io/docs/reference/command-line-tools-reference/kube-proxy/ where <version> is represented by a <major version>-<minor version> string. Kubernetes version 1.23 would be '1-23'."]
    #[serde(rename = "kubeProxyConfig", default, skip_serializing_if = "Option::is_none")]
    pub kube_proxy_config: Option<container_service_network_profile::KubeProxyConfig>,
}
...
pub mod container_service_network_profile {
    ...
    pub struct KubeProxyConfig {
        #[doc = "Whether to enable on kube-proxy on the cluster (if no 'kubeProxyConfig' exists, kube-proxy is enabled in AKS by default without these customizations)."]
        #[serde(default, skip_serializing_if = "Option::is_none")]
        pub enabled: Option<bool>,
        #[doc = "Specify which proxy mode to use ('IPTABLES' or 'IPVS')"]
        #[serde(default, skip_serializing_if = "Option::is_none")]
        pub mode: Option<kube_proxy_config::Mode>,
        #[doc = "Holds configuration customizations for IPVS. May only be specified if 'mode' is set to 'IPVS'."]
        #[serde(rename = "ipvsConfig", default, skip_serializing_if = "Option::is_none")]
        pub ipvs_config: Option<kube_proxy_config::IpvsConfig>,
    }
    ...
    pub mod kube_proxy_config {
        ...
        impl Serialize for Mode {
            ...
            {
                match self {
                    Self::Iptables => serializer.serialize_unit_variant("Mode", 0u32, "IPTABLES"),
                    Self::Ipvs => serializer.serialize_unit_variant("Mode", 1u32, "IPVS"),
                    Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
                }
            }
        }
        ...
        pub struct IpvsConfig {
            #[doc = "IPVS scheduler, for more information please see http://www.linuxvirtualserver.org/docs/scheduling.html."]
            #[serde(default, skip_serializing_if = "Option::is_none")]
            pub scheduler: Option<ipvs_config::Scheduler>,
            #[doc = "The timeout value used for idle IPVS TCP sessions in seconds. Must be a positive integer value."]
            #[serde(rename = "tcpTimeoutSeconds", default, skip_serializing_if = "Option::is_none")]
            pub tcp_timeout_seconds: Option<i32>,
            #[doc = "The timeout value used for IPVS TCP sessions after receiving a FIN in seconds. Must be a positive integer value."]
            #[serde(rename = "tcpFinTimeoutSeconds", default, skip_serializing_if = "Option::is_none")]
            pub tcp_fin_timeout_seconds: Option<i32>,
            #[doc = "The timeout value used for IPVS UDP packets in seconds. Must be a positive integer value."]
            #[serde(rename = "udpTimeoutSeconds", default, skip_serializing_if = "Option::is_none")]
            pub udp_timeout_seconds: Option<i32>,
        }
        impl IpvsConfig {
            pub fn new() -> Self {
                Self::default()
        ...
        pub mod ipvs_config {
            ...
            impl Serialize for Scheduler {
                ...
                {
                    match self {
                        Self::RoundRobin => serializer.serialize_unit_variant("Scheduler", 0u32, "RoundRobin"),
                        Self::LeastConnection => serializer.serialize_unit_variant("Scheduler", 1u32, "LeastConnection"),
                        Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
                    }
                }
            }
...
#[doc = "The list of control plane upgrade override settings."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ControlPlaneUpgradeOverride")]
pub enum ControlPlaneUpgradeOverride {
    IgnoreKubernetesDeprecations,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for ControlPlaneUpgradeOverride {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for ControlPlaneUpgradeOverride {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for ControlPlaneUpgradeOverride {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::IgnoreKubernetesDeprecations => {
                serializer.serialize_unit_variant("ControlPlaneUpgradeOverride", 0u32, "IgnoreKubernetesDeprecations")
            }
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
...
#[doc = "For schedules like: 'recur every day' or 'recur every 3 days'."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DailySchedule {
    #[doc = "Specifies the number of days between each set of occurrences."]
    #[serde(rename = "intervalDays")]
    pub interval_days: i32,
}
impl DailySchedule {
    pub fn new(interval_days: i32) -> Self {
        Self { interval_days }
    }
}
#[doc = "For example, between '2022-12-23' and '2023-01-05'."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DateSpan {
    #[doc = "The start date of the date span."]
    pub start: String,
    #[doc = "The end date of the date span."]
    pub end: String,
}
impl DateSpan {
...
impl FromStr for EbpfDataplane {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for EbpfDataplane {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for EbpfDataplane {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Cilium => serializer.serialize_unit_variant("EbpfDataplane", 0u32, "cilium"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "The Fleet resource which contains multiple Kubernetes clusters as its members."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct Fleet {
    #[serde(flatten)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub etag: Option<String>,
    #[doc = "Properties of a Fleet."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<FleetProperties>,
}
impl Fleet {
...
#[doc = "The credential result response."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct FleetCredentialResult {
    #[doc = "The name of the credential."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Base64-encoded Kubernetes configuration file."]
...
#[doc = "The list credential result response."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct FleetCredentialResults {
    #[doc = "Base64-encoded Kubernetes configuration file."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub kubeconfigs: Vec<FleetCredentialResult>,
}
impl FleetCredentialResults {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl FleetHubProfile {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The response from the List Fleets operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct FleetListResult {
    #[doc = "The list of Fleets."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    ...
    pub value: Vec<Fleet>,
    #[doc = "The URL to get the next page of Fleets."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for FleetListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone()
    }
}
impl FleetListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct FleetMember {
    ...
    #[doc = "Properties of a Fleet member."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<FleetMemberProperties>,
}
impl FleetMember {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "Properties of a Fleet member."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct FleetMemberProperties {
    ...
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<fleet_member_properties::ProvisioningState>,
}
impl FleetMemberProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod fleet_member_properties {
    use super::*;
    #[doc = "The provisioning state of the last accepted operation."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    ...
    impl Serialize for ProvisioningState {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Joining => serializer.serialize_unit_variant("ProvisioningState", 3u32, "Joining"),
                Self::Leaving => serializer.serialize_unit_variant("ProvisioningState", 4u32, "Leaving"),
...
#[doc = "The response from the List FleetMembers operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct FleetMembersListResult {
    #[doc = "The list of members in a given Fleet."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<FleetMember>,
    #[doc = "The URL to get the next page of Fleet members."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for FleetMembersListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone()
    }
}
impl FleetMembersListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct FleetProperties {
    #[doc = "The FleetHubProfile configures the fleet hub."]
    #[serde(rename = "hubProfile", default, skip_serializing_if = "Option::is_none")]
    pub hub_profile: Option<FleetHubProfile>,
    #[doc = "The provisioning state of the last accepted operation."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<fleet_properties::ProvisioningState>,
}
impl FleetProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod fleet_properties {
    use super::*;
    #[doc = "The provisioning state of the last accepted operation."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ProvisioningState")]
...
#[doc = "The Guardrails profile."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GuardrailsProfile {
    #[doc = "List of namespaces specified by AKS to be excluded from Guardrails"]
    #[serde(
        rename = "systemExcludedNamespaces",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub system_excluded_namespaces: Vec<String>,
    #[doc = "The version of constraints to use"]
    pub version: String,
    #[doc = "The guardrails level to be used. By default, Guardrails is enabled for all namespaces except those that AKS excludes via systemExcludedNamespaces"]
    pub level: guardrails_profile::Level,
    #[doc = "List of namespaces excluded from guardrails checks"]
    #[serde(
...
impl GuardrailsProfile {
    pub fn new(version: String, level: guardrails_profile::Level) -> Self {
        Self {
            system_excluded_namespaces: Vec::new(),
            version,
            level,
    ...
    impl Serialize for Level {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Enforcement => serializer.serialize_unit_variant("Level", 2u32, "Enforcement"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct IpTag {
    #[doc = "The IP tag type. Example: RoutingPreference."]
    #[serde(rename = "ipTagType", default, skip_serializing_if = "Option::is_none")]
    pub ip_tag_type: Option<String>,
    #[doc = "The value of the IP tag associated with the public IP. Example: Internet."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct MaintenanceConfigurationProperties {
    ...
    #[doc = "Maintenance window used to configure scheduled auto-upgrade for a Managed Cluster."]
...
pub struct MaintenanceWindow {
    #[doc = "One and only one of the schedule types should be specified. Choose either 'daily', 'weekly', 'absoluteMonthly' or 'relativeMonthly' for your maintenance schedule."]
    pub schedule: Schedule,
    #[doc = "Length of maintenance window range from 4 to 24 hours."]
    #[serde(rename = "durationHours")]
    pub duration_hours: i32,
    #[doc = "The UTC offset in format +/-HH:mm. For example, '+05:30' for IST and '-07:00' for PST. If not specified, the default is '+00:00'."]
    #[serde(rename = "utcOffset", default, skip_serializing_if = "Option::is_none")]
    pub utc_offset: Option<String>,
    #[doc = "The date the maintenance window activates. If the current date is before this date, the maintenance window is inactive and will not be used for upgrades. If not specified, the maintenance window will be active right away."]
    #[serde(rename = "startDate", default, skip_serializing_if = "Option::is_none")]
    pub start_date: Option<String>,
    #[doc = "The start time of the maintenance window. Accepted values are from '00:00' to '23:59'. 'utcOffset' applies to this field. For example: '02:00' with 'utcOffset: +02:00' means UTC time '00:00'."]
    #[serde(rename = "startTime")]
    pub start_time: String,
    #[doc = "Date ranges on which upgrade is not allowed. 'utcOffset' applies to this field. For example, with 'utcOffset: +02:00' and 'dateSpan' being '2022-12-23' to '2023-01-03', maintenance will be blocked from '2022-12-22 22:00' to '2023-01-03 22:00' in UTC time."]
    #[serde(
        rename = "notAllowedDates",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub not_allowed_dates: Vec<DateSpan>,
}
impl MaintenanceWindow {
    pub fn new(schedule: Schedule, duration_hours: i32, start_time: String) -> Self {
        Self {
            schedule,
            duration_hours,
            utc_offset: None,
...
pub struct ManagedClusterAadProfile {
    ...
    #[doc = "(DEPRECATED) The client AAD application ID. Learn more at https://aka.ms/aks/aad-legacy."]
    #[serde(rename = "clientAppID", default, skip_serializing_if = "Option::is_none")]
    pub client_app_id: Option<String>,
    #[doc = "(DEPRECATED) The server AAD application ID. Learn more at https://aka.ms/aks/aad-legacy."]
    #[serde(rename = "serverAppID", default, skip_serializing_if = "Option::is_none")]
    pub server_app_id: Option<String>,
    #[doc = "(DEPRECATED) The server AAD application secret. Learn more at https://aka.ms/aks/aad-legacy."]
...
pub struct ManagedClusterAgentPoolProfileProperties {
    ...
    #[doc = "When set to true, AKS adds a label to the node indicating that the feature is enabled and deploys a daemonset along with host services to sync custom certificate authorities from user-provided list of base64 encoded certificates into node trust stores. Defaults to false."]
    ...
    pub windows_profile: Option<AgentPoolWindowsProfile>,
    #[doc = "Network settings of an agent pool."]
    #[serde(rename = "networkProfile", default, skip_serializing_if = "Option::is_none")]
    pub network_profile: Option<AgentPoolNetworkProfile>,
}
...
pub struct ManagedClusterAutoUpgradeProfile {
    ...
    #[doc = "The default is Unmanaged, but may change to either NodeImage or SecurityPatch at GA."]
    #[serde(rename = "nodeOSUpgradeChannel", default, skip_serializing_if = "Option::is_none")]
    pub node_os_upgrade_channel: Option<managed_cluster_auto_upgrade_profile::NodeOsUpgradeChannel>,
}
...
pub mod managed_cluster_auto_upgrade_profile {
    ...
    #[doc = "The default is Unmanaged, but may change to either NodeImage or SecurityPatch at GA."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "NodeOsUpgradeChannel")]
    pub enum NodeOsUpgradeChannel {
        Unmanaged,
        None,
        SecurityPatch,
        NodeImage,
    ...
    impl FromStr for NodeOsUpgradeChannel {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for NodeOsUpgradeChannel {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for NodeOsUpgradeChannel {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Unmanaged => serializer.serialize_unit_variant("NodeOsUpgradeChannel", 0u32, "Unmanaged"),
                Self::None => serializer.serialize_unit_variant("NodeOsUpgradeChannel", 1u32, "None"),
                Self::SecurityPatch => serializer.serialize_unit_variant("NodeOsUpgradeChannel", 2u32, "SecurityPatch"),
                Self::NodeImage => serializer.serialize_unit_variant("NodeOsUpgradeChannel", 3u32, "NodeImage"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
}
#[doc = "Prometheus addon profile for the container service cluster"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ManagedClusterAzureMonitorProfile {
    #[doc = "Metrics profile for the prometheus service addon"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metrics: Option<ManagedClusterAzureMonitorProfileMetrics>,
}
impl ManagedClusterAzureMonitorProfile {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Kube State Metrics for prometheus addon profile for the container service cluster"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ManagedClusterAzureMonitorProfileKubeStateMetrics {
    #[doc = "Comma-separated list of Kubernetes annotations keys that will be used in the resource's labels metric. "]
    #[serde(rename = "metricLabelsAllowlist", default, skip_serializing_if = "Option::is_none")]
    pub metric_labels_allowlist: Option<String>,
    #[doc = "Comma-separated list of additional Kubernetes label keys that will be used in the resource's labels metric."]
    #[serde(rename = "metricAnnotationsAllowList", default, skip_serializing_if = "Option::is_none")]
    pub metric_annotations_allow_list: Option<String>,
}
impl ManagedClusterAzureMonitorProfileKubeStateMetrics {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Metrics profile for the prometheus service addon"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ManagedClusterAzureMonitorProfileMetrics {
    #[doc = "Whether to enable the Prometheus collector"]
    pub enabled: bool,
    #[doc = "Kube State Metrics for prometheus addon profile for the container service cluster"]
    #[serde(rename = "kubeStateMetrics", default, skip_serializing_if = "Option::is_none")]
    pub kube_state_metrics: Option<ManagedClusterAzureMonitorProfileKubeStateMetrics>,
}
impl ManagedClusterAzureMonitorProfileMetrics {
    pub fn new(enabled: bool) -> Self {
        Self {
            enabled,
...
pub struct ManagedClusterLoadBalancerProfile {
    ...
    #[doc = "The type of the managed inbound Load Balancer BackendPool."]
    #[serde(rename = "backendPoolType", default, skip_serializing_if = "Option::is_none")]
    pub backend_pool_type: Option<managed_cluster_load_balancer_profile::BackendPoolType>,
}
...
pub mod managed_cluster_load_balancer_profile {
    ...
    #[doc = "The type of the managed inbound Load Balancer BackendPool."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "BackendPoolType")]
    pub enum BackendPoolType {
        #[serde(rename = "NodeIPConfiguration")]
        NodeIpConfiguration,
        #[serde(rename = "NodeIP")]
        NodeIp,
        #[serde(skip_deserializing)]
    ...
    impl FromStr for BackendPoolType {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for BackendPoolType {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for BackendPoolType {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::NodeIpConfiguration => serializer.serialize_unit_variant("BackendPoolType", 0u32, "NodeIPConfiguration"),
                Self::NodeIp => serializer.serialize_unit_variant("BackendPoolType", 1u32, "NodeIP"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for BackendPoolType {
        fn default() -> Self {
            Self::NodeIpConfiguration
        }
    }
}
...
#[doc = "Node resource group lockdown profile for a managed cluster."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ManagedClusterNodeResourceGroupProfile {
    #[doc = "The restriction level applied to the cluster's node resource group"]
    #[serde(rename = "restrictionLevel", default, skip_serializing_if = "Option::is_none")]
    pub restriction_level: Option<managed_cluster_node_resource_group_profile::RestrictionLevel>,
}
impl ManagedClusterNodeResourceGroupProfile {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod managed_cluster_node_resource_group_profile {
    use super::*;
    #[doc = "The restriction level applied to the cluster's node resource group"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "RestrictionLevel")]
    ...
    impl FromStr for RestrictionLevel {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for RestrictionLevel {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for RestrictionLevel {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Unrestricted => serializer.serialize_unit_variant("RestrictionLevel", 0u32, "Unrestricted"),
                Self::ReadOnly => serializer.serialize_unit_variant("RestrictionLevel", 1u32, "ReadOnly"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct ManagedClusterProperties {
    ...
    #[doc = "Node resource group lockdown profile for a managed cluster."]
    #[serde(rename = "nodeResourceGroupProfile", default, skip_serializing_if = "Option::is_none")]
    pub node_resource_group_profile: Option<ManagedClusterNodeResourceGroupProfile>,
    ...
    #[doc = "(DEPRECATED) Whether to enable Kubernetes pod security policy (preview). PodSecurityPolicy was deprecated in Kubernetes v1.21, and removed from Kubernetes in v1.25. Learn more at https://aka.ms/k8s/psp and https://aka.ms/aks/psp."]
    ...
    #[doc = "Settings for upgrading a cluster."]
    #[serde(rename = "upgradeSettings", default, skip_serializing_if = "Option::is_none")]
    pub upgrade_settings: Option<ClusterUpgradeSettings>,
    ...
    #[doc = "Workload Auto-scaler profile for the managed cluster."]
    #[serde(rename = "workloadAutoScalerProfile", default, skip_serializing_if = "Option::is_none")]
    pub workload_auto_scaler_profile: Option<ManagedClusterWorkloadAutoScalerProfile>,
    #[doc = "Prometheus addon profile for the container service cluster"]
    #[serde(rename = "azureMonitorProfile", default, skip_serializing_if = "Option::is_none")]
    pub azure_monitor_profile: Option<ManagedClusterAzureMonitorProfile>,
    #[doc = "The Guardrails profile."]
    #[serde(rename = "guardrailsProfile", default, skip_serializing_if = "Option::is_none")]
    pub guardrails_profile: Option<GuardrailsProfile>,
}
...
pub struct ManagedClusterSku {
    ...
    #[doc = "If not specified, the default is 'Free'. See [AKS Pricing Tier](https://learn.microsoft.com/azure/aks/free-standard-pricing-tiers) for more details."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    impl Serialize for Name {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Base => serializer.serialize_unit_variant("Name", 1u32, "Base"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for Tier {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Free => serializer.serialize_unit_variant("Tier", 2u32, "Free"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct ManagedClusterSecurityProfile {
    #[doc = "Microsoft Defender settings for the security profile."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub defender: Option<ManagedClusterSecurityProfileDefender>,
    #[doc = "Azure Key Vault key management service settings for the security profile."]
    ...
    #[doc = "ImageCleaner removes unused images from nodes, freeing up disk space and helping to reduce attack surface area. Here are settings for the security profile."]
    #[serde(rename = "imageCleaner", default, skip_serializing_if = "Option::is_none")]
    pub image_cleaner: Option<ManagedClusterSecurityProfileImageCleaner>,
    #[doc = "Node Restriction settings for the security profile."]
    #[serde(rename = "nodeRestriction", default, skip_serializing_if = "Option::is_none")]
    pub node_restriction: Option<ManagedClusterSecurityProfileNodeRestriction>,
    #[doc = "Certificates will only be added to trust stores on node pools that have enableCustomCATrust field set to true. If updated, the new list of certificates will be installed in the trust store in place of the old certificates. The certificates are applied asynchronously and will be available a short time after the list is updated."]
    #[serde(rename = "customCATrustCertificates", default, skip_serializing_if = "Option::is_none")]
    pub custom_ca_trust_certificates: Option<ManagedClusterSecurityProfileCustomCaTrustCertificates>,
}
...
pub type ManagedClusterSecurityProfileCustomCaTrustCertificates = Vec<String>;
#[doc = "Microsoft Defender settings for the security profile."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ManagedClusterSecurityProfileDefender {
    #[doc = "Resource ID of the Log Analytics workspace to be associated with Microsoft Defender. When Microsoft Defender is enabled, this field is required and must be a valid workspace resource ID. When Microsoft Defender is disabled, leave the field empty."]
    ...
    #[doc = "Microsoft Defender settings for the security profile threat detection."]
    #[serde(rename = "securityMonitoring", default, skip_serializing_if = "Option::is_none")]
    pub security_monitoring: Option<ManagedClusterSecurityProfileDefenderSecurityMonitoring>,
}
impl ManagedClusterSecurityProfileDefender {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Microsoft Defender settings for the security profile threat detection."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ManagedClusterSecurityProfileDefenderSecurityMonitoring {
    #[doc = "Whether to enable Defender threat detection"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
}
impl ManagedClusterSecurityProfileDefenderSecurityMonitoring {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "ImageCleaner removes unused images from nodes, freeing up disk space and helping to reduce attack surface area. Here are settings for the security profile."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ManagedClusterSecurityProfileImageCleaner {
    #[doc = "Whether to enable ImageCleaner on AKS cluster."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
    #[doc = "ImageCleaner scanning interval."]
    #[serde(rename = "intervalHours", default, skip_serializing_if = "Option::is_none")]
    pub interval_hours: Option<i32>,
}
impl ManagedClusterSecurityProfileImageCleaner {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Node Restriction settings for the security profile."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ManagedClusterSecurityProfileNodeRestriction {
    #[doc = "Whether to enable Node Restriction"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
}
impl ManagedClusterSecurityProfileNodeRestriction {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ManagedClusterStorageProfile {
    ...
    #[doc = "AzureBlob CSI Driver settings for the storage profile."]
    #[serde(rename = "blobCSIDriver", default, skip_serializing_if = "Option::is_none")]
    pub blob_csi_driver: Option<ManagedClusterStorageProfileBlobCsiDriver>,
}
...
#[doc = "AzureBlob CSI Driver settings for the storage profile."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ManagedClusterStorageProfileBlobCsiDriver {
    #[doc = "Whether to enable AzureBlob CSI Driver. The default value is false."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
}
impl ManagedClusterStorageProfileBlobCsiDriver {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Workload Auto-scaler profile for the managed cluster."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ManagedClusterWorkloadAutoScalerProfile {
    #[doc = "KEDA (Kubernetes Event-driven Autoscaling) settings for the workload auto-scaler profile."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub keda: Option<ManagedClusterWorkloadAutoScalerProfileKeda>,
    #[serde(rename = "verticalPodAutoscaler", default, skip_serializing_if = "Option::is_none")]
    pub vertical_pod_autoscaler: Option<ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscaler>,
}
impl ManagedClusterWorkloadAutoScalerProfile {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "KEDA (Kubernetes Event-driven Autoscaling) settings for the workload auto-scaler profile."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ManagedClusterWorkloadAutoScalerProfileKeda {
    #[doc = "Whether to enable KEDA."]
    pub enabled: bool,
}
impl ManagedClusterWorkloadAutoScalerProfileKeda {
    pub fn new(enabled: bool) -> Self {
        Self { enabled }
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscaler {
    #[doc = "Whether to enable VPA. Default value is false."]
    pub enabled: bool,
    #[doc = "Controls which resource value autoscaler will change. Default value is RequestsAndLimits."]
    #[serde(rename = "controlledValues")]
    pub controlled_values: managed_cluster_workload_auto_scaler_profile_vertical_pod_autoscaler::ControlledValues,
    #[doc = "Each update mode level is a superset of the lower levels. Off<Initial<Recreate<=Auto. For example: if UpdateMode is Initial, it means VPA sets the recommended resources in the VerticalPodAutoscaler Custom Resource (from UpdateMode Off) and also assigns resources on pod creation (from Initial). The default value is Off."]
    #[serde(rename = "updateMode")]
    pub update_mode: managed_cluster_workload_auto_scaler_profile_vertical_pod_autoscaler::UpdateMode,
}
impl ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscaler {
    pub fn new(
        enabled: bool,
        controlled_values: managed_cluster_workload_auto_scaler_profile_vertical_pod_autoscaler::ControlledValues,
        update_mode: managed_cluster_workload_auto_scaler_profile_vertical_pod_autoscaler::UpdateMode,
    ) -> Self {
        Self {
            enabled,
            controlled_values,
...
pub mod managed_cluster_workload_auto_scaler_profile_vertical_pod_autoscaler {
    use super::*;
    #[doc = "Controls which resource value autoscaler will change. Default value is RequestsAndLimits."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ControlledValues")]
    ...
    impl FromStr for ControlledValues {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for ControlledValues {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for ControlledValues {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::RequestsAndLimits => serializer.serialize_unit_variant("ControlledValues", 0u32, "RequestsAndLimits"),
                Self::RequestsOnly => serializer.serialize_unit_variant("ControlledValues", 1u32, "RequestsOnly"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for ControlledValues {
        fn default() -> Self {
            Self::RequestsAndLimits
        }
    }
    #[doc = "Each update mode level is a superset of the lower levels. Off<Initial<Recreate<=Auto. For example: if UpdateMode is Initial, it means VPA sets the recommended resources in the VerticalPodAutoscaler Custom Resource (from UpdateMode Off) and also assigns resources on pod creation (from Initial). The default value is Off."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    ...
    impl Serialize for UpdateMode {
        ...
        {
            match self {
                Self::Off => serializer.serialize_unit_variant("UpdateMode", 0u32, "Off"),
                Self::Initial => serializer.serialize_unit_variant("UpdateMode", 1u32, "Initial"),
                Self::Recreate => serializer.serialize_unit_variant("UpdateMode", 2u32, "Recreate"),
                Self::Auto => serializer.serialize_unit_variant("UpdateMode", 3u32, "Auto"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub type NodePublicIpTags = Vec<IpTag>;
#[doc = "The default is 'Ephemeral' if the VM supports it and has a cache disk larger than the requested OSDiskSizeGB. Otherwise, defaults to 'Managed'. May not be changed after creation. For more information see [Ephemeral OS](https://docs.microsoft.com/azure/aks/cluster-configuration#ephemeral-os)."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
impl Serialize for Ossku {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::Mariner => serializer.serialize_unit_variant("Ossku", 2u32, "Mariner"),
            Self::Windows2019 => serializer.serialize_unit_variant("Ossku", 3u32, "Windows2019"),
            Self::Windows2022 => serializer.serialize_unit_variant("Ossku", 4u32, "Windows2022"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct PortRange {
    #[doc = "The minimum port that is included in the range. It should be ranged from 1 to 65535, and be less than or equal to portEnd."]
    #[serde(rename = "portStart", default, skip_serializing_if = "Option::is_none")]
    pub port_start: Option<i32>,
    #[doc = "The maximum port that is included in the range. It should be ranged from 1 to 65535, and be greater than or equal to portStart."]
    #[serde(rename = "portEnd", default, skip_serializing_if = "Option::is_none")]
    pub port_end: Option<i32>,
    #[doc = "The network protocol of the port."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub protocol: Option<port_range::Protocol>,
}
impl PortRange {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "For schedules like: 'recur every month on the first Monday' or 'recur every 3 months on last Friday'."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RelativeMonthlySchedule {
    #[doc = "Specifies the number of months between each set of occurrences."]
    #[serde(rename = "intervalMonths")]
    pub interval_months: i32,
    #[doc = "Specifies on which instance of the allowed days specified in daysOfWeek the maintenance occurs."]
    #[serde(rename = "weekIndex")]
    pub week_index: relative_monthly_schedule::WeekIndex,
    #[doc = "The weekday enum."]
    #[serde(rename = "dayOfWeek")]
    pub day_of_week: WeekDay,
}
impl RelativeMonthlySchedule {
    pub fn new(interval_months: i32, week_index: relative_monthly_schedule::WeekIndex, day_of_week: WeekDay) -> Self {
        Self {
            interval_months,
            week_index,
            day_of_week,
...
pub mod relative_monthly_schedule {
    use super::*;
    #[doc = "Specifies on which instance of the allowed days specified in daysOfWeek the maintenance occurs."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "WeekIndex")]
    pub enum WeekIndex {
        First,
        Second,
        Third,
    ...
    impl Serialize for WeekIndex {
        ...
        {
            match self {
                Self::First => serializer.serialize_unit_variant("WeekIndex", 0u32, "First"),
                Self::Second => serializer.serialize_unit_variant("WeekIndex", 1u32, "Second"),
                Self::Third => serializer.serialize_unit_variant("WeekIndex", 2u32, "Third"),
                Self::Fourth => serializer.serialize_unit_variant("WeekIndex", 3u32, "Fourth"),
                Self::Last => serializer.serialize_unit_variant("WeekIndex", 4u32, "Last"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct Schedule {
    ...
    #[doc = "For schedules like: 'recur every Monday' or 'recur every 3 weeks on Wednesday'."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub weekly: Option<WeeklySchedule>,
    #[doc = "For schedules like: 'recur every month on the 15th' or 'recur every 3 months on the 20th'."]
    #[serde(rename = "absoluteMonthly", default, skip_serializing_if = "Option::is_none")]
    pub absolute_monthly: Option<AbsoluteMonthlySchedule>,
    #[doc = "For schedules like: 'recur every month on the first Monday' or 'recur every 3 months on last Friday'."]
    #[serde(rename = "relativeMonthly", default, skip_serializing_if = "Option::is_none")]
    pub relative_monthly: Option<RelativeMonthlySchedule>,
}
impl Schedule {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "Settings for overrides when upgrading a cluster."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct UpgradeOverrideSettings {
    #[doc = "List of upgrade overrides when upgrading a cluster's control plane."]
    #[serde(
        rename = "controlPlaneOverrides",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub control_plane_overrides: Vec<ControlPlaneUpgradeOverride>,
    #[doc = "Until when the overrides are effective. Note that this only matches the start time of an upgrade, and the effectiveness won't change once an upgrade starts even if the `until` expires as upgrade proceeds. This field is not set by default. It must be set for the overrides to take effect."]
    #[serde(default, with = "azure_core::date::rfc3339::option")]
    pub until: Option<time::OffsetDateTime>,
}
impl UpgradeOverrideSettings {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct WeeklySchedule {
    #[doc = "Specifies the number of weeks between each set of occurrences."]
    #[serde(rename = "intervalWeeks")]
...
impl WeeklySchedule {
    pub fn new(interval_weeks: i32, day_of_week: WeekDay) -> Self {
        Self {
            interval_weeks,
            day_of_week,
        }
...
impl Serialize for WorkloadRuntime {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::KataMshvVmIsolation => serializer.serialize_unit_variant("WorkloadRuntime", 2u32, "KataMshvVmIsolation"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
