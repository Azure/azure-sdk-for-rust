...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "AddSubscriptionOperationState")]
pub enum AddSubscriptionOperationState {
    Succeeded,
    Updating,
    Failed,
...
impl FromStr for AddSubscriptionOperationState {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for AddSubscriptionOperationState {
...
impl Serialize for AddSubscriptionOperationState {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Succeeded => serializer.serialize_unit_variant("AddSubscriptionOperationState", 0u32, "Succeeded"),
            Self::Updating => serializer.serialize_unit_variant("AddSubscriptionOperationState", 1u32, "Updating"),
            Self::Failed => serializer.serialize_unit_variant("AddSubscriptionOperationState", 2u32, "Failed"),
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AzureSubscriptions {
    #[doc = "Azure Subscription Ids to be updated"]
    #[serde(rename = "azureSubscriptionIds")]
    pub azure_subscription_ids: Vec<String>,
}
impl AzureSubscriptions {
    pub fn new(azure_subscription_ids: Vec<String>) -> Self {
...
pub struct OracleSubscriptionProperties {
    ...
    pub azure_subscription_ids: Vec<String>,
    #[doc = "Add Subscription Operation state enum"]
    #[serde(rename = "addSubscriptionOperationState", default, skip_serializing_if = "Option::is_none")]
    pub add_subscription_operation_state: Option<AddSubscriptionOperationState>,
    #[doc = "Status details of the last operation on Oracle subscription"]
    #[serde(rename = "lastOperationStatusDetail", default, skip_serializing_if = "Option::is_none")]
    pub last_operation_status_detail: Option<String>,
}
