...
pub struct ExperimentationWorkspaceProperties {
    ...
    pub provisioning_state: Option<ExperimentationWorkspaceProvisioningState>,
    #[doc = "Access policy for an experimentation workspace."]
...
#[doc = "The experimentation workspace resource provisioning state"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ExperimentationWorkspaceProvisioningState")]
pub enum ExperimentationWorkspaceProvisioningState {
    Succeeded,
    Failed,
    Canceled,
    Accepted,
...
impl FromStr for ExperimentationWorkspaceProvisioningState {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for ExperimentationWorkspaceProvisioningState {
...
impl Serialize for ExperimentationWorkspaceProvisioningState {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Succeeded => serializer.serialize_unit_variant("ExperimentationWorkspaceProvisioningState", 0u32, "Succeeded"),
            Self::Failed => serializer.serialize_unit_variant("ExperimentationWorkspaceProvisioningState", 1u32, "Failed"),
            Self::Canceled => serializer.serialize_unit_variant("ExperimentationWorkspaceProvisioningState", 2u32, "Canceled"),
            Self::Accepted => serializer.serialize_unit_variant("ExperimentationWorkspaceProvisioningState", 3u32, "Accepted"),
            Self::Created => serializer.serialize_unit_variant("ExperimentationWorkspaceProvisioningState", 4u32, "Created"),
            Self::Deleting => serializer.serialize_unit_variant("ExperimentationWorkspaceProvisioningState", 5u32, "Deleting"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "The type used for update operations of the ExperimentationWorkspace."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ExperimentationWorkspaceUpdate {
    ...
    #[doc = "The updatable properties of the ExperimentationWorkspace."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ExperimentationWorkspaceUpdateProperties>,
}
...
#[doc = "The updatable properties of the ExperimentationWorkspace."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ExperimentationWorkspaceUpdateProperties {
    #[doc = "Access policy for an experimentation workspace."]
...
impl ExperimentationWorkspaceUpdateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
