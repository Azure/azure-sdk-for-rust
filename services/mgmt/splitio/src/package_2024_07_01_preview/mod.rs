...
impl Client {
    ...
    pub fn data_plane_applications_client(&self) -> data_plane_applications::Client {
        data_plane_applications::Client(self.clone())
    }
    pub fn experimentation_workspaces_client(&self) -> experimentation_workspaces::Client {
        experimentation_workspaces::Client(self.clone())
    }
    ...
    pub mod list {
        ...
        impl RequestBuilder {
                        ...
                        let rsp = match continuation {
                            Some(value) => {
                                ...
                                if !has_api_version_already {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair(azure_core::query_param::API_VERSION, "2024-07-01-preview");
                                }
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path("/providers/SplitIO.Experimentation/operations");
...
pub mod experimentation_workspaces {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List ExperimentationWorkspace resources by subscription ID"]
        #[doc = ""]
        #[doc = "Arguments:"]
        ...
        #[doc = "List ExperimentationWorkspace resources by resource group"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        ...
        #[doc = "Get a ExperimentationWorkspace"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `workspace_name`: The name of the ExperimentationWorkspace resource"]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "Create a ExperimentationWorkspace"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        pub fn create(
            ...
            resource_group_name: impl Into<String>,
            workspace_name: impl Into<String>,
            resource: impl Into<models::ExperimentationWorkspace>,
        ...
        #[doc = "Update a ExperimentationWorkspace"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        pub fn update(
            ...
            resource_group_name: impl Into<String>,
            workspace_name: impl Into<String>,
            properties: impl Into<models::ExperimentationWorkspaceUpdate>,
        ...
        #[doc = "Delete a ExperimentationWorkspace"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod list_by_subscription {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ExperimentationWorkspaceListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ExperimentationWorkspaceListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ExperimentationWorkspaceListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/SplitIO.Experimentation/experimentationWorkspaces",
    ...
    pub mod list_by_resource_group {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/SplitIO.Experimentation/experimentationWorkspaces",
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ExperimentationWorkspace> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ExperimentationWorkspace = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ExperimentationWorkspace>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ExperimentationWorkspace>>;
    ...
    pub mod create {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) workspace_name: String,
            pub(crate) resource: models::ExperimentationWorkspace,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) workspace_name: String,
            pub(crate) properties: models::ExperimentationWorkspaceUpdate,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
...
pub mod data_plane_applications {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    impl Client {
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `workspace_name`: The name of the ExperimentationWorkspace resource."]
        #[doc = "* `application_id`: The id of the Split.IO data plane authentication application in Guid format."]
        #[doc = "* `exchange_token_parameters`: The parameter of exchange token action."]
        pub fn exchange_token(
            ...
            exchange_token_parameters: impl Into<models::ExchangeTokenParameters>,
        ) -> exchange_token::RequestBuilder {
            exchange_token::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
                ...
                exchange_token_parameters: exchange_token_parameters.into(),
            }
        }
    }
    pub mod exchange_token {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ExchangeTokenResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ExchangeTokenResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) exchange_token_parameters: models::ExchangeTokenParameters,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.exchange_token_parameters)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/SplitIO.Experimentation/experimentationWorkspaces/{}/dataPlaneApplications/{}/exchangeToken" , & self . subscription_id , & self . resource_group_name , & self . workspace_name , & self . application_id)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-07-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ExchangeTokenResult>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ExchangeTokenResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
