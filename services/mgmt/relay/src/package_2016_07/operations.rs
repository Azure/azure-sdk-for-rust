...
pub mod namespaces {
    ...
    pub async fn list_post_authorization_rules(
        ...
        match rsp.status() {
            StatusCode::OK => {
                let body: bytes::Bytes = rsp.bytes().await.context(list_post_authorization_rules::ResponseBytesError)?;
                let rsp_value: AuthorizationRuleListResult =
                    serde_json::from_slice(&body).context(list_post_authorization_rules::DeserializeError { body })?;
                Ok(rsp_value)
            }
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(list_post_authorization_rules::ResponseBytesError)?;
    ...
    pub async fn post_authorization_rule(
        ...
        match rsp.status() {
            ...
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(post_authorization_rule::ResponseBytesError)?;
                let rsp_value: ErrorResponse = serde_json::from_slice(&body).context(post_authorization_rule::DeserializeError { body })?;
    ...
    pub async fn list_keys(
        ...
        match rsp.status() {
            StatusCode::OK => {
                ...
                let rsp_value: AuthorizationRuleKeys = serde_json::from_slice(&body).context(list_keys::DeserializeError { body })?;
                Ok(rsp_value)
            }
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(list_keys::ResponseBytesError)?;
    ...
    pub async fn regenerate_keys(
        ...
        match rsp.status() {
            StatusCode::OK => {
                ...
                let rsp_value: AuthorizationRuleKeys = serde_json::from_slice(&body).context(regenerate_keys::DeserializeError { body })?;
                Ok(rsp_value)
            }
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(regenerate_keys::ResponseBytesError)?;
...
pub mod hybrid_connections {
    ...
    pub async fn list_post_authorization_rules(
        ...
        match rsp.status() {
            ...
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(list_post_authorization_rules::ResponseBytesError)?;
                list_post_authorization_rules::UnexpectedResponse { status_code, body: body }.fail()
            }
        }
    }
    pub mod list_post_authorization_rules {
