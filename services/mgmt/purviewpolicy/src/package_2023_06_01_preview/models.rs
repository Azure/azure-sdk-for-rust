...
impl Policy {
    pub fn new(source: String, etag: String, scopes: Vec<String>, members: PolicyMembers, decision_rules: Vec<PolicyDecisionRule>) -> Self {
        Self {
...
pub struct PolicyMembers {
    ...
    #[serde(
        rename = "fabricItemMembers",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub fabric_item_members: Vec<FabricItemMember>,
    #[doc = "Array of azure active directory members"]
    #[serde(
        rename = "aadMembers",
        default,
