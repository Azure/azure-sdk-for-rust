...
impl Client {
    ...
    pub fn purview_policies_client(&self) -> purview_policies::Client {
        purview_policies::Client(self.clone())
    }
}
pub mod purview_policies {
    use super::models;
    ...
    impl Client {
        #[doc = "API to list the purview RBAC policies based on a scope"]
