...
pub use package_2021_08_09::{models, operations, operations::Client, operations::ClientBuilder};
...
pub use package_2020_08_06_preview::{models, operations, operations::Client, operations::ClientBuilder};
