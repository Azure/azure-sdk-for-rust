...
pub struct AzureBareMetalStorageInstance {
    ...
    #[doc = "Identity for Azure Bare Metal Storage Instance."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub identity: Option<AzureBareMetalStorageInstanceIdentity>,
}
...
#[doc = "properties of body during PUT/PATCH for an AzureBareMetalStorageInstance."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AzureBareMetalStorageInstanceBody {
    #[doc = "Identity for Azure Bare Metal Storage Instance."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub identity: Option<AzureBareMetalStorageInstanceIdentity>,
...
impl AzureBareMetalStorageInstanceBody {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Identity for Azure Bare Metal Storage Instance."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AzureBareMetalStorageInstanceIdentity {
    #[doc = "The principal ID of Azure Bare Metal Storage Instance identity. This property will only be provided for a system assigned identity."]
    #[serde(rename = "principalId", default, skip_serializing_if = "Option::is_none")]
    pub principal_id: Option<String>,
    #[doc = "The tenant ID associated with the Azure Bare Metal Storage Instance. This property will only be provided for a system assigned identity."]
    #[serde(rename = "tenantId", default, skip_serializing_if = "Option::is_none")]
    pub tenant_id: Option<String>,
    #[doc = "The type of identity used for the Azure Bare Metal Storage Instance. The type 'SystemAssigned' refers to an implicitly created identity. The type 'None' will remove any identities from the Azure Bare Metal Storage Instance."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<azure_bare_metal_storage_instance_identity::Type>,
}
impl AzureBareMetalStorageInstanceIdentity {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod azure_bare_metal_storage_instance_identity {
    use super::*;
    #[doc = "The type of identity used for the Azure Bare Metal Storage Instance. The type 'SystemAssigned' refers to an implicitly created identity. The type 'None' will remove any identities from the Azure Bare Metal Storage Instance."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Type")]
...
#[doc = "Tags field of the AzureBareMetal/AzureBareMetalStorage instance."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct Tags {
    #[doc = "Tags field of the AzureBareMetal/AzureBareMetaStorage instance."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
