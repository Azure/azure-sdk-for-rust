...
pub mod net_app_resource {
    ...
    pub async fn check_file_path_availability(
        ...
        subscription_id: &str,
        location: &str,
    ) -> std::result::Result<ResourceNameAvailability, check_file_path_availability::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
...
pub mod volumes {
    ...
    pub async fn break_replication(
        ...
        pool_name: &str,
        volume_name: &str,
    ) -> std::result::Result<(), break_replication::Error> {
        let http_client = operation_config.http_client();
    ...
    pub async fn resync_replication(
        ...
        pool_name: &str,
        volume_name: &str,
    ) -> std::result::Result<(), resync_replication::Error> {
        let http_client = operation_config.http_client();
    ...
    pub async fn delete_replication(
        ...
        pool_name: &str,
        volume_name: &str,
    ) -> std::result::Result<(), delete_replication::Error> {
        let http_client = operation_config.http_client();
    ...
    ) -> std::result::Result<(), authorize_replication::Error> {
        let http_client = operation_config.http_client();
...
pub mod mount_targets {
    ...
    pub async fn list(
        ...
        pool_name: &str,
        volume_name: &str,
    ) -> std::result::Result<MountTargetList, list::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
