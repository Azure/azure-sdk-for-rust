...
pub struct SubvolumeModelProperties {
    ...
    #[serde(rename = "accessedTimeStamp", default, skip_serializing_if = "Option::is_none")]
    pub accessed_time_stamp: Option<String>,
    #[doc = "Most recent modification time and date"]
    #[serde(rename = "modifiedTimeStamp", default, skip_serializing_if = "Option::is_none")]
    pub modified_time_stamp: Option<String>,
    #[doc = "Most recent change time and date"]
    #[serde(rename = "changedTimeStamp", default, skip_serializing_if = "Option::is_none")]
    pub changed_time_stamp: Option<String>,
    #[doc = "Azure lifecycle management"]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<String>,
}
