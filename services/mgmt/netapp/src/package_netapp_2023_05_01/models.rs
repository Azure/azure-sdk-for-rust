...
#[doc = "Identity used to authenticate with key vault."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EncryptionIdentity {
    #[doc = "The principal ID (object ID) of the identity used to authenticate with key vault. Read-only."]
    #[serde(rename = "principalId", default, skip_serializing_if = "Option::is_none")]
    pub principal_id: Option<String>,
    #[doc = "The ARM resource identifier of the user assigned identity used to authenticate with key vault. Applicable if identity.type has 'UserAssigned'. It should match key of identity.userAssignedIdentities."]
...
pub struct KeyVaultProperties {
    #[doc = "UUID v4 used to identify the Azure Key Vault configuration"]
    ...
    pub key_name: String,
    #[doc = "The resource ID of KeyVault."]
...
impl KeyVaultProperties {
    pub fn new(key_vault_uri: String, key_name: String, key_vault_resource_id: String) -> Self {
        Self {
            key_vault_id: None,
            key_vault_uri,
            key_name,
...
#[doc = "Network sibling set query."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct QueryNetworkSiblingSetRequest {
    #[doc = "Network Sibling Set ID for a group of volumes sharing networking resources in a subnet."]
    #[serde(rename = "networkSiblingSetId")]
    pub network_sibling_set_id: NetworkSiblingSetId,
    #[doc = "The Azure Resource URI for a delegated subnet. Must have the delegation Microsoft.NetApp/volumes. Example /subscriptions/subscriptionId/resourceGroups/resourceGroup/providers/Microsoft.Network/virtualNetworks/testVnet/subnets/{mySubnet}"]
    #[serde(rename = "subnetId")]
    pub subnet_id: SubnetId,
}
impl QueryNetworkSiblingSetRequest {
    pub fn new(network_sibling_set_id: NetworkSiblingSetId, subnet_id: SubnetId) -> Self {
        Self {
...
#[doc = "Network sibling set update."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateNetworkSiblingSetRequest {
    #[doc = "Network Sibling Set ID for a group of volumes sharing networking resources in a subnet."]
    #[serde(rename = "networkSiblingSetId")]
    pub network_sibling_set_id: NetworkSiblingSetId,
    #[doc = "The Azure Resource URI for a delegated subnet. Must have the delegation Microsoft.NetApp/volumes. Example /subscriptions/subscriptionId/resourceGroups/resourceGroup/providers/Microsoft.Network/virtualNetworks/testVnet/subnets/{mySubnet}"]
    #[serde(rename = "subnetId")]
    pub subnet_id: SubnetId,
    #[doc = "Network sibling set state Id identifying the current state of the sibling set."]
    #[serde(rename = "networkSiblingSetStateId")]
    pub network_sibling_set_state_id: NetworkSiblingSetStateId,
    #[doc = "Network features available to the volume, or current state of update."]
    #[serde(rename = "networkFeatures")]
    pub network_features: NetworkFeatures,
}
impl UpdateNetworkSiblingSetRequest {
    pub fn new(
        network_sibling_set_id: NetworkSiblingSetId,
        subnet_id: SubnetId,
        network_sibling_set_state_id: NetworkSiblingSetStateId,
        network_features: NetworkFeatures,
    ) -> Self {
        Self {
            network_sibling_set_id,
            subnet_id,
            network_sibling_set_state_id,
            network_features,
        }
    }
}
...
pub mod account_encryption {
    ...
    impl Serialize for KeySource {
        ...
        {
            match self {
                Self::MicrosoftNetApp => serializer.serialize_unit_variant("KeySource", 0u32, "Microsoft.NetApp"),
...
pub struct AccountProperties {
    ...
    #[doc = "Shows the status of disableShowmount for all volumes under the subscription, null equals false"]
    #[serde(rename = "disableShowmount", default, skip_serializing_if = "Option::is_none")]
    pub disable_showmount: Option<bool>,
}
...
pub struct ActiveDirectory {
    ...
    #[doc = "Comma separated list of IPv4 addresses of preferred servers for LDAP client. At most two comma separated IPv4 addresses can be passed."]
    #[serde(rename = "preferredServersForLdapClient", default, skip_serializing_if = "Option::is_none")]
    pub preferred_servers_for_ldap_client: Option<String>,
}
...
#[doc = "Break file locks request"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct BreakFileLocksRequest {
    #[doc = "To clear file locks on a volume for a particular client"]
    #[serde(rename = "clientIp", default, skip_serializing_if = "Option::is_none")]
    pub client_ip: Option<String>,
    #[doc = "Break File locks could be a disruptive operation for application as locks on the volume will be broken, if want to process, set to true."]
    #[serde(rename = "confirmRunningDisruptiveOperation", default, skip_serializing_if = "Option::is_none")]
    pub confirm_running_disruptive_operation: Option<bool>,
}
impl BreakFileLocksRequest {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "coolAccessRetrievalPolicy determines the data retrieval behavior from the cool tier to standard storage based on the read pattern for cool access enabled volumes. The possible values for this field are: \n Default - Data will be pulled from cool tier to standard storage on random reads. This policy is the default.\n OnRead - All client-driven data read is pulled from cool tier to standard storage on both sequential and random reads.\n Never - No client-driven data is pulled from cool tier to standard storage."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "CoolAccessRetrievalPolicy")]
pub enum CoolAccessRetrievalPolicy {
    Default,
    OnRead,
    Never,
    #[serde(skip_deserializing)]
...
impl FromStr for CoolAccessRetrievalPolicy {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for CoolAccessRetrievalPolicy {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for CoolAccessRetrievalPolicy {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Default => serializer.serialize_unit_variant("CoolAccessRetrievalPolicy", 0u32, "Default"),
            Self::OnRead => serializer.serialize_unit_variant("CoolAccessRetrievalPolicy", 1u32, "OnRead"),
            Self::Never => serializer.serialize_unit_variant("CoolAccessRetrievalPolicy", 2u32, "Never"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "Get group Id list for LDAP User request"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetGroupIdListForLdapUserRequest {
    #[doc = "username is required to fetch the group to which user is part of"]
    pub username: String,
}
impl GetGroupIdListForLdapUserRequest {
    pub fn new(username: String) -> Self {
        Self { username }
    }
}
#[doc = "Group Id list for Ldap user"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct GetGroupIdListForLdapUserResponse {
    #[doc = "Group Id list"]
    #[serde(
        rename = "groupIdsForLdapUser",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub group_ids_for_ldap_user: Vec<String>,
}
impl GetGroupIdListForLdapUserResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub enum NetworkFeatures {
    Basic,
    Standard,
    #[serde(rename = "Basic_Standard")]
    BasicStandard,
    #[serde(rename = "Standard_Basic")]
    StandardBasic,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
...
impl Serialize for NetworkFeatures {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::BasicStandard => serializer.serialize_unit_variant("NetworkFeatures", 2u32, "Basic_Standard"),
            Self::StandardBasic => serializer.serialize_unit_variant("NetworkFeatures", 3u32, "Standard_Basic"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "Describes the contents of a network sibling set."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NetworkSiblingSet {
    #[doc = "Network Sibling Set ID for a group of volumes sharing networking resources in a subnet."]
    #[serde(rename = "networkSiblingSetId", default, skip_serializing_if = "Option::is_none")]
    pub network_sibling_set_id: Option<NetworkSiblingSetId>,
    #[doc = "The Azure Resource URI for a delegated subnet. Must have the delegation Microsoft.NetApp/volumes. Example /subscriptions/subscriptionId/resourceGroups/resourceGroup/providers/Microsoft.Network/virtualNetworks/testVnet/subnets/{mySubnet}"]
    #[serde(rename = "subnetId", default, skip_serializing_if = "Option::is_none")]
    pub subnet_id: Option<SubnetId>,
    #[doc = "Network sibling set state Id identifying the current state of the sibling set."]
    #[serde(rename = "networkSiblingSetStateId", default, skip_serializing_if = "Option::is_none")]
    pub network_sibling_set_state_id: Option<NetworkSiblingSetStateId>,
    #[doc = "Network features available to the volume, or current state of update."]
    #[serde(rename = "networkFeatures", default, skip_serializing_if = "Option::is_none")]
    pub network_features: Option<NetworkFeatures>,
    #[doc = "Gets the status of the NetworkSiblingSet at the time the operation was called."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<NetworkSiblingSetProvisioningState>,
    #[doc = "List of NIC information"]
    #[serde(
        rename = "nicInfoList",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub nic_info_list: Vec<NicInfo>,
}
impl NetworkSiblingSet {
    pub fn new() -> Self {
        Self::default()
    }
}
pub type NetworkSiblingSetId = String;
#[doc = "Gets the status of the NetworkSiblingSet at the time the operation was called."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "NetworkSiblingSetProvisioningState")]
pub enum NetworkSiblingSetProvisioningState {
    Succeeded,
    Failed,
    Canceled,
    Updating,
...
impl FromStr for NetworkSiblingSetProvisioningState {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for NetworkSiblingSetProvisioningState {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for NetworkSiblingSetProvisioningState {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Succeeded => serializer.serialize_unit_variant("NetworkSiblingSetProvisioningState", 0u32, "Succeeded"),
            Self::Failed => serializer.serialize_unit_variant("NetworkSiblingSetProvisioningState", 1u32, "Failed"),
            Self::Canceled => serializer.serialize_unit_variant("NetworkSiblingSetProvisioningState", 2u32, "Canceled"),
            Self::Updating => serializer.serialize_unit_variant("NetworkSiblingSetProvisioningState", 3u32, "Updating"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
pub type NetworkSiblingSetStateId = String;
#[doc = "NIC information and list of volumes for which the NIC has the primary mount ip address."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NicInfo {
    #[serde(rename = "ipAddress", default, skip_serializing_if = "Option::is_none")]
    pub ip_address: Option<IpAddress>,
    #[serde(rename = "volumeResourceIds", default, skip_serializing_if = "Option::is_none")]
    pub volume_resource_ids: Option<VolumeResourceIds>,
}
impl NicInfo {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "Re-establish request object supplied in the body of the operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ReestablishReplicationRequest {
    #[doc = "Resource id of the source volume for the replication"]
    #[serde(rename = "sourceVolumeId", default, skip_serializing_if = "Option::is_none")]
    pub source_volume_id: Option<String>,
}
impl ReestablishReplicationRequest {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Provides region specific information."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RegionInfo {
    ...
    #[serde(
        rename = "availabilityZoneMappings",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub availability_zone_mappings: Vec<serde_json::Value>,
}
impl RegionInfo {
    pub fn new() -> Self {
        Self::default()
    ...
    impl Serialize for StorageToNetworkProximity {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::AcrossT2 => serializer.serialize_unit_variant("StorageToNetworkProximity", 3u32, "AcrossT2"),
                Self::T1AndT2 => serializer.serialize_unit_variant("StorageToNetworkProximity", 4u32, "T1AndT2"),
                Self::T1AndAcrossT2 => serializer.serialize_unit_variant("StorageToNetworkProximity", 5u32, "T1AndAcrossT2"),
                Self::T2AndAcrossT2 => serializer.serialize_unit_variant("StorageToNetworkProximity", 6u32, "T2AndAcrossT2"),
                Self::T1AndT2AndAcrossT2 => serializer.serialize_unit_variant("StorageToNetworkProximity", 7u32, "T1AndT2AndAcrossT2"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RelocateVolumeRequest {
    #[doc = "New creation token for the volume that controls the mount point name"]
    #[serde(rename = "creationToken", default, skip_serializing_if = "Option::is_none")]
    pub creation_token: Option<String>,
}
impl RelocateVolumeRequest {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "SmbAccessBasedEnumeration")]
pub enum SmbAccessBasedEnumeration {
    Disabled,
    Enabled,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for SmbAccessBasedEnumeration {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for SmbAccessBasedEnumeration {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for SmbAccessBasedEnumeration {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Disabled => serializer.serialize_unit_variant("SmbAccessBasedEnumeration", 0u32, "Disabled"),
            Self::Enabled => serializer.serialize_unit_variant("SmbAccessBasedEnumeration", 1u32, "Enabled"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "SmbNonBrowsable")]
pub enum SmbNonBrowsable {
    Disabled,
    Enabled,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for SmbNonBrowsable {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for SmbNonBrowsable {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for SmbNonBrowsable {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Disabled => serializer.serialize_unit_variant("SmbNonBrowsable", 0u32, "Disabled"),
            Self::Enabled => serializer.serialize_unit_variant("SmbNonBrowsable", 1u32, "Enabled"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
    ...
    impl Serialize for ApplicationType {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Oracle => serializer.serialize_unit_variant("ApplicationType", 1u32, "ORACLE"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct VolumePatchProperties {
    ...
    #[doc = "Maximum storage quota allowed for a file system in bytes. This is a soft quota used for alerting only. Minimum size is 100 GiB. Upper limit is 100TiB, 500Tib for LargeVolume or 2400Tib for LargeVolume on exceptional basis. Specified in bytes."]
    ...
    #[doc = "coolAccessRetrievalPolicy determines the data retrieval behavior from the cool tier to standard storage based on the read pattern for cool access enabled volumes. The possible values for this field are: \n Default - Data will be pulled from cool tier to standard storage on random reads. This policy is the default.\n OnRead - All client-driven data read is pulled from cool tier to standard storage on both sequential and random reads.\n Never - No client-driven data is pulled from cool tier to standard storage."]
    #[serde(rename = "coolAccessRetrievalPolicy", default, skip_serializing_if = "Option::is_none")]
    pub cool_access_retrieval_policy: Option<CoolAccessRetrievalPolicy>,
    #[doc = "If enabled (true) the volume will contain a read-only snapshot directory which provides access to each of the volume's snapshots."]
    ...
    pub smb_access_based_enumeration: Option<SmbAccessBasedEnumeration>,
    #[doc = "Enables non-browsable property for SMB Shares. Only applicable for SMB/DualProtocol volume"]
    #[serde(rename = "smbNonBrowsable", default, skip_serializing_if = "Option::is_none")]
    pub smb_non_browsable: Option<SmbNonBrowsable>,
}
...
pub struct VolumeProperties {
    ...
    #[serde(rename = "snapshotId", default, skip_serializing_if = "Option::is_none")]
    pub snapshot_id: Option<String>,
    #[doc = "If enabled (true) the snapshot the volume was created from will be automatically deleted after the volume create operation has finished.  Defaults to false"]
    #[serde(rename = "deleteBaseSnapshot", default, skip_serializing_if = "Option::is_none")]
    pub delete_base_snapshot: Option<bool>,
    ...
    #[doc = "If enabled (true) the volume will contain a read-only snapshot directory which provides access to each of the volume's snapshots (defaults to true)."]
    #[serde(rename = "snapshotDirectoryVisible", default, skip_serializing_if = "Option::is_none")]
    pub snapshot_directory_visible: Option<bool>,
    ...
    #[serde(rename = "throughputMibps", default, skip_serializing_if = "Option::is_none")]
    pub throughput_mibps: Option<f64>,
    #[doc = "Actual throughput in MiB/s for auto qosType volumes calculated based on size and serviceLevel"]
    #[serde(rename = "actualThroughputMibps", default, skip_serializing_if = "Option::is_none")]
    pub actual_throughput_mibps: Option<f64>,
    ...
    pub key_vault_private_endpoint_resource_id: Option<String>,
    ...
    #[doc = "Flag indicating whether file access logs are enabled for the volume, based on active diagnostic settings present on the volume."]
    #[serde(rename = "fileAccessLogs", default, skip_serializing_if = "Option::is_none")]
    pub file_access_logs: Option<volume_properties::FileAccessLogs>,
    ...
    #[doc = "Data store resource unique identifier"]
    #[serde(
        rename = "dataStoreResourceId",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub data_store_resource_id: Vec<String>,
    #[doc = "Specifies if default quota is enabled for the volume."]
    #[serde(rename = "isDefaultQuotaEnabled", default, skip_serializing_if = "Option::is_none")]
    pub is_default_quota_enabled: Option<bool>,
    #[doc = "Default user quota for volume in KiBs. If isDefaultQuotaEnabled is set, the minimum value of 4 KiBs applies ."]
    ...
    #[doc = "The availability zone where the volume is provisioned. This refers to the logical availability zone where the volume resides."]
    #[serde(rename = "provisionedAvailabilityZone", default, skip_serializing_if = "Option::is_none")]
    pub provisioned_availability_zone: Option<String>,
    #[doc = "Specifies whether volume is a Large Volume or Regular Volume."]
    #[serde(rename = "isLargeVolume", default, skip_serializing_if = "Option::is_none")]
    pub is_large_volume: Option<bool>,
    #[doc = "Id of the snapshot or backup that the volume is restored from."]
    #[serde(rename = "originatingResourceId", default, skip_serializing_if = "Option::is_none")]
    pub originating_resource_id: Option<String>,
}
impl VolumeProperties {
    pub fn new(creation_token: String, usage_threshold: i64, subnet_id: String) -> Self {
        Self {
            ...
            security_style: None,
            smb_encryption: None,
            smb_access_based_enumeration: None,
            smb_non_browsable: None,
            smb_continuously_available: None,
            throughput_mibps: None,
            actual_throughput_mibps: None,
            encryption_key_source: None,
            key_vault_private_endpoint_resource_id: None,
            ldap_enabled: None,
            cool_access: None,
            coolness_period: None,
            cool_access_retrieval_policy: None,
            unix_permissions: None,
            clone_progress: None,
            file_access_logs: None,
            avs_data_store: None,
            data_store_resource_id: Vec::new(),
            ...
            provisioned_availability_zone: None,
            is_large_volume: None,
            originating_resource_id: None,
        }
    }
}
pub mod volume_properties {
    ...
    pub struct DataProtection {
        ...
        #[serde(rename = "volumeRelocation", default, skip_serializing_if = "Option::is_none")]
        pub volume_relocation: Option<VolumeRelocationProperties>,
    }
    impl DataProtection {
        pub fn new() -> Self {
            Self::default()
    ...
    impl Serialize for EncryptionKeySource {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::MicrosoftKeyVault => serializer.serialize_unit_variant("EncryptionKeySource", 1u32, "Microsoft.KeyVault"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    #[doc = "Flag indicating whether file access logs are enabled for the volume, based on active diagnostic settings present on the volume."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "FileAccessLogs")]
    pub enum FileAccessLogs {
        Enabled,
        Disabled,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for FileAccessLogs {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for FileAccessLogs {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for FileAccessLogs {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Enabled => serializer.serialize_unit_variant("FileAccessLogs", 0u32, "Enabled"),
                Self::Disabled => serializer.serialize_unit_variant("FileAccessLogs", 1u32, "Disabled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for FileAccessLogs {
        fn default() -> Self {
            Self::Disabled
        }
    }
...
pub struct VolumeRelocationProperties {
    ...
    #[doc = "Has relocation finished and is ready to be cleaned up"]
    #[serde(rename = "readyToBeFinalized", default, skip_serializing_if = "Option::is_none")]
    pub ready_to_be_finalized: Option<bool>,
}
...
pub type VolumeResourceIds = Vec<String>;
