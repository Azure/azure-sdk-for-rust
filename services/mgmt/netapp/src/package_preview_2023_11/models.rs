...
impl ChangeKeyVault {
    pub fn new(
        ...
        key_vault_private_endpoints: Vec<KeyVaultPrivateEndpoint>,
    ) -> Self {
        Self {
            key_vault_uri,
            key_name,
...
impl PeerClusterForVolumeMigrationRequest {
    pub fn new(peer_addresses: Vec<String>) -> Self {
        Self {
            peer_addresses,
            remote_path: None,
        }
...
pub struct PoolProperties {
    ...
    #[doc = "Provisioned size of the pool (in bytes). Allowed values are in 1TiB chunks (value must be multiply of 1099511627776)."]
    pub size: i64,
