...
#[doc = "A2A provider specific input for apply cluster recovery point."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct A2aApplyClusterRecoveryPointInput {}
impl A2aApplyClusterRecoveryPointInput {
    pub fn new() -> Self {
        Self {}
    }
}
...
#[doc = "A2A provider specific cluster recovery point details."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct A2aClusterRecoveryPointDetails {
    ...
    pub recovery_point_sync_type: Option<a2a_cluster_recovery_point_details::RecoveryPointSyncType>,
    #[doc = "The list of nodes representing the cluster."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
...
impl A2aClusterRecoveryPointDetails {
    pub fn new() -> Self {
        Self {
...
pub mod a2a_cluster_recovery_point_details {
    use super::*;
    #[doc = "A value indicating whether the recovery point is multi VM consistent."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "A2A provider specific input for test cluster failover."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct A2aClusterTestFailoverInput {
    #[doc = "The cluster recovery point id to be passed to failover to a particular recovery point."]
    #[serde(rename = "clusterRecoveryPointId", default, skip_serializing_if = "Option::is_none")]
    pub cluster_recovery_point_id: Option<String>,
    #[doc = "The list of individual node recovery points."]
    #[serde(
        rename = "individualNodeRecoveryPoints",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub individual_node_recovery_points: Vec<String>,
}
impl A2aClusterTestFailoverInput {
    pub fn new() -> Self {
        Self {
            cluster_recovery_point_id: None,
            individual_node_recovery_points: Vec::new(),
        }
    }
}
#[doc = "A2A provider specific input for unplanned cluster failover."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct A2aClusterUnplannedFailoverInput {
    #[doc = "The cluster recovery point id to be passed to failover to a particular recovery point."]
    #[serde(rename = "clusterRecoveryPointId", default, skip_serializing_if = "Option::is_none")]
    pub cluster_recovery_point_id: Option<String>,
    #[doc = "The list of individual node recovery points."]
...
impl A2aClusterUnplannedFailoverInput {
    pub fn new() -> Self {
        Self {
            cluster_recovery_point_id: None,
            individual_node_recovery_points: Vec::new(),
...
pub struct A2aCreateProtectionIntentInput {
    ...
    pub protection_profile_custom_input: Option<ProtectionProfileCustomDetailsUnion>,
    ...
    pub primary_staging_storage_account_custom_input: Option<StorageAccountCustomDetailsUnion>,
    ...
    pub recovery_availability_set_custom_input: Option<RecoveryAvailabilitySetCustomDetailsUnion>,
    ...
    pub recovery_virtual_network_custom_input: Option<RecoveryVirtualNetworkCustomDetailsUnion>,
    ...
    pub recovery_proximity_placement_group_custom_input: Option<RecoveryProximityPlacementGroupCustomDetailsUnion>,
    ...
    pub recovery_boot_diag_storage_account: Option<StorageAccountCustomDetailsUnion>,
...
pub struct A2aEnableProtectionInput {
    ...
    #[serde(rename = "multiVmGroupId", default, skip_serializing_if = "Option::is_none")]
    pub multi_vm_group_id: Option<String>,
    #[doc = "The replication protection cluster Id."]
    #[serde(rename = "protectionClusterId", default, skip_serializing_if = "Option::is_none")]
    pub protection_cluster_id: Option<String>,
    ...
    #[doc = "A value indicating whether the auto protection is enabled."]
    #[serde(rename = "autoProtectionOfDataDisk", default, skip_serializing_if = "Option::is_none")]
    pub auto_protection_of_data_disk: Option<a2a_enable_protection_input::AutoProtectionOfDataDisk>,
}
...
pub mod a2a_enable_protection_input {
    use super::*;
    #[doc = "A value indicating whether the auto protection is enabled."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "AutoProtectionOfDataDisk")]
...
#[doc = "A2A specific switch cluster protection input."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct A2aProtectedItemDetail {
    #[doc = "The list of vm managed disk details."]
    #[serde(
        rename = "vmManagedDisks",
        default,
    ...
    #[serde(rename = "diskEncryptionInfo", default, skip_serializing_if = "Option::is_none")]
    pub disk_encryption_info: Option<DiskEncryptionInfo>,
    #[doc = "The Replication Protected item name."]
...
pub struct A2aProtectionIntentDiskInputDetails {
    ...
    pub recovery_azure_storage_account_custom_input: Option<StorageAccountCustomDetailsUnion>,
    #[doc = "Storage account custom input."]
    #[serde(
        rename = "primaryStagingStorageAccountCustomInput",
        default,
...
pub struct A2aProtectionIntentManagedDiskInputDetails {
    ...
    pub recovery_resource_group_custom_input: Option<RecoveryResourceGroupCustomDetailsUnion>,
    #[doc = "The replica disk type. Its an optional value and will be same as source disk type if not user provided."]
    #[serde(rename = "recoveryReplicaDiskAccountType", default, skip_serializing_if = "Option::is_none")]
    pub recovery_replica_disk_account_type: Option<String>,
    #[doc = "The target disk type after failover. Its an optional value and will be same as source disk type if not user provided."]
...
pub struct A2aReplicationDetails {
    ...
    #[serde(rename = "protectionClusterId", default, skip_serializing_if = "Option::is_none")]
    pub protection_cluster_id: Option<String>,
    #[doc = "A value indicating if the cluster infra is ready or not."]
    #[serde(rename = "isClusterInfraReady", default, skip_serializing_if = "Option::is_none")]
    pub is_cluster_infra_ready: Option<bool>,
...
pub struct A2aReplicationIntentDetails {
    ...
    pub protection_profile: Option<ProtectionProfileCustomDetailsUnion>,
    #[doc = "Storage account custom input."]
    #[serde(rename = "primaryStagingStorageAccount", default, skip_serializing_if = "Option::is_none")]
    pub primary_staging_storage_account: Option<StorageAccountCustomDetailsUnion>,
    #[doc = "Recovery Availability Set custom input."]
    #[serde(rename = "recoveryAvailabilitySet", default, skip_serializing_if = "Option::is_none")]
    pub recovery_availability_set: Option<RecoveryAvailabilitySetCustomDetailsUnion>,
    #[doc = "Recovery Virtual network custom input."]
    #[serde(rename = "recoveryVirtualNetwork", default, skip_serializing_if = "Option::is_none")]
    pub recovery_virtual_network: Option<RecoveryVirtualNetworkCustomDetailsUnion>,
    #[doc = "Recovery Proximity placement group custom input."]
    #[serde(rename = "recoveryProximityPlacementGroup", default, skip_serializing_if = "Option::is_none")]
    pub recovery_proximity_placement_group: Option<RecoveryProximityPlacementGroupCustomDetailsUnion>,
    #[doc = "A value indicating whether the auto protection is enabled."]
    #[serde(rename = "autoProtectionOfDataDisk", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "A2A provider specific settings."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct A2aReplicationProtectionClusterDetails {
    #[doc = "The multi vm group Id."]
    #[serde(rename = "multiVmGroupId", default, skip_serializing_if = "Option::is_none")]
    pub multi_vm_group_id: Option<String>,
    #[doc = "The multi vm group name."]
    ...
    #[doc = "Whether Multi VM group is auto created or specified by user."]
    #[serde(rename = "multiVmGroupCreateOption", default, skip_serializing_if = "Option::is_none")]
    pub multi_vm_group_create_option: Option<a2a_replication_protection_cluster_details::MultiVmGroupCreateOption>,
    #[doc = "Primary fabric location."]
    #[serde(rename = "primaryFabricLocation", default, skip_serializing_if = "Option::is_none")]
    pub primary_fabric_location: Option<String>,
    #[doc = "The recovery fabric location."]
    #[serde(rename = "recoveryFabricLocation", default, skip_serializing_if = "Option::is_none")]
    pub recovery_fabric_location: Option<String>,
    #[doc = "The recovery point Id to which the cluster was failed over."]
    ...
    #[doc = "The cluster management Id."]
    #[serde(rename = "clusterManagementId", default, skip_serializing_if = "Option::is_none")]
    pub cluster_management_id: Option<String>,
    #[doc = "The last RPO value in seconds."]
    #[serde(rename = "rpoInSeconds", default, skip_serializing_if = "Option::is_none")]
    pub rpo_in_seconds: Option<i64>,
    #[doc = "The time (in UTC) when the last RPO value was calculated by Protection Service."]
    ...
    #[serde(rename = "recoveryExtendedLocation", default, skip_serializing_if = "Option::is_none")]
    pub recovery_extended_location: Option<ExtendedLocation>,
    #[doc = "An id that survives actions like switch protection which change the backing PE/CPE objects internally.The lifecycle id gets carried forward to have a link/continuity in being able to have an Id that denotes the \"same\" protected cluster even though other internal Ids/ARM Id might be changing."]
    #[serde(rename = "lifecycleId", default, skip_serializing_if = "Option::is_none")]
    pub lifecycle_id: Option<String>,
}
impl A2aReplicationProtectionClusterDetails {
    pub fn new() -> Self {
        Self {
            multi_vm_group_id: None,
            multi_vm_group_name: None,
...
pub mod a2a_replication_protection_cluster_details {
    use super::*;
    #[doc = "Whether Multi VM group is auto created or specified by user."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "MultiVmGroupCreateOption")]
...
#[doc = "Extended location of the resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct A2aSharedDiskIrErrorDetails {
    #[doc = "The error code."]
    #[serde(rename = "errorCode", default, skip_serializing_if = "Option::is_none")]
    pub error_code: Option<String>,
    #[doc = "The error code enum."]
    #[serde(rename = "errorCodeEnum", default, skip_serializing_if = "Option::is_none")]
    pub error_code_enum: Option<String>,
...
impl A2aSharedDiskIrErrorDetails {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "A2A provider specific settings."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct A2aSharedDiskReplicationDetails {
    #[doc = "The management Id."]
    #[serde(rename = "managementId", default, skip_serializing_if = "Option::is_none")]
    pub management_id: Option<String>,
    #[doc = "The list of unprotected disks."]
    ...
    #[serde(rename = "recoveryFabricLocation", default, skip_serializing_if = "Option::is_none")]
    pub recovery_fabric_location: Option<String>,
    #[doc = "The recovery point id to which the Virtual node was failed over."]
    #[serde(rename = "failoverRecoveryPointId", default, skip_serializing_if = "Option::is_none")]
    pub failover_recovery_point_id: Option<String>,
    #[doc = "The percentage of the monitoring job. The type of the monitoring job is defined by MonitoringJobType property."]
    #[serde(rename = "monitoringPercentageCompletion", default, skip_serializing_if = "Option::is_none")]
    ...
    #[doc = "The IR Errors."]
    #[serde(
        rename = "sharedDiskIRErrors",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub shared_disk_ir_errors: Vec<A2aSharedDiskIrErrorDetails>,
}
impl A2aSharedDiskReplicationDetails {
    pub fn new() -> Self {
        Self {
            management_id: None,
            unprotected_disks: Vec::new(),
            ...
            rpo_in_seconds: None,
            last_rpo_calculated_time: None,
            shared_disk_ir_errors: Vec::new(),
        }
    }
}
#[doc = "A2A specific switch cluster protection input."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct A2aSwitchClusterProtectionInput {
    #[doc = "The recovery container Id."]
    #[serde(rename = "recoveryContainerId", default, skip_serializing_if = "Option::is_none")]
    pub recovery_container_id: Option<String>,
    #[doc = "The Policy Id."]
    ...
    pub policy_id: Option<String>,
    #[serde(
        rename = "protectedItemsDetail",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub protected_items_detail: Vec<A2aProtectedItemDetail>,
}
impl A2aSwitchClusterProtectionInput {
    pub fn new() -> Self {
        Self {
            recovery_container_id: None,
            policy_id: None,
            protected_items_detail: Vec::new(),
        }
    }
}
...
pub struct AsrTask {
    ...
    pub custom_details: Option<TaskTypeDetailsUnion>,
    ...
    pub group_task_custom_details: Option<GroupTaskDetailsUnion>,
...
pub struct AddDisksInputProperties {
    ...
    pub provider_specific_details: AddDisksProviderSpecificInputUnion,
}
impl AddDisksInputProperties {
    pub fn new(provider_specific_details: AddDisksProviderSpecificInputUnion) -> Self {
...
pub enum AddDisksProviderSpecificInputUnion {
    #[serde(rename = "A2A")]
    A2a(A2aAddDisksInput),
    InMageRcm(InMageRcmAddDisksInput),
}
...
pub enum ApplianceSpecificDetailsUnion {
    InMageRcm(InMageRcmApplianceSpecificDetails),
}
#[doc = "Input definition for apply cluster recovery point."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ApplyClusterRecoveryPointInput {
    #[doc = "Input definition for apply cluster recovery point properties."]
    pub properties: ApplyClusterRecoveryPointInputProperties,
}
impl ApplyClusterRecoveryPointInput {
    pub fn new(properties: ApplyClusterRecoveryPointInputProperties) -> Self {
        Self { properties }
    }
}
#[doc = "Input definition for apply cluster recovery point properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ApplyClusterRecoveryPointInputProperties {
    #[doc = "The cluster recovery point id to be passed to failover to a particular recovery point."]
    #[serde(rename = "clusterRecoveryPointId", default, skip_serializing_if = "Option::is_none")]
    pub cluster_recovery_point_id: Option<String>,
    #[doc = "The list of individual node recovery points."]
    ...
    pub individual_node_recovery_points: Vec<String>,
    #[doc = "Provider specific input for apply cluster recovery point."]
    #[serde(rename = "providerSpecificDetails")]
    pub provider_specific_details: ApplyClusterRecoveryPointProviderSpecificInputUnion,
}
impl ApplyClusterRecoveryPointInputProperties {
    pub fn new(provider_specific_details: ApplyClusterRecoveryPointProviderSpecificInputUnion) -> Self {
        Self {
            cluster_recovery_point_id: None,
            individual_node_recovery_points: Vec::new(),
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "instanceType")]
pub enum ApplyClusterRecoveryPointProviderSpecificInputUnion {
    #[serde(rename = "A2A")]
    A2a(A2aApplyClusterRecoveryPointInput),
}
...
pub struct ApplyRecoveryPointInputProperties {
    ...
    #[serde(rename = "providerSpecificDetails")]
    pub provider_specific_details: ApplyRecoveryPointProviderSpecificInputUnion,
}
impl ApplyRecoveryPointInputProperties {
    pub fn new(provider_specific_details: ApplyRecoveryPointProviderSpecificInputUnion) -> Self {
        Self {
            recovery_point_id: None,
            provider_specific_details,
        }
...
pub enum ApplyRecoveryPointProviderSpecificInputUnion {
    ...
    #[serde(rename = "A2ACrossClusterMigration")]
...
#[doc = "This class represents the details for a failover job of cluster."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ClusterFailoverJobDetails {
    #[serde(flatten)]
    pub job_details: JobDetails,
...
impl ClusterFailoverJobDetails {
    pub fn new(job_details: JobDetails) -> Self {
        Self {
            job_details,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "instanceType")]
pub enum ClusterProviderSpecificRecoveryPointDetailsUnion {
    #[serde(rename = "A2A")]
    A2a(A2aClusterRecoveryPointDetails),
}
#[doc = "Recovery point."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ClusterRecoveryPoint {
    #[doc = "The recovery point Id."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "The name of the recovery point."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "The resource type."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<String>,
    #[doc = "Cluster recovery point properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ClusterRecoveryPointProperties>,
}
impl ClusterRecoveryPoint {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Collection of cluster recovery point details."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ClusterRecoveryPointCollection {
    #[doc = "The cluster recovery point details."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<ClusterRecoveryPoint>,
    #[doc = "The value of next link."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ClusterRecoveryPointCollection {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl ClusterRecoveryPointCollection {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Cluster recovery point properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ClusterRecoveryPointProperties {
    ...
    pub recovery_point_type: Option<cluster_recovery_point_properties::RecoveryPointType>,
    #[doc = "Replication provider specific cluster recovery point details."]
    #[serde(rename = "providerSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_details: Option<ClusterProviderSpecificRecoveryPointDetailsUnion>,
}
impl ClusterRecoveryPointProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod cluster_recovery_point_properties {
    use super::*;
    #[doc = "The recovery point type."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "This class represents details for switch cluster protection job."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ClusterSwitchProtectionJobDetails {
    #[serde(flatten)]
    pub job_details: JobDetails,
    #[doc = "ARM Id of the new replication protection cluster."]
    #[serde(rename = "newReplicationProtectionClusterId", default, skip_serializing_if = "Option::is_none")]
    pub new_replication_protection_cluster_id: Option<String>,
}
impl ClusterSwitchProtectionJobDetails {
    pub fn new(job_details: JobDetails) -> Self {
        Self {
            job_details,
            new_replication_protection_cluster_id: None,
        }
    }
}
#[doc = "Input definition for test failover cleanup for cluster."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ClusterTestFailoverCleanupInput {
    #[doc = "Input definition for test failover cleanup input properties."]
    pub properties: ClusterTestFailoverCleanupInputProperties,
}
impl ClusterTestFailoverCleanupInput {
    pub fn new(properties: ClusterTestFailoverCleanupInputProperties) -> Self {
        Self { properties }
    }
}
#[doc = "Input definition for test failover cleanup input properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ClusterTestFailoverCleanupInputProperties {
    #[doc = "Test failover cleanup comments."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub comments: Option<String>,
}
impl ClusterTestFailoverCleanupInputProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Input definition for test cluster failover."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ClusterTestFailoverInput {
    #[doc = "Input definition for test failover input properties."]
    pub properties: ClusterTestFailoverInputProperties,
}
impl ClusterTestFailoverInput {
    pub fn new(properties: ClusterTestFailoverInputProperties) -> Self {
        Self { properties }
    }
}
#[doc = "Input definition for test failover input properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ClusterTestFailoverInputProperties {
    #[doc = "Failover direction."]
    #[serde(rename = "failoverDirection", default, skip_serializing_if = "Option::is_none")]
    pub failover_direction: Option<cluster_test_failover_input_properties::FailoverDirection>,
    ...
    #[doc = "Provider specific test cluster failover input."]
    #[serde(rename = "providerSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_details: Option<ClusterTestFailoverProviderSpecificInputUnion>,
}
impl ClusterTestFailoverInputProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod cluster_test_failover_input_properties {
    use super::*;
    #[doc = "Failover direction."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "This class represents the details for a test failover job of cluster."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ClusterTestFailoverJobDetails {
    #[serde(flatten)]
    pub job_details: JobDetails,
...
impl ClusterTestFailoverJobDetails {
    pub fn new(job_details: JobDetails) -> Self {
        Self {
            job_details,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "instanceType")]
pub enum ClusterTestFailoverProviderSpecificInputUnion {
    #[serde(rename = "A2A")]
    A2a(A2aClusterTestFailoverInput),
}
#[doc = "Input definition for unplanned cluster failover."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ClusterUnplannedFailoverInput {
    #[doc = "Input definition for unplanned failover input properties."]
    pub properties: ClusterUnplannedFailoverInputProperties,
}
impl ClusterUnplannedFailoverInput {
    pub fn new(properties: ClusterUnplannedFailoverInputProperties) -> Self {
        Self { properties }
    }
}
#[doc = "Input definition for unplanned failover input properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ClusterUnplannedFailoverInputProperties {
    #[doc = "Failover direction."]
    #[serde(rename = "failoverDirection", default, skip_serializing_if = "Option::is_none")]
    ...
    #[doc = "Provider specific unplanned cluster failover input."]
    #[serde(rename = "providerSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_details: Option<ClusterUnplannedFailoverProviderSpecificInputUnion>,
}
impl ClusterUnplannedFailoverInputProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "instanceType")]
pub enum ClusterUnplannedFailoverProviderSpecificInputUnion {
    #[serde(rename = "A2A")]
    A2a(A2aClusterUnplannedFailoverInput),
}
...
pub struct CreateNetworkMappingInputProperties {
    ...
    pub fabric_specific_details: Option<FabricSpecificCreateNetworkMappingInputUnion>,
}
...
pub struct CreatePolicyInputProperties {
    ...
    pub provider_specific_input: Option<PolicyProviderSpecificInputUnion>,
}
...
pub struct CreateProtectionContainerInputProperties {
    ...
    pub provider_specific_input: Vec<ReplicationProviderSpecificContainerCreationInputUnion>,
}
...
pub struct CreateProtectionContainerMappingInputProperties {
    ...
    #[serde(rename = "providerSpecificInput", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_input: Option<ReplicationProviderSpecificContainerMappingInputUnion>,
}
...
pub struct CreateProtectionIntentProperties {
    ...
    #[serde(rename = "providerSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_details: Option<CreateProtectionIntentProviderSpecificDetailsUnion>,
}
...
pub enum CreateProtectionIntentProviderSpecificDetailsUnion {
    #[serde(rename = "A2A")]
    A2a(A2aCreateProtectionIntentInput),
}
...
pub struct CreateRecoveryPlanInputProperties {
    ...
    pub provider_specific_input: Vec<RecoveryPlanProviderSpecificInputUnion>,
}
...
pub struct DisableProtectionInputProperties {
    ...
    pub replication_provider_input: Option<DisableProtectionProviderSpecificInputUnion>,
}
...
pub enum DisableProtectionProviderSpecificInputUnion {
    InMage(InMageDisableProtectionProviderSpecificInput),
}
...
#[doc = "The disk type."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "DiskAccountType")]
pub enum DiskAccountType {
...
impl FromStr for DiskAccountType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for DiskAccountType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for DiskAccountType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::StandardLrs => serializer.serialize_unit_variant("DiskAccountType", 0u32, "Standard_LRS"),
            Self::PremiumLrs => serializer.serialize_unit_variant("DiskAccountType", 1u32, "Premium_LRS"),
            Self::StandardSsdLrs => serializer.serialize_unit_variant("DiskAccountType", 2u32, "StandardSSD_LRS"),
            Self::PremiumV2Lrs => serializer.serialize_unit_variant("DiskAccountType", 3u32, "PremiumV2_LRS"),
            Self::UltraSsdLrs => serializer.serialize_unit_variant("DiskAccountType", 4u32, "UltraSSD_LRS"),
            Self::StandardSsdZrs => serializer.serialize_unit_variant("DiskAccountType", 5u32, "StandardSSD_ZRS"),
            Self::PremiumZrs => serializer.serialize_unit_variant("DiskAccountType", 6u32, "Premium_ZRS"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct EnableMigrationInputProperties {
    ...
    #[serde(rename = "providerSpecificDetails")]
    pub provider_specific_details: EnableMigrationProviderSpecificInputUnion,
}
impl EnableMigrationInputProperties {
    pub fn new(policy_id: String, provider_specific_details: EnableMigrationProviderSpecificInputUnion) -> Self {
        Self {
            policy_id,
            provider_specific_details,
        }
...
pub enum EnableMigrationProviderSpecificInputUnion {
    VMwareCbt(VMwareCbtEnableMigrationInput),
}
...
pub struct EnableProtectionInputProperties {
    ...
    #[serde(rename = "providerSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_details: Option<EnableProtectionProviderSpecificInputUnion>,
}
...
pub struct EventProperties {
    ...
    #[serde(rename = "providerSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_details: Option<EventProviderSpecificDetailsUnion>,
    ...
    pub event_specific_details: Option<EventSpecificDetailsUnion>,
...
pub enum EventSpecificDetailsUnion {
    JobStatus(JobStatusEventDetails),
}
...
pub struct FabricCreationInputProperties {
    #[doc = "Fabric provider specific settings."]
    #[serde(rename = "customDetails", default, skip_serializing_if = "Option::is_none")]
    pub custom_details: Option<FabricSpecificCreationInputUnion>,
}
...
pub struct FabricProperties {
    ...
    #[serde(rename = "customDetails", default, skip_serializing_if = "Option::is_none")]
    pub custom_details: Option<FabricSpecificDetailsUnion>,
...
pub struct HyperVReplicaAzureDiskInputDetails {
    ...
    #[doc = "The disk type."]
    #[serde(rename = "diskType", default, skip_serializing_if = "Option::is_none")]
    pub disk_type: Option<DiskAccountType>,
    #[doc = "The DiskEncryptionSet ARM ID."]
    #[serde(rename = "diskEncryptionSetId", default, skip_serializing_if = "Option::is_none")]
    pub disk_encryption_set_id: Option<String>,
    #[doc = "The logical sector size (in bytes), 512 by default."]
    #[serde(rename = "sectorSizeInBytes", default, skip_serializing_if = "Option::is_none")]
    pub sector_size_in_bytes: Option<i32>,
}
...
pub struct HyperVReplicaAzureEnableProtectionInput {
    ...
    #[serde(rename = "osType", default, skip_serializing_if = "Option::is_none")]
    pub os_type: Option<String>,
    #[doc = "The OS name selected by user."]
    #[serde(rename = "userSelectedOSName", default, skip_serializing_if = "Option::is_none")]
    pub user_selected_os_name: Option<String>,
    ...
    #[doc = "Security profile input."]
    #[serde(rename = "targetVmSecurityProfile", default, skip_serializing_if = "Option::is_none")]
    pub target_vm_security_profile: Option<SecurityProfileProperties>,
...
pub struct HyperVReplicaAzureManagedDiskDetails {
    ...
    pub disk_encryption_set_id: Option<String>,
    #[doc = "The disk type."]
    #[serde(rename = "targetDiskAccountType", default, skip_serializing_if = "Option::is_none")]
    pub target_disk_account_type: Option<DiskAccountType>,
    #[doc = "The logical sector size (in bytes), 512 by default."]
    #[serde(rename = "sectorSizeInBytes", default, skip_serializing_if = "Option::is_none")]
    pub sector_size_in_bytes: Option<i32>,
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "instanceType")]
pub enum HyperVReplicaPolicyInputUnion {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "instanceType")]
pub enum HyperVVirtualMachineDetailsUnion {
    VmmVirtualMachine(VmmVirtualMachineDetails),
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "InMageRcm add disk(s) input."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct InMageRcmAddDisksInput {
    #[doc = "The list of disk details."]
    pub disks: Vec<InMageRcmDiskInput>,
}
impl InMageRcmAddDisksInput {
    pub fn new(disks: Vec<InMageRcmDiskInput>) -> Self {
        Self { disks }
    }
}
...
impl InMageRcmDiskInput {
    pub fn new(disk_id: String, log_storage_account_id: String, disk_type: DiskAccountType) -> Self {
        Self {
            disk_id,
            log_storage_account_id,
            disk_type,
            disk_encryption_set_id: None,
            sector_size_in_bytes: None,
        }
    }
}
#[doc = "InMageRcm disk input."]
...
impl InMageRcmDisksDefaultInput {
    pub fn new(log_storage_account_id: String, disk_type: DiskAccountType) -> Self {
        Self {
            log_storage_account_id,
            disk_type,
            disk_encryption_set_id: None,
...
pub struct InMageRcmEnableProtectionInput {
    ...
    #[doc = "The SQL Server license type."]
    #[serde(rename = "sqlServerLicenseType", default, skip_serializing_if = "Option::is_none")]
    pub sql_server_license_type: Option<in_mage_rcm_enable_protection_input::SqlServerLicenseType>,
    #[doc = "The target VM tags."]
    #[serde(
        rename = "targetVmTags",
        default,
    ...
    pub target_vm_tags: Vec<UserCreatedResourceTag>,
    #[doc = "The tags for the seed managed disks."]
    #[serde(
        rename = "seedManagedDiskTags",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub seed_managed_disk_tags: Vec<UserCreatedResourceTag>,
    #[doc = "The tags for the target managed disks."]
    #[serde(
        rename = "targetManagedDiskTags",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub target_managed_disk_tags: Vec<UserCreatedResourceTag>,
    #[doc = "The tags for the target NICs."]
    #[serde(
        rename = "targetNicTags",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub target_nic_tags: Vec<UserCreatedResourceTag>,
    #[doc = "The OS name selected by user."]
    #[serde(rename = "userSelectedOSName", default, skip_serializing_if = "Option::is_none")]
    pub user_selected_os_name: Option<String>,
    #[doc = "Security profile input."]
...
impl InMageRcmEnableProtectionInput {
    pub fn new(fabric_discovery_machine_id: String, target_resource_group_id: String, process_server_id: String) -> Self {
        Self {
            ...
            multi_vm_group_name: None,
            sql_server_license_type: None,
            target_vm_tags: Vec::new(),
            seed_managed_disk_tags: Vec::new(),
            target_managed_disk_tags: Vec::new(),
            target_nic_tags: Vec::new(),
            user_selected_os_name: None,
            target_vm_security_profile: None,
        }
    }
...
pub struct InMageRcmProtectedDiskDetails {
    ...
    #[doc = "The disk state."]
    #[serde(rename = "diskState", default, skip_serializing_if = "Option::is_none")]
    pub disk_state: Option<in_mage_rcm_protected_disk_details::DiskState>,
    #[doc = "The log storage account ARM Id."]
    #[serde(rename = "logStorageAccountId", default, skip_serializing_if = "Option::is_none")]
    pub log_storage_account_id: Option<String>,
    #[doc = "The DiskEncryptionSet ARM Id."]
...
pub mod in_mage_rcm_protected_disk_details {
    ...
    impl Serialize for DiskState {
        ...
        {
            match self {
                Self::Unavailable => serializer.serialize_unit_variant("DiskState", 0u32, "Unavailable"),
                Self::InitialReplicationPending => serializer.serialize_unit_variant("DiskState", 1u32, "InitialReplicationPending"),
                Self::InitialReplicationFailed => serializer.serialize_unit_variant("DiskState", 2u32, "InitialReplicationFailed"),
                Self::Protected => serializer.serialize_unit_variant("DiskState", 3u32, "Protected"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct InMageRcmReplicationDetails {
    ...
    pub unprotected_disks: Vec<InMageRcmUnProtectedDiskDetails>,
    ...
    pub supported_os_versions: Vec<String>,
    #[doc = "The OS name associated with VM."]
    #[serde(rename = "osName", default, skip_serializing_if = "Option::is_none")]
    pub os_name: Option<String>,
    #[doc = "Security profile input."]
    #[serde(rename = "targetVmSecurityProfile", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "InMageRcm un-protected disk details."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct InMageRcmUnProtectedDiskDetails {
    #[doc = "The disk Id."]
    #[serde(rename = "diskId", default, skip_serializing_if = "Option::is_none")]
    pub disk_id: Option<String>,
    #[doc = "The disk name."]
...
impl InMageRcmUnProtectedDiskDetails {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct InMageRcmUpdateReplicationProtectedItemInput {
    ...
    #[doc = "The SQL Server license type."]
    #[serde(rename = "sqlServerLicenseType", default, skip_serializing_if = "Option::is_none")]
    pub sql_server_license_type: Option<in_mage_rcm_update_replication_protected_item_input::SqlServerLicenseType>,
    #[doc = "The target VM tags."]
    #[serde(
        rename = "targetVmTags",
        default,
...
pub struct JobProperties {
    ...
    #[doc = "Job details based on specific job type."]
    #[serde(rename = "customDetails", default, skip_serializing_if = "Option::is_none")]
    pub custom_details: Option<JobDetailsUnion>,
}
impl JobProperties {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "Managed RunCommand script input"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ManagedRunCommandScriptInput {
    #[doc = "The step name."]
    ...
    #[doc = "The script parameters."]
    #[serde(rename = "scriptParameters")]
    pub script_parameters: String,
}
impl ManagedRunCommandScriptInput {
    pub fn new(step_name: String, script_url: String, script_parameters: String) -> Self {
        Self {
            step_name,
            script_url,
            script_parameters,
...
pub struct MigrateInputProperties {
    ...
    #[serde(rename = "providerSpecificDetails")]
    pub provider_specific_details: MigrateProviderSpecificInputUnion,
}
impl MigrateInputProperties {
    pub fn new(provider_specific_details: MigrateProviderSpecificInputUnion) -> Self {
        Self { provider_specific_details }
    }
}
#[doc = "The class type."]
...
pub enum MigrateProviderSpecificInputUnion {
    VMwareCbt(VMwareCbtMigrateInput),
}
#[doc = "Migration item."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct MigrationItemProperties {
    ...
    #[serde(rename = "providerSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_details: Option<MigrationProviderSpecificSettingsUnion>,
}
...
pub struct NetworkMappingProperties {
    ...
    pub fabric_specific_settings: Option<NetworkMappingFabricSpecificSettingsUnion>,
}
...
pub struct PlannedFailoverInputProperties {
    ...
    #[serde(rename = "providerSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_details: Option<PlannedFailoverProviderSpecificFailoverInputUnion>,
}
...
pub struct PolicyProperties {
    ...
    #[serde(rename = "providerSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_details: Option<PolicyProviderSpecificDetailsUnion>,
}
...
pub struct ProtectableItemProperties {
    ...
    #[serde(rename = "customDetails", default, skip_serializing_if = "Option::is_none")]
    pub custom_details: Option<ConfigurationSettingsUnion>,
}
...
pub struct ProtectionContainerMappingProperties {
    ...
    #[serde(rename = "providerSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_details: Option<ProtectionContainerMappingProviderSpecificDetailsUnion>,
...
pub enum ProtectionProfileCustomDetailsUnion {
    Existing(ExistingProtectionProfile),
...
pub enum RecoveryAvailabilitySetCustomDetailsUnion {
    Existing(ExistingRecoveryAvailabilitySet),
}
...
pub struct RecoveryPlanAction {
    ...
    pub custom_details: RecoveryPlanActionDetailsUnion,
}
impl RecoveryPlanAction {
    pub fn new(
        ...
        custom_details: RecoveryPlanActionDetailsUnion,
    ) -> Self {
        Self {
            action_name,
            failover_types,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "instanceType")]
pub enum RecoveryPlanGroupTaskDetailsUnion {
...
pub struct RecoveryPlanPlannedFailoverInputProperties {
    ...
    pub provider_specific_details: Vec<RecoveryPlanProviderSpecificFailoverInputUnion>,
}
...
pub struct RecoveryPlanProperties {
    ...
    pub provider_specific_details: Vec<RecoveryPlanProviderSpecificDetailsUnion>,
}
...
pub struct RecoveryPointProperties {
    ...
    #[serde(rename = "providerSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_details: Option<ProviderSpecificRecoveryPointDetailsUnion>,
}
...
pub enum RecoveryResourceGroupCustomDetailsUnion {
    Existing(ExistingRecoveryRecoveryResourceGroup),
}
...
pub enum RecoveryVirtualNetworkCustomDetailsUnion {
    Existing(ExistingRecoveryVirtualNetwork),
    New(NewRecoveryVirtualNetwork),
}
#[doc = "Extended location of the resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct RegisteredClusterNodes {
    #[doc = "The cluster node name."]
    #[serde(rename = "clusterNodeFqdn", default, skip_serializing_if = "Option::is_none")]
    pub cluster_node_fqdn: Option<String>,
    #[doc = "The machine ID."]
    #[serde(rename = "machineId", default, skip_serializing_if = "Option::is_none")]
    pub machine_id: Option<String>,
    #[doc = "The BIOS ID."]
    #[serde(rename = "biosId", default, skip_serializing_if = "Option::is_none")]
    pub bios_id: Option<String>,
    #[doc = "A value indicating whether this represents virtual entity hosting all the shared disks."]
    #[serde(rename = "isSharedDiskVirtualNode", default, skip_serializing_if = "Option::is_none")]
    pub is_shared_disk_virtual_node: Option<bool>,
}
impl RegisteredClusterNodes {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct RemoveDisksInputProperties {
    ...
    #[serde(rename = "providerSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_details: Option<RemoveDisksProviderSpecificInputUnion>,
}
...
pub struct ReplicationApplianceProperties {
    ...
    #[serde(rename = "providerSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_details: Option<ApplianceSpecificDetailsUnion>,
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "instanceType")]
pub enum ReplicationClusterProviderSpecificSettingsUnion {
    #[serde(rename = "A2A")]
    A2a(A2aReplicationProtectionClusterDetails),
}
...
pub struct ReplicationProtectedItemProperties {
    ...
    #[doc = "Replication provider specific settings."]
    #[serde(rename = "providerSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_details: Option<ReplicationProviderSpecificSettingsUnion>,
    #[doc = "The recovery container Id."]
    #[serde(rename = "recoveryContainerId", default, skip_serializing_if = "Option::is_none")]
    pub recovery_container_id: Option<String>,
...
#[doc = "Replication protection Cluster."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ReplicationProtectionCluster {
    #[doc = "The protection cluster Id."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "The name of the protection cluster."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "The Type of the object."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<String>,
    #[doc = "Replication protection cluster custom data details."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ReplicationProtectionClusterProperties>,
}
impl ReplicationProtectionCluster {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Replication protected item collection."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ReplicationProtectionClusterCollection {
    #[doc = "The Replication protection cluster details."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<ReplicationProtectionCluster>,
    #[doc = "The value of next link."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ReplicationProtectionClusterCollection {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl ReplicationProtectionClusterCollection {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Replication protection cluster custom data details."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ReplicationProtectionClusterProperties {
    #[doc = "The type of protection cluster type."]
    #[serde(rename = "protectionClusterType", default, skip_serializing_if = "Option::is_none")]
    pub protection_cluster_type: Option<String>,
    #[doc = "The friendly name of the primary fabric."]
    #[serde(rename = "primaryFabricFriendlyName", default, skip_serializing_if = "Option::is_none")]
    pub primary_fabric_friendly_name: Option<String>,
    #[doc = "The fabric provider of the primary fabric."]
    ...
    #[serde(rename = "protectionStateDescription", default, skip_serializing_if = "Option::is_none")]
    pub protection_state_description: Option<String>,
    #[doc = "The Current active location of the Protection cluster."]
    #[serde(rename = "activeLocation", default, skip_serializing_if = "Option::is_none")]
    pub active_location: Option<String>,
    #[doc = "The Test failover state."]
    #[serde(rename = "testFailoverState", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "testFailoverStateDescription", default, skip_serializing_if = "Option::is_none")]
    pub test_failover_state_description: Option<String>,
    #[doc = "The allowed operations on the Replication protection cluster."]
    #[serde(
        rename = "allowedOperations",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    #[serde(rename = "recoveryContainerId", default, skip_serializing_if = "Option::is_none")]
    pub recovery_container_id: Option<String>,
    #[doc = "The Agent cluster Id."]
    #[serde(rename = "agentClusterId", default, skip_serializing_if = "Option::is_none")]
    pub agent_cluster_id: Option<String>,
    #[doc = "The cluster FQDN."]
    #[serde(rename = "clusterFqdn", default, skip_serializing_if = "Option::is_none")]
    pub cluster_fqdn: Option<String>,
    #[doc = "The List of cluster Node FQDNs."]
    #[serde(
        rename = "clusterNodeFqdns",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub cluster_node_fqdns: Vec<String>,
    #[doc = "The List of Protected Item Id's."]
    #[serde(
        rename = "clusterProtectedItemIds",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub cluster_protected_item_ids: Vec<String>,
    #[doc = "The provisioning state of the cluster."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<String>,
    #[doc = "A value indicating whether all nodes of the cluster are registered or not."]
    #[serde(rename = "areAllClusterNodesRegistered", default, skip_serializing_if = "Option::is_none")]
    pub are_all_cluster_nodes_registered: Option<bool>,
    #[doc = "The registered node details."]
    #[serde(
        rename = "clusterRegisteredNodes",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub cluster_registered_nodes: Vec<RegisteredClusterNodes>,
    #[doc = "Replication cluster provider specific settings."]
    #[serde(rename = "providerSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_details: Option<ReplicationClusterProviderSpecificSettingsUnion>,
    #[doc = "Shared Disk Replication item custom data details."]
    #[serde(rename = "sharedDiskProperties", default, skip_serializing_if = "Option::is_none")]
    pub shared_disk_properties: Option<SharedDiskReplicationItemProperties>,
    #[doc = "The Policy Id."]
    #[serde(rename = "policyId", default, skip_serializing_if = "Option::is_none")]
    pub policy_id: Option<String>,
}
impl ReplicationProtectionClusterProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ReplicationProtectionIntentProperties {
    ...
    #[doc = "Replication provider specific settings."]
    #[serde(rename = "providerSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_details: Option<ReplicationProtectionIntentProviderSpecificSettingsUnion>,
}
...
pub enum ReplicationProtectionIntentProviderSpecificSettingsUnion {
    #[serde(rename = "A2A")]
    A2a(A2aReplicationIntentDetails),
}
#[doc = "Provider specific input for unpairing operations."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub enum ReplicationProviderSpecificUpdateContainerMappingInputUnion {
    #[serde(rename = "A2A")]
    A2a(A2aUpdateContainerMappingInput),
    InMageRcm(InMageRcmUpdateContainerMappingInput),
}
#[doc = "Reprotect agent details."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct ResumeReplicationInputProperties {
    ...
    #[serde(rename = "providerSpecificDetails")]
    pub provider_specific_details: ResumeReplicationProviderSpecificInputUnion,
}
impl ResumeReplicationInputProperties {
    pub fn new(provider_specific_details: ResumeReplicationProviderSpecificInputUnion) -> Self {
        Self { provider_specific_details }
    }
}
#[doc = "The class type."]
...
pub enum ResumeReplicationProviderSpecificInputUnion {
    VMwareCbt(VMwareCbtResumeReplicationInput),
}
#[doc = "Resync input."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
pub struct ResyncInputProperties {
    ...
    #[serde(rename = "providerSpecificDetails")]
    pub provider_specific_details: ResyncProviderSpecificInputUnion,
}
impl ResyncInputProperties {
    pub fn new(provider_specific_details: ResyncProviderSpecificInputUnion) -> Self {
        Self { provider_specific_details }
    }
}
#[doc = "The class type."]
...
pub enum ResyncProviderSpecificInputUnion {
    VMwareCbt(VMwareCbtResyncInput),
}
...
pub struct ReverseReplicationInputProperties {
    ...
    #[serde(rename = "providerSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_details: Option<ReverseReplicationProviderSpecificInputUnion>,
}
...
#[doc = "Security configuration state."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "SecurityConfiguration")]
...
impl FromStr for SecurityConfiguration {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
...
impl Serialize for SecurityConfiguration {
    ...
    {
        match self {
            Self::Disabled => serializer.serialize_unit_variant("SecurityConfiguration", 0u32, "Disabled"),
            Self::Enabled => serializer.serialize_unit_variant("SecurityConfiguration", 1u32, "Enabled"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct SecurityProfileProperties {
    ...
    pub target_vm_security_type: Option<security_profile_properties::TargetVmSecurityType>,
    #[doc = "Security configuration state."]
    #[serde(rename = "targetVmSecureBoot", default, skip_serializing_if = "Option::is_none")]
    pub target_vm_secure_boot: Option<SecurityConfiguration>,
    #[doc = "Security configuration state."]
    #[serde(rename = "targetVmTpm", default, skip_serializing_if = "Option::is_none")]
    pub target_vm_tpm: Option<SecurityConfiguration>,
    #[doc = "Security configuration state."]
    #[serde(rename = "targetVmMonitoring", default, skip_serializing_if = "Option::is_none")]
    pub target_vm_monitoring: Option<SecurityConfiguration>,
    #[doc = "Security configuration state."]
    #[serde(rename = "targetVmConfidentialEncryption", default, skip_serializing_if = "Option::is_none")]
    pub target_vm_confidential_encryption: Option<SecurityConfiguration>,
}
impl SecurityProfileProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod security_profile_properties {
    use super::*;
    #[doc = "The target VM security type."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "Shared Disk Replication item custom data details."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SharedDiskReplicationItemProperties {
    #[doc = "The protection state of shared disk."]
    #[serde(rename = "protectionState", default, skip_serializing_if = "Option::is_none")]
    pub protection_state: Option<String>,
    #[doc = "The tfo state of shared disk."]
    #[serde(rename = "testFailoverState", default, skip_serializing_if = "Option::is_none")]
    pub test_failover_state: Option<String>,
    #[doc = "The Current active location of the PE."]
    #[serde(rename = "activeLocation", default, skip_serializing_if = "Option::is_none")]
    ...
    pub current_scenario: Option<CurrentScenarioDetails>,
    #[doc = "Replication provider specific settings."]
    #[serde(rename = "sharedDiskProviderSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub shared_disk_provider_specific_details: Option<SharedDiskReplicationProviderSpecificSettingsUnion>,
}
impl SharedDiskReplicationItemProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "instanceType")]
pub enum SharedDiskReplicationProviderSpecificSettingsUnion {
    #[serde(rename = "A2A")]
    A2a(A2aSharedDiskReplicationDetails),
}
#[doc = "The class type."]
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "resourceType")]
pub enum StorageAccountCustomDetailsUnion {
    Existing(ExistingStorageAccount),
}
...
#[doc = "Switch cluster protection input."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SwitchClusterProtectionInput {
    #[doc = "Switch cluster protection input properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<SwitchClusterProtectionInputProperties>,
}
impl SwitchClusterProtectionInput {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Switch cluster protection input properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SwitchClusterProtectionInputProperties {
    #[doc = "The unique replication protection cluster name."]
    #[serde(rename = "replicationProtectionClusterName", default, skip_serializing_if = "Option::is_none")]
    pub replication_protection_cluster_name: Option<String>,
    #[doc = "Provider specific switch cluster protection input."]
    #[serde(rename = "providerSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_details: Option<SwitchClusterProtectionProviderSpecificInputUnion>,
}
impl SwitchClusterProtectionInputProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(tag = "instanceType")]
pub enum SwitchClusterProtectionProviderSpecificInputUnion {
    #[serde(rename = "A2A")]
...
pub struct SwitchProtectionInputProperties {
    ...
    #[serde(rename = "providerSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_details: Option<SwitchProtectionProviderSpecificInputUnion>,
}
...
pub struct SwitchProviderInputProperties {
    ...
    #[serde(rename = "providerSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_details: Option<SwitchProviderProviderSpecificInputUnion>,
}
...
pub enum SwitchProviderProviderSpecificInputUnion {
    InMageAzureV2(InMageAzureV2SwitchProviderProviderInput),
}
...
pub struct TestFailoverInputProperties {
    ...
    #[serde(rename = "providerSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_details: Option<TestFailoverProviderSpecificInputUnion>,
}
...
pub struct TestMigrateInputProperties {
    ...
    #[serde(rename = "providerSpecificDetails")]
    pub provider_specific_details: TestMigrateProviderSpecificInputUnion,
}
impl TestMigrateInputProperties {
    pub fn new(provider_specific_details: TestMigrateProviderSpecificInputUnion) -> Self {
        Self { provider_specific_details }
    }
}
#[doc = "The class type."]
...
pub enum TestMigrateProviderSpecificInputUnion {
    VMwareCbt(VMwareCbtTestMigrateInput),
}
...
pub struct UnplannedFailoverInputProperties {
    ...
    #[serde(rename = "providerSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_details: Option<UnplannedFailoverProviderSpecificInputUnion>,
}
...
pub struct UpdateApplianceForReplicationProtectedItemInputProperties {
    ...
    #[serde(rename = "providerSpecificDetails")]
    pub provider_specific_details: UpdateApplianceForReplicationProtectedItemProviderSpecificInputUnion,
}
...
pub enum UpdateApplianceForReplicationProtectedItemProviderSpecificInputUnion {
    InMageRcm(InMageRcmUpdateApplianceForReplicationProtectedItemInput),
}
...
pub struct UpdateMigrationItemInputProperties {
    ...
    #[serde(rename = "providerSpecificDetails")]
    pub provider_specific_details: UpdateMigrationItemProviderSpecificInputUnion,
}
impl UpdateMigrationItemInputProperties {
    pub fn new(provider_specific_details: UpdateMigrationItemProviderSpecificInputUnion) -> Self {
        Self { provider_specific_details }
    }
}
#[doc = "The class type."]
...
pub struct UpdateNetworkMappingInputProperties {
    ...
    #[doc = "Input details specific to fabrics during Network Mapping."]
    #[serde(rename = "fabricSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub fabric_specific_details: Option<FabricSpecificUpdateNetworkMappingInputUnion>,
}
...
pub struct UpdatePolicyInputProperties {
    ...
    pub replication_provider_settings: Option<PolicyProviderSpecificInputUnion>,
}
...
pub struct UpdateProtectionContainerMappingInputProperties {
    ...
    #[serde(rename = "providerSpecificInput", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_input: Option<ReplicationProviderSpecificUpdateContainerMappingInputUnion>,
}
...
pub struct UpdateReplicationProtectedItemInputProperties {
    ...
    #[doc = "Update replication protected item provider specific input."]
    #[serde(rename = "providerSpecificDetails", default, skip_serializing_if = "Option::is_none")]
    pub provider_specific_details: Option<UpdateReplicationProtectedItemProviderInputUnion>,
}
...
#[doc = "Resource tag input."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct UserCreatedResourceTag {
    #[doc = "The tag name. Please read for more information: https://learn.microsoft.com/en-us/azure/azure-resource-manager/management/tag-resources#limitations"]
    #[serde(rename = "tagName", default, skip_serializing_if = "Option::is_none")]
    pub tag_name: Option<String>,
    #[doc = "The tag value. Please read her for more information: https://learn.microsoft.com/en-us/azure/azure-resource-manager/management/tag-resources#limitations"]
    #[serde(rename = "tagValue", default, skip_serializing_if = "Option::is_none")]
    pub tag_value: Option<String>,
}
impl UserCreatedResourceTag {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct VMwareCbtEnableMigrationInput {
    ...
    #[doc = "The license type for Linux VM's."]
    #[serde(rename = "linuxLicenseType", default, skip_serializing_if = "Option::is_none")]
    pub linux_license_type: Option<v_mware_cbt_enable_migration_input::LinuxLicenseType>,
...
pub mod v_mware_cbt_enable_migration_input {
    ...
    #[doc = "The license type for Linux VM's."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "LinuxLicenseType")]
    pub enum LinuxLicenseType {
        NotSpecified,
        NoLicenseType,
        LinuxServer,
        #[serde(skip_deserializing)]
    ...
    impl FromStr for LinuxLicenseType {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for LinuxLicenseType {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for LinuxLicenseType {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::NotSpecified => serializer.serialize_unit_variant("LinuxLicenseType", 0u32, "NotSpecified"),
                Self::NoLicenseType => serializer.serialize_unit_variant("LinuxLicenseType", 1u32, "NoLicenseType"),
                Self::LinuxServer => serializer.serialize_unit_variant("LinuxLicenseType", 2u32, "LinuxServer"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct VMwareCbtMigrateInput {
    ...
    #[serde(rename = "osUpgradeVersion", default, skip_serializing_if = "Option::is_none")]
    pub os_upgrade_version: Option<String>,
    #[doc = "The managed run command script input."]
    #[serde(
        rename = "postMigrationSteps",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub post_migration_steps: Vec<ManagedRunCommandScriptInput>,
}
...
pub struct VMwareCbtMigrationDetails {
    ...
    #[doc = "The license type for Linux VM's."]
    #[serde(rename = "linuxLicenseType", default, skip_serializing_if = "Option::is_none")]
    pub linux_license_type: Option<v_mware_cbt_migration_details::LinuxLicenseType>,
    #[doc = "The data mover run as account Id."]
...
pub struct VMwareCbtUpdateMigrationItemInput {
    ...
    #[doc = "The license type for Linux VM's."]
    #[serde(rename = "linuxLicenseType", default, skip_serializing_if = "Option::is_none")]
    pub linux_license_type: Option<v_mware_cbt_update_migration_item_input::LinuxLicenseType>,
    #[doc = "A value indicating whether auto resync is to be done."]
    #[serde(rename = "performAutoResync", default, skip_serializing_if = "Option::is_none")]
    pub perform_auto_resync: Option<String>,
    #[doc = "The target VM tags."]
