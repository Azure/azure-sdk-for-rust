...
pub mod replication_protected_items {
    ...
    pub async fn add_disks(
        ...
        url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
        let req_body = azure_core::to_json(add_disks_input).context(add_disks::SerializeError)?;
        req_builder = req_builder.uri(url.as_str());
    ...
    pub async fn remove_disks(
        ...
        url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
        let req_body = azure_core::to_json(remove_disks_input).context(remove_disks::SerializeError)?;
        req_builder = req_builder.uri(url.as_str());
    ...
    pub async fn resolve_health_errors(
        ...
        url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
        let req_body = azure_core::to_json(resolve_health_input).context(resolve_health_errors::SerializeError)?;
        req_builder = req_builder.uri(url.as_str());
