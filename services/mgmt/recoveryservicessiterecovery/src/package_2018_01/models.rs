...
pub struct AzureToAzureVmSyncedConfigDetails {
    ...
    #[serde(rename = "roleAssignments", skip_serializing_if = "Vec::is_empty")]
...
pub struct EventProperties {
    ...
    #[serde(rename = "affectedObjectCorrelationId", skip_serializing)]
...
pub struct ResourceHealthSummary {
    ...
    #[serde(rename = "categorizedResourceCounts", skip_serializing_if = "Option::is_none")]
...
pub struct VMwareCbtEnableMigrationInput {
    ...
    #[serde(rename = "performAutoResync", skip_serializing_if = "Option::is_none")]
