...
pub struct NetworkProfile {
    ...
    #[doc = "PreconfiguredNSG represents whether customers want to use their own NSG attached to the subnets"]
    #[serde(rename = "preconfiguredNSG", default, skip_serializing_if = "Option::is_none")]
    pub preconfigured_nsg: Option<PreconfiguredNsg>,
}
impl NetworkProfile {
    pub fn new() -> Self {
        Self::default()
...
pub struct OpenShiftClusterProperties {
    ...
    #[doc = "The cluster worker profiles status."]
    #[serde(
        rename = "workerProfilesStatus",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub worker_profiles_status: Vec<WorkerProfile>,
    #[doc = "APIServerProfile represents an API server profile."]
...
#[doc = "PreconfiguredNSG represents whether customers want to use their own NSG attached to the subnets"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "PreconfiguredNsg")]
pub enum PreconfiguredNsg {
    Disabled,
    Enabled,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for PreconfiguredNsg {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for PreconfiguredNsg {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for PreconfiguredNsg {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Disabled => serializer.serialize_unit_variant("PreconfiguredNsg", 0u32, "Disabled"),
            Self::Enabled => serializer.serialize_unit_variant("PreconfiguredNsg", 1u32, "Enabled"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl Serialize for ProvisioningState {
    ...
    {
        match self {
            Self::AdminUpdating => serializer.serialize_unit_variant("ProvisioningState", 0u32, "AdminUpdating"),
