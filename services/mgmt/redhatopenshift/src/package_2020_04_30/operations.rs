...
pub enum Error {
    ...
    #[error(transparent)]
    OpenShiftClusters_List(#[from] open_shift_clusters::list::Error),
    #[error(transparent)]
    OpenShiftClusters_ListByResourceGroup(#[from] open_shift_clusters::list_by_resource_group::Error),
    #[error(transparent)]
    OpenShiftClusters_Get(#[from] open_shift_clusters::get::Error),
    #[error(transparent)]
    OpenShiftClusters_CreateOrUpdate(#[from] open_shift_clusters::create_or_update::Error),
    #[error(transparent)]
    OpenShiftClusters_Update(#[from] open_shift_clusters::update::Error),
    #[error(transparent)]
    OpenShiftClusters_Delete(#[from] open_shift_clusters::delete::Error),
    #[error(transparent)]
    OpenShiftClusters_ListCredentials(#[from] open_shift_clusters::list_credentials::Error),
}
pub mod operations {
    use super::models;
    ...
    pub mod list {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::OperationList, Error>> {
                Box::pin(async move {
                    let url_str = &format!("{}/providers/Microsoft.RedHatOpenShift/operations", self.client.endpoint(),);
                    ...
                    url.query_pairs_mut().append_pair("api-version", "2020-04-30");
...
pub mod open_shift_clusters {
    ...
    pub mod list {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::OpenShiftClusterList, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                            let rsp_value: models::OpenShiftClusterList =
                                serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                            Ok(rsp_value)
                        }
                        status_code => {
    ...
    pub mod get {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::OpenShiftCluster, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.RedHatOpenShift/openShiftClusters/{}",
                        self.client.endpoint(),
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                            let rsp_value: models::OpenShiftCluster =
                                serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                            Ok(rsp_value)
                        }
                        status_code => {
    ...
    pub mod list_credentials {
        ...
        impl Builder {
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, std::result::Result<models::OpenShiftClusterCredentials, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                            let rsp_value: models::OpenShiftClusterCredentials =
                                serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                            Ok(rsp_value)
                        }
                        status_code => {
