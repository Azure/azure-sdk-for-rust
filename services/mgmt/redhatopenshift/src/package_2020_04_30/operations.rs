...
pub mod operations {
    ...
    pub async fn list(operation_config: &crate::OperationConfig) -> std::result::Result<OperationList, list::Error> {
        ...
        let uri_str = &format!("{}/providers/Microsoft.RedHatOpenShift/operations", &operation_config.base_path,);
...
pub mod open_shift_clusters {
    ...
    pub async fn list(
        ...
        subscription_id: &str,
    ) -> std::result::Result<OpenShiftClusterList, list::Error> {
        let client = &operation_config.client;
        let uri_str = &format!(
        ...
        match rsp.status() {
            StatusCode::OK => {
                let body: bytes::Bytes = rsp.bytes().await.context(list::ResponseBytesError)?;
                let rsp_value: OpenShiftClusterList = serde_json::from_slice(&body).context(list::DeserializeError { body })?;
                Ok(rsp_value)
            }
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(list::ResponseBytesError)?;
    ...
    pub async fn list_by_resource_group(
    ...
    ) -> std::result::Result<OpenShiftClusterList, list_by_resource_group::Error> {
        let client = &operation_config.client;
        let uri_str = &format!(
        ...
        match rsp.status() {
            StatusCode::OK => {
                ...
                let rsp_value: OpenShiftClusterList =
    ...
    pub async fn get(
        ...
        resource_group_name: &str,
        resource_name: &str,
    ) -> std::result::Result<OpenShiftCluster, get::Error> {
        let client = &operation_config.client;
        let uri_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.RedHatOpenShift/openShiftClusters/{}",
        ...
        match rsp.status() {
            StatusCode::OK => {
                ...
                let rsp_value: OpenShiftCluster = serde_json::from_slice(&body).context(get::DeserializeError { body })?;
                Ok(rsp_value)
            }
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(get::ResponseBytesError)?;
    ...
    pub async fn create_or_update(
        ...
        match rsp.status() {
            StatusCode::OK => {
                ...
                let rsp_value: OpenShiftCluster = serde_json::from_slice(&body).context(create_or_update::DeserializeError { body })?;
    ...
    pub mod create_or_update {
        ...
        #[derive(Debug)]
        pub enum Response {
            Ok200(OpenShiftCluster),
            Created201(OpenShiftCluster),
        }
        #[derive(Debug, Snafu)]
        #[snafu(visibility(pub(crate)))]
        pub enum Error {
    ...
    pub async fn update(
        ...
        match rsp.status() {
            StatusCode::OK => {
                ...
                let rsp_value: OpenShiftCluster = serde_json::from_slice(&body).context(update::DeserializeError { body })?;
    ...
    pub async fn list_credentials(
        ...
        resource_group_name: &str,
        resource_name: &str,
    ) -> std::result::Result<OpenShiftClusterCredentials, list_credentials::Error> {
        let client = &operation_config.client;
        let uri_str = &format!(
        ...
        match rsp.status() {
            StatusCode::OK => {
                ...
                let rsp_value: OpenShiftClusterCredentials =
                    serde_json::from_slice(&body).context(list_credentials::DeserializeError { body })?;
                Ok(rsp_value)
            }
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(list_credentials::ResponseBytesError)?;
                let rsp_value: CloudError = serde_json::from_slice(&body).context(list_credentials::DeserializeError { body })?;
