...
pub mod apps {
    ...
    pub async fn get(
        ...
        resource_name: &str,
    ) -> std::result::Result<models::App, get::Error> {
    ...
    pub async fn list_by_subscription(
        operation_config: &crate::OperationConfig,
        subscription_id: &str,
    ) -> std::result::Result<models::AppListResult, list_by_subscription::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
    ...
    pub async fn list_by_resource_group(
        ...
        subscription_id: &str,
        resource_group_name: &str,
    ) -> std::result::Result<models::AppListResult, list_by_resource_group::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.IoTCentral/IoTApps",
            operation_config.base_path(),
    ...
    pub async fn check_name_availability(
    ...
    ) -> std::result::Result<models::AppNameAvailabilityInfo, check_name_availability::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::AppNameAvailabilityInfo = serde_json::from_slice(rsp_body)
