...
pub struct DisableSerialConsoleResult {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<disable_serial_console_result::Properties>,
}
...
pub mod disable_serial_console_result {
    use super::*;
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct EnableSerialConsoleResult {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<enable_serial_console_result::Properties>,
}
...
pub mod enable_serial_console_result {
    use super::*;
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
    pub struct Properties {
        #[doc = "Whether or not Serial Console is disabled."]
...
pub struct SerialConsoleStatus {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<serial_console_status::Properties>,
}
