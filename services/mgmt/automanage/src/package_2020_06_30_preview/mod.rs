...
pub mod accounts {
    ...
    impl Client {
        #[doc = "Get information about a Automanage account"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `account_name`: The Automanage account name."]
        ...
        #[doc = "Creates an Automanage Account"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `account_name`: Name of the Automanage account."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `parameters`: Parameters supplied to create or update Automanage account."]
        ...
        #[doc = "Updates an Automanage Account"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `account_name`: Name of the Automanage account."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `parameters`: Parameters supplied to update Automanage account."]
        pub fn update(
            &self,
            account_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ...
        #[doc = "Delete a Automanage account"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `account_name`: Name of the Automanage account"]
        ...
        #[doc = "Retrieve a list of Automanage accounts within a given resource group"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Retrieve a list of Automanage accounts within a subscription"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2020-06-30-preview");
                }
                Ok(url)
            }
        }
...
pub mod configuration_profile_assignments {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Compute/virtualMachines/{}/providers/Microsoft.Automanage/configurationProfileAssignments/{}" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . vm_name , & self . configuration_profile_assignment_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2020-06-30-preview");
...
pub mod configuration_profile_preferences {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Get information about a configuration profile preference"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `configuration_profile_preference_name`: The configuration profile preference name."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        pub fn get(
            &self,
        ...
        #[doc = "Creates a configuration profile preference"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `configuration_profile_preference_name`: Name of the configuration profile preference."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `parameters`: Parameters supplied to create or update configuration profile preference."]
        pub fn create_or_update(
            &self,
            configuration_profile_preference_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ...
        #[doc = "Updates a configuration profile preference"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `configuration_profile_preference_name`: Name of the configuration profile preference."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        ...
        #[doc = "Delete a configuration profile preference"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `configuration_profile_preference_name`: Name of the configuration profile preference"]
        ...
        #[doc = "Retrieve a list of configuration profile preferences within a given resource group"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Retrieve a list of configuration profile preferences within a subscription"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        pub fn list_by_subscription(&self, subscription_id: impl Into<String>) -> list_by_subscription::RequestBuilder {
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ConfigurationProfilePreference> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ConfigurationProfilePreference = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ConfigurationProfilePreference>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ConfigurationProfilePreference>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_by_resource_group {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ConfigurationProfilePreferenceList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ConfigurationProfilePreferenceList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
...
pub mod operations {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/providers/Microsoft.Automanage/operations", self.client.endpoint(),))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2020-06-30-preview");
