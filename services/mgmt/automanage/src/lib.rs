...
pub use package_2021_04_30_preview::{models, operations, operations::Client, operations::ClientBuilder};
...
pub use package_2020_06_30_preview::{models, operations, operations::Client, operations::ClientBuilder};
