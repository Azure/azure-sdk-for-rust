...
pub enum Error {
    #[error(transparent)]
    LiveToken_Get(#[from] live_token::get::Error),
}
pub mod live_token {
    use super::models;
    ...
    pub mod get {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::LiveTokenResponse, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                    ...
                    url.query_pairs_mut().append_pair("api-version", "2021-10-14");
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            ...
                            let rsp_value: models::LiveTokenResponse =
