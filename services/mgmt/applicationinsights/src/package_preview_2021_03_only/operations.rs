...
pub mod diagnostic_service_token {
    ...
    pub mod get_read_only {
        ...
        impl Builder {
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, std::result::Result<models::DiagnosticServicesTokenResponse, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                    ...
                    url.query_pairs_mut().append_pair("api-version", "2021-03-03-preview");
