                        ...
                        let rsp = match continuation {
                            Some(value) => {
                                ...
                                if !has_api_version_already {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair(azure_core::query_param::API_VERSION, "2024-04-04-preview");
                                }
...
pub mod subscription_usages {
    ...
    impl Client {
        ...
        pub fn usages(&self, subscription_id: impl Into<String>, location: impl Into<String>) -> usages::RequestBuilder {
            usages::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
    ...
    pub mod usages {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.DevOpsInfrastructure/locations/{}/usages",
...
pub mod image_versions {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List ImageVersion resources by Image"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `image_name`: Name of the image."]
    ...
    pub mod list_by_image {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DevOpsInfrastructure/images/{}/versions",
                    &self.subscription_id, &self.resource_group_name, &self.image_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
