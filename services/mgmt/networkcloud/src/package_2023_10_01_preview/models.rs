...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AdministratorConfigurationPatch {
    #[doc = "SshPublicKey represents the public key used to authenticate with a resource through SSH."]
    #[serde(
        rename = "sshPublicKeys",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
...
impl AdministratorConfigurationPatch {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct AgentPoolPatchProperties {
    #[serde(rename = "administratorConfiguration", default, skip_serializing_if = "Option::is_none")]
    pub administrator_configuration: Option<NodePoolAdministratorConfigurationPatch>,
    #[doc = "The number of virtual machines that use this configuration."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct BareMetalMachineProperties {
    ...
    #[doc = "The list of roles that are assigned to the cluster node running on this machine."]
    #[serde(
        rename = "machineRoles",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    #[serde(rename = "runtimeProtectionStatus", default, skip_serializing_if = "Option::is_none")]
    pub runtime_protection_status: Option<RuntimeProtectionStatus>,
...
impl BareMetalMachineProperties {
    pub fn new(
        ...
        Self {
            ...
            rack_slot,
            ready_state: None,
            runtime_protection_status: None,
            serial_number,
            service_tag: None,
...
pub struct ClusterPatchProperties {
    ...
    #[serde(rename = "runtimeProtectionConfiguration", default, skip_serializing_if = "Option::is_none")]
    pub runtime_protection_configuration: Option<RuntimeProtectionConfiguration>,
    #[serde(rename = "secretArchive", default, skip_serializing_if = "Option::is_none")]
    pub secret_archive: Option<ClusterSecretArchive>,
    #[serde(rename = "updateStrategy", default, skip_serializing_if = "Option::is_none")]
    pub update_strategy: Option<ClusterUpdateStrategy>,
}
...
impl ClusterProperties {
    pub fn new(
        ...
        Self {
            ...
            network_fabric_id,
            provisioning_state: None,
            runtime_protection_configuration: None,
            secret_archive: None,
    ...
    impl Serialize for ClusterConnectionStatus {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Disconnected => serializer.serialize_unit_variant("ClusterConnectionStatus", 1u32, "Disconnected"),
                Self::Timeout => serializer.serialize_unit_variant("ClusterConnectionStatus", 2u32, "Timeout"),
                Self::Undefined => serializer.serialize_unit_variant("ClusterConnectionStatus", 3u32, "Undefined"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ClusterScanRuntimeParameters {
    #[doc = "The choice of if the scan operation should run the scan."]
    #[serde(rename = "scanActivity", default, skip_serializing_if = "Option::is_none")]
    pub scan_activity: Option<cluster_scan_runtime_parameters::ScanActivity>,
}
impl ClusterScanRuntimeParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod cluster_scan_runtime_parameters {
    use super::*;
    #[doc = "The choice of if the scan operation should run the scan."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ScanActivity")]
    ...
    impl FromStr for ScanActivity {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for ScanActivity {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for ScanActivity {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Scan => serializer.serialize_unit_variant("ScanActivity", 0u32, "Scan"),
                Self::Skip => serializer.serialize_unit_variant("ScanActivity", 1u32, "Skip"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ClusterSecretArchive {
    #[doc = "The resource ID of the key vault to archive the secrets of the cluster."]
    #[serde(rename = "keyVaultId")]
    pub key_vault_id: String,
    #[doc = "The indicator if the specified key vault should be used to archive the secrets of the cluster."]
    #[serde(rename = "useKeyVault", default, skip_serializing_if = "Option::is_none")]
    pub use_key_vault: Option<cluster_secret_archive::UseKeyVault>,
}
impl ClusterSecretArchive {
    pub fn new(key_vault_id: String) -> Self {
        Self {
            key_vault_id,
            use_key_vault: None,
        }
...
pub mod cluster_secret_archive {
    use super::*;
    #[doc = "The indicator if the specified key vault should be used to archive the secrets of the cluster."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "UseKeyVault")]
    pub enum UseKeyVault {
        True,
        False,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for UseKeyVault {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for UseKeyVault {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for UseKeyVault {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::True => serializer.serialize_unit_variant("UseKeyVault", 0u32, "True"),
                Self::False => serializer.serialize_unit_variant("UseKeyVault", 1u32, "False"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for UseKeyVault {
        fn default() -> Self {
            Self::False
        }
    }
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ClusterUpdateStrategy {
    #[doc = "The maximum number of worker nodes that can be offline within the increment of update, e.g., rack-by-rack.\nLimited by the maximum number of machines in the increment. Defaults to the whole increment size."]
    #[serde(rename = "maxUnavailable", default, skip_serializing_if = "Option::is_none")]
    pub max_unavailable: Option<i64>,
    #[doc = "The mode of operation for runtime protection."]
    #[serde(rename = "strategyType")]
    pub strategy_type: cluster_update_strategy::StrategyType,
    #[doc = "Selection of how the threshold should be evaluated."]
    #[serde(rename = "thresholdType")]
    pub threshold_type: cluster_update_strategy::ThresholdType,
    #[doc = "The numeric threshold value."]
    #[serde(rename = "thresholdValue")]
    pub threshold_value: i64,
    #[doc = "The time to wait between the increments of update defined by the strategy."]
    #[serde(rename = "waitTimeMinutes", default, skip_serializing_if = "Option::is_none")]
    pub wait_time_minutes: Option<i64>,
}
impl ClusterUpdateStrategy {
    pub fn new(
        strategy_type: cluster_update_strategy::StrategyType,
        threshold_type: cluster_update_strategy::ThresholdType,
        threshold_value: i64,
    ) -> Self {
        Self {
...
pub mod cluster_update_strategy {
    use super::*;
    #[doc = "The mode of operation for runtime protection."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "StrategyType")]
    ...
    impl Serialize for StrategyType {
        ...
        {
            match self {
                Self::Rack => serializer.serialize_unit_variant("StrategyType", 0u32, "Rack"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for ThresholdType {
        ...
        {
            match self {
                Self::CountSuccess => serializer.serialize_unit_variant("ThresholdType", 0u32, "CountSuccess"),
                Self::PercentSuccess => serializer.serialize_unit_variant("ThresholdType", 1u32, "PercentSuccess"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct ControlPlaneNodePatchConfiguration {
    #[serde(rename = "administratorConfiguration", default, skip_serializing_if = "Option::is_none")]
    pub administrator_configuration: Option<AdministratorConfigurationPatch>,
    #[doc = "The number of virtual machines that use this configuration."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub count: Option<i64>,
}
...
pub struct KeySetUser {
    ...
    #[serde(rename = "sshPublicKey")]
    pub ssh_public_key: SshPublicKey,
    #[doc = "The user principal name (email format) used to validate this user's group membership."]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NodePoolAdministratorConfigurationPatch {
    #[doc = "SshPublicKey represents the public key used to authenticate with a resource through SSH."]
    #[serde(
        rename = "sshPublicKeys",
        default,
...
impl NodePoolAdministratorConfigurationPatch {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct RuntimeProtectionConfiguration {
    #[doc = "The mode of operation for runtime protection."]
    #[serde(rename = "enforcementLevel", default, skip_serializing_if = "Option::is_none")]
    pub enforcement_level: Option<runtime_protection_configuration::EnforcementLevel>,
}
impl RuntimeProtectionConfiguration {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod runtime_protection_configuration {
    use super::*;
    #[doc = "The mode of operation for runtime protection."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "EnforcementLevel")]
    ...
    impl<'de> Deserialize<'de> for EnforcementLevel {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for EnforcementLevel {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Audit => serializer.serialize_unit_variant("EnforcementLevel", 0u32, "Audit"),
                Self::Disabled => serializer.serialize_unit_variant("EnforcementLevel", 1u32, "Disabled"),
                Self::OnDemand => serializer.serialize_unit_variant("EnforcementLevel", 2u32, "OnDemand"),
                Self::Passive => serializer.serialize_unit_variant("EnforcementLevel", 3u32, "Passive"),
                Self::RealTime => serializer.serialize_unit_variant("EnforcementLevel", 4u32, "RealTime"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct VirtualMachineProperties {
    ...
    #[serde(rename = "availabilityZone", default, skip_serializing_if = "Option::is_none")]
    pub availability_zone: Option<String>,
    #[doc = "The resource ID of the bare metal machine that hosts the virtual machine."]
    #[serde(rename = "bareMetalMachineId", default, skip_serializing_if = "Option::is_none")]
    pub bare_metal_machine_id: Option<String>,
