...
pub mod bare_metal_machine_key_sets {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List bare metal machine key sets of the cluster in the subscription."]
        #[doc = "Get a list of bare metal machine key sets of the cluster in the provided subscription."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `cluster_name`: The name of the cluster."]
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::BareMetalMachineKeySetList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    ...
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
                            "{}/subscriptions/{}/providers/Microsoft.NetworkCloud/clusters/{}/bareMetalMachineKeySets",
                            this.client.endpoint(),
                            &this.subscription_id,
                            &this.cluster_name
                        ))?;
...
pub mod bmc_key_sets {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List baseboard management controller key sets of the cluster in the subscription."]
        #[doc = "Get a list of baseboard management controller key sets of the cluster in the provided subscription."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `cluster_name`: The name of the cluster."]
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::BmcKeySetList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    ...
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
                            "{}/subscriptions/{}/providers/Microsoft.NetworkCloud/clusters/{}/bmcKeySets",
                            this.client.endpoint(),
                            &this.subscription_id,
                            &this.cluster_name
                        ))?;
...
pub mod metrics_configurations {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List metrics configurations of the cluster in the subscription."]
        #[doc = "Get a list of metrics configurations of the cluster in the provided subscription."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `cluster_name`: The name of the cluster."]
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ClusterMetricsConfigurationList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    ...
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
                            "{}/subscriptions/{}/providers/Microsoft.NetworkCloud/clusters/{}/metricsConfigurations",
                            this.client.endpoint(),
                            &this.subscription_id,
                            &this.cluster_name
                        ))?;
...
pub mod consoles {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List virtual machine consoles in the subscription."]
        #[doc = "Get a list of virtual machine consoles in the provided subscription."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `virtual_machine_name`: The name of the virtual machine."]
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ConsoleList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    ...
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
                            "{}/subscriptions/{}/providers/Microsoft.NetworkCloud/virtualMachines/{}/consoles",
                            this.client.endpoint(),
                            &this.subscription_id,
                            &this.virtual_machine_name
                        ))?;
