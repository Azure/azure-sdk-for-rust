...
pub struct AgentPoolUpgradeSettings {
    #[doc = "The maximum time in seconds that is allowed for a node drain to complete before proceeding with the upgrade of the agent pool. If not specified during creation, a value of 1800 seconds is used."]
    #[serde(rename = "drainTimeout", default, skip_serializing_if = "Option::is_none")]
...
pub struct BareMetalMachineProperties {
    ...
    #[serde(rename = "kubernetesVersion", default, skip_serializing_if = "Option::is_none")]
    pub kubernetes_version: Option<String>,
    #[doc = "The cluster version that has been applied to this machine during deployment or a version update."]
    #[serde(rename = "machineClusterVersion", default, skip_serializing_if = "Option::is_none")]
    pub machine_cluster_version: Option<String>,
    ...
    #[doc = "The list of statuses that represent secret rotation activity."]
    #[serde(
        rename = "secretRotationStatus",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub secret_rotation_status: Vec<SecretRotationStatus>,
...
impl BareMetalMachineProperties {
    pub fn new(
        ...
        Self {
            ...
            secret_rotation_status: Vec::new(),
            serial_number,
            service_tag: None,
...
pub struct ClusterCapacity {
    #[doc = "The remaining appliance-based storage in GB available for workload use. Measured in gibibytes."]
    ...
    #[doc = "The remaining machine or host-based storage in GB available for workload use. Measured in gibibytes."]
    #[serde(rename = "availableHostStorageGB", default, skip_serializing_if = "Option::is_none")]
    pub available_host_storage_gb: Option<i64>,
    #[doc = "The remaining memory in GB that are available in this cluster for workload use. Measured in gibibytes."]
    #[serde(rename = "availableMemoryGB", default, skip_serializing_if = "Option::is_none")]
    pub available_memory_gb: Option<i64>,
    #[doc = "The total appliance-based storage in GB supported by this cluster for workload use. Measured in gibibytes."]
    ...
    #[doc = "The total machine or host-based storage in GB supported by this cluster for workload use. Measured in gibibytes."]
    #[serde(rename = "totalHostStorageGB", default, skip_serializing_if = "Option::is_none")]
    pub total_host_storage_gb: Option<i64>,
    #[doc = "The total memory supported by this cluster for workload use. Measured in gibibytes."]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ClusterContinueUpdateVersionParameters {
    #[doc = "The mode by which the cluster will target the next grouping of servers to continue the update."]
    #[serde(rename = "machineGroupTargetingMode", default, skip_serializing_if = "Option::is_none")]
    pub machine_group_targeting_mode: Option<cluster_continue_update_version_parameters::MachineGroupTargetingMode>,
}
impl ClusterContinueUpdateVersionParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod cluster_continue_update_version_parameters {
    use super::*;
    #[doc = "The mode by which the cluster will target the next grouping of servers to continue the update."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "MachineGroupTargetingMode")]
    pub enum MachineGroupTargetingMode {
        AlphaByRack,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for MachineGroupTargetingMode {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for MachineGroupTargetingMode {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for MachineGroupTargetingMode {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::AlphaByRack => serializer.serialize_unit_variant("MachineGroupTargetingMode", 0u32, "AlphaByRack"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for MachineGroupTargetingMode {
        fn default() -> Self {
            Self::AlphaByRack
        }
    }
...
pub struct ClusterPatchProperties {
    ...
    #[serde(rename = "commandOutputSettings", default, skip_serializing_if = "Option::is_none")]
    pub command_output_settings: Option<CommandOutputSettings>,
    ...
    impl Serialize for DetailedStatus {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::UpdatePaused => serializer.serialize_unit_variant("DetailedStatus", 4u32, "UpdatePaused"),
                Self::Degraded => serializer.serialize_unit_variant("DetailedStatus", 5u32, "Degraded"),
                Self::Deleting => serializer.serialize_unit_variant("DetailedStatus", 6u32, "Deleting"),
                Self::Disconnected => serializer.serialize_unit_variant("DetailedStatus", 7u32, "Disconnected"),
                Self::Failed => serializer.serialize_unit_variant("DetailedStatus", 8u32, "Failed"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for StrategyType {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::PauseAfterRack => serializer.serialize_unit_variant("StrategyType", 1u32, "PauseAfterRack"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct CommandOutputSettings {
    #[serde(rename = "associatedIdentity", default, skip_serializing_if = "Option::is_none")]
    pub associated_identity: Option<IdentitySelector>,
    #[doc = "The URL of the storage account container that is to be used by the specified identities."]
    #[serde(rename = "containerUrl", default, skip_serializing_if = "Option::is_none")]
...
pub struct IdentitySelector {
    ...
    pub identity_type: Option<identity_selector::IdentityType>,
...
pub struct IpAddressPool {
    #[doc = "The list of IP address ranges. Each range can be a either a subnet in CIDR format or an explicit start-end range of IP addresses. For a BGP service load balancer configuration, only CIDR format is supported and excludes /32 (IPv4) and /128 (IPv6) prefixes."]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct KubernetesClusterFeature {
    #[serde(flatten)]
    pub tracked_resource: TrackedResource,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<KubernetesClusterFeatureProperties>,
}
impl KubernetesClusterFeature {
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct KubernetesClusterFeatureList {
    #[doc = "The link used to get the next page of operations."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
    #[doc = "The list of Kubernetes cluster features."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<KubernetesClusterFeature>,
}
impl azure_core::Continuable for KubernetesClusterFeatureList {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl KubernetesClusterFeatureList {
    pub fn new() -> Self {
        Self::default()
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct KubernetesClusterFeaturePatchParameters {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<KubernetesClusterFeaturePatchProperties>,
    #[doc = "The Azure resource tags that will replace the existing ones."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<serde_json::Value>,
}
impl KubernetesClusterFeaturePatchParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct KubernetesClusterFeaturePatchProperties {
    #[doc = "The configured options for the feature."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub options: Vec<StringKeyValuePair>,
}
impl KubernetesClusterFeaturePatchProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct KubernetesClusterFeatureProperties {
    #[doc = "The lifecycle indicator of the feature."]
    #[serde(rename = "availabilityLifecycle", default, skip_serializing_if = "Option::is_none")]
    pub availability_lifecycle: Option<kubernetes_cluster_feature_properties::AvailabilityLifecycle>,
    #[doc = "The detailed status of the feature."]
    #[serde(rename = "detailedStatus", default, skip_serializing_if = "Option::is_none")]
    pub detailed_status: Option<kubernetes_cluster_feature_properties::DetailedStatus>,
    #[doc = "The descriptive message for the detailed status of the feature."]
    #[serde(rename = "detailedStatusMessage", default, skip_serializing_if = "Option::is_none")]
    pub detailed_status_message: Option<String>,
    #[doc = "The configured options for the feature."]
    #[serde(
    ...
    pub options: Vec<StringKeyValuePair>,
    #[doc = "The provisioning state of the Kubernetes cluster feature."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<kubernetes_cluster_feature_properties::ProvisioningState>,
    #[doc = "The indicator of if the feature is required or optional. Optional features may be deleted by the user, while required features are managed with the kubernetes cluster lifecycle."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub required: Option<kubernetes_cluster_feature_properties::Required>,
    #[doc = "The version of the feature."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub version: Option<String>,
}
impl KubernetesClusterFeatureProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod kubernetes_cluster_feature_properties {
    use super::*;
    #[doc = "The lifecycle indicator of the feature."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "AvailabilityLifecycle")]
    ...
    impl Serialize for DetailedStatus {
            ...
            S: Serializer,
        {
            match self {
                Self::Error => serializer.serialize_unit_variant("DetailedStatus", 0u32, "Error"),
                Self::Provisioning => serializer.serialize_unit_variant("DetailedStatus", 1u32, "Provisioning"),
                Self::Installed => serializer.serialize_unit_variant("DetailedStatus", 2u32, "Installed"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct KubernetesClusterNode {
    ...
    #[serde(rename = "detailedStatusMessage", default, skip_serializing_if = "Option::is_none")]
    pub detailed_status_message: Option<String>,
    #[doc = "The size of the disk configured for this node. Allocations are measured in gibibytes."]
    ...
    pub labels: Vec<KubernetesLabel>,
    #[doc = "The amount of memory configured for this node, derived from the vm SKU specified. Allocations are measured in gibibytes."]
...
pub struct KubernetesClusterPatchProperties {
    ...
    #[doc = "The Kubernetes version for this cluster."]
    #[serde(rename = "kubernetesVersion", default, skip_serializing_if = "Option::is_none")]
    pub kubernetes_version: Option<String>,
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct L2ServiceLoadBalancerConfiguration {
    #[doc = "The list of pools of IP addresses that can be allocated to load balancer services."]
    #[serde(
        rename = "ipAddressPools",
        default,
...
impl L2ServiceLoadBalancerConfiguration {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct MachineDisk {
    #[doc = "The maximum amount of storage. Measured in gibibytes."]
...
pub struct MachineSkuProperties {
    ...
    #[doc = "The maximum amount of memory. Measured in gibibytes."]
...
pub struct NetworkConfiguration {
    ...
    #[serde(rename = "l2ServiceLoadBalancerConfiguration", default, skip_serializing_if = "Option::is_none")]
    pub l2_service_load_balancer_configuration: Option<L2ServiceLoadBalancerConfiguration>,
...
impl NetworkConfiguration {
    pub fn new(cloud_services_network_id: String, cni_network_id: String) -> Self {
        Self {
            ...
            cni_network_id,
            dns_service_ip: None,
            l2_service_load_balancer_configuration: None,
            pod_cidrs: Vec::new(),
...
pub struct NetworkInterface {
    ...
    #[doc = "The maximum amount of data in gigabits that the line card transmits through a port at any given second."]
...
pub struct OperationStatusResult {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<OperationStatusResultProperties>,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OperationStatusResultProperties {
    #[doc = "For actions that run commands or scripts, the exit code of the script execution."]
    #[serde(rename = "exitCode", default, skip_serializing_if = "Option::is_none")]
    pub exit_code: Option<String>,
    #[doc = "For actions that run commands or scripts, the leading bytes of the output of the script execution."]
    #[serde(rename = "outputHead", default, skip_serializing_if = "Option::is_none")]
    pub output_head: Option<String>,
    #[doc = "For actions that run commands or scripts, a reference to the location of the result."]
    #[serde(rename = "resultRef", default, skip_serializing_if = "Option::is_none")]
    pub result_ref: Option<String>,
    #[doc = "For actions that run commands or scripts, the URL where the full output of the script output can be retrieved."]
    #[serde(rename = "resultUrl", default, skip_serializing_if = "Option::is_none")]
    pub result_url: Option<String>,
}
impl OperationStatusResultProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct OsDisk {
    ...
    #[doc = "The size of the disk. Required if the createOption is Ephemeral. Allocations are measured in gibibytes."]
...
pub struct SecretRotationStatus {
    #[doc = "The maximum number of days the secret may be used before it must be changed."]
    #[serde(rename = "expirePeriodDays", default, skip_serializing_if = "Option::is_none")]
    pub expire_period_days: Option<i64>,
    #[doc = "The date and time when the secret was last changed."]
    #[serde(rename = "lastRotationTime", default, with = "azure_core::date::rfc3339::option")]
    pub last_rotation_time: Option<::time::OffsetDateTime>,
    #[doc = "The number of days a secret exists before rotations will be attempted."]
    #[serde(rename = "rotationPeriodDays", default, skip_serializing_if = "Option::is_none")]
    pub rotation_period_days: Option<i64>,
    #[serde(rename = "secretArchiveReference", default, skip_serializing_if = "Option::is_none")]
    pub secret_archive_reference: Option<SecretArchiveReference>,
    #[doc = "The type name used to identify the purpose of the secret."]
...
pub struct ServiceLoadBalancerBgpPeer {
    ...
    #[doc = "Field Deprecated. The field was previously optional, now it will have no defined behavior and will be ignored. The requested BGP hold time value. This field uses ISO 8601 duration format, for example P1H."]
    #[serde(rename = "holdTime", default, skip_serializing_if = "Option::is_none")]
    pub hold_time: Option<String>,
    #[doc = "Field Deprecated. The field was previously optional, now it will have no defined behavior and will be ignored. The requested BGP keepalive time value. This field uses ISO 8601 duration format, for example P1H."]
...
pub struct StorageApplianceProperties {
    ...
    #[doc = "The manufacturer of the storage appliance."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[doc = "The version of the storage appliance."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub version: Option<String>,
}
...
pub struct StorageApplianceSkuProperties {
    #[doc = "The maximum capacity of the storage appliance. Measured in gibibytes."]
    #[serde(rename = "capacityGB", default, skip_serializing_if = "Option::is_none")]
    pub capacity_gb: Option<i64>,
    #[doc = "The model of the storage appliance."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct StringKeyValuePair {
    #[doc = "The key to the mapped value."]
    pub key: String,
    #[doc = "The value of the mapping key."]
    pub value: String,
}
impl StringKeyValuePair {
    pub fn new(key: String, value: String) -> Self {
        Self { key, value }
    }
}
...
pub struct VirtualMachineProperties {
    ...
    #[doc = "The memory size of the virtual machine. Allocations are measured in gibibytes."]
