...
impl Client {
    ...
    pub fn kubernetes_cluster_features_client(&self) -> kubernetes_cluster_features::Client {
        kubernetes_cluster_features::Client(self.clone())
    }
    pub fn kubernetes_clusters_client(&self) -> kubernetes_clusters::Client {
        kubernetes_clusters::Client(self.clone())
    }
    ...
    pub mod list {
        ...
        impl RequestBuilder {
                        ...
                        let rsp = match continuation {
                            Some(value) => {
                                ...
                                if !has_api_version_already {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair(azure_core::query_param::API_VERSION, "2024-07-01");
                                }
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path("/providers/Microsoft.NetworkCloud/operations");
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/bareMetalMachines/{}",
                    &self.subscription_id, &self.resource_group_name, &self.bare_metal_machine_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::BareMetalMachine>>;
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/cloudServicesNetworks/{}",
                    &self.subscription_id, &self.resource_group_name, &self.cloud_services_network_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::CloudServicesNetwork>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/clusterManagers/{}",
                    &self.subscription_id, &self.resource_group_name, &self.cluster_manager_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ClusterManager>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod clusters {
    ...
    impl Client {
        ...
        #[doc = "Continue a paused update to the cluster version."]
        #[doc = "Trigger the continuation of an update for a cluster with a matching update strategy that has paused after completing a segment of the update."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `cluster_name`: The name of the cluster."]
        #[doc = "* `cluster_continue_update_version_parameters`: The request body."]
        pub fn continue_update_version(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            cluster_name: impl Into<String>,
            cluster_continue_update_version_parameters: impl Into<models::ClusterContinueUpdateVersionParameters>,
        ) -> continue_update_version::RequestBuilder {
            continue_update_version::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
                cluster_name: cluster_name.into(),
                cluster_continue_update_version_parameters: cluster_continue_update_version_parameters.into(),
            }
        }
        #[doc = "Deploy the cluster."]
        #[doc = "Deploy the cluster using the rack configuration provided during creation."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Execute a runtime protection scan on the cluster."]
        #[doc = "Triggers the execution of a runtime protection scan to detect and remediate detected issues, in accordance with the cluster configuration."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        pub fn scan_runtime(
            ...
            resource_group_name: impl Into<String>,
            cluster_name: impl Into<String>,
        ) -> scan_runtime::RequestBuilder {
            scan_runtime::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
                cluster_name: cluster_name.into(),
                cluster_scan_runtime_parameters: None,
            }
        }
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/clusters/{}",
                    &self.subscription_id, &self.resource_group_name, &self.cluster_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
    ...
    pub mod continue_update_version {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) cluster_name: String,
            pub(crate) cluster_continue_update_version_parameters: models::ClusterContinueUpdateVersionParameters,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.cluster_continue_update_version_parameters)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/clusters/{}/continueUpdateVersion",
                    &self.subscription_id, &self.resource_group_name, &self.cluster_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod scan_runtime {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) cluster_name: String,
            pub(crate) cluster_scan_runtime_parameters: Option<models::ClusterScanRuntimeParameters>,
        }
        impl RequestBuilder {
            #[doc = "The request body."]
            pub fn cluster_scan_runtime_parameters(
                mut self,
                cluster_scan_runtime_parameters: impl Into<models::ClusterScanRuntimeParameters>,
            ) -> Self {
                self.cluster_scan_runtime_parameters = Some(cluster_scan_runtime_parameters.into());
                self
            }
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        let bearer_token = this.client.bearer_token().await?;
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        let req_body = if let Some(cluster_scan_runtime_parameters) = &this.cluster_scan_runtime_parameters {
                            req.insert_header("content-type", "application/json");
                            azure_core::to_json(cluster_scan_runtime_parameters)?
                        } else {
                            azure_core::EMPTY_BODY
                        };
                        req.set_body(req_body);
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/clusters/{}/scanRuntime",
                    &self.subscription_id, &self.resource_group_name, &self.cluster_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
...
pub mod kubernetes_clusters {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List Kubernetes clusters in the subscription."]
        #[doc = "Get a list of Kubernetes clusters in the provided subscription."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        pub fn list_by_subscription(&self, subscription_id: impl Into<String>) -> list_by_subscription::RequestBuilder {
        ...
        #[doc = "List Kubernetes clusters in the resource group."]
        #[doc = "Get a list of Kubernetes clusters in the provided resource group."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Retrieve the Kubernetes cluster."]
        #[doc = "Get properties of the provided the Kubernetes cluster."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `kubernetes_cluster_name`: The name of the Kubernetes cluster."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            kubernetes_cluster_name: impl Into<String>,
        ) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
                kubernetes_cluster_name: kubernetes_cluster_name.into(),
            }
        }
        #[doc = "Create or update the Kubernetes cluster."]
        #[doc = "Create a new Kubernetes cluster or update the properties of the existing one."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `kubernetes_cluster_name`: The name of the Kubernetes cluster."]
        #[doc = "* `kubernetes_cluster_parameters`: The request body."]
        pub fn create_or_update(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            kubernetes_cluster_name: impl Into<String>,
            kubernetes_cluster_parameters: impl Into<models::KubernetesCluster>,
        ) -> create_or_update::RequestBuilder {
            create_or_update::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
                kubernetes_cluster_name: kubernetes_cluster_name.into(),
                kubernetes_cluster_parameters: kubernetes_cluster_parameters.into(),
            }
        }
        #[doc = "Patch the Kubernetes cluster."]
        #[doc = "Patch the properties of the provided Kubernetes cluster, or update the tags associated with the Kubernetes cluster. Properties and tag updates can be done independently."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        pub fn update(
            ...
            update::RequestBuilder {
                ...
                resource_group_name: resource_group_name.into(),
                kubernetes_cluster_name: kubernetes_cluster_name.into(),
                kubernetes_cluster_update_parameters: None,
            }
        }
        #[doc = "Delete the Kubernetes cluster."]
        #[doc = "Delete the provided Kubernetes cluster."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Restart a targeted node of a Kubernetes cluster."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `kubernetes_cluster_name`: The name of the Kubernetes cluster."]
        #[doc = "* `kubernetes_cluster_restart_node_parameters`: The request body."]
        pub fn restart_node(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            kubernetes_cluster_name: impl Into<String>,
            kubernetes_cluster_restart_node_parameters: impl Into<models::KubernetesClusterRestartNodeParameters>,
            ...
            restart_node::RequestBuilder {
                ...
                resource_group_name: resource_group_name.into(),
                kubernetes_cluster_name: kubernetes_cluster_name.into(),
                kubernetes_cluster_restart_node_parameters: kubernetes_cluster_restart_node_parameters.into(),
            }
        }
    }
    pub mod list_by_subscription {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::KubernetesClusterList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::KubernetesClusterList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::KubernetesClusterList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.NetworkCloud/kubernetesClusters",
                    &self.subscription_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod list_by_resource_group {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/kubernetesClusters",
                    &self.subscription_id, &self.resource_group_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::KubernetesCluster> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::KubernetesCluster = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) subscription_id: String,
            pub(crate) resource_group_name: String,
            pub(crate) kubernetes_cluster_name: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/kubernetesClusters/{}",
                    &self.subscription_id, &self.resource_group_name, &self.kubernetes_cluster_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::KubernetesCluster>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::KubernetesCluster>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) kubernetes_cluster_name: String,
            pub(crate) kubernetes_cluster_parameters: models::KubernetesCluster,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.kubernetes_cluster_parameters)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
    ...
    pub mod update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) kubernetes_cluster_name: String,
            pub(crate) kubernetes_cluster_update_parameters: Option<models::KubernetesClusterPatchParameters>,
        }
        impl RequestBuilder {
            #[doc = "The request body."]
            pub fn kubernetes_cluster_update_parameters(
                mut self,
                kubernetes_cluster_update_parameters: impl Into<models::KubernetesClusterPatchParameters>,
            ) -> Self {
                self.kubernetes_cluster_update_parameters = Some(kubernetes_cluster_update_parameters.into());
                self
            }
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        let bearer_token = this.client.bearer_token().await?;
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        let req_body = if let Some(kubernetes_cluster_update_parameters) = &this.kubernetes_cluster_update_parameters {
                            req.insert_header("content-type", "application/json");
                            azure_core::to_json(kubernetes_cluster_update_parameters)?
                        } else {
                            azure_core::EMPTY_BODY
                        };
                        req.set_body(req_body);
    ...
    pub mod restart_node {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) kubernetes_cluster_name: String,
            pub(crate) kubernetes_cluster_restart_node_parameters: models::KubernetesClusterRestartNodeParameters,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.kubernetes_cluster_restart_node_parameters)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/kubernetesClusters/{}/restartNode",
                    &self.subscription_id, &self.resource_group_name, &self.kubernetes_cluster_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/l2Networks/{}",
                    &self.subscription_id, &self.resource_group_name, &self.l2_network_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::L2Network>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/l3Networks/{}",
                    &self.subscription_id, &self.resource_group_name, &self.l3_network_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::L3Network>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.NetworkCloud/rackSkus/{}",
                    &self.subscription_id, &self.rack_sku_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::RackSku>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/racks/{}",
                    &self.subscription_id, &self.resource_group_name, &self.rack_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::Rack>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod storage_appliances {
    ...
    impl Client {
        ...
        #[doc = "Update properties of the provided storage appliance, or update tags associated with the storage appliance Properties and tag updates can be done independently."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/storageAppliances/{}",
                    &self.subscription_id, &self.resource_group_name, &self.storage_appliance_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::StorageAppliance>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod disable_remote_vendor_management {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/storageAppliances/{}/disableRemoteVendorManagement" , & self . subscription_id , & self . resource_group_name , & self . storage_appliance_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-07-01");
    ...
    pub mod enable_remote_vendor_management {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/storageAppliances/{}/enableRemoteVendorManagement" , & self . subscription_id , & self . resource_group_name , & self . storage_appliance_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-07-01");
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/trunkedNetworks/{}",
                    &self.subscription_id, &self.resource_group_name, &self.trunked_network_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::TrunkedNetwork>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/virtualMachines/{}",
                    &self.subscription_id, &self.resource_group_name, &self.virtual_machine_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/volumes/{}",
                    &self.subscription_id, &self.resource_group_name, &self.volume_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
...
pub mod bare_metal_machine_key_sets {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List bare metal machine key sets of the cluster."]
        #[doc = "Get a list of bare metal machine key sets for the provided cluster."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/clusters/{}/bareMetalMachineKeySets/{}",
                    &self.subscription_id, &self.resource_group_name, &self.cluster_name, &self.bare_metal_machine_key_set_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::BareMetalMachineKeySet>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod bmc_key_sets {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List baseboard management controller key sets of the cluster."]
        #[doc = "Get a list of baseboard management controller key sets for the provided cluster."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/clusters/{}/bmcKeySets/{}",
                    &self.subscription_id, &self.resource_group_name, &self.cluster_name, &self.bmc_key_set_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::BmcKeySet>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod metrics_configurations {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List metrics configurations of the cluster."]
        #[doc = "Get a list of metrics configurations for the provided cluster."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Create or update metrics configuration of the cluster."]
        #[doc = "Create new or update the existing metrics configuration of the provided cluster."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/clusters/{}/metricsConfigurations/{}",
                    &self.subscription_id, &self.resource_group_name, &self.cluster_name, &self.metrics_configuration_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ClusterMetricsConfiguration>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod agent_pools {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List agent pools of the Kubernetes cluster."]
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `kubernetes_cluster_name`: The name of the Kubernetes cluster."]
        pub fn list_by_kubernetes_cluster(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            kubernetes_cluster_name: impl Into<String>,
        ) -> list_by_kubernetes_cluster::RequestBuilder {
            list_by_kubernetes_cluster::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        #[doc = "Retrieve the Kubernetes cluster agent pool."]
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `kubernetes_cluster_name`: The name of the Kubernetes cluster."]
        #[doc = "* `agent_pool_name`: The name of the Kubernetes cluster agent pool."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "Create or update the Kubernetes cluster agent pool."]
        ...
        #[doc = "* `kubernetes_cluster_name`: The name of the Kubernetes cluster."]
        #[doc = "* `agent_pool_name`: The name of the Kubernetes cluster agent pool."]
        #[doc = "* `agent_pool_parameters`: The request body."]
        pub fn create_or_update(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            kubernetes_cluster_name: impl Into<String>,
            agent_pool_name: impl Into<String>,
            agent_pool_parameters: impl Into<models::AgentPool>,
        ) -> create_or_update::RequestBuilder {
            create_or_update::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                ...
                kubernetes_cluster_name: kubernetes_cluster_name.into(),
                agent_pool_name: agent_pool_name.into(),
                agent_pool_parameters: agent_pool_parameters.into(),
            }
        }
        #[doc = "Patch the Kubernetes cluster agent pool."]
        ...
        pub fn update(
            ...
            update::RequestBuilder {
                ...
                kubernetes_cluster_name: kubernetes_cluster_name.into(),
                agent_pool_name: agent_pool_name.into(),
                agent_pool_update_parameters: None,
            }
        }
        #[doc = "Delete the Kubernetes cluster agent pool."]
    ...
    pub mod list_by_kubernetes_cluster {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AgentPoolList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AgentPoolList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::AgentPoolList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/kubernetesClusters/{}/agentPools",
                    &self.subscription_id, &self.resource_group_name, &self.kubernetes_cluster_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/kubernetesClusters/{}/agentPools/{}",
                    &self.subscription_id, &self.resource_group_name, &self.kubernetes_cluster_name, &self.agent_pool_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AgentPool>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::AgentPool>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) kubernetes_cluster_name: String,
            pub(crate) agent_pool_name: String,
            pub(crate) agent_pool_parameters: models::AgentPool,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.agent_pool_parameters)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
    ...
    pub mod update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) kubernetes_cluster_name: String,
            pub(crate) agent_pool_name: String,
            pub(crate) agent_pool_update_parameters: Option<models::AgentPoolPatchParameters>,
        }
        impl RequestBuilder {
            #[doc = "The request body."]
            pub fn agent_pool_update_parameters(
                mut self,
                agent_pool_update_parameters: impl Into<models::AgentPoolPatchParameters>,
            ) -> Self {
                self.agent_pool_update_parameters = Some(agent_pool_update_parameters.into());
                self
            }
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        let bearer_token = this.client.bearer_token().await?;
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        let req_body = if let Some(agent_pool_update_parameters) = &this.agent_pool_update_parameters {
                            req.insert_header("content-type", "application/json");
                            azure_core::to_json(agent_pool_update_parameters)?
                        } else {
                            azure_core::EMPTY_BODY
                        };
                        req.set_body(req_body);
...
pub mod kubernetes_cluster_features {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List features for the Kubernetes cluster."]
        #[doc = "Get a list of features for the provided Kubernetes cluster."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Retrieve the Kubernetes cluster feature."]
        #[doc = "Get properties of the provided the Kubernetes cluster feature."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Create or update the Kubernetes cluster feature."]
        #[doc = "Create a new Kubernetes cluster feature or update properties of the Kubernetes cluster feature if it exists."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `kubernetes_cluster_name`: The name of the Kubernetes cluster."]
        #[doc = "* `feature_name`: The name of the feature."]
        #[doc = "* `kubernetes_cluster_feature_parameters`: The request body."]
        pub fn create_or_update(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            kubernetes_cluster_name: impl Into<String>,
            feature_name: impl Into<String>,
            kubernetes_cluster_feature_parameters: impl Into<models::KubernetesClusterFeature>,
        ) -> create_or_update::RequestBuilder {
            create_or_update::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                ...
                kubernetes_cluster_name: kubernetes_cluster_name.into(),
                feature_name: feature_name.into(),
                kubernetes_cluster_feature_parameters: kubernetes_cluster_feature_parameters.into(),
            }
        }
        #[doc = "Patch the Kubernetes cluster feature."]
        #[doc = "Patch properties of the provided Kubernetes cluster feature."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        pub fn update(
            ...
            update::RequestBuilder {
                ...
                kubernetes_cluster_name: kubernetes_cluster_name.into(),
                feature_name: feature_name.into(),
                kubernetes_cluster_feature_update_parameters: None,
            }
        }
        #[doc = "Delete the Kubernetes cluster feature."]
        #[doc = "Delete the provided Kubernetes cluster feature."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod list_by_kubernetes_cluster {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::KubernetesClusterFeatureList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::KubernetesClusterFeatureList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::KubernetesClusterFeatureList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/kubernetesClusters/{}/features",
                    &self.subscription_id, &self.resource_group_name, &self.kubernetes_cluster_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::KubernetesClusterFeature> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::KubernetesClusterFeature = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/kubernetesClusters/{}/features/{}",
                    &self.subscription_id, &self.resource_group_name, &self.kubernetes_cluster_name, &self.feature_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::KubernetesClusterFeature>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::KubernetesClusterFeature>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) kubernetes_cluster_name: String,
            pub(crate) feature_name: String,
            pub(crate) kubernetes_cluster_feature_parameters: models::KubernetesClusterFeature,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.kubernetes_cluster_feature_parameters)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
    ...
    pub mod update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) kubernetes_cluster_name: String,
            pub(crate) feature_name: String,
            pub(crate) kubernetes_cluster_feature_update_parameters: Option<models::KubernetesClusterFeaturePatchParameters>,
        }
        impl RequestBuilder {
            #[doc = "The request body."]
            pub fn kubernetes_cluster_feature_update_parameters(
                mut self,
                kubernetes_cluster_feature_update_parameters: impl Into<models::KubernetesClusterFeaturePatchParameters>,
            ) -> Self {
                self.kubernetes_cluster_feature_update_parameters = Some(kubernetes_cluster_feature_update_parameters.into());
                self
            }
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        let bearer_token = this.client.bearer_token().await?;
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        let req_body = if let Some(kubernetes_cluster_feature_update_parameters) =
                            &this.kubernetes_cluster_feature_update_parameters
                        {
                            req.insert_header("content-type", "application/json");
                            azure_core::to_json(kubernetes_cluster_feature_update_parameters)?
                        } else {
                            azure_core::EMPTY_BODY
                        };
                        req.set_body(req_body);
...
pub mod consoles {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List consoles of the virtual machine."]
        #[doc = "Get a list of consoles for the provided virtual machine."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        pub fn list_by_virtual_machine(
            ...
            resource_group_name: impl Into<String>,
            virtual_machine_name: impl Into<String>,
        ) -> list_by_virtual_machine::RequestBuilder {
            list_by_virtual_machine::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetworkCloud/virtualMachines/{}/consoles/{}",
                    &self.subscription_id, &self.resource_group_name, &self.virtual_machine_name, &self.console_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::Console>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
