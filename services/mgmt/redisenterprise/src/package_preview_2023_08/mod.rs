...
pub mod redis_enterprise {
    ...
    impl Client {
        ...
        #[doc = "Checks that the Redis Enterprise cache name is valid and is not already in use."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `parameters`: Parameters supplied to the CheckNameAvailability Redis operation. The only supported resource type is 'Microsoft.Cache/redisenterprise'"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
