...
pub mod redis_enterprise {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets information about a Redis Enterprise cluster"]
        #[doc = ""]
        #[doc = "Arguments:"]
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `cluster_name`: The name of the Redis Enterprise cluster."]
        #[doc = "* `parameters`: Parameters supplied to the Create Redis Enterprise operation."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        pub fn create(
            &self,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "Updates an existing Redis Enterprise cluster"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `cluster_name`: The name of the Redis Enterprise cluster."]
        #[doc = "* `parameters`: Parameters supplied to the Update Redis Enterprise operation."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        pub fn update(
            &self,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "Deletes a Redis Enterprise cache cluster."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `cluster_name`: The name of the Redis Enterprise cluster."]
        ...
        #[doc = "Lists all Redis Enterprise clusters in a resource group."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        ...
        #[doc = "Lists all Redis Enterprise clusters in the specified subscription."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
...
pub mod databases {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets all databases in the specified Redis Enterprise cluster."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Gets information about a database in a Redis Enterprise cluster."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `cluster_name`: The name of the Redis Enterprise cluster."]
        ...
        #[doc = "Retrieves the access keys for the Redis Enterprise database."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `cluster_name`: The name of the Redis Enterprise cluster."]
        ...
        #[doc = "Regenerates the Redis Enterprise database's access keys."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `cluster_name`: The name of the Redis Enterprise cluster."]
...
pub mod access_policy_assignment {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets information about access policy assignment for database."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `cluster_name`: The name of the Redis Enterprise cluster."]
        #[doc = "* `database_name`: The name of the Redis Enterprise database."]
        #[doc = "* `access_policy_assignment_name`: The name of the Redis Enterprise database access policy assignment."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "Creates/Updates a particular access policy assignment for a database"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "* `database_name`: The name of the Redis Enterprise database."]
        #[doc = "* `access_policy_assignment_name`: The name of the Redis Enterprise database access policy assignment."]
        #[doc = "* `parameters`: Parameters supplied to the create access policy assignment for database."]
        pub fn create_update(
            ...
            database_name: impl Into<String>,
            access_policy_assignment_name: impl Into<String>,
            parameters: impl Into<models::AccessPolicyAssignment>,
        ...
        #[doc = "Deletes a single access policy assignment."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Gets all access policy assignments.."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AccessPolicyAssignment> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AccessPolicyAssignment = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Cache/redisEnterprise/{}/databases/{}/accessPolicyAssignments/{}" , & self . subscription_id , & self . resource_group_name , & self . cluster_name , & self . database_name , & self . access_policy_assignment_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-09-01-preview");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AccessPolicyAssignment>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::AccessPolicyAssignment>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) database_name: String,
            pub(crate) access_policy_assignment_name: String,
            pub(crate) parameters: models::AccessPolicyAssignment,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AccessPolicyAssignmentList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AccessPolicyAssignmentList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::AccessPolicyAssignmentList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Cache/redisEnterprise/{}/databases/{}/accessPolicyAssignments",
                    &self.subscription_id, &self.resource_group_name, &self.cluster_name, &self.database_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
...
pub mod private_endpoint_connections {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Lists all the private endpoint connections associated with the Redis Enterprise cluster."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `cluster_name`: The name of the Redis Enterprise cluster."]
        ...
        #[doc = "Gets the specified private endpoint connection associated with the Redis Enterprise cluster."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `cluster_name`: The name of the Redis Enterprise cluster."]
        ...
        #[doc = "Updates the state of the specified private endpoint connection associated with the Redis Enterprise cluster."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `cluster_name`: The name of the Redis Enterprise cluster."]
        ...
        #[doc = "Deletes the specified private endpoint connection associated with the Redis Enterprise cluster."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `cluster_name`: The name of the Redis Enterprise cluster."]
...
pub mod private_link_resources {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets the private link resources that need to be created for a Redis Enterprise cluster."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `cluster_name`: The name of the Redis Enterprise cluster."]
