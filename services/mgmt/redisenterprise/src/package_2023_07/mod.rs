    ...
    pub mod list {
        ...
        impl RequestBuilder {
                        ...
                        let rsp = match continuation {
                            Some(value) => {
                                ...
                                if !has_api_version_already {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair(azure_core::query_param::API_VERSION, "2023-07-01");
                                }
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/providers/Microsoft.Cache/operations", self.client.endpoint(),))?;
...
pub mod databases {
    ...
    impl Client {
        ...
        #[doc = "* `cluster_name`: The name of the RedisEnterprise cluster."]
        #[doc = "* `database_name`: The name of the database."]
        #[doc = "* `parameters`: Information identifying the databases to be flushed"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        pub fn flush(
            &self,
            resource_group_name: impl Into<String>,
            cluster_name: impl Into<String>,
            database_name: impl Into<String>,
            parameters: impl Into<models::FlushParameters>,
            subscription_id: impl Into<String>,
    ...
    pub mod list_by_cluster {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DatabaseList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DatabaseList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::DatabaseList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod flush {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) cluster_name: String,
            pub(crate) database_name: String,
            pub(crate) parameters: models::FlushParameters,
            pub(crate) subscription_id: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Cache/redisEnterprise/{}/databases/{}/flush",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.resource_group_name,
                    &self.cluster_name,
