...
impl Serialize for SkuName {
    ...
    {
        match self {
            Self::EnterpriseE5 => serializer.serialize_unit_variant("SkuName", 0u32, "Enterprise_E5"),
            Self::EnterpriseE10 => serializer.serialize_unit_variant("SkuName", 1u32, "Enterprise_E10"),
            Self::EnterpriseE20 => serializer.serialize_unit_variant("SkuName", 2u32, "Enterprise_E20"),
            Self::EnterpriseE50 => serializer.serialize_unit_variant("SkuName", 3u32, "Enterprise_E50"),
            Self::EnterpriseE100 => serializer.serialize_unit_variant("SkuName", 4u32, "Enterprise_E100"),
            Self::EnterpriseE200 => serializer.serialize_unit_variant("SkuName", 5u32, "Enterprise_E200"),
            Self::EnterpriseE400 => serializer.serialize_unit_variant("SkuName", 6u32, "Enterprise_E400"),
            Self::EnterpriseFlashF300 => serializer.serialize_unit_variant("SkuName", 7u32, "EnterpriseFlash_F300"),
            Self::EnterpriseFlashF700 => serializer.serialize_unit_variant("SkuName", 8u32, "EnterpriseFlash_F700"),
            Self::EnterpriseFlashF1500 => serializer.serialize_unit_variant("SkuName", 9u32, "EnterpriseFlash_F1500"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
