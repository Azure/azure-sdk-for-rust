...
pub mod redis_enterprise {
    ...
    impl Client {
        ...
        #[doc = "* `cluster_name`: The name of the Redis Enterprise cluster."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        pub fn get(
            &self,
...
pub mod databases {
    ...
    impl Client {
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `cluster_name`: The name of the Redis Enterprise cluster."]
        #[doc = "* `database_name`: The name of the Redis Enterprise database."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        pub fn get(
            &self,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "Forcibly recreates an existing database on the specified cluster, and rejoins it to an existing replication group. **IMPORTANT NOTE:** All data in this database will be discarded, and the database will temporarily be unavailable while rejoining the replication group."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `cluster_name`: The name of the Redis Enterprise cluster."]
        ...
        pub fn force_link_to_replication_group(
            &self,
            resource_group_name: impl Into<String>,
            cluster_name: impl Into<String>,
            database_name: impl Into<String>,
            parameters: impl Into<models::ForceLinkParameters>,
            subscription_id: impl Into<String>,
        ) -> force_link_to_replication_group::RequestBuilder {
            force_link_to_replication_group::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                cluster_name: cluster_name.into(),
        ...
        #[doc = "Upgrades the database Redis version to the latest available."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `cluster_name`: The name of the Redis Enterprise cluster."]
        #[doc = "* `database_name`: The name of the Redis Enterprise database."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        pub fn upgrade_db_redis_version(
            &self,
            resource_group_name: impl Into<String>,
            cluster_name: impl Into<String>,
            database_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ) -> upgrade_db_redis_version::RequestBuilder {
            upgrade_db_redis_version::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                cluster_name: cluster_name.into(),
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Cache/redisEnterprise/{}/databases/{}",
                    &self.subscription_id, &self.resource_group_name, &self.cluster_name, &self.database_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
    ...
    pub mod force_link_to_replication_group {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        impl<'a> Headers<'a> {
            ...
            #[doc = "Azure-AsyncOperation URI to poll for result"]
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) cluster_name: String,
            pub(crate) database_name: String,
            pub(crate) parameters: models::ForceLinkParameters,
            pub(crate) subscription_id: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Cache/redisEnterprise/{}/databases/{}/forceLinkToReplicationGroup" , & self . subscription_id , & self . resource_group_name , & self . cluster_name , & self . database_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-06-01-preview");
    ...
    pub mod upgrade_db_redis_version {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Cache/redisEnterprise/{}/databases/{}/upgradeDBRedisVersion",
                    &self.subscription_id, &self.resource_group_name, &self.cluster_name, &self.database_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Cache/redisEnterprise/{}/privateEndpointConnections/{}",
                    &self.subscription_id, &self.resource_group_name, &self.cluster_name, &self.private_endpoint_connection_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
