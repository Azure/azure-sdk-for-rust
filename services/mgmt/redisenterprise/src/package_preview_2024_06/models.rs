    ...
    impl Serialize for Name {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::EnterpriseFlashF300 => serializer.serialize_unit_variant("Name", 6u32, "EnterpriseFlash_F300"),
                Self::EnterpriseFlashF700 => serializer.serialize_unit_variant("Name", 7u32, "EnterpriseFlash_F700"),
                Self::EnterpriseFlashF1500 => serializer.serialize_unit_variant("Name", 8u32, "EnterpriseFlash_F1500"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
