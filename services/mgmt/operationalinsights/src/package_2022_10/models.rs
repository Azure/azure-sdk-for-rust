...
pub struct RestoredLogs {
    ...
    #[serde(rename = "azureAsyncOperationId", default, skip_serializing_if = "Option::is_none")]
    pub azure_async_operation_id: Option<String>,
}
impl RestoredLogs {
    pub fn new() -> Self {
        Self::default()
...
pub struct ResultStatistics {
    ...
    #[serde(rename = "scannedGb", default, skip_serializing_if = "Option::is_none")]
    pub scanned_gb: Option<f64>,
}
...
pub struct TableProperties {
    ...
    #[serde(rename = "retentionInDaysAsDefault", default, skip_serializing_if = "Option::is_none")]
    pub retention_in_days_as_default: Option<table_properties::RetentionInDaysAsDefault>,
    #[doc = "True - Value originates from retention in days, False - Customer specific."]
    #[serde(rename = "totalRetentionInDaysAsDefault", default, skip_serializing_if = "Option::is_none")]
    pub total_retention_in_days_as_default: Option<table_properties::TotalRetentionInDaysAsDefault>,
}
...
pub mod table_properties {
    ...
    #[doc = "True - Value originates from workspace retention in days, False - Customer specific."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "RetentionInDaysAsDefault")]
    pub enum RetentionInDaysAsDefault {
        True,
        False,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for RetentionInDaysAsDefault {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for RetentionInDaysAsDefault {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for RetentionInDaysAsDefault {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::True => serializer.serialize_unit_variant("RetentionInDaysAsDefault", 0u32, "True"),
                Self::False => serializer.serialize_unit_variant("RetentionInDaysAsDefault", 1u32, "False"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for RetentionInDaysAsDefault {
        fn default() -> Self {
            Self::True
        }
    }
    #[doc = "True - Value originates from retention in days, False - Customer specific."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "TotalRetentionInDaysAsDefault")]
    pub enum TotalRetentionInDaysAsDefault {
        True,
        False,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for TotalRetentionInDaysAsDefault {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for TotalRetentionInDaysAsDefault {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for TotalRetentionInDaysAsDefault {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::True => serializer.serialize_unit_variant("TotalRetentionInDaysAsDefault", 0u32, "True"),
                Self::False => serializer.serialize_unit_variant("TotalRetentionInDaysAsDefault", 1u32, "False"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for TotalRetentionInDaysAsDefault {
        fn default() -> Self {
            Self::True
        }
    }
