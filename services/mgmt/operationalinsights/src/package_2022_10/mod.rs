...
impl Client {
    ...
    pub fn query_packs_client(&self) -> query_packs::Client {
...
pub mod query_packs {
    ...
    impl Client {
        ...
        #[doc = "Creates a Log Analytics QueryPack. Note: You cannot specify a different value for InstrumentationKey nor AppId in the Put operation."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `log_analytics_query_pack_payload`: Properties that need to be specified to create or update a Log Analytics QueryPack."]
        pub fn create_or_update_without_name(
            &self,
            resource_group_name: impl Into<String>,
            subscription_id: impl Into<String>,
            log_analytics_query_pack_payload: impl Into<models::LogAnalyticsQueryPack>,
        ) -> create_or_update_without_name::RequestBuilder {
            create_or_update_without_name::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                subscription_id: subscription_id.into(),
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `query_pack_name`: The name of the Log Analytics QueryPack resource."]
        pub fn get(
            &self,
            resource_group_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ...
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `query_pack_name`: The name of the Log Analytics QueryPack resource."]
        #[doc = "* `query_pack_tags`: Updated tag information to set into the QueryPack instance."]
        pub fn update_tags(
            &self,
            resource_group_name: impl Into<String>,
            subscription_id: impl Into<String>,
    ...
    pub mod list {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::LogAnalyticsQueryPackListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::LogAnalyticsQueryPackListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::LogAnalyticsQueryPackListResult, azure_core::error::Error> {
    ...
    pub mod create_or_update_without_name {
        use super::models;
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::LogAnalyticsQueryPack> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::LogAnalyticsQueryPack = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        let req_body = azure_core::to_json(&this.log_analytics_query_pack_payload)?;
                        req.set_body(req_body);
            ...
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::LogAnalyticsQueryPack>> {
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2019-09-01");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.query_pack_tags)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
...
pub mod queries {
    ...
    impl Client {
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `query_pack_name`: The name of the Log Analytics QueryPack resource."]
        #[doc = "* `query_search_properties`: Properties by which to search queries in the given Log Analytics QueryPack."]
        pub fn search(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `query_pack_name`: The name of the Log Analytics QueryPack resource."]
        #[doc = "* `id`: The id of a specific query defined in the Log Analytics QueryPack"]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "* `query_pack_name`: The name of the Log Analytics QueryPack resource."]
        #[doc = "* `id`: The id of a specific query defined in the Log Analytics QueryPack"]
        #[doc = "* `query_payload`: Properties that need to be specified to create a new query and add it to a Log Analytics QueryPack."]
        pub fn put(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::LogAnalyticsQueryPackQueryListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::LogAnalyticsQueryPackQueryListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::LogAnalyticsQueryPackQueryListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
                        ...
                        let rsp = match continuation {
                            ...
                            None => {
                                ...
                                if let Some(include_body) = &this.include_body {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair("includeBody", &include_body.to_string());
                                }
                    ...
                    async move {
                        ...
                        let rsp = match continuation {
                            ...
                            None => {
                                ...
                                req.insert_header("content-type", "application/json");
                                let req_body = azure_core::to_json(&this.query_search_properties)?;
                                req.set_body(req_body);
                                this.client.send(&mut req).await?
                            }
                        };
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::LogAnalyticsQueryPackQuery> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::LogAnalyticsQueryPackQuery = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::LogAnalyticsQueryPackQuery>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2019-09-01");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.query_payload)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
...
pub mod tables {
    ...
    impl Client {
        ...
        #[doc = "Cancel a log analytics workspace search results table query run."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.OperationalInsights/workspaces/{}/tables/{}/cancelSearch" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . workspace_name , & this . table_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Post);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
