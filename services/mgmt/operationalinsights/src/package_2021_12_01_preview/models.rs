...
pub mod column {
    ...
    impl Serialize for Type {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Dynamic => serializer.serialize_unit_variant("Type", 7u32, "dynamic"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl<'de> Deserialize<'de> for DataTypeHint {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for DataTypeHint {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Uri => serializer.serialize_unit_variant("DataTypeHint", 0u32, "uri"),
                Self::Guid => serializer.serialize_unit_variant("DataTypeHint", 1u32, "guid"),
                Self::ArmPath => serializer.serialize_unit_variant("DataTypeHint", 2u32, "armPath"),
                Self::Ip => serializer.serialize_unit_variant("DataTypeHint", 3u32, "ip"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub mod schema {
    ...
    impl Serialize for Source {
        ...
        {
            match self {
                Self::Microsoft => serializer.serialize_unit_variant("Source", 0u32, "microsoft"),
                Self::Customer => serializer.serialize_unit_variant("Source", 1u32, "customer"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for TableType {
        ...
        {
            match self {
                Self::Microsoft => serializer.serialize_unit_variant("TableType", 0u32, "Microsoft"),
                Self::CustomLog => serializer.serialize_unit_variant("TableType", 1u32, "CustomLog"),
                Self::RestoredLogs => serializer.serialize_unit_variant("TableType", 2u32, "RestoredLogs"),
                Self::SearchResults => serializer.serialize_unit_variant("TableType", 3u32, "SearchResults"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl FromStr for TableSubType {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for TableSubType {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for TableSubType {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Any => serializer.serialize_unit_variant("TableSubType", 0u32, "Any"),
                Self::Classic => serializer.serialize_unit_variant("TableSubType", 1u32, "Classic"),
                Self::DataCollectionRuleBased => serializer.serialize_unit_variant("TableSubType", 2u32, "DataCollectionRuleBased"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub mod table_properties {
    ...
    impl Serialize for Plan {
        ...
        {
            match self {
                Self::Basic => serializer.serialize_unit_variant("Plan", 0u32, "Basic"),
                Self::Analytics => serializer.serialize_unit_variant("Plan", 1u32, "Analytics"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct WorkspaceSku {
    ...
    #[serde(
        rename = "capacityReservationLevel",
        default,
        skip_serializing_if = "Option::is_none",
        with = "azure_core::xml::text_content"
    )]
