...
impl Client {
    ...
    pub fn data_export(&self) -> data_export::Client {
        data_export::Client(self.clone())
    }
...
pub enum Error {
    ...
    #[error(transparent)]
    DataExport_ListByWorkspace(#[from] data_export::list_by_workspace::Error),
    #[error(transparent)]
    DataExport_Get(#[from] data_export::get::Error),
    #[error(transparent)]
    DataExport_CreateOrUpdate(#[from] data_export::create_or_update::Error),
    #[error(transparent)]
    DataExport_Delete(#[from] data_export::delete::Error),
    #[error(transparent)]
...
pub mod linked_storage_accounts {
    ...
    impl Client {
        ...
        pub fn create_or_update(
            ...
            workspace_name: impl Into<String>,
            data_source_type: impl Into<String>,
            parameters: impl Into<models::LinkedStorageAccounts>,
            subscription_id: impl Into<String>,
        ) -> create_or_update::Builder {
            create_or_update::Builder {
                client: self.0.clone(),
    ...
    pub mod get {
        use super::models;
        type Response = models::LinkedStorageAccounts;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("Unexpected HTTP status code {}", status_code)]
            UnexpectedResponse { status_code: http::StatusCode, body: bytes::Bytes },
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        match rsp_status {
                            http::StatusCode::OK => {
                                let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                                let rsp_value: models::LinkedStorageAccounts =
                                    serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                                Ok(rsp_value)
                            }
                            status_code => {
    ...
    pub mod create_or_update {
        ...
        pub struct Builder {
            ...
            pub(crate) workspace_name: String,
            pub(crate) data_source_type: String,
            pub(crate) parameters: models::LinkedStorageAccounts,
            pub(crate) subscription_id: String,
        }
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<Response, Error>> {
