...
pub mod data_exports {
    ...
    pub async fn list_by_workspace(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::DataExportErrorResponse = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_by_workspace::Error::DeserializeError(source, rsp_body.clone()))?;
...
pub mod data_collector_logs {
    ...
    pub async fn get(
        ...
        subscription_id: &str,
        force: Option<bool>,
    ) -> std::result::Result<models::DataCollectorLog, get::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
    ...
    pub async fn list_by_workspace(
        ...
        resource_group_name: &str,
        workspace_name: &str,
    ) -> std::result::Result<models::DataCollectorLogsListResult, list_by_workspace::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourcegroups/{}/providers/Microsoft.OperationalInsights/workspaces/{}/dataCollectorLogs",
            operation_config.base_path(),
...
pub mod clusters {
    ...
    pub async fn list_by_resource_group(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::ClusterErrorResponse = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_by_resource_group::Error::DeserializeError(source, rsp_body.clone()))?;
