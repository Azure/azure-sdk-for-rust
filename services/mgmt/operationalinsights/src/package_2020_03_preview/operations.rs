...
pub mod data_exports {
    ...
    pub async fn list_by_workspace(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: DataExportErrorResponse = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_by_workspace::Error::DeserializeError(source, rsp_body.clone()))?;
...
pub mod data_collector_logs {
    ...
    pub async fn list_by_workspace(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: DataCollectorLogsListResult = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_by_workspace::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
...
pub mod clusters {
    ...
    pub async fn list_by_resource_group(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: ClusterErrorResponse = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_by_resource_group::Error::DeserializeError(source, rsp_body.clone()))?;
