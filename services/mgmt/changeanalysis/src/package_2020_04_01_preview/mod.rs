    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ConfigurationProfileResource> {
                ...
                let body: models::ConfigurationProfileResource = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    ...
                    &self.subscription_id, &self.profile_name
                ));
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ConfigurationProfileResource>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ConfigurationProfileResource>>;
