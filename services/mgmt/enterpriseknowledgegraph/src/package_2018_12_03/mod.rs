...
pub mod enterprise_knowledge_graph {
    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::EnterpriseKnowledgeGraph> {
                ...
                let body: models::EnterpriseKnowledgeGraph = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::EnterpriseKnowledgeGraph>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::EnterpriseKnowledgeGraph>>;
    ...
    pub mod list_by_resource_group {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::EnterpriseKnowledgeGraphResponseList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::EnterpriseKnowledgeGraphResponseList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::EnterpriseKnowledgeGraphResponseList, azure_core::error::Error> {
...
pub mod operations {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.EnterpriseKnowledgeGraph/operations",));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2018-12-03");
