...
pub mod enterprise_knowledge_graph {
    ...
    pub mod get {
        ...
        type Response = models::EnterpriseKnowledgeGraph;
        #[derive(Clone)]
        pub struct Builder {
                    ...
                    async move {
                        ...
                        match rsp_status {
                            http::StatusCode::OK => {
                                ...
                                let rsp_value: models::EnterpriseKnowledgeGraph = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
    ...
    pub mod list_by_resource_group {
        use super::models;
        use azure_core::error::ResultExt;
        type Response = models::EnterpriseKnowledgeGraphResponseList;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) resource_group_name: String,
        ...
        impl Builder {
            pub fn into_stream(self) -> azure_core::Pageable<Response, azure_core::error::Error> {
                let make_request = move |continuation: Option<azure_core::prelude::Continuation>| {
                    let this = self.clone();
                    async move {
                        let url_str = &format!("{}/providers/Microsoft.EnterpriseKnowledgeGraph/operations", this.client.endpoint(),);
                        let mut url = url::Url::parse(url_str).context(azure_core::error::ErrorKind::Other, "build request")?;
                        let mut req_builder = http::request::Builder::new();
                        let rsp = match continuation {
                            Some(token) => {
