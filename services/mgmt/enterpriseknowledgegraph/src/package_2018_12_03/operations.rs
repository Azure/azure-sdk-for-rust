...
pub mod enterprise_knowledge_graph {
    ...
    impl Client {
        ...
        pub fn create(
            ...
            resource_group_name: impl Into<String>,
            resource_name: impl Into<String>,
            parameters: impl Into<models::EnterpriseKnowledgeGraph>,
            subscription_id: impl Into<String>,
        ) -> create::Builder {
            create::Builder {
                client: self.0.clone(),
    ...
    pub mod get {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::EnterpriseKnowledgeGraph, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                    ...
                    url.query_pairs_mut().append_pair("api-version", "2018-12-03");
    ...
    pub mod create {
        ...
        pub struct Builder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) resource_name: String,
            pub(crate) parameters: models::EnterpriseKnowledgeGraph,
            pub(crate) subscription_id: String,
        }
        impl Builder {
    ...
    pub mod list_by_resource_group {
        ...
        impl Builder {
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, std::result::Result<models::EnterpriseKnowledgeGraphResponseList, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.EnterpriseKnowledgeGraph/services",
                        self.client.endpoint(),
    ...
    pub mod list {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::OperationEntityListResult, Error>> {
                Box::pin(async move {
                    let url_str = &format!("{}/providers/Microsoft.EnterpriseKnowledgeGraph/operations", self.client.endpoint(),);
                    let mut url = url::Url::parse(url_str).map_err(Error::ParseUrl)?;
                    let mut req_builder = http::request::Builder::new();
                    req_builder = req_builder.method(http::Method::GET);
                    let credential = self.client.token_credential();
