...
pub struct CheckQuotaAvailabilityResponseProperties {
...
impl CheckQuotaAvailabilityResponseProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct LoadTestMappingResource {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Azure LoadTest mapping resource properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<LoadTestMappingProperties>,
}
impl LoadTestMappingResource {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The response of a LoadTestMappingResource list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct LoadTestMappingResourceListResult {
    #[doc = "The LoadTestMappingResource items on this page"]
    pub value: Vec<LoadTestMappingResource>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for LoadTestMappingResourceListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl LoadTestMappingResourceListResult {
    pub fn new(value: Vec<LoadTestMappingResource>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "The type used for update operations of the LoadTestMappingResource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct LoadTestMappingResourceUpdate {
    #[doc = "The updatable properties of the LoadTestMappingResource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<LoadTestMappingResourceUpdateProperties>,
}
impl LoadTestMappingResourceUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The updatable properties of the LoadTestMappingResource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct LoadTestMappingResourceUpdateProperties {
    #[doc = "Mapped source resource Id."]
    #[serde(rename = "sourceResourceId", default, skip_serializing_if = "Option::is_none")]
    pub source_resource_id: Option<String>,
    #[doc = "Mapped Azure Load Test resource Id."]
...
impl LoadTestMappingResourceUpdateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct LoadTestProfileMappingProperties {
    #[doc = "Mapped source resource Id."]
    #[serde(rename = "sourceResourceId", default, skip_serializing_if = "Option::is_none")]
    pub source_resource_id: Option<String>,
    #[doc = "Mapped Azure Load Test resource Id."]
...
impl LoadTestProfileMappingProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct LoadTestProfileMappingResource {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Azure LoadTest profile mapping resource properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<LoadTestProfileMappingProperties>,
}
impl LoadTestProfileMappingResource {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The response of a LoadTestProfileMappingResource list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct LoadTestProfileMappingResourceListResult {
    #[doc = "The LoadTestProfileMappingResource items on this page"]
    pub value: Vec<LoadTestProfileMappingResource>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for LoadTestProfileMappingResourceListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl LoadTestProfileMappingResourceListResult {
    pub fn new(value: Vec<LoadTestProfileMappingResource>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "The type used for update operations of the LoadTestProfileMappingResource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct LoadTestProfileMappingResourceUpdate {
    #[doc = "The updatable properties of the LoadTestProfileMappingResource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<LoadTestProfileMappingResourceUpdateProperties>,
}
impl LoadTestProfileMappingResourceUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The updatable properties of the LoadTestProfileMappingResource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct LoadTestProfileMappingResourceUpdateProperties {
    #[doc = "Mapped source resource Id."]
    #[serde(rename = "sourceResourceId", default, skip_serializing_if = "Option::is_none")]
    pub source_resource_id: Option<String>,
    #[doc = "Mapped Azure Load Test resource Id."]
...
impl LoadTestProfileMappingResourceUpdateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "New quota request request properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct QuotaBucketRequestProperties {
    #[doc = "Current quota usage of the quota bucket."]
    #[serde(rename = "currentUsage", default, skip_serializing_if = "Option::is_none")]
    pub current_usage: Option<i32>,
    #[doc = "Current quota limit of the quota bucket."]
    #[serde(rename = "currentQuota", default, skip_serializing_if = "Option::is_none")]
    pub current_quota: Option<i32>,
    #[doc = "New quota limit of the quota bucket."]
    #[serde(rename = "newQuota", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Quota bucket resource properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct QuotaResourceProperties {
    #[doc = "Current quota limit of the quota bucket."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
