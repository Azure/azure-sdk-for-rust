...
impl Client {
    ...
    pub fn dnssec_configs_client(&self) -> dnssec_configs::Client {
        dnssec_configs::Client(self.clone())
    }
...
pub mod dnssec_configs {
    use super::models;
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets the DNSSEC configuration."]
        #[doc = ""]
        #[doc = "Arguments:"]
        ...
        #[doc = "Creates or updates the DNSSEC configuration on a DNS zone."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `zone_name`: The name of the DNS zone (without a terminating dot)."]
        ...
        #[doc = "Deletes the DNSSEC configuration on a DNS zone. This operation cannot be undone."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `zone_name`: The name of the DNS zone (without a terminating dot)."]
        ...
        #[doc = "Lists the DNSSEC configurations in a DNS zone."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `zone_name`: The name of the DNS zone (without a terminating dot)."]
    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DnssecConfig> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DnssecConfig = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
                ...
                Box::pin({
                    ...
                    async move {
                        let url = azure_core::Url::parse(&format!(
                            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Network/dnsZones/{}/dnssecConfigs/default",
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DnssecConfig>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::DnssecConfig>>;
    ...
    pub mod create_or_update {
        ...
        impl RequestBuilder {
            #[doc = "The etag of the DNSSEC configuration. Omit this value to always overwrite the DNSSEC configuration. Specify the last-seen etag value to prevent accidentally overwriting any concurrent changes."]
            pub fn if_match(mut self, if_match: impl Into<String>) -> Self {
                self.if_match = Some(if_match.into());
                self
            }
            #[doc = "Set to '*' to allow this DNSSEC configuration to be created, but to prevent updating existing DNSSEC configuration. Other values will be ignored."]
    ...
    pub mod delete {
        ...
        impl RequestBuilder {
            #[doc = "The etag of this DNSSEC configuration. Omit this value to always delete the DNSSEC configuration. Specify the last-seen etag value to prevent accidentally deleting any concurrent changes."]
            pub fn if_match(mut self, if_match: impl Into<String>) -> Self {
                self.if_match = Some(if_match.into());
                self
            }
    ...
    pub mod list_by_dns_zone {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DnssecConfigListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DnssecConfigListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::DnssecConfigListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
                            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Network/dnsZones/{}/dnssecConfigs",
                            this.client.endpoint(),
                            &this.subscription_id,
                            &this.resource_group_name,
                            &this.zone_name
...
pub mod record_sets {
    ...
    impl Client {
        ...
        #[doc = "Creates or updates a record set within a DNS zone. Record sets of type SOA can be updated but not created (they are created when the DNS zone is created)."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `zone_name`: The name of the DNS zone (without a terminating dot)."]
        ...
        #[doc = "Deletes a record set from a DNS zone. This operation cannot be undone. Record sets of type SOA cannot be deleted (they are deleted when the DNS zone is deleted)."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `zone_name`: The name of the DNS zone (without a terminating dot)."]
