        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::RecordSet, Error>> {
                Box::pin(async move {
                    ...
                    url.query_pairs_mut().append_pair("api-version", "2015-05-04-preview");
...
pub mod zones {
    ...
    impl Client {
        ...
        pub fn list_zones_in_resource_group(
            &self,
            resource_group_name: impl Into<String>,
            subscription_id: impl Into<String>,
        ) -> list_zones_in_resource_group::Builder {
            list_zones_in_resource_group::Builder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                subscription_id: subscription_id.into(),
        ...
        pub fn list_zones_in_subscription(&self, subscription_id: impl Into<String>) -> list_zones_in_subscription::Builder {
            list_zones_in_subscription::Builder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                top: None,
                filter: None,
