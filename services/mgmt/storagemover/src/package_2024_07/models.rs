...
pub struct AgentProperties {
    ...
    #[doc = "The agent's local time zone represented in Windows format."]
    #[serde(rename = "timeZone", default, skip_serializing_if = "Option::is_none")]
    pub time_zone: Option<String>,
    #[doc = "The WAN-link upload limit schedule. Overlapping recurrences are not allowed."]
    #[serde(rename = "uploadLimitSchedule", default, skip_serializing_if = "Option::is_none")]
    pub upload_limit_schedule: Option<UploadLimitSchedule>,
    ...
    impl Serialize for Status {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::PausedByBandwidthManagement => serializer.serialize_unit_variant("Status", 8u32, "PausedByBandwidthManagement"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct Time {
    #[doc = "The hour element of the time. Allowed values range from 0 (start of the selected day) to 24 (end of the selected day). Hour value 24 cannot be combined with any other minute value but 0."]
    pub hour: i32,
    #[doc = "The minute element of the time. Allowed values are 0 and 30. If not specified, its value defaults to 0."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub minute: Option<time::Minute>,
}
impl Time {
    pub fn new(hour: i32) -> Self {
        Self { hour, minute: None }
    }
}
pub mod time {
    use super::*;
...
#[doc = "The WAN-link upload limit."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct UploadLimit {
    #[doc = "The WAN-link upload bandwidth (maximum data transfer rate) in megabits per second. Value of 0 indicates no throughput is allowed and any running migration job is effectively paused for the duration of this recurrence. Only data plane operations are governed by this limit. Control plane operations ensure seamless functionality. The agent may exceed this limit with control messages, if necessary."]
    #[serde(rename = "limitInMbps")]
    pub limit_in_mbps: i32,
}
impl UploadLimit {
    pub fn new(limit_in_mbps: i32) -> Self {
        Self { limit_in_mbps }
    }
}
#[doc = "The WAN-link upload limit schedule. Overlapping recurrences are not allowed."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct UploadLimitSchedule {
    #[doc = "The set of weekly repeating recurrences of the WAN-link upload limit schedule."]
    #[serde(
        rename = "weeklyRecurrences",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub weekly_recurrences: Vec<UploadLimitWeeklyRecurrence>,
}
impl UploadLimitSchedule {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The weekly recurrence of the WAN-link upload limit schedule. The start time must be earlier in the day than the end time. The recurrence must not span across multiple days."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct UploadLimitWeeklyRecurrence {
    #[serde(flatten)]
    pub weekly_recurrence: WeeklyRecurrence,
    #[serde(flatten)]
    pub upload_limit: UploadLimit,
}
impl UploadLimitWeeklyRecurrence {
    pub fn new(weekly_recurrence: WeeklyRecurrence, upload_limit: UploadLimit) -> Self {
        Self {
            weekly_recurrence,
            upload_limit,
        }
...
#[doc = "The weekly recurrence of the schedule."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct WeeklyRecurrence {
    #[serde(flatten)]
    pub recurrence: Recurrence,
    #[doc = "The set of days of week for the schedule recurrence. A day must not be specified more than once in a recurrence."]
    pub days: Vec<DayOfWeek>,
}
impl WeeklyRecurrence {
    pub fn new(recurrence: Recurrence, days: Vec<DayOfWeek>) -> Self {
        Self { recurrence, days }
    }
}
#[doc = "Metadata pertaining to creation and last modification of the resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
