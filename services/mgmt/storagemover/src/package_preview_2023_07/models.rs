...
pub struct AzureKeyVaultSmbCredentials {
    ...
    #[serde(rename = "passwordUri", default, skip_serializing_if = "Option::is_none")]
...
impl AzureStorageBlobContainerEndpointUpdateProperties {
    pub fn new(endpoint_base_update_properties: EndpointBaseUpdateProperties) -> Self {
        Self {
            endpoint_base_update_properties,
        }
    }
}
#[doc = "The properties of Azure Storage SMB file share endpoint."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AzureStorageSmbFileShareEndpointProperties {
    #[serde(flatten)]
    pub endpoint_base_properties: EndpointBaseProperties,
...
impl AzureStorageSmbFileShareEndpointProperties {
    pub fn new(endpoint_base_properties: EndpointBaseProperties, storage_account_resource_id: String, file_share_name: String) -> Self {
        Self {
            endpoint_base_properties,
            storage_account_resource_id,
            file_share_name,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AzureStorageSmbFileShareEndpointUpdateProperties {
    #[serde(flatten)]
    pub endpoint_base_update_properties: EndpointBaseUpdateProperties,
}
impl AzureStorageSmbFileShareEndpointUpdateProperties {
    pub fn new(endpoint_base_update_properties: EndpointBaseUpdateProperties) -> Self {
        Self {
            endpoint_base_update_properties,
        }
...
impl Serialize for CredentialType {
    ...
    {
        match self {
            Self::AzureKeyVaultSmb => serializer.serialize_unit_variant("CredentialType", 0u32, "AzureKeyVaultSmb"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl Serialize for EndpointType {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::AzureStorageSmbFileShare => serializer.serialize_unit_variant("EndpointType", 2u32, "AzureStorageSmbFileShare"),
            Self::SmbMount => serializer.serialize_unit_variant("EndpointType", 3u32, "SmbMount"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SmbMountEndpointProperties {
    #[serde(flatten)]
    pub endpoint_base_properties: EndpointBaseProperties,
    #[doc = "The host name or IP address of the server exporting the file system."]
    pub host: String,
    ...
    #[doc = "The Azure Key Vault secret URIs which store the credentials."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub credentials: Option<AzureKeyVaultSmbCredentials>,
}
impl SmbMountEndpointProperties {
    pub fn new(endpoint_base_properties: EndpointBaseProperties, host: String, share_name: String) -> Self {
        Self {
            endpoint_base_properties,
            host,
            share_name,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SmbMountEndpointUpdateProperties {
    #[serde(flatten)]
    pub endpoint_base_update_properties: EndpointBaseUpdateProperties,
    #[doc = "The Azure Key Vault secret URIs which store the credentials."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl SmbMountEndpointUpdateProperties {
    pub fn new(endpoint_base_update_properties: EndpointBaseUpdateProperties) -> Self {
        Self {
            endpoint_base_update_properties,
            credentials: None,
