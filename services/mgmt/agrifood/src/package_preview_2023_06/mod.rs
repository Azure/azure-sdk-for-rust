...
impl Client {
    ...
    pub fn data_manager_for_agriculture_extensions_client(&self) -> data_manager_for_agriculture_extensions::Client {
        data_manager_for_agriculture_extensions::Client(self.clone())
    }
    pub fn data_manager_for_agriculture_resources_client(&self) -> data_manager_for_agriculture_resources::Client {
        data_manager_for_agriculture_resources::Client(self.clone())
    }
...
pub mod check_name_availability {
    ...
    impl Client {
        ...
        #[doc = "* `name_availability_request`: NameAvailabilityRequest object."]
...
pub mod data_connectors {
    ...
    impl Client {
        ...
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `data_manager_for_agriculture_resource_name`: DataManagerForAgriculture resource name."]
        #[doc = "* `data_connector_name`: Connector name."]
        pub fn get(
            &self,
            resource_group_name: impl Into<String>,
            subscription_id: impl Into<String>,
            data_manager_for_agriculture_resource_name: impl Into<String>,
            ...
            get::RequestBuilder {
                ...
                subscription_id: subscription_id.into(),
                data_manager_for_agriculture_resource_name: data_manager_for_agriculture_resource_name.into(),
        ...
        #[doc = "* `data_manager_for_agriculture_resource_name`: DataManagerForAgriculture resource name."]
        #[doc = "* `data_connector_name`: Connector name."]
        #[doc = "* `body`: Body must be valid DataConnector request."]
        pub fn create_or_update(
            ...
            data_manager_for_agriculture_resource_name: impl Into<String>,
            data_connector_name: impl Into<String>,
            body: impl Into<models::DataConnector>,
    ...
    pub mod get {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) subscription_id: String,
            pub(crate) data_manager_for_agriculture_resource_name: String,
            pub(crate) data_connector_name: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
                ...
                Box::pin({
                    ...
                    async move {
                        let url = azure_core::Url::parse(&format!(
                            ...
                            &this.data_manager_for_agriculture_resource_name,
                            &this.data_connector_name
                        ))?;
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DataConnector>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) data_manager_for_agriculture_resource_name: String,
            pub(crate) data_connector_name: String,
            pub(crate) body: models::DataConnector,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DataConnectorListResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DataConnectorListResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::DataConnectorListResponse, azure_core::error::Error> {
...
pub mod data_manager_for_agriculture_extensions {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    impl Client {
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `data_manager_for_agriculture_extension_id`: dataManagerForAgricultureExtensionId to be queried."]
        pub fn get(&self, data_manager_for_agriculture_extension_id: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                data_manager_for_agriculture_extension_id: data_manager_for_agriculture_extension_id.into(),
            }
        }
    }
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DataManagerForAgricultureExtensionListResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DataManagerForAgricultureExtensionListResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(
                self,
            ) -> azure_core::Pageable<models::DataManagerForAgricultureExtensionListResponse, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DataManagerForAgricultureExtension> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DataManagerForAgricultureExtension = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) data_manager_for_agriculture_extension_id: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
                ...
                Box::pin({
                    ...
                    async move {
                        let url = azure_core::Url::parse(&format!(
                            "{}/providers/Microsoft.AgFoodPlatform/farmBeatsExtensionDefinitions/{}",
                            this.client.endpoint(),
                            &this.data_manager_for_agriculture_extension_id
                        ))?;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Get);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DataManagerForAgricultureExtension>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DataManagerForAgricultureExtension>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod data_manager_for_agriculture_resources {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    impl Client {
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `data_manager_for_agriculture_resource_name`: DataManagerForAgriculture resource name."]
        #[doc = "* `request`: Data Manager For Agriculture resource create or update request object."]
        pub fn create_or_update(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            data_manager_for_agriculture_resource_name: impl Into<String>,
            request: impl Into<models::DataManagerForAgriculture>,
        ) -> create_or_update::RequestBuilder {
            create_or_update::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
        ...
        pub fn update(
            ...
            resource_group_name: impl Into<String>,
            data_manager_for_agriculture_resource_name: impl Into<String>,
            request: impl Into<models::DataManagerForAgricultureUpdateRequestModel>,
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DataManagerForAgriculture> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DataManagerForAgriculture = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DataManagerForAgriculture>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DataManagerForAgriculture>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) data_manager_for_agriculture_resource_name: String,
            pub(crate) request: models::DataManagerForAgriculture,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) data_manager_for_agriculture_resource_name: String,
            pub(crate) request: models::DataManagerForAgricultureUpdateRequestModel,
        }
        impl RequestBuilder {
    ...
    pub mod list_by_subscription {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DataManagerForAgricultureListResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DataManagerForAgricultureListResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::DataManagerForAgricultureListResponse, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
...
pub mod operation_results {
    ...
    impl Client {
        ...
        #[doc = "* `operation_results_id`: operationResultsId for a specific location."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
...
pub mod extensions {
    ...
    impl Client {
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `data_manager_for_agriculture_resource_name`: DataManagerForAgriculture resource name."]
        pub fn list_by_data_manager_for_agriculture(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            data_manager_for_agriculture_resource_name: impl Into<String>,
        ) -> list_by_data_manager_for_agriculture::RequestBuilder {
            list_by_data_manager_for_agriculture::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod list_by_data_manager_for_agriculture {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.AgFoodPlatform/farmBeats/{}/privateEndpointConnections/{}" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . data_manager_for_agriculture_resource_name , & this . private_endpoint_connection_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Get);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.AgFoodPlatform/farmBeats/{}/privateEndpointConnections" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . data_manager_for_agriculture_resource_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Get);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
...
pub mod solutions {
    ...
    impl Client {
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `data_manager_for_agriculture_resource_name`: DataManagerForAgriculture resource name."]
        #[doc = "* `solution_id`: SolutionId for Data Manager For Agriculture Resource."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) data_manager_for_agriculture_resource_name: String,
            pub(crate) solution_id: String,
            pub(crate) request_body: Option<models::Solution>,
        }
        impl RequestBuilder {
            #[doc = "Solution resource request body."]
            pub fn request_body(mut self, request_body: impl Into<models::Solution>) -> Self {
                self.request_body = Some(request_body.into());
                self
            }
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
...
pub mod solutions_discoverability {
    ...
    impl Client {
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `data_manager_for_agriculture_solution_id`: dataManagerForAgricultureSolutionId to be queried."]
        pub fn get(&self, data_manager_for_agriculture_solution_id: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                data_manager_for_agriculture_solution_id: data_manager_for_agriculture_solution_id.into(),
            }
        }
    }
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DataManagerForAgricultureSolutionListResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DataManagerForAgricultureSolutionListResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(
                self,
            ) -> azure_core::Pageable<models::DataManagerForAgricultureSolutionListResponse, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DataManagerForAgricultureSolution> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DataManagerForAgricultureSolution = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) data_manager_for_agriculture_solution_id: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
                ...
                Box::pin({
                    ...
                    async move {
                        let url = azure_core::Url::parse(&format!(
                            "{}/providers/Microsoft.AgFoodPlatform/farmBeatsSolutionDefinitions/{}",
                            this.client.endpoint(),
                            &this.data_manager_for_agriculture_solution_id
                        ))?;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Get);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DataManagerForAgricultureSolution>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DataManagerForAgricultureSolution>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
