...
pub enum Error {
    ...
    #[error(transparent)]
    SqlVirtualMachines_Redeploy(#[from] sql_virtual_machines::redeploy::Error),
    #[error(transparent)]
    ...
    #[error(transparent)]
    SqlVirtualMachines_StartAssessment(#[from] sql_virtual_machines::start_assessment::Error),
}
