...
use std::str::FromStr;
#[doc = "Enable AAD authentication for SQL VM."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AadAuthenticationSettings {
    #[doc = "The client Id of the Managed Identity to query Microsoft Graph API. An empty string must be used for the system assigned Managed Identity"]
...
#[doc = "Configure SQL best practices Assessment for databases in your SQL virtual machine."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AssessmentSettings {
    #[doc = "Enable or disable SQL best practices Assessment feature on SQL virtual machine."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enable: Option<bool>,
    #[doc = "Run SQL best practices Assessment immediately on SQL virtual machine."]
    #[serde(rename = "runImmediately", default, skip_serializing_if = "Option::is_none")]
    pub run_immediately: Option<bool>,
    #[doc = "Set assessment schedule for SQL Server."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct SqlStorageSettings {
    ...
    #[doc = "Use storage pool to build a drive if true or not provided"]
    #[serde(rename = "useStoragePool", default, skip_serializing_if = "Option::is_none")]
    pub use_storage_pool: Option<bool>,
}
...
#[doc = "Set tempDb storage settings for SQL Server."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct ServerConfigurationsManagementSettings {
    ...
    #[doc = "Enable AAD authentication for SQL VM."]
    #[serde(rename = "azureAdAuthenticationSettings", default, skip_serializing_if = "Option::is_none")]
    pub azure_ad_authentication_settings: Option<AadAuthenticationSettings>,
}
...
pub struct SqlVirtualMachineProperties {
    ...
    #[doc = "Status of last troubleshooting operation on this SQL VM"]
    #[serde(rename = "troubleshootingStatus", default, skip_serializing_if = "Option::is_none")]
    pub troubleshooting_status: Option<TroubleshootingStatus>,
    #[doc = "Configure SQL best practices Assessment for databases in your SQL virtual machine."]
    ...
    #[doc = "Enable automatic upgrade of Sql IaaS extension Agent."]
...
pub mod sql_virtual_machine_properties {
    ...
    impl FromStr for LeastPrivilegeMode {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for LeastPrivilegeMode {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for LeastPrivilegeMode {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
...
#[doc = "Details required for SQL VM troubleshooting"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SqlVmTroubleshooting {
    #[doc = "Start time in UTC timezone."]
    #[serde(rename = "startTimeUtc", default, with = "azure_core::date::rfc3339::option")]
    pub start_time_utc: Option<time::OffsetDateTime>,
    #[doc = "End time in UTC timezone."]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<TroubleshootingAdditionalProperties>,
    #[doc = "Virtual machine resource id for response."]
    #[serde(rename = "virtualMachineResourceId", default, skip_serializing_if = "Option::is_none")]
    pub virtual_machine_resource_id: Option<String>,
}
impl SqlVmTroubleshooting {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod sql_vm_troubleshooting {
    use super::*;
    #[doc = "SQL VM troubleshooting scenario."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "TroubleshootingScenario")]
    pub enum TroubleshootingScenario {
        UnhealthyReplica,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for TroubleshootingScenario {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for TroubleshootingScenario {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for TroubleshootingScenario {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::UnhealthyReplica => serializer.serialize_unit_variant("TroubleshootingScenario", 0u32, "UnhealthyReplica"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    impl Default for TroubleshootingScenario {
        fn default() -> Self {
            Self::UnhealthyReplica
        }
    }
}
#[doc = "Set workload type to optimize storage for SQL Server."]
...
pub struct StorageConfigurationSettings {
    ...
    pub enable_storage_config_blade: Option<bool>,
}
...
#[doc = "SQL VM Troubleshooting additional properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct TroubleshootingAdditionalProperties {
    #[doc = "SQL VM Troubleshoot UnhealthyReplica scenario information."]
    #[serde(rename = "unhealthyReplicaInfo", default, skip_serializing_if = "Option::is_none")]
    pub unhealthy_replica_info: Option<UnhealthyReplicaInfo>,
}
impl TroubleshootingAdditionalProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Status of last troubleshooting operation on this SQL VM"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct TroubleshootingStatus {
    #[doc = "Root cause of the issue"]
    #[serde(rename = "rootCause", default, skip_serializing_if = "Option::is_none")]
    pub root_cause: Option<String>,
    #[doc = "Last troubleshooting trigger time in UTC timezone"]
    #[serde(rename = "lastTriggerTimeUtc", default, with = "azure_core::date::rfc3339::option")]
    pub last_trigger_time_utc: Option<time::OffsetDateTime>,
    #[doc = "Start time in UTC timezone."]
    #[serde(rename = "startTimeUtc", default, with = "azure_core::date::rfc3339::option")]
    pub start_time_utc: Option<time::OffsetDateTime>,
    #[doc = "End time in UTC timezone."]
...
impl TroubleshootingStatus {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod troubleshooting_status {
    use super::*;
    #[doc = "SQL VM troubleshooting scenario."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "TroubleshootingScenario")]
...
#[doc = "SQL VM Troubleshoot UnhealthyReplica scenario information."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct UnhealthyReplicaInfo {
    #[doc = "The name of the availability group"]
    #[serde(rename = "availabilityGroupName", default, skip_serializing_if = "Option::is_none")]
    pub availability_group_name: Option<String>,
}
impl UnhealthyReplicaInfo {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct WsfcDomainProfile {
    ...
    #[doc = "The flag to check if SQL service account is GMSA."]
    #[serde(rename = "isSqlServiceAccountGmsa", default, skip_serializing_if = "Option::is_none")]
    pub is_sql_service_account_gmsa: Option<bool>,
