...
pub struct AdditionalConfiguration {
    ...
    pub quantity: i32,
    #[doc = "List Provisioning Details for Devices in Additional Config."]
    #[serde(
        rename = "provisioningDetails",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub provisioning_details: Vec<ProvisioningDetails>,
}
impl AdditionalConfiguration {
    pub fn new(hierarchy_information: HierarchyInformation, quantity: i32) -> Self {
        Self {
            ...
            quantity,
            provisioning_details: Vec::new(),
        }
    }
}
#[doc = "Type of address based on its usage context."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "AddressClassification")]
...
impl<'de> Deserialize<'de> for AddressClassification {
...
impl Serialize for AddressClassification {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Shipping => serializer.serialize_unit_variant("AddressClassification", 0u32, "Shipping"),
            Self::Site => serializer.serialize_unit_variant("AddressClassification", 1u32, "Site"),
...
pub struct AddressProperties {
    #[doc = "Type of address based on its usage context."]
    #[serde(rename = "addressClassification", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Auto Provisioning Details."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "AutoProvisioningStatus")]
pub enum AutoProvisioningStatus {
    Enabled,
    Disabled,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for AutoProvisioningStatus {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for AutoProvisioningStatus {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for AutoProvisioningStatus {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Enabled => serializer.serialize_unit_variant("AutoProvisioningStatus", 0u32, "Enabled"),
            Self::Disabled => serializer.serialize_unit_variant("AutoProvisioningStatus", 1u32, "Disabled"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct BillingMeterDetails {
    ...
    #[doc = "Holds details about term type and duration."]
    #[serde(rename = "termTypeDetails", default, skip_serializing_if = "Option::is_none")]
    pub term_type_details: Option<TermTypeDetails>,
}
...
pub struct ChildConfigurationProperties {
    ...
    #[doc = "Determining nature of provisioning that the configuration supports."]
    #[serde(rename = "provisioningSupport", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_support: Option<ProvisioningSupport>,
    ...
    #[doc = "The Term Commitment Durations that are supported for a configuration."]
    #[serde(
        rename = "supportedTermCommitmentDurations",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub supported_term_commitment_durations: Vec<String>,
...
pub struct ConfigurationDeviceDetails {
    ...
    #[doc = "Term Commitment Information."]
    #[serde(rename = "termCommitmentInformation", default, skip_serializing_if = "Option::is_none")]
    pub term_commitment_information: Option<TermCommitmentInformation>,
}
...
pub struct DeviceDetails {
    ...
    #[doc = "Device serial number to be displayed."]
    #[serde(rename = "displaySerialNumber", default, skip_serializing_if = "Option::is_none")]
    pub display_serial_number: Option<String>,
    ...
    #[serde(rename = "provisioningSupport", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_support: Option<ProvisioningSupport>,
    #[doc = "Details Related To Provision Resource."]
...
#[doc = "Proof of possession details."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DevicePresenceVerificationDetails {
    #[doc = "Proof of possession status."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<DevicePresenceVerificationStatus>,
    #[doc = "Insights on current status."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub message: Option<String>,
}
impl DevicePresenceVerificationDetails {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Proof of possession status."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "DevicePresenceVerificationStatus")]
pub enum DevicePresenceVerificationStatus {
    NotInitiated,
    Completed,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for DevicePresenceVerificationStatus {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for DevicePresenceVerificationStatus {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for DevicePresenceVerificationStatus {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::NotInitiated => serializer.serialize_unit_variant("DevicePresenceVerificationStatus", 0u32, "NotInitiated"),
            Self::Completed => serializer.serialize_unit_variant("DevicePresenceVerificationStatus", 1u32, "Completed"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct HierarchyInformation {
    ...
    #[doc = "Represents Model Display Name."]
    #[serde(rename = "configurationIdDisplayName", default, skip_serializing_if = "Option::is_none")]
    pub configuration_id_display_name: Option<String>,
}
...
pub struct OrderItemDetails {
    ...
    #[doc = "Represents Site Related Details."]
    #[serde(rename = "siteDetails", default, skip_serializing_if = "Option::is_none")]
    ...
    impl Serialize for OrderItemType {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::External => serializer.serialize_unit_variant("OrderItemType", 2u32, "External"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Order item details Patchable Properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OrderItemDetailsUpdateParameter {
    #[doc = "Represents product details patchable properties."]
    #[serde(rename = "productDetails", default, skip_serializing_if = "Option::is_none")]
    pub product_details: Option<ProductDetailsUpdateParameter>,
    #[doc = "Represents Site Related Details."]
    #[serde(rename = "siteDetails", default, skip_serializing_if = "Option::is_none")]
    pub site_details: Option<SiteDetails>,
}
impl OrderItemDetailsUpdateParameter {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct OrderItemProperties {
    ...
    #[doc = "Address details for an order item."]
    #[serde(rename = "addressDetails", default, skip_serializing_if = "Option::is_none")]
...
impl OrderItemProperties {
    pub fn new(order_item_details: OrderItemDetails, order_id: String) -> Self {
        Self {
            order_item_details,
...
pub struct OrderItemUpdateProperties {
    ...
    pub notification_email_list: Vec<String>,
    #[doc = "Order item details Patchable Properties."]
    #[serde(rename = "orderItemDetails", default, skip_serializing_if = "Option::is_none")]
    pub order_item_details: Option<OrderItemDetailsUpdateParameter>,
}
...
pub struct Preferences {
    ...
    #[doc = "Term Commitment preference received from customer."]
    #[serde(rename = "termCommitmentPreferences", default, skip_serializing_if = "Option::is_none")]
    pub term_commitment_preferences: Option<TermCommitmentPreferences>,
}
impl Preferences {
    pub fn new() -> Self {
        Self::default()
...
pub struct ProductDetails {
    ...
    #[doc = "Details Related To Provision Resource."]
    #[serde(rename = "parentProvisioningDetails", default, skip_serializing_if = "Option::is_none")]
    pub parent_provisioning_details: Option<ProvisioningDetails>,
...
#[doc = "Represents product details patchable properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ProductDetailsUpdateParameter {
    #[doc = "Details Related To Provision Resource."]
    #[serde(rename = "parentProvisioningDetails", default, skip_serializing_if = "Option::is_none")]
    pub parent_provisioning_details: Option<ProvisioningDetails>,
}
impl ProductDetailsUpdateParameter {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ProvisioningDetails {
    #[doc = "Quantity of the devices."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub quantity: Option<i32>,
    #[doc = "Provisioning Resource Arm ID."]
    #[serde(rename = "provisioningArmId", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_arm_id: Option<String>,
    #[doc = "Provisioning End Point."]
    #[serde(rename = "provisioningEndPoint", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_end_point: Option<String>,
    #[doc = "Serial Number for the Device."]
    #[serde(rename = "serialNumber", default, skip_serializing_if = "Option::is_none")]
    pub serial_number: Option<String>,
    #[doc = "Vendor Name for the Device , (for 1P devices - Microsoft)."]
    #[serde(rename = "vendorName", default, skip_serializing_if = "Option::is_none")]
    pub vendor_name: Option<String>,
    #[doc = "Arc Enabled Resource Arm id."]
    #[serde(rename = "readyToConnectArmId", default, skip_serializing_if = "Option::is_none")]
    pub ready_to_connect_arm_id: Option<String>,
    #[doc = "Management Resource ArmId."]
    #[serde(rename = "managementResourceArmId", default, skip_serializing_if = "Option::is_none")]
    pub management_resource_arm_id: Option<String>,
    #[doc = "Unique Identity for a Device."]
    #[serde(rename = "uniqueDeviceIdentifier", default, skip_serializing_if = "Option::is_none")]
    pub unique_device_identifier: Option<String>,
    #[doc = "Auto Provisioning Details."]
    #[serde(rename = "autoProvisioningStatus", default, skip_serializing_if = "Option::is_none")]
    pub auto_provisioning_status: Option<AutoProvisioningStatus>,
    #[doc = "Proof of possession details."]
    #[serde(rename = "devicePresenceVerification", default, skip_serializing_if = "Option::is_none")]
    pub device_presence_verification: Option<DevicePresenceVerificationDetails>,
}
...
#[doc = "Determining nature of provisioning that the configuration supports."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ProvisioningSupport")]
...
impl FromStr for ProvisioningSupport {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for ProvisioningSupport {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for ProvisioningSupport {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::CloudBased => serializer.serialize_unit_variant("ProvisioningSupport", 0u32, "CloudBased"),
            Self::Manual => serializer.serialize_unit_variant("ProvisioningSupport", 1u32, "Manual"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "Resource move request body."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct SiteDetails {
    #[doc = "Unique Id, Identifying A Site."]
    #[serde(rename = "siteId")]
    pub site_id: String,
}
impl SiteDetails {
    ...
    impl Serialize for StageName {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::ReadyToSetup => serializer.serialize_unit_variant("StageName", 6u32, "ReadyToSetup"),
                Self::InUse => serializer.serialize_unit_variant("StageName", 7u32, "InUse"),
                Self::ReturnInitiated => serializer.serialize_unit_variant("StageName", 8u32, "ReturnInitiated"),
                Self::ReturnPickedUp => serializer.serialize_unit_variant("StageName", 9u32, "ReturnPickedUp"),
                Self::ReturnedToMicrosoft => serializer.serialize_unit_variant("StageName", 10u32, "ReturnedToMicrosoft"),
                Self::ReturnCompleted => serializer.serialize_unit_variant("StageName", 11u32, "ReturnCompleted"),
                Self::Cancelled => serializer.serialize_unit_variant("StageName", 12u32, "Cancelled"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Term Commitment Information."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct TermCommitmentInformation {
    #[doc = "Term Commitment Type"]
    #[serde(rename = "termCommitmentType")]
    pub term_commitment_type: TermCommitmentType,
    #[doc = "Term Commitment Duration. Currently Supporting P365D, P1095D"]
    #[serde(rename = "termCommitmentTypeDuration", default, skip_serializing_if = "Option::is_none")]
    pub term_commitment_type_duration: Option<String>,
    #[doc = "Number of Days Pending for Term Commitment"]
    #[serde(rename = "pendingDaysForTerm", default, skip_serializing_if = "Option::is_none")]
    pub pending_days_for_term: Option<i32>,
}
impl TermCommitmentInformation {
    pub fn new(term_commitment_type: TermCommitmentType) -> Self {
        Self {
            term_commitment_type,
            term_commitment_type_duration: None,
            pending_days_for_term: None,
        }
    }
}
#[doc = "Term Commitment preference received from customer."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct TermCommitmentPreferences {
    #[doc = "Term Commitment Type"]
    #[serde(rename = "preferredTermCommitmentType")]
    pub preferred_term_commitment_type: TermCommitmentType,
    #[doc = "Customer preferred Term Duration."]
    #[serde(rename = "preferredTermCommitmentDuration", default, skip_serializing_if = "Option::is_none")]
    pub preferred_term_commitment_duration: Option<String>,
}
impl TermCommitmentPreferences {
    pub fn new(preferred_term_commitment_type: TermCommitmentType) -> Self {
        Self {
            preferred_term_commitment_type,
            preferred_term_commitment_duration: None,
        }
    }
}
#[doc = "Term Commitment Type"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "TermCommitmentType")]
pub enum TermCommitmentType {
    None,
    Trial,
    Timed,
    #[serde(skip_deserializing)]
...
impl FromStr for TermCommitmentType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for TermCommitmentType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for TermCommitmentType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::None => serializer.serialize_unit_variant("TermCommitmentType", 0u32, "None"),
            Self::Trial => serializer.serialize_unit_variant("TermCommitmentType", 1u32, "Trial"),
            Self::Timed => serializer.serialize_unit_variant("TermCommitmentType", 2u32, "Timed"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "Holds details about term type and duration."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct TermTypeDetails {
    #[doc = "Term Commitment Type"]
    #[serde(rename = "termType")]
    pub term_type: TermCommitmentType,
    #[doc = "Duration for the term type."]
    #[serde(rename = "termTypeDuration")]
    pub term_type_duration: String,
}
impl TermTypeDetails {
    pub fn new(term_type: TermCommitmentType, term_type_duration: String) -> Self {
        Self {
            term_type,
            term_type_duration,
        }
