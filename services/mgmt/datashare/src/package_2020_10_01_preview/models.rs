...
impl AdlsGen2StorageAccountDataSet {
    pub fn new(properties: AdlsGen2StorageAccountDataSetProperties) -> Self {
        Self { properties }
    }
}
...
impl AdlsGen2StorageAccountDataSetMapping {
    pub fn new(properties: AdlsGen2StorageAccountDataSetMappingProperties) -> Self {
        Self { properties }
    }
}
#[doc = "Properties of the ADLSGen2 storage account data set."]
...
impl BlobStorageAccountDataSet {
    pub fn new(properties: BlobStorageAccountDataSetProperties) -> Self {
        Self { properties }
    }
}
...
impl BlobStorageAccountDataSetMapping {
    pub fn new(properties: BlobStorageAccountDataSetMappingProperties) -> Self {
        Self { properties }
    }
}
#[doc = "Properties of the blob storage account data set."]
    ...
    impl Serialize for DataSetType {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::AdlsGen2StorageAccount => serializer.serialize_unit_variant("DataSetType", 8u32, "AdlsGen2StorageAccount"),
                Self::KustoCluster => serializer.serialize_unit_variant("DataSetType", 9u32, "KustoCluster"),
                Self::KustoDatabase => serializer.serialize_unit_variant("DataSetType", 10u32, "KustoDatabase"),
                Self::SqlDbTable => serializer.serialize_unit_variant("DataSetType", 11u32, "SqlDBTable"),
                Self::SqlDwTable => serializer.serialize_unit_variant("DataSetType", 12u32, "SqlDWTable"),
                Self::SynapseWorkspaceSqlPoolTable => {
                    serializer.serialize_unit_variant("DataSetType", 13u32, "SynapseWorkspaceSqlPoolTable")
                }
                Self::BlobStorageAccount => serializer.serialize_unit_variant("DataSetType", 14u32, "BlobStorageAccount"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
