    ...
    impl Serialize for DataSetType {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::KustoTable => serializer.serialize_unit_variant("DataSetType", 10u32, "KustoTable"),
    ...
    impl Serialize for Kind {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::KustoTable => serializer.serialize_unit_variant("Kind", 10u32, "KustoTable"),
    ...
    impl Serialize for Kind {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::KustoTable => serializer.serialize_unit_variant("Kind", 8u32, "KustoTable"),
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct KustoTableDataSet {
    #[serde(flatten)]
    pub data_set: DataSet,
    #[doc = "Properties of the kusto table data set."]
    pub properties: KustoTableDataSetProperties,
}
impl KustoTableDataSet {
    pub fn new(data_set: DataSet, properties: KustoTableDataSetProperties) -> Self {
        Self { data_set, properties }
    }
}
#[doc = "A Kusto database data set mapping"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct KustoTableDataSetMapping {
    #[serde(flatten)]
    pub data_set_mapping: DataSetMapping,
    #[doc = "Properties of the Kusto database data set mapping"]
    pub properties: KustoTableDataSetMappingProperties,
}
impl KustoTableDataSetMapping {
    pub fn new(data_set_mapping: DataSetMapping, properties: KustoTableDataSetMappingProperties) -> Self {
        Self {
            data_set_mapping,
            properties,
        }
...
#[doc = "Properties of the Kusto database data set mapping"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct KustoTableDataSetMappingProperties {
    #[doc = "The id of the source data set."]
    #[serde(rename = "dataSetId")]
    pub data_set_id: String,
    #[doc = "Gets the status of the data set mapping."]
    #[serde(rename = "dataSetMappingStatus", default, skip_serializing_if = "Option::is_none")]
    pub data_set_mapping_status: Option<kusto_table_data_set_mapping_properties::DataSetMappingStatus>,
    #[doc = "Resource id of the sink kusto cluster."]
    #[serde(rename = "kustoClusterResourceId")]
    pub kusto_cluster_resource_id: String,
    #[doc = "Location of the sink kusto cluster."]
    ...
    #[doc = "Provisioning state of the data set mapping."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<kusto_table_data_set_mapping_properties::ProvisioningState>,
}
impl KustoTableDataSetMappingProperties {
    pub fn new(data_set_id: String, kusto_cluster_resource_id: String) -> Self {
        Self {
            data_set_id,
            data_set_mapping_status: None,
...
pub mod kusto_table_data_set_mapping_properties {
    use super::*;
    #[doc = "Gets the status of the data set mapping."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "DataSetMappingStatus")]
...
#[doc = "Properties of the kusto table data set."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct KustoTableDataSetProperties {
    #[doc = "Unique id for identifying a data set resource"]
    #[serde(rename = "dataSetId", default, skip_serializing_if = "Option::is_none")]
    pub data_set_id: Option<String>,
    #[doc = "Resource id of the kusto database."]
    ...
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<kusto_table_data_set_properties::ProvisioningState>,
    #[doc = "Table level sharing properties dto for kusto data set properties"]
    #[serde(rename = "tableLevelSharingProperties")]
    pub table_level_sharing_properties: TableLevelSharingProperties,
}
impl KustoTableDataSetProperties {
    pub fn new(kusto_database_resource_id: String, table_level_sharing_properties: TableLevelSharingProperties) -> Self {
        Self {
            data_set_id: None,
            kusto_database_resource_id,
            location: None,
...
pub mod kusto_table_data_set_properties {
    use super::*;
    #[doc = "Provisioning state of the kusto table data set."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ProvisioningState")]
