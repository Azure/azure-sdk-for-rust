            ...
            S: Serializer,
        {
            match self {
                ...
                Self::SynapseWorkspaceSqlPoolTable => {
                    serializer.serialize_unit_variant("DataSetType", 12u32, "SynapseWorkspaceSqlPoolTable")
                }
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
...
pub struct EmailRegistration {
    ...
    #[serde(rename = "activationExpirationDate", default, with = "azure_core::date::rfc3339::option")]
    pub activation_expiration_date: Option<time::OffsetDateTime>,
