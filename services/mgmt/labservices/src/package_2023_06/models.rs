...
pub struct LabPlanProperties {
    ...
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<ProvisioningState>,
    #[doc = "Error details of the latest operation failure on this resource"]
...
pub struct ResourceOperationError {
    #[doc = "The datetime of when the error occured"]
    #[serde(default, with = "azure_core::date::rfc3339::option")]
    pub timestamp: Option<time::OffsetDateTime>,
    #[doc = "The code that corresponds to the type of operation failure"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub code: Option<String>,
    #[doc = "The operation failure message"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub message: Option<String>,
    #[doc = "The operation action that failed"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
