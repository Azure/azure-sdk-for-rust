...
pub struct DeletedService {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<DeletedServiceProperties>,
}
impl DeletedService {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "The response of a DeletedService list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct DeletedServiceListResult {
    #[doc = "The DeletedService items on this page"]
    pub value: Vec<DeletedService>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for DeletedServiceListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl DeletedServiceListResult {
    pub fn new(value: Vec<DeletedService>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Deleted service properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DeletedServiceProperties {
    ...
    #[serde(rename = "softDeletionDate", default, with = "azure_core::date::rfc3339::option")]
    pub soft_deletion_date: Option<::time::OffsetDateTime>,
}
impl DeletedServiceProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ServiceUpdate {
    ...
    #[doc = "The updatable properties of the Service."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ServiceUpdateProperties>,
}
impl ServiceUpdate {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "The updatable properties of the Service."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ServiceUpdateProperties {
    #[doc = "Flag used to restore soft-deleted API Center service. If specified and set to 'true' all other properties will be ignored."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub restore: Option<bool>,
}
impl ServiceUpdateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
