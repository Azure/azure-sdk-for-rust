        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::OperationListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    ...
                    async move {
                        let mut url =
                            azure_core::Url::parse(&format!("{}/providers/Microsoft.ApiCenter/operations", this.client.endpoint(),))?;
...
pub mod services {
    ...
    impl Client {
        ...
        #[doc = "Lists services within a resource group"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) service_name: String,
            pub(crate) resource: Option<models::Service>,
        }
        impl RequestBuilder {
            #[doc = "The service entity."]
            pub fn resource(mut self, resource: impl Into<models::Service>) -> Self {
    ...
    pub mod update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) service_name: String,
            pub(crate) parameters: Option<models::ServiceUpdate>,
        }
        impl RequestBuilder {
            #[doc = "The service properties to be updated."]
            pub fn parameters(mut self, parameters: impl Into<models::ServiceUpdate>) -> Self {
