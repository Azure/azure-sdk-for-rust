...
#[doc = "Defines the security user configuration"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SecurityUserConfiguration {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Defines the security user configuration properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<SecurityUserConfigurationPropertiesFormat>,
    #[doc = "Metadata pertaining to creation and last modification of the resource."]
    #[serde(rename = "systemData", default, skip_serializing_if = "Option::is_none")]
    pub system_data: Option<SystemData>,
}
...
#[doc = "A list of network manager security user configurations"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SecurityUserConfigurationListResult {
    #[doc = "Gets a page of security user configurations"]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub value: Vec<SecurityUserConfiguration>,
    #[doc = "Gets the URL to get the next page of results."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for SecurityUserConfigurationListResult {
    fn continuation(&self) -> Option<String> {
        self.next_link.clone()
    }
}
impl SecurityUserConfigurationListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Defines the security user configuration properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SecurityUserConfigurationPropertiesFormat {
    #[doc = "A description of the security user configuration."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    ...
    pub delete_existing_ns_gs: Option<security_user_configuration_properties_format::DeleteExistingNsGs>,
    #[doc = "The current provisioning state."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<ProvisioningState>,
}
impl SecurityUserConfigurationPropertiesFormat {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod security_user_configuration_properties_format {
    use super::*;
    #[doc = "Flag if need to delete existing network security groups."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "Defines the user rule collection."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct UserRuleCollection {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "Defines the user rule collection properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<UserRuleCollectionPropertiesFormat>,
    #[doc = "Metadata pertaining to creation and last modification of the resource."]
    #[serde(rename = "systemData", default, skip_serializing_if = "Option::is_none")]
    pub system_data: Option<SystemData>,
}
...
#[doc = "Security user configuration rule collection list result."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct UserRuleCollectionListResult {
    #[doc = "A list of network manager security user configuration rule collections"]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub value: Vec<UserRuleCollection>,
    #[doc = "Gets the URL to get the next set of results."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for UserRuleCollectionListResult {
    fn continuation(&self) -> Option<String> {
        self.next_link.clone()
    }
}
impl UserRuleCollectionListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Defines the user rule collection properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct UserRuleCollectionPropertiesFormat {
    #[doc = "A description of the user rule collection."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    #[doc = "Groups for configuration"]
    #[serde(rename = "appliesToGroups")]
...
impl UserRuleCollectionPropertiesFormat {
    pub fn new(applies_to_groups: Vec<NetworkManagerSecurityGroupItem>) -> Self {
        Self {
            description: None,
            applies_to_groups,
