...
pub mod express_route_circuits {
    ...
    pub mod list_arp_table {
        use super::models;
        type Response = models::ExpressRouteCircuitsArpTableListResult;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("Unexpected HTTP status code {}", status_code)]
            UnexpectedResponse { status_code: http::StatusCode, body: bytes::Bytes },
    ...
    pub mod list_routes_table {
        use super::models;
        type Response = models::ExpressRouteCircuitsRoutesTableListResult;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("Unexpected HTTP status code {}", status_code)]
            UnexpectedResponse { status_code: http::StatusCode, body: bytes::Bytes },
    ...
    pub mod list_stats {
        use super::models;
        type Response = models::ExpressRouteCircuitsStatsListResult;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("Unexpected HTTP status code {}", status_code)]
            UnexpectedResponse { status_code: http::StatusCode, body: bytes::Bytes },
...
pub mod virtual_network_gateway_connections {
    ...
    pub mod get_shared_key {
        use super::models;
        type Response = models::ConnectionSharedKeyResult;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("Unexpected HTTP status code {}", status_code)]
            UnexpectedResponse { status_code: http::StatusCode, body: bytes::Bytes },
