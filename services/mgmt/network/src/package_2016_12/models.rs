...
pub struct ApplicationGatewayBackendHealthServer {
    ...
    #[doc = "Health of backend server. Possible values are: 'Unknown', 'Up', 'Down', and 'Partial'."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct ApplicationGatewaySku {
    ...
    #[doc = "Tier of an application gateway. Possible values are: 'Standard' and 'WAF'."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct ApplicationGatewaySslPolicy {
    #[doc = "SSL protocols to be disabled on application gateway. Possible values are: 'TLSv1_0', 'TLSv1_1', and 'TLSv1_2'."]
...
pub struct ApplicationGatewayWebApplicationFirewallConfiguration {
    ...
    pub enabled: bool,
    #[doc = "Web application firewall mode. Possible values are: 'Detection' and 'Prevention'."]
...
pub struct EffectiveNetworkSecurityRule {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "The network protocol this rule applies to. Possible values are: 'Tcp', 'Udp', and '*'."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct VirtualNetworkGatewaySku {
    #[doc = "Gateway SKU name. Possible values are: 'Basic', 'HighPerformance','Standard', and 'UltraPerformance'."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<virtual_network_gateway_sku::Name>,
    #[doc = "Gateway SKU tier. Possible values are: 'Basic', 'HighPerformance','Standard', and 'UltraPerformance'."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
