...
pub struct PrivateEndpointListResult {
    #[doc = "Gets a list of private endpoint resources in a resource group."]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
...
pub struct PrivateEndpointProperties {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub subnet: Option<Subnet>,
    #[doc = "Gets an array of references to the network interfaces created for this private endpoint."]
    #[serde(rename = "networkInterfaces", default, skip_serializing_if = "Vec::is_empty")]
    pub network_interfaces: Vec<NetworkInterface>,
    #[doc = "The current provisioning state."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
...
pub struct PrivateLinkServiceListResult {
    #[doc = "Gets a list of PrivateLinkService resources in a resource group."]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
...
pub struct PrivateLinkServiceProperties {
    ...
    #[doc = "An array of references to the private link service IP configuration."]
    #[serde(rename = "ipConfigurations", default, skip_serializing_if = "Vec::is_empty")]
    pub ip_configurations: Vec<PrivateLinkServiceIpConfiguration>,
    #[doc = "Gets an array of references to the network interfaces created for this private link service."]
    #[serde(rename = "networkInterfaces", default, skip_serializing_if = "Vec::is_empty")]
    pub network_interfaces: Vec<NetworkInterface>,
    #[doc = "The current provisioning state."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
...
pub struct SubnetPropertiesFormat {
    ...
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<String>,
    #[doc = "Enable or Disable private end point on the subnet."]
    ...
    #[doc = "Enable or Disable private link service on the subnet."]
