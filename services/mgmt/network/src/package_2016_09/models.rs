...
pub struct ApplicationGatewayWebApplicationFirewallConfiguration {
    #[doc = "Whether the web application firewall is enabled."]
    pub enabled: bool,
...
impl LocalNetworkGatewayPropertiesFormat {
    pub fn new(local_network_address_space: AddressSpace) -> Self {
        Self {
...
impl VirtualNetworkGatewayPropertiesFormat {
    pub fn new(
        ip_configurations: Vec<VirtualNetworkGatewayIpConfiguration>,
        gateway_type: virtual_network_gateway_properties_format::GatewayType,
        vpn_type: virtual_network_gateway_properties_format::VpnType,
    ) -> Self {
        Self {
            ip_configurations,
            gateway_type,
...
impl VirtualNetworkGatewaySku {
    pub fn new(name: virtual_network_gateway_sku::Name, tier: virtual_network_gateway_sku::Tier) -> Self {
        Self {
            name,
            tier,
            capacity: None,
