...
pub struct ApplicationGatewayBackendHttpSettingsPropertiesFormat {
    ...
    #[doc = "Gets or sets request timeout"]
...
pub struct ApplicationGatewayHttpListenerPropertiesFormat {
    ...
    #[doc = "Gets or sets the host name of http listener "]
    ...
    #[doc = "Gets or sets the requireServerNameIndication of http listener "]
...
pub struct ApplicationGatewayPathRulePropertiesFormat {
    #[doc = "Gets or sets the path rules of URL path map"]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    ...
    #[doc = "Gets or sets path rule of URL path map resource Updating/Deleting/Failed"]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<String>,
}
...
pub struct ApplicationGatewayProbePropertiesFormat {
    ...
    #[doc = "Gets or sets the host to send probe to "]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub host: Option<String>,
    #[doc = "Gets or sets the relative path of probe "]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub path: Option<String>,
    #[doc = "Gets or sets probing interval in seconds "]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub interval: Option<i32>,
    #[doc = "Gets or sets probing timeout in seconds "]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub timeout: Option<i32>,
    #[doc = "Gets or sets probing unhealthy threshold "]
...
pub struct ApplicationGatewayPropertiesFormat {
    ...
    #[doc = "Gets or sets probes of application gateway resource"]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    ...
    #[doc = "Gets or sets URL path map of application gateway resource"]
...
pub struct ApplicationGatewayUrlPathMapPropertiesFormat {
    ...
    #[doc = "Gets or sets path rule of URL path map resource"]
...
pub struct VpnClientRevokedCertificatePropertiesFormat {
    ...
    #[doc = "Gets or sets Provisioning state of the VPN client revoked certificate resource Updating/Deleting/Failed"]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<String>,
}
...
pub struct VpnClientRootCertificatePropertiesFormat {
    ...
    #[serde(rename = "publicCertData", default, skip_serializing_if = "Option::is_none")]
    pub public_cert_data: Option<String>,
    #[doc = "Gets or sets Provisioning state of the VPN client root certificate resource Updating/Deleting/Failed"]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<String>,
}
