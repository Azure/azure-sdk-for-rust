...
pub struct ManagedRuleOverride {
    ...
    #[serde(rename = "ruleId")]
    pub rule_id: String,
    #[doc = "Describes the state of the managed rule. Defaults to Disabled if not specified."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct ManagedRulesDefinition {
    #[doc = "Describes the Exclusions that are applied on the policy."]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub exclusions: Vec<OwaspCrsExclusionEntry>,
    #[doc = "Describes the ruleSets that are associated with the policy."]
