...
impl NetworkGroupProperties {
    pub fn new(member_type: String) -> Self {
        Self {
            display_name: None,
            description: None,
            member_type,
...
impl NetworkManagerCommit {
    pub fn new(target_locations: Vec<String>) -> Self {
        Self {
            commit_id: None,
            target_locations,
...
pub mod network_manager_properties {
    ...
    pub struct NetworkManagerScopes {
        ...
        #[serde(rename = "crossTenantScopes", default, skip_serializing_if = "Vec::is_empty")]
...
pub struct SecurityConfigurationPropertiesFormat {
    ...
    #[serde(rename = "applyOnNetworkIntentPolicyBasedServices", default, skip_serializing_if = "Vec::is_empty")]
