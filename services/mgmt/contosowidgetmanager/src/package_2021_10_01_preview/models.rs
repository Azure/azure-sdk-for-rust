...
pub struct Employee {
    ...
    pub properties: Option<EmployeeProperties>,
}
impl Employee {
...
#[doc = "The response of a Employee list operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct EmployeeListResult {
    #[doc = "The Employee items on this page"]
    pub value: Vec<Employee>,
    #[doc = "The link to the next page of items"]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for EmployeeListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl EmployeeListResult {
    pub fn new(value: Vec<Employee>) -> Self {
        Self { value, next_link: None }
    }
}
#[doc = "Employee properties"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EmployeeProperties {
    #[doc = "Age of employee"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub age: Option<i32>,
...
pub struct EmployeeUpdate {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<EmployeeUpdateProperties>,
}
impl EmployeeUpdate {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "The updatable properties of the Employee."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EmployeeUpdateProperties {
    #[doc = "Age of employee"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub age: Option<i32>,
    #[doc = "City of employee"]
