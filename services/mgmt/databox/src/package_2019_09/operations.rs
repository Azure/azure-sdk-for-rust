...
pub mod jobs {
    ...
    pub async fn book_shipment_pick_up(
        ...
        match rsp.status() {
            ...
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(book_shipment_pick_up::ResponseBytesError)?;
                let rsp_value: CloudError = serde_json::from_slice(&body).context(book_shipment_pick_up::DeserializeError { body })?;
...
pub mod service {
    ...
    pub async fn list_available_skus(
        ...
        match rsp.status() {
            ...
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(list_available_skus::ResponseBytesError)?;
                let rsp_value: CloudError = serde_json::from_slice(&body).context(list_available_skus::DeserializeError { body })?;
    ...
    pub async fn validate_address(
        ...
        match rsp.status() {
            ...
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(validate_address::ResponseBytesError)?;
                let rsp_value: CloudError = serde_json::from_slice(&body).context(validate_address::DeserializeError { body })?;
    ...
    pub async fn validate_inputs(
        ...
        match rsp.status() {
            ...
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(validate_inputs::ResponseBytesError)?;
                let rsp_value: CloudError = serde_json::from_slice(&body).context(validate_inputs::DeserializeError { body })?;
    ...
    pub async fn region_configuration(
        ...
        match rsp.status() {
            ...
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(region_configuration::ResponseBytesError)?;
                let rsp_value: CloudError = serde_json::from_slice(&body).context(region_configuration::DeserializeError { body })?;
