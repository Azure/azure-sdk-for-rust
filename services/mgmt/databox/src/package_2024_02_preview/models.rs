...
impl ContactInfo {
    pub fn new(contact_name: String, phone: String) -> Self {
        Self {
            contact_name,
            phone,
            phone_extension: None,
...
pub enum DataAccountDetailsUnion {
    ManagedDisk(ManagedDiskDetails),
    StorageAccount(StorageAccountDetails),
}
...
pub struct DataExportDetails {
    ...
    pub account_details: DataAccountDetailsUnion,
}
impl DataExportDetails {
    pub fn new(transfer_configuration: TransferConfiguration, account_details: DataAccountDetailsUnion) -> Self {
        Self {
...
impl DataImportDetails {
    pub fn new(account_details: DataAccountDetailsUnion) -> Self {
        Self {
            account_details,
            log_collection_level: None,
        }
...
#[doc = "Device capability details for a given sku for a given region."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DeviceCapabilityDetails {
    #[doc = "Hardware encryption support for a given sku for a given region."]
    #[serde(rename = "hardwareEncryption", default, skip_serializing_if = "Option::is_none")]
    pub hardware_encryption: Option<device_capability_details::HardwareEncryption>,
}
impl DeviceCapabilityDetails {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod device_capability_details {
    use super::*;
    #[doc = "Hardware encryption support for a given sku for a given region."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "Device capabilities for given sku in a region"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DeviceCapabilityResponse {
    #[doc = "List of device capabilities available for a given region and a given sku"]
    #[serde(
        rename = "deviceCapabilityDetails",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub device_capability_details: Vec<DeviceCapabilityDetails>,
}
impl DeviceCapabilityResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub enum GranularCopyLogDetailsUnion {
    DataBoxCustomerDisk(DataBoxDiskGranularCopyLogDetails),
}
...
#[doc = "Job Delay Notification details"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub mod job_delay_details {
    ...
    impl Serialize for ErrorCode {
        ...
        {
            match self {
                Self::InternalIssueDelay => serializer.serialize_unit_variant("ErrorCode", 0u32, "InternalIssueDelay"),
                Self::ActiveOrderLimitBreachedDelay => {
                    serializer.serialize_unit_variant("ErrorCode", 1u32, "ActiveOrderLimitBreachedDelay")
                }
                Self::HighDemandDelay => serializer.serialize_unit_variant("ErrorCode", 2u32, "HighDemandDelay"),
                Self::LargeNumberOfFilesDelay => serializer.serialize_unit_variant("ErrorCode", 3u32, "LargeNumberOfFilesDelay"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct JobDetails {
    ...
    pub copy_log_details: Vec<CopyLogDetailsUnion>,
    ...
    pub datacenter_address: Option<DatacenterAddressResponseUnion>,
    #[doc = "DataCenter code."]
    ...
    impl Serialize for DataCenterCode {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Bl24 => serializer.serialize_unit_variant("DataCenterCode", 59u32, "BL24"),
                Self::Idc5 => serializer.serialize_unit_variant("DataCenterCode", 60u32, "IDC5"),
                Self::Tyo23 => serializer.serialize_unit_variant("DataCenterCode", 61u32, "TYO23"),
                Self::Ntg20 => serializer.serialize_unit_variant("DataCenterCode", 62u32, "NTG20"),
                Self::Dxb23 => serializer.serialize_unit_variant("DataCenterCode", 63u32, "DXB23"),
                Self::Dsm11 => serializer.serialize_unit_variant("DataCenterCode", 64u32, "DSM11"),
                Self::Ams25 => serializer.serialize_unit_variant("DataCenterCode", 65u32, "AMS25"),
                Self::Cpq21 => serializer.serialize_unit_variant("DataCenterCode", 66u32, "CPQ21"),
                Self::Osa23 => serializer.serialize_unit_variant("DataCenterCode", 67u32, "OSA23"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct JobProperties {
    ...
    #[doc = "Job details."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub details: Option<JobDetailsUnion>,
    #[doc = "Reason for cancellation."]
    ...
    #[doc = "Flag to indicate if all devices associated with the job are lost."]
    #[serde(rename = "allDevicesLost", default, skip_serializing_if = "Option::is_none")]
    pub all_devices_lost: Option<bool>,
}
impl JobProperties {
    pub fn new(transfer_type: job_properties::TransferType) -> Self {
        Self {
            ...
            reverse_shipping_details_update: None,
            reverse_transport_preference_update: None,
...
pub mod job_properties {
    ...
    #[doc = "The Editable status for Reverse Shipping Address and Contact Info"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum ReverseShippingDetailsUpdate {
        Enabled,
        Disabled,
        NotSupported,
    }
    #[doc = "The Editable status for Reverse Transport preferences"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum ReverseTransportPreferenceUpdate {
        Enabled,
        Disabled,
        NotSupported,
    }
    ...
    #[doc = "Name of the stage where delay might be present."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "DelayedStage")]
    pub enum DelayedStage {
        DeviceOrdered,
        DevicePrepared,
        Dispatched,
        Delivered,
    ...
    impl FromStr for DelayedStage {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for DelayedStage {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for DelayedStage {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::DeviceOrdered => serializer.serialize_unit_variant("DelayedStage", 0u32, "DeviceOrdered"),
                Self::DevicePrepared => serializer.serialize_unit_variant("DelayedStage", 1u32, "DevicePrepared"),
                Self::Dispatched => serializer.serialize_unit_variant("DelayedStage", 2u32, "Dispatched"),
                Self::Delivered => serializer.serialize_unit_variant("DelayedStage", 3u32, "Delivered"),
                Self::PickedUp => serializer.serialize_unit_variant("DelayedStage", 4u32, "PickedUp"),
                Self::AtAzureDc => serializer.serialize_unit_variant("DelayedStage", 5u32, "AtAzureDC"),
                Self::DataCopy => serializer.serialize_unit_variant("DelayedStage", 6u32, "DataCopy"),
                Self::Completed => serializer.serialize_unit_variant("DelayedStage", 7u32, "Completed"),
                Self::CompletedWithErrors => serializer.serialize_unit_variant("DelayedStage", 8u32, "CompletedWithErrors"),
                Self::Cancelled => serializer.serialize_unit_variant("DelayedStage", 9u32, "Cancelled"),
                Self::FailedIssueReportedAtCustomer => {
                    serializer.serialize_unit_variant("DelayedStage", 10u32, "Failed_IssueReportedAtCustomer")
                }
                Self::FailedIssueDetectedAtAzureDc => {
                    serializer.serialize_unit_variant("DelayedStage", 11u32, "Failed_IssueDetectedAtAzureDC")
                }
                Self::Aborted => serializer.serialize_unit_variant("DelayedStage", 12u32, "Aborted"),
                Self::CompletedWithWarnings => serializer.serialize_unit_variant("DelayedStage", 13u32, "CompletedWithWarnings"),
                Self::ReadyToDispatchFromAzureDc => serializer.serialize_unit_variant("DelayedStage", 14u32, "ReadyToDispatchFromAzureDC"),
                Self::ReadyToReceiveAtAzureDc => serializer.serialize_unit_variant("DelayedStage", 15u32, "ReadyToReceiveAtAzureDC"),
                Self::Created => serializer.serialize_unit_variant("DelayedStage", 16u32, "Created"),
                Self::ShippedToAzureDc => serializer.serialize_unit_variant("DelayedStage", 17u32, "ShippedToAzureDC"),
                Self::AwaitingShipmentDetails => serializer.serialize_unit_variant("DelayedStage", 18u32, "AwaitingShipmentDetails"),
                Self::PreparingToShipFromAzureDc => serializer.serialize_unit_variant("DelayedStage", 19u32, "PreparingToShipFromAzureDC"),
                Self::ShippedToCustomer => serializer.serialize_unit_variant("DelayedStage", 20u32, "ShippedToCustomer"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct JobStages {
    ...
    #[doc = "Delay information for the job stages."]
    #[serde(
        rename = "delayInformation",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub delay_information: Vec<JobDelayDetails>,
}
impl JobStages {
    pub fn new() -> Self {
        Self::default()
...
pub struct MitigateJobRequest {
    ...
    pub serial_number_customer_resolution_map: Option<serde_json::Value>,
}
...
pub struct Preferences {
    ...
    #[doc = "Preferences related to the shipment logistics of the sku"]
    #[serde(rename = "reverseTransportPreferences", default, skip_serializing_if = "Option::is_none")]
    pub reverse_transport_preferences: Option<TransportPreferences>,
    #[doc = "Preferences related to the Encryption."]
    ...
    #[serde(
        rename = "storageAccountAccessTierPreferences",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
...
pub struct RegionConfigurationRequest {
    ...
    pub schedule_availability_request: Option<ScheduleAvailabilityRequestUnion>,
    ...
    #[doc = "Request body to get the device capabilities for given sku."]
    #[serde(rename = "deviceCapabilityRequest", default, skip_serializing_if = "Option::is_none")]
    pub device_capability_request: Option<DeviceCapabilityRequest>,
}
...
pub struct RegionConfigurationResponse {
    ...
    #[doc = "Device capabilities for given sku in a region"]
    #[serde(rename = "deviceCapabilityResponse", default, skip_serializing_if = "Option::is_none")]
    pub device_capability_response: Option<DeviceCapabilityResponse>,
}
...
pub struct SkuProperties {
    ...
    #[serde(
        rename = "countriesWithinCommerceBoundary",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub countries_within_commerce_boundary: Vec<String>,
}
impl SkuProperties {
    pub fn new() -> Self {
        Self::default()
...
pub struct UnencryptedCredentials {
    ...
    pub job_secrets: Option<JobSecretsUnion>,
}
...
pub enum ValidationRequestUnion {
    JobCreationValidation(CreateJobValidations),
}
...
pub struct ValidationResponseProperties {
    ...
    pub individual_response_details: Vec<ValidationInputResponseUnion>,
}
