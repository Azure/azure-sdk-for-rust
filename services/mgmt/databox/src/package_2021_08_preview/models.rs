    ...
    impl Serialize for DataCenterCode {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Bn7 => serializer.serialize_unit_variant("DataCenterCode", 50u32, "BN7"),
                Self::Sn6 => serializer.serialize_unit_variant("DataCenterCode", 51u32, "SN6"),
                Self::Par22 => serializer.serialize_unit_variant("DataCenterCode", 52u32, "PAR22"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
