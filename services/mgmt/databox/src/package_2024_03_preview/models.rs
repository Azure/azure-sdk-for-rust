...
pub struct SkuCapacity {
    ...
    #[doc = "Maximum capacity per device in TB."]
    #[serde(rename = "individualSkuUsable", default, skip_serializing_if = "Option::is_none")]
    pub individual_sku_usable: Option<String>,
}
impl SkuCapacity {
    pub fn new() -> Self {
        Self::default()
