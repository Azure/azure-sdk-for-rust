...
impl Client {
    ...
    pub fn backup_instances_extension_routing_client(&self) -> backup_instances_extension_routing::Client {
        backup_instances_extension_routing::Client(self.clone())
    }
...
pub mod backup_instances {
    ...
    pub mod stop_protection {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) vault_name: String,
            pub(crate) backup_instance_name: String,
            pub(crate) parameters: Option<models::StopProtectionRequest>,
            pub(crate) x_ms_authorization_auxiliary: Option<String>,
        }
        impl RequestBuilder {
            #[doc = "Request body for operation"]
            pub fn parameters(mut self, parameters: impl Into<models::StopProtectionRequest>) -> Self {
    ...
    pub mod suspend_backups {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) vault_name: String,
            pub(crate) backup_instance_name: String,
            pub(crate) parameters: Option<models::SuspendBackupRequest>,
            pub(crate) x_ms_authorization_auxiliary: Option<String>,
        }
        impl RequestBuilder {
            #[doc = "Request body for operation"]
            pub fn parameters(mut self, parameters: impl Into<models::SuspendBackupRequest>) -> Self {
                self.parameters = Some(parameters.into());
                self
            }
            pub fn x_ms_authorization_auxiliary(mut self, x_ms_authorization_auxiliary: impl Into<String>) -> Self {
...
pub mod backup_instances_extension_routing {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets a list of backup instances associated with a tracked resource"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_id`: ARM path of the resource to be protected using Microsoft.DataProtection"]
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/{}/providers/Microsoft.DataProtection/backupInstances",
                    &self.resource_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
