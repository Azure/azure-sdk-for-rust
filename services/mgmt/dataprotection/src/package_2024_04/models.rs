...
pub struct AzureBackupDiscreteRecoveryPoint {
    ...
    #[serde(rename = "recoveryPointState", default, skip_serializing_if = "Option::is_none")]
    pub recovery_point_state: Option<azure_backup_discrete_recovery_point::RecoveryPointState>,
}
impl AzureBackupDiscreteRecoveryPoint {
    pub fn new(recovery_point_time: ::time::OffsetDateTime) -> Self {
        Self {
            ...
            expiry_time: None,
            recovery_point_state: None,
        }
    }
}
pub mod azure_backup_discrete_recovery_point {
    use super::*;
    #[doc = "Specifies recovery point completeness. Partial (i.e., only some of the intended items were backed up), or Completed (i.e., ALL intended items were backed up)."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "RecoveryPointState")]
    ...
    impl FromStr for RecoveryPointState {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for RecoveryPointState {
    ...
    impl Serialize for RecoveryPointState {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Completed => serializer.serialize_unit_variant("RecoveryPointState", 0u32, "Completed"),
                Self::Partial => serializer.serialize_unit_variant("RecoveryPointState", 1u32, "Partial"),
...
pub struct BackupVault {
    ...
    #[doc = "Security Level of Backup Vault"]
    #[serde(rename = "bcdrSecurityLevel", default, skip_serializing_if = "Option::is_none")]
    pub bcdr_security_level: Option<backup_vault::BcdrSecurityLevel>,
    #[doc = "ResourceGuardOperationRequests on which LAC check will be performed"]
    #[serde(
        rename = "resourceGuardOperationRequests",
        default,
...
pub mod backup_vault {
    ...
    #[doc = "Security Level of Backup Vault"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "BcdrSecurityLevel")]
    pub enum BcdrSecurityLevel {
        Poor,
        Fair,
        Good,
        Excellent,
    ...
    impl FromStr for BcdrSecurityLevel {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for BcdrSecurityLevel {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for BcdrSecurityLevel {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Poor => serializer.serialize_unit_variant("BcdrSecurityLevel", 0u32, "Poor"),
                Self::Fair => serializer.serialize_unit_variant("BcdrSecurityLevel", 1u32, "Fair"),
                Self::Good => serializer.serialize_unit_variant("BcdrSecurityLevel", 2u32, "Good"),
                Self::Excellent => serializer.serialize_unit_variant("BcdrSecurityLevel", 3u32, "Excellent"),
                Self::NotSupported => serializer.serialize_unit_variant("BcdrSecurityLevel", 4u32, "NotSupported"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
impl BlobBackupDatasourceParameters {
    pub fn new(containers_list: Vec<String>) -> Self {
...
#[doc = "The details of the managed identity used for CMK"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CmkKekIdentity {
    #[doc = "The identity type. 'SystemAssigned' and 'UserAssigned' are mutually exclusive. 'SystemAssigned' will use implicitly created managed identity."]
    #[serde(rename = "identityType", default, skip_serializing_if = "Option::is_none")]
    pub identity_type: Option<cmk_kek_identity::IdentityType>,
    #[doc = "The managed identity to be used which has access permissions to the Key Vault. Provide a value here in case identity types: 'UserAssigned' only."]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CrossRegionRestoreDetails {
    #[serde(rename = "sourceRegion")]
    pub source_region: String,
    #[serde(rename = "sourceBackupInstanceId")]
    pub source_backup_instance_id: String,
}
impl CrossRegionRestoreDetails {
    pub fn new(source_region: String, source_backup_instance_id: String) -> Self {
        Self {
            source_region,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CrossRegionRestoreJobRequest {
    #[serde(rename = "sourceRegion")]
    pub source_region: String,
    #[serde(rename = "sourceBackupVaultId")]
    pub source_backup_vault_id: String,
    #[serde(rename = "jobId")]
    pub job_id: String,
}
impl CrossRegionRestoreJobRequest {
    pub fn new(source_region: String, source_backup_vault_id: String, job_id: String) -> Self {
        Self {
            source_region,
            source_backup_vault_id,
            job_id,
        }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CrossRegionRestoreJobsRequest {
    #[serde(rename = "sourceRegion")]
    pub source_region: String,
    #[serde(rename = "sourceBackupVaultId")]
    pub source_backup_vault_id: String,
}
impl CrossRegionRestoreJobsRequest {
    pub fn new(source_region: String, source_backup_vault_id: String) -> Self {
        Self {
            source_region,
            source_backup_vault_id,
        }
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CrossRegionRestoreRequestObject {
    #[doc = "Azure backup restore request"]
    #[serde(rename = "restoreRequestObject")]
    pub restore_request_object: AzureBackupRestoreRequestUnion,
    #[doc = "Cross Region Restore details"]
    #[serde(rename = "crossRegionRestoreDetails")]
    pub cross_region_restore_details: CrossRegionRestoreDetails,
}
impl CrossRegionRestoreRequestObject {
    pub fn new(restore_request_object: AzureBackupRestoreRequestUnion, cross_region_restore_details: CrossRegionRestoreDetails) -> Self {
        Self {
...
#[doc = "Information about BI whose secondary RecoveryPoints are requested\r\nSource region and\r\nBI ARM path"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct FetchSecondaryRPsRequestParameters {
    ...
    #[serde(rename = "sourceBackupInstanceId", default, skip_serializing_if = "Option::is_none")]
    pub source_backup_instance_id: Option<String>,
}
impl FetchSecondaryRPsRequestParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl ItemPathBasedRestoreCriteria {
    pub fn new(item_path: String, is_path_relative_to_backup_item: bool) -> Self {
        Self {
            item_path,
...
pub struct JobExtendedInfo {
    ...
    pub warning_details: Vec<UserFacingWarningDetail>,
}
...
impl KubernetesClusterBackupDatasourceParameters {
    pub fn new(snapshot_volumes: bool, include_cluster_scope_resources: bool) -> Self {
        Self {
            snapshot_volumes,
...
pub struct KubernetesClusterRestoreCriteria {
    ...
    #[serde(rename = "resourceModifierReference", default, skip_serializing_if = "Option::is_none")]
    pub resource_modifier_reference: Option<NamespacedNameResource>,
}
impl KubernetesClusterRestoreCriteria {
    pub fn new(include_cluster_scope_resources: bool) -> Self {
        Self {
            include_cluster_scope_resources,
            included_namespaces: Vec::new(),
            excluded_namespaces: Vec::new(),
            ...
            resource_modifier_reference: None,
        }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct KubernetesClusterVaultTierRestoreCriteria {
    ...
    #[serde(rename = "persistentVolumeRestoreMode", default, skip_serializing_if = "Option::is_none")]
    pub persistent_volume_restore_mode: Option<kubernetes_cluster_vault_tier_restore_criteria::PersistentVolumeRestoreMode>,
    ...
    #[serde(rename = "conflictPolicy", default, skip_serializing_if = "Option::is_none")]
    pub conflict_policy: Option<kubernetes_cluster_vault_tier_restore_criteria::ConflictPolicy>,
    ...
    #[serde(rename = "stagingResourceGroupId", default, skip_serializing_if = "Option::is_none")]
    pub staging_resource_group_id: Option<String>,
    ...
    #[serde(rename = "stagingStorageAccountId", default, skip_serializing_if = "Option::is_none")]
    pub staging_storage_account_id: Option<String>,
    #[doc = "Class to refer resources which contains namespace and name"]
    #[serde(rename = "resourceModifierReference", default, skip_serializing_if = "Option::is_none")]
    pub resource_modifier_reference: Option<NamespacedNameResource>,
}
impl KubernetesClusterVaultTierRestoreCriteria {
    pub fn new(include_cluster_scope_resources: bool) -> Self {
        Self {
            include_cluster_scope_resources,
            included_namespaces: Vec::new(),
            ...
            namespace_mappings: None,
            restore_hook_references: Vec::new(),
            staging_resource_group_id: None,
            staging_storage_account_id: None,
            resource_modifier_reference: None,
        }
    }
}
pub mod kubernetes_cluster_vault_tier_restore_criteria {
    use super::*;
    #[doc = "Gets or sets the PV (Persistent Volume) Restore Mode property. This property sets whether volumes needs to be restored from vault."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "PersistentVolumeRestoreMode")]
...
#[doc = "Request body of Stop protection when MUA is Enabled"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct StopProtectionRequest {
    #[doc = "ResourceGuardOperationRequests on which LAC check will be performed"]
    #[serde(
        rename = "resourceGuardOperationRequests",
        default,
...
#[doc = "Request body of Suspend backup when MUA is Enabled"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SuspendBackupRequest {
    #[doc = "ResourceGuardOperationRequests on which LAC check will be performed"]
    #[serde(
        rename = "resourceGuardOperationRequests",
        default,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct UserFacingWarningDetail {
    #[doc = "Name of resource for which warning is raised."]
    #[serde(rename = "resourceName", default, skip_serializing_if = "Option::is_none")]
    pub resource_name: Option<String>,
    #[doc = "Error object used by layers that have access to localized content, and propagate that to user"]
    pub warning: UserFacingError,
}
impl UserFacingWarningDetail {
    pub fn new(warning: UserFacingError) -> Self {
        Self {
            resource_name: None,
            warning,
        }
...
#[doc = "Cross Region Restore Request Object"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ValidateCrossRegionRestoreRequestObject {
    #[doc = "Azure backup restore request"]
    #[serde(rename = "restoreRequestObject")]
    pub restore_request_object: AzureBackupRestoreRequestUnion,
    #[doc = "Cross Region Restore details"]
...
impl ValidateCrossRegionRestoreRequestObject {
    pub fn new(restore_request_object: AzureBackupRestoreRequestUnion, cross_region_restore_details: CrossRegionRestoreDetails) -> Self {
        Self {
            restore_request_object,
            cross_region_restore_details,
...
pub struct EncryptionSettings {
    #[doc = "Encryption state of the Backup Vault."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<encryption_settings::State>,
    #[doc = "The properties of the Key Vault which hosts CMK"]
    ...
    pub infrastructure_encryption: Option<encryption_settings::InfrastructureEncryption>,
}
    ...
    impl Serialize for State {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Inconsistent => serializer.serialize_unit_variant("State", 2u32, "Inconsistent"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
