...
#[doc = "Properties which are specific to datasource/datasourcesets/backupinstanceref/backupsettings"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "VMware VM specific data source properties"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct VmwareVmProperties {
    #[serde(flatten)]
    pub base_resource_properties: BaseResourceProperties,
    #[doc = "Unique Identifier of Vmware VM on VCenter (guid)"]
    #[serde(rename = "instanceUuid", default, skip_serializing_if = "Option::is_none")]
    pub instance_uuid: Option<String>,
}
impl VmwareVmProperties {
