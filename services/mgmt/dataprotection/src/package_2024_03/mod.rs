...
impl Client {
    ...
    pub fn deleted_backup_instances_client(&self) -> deleted_backup_instances::Client {
        deleted_backup_instances::Client(self.clone())
    }
    pub fn dpp_resource_guard_proxy_client(&self) -> dpp_resource_guard_proxy::Client {
        dpp_resource_guard_proxy::Client(self.clone())
    }
    ...
    pub fn fetch_cross_region_restore_job_client(&self) -> fetch_cross_region_restore_job::Client {
        fetch_cross_region_restore_job::Client(self.clone())
    }
    pub fn fetch_cross_region_restore_jobs_client(&self) -> fetch_cross_region_restore_jobs::Client {
        fetch_cross_region_restore_jobs::Client(self.clone())
    }
    pub fn fetch_secondary_recovery_points_client(&self) -> fetch_secondary_recovery_points::Client {
        fetch_secondary_recovery_points::Client(self.clone())
    }
...
pub mod backup_vaults {
    ...
    impl Client {
        ...
        pub fn get_in_subscription(&self, subscription_id: impl Into<String>) -> get_in_subscription::RequestBuilder {
            get_in_subscription::RequestBuilder {
                client: self.0.clone(),
        ...
        ) -> get_in_resource_group::RequestBuilder {
            get_in_resource_group::RequestBuilder {
                client: self.0.clone(),
    ...
    pub mod get_in_subscription {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BackupVaultResourceList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BackupVaultResourceList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::BackupVaultResourceList, azure_core::error::Error> {
    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BackupVaultResource> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BackupVaultResource = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::BackupVaultResource>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::BackupVaultResource>>;
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    ...
                    &self.subscription_id, &self.resource_group_name, &self.location
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    ...
                    &self.subscription_id, &self.resource_group_name, &self.operation_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
...
pub mod data_protection_operations {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path("/providers/Microsoft.DataProtection/operations");
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01");
...
pub mod backup_policies {
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BaseBackupPolicyResourceList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BaseBackupPolicyResourceList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::BaseBackupPolicyResourceList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BaseBackupPolicyResource> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BaseBackupPolicyResource = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/backupVaults/{}/backupPolicies/{}",
                    &self.subscription_id, &self.resource_group_name, &self.vault_name, &self.backup_policy_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::BaseBackupPolicyResource>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::BaseBackupPolicyResource>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod backup_instances {
    ...
    impl Client {
        ...
        ) -> validate_for_backup::RequestBuilder {
            validate_for_backup::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        pub fn get_backup_instance_operation_result(
            ...
            backup_instance_name: impl Into<String>,
            operation_id: impl Into<String>,
        ) -> get_backup_instance_operation_result::RequestBuilder {
            get_backup_instance_operation_result::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        #[doc = "Triggers Cross Region Restore for BackupInstance."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `location`: The name of the Azure region."]
        #[doc = "* `parameters`: Request body for trigger CRR operation"]
        pub fn trigger_cross_region_restore(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            location: impl Into<String>,
            parameters: impl Into<models::CrossRegionRestoreRequestObject>,
        ) -> trigger_cross_region_restore::RequestBuilder {
            trigger_cross_region_restore::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        #[doc = "Validates whether Cross Region Restore can be triggered for DataSource."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `location`: The name of the Azure region."]
        #[doc = "* `parameters`: Request body for operation"]
        pub fn validate_cross_region_restore(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            location: impl Into<String>,
            parameters: impl Into<models::ValidateCrossRegionRestoreRequestObject>,
        ) -> validate_cross_region_restore::RequestBuilder {
            validate_cross_region_restore::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        pub fn trigger_rehydrate(
            ...
            backup_instance_name: impl Into<String>,
        ) -> trigger_rehydrate::RequestBuilder {
            trigger_rehydrate::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                subscription_id: subscription_id.into(),
        ...
        pub fn resume_protection(
            ...
            vault_name: impl Into<String>,
            backup_instance_name: impl Into<String>,
        ) -> resume_protection::RequestBuilder {
            resume_protection::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        pub fn stop_protection(
            ...
            vault_name: impl Into<String>,
            backup_instance_name: impl Into<String>,
        ) -> stop_protection::RequestBuilder {
            stop_protection::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        pub fn suspend_backups(
            ...
            vault_name: impl Into<String>,
            backup_instance_name: impl Into<String>,
        ) -> suspend_backups::RequestBuilder {
            suspend_backups::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        ) -> sync_backup_instance::RequestBuilder {
            sync_backup_instance::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        ) -> validate_for_restore::RequestBuilder {
            validate_for_restore::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BackupInstanceResourceList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BackupInstanceResourceList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::BackupInstanceResourceList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BackupInstanceResource> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BackupInstanceResource = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/backupVaults/{}/backupInstances/{}",
                    &self.subscription_id, &self.resource_group_name, &self.vault_name, &self.backup_instance_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::BackupInstanceResource>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::BackupInstanceResource>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod adhoc_backup {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::OperationJobExtendedInfo> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::OperationJobExtendedInfo = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::OperationJobExtendedInfo>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::OperationJobExtendedInfo>>;
    ...
    pub mod get_backup_instance_operation_result {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/backupVaults/{}/backupInstances/{}/operationResults/{}" , & self . subscription_id , & self . resource_group_name , & self . vault_name , & self . backup_instance_name , & self . operation_id)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01");
    ...
    pub mod trigger_cross_region_restore {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) location: String,
            pub(crate) parameters: models::CrossRegionRestoreRequestObject,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/locations/{}/crossRegionRestore",
                    &self.subscription_id, &self.resource_group_name, &self.location
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod validate_cross_region_restore {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) location: String,
            pub(crate) parameters: models::ValidateCrossRegionRestoreRequestObject,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/locations/{}/validateCrossRegionRestore",
                    &self.subscription_id, &self.resource_group_name, &self.location
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod resume_backups {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/backupVaults/{}/backupInstances/{}/resumeBackups" , & self . subscription_id , & self . resource_group_name , & self . vault_name , & self . backup_instance_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01");
    ...
    pub mod resume_protection {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/backupVaults/{}/backupInstances/{}/resumeProtection" , & self . subscription_id , & self . resource_group_name , & self . vault_name , & self . backup_instance_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01");
    ...
    pub mod stop_protection {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/backupVaults/{}/backupInstances/{}/stopProtection" , & self . subscription_id , & self . resource_group_name , & self . vault_name , & self . backup_instance_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01");
    ...
    pub mod suspend_backups {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/backupVaults/{}/backupInstances/{}/suspendBackups" , & self . subscription_id , & self . resource_group_name , & self . vault_name , & self . backup_instance_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01");
    ...
    pub mod validate_for_restore {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/backupVaults/{}/backupInstances/{}/validateRestore" , & self . subscription_id , & self . resource_group_name , & self . vault_name , & self . backup_instance_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01");
...
pub mod recovery_points {
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AzureBackupRecoveryPointResourceList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AzureBackupRecoveryPointResourceList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::AzureBackupRecoveryPointResourceList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/backupVaults/{}/backupInstances/{}/recoveryPoints" , & self . subscription_id , & self . resource_group_name , & self . vault_name , & self . backup_instance_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01");
    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AzureBackupRecoveryPointResource> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AzureBackupRecoveryPointResource = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/backupVaults/{}/backupInstances/{}/recoveryPoints/{}" , & self . subscription_id , & self . resource_group_name , & self . vault_name , & self . backup_instance_name , & self . recovery_point_id)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AzureBackupRecoveryPointResource>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::AzureBackupRecoveryPointResource>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod fetch_secondary_recovery_points {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    impl Client {
        ...
        pub fn list(
            ...
            resource_group_name: impl Into<String>,
            location: impl Into<String>,
            parameters: impl Into<models::FetchSecondaryRPsRequestParameters>,
        ) -> list::RequestBuilder {
            list::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
    ...
    pub mod list {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) location: String,
            pub(crate) parameters: models::FetchSecondaryRPsRequestParameters,
            pub(crate) filter: Option<String>,
            pub(crate) skip_token: Option<String>,
        }
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/locations/{}/fetchSecondaryRecoveryPoints",
                    &self.subscription_id, &self.resource_group_name, &self.location
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
...
pub mod fetch_cross_region_restore_job {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    impl Client {
        ...
        pub fn get(
            ...
            subscription_id: impl Into<String>,
            location: impl Into<String>,
            parameters: impl Into<models::CrossRegionRestoreJobRequest>,
        ) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AzureBackupJobResource> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AzureBackupJobResource = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) subscription_id: String,
            pub(crate) location: String,
            pub(crate) parameters: models::CrossRegionRestoreJobRequest,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/locations/{}/fetchCrossRegionRestoreJob",
                    &self.subscription_id, &self.resource_group_name, &self.location
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AzureBackupJobResource>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::AzureBackupJobResource>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod fetch_cross_region_restore_jobs {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    impl Client {
        ...
        pub fn list(
            ...
            subscription_id: impl Into<String>,
            location: impl Into<String>,
            parameters: impl Into<models::CrossRegionRestoreJobsRequest>,
        ) -> list::RequestBuilder {
            list::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AzureBackupJobResourceList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AzureBackupJobResourceList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) subscription_id: String,
            pub(crate) location: String,
            pub(crate) parameters: models::CrossRegionRestoreJobsRequest,
            pub(crate) filter: Option<String>,
        }
        impl RequestBuilder {
            #[doc = "OData filter options."]
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::AzureBackupJobResourceList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/locations/{}/fetchCrossRegionRestoreJobs",
                    &self.subscription_id, &self.resource_group_name, &self.location
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/backupVaults/{}/backupJobs/{}",
                    &self.subscription_id, &self.resource_group_name, &self.vault_name, &self.job_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
    ...
    pub mod find {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AzureBackupFindRestorableTimeRangesResponseResource> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AzureBackupFindRestorableTimeRangesResponseResource = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/backupVaults/{}/backupInstances/{}/findRestorableTimeRanges" , & self . subscription_id , & self . resource_group_name , & self . vault_name , & self . backup_instance_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AzureBackupFindRestorableTimeRangesResponseResource>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::AzureBackupFindRestorableTimeRangesResponseResource>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ExportJobsResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ExportJobsResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ExportJobsResult>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ExportJobsResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod deleted_backup_instances {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets deleted backup instances belonging to a backup vault"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Gets a deleted backup instance with name in a backup vault"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `vault_name`: The name of the backup vault."]
        #[doc = "* `backup_instance_name`: The name of the deleted backup instance"]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DeletedBackupInstanceResourceList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DeletedBackupInstanceResourceList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::DeletedBackupInstanceResourceList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/backupVaults/{}/deletedBackupInstances",
                    &self.subscription_id, &self.resource_group_name, &self.vault_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DeletedBackupInstanceResource> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DeletedBackupInstanceResource = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DeletedBackupInstanceResource>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DeletedBackupInstanceResource>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod undelete {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/backupVaults/{}/deletedBackupInstances/{}/undelete" , & self . subscription_id , & self . resource_group_name , & self . vault_name , & self . backup_instance_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01");
...
pub mod resource_guards {
    ...
    impl Client {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        pub fn get_resources_in_subscription(&self, subscription_id: impl Into<String>) -> get_resources_in_subscription::RequestBuilder {
            get_resources_in_subscription::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
            }
        }
        ...
        pub fn get_resources_in_resource_group(
            ...
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ) -> get_resources_in_resource_group::RequestBuilder {
            get_resources_in_resource_group::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        pub fn patch(
            ...
            subscription_id: impl Into<String>,
            resource_guards_name: impl Into<String>,
            parameters: impl Into<models::PatchResourceGuardInput>,
        ...
        pub fn get_disable_soft_delete_requests_objects(
            ...
            subscription_id: impl Into<String>,
            resource_guards_name: impl Into<String>,
        ) -> get_disable_soft_delete_requests_objects::RequestBuilder {
            get_disable_soft_delete_requests_objects::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                subscription_id: subscription_id.into(),
        ...
        pub fn get_delete_resource_guard_proxy_requests_objects(
            ...
            subscription_id: impl Into<String>,
            resource_guards_name: impl Into<String>,
        ) -> get_delete_resource_guard_proxy_requests_objects::RequestBuilder {
            get_delete_resource_guard_proxy_requests_objects::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                subscription_id: subscription_id.into(),
        ...
        pub fn get_backup_security_pin_requests_objects(
            ...
            subscription_id: impl Into<String>,
            resource_guards_name: impl Into<String>,
        ) -> get_backup_security_pin_requests_objects::RequestBuilder {
            get_backup_security_pin_requests_objects::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                subscription_id: subscription_id.into(),
        ...
        pub fn get_delete_protected_item_requests_objects(
            ...
            subscription_id: impl Into<String>,
            resource_guards_name: impl Into<String>,
        ) -> get_delete_protected_item_requests_objects::RequestBuilder {
            get_delete_protected_item_requests_objects::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                subscription_id: subscription_id.into(),
        ...
        pub fn get_update_protection_policy_requests_objects(
            ...
            subscription_id: impl Into<String>,
            resource_guards_name: impl Into<String>,
        ) -> get_update_protection_policy_requests_objects::RequestBuilder {
            get_update_protection_policy_requests_objects::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                subscription_id: subscription_id.into(),
        ...
        pub fn get_update_protected_item_requests_objects(
            ...
            subscription_id: impl Into<String>,
            resource_guards_name: impl Into<String>,
        ) -> get_update_protected_item_requests_objects::RequestBuilder {
            get_update_protected_item_requests_objects::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                subscription_id: subscription_id.into(),
        ...
        ) -> get_default_disable_soft_delete_requests_object::RequestBuilder {
            get_default_disable_soft_delete_requests_object::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                subscription_id: subscription_id.into(),
        ...
        pub fn get_default_delete_resource_guard_proxy_requests_object(
            ...
            resource_guards_name: impl Into<String>,
            request_name: impl Into<String>,
        ) -> get_default_delete_resource_guard_proxy_requests_object::RequestBuilder {
            get_default_delete_resource_guard_proxy_requests_object::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                subscription_id: subscription_id.into(),
        ...
        pub fn get_default_backup_security_pin_requests_object(
            ...
            resource_guards_name: impl Into<String>,
            request_name: impl Into<String>,
        ) -> get_default_backup_security_pin_requests_object::RequestBuilder {
            get_default_backup_security_pin_requests_object::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                subscription_id: subscription_id.into(),
        ...
        pub fn get_default_delete_protected_item_requests_object(
            ...
            resource_guards_name: impl Into<String>,
            request_name: impl Into<String>,
        ) -> get_default_delete_protected_item_requests_object::RequestBuilder {
            get_default_delete_protected_item_requests_object::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                subscription_id: subscription_id.into(),
        ...
        pub fn get_default_update_protection_policy_requests_object(
            ...
            resource_guards_name: impl Into<String>,
            request_name: impl Into<String>,
        ) -> get_default_update_protection_policy_requests_object::RequestBuilder {
            get_default_update_protection_policy_requests_object::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                subscription_id: subscription_id.into(),
        ...
        pub fn get_default_update_protected_item_requests_object(
            ...
            resource_guards_name: impl Into<String>,
            request_name: impl Into<String>,
        ) -> get_default_update_protected_item_requests_object::RequestBuilder {
            get_default_update_protected_item_requests_object::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                subscription_id: subscription_id.into(),
    ...
    pub mod get_resources_in_subscription {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ResourceGuardResourceList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ResourceGuardResourceList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ResourceGuardResourceList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ResourceGuardResource> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ResourceGuardResource = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/resourceGuards/{}",
                    &self.subscription_id, &self.resource_group_name, &self.resource_guards_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ResourceGuardResource>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ResourceGuardResource>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod patch {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) subscription_id: String,
            pub(crate) resource_guards_name: String,
            pub(crate) parameters: models::PatchResourceGuardInput,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod get_disable_soft_delete_requests_objects {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DppBaseResourceList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DppBaseResourceList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::DppBaseResourceList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod get_delete_resource_guard_proxy_requests_objects {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/resourceGuards/{}/deleteResourceGuardProxyRequests" , & self . subscription_id , & self . resource_group_name , & self . resource_guards_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01");
    ...
    pub mod get_update_protection_policy_requests_objects {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/resourceGuards/{}/updateProtectionPolicyRequests" , & self . subscription_id , & self . resource_group_name , & self . resource_guards_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01");
    ...
    pub mod get_default_disable_soft_delete_requests_object {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DppBaseResource> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DppBaseResource = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/resourceGuards/{}/disableSoftDeleteRequests/{}",
                    &self.subscription_id, &self.resource_group_name, &self.resource_guards_name, &self.request_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DppBaseResource>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DppBaseResource>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get_default_delete_resource_guard_proxy_requests_object {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/resourceGuards/{}/deleteResourceGuardProxyRequests/{}" , & self . subscription_id , & self . resource_group_name , & self . resource_guards_name , & self . request_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01");
    ...
    pub mod get_default_backup_security_pin_requests_object {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/resourceGuards/{}/getBackupSecurityPINRequests/{}" , & self . subscription_id , & self . resource_group_name , & self . resource_guards_name , & self . request_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01");
    ...
    pub mod get_default_delete_protected_item_requests_object {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/resourceGuards/{}/deleteProtectedItemRequests/{}" , & self . subscription_id , & self . resource_group_name , & self . resource_guards_name , & self . request_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01");
    ...
    pub mod get_default_update_protection_policy_requests_object {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/resourceGuards/{}/updateProtectionPolicyRequests/{}" , & self . subscription_id , & self . resource_group_name , & self . resource_guards_name , & self . request_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01");
    ...
    pub mod get_default_update_protected_item_requests_object {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/resourceGuards/{}/updateProtectedItemRequests/{}" , & self . subscription_id , & self . resource_group_name , & self . resource_guards_name , & self . request_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01");
...
pub mod dpp_resource_guard_proxy {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Returns the list of ResourceGuardProxies associated with the vault"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Returns the ResourceGuardProxy object associated with the vault, and that matches the name in the request"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `vault_name`: The name of the backup vault."]
        #[doc = "* `resource_guard_proxy_name`: name of the resource guard proxy"]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "Creates or Updates a ResourceGuardProxy"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Deletes the ResourceGuardProxy"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "UnlockDelete call for ResourceGuardProxy, executed before one can delete it"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/backupVaults/{}/backupResourceGuardProxies",
                    &self.subscription_id, &self.resource_group_name, &self.vault_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/backupVaults/{}/backupResourceGuardProxies/{}",
                    &self.subscription_id, &self.resource_group_name, &self.vault_name, &self.resource_guard_proxy_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ResourceGuardProxyBaseResource>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod unlock_delete {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url . set_path (& format ! ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DataProtection/backupVaults/{}/backupResourceGuardProxies/{}/unlockDelete" , & self . subscription_id , & self . resource_group_name , & self . vault_name , & self . resource_guard_proxy_name)) ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2024-03-01");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::UnlockDeleteResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
