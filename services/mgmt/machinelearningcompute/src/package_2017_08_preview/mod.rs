...
pub mod operationalization_clusters {
    ...
    impl Client {
        ...
        pub fn check_system_services_updates_available(
            ...
            resource_group_name: impl Into<String>,
            cluster_name: impl Into<String>,
        ) -> check_system_services_updates_available::Builder {
            check_system_services_updates_available::Builder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        pub fn update_system_services(
            ...
            resource_group_name: impl Into<String>,
            cluster_name: impl Into<String>,
        ) -> update_system_services::Builder {
            update_system_services::Builder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod list_keys {
        use super::models;
        type Response = models::OperationalizationClusterCredentials;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) subscription_id: String,
    ...
    pub mod check_system_services_updates_available {
        use super::models;
        type Response = models::CheckSystemServicesUpdatesAvailableResponse;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) subscription_id: String,
