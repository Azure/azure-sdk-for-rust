...
pub struct CapabilityTypeProperties {
    ...
    #[doc = "Array of control and data plane actions necessary to execute capability type."]
    #[serde(rename = "permissionsNecessary", default, skip_serializing_if = "Option::is_none")]
    pub permissions_necessary: Option<capability_type_properties::PermissionsNecessary>,
...
pub mod capability_type_properties {
    ...
    #[doc = "Array of control and data plane actions necessary to execute capability type."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
    pub struct PermissionsNecessary {
...
pub struct ResourceIdentity {
    ...
    #[doc = "The list of user identities associated with the experiment."]
