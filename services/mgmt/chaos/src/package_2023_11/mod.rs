...
pub mod experiments {
    ...
    impl Client {
        ...
        pub fn list_all_executions(
            ...
            resource_group_name: impl Into<String>,
            experiment_name: impl Into<String>,
        ) -> list_all_executions::RequestBuilder {
            list_all_executions::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        #[doc = "* `resource_group_name`: String that represents an Azure resource group."]
        #[doc = "* `experiment_name`: String that represents a Experiment resource name."]
        #[doc = "* `execution_id`: GUID that represents a Experiment execution detail."]
        ...
        pub fn execution_details(
            ...
            experiment_name: impl Into<String>,
            execution_id: impl Into<String>,
        ) -> execution_details::RequestBuilder {
            execution_details::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod list_all_executions {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ExperimentExecutionListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ExperimentExecutionListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ExperimentExecutionListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Chaos/experiments/{}/executions",
                    &self.subscription_id, &self.resource_group_name, &self.experiment_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod get_execution {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ExperimentExecution> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ExperimentExecution = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Chaos/experiments/{}/executions/{}",
                    &self.subscription_id, &self.resource_group_name, &self.experiment_name, &self.execution_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ExperimentExecution>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ExperimentExecution>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod execution_details {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Chaos/experiments/{}/executions/{}/getExecutionDetails",
                    &self.subscription_id, &self.resource_group_name, &self.experiment_name, &self.execution_id
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/providers/Microsoft.Chaos/locations/{}/operationStatuses/{}",
