...
pub struct AzureAdOnlyAuthentication {
    ...
    #[doc = "Azure Active Directory Only Authentication properties"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "A list of Azure Active Directory only authentications."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct AzureAdOnlyAuthenticationProperties {
    ...
    #[doc = "Azure Active Directory Only Authentication configuration state"]
...
impl IntegrationRuntimeEnableinteractivequery {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod integration_runtime_enableinteractivequery {
    use super::*;
    #[doc = "EnableInteractivequery status of  Integrationruntimes."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Status")]
...
pub struct ManagedVirtualNetworkSettings {
    ...
    #[serde(
        rename = "allowedAadTenantIdsForLinking",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
...
pub struct SelfHostedIntegrationRuntimeStatusTypeProperties {
    ...
    pub target_framework: Option<i32>,
}
