...
pub mod kusto_pools {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Lists eligible SKUs for Kusto Pool resource."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        ...
        pub fn list_skus_by_resource(
            ...
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ) -> list_skus_by_resource::RequestBuilder {
            list_skus_by_resource::RequestBuilder {
                client: self.0.clone(),
                workspace_name: workspace_name.into(),
                kusto_pool_name: kusto_pool_name.into(),
        ...
        #[doc = "Returns a list of language extensions that can run within KQL queries."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `workspace_name`: The name of the workspace."]
        #[doc = "* `kusto_pool_name`: The name of the Kusto pool."]
        ...
        pub fn list_language_extensions(
            ...
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ) -> list_language_extensions::RequestBuilder {
            list_language_extensions::RequestBuilder {
                client: self.0.clone(),
                workspace_name: workspace_name.into(),
                kusto_pool_name: kusto_pool_name.into(),
        ...
        #[doc = "Add a list of language extensions that can run within KQL queries."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `workspace_name`: The name of the workspace."]
        #[doc = "* `kusto_pool_name`: The name of the Kusto pool."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `language_extensions_to_add`: The language extensions to add."]
        ...
        ) -> add_language_extensions::RequestBuilder {
            add_language_extensions::RequestBuilder {
                client: self.0.clone(),
                workspace_name: workspace_name.into(),
                kusto_pool_name: kusto_pool_name.into(),
        ...
        #[doc = "Remove a list of language extensions that can run within KQL queries."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `workspace_name`: The name of the workspace."]
        #[doc = "* `kusto_pool_name`: The name of the Kusto pool."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `language_extensions_to_remove`: The language extensions to remove."]
        ...
        ) -> remove_language_extensions::RequestBuilder {
            remove_language_extensions::RequestBuilder {
                client: self.0.clone(),
                workspace_name: workspace_name.into(),
                kusto_pool_name: kusto_pool_name.into(),
        ...
        #[doc = "Returns a list of databases that are owned by this Kusto Pool and were followed by another Kusto Pool."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `workspace_name`: The name of the workspace."]
        #[doc = "* `kusto_pool_name`: The name of the Kusto pool."]
        ...
        pub fn list_follower_databases(
            ...
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ) -> list_follower_databases::RequestBuilder {
            list_follower_databases::RequestBuilder {
                client: self.0.clone(),
                workspace_name: workspace_name.into(),
                kusto_pool_name: kusto_pool_name.into(),
        ...
        #[doc = "Detaches all followers of a database owned by this Kusto Pool."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `workspace_name`: The name of the workspace."]
        #[doc = "* `kusto_pool_name`: The name of the Kusto pool."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `follower_database_to_remove`: The follower databases properties to remove."]
        ...
        ) -> detach_follower_databases::RequestBuilder {
            detach_follower_databases::RequestBuilder {
                client: self.0.clone(),
                workspace_name: workspace_name.into(),
                kusto_pool_name: kusto_pool_name.into(),
    ...
    pub mod check_name_availability {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CheckNameResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CheckNameResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        }
        #[derive(Clone)]
    ...
    pub mod list_by_workspace {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::KustoPoolListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::KustoPoolListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        }
        #[derive(Clone)]
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::KustoPool> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::KustoPool = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        }
        #[derive(Clone)]
    ...
    pub mod list_skus_by_resource {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ListResourceSkusResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ListResourceSkusResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        }
        #[derive(Clone)]
    ...
    pub mod list_language_extensions {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::LanguageExtensionsList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::LanguageExtensionsList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        }
        #[derive(Clone)]
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Synapse/workspaces/{}/kustoPools/{}/listLanguageExtensions" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . workspace_name , & this . kusto_pool_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Post);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Synapse/workspaces/{}/kustoPools/{}/addLanguageExtensions" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . workspace_name , & this . kusto_pool_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Post);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2021-06-01-preview");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.language_extensions_to_add)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Synapse/workspaces/{}/kustoPools/{}/removeLanguageExtensions" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . workspace_name , & this . kusto_pool_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Post);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2021-06-01-preview");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.language_extensions_to_remove)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
    ...
    pub mod list_follower_databases {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::FollowerDatabaseListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::FollowerDatabaseListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        }
        #[derive(Clone)]
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Synapse/workspaces/{}/kustoPools/{}/listFollowerDatabases" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . workspace_name , & this . kusto_pool_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Post);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Synapse/workspaces/{}/kustoPools/{}/detachFollowerDatabases" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . workspace_name , & this . kusto_pool_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Post);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
...
pub mod kusto_pool_child_resource {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Checks that the Kusto Pool child resource name is valid and is not already in use."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `workspace_name`: The name of the workspace."]
        #[doc = "* `kusto_pool_name`: The name of the Kusto pool."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `resource_name`: The name of the Kusto Pool child resource."]
        pub fn check_name_availability(
            &self,
            workspace_name: impl Into<String>,
            kusto_pool_name: impl Into<String>,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            resource_name: impl Into<models::DatabaseCheckNameRequest>,
        ) -> check_name_availability::RequestBuilder {
            check_name_availability::RequestBuilder {
                client: self.0.clone(),
                workspace_name: workspace_name.into(),
    ...
    pub mod check_name_availability {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) subscription_id: String,
            pub(crate) resource_group_name: String,
            pub(crate) resource_name: models::DatabaseCheckNameRequest,
        }
        impl RequestBuilder {
            #[doc = "Send the request and returns the response."]
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Synapse/workspaces/{}/kustoPools/{}/checkNameAvailability" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . workspace_name , & this . kusto_pool_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Post);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
...
pub mod kusto_pool_attached_database_configurations {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Returns the list of attached database configurations of the given Kusto Pool."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `workspace_name`: The name of the workspace."]
        #[doc = "* `kusto_pool_name`: The name of the Kusto pool."]
        ...
        pub fn list_by_kusto_pool(
            ...
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ) -> list_by_kusto_pool::RequestBuilder {
            list_by_kusto_pool::RequestBuilder {
                client: self.0.clone(),
                workspace_name: workspace_name.into(),
                kusto_pool_name: kusto_pool_name.into(),
        ...
        #[doc = "Returns an attached database configuration."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `workspace_name`: The name of the workspace."]
        #[doc = "* `kusto_pool_name`: The name of the Kusto pool."]
        #[doc = "* `attached_database_configuration_name`: The name of the attached database configuration."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        pub fn get(
            &self,
        ...
        #[doc = "Creates or updates an attached database configuration."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `workspace_name`: The name of the workspace."]
        #[doc = "* `kusto_pool_name`: The name of the Kusto pool."]
        ...
        #[doc = "Deletes the attached database configuration with the given name."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `workspace_name`: The name of the workspace."]
        #[doc = "* `kusto_pool_name`: The name of the Kusto pool."]
    ...
    pub mod list_by_kusto_pool {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AttachedDatabaseConfigurationListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AttachedDatabaseConfigurationListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        }
        #[derive(Clone)]
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Synapse/workspaces/{}/kustoPools/{}/attachedDatabaseConfigurations" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . workspace_name , & this . kusto_pool_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Get);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AttachedDatabaseConfiguration> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AttachedDatabaseConfiguration = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        }
        #[derive(Clone)]
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Synapse/workspaces/{}/kustoPools/{}/attachedDatabaseConfigurations/{}" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . workspace_name , & this . kusto_pool_name , & this . attached_database_configuration_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Get);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
...
pub mod kusto_pool_data_connections {
    ...
    impl Client {
        ...
        ) -> data_connection_validation::RequestBuilder {
            data_connection_validation::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Synapse/workspaces/{}/kustoPools/{}/databases/{}/checkNameAvailability" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . workspace_name , & this . kusto_pool_name , & this . database_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Post);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
    ...
    pub mod data_connection_validation {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DataConnectionValidationListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DataConnectionValidationListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        }
        #[derive(Clone)]
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Synapse/workspaces/{}/kustoPools/{}/databases/{}/dataConnectionValidation" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . workspace_name , & this . kusto_pool_name , & this . database_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Post);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
    ...
    pub mod list_by_database {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DataConnectionListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DataConnectionListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        }
        #[derive(Clone)]
...
pub mod kusto_pool_principal_assignments {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Checks that the principal assignment name is valid and is not already in use."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `workspace_name`: The name of the workspace."]
        #[doc = "* `kusto_pool_name`: The name of the Kusto pool."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `principal_assignment_name`: The name of the principal assignment."]
        pub fn check_name_availability(
            &self,
            workspace_name: impl Into<String>,
            kusto_pool_name: impl Into<String>,
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Synapse/workspaces/{}/kustoPools/{}/checkPrincipalAssignmentNameAvailability" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . workspace_name , & this . kusto_pool_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Post);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2021-06-01-preview");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.principal_assignment_name)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ClusterPrincipalAssignmentListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ClusterPrincipalAssignmentListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        }
        #[derive(Clone)]
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ClusterPrincipalAssignment> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ClusterPrincipalAssignment = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        }
        #[derive(Clone)]
...
pub mod kusto_pool_database_principal_assignments {
    ...
    impl Client {
        ...
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `principal_assignment_name`: The name of the resource."]
        pub fn check_name_availability(
            &self,
            workspace_name: impl Into<String>,
            kusto_pool_name: impl Into<String>,
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Synapse/workspaces/{}/kustoPools/{}/databases/{}/checkPrincipalAssignmentNameAvailability" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . workspace_name , & this . kusto_pool_name , & this . database_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Post);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DatabasePrincipalAssignmentListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DatabasePrincipalAssignmentListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        }
        #[derive(Clone)]
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DatabasePrincipalAssignment> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DatabasePrincipalAssignment = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        }
        #[derive(Clone)]
