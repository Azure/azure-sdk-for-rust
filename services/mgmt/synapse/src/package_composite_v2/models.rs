...
pub mod azure_sku {
    ...
    impl Serialize for Name {
        ...
        {
            match self {
                Self::ComputeOptimized => serializer.serialize_unit_variant("Name", 0u32, "Compute optimized"),
                Self::StorageOptimized => serializer.serialize_unit_variant("Name", 1u32, "Storage optimized"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for Size {
        ...
        {
            match self {
                Self::ExtraSmall => serializer.serialize_unit_variant("Size", 0u32, "Extra small"),
                Self::Small => serializer.serialize_unit_variant("Size", 1u32, "Small"),
                Self::Medium => serializer.serialize_unit_variant("Size", 2u32, "Medium"),
                Self::Large => serializer.serialize_unit_variant("Size", 3u32, "Large"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "Language extension that can run within KQL query."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "LanguageExtensionName")]
...
impl FromStr for LanguageExtensionName {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for LanguageExtensionName {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for LanguageExtensionName {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Python => serializer.serialize_unit_variant("LanguageExtensionName", 0u32, "PYTHON"),
            Self::R => serializer.serialize_unit_variant("LanguageExtensionName", 1u32, "R"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
