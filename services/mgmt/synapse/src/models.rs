...
pub struct AttachedDatabaseConfigurationProperties {
    ...
    #[doc = "The resource id of the kusto pool where the databases you would like to attach reside."]
    #[serde(rename = "clusterResourceId")]
    pub cluster_resource_id: String,
    #[doc = "The list of databases from the clusterResourceId which are currently attached to the kusto pool."]
...
pub struct ClusterPrincipalAssignmentCheckNameRequest {
    ...
    pub name: String,
    #[doc = "The type of resource, Microsoft.Synapse/workspaces/kustoPools/principalAssignments."]
    #[serde(rename = "type")]
...
pub struct DataConnectionCheckNameRequest {
    ...
    pub name: String,
    #[doc = "The type of resource, Microsoft.Synapse/workspaces/kustoPools/databases/dataConnections."]
    #[serde(rename = "type")]
...
pub struct DatabaseCheckNameRequest {
    #[doc = "Resource name."]
    pub name: String,
    #[doc = "The type of resource, for instance Microsoft.Synapse/workspaces/kustoPools/databases."]
    #[serde(rename = "type")]
...
pub struct DatabasePrincipalAssignmentCheckNameRequest {
    #[doc = "Principal Assignment resource name."]
    pub name: String,
    #[doc = "The type of resource, Microsoft.Synapse/workspaces/kustoPools/databases/principalAssignments."]
    #[serde(rename = "type")]
...
#[doc = "List of available SKUs for a Kusto Pool."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "The list of the SKU descriptions"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
