...
pub use package_preview_2019_07::{models, operations, operations::Client, operations::ClientBuilder};
...
pub use package_2017_03_01_preview::{models, operations, operations::Client, operations::ClientBuilder};
