...
pub mod management_lock_properties {
    ...
    impl Serialize for Level {
        ...
        {
            match self {
                Self::NotSpecified => serializer.serialize_unit_variant("Level", 0u32, "NotSpecified"),
                Self::CanNotDelete => serializer.serialize_unit_variant("Level", 1u32, "CanNotDelete"),
                Self::ReadOnly => serializer.serialize_unit_variant("Level", 2u32, "ReadOnly"),
