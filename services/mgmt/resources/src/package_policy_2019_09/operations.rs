...
pub mod policy_assignments {
    ...
    pub async fn create_by_id(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: CloudError = serde_json::from_slice(rsp_body).map_err(|source| create_by_id::Error::DeserializeError {
                    source,
                    body: rsp_body.clone(),
                })?;
...
pub mod policy_definitions {
    ...
    pub async fn get_built_in(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: CloudError = serde_json::from_slice(rsp_body).map_err(|source| get_built_in::Error::DeserializeError {
                    source,
                    body: rsp_body.clone(),
                })?;
    ...
    pub async fn list_built_in(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: CloudError = serde_json::from_slice(rsp_body).map_err(|source| list_built_in::Error::DeserializeError {
                    source,
                    body: rsp_body.clone(),
                })?;
