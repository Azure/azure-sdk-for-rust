...
pub mod private_link_association {
    ...
    pub mod get {
        use super::models;
        type Response = models::PrivateLinkAssociation;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<Response, Error>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url_str = & format ! ("{}/providers/Microsoft.Management/managementGroups/{}/providers/Microsoft.Authorization/privateLinkAssociations/{}" , this . client . endpoint () , & this . group_id , & this . pla_id) ;
    ...
    pub mod list {
        use super::models;
        type Response = models::PrivateLinkAssociationGetResult;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
            DefaultResponse {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<Response, Error>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url_str = & format ! ("{}/providers/Microsoft.Management/managementGroups/{}/providers/Microsoft.Authorization/privateLinkAssociations" , this . client . endpoint () , & this . group_id) ;
                        let mut url = url::Url::parse(url_str).map_err(Error::ParseUrl)?;
                        let mut req_builder = http::request::Builder::new();
                        req_builder = req_builder.method(http::Method::GET);
                        let credential = this.client.token_credential();
...
pub mod resource_management_private_link {
    ...
    pub mod get {
        use super::models;
        type Response = models::ResourceManagementPrivateLink;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
            DefaultResponse {
    ...
    pub mod list {
        use super::models;
        type Response = models::ResourceManagementPrivateLinkListResult;
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
            DefaultResponse {
