...
pub mod providers {
    ...
    pub async fn list(configuration: &Configuration, top: Option<i64>, subscription_id: &str) -> Result<ProviderListResult> {
        let client = &configuration.client;
    ...
    pub async fn get(configuration: &Configuration, resource_provider_namespace: &str, subscription_id: &str) -> Result<Provider> {
        let client = &configuration.client;
        let uri_str = &format!(
...
pub mod policy_assignments {
    ...
    pub async fn list_for_scope(configuration: &Configuration, scope: &str, filter: Option<&str>) -> Result<PolicyAssignmentListResult> {
        let client = &configuration.client;
        let uri_str = &format!(
            "{}/{}/providers/Microsoft.Authorization/policyAssignments",
