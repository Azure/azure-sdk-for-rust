                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        if let Some(include_extended_locations) = &this.include_extended_locations {
                            req.url_mut()
                                .query_pairs_mut()
                                .append_pair("includeExtendedLocations", &include_extended_locations.to_string());
                        }
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await?;
                                let rsp_value: models::CheckZonePeersResult = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code as u16,
            ...
            Box::pin({
                ...
                async move {
                    ...
                    let req_body = if let Some(resource_name_definition) = &this.resource_name_definition {
                        req.insert_header("content-type", "application/json");
                        azure_core::to_json(resource_name_definition)?
                    } else {
