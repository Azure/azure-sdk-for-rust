...
pub mod tags {
    ...
    pub async fn get_at_scope(configuration: &crate::Configuration, scope: &str) -> std::result::Result<TagsResource, get_at_scope::Error> {
        let client = &configuration.client;
    ...
    pub async fn delete_at_scope(configuration: &crate::Configuration, scope: &str) -> std::result::Result<(), delete_at_scope::Error> {
        let client = &configuration.client;
        let uri_str = &format!("{}/{}/providers/Microsoft.Resources/tags/default", &configuration.base_path, scope);
        let mut req_builder = client.delete(uri_str);
        if let Some(token) = &configuration.bearer_access_token {
