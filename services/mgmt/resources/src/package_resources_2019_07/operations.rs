...
pub mod deployments {
    use crate::{models::*, *};
    pub async fn get_at_scope(configuration: &Configuration, scope: &str, deployment_name: &str) -> Result<DeploymentExtended> {
        let client = &configuration.client;
        let uri_str = &format!(
            "{}/{}/providers/Microsoft.Resources/deployments/{}",
            &configuration.base_path, scope, deployment_name
        );
        let mut req_builder = client.get(uri_str);
        if let Some(token) = &configuration.bearer_access_token {
            req_builder = req_builder.bearer_auth(token);
    ...
    pub async fn delete_at_scope(configuration: &Configuration, scope: &str, deployment_name: &str) -> Result<CloudError> {
        let client = &configuration.client;
        let uri_str = &format!(
            "{}/{}/providers/Microsoft.Resources/deployments/{}",
            &configuration.base_path, scope, deployment_name
    ...
    pub async fn check_existence_at_scope(configuration: &Configuration, scope: &str, deployment_name: &str) -> Result<CloudError> {
        let client = &configuration.client;
        let uri_str = &format!(
            "{}/{}/providers/Microsoft.Resources/deployments/{}",
            &configuration.base_path, scope, deployment_name
    ...
    pub async fn cancel_at_scope(configuration: &Configuration, scope: &str, deployment_name: &str) -> Result<CloudError> {
        let client = &configuration.client;
        let uri_str = &format!(
    ...
    pub async fn list_at_scope(
        ...
        let client = &configuration.client;
        let uri_str = &format!("{}/{}/providers/Microsoft.Resources/deployments/", &configuration.base_path, scope);
        let mut req_builder = client.get(uri_str);
        if let Some(token) = &configuration.bearer_access_token {
            req_builder = req_builder.bearer_auth(token);
        }
    ...
    pub async fn get_at_tenant_scope(configuration: &Configuration, deployment_name: &str) -> Result<DeploymentExtended> {
        let client = &configuration.client;
        let uri_str = &format!(
            "{}/providers/Microsoft.Resources/deployments/{}",
            &configuration.base_path, deployment_name
        );
        let mut req_builder = client.get(uri_str);
        if let Some(token) = &configuration.bearer_access_token {
            req_builder = req_builder.bearer_auth(token);
    ...
    pub async fn delete_at_tenant_scope(configuration: &Configuration, deployment_name: &str) -> Result<CloudError> {
        let client = &configuration.client;
        let uri_str = &format!(
            "{}/providers/Microsoft.Resources/deployments/{}",
            &configuration.base_path, deployment_name
    ...
    pub async fn check_existence_at_tenant_scope(configuration: &Configuration, deployment_name: &str) -> Result<CloudError> {
        let client = &configuration.client;
        let uri_str = &format!(
            "{}/providers/Microsoft.Resources/deployments/{}",
            &configuration.base_path, deployment_name
    ...
    pub async fn cancel_at_tenant_scope(configuration: &Configuration, deployment_name: &str) -> Result<CloudError> {
        let client = &configuration.client;
        let uri_str = &format!(
            "{}/providers/Microsoft.Resources/deployments/{}/cancel",
            &configuration.base_path, deployment_name
    ...
    pub async fn export_template_at_tenant_scope(configuration: &Configuration, deployment_name: &str) -> Result<DeploymentExportResult> {
        let client = &configuration.client;
        let uri_str = &format!(
            "{}/providers/Microsoft.Resources/deployments/{}/exportTemplate",
            &configuration.base_path, deployment_name
    ...
    pub async fn list_at_tenant_scope(
        ...
        let client = &configuration.client;
        let uri_str = &format!("{}/providers/Microsoft.Resources/deployments/", &configuration.base_path,);
        let mut req_builder = client.get(uri_str);
        if let Some(token) = &configuration.bearer_access_token {
            req_builder = req_builder.bearer_auth(token);
        }
    ...
    pub async fn get_at_management_group_scope(
        ...
        let uri_str = &format!(
            ...
            &configuration.base_path, group_id, deployment_name
        );
        let mut req_builder = client.get(uri_str);
        if let Some(token) = &configuration.bearer_access_token {
            req_builder = req_builder.bearer_auth(token);
...
pub mod providers {
    ...
    pub async fn list_at_tenant_scope(configuration: &Configuration, top: Option<i64>, expand: Option<&str>) -> Result<ProviderListResult> {
        let client = &configuration.client;
    ...
    pub async fn get_at_tenant_scope(
        ...
        let client = &configuration.client;
        let uri_str = &format!("{}/providers/{}", &configuration.base_path, resource_provider_namespace);
        let mut req_builder = client.get(uri_str);
        if let Some(token) = &configuration.bearer_access_token {
            req_builder = req_builder.bearer_auth(token);
        }
...
pub mod resources {
    ...
    pub async fn delete_by_id(configuration: &Configuration, resource_id: &str) -> Result<CloudError> {
        let client = &configuration.client;
        let uri_str = &format!("{}/{}", &configuration.base_path, resource_id);
        let mut req_builder = client.delete(uri_str);
        if let Some(token) = &configuration.bearer_access_token {
    ...
    pub async fn check_existence_by_id(configuration: &Configuration, resource_id: &str) -> Result<CloudError> {
        let client = &configuration.client;
        let uri_str = &format!("{}/{}", &configuration.base_path, resource_id);
        let mut req_builder = client.head(uri_str);
        if let Some(token) = &configuration.bearer_access_token {
...
pub mod resource_groups {
    ...
    pub async fn delete(configuration: &Configuration, resource_group_name: &str, subscription_id: &str) -> Result<CloudError> {
        let client = &configuration.client;
        let uri_str = &format!(
            "{}/subscriptions/{}/resourcegroups/{}",
            &configuration.base_path, subscription_id, resource_group_name
    ...
    pub async fn check_existence(configuration: &Configuration, resource_group_name: &str, subscription_id: &str) -> Result<CloudError> {
        let client = &configuration.client;
        let uri_str = &format!(
            "{}/subscriptions/{}/resourcegroups/{}",
            &configuration.base_path, subscription_id, resource_group_name
...
pub mod tags {
    ...
    pub async fn delete_value(configuration: &Configuration, tag_name: &str, tag_value: &str, subscription_id: &str) -> Result<CloudError> {
        let client = &configuration.client;
        let uri_str = &format!(
            "{}/subscriptions/{}/tagNames/{}/tagValues/{}",
            &configuration.base_path, subscription_id, tag_name, tag_value
    ...
    pub async fn delete(configuration: &Configuration, tag_name: &str, subscription_id: &str) -> Result<CloudError> {
        let client = &configuration.client;
        let uri_str = &format!(
            "{}/subscriptions/{}/tagNames/{}",
            &configuration.base_path, subscription_id, tag_name
...
pub mod deployment_operations {
    ...
    pub async fn get_at_scope(
        ...
        let uri_str = &format!(
            ...
            &configuration.base_path, scope, deployment_name, operation_id
        );
        let mut req_builder = client.get(uri_str);
        if let Some(token) = &configuration.bearer_access_token {
            req_builder = req_builder.bearer_auth(token);
    ...
    pub async fn get_at_tenant_scope(
        ...
        let uri_str = &format!(
            "{}/providers/Microsoft.Resources/deployments/{}/operations/{}",
            &configuration.base_path, deployment_name, operation_id
        );
        let mut req_builder = client.get(uri_str);
        if let Some(token) = &configuration.bearer_access_token {
            req_builder = req_builder.bearer_auth(token);
    ...
    pub async fn get_at_management_group_scope(
        ...
        let uri_str = &format!(
            ...
            &configuration.base_path, group_id, deployment_name, operation_id
        );
        let mut req_builder = client.get(uri_str);
        if let Some(token) = &configuration.bearer_access_token {
            req_builder = req_builder.bearer_auth(token);
