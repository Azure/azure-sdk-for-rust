...
pub mod deployments {
    ...
    pub async fn validate_at_scope(
        ...
        deployment_name: &str,
        parameters: &models::Deployment,
    ) -> std::result::Result<models::DeploymentValidateResult, validate_at_scope::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
    ...
    pub async fn validate_at_tenant_scope(
        ...
        deployment_name: &str,
        parameters: &models::Deployment,
    ) -> std::result::Result<models::DeploymentValidateResult, validate_at_tenant_scope::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/providers/Microsoft.Resources/deployments/{}/validate",
            operation_config.base_path(),
