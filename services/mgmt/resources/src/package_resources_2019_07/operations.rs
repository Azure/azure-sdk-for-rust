...
pub mod deployments {
    ...
    pub async fn validate_at_scope(
        ...
        deployment_name: &str,
        parameters: &Deployment,
    ) -> std::result::Result<DeploymentValidateResult, validate_at_scope::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
    ...
    pub async fn validate_at_tenant_scope(
        ...
        deployment_name: &str,
        parameters: &Deployment,
    ) -> std::result::Result<DeploymentValidateResult, validate_at_tenant_scope::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/providers/Microsoft.Resources/deployments/{}/validate",
            operation_config.base_path(),
    ...
    pub async fn validate_at_management_group_scope(
        ...
        deployment_name: &str,
        parameters: &Deployment,
    ) -> std::result::Result<DeploymentValidateResult, validate_at_management_group_scope::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
