...
pub mod deployments {
    ...
    pub async fn get_at_management_group_scope(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                get_at_management_group_scope::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                }
                .fail()
    ...
    pub async fn create_or_update_at_management_group_scope(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                create_or_update_at_management_group_scope::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                }
                .fail()
    ...
    pub async fn delete_at_management_group_scope(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                delete_at_management_group_scope::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                }
                .fail()
    ...
    pub async fn check_existence_at_management_group_scope(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                check_existence_at_management_group_scope::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                }
                .fail()
    ...
    pub async fn cancel_at_management_group_scope(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                cancel_at_management_group_scope::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                }
                .fail()
    ...
    pub async fn validate_at_management_group_scope(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                validate_at_management_group_scope::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                }
                .fail()
    ...
    pub async fn export_template_at_management_group_scope(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                export_template_at_management_group_scope::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                }
                .fail()
    ...
    pub async fn list_at_management_group_scope(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                list_at_management_group_scope::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                }
                .fail()
...
pub mod providers {
    ...
    pub async fn list_at_tenant_scope(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                list_at_tenant_scope::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                }
                .fail()
    ...
    pub async fn get_at_tenant_scope(
        ...
        match rsp.status() {
            ...
            status_code => {
                let rsp_body = rsp.body();
                get_at_tenant_scope::UnexpectedResponse {
                    status_code,
                    body: rsp_body.clone(),
                }
                .fail()
