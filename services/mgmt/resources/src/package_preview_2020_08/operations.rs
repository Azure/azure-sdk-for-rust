...
pub mod applications {
    ...
    pub async fn delete_by_id(configuration: &Configuration, application_id: &str) -> Result<CloudError> {
        let client = &configuration.client;
        let uri_str = &format!("{}/{}", &configuration.base_path, application_id);
        let mut req_builder = client.delete(uri_str);
        if let Some(token) = &configuration.bearer_access_token {
...
pub mod jit_requests {
    ...
    pub async fn list_by_subscription(configuration: &Configuration, subscription_id: &str) -> Result<JitRequestDefinitionListResult> {
        let client = &configuration.client;
        let uri_str = &format!(
    ...
    pub async fn list_by_resource_group(
        ...
        resource_group_name: &str,
        subscription_id: &str,
    ) -> Result<JitRequestDefinitionListResult> {
        let client = &configuration.client;
        let uri_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Solutions/jitRequests",
            &configuration.base_path, subscription_id, resource_group_name
