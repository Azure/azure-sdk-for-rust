...
pub mod virtual_machine_image_templates {
    ...
    impl Client {
        ...
        pub fn get(
            ...
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            image_template_name: impl Into<String>,
        ) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
        ...
        pub fn list_run_outputs(
            ...
            resource_group_name: impl Into<String>,
            image_template_name: impl Into<String>,
        ) -> list_run_outputs::RequestBuilder {
            list_run_outputs::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        pub fn get_run_output(
            ...
            resource_group_name: impl Into<String>,
            image_template_name: impl Into<String>,
            run_output_name: impl Into<String>,
        ) -> get_run_output::RequestBuilder {
            get_run_output::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
                image_template_name: image_template_name.into(),
                run_output_name: run_output_name.into(),
            }
        }
    }
    pub mod list {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ImageTemplateListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ImageTemplateListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ImageTemplateListResult, azure_core::error::Error> {
                        ...
                        let rsp = match continuation {
                            Some(value) => {
                                ...
                                if !has_api_version_already {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair(azure_core::query_param::API_VERSION, "2022-07-01");
                                }
    ...
    pub mod get {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ImageTemplate> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ImageTemplate = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) subscription_id: String,
            pub(crate) resource_group_name: String,
            pub(crate) image_template_name: String,
        }
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.VirtualMachineImages/imageTemplates/{}",
                    &self.subscription_id, &self.resource_group_name, &self.image_template_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ImageTemplate>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ImageTemplate>>;
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) parameters: models::ImageTemplate,
            pub(crate) subscription_id: String,
            pub(crate) resource_group_name: String,
            pub(crate) image_template_name: String,
        }
    ...
    pub mod update {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) parameters: models::ImageTemplateUpdateParameters,
            pub(crate) subscription_id: String,
            pub(crate) resource_group_name: String,
            pub(crate) image_template_name: String,
        }
    ...
    pub mod list_run_outputs {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::RunOutputCollection> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::RunOutputCollection = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::RunOutputCollection, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod get_run_output {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::RunOutput> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::RunOutput = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) image_template_name: String,
            pub(crate) run_output_name: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.VirtualMachineImages/imageTemplates/{}/runOutputs/{}",
                    &self.subscription_id, &self.resource_group_name, &self.image_template_name, &self.run_output_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::RunOutput>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::RunOutput>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod triggers {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List all triggers for the specified Image Template resource"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription Id forms part of the URI for every service call."]
        #[doc = "* `resource_group_name`: The name of the resource group."]
        #[doc = "* `image_template_name`: The name of the image Template"]
        pub fn list_by_image_template(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            image_template_name: impl Into<String>,
        ) -> list_by_image_template::RequestBuilder {
            list_by_image_template::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        #[doc = "Get the specified trigger for the specified image template resource"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription Id forms part of the URI for every service call."]
        #[doc = "* `resource_group_name`: The name of the resource group."]
        ...
        #[doc = "Create or update a trigger for the specified virtual machine image template"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `parameters`: Parameters supplied to the CreateTrigger operation"]
        #[doc = "* `subscription_id`: Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription Id forms part of the URI for every service call."]
        #[doc = "* `resource_group_name`: The name of the resource group."]
        #[doc = "* `image_template_name`: The name of the image Template"]
        #[doc = "* `trigger_name`: The name of the trigger"]
        pub fn create_or_update(
            &self,
            parameters: impl Into<models::Trigger>,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            image_template_name: impl Into<String>,
            trigger_name: impl Into<String>,
        ...
        #[doc = "Delete a trigger for the specified virtual machine image template"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription Id forms part of the URI for every service call."]
        #[doc = "* `resource_group_name`: The name of the resource group."]
    ...
    pub mod list_by_image_template {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::TriggerCollection> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::TriggerCollection = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::TriggerCollection, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.VirtualMachineImages/imageTemplates/{}/triggers",
                    &self.subscription_id, &self.resource_group_name, &self.image_template_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.VirtualMachineImages/imageTemplates/{}/triggers/{}",
                    &self.subscription_id, &self.resource_group_name, &self.image_template_name, &self.trigger_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) parameters: models::Trigger,
            pub(crate) subscription_id: String,
            pub(crate) resource_group_name: String,
            pub(crate) image_template_name: String,
            pub(crate) trigger_name: String,
...
pub mod operations {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.VirtualMachineImages/operations",));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-07-01");
