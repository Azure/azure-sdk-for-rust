...
use std::str::FromStr;
#[doc = "List of api keys to be generated."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ApiKeys {
    #[doc = "A list of api key names."]
    #[serde(
        default,
...
#[doc = "Azure quantum workspace Api key details."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ApiKey {
    #[doc = "The creation time of the api key."]
...
#[doc = "Result of list Api keys and connection strings."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ListKeysResult {
    #[doc = "Indicator of enablement of the Quantum workspace Api keys."]
    #[serde(rename = "apiKeyEnabled", default, skip_serializing_if = "Option::is_none")]
    pub api_key_enabled: Option<bool>,
    #[doc = "Azure quantum workspace Api key details."]
    #[serde(rename = "primaryKey", default, skip_serializing_if = "Option::is_none")]
    pub primary_key: Option<ApiKey>,
    #[doc = "Azure quantum workspace Api key details."]
    #[serde(rename = "secondaryKey", default, skip_serializing_if = "Option::is_none")]
    pub secondary_key: Option<ApiKey>,
    #[doc = "The connection string of the primary api key."]
    #[serde(rename = "primaryConnectionString", default, skip_serializing_if = "Option::is_none")]
    pub primary_connection_string: Option<String>,
    #[doc = "The connection string of the secondary api key."]
