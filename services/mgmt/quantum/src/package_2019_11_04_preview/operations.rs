...
pub mod workspaces {
    ...
    pub async fn create_or_update(
        ...
        let req_body = azure_core::to_json(quantum_workspace).map_err(create_or_update::Error::SerializeError)?;
        req_builder = req_builder.uri(url.as_str());
        ...
        match rsp.status() {
            http::StatusCode::CREATED => {
                let rsp_body = rsp.body();
                let rsp_value: QuantumWorkspace = serde_json::from_slice(rsp_body)
    ...
    pub async fn update_tags(
        ...
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        req_builder = req_builder.header("content-type", "application/json");
        let req_body = azure_core::to_json(workspace_tags).map_err(update_tags::Error::SerializeError)?;
        req_builder = req_builder.uri(url.as_str());
