...
pub enum Error {
    ...
    #[error(transparent)]
    Workspaces_UpdateTags(#[from] workspaces::update_tags::Error),
    #[error(transparent)]
    ...
    #[error(transparent)]
    Offerings_List(#[from] offerings::list::Error),
    #[error(transparent)]
    Operations_List(#[from] operations::list::Error),
    #[error(transparent)]
    Workspace_CheckNameAvailability(#[from] workspace::check_name_availability::Error),
}
pub mod workspaces {
    use super::models;
    ...
    impl Client {
        ...
        pub fn create_or_update(
            ...
            subscription_id: impl Into<String>,
            workspace_name: impl Into<String>,
            quantum_workspace: impl Into<models::QuantumWorkspace>,
        ...
        pub fn update_tags(
            ...
            subscription_id: impl Into<String>,
            workspace_name: impl Into<String>,
            workspace_tags: impl Into<models::TagsObject>,
        ) -> update_tags::Builder {
            update_tags::Builder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod get {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::QuantumWorkspace, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                    ...
                    url.query_pairs_mut().append_pair("api-version", "2019-11-04-preview");
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            ...
                            let rsp_value: models::QuantumWorkspace =
    ...
    pub mod create_or_update {
        ...
        #[derive(Debug)]
        pub enum Response {
            Created201(models::QuantumWorkspace),
        ...
        pub struct Builder {
            ...
            pub(crate) subscription_id: String,
            pub(crate) workspace_name: String,
            pub(crate) quantum_workspace: models::QuantumWorkspace,
        }
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<Response, Error>> {
                Box::pin(async move {
                    ...
                    let req_body = azure_core::to_json(&self.quantum_workspace).map_err(Error::Serialize)?;
                    req_builder = req_builder.uri(url.as_str());
                    let req = req_builder.body(req_body).map_err(Error::BuildRequest)?;
                    let rsp = self.client.send(req).await.map_err(Error::SendRequest)?;
                    let (rsp_status, rsp_headers, rsp_stream) = rsp.deconstruct();
    ...
    pub mod update_tags {
        ...
        pub struct Builder {
            ...
            pub(crate) subscription_id: String,
            pub(crate) workspace_name: String,
            pub(crate) workspace_tags: models::TagsObject,
        }
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::QuantumWorkspace, Error>> {
                Box::pin(async move {
                    ...
                    url.query_pairs_mut().append_pair("api-version", "2019-11-04-preview");
                    req_builder = req_builder.header("content-type", "application/json");
                    let req_body = azure_core::to_json(&self.workspace_tags).map_err(Error::Serialize)?;
                    req_builder = req_builder.uri(url.as_str());
                    let req = req_builder.body(req_body).map_err(Error::BuildRequest)?;
                    let rsp = self.client.send(req).await.map_err(Error::SendRequest)?;
                    let (rsp_status, rsp_headers, rsp_stream) = rsp.deconstruct();
    ...
    pub mod list_by_subscription {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::WorkspaceListResult, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/subscriptions/{}/providers/Microsoft.Quantum/workspaces",
                        self.client.endpoint(),
                        &self.subscription_id
                    );
                    let mut url = url::Url::parse(url_str).map_err(Error::ParseUrl)?;
...
pub mod offerings {
    ...
    pub mod list {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::OfferingsListResult, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/subscriptions/{}/providers/Microsoft.Quantum/locations/{}/offerings",
                        self.client.endpoint(),
                        &self.subscription_id,
                        &self.location_name
                    );
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                            let rsp_value: models::OfferingsListResult =
                                serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                            Ok(rsp_value)
                        }
                        status_code => {
    ...
    pub mod list {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::OperationsList, Error>> {
                Box::pin(async move {
                    let url_str = &format!("{}/providers/Microsoft.Quantum/operations", self.client.endpoint(),);
                    let mut url = url::Url::parse(url_str).map_err(Error::ParseUrl)?;
                    let mut req_builder = http::request::Builder::new();
                    req_builder = req_builder.method(http::Method::GET);
                    let credential = self.client.token_credential();
    ...
    pub mod check_name_availability {
        ...
        impl Builder {
            pub fn into_future(
                ...
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/subscriptions/{}/providers/Microsoft.Quantum/locations/{}/checkNameAvailability",
                        self.client.endpoint(),
                        &self.subscription_id,
                        &self.location_name
                    );
