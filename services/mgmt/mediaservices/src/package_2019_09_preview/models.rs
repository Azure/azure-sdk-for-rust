...
pub struct MediaGraphRtspSource {
    ...
    pub rtsp_url: String,
    #[doc = "Credentials to authenticate to Media Graph sources"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub credentials: Option<MediaGraphUserCredentials>,
}
impl MediaGraphRtspSource {
    pub fn new(media_graph_source: MediaGraphSource, rtsp_url: String) -> Self {
        Self {
            media_graph_source,
            rtsp_url,
            credentials: None,
...
#[doc = "Credentials to authenticate to Media Graph sources"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct MediaGraphUserCredentials {
    #[doc = "User name"]
    pub username: String,
    #[doc = "Password credential"]
    pub password: String,
}
impl MediaGraphUserCredentials {
