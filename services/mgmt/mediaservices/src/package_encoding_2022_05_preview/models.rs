...
impl BuiltInStandardEncoderPreset {
    pub fn new(preset_name: built_in_standard_encoder_preset::PresetName) -> Self {
        Self {
            configurations: None,
            preset_name,
        }
...
pub struct CmafFormat {
    ...
    #[serde(rename = "streamingFormat", default, skip_serializing_if = "Option::is_none")]
    pub streaming_format: Option<cmaf_format::StreamingFormat>,
}
impl CmafFormat {
    pub fn new(multi_bitrate_format: MultiBitrateFormat) -> Self {
        Self {
            multi_bitrate_format,
...
pub mod cmaf_format {
    ...
    impl Serialize for StreamingFormat {
        ...
        {
            match self {
                Self::HlsAndDash => serializer.serialize_unit_variant("StreamingFormat", 0u32, "HlsAndDash"),
                Self::Hls => serializer.serialize_unit_variant("StreamingFormat", 1u32, "Hls"),
                Self::Dash => serializer.serialize_unit_variant("StreamingFormat", 2u32, "Dash"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub enum CodecUnion {
    ...
    #[serde(rename = "#Microsoft.Media.DDAudio")]
    MicrosoftMediaDdAudio(DdAudio),
...
impl ContentKeyPolicyPlayReadyConfiguration {
    pub fn new(licenses: Vec<ContentKeyPolicyPlayReadyLicense>) -> Self {
        Self {
            licenses,
...
impl ContentKeyPolicyRsaTokenKey {
    pub fn new(exponent: String, modulus: String) -> Self {
...
impl ContentKeyPolicyWidevineConfiguration {
    pub fn new(widevine_template: String) -> Self {
        Self { widevine_template }
    }
}
...
impl ContentKeyPolicyX509CertificateTokenKey {
    pub fn new(raw_body: String) -> Self {
        Self { raw_body }
    }
}
...
pub enum FormatUnion {
    #[serde(rename = "#Microsoft.Media.CmafFormat")]
    MicrosoftMediaCmafFormat(CmafFormat),
...
impl StandardEncoderPreset {
    pub fn new(codecs: Vec<CodecUnion>, formats: Vec<FormatUnion>) -> Self {
        Self {
            filters: None,
            codecs,
            formats,
