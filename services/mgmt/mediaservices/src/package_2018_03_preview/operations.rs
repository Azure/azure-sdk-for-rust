...
pub mod assets {
    ...
    pub async fn get_encryption_key(
        ...
        account_name: &str,
        asset_name: &str,
    ) -> std::result::Result<models::AssetStorageEncryptionKey, get_encryption_key::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::AssetStorageEncryptionKey = serde_json::from_slice(rsp_body)
