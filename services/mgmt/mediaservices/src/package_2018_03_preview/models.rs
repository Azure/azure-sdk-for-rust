...
pub struct Format {
    #[serde(rename = "@odata.type")]
    pub odata_type: String,
    #[serde(rename = "filenamePattern", skip_serializing_if = "Option::is_none")]
...
pub struct VideoAnalyzerPreset {
    ...
    #[serde(rename = "audioInsightsOnly", skip_serializing_if = "Option::is_none")]
...
pub struct AssetStorageEncryptionKey {
    #[serde(rename = "storageEncryptionKey", skip_serializing_if = "Option::is_none")]
...
pub struct StreamingEndpointProperties {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    #[serde(rename = "scaleUnits", skip_serializing_if = "Option::is_none")]
