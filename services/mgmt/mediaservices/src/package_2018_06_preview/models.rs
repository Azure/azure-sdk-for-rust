...
pub struct EnvelopeEncryption {
    ...
    #[serde(rename = "contentKeys", default, skip_serializing_if = "Option::is_none")]
    pub content_keys: Option<StreamingPolicyContentKeys>,
    #[doc = "KeyAcquisitionUrlTemplate is used to point to user specified service to delivery content keys"]
...
pub struct JobProperties {
    ...
    #[doc = "Customer provided correlation data that will be returned in Job completed events."]
