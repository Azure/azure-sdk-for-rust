...
pub mod media_service {
    ...
    pub async fn get(
        ...
        let uri_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Media/mediaservices/{}",
            &operation_config.base_path, subscription_id, resource_group_name, media_service_name
        );
        let mut req_builder = client.get(uri_str);
        if let Some(token_credential) = &operation_config.token_credential {
            let token_response = token_credential
    ...
    pub async fn create(
        ...
        match rsp.status() {
            StatusCode::CREATED => {
                ...
                let rsp_value: MediaService = serde_json::from_slice(&body).context(create::DeserializeError { body })?;
                Ok(rsp_value)
            }
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(create::ResponseBytesError)?;
    ...
    pub async fn regenerate_key(
        ...
        match rsp.status() {
            StatusCode::OK => {
                ...
                let rsp_value: RegenerateKeyOutput = serde_json::from_slice(&body).context(regenerate_key::DeserializeError { body })?;
                Ok(rsp_value)
            }
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(regenerate_key::ResponseBytesError)?;
                let rsp_value: ApiError = serde_json::from_slice(&body).context(regenerate_key::DeserializeError { body })?;
    ...
    pub async fn list_keys(
        ...
        match rsp.status() {
            StatusCode::OK => {
                ...
                let rsp_value: ServiceKeys = serde_json::from_slice(&body).context(list_keys::DeserializeError { body })?;
                Ok(rsp_value)
            }
            status_code => {
                let body: bytes::Bytes = rsp.bytes().await.context(list_keys::ResponseBytesError)?;
                let rsp_value: ApiError = serde_json::from_slice(&body).context(list_keys::DeserializeError { body })?;
