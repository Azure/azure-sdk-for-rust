...
pub mod get_cached_server_name {
    ...
    pub mod execute {
        use super::models;
        type Response = models::CachedServerName;
        #[derive(Clone)]
        pub struct Builder {
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                ...
                                let rsp_value: models::CachedServerName = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
...
pub mod backups {
    ...
    pub mod get {
        use super::models;
        type Response = models::ServerBackup;
        #[derive(Clone)]
        pub struct Builder {
            pub(crate) client: super::super::Client,
            pub(crate) subscription_id: String,
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                let rsp_body = rsp_stream.collect().await?;
                                let rsp_value: models::ServerBackup = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
