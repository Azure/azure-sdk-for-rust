...
pub mod get_cached_server_name {
    ...
    pub mod execute {
        ...
        impl RequestBuilder {
            ...
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::CachedServerName>> {
...
pub mod get_private_dns_zone_suffix {
    ...
    pub mod execute {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::PrivateDnsZoneSuffix>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
...
pub mod backups {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::ServerBackup>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
...
pub mod virtual_network_subnet_usage {
    ...
    pub mod execute {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::VirtualNetworkSubnetUsageResult>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
