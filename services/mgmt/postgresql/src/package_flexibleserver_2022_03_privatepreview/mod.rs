...
impl Client {
    ...
    pub fn get_cached_server_name_client(&self) -> get_cached_server_name::Client {
        get_cached_server_name::Client(self.clone())
    }
...
pub mod get_cached_server_name {
    use super::models;
    ...
    impl Client {
        #[doc = "Get available cached server name for fast provisioning"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `location_name`: The name of the location."]
        #[doc = "* `cached_server_name_request`: The required parameters for get cached name available for fast provisioning."]
        pub fn execute(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            location_name: impl Into<String>,
            cached_server_name_request: impl Into<models::CachedServerNameRequest>,
            ...
            execute::RequestBuilder {
                ...
                cached_server_name_request: cached_server_name_request.into(),
            }
        }
    }
    pub mod execute {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CachedServerName> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CachedServerName = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) cached_server_name_request: models::CachedServerNameRequest,
        }
        impl RequestBuilder {
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        let req_body = azure_core::to_json(&this.cached_server_name_request)?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DBforPostgreSQL/locations/{}/getCachedServerName",
                    &self.subscription_id, &self.resource_group_name, &self.location_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-03-08-privatepreview");
                }
                Ok(url)
            }
        }
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::CachedServerName>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::CachedServerName>>;
...
pub mod get_private_dns_zone_suffix {
    ...
    pub mod execute {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.DBforPostgreSQL/getPrivateDnsZoneSuffix",));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-01-20-preview");
...
pub mod operations {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/providers/Microsoft.DBforPostgreSQL/operations",));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-01-20-preview");
