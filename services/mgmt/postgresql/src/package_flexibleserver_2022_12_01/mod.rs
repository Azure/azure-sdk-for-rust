...
pub mod administrators {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::ActiveDirectoryAdministrator>> {
...
pub mod replicas {
    ...
    pub mod list_by_server {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Send the request and return the response body."]
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<models::ServerListResult>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
