...
pub struct ServerProperties {
    ...
    #[doc = "The subscription id of source serve PostgreSQL server name to restore from."]
    #[serde(rename = "sourceSubscriptionId", default, skip_serializing_if = "Option::is_none")]
    pub source_subscription_id: Option<String>,
    #[doc = "The resource group name of source serve PostgreSQL server name to restore from."]
