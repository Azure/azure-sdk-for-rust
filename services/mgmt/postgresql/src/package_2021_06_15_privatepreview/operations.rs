...
pub mod migrations {
    ...
    impl Client {
        pub fn get(
            ...
            target_db_server_resource_group_name: impl Into<String>,
            target_db_server_name: impl Into<String>,
            migration_name: impl Into<String>,
        ) -> get::Builder {
            get::Builder {
                client: self.0.clone(),
                target_db_server_subscription_id: target_db_server_subscription_id.into(),
                target_db_server_resource_group_name: target_db_server_resource_group_name.into(),
    ...
    pub mod get {
        ...
        pub struct Builder {
            ...
            pub(crate) target_db_server_subscription_id: String,
            pub(crate) target_db_server_resource_group_name: String,
            pub(crate) target_db_server_name: String,
            pub(crate) migration_name: String,
        }
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::MigrationResource, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DBforPostgreSQL/flexibleServers/{}/migrations/{}",
                        self.client.endpoint(),
                        &self.target_db_server_subscription_id,
                        &self.target_db_server_resource_group_name,
                    ...
                    url.query_pairs_mut().append_pair("api-version", "2021-06-15-privatepreview");
    ...
    pub mod list_by_target_server {
        ...
        impl Builder {
            ...
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, std::result::Result<models::MigrationResourceListResult, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DBforPostgreSQL/flexibleServers/{}/migrations",
                        self.client.endpoint(),
                    ...
                    req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
                    url.query_pairs_mut().append_pair("api-version", "2021-06-15-privatepreview");
                    if let Some(migration_list_filter) = &self.migration_list_filter {
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                            let rsp_value: models::MigrationResourceListResult =
                                serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                            Ok(rsp_value)
                        }
                        status_code => {
...
impl Client {
    ...
    ) -> check_migration_name_availability::Builder {
        check_migration_name_availability::Builder {
            client: self.clone(),
            target_db_server_subscription_id: target_db_server_subscription_id.into(),
            target_db_server_resource_group_name: target_db_server_resource_group_name.into(),
...
pub mod check_migration_name_availability {
    ...
    impl Builder {
        pub fn into_future(
            self,
        ) -> futures::future::BoxFuture<'static, std::result::Result<models::MigrationNameAvailabilityResource, Error>> {
            Box::pin(async move {
                let url_str = & format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DBforPostgreSQL/flexibleServers/{}/checkMigrationNameAvailability" , self . client . endpoint () , & self . target_db_server_subscription_id , & self . target_db_server_resource_group_name , & self . target_db_server_name) ;
                let mut url = url::Url::parse(url_str).map_err(Error::ParseUrl)?;
                let mut req_builder = http::request::Builder::new();
                ...
                match rsp_status {
                    http::StatusCode::OK => {
                        let rsp_body = azure_core::collect_pinned_stream(rsp_stream).await.map_err(Error::ResponseBytes)?;
                        let rsp_value: models::MigrationNameAvailabilityResource =
                            serde_json::from_slice(&rsp_body).map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                        Ok(rsp_value)
                    }
                    status_code => {
