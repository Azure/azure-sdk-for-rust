...
pub enum Error {
    #[error(transparent)]
    Migrations_Get(#[from] migrations::get::Error),
    #[error(transparent)]
    Migrations_Create(#[from] migrations::create::Error),
    #[error(transparent)]
    Migrations_Update(#[from] migrations::update::Error),
    #[error(transparent)]
    Migrations_Delete(#[from] migrations::delete::Error),
    #[error(transparent)]
    Migrations_ListByTargetServer(#[from] migrations::list_by_target_server::Error),
    #[error(transparent)]
    CheckMigrationNameAvailability(#[from] check_migration_name_availability::Error),
    #[error(transparent)]
...
pub mod migrations {
    ...
    pub async fn get(
        ...
        migration_name: &str,
    ) -> std::result::Result<models::MigrationResource, get::Error> {
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                ...
                let rsp_value: models::MigrationResource =
                    serde_json::from_slice(rsp_body).map_err(|source| get::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::ServiceError =
                    serde_json::from_slice(rsp_body).map_err(|source| get::Error::DeserializeError(source, rsp_body.clone()))?;
    ...
    pub async fn create(
        ...
        target_db_server_name: &str,
        migration_name: &str,
        parameters: &models::MigrationResource,
    ...
    pub mod create {
        ...
        #[derive(Debug)]
        pub enum Response {
            Ok200(models::MigrationResource),
            Created201(models::MigrationResource),
        }
        #[derive(Debug, thiserror :: Error)]
        pub enum Error {
            #[error("HTTP status code {}", status_code)]
    ...
    pub async fn update(
        ...
        target_db_server_name: &str,
        migration_name: &str,
        parameters: &models::MigrationResourceForPatch,
    ) -> std::result::Result<models::MigrationResource, update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DBforPostgreSQL/flexibleServers/{}/migrations/{}",
            operation_config.base_path(),
    ...
    pub async fn list_by_target_server(
        operation_config: &crate::OperationConfig,
        target_db_server_subscription_id: &str,
        target_db_server_resource_group_name: &str,
        target_db_server_name: &str,
        migration_list_filter: Option<&str>,
    ) -> std::result::Result<models::MigrationResourceListResult, list_by_target_server::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DBforPostgreSQL/flexibleServers/{}/migrations",
            operation_config.base_path(),
        ...
        let mut url = url::Url::parse(url_str).map_err(list_by_target_server::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::GET);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(list_by_target_server::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
        if let Some(migration_list_filter) = migration_list_filter {
            url.query_pairs_mut().append_pair("migrationListFilter", migration_list_filter);
        }
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        req_builder = req_builder.uri(url.as_str());
        let req = req_builder
            .body(req_body)
            .map_err(list_by_target_server::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(list_by_target_server::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::MigrationResourceListResult = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_by_target_server::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: models::ServiceError = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_by_target_server::Error::DeserializeError(source, rsp_body.clone()))?;
                Err(list_by_target_server::Error::DefaultResponse {
                    status_code,
                    value: rsp_value,
                })
            }
...
pub async fn check_migration_name_availability(
    operation_config: &crate::OperationConfig,
    target_db_server_subscription_id: &str,
    target_db_server_resource_group_name: &str,
    target_db_server_name: &str,
    parameters: &models::MigrationNameAvailabilityResource,
) -> std::result::Result<models::MigrationNameAvailabilityResource, check_migration_name_availability::Error> {
    let http_client = operation_config.http_client();
    let url_str = &format!(
    ...
    let mut url = url::Url::parse(url_str).map_err(check_migration_name_availability::Error::ParseUrlError)?;
    let mut req_builder = http::request::Builder::new();
    ...
    if let Some(token_credential) = operation_config.token_credential() {
        let token_response = token_credential
            .get_token(operation_config.token_credential_resource())
            .await
            .map_err(check_migration_name_availability::Error::GetTokenError)?;
        req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
    }
    url.query_pairs_mut().append_pair("api-version", super::API_VERSION);
    req_builder = req_builder.header("content-type", "application/json");
    let req_body = azure_core::to_json(parameters).map_err(check_migration_name_availability::Error::SerializeError)?;
    req_builder = req_builder.uri(url.as_str());
    let req = req_builder
        .body(req_body)
        .map_err(check_migration_name_availability::Error::BuildRequestError)?;
    let rsp = http_client
        .execute_request(req)
        .await
        .map_err(check_migration_name_availability::Error::ExecuteRequestError)?;
    match rsp.status() {
        http::StatusCode::OK => {
            let rsp_body = rsp.body();
            let rsp_value: models::MigrationNameAvailabilityResource = serde_json::from_slice(rsp_body)
                .map_err(|source| check_migration_name_availability::Error::DeserializeError(source, rsp_body.clone()))?;
            Ok(rsp_value)
        }
        status_code => {
            let rsp_body = rsp.body();
            let rsp_value: models::ServiceError = serde_json::from_slice(rsp_body)
                .map_err(|source| check_migration_name_availability::Error::DeserializeError(source, rsp_body.clone()))?;
            Err(check_migration_name_availability::Error::DefaultResponse {
                status_code,
                value: rsp_value,
            })
        }
...
pub mod servers {
    ...
    pub async fn restart(
        ...
        resource_group_name: &str,
        server_name: &str,
        parameters: Option<&models::RestartParameter>,
...
pub mod location_based_capabilities {
    ...
    pub async fn execute(
        ...
        subscription_id: &str,
        location_name: &str,
    ) -> std::result::Result<models::CapabilitiesListResult, execute::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
