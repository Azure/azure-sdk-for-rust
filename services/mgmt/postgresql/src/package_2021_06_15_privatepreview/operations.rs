...
pub mod migrations {
    ...
    impl Client {
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `target_db_server_subscription_id`: The subscription ID of the target database server."]
        #[doc = "* `target_db_server_resource_group_name`: The resource group name of the target database server."]
            ...
            pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            .query_pairs_mut()
                            .append_pair(azure_core::query_param::API_VERSION, "2021-06-15-privatepreview");
                        ...
                        match rsp_status {
                            azure_core::StatusCode::Ok => {
                                ...
                                let rsp_value: models::MigrationResource = serde_json::from_slice(&rsp_body)?;
                                Ok(rsp_value)
                            }
    ...
    impl Builder {
        pub fn into_future(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
            Box::pin({
                let this = self.clone();
                async move {
                    let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DBforPostgreSQL/flexibleServers/{}/checkMigrationNameAvailability" , this . client . endpoint () , & this . target_db_server_subscription_id , & this . target_db_server_resource_group_name , & this . target_db_server_name)) ? ;
