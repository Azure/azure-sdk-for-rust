...
pub struct MigrationResourceProperties {
    ...
    #[doc = "ResourceId of the private endpoint migration instance"]
    #[serde(rename = "migrationInstanceResourceId", default, skip_serializing_if = "Option::is_none")]
    pub migration_instance_resource_id: Option<String>,
    #[doc = "There are two types of migration modes Online and Offline"]
    ...
    #[doc = "Migration source server type : OnPremises, AWS, GCP, AzureVM, PostgreSQLSingleServer, AWS_RDS, AWS_AURORA, AWS_EC2, GCP_CloudSQL, GCP_AlloyDB, GCP_Compute, or EDB"]
    ...
    #[doc = "Source server fully qualified domain name (FQDN) or IP address. It is a optional value, if customer provide it, migration service will always use it for connection"]
    #[serde(
    ...
    #[doc = "Target server fully qualified domain name (FQDN) or IP address. It is a optional value, if customer provide it, migration service will always use it for connection"]
    #[serde(
    ...
    #[doc = "To migrate roles and permissions we need to send this flag as True"]
    #[serde(rename = "migrateRoles", default, skip_serializing_if = "Option::is_none")]
    pub migrate_roles: Option<migration_resource_properties::MigrateRoles>,
...
pub mod migration_resource_properties {
    ...
    #[doc = "To migrate roles and permissions we need to send this flag as True"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "MigrateRoles")]
    pub enum MigrateRoles {
        True,
        False,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for MigrateRoles {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for MigrateRoles {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for MigrateRoles {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::True => serializer.serialize_unit_variant("MigrateRoles", 0u32, "True"),
                Self::False => serializer.serialize_unit_variant("MigrateRoles", 1u32, "False"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct MigrationResourcePropertiesForPatch {
    ...
    #[doc = "To migrate roles and permissions we need to send this flag as True"]
    #[serde(rename = "migrateRoles", default, skip_serializing_if = "Option::is_none")]
    pub migrate_roles: Option<migration_resource_properties_for_patch::MigrateRoles>,
    #[doc = "Indicates whether the data migration should start right away"]
    #[serde(rename = "startDataMigration", default, skip_serializing_if = "Option::is_none")]
...
pub mod server_backup_properties {
    ...
    pub enum BackupType {
        Full,
        #[serde(rename = "Customer On-Demand")]
        CustomerOnDemand,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    ...
    impl Serialize for BackupType {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::CustomerOnDemand => serializer.serialize_unit_variant("BackupType", 1u32, "Customer On-Demand"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct ServerPropertiesForUpdate {
    #[doc = "The administrator's login name of a server. Can only be specified when the server is trying to switch to password authentication and does not have default administrator login."]
    #[serde(rename = "administratorLogin", default, skip_serializing_if = "Option::is_none")]
    pub administrator_login: Option<String>,
...
impl Serialize for ServerVersion {
    ...
    {
        match self {
            Self::N16 => serializer.serialize_unit_variant("ServerVersion", 0u32, "16"),
            Self::N15 => serializer.serialize_unit_variant("ServerVersion", 1u32, "15"),
            Self::N14 => serializer.serialize_unit_variant("ServerVersion", 2u32, "14"),
            Self::N13 => serializer.serialize_unit_variant("ServerVersion", 3u32, "13"),
            Self::N12 => serializer.serialize_unit_variant("ServerVersion", 4u32, "12"),
            Self::N11 => serializer.serialize_unit_variant("ServerVersion", 5u32, "11"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub enum SourceType {
    ...
    #[serde(rename = "AWS_RDS")]
    AwsRds,
    #[serde(rename = "AWS_AURORA")]
    AwsAurora,
    #[serde(rename = "AWS_EC2")]
    AwsEc2,
    #[serde(rename = "GCP_CloudSQL")]
    GcpCloudSql,
    #[serde(rename = "GCP_AlloyDB")]
    GcpAlloyDb,
    #[serde(rename = "GCP_Compute")]
    GcpCompute,
    #[serde(rename = "EDB")]
    Edb,
    #[serde(skip_deserializing)]
...
impl Serialize for SourceType {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::AwsRds => serializer.serialize_unit_variant("SourceType", 5u32, "AWS_RDS"),
            Self::AwsAurora => serializer.serialize_unit_variant("SourceType", 6u32, "AWS_AURORA"),
            Self::AwsEc2 => serializer.serialize_unit_variant("SourceType", 7u32, "AWS_EC2"),
            Self::GcpCloudSql => serializer.serialize_unit_variant("SourceType", 8u32, "GCP_CloudSQL"),
            Self::GcpAlloyDb => serializer.serialize_unit_variant("SourceType", 9u32, "GCP_AlloyDB"),
            Self::GcpCompute => serializer.serialize_unit_variant("SourceType", 10u32, "GCP_Compute"),
            Self::Edb => serializer.serialize_unit_variant("SourceType", 11u32, "EDB"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
