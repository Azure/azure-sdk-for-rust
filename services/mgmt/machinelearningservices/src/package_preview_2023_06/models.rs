...
pub struct DataDriftMonitoringSignal {
    ...
    pub production_data: MonitoringInputDataBase,
    #[doc = "Monitoring input data base definition."]
    #[serde(rename = "referenceData")]
    pub reference_data: MonitoringInputDataBase,
}
...
pub struct FeatureAttributionDriftMonitoringSignal {
    ...
    #[serde(rename = "productionData")]
    pub production_data: Vec<MonitoringInputDataBase>,
    #[doc = "Monitoring input data base definition."]
    #[serde(rename = "referenceData")]
    pub reference_data: MonitoringInputDataBase,
}
impl FeatureAttributionDriftMonitoringSignal {
    pub fn new(
        ...
        production_data: Vec<MonitoringInputDataBase>,
        reference_data: MonitoringInputDataBase,
    ) -> Self {
        Self {
            monitoring_signal_base,
...
pub struct MonitorComputeIdentityBase {
    ...
    #[serde(rename = "computeIdentityType", with = "azure_core::xml::text_content")]
...
pub struct MonitorDefinition {
    ...
    pub compute_configuration: MonitorComputeConfigurationBase,
...
impl MonitorDefinition {
    pub fn new(compute_configuration: MonitorComputeConfigurationBase, signals: serde_json::Value) -> Self {
        Self {
...
pub struct MonitorServerlessSparkCompute {
    ...
    pub compute_identity: MonitorComputeIdentityBase,
...
pub struct MonitoringInputDataBase {
    ...
    #[serde(rename = "inputDataType", with = "azure_core::xml::text_content")]
...
impl PackageRequest {
    pub fn new(inferencing_server: InferencingServer, target_environment_id: String) -> Self {
        Self {
