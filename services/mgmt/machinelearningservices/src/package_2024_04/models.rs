...
use std::str::FromStr;
#[doc = "This connection type covers the AAD auth for any applicable Azure service"]
...
impl AadAuthTypeWorkspaceConnectionProperties {
...
#[doc = "This connection type covers the account key connection for Azure storage"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
impl AccountKeyAuthTypeWorkspaceConnectionProperties {
    pub fn new(workspace_connection_properties_v2: WorkspaceConnectionPropertiesV2) -> Self {
        Self {
            workspace_connection_properties_v2,
            credentials: None,
...
impl AzureDataLakeGen2Datastore {
    pub fn new(datastore: Datastore, filesystem: String, account_name: String) -> Self {
        Self {
            azure_datastore: AzureDatastore::default(),
            datastore,
            filesystem,
...
impl CertificateDatastoreCredentials {
    pub fn new(tenant_id: String, client_id: String, thumbprint: String, secrets: CertificateDatastoreSecrets) -> Self {
        Self {
            authority_url: None,
            resource_url: None,
            tenant_id,
...
impl Serialize for ConnectionAuthType {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::AccountKey => serializer.serialize_unit_variant("ConnectionAuthType", 5u32, "AccountKey"),
            Self::ServicePrincipal => serializer.serialize_unit_variant("ConnectionAuthType", 6u32, "ServicePrincipal"),
            Self::AccessKey => serializer.serialize_unit_variant("ConnectionAuthType", 7u32, "AccessKey"),
            Self::ApiKey => serializer.serialize_unit_variant("ConnectionAuthType", 8u32, "ApiKey"),
            Self::CustomKeys => serializer.serialize_unit_variant("ConnectionAuthType", 9u32, "CustomKeys"),
            Self::OAuth2 => serializer.serialize_unit_variant("ConnectionAuthType", 10u32, "OAuth2"),
            Self::Aad => serializer.serialize_unit_variant("ConnectionAuthType", 11u32, "AAD"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub enum ConnectionCategory {
    ...
    OpenAi,
    Serp,
    #[serde(rename = "BingLLMSearch")]
    BingLlmSearch,
    Serverless,
    #[serde(rename = "AIServices")]
    AiServices,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
...
impl Serialize for ConnectionCategory {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::AzureBlob => serializer.serialize_unit_variant("ConnectionCategory", 16u32, "AzureBlob"),
            Self::AzureOneLake => serializer.serialize_unit_variant("ConnectionCategory", 17u32, "AzureOneLake"),
            Self::CosmosDb => serializer.serialize_unit_variant("ConnectionCategory", 18u32, "CosmosDb"),
            Self::CosmosDbMongoDbApi => serializer.serialize_unit_variant("ConnectionCategory", 19u32, "CosmosDbMongoDbApi"),
            Self::AzureDataExplorer => serializer.serialize_unit_variant("ConnectionCategory", 20u32, "AzureDataExplorer"),
            Self::AzureMariaDb => serializer.serialize_unit_variant("ConnectionCategory", 21u32, "AzureMariaDb"),
            Self::AzureDatabricksDeltaLake => serializer.serialize_unit_variant("ConnectionCategory", 22u32, "AzureDatabricksDeltaLake"),
            Self::AzureSqlMi => serializer.serialize_unit_variant("ConnectionCategory", 23u32, "AzureSqlMi"),
            Self::AzureTableStorage => serializer.serialize_unit_variant("ConnectionCategory", 24u32, "AzureTableStorage"),
            Self::AmazonRdsForOracle => serializer.serialize_unit_variant("ConnectionCategory", 25u32, "AmazonRdsForOracle"),
            Self::AmazonRdsForSqlServer => serializer.serialize_unit_variant("ConnectionCategory", 26u32, "AmazonRdsForSqlServer"),
            Self::AmazonRedshift => serializer.serialize_unit_variant("ConnectionCategory", 27u32, "AmazonRedshift"),
            Self::Db2 => serializer.serialize_unit_variant("ConnectionCategory", 28u32, "Db2"),
            Self::Drill => serializer.serialize_unit_variant("ConnectionCategory", 29u32, "Drill"),
            Self::GoogleBigQuery => serializer.serialize_unit_variant("ConnectionCategory", 30u32, "GoogleBigQuery"),
            Self::Greenplum => serializer.serialize_unit_variant("ConnectionCategory", 31u32, "Greenplum"),
            Self::Hbase => serializer.serialize_unit_variant("ConnectionCategory", 32u32, "Hbase"),
            Self::Hive => serializer.serialize_unit_variant("ConnectionCategory", 33u32, "Hive"),
            Self::Impala => serializer.serialize_unit_variant("ConnectionCategory", 34u32, "Impala"),
            Self::Informix => serializer.serialize_unit_variant("ConnectionCategory", 35u32, "Informix"),
            Self::MariaDb => serializer.serialize_unit_variant("ConnectionCategory", 36u32, "MariaDb"),
            Self::MicrosoftAccess => serializer.serialize_unit_variant("ConnectionCategory", 37u32, "MicrosoftAccess"),
            Self::MySql => serializer.serialize_unit_variant("ConnectionCategory", 38u32, "MySql"),
            Self::Netezza => serializer.serialize_unit_variant("ConnectionCategory", 39u32, "Netezza"),
            Self::Oracle => serializer.serialize_unit_variant("ConnectionCategory", 40u32, "Oracle"),
            Self::Phoenix => serializer.serialize_unit_variant("ConnectionCategory", 41u32, "Phoenix"),
            Self::PostgreSql => serializer.serialize_unit_variant("ConnectionCategory", 42u32, "PostgreSql"),
            Self::Presto => serializer.serialize_unit_variant("ConnectionCategory", 43u32, "Presto"),
            Self::SapOpenHub => serializer.serialize_unit_variant("ConnectionCategory", 44u32, "SapOpenHub"),
            Self::SapBw => serializer.serialize_unit_variant("ConnectionCategory", 45u32, "SapBw"),
            Self::SapHana => serializer.serialize_unit_variant("ConnectionCategory", 46u32, "SapHana"),
            Self::SapTable => serializer.serialize_unit_variant("ConnectionCategory", 47u32, "SapTable"),
            Self::Spark => serializer.serialize_unit_variant("ConnectionCategory", 48u32, "Spark"),
            Self::SqlServer => serializer.serialize_unit_variant("ConnectionCategory", 49u32, "SqlServer"),
            Self::Sybase => serializer.serialize_unit_variant("ConnectionCategory", 50u32, "Sybase"),
            Self::Teradata => serializer.serialize_unit_variant("ConnectionCategory", 51u32, "Teradata"),
            Self::Vertica => serializer.serialize_unit_variant("ConnectionCategory", 52u32, "Vertica"),
            Self::Cassandra => serializer.serialize_unit_variant("ConnectionCategory", 53u32, "Cassandra"),
            Self::Couchbase => serializer.serialize_unit_variant("ConnectionCategory", 54u32, "Couchbase"),
            Self::MongoDbV2 => serializer.serialize_unit_variant("ConnectionCategory", 55u32, "MongoDbV2"),
            Self::MongoDbAtlas => serializer.serialize_unit_variant("ConnectionCategory", 56u32, "MongoDbAtlas"),
            Self::AmazonS3Compatible => serializer.serialize_unit_variant("ConnectionCategory", 57u32, "AmazonS3Compatible"),
            Self::FileServer => serializer.serialize_unit_variant("ConnectionCategory", 58u32, "FileServer"),
            Self::FtpServer => serializer.serialize_unit_variant("ConnectionCategory", 59u32, "FtpServer"),
            Self::GoogleCloudStorage => serializer.serialize_unit_variant("ConnectionCategory", 60u32, "GoogleCloudStorage"),
            Self::Hdfs => serializer.serialize_unit_variant("ConnectionCategory", 61u32, "Hdfs"),
            Self::OracleCloudStorage => serializer.serialize_unit_variant("ConnectionCategory", 62u32, "OracleCloudStorage"),
            Self::Sftp => serializer.serialize_unit_variant("ConnectionCategory", 63u32, "Sftp"),
            Self::GenericHttp => serializer.serialize_unit_variant("ConnectionCategory", 64u32, "GenericHttp"),
            Self::ODataRest => serializer.serialize_unit_variant("ConnectionCategory", 65u32, "ODataRest"),
            Self::Odbc => serializer.serialize_unit_variant("ConnectionCategory", 66u32, "Odbc"),
            Self::GenericRest => serializer.serialize_unit_variant("ConnectionCategory", 67u32, "GenericRest"),
            Self::AmazonMws => serializer.serialize_unit_variant("ConnectionCategory", 68u32, "AmazonMws"),
            Self::Concur => serializer.serialize_unit_variant("ConnectionCategory", 69u32, "Concur"),
            Self::Dynamics => serializer.serialize_unit_variant("ConnectionCategory", 70u32, "Dynamics"),
            Self::DynamicsAx => serializer.serialize_unit_variant("ConnectionCategory", 71u32, "DynamicsAx"),
            Self::DynamicsCrm => serializer.serialize_unit_variant("ConnectionCategory", 72u32, "DynamicsCrm"),
            Self::GoogleAdWords => serializer.serialize_unit_variant("ConnectionCategory", 73u32, "GoogleAdWords"),
            Self::Hubspot => serializer.serialize_unit_variant("ConnectionCategory", 74u32, "Hubspot"),
            Self::Jira => serializer.serialize_unit_variant("ConnectionCategory", 75u32, "Jira"),
            Self::Magento => serializer.serialize_unit_variant("ConnectionCategory", 76u32, "Magento"),
            Self::Marketo => serializer.serialize_unit_variant("ConnectionCategory", 77u32, "Marketo"),
            Self::Office365 => serializer.serialize_unit_variant("ConnectionCategory", 78u32, "Office365"),
            Self::Eloqua => serializer.serialize_unit_variant("ConnectionCategory", 79u32, "Eloqua"),
            Self::Responsys => serializer.serialize_unit_variant("ConnectionCategory", 80u32, "Responsys"),
            Self::OracleServiceCloud => serializer.serialize_unit_variant("ConnectionCategory", 81u32, "OracleServiceCloud"),
            Self::PayPal => serializer.serialize_unit_variant("ConnectionCategory", 82u32, "PayPal"),
            Self::QuickBooks => serializer.serialize_unit_variant("ConnectionCategory", 83u32, "QuickBooks"),
            Self::Salesforce => serializer.serialize_unit_variant("ConnectionCategory", 84u32, "Salesforce"),
            Self::SalesforceServiceCloud => serializer.serialize_unit_variant("ConnectionCategory", 85u32, "SalesforceServiceCloud"),
            Self::SalesforceMarketingCloud => serializer.serialize_unit_variant("ConnectionCategory", 86u32, "SalesforceMarketingCloud"),
            Self::SapCloudForCustomer => serializer.serialize_unit_variant("ConnectionCategory", 87u32, "SapCloudForCustomer"),
            Self::SapEcc => serializer.serialize_unit_variant("ConnectionCategory", 88u32, "SapEcc"),
            Self::ServiceNow => serializer.serialize_unit_variant("ConnectionCategory", 89u32, "ServiceNow"),
            Self::SharePointOnlineList => serializer.serialize_unit_variant("ConnectionCategory", 90u32, "SharePointOnlineList"),
            Self::Shopify => serializer.serialize_unit_variant("ConnectionCategory", 91u32, "Shopify"),
            Self::Square => serializer.serialize_unit_variant("ConnectionCategory", 92u32, "Square"),
            Self::WebTable => serializer.serialize_unit_variant("ConnectionCategory", 93u32, "WebTable"),
            Self::Xero => serializer.serialize_unit_variant("ConnectionCategory", 94u32, "Xero"),
            Self::Zoho => serializer.serialize_unit_variant("ConnectionCategory", 95u32, "Zoho"),
            Self::GenericContainerRegistry => serializer.serialize_unit_variant("ConnectionCategory", 96u32, "GenericContainerRegistry"),
            Self::OpenAi => serializer.serialize_unit_variant("ConnectionCategory", 97u32, "OpenAI"),
            Self::Serp => serializer.serialize_unit_variant("ConnectionCategory", 98u32, "Serp"),
            Self::BingLlmSearch => serializer.serialize_unit_variant("ConnectionCategory", 99u32, "BingLLMSearch"),
            Self::Serverless => serializer.serialize_unit_variant("ConnectionCategory", 100u32, "Serverless"),
            Self::AiServices => serializer.serialize_unit_variant("ConnectionCategory", 101u32, "AIServices"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "Group based on connection category"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ConnectionGroup")]
pub enum ConnectionGroup {
    Azure,
    #[serde(rename = "AzureAI")]
    AzureAi,
    Database,
    #[serde(rename = "NoSQL")]
    NoSql,
...
impl Serialize for ConnectionGroup {
    ...
    {
        match self {
            Self::Azure => serializer.serialize_unit_variant("ConnectionGroup", 0u32, "Azure"),
            Self::AzureAi => serializer.serialize_unit_variant("ConnectionGroup", 1u32, "AzureAI"),
            Self::Database => serializer.serialize_unit_variant("ConnectionGroup", 2u32, "Database"),
            Self::NoSql => serializer.serialize_unit_variant("ConnectionGroup", 3u32, "NoSQL"),
            Self::File => serializer.serialize_unit_variant("ConnectionGroup", 4u32, "File"),
            Self::GenericProtocol => serializer.serialize_unit_variant("ConnectionGroup", 5u32, "GenericProtocol"),
            Self::ServicesAndApps => serializer.serialize_unit_variant("ConnectionGroup", 6u32, "ServicesAndApps"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct ContentSafety {
    #[doc = "Specifies the status of content safety."]
    #[serde(rename = "contentSafetyStatus")]
    pub content_safety_status: ContentSafetyStatus,
}
impl ContentSafety {
    pub fn new(content_safety_status: ContentSafetyStatus) -> Self {
        Self { content_safety_status }
    }
}
#[doc = "Specifies the status of content safety."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ContentSafetyStatus")]
...
impl Serialize for ContentSafetyStatus {
    ...
    {
        match self {
            Self::Enabled => serializer.serialize_unit_variant("ContentSafetyStatus", 0u32, "Enabled"),
            Self::Disabled => serializer.serialize_unit_variant("ContentSafetyStatus", 1u32, "Disabled"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl Serialize for DatastoreType {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::OneLake => serializer.serialize_unit_variant("DatastoreType", 4u32, "OneLake"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl Serialize for JobType {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::Spark => serializer.serialize_unit_variant("JobType", 4u32, "Spark"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct MarketplacePlan {
    #[doc = "The identifying name of the Publisher of the Marketplace Plan."]
    #[serde(rename = "publisherId", default, skip_serializing_if = "Option::is_none")]
    pub publisher_id: Option<String>,
    #[doc = "The identifying name of the Offer of the Marketplace Plan."]
    #[serde(rename = "offerId", default, skip_serializing_if = "Option::is_none")]
    pub offer_id: Option<String>,
    #[doc = "The identifying name of the Plan of the Marketplace Plan."]
...
pub struct MarketplaceSubscription {
    #[doc = "[Required] Target Marketplace Model ID to create a Marketplace Subscription for."]
    #[serde(rename = "modelId")]
    pub model_id: String,
    #[serde(rename = "marketplacePlan", default, skip_serializing_if = "Option::is_none")]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "MarketplaceSubscriptionProvisioningState")]
...
impl Serialize for MarketplaceSubscriptionProvisioningState {
    ...
    {
        match self {
            Self::Creating => serializer.serialize_unit_variant("MarketplaceSubscriptionProvisioningState", 0u32, "Creating"),
            Self::Deleting => serializer.serialize_unit_variant("MarketplaceSubscriptionProvisioningState", 1u32, "Deleting"),
            Self::Succeeded => serializer.serialize_unit_variant("MarketplaceSubscriptionProvisioningState", 2u32, "Succeeded"),
            Self::Failed => serializer.serialize_unit_variant("MarketplaceSubscriptionProvisioningState", 3u32, "Failed"),
            Self::Updating => serializer.serialize_unit_variant("MarketplaceSubscriptionProvisioningState", 4u32, "Updating"),
            Self::Canceled => serializer.serialize_unit_variant("MarketplaceSubscriptionProvisioningState", 5u32, "Canceled"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "Azure Resource Manager resource envelope."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct MarketplaceSubscriptionResource {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    pub properties: MarketplaceSubscription,
}
impl MarketplaceSubscriptionResource {
    pub fn new(properties: MarketplaceSubscription) -> Self {
        Self {
            proxy_resource: ProxyResource::default(),
            properties,
        }
...
#[doc = "A paginated list of MarketplaceSubscription entities."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MarketplaceSubscriptionResourceArmPaginatedResult {
    #[doc = "An array of objects of type MarketplaceSubscription."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<MarketplaceSubscriptionResource>,
    #[doc = "The link to the next page of MarketplaceSubscription objects. If null, there are no additional pages."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for MarketplaceSubscriptionResourceArmPaginatedResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
...
impl Serialize for MarketplaceSubscriptionStatus {
    ...
    {
        match self {
            Self::Subscribed => serializer.serialize_unit_variant("MarketplaceSubscriptionStatus", 0u32, "Subscribed"),
            Self::Suspended => serializer.serialize_unit_variant("MarketplaceSubscriptionStatus", 1u32, "Suspended"),
            Self::Unsubscribed => serializer.serialize_unit_variant("MarketplaceSubscriptionStatus", 2u32, "Unsubscribed"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct ModelSettings {
    #[doc = "The unique model identifier that this ServerlessEndpoint should provision."]
...
impl MonitorDefinition {
    pub fn new(signals: serde_json::Value, compute_configuration: MonitorComputeConfigurationBaseUnion) -> Self {
        Self {
...
pub struct OAuth2AuthTypeWorkspaceConnectionProperties {
    #[serde(flatten)]
    pub workspace_connection_properties_v2: WorkspaceConnectionPropertiesV2,
    #[doc = "ClientId and ClientSecret are required. Other properties are optional\r\ndepending on each OAuth2 provider's implementation."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub credentials: Option<WorkspaceConnectionOAuth2>,
}
impl OAuth2AuthTypeWorkspaceConnectionProperties {
    pub fn new(workspace_connection_properties_v2: WorkspaceConnectionPropertiesV2) -> Self {
        Self {
            workspace_connection_properties_v2,
            credentials: None,
...
impl Objective {
    pub fn new(primary_metric: String, goal: Goal) -> Self {
        Self { primary_metric, goal }
    }
}
...
impl Serialize for RuleCategory {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::Dependency => serializer.serialize_unit_variant("RuleCategory", 3u32, "Dependency"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl Schedule {
    pub fn new(trigger: TriggerBaseUnion, action: ScheduleActionBaseUnion) -> Self {
        Self {
            resource_base: ResourceBase::default(),
            display_name: None,
            is_enabled: None,
...
pub struct ServerlessEndpoint {
    ...
    #[serde(rename = "authMode")]
    pub auth_mode: ServerlessInferenceEndpointAuthMode,
    #[serde(rename = "inferenceEndpoint", default, skip_serializing_if = "Option::is_none")]
    pub inference_endpoint: Option<ServerlessInferenceEndpoint>,
    #[doc = "State of endpoint provisioning."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<EndpointProvisioningState>,
    #[doc = "State of the Serverless Endpoint."]
    #[serde(rename = "endpointState", default, skip_serializing_if = "Option::is_none")]
    pub endpoint_state: Option<ServerlessEndpointState>,
    #[doc = "The MarketplaceSubscription Azure ID associated to this ServerlessEndpoint."]
    ...
    #[serde(rename = "contentSafety", default, skip_serializing_if = "Option::is_none")]
    pub content_safety: Option<ContentSafety>,
}
impl ServerlessEndpoint {
    pub fn new(auth_mode: ServerlessInferenceEndpointAuthMode) -> Self {
        Self {
            model_settings: None,
            auth_mode,
...
#[doc = "State of the Serverless Endpoint."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ServerlessEndpointState")]
...
impl Serialize for ServerlessEndpointState {
    ...
    {
        match self {
            Self::Unknown => serializer.serialize_unit_variant("ServerlessEndpointState", 0u32, "Unknown"),
            Self::Creating => serializer.serialize_unit_variant("ServerlessEndpointState", 1u32, "Creating"),
            Self::Deleting => serializer.serialize_unit_variant("ServerlessEndpointState", 2u32, "Deleting"),
            Self::Suspending => serializer.serialize_unit_variant("ServerlessEndpointState", 3u32, "Suspending"),
            Self::Reinstating => serializer.serialize_unit_variant("ServerlessEndpointState", 4u32, "Reinstating"),
            Self::Online => serializer.serialize_unit_variant("ServerlessEndpointState", 5u32, "Online"),
            Self::Suspended => serializer.serialize_unit_variant("ServerlessEndpointState", 6u32, "Suspended"),
            Self::CreationFailed => serializer.serialize_unit_variant("ServerlessEndpointState", 7u32, "CreationFailed"),
            Self::DeletionFailed => serializer.serialize_unit_variant("ServerlessEndpointState", 8u32, "DeletionFailed"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ServerlessEndpointTrackedResource {
    #[serde(flatten)]
    pub tracked_resource: TrackedResource,
    pub properties: ServerlessEndpoint,
    #[doc = "Metadata used by portal/tooling/etc to render different UX experiences for resources of the same type."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kind: Option<String>,
    #[doc = "Managed service identity (system assigned and/or user assigned identities)"]
...
impl ServerlessEndpointTrackedResource {
    pub fn new(tracked_resource: TrackedResource, properties: ServerlessEndpoint) -> Self {
        Self {
            tracked_resource,
            properties,
            kind: None,
...
#[doc = "A paginated list of ServerlessEndpoint entities."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ServerlessEndpointTrackedResourceArmPaginatedResult {
    #[doc = "An array of objects of type ServerlessEndpoint."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<ServerlessEndpointTrackedResource>,
    #[doc = "The link to the next page of ServerlessEndpoint objects. If null, there are no additional pages."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ServerlessEndpointTrackedResourceArmPaginatedResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
...
pub struct ServerlessInferenceEndpoint {
    #[doc = "[Required] The inference uri to target when making requests against the Serverless Endpoint."]
    pub uri: String,
    #[doc = "Specifies any required headers to target this serverless endpoint."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ServerlessInferenceEndpointAuthMode")]
...
impl Serialize for ServerlessInferenceEndpointAuthMode {
    ...
    {
        match self {
            Self::Key => serializer.serialize_unit_variant("ServerlessInferenceEndpointAuthMode", 0u32, "Key"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl ServicePrincipalDatastoreCredentials {
    pub fn new(tenant_id: String, client_id: String, secrets: ServicePrincipalDatastoreSecrets) -> Self {
        Self {
            authority_url: None,
            resource_url: None,
            tenant_id,
...
pub struct SparkJob {
    ...
    #[doc = "[Required] arm-id of the code asset."]
    #[serde(rename = "codeId")]
    pub code_id: String,
...
impl WorkspaceConnectionAccountKey {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct WorkspaceConnectionOAuth2 {
    #[doc = "Required by Concur connection category"]
    #[serde(rename = "authUrl", default, skip_serializing_if = "Option::is_none")]
    pub auth_url: Option<String>,
    #[doc = "Client id in the format of UUID"]
    #[serde(rename = "clientId", default, skip_serializing_if = "Option::is_none")]
    pub client_id: Option<String>,
    #[serde(rename = "clientSecret", default, skip_serializing_if = "Option::is_none")]
    pub client_secret: Option<String>,
    #[doc = "Required by GoogleAdWords connection category"]
    #[serde(rename = "developerToken", default, skip_serializing_if = "Option::is_none")]
    pub developer_token: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub password: Option<String>,
    #[doc = "Required by GoogleBigQuery, GoogleAdWords, Hubspot, QuickBooks, Square, Xero, Zoho\r\nwhere user needs to get RefreshToken offline"]
    #[serde(rename = "refreshToken", default, skip_serializing_if = "Option::is_none")]
    pub refresh_token: Option<String>,
    #[doc = "Required by QuickBooks and Xero connection categories"]
    #[serde(rename = "tenantId", default, skip_serializing_if = "Option::is_none")]
    pub tenant_id: Option<String>,
    #[doc = "Concur, ServiceNow auth server AccessToken grant type is 'Password'\r\nwhich requires UsernamePassword"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub username: Option<String>,
}
impl WorkspaceConnectionOAuth2 {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct WorkspaceConnectionPropertiesV2 {
    ...
    #[serde(rename = "createdByWorkspaceArmId", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "isSharedToAll", default, skip_serializing_if = "Option::is_none")]
    pub is_shared_to_all: Option<bool>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<String>,
    #[doc = "Store user metadata for this connection"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metadata: Option<serde_json::Value>,
    #[serde(
        rename = "sharedUserList",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub shared_user_list: Vec<String>,
...
impl WorkspaceConnectionPropertiesV2 {
    pub fn new() -> Self {
        Self {
            category: None,
            created_by_workspace_arm_id: None,
            expiry_time: None,
            group: None,
            is_shared_to_all: None,
            target: None,
            metadata: None,
            shared_user_list: Vec::new(),
            value: None,
            value_format: None,
        }
    }
...
pub struct WorkspaceConnectionUsernamePassword {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub password: Option<String>,
    #[doc = "Optional, required by connections like SalesForce for extra security in addition to UsernamePassword"]
