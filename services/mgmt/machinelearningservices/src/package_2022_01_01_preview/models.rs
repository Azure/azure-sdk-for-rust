...
pub struct EncryptionProperty {
    ...
    #[doc = "The Bring-Your-Own cosmosdb account that customer brings to store data"]
    #[serde(rename = "cosmosDbResourceId", default, skip_serializing_if = "Option::is_none")]
    pub cosmos_db_resource_id: Option<String>,
    #[doc = "The Bring-Your-Own storage account that customer brings to store data"]
    ...
    #[doc = "The Bring-Your-Own search account that customer brings to store index"]
...
pub struct WorkspaceProperties {
    ...
    #[doc = "create a workspace with soft delete capability"]
    #[serde(rename = "softDeleteEnabled", default, skip_serializing_if = "Option::is_none")]
    pub soft_delete_enabled: Option<workspace_properties::SoftDeleteEnabled>,
    #[doc = "Allow a soft deleted workspace to be recovered"]
    #[serde(rename = "allowRecoverSoftDeletedWorkspace", default, skip_serializing_if = "Option::is_none")]
    pub allow_recover_soft_deleted_workspace: Option<workspace_properties::AllowRecoverSoftDeletedWorkspace>,
...
pub mod workspace_properties {
    ...
    #[doc = "create a workspace with soft delete capability"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "SoftDeleteEnabled")]
    pub enum SoftDeleteEnabled {
        True,
        False,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for SoftDeleteEnabled {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for SoftDeleteEnabled {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for SoftDeleteEnabled {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::True => serializer.serialize_unit_variant("SoftDeleteEnabled", 0u32, "True"),
                Self::False => serializer.serialize_unit_variant("SoftDeleteEnabled", 1u32, "False"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    #[doc = "Allow a soft deleted workspace to be recovered"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "AllowRecoverSoftDeletedWorkspace")]
    pub enum AllowRecoverSoftDeletedWorkspace {
        True,
        False,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for AllowRecoverSoftDeletedWorkspace {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for AllowRecoverSoftDeletedWorkspace {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for AllowRecoverSoftDeletedWorkspace {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::True => serializer.serialize_unit_variant("AllowRecoverSoftDeletedWorkspace", 0u32, "True"),
                Self::False => serializer.serialize_unit_variant("AllowRecoverSoftDeletedWorkspace", 1u32, "False"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
