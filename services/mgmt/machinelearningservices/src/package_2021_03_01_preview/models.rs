...
impl FromStr for ContentsType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for ContentsType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for ContentsType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::AzureBlob => serializer.serialize_unit_variant("ContentsType", 0u32, "AzureBlob"),
            Self::AzureDataLakeGen1 => serializer.serialize_unit_variant("ContentsType", 1u32, "AzureDataLakeGen1"),
            Self::AzureDataLakeGen2 => serializer.serialize_unit_variant("ContentsType", 2u32, "AzureDataLakeGen2"),
            Self::AzureFile => serializer.serialize_unit_variant("ContentsType", 3u32, "AzureFile"),
            Self::AzureMySql => serializer.serialize_unit_variant("ContentsType", 4u32, "AzureMySql"),
            Self::AzurePostgreSql => serializer.serialize_unit_variant("ContentsType", 5u32, "AzurePostgreSql"),
            Self::AzureSqlDatabase => serializer.serialize_unit_variant("ContentsType", 6u32, "AzureSqlDatabase"),
            Self::GlusterFs => serializer.serialize_unit_variant("ContentsType", 7u32, "GlusterFs"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl Serialize for CredentialsType {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::SqlAdmin => serializer.serialize_unit_variant("CredentialsType", 5u32, "SqlAdmin"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl FromStr for DataBindingMode {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for DataBindingMode {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for DataBindingMode {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Mount => serializer.serialize_unit_variant("DataBindingMode", 0u32, "Mount"),
            Self::Download => serializer.serialize_unit_variant("DataBindingMode", 1u32, "Download"),
            Self::Upload => serializer.serialize_unit_variant("DataBindingMode", 2u32, "Upload"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl Serialize for DatasetType {
    ...
    {
        match self {
            Self::Simple => serializer.serialize_unit_variant("DatasetType", 0u32, "Simple"),
            Self::Dataflow => serializer.serialize_unit_variant("DatasetType", 1u32, "Dataflow"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "Enum to determine docker specification type. Must be either Build or Image."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "DockerSpecificationType")]
...
impl FromStr for DockerSpecificationType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for DockerSpecificationType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for DockerSpecificationType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Build => serializer.serialize_unit_variant("DockerSpecificationType", 0u32, "Build"),
            Self::Image => serializer.serialize_unit_variant("DockerSpecificationType", 1u32, "Image"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl Serialize for EndpointComputeType {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::K8s => serializer.serialize_unit_variant("EndpointComputeType", 1u32, "K8S"),
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "EnvironmentSpecificationType")]
...
impl FromStr for EnvironmentSpecificationType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for EnvironmentSpecificationType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for EnvironmentSpecificationType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Curated => serializer.serialize_unit_variant("EnvironmentSpecificationType", 0u32, "Curated"),
            Self::UserCreated => serializer.serialize_unit_variant("EnvironmentSpecificationType", 1u32, "UserCreated"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "Enum to determine the type of linked service."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "OriginType")]
pub enum OriginType {
    Synapse,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for OriginType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
...
impl Serialize for OriginType {
    ...
    {
        match self {
            Self::Synapse => serializer.serialize_unit_variant("OriginType", 0u32, "Synapse"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "Defines values for a ResourceIdentity's type."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "ResourceIdentityAssignment")]
...
impl FromStr for ResourceIdentityAssignment {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for ResourceIdentityAssignment {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for ResourceIdentityAssignment {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::SystemAssigned => serializer.serialize_unit_variant("ResourceIdentityAssignment", 0u32, "SystemAssigned"),
            Self::UserAssigned => serializer.serialize_unit_variant("ResourceIdentityAssignment", 1u32, "UserAssigned"),
            Self::SystemAssignedUserAssigned => {
                serializer.serialize_unit_variant("ResourceIdentityAssignment", 2u32, "SystemAssigned,UserAssigned")
            }
            Self::None => serializer.serialize_unit_variant("ResourceIdentityAssignment", 3u32, "None"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "SamplingAlgorithm")]
...
impl<'de> Deserialize<'de> for SamplingAlgorithm {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for SamplingAlgorithm {
    ...
    {
        match self {
            Self::Grid => serializer.serialize_unit_variant("SamplingAlgorithm", 0u32, "Grid"),
            Self::Random => serializer.serialize_unit_variant("SamplingAlgorithm", 1u32, "Random"),
            Self::Bayesian => serializer.serialize_unit_variant("SamplingAlgorithm", 2u32, "Bayesian"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl Serialize for ScaleType {
    ...
    {
        match self {
            Self::Auto => serializer.serialize_unit_variant("ScaleType", 0u32, "Auto"),
...
impl Serialize for ScheduleType {
    ...
    {
        match self {
            Self::ComputeStartStop => serializer.serialize_unit_variant("ScheduleType", 0u32, "ComputeStartStop"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl Serialize for SecretsType {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::None => serializer.serialize_unit_variant("SecretsType", 2u32, "None"),
            Self::Sas => serializer.serialize_unit_variant("SecretsType", 3u32, "Sas"),
            Self::ServicePrincipal => serializer.serialize_unit_variant("SecretsType", 4u32, "ServicePrincipal"),
            Self::SqlAdmin => serializer.serialize_unit_variant("SecretsType", 5u32, "SqlAdmin"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
