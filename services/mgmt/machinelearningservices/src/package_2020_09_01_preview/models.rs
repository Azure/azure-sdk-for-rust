...
pub struct ComputeBinding {
    #[doc = "ID of the compute resource."]
...
#[doc = "Represents a category of labels in a labeling job."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
impl LabelCategory {
    pub fn new(classes: serde_json::Value) -> Self {
        Self {
            display_name: None,
...
#[doc = "Represents a label or a category of labels in a labeling job."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "Represents configuration of dataset used in a labeling job."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct LabelingDatasetConfiguration {
    ...
    #[serde(rename = "enableIncrementalDatasetRefresh", default, skip_serializing_if = "Option::is_none")]
...
impl LabelingDatasetConfiguration {
    pub fn new(asset_name: String, dataset_version: String) -> Self {
        Self {
            asset_name,
            enable_incremental_dataset_refresh: None,
            dataset_version,
        }
    }
}
#[doc = "The parameters for creating or updating a labeling job."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct LabelingJobCreateResource {
    #[doc = "Definition of a labeling job."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<LabelingJobProperties>,
}
impl LabelingJobCreateResource {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct LabelingJobImageProperties {
    ...
    #[doc = "Annotation type of image labeling tasks."]
    #[serde(rename = "annotationType", default, skip_serializing_if = "Option::is_none")]
    pub annotation_type: Option<labeling_job_image_properties::AnnotationType>,
}
...
pub mod labeling_job_image_properties {
    use super::*;
    #[doc = "Annotation type of image labeling tasks."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "Instructions for a labeling job."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
#[doc = "Media specific properties in a labeling job."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
impl LabelingJobMediaProperties {
    pub fn new(media_type: labeling_job_media_properties::MediaType) -> Self {
        Self { media_type }
    }
}
...
pub struct LabelingJobProperties {
    ...
    #[doc = "Represents configuration for machine learning assisted features in a labeling job."]
    ...
    #[doc = "Progress metrics for a labeling job."]
    ...
    #[doc = "The job property dictionary. Properties can be added, but not removed or altered."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<serde_json::Value>,
    #[doc = "The job tag dictionary. Tags can be added, removed, and updated."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<serde_json::Value>,
}
impl LabelingJobProperties {
    pub fn new(
        label_categories: serde_json::Value,
...
#[doc = "Machine Learning labeling job object wrapped into ARM resource envelope."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct LabelingJobResource {
    #[doc = "The resource URL of the entity (not URL encoded)."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "The name of the resource entity."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "The resource provider and type."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Paginated list of Machine Learning labeling job objects wrapped in ARM resource envelope."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
impl azure_core::Continuable for LabelingJobResourcePaginatedResult {
    fn continuation(&self) -> Option<String> {
        self.next_link.clone()
    }
}
impl LabelingJobResourcePaginatedResult {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct LabelingJobTextProperties {
    #[serde(flatten)]
    pub labeling_job_media_properties: LabelingJobMediaProperties,
    #[doc = "Annotation type of text labeling tasks."]
    #[serde(rename = "annotationType", default, skip_serializing_if = "Option::is_none")]
    pub annotation_type: Option<labeling_job_text_properties::AnnotationType>,
}
...
pub mod labeling_job_text_properties {
    use super::*;
    #[doc = "Annotation type of text labeling tasks."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub enum AnnotationType {
...
#[doc = "object used for creating linked service."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct LinkedServiceRequest {
    #[doc = "Friendly name of the linked service"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "location of the linked service."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub location: Option<String>,
    #[doc = "Identity for the resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct LinkedServiceResponse {
    #[doc = "ResourceId of the link of the linked service."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "Friendly name of the linked service."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "Resource type of linked service."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<String>,
    #[doc = "location of the linked service."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct MlAssistConfiguration {
    ...
    #[doc = "Name prefix to use for machine learning model. For each iteration modelName will be appended with iteration e.g.{modelName}_{i}."]
    #[serde(rename = "modelNamePrefix")]
    pub model_name_prefix: String,
    #[doc = "Prelabel accuracy threshold used in MLAssist feature."]
    #[serde(rename = "prelabelAccuracyThreshold", default, skip_serializing_if = "Option::is_none")]
...
impl MlAssistConfiguration {
    pub fn new(inferencing_compute_binding: ComputeBinding, training_compute_binding: ComputeBinding, model_name_prefix: String) -> Self {
        Self {
            inferencing_compute_binding,
            training_compute_binding,
            model_name_prefix,
            prelabel_accuracy_threshold: None,
...
impl NotebookListCredentialsResult {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct StatusMessage {
    #[doc = "Severity level of the status message."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
