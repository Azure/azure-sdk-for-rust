...
#[cfg(all(feature = "package-2020-08-01", not(feature = "no-default-tag")))]
...
#[cfg(all(feature = "package-2019-05-01", not(feature = "no-default-tag")))]
...
#[cfg(all(feature = "package-2018-11-19", not(feature = "no-default-tag")))]
...
#[cfg(all(feature = "package-2020-02-18-preview", not(feature = "no-default-tag")))]
