...
pub mod machine_learning_datasets {
    ...
    pub async fn list_by_workspace(
        ...
        workspace_name: &str,
        skiptoken: Option<&str>,
    ) -> std::result::Result<models::PaginatedDatasetResourcesList, list_by_workspace::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::PaginatedDatasetResourcesList = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_by_workspace::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
    ...
    pub async fn create_or_update(
        ...
        workspace_name: &str,
        dataset_name: &str,
        properties: &models::DatasetCreateRequest,
    ) -> std::result::Result<create_or_update::Response, create_or_update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.MachineLearningServices/workspaces/{}/datasets/{}",
...
pub mod machine_learning_datastores {
    ...
    pub async fn list_by_workspace(
        ...
        workspace_name: &str,
        skiptoken: Option<&str>,
    ) -> std::result::Result<models::PaginatedDatastoreResourcesList, list_by_workspace::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        match rsp.status() {
            http::StatusCode::OK => {
                let rsp_body = rsp.body();
                let rsp_value: models::PaginatedDatastoreResourcesList = serde_json::from_slice(rsp_body)
                    .map_err(|source| list_by_workspace::Error::DeserializeError(source, rsp_body.clone()))?;
                Ok(rsp_value)
            }
            status_code => {
    ...
    pub async fn get(
        ...
        workspace_name: &str,
        datastore_name: &str,
    ) -> std::result::Result<models::DatastoreResource, get::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.MachineLearningServices/workspaces/{}/datastores/{}",
            operation_config.base_path(),
    ...
    pub async fn create_or_update(
        ...
        workspace_name: &str,
        datastore_name: &str,
        properties: &models::DatastoreCreateRequest,
    ) -> std::result::Result<create_or_update::Response, create_or_update::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.MachineLearningServices/workspaces/{}/datastores/{}",
