...
pub enum Error {
    ...
    #[error(transparent)]
    Workspace_ListSkus(#[from] workspace::list_skus::Error),
    #[error(transparent)]
    ...
    #[error(transparent)]
    StorageAccount_ListKeys(#[from] storage_account::list_keys::Error),
    #[error(transparent)]
...
pub mod notebooks {
    ...
    pub async fn list_keys(
        ...
        resource_group_name: &str,
        workspace_name: &str,
    ) -> std::result::Result<models::ListNotebookKeysResult, list_keys::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
...
pub mod storage_account {
    ...
    pub async fn list_keys(
        ...
        resource_group_name: &str,
        workspace_name: &str,
    ) -> std::result::Result<models::ListStorageAccountKeysResult, list_keys::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
