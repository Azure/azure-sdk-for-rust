...
impl LinkableEnvironmentRequest {
    pub fn new(tenant_id: String, user_principal: String, region: String) -> Self {
        Self {
            tenant_id,
            user_principal,
            region,
...
#[doc = "Request for getting Marketplace SaaS resource details for a tenant Id"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct MarketplaceSaaSResourceDetailsRequest {
    #[doc = "Tenant Id"]
    #[serde(rename = "tenantId")]
    pub tenant_id: String,
}
impl MarketplaceSaaSResourceDetailsRequest {
    pub fn new(tenant_id: String) -> Self {
        Self { tenant_id }
    }
}
#[doc = "Marketplace SaaS resource details linked to the given tenant Id"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MarketplaceSaaSResourceDetailsResponse {
    #[doc = "Id of the Marketplace SaaS Resource"]
    #[serde(rename = "marketplaceSaaSResourceId", default, skip_serializing_if = "Option::is_none")]
    pub marketplace_saa_s_resource_id: Option<String>,
    #[doc = "Id of the plan"]
...
impl MarketplaceSaaSResourceDetailsResponse {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl SsoDetailsRequest {
    pub fn new(user_principal: String) -> Self {
        Self { user_principal }
    }
}
