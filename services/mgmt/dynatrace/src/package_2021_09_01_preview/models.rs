...
pub struct PlanData {
    ...
    pub usage_type: Option<MediumString>,
    #[doc = "Shorthand for setting length limit."]
    #[serde(rename = "billingCycle", default, skip_serializing_if = "Option::is_none")]
    pub billing_cycle: Option<MediumString>,
    #[doc = "Shorthand for setting length limit."]
...
pub struct UserInfo {
    ...
    pub first_name: Option<MediumString>,
    #[doc = "Shorthand for setting length limit."]
    #[serde(rename = "lastName", default, skip_serializing_if = "Option::is_none")]
    pub last_name: Option<MediumString>,
