...
#[doc = "The Storage Account ManagementPolicies Rules, in JSON format. See more details in: https://docs.microsoft.com/en-us/azure/storage/common/storage-lifecycle-managment-concepts."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
impl ManagementPoliciesRulesSetParameter {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct StorageAccountManagementPolicies {
    #[serde(flatten)]
    pub resource: Resource,
    #[doc = "The Storage Account Data Policies properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<StorageAccountManagementPoliciesRulesProperty>,
}
impl StorageAccountManagementPolicies {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl StorageAccountManagementPoliciesRulesProperty {
    pub fn new() -> Self {
        Self::default()
    }
}
