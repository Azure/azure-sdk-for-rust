...
pub mod storage_accounts {
    ...
    pub async fn hierarchical_namespace_migration(
        operation_config: &crate::OperationConfig,
        resource_group_name: &str,
        account_name: &str,
        subscription_id: &str,
        request_type: &str,
    ) -> std::result::Result<hierarchical_namespace_migration::Response, hierarchical_namespace_migration::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        let mut url = url::Url::parse(url_str).map_err(hierarchical_namespace_migration::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::POST);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(hierarchical_namespace_migration::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
        ...
        let req = req_builder
            .body(req_body)
            .map_err(hierarchical_namespace_migration::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(hierarchical_namespace_migration::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => Ok(hierarchical_namespace_migration::Response::Ok200),
            http::StatusCode::ACCEPTED => Ok(hierarchical_namespace_migration::Response::Accepted202),
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: ErrorResponse = serde_json::from_slice(rsp_body)
                    .map_err(|source| hierarchical_namespace_migration::Error::DeserializeError(source, rsp_body.clone()))?;
                Err(hierarchical_namespace_migration::Error::DefaultResponse {
                    status_code,
                    value: rsp_value,
                })
            }
    ...
    pub async fn abort_hierarchical_namespace_migration(
        operation_config: &crate::OperationConfig,
        resource_group_name: &str,
        account_name: &str,
        subscription_id: &str,
    ) -> std::result::Result<abort_hierarchical_namespace_migration::Response, abort_hierarchical_namespace_migration::Error> {
        let http_client = operation_config.http_client();
        let url_str = &format!(
        ...
        let mut url = url::Url::parse(url_str).map_err(abort_hierarchical_namespace_migration::Error::ParseUrlError)?;
        let mut req_builder = http::request::Builder::new();
        req_builder = req_builder.method(http::Method::POST);
        if let Some(token_credential) = operation_config.token_credential() {
            let token_response = token_credential
                .get_token(operation_config.token_credential_resource())
                .await
                .map_err(abort_hierarchical_namespace_migration::Error::GetTokenError)?;
            req_builder = req_builder.header(http::header::AUTHORIZATION, format!("Bearer {}", token_response.token.secret()));
        }
        url.query_pairs_mut().append_pair("api-version", operation_config.api_version());
        let req_body = bytes::Bytes::from_static(azure_core::EMPTY_BODY);
        ...
        let req = req_builder
            .body(req_body)
            .map_err(abort_hierarchical_namespace_migration::Error::BuildRequestError)?;
        let rsp = http_client
            .execute_request(req)
            .await
            .map_err(abort_hierarchical_namespace_migration::Error::ExecuteRequestError)?;
        match rsp.status() {
            http::StatusCode::OK => Ok(abort_hierarchical_namespace_migration::Response::Ok200),
            http::StatusCode::ACCEPTED => Ok(abort_hierarchical_namespace_migration::Response::Accepted202),
            status_code => {
                let rsp_body = rsp.body();
                let rsp_value: ErrorResponse = serde_json::from_slice(rsp_body)
                    .map_err(|source| abort_hierarchical_namespace_migration::Error::DeserializeError(source, rsp_body.clone()))?;
                Err(abort_hierarchical_namespace_migration::Error::DefaultResponse {
                    status_code,
                    value: rsp_value,
                })
            }
