...
pub struct AuthInfoBase {
    #[doc = "Indicates how to apply the authentication configuration operations."]
...
pub enum AuthInfoBaseUnion {
    ...
    #[serde(rename = "easyAuthMicrosoftEntraID")]
...
#[doc = "Indicates how to apply the authentication configuration operations."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "AuthMode")]
pub enum AuthMode {
    #[serde(rename = "optInAllAuth")]
    OptInAllAuth,
    #[serde(rename = "optOutAllAuth")]
    OptOutAllAuth,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
...
impl Serialize for AuthMode {
    ...
    {
        match self {
            Self::OptInAllAuth => serializer.serialize_unit_variant("AuthMode", 0u32, "optInAllAuth"),
            Self::OptOutAllAuth => serializer.serialize_unit_variant("AuthMode", 1u32, "optOutAllAuth"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl Serialize for AuthType {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::EasyAuthMicrosoftEntraId => serializer.serialize_unit_variant("AuthType", 7u32, "easyAuthMicrosoftEntraID"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
#[doc = "The resource properties when type is Azure App Configuration"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AzureAppConfigProperties {
    #[doc = "True if connection enables app configuration kubernetes extension."]
    #[serde(rename = "connectWithKubernetesExtension", default, skip_serializing_if = "Option::is_none")]
    pub connect_with_kubernetes_extension: Option<bool>,
}
impl AzureAppConfigProperties {
    pub fn new() -> Self {
        Self {
            connect_with_kubernetes_extension: None,
        }
    }
}
...
pub enum AzureResourcePropertiesBaseUnion {
    AppConfig(AzureAppConfigProperties),
...
impl Serialize for AzureResourceType {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::AppConfig => serializer.serialize_unit_variant("AzureResourceType", 1u32, "AppConfig"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
impl Serialize for ClientType {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::JmsSpringBoot => serializer.serialize_unit_variant("ClientType", 11u32, "jms-springBoot"),
            Self::Dapr => serializer.serialize_unit_variant("ClientType", 12u32, "dapr"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct ConfigurationInfo {
    ...
    #[doc = "A dictionary of additional properties to be added in the end of connection string."]
    #[serde(rename = "additionalConnectionStringProperties", default, skip_serializing_if = "Option::is_none")]
    pub additional_connection_string_properties: Option<serde_json::Value>,
    #[doc = "An option to store configuration into different place"]
    #[serde(rename = "configurationStore", default, skip_serializing_if = "Option::is_none")]
    pub configuration_store: Option<ConfigurationStore>,
}
...
pub struct ConfigurationNames {
    ...
    #[doc = "The type of secret source."]
    #[serde(rename = "secretType", default, skip_serializing_if = "Option::is_none")]
    pub secret_type: Option<SecretSourceType>,
    #[doc = "Indicates some additional properties for dapr client type"]
    #[serde(rename = "daprProperties", default, skip_serializing_if = "Option::is_none")]
    pub dapr_properties: Option<DaprProperties>,
...
pub struct ConfigurationStore {
    #[doc = "The app configuration id to store configuration"]
    #[serde(rename = "appConfigurationId", default, skip_serializing_if = "Option::is_none")]
    pub app_configuration_id: Option<String>,
}
...
#[doc = "Dapr configuration list supported by Service Connector"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DaprConfigurationList {
    #[doc = "The list of dapr configurations"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<DaprConfigurationResource>,
    #[doc = "Link to next page of resources."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for DaprConfigurationList {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl DaprConfigurationList {
    pub fn new() -> Self {
        Self::default()
    }
}
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DaprConfigurationProperties {
    #[doc = "Supported target resource type, extract from resource id, uppercase"]
...
impl DaprConfigurationProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Represent one resource of the dapr configuration list"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DaprConfigurationResource {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<DaprConfigurationProperties>,
}
impl DaprConfigurationResource {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct DaprMetadata {
    ...
    #[doc = "The description of the metadata, returned from configuration api"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    #[doc = "The value indicating whether the metadata is required or not"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub required: Option<dapr_metadata::Required>,
}
impl DaprMetadata {
    pub fn new() -> Self {
        Self::default()
...
pub mod dapr_metadata {
    use super::*;
    #[doc = "The value indicating whether the metadata is required or not"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Required")]
    pub enum Required {
        #[serde(rename = "true")]
        True,
        #[serde(rename = "false")]
    ...
    impl Serialize for Required {
        ...
        {
            match self {
                Self::True => serializer.serialize_unit_variant("Required", 0u32, "true"),
                Self::False => serializer.serialize_unit_variant("Required", 1u32, "false"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct DaprProperties {
    ...
    #[doc = "The runtime version supported by the properties"]
    #[serde(rename = "runtimeVersion", default, skip_serializing_if = "Option::is_none")]
    pub runtime_version: Option<String>,
    #[doc = "The direction supported by the dapr binding component"]
    #[serde(rename = "bindingComponentDirection", default, skip_serializing_if = "Option::is_none")]
    pub binding_component_direction: Option<dapr_properties::BindingComponentDirection>,
}
impl DaprProperties {
    pub fn new() -> Self {
        Self::default()
...
pub mod dapr_properties {
    use super::*;
    #[doc = "The direction supported by the dapr binding component"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "BindingComponentDirection")]
    pub enum BindingComponentDirection {
        #[serde(rename = "input")]
        Input,
        #[serde(rename = "output")]
        Output,
    ...
    impl FromStr for BindingComponentDirection {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for BindingComponentDirection {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for BindingComponentDirection {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Input => serializer.serialize_unit_variant("BindingComponentDirection", 0u32, "input"),
                Self::Output => serializer.serialize_unit_variant("BindingComponentDirection", 1u32, "output"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "The authentication info when authType is EasyAuth Microsoft Entra ID"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct EasyAuthMicrosoftEntraIdAuthInfo {
    #[serde(flatten)]
    pub auth_info_base: AuthInfoBase,
    #[doc = "Application clientId for EasyAuth Microsoft Entra ID."]
    #[serde(rename = "clientId", default, skip_serializing_if = "Option::is_none")]
    pub client_id: Option<String>,
    #[doc = "Application Secret for EasyAuth Microsoft Entra ID."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl EasyAuthMicrosoftEntraIdAuthInfo {
    pub fn new(auth_info_base: AuthInfoBase) -> Self {
        Self {
            auth_info_base,
            client_id: None,
...
#[doc = "The service properties when target service type is FabricPlatform"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "Type of configuration to determine whether the configuration can be modified after creation. KeyvaultSecret means the configuration references a key vault secret, such as App Service/ACA key vault reference. Default means the configuration is real value, such as user name, raw secret, etc."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "LinkerConfigurationType")]
pub enum LinkerConfigurationType {
    Default,
    KeyVaultSecret,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for LinkerConfigurationType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for LinkerConfigurationType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for LinkerConfigurationType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Default => serializer.serialize_unit_variant("LinkerConfigurationType", 0u32, "Default"),
            Self::KeyVaultSecret => serializer.serialize_unit_variant("LinkerConfigurationType", 1u32, "KeyVaultSecret"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
#[doc = "The type of secret source."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "SecretSourceType")]
pub enum SecretSourceType {
    #[serde(rename = "rawValue")]
    RawValue,
    #[serde(rename = "keyVaultSecret")]
    KeyVaultSecret,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for SecretSourceType {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for SecretSourceType {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for SecretSourceType {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::RawValue => serializer.serialize_unit_variant("SecretSourceType", 0u32, "rawValue"),
            Self::KeyVaultSecret => serializer.serialize_unit_variant("SecretSourceType", 1u32, "keyVaultSecret"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct SourceConfiguration {
    ...
    pub config_type: Option<LinkerConfigurationType>,
    #[doc = "The identity for key vault reference, system or user-assigned managed identity ID"]
    ...
    #[doc = "Descriptive information for the configuration"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
}
...
impl Serialize for TargetServiceType {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::FabricPlatform => serializer.serialize_unit_variant("TargetServiceType", 4u32, "FabricPlatform"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
