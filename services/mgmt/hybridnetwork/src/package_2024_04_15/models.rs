...
#[doc = "List of network fabric controller ids."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ArtifactStoreNetworkFabricControllerEndPoints {
    #[doc = "list of network fabric controllers."]
    #[serde(
        rename = "networkFabricControllerIds",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub network_fabric_controller_ids: Vec<ReferencedResource>,
}
impl ArtifactStoreNetworkFabricControllerEndPoints {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "List of manual private endpoints."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ArtifactStoreNetworkFabricControllerEndPointsList {
    #[doc = "A list of network fabric controllers."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<ArtifactStoreNetworkFabricControllerEndPoints>,
    #[doc = "The URI to get the next set of results."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ArtifactStoreNetworkFabricControllerEndPointsList {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl ArtifactStoreNetworkFabricControllerEndPointsList {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "List of manual private endpoints."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ArtifactStorePrivateEndPointsFormat {
    #[doc = "list of private endpoints."]
    #[serde(
        rename = "manualPrivateEndPointConnections",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub manual_private_end_point_connections: Vec<ReferencedResource>,
}
impl ArtifactStorePrivateEndPointsFormat {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "List of manual private endpoints."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ArtifactStorePrivateEndPointsListResult {
    ...
    pub value: Vec<ArtifactStorePrivateEndPointsFormat>,
    #[doc = "The URI to get the next set of results."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ArtifactStorePrivateEndPointsListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone().filter(|value| !value.is_empty())
    }
}
impl ArtifactStorePrivateEndPointsListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ArtifactStorePropertiesFormat {
    ...
    #[doc = "The backing resource network access type."]
    #[serde(rename = "backingResourcePublicNetworkAccess", default, skip_serializing_if = "Option::is_none")]
    pub backing_resource_public_network_access: Option<BackingResourcePublicNetworkAccess>,
...
#[doc = "The backing resource network access type."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "BackingResourcePublicNetworkAccess")]
pub enum BackingResourcePublicNetworkAccess {
    Enabled,
    Disabled,
    #[serde(skip_deserializing)]
    UnknownValue(String),
}
impl FromStr for BackingResourcePublicNetworkAccess {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for BackingResourcePublicNetworkAccess {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for BackingResourcePublicNetworkAccess {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::Enabled => serializer.serialize_unit_variant("BackingResourcePublicNetworkAccess", 0u32, "Enabled"),
            Self::Disabled => serializer.serialize_unit_variant("BackingResourcePublicNetworkAccess", 1u32, "Disabled"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
