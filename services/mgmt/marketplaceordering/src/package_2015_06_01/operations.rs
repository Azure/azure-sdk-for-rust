...
pub mod marketplace_agreements {
    ...
    pub mod sign {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::OldAgreementTerms, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
    ...
    pub mod list {
        ...
        impl Builder {
            pub fn into_future(self) -> futures::future::BoxFuture<'static, std::result::Result<models::AgreementTermsList, Error>> {
                Box::pin(async move {
                    let url_str = &format!(
