...
#[cfg(all(feature = "package-2015-06-01", not(feature = "no-default-version")))]
pub use package_2015_06_01::{models, operations, operations::Client, operations::ClientBuilder, operations::Error};
