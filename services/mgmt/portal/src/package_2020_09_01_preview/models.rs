    ...
    pub mod settings {
        ...
        pub mod content {
            ...
            pub struct Settings {
                ...
                #[serde(rename = "markdownSource", skip_serializing_if = "Option::is_none")]
                pub markdown_source: Option<i32>,
                #[serde(rename = "markdownUri", skip_serializing_if = "Option::is_none")]
...
pub struct ConfigurationProperties {
    #[serde(rename = "enforcePrivateMarkdownStorage", skip_serializing_if = "Option::is_none")]
