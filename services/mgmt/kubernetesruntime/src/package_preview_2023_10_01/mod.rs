...
impl Client {
    ...
    pub fn bgp_peers_client(&self) -> bgp_peers::Client {
        bgp_peers::Client(self.clone())
    }
    ...
    pub fn storage_class_client(&self) -> storage_class::Client {
        storage_class::Client(self.clone())
    }
}
pub mod bgp_peers {
    use super::models;
    ...
    impl Client {
        #[doc = "List BgpPeer resources by parent"]
        #[doc = ""]
        #[doc = "Arguments:"]
        ...
        #[doc = "Arguments:"]
        #[doc = "* `resource_uri`: The fully qualified Azure Resource manager identifier of the resource."]
        #[doc = "* `bgp_peer_name`: The name of the BgpPeer"]
        pub fn get(&self, resource_uri: impl Into<String>, bgp_peer_name: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                resource_uri: resource_uri.into(),
                bgp_peer_name: bgp_peer_name.into(),
            }
        }
        #[doc = "Create a BgpPeer"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_uri`: The fully qualified Azure Resource manager identifier of the resource."]
        #[doc = "* `bgp_peer_name`: The name of the BgpPeer"]
        ...
        pub fn create_or_update(
            ...
            resource: impl Into<models::BgpPeer>,
        ...
        #[doc = "Delete a BgpPeer"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_uri`: The fully qualified Azure Resource manager identifier of the resource."]
        #[doc = "* `bgp_peer_name`: The name of the BgpPeer"]
        pub fn delete(&self, resource_uri: impl Into<String>, bgp_peer_name: impl Into<String>) -> delete::RequestBuilder {
    ...
    pub mod list {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BgpPeerListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BgpPeerListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::BgpPeerListResult, azure_core::error::Error> {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!("/{}/providers/Microsoft.KubernetesRuntime/bgpPeers", &self.resource_uri));
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BgpPeer> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BgpPeer = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) resource_uri: String,
            pub(crate) bgp_peer_name: String,
        }
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    ...
                    &self.resource_uri, &self.bgp_peer_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::BgpPeer>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::BgpPeer>>;
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_uri: String,
            pub(crate) bgp_peer_name: String,
            pub(crate) resource: models::BgpPeer,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
...
pub mod load_balancers {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List LoadBalancer resources by parent"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_uri`: The fully qualified Azure Resource manager identifier of the resource."]
        pub fn list(&self, resource_uri: impl Into<String>) -> list::RequestBuilder {
        ...
        #[doc = "Get a LoadBalancer"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_uri`: The fully qualified Azure Resource manager identifier of the resource."]
        #[doc = "* `load_balancer_name`: The name of the LoadBalancer"]
        pub fn get(&self, resource_uri: impl Into<String>, load_balancer_name: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                resource_uri: resource_uri.into(),
        ...
        pub fn create_or_update(
            ...
            resource: impl Into<models::LoadBalancer>,
        ) -> create_or_update::RequestBuilder {
            create_or_update::RequestBuilder {
                client: self.0.clone(),
                resource_uri: resource_uri.into(),
        ...
        #[doc = "* `resource_uri`: The fully qualified Azure Resource manager identifier of the resource."]
        #[doc = "* `load_balancer_name`: The name of the LoadBalancer"]
        pub fn delete(&self, resource_uri: impl Into<String>, load_balancer_name: impl Into<String>) -> delete::RequestBuilder {
            delete::RequestBuilder {
                client: self.0.clone(),
                resource_uri: resource_uri.into(),
                load_balancer_name: load_balancer_name.into(),
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/{}/providers/Microsoft.KubernetesRuntime/loadBalancers/{}",
                    &self.resource_uri, &self.load_balancer_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_uri: String,
            pub(crate) load_balancer_name: String,
            pub(crate) resource: models::LoadBalancer,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
...
pub mod services {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List ServiceResource resources by parent"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_uri`: The fully qualified Azure Resource manager identifier of the resource."]
        pub fn list(&self, resource_uri: impl Into<String>) -> list::RequestBuilder {
        ...
        #[doc = "Get a ServiceResource"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_uri`: The fully qualified Azure Resource manager identifier of the resource."]
        #[doc = "* `service_name`: The name of the the service"]
        pub fn get(&self, resource_uri: impl Into<String>, service_name: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                resource_uri: resource_uri.into(),
        ...
        #[doc = "Delete a ServiceResource"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_uri`: The fully qualified Azure Resource manager identifier of the resource."]
        #[doc = "* `service_name`: The name of the the service"]
        pub fn delete(&self, resource_uri: impl Into<String>, service_name: impl Into<String>) -> delete::RequestBuilder {
            delete::RequestBuilder {
                client: self.0.clone(),
                resource_uri: resource_uri.into(),
                service_name: service_name.into(),
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ServiceResourceListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path(&format!("/{}/providers/Microsoft.KubernetesRuntime/services", &self.resource_uri));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-10-01-preview");
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    ...
                    &self.resource_uri, &self.service_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
...
pub mod storage_class {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List StorageClassResource resources by parent"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_uri`: The fully qualified Azure Resource manager identifier of the resource."]
        pub fn list(&self, resource_uri: impl Into<String>) -> list::RequestBuilder {
        ...
        #[doc = "Get a StorageClassResource"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_uri`: The fully qualified Azure Resource manager identifier of the resource."]
        #[doc = "* `storage_class_name`: The name of the the storage class"]
        pub fn get(&self, resource_uri: impl Into<String>, storage_class_name: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                resource_uri: resource_uri.into(),
        ...
        #[doc = "Create a StorageClassResource"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_uri`: The fully qualified Azure Resource manager identifier of the resource."]
        #[doc = "* `storage_class_name`: The name of the the storage class"]
        ...
        pub fn create_or_update(
            ...
            resource: impl Into<models::StorageClassResource>,
        ) -> create_or_update::RequestBuilder {
            create_or_update::RequestBuilder {
                client: self.0.clone(),
                resource_uri: resource_uri.into(),
        ...
        #[doc = "Update a StorageClassResource"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_uri`: The fully qualified Azure Resource manager identifier of the resource."]
        #[doc = "* `storage_class_name`: The name of the the storage class"]
        ...
        pub fn update(
            ...
            resource_uri: impl Into<String>,
            storage_class_name: impl Into<String>,
            properties: impl Into<models::StorageClassResourceUpdate>,
        ...
        #[doc = "Delete a StorageClassResource"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_uri`: The fully qualified Azure Resource manager identifier of the resource."]
        #[doc = "* `storage_class_name`: The name of the the storage class"]
        pub fn delete(&self, resource_uri: impl Into<String>, storage_class_name: impl Into<String>) -> delete::RequestBuilder {
            delete::RequestBuilder {
                client: self.0.clone(),
                resource_uri: resource_uri.into(),
                storage_class_name: storage_class_name.into(),
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::StorageClassResourceListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::StorageClassResourceListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::StorageClassResourceListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::StorageClassResource> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::StorageClassResource = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) resource_uri: String,
            pub(crate) storage_class_name: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                ...
                url.set_path(&format!(
                    "/{}/providers/Microsoft.KubernetesRuntime/storageClasses/{}",
                    &self.resource_uri, &self.storage_class_name
                ));
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::StorageClassResource>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::StorageClassResource>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_uri: String,
            pub(crate) storage_class_name: String,
            pub(crate) resource: models::StorageClassResource,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_uri: String,
            pub(crate) storage_class_name: String,
            pub(crate) properties: models::StorageClassResourceUpdate,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
...
pub mod operations {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = self.client.endpoint().clone();
                url.set_path("/providers/Microsoft.KubernetesRuntime/operations");
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-10-01-preview");
