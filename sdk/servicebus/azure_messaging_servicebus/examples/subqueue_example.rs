...
use azure_messaging_servicebus::{
    CreateReceiverOptions, CreateSenderOptions, DeadLetterMessageOptions, Message, ReceiveMode,
    ServiceBusClient, SubQueue,
};
use std::env;
...
async fn demonstrate_queue_subqueues(
    ...
    let mut message = Message::from_string("This message will demonstrate SubQueue enum usage");
...
async fn demonstrate_subscription_subqueues(
    ...
    let mut message = Message::from_string("This message demonstrates subscription sub-queues");
