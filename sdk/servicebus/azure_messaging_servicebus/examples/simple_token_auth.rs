...
//! using DefaultAzureCredential to send a message to a Service Bus queue.

use azure_identity::DefaultAzureCredential;
use azure_messaging_servicebus::{ServiceBusClient, CreateSenderOptions, Message};
use std::env;
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Create a DefaultAzureCredential (tries multiple auth methods automatically)
    ...
    let mut message = Message::from_string("Hello from Azure Service Bus with TokenCredential!");
    ...
    println!("\nNote: This example uses DefaultAzureCredential which automatically tries:");
