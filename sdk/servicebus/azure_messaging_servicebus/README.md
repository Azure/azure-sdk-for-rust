...
- **DefaultAzureCredential** (Recommended): Automatically tries multiple authentication methods
...
let message = Message::from_string("Hello, Service Bus!");
...
let message = Message::from_string("Hello, Topic subscribers!");
sender.send_message(message, None).await?;
# Ok(())
# }
```
