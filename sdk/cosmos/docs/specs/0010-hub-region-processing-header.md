...
```rust
// 0010-hub-region-processing-header.md §3.1: the latch trigger pins to
...
should still leave a `// 0010-hub-region-processing-header.md §3.1` cross-reference at
...
5. **AG-5: Driver-migration anchor.** *(Not applicable on `release/azure_data_cosmos-previews`.)*
   ...
   `// 0010-hub-region-processing-header.md §3.1 — set latch on first 404/1002 for`
