...
This is a visual companion to [`sdk/cosmos/docs/specs/0019-native-wrapper.md`](https://github.com/Azure/azure-sdk-for-rust/blob/main/sdk/cosmos/docs/specs/0019-native-wrapper.md).
...
See [section 3.6.1](https://github.com/Azure/azure-sdk-for-rust/blob/main/sdk/cosmos/docs/specs/0019-native-wrapper.md#361-cosmos_completion_t) of the
...
[section 3.1 of the spec](https://github.com/Azure/azure-sdk-for-rust/blob/main/sdk/cosmos/docs/specs/0019-native-wrapper.md#31-invocation-model--completion-queues).
...
fairness inside a single queue. See [section 9 Q12](https://github.com/Azure/azure-sdk-for-rust/blob/main/sdk/cosmos/docs/specs/0019-native-wrapper.md#9-open-questions)
...
- [`sdk/cosmos/docs/specs/0019-native-wrapper.md` section 3.1](https://github.com/Azure/azure-sdk-for-rust/blob/main/sdk/cosmos/docs/specs/0019-native-wrapper.md#31-invocation-model--completion-queues) — full invocation model + per-language call sites.
- [`sdk/cosmos/docs/specs/0019-native-wrapper.md` section 3.5](https://github.com/Azure/azure-sdk-for-rust/blob/main/sdk/cosmos/docs/specs/0019-native-wrapper.md#35-error-model) — error model (packed `cosmos_status_code_t` + `cosmos_error_t`).
- [`sdk/cosmos/docs/specs/0019-native-wrapper.md` section 3.6](https://github.com/Azure/azure-sdk-for-rust/blob/main/sdk/cosmos/docs/specs/0019-native-wrapper.md#36-completion-records--operation-handles) — completion record / operation handle accessors.
- [`sdk/cosmos/docs/specs/0019-native-wrapper.md` section 8](https://github.com/Azure/azure-sdk-for-rust/blob/main/sdk/cosmos/docs/specs/0019-native-wrapper.md#8-phased-implementation-plan) — phased rollout (Phase 0 scaffolding through Phase 10 advanced surface).
- [`sdk/cosmos/docs/specs/0019-native-wrapper.md` section 6](https://github.com/Azure/azure-sdk-for-rust/blob/main/sdk/cosmos/docs/specs/0019-native-wrapper.md#6-error-semantics) — how the merged driver's `CosmosError` packs into the `cosmos_status_code_t`.
