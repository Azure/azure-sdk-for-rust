...
- Added `QueryPlanMode::{LocalPreferred, GatewayOnly}` and `CosmosClientBuilder::with_query_plan_mode`, allowing applications to force Gateway query planning as a livesite mitigation. ([#5181](https://github.com/Azure/azure-sdk-for-rust/pull/5181))
