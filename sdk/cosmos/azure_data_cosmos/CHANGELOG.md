...
- `DatabaseClient::container_client()` now accepts an `Option<ContainerClientOptions>` second argument, aligning it with other async operations. ([#4862](https://github.com/Azure/azure-sdk-for-rust/pull/4862))
