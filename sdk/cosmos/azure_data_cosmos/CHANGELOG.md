...
- Removed `with_application_preferred_regions` and `with_preferred_regions` APIs. Use `with_application_region` to set a single region; the SDK generates preferred regions by geographic proximity. ([#3796](https://github.com/Azure/azure-sdk-for-rust/pull/3796))
