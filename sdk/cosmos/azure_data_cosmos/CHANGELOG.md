...
- Name-addressed container clients now recover after a container is deleted and recreated, while keeping session and continuation tokens isolated to the original container generation. ([#5219](https://github.com/Azure/azure-sdk-for-rust/pull/5219))
