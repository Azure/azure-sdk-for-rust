...
- Fixed `ResponseHeaders::server_duration_ms()` returning `None` for Gateway 2.0 responses instead of the service-reported backend request duration. ([#4797](https://github.com/Azure/azure-sdk-for-rust/pull/4797))
