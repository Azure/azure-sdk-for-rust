...
- RID-addressed container feed operations now retain Gateway 2.0 routing for create, upsert, query, change feed, and transactional batch workloads instead of silently falling back to standard Gateway.
