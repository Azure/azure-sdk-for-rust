...
// use crate::partition_key_internal::PartitionKeyInternal;
// use crate::errors::{CosmosError, CosmosResult};
...
//     ) -> CosmosResult<&PartitionKeyRange> {
//         if effective_partition_key_value
//             >= PartitionKey::maximum_exclusive_effective_partition_key()
//         {
//             return Err(CosmosError::InvalidArgument(
//                 "effectivePartitionKeyValue out of range".to_string(),
//             ));
//         }
//
//         if effective_partition_key_value
//             == PartitionKeyInternal::minimum_inclusive_effective_partition_key()
//         {
...
//                 debug_assert!(self.ordered_ranges[adjusted_idx].contains(effective_partition_key_value));
//                 adjusted_idx
//             }
//         };
//
...
//     fn is_complete_set_of_ranges(ordered_ranges: &[PartitionKeyRange]) -> CosmosResult<bool> {
...
//             == PartitionKeyInternal::maximum_exclusive_effective_partition_key();
//
...
//                     return Err(CosmosError::InvalidOperation(
//                         "Ranges overlap".to_string(),
//                     ));
//                 }
//                 break;
//             }
