...
fn main() {
    ...
    println!(
        "cargo:rustc-check-cfg=cfg(test_category, values(\"live\", \"emulator\", \"emulator_vnext\", \"emulator_inmemory\", \"emulator_inmemory_gateway_v2\", \"e2e\", \"multi_write\", \"split\", \"merge\", \"binary_encoding\", \"gateway_v2\", \"gateway_v2_multi_region\"))"
    );
