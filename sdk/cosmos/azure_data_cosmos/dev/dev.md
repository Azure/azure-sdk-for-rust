...
1. Run the tests using the following command using the specific `nightly` toolchain from [Language-Settings.ps1](../../../../eng/scripts/Language-Settings.ps1) e.g., `nightly-2026-04-14`:
