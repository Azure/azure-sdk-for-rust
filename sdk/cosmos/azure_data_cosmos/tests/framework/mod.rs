...
pub use test_client::{
    ...
    probe_data_plane_ready, read_item_with_readiness_retry, resolve_connection_string,
    targets_emulator, TestClient, TestOptions, TestRunContext, AUTH_MODE_ENV_VAR,
