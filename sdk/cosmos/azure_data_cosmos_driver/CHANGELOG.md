...
- Added fault injection support behind `fault_injection` feature flag, with `FaultClient` and `FaultInjectingHttpClientFactory` for transport-level fault injection per Transport Pipeline Spec §7.
