...
- Added `#[non_exhaustive]` to the public fault-injection builder structs (`FaultClient`, `CustomResponseBuilder`, `FaultInjectionResultBuilder`, `FaultInjectionRuleBuilder`, `FaultInjectionConditionBuilder`) so future fields can be added without a major version bump.
