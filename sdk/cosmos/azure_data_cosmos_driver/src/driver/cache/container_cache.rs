...
impl ContainerCache {
    ...
    #[expect(dead_code, reason = "Used in tests; will be called from production code once lookup-by-name is wired up.")]
    ...
    #[expect(dead_code, reason = "Used in tests; will be called from production code once lookup-by-RID is wired up.")]
