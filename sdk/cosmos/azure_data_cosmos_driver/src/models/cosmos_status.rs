...
impl CosmosStatus {
    ...
    /// Channel-closed 503 Service Unavailable (sub-status 20006).
    ///
    /// Generated by the SDK when the underlying transport reports an explicit
    /// channel-closed failure.
    pub const CHANNEL_CLOSED: CosmosStatus = CosmosStatus {
        status_code: StatusCode::ServiceUnavailable,
        sub_status: Some(SubStatusCode::CHANNEL_CLOSED),
    };
