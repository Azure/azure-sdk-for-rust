...
- This artifact is **not consumer-facing and not language-shaped.** Consumers never download it; per-language publish jobs consume it (see ADR 0008, ADR 0009).
...
- All per-language jobs must consume this artifact rather than rebuilding (enforced by ADR 0008).
...
> Supersedes the earlier "canonical artifact bundle as a distributed product" framing.
