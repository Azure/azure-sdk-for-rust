...
```rust
#![crate_name = "typespec_client_core"]
#![crate_type = "lib"]
...
pub use typespec_client_core::sleep::sleep;
#[macro_export]
...
#[cfg(feature = "http")]
pub mod http {
    pub use typespec_client_core::http::response::AsyncRawResponse;
    pub use typespec_client_core::http::response::AsyncResponseBody;
    pub use typespec_client_core::http::request::Body;
    pub use typespec_client_core::http::request::Request;
    pub use typespec_client_core::http::request::RequestContent;
    pub use typespec_client_core::http::response::Response;
    pub use url::Url;
