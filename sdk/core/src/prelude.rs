...
pub use crate::{
    ...
    IfSinceConditionOption, IfSinceConditionSupport, IfSourceMatchConditionOption,
    IfSourceMatchConditionSupport, IfSourceSinceConditionOption, IfSourceSinceConditionSupport,
