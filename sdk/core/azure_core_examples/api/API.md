...
pub mod certificates {
    ...
    pub mod models {
        ...
        pub struct Certificate {
            ...
            #[serde(default, deserialize_with = "base64_option::deserialize", serialize_with = "base64_option::serialize", skip_serializing_if = "Option::is_none")]
...
pub mod identity {
    ...
    impl TokenCredential for DeveloperToolsCredential {
        #[allow(elided_named_lifetimes, clippy::async_yields_async, clippy::diverging_sub_expression, clippy::let_unit_value, clippy::needless_arbitrary_self_type, clippy::no_effect_underscore_binding, clippy::shadow_same, clippy::type_complexity, clippy::type_repetition_in_bounds, clippy::used_underscore_binding)]
        fn get_token(&self, _scopes: &[&str], _options: Option<TokenRequestOptions<'_>>) -> ::core::pin::Pin<Box<dyn ::core::future::Future<Output = azure_core::Result<AccessToken>> + ::core::marker::Send>>;
    }
    #[derive(Clone, Debug, Default)]
...
pub mod secrets {
    ...
    pub mod models {
        ...
        impl ResourceExt for crate::secrets::models::SecretProperties {
            fn resource_id(&self) -> Result<ResourceId>;
        }
        #[derive(Clone, Debug, Default, serde::Deserialize, serde::Serialize)]
        ...
        impl TryFrom<SetSecretParameters> for azure_core::http::RequestContent<SetSecretParameters> {
            type Error = Error;
        ...
        impl TryFrom<UpdateSecretPropertiesParameters> for azure_core::http::RequestContent<UpdateSecretPropertiesParameters> {
            type Error = Error;
