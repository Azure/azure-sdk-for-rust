...
- Removed AMQP-over-WebSockets support, including `AmqpTransport`, `AmqpConnectionOptions::transport`, and the `fe2o3_amqp_ws` and `fe2o3_amqp_ws_rustls` features, to eliminate the prohibited `sha1` dependency. ([#5261](https://github.com/Azure/azure-sdk-for-rust/issues/5261))
