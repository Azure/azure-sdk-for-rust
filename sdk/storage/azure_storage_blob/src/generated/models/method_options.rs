...
use super::{
    AccessTier, BlobCopySourceTags, BlobDeleteType, BlobImmutabilityPolicyMode,
    DeleteSnapshotsOptionType, EncryptionAlgorithmType, FileShareTokenIntent,
    FilterBlobsIncludeItem, ListBlobsIncludeItem, ListContainersIncludeType,
...
/// Options to be passed to `BlobServiceClient::get_service_stats()`
#[derive(Clone, Default, SafeDebug)]
pub struct BlobServiceClientGetServiceStatsOptions<'a> {
    /// An opaque, globally-unique, client-generated string identifier for the request.
    pub client_request_id: Option<String>,
