...
pub(crate) struct BlobClientCopyFromUrlOptions<'a> {
    ...
    /// Valid value is backup
    pub(crate) file_request_intent: Option<FileShareTokenIntent>,
    ...
    /// Specify the md5 calculated for the range of bytes that must be read from the copy source.
    pub(crate) source_content_md5: Option<Vec<u8>>,

    /// Specify an ETag value to operate only on blobs with a matching value.
    pub(crate) source_if_match: Option<String>,

    /// Specify this header value to operate only on a blob if it has been modified since the specified date/time.
    pub(crate) source_if_modified_since: Option<OffsetDateTime>,

    /// Specify this header value to operate only on a blob if it has been modified since the specified date/time.
    pub(crate) source_if_none_match: Option<String>,

    /// Specify this header value to operate only on a blob if it has not been modified since the specified date/time.
    pub(crate) source_if_unmodified_since: Option<OffsetDateTime>,
...
#[derive(Clone, Default, SafeDebug)]
pub(crate) struct BlobClientSetExpiryOptions<'a> {
    /// The time this blob will expire.
    pub(crate) expires_on: Option<OffsetDateTime>,
...
#[derive(Clone, Default, SafeDebug)]
pub(crate) struct BlobClientStartCopyFromUrlOptions<'a> {
    /// Optional. Used to set blob tags in various blob operations.
    pub(crate) blob_tags_string: Option<String>,
    ...
    /// If an object is in rehydrate pending state then this header is returned with priority of rehydrate. Valid values are High
    /// and Standard.
    pub(crate) rehydrate_priority: Option<RehydratePriority>,

    /// Overrides the sealed state of the destination blob. Service version 2019-12-12 and newer.
    pub(crate) seal_blob: Option<bool>,
    ...
    /// Specify a SQL where clause on blob tags to operate only on blobs with a matching value.
    pub(crate) source_if_tags: Option<String>,
...
#[derive(Clone, Default, SafeDebug)]
pub(crate) struct BlobContainerClientListBlobHierarchySegmentOptions<'a> {
    /// Include this parameter to specify one or more datasets to include in the response.
    ...
    /// Allows customization of the method call.
    pub(crate) method_options: PagerOptions<'a, String>,
...
#[derive(Clone, Default, SafeDebug)]
pub(crate) struct BlobContainerClientRenameOptions<'a> {
    /// Allows customization of the method call.
    pub(crate) method_options: ClientMethodOptions<'a>,

    /// A lease ID for the source path. If specified, the source path must have an active lease and the lease ID must match.
    pub(crate) source_lease_id: Option<String>,
...
#[derive(Clone, Default, SafeDebug)]
pub(crate) struct BlockBlobClientQueryOptions<'a> {
    /// Optional. Version 2019-07-07 and later. Specifies the algorithm to use for encryption. If not specified, the default is
    /// AES256.
...
#[derive(Clone, Default, SafeDebug)]
pub(crate) struct BlockBlobClientStageBlockFromUrlOptions<'a> {
    /// Only Bearer type is supported. Credentials should be a valid OAuth access token to copy source.
    pub(crate) copy_source_authorization: Option<String>,
    ...
    /// Specify the crc64 calculated for the range of bytes that must be read from the copy source.
    pub(crate) source_content_crc64: Option<Vec<u8>>,
    ...
    /// The algorithm used to produce the source encryption key hash. Currently, the only accepted value is "AES256". Must be
    /// provided if the x-ms-source-encryption-key is provided.
    pub(crate) source_encryption_algorithm: Option<EncryptionAlgorithmType>,

    /// Optional. Specifies the source encryption key to use to encrypt the source data provided in the request.
    pub(crate) source_encryption_key: Option<String>,

    /// The SHA-256 hash of the provided source encryption key. Must be provided if the x-ms-source-encryption-key header is provided.
    pub(crate) source_encryption_key_sha256: Option<String>,
...
#[derive(Clone, Default, SafeDebug)]
pub(crate) struct PageBlobClientCopyIncrementalOptions<'a> {
    /// A condition that must be met in order for the request to be processed.
    pub(crate) if_match: Option<String>,
...
#[derive(Clone, Default, SafeDebug)]
pub(crate) struct PageBlobClientGetPageRangesDiffOptions<'a> {
    /// A condition that must be met in order for the request to be processed.
    pub(crate) if_match: Option<String>,
    ...
    pub(crate) prev_snapshot_url: Option<String>,
