...
impl AppendBlobClientAppendBlockFromUrlResultHeaders
    for Response<AppendBlobClientAppendBlockFromUrlResult, XmlFormat>
{
...
impl AppendBlobClientAppendBlockResultHeaders
    for Response<AppendBlobClientAppendBlockResult, XmlFormat>
{
    /// If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the
    /// client can check for message content integrity.
    fn content_md5(&self) -> Result<Option<Vec<u8>>> {
...
impl AppendBlobClientCreateResultHeaders for Response<AppendBlobClientCreateResult, XmlFormat> {
    /// If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the
    /// client can check for message content integrity.
    fn content_md5(&self) -> Result<Option<Vec<u8>>> {
        Headers::get_optional_with(self.headers(), &CONTENT_MD5, |h| base64::decode(h.as_str()))
...
impl AppendBlobClientSealResultHeaders for Response<AppendBlobClientSealResult, XmlFormat> {
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl BlobClientAbortCopyFromUrlResultHeaders
    for Response<BlobClientAbortCopyFromUrlResult, XmlFormat>
{
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
...
impl BlobClientAcquireLeaseResultHeaders for Response<BlobClientAcquireLeaseResult, XmlFormat> {
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl BlobClientBreakLeaseResultHeaders for Response<BlobClientBreakLeaseResult, XmlFormat> {
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl BlobClientChangeLeaseResultHeaders for Response<BlobClientChangeLeaseResult, XmlFormat> {
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl BlobClientCopyFromUrlResultHeaders for Response<BlobClientCopyFromUrlResult, XmlFormat> {
    /// If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the
    /// client can check for message content integrity.
    fn content_md5(&self) -> Result<Option<Vec<u8>>> {
        Headers::get_optional_with(self.headers(), &CONTENT_MD5, |h| base64::decode(h.as_str()))
...
impl BlobClientCreateSnapshotResultHeaders for Response<BlobClientCreateSnapshotResult, XmlFormat> {
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl BlobClientDeleteImmutabilityPolicyResultHeaders
    for Response<BlobClientDeleteImmutabilityPolicyResult, XmlFormat>
{
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
...
impl BlobClientDownloadResultHeaders for Response<BlobClientDownloadResult, XmlFormat> {
...
impl BlobClientGetAccountInfoResultHeaders for Response<BlobClientGetAccountInfoResult, XmlFormat> {
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl BlobClientGetPropertiesResultHeaders for Response<BlobClientGetPropertiesResult, XmlFormat> {
    /// This header is returned if it was previously specified for the blob.
    fn cache_control(&self) -> Result<Option<String>> {
        Headers::get_optional_as(self.headers(), &CACHE_CONTROL)
    }
...
impl BlobClientReleaseLeaseResultHeaders for Response<BlobClientReleaseLeaseResult, XmlFormat> {
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl BlobClientRenewLeaseResultHeaders for Response<BlobClientRenewLeaseResult, XmlFormat> {
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl BlobClientSetExpiryResultHeaders for Response<BlobClientSetExpiryResult, XmlFormat> {
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl BlobClientSetImmutabilityPolicyResultHeaders
    for Response<BlobClientSetImmutabilityPolicyResult, XmlFormat>
{
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
...
impl BlobClientSetLegalHoldResultHeaders for Response<BlobClientSetLegalHoldResult, XmlFormat> {
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl BlobClientSetTagsResultHeaders for Response<BlobClientSetTagsResult, XmlFormat> {
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl BlobClientStartCopyFromUrlResultHeaders
    for Response<BlobClientStartCopyFromUrlResult, XmlFormat>
{
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
...
impl BlobClientUndeleteResultHeaders for Response<BlobClientUndeleteResult, XmlFormat> {
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl BlobContainerClientAcquireLeaseResultHeaders
    for Response<BlobContainerClientAcquireLeaseResult, XmlFormat>
{
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
...
impl BlobContainerClientBreakLeaseResultHeaders
    for Response<BlobContainerClientBreakLeaseResult, XmlFormat>
{
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
...
impl BlobContainerClientChangeLeaseResultHeaders
    for Response<BlobContainerClientChangeLeaseResult, XmlFormat>
{
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
...
impl BlobContainerClientGetAccountInfoResultHeaders
    for Response<BlobContainerClientGetAccountInfoResult, XmlFormat>
{
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
...
impl BlobContainerClientGetPropertiesResultHeaders
    for Response<BlobContainerClientGetPropertiesResult, XmlFormat>
{
    /// The date/time that the container was last modified.
    fn last_modified(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &LAST_MODIFIED, |h| {
...
impl BlobContainerClientReleaseLeaseResultHeaders
    for Response<BlobContainerClientReleaseLeaseResult, XmlFormat>
{
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
...
impl BlobContainerClientRenameResultHeaders
    for Response<BlobContainerClientRenameResult, XmlFormat>
{
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
...
impl BlobContainerClientRenewLeaseResultHeaders
    for Response<BlobContainerClientRenewLeaseResult, XmlFormat>
{
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
...
impl BlobContainerClientRestoreResultHeaders
    for Response<BlobContainerClientRestoreResult, XmlFormat>
{
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
...
impl BlobContainerClientSetAccessPolicyResultHeaders
    for Response<BlobContainerClientSetAccessPolicyResult, XmlFormat>
{
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
...
impl BlobServiceClientGetAccountInfoResultHeaders
    for Response<BlobServiceClientGetAccountInfoResult, XmlFormat>
{
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
...
impl BlockBlobClientCommitBlockListResultHeaders
    for Response<BlockBlobClientCommitBlockListResult, XmlFormat>
{
    /// If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the
    /// client can check for message content integrity.
    fn content_md5(&self) -> Result<Option<Vec<u8>>> {
...
impl BlockBlobClientPutBlobFromUrlResultHeaders
    for Response<BlockBlobClientPutBlobFromUrlResult, XmlFormat>
{
    /// If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the
    /// client can check for message content integrity.
    fn content_md5(&self) -> Result<Option<Vec<u8>>> {
...
impl BlockBlobClientQueryResultHeaders for Response<BlockBlobClientQueryResult, XmlFormat> {
    /// Indicates that the service supports requests for partial blob content.
    fn accept_ranges(&self) -> Result<Option<String>> {
        Headers::get_optional_as(self.headers(), &ACCEPT_RANGES)
    }
...
impl BlockBlobClientStageBlockFromUrlResultHeaders
    for Response<BlockBlobClientStageBlockFromUrlResult, XmlFormat>
{
    /// If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the
    /// client can check for message content integrity.
    fn content_md5(&self) -> Result<Option<Vec<u8>>> {
...
impl BlockBlobClientStageBlockResultHeaders
    for Response<BlockBlobClientStageBlockResult, XmlFormat>
{
    /// If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the
    /// client can check for message content integrity.
    fn content_md5(&self) -> Result<Option<Vec<u8>>> {
...
impl BlockBlobClientUploadResultHeaders for Response<BlockBlobClientUploadResult, XmlFormat> {
    /// If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the
    /// client can check for message content integrity.
    fn content_md5(&self) -> Result<Option<Vec<u8>>> {
        Headers::get_optional_with(self.headers(), &CONTENT_MD5, |h| base64::decode(h.as_str()))
...
impl PageBlobClientClearPagesResultHeaders for Response<PageBlobClientClearPagesResult, XmlFormat> {
    /// If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the
    /// client can check for message content integrity.
    fn content_md5(&self) -> Result<Option<Vec<u8>>> {
        Headers::get_optional_with(self.headers(), &CONTENT_MD5, |h| base64::decode(h.as_str()))
...
impl PageBlobClientCopyIncrementalResultHeaders
    for Response<PageBlobClientCopyIncrementalResult, XmlFormat>
{
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
...
impl PageBlobClientCreateResultHeaders for Response<PageBlobClientCreateResult, XmlFormat> {
    /// If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the
    /// client can check for message content integrity.
    fn content_md5(&self) -> Result<Option<Vec<u8>>> {
        Headers::get_optional_with(self.headers(), &CONTENT_MD5, |h| base64::decode(h.as_str()))
...
impl PageBlobClientResizeResultHeaders for Response<PageBlobClientResizeResult, XmlFormat> {
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl PageBlobClientUpdateSequenceNumberResultHeaders
    for Response<PageBlobClientUpdateSequenceNumberResult, XmlFormat>
{
    /// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
...
impl PageBlobClientUploadPagesFromUrlResultHeaders
    for Response<PageBlobClientUploadPagesFromUrlResult, XmlFormat>
{
    /// If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the
    /// client can check for message content integrity.
    fn content_md5(&self) -> Result<Option<Vec<u8>>> {
...
impl PageBlobClientUploadPagesResultHeaders
    for Response<PageBlobClientUploadPagesResult, XmlFormat>
{
    /// If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the
    /// client can check for message content integrity.
    fn content_md5(&self) -> Result<Option<Vec<u8>>> {
...
mod private {
    ...
    use azure_core::http::{Format, Response};

    pub trait Sealed {}

    impl<F: Format> Sealed for Response<AppendBlobClientAppendBlockFromUrlResult, F> {}
    impl<F: Format> Sealed for Response<AppendBlobClientAppendBlockResult, F> {}
    impl<F: Format> Sealed for Response<AppendBlobClientCreateResult, F> {}
    impl<F: Format> Sealed for Response<AppendBlobClientSealResult, F> {}
    impl<F: Format> Sealed for Response<BlobClientAbortCopyFromUrlResult, F> {}
    impl<F: Format> Sealed for Response<BlobClientAcquireLeaseResult, F> {}
    impl<F: Format> Sealed for Response<BlobClientBreakLeaseResult, F> {}
    impl<F: Format> Sealed for Response<BlobClientChangeLeaseResult, F> {}
    impl<F: Format> Sealed for Response<BlobClientCopyFromUrlResult, F> {}
    impl<F: Format> Sealed for Response<BlobClientCreateSnapshotResult, F> {}
    impl<F: Format> Sealed for Response<BlobClientDeleteImmutabilityPolicyResult, F> {}
    impl<F: Format> Sealed for Response<BlobClientDownloadResult, F> {}
    impl<F: Format> Sealed for Response<BlobClientGetAccountInfoResult, F> {}
    impl<F: Format> Sealed for Response<BlobClientGetPropertiesResult, F> {}
    impl<F: Format> Sealed for Response<BlobClientReleaseLeaseResult, F> {}
    impl<F: Format> Sealed for Response<BlobClientRenewLeaseResult, F> {}
    impl<F: Format> Sealed for Response<BlobClientSetExpiryResult, F> {}
    impl<F: Format> Sealed for Response<BlobClientSetImmutabilityPolicyResult, F> {}
    impl<F: Format> Sealed for Response<BlobClientSetLegalHoldResult, F> {}
    impl<F: Format> Sealed for Response<BlobClientSetTagsResult, F> {}
    impl<F: Format> Sealed for Response<BlobClientStartCopyFromUrlResult, F> {}
    impl<F: Format> Sealed for Response<BlobClientUndeleteResult, F> {}
    impl<F: Format> Sealed for Response<BlobContainerClientAcquireLeaseResult, F> {}
    impl<F: Format> Sealed for Response<BlobContainerClientBreakLeaseResult, F> {}
    impl<F: Format> Sealed for Response<BlobContainerClientChangeLeaseResult, F> {}
    impl<F: Format> Sealed for Response<BlobContainerClientGetAccountInfoResult, F> {}
    impl<F: Format> Sealed for Response<BlobContainerClientGetPropertiesResult, F> {}
    impl<F: Format> Sealed for Response<BlobContainerClientReleaseLeaseResult, F> {}
    impl<F: Format> Sealed for Response<BlobContainerClientRenameResult, F> {}
    impl<F: Format> Sealed for Response<BlobContainerClientRenewLeaseResult, F> {}
    impl<F: Format> Sealed for Response<BlobContainerClientRestoreResult, F> {}
    impl<F: Format> Sealed for Response<BlobContainerClientSetAccessPolicyResult, F> {}
    impl<F: Format> Sealed for Response<BlobServiceClientGetAccountInfoResult, F> {}
    impl<F: Format> Sealed for Response<BlobTags, F> {}
    impl<F: Format> Sealed for Response<BlockBlobClientCommitBlockListResult, F> {}
    impl<F: Format> Sealed for Response<BlockBlobClientPutBlobFromUrlResult, F> {}
    impl<F: Format> Sealed for Response<BlockBlobClientQueryResult, F> {}
    impl<F: Format> Sealed for Response<BlockBlobClientStageBlockFromUrlResult, F> {}
    impl<F: Format> Sealed for Response<BlockBlobClientStageBlockResult, F> {}
    impl<F: Format> Sealed for Response<BlockBlobClientUploadResult, F> {}
    impl<F: Format> Sealed for Response<BlockList, F> {}
    impl<F: Format> Sealed for Response<FilterBlobSegment, F> {}
    impl<F: Format> Sealed for Response<ListBlobsFlatSegmentResponse, F> {}
    impl<F: Format> Sealed for Response<ListBlobsHierarchySegmentResponse, F> {}
    impl<F: Format> Sealed for Response<PageBlobClientClearPagesResult, F> {}
    impl<F: Format> Sealed for Response<PageBlobClientCopyIncrementalResult, F> {}
    impl<F: Format> Sealed for Response<PageBlobClientCreateResult, F> {}
    impl<F: Format> Sealed for Response<PageBlobClientResizeResult, F> {}
    impl<F: Format> Sealed for Response<PageBlobClientUpdateSequenceNumberResult, F> {}
    impl<F: Format> Sealed for Response<PageBlobClientUploadPagesFromUrlResult, F> {}
    impl<F: Format> Sealed for Response<PageBlobClientUploadPagesResult, F> {}
    impl<F: Format> Sealed for Response<PageList, F> {}
    impl<F: Format> Sealed for Response<StorageServiceStats, F> {}
    impl<F: Format> Sealed for Response<UserDelegationKey, F> {}
    impl<F: Format> Sealed for Response<Vec<SignedIdentifier>, F> {}
}
