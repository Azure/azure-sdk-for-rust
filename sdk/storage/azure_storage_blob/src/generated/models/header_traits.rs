...
use super::{
    crate_models::{
        BlobClientCopyFromUrlResult, BlobClientSetExpiryResult, BlobClientStartCopyFromUrlResult,
...
/// }
/// ```
pub(crate) trait BlobClientCopyFromUrlResultHeaders: private::Sealed {
    fn content_md5(&self) -> Result<Option<Vec<u8>>>;
    fn etag(&self) -> Result<Option<String>>;
    fn last_modified(&self) -> Result<Option<OffsetDateTime>>;
    fn content_crc64(&self) -> Result<Option<Vec<u8>>>;
...
/// }
/// ```
pub(crate) trait BlobClientSetExpiryResultHeaders: private::Sealed {
    fn etag(&self) -> Result<Option<String>>;
    fn last_modified(&self) -> Result<Option<OffsetDateTime>>;
}
...
/// }
/// ```
pub(crate) trait BlobClientStartCopyFromUrlResultHeaders: private::Sealed {
    fn etag(&self) -> Result<Option<String>>;
    fn last_modified(&self) -> Result<Option<OffsetDateTime>>;
    fn copy_id(&self) -> Result<Option<String>>;
    fn copy_status(&self) -> Result<Option<CopyStatus>>;
...
/// }
/// ```
pub(crate) trait BlockBlobClientQueryResultHeaders: private::Sealed {
...
/// }
/// ```
pub(crate) trait BlockBlobClientStageBlockFromUrlResultHeaders: private::Sealed {
    fn content_md5(&self) -> Result<Option<Vec<u8>>>;
    fn content_crc64(&self) -> Result<Option<Vec<u8>>>;
    fn encryption_key_sha256(&self) -> Result<Option<String>>;
    fn encryption_scope(&self) -> Result<Option<String>>;
...
/// }
/// ```
pub(crate) trait PageBlobClientCopyIncrementalResultHeaders: private::Sealed {
    fn etag(&self) -> Result<Option<String>>;
    fn last_modified(&self) -> Result<Option<OffsetDateTime>>;
    fn copy_id(&self) -> Result<Option<String>>;
    fn copy_status(&self) -> Result<Option<CopyStatus>>;
