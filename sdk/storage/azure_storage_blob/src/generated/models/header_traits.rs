...
use super::{
    ...
    LeaseDuration, LeaseState, LeaseStatus, ListBlobsRawResponseResponseContentType,
...
pub trait BlobContainerClientListBlobsInternalResultHeaders: private::Sealed {
    fn content_type(&self) -> Result<Option<ListBlobsRawResponseResponseContentType>>;
}
...
mod private {
    use super::{
        ...
        BlobContainerClientGetPropertiesResult, BlobContainerClientListBlobsInternalResult,
