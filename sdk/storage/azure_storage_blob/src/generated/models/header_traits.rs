...
impl AppendBlobClientAppendBlockFromUrlResultHeaders for Response<AppendBlobClientAppendBlockFromUrlResult, NoFormat> {
...
/// The date/time that the container was last modified.
    fn last_modified(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &LAST_MODIFIED, |h| parse_rfc7231(h.as_str()))
    }
...
impl AppendBlobClientAppendBlockResultHeaders for Response<AppendBlobClientAppendBlockResult, NoFormat> {
/// If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the
/// client can check for message content integrity.
    fn content_md5(&self) -> Result<Option<Vec<u8>>> {
        Headers::get_optional_with(self.headers(), &CONTENT_MD5, |h| decode(h.as_str()))
...
/// operation using Set Blob Properties, Put Blob, or Put Block List.
    fn copy_completion_time(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &COPY_COMPLETION_TIME, |h| parse_rfc7231(h.as_str()))
    }
...
/// Returns the date and time the blob was created.
    fn creation_time(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &CREATION_TIME, |h| parse_rfc7231(h.as_str()))
    }
...
/// UTC date/time value generated by the service that indicates the time at which the blob immutability policy will expire.
    fn immutability_policy_expires_on(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &IMMUTABILITY_POLICY_UNTIL_DATE, |h| parse_rfc7231(h.as_str()))
    }
...
/// UTC date/time value generated by the service that indicates the time at which the blob was last read or written to
    fn last_accessed(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &LAST_ACCESS_TIME, |h| parse_rfc7231(h.as_str()))
    }
...
/// The time the tier was changed on the object. This is only returned if the tier on the block blob was ever set.
    fn access_tier_change_time(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &ACCESS_TIER_CHANGE_TIME, |h| parse_rfc7231(h.as_str()))
    }
...
impl BlobClientStartCopyFromUrlResultHeaders for Response<BlobClientStartCopyFromUrlResult, NoFormat> {
/// The ETag contains a value that you can use to perform operations conditionally.
    fn etag(&self) -> Result<Option<String>> {
        Headers::get_optional_as(self.headers(), &ETAG)
    }
...
impl BlobContainerClientAcquireLeaseResultHeaders for Response<BlobContainerClientAcquireLeaseResult, NoFormat> {
/// The ETag contains a value that you can use to perform operations conditionally.
    fn etag(&self) -> Result<Option<String>> {
        Headers::get_optional_as(self.headers(), &ETAG)
    }
...
impl BlobContainerClientBreakLeaseResultHeaders for Response<BlobContainerClientBreakLeaseResult, NoFormat> {
/// The ETag contains a value that you can use to perform operations conditionally.
    fn etag(&self) -> Result<Option<String>> {
        Headers::get_optional_as(self.headers(), &ETAG)
    }
...
impl BlobContainerClientChangeLeaseResultHeaders for Response<BlobContainerClientChangeLeaseResult, NoFormat> {
/// The ETag contains a value that you can use to perform operations conditionally.
    fn etag(&self) -> Result<Option<String>> {
        Headers::get_optional_as(self.headers(), &ETAG)
    }
...
impl BlobContainerClientGetAccountInfoResultHeaders for Response<BlobContainerClientGetAccountInfoResult, NoFormat> {
/// Identifies the account kind
    fn account_kind(&self) -> Result<Option<AccountKind>> {
        Headers::get_optional_as(self.headers(), &ACCOUNT_KIND)
    }
...
impl BlobContainerClientGetPropertiesResultHeaders for Response<BlobContainerClientGetPropertiesResult, NoFormat> {
/// The ETag contains a value that you can use to perform operations conditionally.
    fn etag(&self) -> Result<Option<String>> {
        Headers::get_optional_as(self.headers(), &ETAG)
    }
...
impl BlobContainerClientReleaseLeaseResultHeaders for Response<BlobContainerClientReleaseLeaseResult, NoFormat> {
/// The ETag contains a value that you can use to perform operations conditionally.
    fn etag(&self) -> Result<Option<String>> {
        Headers::get_optional_as(self.headers(), &ETAG)
    }
...
impl BlobContainerClientRenewLeaseResultHeaders for Response<BlobContainerClientRenewLeaseResult, NoFormat> {
/// The ETag contains a value that you can use to perform operations conditionally.
    fn etag(&self) -> Result<Option<String>> {
        Headers::get_optional_as(self.headers(), &ETAG)
    }
...
impl BlobServiceClientGetAccountInfoResultHeaders for Response<BlobServiceClientGetAccountInfoResult, NoFormat> {
/// Identifies the account kind
    fn account_kind(&self) -> Result<Option<AccountKind>> {
        Headers::get_optional_as(self.headers(), &ACCOUNT_KIND)
    }
...
impl BlockBlobClientCommitBlockListResultHeaders for Response<BlockBlobClientCommitBlockListResult, NoFormat> {
/// If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the
/// client can check for message content integrity.
    fn content_md5(&self) -> Result<Option<Vec<u8>>> {
        Headers::get_optional_with(self.headers(), &CONTENT_MD5, |h| decode(h.as_str()))
...
impl BlockBlobClientStageBlockFromUrlResultHeaders for Response<BlockBlobClientStageBlockFromUrlResult, NoFormat> {
/// If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the
/// client can check for message content integrity.
    fn content_md5(&self) -> Result<Option<Vec<u8>>> {
        Headers::get_optional_with(self.headers(), &CONTENT_MD5, |h| decode(h.as_str()))
...
impl BlockBlobClientStageBlockResultHeaders for Response<BlockBlobClientStageBlockResult, NoFormat> {
/// If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the
/// client can check for message content integrity.
    fn content_md5(&self) -> Result<Option<Vec<u8>>> {
        Headers::get_optional_with(self.headers(), &CONTENT_MD5, |h| decode(h.as_str()))
...
impl BlockBlobClientUploadBlobFromUrlResultHeaders for Response<BlockBlobClientUploadBlobFromUrlResult, NoFormat> {
/// If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the
/// client can check for message content integrity.
    fn content_md5(&self) -> Result<Option<Vec<u8>>> {
        Headers::get_optional_with(self.headers(), &CONTENT_MD5, |h| decode(h.as_str()))
...
impl PageBlobClientSetSequenceNumberResultHeaders for Response<PageBlobClientSetSequenceNumberResult, NoFormat> {
/// The ETag contains a value that you can use to perform operations conditionally.
    fn etag(&self) -> Result<Option<String>> {
        Headers::get_optional_as(self.headers(), &ETAG)
    }
...
impl PageBlobClientUploadPagesFromUrlResultHeaders for Response<PageBlobClientUploadPagesFromUrlResult, NoFormat> {
/// If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the
/// client can check for message content integrity.
    fn content_md5(&self) -> Result<Option<Vec<u8>>> {
        Headers::get_optional_with(self.headers(), &CONTENT_MD5, |h| decode(h.as_str()))
...
impl PageBlobClientUploadPagesResultHeaders for Response<PageBlobClientUploadPagesResult, NoFormat> {
/// If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the
/// client can check for message content integrity.
    fn content_md5(&self) -> Result<Option<Vec<u8>>> {
        Headers::get_optional_with(self.headers(), &CONTENT_MD5, |h| decode(h.as_str()))
