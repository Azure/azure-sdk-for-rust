...
use azure_core::http::{
    Response, headers::HeaderName, headers::Headers,
};
use std::collections::HashMap;
use super::{
    AccessTier, AccountKind, AppendBlobClientAppendBlockFromUrlResult, AppendBlobClientAppendBlockResult, AppendBlobClientCreateResult, AppendBlobClientSealResult, ArchiveStatus, BlobClientAbortCopyFromUrlResult, BlobClientAcquireLeaseResult, BlobClientBreakLeaseResult, BlobClientChangeLeaseResult, BlobClientCopyFromUrlResult, BlobClientCreateSnapshotResult, BlobClientDeleteImmutabilityPolicyResult, BlobClientDownloadResult, BlobClientGetAccountInfoResult, BlobClientGetPropertiesResult, BlobClientReleaseLeaseResult, BlobClientRenewLeaseResult, BlobClientSetExpiryResult, BlobClientSetHttpHeadersResult, BlobClientSetImmutabilityPolicyResult, BlobClientSetLegalHoldResult, BlobClientSetMetadataResult, BlobClientSetTagsResult, BlobClientStartCopyFromUrlResult, BlobClientUndeleteResult, BlobContainerClientAcquireLeaseResult, BlobContainerClientBreakLeaseResult, BlobContainerClientChangeLeaseResult, BlobContainerClientGetAccountInfoResult, BlobContainerClientGetPropertiesResult, BlobContainerClientReleaseLeaseResult, BlobContainerClientRenameResult, BlobContainerClientRenewLeaseResult, BlobContainerClientRestoreResult, BlobContainerClientSetAccessPolicyResult, BlobContainerClientSetMetadataResult, BlobContainerClientSubmitBatchResult, BlobImmutabilityPolicyMode, BlobServiceClientGetAccountInfoResult, BlobServiceClientSubmitBatchResult, BlobTags, BlobType, BlockBlobClientCommitBlockListResult, BlockBlobClientPutBlobFromUrlResult, BlockBlobClientQueryResult, BlockBlobClientStageBlockFromUrlResult, BlockBlobClientStageBlockResult, BlockBlobClientUploadResult, BlockList, CopyStatus, FilterBlobSegment, LeaseState, LeaseStatus, ListBlobsFlatSegmentResponse, ListBlobsHierarchySegmentResponse, PageBlobClientClearPagesResult, PageBlobClientCopyIncrementalResult, PageBlobClientCreateResult, PageBlobClientResizeResult, PageBlobClientUpdateSequenceNumberResult, PageBlobClientUploadPagesFromUrlResult, PageBlobClientUploadPagesResult, PageList, PublicAccessType, RehydratePriority, SignedIdentifier, SkuName, StorageServiceStats, UserDelegationKey,
};
...
const BLOB_COMMITTED_BLOCK_COUNT: HeaderName = HeaderName::from_static("x-ms-blob-committed-block-count");
...
const COPY_DESTINATION_SNAPSHOT: HeaderName = HeaderName::from_static("x-ms-copy-destination-snapshot");
...
const DEFAULT_ENCRYPTION_SCOPE: HeaderName = HeaderName::from_static("x-ms-default-encryption-scope");
const DENY_ENCRYPTION_SCOPE_OVERRIDE: HeaderName = HeaderName::from_static("x-ms-deny-encryption-scope-override");
...
const IMMUTABILITY_POLICY_MODE: HeaderName = HeaderName::from_static("x-ms-immutability-policy-mode");
const IMMUTABILITY_POLICY_UNTIL_DATE: HeaderName = HeaderName::from_static("x-ms-immutability-policy-until-date");
const IMMUTABLE_STORAGE_WITH_VERSIONING_ENABLED: HeaderName = HeaderName::from_static("x-ms-immutable-storage-with-versioning-enabled");
...
const REQUEST_SERVER_ENCRYPTED: HeaderName = HeaderName::from_static("x-ms-request-server-encrypted");
...
impl AppendBlobClientAppendBlockFromUrlResultHeaders for Response<AppendBlobClientAppendBlockFromUrlResult> {
...
/// The date/time that the container was last modified.
    fn last_modified(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &LAST_MODIFIED, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl BlobClientDeleteImmutabilityPolicyResultHeaders for Response<BlobClientDeleteImmutabilityPolicyResult> {
/// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
/// header, with the latter calculated from the requested range
    fn blob_content_md5(&self) -> Result<Option<Vec<u8>>> {
        Headers::get_optional_with(self.headers(), &BLOB_CONTENT_MD5, |h| base64::decode(h.as_str()))
    }
...
/// operation using Set Blob Properties, Put Blob, or Put Block List.
    fn copy_completion_time(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &COPY_COMPLETION_TIME, |h| date::parse_rfc7231(h.as_str()))
    }
...
/// Returns the date and time the blob was created.
    fn creation_time(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &CREATION_TIME, |h| date::parse_rfc7231(h.as_str()))
    }
...
/// UTC date/time value generated by the service that indicates the time at which the blob immutability policy will expire.
    fn immutability_policy_expires_on(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &IMMUTABILITY_POLICY_UNTIL_DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
/// UTC date/time value generated by the service that indicates the time at which the blob was last read or written to
    fn last_accessed(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &LAST_ACCESS_TIME, |h| date::parse_rfc7231(h.as_str()))
    }
...
/// The time the tier was changed on the object. This is only returned if the tier on the block blob was ever set.
    fn access_tier_change_time(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &ACCESS_TIER_CHANGE_TIME, |h| date::parse_rfc7231(h.as_str()))
    }
...
/// The time this blob will expire.
    fn expires_on(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &EXPIRY_TIME, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl BlobClientSetImmutabilityPolicyResultHeaders for Response<BlobClientSetImmutabilityPolicyResult> {
/// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl BlobContainerClientAcquireLeaseResultHeaders for Response<BlobContainerClientAcquireLeaseResult> {
/// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl BlobContainerClientChangeLeaseResultHeaders for Response<BlobContainerClientChangeLeaseResult> {
/// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl BlobContainerClientGetAccountInfoResultHeaders for Response<BlobContainerClientGetAccountInfoResult> {
/// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl BlobContainerClientGetPropertiesResultHeaders for Response<BlobContainerClientGetPropertiesResult> {
/// The date/time that the container was last modified.
    fn last_modified(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &LAST_MODIFIED, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl BlobContainerClientReleaseLeaseResultHeaders for Response<BlobContainerClientReleaseLeaseResult> {
/// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl BlobContainerClientSetAccessPolicyResultHeaders for Response<BlobContainerClientSetAccessPolicyResult> {
/// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl BlobContainerClientSetMetadataResultHeaders for Response<BlobContainerClientSetMetadataResult> {
/// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl BlobContainerClientSubmitBatchResultHeaders for Response<BlobContainerClientSubmitBatchResult> {
...
impl BlobServiceClientGetAccountInfoResultHeaders for Response<BlobServiceClientGetAccountInfoResult> {
/// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl BlockBlobClientCommitBlockListResultHeaders for Response<BlockBlobClientCommitBlockListResult> {
/// If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the
/// client can check for message content integrity.
    fn content_md5(&self) -> Result<Option<String>> {
        Headers::get_optional_as(self.headers(), &CONTENT_MD5)
...
impl BlockBlobClientStageBlockFromUrlResultHeaders for Response<BlockBlobClientStageBlockFromUrlResult> {
/// If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the
/// client can check for message content integrity.
    fn content_md5(&self) -> Result<Option<String>> {
        Headers::get_optional_as(self.headers(), &CONTENT_MD5)
...
impl PageBlobClientUpdateSequenceNumberResultHeaders for Response<PageBlobClientUpdateSequenceNumberResult> {
/// UTC date/time value generated by the service that indicates the time at which the response was initiated
    fn date(&self) -> Result<Option<OffsetDateTime>> {
        Headers::get_optional_with(self.headers(), &DATE, |h| date::parse_rfc7231(h.as_str()))
    }
...
impl PageBlobClientUploadPagesFromUrlResultHeaders for Response<PageBlobClientUploadPagesFromUrlResult> {
/// If the blob has an MD5 hash and this operation is to read the full blob, this response header is returned so that the
/// client can check for message content integrity.
    fn content_md5(&self) -> Result<Option<String>> {
        Headers::get_optional_as(self.headers(), &CONTENT_MD5)
...
mod private {
    ...
    use super::{
        AppendBlobClientAppendBlockFromUrlResult, AppendBlobClientAppendBlockResult, AppendBlobClientCreateResult, AppendBlobClientSealResult, BlobClientAbortCopyFromUrlResult, BlobClientAcquireLeaseResult, BlobClientBreakLeaseResult, BlobClientChangeLeaseResult, BlobClientCopyFromUrlResult, BlobClientCreateSnapshotResult, BlobClientDeleteImmutabilityPolicyResult, BlobClientDownloadResult, BlobClientGetAccountInfoResult, BlobClientGetPropertiesResult, BlobClientReleaseLeaseResult, BlobClientRenewLeaseResult, BlobClientSetExpiryResult, BlobClientSetHttpHeadersResult, BlobClientSetImmutabilityPolicyResult, BlobClientSetLegalHoldResult, BlobClientSetMetadataResult, BlobClientSetTagsResult, BlobClientStartCopyFromUrlResult, BlobClientUndeleteResult, BlobContainerClientAcquireLeaseResult, BlobContainerClientBreakLeaseResult, BlobContainerClientChangeLeaseResult, BlobContainerClientGetAccountInfoResult, BlobContainerClientGetPropertiesResult, BlobContainerClientReleaseLeaseResult, BlobContainerClientRenameResult, BlobContainerClientRenewLeaseResult, BlobContainerClientRestoreResult, BlobContainerClientSetAccessPolicyResult, BlobContainerClientSetMetadataResult, BlobContainerClientSubmitBatchResult, BlobServiceClientGetAccountInfoResult, BlobServiceClientSubmitBatchResult, BlobTags, BlockBlobClientCommitBlockListResult, BlockBlobClientPutBlobFromUrlResult, BlockBlobClientQueryResult, BlockBlobClientStageBlockFromUrlResult, BlockBlobClientStageBlockResult, BlockBlobClientUploadResult, BlockList, FilterBlobSegment, ListBlobsFlatSegmentResponse, ListBlobsHierarchySegmentResponse, PageBlobClientClearPagesResult, PageBlobClientCopyIncrementalResult, PageBlobClientCreateResult, PageBlobClientResizeResult, PageBlobClientUpdateSequenceNumberResult, PageBlobClientUploadPagesFromUrlResult, PageBlobClientUploadPagesResult, PageList, SignedIdentifier, StorageServiceStats, UserDelegationKey,
    };
