...
use super::{
    ArrowField, BlobItemInternal, BlobPrefix, BlobTag, Block, ClearRange, ContainerItem, CorsRule, FilterBlobItem, PageRange,
};
...
impl Blob_itemsBlobItemInternal {
    pub fn unwrap<'de, D>(deserializer: D) -> Result<Vec<BlobItemInternal>, D::Error> where D: Deserializer<'de> {
        Ok(Blob_itemsBlobItemInternal::deserialize(deserializer)?.BlobItemInternal)
    }

    pub fn wrap<S>(to_serialize: &Vec<BlobItemInternal>, serializer: S) -> Result<S::Ok, S::Error> where S: Serializer {
...
impl Blob_prefixesBlobPrefix {
    pub fn unwrap<'de, D>(deserializer: D) -> Result<Vec<BlobPrefix>, D::Error> where D: Deserializer<'de> {
        Ok(Blob_prefixesBlobPrefix::deserialize(deserializer)?.BlobPrefix)
    }

    pub fn wrap<S>(to_serialize: &Vec<BlobPrefix>, serializer: S) -> Result<S::Ok, S::Error> where S: Serializer {
...
impl Blob_tag_setBlobTag {
    pub fn unwrap<'de, D>(deserializer: D) -> Result<Vec<BlobTag>, D::Error> where D: Deserializer<'de> {
        Ok(Blob_tag_setBlobTag::deserialize(deserializer)?.BlobTag)
    }

    pub fn wrap<S>(to_serialize: &Vec<BlobTag>, serializer: S) -> Result<S::Ok, S::Error> where S: Serializer {
        Blob_tag_setBlobTag {
...
impl BlobsFilterBlobItem {
    pub fn unwrap<'de, D>(deserializer: D) -> Result<Vec<FilterBlobItem>, D::Error> where D: Deserializer<'de> {
        Ok(BlobsFilterBlobItem::deserialize(deserializer)?.FilterBlobItem)
    }

    pub fn wrap<S>(to_serialize: &Vec<FilterBlobItem>, serializer: S) -> Result<S::Ok, S::Error> where S: Serializer {
        BlobsFilterBlobItem {
...
impl Clear_rangeClearRange {
    pub fn unwrap<'de, D>(deserializer: D) -> Result<Vec<ClearRange>, D::Error> where D: Deserializer<'de> {
        Ok(Clear_rangeClearRange::deserialize(deserializer)?.ClearRange)
    }

    pub fn wrap<S>(to_serialize: &Vec<ClearRange>, serializer: S) -> Result<S::Ok, S::Error> where S: Serializer {
...
impl Committed_blocksBlock {
    pub fn unwrap<'de, D>(deserializer: D) -> Result<Vec<Block>, D::Error> where D: Deserializer<'de> {
        Ok(Committed_blocksBlock::deserialize(deserializer)?.Block)
    }

    pub fn wrap<S>(to_serialize: &Vec<Block>, serializer: S) -> Result<S::Ok, S::Error> where S: Serializer {
...
impl Container_itemsContainerItem {
    pub fn unwrap<'de, D>(deserializer: D) -> Result<Vec<ContainerItem>, D::Error> where D: Deserializer<'de> {
        Ok(Container_itemsContainerItem::deserialize(deserializer)?.ContainerItem)
    }

    pub fn wrap<S>(to_serialize: &Vec<ContainerItem>, serializer: S) -> Result<S::Ok, S::Error> where S: Serializer {
...
impl CorsCorsRule {
    pub fn unwrap<'de, D>(deserializer: D) -> Result<Vec<CorsRule>, D::Error> where D: Deserializer<'de> {
        Ok(CorsCorsRule::deserialize(deserializer)?.CorsRule)
    }

    pub fn wrap<S>(to_serialize: &Vec<CorsRule>, serializer: S) -> Result<S::Ok, S::Error> where S: Serializer {
        CorsCorsRule {
...
impl Page_rangePageRange {
    pub fn unwrap<'de, D>(deserializer: D) -> Result<Vec<PageRange>, D::Error> where D: Deserializer<'de> {
        Ok(Page_rangePageRange::deserialize(deserializer)?.PageRange)
    }

    pub fn wrap<S>(to_serialize: &Vec<PageRange>, serializer: S) -> Result<S::Ok, S::Error> where S: Serializer {
        Page_rangePageRange {
...
impl SchemaArrowField {
    pub fn unwrap<'de, D>(deserializer: D) -> Result<Vec<ArrowField>, D::Error> where D: Deserializer<'de> {
        Ok(SchemaArrowField::deserialize(deserializer)?.ArrowField)
    }

    pub fn wrap<S>(to_serialize: &Vec<ArrowField>, serializer: S) -> Result<S::Ok, S::Error> where S: Serializer {
        SchemaArrowField {
