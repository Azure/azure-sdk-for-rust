...
use super::{
    AccessTier, ArchiveStatus, BlobImmutabilityPolicyMode, BlobType, CopyStatus, GeoReplicationStatusType, LeaseDuration, LeaseState, LeaseStatus, PublicAccessType, QueryRequestType, QueryType, RehydratePriority, models_serde,
};
use super::xml_helpers::{
    Blob_itemsBlobItemInternal, Blob_prefixesBlobPrefix, Blob_tag_setBlobTag, BlobsFilterBlobItem, Clear_rangeClearRange, Committed_blocksBlock, Container_itemsContainerItem, CorsCorsRule, Page_rangePageRange, SchemaArrowField, Uncommitted_blocksBlock,
};
...
/// The date-time the policy expires.
    #[serde(default, rename = "Expiry", skip_serializing_if = "Option::is_none", with = "azure_core::date::rfc3339::option")]
...
/// The date-time the policy is active.
    #[serde(default, rename = "Start", skip_serializing_if = "Option::is_none", with = "azure_core::date::rfc3339::option")]
...
/// The Apache Arrow schema
    #[serde(default, deserialize_with = "SchemaArrowField::unwrap", rename = "Schema", serialize_with = "SchemaArrowField::wrap")]
...
/// The blob items.
    #[serde(default, deserialize_with = "Blob_itemsBlobItemInternal::unwrap", rename = "BlobItems", serialize_with = "Blob_itemsBlobItemInternal::wrap")]
...
/// The blob prefixes.
    #[serde(default, deserialize_with = "Blob_prefixesBlobPrefix::unwrap", rename = "BlobPrefixes", serialize_with = "Blob_prefixesBlobPrefix::wrap")]
...
/// The object replication metadata of the blob.
    #[serde(rename = "ObjectReplicationMetadata", skip_serializing_if = "Option::is_none")]
...
/// The access tier change time of the blob.
    #[serde(default, rename = "AccessTierChangeTime", skip_serializing_if = "Option::is_none", with = "azure_core::date::rfc7231::option")]
...
/// The content MD5 of the blob.
    #[serde(default, deserialize_with = "base64::deserialize", rename = "Content-MD5", serialize_with = "base64::serialize", skip_serializing_if = "Option::is_none")]
...
/// The copy completion time of the blob.
    #[serde(default, rename = "CopyCompletionTime", skip_serializing_if = "Option::is_none", with = "azure_core::date::rfc7231::option")]
...
/// The date-time the blob was created in RFC1123 format.
    #[serde(default, rename = "Creation-Time", skip_serializing_if = "Option::is_none", with = "azure_core::date::rfc7231::option")]
...
/// The time the blob was deleted.
    #[serde(default, rename = "DeletedTime", skip_serializing_if = "Option::is_none", with = "azure_core::date::rfc7231::option")]
...
/// The expire time of the blob.
    #[serde(default, rename = "Expiry-Time", skip_serializing_if = "Option::is_none", with = "azure_core::date::rfc7231::option")]
    pub expires_on: Option<OffsetDateTime>,

/// The immutability policy until time of the blob.
    #[serde(default, rename = "ImmutabilityPolicyUntilDate", skip_serializing_if = "Option::is_none", with = "azure_core::date::rfc7231::option")]
...
/// The last access time of the blob.
    #[serde(default, rename = "LastAccessTime", skip_serializing_if = "Option::is_none", with = "azure_core::date::rfc7231::option")]
    pub last_accessed_on: Option<OffsetDateTime>,

/// The date-time the blob was last modified in RFC1123 format.
    #[serde(default, rename = "Last-Modified", skip_serializing_if = "Option::is_none", with = "azure_core::date::rfc7231::option")]
...
/// Represents the blob tags.
    #[serde(default, deserialize_with = "Blob_tag_setBlobTag::unwrap", rename = "TagSet", serialize_with = "Blob_tag_setBlobTag::wrap")]
...
/// The base64 encoded block ID.
    #[serde(default, deserialize_with = "base64::deserialize", rename = "Name", serialize_with = "base64::serialize", skip_serializing_if = "Option::is_none")]
...
/// The list of committed blocks.
    #[serde(default, deserialize_with = "Committed_blocksBlock::unwrap", rename = "CommittedBlocks", serialize_with = "Committed_blocksBlock::wrap")]
    pub committed_blocks: Vec<Block>,

/// The list of uncommitted blocks.
    #[serde(default, deserialize_with = "Uncommitted_blocksBlock::unwrap", rename = "UncommittedBlocks", serialize_with = "Uncommitted_blocksBlock::wrap")]
...
/// The committed blocks
    #[serde(default, rename = "Committed", skip_serializing_if = "Vec::is_empty", with = "models_serde::vec_encoded_bytes_std")]
    pub committed: Vec<Vec<u8>>,

/// The latest blocks
    #[serde(default, rename = "Latest", skip_serializing_if = "Vec::is_empty", with = "models_serde::vec_encoded_bytes_std")]
    pub latest: Vec<Vec<u8>>,

/// The uncommitted blocks
    #[serde(default, rename = "Uncommitted", skip_serializing_if = "Vec::is_empty", with = "models_serde::vec_encoded_bytes_std")]
...
/// The metadata of the container.
    #[serde(default, rename = "Metadata", skip_serializing_if = "HashMap::is_empty")]
...
/// The blob segment.
    #[serde(default, deserialize_with = "BlobsFilterBlobItem::unwrap", rename = "Blobs", serialize_with = "BlobsFilterBlobItem::wrap")]
...
/// operations at the secondary. Primary writes after this point in time may or may not be available for reads.
    #[serde(default, rename = "LastSyncTime", skip_serializing_if = "Option::is_none", with = "azure_core::date::rfc7231::option")]
...
pub struct PageList {
/// The clear ranges.
    #[serde(default, deserialize_with = "Clear_rangeClearRange::unwrap", rename = "ClearRange", serialize_with = "Clear_rangeClearRange::wrap")]
...
/// The page ranges.
    #[serde(default, deserialize_with = "Page_rangePageRange::unwrap", rename = "PageRange", serialize_with = "Page_rangePageRange::wrap")]
...
/// The delimited text configuration.
    #[serde(rename = "DelimitedTextConfiguration", skip_serializing_if = "Option::is_none")]
    pub delimited_text_configuration: Option<DelimitedTextConfiguration>,

/// The JSON text configuration.
    #[serde(rename = "JsonTextConfiguration", skip_serializing_if = "Option::is_none")]
    pub json_text_configuration: Option<JsonTextConfiguration>,

/// The Parquet configuration.
    #[serde(rename = "ParquetConfiguration", skip_serializing_if = "Option::is_none")]
...
/// The output serialization settings.
    #[serde(rename = "OutputSerialization", skip_serializing_if = "Option::is_none")]
...
/// The CORS properties.
    #[serde(default, deserialize_with = "CorsCorsRule::unwrap", rename = "Cors", serialize_with = "CorsCorsRule::wrap")]
...
/// The key as a base64 string.
    #[serde(default, deserialize_with = "base64::deserialize", rename = "Value", serialize_with = "base64::serialize", skip_serializing_if = "Option::is_none")]
