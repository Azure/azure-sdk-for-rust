...
use azure_core::{Value, base64::option::{deserialize, serialize, }, fmt::SafeDebug, time::OffsetDateTime, };
use serde::{Deserialize, Serialize, };
use std::collections::HashMap;
use super::{AccessTier, ArchiveStatus, BlobType, CopyStatus, GeoReplicationStatusType, ImmutabilityPolicyMode, LeaseDuration, LeaseState, LeaseStatus, PublicAccessType, QueryRequestType, QueryType, RehydratePriority, models_serde, xml_helpers::{Blob_tag_setTag, BlobsBlob, Committed_blocksBlock, Container_itemsContainer, CorsCorsRule, SchemaField, Uncommitted_blocksBlock, }, };
...
/// The Apache Arrow schema
    #[serde(default, deserialize_with = "SchemaField::unwrap", rename = "Schema", serialize_with = "SchemaField::wrap", skip_serializing_if = "Option::is_none")]
...
/// The content MD5 of the blob.
    #[serde(default, deserialize_with = "deserialize", rename = "Content-MD5", serialize_with = "serialize", skip_serializing_if = "Option::is_none")]
...
/// Represents the blob tags.
    #[serde(default, deserialize_with = "Blob_tag_setTag::unwrap", rename = "TagSet", serialize_with = "Blob_tag_setTag::wrap", skip_serializing_if = "Option::is_none")]
...
/// The base64 encoded block ID.
    #[serde(default, deserialize_with = "deserialize", rename = "Name", serialize_with = "serialize", skip_serializing_if = "Option::is_none")]
...
/// The blob segment.
    #[serde(default, deserialize_with = "BlobsBlob::unwrap", rename = "Blobs", serialize_with = "BlobsBlob::wrap", skip_serializing_if = "Option::is_none")]
...
/// The container segment.
    #[serde(default, deserialize_with = "Container_itemsContainer::unwrap", rename = "Containers", serialize_with = "Container_itemsContainer::wrap")]
