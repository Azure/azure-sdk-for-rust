...
impl FromStr for ListBlobsRawResponseResponseContentType {
    type Err = Error;
    fn from_str(s: &str) -> ::core::result::Result<Self, <Self as FromStr>::Err> {
        Ok(match s {
            "application/vnd.apache.arrow.stream" => {
                ListBlobsRawResponseResponseContentType::ApplicationVndApacheArrowStream
            }
            "application/xml" => ListBlobsRawResponseResponseContentType::ApplicationXml,
            _ => {
                return Err(Error::with_message_fn(ErrorKind::DataConversion, || {
                    format!(
                        "unknown variant of ListBlobsRawResponseResponseContentType found: \"{s}\""
                    )
                }))
            }
        })
...
impl AsRef<str> for ListBlobsRawResponseResponseContentType {
    fn as_ref(&self) -> &str {
        match self {
            ListBlobsRawResponseResponseContentType::ApplicationVndApacheArrowStream => {
                "application/vnd.apache.arrow.stream"
            }
            ListBlobsRawResponseResponseContentType::ApplicationXml => "application/xml",
        }
    }
}

impl Display for ListBlobsRawResponseResponseContentType {
    fn fmt(&self, f: &mut Formatter<'_>) -> ::std::fmt::Result {
        match self {
            ListBlobsRawResponseResponseContentType::ApplicationVndApacheArrowStream => {
                Display::fmt("application/vnd.apache.arrow.stream", f)
            }
            ListBlobsRawResponseResponseContentType::ApplicationXml => {
