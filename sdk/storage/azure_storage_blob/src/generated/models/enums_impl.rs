    ...
    impl<'a> From<&'a StorageErrorCode> for &'a str {
        fn from(e: &'a StorageErrorCode) -> Self {
            match e {
                ...
                StorageErrorCode::BlobAccessTierNotSupportedForAccountType => "BlobAccessTierNotSupportedForAccountType",
    ...
    impl FromStr for StorageErrorCode {
        ...
        fn from_str(s: &str) -> ::core::result::Result<Self, <Self as FromStr>::Err> {
            Ok(match s {
                ...
                "BlobAccessTierNotSupportedForAccountType" => StorageErrorCode::BlobAccessTierNotSupportedForAccountType,
                ...
                "BlobTierInadequateForContentLength" => StorageErrorCode::BlobTierInadequateForContentLength,
                ...
                "InvalidVersionForPageBlobOperation" => StorageErrorCode::InvalidVersionForPageBlobOperation,
                ...
                "LeaseIdMismatchWithBlobOperation" => StorageErrorCode::LeaseIdMismatchWithBlobOperation,
                "LeaseIdMismatchWithContainerOperation" => StorageErrorCode::LeaseIdMismatchWithContainerOperation,
                ...
                "LeaseNotPresentWithBlobOperation" => StorageErrorCode::LeaseNotPresentWithBlobOperation,
                "LeaseNotPresentWithContainerOperation" => StorageErrorCode::LeaseNotPresentWithContainerOperation,
                ...
                "OperationNotAllowedOnIncrementalCopyBlob" => StorageErrorCode::OperationNotAllowedOnIncrementalCopyBlob,
    ...
    impl Display for StorageErrorCode {
        fn fmt(&self, f: &mut Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                StorageErrorCode::AppendPositionConditionNotMet => f.write_str("AppendPositionConditionNotMet"),
                ...
                StorageErrorCode::AuthorizationPermissionMismatch => f.write_str("AuthorizationPermissionMismatch"),
                StorageErrorCode::AuthorizationProtocolMismatch => f.write_str("AuthorizationProtocolMismatch"),
                StorageErrorCode::AuthorizationResourceTypeMismatch => f.write_str("AuthorizationResourceTypeMismatch"),
                StorageErrorCode::AuthorizationServiceMismatch => f.write_str("AuthorizationServiceMismatch"),
                StorageErrorCode::AuthorizationSourceIPMismatch => f.write_str("AuthorizationSourceIPMismatch"),
                StorageErrorCode::BlobAccessTierNotSupportedForAccountType => f.write_str("BlobAccessTierNotSupportedForAccountType"),
                ...
                StorageErrorCode::BlobTierInadequateForContentLength => f.write_str("BlobTierInadequateForContentLength"),
                StorageErrorCode::BlobUsesCustomerSpecifiedEncryption => f.write_str("BlobUsesCustomerSpecifiedEncryption"),
                ...
                StorageErrorCode::ContentLengthLargerThanTierLimit => f.write_str("ContentLengthLargerThanTierLimit"),
                StorageErrorCode::CopyAcrossAccountsNotSupported => f.write_str("CopyAcrossAccountsNotSupported"),
                ...
                StorageErrorCode::IncrementalCopyBlobMismatch => f.write_str("IncrementalCopyBlobMismatch"),
                StorageErrorCode::IncrementalCopyOfEarlierVersionSnapshotNotAllowed => f.write_str("IncrementalCopyOfEarlierVersionSnapshotNotAllowed"),
                StorageErrorCode::IncrementalCopySourceMustBeSnapshot => f.write_str("IncrementalCopySourceMustBeSnapshot"),
                StorageErrorCode::InfiniteLeaseDurationRequired => f.write_str("InfiniteLeaseDurationRequired"),
                StorageErrorCode::InsufficientAccountPermissions => f.write_str("InsufficientAccountPermissions"),
                ...
                StorageErrorCode::InvalidQueryParameterValue => f.write_str("InvalidQueryParameterValue"),
                ...
                StorageErrorCode::InvalidVersionForPageBlobOperation => f.write_str("InvalidVersionForPageBlobOperation"),
                ...
                StorageErrorCode::LeaseIdMismatchWithBlobOperation => f.write_str("LeaseIdMismatchWithBlobOperation"),
                StorageErrorCode::LeaseIdMismatchWithContainerOperation => f.write_str("LeaseIdMismatchWithContainerOperation"),
                StorageErrorCode::LeaseIdMismatchWithLeaseOperation => f.write_str("LeaseIdMismatchWithLeaseOperation"),
                StorageErrorCode::LeaseIdMissing => f.write_str("LeaseIdMissing"),
                StorageErrorCode::LeaseIsBreakingAndCannotBeAcquired => f.write_str("LeaseIsBreakingAndCannotBeAcquired"),
                StorageErrorCode::LeaseIsBreakingAndCannotBeChanged => f.write_str("LeaseIsBreakingAndCannotBeChanged"),
                StorageErrorCode::LeaseIsBrokenAndCannotBeRenewed => f.write_str("LeaseIsBrokenAndCannotBeRenewed"),
                StorageErrorCode::LeaseLost => f.write_str("LeaseLost"),
                StorageErrorCode::LeaseNotPresentWithBlobOperation => f.write_str("LeaseNotPresentWithBlobOperation"),
                StorageErrorCode::LeaseNotPresentWithContainerOperation => f.write_str("LeaseNotPresentWithContainerOperation"),
                StorageErrorCode::LeaseNotPresentWithLeaseOperation => f.write_str("LeaseNotPresentWithLeaseOperation"),
                StorageErrorCode::MaxBlobSizeConditionNotMet => f.write_str("MaxBlobSizeConditionNotMet"),
                StorageErrorCode::Md5Mismatch => f.write_str("Md5Mismatch"),
                StorageErrorCode::MetadataTooLarge => f.write_str("MetadataTooLarge"),
                StorageErrorCode::MissingContentLengthHeader => f.write_str("MissingContentLengthHeader"),
                StorageErrorCode::MissingRequiredHeader => f.write_str("MissingRequiredHeader"),
                StorageErrorCode::MissingRequiredQueryParameter => f.write_str("MissingRequiredQueryParameter"),
                StorageErrorCode::MissingRequiredXmlNode => f.write_str("MissingRequiredXmlNode"),
                StorageErrorCode::MultipleConditionHeadersNotSupported => f.write_str("MultipleConditionHeadersNotSupported"),
                StorageErrorCode::NoPendingCopyOperation => f.write_str("NoPendingCopyOperation"),
                StorageErrorCode::OperationNotAllowedOnIncrementalCopyBlob => f.write_str("OperationNotAllowedOnIncrementalCopyBlob"),
                ...
                StorageErrorCode::OutOfRangeQueryParameterValue => f.write_str("OutOfRangeQueryParameterValue"),
                StorageErrorCode::PendingCopyOperation => f.write_str("PendingCopyOperation"),
                StorageErrorCode::PreviousSnapshotCannotBeNewer => f.write_str("PreviousSnapshotCannotBeNewer"),
                StorageErrorCode::PreviousSnapshotNotFound => f.write_str("PreviousSnapshotNotFound"),
                StorageErrorCode::PreviousSnapshotOperationNotSupported => f.write_str("PreviousSnapshotOperationNotSupported"),
                ...
                StorageErrorCode::SequenceNumberConditionNotMet => f.write_str("SequenceNumberConditionNotMet"),
                StorageErrorCode::SequenceNumberIncrementTooLarge => f.write_str("SequenceNumberIncrementTooLarge"),
                ...
                StorageErrorCode::SnapshotOperationRateExceeded => f.write_str("SnapshotOperationRateExceeded"),
