...
use azure_core::{
    Bytes, ClientMethodOptions, Context, Method, Pipeline, Request, RequestContent, Response, Result, Url, base64, date,
};
use crate::models::{
    BlobImmutabilityPolicyMode, EncryptionAlgorithmType, PremiumPageBlobAccessTier, SequenceNumberActionType,
};
...
impl BlobPageBlobClient {
    ...
    pub async fn clear_pages(&self, content_length: i64, options: Option<BlobPageBlobClientClearPagesOptions<'_>>) -> Result<Response<()>> {
        ...
        url = url.join(&path)?;
        url.query_pairs_mut().append_key_only("clear").append_pair("comp", "page");
        ...
        if let Some(if_unmodified_since) = options.if_unmodified_since {
            request.insert_header("if-unmodified-since", date::to_rfc7231(&if_unmodified_since));
        }
        ...
        if let Some(if_sequence_number_equal_to) = options.if_sequence_number_equal_to {
            request.insert_header("x-ms-if-sequence-number-eq", if_sequence_number_equal_to.to_string());
        }
        if let Some(if_sequence_number_less_than_or_equal_to) = options.if_sequence_number_less_than_or_equal_to {
            request.insert_header("x-ms-if-sequence-number-le", if_sequence_number_less_than_or_equal_to.to_string());
        }
        if let Some(if_sequence_number_less_than) = options.if_sequence_number_less_than {
            request.insert_header("x-ms-if-sequence-number-lt", if_sequence_number_less_than.to_string());
        }
...
/// since REST version 2016-05-31.
    pub async fn copy_incremental(&self, copy_source: String, options: Option<BlobPageBlobClientCopyIncrementalOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
    ...
    pub async fn create(&self, content_length: i64, blob_content_length: i64, options: Option<BlobPageBlobClientCreateOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
        ...
        if let Some(blob_sequence_number) = options.blob_sequence_number {
            request.insert_header("x-ms-blob-sequence-number", blob_sequence_number.to_string());
        }
        if let Some(client_request_id) = options.client_request_id {
            request.insert_header("x-ms-client-request-id", client_request_id);
        }
...
for (k, v) in &metadata {
    ...
    pub async fn resize(&self, blob_content_length: i64, options: Option<BlobPageBlobClientResizeOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
        ...
        path = path.replace("{containerName}", &self.container_name);
        url = url.join(&path)?;
        url.query_pairs_mut().append_key_only("Resize").append_pair("comp", "properties");
        if let Some(timeout) = options.timeout {
            url.query_pairs_mut().append_pair("timeout", &timeout.to_string());
        }
        let mut request = Request::new(url, Method::Put);
...
/// number is less than the current sequence number of the blob.
    pub async fn update_sequence_number(&self, sequence_number_action: SequenceNumberActionType, options: Option<BlobPageBlobClientUpdateSequenceNumberOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
        ...
        path = path.replace("{containerName}", &self.container_name);
        url = url.join(&path)?;
        url.query_pairs_mut().append_key_only("UpdateSequenceNumber").append_pair("comp", "properties");
        if let Some(timeout) = options.timeout {
            url.query_pairs_mut().append_pair("timeout", &timeout.to_string());
        }
        let mut request = Request::new(url, Method::Put);
        ...
        request.insert_header("x-ms-sequence-number-action", sequence_number_action.to_string());
        request.insert_header("x-ms-version", &self.version);
        self.pipeline.send(&ctx, &mut request).await
    ...
    pub async fn upload_pages(&self, body: RequestContent<Bytes>, content_length: i64, options: Option<BlobPageBlobClientUploadPagesOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
        ...
        path = path.replace("{containerName}", &self.container_name);
        url = url.join(&path)?;
        url.query_pairs_mut().append_pair("comp", "page").append_key_only("update");
        if let Some(timeout) = options.timeout {
            url.query_pairs_mut().append_pair("timeout", &timeout.to_string());
        }
        let mut request = Request::new(url, Method::Put);
    ...
    pub async fn upload_pages_from_url(&self, source_url: String, source_range: String, content_length: i64, range: String, options: Option<BlobPageBlobClientUploadPagesFromUrlOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
        ...
        path = path.replace("{containerName}", &self.container_name);
        url = url.join(&path)?;
        url.query_pairs_mut().append_pair("comp", "page").append_key_only("fromUrl").append_key_only("update");
        if let Some(timeout) = options.timeout {
            url.query_pairs_mut().append_pair("timeout", &timeout.to_string());
        }
        let mut request = Request::new(url, Method::Put);
