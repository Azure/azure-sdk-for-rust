...
use crate::generated::models::{
    AppendBlobClientAppendBlockFromUrlOptions, AppendBlobClientAppendBlockFromUrlResult, AppendBlobClientAppendBlockOptions, AppendBlobClientAppendBlockResult, AppendBlobClientCreateOptions, AppendBlobClientCreateResult, AppendBlobClientSealOptions, AppendBlobClientSealResult, BlobType,
};
use std::sync::Arc;
...
/// * `options` - Optional configuration for the client.
    pub fn new(endpoint: &str, credential: Arc<dyn TokenCredential>, container_name: String, blob_name: String, options: Option<AppendBlobClientOptions>) -> Result<Self> {
...
/// * `options` - Optional parameters for the request.
    pub async fn append_block(&self, body: RequestContent<Bytes>, content_length: u64, options: Option<AppendBlobClientAppendBlockOptions<'_>>) -> Result<Response<AppendBlobClientAppendBlockResult>> {
        let options = options.unwrap_or_default();
...
/// * `content_length` - The length of the request.
/// * `options` - Optional parameters for the request.
    pub async fn append_block_from_url(&self, source_url: &str, content_length: u64, options: Option<AppendBlobClientAppendBlockFromUrlOptions<'_>>) -> Result<Response<AppendBlobClientAppendBlockFromUrlResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
...
/// * `content_length` - The length of the request.
/// * `options` - Optional parameters for the request.
    pub async fn create(&self, content_length: u64, options: Option<AppendBlobClientCreateOptions<'_>>) -> Result<Response<AppendBlobClientCreateResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
...
/// later.
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn seal(&self, options: Option<AppendBlobClientSealOptions<'_>>) -> Result<Response<AppendBlobClientSealResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
