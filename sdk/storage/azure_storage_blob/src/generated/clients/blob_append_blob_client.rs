...
impl BlobAppendBlobClient {
    ...
    pub async fn append_block(&self, body: RequestContent<Bytes>, content_length: i64, options: Option<BlobAppendBlobClientAppendBlockOptions<'_>>) -> Result<Response<()>> {
...
/// read from a URL.
    pub async fn append_block_from_url(&self, source_url: String, content_length: i64, options: Option<BlobAppendBlobClientAppendBlockFromUrlOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
    ...
    pub async fn create(&self, content_length: i64, options: Option<BlobAppendBlobClientCreateOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
...
/// later.
    pub async fn seal(&self, options: Option<BlobAppendBlobClientSealOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
