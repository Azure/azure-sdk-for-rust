...
/// * `options` - Optional parameters for the request.
    pub async fn filter_blobs(&self, options: Option<BlobServiceClientFilterBlobsOptions<'_>>) -> Result<Response<FilterBlobSegment>> {
        let options = options.unwrap_or_default();
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn get_account_info(&self, options: Option<BlobServiceClientGetAccountInfoOptions<'_>>) -> Result<Response<BlobServiceClientGetAccountInfoResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// Resource Sharing) rules.
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn get_properties(&self, options: Option<BlobServiceClientGetPropertiesOptions<'_>>) -> Result<Response<StorageServiceProperties>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// when read-access geo-redundant replication is enabled for the storage account.
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn get_statistics(&self, options: Option<BlobServiceClientGetStatisticsOptions<'_>>) -> Result<Response<StorageServiceStats>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// * `options` - Optional parameters for the request.
    pub async fn get_user_delegation_key(&self, start: &str, expiry: &str, options: Option<BlobServiceClientGetUserDelegationKeyOptions<'_>>) -> Result<Response<UserDelegationKey>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn list_containers_segment(&self, options: Option<BlobServiceClientListContainersSegmentOptions<'_>>) -> Result<Response<ListContainersSegmentResponse>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// Resource Sharing) rules
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn set_properties(&self, options: Option<BlobServiceClientSetPropertiesOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url.query_pairs_mut().append_pair("comp", "properties").append_pair("restype", "service");
...
/// * `options` - Optional parameters for the request.
    pub async fn submit_batch(&self, content_length: u64, body: RequestContent<Bytes>, options: Option<BlobServiceClientSubmitBatchOptions<'_>>) -> Result<Response<BlobServiceClientSubmitBatchResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
