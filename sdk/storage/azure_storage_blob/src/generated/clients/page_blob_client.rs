...
use azure_core::{Bytes, Result, base64::encode, credentials::TokenCredential, error::CheckSuccessOptions, fmt::SafeDebug, http::{ClientOptions, Method, NoFormat, Pipeline, PipelineSendOptions, Request, RequestContent, Response, Url, UrlExt, XmlFormat, policies::{Policy, auth::BearerTokenAuthorizationPolicy, }, }, time::to_rfc7231, tracing, };
use crate::generated::models::{PageBlobClientClearPagesOptions, PageBlobClientClearPagesResult, PageBlobClientCopyIncrementalOptions, PageBlobClientCopyIncrementalResult, PageBlobClientCreateOptions, PageBlobClientCreateResult, PageBlobClientGetPageRangesDiffOptions, PageBlobClientGetPageRangesOptions, PageBlobClientResizeOptions, PageBlobClientResizeResult, PageBlobClientSetSequenceNumberOptions, PageBlobClientSetSequenceNumberResult, PageBlobClientUploadPagesFromUrlOptions, PageBlobClientUploadPagesFromUrlResult, PageBlobClientUploadPagesOptions, PageBlobClientUploadPagesResult, PageList, SequenceNumberActionType, };
use std::sync::Arc;
...
/// * `options` - Optional configuration for the client.
    ...
    pub fn new(endpoint: &str, credential: Arc<dyn TokenCredential>, options: Option<PageBlobClientOptions>) -> Result<Self> {
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn clear_pages(&self, range: String, options: Option<PageBlobClientClearPagesOptions<'_>>) -> Result<Response<PageBlobClientClearPagesResult, NoFormat>> {
        let options = options.unwrap_or_default();
        let ctx = options.method_options.context.to_borrowed();
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_key_only("clear").append_pair("comp", "page");
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn copy_incremental(&self, copy_source: String, options: Option<PageBlobClientCopyIncrementalOptions<'_>>) -> Result<Response<PageBlobClientCopyIncrementalResult, NoFormat>> {
        let options = options.unwrap_or_default();
        let ctx = options.method_options.context.to_borrowed();
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn create(&self, size: u64, options: Option<PageBlobClientCreateOptions<'_>>) -> Result<Response<PageBlobClientCreateResult, NoFormat>> {
        ...
        if let Some(immutability_policy_expiry) = options.immutability_policy_expiry {
            request.insert_header("x-ms-immutability-policy-until-date", to_rfc7231(&immutability_policy_expiry));
        }
        if let Some(lease_id) = options.lease_id.as_ref() {
            request.insert_header("x-ms-lease-id", lease_id);
        }
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn get_page_ranges(&self, options: Option<PageBlobClientGetPageRangesOptions<'_>>) -> Result<Response<PageList, XmlFormat>> {
        let options = options.unwrap_or_default();
        let ctx = options.method_options.context.to_borrowed();
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn get_page_ranges_diff(&self, options: Option<PageBlobClientGetPageRangesDiffOptions<'_>>) -> Result<Response<PageList, XmlFormat>> {
        let options = options.unwrap_or_default();
        let ctx = options.method_options.context.to_borrowed();
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_pair("comp", "pagelist").append_key_only("diff");
        if let Some(marker) = options.marker.as_ref() {
            query_builder.set_pair("marker", marker);
        }
        if let Some(maxresults) = options.maxresults {
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn resize(&self, size: u64, options: Option<PageBlobClientResizeOptions<'_>>) -> Result<Response<PageBlobClientResizeResult, NoFormat>> {
        ...
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_key_only("Resize").append_pair("comp", "properties");
        if let Some(timeout) = options.timeout {
            query_builder.set_pair("timeout", timeout.to_string());
        }
        query_builder.build();
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn set_sequence_number(&self, sequence_number_action: SequenceNumberActionType, options: Option<PageBlobClientSetSequenceNumberOptions<'_>>) -> Result<Response<PageBlobClientSetSequenceNumberResult, NoFormat>> {
        ...
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_key_only("UpdateSequenceNumber").append_pair("comp", "properties");
        if let Some(timeout) = options.timeout {
            query_builder.set_pair("timeout", timeout.to_string());
        }
        query_builder.build();
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn upload_pages(&self, body: RequestContent<Bytes, NoFormat>, content_length: u64, range: String, options: Option<PageBlobClientUploadPagesOptions<'_>>) -> Result<Response<PageBlobClientUploadPagesResult, NoFormat>> {
        let options = options.unwrap_or_default();
        let ctx = options.method_options.context.to_borrowed();
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_pair("comp", "page").append_key_only("update");
        if let Some(timeout) = options.timeout {
            query_builder.set_pair("timeout", timeout.to_string());
        }
        query_builder.build();
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn upload_pages_from_url(&self, source_url: String, source_range: String, content_length: u64, range: String, options: Option<PageBlobClientUploadPagesFromUrlOptions<'_>>) -> Result<Response<PageBlobClientUploadPagesFromUrlResult, NoFormat>> {
        let options = options.unwrap_or_default();
        let ctx = options.method_options.context.to_borrowed();
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_pair("comp", "page").append_key_only("fromUrl").append_key_only("update");
        if let Some(timeout) = options.timeout {
            query_builder.set_pair("timeout", timeout.to_string());
        }
        query_builder.build();
        ...
        if let Some(source_if_modified_since) = options.source_if_modified_since {
            request.insert_header("x-ms-source-if-modified-since", to_rfc7231(&source_if_modified_since));
        }
        ...
        if let Some(source_if_unmodified_since) = options.source_if_unmodified_since {
            request.insert_header("x-ms-source-if-unmodified-since", to_rfc7231(&source_if_unmodified_since));
        }
