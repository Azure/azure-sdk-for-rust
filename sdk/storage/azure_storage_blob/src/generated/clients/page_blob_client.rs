...
/// * `options` - Optional configuration for the client.
    pub fn new(endpoint: &str, credential: Arc<dyn TokenCredential>, container_name: String, blob_name: String, options: Option<PageBlobClientOptions>) -> Result<Self> {
...
/// * `options` - Optional parameters for the request.
    pub async fn clear_pages(&self, content_length: u64, options: Option<PageBlobClientClearPagesOptions<'_>>) -> Result<Response<PageBlobClientClearPagesResult>> {
        let options = options.unwrap_or_default();
...
/// * `options` - Optional parameters for the request.
    pub async fn copy_incremental(&self, copy_source: &str, options: Option<PageBlobClientCopyIncrementalOptions<'_>>) -> Result<Response<PageBlobClientCopyIncrementalResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
...
/// * `options` - Optional parameters for the request.
    pub async fn create(&self, content_length: u64, blob_content_length: u64, options: Option<PageBlobClientCreateOptions<'_>>) -> Result<Response<PageBlobClientCreateResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
        ...
        if let Some(immutability_policy_expiry) = options.immutability_policy_expiry {
            request.insert_header("x-ms-immutability-policy-until-date", date::to_rfc7231(&immutability_policy_expiry));
        }
        if let Some(lease_id) = options.lease_id {
            request.insert_header("x-ms-lease-id", lease_id);
        }
...
for (k, v) in &metadata {
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn get_page_ranges(&self, options: Option<PageBlobClientGetPageRangesOptions<'_>>) -> Result<Response<PageList>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn get_page_ranges_diff(&self, options: Option<PageBlobClientGetPageRangesDiffOptions<'_>>) -> Result<Response<PageList>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
        ...
        path = path.replace("{containerName}", &self.container_name);
        url = url.join(&path)?;
        url.query_pairs_mut().append_pair("comp", "pagelist").append_key_only("diff");
        if let Some(marker) = options.marker {
            url.query_pairs_mut().append_pair("marker", &marker);
        }
        if let Some(maxresults) = options.maxresults {
...
///   be aligned to a 512-byte boundary.
/// * `options` - Optional parameters for the request.
    pub async fn resize(&self, blob_content_length: u64, options: Option<PageBlobClientResizeOptions<'_>>) -> Result<Response<PageBlobClientResizeResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
...
/// * `options` - Optional parameters for the request.
    pub async fn update_sequence_number(&self, sequence_number_action: SequenceNumberActionType, options: Option<PageBlobClientUpdateSequenceNumberOptions<'_>>) -> Result<Response<PageBlobClientUpdateSequenceNumberResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
...
/// * `content_length` - The length of the request.
/// * `options` - Optional parameters for the request.
    pub async fn upload_pages(&self, body: RequestContent<Bytes>, content_length: u64, options: Option<PageBlobClientUploadPagesOptions<'_>>) -> Result<Response<PageBlobClientUploadPagesResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
...
/// * `options` - Optional parameters for the request.
    pub async fn upload_pages_from_url(&self, source_url: &str, source_range: &str, content_length: u64, range: &str, options: Option<PageBlobClientUploadPagesFromUrlOptions<'_>>) -> Result<Response<PageBlobClientUploadPagesFromUrlResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
        ...
        if let Some(source_if_modified_since) = options.source_if_modified_since {
            request.insert_header("x-ms-source-if-modified-since", date::to_rfc7231(&source_if_modified_since));
        }
        ...
        if let Some(source_if_unmodified_since) = options.source_if_unmodified_since {
            request.insert_header("x-ms-source-if-unmodified-since", date::to_rfc7231(&source_if_unmodified_since));
        }
