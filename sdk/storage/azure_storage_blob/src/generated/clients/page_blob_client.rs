...
use crate::generated::models::{
    crate_models::PageBlobClientCopyIncrementalResult, PageBlobClientClearPagesOptions,
    PageBlobClientClearPagesResult, PageBlobClientCopyIncrementalOptions,
...
impl PageBlobClient {
    ...
    pub(crate) async fn copy_incremental(
        &self,
        copy_source: String,
    ...
    pub(crate) async fn get_page_ranges_diff(
        &self,
