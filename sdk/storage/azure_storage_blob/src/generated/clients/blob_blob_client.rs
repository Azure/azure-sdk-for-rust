...
/// and full metadata.
    pub async fn abort_copy_from_url(&self, container_name: String, blob: String, copy_id: String, options: Option<BlobBlobClientAbortCopyFromUrlOptions<'_>>) -> Result<Response<()>> {
    ...
    pub async fn acquire_lease(&self, container_name: String, blob: String, options: Option<BlobBlobClientAcquireLeaseOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
    ...
    /// [Update] The Lease Blob operation establishes and manages a lock on a blob for write and delete operations.
    pub async fn break_lease(&self, container_name: String, blob: String, options: Option<BlobBlobClientBreakLeaseOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
    ...
    /// [Update] The Lease Blob operation establishes and manages a lock on a blob for write and delete operations.
    pub async fn change_lease(&self, container_name: String, blob: String, lease_id: String, options: Option<BlobBlobClientChangeLeaseOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
...
/// copy is complete.
    pub async fn copy_from_url(&self, container_name: String, blob: String, copy_source: String, options: Option<BlobBlobClientCopyFromUrlOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
...
for (k, v) in &metadata {
    ...
    pub async fn create_snapshot(&self, container_name: String, blob: String, options: Option<BlobBlobClientCreateSnapshotOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
...
/// causes the service to return an HTTP status code of 404 (ResourceNotFound).
    pub async fn delete(&self, container_name: String, blob: String, options: Option<BlobBlobClientDeleteOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
    ...
    pub async fn delete_immutability_policy(&self, container_name: String, blob: String, options: Option<BlobBlobClientDeleteImmutabilityPolicyOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
...
/// call Download to read a snapshot.
    pub async fn download(&self, container_name: String, blob: String, options: Option<BlobBlobClientDownloadOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
    ...
    pub async fn get_account_info(&self, container_name: String, blob: String, options: Option<BlobBlobClientGetAccountInfoOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
...
/// blob. It does not return the content of the blob.
    pub async fn get_properties(&self, container_name: String, blob: String, options: Option<BlobBlobClientGetPropertiesOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
    ...
    pub async fn get_tags(&self, container_name: String, blob: String, options: Option<BlobBlobClientGetTagsOptions<'_>>) -> Result<Response<BlobTags>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
    ...
    pub async fn query(&self, container_name: String, blob: String, query_request: RequestContent<QueryRequest>, options: Option<BlobBlobClientQueryOptions<'_>>) -> Result<Response<Vec<u8>>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
    ...
    /// [Update] The Lease Blob operation establishes and manages a lock on a blob for write and delete operations.
    pub async fn release_lease(&self, container_name: String, blob: String, lease_id: String, options: Option<BlobBlobClientReleaseLeaseOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
    ...
    /// [Update] The Lease Blob operation establishes and manages a lock on a blob for write and delete operations.
    pub async fn renew_lease(&self, container_name: String, blob: String, lease_id: String, options: Option<BlobBlobClientRenewLeaseOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
    ...
    pub async fn set_expiry(&self, container_name: String, blob: String, expiry_options: BlobExpiryOptions, options: Option<BlobBlobClientSetExpiryOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
    ...
    pub async fn set_http_headers(&self, container_name: String, blob: String, options: Option<BlobBlobClientSetHttpHeadersOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
    ...
    pub async fn set_immutability_policy(&self, container_name: String, blob: String, options: Option<BlobBlobClientSetImmutabilityPolicyOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
    ...
    pub async fn set_legal_hold(&self, container_name: String, blob: String, legal_hold: bool, options: Option<BlobBlobClientSetLegalHoldOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
    ...
    pub async fn set_metadata(&self, container_name: String, blob: String, options: Option<BlobBlobClientSetMetadataOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
...
for (k, v) in &metadata {
    ...
    pub async fn set_tags(&self, container_name: String, blob: String, tags: RequestContent<BlobTags>, options: Option<BlobBlobClientSetTagsOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
...
/// ETag.
    pub async fn set_tier(&self, container_name: String, blob: String, tier: AccessTier, options: Option<BlobBlobClientSetTierOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
    ...
    pub async fn start_copy_from_url(&self, container_name: String, blob: String, copy_source: String, options: Option<BlobBlobClientStartCopyFromUrlOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
...
for (k, v) in &metadata {
    ...
    pub async fn undelete(&self, container_name: String, blob: String, options: Option<BlobBlobClientUndeleteOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
