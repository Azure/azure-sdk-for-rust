...
/// * `options` - Optional configuration for the client.
    pub fn new(endpoint: &str, credential: Arc<dyn TokenCredential>, container_name: String, options: Option<BlobContainerClientOptions>) -> Result<Self> {
    let options = options.unwrap_or_default();
        ...
        let auth_policy: Arc<dyn Policy> = Arc::new(BearerTokenCredentialPolicy::new(credential, vec!["https://storage.azure.com/.default"]));
        Ok(Self {
            container_name,
            endpoint,
...
/// * `options` - Optional parameters for the request.
    pub async fn acquire_lease(&self, options: Option<BlobContainerClientAcquireLeaseOptions<'_>>) -> Result<Response<BlobContainerClientAcquireLeaseResult>> {
        let options = options.unwrap_or_default();
...
/// period has expired.
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn break_lease(&self, options: Option<BlobContainerClientBreakLeaseOptions<'_>>) -> Result<Response<BlobContainerClientBreakLeaseResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&self.container_name)?;
...
/// * `options` - Optional parameters for the request.
    pub async fn change_lease(&self, lease_id: &str, proposed_lease_id: &str, options: Option<BlobContainerClientChangeLeaseOptions<'_>>) -> Result<Response<BlobContainerClientChangeLeaseResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&self.container_name)?;
...
/// fails.
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn create(&self, options: Option<BlobContainerClientCreateOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&self.container_name)?;
...
/// during garbage collection
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn delete(&self, options: Option<BlobContainerClientDeleteOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&self.container_name)?;
...
/// blobs searches within the given container.
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn filter_blobs(&self, options: Option<BlobContainerClientFilterBlobsOptions<'_>>) -> Result<Response<FilterBlobSegment>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&self.container_name)?;
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn get_access_policy(&self, options: Option<BlobContainerClientGetAccessPolicyOptions<'_>>) -> Result<Response<Vec<SignedIdentifier>>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&self.container_name)?;
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn get_account_info(&self, options: Option<BlobContainerClientGetAccountInfoOptions<'_>>) -> Result<Response<BlobContainerClientGetAccountInfoResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&self.container_name)?;
...
/// the container's list of blobs
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn get_properties(&self, options: Option<BlobContainerClientGetPropertiesOptions<'_>>) -> Result<Response<BlobContainerClientGetPropertiesResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&self.container_name)?;
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn list_blob_flat_segment(&self, options: Option<BlobContainerClientListBlobFlatSegmentOptions<'_>>) -> Result<Response<ListBlobsFlatSegmentResponse>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&self.container_name)?;
        url.query_pairs_mut().append_pair("comp", "list").append_key_only("flat").append_pair("restype", "container");
        if let Some(include) = options.include {
            url.query_pairs_mut().append_pair("include", &include.iter().map(|i| i.to_string()).collect::<Vec<String>>().join(","));
        }
        if let Some(marker) = options.marker {
...
/// * `options` - Optional parameters for the request.
    pub async fn list_blob_hierarchy_segment(&self, delimiter: &str, options: Option<BlobContainerClientListBlobHierarchySegmentOptions<'_>>) -> Result<Response<ListBlobsHierarchySegmentResponse>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&self.container_name)?;
        url.query_pairs_mut().append_pair("comp", "list").append_key_only("hierarchy").append_pair("restype", "container");
...
///   lease ID must match.
/// * `options` - Optional parameters for the request.
    pub async fn release_lease(&self, lease_id: &str, options: Option<BlobContainerClientReleaseLeaseOptions<'_>>) -> Result<Response<BlobContainerClientReleaseLeaseResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&self.container_name)?;
...
/// * `options` - Optional parameters for the request.
    pub async fn rename(&self, source_container_name: &str, options: Option<BlobContainerClientRenameOptions<'_>>) -> Result<Response<BlobContainerClientRenameResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&self.container_name)?;
        ...
        request.insert_header("x-ms-source-container-name", source_container_name.to_owned());
...
///   lease ID must match.
/// * `options` - Optional parameters for the request.
    pub async fn renew_lease(&self, lease_id: &str, options: Option<BlobContainerClientRenewLeaseOptions<'_>>) -> Result<Response<BlobContainerClientRenewLeaseResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&self.container_name)?;
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn restore(&self, options: Option<BlobContainerClientRestoreOptions<'_>>) -> Result<Response<BlobContainerClientRestoreResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&self.container_name)?;
...
/// * `options` - Optional parameters for the request.
    pub async fn set_access_policy(&self, container_acl: RequestContent<Vec<SignedIdentifier>>, options: Option<BlobContainerClientSetAccessPolicyOptions<'_>>) -> Result<Response<BlobContainerClientSetAccessPolicyResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&self.container_name)?;
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn set_metadata(&self, options: Option<BlobContainerClientSetMetadataOptions<'_>>) -> Result<Response<BlobContainerClientSetMetadataResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&self.container_name)?;
...
/// * `options` - Optional parameters for the request.
    pub async fn submit_batch(&self, body: RequestContent<Bytes>, content_length: u64, options: Option<BlobContainerClientSubmitBatchOptions<'_>>) -> Result<Response<BlobContainerClientSubmitBatchResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&self.container_name)?;
