...
use crate::generated::models::{
    ...
    BlobContainerClientListBlobsHierarchicalOptions, BlobContainerClientListBlobsRawOptions,
    BlobContainerClientListBlobsRawResult, BlobContainerClientListBlobsXmlOptions,
...
use azure_core::{
    ...
    http::{
        ...
        AsyncResponse, ClientOptions, Method, NoFormat, PageIterator, Pager, Pipeline,
        PipelineSendOptions, PipelineStreamOptions, RawResponse, Request, RequestContent, Response,
...
impl BlobContainerClient {
    ...
    /// ## Response Headers
    ///
    /// The returned [`AsyncResponse`](azure_core::http::AsyncResponse) implements the [`BlobContainerClientListBlobsRawResultHeaders`] trait, which provides
    /// access to response headers. For example:
    ///
    /// ```ignore
    /// use azure_core::{Result, http::AsyncResponse};
    /// use azure_storage_blob::models::{BlobContainerClientListBlobsRawResult, BlobContainerClientListBlobsRawResultHeaders};
    /// async fn example() -> Result<()> {
    ///     let response: AsyncResponse<BlobContainerClientListBlobsRawResult> = unimplemented!();
    ///     // Access response headers
    ...
    ///
    /// ### Available headers
    /// * [`content_type`()](crate::generated::models::BlobContainerClientListBlobsRawResultHeaders::content_type) - content-type
    ///
    /// [`BlobContainerClientListBlobsRawResultHeaders`]: crate::generated::models::BlobContainerClientListBlobsRawResultHeaders
    #[tracing::function("Storage.Blob.BlobContainerClient.listBlobsRaw")]
    pub(crate) async fn list_blobs_raw(
        &self,
        accept: String,
        options: Option<BlobContainerClientListBlobsRawOptions<'_>>,
    ) -> Result<AsyncResponse<BlobContainerClientListBlobsRawResult>> {
        let options = options.unwrap_or_default();
        let ctx = options.method_options.context.to_borrowed();
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
