...
/// or can be infinite
    pub async fn acquire_lease(&self, container_name: String, options: Option<BlobContainerClientAcquireLeaseOptions<'_>>) -> Result<Response<()>> {
    ...
    /// [Update] establishes and manages a lock on a container for delete operations. The lock duration can be 15 to 60 seconds,
/// or can be infinite
    pub async fn break_lease(&self, container_name: String, options: Option<BlobContainerClientBreakLeaseOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&container_name)?;
    ...
    /// [Update] establishes and manages a lock on a container for delete operations. The lock duration can be 15 to 60 seconds,
/// or can be infinite
    pub async fn change_lease(&self, container_name: String, lease_id: String, proposed_lease_id: String, options: Option<BlobContainerClientChangeLeaseOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&container_name)?;
...
/// fails.
    pub async fn create(&self, container_name: String, options: Option<BlobContainerClientCreateOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&container_name)?;
...
/// during garbage collection
    pub async fn delete(&self, container_name: String, options: Option<BlobContainerClientDeleteOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&container_name)?;
...
/// blobs searches within the given container.
    pub async fn filter_blobs(&self, container_name: String, options: Option<BlobContainerClientFilterBlobsOptions<'_>>) -> Result<Response<FilterBlobSegment>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&container_name)?;
    ...
    pub async fn get_access_policy(&self, container_name: String, options: Option<BlobContainerClientGetAccessPolicyOptions<'_>>) -> Result<Response<Vec<SignedIdentifier>>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&container_name)?;
    ...
    pub async fn get_account_info(&self, container_name: String, options: Option<BlobContainerClientGetAccountInfoOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&container_name)?;
...
/// the container's list of blobs
    pub async fn get_properties(&self, container_name: String, options: Option<BlobContainerClientGetPropertiesOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&container_name)?;
    ...
    /// [Update] establishes and manages a lock on a container for delete operations. The lock duration can be 15 to 60 seconds,
/// or can be infinite
    pub async fn release_lease(&self, container_name: String, lease_id: String, options: Option<BlobContainerClientReleaseLeaseOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&container_name)?;
    ...
    pub async fn rename(&self, container_name: String, source_container_name: String, options: Option<BlobContainerClientRenameOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&container_name)?;
    ...
    /// [Update] establishes and manages a lock on a container for delete operations. The lock duration can be 15 to 60 seconds,
/// or can be infinite
    pub async fn renew_lease(&self, container_name: String, lease_id: String, options: Option<BlobContainerClientRenewLeaseOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&container_name)?;
    ...
    pub async fn restore(&self, container_name: String, options: Option<BlobContainerClientRestoreOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&container_name)?;
...
/// publicly.
    pub async fn set_access_policy(&self, container_name: String, container_acl: RequestContent<Vec<SignedIdentifier>>, options: Option<BlobContainerClientSetAccessPolicyOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&container_name)?;
    ...
    pub async fn set_metadata(&self, container_name: String, options: Option<BlobContainerClientSetMetadataOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&container_name)?;
...
for (k, v) in &metadata {
    ...
    pub async fn submit_batch(&self, container_name: String, body: RequestContent<Vec<u8>>, content_length: i64, options: Option<BlobContainerClientSubmitBatchOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join(&container_name)?;
