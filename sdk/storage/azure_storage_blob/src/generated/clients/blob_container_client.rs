...
/// * `options` - Optional configuration for the client.
    ...
    pub fn new(endpoint: &str, credential: Arc<dyn TokenCredential>, options: Option<BlobContainerClientOptions>) -> Result<Self> {
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn acquire_lease(&self, duration: i32, options: Option<BlobContainerClientAcquireLeaseOptions<'_>>) -> Result<Response<BlobContainerClientAcquireLeaseResult, NoFormat>> {
        ...
        query_builder.append_key_only("acquire").append_pair("comp", "lease").append_pair("restype", "container");
        ...
        let rsp = self.pipeline.send(&ctx, &mut request, Some(PipelineSendOptions {
            check_success: CheckSuccessOptions{ success_codes: &[201]},
            ..Default::default()
        })).await?;
        Ok(rsp.into())
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn break_lease(&self, options: Option<BlobContainerClientBreakLeaseOptions<'_>>) -> Result<Response<BlobContainerClientBreakLeaseResult, NoFormat>> {
        ...
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_key_only("break").append_pair("comp", "lease").append_pair("restype", "container");
        if let Some(timeout) = options.timeout {
            query_builder.set_pair("timeout", timeout.to_string());
        }
        query_builder.build();
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn change_lease(&self, lease_id: String, proposed_lease_id: String, options: Option<BlobContainerClientChangeLeaseOptions<'_>>) -> Result<Response<BlobContainerClientChangeLeaseResult, NoFormat>> {
        ...
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_key_only("change").append_pair("comp", "lease").append_pair("restype", "container");
        if let Some(timeout) = options.timeout {
            query_builder.set_pair("timeout", timeout.to_string());
        }
        query_builder.build();
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn find_blobs_by_tags(&self, filter_expression: &str, options: Option<BlobContainerClientFindBlobsByTagsOptions<'_>>) -> Result<Response<FilterBlobSegment, XmlFormat>> {
        let options = options.unwrap_or_default();
        let ctx = options.method_options.context.to_borrowed();
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_pair("comp", "blobs").append_pair("restype", "container");
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn get_access_policy(&self, options: Option<BlobContainerClientGetAccessPolicyOptions<'_>>) -> Result<Response<SignedIdentifiers, XmlFormat>> {
        ...
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_pair("comp", "acl").append_pair("restype", "container");
        if let Some(timeout) = options.timeout {
            query_builder.set_pair("timeout", timeout.to_string());
        }
        query_builder.build();
...
/// * `options` - Optional parameters for the request.
    ...
    pub fn list_blob_flat_segment(&self, options: Option<BlobContainerClientListBlobFlatSegmentOptions<'_>>) -> Result<Pager<ListBlobsFlatSegmentResponse, XmlFormat, String>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut first_url = self.endpoint.clone();
        let mut query_builder = first_url.query_builder();
        query_builder.append_pair("comp", "list").append_key_only("flat").append_pair("restype", "container");
        if let Some(include) = options.include.as_ref() {
            query_builder.set_pair("include", include.iter().map(|i| i.to_string()).collect::<Vec<String>>().join(","));
        }
        if let Some(marker) = options.marker.as_ref() {
...
/// * `options` - Optional parameters for the request.
    ...
    pub fn list_blob_hierarchy_segment(&self, delimiter: &str, options: Option<BlobContainerClientListBlobHierarchySegmentOptions<'_>>) -> Result<Pager<ListBlobsHierarchySegmentResponse, XmlFormat, String>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut first_url = self.endpoint.clone();
        let mut query_builder = first_url.query_builder();
        query_builder.append_pair("comp", "list").append_key_only("hierarchy").append_pair("restype", "container");
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn release_lease(&self, lease_id: String, options: Option<BlobContainerClientReleaseLeaseOptions<'_>>) -> Result<Response<BlobContainerClientReleaseLeaseResult, NoFormat>> {
        ...
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_pair("comp", "lease").append_key_only("release").append_pair("restype", "container");
        if let Some(timeout) = options.timeout {
            query_builder.set_pair("timeout", timeout.to_string());
        }
        query_builder.build();
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn rename(&self, source_container_name: String, options: Option<BlobContainerClientRenameOptions<'_>>) -> Result<Response<(), NoFormat>> {
        let options = options.unwrap_or_default();
        let ctx = options.method_options.context.to_borrowed();
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_pair("comp", "rename").append_pair("restype", "container");
        if let Some(timeout) = options.timeout {
            query_builder.set_pair("timeout", timeout.to_string());
        }
        query_builder.build();
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn renew_lease(&self, lease_id: String, options: Option<BlobContainerClientRenewLeaseOptions<'_>>) -> Result<Response<BlobContainerClientRenewLeaseResult, NoFormat>> {
        ...
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_pair("comp", "lease").append_key_only("renew").append_pair("restype", "container");
        if let Some(timeout) = options.timeout {
            query_builder.set_pair("timeout", timeout.to_string());
        }
        query_builder.build();
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn restore(&self, options: Option<BlobContainerClientRestoreOptions<'_>>) -> Result<Response<(), NoFormat>> {
        let options = options.unwrap_or_default();
        let ctx = options.method_options.context.to_borrowed();
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_pair("comp", "undelete").append_pair("restype", "container");
        if let Some(timeout) = options.timeout {
            query_builder.set_pair("timeout", timeout.to_string());
        }
        query_builder.build();
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn set_metadata(&self, metadata: &HashMap<String, String>, options: Option<BlobContainerClientSetMetadataOptions<'_>>) -> Result<Response<(), NoFormat>> {
        ...
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_pair("comp", "metadata").append_pair("restype", "container");
        if let Some(timeout) = options.timeout {
            query_builder.set_pair("timeout", timeout.to_string());
        }
        query_builder.build();
