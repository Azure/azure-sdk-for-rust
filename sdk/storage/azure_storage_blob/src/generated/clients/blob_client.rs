...
/// * `options` - Optional configuration for the client.
    pub fn new(endpoint: &str, credential: Arc<dyn TokenCredential>, container_name: String, blob_name: String, options: Option<BlobClientOptions>) -> Result<Self> {
...
/// * `options` - Optional parameters for the request.
    pub async fn abort_copy_from_url(&self, copy_id: &str, options: Option<BlobClientAbortCopyFromUrlOptions<'_>>) -> Result<Response<BlobClientAbortCopyFromUrlResult>> {
        let options = options.unwrap_or_default();
...
/// infinite.
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn acquire_lease(&self, options: Option<BlobClientAcquireLeaseOptions<'_>>) -> Result<Response<BlobClientAcquireLeaseResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
...
/// period has expired.
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn break_lease(&self, options: Option<BlobClientBreakLeaseOptions<'_>>) -> Result<Response<BlobClientBreakLeaseResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
...
///   lease ID must match.
/// * `options` - Optional parameters for the request.
    pub async fn change_lease(&self, lease_id: &str, options: Option<BlobClientChangeLeaseOptions<'_>>) -> Result<Response<BlobClientChangeLeaseResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
...
/// * `options` - Optional parameters for the request.
    pub async fn copy_from_url(&self, copy_source: &str, options: Option<BlobClientCopyFromUrlOptions<'_>>) -> Result<Response<BlobClientCopyFromUrlResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
...
for (k, v) in &metadata {
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn create_snapshot(&self, options: Option<BlobClientCreateSnapshotOptions<'_>>) -> Result<Response<BlobClientCreateSnapshotResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
...
/// * `options` - Optional parameters for the request.
    pub async fn delete(&self, options: Option<BlobClientDeleteOptions<'_>>) -> Result<Response<()>> {
        ...
        if let Some(blob_delete_type) = options.blob_delete_type {
            url.query_pairs_mut().append_pair("deletetype", blob_delete_type.as_ref());
        }
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn delete_immutability_policy(&self, options: Option<BlobClientDeleteImmutabilityPolicyOptions<'_>>) -> Result<Response<BlobClientDeleteImmutabilityPolicyResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
...
/// * `options` - Optional parameters for the request.
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn get_account_info(&self, options: Option<BlobClientGetAccountInfoOptions<'_>>) -> Result<Response<BlobClientGetAccountInfoResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
...
/// * `options` - Optional parameters for the request.
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn get_tags(&self, options: Option<BlobClientGetTagsOptions<'_>>) -> Result<Response<BlobTags>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
...
///   lease ID must match.
/// * `options` - Optional parameters for the request.
    pub async fn release_lease(&self, lease_id: &str, options: Option<BlobClientReleaseLeaseOptions<'_>>) -> Result<Response<BlobClientReleaseLeaseResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
...
///   lease ID must match.
/// * `options` - Optional parameters for the request.
    pub async fn renew_lease(&self, lease_id: &str, options: Option<BlobClientRenewLeaseOptions<'_>>) -> Result<Response<BlobClientRenewLeaseResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
...
/// * `options` - Optional parameters for the request.
    pub async fn set_expiry(&self, expiry_options: BlobExpiryOptions, options: Option<BlobClientSetExpiryOptions<'_>>) -> Result<Response<BlobClientSetExpiryResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn set_http_headers(&self, options: Option<BlobClientSetHttpHeadersOptions<'_>>) -> Result<Response<BlobClientSetHttpHeadersResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn set_immutability_policy(&self, options: Option<BlobClientSetImmutabilityPolicyOptions<'_>>) -> Result<Response<BlobClientSetImmutabilityPolicyResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
...
/// * `options` - Optional parameters for the request.
    pub async fn set_legal_hold(&self, legal_hold: bool, options: Option<BlobClientSetLegalHoldOptions<'_>>) -> Result<Response<BlobClientSetLegalHoldResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn set_metadata(&self, options: Option<BlobClientSetMetadataOptions<'_>>) -> Result<Response<BlobClientSetMetadataResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
...
/// * `tags` - The blob tags.
/// * `options` - Optional parameters for the request.
    pub async fn set_tags(&self, tags: RequestContent<BlobTags>, options: Option<BlobClientSetTagsOptions<'_>>) -> Result<Response<BlobClientSetTagsResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
...
/// * `options` - Optional parameters for the request.
    pub async fn set_tier(&self, tier: AccessTier, options: Option<BlobClientSetTierOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
...
///   either be public or must be authenticated via a shared access signature.
/// * `options` - Optional parameters for the request.
    pub async fn start_copy_from_url(&self, copy_source: &str, options: Option<BlobClientStartCopyFromUrlOptions<'_>>) -> Result<Response<BlobClientStartCopyFromUrlResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
...
for (k, v) in &metadata {
    ...
    ///
/// * `options` - Optional parameters for the request.
    pub async fn undelete(&self, options: Option<BlobClientUndeleteOptions<'_>>) -> Result<Response<BlobClientUndeleteResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blobName}");
