...
use azure_core::{
    BearerTokenCredentialPolicy, ClientOptions, Pipeline, Policy, Result, Url,
};
...
impl BlobClient {
    ...
    pub fn get_blob_append_blob_client(&self, container_name: String, blob: String) -> BlobAppendBlobClient {
    ...
    pub fn get_blob_block_blob_client(&self, container_name: String, blob: String) -> BlobBlockBlobClient {
        BlobBlockBlobClient {
            blob,
            container_name,
            endpoint: self.endpoint.clone(),
    ...
    pub fn get_blob_page_blob_client(&self, container_name: String, blob: String) -> BlobPageBlobClient {
        BlobPageBlobClient {
            blob,
            container_name,
            endpoint: self.endpoint.clone(),
