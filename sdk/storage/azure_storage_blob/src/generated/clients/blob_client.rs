...
/// * `options` - Optional configuration for the client.
    ...
    pub fn new(endpoint: &str, credential: Arc<dyn TokenCredential>, options: Option<BlobClientOptions>) -> Result<Self> {
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn abort_copy_from_url(&self, copy_id: &str, options: Option<BlobClientAbortCopyFromUrlOptions<'_>>) -> Result<Response<(), NoFormat>> {
        let options = options.unwrap_or_default();
        let ctx = options.method_options.context.to_borrowed();
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_pair("comp", "copy").append_key_only("copyid");
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn acquire_lease(&self, duration: i32, options: Option<BlobClientAcquireLeaseOptions<'_>>) -> Result<Response<BlobClientAcquireLeaseResult, NoFormat>> {
        ...
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_key_only("acquire").append_pair("comp", "lease");
        if let Some(timeout) = options.timeout {
            query_builder.set_pair("timeout", timeout.to_string());
        }
        query_builder.build();
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn break_lease(&self, options: Option<BlobClientBreakLeaseOptions<'_>>) -> Result<Response<BlobClientBreakLeaseResult, NoFormat>> {
        ...
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_key_only("break").append_pair("comp", "lease");
        if let Some(timeout) = options.timeout {
            query_builder.set_pair("timeout", timeout.to_string());
        }
        query_builder.build();
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn change_lease(&self, lease_id: String, proposed_lease_id: String, options: Option<BlobClientChangeLeaseOptions<'_>>) -> Result<Response<BlobClientChangeLeaseResult, NoFormat>> {
        ...
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_key_only("change").append_pair("comp", "lease");
        if let Some(timeout) = options.timeout {
            query_builder.set_pair("timeout", timeout.to_string());
        }
        query_builder.build();
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn copy_from_url(&self, copy_source: String, options: Option<BlobClientCopyFromUrlOptions<'_>>) -> Result<Response<BlobClientCopyFromUrlResult, NoFormat>> {
        let options = options.unwrap_or_default();
        let ctx = options.method_options.context.to_borrowed();
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_pair("comp", "copy").append_key_only("sync");
        if let Some(timeout) = options.timeout {
            query_builder.set_pair("timeout", timeout.to_string());
        }
        query_builder.build();
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn download(&self, options: Option<BlobClientDownloadOptions<'_>>) -> Result<AsyncResponse<BlobClientDownloadResult>> {
        let options = options.unwrap_or_default();
        let ctx = options.method_options.context.to_borrowed();
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn get_account_info(&self, options: Option<BlobClientGetAccountInfoOptions<'_>>) -> Result<Response<BlobClientGetAccountInfoResult, NoFormat>> {
        ...
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_key_only("blob").append_pair("comp", "properties").append_pair("restype", "account");
        if let Some(timeout) = options.timeout {
            query_builder.set_pair("timeout", timeout.to_string());
        }
        query_builder.build();
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn release_lease(&self, lease_id: String, options: Option<BlobClientReleaseLeaseOptions<'_>>) -> Result<Response<BlobClientReleaseLeaseResult, NoFormat>> {
        ...
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_pair("comp", "lease").append_key_only("release");
        if let Some(timeout) = options.timeout {
            query_builder.set_pair("timeout", timeout.to_string());
        }
        query_builder.build();
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn renew_lease(&self, lease_id: String, options: Option<BlobClientRenewLeaseOptions<'_>>) -> Result<Response<BlobClientRenewLeaseResult, NoFormat>> {
        ...
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_pair("comp", "lease").append_key_only("renew");
        if let Some(timeout) = options.timeout {
            query_builder.set_pair("timeout", timeout.to_string());
        }
        query_builder.build();
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn set_expiry(&self, expiry_options: BlobExpiryOptions, options: Option<BlobClientSetExpiryOptions<'_>>) -> Result<Response<BlobClientSetExpiryResult, NoFormat>> {
        let options = options.unwrap_or_default();
        let ctx = options.method_options.context.to_borrowed();
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn set_properties(&self, options: Option<BlobClientSetPropertiesOptions<'_>>) -> Result<Response<(), NoFormat>> {
        ...
        let mut url = self.endpoint.clone();
        let mut query_builder = url.query_builder();
        query_builder.append_key_only("SetHTTPHeaders").append_pair("comp", "properties");
        if let Some(timeout) = options.timeout {
            query_builder.set_pair("timeout", timeout.to_string());
        }
        query_builder.build();
...
/// * `options` - Optional parameters for the request.
    ...
    pub async fn set_tier(&self, tier: AccessTier, options: Option<BlobClientSetTierOptions<'_>>) -> Result<Response<(), NoFormat>> {
        ...
        request.insert_header("x-ms-version", &self.version);
        let rsp = self.pipeline.send(&ctx, &mut request, Some(PipelineSendOptions {
            check_success: CheckSuccessOptions{ success_codes: &[200, 202]},
            ..Default::default()
        })).await?;
        Ok(rsp.into())
