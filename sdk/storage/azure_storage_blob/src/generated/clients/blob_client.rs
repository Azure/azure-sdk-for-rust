...
use crate::{
    generated::models::{
        ...
        BlobClientDownloadInternalResult, BlobClientGetAccountInfoOptions,
...
impl BlobClient {
    ...
    pub fn get_layout(
        &self,
        options: Option<BlobClientGetLayoutOptions<'_>>,
        ...
        struct BlobClientGetLayoutPage {
        ...
        Ok(PageIterator::new(
            move |marker: PagerState, pager_options| {
                ...
                Box::pin(async move {
                    ...
                    let res: BlobClientGetLayoutPage = xml::from_xml(&body)?;
