...
async fn test_find_blobs_by_tags(ctx: TestContext) -> Result<(), Box<dyn Error>> {
    ...
    create_test_blob(
        ...
        Some(BlockBlobClientUploadOptions::default().tags(HashMap::from([
    ...
    create_test_blob(
        ...
        Some(BlockBlobClientUploadOptions::default().tags(blob2_tags.clone())),
    )
    .await?;
    ...
    for _ in 0..3 {
        ...
        create_test_blob(
            ...
            Some(BlockBlobClientUploadOptions::default().tags(shared_tag.clone())),
        )
        .await?;
    }
