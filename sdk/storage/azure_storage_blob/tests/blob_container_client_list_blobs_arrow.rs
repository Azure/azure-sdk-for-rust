...
#[recorded::test]
async fn test_list_blobs_arrow(ctx: TestContext) -> Result<(), Box<dyn Error>> {
    // Recording Setup
...
#[recorded::test]
async fn test_list_blobs_populates_properties_arrow(
    ctx: TestContext,
...
#[recorded::test]
async fn test_list_blobs_end_before_arrow(ctx: TestContext) -> Result<(), Box<dyn Error>> {
    // Recording Setup
    let recording = ctx.recording();
    let container_client =
        get_container_client(recording, false, StorageAccount::Standard, None).await?;
...
#[recorded::test]
async fn test_list_blobs_stateful_properties_arrow(ctx: TestContext) -> Result<(), Box<dyn Error>> {
    // Recording Setup
    let recording = ctx.recording();
    let container_client =
...
#[recorded::test]
async fn test_list_blobs_version_properties_arrow(ctx: TestContext) -> Result<(), Box<dyn Error>> {
    // Recording Setup
    let recording = ctx.recording();
    let container_client =
...
#[recorded::test]
async fn test_list_blobs_has_versions_only_arrow(ctx: TestContext) -> Result<(), Box<dyn Error>> {
    // Recording Setup
    let recording = ctx.recording();
    let container_client =
        get_container_client(recording, true, StorageAccount::Versioned, None).await?;
...
#[recorded::test]
async fn test_list_blobs_copy_properties_arrow(ctx: TestContext) -> Result<(), Box<dyn Error>> {
    // Recording Setup
    let recording = ctx.recording();
    let container_client =
        get_container_client(recording, true, StorageAccount::Standard, None).await?;
...
async fn test_list_blobs_immutability_properties_arrow(
    ctx: TestContext,
) -> Result<(), Box<dyn Error>> {
    // Recording Setup
    let recording = ctx.recording();
...
#[recorded::test(playback)]
async fn test_list_blobs_last_accessed_on_arrow(ctx: TestContext) -> Result<(), Box<dyn Error>> {
    // Recording Setup
    let recording = ctx.recording();
    let container_client =
        get_container_client(recording, true, StorageAccount::Standard, None).await?;
...
#[recorded::test(playback)]
async fn test_list_blobs_object_replication_metadata_arrow(
    ctx: TestContext,
) -> Result<(), Box<dyn Error>> {
    // Recording Setup
    let recording = ctx.recording();
...
#[recorded::test]
async fn test_list_blobs_with_continuation_arrow(ctx: TestContext) -> Result<(), Box<dyn Error>> {
    // Recording Setup
    let recording = ctx.recording();
    let container_client =
        get_container_client(recording, false, StorageAccount::Standard, None).await?;
...
#[recorded::test]
async fn test_list_blobs_with_prefix_arrow(ctx: TestContext) -> Result<(), Box<dyn Error>> {
    // Recording Setup
    let recording = ctx.recording();
    let container_client =
        get_container_client(recording, false, StorageAccount::Standard, None).await?;
...
#[recorded::test]
async fn test_list_blobs_with_uncommitted_blobs_include_arrow(
    ctx: TestContext,
) -> Result<(), Box<dyn Error>> {
    // Recording Setup
    let recording = ctx.recording();
...
#[recorded::test]
async fn test_list_blobs_with_deleted_include_arrow(
    ctx: TestContext,
) -> Result<(), Box<dyn Error>> {
    // Recording Setup
    let recording = ctx.recording();
