...
async fn test_get_blob_properties() -> Result<(), Box<dyn Error>> {
    ...
    // )?;
    // container_client
    //     .create_container(Some(BlobContainerClientCreateOptions::default()))
    //     .await?;
    ...
    // TODO: Cleanup
    // container_client.delete_container(Some(BlobContainerClientDeleteOptions::default()));
