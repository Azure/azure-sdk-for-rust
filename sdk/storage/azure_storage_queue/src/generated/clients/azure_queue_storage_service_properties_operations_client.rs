...
use azure_core::{Result, http::{Context, Method, Pipeline, Request, RequestContent, Response, Url, }, };
use crate::generated::models::{AzureQueueStorageServicePropertiesOperationsClientSetPropertiesOptions, QueueApiVersion, ServicePropertiesCompType, ServiceRestypeType, StorageServicePropertiesRequest, };
...
/// * `options` - Optional parameters for the request.
    pub async fn set_properties(&self, restype: ServiceRestypeType, comp: ServicePropertiesCompType, version: QueueApiVersion, storage_service_properties: RequestContent<StorageServicePropertiesRequest>, options: Option<AzureQueueStorageServicePropertiesOperationsClientSetPropertiesOptions<'_>>) -> Result<Response<()>> {
        ...
        url.query_pairs_mut().append_pair("restype", restype.as_ref());
