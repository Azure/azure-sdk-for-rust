...
use crate::generated::models::{
    ...
    AzureQueueStorageMessagesOperationGroupClientPeekOptions, ListOfDequeuedMessageItem,
...
pub struct AzureQueueStorageMessagesOperationGroupClient {
    pub(crate) api_version: String,
    pub(crate) endpoint: Url,
    pub(crate) pipeline: Pipeline,
}

impl AzureQueueStorageMessagesOperationGroupClient {
