...
use crate::models::{
    CorsRule, Logging, Metrics, RetentionPolicy, StaticWebsite,
};
use serde::{
...
/// The CORS properties.
    #[serde(rename = "Cors", deserialize_with = "CorsCorsRule::unwrap", serialize_with = "CorsCorsRule::wrap", skip_serializing_if = "Option::is_none")]
