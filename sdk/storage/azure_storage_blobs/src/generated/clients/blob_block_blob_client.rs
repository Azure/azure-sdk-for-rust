...
/// to.
    pub async fn commit_block_list(&self, container_name: String, blob: String, blocks: RequestContent<BlockLookupList>, options: Option<BlobBlockBlobClientCommitBlockListOptions<'_>>) -> Result<Response<()>> {
...
for (k, v) in &metadata {
    ...
    pub async fn get_block_list(&self, container_name: String, blob: String, list_type: BlockListType, options: Option<BlobBlockBlobClientGetBlockListOptions<'_>>) -> Result<Response<BlockLookupList>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
...
/// contents using a source URL, use the Put Block from URL API in conjunction with Put Block List.
    pub async fn put_blob_from_url(&self, container_name: String, blob: String, content_length: i64, copy_source: String, options: Option<BlobBlockBlobClientPutBlobFromUrlOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
...
for (k, v) in &metadata {
    ...
    pub async fn stage_block(&self, container_name: String, blob: String, block_id: String, content_length: i64, body: RequestContent<Vec<u8>>, options: Option<BlobBlockBlobClientStageBlockOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
...
/// a URL.
    pub async fn stage_block_from_url(&self, container_name: String, blob: String, block_id: String, content_length: i64, source_url: String, options: Option<BlobBlockBlobClientStageBlockFromUrlOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
...
/// Block List operation.
    pub async fn upload(&self, container_name: String, blob: String, body: RequestContent<Vec<u8>>, content_length: i64, options: Option<BlobBlockBlobClientUploadOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
