...
impl BlobPageBlobClient {
    ...
    pub async fn clear_pages(&self, container_name: String, blob: String, content_length: i64, options: Option<BlobPageBlobClientClearPagesOptions<'_>>) -> Result<Response<()>> {
...
/// since REST version 2016-05-31.
    pub async fn copy_incremental(&self, container_name: String, blob: String, copy_source: String, options: Option<BlobPageBlobClientCopyIncrementalOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
    ...
    pub async fn create(&self, container_name: String, blob: String, content_length: i64, blob_content_length: i64, options: Option<BlobPageBlobClientCreateOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
...
for (k, v) in &metadata {
    ...
    pub async fn resize(&self, container_name: String, blob: String, blob_content_length: i64, options: Option<BlobPageBlobClientResizeOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
...
/// number is less than the current sequence number of the blob.
    pub async fn update_sequence_number(&self, container_name: String, blob: String, sequence_number_action: SequenceNumberActionType, options: Option<BlobPageBlobClientUpdateSequenceNumberOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
    ...
    pub async fn upload_pages(&self, container_name: String, blob: String, body: RequestContent<Vec<u8>>, content_length: i64, options: Option<BlobPageBlobClientUploadPagesOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
    ...
    pub async fn upload_pages_from_url(&self, container_name: String, blob: String, source_url: String, source_range: String, content_length: i64, range: String, options: Option<BlobPageBlobClientUploadPagesFromUrlOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("{containerName}/{blob}");
