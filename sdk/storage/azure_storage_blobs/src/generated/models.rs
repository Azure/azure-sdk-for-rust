...
use crate::{
    generated::xml_helpers::Blob_tag_setBlobTag, generated::xml_helpers::BlobsFilterBlobItem, generated::xml_helpers::CorsCorsRule, generated::xml_helpers::SchemaArrowField,
};
use crate::models::{
    GeoReplicationStatusType, QueryRequestType, QueryType,
};
use serde::{
...
/// The Apache Arrow schema
    #[serde(rename = "Schema", deserialize_with = "SchemaArrowField::unwrap", serialize_with = "SchemaArrowField::wrap", skip_serializing_if = "Option::is_none")]
...
/// Represents the blob tags.
    #[serde(rename = "TagSet", deserialize_with = "Blob_tag_setBlobTag::unwrap", serialize_with = "Blob_tag_setBlobTag::wrap", skip_serializing_if = "Option::is_none")]
...
/// The blob segment.
    #[serde(rename = "Blobs", deserialize_with = "BlobsFilterBlobItem::unwrap", serialize_with = "BlobsFilterBlobItem::wrap", skip_serializing_if = "Option::is_none")]
