...
pub fn content_crc64_from_headers(headers: &HeaderMap) -> Result<ConsistencyCRC64, crate::Error> {
...
pub fn content_crc64_from_headers_optional(
    headers: &HeaderMap,
) -> Result<Option<ConsistencyCRC64>, crate::Error> {
...
pub fn content_md5_from_headers(headers: &HeaderMap) -> Result<ConsistencyMD5, crate::Error> {
...
pub fn content_md5_from_headers_optional(
    headers: &HeaderMap,
) -> Result<Option<ConsistencyMD5>, crate::Error> {
