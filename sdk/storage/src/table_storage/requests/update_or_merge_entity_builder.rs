...
use crate::table_storage::responses::*;
use crate::table_storage::IfMatchCondition;
use crate::table_storage::TransactionOperation;
        ...
        E: Serialize,
    {
        ...
        let request = self.entity_client.prepare_request(
            ...
            match self.operation {
                Operation::Merge => &crate::table_storage::MERGE,
