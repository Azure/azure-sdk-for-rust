...
/// This operation requires the secrets/backup permission.
    pub async fn backup_secret(&self, secret_name: String, options: Option<SecretClientBackupSecretOptions<'_>>) -> Result<Response<BackupSecretResult>> {
        let options = options.unwrap_or_default();
...
/// of a secret. This operation requires the secrets/delete permission.
    pub async fn delete_secret(&self, secret_name: String, options: Option<SecretClientDeleteSecretOptions<'_>>) -> Result<Response<DeletedSecretBundle>> {
        let options = options.unwrap_or_default();
        let mut ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// the secrets/get permission.
    pub async fn get_deleted_secret(&self, secret_name: String, options: Option<SecretClientGetDeletedSecretOptions<'_>>) -> Result<Response<DeletedSecretBundle>> {
        let options = options.unwrap_or_default();
        let mut ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// operation requires the secrets/list permission.
    pub fn get_deleted_secrets(&self, options: Option<SecretClientGetDeletedSecretsOptions<'_>>) -> Result<Pager<DeletedSecretListResult>> {
...
/// The GET operation is applicable to any secret stored in Azure Key Vault. This operation requires the secrets/get permission.
    pub async fn get_secret(&self, secret_name: String, secret_version: String, options: Option<SecretClientGetSecretOptions<'_>>) -> Result<Response<SecretBundle>> {
        let options = options.unwrap_or_default();
        let mut ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// requires the secrets/list permission.
    pub fn get_secret_versions(&self, secret_name: String, options: Option<SecretClientGetSecretVersionsOptions<'_>>) -> Result<Pager<SecretListResult>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut first_url = self.endpoint.clone();
...
/// permission.
    pub fn get_secrets(&self, options: Option<SecretClientGetSecretsOptions<'_>>) -> Result<Pager<SecretListResult>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut first_url = self.endpoint.clone();
...
/// can only be enabled on a soft-delete enabled vault. This operation requires the secrets/purge permission.
    pub async fn purge_deleted_secret(&self, secret_name: String, options: Option<SecretClientPurgeDeletedSecretOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let mut ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("deletedsecrets/{secret-name}");
...
/// This operation requires the secrets/recover permission.
    pub async fn recover_deleted_secret(&self, secret_name: String, options: Option<SecretClientRecoverDeletedSecretOptions<'_>>) -> Result<Response<SecretBundle>> {
        let options = options.unwrap_or_default();
        let mut ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// Restores a backed up secret, and all its versions, to a vault. This operation requires the secrets/restore permission.
    pub async fn restore_secret(&self, parameters: RequestContent<SecretRestoreParameters>, options: Option<SecretClientRestoreSecretOptions<'_>>) -> Result<Response<SecretBundle>> {
        let options = options.unwrap_or_default();
        let mut ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// new version of that secret. This operation requires the secrets/set permission.
    pub async fn set_secret(&self, secret_name: String, parameters: RequestContent<SecretSetParameters>, options: Option<SecretClientSetSecretOptions<'_>>) -> Result<Response<SecretBundle>> {
        let options = options.unwrap_or_default();
        let mut ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("secrets/{secret-name}");
...
/// request are left unchanged. The value of a secret itself cannot be changed. This operation requires the secrets/set permission.
    pub async fn update_secret(&self, secret_name: String, secret_version: String, parameters: RequestContent<SecretUpdateParameters>, options: Option<SecretClientUpdateSecretOptions<'_>>) -> Result<Response<SecretBundle>> {
        let options = options.unwrap_or_default();
        let mut ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("secrets/{secret-name}/{secret-version}");
