...
use crate::generated::models::{
    BackupKeyResult, DeletedKeyBundle, DeletedKeyListResult, GetRandomBytesRequest, KeyBundle,
    ...
    KeyClientGetKeyAttestationOptions, KeyClientGetKeyOptions,
    KeyClientGetKeyRotationPolicyOptions, KeyClientGetRandomBytesOptions,
    KeyClientImportKeyOptions, KeyClientListDeletedKeysOptions, KeyClientListKeyVersionsOptions,
    KeyClientListKeysOptions, KeyClientPurgeDeletedKeyOptions, KeyClientRecoverDeletedKeyOptions,
    ...
    KeyCreateParameters, KeyImportParameters, KeyListResult, KeyOperationResult,
    KeyOperationsParameters, KeyReleaseParameters, KeyReleaseResult, KeyRestoreParameters,
...
impl KeyClient {
    ...
    pub async fn decrypt(
        ...
        key_name: &str,
        key_version: &str,
        parameters: RequestContent<KeyOperationsParameters>,
    ...
    ) -> Result<Response<DeletedKeyBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub async fn import_key(
        &self,
        key_name: &str,
        parameters: RequestContent<KeyImportParameters>,
    ...
    ///
    /// * `options` - Optional parameters for the request.
    pub fn list_deleted_keys(
        &self,
        options: Option<KeyClientListDeletedKeysOptions<'_>>,
    ) -> Result<Pager<DeletedKeyListResult>> {
    ...
    pub fn list_key_versions(
        &self,
        key_name: &str,
        options: Option<KeyClientListKeyVersionsOptions<'_>>,
    ...
    pub fn list_keys(
        &self,
        options: Option<KeyClientListKeysOptions<'_>>,
    ) -> Result<Pager<KeyListResult>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut first_url = self.endpoint.clone();
    ...
    pub async fn release(
        ...
        key_name: &str,
        key_version: &str,
        parameters: RequestContent<KeyReleaseParameters>,
    ...
    pub async fn sign(
        ...
        key_name: &str,
        key_version: &str,
        parameters: RequestContent<KeySignParameters>,
    ...
    pub async fn update_key(
        ...
        key_name: &str,
        key_version: &str,
        parameters: RequestContent<KeyUpdateParameters>,
    ...
    pub async fn verify(
        ...
        key_name: &str,
        key_version: &str,
        parameters: RequestContent<KeyVerifyParameters>,
