...
/// Key Vault creates a new version of the key. It requires the keys/create permission.
    pub async fn create_key(&self, key_name: &str, parameters: RequestContent<KeyCreateParameters>, options: Option<KeyClientCreateKeyOptions<'_>>) -> Result<Response<KeyBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// for more information.
    pub async fn decrypt(&self, key_name: &str, key_version: &str, parameters: RequestContent<KeyOperationsParameters>, options: Option<KeyClientDecryptOptions<'_>>) -> Result<Response<KeyOperationResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// This operation requires the keys/delete permission.
    pub async fn delete_key(&self, key_name: &str, options: Option<KeyClientDeleteKeyOptions<'_>>) -> Result<Response<DeletedKeyBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// public key material. This operation requires the keys/encrypt permission.
    pub async fn encrypt(&self, key_name: &str, key_version: &str, parameters: RequestContent<KeyOperationsParameters>, options: Option<KeyClientEncryptOptions<'_>>) -> Result<Response<KeyOperationResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// vault, it will return an error if invoked on a non soft-delete enabled vault. This operation requires the keys/get permission.
    pub async fn get_deleted_key(&self, key_name: &str, options: Option<KeyClientGetDeletedKeyOptions<'_>>) -> Result<Response<DeletedKeyBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// enabled vault. This operation requires the keys/list permission.
    pub fn get_deleted_keys(&self, options: Option<KeyClientGetDeletedKeysOptions<'_>>) -> Result<Pager<DeletedKeyListResult>> {
...
/// in the response. This operation requires the keys/get permission.
    pub async fn get_key(&self, key_name: &str, key_version: &str, options: Option<KeyClientGetKeyOptions<'_>>) -> Result<Response<KeyBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// The full key identifier, attributes, and tags are provided in the response. This operation requires the keys/list permission.
    pub fn get_key_versions(&self, key_name: &str, options: Option<KeyClientGetKeyVersionsOptions<'_>>) -> Result<Pager<KeyListResult>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut first_url = self.endpoint.clone();
...
/// in the response. Individual versions of a key are not listed in the response. This operation requires the keys/list permission.
    pub fn get_keys(&self, options: Option<KeyClientGetKeysOptions<'_>>) -> Result<Pager<KeyListResult>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut first_url = self.endpoint.clone();
...
/// Get the requested number of bytes containing random values from a managed HSM.
    pub async fn get_random_bytes(&self, parameters: RequestContent<GetRandomBytesRequest>, options: Option<KeyClientGetRandomBytesOptions<'_>>) -> Result<Response<RandomBytes>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        url = url.join("rng")?;
...
/// Azure Key Vault creates a new version of the key. This operation requires the keys/import permission.
    pub async fn import_key(&self, key_name: &str, parameters: RequestContent<KeyImportParameters>, options: Option<KeyClientImportKeyOptions<'_>>) -> Result<Response<KeyBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("keys/{key-name}");
...
/// vault, it will return an error if invoked on a non soft-delete enabled vault. This operation requires the keys/purge permission.
    pub async fn purge_deleted_key(&self, key_name: &str, options: Option<KeyClientPurgeDeletedKeyOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("deletedkeys/{key-name}");
...
/// the inverse of the delete operation on soft-delete enabled vaults. This operation requires the keys/recover permission.
    pub async fn recover_deleted_key(&self, key_name: &str, options: Option<KeyClientRecoverDeletedKeyOptions<'_>>) -> Result<Response<KeyBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// the keys/release permission.
    pub async fn release(&self, key_name: &str, key_version: &str, parameters: RequestContent<KeyReleaseParameters>, options: Option<KeyClientReleaseOptions<'_>>) -> Result<Response<KeyReleaseResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// in the target Key Vault. This operation requires the keys/restore permission.
    pub async fn restore_key(&self, parameters: RequestContent<KeyRestoreParameters>, options: Option<KeyClientRestoreKeyOptions<'_>>) -> Result<Response<KeyBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// The operation will rotate the key based on the key policy. It requires the keys/rotate permission.
    pub async fn rotate_key(&self, key_name: &str, options: Option<KeyClientRotateKeyOptions<'_>>) -> Result<Response<KeyBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// the private portion of the key. This operation requires the keys/sign permission.
    pub async fn sign(&self, key_name: &str, key_version: &str, parameters: RequestContent<KeySignParameters>, options: Option<KeyClientSignOptions<'_>>) -> Result<Response<KeyOperationResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// since it uses the private portion of the key. This operation requires the keys/unwrapKey permission.
    pub async fn unwrap_key(&self, key_name: &str, key_version: &str, parameters: RequestContent<KeyOperationsParameters>, options: Option<KeyClientUnwrapKeyOptions<'_>>) -> Result<Response<KeyOperationResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// key itself cannot be changed. This operation requires the keys/update permission.
    pub async fn update_key(&self, key_name: &str, key_version: &str, parameters: RequestContent<KeyUpdateParameters>, options: Option<KeyClientUpdateKeyOptions<'_>>) -> Result<Response<KeyBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("keys/{key-name}/{key-version}");
...
/// This operation requires the keys/verify permission.
    pub async fn verify(&self, key_name: &str, key_version: &str, parameters: RequestContent<KeyVerifyParameters>, options: Option<KeyClientVerifyOptions<'_>>) -> Result<Response<KeyVerifyResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
...
/// requires the keys/wrapKey permission.
    pub async fn wrap_key(&self, key_name: &str, key_version: &str, parameters: RequestContent<KeyOperationsParameters>, options: Option<KeyClientWrapKeyOptions<'_>>) -> Result<Response<KeyOperationResult>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
