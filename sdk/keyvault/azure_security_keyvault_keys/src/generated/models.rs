...
use crate::models::{
    DeletionRecoveryLevel, JsonWebKeyCurveName, JsonWebKeyEncryptionAlgorithm, JsonWebKeyOperation, JsonWebKeySignatureAlgorithm, JsonWebKeyType, KeyEncryptionAlgorithm, KeyRotationPolicyAction,
};
use serde::{
...
/// A response message containing a list of deleted keys in the key vault along with a link to the next page of deleted keys.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub value: Option<Vec<DeletedKeyItem>>,
...
/// Protected Key, used with 'Bring Your Own Key'.
    #[serde(default, deserialize_with = "base64::deserialize_url_safe", rename = "key_hsm", serialize_with = "base64::serialize_url_safe", skip_serializing_if = "Option::is_none")]
    pub t: Option<Vec<u8>>,
...
/// Additional data to authenticate but not encrypt/decrypt when using authenticated crypto algorithms.
    #[serde(default, deserialize_with = "base64::deserialize_url_safe", rename = "aad", serialize_with = "base64::serialize_url_safe", skip_serializing_if = "Option::is_none")]
    pub additional_authenticated_data: Option<Vec<u8>>,

/// The tag to authenticate when performing decryption with an authenticated algorithm.
    #[serde(default, deserialize_with = "base64::deserialize_url_safe", rename = "tag", serialize_with = "base64::serialize_url_safe", skip_serializing_if = "Option::is_none")]
...
/// Blob encoding the policy rules under which the key can be released. Blob must be base64 URL encoded.
    #[serde(default, deserialize_with = "base64::deserialize_url_safe", rename = "data", serialize_with = "base64::serialize_url_safe", skip_serializing_if = "Option::is_none")]
