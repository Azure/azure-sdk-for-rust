...
use super::{
    CurveName, DeletionRecoveryLevel, EncryptionAlgorithm, JsonWebKeyWrapAlgorithm,
    KeyEncryptionAlgorithm, KeyOperation, KeyRotationPolicyAction, KeyType, SignatureAlgorithm,
};
...
pub struct SecureKeyOperationResult {
    ...
    #[serde(rename = "alg", skip_serializing_if = "Option::is_none")]
    pub algorithm: Option<JsonWebKeyWrapAlgorithm>,
