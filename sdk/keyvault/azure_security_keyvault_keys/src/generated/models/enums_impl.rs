...
impl<'a> From<&'a JsonWebKeyWrapAlgorithm> for &'a str {
    fn from(e: &'a JsonWebKeyWrapAlgorithm) -> Self {
        match e {
            JsonWebKeyWrapAlgorithm::A128Kw => "A128KW",
            JsonWebKeyWrapAlgorithm::A128Kwpad => "A128KWPAD",
            JsonWebKeyWrapAlgorithm::A192Kw => "A192KW",
            JsonWebKeyWrapAlgorithm::A192Kwpad => "A192KWPAD",
            JsonWebKeyWrapAlgorithm::A256Kw => "A256KW",
            JsonWebKeyWrapAlgorithm::A256Kwpad => "A256KWPAD",
            JsonWebKeyWrapAlgorithm::CkmAesKeyWrap => "CKM_AES_KEY_WRAP",
            JsonWebKeyWrapAlgorithm::CkmAesKeyWrapPad => "CKM_AES_KEY_WRAP_PAD",
            JsonWebKeyWrapAlgorithm::RsaOaep256 => "RSA-OAEP-256",
            JsonWebKeyWrapAlgorithm::UnknownValue(s) => s.as_ref(),
        }
    }
}

impl FromStr for JsonWebKeyWrapAlgorithm {
    type Err = Infallible;
    fn from_str(s: &str) -> ::core::result::Result<Self, <Self as FromStr>::Err> {
        Ok(match s {
            "A128KW" => JsonWebKeyWrapAlgorithm::A128Kw,
            "A128KWPAD" => JsonWebKeyWrapAlgorithm::A128Kwpad,
            "A192KW" => JsonWebKeyWrapAlgorithm::A192Kw,
            "A192KWPAD" => JsonWebKeyWrapAlgorithm::A192Kwpad,
            "A256KW" => JsonWebKeyWrapAlgorithm::A256Kw,
            "A256KWPAD" => JsonWebKeyWrapAlgorithm::A256Kwpad,
            "CKM_AES_KEY_WRAP" => JsonWebKeyWrapAlgorithm::CkmAesKeyWrap,
            "CKM_AES_KEY_WRAP_PAD" => JsonWebKeyWrapAlgorithm::CkmAesKeyWrapPad,
            "RSA-OAEP-256" => JsonWebKeyWrapAlgorithm::RsaOaep256,
            _ => JsonWebKeyWrapAlgorithm::UnknownValue(s.to_string()),
        })
    }
}

impl AsRef<str> for JsonWebKeyWrapAlgorithm {
    fn as_ref(&self) -> &str {
        match self {
            JsonWebKeyWrapAlgorithm::A128Kw => "A128KW",
            JsonWebKeyWrapAlgorithm::A128Kwpad => "A128KWPAD",
            ...
            JsonWebKeyWrapAlgorithm::CkmAesKeyWrapPad => "CKM_AES_KEY_WRAP_PAD",
            JsonWebKeyWrapAlgorithm::RsaOaep256 => "RSA-OAEP-256",
            JsonWebKeyWrapAlgorithm::UnknownValue(s) => s.as_str(),
        }
    }
}

impl Display for JsonWebKeyWrapAlgorithm {
    fn fmt(&self, f: &mut Formatter<'_>) -> ::std::fmt::Result {
        match self {
            JsonWebKeyWrapAlgorithm::A128Kw => f.write_str("A128KW"),
            JsonWebKeyWrapAlgorithm::A128Kwpad => f.write_str("A128KWPAD"),
            JsonWebKeyWrapAlgorithm::A192Kw => f.write_str("A192KW"),
            JsonWebKeyWrapAlgorithm::A192Kwpad => f.write_str("A192KWPAD"),
            JsonWebKeyWrapAlgorithm::A256Kw => f.write_str("A256KW"),
            JsonWebKeyWrapAlgorithm::A256Kwpad => f.write_str("A256KWPAD"),
            JsonWebKeyWrapAlgorithm::CkmAesKeyWrap => f.write_str("CKM_AES_KEY_WRAP"),
            JsonWebKeyWrapAlgorithm::CkmAesKeyWrapPad => f.write_str("CKM_AES_KEY_WRAP_PAD"),
            JsonWebKeyWrapAlgorithm::RsaOaep256 => f.write_str("RSA-OAEP-256"),
            JsonWebKeyWrapAlgorithm::UnknownValue(s) => f.write_str(s.as_str()),
        }
    }
}
