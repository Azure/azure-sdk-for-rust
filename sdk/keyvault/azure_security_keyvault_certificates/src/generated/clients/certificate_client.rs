...
use crate::generated::models::{
    BackupCertificateResult, CertificateBundle, CertificateClientBackupCertificateOptions,
    CertificateClientCreateCertificateOptions, CertificateClientDeleteCertificateContactsOptions,
    CertificateClientDeleteCertificateIssuerOptions,
    CertificateClientDeleteCertificateOperationOptions, CertificateClientDeleteCertificateOptions,
    CertificateClientGetCertificateContactsOptions, CertificateClientGetCertificateIssuerOptions,
    CertificateClientGetCertificateOperationOptions, CertificateClientGetCertificateOptions,
    CertificateClientGetCertificatePolicyOptions, CertificateClientGetDeletedCertificateOptions,
    CertificateClientImportCertificateOptions, CertificateClientListCertificateIssuersOptions,
    CertificateClientListCertificateVersionsOptions, CertificateClientListCertificatesOptions,
    CertificateClientListDeletedCertificatesOptions, CertificateClientMergeCertificateOptions,
    ...
    CertificateClientSetCertificateContactsOptions, CertificateClientSetCertificateIssuerOptions,
    CertificateClientUpdateCertificateIssuerOptions,
    CertificateClientUpdateCertificateOperationOptions, CertificateClientUpdateCertificateOptions,
    CertificateClientUpdateCertificatePolicyOptions, CertificateCreateParameters,
    CertificateImportParameters, CertificateIssuerListResult, CertificateIssuerSetParameters,
    CertificateIssuerUpdateParameters, CertificateListResult, CertificateMergeParameters,
    CertificateOperation, CertificateOperationUpdateParameter, CertificatePolicy,
    CertificateRestoreParameters, CertificateUpdateParameters, Contacts, DeletedCertificateBundle,
    DeletedCertificateListResult, IssuerBundle,
};
use azure_core::{
...
impl CertificateClient {
    ...
    pub async fn create_certificate(
        &self,
        certificate_name: &str,
        parameters: RequestContent<CertificateCreateParameters>,
    ...
    ) -> Result<Response<DeletedCertificateBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub async fn delete_certificate_contacts(
        &self,
        options: Option<CertificateClientDeleteCertificateContactsOptions<'_>>,
    ...
    pub async fn delete_certificate_issuer(
        &self,
        issuer_name: &str,
        options: Option<CertificateClientDeleteCertificateIssuerOptions<'_>>,
    ) -> Result<Response<IssuerBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    ) -> Result<Response<CertificateBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub async fn get_certificate_contacts(
        &self,
        options: Option<CertificateClientGetCertificateContactsOptions<'_>>,
    ) -> Result<Response<Contacts>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub async fn get_certificate_issuer(
        &self,
        issuer_name: &str,
        options: Option<CertificateClientGetCertificateIssuerOptions<'_>>,
    ) -> Result<Response<IssuerBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub async fn import_certificate(
        &self,
        certificate_name: &str,
        parameters: RequestContent<CertificateImportParameters>,
    ...
    ///
    /// * `options` - Optional parameters for the request.
    pub fn list_certificate_issuers(
        &self,
        options: Option<CertificateClientListCertificateIssuersOptions<'_>>,
    ) -> Result<Pager<CertificateIssuerListResult>> {
        ...
        Ok(Pager::from_callback(move |next_link: Option<Url>| {
            ...
            async move {
                let rsp: Response<CertificateIssuerListResult> =
                    pipeline.send(&ctx, &mut request).await?;
                let (status, headers, body) = rsp.deconstruct();
                let bytes = body.collect().await?;
                let res: CertificateIssuerListResult = json::from_json(bytes.clone())?;
    ...
    /// * `certificate_name` - The name of the certificate.
    /// * `options` - Optional parameters for the request.
    pub fn list_certificate_versions(
        &self,
        certificate_name: &str,
        options: Option<CertificateClientListCertificateVersionsOptions<'_>>,
    ) -> Result<Pager<CertificateListResult>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut first_url = self.endpoint.clone();
        ...
        Ok(Pager::from_callback(move |next_link: Option<Url>| {
            ...
            let pipeline = pipeline.clone();
            async move {
                let rsp: Response<CertificateListResult> =
                    pipeline.send(&ctx, &mut request).await?;
                let (status, headers, body) = rsp.deconstruct();
                let bytes = body.collect().await?;
                let res: CertificateListResult = json::from_json(bytes.clone())?;
                let rsp = Response::from_bytes(status, headers, bytes);
                Ok(match res.next_link {
                    Some(next_link) => PagerResult::Continue {
                        response: rsp,
    ...
    pub fn list_certificates(
        &self,
        options: Option<CertificateClientListCertificatesOptions<'_>>,
    ) -> Result<Pager<CertificateListResult>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut first_url = self.endpoint.clone();
    ...
    ///
    /// * `options` - Optional parameters for the request.
    pub fn list_deleted_certificates(
        &self,
        options: Option<CertificateClientListDeletedCertificatesOptions<'_>>,
    ) -> Result<Pager<DeletedCertificateListResult>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut first_url = self.endpoint.clone();
        ...
        Ok(Pager::from_callback(move |next_link: Option<Url>| {
            ...
            let pipeline = pipeline.clone();
            async move {
                let rsp: Response<DeletedCertificateListResult> =
                    pipeline.send(&ctx, &mut request).await?;
                let (status, headers, body) = rsp.deconstruct();
                let bytes = body.collect().await?;
                let res: DeletedCertificateListResult = json::from_json(bytes.clone())?;
                let rsp = Response::from_bytes(status, headers, bytes);
                Ok(match res.next_link {
                    Some(next_link) => PagerResult::Continue {
                        response: rsp,
    ...
    pub async fn merge_certificate(
        &self,
        certificate_name: &str,
        parameters: RequestContent<CertificateMergeParameters>,
    ...
    pub async fn restore_certificate(
        &self,
        parameters: RequestContent<CertificateRestoreParameters>,
    ...
    pub async fn set_certificate_contacts(
        ...
        options: Option<CertificateClientSetCertificateContactsOptions<'_>>,
    ) -> Result<Response<Contacts>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub async fn set_certificate_issuer(
        &self,
        issuer_name: &str,
        parameter: RequestContent<CertificateIssuerSetParameters>,
        options: Option<CertificateClientSetCertificateIssuerOptions<'_>>,
    ) -> Result<Response<IssuerBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub async fn update_certificate(
        ...
        certificate_name: &str,
        certificate_version: &str,
        parameters: RequestContent<CertificateUpdateParameters>,
    ...
    pub async fn update_certificate_issuer(
        &self,
        issuer_name: &str,
        parameter: RequestContent<CertificateIssuerUpdateParameters>,
        options: Option<CertificateClientUpdateCertificateIssuerOptions<'_>>,
    ) -> Result<Response<IssuerBundle>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub async fn update_certificate_operation(
        &self,
        certificate_name: &str,
        certificate_operation: RequestContent<CertificateOperationUpdateParameter>,
