...
impl CertificateClientGetCertificateOperationOptions<'_> {
    pub fn into_owned(self) -> CertificateClientGetCertificateOperationOptions<'static> {
        CertificateClientGetCertificateOperationOptions {
            method_options: ClientMethodOptions {
                context: self.method_options.context.into_owned(),
            },
            poller_options: self.poller_options,
