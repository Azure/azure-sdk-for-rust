...
use super::{
    models_serde, CertificatePolicyAction, DeletionRecoveryLevel, JsonWebKeyCurveName,
    JsonWebKeyType, KeyUsageType,
};
...
pub struct CertificateRestoreParameters {
    ...
    pub certificate_bundle_backup: Option<Vec<u8>>,
}
...
pub struct KeyProperties {
    ...
    pub key_type: Option<JsonWebKeyType>,
