...
impl CheckpointStore for InMemoryCheckpointStore {
    async fn claim_ownership(
        ...
        #[allow(unused_variables)] options: Option<ClaimOwnershipOptions>,
    ...
    async fn list_checkpoints(
        ...
        event_hub_name: &str,
        consumer_group: &str,
        #[allow(unused_variables)] options: Option<ListCheckpointsOptions>,
        ...
        let prefix = checkpoint.get_checkpoint_blob_prefix_name();
    ...
    async fn list_ownerships(
        ...
        event_hub_name: &str,
        consumer_group: &str,
        #[allow(unused_variables)] options: Option<ListOwnershipOptions>,
    ) -> Result<Vec<Ownership>> {
        ...
        let prefix = ownership.get_ownership_prefix_name();
    ...
    async fn update_checkpoint(&self, checkpoint: Checkpoint) -> Result<()> {
        ...
        store.insert(checkpoint.get_checkpoint_blob_name(), checkpoint);
        Ok(())
    }
}
