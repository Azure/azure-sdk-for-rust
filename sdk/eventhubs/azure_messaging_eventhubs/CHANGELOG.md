...
- `ProducerClient::close` now stops the authorization refresh task, so repeated producer lifecycles release task-held memory. ([#4595](https://github.com/Azure/azure-sdk-for-rust/issues/4595))
