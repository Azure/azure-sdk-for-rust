...
- Significant modifications to API surface to improve conformance to Azure RUST guidelines - APIs which take ownership of a string consume `String` parameter instead of borrowing a `&str` parameter.
