...
use crate::{core::transport_event_batch::TransportEventBatch, Event, producer::create_batch_options::CreateBatchOptions};
    ...
    fn try_add(
        ...
        let new_size = if self.messages.is_empty() {
            ...
            let reserve_overhead_envelope =
                match build_amqp_batch_from_messages(reservce_overhead_message, self.options.partition_key.clone()) {
