...
use crate::generated::models::{
    AVSCloudLinksClientCreateOrUpdateOperationStatus, AVSCloudLinksClientCreateOrUpdateOptions,
    AVSCloudLinksClientDeleteOperationStatus, AVSCloudLinksClientDeleteOptions,
    AVSCloudLinksClientGetOptions, AVSCloudLinksClientListOptions, CloudLink, CloudLinkList,
};
use azure_core::{
...
impl AVSCloudLinksClient {
    ...
    /// * `cloud_link_name` - Name of the cloud link.
    /// * `cloud_link` - Resource create parameters.
    /// * `options` - Optional parameters for the request.
    ///
    /// ## Response Headers
    ///
    /// The returned [`Response`](azure_core::http::Response) implements the [`AVSCloudLinksClientCreateOrUpdateOperationStatusHeaders`] trait, which provides
    ...
    ///
    /// ### Available headers
    /// * [`retry_after`()](crate::generated::models::AVSCloudLinksClientCreateOrUpdateOperationStatusHeaders::retry_after) - retry-after
    ///
    /// [`AVSCloudLinksClientCreateOrUpdateOperationStatusHeaders`]: crate::generated::models::AVSCloudLinksClientCreateOrUpdateOperationStatusHeaders
    #[tracing::function("Microsoft.AVS.CloudLinks.createOrUpdate")]
    ...
    ) -> Result<Poller<AVSCloudLinksClientCreateOrUpdateOperationStatus>> {
            ...
            move |poller_state: PollerState, poller_options| {
                let (mut request, continuation) = match poller_state {
                    ...
                    PollerState::Initial => {
                        ...
                        request.insert_header("accept", "application/json");
                        request.insert_header("content-type", "application/json");
                        request.set_body(cloud_link.clone());
                        (
                            request,
                            PollerContinuation::Links {
                                next_link: url.clone(),
                ...
                Box::pin(async move {
                    ...
                    let res: AVSCloudLinksClientCreateOrUpdateOperationStatus =
                        json::from_json(&body)?;
    ...
    /// ## Response Headers
    ///
    /// The returned [`Response`](azure_core::http::Response) implements the [`AVSCloudLinksClientDeleteOperationStatusHeaders`] trait, which provides
    /// access to response headers. For example:
    ///
    /// ```no_run
    /// use azure_core::{Result, http::Response};
    ...
    ///
    /// ### Available headers
    /// * [`location`()](crate::generated::models::AVSCloudLinksClientDeleteOperationStatusHeaders::location) - location
    /// * [`retry_after`()](crate::generated::models::AVSCloudLinksClientDeleteOperationStatusHeaders::retry_after) - retry-after
    ///
    /// [`AVSCloudLinksClientDeleteOperationStatusHeaders`]: crate::generated::models::AVSCloudLinksClientDeleteOperationStatusHeaders
    #[tracing::function("Microsoft.AVS.CloudLinks.delete")]
    pub fn delete(
        &self,
        resource_group_name: &str,
        private_cloud_name: &str,
    ...
    ) -> Result<Poller<AVSCloudLinksClientDeleteOperationStatus>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut url = self.endpoint.clone();
        let mut path = String::from("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/cloudLinks/{cloudLinkName}");
        ...
        Ok(Poller::new(
            move |poller_state: PollerState, poller_options| {
                ...
                Box::pin(async move {
                    ...
                    let res: AVSCloudLinksClientDeleteOperationStatus = json::from_json(&body)?;
    ...
    /// * `cloud_link_name` - Name of the cloud link.
    /// * `options` - Optional parameters for the request.
    #[tracing::function("Microsoft.AVS.CloudLinks.get")]
    pub async fn get(
        &self,
        resource_group_name: &str,
        private_cloud_name: &str,
        ...
        if cloud_link_name.is_empty() {
            return Err(azure_core::Error::with_message(
                azure_core::error::ErrorKind::Other,
                "parameter cloud_link_name cannot be empty",
            ));
        }
    ...
    /// * `private_cloud_name` - Name of the private cloud
    /// * `options` - Optional parameters for the request.
    #[tracing::function("Microsoft.AVS.CloudLinks.list")]
    pub fn list(
        &self,
        resource_group_name: &str,
        private_cloud_name: &str,
                ...
                Box::pin({
                    ...
                    async move {
                        let rsp = pipeline
                            ...
                            .await?;
                        let (status, headers, body) = rsp.deconstruct();
                        let res: CloudLinkList = json::from_json(&body)?;
                        let rsp = RawResponse::from_bytes(status, headers, body).into();
