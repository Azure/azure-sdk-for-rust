...
use crate::generated::models::{
    ...
    AVSScriptExecutionsClientCreateOrUpdateOptions, AVSScriptExecutionsClientDeleteOperationStatus,
    AVSScriptExecutionsClientDeleteOptions, AVSScriptExecutionsClientGetExecutionLogsOptions,
    AVSScriptExecutionsClientGetOptions, AVSScriptExecutionsClientListOptions, ScriptExecution,
...
impl AVSScriptExecutionsClient {
    ...
    /// * `script_execution_name` - Name of the script cmdlet.
    /// * `script_execution` - Resource create parameters.
    /// * `options` - Optional parameters for the request.
    ///
    /// ## Response Headers
    ///
    /// The returned [`Response`](azure_core::http::Response) implements the [`AVSScriptExecutionsClientCreateOrUpdateOperationStatusHeaders`] trait, which provides
    ...
    ///
    /// ### Available headers
    /// * [`retry_after`()](crate::generated::models::AVSScriptExecutionsClientCreateOrUpdateOperationStatusHeaders::retry_after) - retry-after
    ///
    /// [`AVSScriptExecutionsClientCreateOrUpdateOperationStatusHeaders`]: crate::generated::models::AVSScriptExecutionsClientCreateOrUpdateOperationStatusHeaders
    #[tracing::function("Microsoft.AVS.ScriptExecutions.createOrUpdate")]
    ...
    ) -> Result<Poller<AVSScriptExecutionsClientCreateOrUpdateOperationStatus>> {
            ...
            move |poller_state: PollerState, poller_options| {
                let (mut request, continuation) = match poller_state {
                    ...
                    PollerState::Initial => {
                        ...
                        request.insert_header("accept", "application/json");
                        request.insert_header("content-type", "application/json");
                        request.set_body(script_execution.clone());
                        (
                            request,
                            PollerContinuation::Links {
                                next_link: url.clone(),
                ...
                Box::pin(async move {
                    ...
                    let res: AVSScriptExecutionsClientCreateOrUpdateOperationStatus =
                        json::from_json(&body)?;
    ...
    /// ## Response Headers
    ///
    /// The returned [`Response`](azure_core::http::Response) implements the [`AVSScriptExecutionsClientDeleteOperationStatusHeaders`] trait, which provides
    /// access to response headers. For example:
    ///
    /// ```no_run
    /// use azure_core::{Result, http::Response};
    ...
    ///
    /// ### Available headers
    /// * [`location`()](crate::generated::models::AVSScriptExecutionsClientDeleteOperationStatusHeaders::location) - location
    /// * [`retry_after`()](crate::generated::models::AVSScriptExecutionsClientDeleteOperationStatusHeaders::retry_after) - retry-after
    ///
    /// [`AVSScriptExecutionsClientDeleteOperationStatusHeaders`]: crate::generated::models::AVSScriptExecutionsClientDeleteOperationStatusHeaders
    #[tracing::function("Microsoft.AVS.ScriptExecutions.delete")]
    pub fn delete(
        &self,
        resource_group_name: &str,
        private_cloud_name: &str,
    ...
    ) -> Result<Poller<AVSScriptExecutionsClientDeleteOperationStatus>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut url = self.endpoint.clone();
        let mut path = String::from("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/scriptExecutions/{scriptExecutionName}");
        ...
        Ok(Poller::new(
            move |poller_state: PollerState, poller_options| {
                ...
                Box::pin(async move {
                    ...
                    let res: AVSScriptExecutionsClientDeleteOperationStatus =
                        json::from_json(&body)?;
    ...
    /// * `script_execution_name` - Name of the script cmdlet.
    /// * `options` - Optional parameters for the request.
    #[tracing::function("Microsoft.AVS.ScriptExecutions.get")]
    pub async fn get(
        &self,
        resource_group_name: &str,
        private_cloud_name: &str,
        ...
        if script_execution_name.is_empty() {
            return Err(azure_core::Error::with_message(
                azure_core::error::ErrorKind::Other,
                "parameter script_execution_name cannot be empty",
            ));
        }
    ...
    /// * `script_execution_name` - Name of the script cmdlet.
    /// * `options` - Optional parameters for the request.
    #[tracing::function("Microsoft.AVS.ScriptExecutions.getExecutionLogs")]
    pub async fn get_execution_logs(
        ...
        request.insert_header("accept", "application/json");
        if let Some(script_output_stream_type) = options.script_output_stream_type.clone() {
            request.insert_header("content-type", "application/json");
    ...
    /// * `private_cloud_name` - Name of the private cloud
    /// * `options` - Optional parameters for the request.
    #[tracing::function("Microsoft.AVS.ScriptExecutions.list")]
    pub fn list(
        &self,
        resource_group_name: &str,
        private_cloud_name: &str,
                ...
                Box::pin({
                    ...
                    async move {
                        let rsp = pipeline
                            ...
                            .await?;
                        let (status, headers, body) = rsp.deconstruct();
                        let res: ScriptExecutionsList = json::from_json(&body)?;
                        let rsp = RawResponse::from_bytes(status, headers, body).into();
