...
use crate::generated::models::{
    AVSIscsiPathsClientCreateOrUpdateOperationStatus, AVSIscsiPathsClientCreateOrUpdateOptions,
    AVSIscsiPathsClientDeleteOperationStatus, AVSIscsiPathsClientDeleteOptions,
    AVSIscsiPathsClientGetOptions, AVSIscsiPathsClientListByPrivateCloudOptions, IscsiPath,
    IscsiPathListResult,
};
use azure_core::{
...
impl AVSIscsiPathsClient {
    ...
    /// ## Response Headers
    ///
    /// The returned [`Response`](azure_core::http::Response) implements the [`AVSIscsiPathsClientCreateOrUpdateOperationStatusHeaders`] trait, which provides
    ...
    ///
    /// ### Available headers
    /// * [`retry_after`()](crate::generated::models::AVSIscsiPathsClientCreateOrUpdateOperationStatusHeaders::retry_after) - retry-after
    ///
    /// [`AVSIscsiPathsClientCreateOrUpdateOperationStatusHeaders`]: crate::generated::models::AVSIscsiPathsClientCreateOrUpdateOperationStatusHeaders
    #[tracing::function("Microsoft.AVS.IscsiPaths.createOrUpdate")]
    pub fn create_or_update(
        &self,
        resource_group_name: &str,
        private_cloud_name: &str,
        resource: RequestContent<IscsiPath>,
        options: Option<AVSIscsiPathsClientCreateOrUpdateOptions<'_>>,
    ) -> Result<Poller<AVSIscsiPathsClientCreateOrUpdateOperationStatus>> {
        ...
        Ok(Poller::new(
            move |poller_state: PollerState, poller_options| {
                ...
                Box::pin(async move {
                    ...
                    let res: AVSIscsiPathsClientCreateOrUpdateOperationStatus =
                        json::from_json(&body)?;
    ...
    /// ## Response Headers
    ///
    /// The returned [`Response`](azure_core::http::Response) implements the [`AVSIscsiPathsClientDeleteOperationStatusHeaders`] trait, which provides
    /// access to response headers. For example:
    ///
    /// ```no_run
    /// use azure_core::{Result, http::Response};
    ...
    ///
    /// ### Available headers
    /// * [`location`()](crate::generated::models::AVSIscsiPathsClientDeleteOperationStatusHeaders::location) - location
    /// * [`retry_after`()](crate::generated::models::AVSIscsiPathsClientDeleteOperationStatusHeaders::retry_after) - retry-after
    ///
    /// [`AVSIscsiPathsClientDeleteOperationStatusHeaders`]: crate::generated::models::AVSIscsiPathsClientDeleteOperationStatusHeaders
    #[tracing::function("Microsoft.AVS.IscsiPaths.delete")]
    pub fn delete(
        &self,
        resource_group_name: &str,
        private_cloud_name: &str,
        options: Option<AVSIscsiPathsClientDeleteOptions<'_>>,
    ) -> Result<Poller<AVSIscsiPathsClientDeleteOperationStatus>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut url = self.endpoint.clone();
        let mut path = String::from("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/iscsiPaths/default");
        ...
        Ok(Poller::new(
            move |poller_state: PollerState, poller_options| {
                ...
                Box::pin(async move {
                    ...
                    let res: AVSIscsiPathsClientDeleteOperationStatus = json::from_json(&body)?;
    ...
    /// * `private_cloud_name` - Name of the private cloud
    /// * `options` - Optional parameters for the request.
    #[tracing::function("Microsoft.AVS.IscsiPaths.get")]
    pub async fn get(
        &self,
        resource_group_name: &str,
        private_cloud_name: &str,
        options: Option<AVSIscsiPathsClientGetOptions<'_>>,
    ) -> Result<Response<IscsiPath>> {
    ...
    /// * `private_cloud_name` - Name of the private cloud
    /// * `options` - Optional parameters for the request.
    #[tracing::function("Microsoft.AVS.IscsiPaths.listByPrivateCloud")]
    pub fn list_by_private_cloud(
        &self,
        resource_group_name: &str,
        private_cloud_name: &str,
        options: Option<AVSIscsiPathsClientListByPrivateCloudOptions<'_>>,
    ) -> Result<Pager<IscsiPathListResult>> {
        if private_cloud_name.is_empty() {
            return Err(azure_core::Error::with_message(
                azure_core::error::ErrorKind::Other,
                "parameter private_cloud_name cannot be empty",
                ...
                Box::pin({
                    ...
                    async move {
                        let rsp = pipeline
                            ...
                            .await?;
                        let (status, headers, body) = rsp.deconstruct();
                        let res: IscsiPathListResult = json::from_json(&body)?;
                        let rsp = RawResponse::from_bytes(status, headers, body).into();
